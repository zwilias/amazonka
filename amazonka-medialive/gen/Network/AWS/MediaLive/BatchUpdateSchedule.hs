...
data BatchUpdateSchedule = BatchUpdateSchedule'{_busCreates
                                                ::
                                                !(Maybe
...
batchUpdateSchedule pChannelId_
  = BatchUpdateSchedule'{_busCreates = Nothing,
                         _busDeletes = Nothing, _busChannelId = pChannelId_}
...
instance Hashable BatchUpdateSchedule where

instance NFData BatchUpdateSchedule where
...
data BatchUpdateScheduleResponse = BatchUpdateScheduleResponse'{_busrsCreates
                                                                ::
                                                                !(Maybe
...
batchUpdateScheduleResponse
    :: Int -- ^ 'busrsResponseStatus'
    -> BatchUpdateScheduleResponse
batchUpdateScheduleResponse pResponseStatus_
  = BatchUpdateScheduleResponse'{_busrsCreates =
                                   Nothing,
...
instance NFData BatchUpdateScheduleResponse where
