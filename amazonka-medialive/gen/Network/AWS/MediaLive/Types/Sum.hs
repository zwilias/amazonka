...
instance FromText AacInputType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacInputType from value: '" <>
...
instance FromText AacProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacProfile from value: '" <>
...
instance FromText AacSpec where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacSpec from value: '" <>
...
instance FromText Ac3DrcProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3DrcProfile from value: '" <>
...
instance FromText AudioDescriptionAudioTypeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioDescriptionAudioTypeControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText AudioDescriptionLanguageCodeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioDescriptionLanguageCodeControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText AudioLanguageSelectionPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioLanguageSelectionPolicy from value: '" <>
        e <> "'. Accepted values: loose, strict"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: itu_1770_1, itu_1770_2"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: correct_audio"
...
instance FromText AudioOnlyHlsTrackType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioOnlyHlsTrackType from value: '" <>
        e <>
...
instance FromText AudioType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioType from value: '" <>
        e <>
...
instance FromText AuthenticationScheme where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AuthenticationScheme from value: '" <>
        e <> "'. Accepted values: akamai, common"
...
instance FromText AvailBlankingState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AvailBlankingState from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText BlackoutSlateNetworkEndBlackout where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BlackoutSlateNetworkEndBlackout from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText BlackoutSlateState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BlackoutSlateState from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText BurnInAlignment where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInAlignment from value: '" <>
        e <> "'. Accepted values: centered, left, smart"
...
instance FromText BurnInBackgroundColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInBackgroundColor from value: '" <>
...
instance FromText BurnInFontColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInFontColor from value: '" <>
...
instance FromText BurnInOutlineColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInOutlineColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText BurnInShadowColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInShadowColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText BurnInTeletextGridControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurnInTeletextGridControl from value: '" <>
        e <> "'. Accepted values: fixed, scaled"
...
instance FromText ChannelState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ChannelState from value: '" <>
        e <>
...
instance FromText DvbSdtOutputSdt where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSdtOutputSdt from value: '" <>
        e <>
...
instance FromText DvbSubDestinationAlignment where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationAlignment from value: '" <>
        e <> "'. Accepted values: centered, left, smart"
...
instance FromText DvbSubDestinationBackgroundColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationBackgroundColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText DvbSubDestinationFontColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationFontColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText DvbSubDestinationOutlineColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationOutlineColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText DvbSubDestinationShadowColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationShadowColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText DvbSubDestinationTeletextGridControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubDestinationTeletextGridControl from value: '" <>
        e <> "'. Accepted values: fixed, scaled"
...
instance FromText Eac3DrcLine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3DrcLine from value: '" <>
        e <>
...
instance FromText Eac3DrcRf where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3DrcRf from value: '" <>
        e <>
        "'. Accepted values: film_light, film_standard, music_light, music_standard, none, speech"
...
instance FromText EmbeddedScte20Detection where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EmbeddedScte20Detection from value: '" <>
        e <> "'. Accepted values: auto, off"
...
instance FromText FecOutputIncludeFec where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FecOutputIncludeFec from value: '" <>
        e <> "'. Accepted values: column, column_and_row"
...
instance FromText FixedAfd where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FixedAfd from value: '" <>
        e <>
...
instance FromText GlobalConfigurationInputEndAction where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GlobalConfigurationInputEndAction from value: '" <>
        e <> "'. Accepted values: none, switch_and_loop_inputs"
...
instance FromText GlobalConfigurationLowFramerateInputs where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GlobalConfigurationLowFramerateInputs from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText GlobalConfigurationOutputTimingSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GlobalConfigurationOutputTimingSource from value: '" <>
        e <> "'. Accepted values: input_clock, system_clock"
...
instance FromText H264ColorMetadata where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264ColorMetadata from value: '" <>
...
instance FromText H264FlickerAq where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264FlickerAq from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264Level where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264Level from value: '" <>
        e <>
...
instance FromText H264LookAheadRateControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264LookAheadRateControl from value: '" <>
        e <> "'. Accepted values: high, low, medium"
...
instance FromText H264Profile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264Profile from value: '" <>
        e <>
...
instance FromText H264ScanType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264ScanType from value: '" <>
        e <> "'. Accepted values: interlaced, progressive"
...
instance FromText H264SpatialAq where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264SpatialAq from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264TemporalAq where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264TemporalAq from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264TimecodeInsertionBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264TimecodeInsertionBehavior from value: '" <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: adobe, elemental, elemental_scte35"
...
instance FromText HlsAkamaiHTTPTransferMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsAkamaiHTTPTransferMode from value: '" <>
        e <> "'. Accepted values: chunked, non_chunked"
...
instance FromText HlsIvInManifest where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsIvInManifest from value: '" <>
...
instance FromText HlsIvSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsIvSource from value: '" <>
        e <> "'. Accepted values: explicit, follows_segment_number"
...
instance FromText HlsMediaStoreStorageClass where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsMediaStoreStorageClass from value: '" <>
        e <> "'. Accepted values: temporal"
...
instance FromText HlsMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsMode from value: '" <>
        e <> "'. Accepted values: live, vod"
...
instance FromText HlsSegmentationMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsSegmentationMode from value: '" <>
        e <> "'. Accepted values: use_input_segmentation, use_segment_duration"
...
instance FromText HlsTsFileMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsTsFileMode from value: '" <>
...
instance FromText HlsWebdavHTTPTransferMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsWebdavHTTPTransferMode from value: '" <>
        e <> "'. Accepted values: chunked, non_chunked"
...
instance FromText InputCodec where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputCodec from value: '" <>
        e <> "'. Accepted values: avc, hevc, mpeg2"
...
instance FromText InputFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputFilter from value: '" <>
        e <> "'. Accepted values: auto, disabled, forced"
...
instance FromText InputLossActionForHlsOut where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputLossActionForHlsOut from value: '" <>
        e <> "'. Accepted values: emit_output, pause_output"
...
instance FromText InputLossActionForMsSmoothOut where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputLossActionForMsSmoothOut from value: '" <>
        e <> "'. Accepted values: emit_output, pause_output"
...
instance FromText InputLossActionForUdpOut where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputLossActionForUdpOut from value: '" <>
        e <> "'. Accepted values: drop_program, drop_ts, emit_program"
...
instance FromText InputLossImageType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputLossImageType from value: '" <>
        e <> "'. Accepted values: color, slate"
...
instance FromText InputMaximumBitrate where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputMaximumBitrate from value: '" <>
        e <> "'. Accepted values: max_10_mbps, max_20_mbps, max_50_mbps"
...
instance FromText InputResolution where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputResolution from value: '" <>
        e <> "'. Accepted values: hd, sd, uhd"
...
instance FromText InputSecurityGroupState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputSecurityGroupState from value: '" <>
        e <> "'. Accepted values: deleted, idle, in_use, updating"
...
instance FromText InputSourceEndBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputSourceEndBehavior from value: '" <>
        e <> "'. Accepted values: continue, loop"
...
instance FromText InputState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputState from value: '" <>
        e <>
...
instance FromText InputType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputType from value: '" <>
        e <>
...
instance FromText M2tsAbsentInputAudioBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsAbsentInputAudioBehavior from value: '" <>
        e <> "'. Accepted values: drop, encode_silence"
...
instance FromText M2tsArib where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsArib from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText M2tsAribCaptionsPidControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsAribCaptionsPidControl from value: '" <>
        e <> "'. Accepted values: auto, use_configured"
...
instance FromText M2tsAudioInterval where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsAudioInterval from value: '" <>
...
instance FromText M2tsAudioStreamType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsAudioStreamType from value: '" <>
        e <> "'. Accepted values: atsc, dvb"
...
instance FromText M2tsCCDescriptor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsCCDescriptor from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText M2tsEbifControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsEbifControl from value: '" <>
...
instance FromText M2tsKlv where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsKlv from value: '" <>
        e <> "'. Accepted values: none, passthrough"
...
instance FromText M2tsScte35Control where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsScte35Control from value: '" <>
        e <> "'. Accepted values: none, passthrough"
...
instance FromText M2tsTimedMetadataBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsTimedMetadataBehavior from value: '" <>
        e <> "'. Accepted values: no_passthrough, passthrough"
...
instance FromText M3u8Scte35Behavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M3u8Scte35Behavior from value: '" <>
        e <> "'. Accepted values: no_passthrough, passthrough"
...
instance FromText M3u8TimedMetadataBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M3u8TimedMetadataBehavior from value: '" <>
        e <> "'. Accepted values: no_passthrough, passthrough"
...
instance FromText Mp2CodingMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mp2CodingMode from value: '" <>
        e <> "'. Accepted values: coding_mode_1_0, coding_mode_2_0"
  ...
  parser =
    takeLowerText >>= \case
      "check_cryptography_and_validate_name" ->
        pure CheckCryptographyAndValidateName
      "check_cryptography_only" -> pure CheckCryptographyOnly
      e ->
        fromTextError $
        "Failure parsing NetworkInputServerValidation from value: '" <>
        e <>
...
instance FromText RtmpCacheFullBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RtmpCacheFullBehavior from value: '" <>
        e <> "'. Accepted values: disconnect_immediately, wait_for_server"
...
instance FromText RtmpCaptionData where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RtmpCaptionData from value: '" <>
        e <> "'. Accepted values: all, field1_608, field1_and_field2_608"
...
instance FromText RtmpOutputCertificateMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RtmpOutputCertificateMode from value: '" <>
        e <> "'. Accepted values: self_signed, verify_authenticity"
...
instance FromText Scte20Convert608To708 where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scte20Convert608To708 from value: '" <>
        e <> "'. Accepted values: disabled, upconvert"
...
instance FromText Scte35AposNoRegionalBlackoutBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scte35AposNoRegionalBlackoutBehavior from value: '" <>
        e <> "'. Accepted values: follow, ignore"
...
instance FromText Scte35AposWebDeliveryAllowedBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scte35AposWebDeliveryAllowedBehavior from value: '" <>
        e <> "'. Accepted values: follow, ignore"
...
instance FromText Scte35SpliceInsertNoRegionalBlackoutBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scte35SpliceInsertNoRegionalBlackoutBehavior from value: '" <>
        e <> "'. Accepted values: follow, ignore"
...
instance FromText Scte35SpliceInsertWebDeliveryAllowedBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scte35SpliceInsertWebDeliveryAllowedBehavior from value: '" <>
        e <> "'. Accepted values: follow, ignore"
...
instance FromText SmoothGroupAudioOnlyTimecodeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupAudioOnlyTimecodeControl from value: '" <>
        e <> "'. Accepted values: passthrough, use_configured_clock"
...
instance FromText SmoothGroupCertificateMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupCertificateMode from value: '" <>
        e <> "'. Accepted values: self_signed, verify_authenticity"
...
instance FromText SmoothGroupEventIdMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupEventIdMode from value: '" <>
        e <> "'. Accepted values: no_event_id, use_configured, use_timestamp"
...
instance FromText SmoothGroupEventStopBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupEventStopBehavior from value: '" <>
        e <> "'. Accepted values: none, send_eos"
...
instance FromText SmoothGroupSegmentationMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupSegmentationMode from value: '" <>
        e <> "'. Accepted values: use_input_segmentation, use_segment_duration"
...
instance FromText SmoothGroupSparseTrackType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupSparseTrackType from value: '" <>
        e <> "'. Accepted values: none, scte_35"
...
instance FromText SmoothGroupStreamManifestBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupStreamManifestBehavior from value: '" <>
        e <> "'. Accepted values: do_not_send, send"
...
instance FromText SmoothGroupTimestampOffsetMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SmoothGroupTimestampOffsetMode from value: '" <>
        e <> "'. Accepted values: use_configured_offset, use_event_start_date"
...
instance FromText TimecodeConfigSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TimecodeConfigSource from value: '" <>
        e <> "'. Accepted values: embedded, systemclock, zerobased"
...
instance FromText TtmlDestinationStyleControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TtmlDestinationStyleControl from value: '" <>
        e <> "'. Accepted values: passthrough, use_configured"
...
instance FromText UdpTimedMetadataId3Frame where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing UdpTimedMetadataId3Frame from value: '" <>
        e <> "'. Accepted values: none, priv, tdrl"
...
instance FromText VideoDescriptionRespondToAfd where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoDescriptionRespondToAfd from value: '" <>
...
instance FromText VideoDescriptionScalingBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoDescriptionScalingBehavior from value: '" <>
...
instance FromText VideoSelectorColorSpace where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoSelectorColorSpace from value: '" <>
        e <> "'. Accepted values: follow, rec_601, rec_709"
...
instance FromText VideoSelectorColorSpaceUsage where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoSelectorColorSpaceUsage from value: '" <>
