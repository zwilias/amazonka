...
newtype DeleteSchedule = DeleteSchedule'{_dsChannelId
                                         :: Text}
...
instance Hashable DeleteSchedule where

instance NFData DeleteSchedule where
...
newtype DeleteScheduleResponse = DeleteScheduleResponse'{_dsrsResponseStatus
                                                         :: Int}
...
deleteScheduleResponse pResponseStatus_
  = DeleteScheduleResponse'{_dsrsResponseStatus =
                              pResponseStatus_}
...
instance NFData DeleteScheduleResponse where
