...
data PurchaseOffering = PurchaseOffering'{_poRequestId
                                          :: !(Maybe Text),
                                          _poStart :: !(Maybe Text),
                                          _poName :: !(Maybe Text),
...
purchaseOffering pOfferingId_ pCount_
  = PurchaseOffering'{_poRequestId = Nothing,
                      _poStart = Nothing, _poName = Nothing,
                      _poTags = Nothing, _poOfferingId = pOfferingId_,
          ...
          = object
              (catMaybes
                 [("requestId" .=) <$> _poRequestId,
                  ("start" .=) <$> _poStart, ("name" .=) <$> _poName,
                  ("tags" .=) <$> _poTags, Just ("count" .= _poCount)])
...
data PurchaseOfferingResponse = PurchaseOfferingResponse'{_porsReservation
                                                          ::
                                                          !(Maybe Reservation),
                                                          _porsResponseStatus ::
                                                          !Int}
...
purchaseOfferingResponse pResponseStatus_
  = PurchaseOfferingResponse'{_porsReservation =
                                Nothing,
