...
newtype DeleteMultiplex = DeleteMultiplex'{_dMultiplexId
                                           :: Text}
...
instance Hashable DeleteMultiplex where

instance NFData DeleteMultiplex where
...
data DeleteMultiplexResponse = DeleteMultiplexResponse'{_delrsState
                                                        ::
...
instance NFData DeleteMultiplexResponse where
