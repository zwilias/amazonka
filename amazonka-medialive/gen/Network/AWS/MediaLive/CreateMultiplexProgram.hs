...
data CreateMultiplexProgram = CreateMultiplexProgram'{_cmpMultiplexId
                                                      :: !Text,
                                                      _cmpRequestId :: !Text,
...
createMultiplexProgram
    :: Text -- ^ 'cmpMultiplexId'
    -> Text -- ^ 'cmpRequestId'
    -> MultiplexProgramSettings -- ^ 'cmpMultiplexProgramSettings'
    -> Text -- ^ 'cmpProgramName'
    -> CreateMultiplexProgram
createMultiplexProgram pMultiplexId_ pRequestId_
  pMultiplexProgramSettings_ pProgramName_
  = CreateMultiplexProgram'{_cmpMultiplexId =
                              pMultiplexId_,
...
instance AWSRequest CreateMultiplexProgram where
        type Rs CreateMultiplexProgram =
             CreateMultiplexProgramResponse
...
instance Hashable CreateMultiplexProgram where

instance NFData CreateMultiplexProgram where
...
instance ToPath CreateMultiplexProgram where
        toPath CreateMultiplexProgram'{..}
          = mconcat
              ["/prod/multiplexes/", toBS _cmpMultiplexId,
               "/programs"]
...
data CreateMultiplexProgramResponse = CreateMultiplexProgramResponse'{_cmprsMultiplexProgram
                                                                      ::
                                                                      !(Maybe
                                                                          MultiplexProgram),
...
createMultiplexProgramResponse pResponseStatus_
  = CreateMultiplexProgramResponse'{_cmprsMultiplexProgram
                                      = Nothing,
...
instance NFData CreateMultiplexProgramResponse where
