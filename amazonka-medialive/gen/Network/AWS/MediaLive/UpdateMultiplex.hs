...
data UpdateMultiplex = UpdateMultiplex'{_umName ::
                                        !(Maybe Text),
                                        _umMultiplexSettings ::
...
updateMultiplex pMultiplexId_
  = UpdateMultiplex'{_umName = Nothing,
...
instance Hashable UpdateMultiplex where

instance NFData UpdateMultiplex where
...
data UpdateMultiplexResponse = UpdateMultiplexResponse'{_umrsMultiplex
                                                        :: !(Maybe Multiplex),
                                                        _umrsResponseStatus ::
                                                        !Int}
...
updateMultiplexResponse pResponseStatus_
  = UpdateMultiplexResponse'{_umrsMultiplex = Nothing,
...
instance NFData UpdateMultiplexResponse where
