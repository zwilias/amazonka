...
data CreateMultiplex = CreateMultiplex'{_cmTags ::
                                        !(Maybe (Map Text Text)),
                                        _cmRequestId :: !Text,
...
createMultiplex
    :: Text -- ^ 'cmRequestId'
    -> MultiplexSettings -- ^ 'cmMultiplexSettings'
    -> Text -- ^ 'cmName'
    -> CreateMultiplex
createMultiplex pRequestId_ pMultiplexSettings_
  pName_
  = CreateMultiplex'{_cmTags = Nothing,
                     _cmRequestId = pRequestId_,
                     _cmMultiplexSettings = pMultiplexSettings_,
                     _cmAvailabilityZones = mempty, _cmName = pName_}
...
instance Hashable CreateMultiplex where

instance NFData CreateMultiplex where
...
data CreateMultiplexResponse = CreateMultiplexResponse'{_cmrsMultiplex
                                                        :: !(Maybe Multiplex),
                                                        _cmrsResponseStatus ::
                                                        !Int}
...
createMultiplexResponse pResponseStatus_
  = CreateMultiplexResponse'{_cmrsMultiplex = Nothing,
...
instance NFData CreateMultiplexResponse where
