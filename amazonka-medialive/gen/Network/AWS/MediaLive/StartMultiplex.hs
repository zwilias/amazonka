...
newtype StartMultiplex = StartMultiplex'{_sMultiplexId
                                         :: Text}
...
instance Hashable StartMultiplex where

instance NFData StartMultiplex where
...
instance ToPath StartMultiplex where
        toPath StartMultiplex'{..}
          = mconcat
              ["/prod/multiplexes/", toBS _sMultiplexId, "/start"]
...
data StartMultiplexResponse = StartMultiplexResponse'{_starsState
                                                      ::
...
instance NFData StartMultiplexResponse where
