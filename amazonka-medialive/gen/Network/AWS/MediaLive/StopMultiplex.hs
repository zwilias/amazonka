...
newtype StopMultiplex = StopMultiplex'{_smMultiplexId
                                       :: Text}
...
instance Hashable StopMultiplex where

instance NFData StopMultiplex where
...
instance ToPath StopMultiplex where
        toPath StopMultiplex'{..}
          = mconcat
              ["/prod/multiplexes/", toBS _smMultiplexId, "/stop"]
...
data StopMultiplexResponse = StopMultiplexResponse'{_smrsState
                                                    :: !(Maybe MultiplexState),
                                                    _smrsARN :: !(Maybe Text),
                                                    _smrsPipelinesRunningCount
                                                    :: !(Maybe Int),
                                                    _smrsAvailabilityZones ::
                                                    !(Maybe [Text]),
                                                    _smrsProgramCount ::
                                                    !(Maybe Int),
                                                    _smrsDestinations ::
...
stopMultiplexResponse pResponseStatus_
  = StopMultiplexResponse'{_smrsState = Nothing,
                           _smrsARN = Nothing,
                           _smrsPipelinesRunningCount = Nothing,
                           _smrsAvailabilityZones = Nothing,
                           _smrsProgramCount = Nothing,
                           _smrsDestinations = Nothing, _smrsName = Nothing,
                           _smrsId = Nothing, _smrsMultiplexSettings = Nothing,
                           _smrsTags = Nothing,
...
instance NFData StopMultiplexResponse where
