...
data UpdateMultiplexProgram = UpdateMultiplexProgram'{_umpMultiplexProgramSettings
                                                      ::
                                                      !(Maybe
...
updateMultiplexProgram pMultiplexId_ pProgramName_
  = UpdateMultiplexProgram'{_umpMultiplexProgramSettings
                              = Nothing,
...
instance AWSRequest UpdateMultiplexProgram where
        type Rs UpdateMultiplexProgram =
             UpdateMultiplexProgramResponse
...
instance Hashable UpdateMultiplexProgram where

instance NFData UpdateMultiplexProgram where
...
instance ToPath UpdateMultiplexProgram where
        toPath UpdateMultiplexProgram'{..}
          = mconcat
              ["/prod/multiplexes/", toBS _umpMultiplexId,
               "/programs/", toBS _umpProgramName]
...
data UpdateMultiplexProgramResponse = UpdateMultiplexProgramResponse'{_umprsMultiplexProgram
                                                                      ::
                                                                      !(Maybe
                                                                          MultiplexProgram),
...
updateMultiplexProgramResponse pResponseStatus_
  = UpdateMultiplexProgramResponse'{_umprsMultiplexProgram
                                      = Nothing,
...
instance NFData UpdateMultiplexProgramResponse where
