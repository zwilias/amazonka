...
data UpdateChannelClass = UpdateChannelClass'{_uccDestinations
...
updateChannelClass
    :: Text -- ^ 'uccChannelId'
    -> ChannelClass -- ^ 'uccChannelClass'
    -> UpdateChannelClass
updateChannelClass pChannelId_ pChannelClass_
  = UpdateChannelClass'{_uccDestinations = Nothing,
...
instance Hashable UpdateChannelClass where

instance NFData UpdateChannelClass where
...
instance ToPath UpdateChannelClass where
        toPath UpdateChannelClass'{..}
          = mconcat
              ["/prod/channels/", toBS _uccChannelId,
               "/channelClass"]
...
data UpdateChannelClassResponse = UpdateChannelClassResponse'{_uccrsChannel
                                                              ::
                                                              !(Maybe Channel),
...
updateChannelClassResponse pResponseStatus_
  = UpdateChannelClassResponse'{_uccrsChannel =
                                  Nothing,
...
instance NFData UpdateChannelClassResponse where
