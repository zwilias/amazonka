...
newtype DeleteReservation = DeleteReservation'{_dReservationId
                                               :: Text}
...
deleteReservation pReservationId_
  = DeleteReservation'{_dReservationId =
                         pReservationId_}
...
instance Hashable DeleteReservation where

instance NFData DeleteReservation where
...
data DeleteReservationResponse = DeleteReservationResponse'{_drrsState
                                                            ::
                                                            !(Maybe
                                                                ReservationState),
...
deleteReservationResponse pResponseStatus_
  = DeleteReservationResponse'{_drrsState = Nothing,
                               _drrsResourceSpecification = Nothing,
                               _drrsCurrencyCode = Nothing, _drrsARN = Nothing,
                               _drrsStart = Nothing, _drrsCount = Nothing,
                               _drrsEnd = Nothing, _drrsName = Nothing,
                               _drrsReservationId = Nothing,
                               _drrsOfferingId = Nothing, _drrsRegion = Nothing,
                               ...
                               _drrsDuration = Nothing, _drrsTags = Nothing,
...
instance NFData DeleteReservationResponse where
