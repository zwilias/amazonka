...
newtype DescribeOffering = DescribeOffering'{_doOfferingId
                                             :: Text}
...
instance Hashable DescribeOffering where

instance NFData DescribeOffering where
...
data DescribeOfferingResponse = DescribeOfferingResponse'{_dorsResourceSpecification
                                                          ::
                                                          !(Maybe
...
describeOfferingResponse pResponseStatus_
  = DescribeOfferingResponse'{_dorsResourceSpecification
                                = Nothing,
                              _dorsCurrencyCode = Nothing, _dorsARN = Nothing,
                              _dorsOfferingId = Nothing, _dorsRegion = Nothing,
...
instance NFData DescribeOfferingResponse where
