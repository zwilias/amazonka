...
newtype DescribeMultiplex = DescribeMultiplex'{_dmMultiplexId
                                               :: Text}
...
instance Hashable DescribeMultiplex where

instance NFData DescribeMultiplex where
...
data DescribeMultiplexResponse = DescribeMultiplexResponse'{_dmrsState
                                                            ::
                                                            !(Maybe
                                                                MultiplexState),
                                                            _dmrsARN ::
...
instance NFData DescribeMultiplexResponse where
