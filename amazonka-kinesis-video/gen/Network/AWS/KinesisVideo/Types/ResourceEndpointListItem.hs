...
data ResourceEndpointListItem = ResourceEndpointListItem'{_reliProtocol
                                                          ::
                                                          !(Maybe
                                                              ChannelProtocol),
...
resourceEndpointListItem
    :: ResourceEndpointListItem
resourceEndpointListItem
  = ResourceEndpointListItem'{_reliProtocol = Nothing,
...
instance FromJSON ResourceEndpointListItem where
        parseJSON
          = withObject "ResourceEndpointListItem"
              (\ x ->
                 ResourceEndpointListItem' <$>
                   (x .:? "Protocol") <*> (x .:? "ResourceEndpoint"))

instance Hashable ResourceEndpointListItem where

instance NFData ResourceEndpointListItem where
