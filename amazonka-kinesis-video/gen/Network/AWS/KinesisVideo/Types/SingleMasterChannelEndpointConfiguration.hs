...
data SingleMasterChannelEndpointConfiguration = SingleMasterChannelEndpointConfiguration'{_smcecProtocols
                                                                                          ::
                                                                                          !(Maybe
                                                                                              (List1
                                                                                                 ChannelProtocol)),
...
singleMasterChannelEndpointConfiguration
    :: SingleMasterChannelEndpointConfiguration
singleMasterChannelEndpointConfiguration
  = SingleMasterChannelEndpointConfiguration'{_smcecProtocols
                                                = Nothing,
                                              _smcecRole = Nothing}
