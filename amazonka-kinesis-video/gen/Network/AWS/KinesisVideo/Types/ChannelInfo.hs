...
data ChannelInfo = ChannelInfo'{_ciCreationTime ::
                                !(Maybe POSIX),
...
channelInfo
    :: ChannelInfo
channelInfo
  = ChannelInfo'{_ciCreationTime = Nothing,
                 _ciChannelStatus = Nothing, _ciChannelARN = Nothing,
                 _ciSingleMasterConfiguration = Nothing,
                 _ciChannelName = Nothing, _ciVersion = Nothing,
...
instance FromJSON ChannelInfo where
        parseJSON
          = withObject "ChannelInfo"
              (\ x ->
                 ChannelInfo' <$>
                   (x .:? "CreationTime") <*> (x .:? "ChannelStatus")
                     <*> (x .:? "ChannelARN")
...
instance Hashable ChannelInfo where

instance NFData ChannelInfo where
