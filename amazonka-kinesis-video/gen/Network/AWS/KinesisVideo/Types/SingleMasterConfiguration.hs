...
newtype SingleMasterConfiguration = SingleMasterConfiguration'{_smcMessageTtlSeconds
                                                               :: Maybe Nat}
...
singleMasterConfiguration
    :: SingleMasterConfiguration
singleMasterConfiguration
  = SingleMasterConfiguration'{_smcMessageTtlSeconds =
                                 Nothing}
...
instance FromJSON SingleMasterConfiguration where
        parseJSON
          = withObject "SingleMasterConfiguration"
              (\ x ->
                 SingleMasterConfiguration' <$>
                   (x .:? "MessageTtlSeconds"))

instance Hashable SingleMasterConfiguration where

instance NFData SingleMasterConfiguration where
