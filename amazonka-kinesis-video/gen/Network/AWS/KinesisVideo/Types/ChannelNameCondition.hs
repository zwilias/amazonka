...
data ChannelNameCondition = ChannelNameCondition'{_cncComparisonOperator
                                                  ::
...
channelNameCondition
    :: ChannelNameCondition
channelNameCondition
  = ChannelNameCondition'{_cncComparisonOperator =
                            Nothing,
...
instance Hashable ChannelNameCondition where

instance NFData ChannelNameCondition where
