...
data StreamInfo = StreamInfo'{_siCreationTime ::
                              !(Maybe POSIX),
...
streamInfo
    :: StreamInfo
streamInfo
  = StreamInfo'{_siCreationTime = Nothing,
                _siStatus = Nothing, _siMediaType = Nothing,
                _siDataRetentionInHours = Nothing,
                _siStreamARN = Nothing, _siKMSKeyId = Nothing,
