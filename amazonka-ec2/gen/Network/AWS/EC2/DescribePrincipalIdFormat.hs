...
data DescribePrincipalIdFormat = DescribePrincipalIdFormat'{_dpifResources
                                                            :: !(Maybe [Text]),
                                                            _dpifNextToken ::
                                                            !(Maybe Text),
                                                            _dpifDryRun ::
...
describePrincipalIdFormat
    :: DescribePrincipalIdFormat
describePrincipalIdFormat
  = DescribePrincipalIdFormat'{_dpifResources =
                                 Nothing,
                               _dpifNextToken = Nothing, _dpifDryRun = Nothing,
...
data DescribePrincipalIdFormatResponse = DescribePrincipalIdFormatResponse'{_dpifrsPrincipals
                                                                            ::
                                                                            !(Maybe
                                                                                [PrincipalIdFormat]),
                                                                            _dpifrsNextToken
...
describePrincipalIdFormatResponse pResponseStatus_
  = DescribePrincipalIdFormatResponse'{_dpifrsPrincipals
                                         = Nothing,
