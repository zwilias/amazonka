...
data RequestSpotInstances = RequestSpotInstances'{_rBlockDurationMinutes
                                                  :: !(Maybe Int),
                                                  _rClientToken ::
                                                  !(Maybe Text),
                                                  _rInstanceCount ::
                                                  ...
                                                  _rLaunchSpecification ::
                                                  !(Maybe
                                                      RequestSpotLaunchSpecification),
                                                  _rAvailabilityZoneGroup ::
                                                  !(Maybe Text),
                                                  _rValidUntil ::
                                                  !(Maybe ISO8601),
                                                  _rLaunchGroup ::
...
requestSpotInstances
    :: RequestSpotInstances
requestSpotInstances
  = RequestSpotInstances'{_rBlockDurationMinutes =
                            Nothing,
                          _rClientToken = Nothing, _rInstanceCount = Nothing,
                          _rInstanceInterruptionBehavior = Nothing,
                          _rSpotPrice = Nothing,
                          _rLaunchSpecification = Nothing,
                          _rAvailabilityZoneGroup = Nothing,
                          _rValidUntil = Nothing, _rLaunchGroup = Nothing,
                          _rType = Nothing, _rValidFrom = Nothing,
                          _rDryRun = Nothing}
...
data RequestSpotInstancesResponse = RequestSpotInstancesResponse'{_rsirsSpotInstanceRequests
                                                                  ::
                                                                  !(Maybe
                                                                      [SpotInstanceRequest]),
...
requestSpotInstancesResponse pResponseStatus_
  = RequestSpotInstancesResponse'{_rsirsSpotInstanceRequests
                                    = Nothing,
