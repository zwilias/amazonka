...
cltvLaunchTemplateName =
  lens _cltvLaunchTemplateName (\s a -> s {_cltvLaunchTemplateName = a})
...
cltvLaunchTemplateId =
  lens _cltvLaunchTemplateId (\s a -> s {_cltvLaunchTemplateId = a})

-- | A description for the version of the launch template.
cltvVersionDescription :: Lens' CreateLaunchTemplateVersion (Maybe Text)
cltvVersionDescription =
  lens _cltvVersionDescription (\s a -> s {_cltvVersionDescription = a})
...
cltvLaunchTemplateData ::
     Lens' CreateLaunchTemplateVersion RequestLaunchTemplateData
cltvLaunchTemplateData =
  lens _cltvLaunchTemplateData (\s a -> s {_cltvLaunchTemplateData = a})

instance AWSRequest CreateLaunchTemplateVersion where
  type Rs CreateLaunchTemplateVersion = CreateLaunchTemplateVersionResponse
...
cltvrsLaunchTemplateVersion ::
     Lens' CreateLaunchTemplateVersionResponse (Maybe LaunchTemplateVersion)
cltvrsLaunchTemplateVersion =
  lens
    _cltvrsLaunchTemplateVersion
    (\s a -> s {_cltvrsLaunchTemplateVersion = a})

-- | -- | The response status code.
cltvrsResponseStatus :: Lens' CreateLaunchTemplateVersionResponse Int
cltvrsResponseStatus =
  lens _cltvrsResponseStatus (\s a -> s {_cltvrsResponseStatus = a})
