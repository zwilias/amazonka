...
instance AWSRequest DescribeSpotFleetRequests where
  ...
  response =
    receiveXML
      (\s h x ->
         DescribeSpotFleetRequestsResponse' <$> (x .@? "nextToken") <*>
         (pure (fromEnum s)) <*>
         (x .@? "spotFleetRequestConfigSet" .!@ mempty >>= parseXMLList "item"))
...
instance ToQuery DescribeSpotFleetRequests where
  toQuery DescribeSpotFleetRequests' {..} =
    mconcat
      ...
      , toQuery (toQueryList "SpotFleetRequestId" <$> _dsfrSpotFleetRequestIds)
...
dsfrrsResponseStatus =
  lens _dsfrrsResponseStatus (\s a -> s {_dsfrrsResponseStatus = a})

-- | Information about the configuration of your Spot Fleet.
dsfrrsSpotFleetRequestConfigs ::
     Lens' DescribeSpotFleetRequestsResponse [SpotFleetRequestConfig]
dsfrrsSpotFleetRequestConfigs =
  lens
    _dsfrrsSpotFleetRequestConfigs
    (\s a -> s {_dsfrrsSpotFleetRequestConfigs = a}) .
  _Coerce
