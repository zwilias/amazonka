...
csirSpotInstanceRequestIds =
  lens _csirSpotInstanceRequestIds (\s a -> s {_csirSpotInstanceRequestIds = a}) .
  _Coerce
...
csirrsCancelledSpotInstanceRequests ::
     Lens' CancelSpotInstanceRequestsResponse [CancelledSpotInstanceRequest]
csirrsCancelledSpotInstanceRequests =
  lens
...
csirrsResponseStatus =
  lens _csirrsResponseStatus (\s a -> s {_csirrsResponseStatus = a})
