...
mltLaunchTemplateName =
  lens _mltLaunchTemplateName (\s a -> s {_mltLaunchTemplateName = a})
...
mltLaunchTemplateId =
  lens _mltLaunchTemplateId (\s a -> s {_mltLaunchTemplateId = a})
...
instance AWSRequest ModifyLaunchTemplate where
  ...
  response =
    receiveXML
      (\s h x ->
         ModifyLaunchTemplateResponse' <$> (x .@? "launchTemplate") <*>
         (pure (fromEnum s)))
...
mltrsLaunchTemplate =
  lens _mltrsLaunchTemplate (\s a -> s {_mltrsLaunchTemplate = a})

-- | -- | The response status code.
mltrsResponseStatus :: Lens' ModifyLaunchTemplateResponse Int
mltrsResponseStatus =
  lens _mltrsResponseStatus (\s a -> s {_mltrsResponseStatus = a})
