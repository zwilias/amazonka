...
--
-- Before the service provider runs this command, they must add a record to the DNS server. For more information, see <https://docs.aws.amazon.com/vpc/latest/userguide/ndpoint-services-dns-validation.html#add-dns-txt-record Adding a TXT Record to Your Domain's DNS Server > in the /Amazon VPC User Guide/ .
--
module Network.AWS.EC2.StartVPCEndpointServicePrivateDNSVerification
    (
    -- * Creating a Request
