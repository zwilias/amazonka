...
mfExcessCapacityTerminationPolicy ::
     Lens' ModifyFleet (Maybe FleetExcessCapacityTerminationPolicy)
mfExcessCapacityTerminationPolicy =
  lens
    _mfExcessCapacityTerminationPolicy
    (\s a -> s {_mfExcessCapacityTerminationPolicy = a})
...
mfTargetCapacitySpecification ::
     Lens' ModifyFleet TargetCapacitySpecificationRequest
mfTargetCapacitySpecification =
  lens
    _mfTargetCapacitySpecification
    (\s a -> s {_mfTargetCapacitySpecification = a})
...
instance ToQuery ModifyFleet where
  toQuery ModifyFleet' {..} =
    mconcat
      ...
      , "ExcessCapacityTerminationPolicy" =: _mfExcessCapacityTerminationPolicy
      , "DryRun" =: _mfDryRun
      , "FleetId" =: _mfFleetId
...
mfrsResponseStatus =
  lens _mfrsResponseStatus (\s a -> s {_mfrsResponseStatus = a})
