...
rsiLaunchSpecification ::
     Lens' RunScheduledInstances ScheduledInstancesLaunchSpecification
rsiLaunchSpecification =
...
rsiScheduledInstanceId =
  lens _rsiScheduledInstanceId (\s a -> s {_rsiScheduledInstanceId = a})
...
rrsInstanceIdSet =
  lens _rrsInstanceIdSet (\s a -> s {_rrsInstanceIdSet = a}) .
  _Default . _Coerce
