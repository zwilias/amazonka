...
dmaPublicIPs =
  lens _dmaPublicIPs (\s a -> s {_dmaPublicIPs = a}) . _Default . _Coerce
...
dmarsMovingAddressStatuses ::
     Lens' DescribeMovingAddressesResponse [MovingAddressStatus]
dmarsMovingAddressStatuses =
  lens _dmarsMovingAddressStatuses (\s a -> s {_dmarsMovingAddressStatuses = a}) .
  _Default . _Coerce
...
dmarsResponseStatus =
  lens _dmarsResponseStatus (\s a -> s {_dmarsResponseStatus = a})
