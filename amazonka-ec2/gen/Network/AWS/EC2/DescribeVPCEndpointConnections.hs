...
dvecFilters =
  lens _dvecFilters (\s a -> s {_dvecFilters = a}) . _Default . _Coerce
...
instance AWSRequest DescribeVPCEndpointConnections where
  type Rs DescribeVPCEndpointConnections = DescribeVPCEndpointConnectionsResponse
...
dvecrsVPCEndpointConnections ::
     Lens' DescribeVPCEndpointConnectionsResponse [VPCEndpointConnection]
dvecrsVPCEndpointConnections =
  lens
    _dvecrsVPCEndpointConnections
    (\s a -> s {_dvecrsVPCEndpointConnections = a}) .
  _Default . _Coerce
...
dvecrsResponseStatus =
  lens _dvecrsResponseStatus (\s a -> s {_dvecrsResponseStatus = a})
