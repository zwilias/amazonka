...
rrVPCPeeringConnectionId =
  lens _rrVPCPeeringConnectionId (\s a -> s {_rrVPCPeeringConnectionId = a})
...
rrEgressOnlyInternetGatewayId =
  lens
    ...
    (\s a -> s {_rrEgressOnlyInternetGatewayId = a})
...
rrDestinationIPv6CidrBlock =
  lens _rrDestinationIPv6CidrBlock (\s a -> s {_rrDestinationIPv6CidrBlock = a})
