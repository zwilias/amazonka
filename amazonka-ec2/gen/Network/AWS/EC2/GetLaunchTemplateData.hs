...
instance AWSRequest GetLaunchTemplateData where
  ...
  response =
    receiveXML
      (\s h x ->
         GetLaunchTemplateDataResponse' <$> (x .@? "launchTemplateData") <*>
         (pure (fromEnum s)))
...
-- | The instance data.
gltdrsLaunchTemplateData ::
     Lens' GetLaunchTemplateDataResponse (Maybe ResponseLaunchTemplateData)
gltdrsLaunchTemplateData =
  lens _gltdrsLaunchTemplateData (\s a -> s {_gltdrsLaunchTemplateData = a})

-- | -- | The response status code.
gltdrsResponseStatus :: Lens' GetLaunchTemplateDataResponse Int
gltdrsResponseStatus =
  lens _gltdrsResponseStatus (\s a -> s {_gltdrsResponseStatus = a})
