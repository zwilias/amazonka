...
data CreateVPCEndpoint = CreateVPCEndpoint'{_cvpcePolicyDocument
                                            :: !(Maybe Text),
...
--
-- * 'cvpcePolicyDocument' - A policy to attach to the endpoint that controls access to the service. The policy must be in valid JSON format. If this parameter is not specified, we attach a default policy that allows full access to the service.
--
...
--
-- * 'cvpceSubnetIds' - (Interface endpoint) The ID of one or more subnets in which to create an endpoint network interface.
--
...
createVPCEndpoint pVPCId_ pServiceName_
  = CreateVPCEndpoint'{_cvpcePolicyDocument = Nothing,
                       ...
                       _cvpceRouteTableIds = Nothing, _cvpceVPCId = pVPCId_,
...
data CreateVPCEndpointResponse = CreateVPCEndpointResponse'{_cversClientToken
                                                            :: !(Maybe Text),
                                                            _cversVPCEndpoint ::
                                                            !(Maybe
                                                                VPCEndpoint),
                                                            _cversResponseStatus
                                                            :: !Int}
...
createVPCEndpointResponse pResponseStatus_
  = CreateVPCEndpointResponse'{_cversClientToken =
                                 Nothing,
