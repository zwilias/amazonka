...
dvgsFilters =
  lens _dvgsFilters (\s a -> s {_dvgsFilters = a}) . _Default . _Coerce
...
dvgsVPNGatewayIds =
  lens _dvgsVPNGatewayIds (\s a -> s {_dvgsVPNGatewayIds = a}) .
  _Default . _Coerce
...
dvgrsResponseStatus =
  lens _dvgrsResponseStatus (\s a -> s {_dvgrsResponseStatus = a})
