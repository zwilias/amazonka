...
drioProductDescription ::
     Lens' DescribeReservedInstancesOfferings (Maybe RIProductDescription)
drioProductDescription =
...
drioFilters =
  lens _drioFilters (\s a -> s {_drioFilters = a}) . _Default . _Coerce
...
drioInstanceType ::
     Lens' DescribeReservedInstancesOfferings (Maybe InstanceType)
...
drioOfferingType ::
     Lens' DescribeReservedInstancesOfferings (Maybe OfferingTypeValues)
drioOfferingType = lens _drioOfferingType (\s a -> s {_drioOfferingType = a})

-- | One or more Reserved Instances offering IDs.
drioReservedInstancesOfferingIds ::
     Lens' DescribeReservedInstancesOfferings [Text]
drioReservedInstancesOfferingIds =
  lens
...
drioOfferingClass ::
     Lens' DescribeReservedInstancesOfferings (Maybe OfferingClassType)
...
instance AWSRequest DescribeReservedInstancesOfferings where
  ...
  response =
    receiveXML
      (\s h x ->
         DescribeReservedInstancesOfferingsResponse' <$> (x .@? "nextToken") <*>
...
driorsReservedInstancesOfferings ::
     Lens' DescribeReservedInstancesOfferingsResponse [ReservedInstancesOffering]
driorsReservedInstancesOfferings =
  lens
...
driorsResponseStatus =
  lens _driorsResponseStatus (\s a -> s {_driorsResponseStatus = a})
