...
data DescribeFpgaImages = DescribeFpgaImages'{_dfifOwners
                                              :: !(Maybe [Text]),
...
describeFpgaImages
    :: DescribeFpgaImages
describeFpgaImages
  = DescribeFpgaImages'{_dfifOwners = Nothing,
                        _dfifFilters = Nothing, _dfifNextToken = Nothing,
                        _dfifDryRun = Nothing, _dfifMaxResults = Nothing,
