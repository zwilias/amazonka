...
dsiaMinSlotDurationInHours ::
     Lens' DescribeScheduledInstanceAvailability (Maybe Int)
dsiaMinSlotDurationInHours =
  lens _dsiaMinSlotDurationInHours (\s a -> s {_dsiaMinSlotDurationInHours = a})
...
dsiaFilters =
  lens _dsiaFilters (\s a -> s {_dsiaFilters = a}) . _Default . _Coerce
...
dsiaMaxSlotDurationInHours ::
     Lens' DescribeScheduledInstanceAvailability (Maybe Int)
dsiaMaxSlotDurationInHours =
  lens _dsiaMaxSlotDurationInHours (\s a -> s {_dsiaMaxSlotDurationInHours = a})
...
dsiaFirstSlotStartTimeRange ::
     Lens' DescribeScheduledInstanceAvailability SlotDateTimeRangeRequest
dsiaFirstSlotStartTimeRange =
  lens
    _dsiaFirstSlotStartTimeRange
    (\s a -> s {_dsiaFirstSlotStartTimeRange = a})
...
instance AWSRequest DescribeScheduledInstanceAvailability where
  type Rs DescribeScheduledInstanceAvailability = DescribeScheduledInstanceAvailabilityResponse
...
instance ToQuery DescribeScheduledInstanceAvailability where
  toQuery DescribeScheduledInstanceAvailability' {..} =
    mconcat
      [ "Action" =: ("DescribeScheduledInstanceAvailability" :: ByteString)
...
dsiarsScheduledInstanceAvailabilitySet ::
     Lens' DescribeScheduledInstanceAvailabilityResponse [ScheduledInstanceAvailability]
dsiarsScheduledInstanceAvailabilitySet =
  lens
    _dsiarsScheduledInstanceAvailabilitySet
    (\s a -> s {_dsiarsScheduledInstanceAvailabilitySet = a}) .
  _Default . _Coerce

-- | The token required to retrieve the next set of results. This value is @null@ when there are no more results to return.
dsiarsNextToken ::
     Lens' DescribeScheduledInstanceAvailabilityResponse (Maybe Text)
...
dsiarsResponseStatus =
  lens _dsiarsResponseStatus (\s a -> s {_dsiarsResponseStatus = a})
