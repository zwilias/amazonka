...
micsInstanceCreditSpecifications ::
     Lens' ModifyInstanceCreditSpecification [InstanceCreditSpecificationRequest]
micsInstanceCreditSpecifications =
  lens
    _micsInstanceCreditSpecifications
    (\s a -> s {_micsInstanceCreditSpecifications = a}) .
  _Coerce

instance AWSRequest ModifyInstanceCreditSpecification where
  type Rs ModifyInstanceCreditSpecification = ModifyInstanceCreditSpecificationResponse
...
micsrsUnsuccessfulInstanceCreditSpecifications ::
     Lens' ModifyInstanceCreditSpecificationResponse [UnsuccessfulInstanceCreditSpecificationItem]
micsrsUnsuccessfulInstanceCreditSpecifications =
  lens
    _micsrsUnsuccessfulInstanceCreditSpecifications
    (\s a -> s {_micsrsUnsuccessfulInstanceCreditSpecifications = a}) .
  _Default . _Coerce

-- | Information about the instances whose credit option for CPU usage was successfully modified.
micsrsSuccessfulInstanceCreditSpecifications ::
     Lens' ModifyInstanceCreditSpecificationResponse [SuccessfulInstanceCreditSpecificationItem]
micsrsSuccessfulInstanceCreditSpecifications =
  lens
    _micsrsSuccessfulInstanceCreditSpecifications
    (\s a -> s {_micsrsSuccessfulInstanceCreditSpecifications = a}) .
  _Default . _Coerce

-- | -- | The response status code.
micsrsResponseStatus :: Lens' ModifyInstanceCreditSpecificationResponse Int
micsrsResponseStatus =
  lens _micsrsResponseStatus (\s a -> s {_micsrsResponseStatus = a})
