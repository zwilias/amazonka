...
instance AWSRequest PurchaseHostReservation where
  ...
  response =
    receiveXML
      (\s h x ->
         PurchaseHostReservationResponse' <$> (x .@? "currencyCode") <*>
         (x .@? "clientToken") <*>
         (x .@? "totalHourlyPrice") <*>
         (x .@? "totalUpfrontPrice") <*>
...
phrrsCurrencyCode ::
     Lens' PurchaseHostReservationResponse (Maybe CurrencyCodeValues)
...
phrrsTotalHourlyPrice =
  lens _phrrsTotalHourlyPrice (\s a -> s {_phrrsTotalHourlyPrice = a})
...
phrrsTotalUpfrontPrice =
  lens _phrrsTotalUpfrontPrice (\s a -> s {_phrrsTotalUpfrontPrice = a})

-- | Describes the details of the purchase.
phrrsPurchase :: Lens' PurchaseHostReservationResponse [Purchase]
phrrsPurchase =
  lens _phrrsPurchase (\s a -> s {_phrrsPurchase = a}) . _Default . _Coerce

-- | -- | The response status code.
phrrsResponseStatus :: Lens' PurchaseHostReservationResponse Int
phrrsResponseStatus =
  lens _phrrsResponseStatus (\s a -> s {_phrrsResponseStatus = a})
