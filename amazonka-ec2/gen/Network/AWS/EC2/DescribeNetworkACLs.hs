...
dnaclFilters =
  lens _dnaclFilters (\s a -> s {_dnaclFilters = a}) . _Default . _Coerce

-- | One or more network ACL IDs. Default: Describes all your network ACLs.
dnaclNetworkACLIds :: Lens' DescribeNetworkACLs [Text]
dnaclNetworkACLIds =
  lens _dnaclNetworkACLIds (\s a -> s {_dnaclNetworkACLIds = a}) .
  _Default . _Coerce
...
dnarsResponseStatus =
  lens _dnarsResponseStatus (\s a -> s {_dnarsResponseStatus = a})
