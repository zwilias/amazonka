...
data DescribeReservedInstances = DescribeReservedInstances'{_driFilters
                                                            ::
                                                            !(Maybe [Filter]),
...
describeReservedInstances
    :: DescribeReservedInstances
describeReservedInstances
  = DescribeReservedInstances'{_driFilters = Nothing,
...
data DescribeReservedInstancesResponse = DescribeReservedInstancesResponse'{_drirsReservedInstances
                                                                            ::
                                                                            !(Maybe
                                                                                [ReservedInstances]),
