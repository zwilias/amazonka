...
dltLaunchTemplateName =
  lens _dltLaunchTemplateName (\s a -> s {_dltLaunchTemplateName = a})

-- | The ID of the launch template. You must specify either the launch template ID or launch template name in the request.
dltLaunchTemplateId :: Lens' DeleteLaunchTemplate (Maybe Text)
dltLaunchTemplateId =
  lens _dltLaunchTemplateId (\s a -> s {_dltLaunchTemplateId = a})
...
instance AWSRequest DeleteLaunchTemplate where
  ...
  response =
    receiveXML
      (\s h x ->
         DeleteLaunchTemplateResponse' <$> (x .@? "launchTemplate") <*>
         (pure (fromEnum s)))
...
dltrsLaunchTemplate =
  lens _dltrsLaunchTemplate (\s a -> s {_dltrsLaunchTemplate = a})

-- | -- | The response status code.
dltrsResponseStatus :: Lens' DeleteLaunchTemplateResponse Int
dltrsResponseStatus =
  lens _dltrsResponseStatus (\s a -> s {_dltrsResponseStatus = a})
