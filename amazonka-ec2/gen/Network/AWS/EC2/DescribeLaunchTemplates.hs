...
dltsFilters =
  lens _dltsFilters (\s a -> s {_dltsFilters = a}) . _Default . _Coerce
...
dltsLaunchTemplateIds =
  lens _dltsLaunchTemplateIds (\s a -> s {_dltsLaunchTemplateIds = a}) .
  _Default . _Coerce
...
dltsLaunchTemplateNames =
  lens _dltsLaunchTemplateNames (\s a -> s {_dltsLaunchTemplateNames = a}) .
  _Default . _Coerce
...
instance ToQuery DescribeLaunchTemplates where
  toQuery DescribeLaunchTemplates' {..} =
    mconcat
      ...
      , toQuery (toQueryList "LaunchTemplateId" <$> _dltsLaunchTemplateIds)
      , "DryRun" =: _dltsDryRun
      , "MaxResults" =: _dltsMaxResults
      , toQuery (toQueryList "LaunchTemplateName" <$> _dltsLaunchTemplateNames)
      ]
...
dltsrsLaunchTemplates =
  lens _dltsrsLaunchTemplates (\s a -> s {_dltsrsLaunchTemplates = a}) .
  _Default . _Coerce
...
dltsrsResponseStatus =
  lens _dltsrsResponseStatus (\s a -> s {_dltsrsResponseStatus = a})
