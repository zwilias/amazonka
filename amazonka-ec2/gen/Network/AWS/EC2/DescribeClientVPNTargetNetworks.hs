...
data DescribeClientVPNTargetNetworks = DescribeClientVPNTargetNetworks'{_dcvtnFilters
                                                                        ::
                                                                        !(Maybe
                                                                            [Filter]),
                                                                        _dcvtnNextToken
...
describeClientVPNTargetNetworks pClientVPNEndpointId_
  = DescribeClientVPNTargetNetworks'{_dcvtnFilters =
                                       Nothing,
...
data DescribeClientVPNTargetNetworksResponse = DescribeClientVPNTargetNetworksResponse'{_dcvtnrsClientVPNTargetNetworks
                                                                                        ::
                                                                                        !(Maybe
                                                                                            [TargetNetwork]),
                                                                                        _dcvtnrsNextToken
...
describeClientVPNTargetNetworksResponse
  pResponseStatus_
  = DescribeClientVPNTargetNetworksResponse'{_dcvtnrsClientVPNTargetNetworks
                                               = Nothing,
