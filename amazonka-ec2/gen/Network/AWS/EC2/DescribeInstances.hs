...
data DescribeInstances = DescribeInstances'{_diiFilters
                                            :: !(Maybe [Filter]),
...
describeInstances
    :: DescribeInstances
describeInstances
  = DescribeInstances'{_diiFilters = Nothing,
                       _diiNextToken = Nothing, _diiInstanceIds = Nothing,
                       _diiDryRun = Nothing, _diiMaxResults = Nothing}
