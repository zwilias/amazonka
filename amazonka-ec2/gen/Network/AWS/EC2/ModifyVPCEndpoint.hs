...
mvePrivateDNSEnabled =
  lens _mvePrivateDNSEnabled (\s a -> s {_mvePrivateDNSEnabled = a})

-- | (Interface endpoint) One or more subnet IDs in which to serve the endpoint.
mveAddSubnetIds :: Lens' ModifyVPCEndpoint [Text]
mveAddSubnetIds =
  lens _mveAddSubnetIds (\s a -> s {_mveAddSubnetIds = a}) . _Default . _Coerce

-- | (Interface endpoint) One or more subnets IDs in which to remove the endpoint.
mveRemoveSubnetIds :: Lens' ModifyVPCEndpoint [Text]
mveRemoveSubnetIds =
  lens _mveRemoveSubnetIds (\s a -> s {_mveRemoveSubnetIds = a}) .
  _Default . _Coerce

-- | (Interface endpoint) One or more security group IDs to associate with the network interface.
mveAddSecurityGroupIds :: Lens' ModifyVPCEndpoint [Text]
mveAddSecurityGroupIds =
  lens _mveAddSecurityGroupIds (\s a -> s {_mveAddSecurityGroupIds = a}) .
  _Default . _Coerce
...
mveRemoveSecurityGroupIds =
  lens _mveRemoveSecurityGroupIds (\s a -> s {_mveRemoveSecurityGroupIds = a}) .
  _Default . _Coerce
...
instance AWSRequest ModifyVPCEndpoint where
  ...
  response =
    receiveXML
      (\s h x ->
         ModifyVPCEndpointResponse' <$> (x .@? "return") <*> (pure (fromEnum s)))
...
instance ToQuery ModifyVPCEndpoint where
  toQuery ModifyVPCEndpoint' {..} =
    mconcat
      ...
      , toQuery (toQueryList "RemoveRouteTableId" <$> _mveRemoveRouteTableIds)
      ...
      , toQuery (toQueryList "AddSecurityGroupId" <$> _mveAddSecurityGroupIds)
      , "DryRun" =: _mveDryRun
      , toQuery
          (toQueryList "RemoveSecurityGroupId" <$> _mveRemoveSecurityGroupIds)
...
mversResponseStatus =
  lens _mversResponseStatus (\s a -> s {_mversResponseStatus = a})
