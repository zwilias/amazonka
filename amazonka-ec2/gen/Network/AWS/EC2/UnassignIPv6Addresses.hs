...
uiaIPv6Addresses =
  lens _uiaIPv6Addresses (\s a -> s {_uiaIPv6Addresses = a}) . _Coerce

-- | The ID of the network interface.
uiaNetworkInterfaceId :: Lens' UnassignIPv6Addresses Text
uiaNetworkInterfaceId =
  lens _uiaNetworkInterfaceId (\s a -> s {_uiaNetworkInterfaceId = a})
...
instance AWSRequest UnassignIPv6Addresses where
  ...
  response =
    receiveXML
      (\s h x ->
         UnassignIPv6AddressesResponse' <$> (x .@? "networkInterfaceId") <*>
...
uiarsNetworkInterfaceId =
  lens _uiarsNetworkInterfaceId (\s a -> s {_uiarsNetworkInterfaceId = a})
...
uiarsUnassignedIPv6Addresses =
  lens
    ...
    (\s a -> s {_uiarsUnassignedIPv6Addresses = a}) .
  _Default . _Coerce

-- | -- | The response status code.
uiarsResponseStatus :: Lens' UnassignIPv6AddressesResponse Int
uiarsResponseStatus =
  lens _uiarsResponseStatus (\s a -> s {_uiarsResponseStatus = a})
