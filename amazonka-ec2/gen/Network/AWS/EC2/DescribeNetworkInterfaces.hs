...
dnisNetworkInterfaceIds =
  lens _dnisNetworkInterfaceIds (\s a -> s {_dnisNetworkInterfaceIds = a}) .
  _Default . _Coerce
...
dnisFilters =
  lens _dnisFilters (\s a -> s {_dnisFilters = a}) . _Default . _Coerce
...
instance ToQuery DescribeNetworkInterfaces where
  toQuery DescribeNetworkInterfaces' {..} =
    mconcat
      ...
      , toQuery (toQueryList "NetworkInterfaceId" <$> _dnisNetworkInterfaceIds)
...
dnirsNetworkInterfaces ::
     Lens' DescribeNetworkInterfacesResponse [NetworkInterface]
dnirsNetworkInterfaces =
