...
dcliFilters =
  lens _dcliFilters (\s a -> s {_dcliFilters = a}) . _Default . _Coerce
...
dcliInstanceIds =
  lens _dcliInstanceIds (\s a -> s {_dcliInstanceIds = a}) . _Default . _Coerce
...
instance AWSRequest DescribeClassicLinkInstances where
  ...
  response =
    receiveXML
      (\s h x ->
         DescribeClassicLinkInstancesResponse' <$> (x .@? "nextToken") <*>
...
dclirsInstances ::
     Lens' DescribeClassicLinkInstancesResponse [ClassicLinkInstance]
dclirsInstances =
  lens _dclirsInstances (\s a -> s {_dclirsInstances = a}) . _Default . _Coerce

-- | -- | The response status code.
dclirsResponseStatus :: Lens' DescribeClassicLinkInstancesResponse Int
dclirsResponseStatus =
  lens _dclirsResponseStatus (\s a -> s {_dclirsResponseStatus = a})
