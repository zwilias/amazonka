...
--
-- * 'eiRoleName' - The name of the role that grants VM Import/Export permission to export images to your S3 bucket. If this parameter is not specified, the default role is named 'vmimport'.
--
-- * 'eiDescription' - A description of the image being exported. The maximum length is 255 bytes.
--
...
--
-- * 'eiS3ExportLocation' - Information about the destination S3 bucket. The bucket must exist and grant WRITE and READ_ACP permissions to the AWS account vm-import-export@amazon.com.
exportImage
...
--
-- * 'eirsRoleName' - The name of the role that grants VM Import/Export permission to export images to your S3 bucket.
--
...
--
-- * 'eirsS3ExportLocation' - Information about the destination S3 bucket.
--
