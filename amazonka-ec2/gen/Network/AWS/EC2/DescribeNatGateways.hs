...
dngNatGatewayIds =
  lens _dngNatGatewayIds (\s a -> s {_dngNatGatewayIds = a}) .
  _Default . _Coerce
...
dngrsNatGateways =
  lens _dngrsNatGateways (\s a -> s {_dngrsNatGateways = a}) .
  _Default . _Coerce
...
dngrsResponseStatus =
  lens _dngrsResponseStatus (\s a -> s {_dngrsResponseStatus = a})
