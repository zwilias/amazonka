...
data DescribeVPCs = DescribeVPCs'{_dvsFilters ::
                                  !(Maybe [Filter]),
...
describeVPCs
    :: DescribeVPCs
describeVPCs
  = DescribeVPCs'{_dvsFilters = Nothing,
                  _dvsNextToken = Nothing, _dvsVPCIds = Nothing,
                  _dvsDryRun = Nothing, _dvsMaxResults = Nothing}
...
data DescribeVPCsResponse = DescribeVPCsResponse'{_dvrsVPCs
                                                  :: !(Maybe [VPC]),
                                                  _dvrsNextToken ::
                                                  !(Maybe Text),
...
describeVPCsResponse pResponseStatus_
  = DescribeVPCsResponse'{_dvrsVPCs = Nothing,
