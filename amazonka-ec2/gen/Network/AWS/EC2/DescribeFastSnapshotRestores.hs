...
--
-- * 'dfsrFilters' - The filters. The possible values are:     * @availability-zone@ : The Availability Zone of the snapshot.     * @owner-id@ : The ID of the AWS account that owns the snapshot.     * @snapshot-id@ : The ID of the snapshot.     * @state@ : The state of fast snapshot restores for the snapshot (@enabling@ | @optimizing@ | @enabled@ | @disabling@ | @disabled@ ).
--
