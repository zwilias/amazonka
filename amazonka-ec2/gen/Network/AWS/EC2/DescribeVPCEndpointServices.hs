...
dvesFilters =
  lens _dvesFilters (\s a -> s {_dvesFilters = a}) . _Default . _Coerce

-- | One or more service names.
dvesServiceNames :: Lens' DescribeVPCEndpointServices [Text]
dvesServiceNames =
  lens _dvesServiceNames (\s a -> s {_dvesServiceNames = a}) .
  _Default . _Coerce
...
dvesrsServiceDetails ::
     Lens' DescribeVPCEndpointServicesResponse [ServiceDetail]
dvesrsServiceDetails =
  lens _dvesrsServiceDetails (\s a -> s {_dvesrsServiceDetails = a}) .
  _Default . _Coerce

-- | A list of supported services.
dvesrsServiceNames :: Lens' DescribeVPCEndpointServicesResponse [Text]
dvesrsServiceNames =
  lens _dvesrsServiceNames (\s a -> s {_dvesrsServiceNames = a}) .
  _Default . _Coerce
...
dvesrsResponseStatus =
  lens _dvesrsResponseStatus (\s a -> s {_dvesrsResponseStatus = a})
