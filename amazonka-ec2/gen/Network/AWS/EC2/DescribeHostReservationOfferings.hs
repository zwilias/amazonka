...
instance AWSRequest DescribeHostReservationOfferings where
  type Rs DescribeHostReservationOfferings = DescribeHostReservationOfferingsResponse
...
dhrorsOfferingSet ::
     Lens' DescribeHostReservationOfferingsResponse [HostOffering]
dhrorsOfferingSet =
  lens _dhrorsOfferingSet (\s a -> s {_dhrorsOfferingSet = a}) .
  _Default . _Coerce
...
dhrorsResponseStatus =
  lens _dhrorsResponseStatus (\s a -> s {_dhrorsResponseStatus = a})
