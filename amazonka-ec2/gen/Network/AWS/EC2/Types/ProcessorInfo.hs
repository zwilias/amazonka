...
data ProcessorInfo = ProcessorInfo'{_piSupportedArchitectures
...
--
-- * 'piSupportedArchitectures' - A list of architectures supported by the instance type.
--
-- * 'piSustainedClockSpeedInGhz' - The speed of the processor, in GHz.
processorInfo
    :: ProcessorInfo
processorInfo
  = ProcessorInfo'{_piSupportedArchitectures = Nothing,
