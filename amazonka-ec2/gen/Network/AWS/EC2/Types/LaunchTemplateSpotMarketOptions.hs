...
data LaunchTemplateSpotMarketOptions = LaunchTemplateSpotMarketOptions'{_ltsmoBlockDurationMinutes
                                                                        ::
                                                                        !(Maybe
                                                                            Int),
...
launchTemplateSpotMarketOptions
    :: LaunchTemplateSpotMarketOptions
launchTemplateSpotMarketOptions
  = LaunchTemplateSpotMarketOptions'{_ltsmoBlockDurationMinutes
                                       = Nothing,
                                     _ltsmoInstanceInterruptionBehavior =
                                       Nothing,
