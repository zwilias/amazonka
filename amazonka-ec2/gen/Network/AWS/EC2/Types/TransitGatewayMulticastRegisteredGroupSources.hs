...
data TransitGatewayMulticastRegisteredGroupSources = TransitGatewayMulticastRegisteredGroupSources'{_tgmrgsTransitGatewayMulticastDomainId
                                                                                                    ::
                                                                                                    !(Maybe
                                                                                                        Text),
...
transitGatewayMulticastRegisteredGroupSources
    :: TransitGatewayMulticastRegisteredGroupSources
transitGatewayMulticastRegisteredGroupSources
  = TransitGatewayMulticastRegisteredGroupSources'{_tgmrgsTransitGatewayMulticastDomainId
                                                     = Nothing,
                                                   _tgmrgsRegisteredNetworkInterfaceIds
                                                     = Nothing,
                                                   _tgmrgsGroupIPAddress =
