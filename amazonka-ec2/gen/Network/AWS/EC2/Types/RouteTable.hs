...
data RouteTable = RouteTable'{_rtRouteTableId ::
                              !(Maybe Text),
...
routeTable
    :: RouteTable
routeTable
  = RouteTable'{_rtRouteTableId = Nothing,
                _rtRoutes = Nothing, _rtVPCId = Nothing,
                _rtPropagatingVGWs = Nothing, _rtOwnerId = Nothing,
                _rtAssociations = Nothing, _rtTags = Nothing}
