...
data TransitGatewayMulticastDeregisteredGroupSources = TransitGatewayMulticastDeregisteredGroupSources'{_tgmdgsDeregisteredNetworkInterfaceIds
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            [Text]),
...
transitGatewayMulticastDeregisteredGroupSources
    :: TransitGatewayMulticastDeregisteredGroupSources
transitGatewayMulticastDeregisteredGroupSources
  = TransitGatewayMulticastDeregisteredGroupSources'{_tgmdgsDeregisteredNetworkInterfaceIds
                                                       = Nothing,
                                                     _tgmdgsTransitGatewayMulticastDomainId
                                                       = Nothing,
                                                     _tgmdgsGroupIPAddress =
