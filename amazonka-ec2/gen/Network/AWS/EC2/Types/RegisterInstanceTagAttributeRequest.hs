...
data RegisterInstanceTagAttributeRequest = RegisterInstanceTagAttributeRequest'{_ritarIncludeAllTagsOfInstance
                                                                                ::
                                                                                !(Maybe
                                                                                    Bool),
...
registerInstanceTagAttributeRequest
    :: RegisterInstanceTagAttributeRequest
registerInstanceTagAttributeRequest
  = RegisterInstanceTagAttributeRequest'{_ritarIncludeAllTagsOfInstance
                                           = Nothing,
