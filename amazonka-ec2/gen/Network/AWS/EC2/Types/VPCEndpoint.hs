...
data VPCEndpoint = VPCEndpoint'{_veGroups ::
...
vpcEndpoint
    :: VPCEndpoint
vpcEndpoint
  = VPCEndpoint'{_veGroups = Nothing,
                 _veState = Nothing, _vePolicyDocument = Nothing,
                 _veSubnetIds = Nothing,
                 _veNetworkInterfaceIds = Nothing, _veVPCId = Nothing,
                 _veRequesterManaged = Nothing,
                 _veDNSEntries = Nothing,
                 _veVPCEndpointType = Nothing,
                 _vePrivateDNSEnabled = Nothing, _veOwnerId = Nothing,
                 _veCreationTimestamp = Nothing,
                 _veServiceName = Nothing, _veLastError = Nothing,
                 _veVPCEndpointId = Nothing, _veTags = Nothing,
