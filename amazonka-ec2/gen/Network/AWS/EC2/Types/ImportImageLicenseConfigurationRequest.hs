...
newtype ImportImageLicenseConfigurationRequest = ImportImageLicenseConfigurationRequest'{_iilcrLicenseConfigurationARN
                                                                                         ::
                                                                                         Maybe
                                                                                           Text}
...
importImageLicenseConfigurationRequest
    :: ImportImageLicenseConfigurationRequest
importImageLicenseConfigurationRequest
  = ImportImageLicenseConfigurationRequest'{_iilcrLicenseConfigurationARN
                                              = Nothing}
