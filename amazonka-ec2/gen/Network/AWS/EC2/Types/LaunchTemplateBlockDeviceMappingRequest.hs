...
data LaunchTemplateBlockDeviceMappingRequest = LaunchTemplateBlockDeviceMappingRequest'{_ltbdmrVirtualName
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
                                                                                        _ltbdmrNoDevice
...
launchTemplateBlockDeviceMappingRequest
    :: LaunchTemplateBlockDeviceMappingRequest
launchTemplateBlockDeviceMappingRequest
  = LaunchTemplateBlockDeviceMappingRequest'{_ltbdmrVirtualName
                                               = Nothing,
