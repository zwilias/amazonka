...
data Instance = Instance'{_insPublicDNSName ::
                          ...
                          _insHibernationOptions ::
                          !(Maybe HibernationOptions),
                          _insInstanceLifecycle ::
                          !(Maybe InstanceLifecycleType),
                          _insIAMInstanceProfile ::
                          ...
                          _insBlockDeviceMappings ::
                          !(Maybe [InstanceBlockDeviceMapping]),
                          _insPublicIPAddress :: !(Maybe Text),
                          _insTags :: !(Maybe [Tag]), _insInstanceId :: !Text,
                          _insImageId :: !Text, _insAMILaunchIndex :: !Int,
...
instance'
    ...
    -> Instance
instance' pInstanceId_ pImageId_ pAMILaunchIndex_
  pInstanceType_ pLaunchTime_ pPlacement_ pMonitoring_
  pArchitecture_ pRootDeviceType_ pVirtualizationType_
  pHypervisor_ pState_
  = Instance'{_insPublicDNSName = Nothing,
              _insPlatform = Nothing, _insSecurityGroups = Nothing,
              _insClientToken = Nothing, _insEnaSupport = Nothing,
              _insSourceDestCheck = Nothing,
              _insElasticGpuAssociations = Nothing,
              _insVPCId = Nothing, _insKeyName = Nothing,
              _insNetworkInterfaces = Nothing,
              _insOutpostARN = Nothing, _insRAMDiskId = Nothing,
              _insCPUOptions = Nothing, _insSubnetId = Nothing,
              _insKernelId = Nothing, _insRootDeviceName = Nothing,
              ...
              _insPublicIPAddress = Nothing, _insTags = Nothing,
              ...
              _insHypervisor = pHypervisor_, _insState = pState_}
