...
data ExportImageTask = ExportImageTask'{_eitStatus ::
                                        !(Maybe Text),
...
--
-- * 'eitS3ExportLocation' - Information about the destination S3 bucket.
exportImageTask
    :: ExportImageTask
exportImageTask
  = ExportImageTask'{_eitStatus = Nothing,
                     _eitProgress = Nothing,
                     _eitExportImageTaskId = Nothing,
                     _eitStatusMessage = Nothing, _eitImageId = Nothing,
