...
data ExportTask = ExportTask'{_etTags ::
                              !(Maybe [Tag]),
                              _etDescription :: !Text, _etExportTaskId :: !Text,
...
exportTask
    ...
    -> ExportTask
exportTask pDescription_ pExportTaskId_
  pExportToS3Task_ pInstanceExportDetails_ pState_
  pStatusMessage_
  = ExportTask'{_etTags = Nothing,
