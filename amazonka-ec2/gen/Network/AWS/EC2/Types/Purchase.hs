...
data Purchase = Purchase'{_pInstanceFamily ::
                          !(Maybe Text),
...
purchase
    :: Purchase
purchase
  = Purchase'{_pInstanceFamily = Nothing,
              _pCurrencyCode = Nothing,
              _pHostReservationId = Nothing,
              _pHourlyPrice = Nothing, _pUpfrontPrice = Nothing,
              _pHostIdSet = Nothing, _pDuration = Nothing,
