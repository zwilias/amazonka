...
data TransitGatewayRouteTableAssociation = TransitGatewayRouteTableAssociation'{_tgrtaState
                                                                                ::
                                                                                !(Maybe
...
--
-- * 'tgrtaResourceType' - The resource type.
--
-- * 'tgrtaTransitGatewayAttachmentId' - The ID of the attachment.
transitGatewayRouteTableAssociation
    :: TransitGatewayRouteTableAssociation
transitGatewayRouteTableAssociation
  = TransitGatewayRouteTableAssociation'{_tgrtaState =
                                           Nothing,
