...
newtype DirectoryServiceAuthenticationRequest = DirectoryServiceAuthenticationRequest'{_dsarDirectoryId
                                                                                       ::
                                                                                       Maybe
                                                                                         Text}
...
directoryServiceAuthenticationRequest
    :: DirectoryServiceAuthenticationRequest
directoryServiceAuthenticationRequest
  = DirectoryServiceAuthenticationRequest'{_dsarDirectoryId
                                             = Nothing}
