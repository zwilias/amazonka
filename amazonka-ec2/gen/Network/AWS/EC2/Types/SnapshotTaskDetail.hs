...
data SnapshotTaskDetail = SnapshotTaskDetail'{_stdStatus
                                              :: !(Maybe Text),
...
snapshotTaskDetail
    :: SnapshotTaskDetail
snapshotTaskDetail
  = SnapshotTaskDetail'{_stdStatus = Nothing,
                        _stdProgress = Nothing, _stdFormat = Nothing,
                        _stdURL = Nothing, _stdEncrypted = Nothing,
                        _stdKMSKeyId = Nothing, _stdStatusMessage = Nothing,
                        _stdUserBucket = Nothing,
                        _stdDiskImageSize = Nothing,
                        _stdDescription = Nothing, _stdSnapshotId = Nothing}
