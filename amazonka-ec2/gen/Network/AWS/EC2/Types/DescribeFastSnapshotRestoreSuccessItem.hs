...
data DescribeFastSnapshotRestoreSuccessItem = DescribeFastSnapshotRestoreSuccessItem'{_dfsrsiDisablingTime
                                                                                      ::
                                                                                      !(Maybe
                                                                                          ISO8601),
                                                                                      _dfsrsiState
...
--
-- * 'dfsrsiOwnerAlias' - The alias of the snapshot owner.
--
...
--
-- * 'dfsrsiOwnerId' - The ID of the AWS account that owns the snapshot.
--
...
describeFastSnapshotRestoreSuccessItem
    :: DescribeFastSnapshotRestoreSuccessItem
describeFastSnapshotRestoreSuccessItem
  = DescribeFastSnapshotRestoreSuccessItem'{_dfsrsiDisablingTime
                                              = Nothing,
