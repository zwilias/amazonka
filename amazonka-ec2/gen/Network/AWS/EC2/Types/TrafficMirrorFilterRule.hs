...
data TrafficMirrorFilterRule = TrafficMirrorFilterRule'{_tmfrRuleNumber
                                                        :: !(Maybe Int),
...
trafficMirrorFilterRule
    :: TrafficMirrorFilterRule
trafficMirrorFilterRule
  = TrafficMirrorFilterRule'{_tmfrRuleNumber = Nothing,
                             _tmfrTrafficDirection = Nothing,
                             _tmfrRuleAction = Nothing, _tmfrProtocol = Nothing,
