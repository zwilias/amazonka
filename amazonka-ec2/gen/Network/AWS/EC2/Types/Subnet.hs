...
data Subnet = Subnet'{_subIPv6CidrBlockAssociationSet
                      ...
                      _subCidrBlock :: !Text, _subState :: !SubnetState,
                      _subSubnetId :: !Text, _subVPCId :: !Text}
...
subnet
    ...
    -> Text -- ^ 'subVPCId'
    -> Subnet
subnet pAvailabilityZone_ pAvailableIPAddressCount_
  pCidrBlock_ pState_ pSubnetId_ pVPCId_
  = Subnet'{_subIPv6CidrBlockAssociationSet = Nothing,
            _subAvailabilityZoneId = Nothing,
            _subOutpostARN = Nothing,
            _subAssignIPv6AddressOnCreation = Nothing,
            _subSubnetARN = Nothing, _subOwnerId = Nothing,
            _subMapPublicIPOnLaunch = Nothing,
            _subDefaultForAz = Nothing, _subTags = Nothing,
            _subAvailabilityZone = pAvailabilityZone_,
            _subAvailableIPAddressCount =
              pAvailableIPAddressCount_,
            _subCidrBlock = pCidrBlock_, _subState = pState_,
            _subSubnetId = pSubnetId_, _subVPCId = pVPCId_}
