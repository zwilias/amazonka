...
data TransitGatewayRouteTablePropagation = TransitGatewayRouteTablePropagation'{_tgrtpState
                                                                                ::
                                                                                !(Maybe
...
--
-- * 'tgrtpResourceType' - The type of resource.
--
-- * 'tgrtpTransitGatewayAttachmentId' - The ID of the attachment.
transitGatewayRouteTablePropagation
    :: TransitGatewayRouteTablePropagation
transitGatewayRouteTablePropagation
  = TransitGatewayRouteTablePropagation'{_tgrtpState =
                                           Nothing,
