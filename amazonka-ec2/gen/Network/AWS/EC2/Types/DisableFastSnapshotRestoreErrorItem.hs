...
data DisableFastSnapshotRestoreErrorItem = DisableFastSnapshotRestoreErrorItem'{_dfsreiFastSnapshotRestoreStateErrors
                                                                                ::
                                                                                !(Maybe
...
disableFastSnapshotRestoreErrorItem
    :: DisableFastSnapshotRestoreErrorItem
disableFastSnapshotRestoreErrorItem
  = DisableFastSnapshotRestoreErrorItem'{_dfsreiFastSnapshotRestoreStateErrors
                                           = Nothing,
