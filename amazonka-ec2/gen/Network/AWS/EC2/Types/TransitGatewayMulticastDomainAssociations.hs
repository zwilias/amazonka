...
data TransitGatewayMulticastDomainAssociations = TransitGatewayMulticastDomainAssociations'{_tResourceId
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
                                                                                            _tResourceType
...
transitGatewayMulticastDomainAssociations
    :: TransitGatewayMulticastDomainAssociations
transitGatewayMulticastDomainAssociations
  = TransitGatewayMulticastDomainAssociations'{_tResourceId
                                                 = Nothing,
