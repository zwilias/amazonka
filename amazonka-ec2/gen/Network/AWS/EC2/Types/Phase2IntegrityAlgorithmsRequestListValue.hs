...
newtype Phase2IntegrityAlgorithmsRequestListValue = Phase2IntegrityAlgorithmsRequestListValue'{_piarlvValue
                                                                                               ::
                                                                                               Maybe
                                                                                                 Text}
...
phase2IntegrityAlgorithmsRequestListValue
    :: Phase2IntegrityAlgorithmsRequestListValue
phase2IntegrityAlgorithmsRequestListValue
  = Phase2IntegrityAlgorithmsRequestListValue'{_piarlvValue
                                                 = Nothing}
