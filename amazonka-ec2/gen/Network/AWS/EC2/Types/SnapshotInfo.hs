...
data SnapshotInfo = SnapshotInfo'{_siState ::
                                  !(Maybe SnapshotState),
...
snapshotInfo
    :: SnapshotInfo
snapshotInfo
  = SnapshotInfo'{_siState = Nothing,
                  _siProgress = Nothing, _siStartTime = Nothing,
                  _siVolumeSize = Nothing, _siEncrypted = Nothing,
                  _siOwnerId = Nothing, _siVolumeId = Nothing,
                  _siDescription = Nothing, _siTags = Nothing,
