...
data ElasticInferenceAcceleratorAssociation = ElasticInferenceAcceleratorAssociation'{_eiaaElasticInferenceAcceleratorAssociationState
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
elasticInferenceAcceleratorAssociation
    :: ElasticInferenceAcceleratorAssociation
elasticInferenceAcceleratorAssociation
  = ElasticInferenceAcceleratorAssociation'{_eiaaElasticInferenceAcceleratorAssociationState
                                              = Nothing,
                                            _eiaaElasticInferenceAcceleratorAssociationTime
                                              = Nothing,
                                            _eiaaElasticInferenceAcceleratorARN
