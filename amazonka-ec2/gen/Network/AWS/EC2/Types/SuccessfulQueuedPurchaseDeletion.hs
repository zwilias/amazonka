...
newtype SuccessfulQueuedPurchaseDeletion = SuccessfulQueuedPurchaseDeletion'{_sqpdReservedInstancesId
                                                                             ::
                                                                             Maybe
                                                                               Text}
...
successfulQueuedPurchaseDeletion
    :: SuccessfulQueuedPurchaseDeletion
successfulQueuedPurchaseDeletion
  = SuccessfulQueuedPurchaseDeletion'{_sqpdReservedInstancesId
                                        = Nothing}
