...
data LaunchTemplateCapacityReservationSpecificationResponse = LaunchTemplateCapacityReservationSpecificationResponse'{_ltcrsCapacityReservationTarget
                                                                                                                      ::
                                                                                                                      !(Maybe
...
--
-- * 'ltcrsCapacityReservationTarget' - Information about the target Capacity Reservation.
--
...
launchTemplateCapacityReservationSpecificationResponse
    :: LaunchTemplateCapacityReservationSpecificationResponse
launchTemplateCapacityReservationSpecificationResponse
  = LaunchTemplateCapacityReservationSpecificationResponse'{_ltcrsCapacityReservationTarget
                                                              = Nothing,
                                                            _ltcrsCapacityReservationPreference
                                                              = Nothing}
