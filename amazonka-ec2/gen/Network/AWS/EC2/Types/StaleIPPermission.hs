...
data StaleIPPermission = StaleIPPermission'{_sipFromPort
                                            :: !(Maybe Int),
...
--
-- * 'sipPrefixListIds' - The prefix list IDs for an AWS service. Not applicable for stale security group rules.
--
...
staleIPPermission
    :: StaleIPPermission
staleIPPermission
  = StaleIPPermission'{_sipFromPort = Nothing,
                       _sipUserIdGroupPairs = Nothing,
                       _sipPrefixListIds = Nothing,
                       _sipIPProtocol = Nothing, _sipToPort = Nothing,
