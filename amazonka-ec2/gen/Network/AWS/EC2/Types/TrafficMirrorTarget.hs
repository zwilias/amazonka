...
data TrafficMirrorTarget = TrafficMirrorTarget'{_tmtTrafficMirrorTargetId
                                                :: !(Maybe Text),
...
trafficMirrorTarget
    :: TrafficMirrorTarget
trafficMirrorTarget
  = TrafficMirrorTarget'{_tmtTrafficMirrorTargetId =
                           Nothing,
                         _tmtNetworkInterfaceId = Nothing,
                         _tmtNetworkLoadBalancerARN = Nothing,
                         _tmtOwnerId = Nothing, _tmtType = Nothing,
                         _tmtDescription = Nothing, _tmtTags = Nothing}
