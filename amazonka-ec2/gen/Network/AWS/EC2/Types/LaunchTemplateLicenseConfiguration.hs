...
newtype LaunchTemplateLicenseConfiguration = LaunchTemplateLicenseConfiguration'{_ltlcLicenseConfigurationARN
                                                                                 ::
                                                                                 Maybe
                                                                                   Text}
...
launchTemplateLicenseConfiguration
    :: LaunchTemplateLicenseConfiguration
launchTemplateLicenseConfiguration
  = LaunchTemplateLicenseConfiguration'{_ltlcLicenseConfigurationARN
                                          = Nothing}
