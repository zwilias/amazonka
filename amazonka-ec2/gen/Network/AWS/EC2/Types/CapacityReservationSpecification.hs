...
data CapacityReservationSpecification = CapacityReservationSpecification'{_cCapacityReservationTarget
                                                                          ::
                                                                          !(Maybe
...
--
-- * 'cCapacityReservationTarget' - Information about the target Capacity Reservation.
--
...
capacityReservationSpecification
    :: CapacityReservationSpecification
capacityReservationSpecification
  = CapacityReservationSpecification'{_cCapacityReservationTarget
                                        = Nothing,
