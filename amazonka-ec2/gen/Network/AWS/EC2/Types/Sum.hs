...
instance FromText AccountAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AccountAttributeName from value: '" <>
        e <> "'. Accepted values: default-vpc, supported-platforms"
...
instance FromText ActivityStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ActivityStatus from value: '" <>
        e <>
...
instance FromText AddressStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AddressStatus from value: '" <>
        e <> "'. Accepted values: inclassic, invpc, moveinprogress"
...
instance FromText Affinity where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Affinity from value: '" <>
        e <> "'. Accepted values: default, host"
...
instance FromText AllocationState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AllocationState from value: '" <>
        e <>
...
instance FromText AllocationStrategy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AllocationStrategy from value: '" <>
        e <> "'. Accepted values: diversified, lowestprice"
...
instance FromText ArchitectureValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ArchitectureValues from value: '" <>
        e <> "'. Accepted values: i386, x86_64"
...
instance FromText AttachmentStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AttachmentStatus from value: '" <>
        e <>
...
instance FromText AutoPlacement where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutoPlacement from value: '" <>
        e <> "'. Accepted values: on, off"
...
instance FromText AvailabilityZoneState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AvailabilityZoneState from value: '" <>
        e <> "'. Accepted values: available, impaired, information, unavailable"
...
instance FromText BatchState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BatchState from value: '" <>
        e <>
...
instance FromText BundleTaskState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BundleTaskState from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      "fleetrequestnotincancellablestate" ->
        pure CBECFleetRequestNotInCancellableState
      "unexpectederror" -> pure CBECUnexpectedError
      e ->
        fromTextError $
        "Failure parsing CancelBatchErrorCode from value: '" <>
        e <>
...
instance FromText CancelSpotInstanceRequestState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CancelSpotInstanceRequestState from value: '" <>
        e <> "'. Accepted values: active, cancelled, closed, completed, open"
...
instance FromText ConnectionNotificationState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ConnectionNotificationState from value: '" <>
...
instance FromText ConnectionNotificationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ConnectionNotificationType from value: '" <>
        e <> "'. Accepted values: topic"
...
instance FromText ContainerFormat where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ContainerFormat from value: '" <>
        e <> "'. Accepted values: ova"
...
instance FromText ConversionTaskState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ConversionTaskState from value: '" <>
        e <> "'. Accepted values: active, cancelled, cancelling, completed"
...
instance FromText CurrencyCodeValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CurrencyCodeValues from value: '" <>
        e <> "'. Accepted values: usd"
...
instance FromText DatafeedSubscriptionState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DatafeedSubscriptionState from value: '" <>
        e <> "'. Accepted values: active, inactive"
...
instance FromText DefaultTargetCapacityType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DefaultTargetCapacityType from value: '" <>
        e <> "'. Accepted values: on-demand, spot"
...
instance FromText DeleteFleetErrorCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeleteFleetErrorCode from value: '" <>
        e <>
...
instance FromText DeviceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeviceType from value: '" <>
        e <> "'. Accepted values: ebs, instance-store"
...
instance FromText DiskImageFormat where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DiskImageFormat from value: '" <>
        e <> "'. Accepted values: raw, vhd, vmdk"
...
instance FromText DomainType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DomainType from value: '" <>
        e <> "'. Accepted values: standard, vpc"
...
instance FromText ElasticGpuState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ElasticGpuState from value: '" <>
        e <> "'. Accepted values: attached"
...
instance FromText ElasticGpuStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ElasticGpuStatus from value: '" <>
        e <> "'. Accepted values: impaired, ok"
...
instance FromText EventCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EventCode from value: '" <>
        e <>
...
instance FromText EventType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EventType from value: '" <>
        e <> "'. Accepted values: error, fleetrequestchange, instancechange"
...
instance FromText ExcessCapacityTerminationPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExcessCapacityTerminationPolicy from value: '" <>
        e <> "'. Accepted values: default, notermination"
...
instance FromText ExportEnvironment where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExportEnvironment from value: '" <>
        e <> "'. Accepted values: citrix, microsoft, vmware"
...
instance FromText ExportTaskState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExportTaskState from value: '" <>
        e <> "'. Accepted values: active, cancelled, cancelling, completed"
...
instance FromText FleetActivityStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetActivityStatus from value: '" <>
        e <>
...
instance FromText FleetEventType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetEventType from value: '" <>
        e <> "'. Accepted values: fleet-change, instance-change, service-error"
...
instance FromText FleetExcessCapacityTerminationPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetExcessCapacityTerminationPolicy from value: '" <>
        e <> "'. Accepted values: no-termination, termination"
...
instance FromText FleetStateCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetStateCode from value: '" <>
        e <>
...
instance FromText FleetType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetType from value: '" <>
        e <> "'. Accepted values: maintain, request"
...
instance FromText FlowLogsResourceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FlowLogsResourceType from value: '" <>
        e <> "'. Accepted values: networkinterface, subnet, vpc"
...
instance FromText FpgaImageAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FpgaImageAttributeName from value: '" <>
        e <>
...
instance FromText FpgaImageStateCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FpgaImageStateCode from value: '" <>
        e <> "'. Accepted values: available, failed, pending, unavailable"
...
instance FromText GatewayType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GatewayType from value: '" <>
        e <> "'. Accepted values: ipsec.1"
...
instance FromText HostTenancy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HostTenancy from value: '" <>
        e <> "'. Accepted values: dedicated, host"
...
instance FromText HypervisorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HypervisorType from value: '" <>
        e <> "'. Accepted values: ovm, xen"
...
instance FromText IAMInstanceProfileAssociationState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing IAMInstanceProfileAssociationState from value: '" <>
        e <>
...
instance FromText ImageAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ImageAttributeName from value: '" <>
        e <>
...
instance FromText ImageState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ImageState from value: '" <>
        e <>
...
instance FromText ImageTypeValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ImageTypeValues from value: '" <>
        e <> "'. Accepted values: kernel, machine, ramdisk"
...
instance FromText InstanceAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceAttributeName from value: '" <>
        e <>
...
instance FromText InstanceHealthStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceHealthStatus from value: '" <>
        e <> "'. Accepted values: healthy, unhealthy"
...
instance FromText InstanceInterruptionBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceInterruptionBehavior from value: '" <>
        e <> "'. Accepted values: hibernate, stop, terminate"
...
instance FromText InstanceLifecycleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceLifecycleType from value: '" <>
        e <> "'. Accepted values: scheduled, spot"
...
instance FromText InstanceStateName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceStateName from value: '" <>
        e <>
...
instance FromText InstanceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceType from value: '" <>
        e <>
...
instance FromText InterfacePermissionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InterfacePermissionType from value: '" <>
        e <> "'. Accepted values: eip-associate, instance-attach"
...
instance FromText LaunchTemplateErrorCode where
  parser =
    takeLowerText >>= \case
      ...
      "launchtemplateversiondoesnotexist" ->
        pure LaunchTemplateVersionDoesNotExist
      "unexpectederror" -> pure UnexpectedError
      e ->
        fromTextError $
        "Failure parsing LaunchTemplateErrorCode from value: '" <>
        e <>
...
instance FromText ListingState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ListingState from value: '" <>
        e <> "'. Accepted values: available, cancelled, pending, sold"
...
instance FromText ListingStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ListingStatus from value: '" <>
        e <> "'. Accepted values: active, cancelled, closed, pending"
...
instance FromText MarketType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MarketType from value: '" <>
        e <> "'. Accepted values: spot"
...
instance FromText MonitoringState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MonitoringState from value: '" <>
        e <> "'. Accepted values: disabled, disabling, enabled, pending"
...
instance FromText MoveStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MoveStatus from value: '" <>
        e <> "'. Accepted values: movingtovpc, restoringtoclassic"
...
instance FromText NatGatewayState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NatGatewayState from value: '" <>
        e <> "'. Accepted values: available, deleted, deleting, failed, pending"
...
instance FromText NetworkInterfaceAttribute where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkInterfaceAttribute from value: '" <>
        e <>
...
instance FromText NetworkInterfacePermissionStateCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkInterfacePermissionStateCode from value: '" <>
        e <> "'. Accepted values: granted, pending, revoked, revoking"
...
instance FromText NetworkInterfaceStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkInterfaceStatus from value: '" <>
        e <>
...
instance FromText NetworkInterfaceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkInterfaceType from value: '" <>
        e <> "'. Accepted values: interface, natgateway"
...
instance FromText OfferingClassType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OfferingClassType from value: '" <>
        e <> "'. Accepted values: convertible, standard"
...
instance FromText OfferingTypeValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OfferingTypeValues from value: '" <>
        e <>
...
instance FromText OperationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OperationType from value: '" <>
        e <> "'. Accepted values: add, remove"
...
instance FromText PaymentOption where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PaymentOption from value: '" <>
        e <> "'. Accepted values: allupfront, noupfront, partialupfront"
...
instance FromText PermissionGroup where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PermissionGroup from value: '" <>
        e <> "'. Accepted values: all"
...
instance FromText PlacementGroupState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PlacementGroupState from value: '" <>
...
instance FromText PlacementStrategy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PlacementStrategy from value: '" <>
        e <> "'. Accepted values: cluster, spread"
...
instance FromText PlatformValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PlatformValues from value: '" <>
        e <> "'. Accepted values: windows"
...
instance FromText ProductCodeValues where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProductCodeValues from value: '" <>
        e <> "'. Accepted values: devpay, marketplace"
...
instance FromText RIProductDescription where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RIProductDescription from value: '" <>
        e <>
...
instance FromText RecurringChargeFrequency where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RecurringChargeFrequency from value: '" <>
        e <> "'. Accepted values: hourly"
...
instance FromText ReportInstanceReasonCodes where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ReportInstanceReasonCodes from value: '" <>
        e <>
...
instance FromText ReportStatusType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ReportStatusType from value: '" <>
        e <> "'. Accepted values: impaired, ok"
...
instance FromText ReservationState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ReservationState from value: '" <>
        e <>
...
instance FromText ReservedInstanceState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ReservedInstanceState from value: '" <>
        e <>
        "'. Accepted values: active, payment-failed, payment-pending, retired"
...
instance FromText ResetFpgaImageAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResetFpgaImageAttributeName from value: '" <>
        e <> "'. Accepted values: loadpermission"
...
instance FromText ResetImageAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResetImageAttributeName from value: '" <>
        e <> "'. Accepted values: launchpermission"
...
instance FromText RouteOrigin where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RouteOrigin from value: '" <>
        e <>
...
instance FromText RouteState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RouteState from value: '" <>
        e <> "'. Accepted values: active, blackhole"
...
instance FromText RuleAction where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RuleAction from value: '" <>
        e <> "'. Accepted values: allow, deny"
...
instance FromText Scope where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Scope from value: '" <>
        e <> "'. Accepted values: availability zone, region"
...
instance FromText ServiceState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ServiceState from value: '" <>
        e <> "'. Accepted values: available, deleted, deleting, failed, pending"
...
instance FromText ServiceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ServiceType from value: '" <>
        e <> "'. Accepted values: gateway, interface"
...
instance FromText ShutdownBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ShutdownBehavior from value: '" <>
        e <> "'. Accepted values: stop, terminate"
...
instance FromText SnapshotAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SnapshotAttributeName from value: '" <>
        e <> "'. Accepted values: createvolumepermission, productcodes"
...
instance FromText SnapshotState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SnapshotState from value: '" <>
        e <> "'. Accepted values: completed, error, pending"
...
instance FromText SpotAllocationStrategy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SpotAllocationStrategy from value: '" <>
        e <> "'. Accepted values: diversified, lowest-price"
...
instance FromText SpotInstanceInterruptionBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SpotInstanceInterruptionBehavior from value: '" <>
        e <> "'. Accepted values: hibernate, stop, terminate"
...
instance FromText SpotInstanceState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SpotInstanceState from value: '" <>
        e <> "'. Accepted values: active, cancelled, closed, failed, open"
...
instance FromText SpotInstanceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SpotInstanceType from value: '" <>
        e <> "'. Accepted values: one-time, persistent"
...
instance FromText State where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing State from value: '" <>
        e <>
...
instance FromText StatusName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StatusName from value: '" <>
        e <> "'. Accepted values: reachability"
...
instance FromText SubnetCidrBlockStateCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SubnetCidrBlockStateCode from value: '" <>
        e <>
...
instance FromText SubnetState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SubnetState from value: '" <>
        e <> "'. Accepted values: available, pending"
...
instance FromText SummaryStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SummaryStatus from value: '" <>
        e <>
...
instance FromText TelemetryStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TelemetryStatus from value: '" <>
...
instance FromText Tenancy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Tenancy from value: '" <>
        e <> "'. Accepted values: dedicated, default, host"
...
instance FromText TrafficType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TrafficType from value: '" <>
        e <> "'. Accepted values: accept, all, reject"
  ...
  parser =
    takeLowerText >>= \case
      ...
      "instancecreditspecification.notsupported" ->
        pure InstanceCreditSpecification_NotSupported
      "invalidinstanceid.malformed" -> pure InvalidInstanceId_Malformed
      "invalidinstanceid.notfound" -> pure InvalidInstanceId_NotFound
      e ->
        fromTextError $
        "Failure parsing UnsuccessfulInstanceCreditSpecificationErrorCode from value: '" <>
        e <>
...
instance FromText VPCAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCAttributeName from value: '" <>
        e <> "'. Accepted values: enablednshostnames, enablednssupport"
...
instance FromText VPCCidrBlockStateCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCCidrBlockStateCode from value: '" <>
        e <>
        "'. Accepted values: associated, associating, disassociated, disassociating, failed, failing"
...
instance FromText VPCEndpointType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCEndpointType from value: '" <>
        e <> "'. Accepted values: gateway, interface"
...
instance FromText VPCPeeringConnectionStateReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCPeeringConnectionStateReasonCode from value: '" <>
        e <>
...
instance FromText VPCState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCState from value: '" <>
        e <> "'. Accepted values: available, pending"
...
instance FromText VPCTenancy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPCTenancy from value: '" <>
        e <> "'. Accepted values: default"
...
instance FromText VPNState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPNState from value: '" <>
        e <> "'. Accepted values: available, deleted, deleting, pending"
...
instance FromText VPNStaticRouteSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VPNStaticRouteSource from value: '" <>
        e <> "'. Accepted values: static"
...
instance FromText VirtualizationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VirtualizationType from value: '" <>
        e <> "'. Accepted values: hvm, paravirtual"
...
instance FromText VolumeAttachmentState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeAttachmentState from value: '" <>
        e <>
...
instance FromText VolumeAttributeName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeAttributeName from value: '" <>
        e <> "'. Accepted values: autoenableio, productcodes"
...
instance FromText VolumeModificationState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeModificationState from value: '" <>
        e <> "'. Accepted values: completed, failed, modifying, optimizing"
...
instance FromText VolumeState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeState from value: '" <>
        e <>
...
instance FromText VolumeStatusInfoStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeStatusInfoStatus from value: '" <>
        e <> "'. Accepted values: impaired, insufficient-data, ok"
...
instance FromText VolumeStatusName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VolumeStatusName from value: '" <>
        e <> "'. Accepted values: io-enabled, io-performance"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: gp2, io1, sc1, st1, standard"
