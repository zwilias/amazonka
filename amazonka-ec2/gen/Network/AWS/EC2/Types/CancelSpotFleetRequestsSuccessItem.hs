...
data CancelSpotFleetRequestsSuccessItem = CancelSpotFleetRequestsSuccessItem'{_csfrsiCurrentSpotFleetRequestState
                                                                              ::
                                                                              !(Maybe
                                                                                  BatchState),
...
cancelSpotFleetRequestsSuccessItem
    :: CancelSpotFleetRequestsSuccessItem
cancelSpotFleetRequestsSuccessItem
  = CancelSpotFleetRequestsSuccessItem'{_csfrsiCurrentSpotFleetRequestState
                                          = Nothing,
