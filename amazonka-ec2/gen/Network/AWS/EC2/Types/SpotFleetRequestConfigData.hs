...
data SpotFleetRequestConfigData = SpotFleetRequestConfigData'{_sfrcdClientToken
                                                              :: !(Maybe Text),
...
spotFleetRequestConfigData
    ...
    -> SpotFleetRequestConfigData
spotFleetRequestConfigData pIAMFleetRole_
  pTargetCapacity_
  = SpotFleetRequestConfigData'{_sfrcdClientToken =
                                  Nothing,
                                ...
                                _sfrcdType = Nothing, _sfrcdValidFrom = Nothing,
