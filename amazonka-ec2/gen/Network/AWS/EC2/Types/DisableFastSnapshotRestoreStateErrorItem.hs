...
data DisableFastSnapshotRestoreStateErrorItem = DisableFastSnapshotRestoreStateErrorItem'{_dfsrseiError
                                                                                          ::
                                                                                          !(Maybe
...
disableFastSnapshotRestoreStateErrorItem
    :: DisableFastSnapshotRestoreStateErrorItem
disableFastSnapshotRestoreStateErrorItem
  = DisableFastSnapshotRestoreStateErrorItem'{_dfsrseiError
                                                = Nothing,
                                              _dfsrseiAvailabilityZone =
                                                Nothing}
