...
data VPCIPv6CidrBlockAssociation = VPCIPv6CidrBlockAssociation'{_vicbaAssociationId
                                                                ::
                                                                !(Maybe Text),
                                                                _vicbaIPv6CidrBlock
                                                                ::
...
--
-- * 'vicbaNetworkBorderGroup' - The name of the location from which we advertise the IPV6 CIDR block.
--
...
vpcIPv6CidrBlockAssociation
    :: VPCIPv6CidrBlockAssociation
vpcIPv6CidrBlockAssociation
  = VPCIPv6CidrBlockAssociation'{_vicbaAssociationId =
                                   Nothing,
