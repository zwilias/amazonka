...
data LocalGatewayVirtualInterface = LocalGatewayVirtualInterface'{_lgviLocalGatewayVirtualInterfaceId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _lgviLocalBGPASN
                                                                  ::
...
localGatewayVirtualInterface
    :: LocalGatewayVirtualInterface
localGatewayVirtualInterface
  = LocalGatewayVirtualInterface'{_lgviLocalGatewayVirtualInterfaceId
                                    = Nothing,
