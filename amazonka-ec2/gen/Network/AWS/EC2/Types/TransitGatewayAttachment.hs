...
data TransitGatewayAttachment = TransitGatewayAttachment'{_tgaCreationTime
                                                          :: !(Maybe ISO8601),
                                                          _tgaState ::
                                                          !(Maybe
...
--
-- * 'tgaState' - The attachment state.
--
-- * 'tgaResourceId' - The ID of the resource.
--
-- * 'tgaResourceType' - The resource type.
--
...
transitGatewayAttachment
    :: TransitGatewayAttachment
transitGatewayAttachment
  = TransitGatewayAttachment'{_tgaCreationTime =
                                Nothing,
                              _tgaState = Nothing, _tgaResourceId = Nothing,
                              ...
                              _tgaResourceOwnerId = Nothing, _tgaTags = Nothing,
