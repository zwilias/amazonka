...
data EnableFastSnapshotRestoreErrorItem = EnableFastSnapshotRestoreErrorItem'{_efsreiFastSnapshotRestoreStateErrors
                                                                              ::
                                                                              !(Maybe
...
enableFastSnapshotRestoreErrorItem
    :: EnableFastSnapshotRestoreErrorItem
enableFastSnapshotRestoreErrorItem
  = EnableFastSnapshotRestoreErrorItem'{_efsreiFastSnapshotRestoreStateErrors
                                          = Nothing,
