...
newtype PlacementGroupInfo = PlacementGroupInfo'{_pgiSupportedStrategies
                                                 ::
...
--
-- * 'pgiSupportedStrategies' - A list of supported placement groups types.
placementGroupInfo
    :: PlacementGroupInfo
placementGroupInfo
  = PlacementGroupInfo'{_pgiSupportedStrategies =
                          Nothing}
