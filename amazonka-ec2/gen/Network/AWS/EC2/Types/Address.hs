...
data Address = Address'{_aAssociationId ::
                        !(Maybe Text),
...
--
-- * 'aNetworkBorderGroup' - The name of the location from which the IP address is advertised.
--
