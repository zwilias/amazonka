...
data NetworkACL = NetworkACL'{_naEntries ::
...
networkACL
    :: NetworkACL
networkACL
  = NetworkACL'{_naEntries = Nothing,
                _naNetworkACLId = Nothing, _naVPCId = Nothing,
                _naOwnerId = Nothing, _naAssociations = Nothing,
                _naTags = Nothing, _naIsDefault = Nothing}
