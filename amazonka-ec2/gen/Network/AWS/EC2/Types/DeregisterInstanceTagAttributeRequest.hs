...
data DeregisterInstanceTagAttributeRequest = DeregisterInstanceTagAttributeRequest'{_ditarIncludeAllTagsOfInstance
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Bool),
...
deregisterInstanceTagAttributeRequest
    :: DeregisterInstanceTagAttributeRequest
deregisterInstanceTagAttributeRequest
  = DeregisterInstanceTagAttributeRequest'{_ditarIncludeAllTagsOfInstance
                                             = Nothing,
