...
data TunnelOption = TunnelOption'{_toOutsideIPAddress
                                  :: !(Maybe Text),
...
--
-- * 'toTunnelInsideCidr' - The range of inside IP addresses for the tunnel.
--
...
tunnelOption
    :: TunnelOption
tunnelOption
  = TunnelOption'{_toOutsideIPAddress = Nothing,
