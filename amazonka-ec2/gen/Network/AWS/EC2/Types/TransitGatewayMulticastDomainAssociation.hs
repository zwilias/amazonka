...
data TransitGatewayMulticastDomainAssociation = TransitGatewayMulticastDomainAssociation'{_tgmdaResourceId
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
                                                                                          _tgmdaResourceType
...
transitGatewayMulticastDomainAssociation
    :: TransitGatewayMulticastDomainAssociation
transitGatewayMulticastDomainAssociation
  = TransitGatewayMulticastDomainAssociation'{_tgmdaResourceId
                                                = Nothing,
