...
data TransitGatewayVPCAttachmentOptions = TransitGatewayVPCAttachmentOptions'{_tgvaoIPv6Support
                                                                              ::
                                                                              !(Maybe
                                                                                  IPv6SupportValue),
                                                                              _tgvaoDNSSupport
...
transitGatewayVPCAttachmentOptions
    :: TransitGatewayVPCAttachmentOptions
transitGatewayVPCAttachmentOptions
  = TransitGatewayVPCAttachmentOptions'{_tgvaoIPv6Support
                                          = Nothing,
