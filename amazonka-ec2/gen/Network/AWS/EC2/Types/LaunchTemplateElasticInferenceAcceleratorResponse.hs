...
data LaunchTemplateElasticInferenceAcceleratorResponse = LaunchTemplateElasticInferenceAcceleratorResponse'{_lCount
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Int),
                                                                                                            _lType
...
launchTemplateElasticInferenceAcceleratorResponse
    :: LaunchTemplateElasticInferenceAcceleratorResponse
launchTemplateElasticInferenceAcceleratorResponse
  = LaunchTemplateElasticInferenceAcceleratorResponse'{_lCount
                                                         = Nothing,
                                                       _lType = Nothing}
