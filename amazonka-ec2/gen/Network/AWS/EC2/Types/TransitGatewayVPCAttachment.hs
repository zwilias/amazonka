...
data TransitGatewayVPCAttachment = TransitGatewayVPCAttachment'{_tgvaCreationTime
                                                                ::
                                                                !(Maybe
                                                                    ISO8601),
                                                                _tgvaState ::
...
--
-- * 'tgvaState' - The state of the VPC attachment.
--
...
transitGatewayVPCAttachment
    :: TransitGatewayVPCAttachment
transitGatewayVPCAttachment
  = TransitGatewayVPCAttachment'{_tgvaCreationTime =
                                   Nothing,
                                 _tgvaState = Nothing, _tgvaSubnetIds = Nothing,
                                 _tgvaVPCId = Nothing,
                                 _tgvaTransitGatewayId = Nothing,
                                 _tgvaOptions = Nothing,
                                 _tgvaTransitGatewayAttachmentId = Nothing,
                                 _tgvaTags = Nothing, _tgvaVPCOwnerId = Nothing}
