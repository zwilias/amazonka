...
data InstanceTagNotificationAttribute = InstanceTagNotificationAttribute'{_itnaIncludeAllTagsOfInstance
                                                                          ::
                                                                          !(Maybe
                                                                              Bool),
...
instanceTagNotificationAttribute
    :: InstanceTagNotificationAttribute
instanceTagNotificationAttribute
  = InstanceTagNotificationAttribute'{_itnaIncludeAllTagsOfInstance
                                        = Nothing,
