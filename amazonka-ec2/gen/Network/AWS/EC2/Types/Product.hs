...
instance FromXML AccountAttribute where
  parseXML x =
    AccountAttribute' <$>
    (x .@? "attributeValueSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "attributeName")
...
instance FromXML ActiveInstance where
  parseXML x =
    ActiveInstance' <$> (x .@? "instanceId") <*> (x .@? "instanceHealth") <*>
    (x .@? "instanceType") <*>
...
aNetworkInterfaceOwnerId =
  lens _aNetworkInterfaceOwnerId (\s a -> s {_aNetworkInterfaceOwnerId = a})
...
instance FromXML Address where
  parseXML x =
    Address' <$> (x .@? "associationId") <*> (x .@? "instanceId") <*>
...
instance FromXML AllowedPrincipal where
  parseXML x =
    AllowedPrincipal' <$> (x .@? "principalType") <*> (x .@? "principal")
...
instance FromXML AvailabilityZone where
  parseXML x =
    AvailabilityZone' <$> (x .@? "zoneState") <*> (x .@? "regionName") <*>
    (x .@? "zoneName") <*>
...
acAvailableInstanceCapacity =
  lens
    ...
    (\s a -> s {_acAvailableInstanceCapacity = a}) .
  _Default . _Coerce
...
instance FromXML AvailableCapacity where
  parseXML x =
    AvailableCapacity' <$>
    (x .@? "availableInstanceCapacity" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "availableVCpus")
...
instance FromXML BlockDeviceMapping where
  parseXML x =
    BlockDeviceMapping' <$> (x .@? "virtualName") <*> (x .@? "noDevice") <*>
    (x .@? "ebs") <*>
    (x .@ "deviceName")
...
instance FromXML BundleTaskError where
  parseXML x = BundleTaskError' <$> (x .@? "code") <*> (x .@? "message")
...
instance FromXML CPUOptions where
  parseXML x = CPUOptions' <$> (x .@? "coreCount") <*> (x .@? "threadsPerCore")
...
instance ToQuery CPUOptionsRequest where
  toQuery CPUOptionsRequest' {..} =
    mconcat
      ["CoreCount" =: _corCoreCount, "ThreadsPerCore" =: _corThreadsPerCore]
...
instance FromXML CancelSpotFleetRequestsError where
  parseXML x =
    CancelSpotFleetRequestsError' <$> (x .@ "code") <*> (x .@ "message")
...
-- | The error.
csfreiError ::
     Lens' CancelSpotFleetRequestsErrorItem CancelSpotFleetRequestsError
...
csfreiSpotFleetRequestId =
  lens _csfreiSpotFleetRequestId (\s a -> s {_csfreiSpotFleetRequestId = a})

instance FromXML CancelSpotFleetRequestsErrorItem where
  parseXML x =
    CancelSpotFleetRequestsErrorItem' <$> (x .@ "error") <*>
...
csfrsiCurrentSpotFleetRequestState ::
     Lens' CancelSpotFleetRequestsSuccessItem BatchState
csfrsiCurrentSpotFleetRequestState =
  lens
...
csfrsiSpotFleetRequestId =
  lens _csfrsiSpotFleetRequestId (\s a -> s {_csfrsiSpotFleetRequestId = a})
...
csirState ::
     Lens' CancelledSpotInstanceRequest (Maybe CancelSpotInstanceRequestState)
...
csirSpotInstanceRequestId =
  lens _csirSpotInstanceRequestId (\s a -> s {_csirSpotInstanceRequestId = a})

instance FromXML CancelledSpotInstanceRequest where
  parseXML x =
    CancelledSpotInstanceRequest' <$> (x .@? "state") <*>
    (x .@? "spotInstanceRequestId")
...
cldsClassicLinkDNSSupported =
  lens
    ...
    (\s a -> s {_cldsClassicLinkDNSSupported = a})

instance FromXML ClassicLinkDNSSupport where
  parseXML x =
    ClassicLinkDNSSupport' <$> (x .@? "vpcId") <*>
    (x .@? "classicLinkDnsSupported")
...
instance FromXML ClassicLinkInstance where
  parseXML x =
    ClassicLinkInstance' <$> (x .@? "instanceId") <*>
...
clbcClassicLoadBalancers ::
     Lens' ClassicLoadBalancersConfig (NonEmpty ClassicLoadBalancer)
clbcClassicLoadBalancers =
  lens _clbcClassicLoadBalancers (\s a -> s {_clbcClassicLoadBalancers = a}) .
  _List1

instance FromXML ClassicLoadBalancersConfig where
  parseXML x =
    ClassicLoadBalancersConfig' <$>
    (x .@? "classicLoadBalancers" .!@ mempty >>= parseXMLList1 "item")
...
instance ToQuery ClassicLoadBalancersConfig where
  toQuery ClassicLoadBalancersConfig' {..} =
    mconcat [toQueryList "ClassicLoadBalancers" _clbcClassicLoadBalancers]
...
cdUploadStart =
  lens _cdUploadStart (\s a -> s {_cdUploadStart = a}) . mapping _Time
...
cnConnectionNotificationState ::
     Lens' ConnectionNotification (Maybe ConnectionNotificationState)
cnConnectionNotificationState =
  lens
    _cnConnectionNotificationState
    (\s a -> s {_cnConnectionNotificationState = a})

-- | The type of notification.
cnConnectionNotificationType ::
     Lens' ConnectionNotification (Maybe ConnectionNotificationType)
cnConnectionNotificationType =
  lens
    _cnConnectionNotificationType
    (\s a -> s {_cnConnectionNotificationType = a})

-- | The events for the notification. Valid values are @Accept@ , @Connect@ , @Delete@ , and @Reject@ .
cnConnectionEvents :: Lens' ConnectionNotification [Text]
cnConnectionEvents =
  lens _cnConnectionEvents (\s a -> s {_cnConnectionEvents = a}) .
  _Default . _Coerce
...
cnConnectionNotificationId =
  lens _cnConnectionNotificationId (\s a -> s {_cnConnectionNotificationId = a})
...
cnConnectionNotificationARN =
  lens
    ...
    (\s a -> s {_cnConnectionNotificationARN = a})

instance FromXML ConnectionNotification where
  parseXML x =
    ConnectionNotification' <$> (x .@? "connectionNotificationState") <*>
...
instance FromXML ConversionTask where
  parseXML x =
    ConversionTask' <$> (x .@? "importInstance") <*> (x .@? "state") <*>
    (x .@? "statusMessage") <*>
    (x .@? "importVolume") <*>
    (x .@? "conversionTaskId") <*>
    (x .@? "expirationTime") <*>
...
instance FromXML CreateVolumePermission where
  parseXML x = CreateVolumePermission' <$> (x .@? "group") <*> (x .@? "userId")
...
instance FromXML DHCPOptions where
  parseXML x =
    DHCPOptions' <$>
    (x .@? "dhcpConfigurationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "dhcpOptionsId") <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item"))
...
instance FromXML DNSEntry where
  parseXML x = DNSEntry' <$> (x .@? "hostedZoneId") <*> (x .@? "dnsName")
...
instance FromXML DeleteFleetError where
  parseXML x = DeleteFleetError' <$> (x .@? "code") <*> (x .@? "message")
...
instance FromXML DeleteFleetErrorItem where
  parseXML x = DeleteFleetErrorItem' <$> (x .@? "error") <*> (x .@? "fleetId")
...
dfsiCurrentFleetState =
  lens _dfsiCurrentFleetState (\s a -> s {_dfsiCurrentFleetState = a})

-- | The previous state of the EC2 Fleet.
dfsiPreviousFleetState :: Lens' DeleteFleetSuccessItem (Maybe FleetStateCode)
dfsiPreviousFleetState =
  lens _dfsiPreviousFleetState (\s a -> s {_dfsiPreviousFleetState = a})
...
instance FromXML DeleteFleetSuccessItem where
  parseXML x =
    DeleteFleetSuccessItem' <$> (x .@? "currentFleetState") <*>
...
dltvreiLaunchTemplateName ::
     Lens' DeleteLaunchTemplateVersionsResponseErrorItem (Maybe Text)
dltvreiLaunchTemplateName =
  lens _dltvreiLaunchTemplateName (\s a -> s {_dltvreiLaunchTemplateName = a})

-- | The ID of the launch template.
dltvreiLaunchTemplateId ::
     Lens' DeleteLaunchTemplateVersionsResponseErrorItem (Maybe Text)
dltvreiLaunchTemplateId =
  lens _dltvreiLaunchTemplateId (\s a -> s {_dltvreiLaunchTemplateId = a})

-- | The version number of the launch template.
dltvreiVersionNumber ::
     Lens' DeleteLaunchTemplateVersionsResponseErrorItem (Maybe Integer)
dltvreiVersionNumber =
  lens _dltvreiVersionNumber (\s a -> s {_dltvreiVersionNumber = a})

-- | Information about the error.
dltvreiResponseError ::
     Lens' DeleteLaunchTemplateVersionsResponseErrorItem (Maybe ResponseError)
dltvreiResponseError =
  lens _dltvreiResponseError (\s a -> s {_dltvreiResponseError = a})
...
dltvrsiLaunchTemplateName ::
     Lens' DeleteLaunchTemplateVersionsResponseSuccessItem (Maybe Text)
dltvrsiLaunchTemplateName =
  lens _dltvrsiLaunchTemplateName (\s a -> s {_dltvrsiLaunchTemplateName = a})

-- | The ID of the launch template.
dltvrsiLaunchTemplateId ::
     Lens' DeleteLaunchTemplateVersionsResponseSuccessItem (Maybe Text)
dltvrsiLaunchTemplateId =
  lens _dltvrsiLaunchTemplateId (\s a -> s {_dltvrsiLaunchTemplateId = a})

-- | The version number of the launch template.
dltvrsiVersionNumber ::
     Lens' DeleteLaunchTemplateVersionsResponseSuccessItem (Maybe Integer)
dltvrsiVersionNumber =
  lens _dltvrsiVersionNumber (\s a -> s {_dltvrsiVersionNumber = a})
...
dImportManifestURL =
  lens _dImportManifestURL (\s a -> s {_dImportManifestURL = a})

instance FromXML DiskImageDescription where
  parseXML x =
    DiskImageDescription' <$> (x .@? "size") <*> (x .@? "checksum") <*>
    (x .@? "format") <*>
    (x .@? "importManifestUrl")
...
instance FromXML DiskImageVolumeDescription where
  parseXML x = DiskImageVolumeDescription' <$> (x .@? "size") <*> (x .@? "id")
...
instance FromXML EBSBlockDevice where
  parseXML x =
    EBSBlockDevice' <$> (x .@? "deleteOnTermination") <*> (x .@? "volumeSize") <*>
    (x .@? "iops") <*>
    (x .@? "encrypted") <*>
    (x .@? "KmsKeyId") <*>
    (x .@? "volumeType") <*>
...
eibdAttachTime =
  lens _eibdAttachTime (\s a -> s {_eibdAttachTime = a}) . mapping _Time

instance FromXML EBSInstanceBlockDevice where
  parseXML x =
    EBSInstanceBlockDevice' <$> (x .@? "status") <*>
...
eibdsDeleteOnTermination ::
     Lens' EBSInstanceBlockDeviceSpecification (Maybe Bool)
eibdsDeleteOnTermination =
  lens _eibdsDeleteOnTermination (\s a -> s {_eibdsDeleteOnTermination = a})
...
eoigEgressOnlyInternetGatewayId =
  lens
    ...
    (\s a -> s {_eoigEgressOnlyInternetGatewayId = a})

-- | Information about the attachment of the egress-only Internet gateway.
eoigAttachments :: Lens' EgressOnlyInternetGateway [InternetGatewayAttachment]
eoigAttachments =
  lens _eoigAttachments (\s a -> s {_eoigAttachments = a}) . _Default . _Coerce

instance FromXML EgressOnlyInternetGateway where
  parseXML x =
    EgressOnlyInternetGateway' <$> (x .@? "egressOnlyInternetGatewayId") <*>
...
egaElasticGpuAssociationId =
  lens _egaElasticGpuAssociationId (\s a -> s {_egaElasticGpuAssociationId = a})
...
egaElasticGpuAssociationTime =
  lens
    ...
    (\s a -> s {_egaElasticGpuAssociationTime = a})
...
egaElasticGpuAssociationState =
  lens
    ...
    (\s a -> s {_egaElasticGpuAssociationState = a})

instance FromXML ElasticGpuAssociation where
  parseXML x =
    ElasticGpuAssociation' <$> (x .@? "elasticGpuId") <*>
...
egElasticGpuHealth =
  lens _egElasticGpuHealth (\s a -> s {_egElasticGpuHealth = a})

-- | The Availability Zone in the which the Elastic GPU resides.
egAvailabilityZone :: Lens' ElasticGpus (Maybe Text)
egAvailabilityZone =
  lens _egAvailabilityZone (\s a -> s {_egAvailabilityZone = a})

instance FromXML ElasticGpus where
  parseXML x =
    ElasticGpus' <$> (x .@? "instanceId") <*> (x .@? "elasticGpuType") <*>
    (x .@? "elasticGpuId") <*>
    (x .@? "elasticGpuState") <*>
    (x .@? "elasticGpuHealth") <*>
    (x .@? "availabilityZone")
...
instance FromXML EventInformation where
  parseXML x =
    EventInformation' <$> (x .@? "instanceId") <*> (x .@? "eventDescription") <*>
    (x .@? "eventSubType")
...
instance FromXML ExportTask where
  parseXML x =
    ExportTask' <$> (x .@ "description") <*> (x .@ "exportTaskId") <*>
    (x .@ "exportToS3") <*>
    (x .@ "instanceExport") <*>
    (x .@ "state") <*>
    (x .@ "statusMessage")
...
instance FromXML ExportToS3Task where
  parseXML x =
    ExportToS3Task' <$> (x .@? "s3Key") <*> (x .@? "containerFormat") <*>
    (x .@? "s3Bucket") <*>
    (x .@? "diskImageFormat")
...
etstsContainerFormat ::
     Lens' ExportToS3TaskSpecification (Maybe ContainerFormat)
etstsContainerFormat =
...
etstsDiskImageFormat ::
     Lens' ExportToS3TaskSpecification (Maybe DiskImageFormat)
etstsDiskImageFormat =
...
instance ToQuery Filter where
  toQuery Filter' {..} =
    mconcat [toQuery (toQueryList "Value" <$> _fValues), "Name" =: _fName]
...
fdTargetCapacitySpecification ::
     Lens' FleetData (Maybe TargetCapacitySpecification)
fdTargetCapacitySpecification =
  lens
    _fdTargetCapacitySpecification
    (\s a -> s {_fdTargetCapacitySpecification = a})
...
fdExcessCapacityTerminationPolicy ::
     Lens' FleetData (Maybe FleetExcessCapacityTerminationPolicy)
fdExcessCapacityTerminationPolicy =
  lens
    _fdExcessCapacityTerminationPolicy
    (\s a -> s {_fdExcessCapacityTerminationPolicy = a})
...
fdLaunchTemplateConfigs =
  lens _fdLaunchTemplateConfigs (\s a -> s {_fdLaunchTemplateConfigs = a}) .
  _Default . _Coerce
...
fdValidUntil =
  lens _fdValidUntil (\s a -> s {_fdValidUntil = a}) . mapping _Time
...
fdTerminateInstancesWithExpiration =
  lens
    ...
    (\s a -> s {_fdTerminateInstancesWithExpiration = a})

-- | The number of units fulfilled by this request compared to the set target capacity.
fdFulfilledCapacity :: Lens' FleetData (Maybe Double)
fdFulfilledCapacity =
  lens _fdFulfilledCapacity (\s a -> s {_fdFulfilledCapacity = a})
...
fdReplaceUnhealthyInstances =
  lens
    _fdReplaceUnhealthyInstances
    (\s a -> s {_fdReplaceUnhealthyInstances = a})

-- | The number of units fulfilled by this request compared to the set target On-Demand capacity.
fdFulfilledOnDemandCapacity :: Lens' FleetData (Maybe Double)
fdFulfilledOnDemandCapacity =
  lens
    _fdFulfilledOnDemandCapacity
    (\s a -> s {_fdFulfilledOnDemandCapacity = a})
...
fdCreateTime =
  lens _fdCreateTime (\s a -> s {_fdCreateTime = a}) . mapping _Time
...
instance FromXML FleetData where
  parseXML x =
    FleetData' <$> (x .@? "clientToken") <*>
    (x .@? "targetCapacitySpecification") <*>
    (x .@? "spotOptions") <*>
    (x .@? "excessCapacityTerminationPolicy") <*>
    (x .@? "fleetState") <*>
    (x .@? "launchTemplateConfigs" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "validUntil") <*>
...
fltcOverrides =
  lens _fltcOverrides (\s a -> s {_fltcOverrides = a}) . _Default . _Coerce

-- | The launch template.
fltcLaunchTemplateSpecification ::
     Lens' FleetLaunchTemplateConfig (Maybe FleetLaunchTemplateSpecification)
fltcLaunchTemplateSpecification =
  lens
    _fltcLaunchTemplateSpecification
    (\s a -> s {_fltcLaunchTemplateSpecification = a})
...
-- | Any parameters that you specify override the same parameters in the launch template.
fltcrOverrides ::
     Lens' FleetLaunchTemplateConfigRequest [FleetLaunchTemplateOverridesRequest]
fltcrOverrides =
  lens _fltcrOverrides (\s a -> s {_fltcrOverrides = a}) . _Default . _Coerce

-- | The launch template to use. You must specify either the launch template ID or launch template name in the request.
fltcrLaunchTemplateSpecification ::
     Lens' FleetLaunchTemplateConfigRequest (Maybe FleetLaunchTemplateSpecificationRequest)
fltcrLaunchTemplateSpecification =
  lens
    _fltcrLaunchTemplateSpecification
    (\s a -> s {_fltcrLaunchTemplateSpecification = a})
...
fltoWeightedCapacity =
  lens _fltoWeightedCapacity (\s a -> s {_fltoWeightedCapacity = a})
...
fltoAvailabilityZone =
  lens _fltoAvailabilityZone (\s a -> s {_fltoAvailabilityZone = a})
...
instance FromXML FleetLaunchTemplateOverrides where
  parseXML x =
    FleetLaunchTemplateOverrides' <$> (x .@? "weightedCapacity") <*>
    (x .@? "subnetId") <*>
    (x .@? "instanceType") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "maxPrice")
...
fltorWeightedCapacity ::
     Lens' FleetLaunchTemplateOverridesRequest (Maybe Double)
fltorWeightedCapacity =
  lens _fltorWeightedCapacity (\s a -> s {_fltorWeightedCapacity = a})
...
-- | The instance type.
fltorInstanceType ::
     Lens' FleetLaunchTemplateOverridesRequest (Maybe InstanceType)
...
fltorAvailabilityZone =
  lens _fltorAvailabilityZone (\s a -> s {_fltorAvailabilityZone = a})
...
fltsLaunchTemplateName =
  lens _fltsLaunchTemplateName (\s a -> s {_fltsLaunchTemplateName = a})

-- | The ID of the launch template. You must specify either a template ID or a template name.
fltsLaunchTemplateId :: Lens' FleetLaunchTemplateSpecification (Maybe Text)
fltsLaunchTemplateId =
  lens _fltsLaunchTemplateId (\s a -> s {_fltsLaunchTemplateId = a})
...
instance FromXML FleetLaunchTemplateSpecification where
  parseXML x =
    FleetLaunchTemplateSpecification' <$> (x .@? "launchTemplateName") <*>
    (x .@? "launchTemplateId") <*>
    (x .@? "version")
...
fltsrLaunchTemplateName ::
     Lens' FleetLaunchTemplateSpecificationRequest (Maybe Text)
fltsrLaunchTemplateName =
  lens _fltsrLaunchTemplateName (\s a -> s {_fltsrLaunchTemplateName = a})

-- | The ID of the launch template.
fltsrLaunchTemplateId ::
     Lens' FleetLaunchTemplateSpecificationRequest (Maybe Text)
fltsrLaunchTemplateId =
  lens _fltsrLaunchTemplateId (\s a -> s {_fltsrLaunchTemplateId = a})
...
flCreationTime =
  lens _flCreationTime (\s a -> s {_flCreationTime = a}) . mapping _Time
...
flDeliverLogsStatus =
  lens _flDeliverLogsStatus (\s a -> s {_flDeliverLogsStatus = a})

-- | Information about the error that occurred. @Rate limited@ indicates that CloudWatch logs throttling has been applied for one or more network interfaces, or that you've reached the limit on the number of CloudWatch Logs log groups that you can create. @Access error@ indicates that the IAM role associated with the flow log does not have sufficient permissions to publish to CloudWatch Logs. @Unknown error@ indicates an internal error.
flDeliverLogsErrorMessage :: Lens' FlowLog (Maybe Text)
flDeliverLogsErrorMessage =
  lens _flDeliverLogsErrorMessage (\s a -> s {_flDeliverLogsErrorMessage = a})
...
flDeliverLogsPermissionARN =
  lens _flDeliverLogsPermissionARN (\s a -> s {_flDeliverLogsPermissionARN = a})
...
instance FromXML FlowLog where
  parseXML x =
    FlowLog' <$> (x .@? "creationTime") <*> (x .@? "resourceId") <*>
    (x .@? "flowLogStatus") <*>
    (x .@? "trafficType") <*>
    (x .@? "deliverLogsStatus") <*>
...
fiUpdateTime =
  lens _fiUpdateTime (\s a -> s {_fiUpdateTime = a}) . mapping _Time
...
fiProductCodes =
  lens _fiProductCodes (\s a -> s {_fiProductCodes = a}) . _Default . _Coerce
...
fiCreateTime =
  lens _fiCreateTime (\s a -> s {_fiCreateTime = a}) . mapping _Time
...
fiFpgaImageGlobalId =
  lens _fiFpgaImageGlobalId (\s a -> s {_fiFpgaImageGlobalId = a})

instance FromXML FpgaImage where
  parseXML x =
    FpgaImage' <$> (x .@? "shellVersion") <*> (x .@? "pciId") <*>
    (x .@? "state") <*>
    (x .@? "ownerAlias") <*>
    (x .@? "fpgaImageId") <*>
    (x .@? "ownerId") <*>
...
fiaProductCodes =
  lens _fiaProductCodes (\s a -> s {_fiaProductCodes = a}) . _Default . _Coerce
...
fiaLoadPermissions =
  lens _fiaLoadPermissions (\s a -> s {_fiaLoadPermissions = a}) .
  _Default . _Coerce

instance FromXML FpgaImageAttribute where
  parseXML x =
    FpgaImageAttribute' <$> (x .@? "fpgaImageId") <*> (x .@? "name") <*>
    (x .@? "productCodes" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "description") <*>
...
instance FromXML FpgaImageState where
  parseXML x = FpgaImageState' <$> (x .@? "code") <*> (x .@? "message")
...
instance FromXML GroupIdentifier where
  parseXML x = GroupIdentifier' <$> (x .@? "groupId") <*> (x .@? "groupName")
...
instance FromXML HistoryRecord where
  parseXML x =
    HistoryRecord' <$> (x .@ "eventInformation") <*> (x .@ "eventType") <*>
    (x .@ "timestamp")
...
hreEventInformation =
  lens _hreEventInformation (\s a -> s {_hreEventInformation = a})

-- | The date and time of the event, in UTC format (for example, /YYYY/ -/MM/ -/DD/ T/HH/ :/MM/ :/SS/ Z).
hreTimestamp :: Lens' HistoryRecordEntry (Maybe UTCTime)
hreTimestamp =
  lens _hreTimestamp (\s a -> s {_hreTimestamp = a}) . mapping _Time

instance FromXML HistoryRecordEntry where
  parseXML x =
    HistoryRecordEntry' <$> (x .@? "eventType") <*> (x .@? "eventInformation") <*>
    (x .@? "timestamp")
...
hReleaseTime =
  lens _hReleaseTime (\s a -> s {_hReleaseTime = a}) . mapping _Time
...
hAvailableCapacity =
  lens _hAvailableCapacity (\s a -> s {_hAvailableCapacity = a})

-- | The reservation ID of the Dedicated Host. This returns a @null@ response if the Dedicated Host doesn't have an associated reservation.
hHostReservationId :: Lens' Host (Maybe Text)
hHostReservationId =
  lens _hHostReservationId (\s a -> s {_hHostReservationId = a})
...
hAllocationTime =
  lens _hAllocationTime (\s a -> s {_hAllocationTime = a}) . mapping _Time
...
instance FromXML HostInstance where
  parseXML x = HostInstance' <$> (x .@? "instanceId") <*> (x .@? "instanceType")
...
instance FromXML HostOffering where
  parseXML x =
    HostOffering' <$> (x .@? "instanceFamily") <*> (x .@? "currencyCode") <*>
    (x .@? "hourlyPrice") <*>
    (x .@? "upfrontPrice") <*>
    (x .@? "offeringId") <*>
    (x .@? "duration") <*>
...
instance FromXML HostProperties where
  parseXML x =
    HostProperties' <$> (x .@? "instanceType") <*> (x .@? "totalVCpus") <*>
    (x .@? "cores") <*>
    (x .@? "sockets")
...
hrHostReservationId =
  lens _hrHostReservationId (\s a -> s {_hrHostReservationId = a})
...
hrHostIdSet =
  lens _hrHostIdSet (\s a -> s {_hrHostIdSet = a}) . _Default . _Coerce
...
instance FromXML HostReservation where
  parseXML x =
    HostReservation' <$> (x .@? "state") <*> (x .@? "instanceFamily") <*>
    (x .@? "currencyCode") <*>
    (x .@? "hostReservationId") <*>
    (x .@? "start") <*>
    (x .@? "hourlyPrice") <*>
...
iapaState ::
     Lens' IAMInstanceProfileAssociation (Maybe IAMInstanceProfileAssociationState)
iapaState = lens _iapaState (\s a -> s {_iapaState = a})

-- | The IAM instance profile.
iapaIAMInstanceProfile ::
     Lens' IAMInstanceProfileAssociation (Maybe IAMInstanceProfile)
iapaIAMInstanceProfile =
  lens _iapaIAMInstanceProfile (\s a -> s {_iapaIAMInstanceProfile = a})

-- | The time the IAM instance profile was associated with the instance.
iapaTimestamp :: Lens' IAMInstanceProfileAssociation (Maybe UTCTime)
iapaTimestamp =
  lens _iapaTimestamp (\s a -> s {_iapaTimestamp = a}) . mapping _Time

instance FromXML IAMInstanceProfileAssociation where
  parseXML x =
    IAMInstanceProfileAssociation' <$> (x .@? "associationId") <*>
    (x .@? "instanceId") <*>
    (x .@? "state") <*>
...
instance FromXML IAMInstanceProfileSpecification where
  parseXML x =
    IAMInstanceProfileSpecification' <$> (x .@? "arn") <*> (x .@? "name")
...
instance ToQuery ICMPTypeCode where
  toQuery ICMPTypeCode' {..} = mconcat ["Code" =: _itcCode, "Type" =: _itcType]
...
ipPrefixListIds =
  lens _ipPrefixListIds (\s a -> s {_ipPrefixListIds = a}) . _Default . _Coerce
...
ipIPv6Ranges =
  lens _ipIPv6Ranges (\s a -> s {_ipIPv6Ranges = a}) . _Default . _Coerce
...
instance ToQuery IPRange where
  toQuery IPRange' {..} =
    mconcat ["Description" =: _iprDescription, "CidrIp" =: _iprCidrIP]
...
instance FromXML IPv6Range where
  parseXML x = IPv6Range' <$> (x .@? "cidrIpv6") <*> (x .@? "description")
...
instance ToQuery IPv6Range where
  toQuery IPv6Range' {..} =
    mconcat ["CidrIpv6" =: _irCidrIPv6, "Description" =: _irDescription]
...
instance FromXML IdFormat where
  parseXML x =
    IdFormat' <$> (x .@? "useLongIds") <*> (x .@? "deadline") <*>
    (x .@? "resource")
...
iProductCodes =
  lens _iProductCodes (\s a -> s {_iProductCodes = a}) . _Default . _Coerce
...
instance FromXML Image where
  parseXML x =
    ...
    (x .@? "stateReason") <*>
    (x .@? "description") <*>
    (x .@? "blockDeviceMapping" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@ "imageId") <*>
    (x .@ "imageLocation") <*>
    (x .@ "imageState") <*>
...
instance FromXML ImportImageTask where
  parseXML x =
    ImportImageTask' <$> (x .@? "status") <*> (x .@? "hypervisor") <*>
    (x .@? "platform") <*>
    (x .@? "progress") <*>
    (x .@? "licenseType") <*>
    (x .@? "snapshotDetailSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "statusMessage") <*>
    (x .@? "imageId") <*>
    (x .@? "importTaskId") <*>
    (x .@? "architecture") <*>
...
iilsGroupNames =
  lens _iilsGroupNames (\s a -> s {_iilsGroupNames = a}) . _Default . _Coerce
...
iilsGroupIds =
  lens _iilsGroupIds (\s a -> s {_iilsGroupIds = a}) . _Default . _Coerce
...
iilsInstanceInitiatedShutdownBehavior ::
     Lens' ImportInstanceLaunchSpecification (Maybe ShutdownBehavior)
iilsInstanceInitiatedShutdownBehavior =
  lens
...
iilsArchitecture ::
     Lens' ImportInstanceLaunchSpecification (Maybe ArchitectureValues)
...
iitdVolumes =
  lens _iitdVolumes (\s a -> s {_iitdVolumes = a}) . _Default . _Coerce
...
instance FromXML ImportInstanceTaskDetails where
  parseXML x =
    ImportInstanceTaskDetails' <$> (x .@? "instanceId") <*> (x .@? "platform") <*>
...
instance FromXML ImportInstanceVolumeDetailItem where
  parseXML x =
    ImportInstanceVolumeDetailItem' <$> (x .@? "statusMessage") <*>
    (x .@? "description") <*>
    (x .@ "availabilityZone") <*>
    (x .@ "bytesConverted") <*>
    (x .@ "image") <*>
...
instance FromXML ImportSnapshotTask where
  parseXML x =
    ImportSnapshotTask' <$> (x .@? "snapshotTaskDetail") <*>
    (x .@? "importTaskId") <*>
    (x .@? "description")
...
instance FromXML ImportVolumeTaskDetails where
  parseXML x =
    ImportVolumeTaskDetails' <$> (x .@? "bytesConverted") <*> (x .@? "image") <*>
    (x .@? "volume") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "description")
...
insSecurityGroups =
  lens _insSecurityGroups (\s a -> s {_insSecurityGroups = a}) .
  _Default . _Coerce
...
insSourceDestCheck =
  lens _insSourceDestCheck (\s a -> s {_insSourceDestCheck = a})

-- | The Elastic GPU associated with the instance.
insElasticGpuAssociations :: Lens' Instance [ElasticGpuAssociation]
insElasticGpuAssociations =
  lens _insElasticGpuAssociations (\s a -> s {_insElasticGpuAssociations = a}) .
  _Default . _Coerce
...
insNetworkInterfaces =
  lens _insNetworkInterfaces (\s a -> s {_insNetworkInterfaces = a}) .
  _Default . _Coerce
...
insSRIOVNetSupport =
  lens _insSRIOVNetSupport (\s a -> s {_insSRIOVNetSupport = a})
...
insBlockDeviceMappings =
  lens _insBlockDeviceMappings (\s a -> s {_insBlockDeviceMappings = a}) .
  _Default . _Coerce

-- | The public IPv4 address assigned to the instance, if applicable.
insPublicIPAddress :: Lens' Instance (Maybe Text)
insPublicIPAddress =
  lens _insPublicIPAddress (\s a -> s {_insPublicIPAddress = a})
...
insVirtualizationType =
  lens _insVirtualizationType (\s a -> s {_insVirtualizationType = a})
...
instance FromXML Instance where
  parseXML x =
    Instance' <$> (x .@? "dnsName") <*> (x .@? "platform") <*>
    (x .@? "groupSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "clientToken") <*>
    (x .@? "enaSupport") <*>
    (x .@? "sourceDestCheck") <*>
    (x .@? "elasticGpuAssociationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "vpcId") <*>
    (x .@? "keyName") <*>
    (x .@? "networkInterfaceSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "ramdiskId") <*>
    (x .@? "cpuOptions") <*>
    (x .@? "subnetId") <*>
    (x .@? "kernelId") <*>
...
instance FromXML InstanceBlockDeviceMapping where
  parseXML x =
    InstanceBlockDeviceMapping' <$> (x .@? "ebs") <*> (x .@? "deviceName")
...
-- | Parameters used to automatically set up EBS volumes when the instance is launched.
ibdmsEBS ::
     Lens' InstanceBlockDeviceMappingSpecification (Maybe EBSInstanceBlockDeviceSpecification)
...
icAvailableCapacity =
  lens _icAvailableCapacity (\s a -> s {_icAvailableCapacity = a})
...
instance FromXML InstanceCapacity where
  parseXML x =
    InstanceCapacity' <$> (x .@? "availableCapacity") <*> (x .@? "instanceType") <*>
    (x .@? "totalCapacity")
...
instance FromXML InstanceCount where
  parseXML x = InstanceCount' <$> (x .@? "state") <*> (x .@? "instanceCount")
...
instance FromXML InstanceCreditSpecification where
  parseXML x =
    InstanceCreditSpecification' <$> (x .@? "instanceId") <*>
    (x .@? "cpuCredits")
...
instance ToQuery InstanceCreditSpecificationRequest where
  toQuery InstanceCreditSpecificationRequest' {..} =
    mconcat ["InstanceId" =: _icsrInstanceId, "CpuCredits" =: _icsrCPUCredits]
...
instance FromXML InstanceExportDetails where
  parseXML x =
    InstanceExportDetails' <$> (x .@? "targetEnvironment") <*>
    (x .@? "instanceId")
...
instance ToQuery InstanceIPv6Address where
  toQuery InstanceIPv6Address' {..} = mconcat ["Ipv6Address" =: _iiaIPv6Address]
...
instance ToQuery InstanceMarketOptionsRequest where
  toQuery InstanceMarketOptionsRequest' {..} =
    mconcat ["MarketType" =: _imorMarketType, "SpotOptions" =: _imorSpotOptions]
...
instance FromXML InstanceMonitoring where
  parseXML x =
    InstanceMonitoring' <$> (x .@? "instanceId") <*> (x .@? "monitoring")
...
iniPrivateIPAddresses ::
     Lens' InstanceNetworkInterface [InstancePrivateIPAddress]
iniPrivateIPAddresses =
...
iniAttachment ::
     Lens' InstanceNetworkInterface (Maybe InstanceNetworkInterfaceAttachment)
...
iniAssociation ::
     Lens' InstanceNetworkInterface (Maybe InstanceNetworkInterfaceAssociation)
...
iniIPv6Addresses =
  lens _iniIPv6Addresses (\s a -> s {_iniIPv6Addresses = a}) .
  _Default . _Coerce
...
instance FromXML InstanceNetworkInterface where
  parseXML x =
    ...
    (x .@? "groupSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "status") <*>
    (x .@? "privateIpAddressesSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "sourceDestCheck") <*>
    (x .@? "vpcId") <*>
    (x .@? "networkInterfaceId") <*>
    (x .@? "subnetId") <*>
...
instance FromXML InstanceNetworkInterfaceAssociation where
  parseXML x =
    InstanceNetworkInterfaceAssociation' <$> (x .@? "publicDnsName") <*>
    (x .@? "ipOwnerId") <*>
    (x .@? "publicIp")
...
iniaAttachTime =
  lens _iniaAttachTime (\s a -> s {_iniaAttachTime = a}) . mapping _Time
...
instance FromXML InstanceNetworkInterfaceAttachment where
  parseXML x =
    InstanceNetworkInterfaceAttachment' <$> (x .@? "status") <*>
    (x .@? "deleteOnTermination") <*>
    (x .@? "attachmentId") <*>
    (x .@? "attachTime") <*>
    (x .@? "deviceIndex")
...
inisPrivateIPAddresses ::
     Lens' InstanceNetworkInterfaceSpecification [PrivateIPAddressSpecification]
inisPrivateIPAddresses =
...
inisDeleteOnTermination ::
     Lens' InstanceNetworkInterfaceSpecification (Maybe Bool)
inisDeleteOnTermination =
...
inisNetworkInterfaceId ::
     Lens' InstanceNetworkInterfaceSpecification (Maybe Text)
inisNetworkInterfaceId =
...
inisIPv6AddressCount =
  lens _inisIPv6AddressCount (\s a -> s {_inisIPv6AddressCount = a})
...
inisSecondaryPrivateIPAddressCount ::
     Lens' InstanceNetworkInterfaceSpecification (Maybe Int)
inisSecondaryPrivateIPAddressCount =
  lens
...
inisIPv6Addresses ::
     Lens' InstanceNetworkInterfaceSpecification [InstanceIPv6Address]
inisIPv6Addresses =
  lens _inisIPv6Addresses (\s a -> s {_inisIPv6Addresses = a}) .
  _Default . _Coerce

instance FromXML InstanceNetworkInterfaceSpecification where
  parseXML x =
    InstanceNetworkInterfaceSpecification' <$>
    (x .@? "SecurityGroupId" .!@ mempty >>= may (parseXMLList "SecurityGroupId")) <*>
    (x .@? "privateIpAddressesSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "deleteOnTermination") <*>
...
instance ToQuery InstanceNetworkInterfaceSpecification where
  toQuery InstanceNetworkInterfaceSpecification' {..} =
    mconcat
      ...
      , toQuery (toQueryList "PrivateIpAddresses" <$> _inisPrivateIPAddresses)
...
instance FromXML InstanceStateChange where
  parseXML x =
    InstanceStateChange' <$> (x .@? "instanceId") <*> (x .@? "currentState") <*>
    (x .@? "previousState")
...
instance FromXML InstanceStatus where
  parseXML x =
    InstanceStatus' <$> (x .@? "instanceId") <*> (x .@? "systemStatus") <*>
...
isdImpairedSince =
  lens _isdImpairedSince (\s a -> s {_isdImpairedSince = a}) . mapping _Time
...
instance FromXML InstanceStatusDetails where
  parseXML x =
    InstanceStatusDetails' <$> (x .@? "status") <*> (x .@? "impairedSince") <*>
    (x .@? "name")
...
iseNotBefore =
  lens _iseNotBefore (\s a -> s {_iseNotBefore = a}) . mapping _Time
...
instance FromXML InstanceStatusEvent where
  parseXML x =
    InstanceStatusEvent' <$> (x .@? "notBefore") <*> (x .@? "code") <*>
    (x .@? "description") <*>
    (x .@? "notAfter")
...
igAttachments =
  lens _igAttachments (\s a -> s {_igAttachments = a}) . _Default . _Coerce
...
instance FromXML InternetGatewayAttachment where
  parseXML x = InternetGatewayAttachment' <$> (x .@ "state") <*> (x .@ "vpcId")
...
instance FromXML KeyPairInfo where
  parseXML x = KeyPairInfo' <$> (x .@? "keyFingerprint") <*> (x .@? "keyName")
...
instance FromXML LaunchPermission where
  parseXML x = LaunchPermission' <$> (x .@? "group") <*> (x .@? "userId")
...
lsNetworkInterfaces ::
     Lens' LaunchSpecification [InstanceNetworkInterfaceSpecification]
lsNetworkInterfaces =
...
lsIAMInstanceProfile ::
     Lens' LaunchSpecification (Maybe IAMInstanceProfileSpecification)
lsIAMInstanceProfile =
...
ltLaunchTemplateName =
  lens _ltLaunchTemplateName (\s a -> s {_ltLaunchTemplateName = a})

-- | The version number of the latest version of the launch template.
ltLatestVersionNumber :: Lens' LaunchTemplate (Maybe Integer)
ltLatestVersionNumber =
  lens _ltLatestVersionNumber (\s a -> s {_ltLatestVersionNumber = a})

-- | The ID of the launch template.
ltLaunchTemplateId :: Lens' LaunchTemplate (Maybe Text)
ltLaunchTemplateId =
  lens _ltLaunchTemplateId (\s a -> s {_ltLaunchTemplateId = a})
...
ltDefaultVersionNumber =
  lens _ltDefaultVersionNumber (\s a -> s {_ltDefaultVersionNumber = a})

-- | The time launch template was created.
ltCreateTime :: Lens' LaunchTemplate (Maybe UTCTime)
ltCreateTime =
  lens _ltCreateTime (\s a -> s {_ltCreateTime = a}) . mapping _Time
...
instance FromXML LaunchTemplate where
  parseXML x =
    LaunchTemplate' <$> (x .@? "launchTemplateName") <*>
...
ltbdmEBS ::
     Lens' LaunchTemplateBlockDeviceMapping (Maybe LaunchTemplateEBSBlockDevice)
...
instance FromXML LaunchTemplateBlockDeviceMapping where
  parseXML x =
    LaunchTemplateBlockDeviceMapping' <$> (x .@? "virtualName") <*>
    (x .@? "noDevice") <*>
    (x .@? "ebs") <*>
    (x .@? "deviceName")
...
-- | Parameters used to automatically set up EBS volumes when the instance is launched.
ltbdmrEBS ::
     Lens' LaunchTemplateBlockDeviceMappingRequest (Maybe LaunchTemplateEBSBlockDeviceRequest)
...
ltcOverrides =
  lens _ltcOverrides (\s a -> s {_ltcOverrides = a}) . _Default . _Coerce

-- | The launch template.
ltcLaunchTemplateSpecification ::
     Lens' LaunchTemplateConfig (Maybe FleetLaunchTemplateSpecification)
ltcLaunchTemplateSpecification =
  lens
    _ltcLaunchTemplateSpecification
    (\s a -> s {_ltcLaunchTemplateSpecification = a})
...
ltebdDeleteOnTermination =
  lens _ltebdDeleteOnTermination (\s a -> s {_ltebdDeleteOnTermination = a})
...
instance FromXML LaunchTemplateEBSBlockDevice where
  parseXML x =
    LaunchTemplateEBSBlockDevice' <$> (x .@? "deleteOnTermination") <*>
    (x .@? "volumeSize") <*>
    (x .@? "iops") <*>
    (x .@? "encrypted") <*>
    (x .@? "kmsKeyId") <*>
...
ltebdrDeleteOnTermination ::
     Lens' LaunchTemplateEBSBlockDeviceRequest (Maybe Bool)
ltebdrDeleteOnTermination =
  lens _ltebdrDeleteOnTermination (\s a -> s {_ltebdrDeleteOnTermination = a})
...
instance FromXML LaunchTemplateIAMInstanceProfileSpecification where
  parseXML x =
    LaunchTemplateIAMInstanceProfileSpecification' <$> (x .@? "arn") <*>
    (x .@? "name")
...
-- | The Amazon Resource Name (ARN) of the instance profile.
ltiapsrARN ::
     Lens' LaunchTemplateIAMInstanceProfileSpecificationRequest (Maybe Text)
...
instance Hashable LaunchTemplateIAMInstanceProfileSpecificationRequest

instance NFData LaunchTemplateIAMInstanceProfileSpecificationRequest

instance ToQuery LaunchTemplateIAMInstanceProfileSpecificationRequest where
...
-- | The options for Spot Instances.
ltimoSpotOptions ::
     Lens' LaunchTemplateInstanceMarketOptions (Maybe LaunchTemplateSpotMarketOptions)
...
instance FromXML LaunchTemplateInstanceMarketOptions where
  parseXML x =
    LaunchTemplateInstanceMarketOptions' <$> (x .@? "marketType") <*>
    (x .@? "spotOptions")
...
-- | The market type.
ltimorMarketType ::
     Lens' LaunchTemplateInstanceMarketOptionsRequest (Maybe MarketType)
ltimorMarketType = lens _ltimorMarketType (\s a -> s {_ltimorMarketType = a})

-- | The options for Spot Instances.
ltimorSpotOptions ::
     Lens' LaunchTemplateInstanceMarketOptionsRequest (Maybe LaunchTemplateSpotMarketOptionsRequest)
...
instance ToQuery LaunchTemplateInstanceMarketOptionsRequest where
  toQuery LaunchTemplateInstanceMarketOptionsRequest' {..} =
    mconcat
      ["MarketType" =: _ltimorMarketType, "SpotOptions" =: _ltimorSpotOptions]
...
ltinisGroups =
  lens _ltinisGroups (\s a -> s {_ltinisGroups = a}) . _Default . _Coerce

-- | One or more private IPv4 addresses.
ltinisPrivateIPAddresses ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification [PrivateIPAddressSpecification]
ltinisPrivateIPAddresses =
  lens _ltinisPrivateIPAddresses (\s a -> s {_ltinisPrivateIPAddresses = a}) .
  _Default . _Coerce

-- | Indicates whether the network interface is deleted when the instance is terminated.
ltinisDeleteOnTermination ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification (Maybe Bool)
ltinisDeleteOnTermination =
  lens _ltinisDeleteOnTermination (\s a -> s {_ltinisDeleteOnTermination = a})
...
ltinisAssociatePublicIPAddress =
  lens
    ...
    (\s a -> s {_ltinisAssociatePublicIPAddress = a})

-- | The ID of the network interface.
ltinisNetworkInterfaceId ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification (Maybe Text)
ltinisNetworkInterfaceId =
  lens _ltinisNetworkInterfaceId (\s a -> s {_ltinisNetworkInterfaceId = a})
...
ltinisIPv6AddressCount ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification (Maybe Int)
ltinisIPv6AddressCount =
  lens _ltinisIPv6AddressCount (\s a -> s {_ltinisIPv6AddressCount = a})

-- | The primary private IPv4 address of the network interface.
ltinisPrivateIPAddress ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification (Maybe Text)
ltinisPrivateIPAddress =
  lens _ltinisPrivateIPAddress (\s a -> s {_ltinisPrivateIPAddress = a})
...
ltinisSecondaryPrivateIPAddressCount =
  lens
    ...
    (\s a -> s {_ltinisSecondaryPrivateIPAddressCount = a})
...
ltinisIPv6Addresses ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecification [InstanceIPv6Address]
ltinisIPv6Addresses =
  lens _ltinisIPv6Addresses (\s a -> s {_ltinisIPv6Addresses = a}) .
  _Default . _Coerce

instance FromXML LaunchTemplateInstanceNetworkInterfaceSpecification where
  parseXML x =
    LaunchTemplateInstanceNetworkInterfaceSpecification' <$>
...
instance Hashable LaunchTemplateInstanceNetworkInterfaceSpecification
...
-- | The IDs of one or more security groups.
ltinisrGroups ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest [Text]
ltinisrGroups =
  lens _ltinisrGroups (\s a -> s {_ltinisrGroups = a}) . _Default . _Coerce

-- | One or more private IPv4 addresses.
ltinisrPrivateIPAddresses ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest [PrivateIPAddressSpecification]
ltinisrPrivateIPAddresses =
  lens _ltinisrPrivateIPAddresses (\s a -> s {_ltinisrPrivateIPAddresses = a}) .
  _Default . _Coerce

-- | Indicates whether the network interface is deleted when the instance is terminated.
ltinisrDeleteOnTermination ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Bool)
ltinisrDeleteOnTermination =
  lens _ltinisrDeleteOnTermination (\s a -> s {_ltinisrDeleteOnTermination = a})
...
ltinisrAssociatePublicIPAddress =
  lens
    ...
    (\s a -> s {_ltinisrAssociatePublicIPAddress = a})

-- | The ID of the network interface.
ltinisrNetworkInterfaceId ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Text)
ltinisrNetworkInterfaceId =
  lens _ltinisrNetworkInterfaceId (\s a -> s {_ltinisrNetworkInterfaceId = a})
...
ltinisrIPv6AddressCount ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Int)
ltinisrIPv6AddressCount =
  lens _ltinisrIPv6AddressCount (\s a -> s {_ltinisrIPv6AddressCount = a})

-- | The primary private IPv4 address of the network interface.
ltinisrPrivateIPAddress ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Text)
ltinisrPrivateIPAddress =
  lens _ltinisrPrivateIPAddress (\s a -> s {_ltinisrPrivateIPAddress = a})
...
ltinisrSecondaryPrivateIPAddressCount =
  lens
    ...
    (\s a -> s {_ltinisrSecondaryPrivateIPAddressCount = a})

-- | A description for the network interface.
ltinisrDescription ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Text)
ltinisrDescription =
  lens _ltinisrDescription (\s a -> s {_ltinisrDescription = a})

-- | The device index for the network interface attachment.
ltinisrDeviceIndex ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest (Maybe Int)
ltinisrDeviceIndex =
  lens _ltinisrDeviceIndex (\s a -> s {_ltinisrDeviceIndex = a})

-- | One or more specific IPv6 addresses from the IPv6 CIDR block range of your subnet. You can't use this option if you're specifying a number of IPv6 addresses.
ltinisrIPv6Addresses ::
     Lens' LaunchTemplateInstanceNetworkInterfaceSpecificationRequest [InstanceIPv6AddressRequest]
ltinisrIPv6Addresses =
  lens _ltinisrIPv6Addresses (\s a -> s {_ltinisrIPv6Addresses = a}) .
  _Default . _Coerce

instance Hashable LaunchTemplateInstanceNetworkInterfaceSpecificationRequest

instance NFData LaunchTemplateInstanceNetworkInterfaceSpecificationRequest

instance ToQuery LaunchTemplateInstanceNetworkInterfaceSpecificationRequest where
...
ltoWeightedCapacity =
  lens _ltoWeightedCapacity (\s a -> s {_ltoWeightedCapacity = a})
...
ltoAvailabilityZone =
  lens _ltoAvailabilityZone (\s a -> s {_ltoAvailabilityZone = a})

instance FromXML LaunchTemplateOverrides where
  parseXML x =
    LaunchTemplateOverrides' <$> (x .@? "spotPrice") <*>
    (x .@? "weightedCapacity") <*>
    (x .@? "subnetId") <*>
    (x .@? "instanceType") <*>
    (x .@? "availabilityZone")
...
ltpAvailabilityZone =
  lens _ltpAvailabilityZone (\s a -> s {_ltpAvailabilityZone = a})
...
instance FromXML LaunchTemplatePlacement where
  parseXML x =
    LaunchTemplatePlacement' <$> (x .@? "affinity") <*> (x .@? "hostId") <*>
    (x .@? "spreadDomain") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "tenancy") <*>
    (x .@? "groupName")
...
ltprAvailabilityZone =
  lens _ltprAvailabilityZone (\s a -> s {_ltprAvailabilityZone = a})
...
ltsmoBlockDurationMinutes =
  lens _ltsmoBlockDurationMinutes (\s a -> s {_ltsmoBlockDurationMinutes = a})

-- | The behavior when a Spot Instance is interrupted.
ltsmoInstanceInterruptionBehavior ::
     Lens' LaunchTemplateSpotMarketOptions (Maybe InstanceInterruptionBehavior)
ltsmoInstanceInterruptionBehavior =
  lens
    _ltsmoInstanceInterruptionBehavior
    (\s a -> s {_ltsmoInstanceInterruptionBehavior = a})

-- | The end date of the request. For a one-time request, the request remains active until all instances launch, the request is canceled, or this date is reached. If the request is persistent, it remains active until it is canceled or this date and time is reached.
ltsmoValidUntil :: Lens' LaunchTemplateSpotMarketOptions (Maybe UTCTime)
ltsmoValidUntil =
  lens _ltsmoValidUntil (\s a -> s {_ltsmoValidUntil = a}) . mapping _Time

-- | The Spot Instance request type.
ltsmoSpotInstanceType ::
     Lens' LaunchTemplateSpotMarketOptions (Maybe SpotInstanceType)
ltsmoSpotInstanceType =
  lens _ltsmoSpotInstanceType (\s a -> s {_ltsmoSpotInstanceType = a})
...
instance FromXML LaunchTemplateSpotMarketOptions where
  parseXML x =
    LaunchTemplateSpotMarketOptions' <$> (x .@? "blockDurationMinutes") <*>
...
ltsmorBlockDurationMinutes ::
     Lens' LaunchTemplateSpotMarketOptionsRequest (Maybe Int)
ltsmorBlockDurationMinutes =
  lens _ltsmorBlockDurationMinutes (\s a -> s {_ltsmorBlockDurationMinutes = a})

-- | The behavior when a Spot Instance is interrupted. The default is @terminate@ .
ltsmorInstanceInterruptionBehavior ::
     Lens' LaunchTemplateSpotMarketOptionsRequest (Maybe InstanceInterruptionBehavior)
ltsmorInstanceInterruptionBehavior =
  lens
    _ltsmorInstanceInterruptionBehavior
    (\s a -> s {_ltsmorInstanceInterruptionBehavior = a})

-- | The end date of the request. For a one-time request, the request remains active until all instances launch, the request is canceled, or this date is reached. If the request is persistent, it remains active until it is canceled or this date and time is reached. The default end date is 7 days from the current date.
ltsmorValidUntil :: Lens' LaunchTemplateSpotMarketOptionsRequest (Maybe UTCTime)
ltsmorValidUntil =
  lens _ltsmorValidUntil (\s a -> s {_ltsmorValidUntil = a}) . mapping _Time

-- | The Spot Instance request type.
ltsmorSpotInstanceType ::
     Lens' LaunchTemplateSpotMarketOptionsRequest (Maybe SpotInstanceType)
ltsmorSpotInstanceType =
  lens _ltsmorSpotInstanceType (\s a -> s {_ltsmorSpotInstanceType = a})
...
instance ToQuery LaunchTemplateSpotMarketOptionsRequest where
  toQuery LaunchTemplateSpotMarketOptionsRequest' {..} =
    mconcat
      ...
      , "InstanceInterruptionBehavior" =: _ltsmorInstanceInterruptionBehavior
...
instance FromXML LaunchTemplateTagSpecification where
  parseXML x =
    LaunchTemplateTagSpecification' <$> (x .@? "resourceType") <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item"))
...
lttsrResourceType ::
     Lens' LaunchTemplateTagSpecificationRequest (Maybe ResourceType)
...
ltvLaunchTemplateName =
  lens _ltvLaunchTemplateName (\s a -> s {_ltvLaunchTemplateName = a})

-- | The ID of the launch template.
ltvLaunchTemplateId :: Lens' LaunchTemplateVersion (Maybe Text)
ltvLaunchTemplateId =
  lens _ltvLaunchTemplateId (\s a -> s {_ltvLaunchTemplateId = a})
...
ltvVersionDescription =
  lens _ltvVersionDescription (\s a -> s {_ltvVersionDescription = a})

-- | Information about the launch template.
ltvLaunchTemplateData ::
     Lens' LaunchTemplateVersion (Maybe ResponseLaunchTemplateData)
ltvLaunchTemplateData =
  lens _ltvLaunchTemplateData (\s a -> s {_ltvLaunchTemplateData = a})

-- | The time the version was created.
ltvCreateTime :: Lens' LaunchTemplateVersion (Maybe UTCTime)
ltvCreateTime =
  lens _ltvCreateTime (\s a -> s {_ltvCreateTime = a}) . mapping _Time

instance FromXML LaunchTemplateVersion where
  parseXML x =
    LaunchTemplateVersion' <$> (x .@? "launchTemplateName") <*>
    (x .@? "launchTemplateId") <*>
    (x .@? "createdBy") <*>
    (x .@? "defaultVersion") <*>
    (x .@? "versionNumber") <*>
...
lbcClassicLoadBalancersConfig ::
     Lens' LoadBalancersConfig (Maybe ClassicLoadBalancersConfig)
lbcClassicLoadBalancersConfig =
  lens
    _lbcClassicLoadBalancersConfig
    (\s a -> s {_lbcClassicLoadBalancersConfig = a})

-- | The target groups.
lbcTargetGroupsConfig :: Lens' LoadBalancersConfig (Maybe TargetGroupsConfig)
lbcTargetGroupsConfig =
  lens _lbcTargetGroupsConfig (\s a -> s {_lbcTargetGroupsConfig = a})

instance FromXML LoadBalancersConfig where
  parseXML x =
    LoadBalancersConfig' <$> (x .@? "classicLoadBalancersConfig") <*>
...
instance FromXML LoadPermission where
  parseXML x = LoadPermission' <$> (x .@? "group") <*> (x .@? "userId")
...
instance FromXML MovingAddressStatus where
  parseXML x =
    MovingAddressStatus' <$> (x .@? "moveStatus") <*> (x .@? "publicIp")
...
ngDeleteTime =
  lens _ngDeleteTime (\s a -> s {_ngDeleteTime = a}) . mapping _Time
...
ngProvisionedBandwidth =
  lens _ngProvisionedBandwidth (\s a -> s {_ngProvisionedBandwidth = a})

-- | Information about the IP addresses and network interface associated with the NAT gateway.
ngNatGatewayAddresses :: Lens' NatGateway [NatGatewayAddress]
ngNatGatewayAddresses =
  lens _ngNatGatewayAddresses (\s a -> s {_ngNatGatewayAddresses = a}) .
  _Default . _Coerce

-- | The date and time the NAT gateway was created.
ngCreateTime :: Lens' NatGateway (Maybe UTCTime)
ngCreateTime =
  lens _ngCreateTime (\s a -> s {_ngCreateTime = a}) . mapping _Time
...
instance FromXML NatGateway where
  parseXML x =
    NatGateway' <$> (x .@? "state") <*> (x .@? "failureCode") <*>
    (x .@? "vpcId") <*>
    (x .@? "failureMessage") <*>
    (x .@? "natGatewayId") <*>
    (x .@? "subnetId") <*>
    ...
    (x .@? "natGatewayAddressSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "createTime") <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item"))
...
ngaNetworkInterfaceId =
  lens _ngaNetworkInterfaceId (\s a -> s {_ngaNetworkInterfaceId = a})
...
instance FromXML NatGatewayAddress where
  parseXML x =
    NatGatewayAddress' <$> (x .@? "privateIp") <*> (x .@? "allocationId") <*>
    (x .@? "networkInterfaceId") <*>
    (x .@? "publicIp")
...
naAssociations =
  lens _naAssociations (\s a -> s {_naAssociations = a}) . _Default . _Coerce
...
instance FromXML NetworkACL where
  parseXML x =
    NetworkACL' <$> (x .@? "entrySet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "networkAclId") <*>
    (x .@? "vpcId") <*>
...
naaNetworkACLAssociationId =
  lens _naaNetworkACLAssociationId (\s a -> s {_naaNetworkACLAssociationId = a})

instance FromXML NetworkACLAssociation where
  parseXML x =
    NetworkACLAssociation' <$> (x .@? "networkAclId") <*> (x .@? "subnetId") <*>
...
instance FromXML NetworkACLEntry where
  parseXML x =
    NetworkACLEntry' <$> (x .@? "ipv6CidrBlock") <*> (x .@? "icmpTypeCode") <*>
    (x .@? "ruleNumber") <*>
    (x .@? "ruleAction") <*>
    (x .@? "protocol") <*>
    (x .@? "portRange") <*>
...
niPrivateIPAddresses ::
     Lens' NetworkInterface [NetworkInterfacePrivateIPAddress]
niPrivateIPAddresses =
...
instance FromXML NetworkInterfaceAssociation where
  parseXML x =
    NetworkInterfaceAssociation' <$> (x .@? "associationId") <*>
    (x .@? "publicDnsName") <*>
    (x .@? "allocationId") <*>
    (x .@? "ipOwnerId") <*>
    (x .@? "publicIp")
...
niaAttachTime =
  lens _niaAttachTime (\s a -> s {_niaAttachTime = a}) . mapping _Time
...
instance FromXML NetworkInterfaceAttachment where
  parseXML x =
    NetworkInterfaceAttachment' <$> (x .@? "instanceId") <*> (x .@? "status") <*>
    (x .@? "deleteOnTermination") <*>
    (x .@? "attachmentId") <*>
    (x .@? "instanceOwnerId") <*>
    (x .@? "attachTime") <*>
...
nipPermissionState ::
     Lens' NetworkInterfacePermission (Maybe NetworkInterfacePermissionState)
nipPermissionState =
  lens _nipPermissionState (\s a -> s {_nipPermissionState = a})
...
nipNetworkInterfacePermissionId =
  lens
    ...
    (\s a -> s {_nipNetworkInterfacePermissionId = a})

-- | The ID of the network interface.
nipNetworkInterfaceId :: Lens' NetworkInterfacePermission (Maybe Text)
nipNetworkInterfaceId =
  lens _nipNetworkInterfaceId (\s a -> s {_nipNetworkInterfaceId = a})
...
nipPermission ::
     Lens' NetworkInterfacePermission (Maybe InterfacePermissionType)
nipPermission = lens _nipPermission (\s a -> s {_nipPermission = a})

instance FromXML NetworkInterfacePermission where
  parseXML x =
    NetworkInterfacePermission' <$> (x .@? "permissionState") <*>
...
nipsState ::
     Lens' NetworkInterfacePermissionState (Maybe NetworkInterfacePermissionStateCode)
...
instance FromXML NetworkInterfacePermissionState where
  parseXML x =
    NetworkInterfacePermissionState' <$> (x .@? "state") <*>
    (x .@? "statusMessage")
...
instance ToQuery NewDHCPConfiguration where
  toQuery NewDHCPConfiguration' {..} =
    mconcat [toQuery (toQueryList "Value" <$> _ndcValues), "Key" =: _ndcKey]
...
piSubsystemVendorId =
  lens _piSubsystemVendorId (\s a -> s {_piSubsystemVendorId = a})
...
instance FromXML PciId where
  parseXML x =
    PciId' <$> (x .@? "SubsystemId") <*> (x .@? "DeviceId") <*>
    (x .@? "SubsystemVendorId") <*>
    (x .@? "VendorId")
...
pcoAllowEgressFromLocalVPCToRemoteClassicLink ::
     Lens' PeeringConnectionOptions (Maybe Bool)
pcoAllowEgressFromLocalVPCToRemoteClassicLink =
  lens
    _pcoAllowEgressFromLocalVPCToRemoteClassicLink
    (\s a -> s {_pcoAllowEgressFromLocalVPCToRemoteClassicLink = a})
...
pcoAllowEgressFromLocalClassicLinkToRemoteVPC =
  lens
    ...
    (\s a -> s {_pcoAllowEgressFromLocalClassicLinkToRemoteVPC = a})
...
pcoAllowDNSResolutionFromRemoteVPC =
  lens
    ...
    (\s a -> s {_pcoAllowDNSResolutionFromRemoteVPC = a})
...
pcorAllowEgressFromLocalVPCToRemoteClassicLink ::
     Lens' PeeringConnectionOptionsRequest (Maybe Bool)
pcorAllowEgressFromLocalVPCToRemoteClassicLink =
  lens
    _pcorAllowEgressFromLocalVPCToRemoteClassicLink
    (\s a -> s {_pcorAllowEgressFromLocalVPCToRemoteClassicLink = a})
...
pcorAllowEgressFromLocalClassicLinkToRemoteVPC =
  lens
    ...
    (\s a -> s {_pcorAllowEgressFromLocalClassicLinkToRemoteVPC = a})
...
pcorAllowDNSResolutionFromRemoteVPC =
  lens
    ...
    (\s a -> s {_pcorAllowDNSResolutionFromRemoteVPC = a})
...
instance FromXML PlacementGroup where
  parseXML x =
    PlacementGroup' <$> (x .@? "state") <*> (x .@? "strategy") <*>
    (x .@? "groupName")
...
instance FromXML PrefixList where
  parseXML x =
    PrefixList' <$> (x .@? "cidrSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "prefixListId") <*>
    (x .@? "prefixListName")
...
instance FromXML PrefixListId where
  parseXML x =
    PrefixListId' <$> (x .@? "prefixListId") <*> (x .@? "description")
...
instance ToQuery PrefixListId where
  toQuery PrefixListId' {..} =
    mconcat
      ["PrefixListId" =: _pliPrefixListId, "Description" =: _pliDescription]
...
instance FromXML PriceSchedule where
  parseXML x =
    PriceSchedule' <$> (x .@? "currencyCode") <*> (x .@? "term") <*>
    (x .@? "active") <*>
    (x .@? "price")
...
pifStatuses =
  lens _pifStatuses (\s a -> s {_pifStatuses = a}) . _Default . _Coerce

instance FromXML PrincipalIdFormat where
  parseXML x =
    PrincipalIdFormat' <$> (x .@? "arn") <*>
...
instance FromXML PrivateIPAddressSpecification where
  parseXML x =
    PrivateIPAddressSpecification' <$> (x .@? "primary") <*>
    (x .@ "privateIpAddress")
...
instance ToQuery PrivateIPAddressSpecification where
  toQuery PrivateIPAddressSpecification' {..} =
    mconcat
      ["Primary" =: _piasPrimary, "PrivateIpAddress" =: _piasPrivateIPAddress]
...
instance FromXML ProductCode where
  parseXML x = ProductCode' <$> (x .@? "type") <*> (x .@? "productCode")
...
pbRequestTime =
  lens _pbRequestTime (\s a -> s {_pbRequestTime = a}) . mapping _Time

-- | Reserved. If you need to sustain traffic greater than the <http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-nat-gateway.html documented limits> , contact us through the <https://console.aws.amazon.com/support/home? Support Center> .
pbProvisionTime :: Lens' ProvisionedBandwidth (Maybe UTCTime)
pbProvisionTime =
  lens _pbProvisionTime (\s a -> s {_pbProvisionTime = a}) . mapping _Time

instance FromXML ProvisionedBandwidth where
  parseXML x =
    ProvisionedBandwidth' <$> (x .@? "status") <*> (x .@? "requested") <*>
    (x .@? "provisioned") <*>
    (x .@? "requestTime") <*>
    (x .@? "provisionTime")
...
pHostReservationId =
  lens _pHostReservationId (\s a -> s {_pHostReservationId = a})
...
instance FromXML Purchase where
  parseXML x =
    Purchase' <$> (x .@? "instanceFamily") <*> (x .@? "currencyCode") <*>
    (x .@? "hostReservationId") <*>
    (x .@? "hourlyPrice") <*>
    (x .@? "upfrontPrice") <*>
    (x .@? "hostIdSet" .!@ mempty >>= may (parseXMLList "item")) <*>
...
instance ToQuery PurchaseRequest where
  toQuery PurchaseRequest' {..} =
    mconcat
      ["InstanceCount" =: _prInstanceCount, "PurchaseToken" =: _prPurchaseToken]
...
instance FromXML RecurringCharge where
  parseXML x = RecurringCharge' <$> (x .@? "amount") <*> (x .@? "frequency")
...
instance FromXML RegionInfo where
  parseXML x = RegionInfo' <$> (x .@? "regionName") <*> (x .@? "regionEndpoint")
...
rltdSecurityGroupIds =
  lens _rltdSecurityGroupIds (\s a -> s {_rltdSecurityGroupIds = a}) .
  _Default . _Coerce

-- | [EC2-Classic, default VPC] One or more security group names. For a nondefault VPC, you must use security group IDs instead. You cannot specify both a security group ID and security name in the same request.
rltdSecurityGroups :: Lens' RequestLaunchTemplateData [Text]
rltdSecurityGroups =
  lens _rltdSecurityGroups (\s a -> s {_rltdSecurityGroups = a}) .
  _Default . _Coerce

-- | The market (purchasing) option for the instances.
rltdInstanceMarketOptions ::
     Lens' RequestLaunchTemplateData (Maybe LaunchTemplateInstanceMarketOptionsRequest)
rltdInstanceMarketOptions =
  lens _rltdInstanceMarketOptions (\s a -> s {_rltdInstanceMarketOptions = a})
...
rltdDisableAPITermination =
  lens _rltdDisableAPITermination (\s a -> s {_rltdDisableAPITermination = a})
...
rltdNetworkInterfaces ::
     Lens' RequestLaunchTemplateData [LaunchTemplateInstanceNetworkInterfaceSpecificationRequest]
rltdNetworkInterfaces =
  lens _rltdNetworkInterfaces (\s a -> s {_rltdNetworkInterfaces = a}) .
  _Default . _Coerce
...
rltdElasticGpuSpecifications ::
     Lens' RequestLaunchTemplateData [ElasticGpuSpecification]
rltdElasticGpuSpecifications =
  lens
    _rltdElasticGpuSpecifications
    (\s a -> s {_rltdElasticGpuSpecifications = a}) .
  _Default . _Coerce
...
-- | The monitoring for the instance.
rltdMonitoring ::
     Lens' RequestLaunchTemplateData (Maybe LaunchTemplatesMonitoringRequest)
...
rltdTagSpecifications ::
     Lens' RequestLaunchTemplateData [LaunchTemplateTagSpecificationRequest]
rltdTagSpecifications =
  lens _rltdTagSpecifications (\s a -> s {_rltdTagSpecifications = a}) .
  _Default . _Coerce

-- | The IAM instance profile.
rltdIAMInstanceProfile ::
     Lens' RequestLaunchTemplateData (Maybe LaunchTemplateIAMInstanceProfileSpecificationRequest)
rltdIAMInstanceProfile =
  lens _rltdIAMInstanceProfile (\s a -> s {_rltdIAMInstanceProfile = a})
...
rltdInstanceInitiatedShutdownBehavior ::
     Lens' RequestLaunchTemplateData (Maybe ShutdownBehavior)
rltdInstanceInitiatedShutdownBehavior =
  lens
    _rltdInstanceInitiatedShutdownBehavior
    (\s a -> s {_rltdInstanceInitiatedShutdownBehavior = a})

-- | The credit option for CPU usage of the instance. Valid for T2 instances only.
rltdCreditSpecification ::
     Lens' RequestLaunchTemplateData (Maybe CreditSpecificationRequest)
rltdCreditSpecification =
  lens _rltdCreditSpecification (\s a -> s {_rltdCreditSpecification = a})

-- | The block device mapping. /Important:/ Supplying both a snapshot ID and an encryption value as arguments for block-device mapping results in an error. This is because only blank volumes can be encrypted on start, and these are not created from a snapshot. If a snapshot is the basis for the volume, it contains data by definition and its encryption status cannot be changed using this action.
rltdBlockDeviceMappings ::
     Lens' RequestLaunchTemplateData [LaunchTemplateBlockDeviceMappingRequest]
rltdBlockDeviceMappings =
  lens _rltdBlockDeviceMappings (\s a -> s {_rltdBlockDeviceMappings = a}) .
  _Default . _Coerce

-- | The placement for the instance.
rltdPlacement ::
     Lens' RequestLaunchTemplateData (Maybe LaunchTemplatePlacementRequest)
...
instance ToQuery RequestLaunchTemplateData where
  toQuery RequestLaunchTemplateData' {..} =
    mconcat
      ...
      , toQuery (toQueryList "NetworkInterface" <$> _rltdNetworkInterfaces)
      ...
      , toQuery (toQueryList "TagSpecification" <$> _rltdTagSpecifications)
      , "IamInstanceProfile" =: _rltdIAMInstanceProfile
      , "ImageId" =: _rltdImageId
      , "InstanceInitiatedShutdownBehavior" =:
        _rltdInstanceInitiatedShutdownBehavior
      , "CreditSpecification" =: _rltdCreditSpecification
      , toQuery (toQueryList "BlockDeviceMapping" <$> _rltdBlockDeviceMappings)
...
rslsNetworkInterfaces ::
     Lens' RequestSpotLaunchSpecification [InstanceNetworkInterfaceSpecification]
rslsNetworkInterfaces =
...
rslsMonitoring ::
     Lens' RequestSpotLaunchSpecification (Maybe RunInstancesMonitoringEnabled)
...
rslsBlockDeviceMappings ::
     Lens' RequestSpotLaunchSpecification [BlockDeviceMapping]
rslsBlockDeviceMappings =
...
instance ToQuery RequestSpotLaunchSpecification where
  toQuery RequestSpotLaunchSpecification' {..} =
    mconcat
      ...
      , toQuery (toQueryList "NetworkInterface" <$> _rslsNetworkInterfaces)
      ...
      , toQuery (toQueryList "BlockDeviceMapping" <$> _rslsBlockDeviceMappings)
...
instance FromXML Reservation where
  parseXML x =
    Reservation' <$> (x .@? "groupSet" .!@ mempty >>= may (parseXMLList "item")) <*>
...
rvRemainingTotalValue =
  lens _rvRemainingTotalValue (\s a -> s {_rvRemainingTotalValue = a})

-- | The remaining upfront cost of the reservation.
rvRemainingUpfrontValue :: Lens' ReservationValue (Maybe Text)
rvRemainingUpfrontValue =
  lens _rvRemainingUpfrontValue (\s a -> s {_rvRemainingUpfrontValue = a})

instance FromXML ReservationValue where
  parseXML x =
    ReservationValue' <$> (x .@? "hourlyPrice") <*>
...
rirvReservationValue ::
     Lens' ReservedInstanceReservationValue (Maybe ReservationValue)
rirvReservationValue =
  lens _rirvReservationValue (\s a -> s {_rirvReservationValue = a})

-- | The ID of the Convertible Reserved Instance that you are exchanging.
rirvReservedInstanceId :: Lens' ReservedInstanceReservationValue (Maybe Text)
rirvReservedInstanceId =
  lens _rirvReservedInstanceId (\s a -> s {_rirvReservedInstanceId = a})

instance FromXML ReservedInstanceReservationValue where
  parseXML x =
    ReservedInstanceReservationValue' <$> (x .@? "reservationValue") <*>
...
instance FromXML ReservedInstances where
  parseXML x =
    ReservedInstances' <$> (x .@? "state") <*> (x .@? "currencyCode") <*>
    (x .@? "instanceCount") <*>
...
instance FromXML ReservedInstancesConfiguration where
  parseXML x =
    ReservedInstancesConfiguration' <$> (x .@? "platform") <*>
    (x .@? "instanceCount") <*>
    (x .@? "instanceType") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "scope")
...
rilUpdateDate =
  lens _rilUpdateDate (\s a -> s {_rilUpdateDate = a}) . mapping _Time

-- | The time the listing was created.
rilCreateDate :: Lens' ReservedInstancesListing (Maybe UTCTime)
rilCreateDate =
  lens _rilCreateDate (\s a -> s {_rilCreateDate = a}) . mapping _Time
...
instance FromXML ReservedInstancesListing where
  parseXML x =
    ReservedInstancesListing' <$> (x .@? "status") <*> (x .@? "clientToken") <*>
    (x .@? "updateDate") <*>
    (x .@? "createDate") <*>
...
rimModificationResults ::
     Lens' ReservedInstancesModification [ReservedInstancesModificationResult]
rimModificationResults =
...
rimUpdateDate =
  lens _rimUpdateDate (\s a -> s {_rimUpdateDate = a}) . mapping _Time

-- | The time when the modification request was created.
rimCreateDate :: Lens' ReservedInstancesModification (Maybe UTCTime)
rimCreateDate =
  lens _rimCreateDate (\s a -> s {_rimCreateDate = a}) . mapping _Time

-- | The time for the modification to become effective.
rimEffectiveDate :: Lens' ReservedInstancesModification (Maybe UTCTime)
rimEffectiveDate =
  lens _rimEffectiveDate (\s a -> s {_rimEffectiveDate = a}) . mapping _Time
...
rimReservedInstancesModificationId ::
     Lens' ReservedInstancesModification (Maybe Text)
rimReservedInstancesModificationId =
  lens
...
rimReservedInstancesIds ::
     Lens' ReservedInstancesModification [ReservedInstancesId]
rimReservedInstancesIds =
...
instance FromXML ReservedInstancesModification where
  parseXML x =
    ReservedInstancesModification' <$>
    (x .@? "modificationResultSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "status") <*>
    (x .@? "clientToken") <*>
    (x .@? "updateDate") <*>
    (x .@? "createDate") <*>
    ...
    (x .@? "reservedInstancesSet" .!@ mempty >>= may (parseXMLList "item"))
...
rioProductDescription ::
     Lens' ReservedInstancesOffering (Maybe RIProductDescription)
rioProductDescription =
...
instance FromXML ReservedInstancesOffering where
  parseXML x =
    ReservedInstancesOffering' <$> (x .@? "marketplace") <*>
    (x .@? "currencyCode") <*>
    (x .@? "productDescription") <*>
    (x .@? "instanceType") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "pricingDetailsSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "scope") <*>
    (x .@? "recurringCharges" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "offeringType") <*>
    (x .@? "usagePrice") <*>
...
instance FromXML ResponseError where
  parseXML x = ResponseError' <$> (x .@? "code") <*> (x .@? "message")
...
rSecurityGroupIds =
  lens _rSecurityGroupIds (\s a -> s {_rSecurityGroupIds = a}) .
  _Default . _Coerce

-- | The security group names.
rSecurityGroups :: Lens' ResponseLaunchTemplateData [Text]
rSecurityGroups =
  lens _rSecurityGroups (\s a -> s {_rSecurityGroups = a}) . _Default . _Coerce

-- | The market (purchasing) option for the instances.
rInstanceMarketOptions ::
     Lens' ResponseLaunchTemplateData (Maybe LaunchTemplateInstanceMarketOptions)
rInstanceMarketOptions =
  lens _rInstanceMarketOptions (\s a -> s {_rInstanceMarketOptions = a})

-- | If set to @true@ , indicates that the instance cannot be terminated using the Amazon EC2 console, command line tool, or API.
rDisableAPITermination :: Lens' ResponseLaunchTemplateData (Maybe Bool)
rDisableAPITermination =
  lens _rDisableAPITermination (\s a -> s {_rDisableAPITermination = a})
...
rNetworkInterfaces ::
     Lens' ResponseLaunchTemplateData [LaunchTemplateInstanceNetworkInterfaceSpecification]
rNetworkInterfaces =
  lens _rNetworkInterfaces (\s a -> s {_rNetworkInterfaces = a}) .
  _Default . _Coerce
...
rElasticGpuSpecifications ::
     Lens' ResponseLaunchTemplateData [ElasticGpuSpecificationResponse]
rElasticGpuSpecifications =
  lens _rElasticGpuSpecifications (\s a -> s {_rElasticGpuSpecifications = a}) .
  _Default . _Coerce
...
-- | The monitoring for the instance.
rMonitoring ::
     Lens' ResponseLaunchTemplateData (Maybe LaunchTemplatesMonitoring)
rMonitoring = lens _rMonitoring (\s a -> s {_rMonitoring = a})

-- | The tags.
rTagSpecifications ::
     Lens' ResponseLaunchTemplateData [LaunchTemplateTagSpecification]
rTagSpecifications =
  lens _rTagSpecifications (\s a -> s {_rTagSpecifications = a}) .
  _Default . _Coerce

-- | The IAM instance profile.
rIAMInstanceProfile ::
     Lens' ResponseLaunchTemplateData (Maybe LaunchTemplateIAMInstanceProfileSpecification)
rIAMInstanceProfile =
  lens _rIAMInstanceProfile (\s a -> s {_rIAMInstanceProfile = a})
...
rInstanceInitiatedShutdownBehavior ::
     Lens' ResponseLaunchTemplateData (Maybe ShutdownBehavior)
rInstanceInitiatedShutdownBehavior =
  lens
    _rInstanceInitiatedShutdownBehavior
    (\s a -> s {_rInstanceInitiatedShutdownBehavior = a})

-- | The credit option for CPU usage of the instance.
rCreditSpecification ::
     Lens' ResponseLaunchTemplateData (Maybe CreditSpecification)
rCreditSpecification =
  lens _rCreditSpecification (\s a -> s {_rCreditSpecification = a})

-- | The block device mappings.
rBlockDeviceMappings ::
     Lens' ResponseLaunchTemplateData [LaunchTemplateBlockDeviceMapping]
rBlockDeviceMappings =
  lens _rBlockDeviceMappings (\s a -> s {_rBlockDeviceMappings = a}) .
  _Default . _Coerce
...
instance FromXML ResponseLaunchTemplateData where
  parseXML x =
    ResponseLaunchTemplateData' <$>
    (x .@? "securityGroupIdSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    ...
    (x .@? "ramDiskId") <*>
    (x .@? "kernelId") <*>
    (x .@? "elasticGpuSpecificationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "instanceType") <*>
    (x .@? "ebsOptimized") <*>
    (x .@? "userData") <*>
    (x .@? "monitoring") <*>
    (x .@? "tagSpecificationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "iamInstanceProfile") <*>
    (x .@? "imageId") <*>
    (x .@? "instanceInitiatedShutdownBehavior") <*>
    (x .@? "creditSpecification") <*>
    (x .@? "blockDeviceMappingSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "placement")
...
rEgressOnlyInternetGatewayId =
  lens
    _rEgressOnlyInternetGatewayId
    (\s a -> s {_rEgressOnlyInternetGatewayId = a})

-- | The IPv6 CIDR block used for the destination match.
rDestinationIPv6CidrBlock :: Lens' Route (Maybe Text)
rDestinationIPv6CidrBlock =
  lens _rDestinationIPv6CidrBlock (\s a -> s {_rDestinationIPv6CidrBlock = a})
...
rDestinationPrefixListId =
  lens _rDestinationPrefixListId (\s a -> s {_rDestinationPrefixListId = a})
...
instance FromXML Route where
  parseXML x =
    Route' <$> (x .@? "vpcPeeringConnectionId") <*> (x .@? "instanceId") <*>
    (x .@? "origin") <*>
    (x .@? "state") <*>
...
rtAssociations =
  lens _rtAssociations (\s a -> s {_rtAssociations = a}) . _Default . _Coerce
...
instance FromXML RouteTable where
  parseXML x =
    RouteTable' <$> (x .@? "routeTableId") <*>
    (x .@? "routeSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "vpcId") <*>
    (x .@? "propagatingVgwSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "associationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item"))
...
rtaRouteTableAssociationId =
  lens _rtaRouteTableAssociationId (\s a -> s {_rtaRouteTableAssociationId = a})
...
instance FromXML RouteTableAssociation where
  parseXML x =
    RouteTableAssociation' <$> (x .@? "routeTableId") <*>
...
ssUploadPolicy =
  lens _ssUploadPolicy (\s a -> s {_ssUploadPolicy = a}) . mapping _Base64
...
instance FromXML S3Storage where
  parseXML x =
    S3Storage' <$> (x .@? "prefix") <*> (x .@? "uploadPolicy") <*>
    (x .@? "bucket") <*>
...
siPreviousSlotEndTime =
  lens _siPreviousSlotEndTime (\s a -> s {_siPreviousSlotEndTime = a}) .
  mapping _Time
...
siTermStartDate =
  lens _siTermStartDate (\s a -> s {_siTermStartDate = a}) . mapping _Time
...
siScheduledInstanceId =
  lens _siScheduledInstanceId (\s a -> s {_siScheduledInstanceId = a})
...
siCreateDate =
  lens _siCreateDate (\s a -> s {_siCreateDate = a}) . mapping _Time

-- | The number of hours in the schedule.
siSlotDurationInHours :: Lens' ScheduledInstance (Maybe Int)
siSlotDurationInHours =
  lens _siSlotDurationInHours (\s a -> s {_siSlotDurationInHours = a})
...
siTotalScheduledInstanceHours =
  lens
    ...
    (\s a -> s {_siTotalScheduledInstanceHours = a})
...
siAvailabilityZone =
  lens _siAvailabilityZone (\s a -> s {_siAvailabilityZone = a})

-- | The end date for the Scheduled Instance.
siTermEndDate :: Lens' ScheduledInstance (Maybe UTCTime)
siTermEndDate =
  lens _siTermEndDate (\s a -> s {_siTermEndDate = a}) . mapping _Time

-- | The time for the next schedule to start.
siNextSlotStartTime :: Lens' ScheduledInstance (Maybe UTCTime)
siNextSlotStartTime =
  lens _siNextSlotStartTime (\s a -> s {_siNextSlotStartTime = a}) .
  mapping _Time
...
instance FromXML ScheduledInstance where
  parseXML x =
    ScheduledInstance' <$> (x .@? "previousSlotEndTime") <*> (x .@? "platform") <*>
    (x .@? "termStartDate") <*>
    (x .@? "instanceCount") <*>
...
siaMaxTermDurationInDays =
  lens _siaMaxTermDurationInDays (\s a -> s {_siaMaxTermDurationInDays = a})
...
siaAvailableInstanceCount =
  lens _siaAvailableInstanceCount (\s a -> s {_siaAvailableInstanceCount = a})

-- | The number of hours in the schedule.
siaSlotDurationInHours :: Lens' ScheduledInstanceAvailability (Maybe Int)
siaSlotDurationInHours =
  lens _siaSlotDurationInHours (\s a -> s {_siaSlotDurationInHours = a})

-- | The total number of hours for a single instance for the entire term.
siaTotalScheduledInstanceHours ::
     Lens' ScheduledInstanceAvailability (Maybe Int)
siaTotalScheduledInstanceHours =
  lens
    _siaTotalScheduledInstanceHours
    (\s a -> s {_siaTotalScheduledInstanceHours = a})
...
-- | The schedule recurrence.
siaRecurrence ::
     Lens' ScheduledInstanceAvailability (Maybe ScheduledInstanceRecurrence)
...
sirOccurrenceRelativeToEnd =
  lens _sirOccurrenceRelativeToEnd (\s a -> s {_sirOccurrenceRelativeToEnd = a})
...
sirOccurrenceDaySet =
  lens _sirOccurrenceDaySet (\s a -> s {_sirOccurrenceDaySet = a}) .
  _Default . _Coerce

instance FromXML ScheduledInstanceRecurrence where
  parseXML x =
    ScheduledInstanceRecurrence' <$> (x .@? "frequency") <*>
...
sibdmEBS ::
     Lens' ScheduledInstancesBlockDeviceMapping (Maybe ScheduledInstancesEBS)
...
sieDeleteOnTermination =
  lens _sieDeleteOnTermination (\s a -> s {_sieDeleteOnTermination = a})
...
silsSecurityGroupIds =
  lens _silsSecurityGroupIds (\s a -> s {_silsSecurityGroupIds = a}) .
  _Default . _Coerce
...
silsNetworkInterfaces ::
     Lens' ScheduledInstancesLaunchSpecification [ScheduledInstancesNetworkInterface]
silsNetworkInterfaces =
  lens _silsNetworkInterfaces (\s a -> s {_silsNetworkInterfaces = a}) .
  _Default . _Coerce
...
silsMonitoring ::
     Lens' ScheduledInstancesLaunchSpecification (Maybe ScheduledInstancesMonitoring)
silsMonitoring = lens _silsMonitoring (\s a -> s {_silsMonitoring = a})

-- | The IAM instance profile.
silsIAMInstanceProfile ::
     Lens' ScheduledInstancesLaunchSpecification (Maybe ScheduledInstancesIAMInstanceProfile)
silsIAMInstanceProfile =
  lens _silsIAMInstanceProfile (\s a -> s {_silsIAMInstanceProfile = a})

-- | One or more block device mapping entries.
silsBlockDeviceMappings ::
     Lens' ScheduledInstancesLaunchSpecification [ScheduledInstancesBlockDeviceMapping]
silsBlockDeviceMappings =
  lens _silsBlockDeviceMappings (\s a -> s {_silsBlockDeviceMappings = a}) .
  _Default . _Coerce

-- | The placement information.
silsPlacement ::
     Lens' ScheduledInstancesLaunchSpecification (Maybe ScheduledInstancesPlacement)
...
instance ToQuery ScheduledInstancesLaunchSpecification where
  toQuery ScheduledInstancesLaunchSpecification' {..} =
    mconcat
      ...
      , toQuery (toQueryList "NetworkInterface" <$> _silsNetworkInterfaces)
      ...
      , toQuery (toQueryList "BlockDeviceMapping" <$> _silsBlockDeviceMappings)
...
siniDeleteOnTermination =
  lens _siniDeleteOnTermination (\s a -> s {_siniDeleteOnTermination = a})

-- | Indicates whether to assign a public IPv4 address to instances launched in a VPC. The public IPv4 address can only be assigned to a network interface for eth0, and can only be assigned to a new network interface, not an existing one. You cannot specify more than one network interface in the request. If launching into a default subnet, the default value is @true@ .
siniAssociatePublicIPAddress ::
     Lens' ScheduledInstancesNetworkInterface (Maybe Bool)
siniAssociatePublicIPAddress =
  lens
    _siniAssociatePublicIPAddress
    (\s a -> s {_siniAssociatePublicIPAddress = a})

-- | The private IPv4 addresses.
siniPrivateIPAddressConfigs ::
     Lens' ScheduledInstancesNetworkInterface [ScheduledInstancesPrivateIPAddressConfig]
siniPrivateIPAddressConfigs =
  lens
    _siniPrivateIPAddressConfigs
    (\s a -> s {_siniPrivateIPAddressConfigs = a}) .
  _Default . _Coerce

-- | The ID of the network interface.
siniNetworkInterfaceId :: Lens' ScheduledInstancesNetworkInterface (Maybe Text)
siniNetworkInterfaceId =
  lens _siniNetworkInterfaceId (\s a -> s {_siniNetworkInterfaceId = a})
...
siniIPv6AddressCount =
  lens _siniIPv6AddressCount (\s a -> s {_siniIPv6AddressCount = a})

-- | The IPv4 address of the network interface within the subnet.
siniPrivateIPAddress :: Lens' ScheduledInstancesNetworkInterface (Maybe Text)
siniPrivateIPAddress =
  lens _siniPrivateIPAddress (\s a -> s {_siniPrivateIPAddress = a})

-- | The number of secondary private IPv4 addresses.
siniSecondaryPrivateIPAddressCount ::
     Lens' ScheduledInstancesNetworkInterface (Maybe Int)
siniSecondaryPrivateIPAddressCount =
  lens
    _siniSecondaryPrivateIPAddressCount
    (\s a -> s {_siniSecondaryPrivateIPAddressCount = a})
...
siniIPv6Addresses ::
     Lens' ScheduledInstancesNetworkInterface [ScheduledInstancesIPv6Address]
siniIPv6Addresses =
  lens _siniIPv6Addresses (\s a -> s {_siniIPv6Addresses = a}) .
  _Default . _Coerce
...
instance ToQuery ScheduledInstancesNetworkInterface where
  toQuery ScheduledInstancesNetworkInterface' {..} =
    mconcat
      ...
      , toQuery
          (toQueryList "PrivateIpAddressConfig" <$> _siniPrivateIPAddressConfigs)
      ...
      , "SecondaryPrivateIpAddressCount" =: _siniSecondaryPrivateIPAddressCount
...
sipAvailabilityZone =
  lens _sipAvailabilityZone (\s a -> s {_sipAvailabilityZone = a})
...
instance ToQuery ScheduledInstancesPlacement where
  toQuery ScheduledInstancesPlacement' {..} =
    mconcat
      ["AvailabilityZone" =: _sipAvailabilityZone, "GroupName" =: _sipGroupName]
...
sipiacPrivateIPAddress ::
     Lens' ScheduledInstancesPrivateIPAddressConfig (Maybe Text)
sipiacPrivateIPAddress =
  lens _sipiacPrivateIPAddress (\s a -> s {_sipiacPrivateIPAddress = a})
...
sgIPPermissions =
  lens _sgIPPermissions (\s a -> s {_sgIPPermissions = a}) . _Default . _Coerce
...
instance FromXML SecurityGroup where
  parseXML x =
    SecurityGroup' <$> (x .@? "vpcId") <*>
    (x .@? "ipPermissions" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "ipPermissionsEgress" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@ "ownerId") <*>
    (x .@ "groupId") <*>
    (x .@ "groupName") <*>
...
instance FromXML SecurityGroupIdentifier where
  parseXML x =
    SecurityGroupIdentifier' <$> (x .@? "groupId") <*> (x .@? "groupName")
...
sgrVPCPeeringConnectionId =
  lens _sgrVPCPeeringConnectionId (\s a -> s {_sgrVPCPeeringConnectionId = a})
...
sgrReferencingVPCId =
  lens _sgrReferencingVPCId (\s a -> s {_sgrReferencingVPCId = a})

instance FromXML SecurityGroupReference where
  parseXML x =
    SecurityGroupReference' <$> (x .@? "vpcPeeringConnectionId") <*>
    (x .@ "groupId") <*>
    (x .@ "referencingVpcId")
...
scNetworkLoadBalancerARNs =
  lens _scNetworkLoadBalancerARNs (\s a -> s {_scNetworkLoadBalancerARNs = a}) .
  _Default . _Coerce

-- | The DNS names for the service.
scBaseEndpointDNSNames :: Lens' ServiceConfiguration [Text]
scBaseEndpointDNSNames =
  lens _scBaseEndpointDNSNames (\s a -> s {_scBaseEndpointDNSNames = a}) .
  _Default . _Coerce

-- | In the Availability Zones in which the service is available.
scAvailabilityZones :: Lens' ServiceConfiguration [Text]
scAvailabilityZones =
  lens _scAvailabilityZones (\s a -> s {_scAvailabilityZones = a}) .
  _Default . _Coerce
...
scServiceType =
  lens _scServiceType (\s a -> s {_scServiceType = a}) . _Default . _Coerce

-- | Indicates whether requests from other AWS accounts to create an endpoint to the service must first be accepted.
scAcceptanceRequired :: Lens' ServiceConfiguration (Maybe Bool)
scAcceptanceRequired =
  lens _scAcceptanceRequired (\s a -> s {_scAcceptanceRequired = a})
...
instance FromXML ServiceConfiguration where
  parseXML x =
    ServiceConfiguration' <$>
    (x .@? "networkLoadBalancerArnSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "baseEndpointDnsNameSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "availabilityZoneSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "serviceName") <*>
    (x .@? "serviceState") <*>
...
sdVPCEndpointPolicySupported =
  lens
    ...
    (\s a -> s {_sdVPCEndpointPolicySupported = a})

-- | The DNS names for the service.
sdBaseEndpointDNSNames :: Lens' ServiceDetail [Text]
sdBaseEndpointDNSNames =
  lens _sdBaseEndpointDNSNames (\s a -> s {_sdBaseEndpointDNSNames = a}) .
  _Default . _Coerce
...
sdAvailabilityZones =
  lens _sdAvailabilityZones (\s a -> s {_sdAvailabilityZones = a}) .
  _Default . _Coerce
...
sdServiceType =
  lens _sdServiceType (\s a -> s {_sdServiceType = a}) . _Default . _Coerce

-- | Indicates whether VPC endpoint connection requests to the service must be accepted by the service owner.
sdAcceptanceRequired :: Lens' ServiceDetail (Maybe Bool)
sdAcceptanceRequired =
  lens _sdAcceptanceRequired (\s a -> s {_sdAcceptanceRequired = a})
...
instance FromXML ServiceDetail where
  parseXML x =
    ServiceDetail' <$> (x .@? "vpcEndpointPolicySupported") <*>
    (x .@? "baseEndpointDnsNameSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "owner") <*>
    (x .@? "availabilityZoneSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "serviceName") <*>
...
sdtrrEarliestTime =
  lens _sdtrrEarliestTime (\s a -> s {_sdtrrEarliestTime = a}) . _Time

-- | The latest date and time, in UTC, for the Scheduled Instance to start. This value must be later than or equal to the earliest date and at most three months in the future.
sdtrrLatestTime :: Lens' SlotDateTimeRangeRequest UTCTime
sdtrrLatestTime =
  lens _sdtrrLatestTime (\s a -> s {_sdtrrLatestTime = a}) . _Time
...
instance ToQuery SlotDateTimeRangeRequest where
  toQuery SlotDateTimeRangeRequest' {..} =
    mconcat
      ["EarliestTime" =: _sdtrrEarliestTime, "LatestTime" =: _sdtrrLatestTime]
...
sstrrLatestTime =
  lens _sstrrLatestTime (\s a -> s {_sstrrLatestTime = a}) . mapping _Time

-- | The earliest date and time, in UTC, for the Scheduled Instance to start.
sstrrEarliestTime :: Lens' SlotStartTimeRangeRequest (Maybe UTCTime)
sstrrEarliestTime =
  lens _sstrrEarliestTime (\s a -> s {_sstrrEarliestTime = a}) . mapping _Time
...
instance ToQuery SlotStartTimeRangeRequest where
  toQuery SlotStartTimeRangeRequest' {..} =
    mconcat
      ["LatestTime" =: _sstrrLatestTime, "EarliestTime" =: _sstrrEarliestTime]
...
sDataEncryptionKeyId =
  lens _sDataEncryptionKeyId (\s a -> s {_sDataEncryptionKeyId = a})
...
instance FromXML Snapshot where
  parseXML x =
    Snapshot' <$> (x .@? "statusMessage") <*> (x .@? "ownerAlias") <*>
...
instance FromXML SnapshotDetail where
  parseXML x =
    SnapshotDetail' <$> (x .@? "status") <*> (x .@? "progress") <*>
    (x .@? "format") <*>
    (x .@? "url") <*>
    (x .@? "deviceName") <*>
    (x .@? "statusMessage") <*>
...
instance FromXML SnapshotTaskDetail where
  parseXML x =
    SnapshotTaskDetail' <$> (x .@? "status") <*> (x .@? "progress") <*>
    (x .@? "format") <*>
    (x .@? "url") <*>
    (x .@? "statusMessage") <*>
    (x .@? "userBucket") <*>
...
instance FromXML SpotDatafeedSubscription where
  parseXML x =
    SpotDatafeedSubscription' <$> (x .@? "state") <*> (x .@? "prefix") <*>
    (x .@? "bucket") <*>
    (x .@? "ownerId") <*>
    (x .@? "fault")
...
sflsSecurityGroups =
  lens _sflsSecurityGroups (\s a -> s {_sflsSecurityGroups = a}) .
  _Default . _Coerce
...
sflsWeightedCapacity =
  lens _sflsWeightedCapacity (\s a -> s {_sflsWeightedCapacity = a})
...
sflsNetworkInterfaces ::
     Lens' SpotFleetLaunchSpecification [InstanceNetworkInterfaceSpecification]
sflsNetworkInterfaces =
  lens _sflsNetworkInterfaces (\s a -> s {_sflsNetworkInterfaces = a}) .
  _Default . _Coerce
...
sflsTagSpecifications ::
     Lens' SpotFleetLaunchSpecification [SpotFleetTagSpecification]
sflsTagSpecifications =
  lens _sflsTagSpecifications (\s a -> s {_sflsTagSpecifications = a}) .
  _Default . _Coerce

-- | The IAM instance profile.
sflsIAMInstanceProfile ::
     Lens' SpotFleetLaunchSpecification (Maybe IAMInstanceProfileSpecification)
sflsIAMInstanceProfile =
  lens _sflsIAMInstanceProfile (\s a -> s {_sflsIAMInstanceProfile = a})
...
sflsAddressingType =
  lens _sflsAddressingType (\s a -> s {_sflsAddressingType = a})

-- | One or more block device mapping entries. You can't specify both a snapshot ID and an encryption value. This is because only blank volumes can be encrypted on creation. If a snapshot is the basis for a volume, it is not blank and its encryption status is used for the volume encryption status.
sflsBlockDeviceMappings ::
     Lens' SpotFleetLaunchSpecification [BlockDeviceMapping]
sflsBlockDeviceMappings =
  lens _sflsBlockDeviceMappings (\s a -> s {_sflsBlockDeviceMappings = a}) .
  _Default . _Coerce
...
instance ToQuery SpotFleetLaunchSpecification where
  toQuery SpotFleetLaunchSpecification' {..} =
    mconcat
      ...
      , toQuery (toQueryList "NetworkInterfaceSet" <$> _sflsNetworkInterfaces)
      ...
      , toQuery (toQueryList "TagSpecificationSet" <$> _sflsTagSpecifications)
      , "IamInstanceProfile" =: _sflsIAMInstanceProfile
      , "ImageId" =: _sflsImageId
      , "AddressingType" =: _sflsAddressingType
      , toQuery (toQueryList "BlockDeviceMapping" <$> _sflsBlockDeviceMappings)
...
instance ToQuery SpotFleetMonitoring where
  toQuery SpotFleetMonitoring' {..} = mconcat ["Enabled" =: _sfmEnabled]
...
sfrcActivityStatus =
  lens _sfrcActivityStatus (\s a -> s {_sfrcActivityStatus = a})
...
sfrcSpotFleetRequestConfig ::
     Lens' SpotFleetRequestConfig SpotFleetRequestConfigData
sfrcSpotFleetRequestConfig =
  lens _sfrcSpotFleetRequestConfig (\s a -> s {_sfrcSpotFleetRequestConfig = a})
...
sfrcSpotFleetRequestState =
  lens _sfrcSpotFleetRequestState (\s a -> s {_sfrcSpotFleetRequestState = a})

instance FromXML SpotFleetRequestConfig where
  parseXML x =
    SpotFleetRequestConfig' <$> (x .@? "activityStatus") <*> (x .@ "createTime") <*>
...
sfrcdInstanceInterruptionBehavior ::
     Lens' SpotFleetRequestConfigData (Maybe InstanceInterruptionBehavior)
sfrcdInstanceInterruptionBehavior =
  lens
    _sfrcdInstanceInterruptionBehavior
    (\s a -> s {_sfrcdInstanceInterruptionBehavior = a})
...
sfrcdLoadBalancersConfig ::
     Lens' SpotFleetRequestConfigData (Maybe LoadBalancersConfig)
sfrcdLoadBalancersConfig =
  lens _sfrcdLoadBalancersConfig (\s a -> s {_sfrcdLoadBalancersConfig = a})

-- | Indicates whether running Spot Instances should be terminated if the target capacity of the Spot Fleet request is decreased below the current size of the Spot Fleet.
sfrcdExcessCapacityTerminationPolicy ::
     Lens' SpotFleetRequestConfigData (Maybe ExcessCapacityTerminationPolicy)
sfrcdExcessCapacityTerminationPolicy =
  lens
    _sfrcdExcessCapacityTerminationPolicy
    (\s a -> s {_sfrcdExcessCapacityTerminationPolicy = a})
...
sfrcdOnDemandTargetCapacity =
  lens
    ...
    (\s a -> s {_sfrcdOnDemandTargetCapacity = a})

-- | The launch template and overrides.
sfrcdLaunchTemplateConfigs ::
     Lens' SpotFleetRequestConfigData [LaunchTemplateConfig]
sfrcdLaunchTemplateConfigs =
  lens _sfrcdLaunchTemplateConfigs (\s a -> s {_sfrcdLaunchTemplateConfigs = a}) .
  _Default . _Coerce
...
sfrcdValidUntil =
  lens _sfrcdValidUntil (\s a -> s {_sfrcdValidUntil = a}) . mapping _Time

-- | Indicates whether running Spot Instances should be terminated when the Spot Fleet request expires.
sfrcdTerminateInstancesWithExpiration ::
     Lens' SpotFleetRequestConfigData (Maybe Bool)
sfrcdTerminateInstancesWithExpiration =
  lens
...
sfrcdFulfilledCapacity =
  lens _sfrcdFulfilledCapacity (\s a -> s {_sfrcdFulfilledCapacity = a})
...
sfrcdValidFrom =
  lens _sfrcdValidFrom (\s a -> s {_sfrcdValidFrom = a}) . mapping _Time
...
sfrcdReplaceUnhealthyInstances =
  lens
    ...
    (\s a -> s {_sfrcdReplaceUnhealthyInstances = a})

-- | The launch specifications for the Spot Fleet request.
sfrcdLaunchSpecifications ::
     Lens' SpotFleetRequestConfigData [SpotFleetLaunchSpecification]
sfrcdLaunchSpecifications =
  lens _sfrcdLaunchSpecifications (\s a -> s {_sfrcdLaunchSpecifications = a}) .
  _Default . _Coerce

-- | The number of On-Demand units fulfilled by this request compared to the set target On-Demand capacity.
sfrcdOnDemandFulfilledCapacity ::
     Lens' SpotFleetRequestConfigData (Maybe Double)
sfrcdOnDemandFulfilledCapacity =
  lens
    _sfrcdOnDemandFulfilledCapacity
    (\s a -> s {_sfrcdOnDemandFulfilledCapacity = a})

-- | Indicates how to allocate the target capacity across the Spot pools specified by the Spot Fleet request. The default is @lowestPrice@ .
sfrcdAllocationStrategy ::
     Lens' SpotFleetRequestConfigData (Maybe AllocationStrategy)
sfrcdAllocationStrategy =
  lens _sfrcdAllocationStrategy (\s a -> s {_sfrcdAllocationStrategy = a})
...
instance FromXML SpotFleetRequestConfigData where
  parseXML x =
    SpotFleetRequestConfigData' <$> (x .@? "clientToken") <*>
    (x .@? "instanceInterruptionBehavior") <*>
    (x .@? "spotPrice") <*>
    ...
    (x .@? "validFrom") <*>
    (x .@? "replaceUnhealthyInstances") <*>
    (x .@? "launchSpecifications" .!@ mempty >>= may (parseXMLList "item")) <*>
...
instance ToQuery SpotFleetRequestConfigData where
  toQuery SpotFleetRequestConfigData' {..} =
    mconcat
      ...
      , "InstanceInterruptionBehavior" =: _sfrcdInstanceInterruptionBehavior
      ...
      , toQuery
          (toQueryList "LaunchTemplateConfigs" <$> _sfrcdLaunchTemplateConfigs)
      ...
      , toQuery
          (toQueryList "LaunchSpecifications" <$> _sfrcdLaunchSpecifications)
...
instance FromXML SpotFleetTagSpecification where
  parseXML x =
    SpotFleetTagSpecification' <$> (x .@? "resourceType") <*>
...
sirActualBlockHourlyPrice =
  lens _sirActualBlockHourlyPrice (\s a -> s {_sirActualBlockHourlyPrice = a})

-- | The duration for the Spot Instance, in minutes.
sirBlockDurationMinutes :: Lens' SpotInstanceRequest (Maybe Int)
sirBlockDurationMinutes =
  lens _sirBlockDurationMinutes (\s a -> s {_sirBlockDurationMinutes = a})

-- | The behavior when a Spot Instance is interrupted.
sirInstanceInterruptionBehavior ::
     Lens' SpotInstanceRequest (Maybe InstanceInterruptionBehavior)
sirInstanceInterruptionBehavior =
  lens
    _sirInstanceInterruptionBehavior
    (\s a -> s {_sirInstanceInterruptionBehavior = a})
...
sirAvailabilityZoneGroup =
  lens _sirAvailabilityZoneGroup (\s a -> s {_sirAvailabilityZoneGroup = a})
...
sirValidUntil =
  lens _sirValidUntil (\s a -> s {_sirValidUntil = a}) . mapping _Time
...
sirSpotInstanceRequestId =
  lens _sirSpotInstanceRequestId (\s a -> s {_sirSpotInstanceRequestId = a})
...
sirValidFrom =
  lens _sirValidFrom (\s a -> s {_sirValidFrom = a}) . mapping _Time
...
sirCreateTime =
  lens _sirCreateTime (\s a -> s {_sirCreateTime = a}) . mapping _Time
...
instance FromXML SpotInstanceRequest where
  parseXML x =
    SpotInstanceRequest' <$> (x .@? "instanceId") <*> (x .@? "status") <*>
    (x .@? "state") <*>
...
instance FromXML SpotInstanceStateFault where
  parseXML x = SpotInstanceStateFault' <$> (x .@? "code") <*> (x .@? "message")
...
sisUpdateTime =
  lens _sisUpdateTime (\s a -> s {_sisUpdateTime = a}) . mapping _Time
...
instance FromXML SpotInstanceStatus where
  parseXML x =
    SpotInstanceStatus' <$> (x .@? "updateTime") <*> (x .@? "code") <*>
    (x .@? "message")
...
smoBlockDurationMinutes =
  lens _smoBlockDurationMinutes (\s a -> s {_smoBlockDurationMinutes = a})

-- | The behavior when a Spot Instance is interrupted. The default is @terminate@ .
smoInstanceInterruptionBehavior ::
     Lens' SpotMarketOptions (Maybe InstanceInterruptionBehavior)
smoInstanceInterruptionBehavior =
  lens
    _smoInstanceInterruptionBehavior
    (\s a -> s {_smoInstanceInterruptionBehavior = a})

-- | The end date of the request. For a one-time request, the request remains active until all instances launch, the request is canceled, or this date is reached. If the request is persistent, it remains active until it is canceled or this date and time is reached. The default end date is 7 days from the current date.
smoValidUntil :: Lens' SpotMarketOptions (Maybe UTCTime)
smoValidUntil =
  lens _smoValidUntil (\s a -> s {_smoValidUntil = a}) . mapping _Time

-- | The Spot Instance request type.
smoSpotInstanceType :: Lens' SpotMarketOptions (Maybe SpotInstanceType)
smoSpotInstanceType =
  lens _smoSpotInstanceType (\s a -> s {_smoSpotInstanceType = a})
...
soInstanceInterruptionBehavior ::
     Lens' SpotOptions (Maybe SpotInstanceInterruptionBehavior)
soInstanceInterruptionBehavior =
  lens
    _soInstanceInterruptionBehavior
    (\s a -> s {_soInstanceInterruptionBehavior = a})

-- | Indicates how to allocate the target capacity across the Spot pools specified by the Spot Fleet request. The default is @lowestPrice@ .
soAllocationStrategy :: Lens' SpotOptions (Maybe SpotAllocationStrategy)
soAllocationStrategy =
  lens _soAllocationStrategy (\s a -> s {_soAllocationStrategy = a})

instance FromXML SpotOptions where
  parseXML x =
    SpotOptions' <$> (x .@? "instanceInterruptionBehavior") <*>
    (x .@? "allocationStrategy")
...
sorInstanceInterruptionBehavior ::
     Lens' SpotOptionsRequest (Maybe SpotInstanceInterruptionBehavior)
sorInstanceInterruptionBehavior =
  lens
    _sorInstanceInterruptionBehavior
    (\s a -> s {_sorInstanceInterruptionBehavior = a})

-- | Indicates how to allocate the target capacity across the Spot pools specified by the Spot Fleet request. The default is @lowestPrice@ .
sorAllocationStrategy :: Lens' SpotOptionsRequest (Maybe SpotAllocationStrategy)
sorAllocationStrategy =
  lens _sorAllocationStrategy (\s a -> s {_sorAllocationStrategy = a})
...
instance ToQuery SpotOptionsRequest where
  toQuery SpotOptionsRequest' {..} =
    mconcat
      [ "InstanceInterruptionBehavior" =: _sorInstanceInterruptionBehavior
...
instance FromXML SpotPlacement where
  parseXML x =
    SpotPlacement' <$> (x .@? "availabilityZone") <*> (x .@? "tenancy") <*>
    (x .@? "groupName")
...
sProductDescription =
  lens _sProductDescription (\s a -> s {_sProductDescription = a})
...
instance FromXML SpotPrice where
  parseXML x =
    SpotPrice' <$> (x .@? "productDescription") <*> (x .@? "spotPrice") <*>
    (x .@? "instanceType") <*>
    (x .@? "availabilityZone") <*>
    (x .@? "timestamp")
...
sipUserIdGroupPairs =
  lens _sipUserIdGroupPairs (\s a -> s {_sipUserIdGroupPairs = a}) .
  _Default . _Coerce

-- | One or more prefix list IDs for an AWS service. Not applicable for stale security group rules.
sipPrefixListIds :: Lens' StaleIPPermission [Text]
sipPrefixListIds =
  lens _sipPrefixListIds (\s a -> s {_sipPrefixListIds = a}) .
  _Default . _Coerce
...
sipIPRanges =
  lens _sipIPRanges (\s a -> s {_sipIPRanges = a}) . _Default . _Coerce

instance FromXML StaleIPPermission where
  parseXML x =
    StaleIPPermission' <$> (x .@? "fromPort") <*>
    (x .@? "groups" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "prefixListIds" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "ipProtocol") <*>
    (x .@? "toPort") <*>
...
instance FromXML StaleSecurityGroup where
  parseXML x =
    StaleSecurityGroup' <$> (x .@? "vpcId") <*> (x .@? "groupName") <*>
    (x .@? "staleIpPermissionsEgress" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "staleIpPermissions" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "description") <*>
    (x .@ "groupId")
...
subIPv6CidrBlockAssociationSet =
  lens
    ...
    (\s a -> s {_subIPv6CidrBlockAssociationSet = a}) .
  _Default . _Coerce
...
subAssignIPv6AddressOnCreation =
  lens
    _subAssignIPv6AddressOnCreation
    (\s a -> s {_subAssignIPv6AddressOnCreation = a})

-- | Indicates whether instances launched in this subnet receive a public IPv4 address.
subMapPublicIPOnLaunch :: Lens' Subnet (Maybe Bool)
subMapPublicIPOnLaunch =
  lens _subMapPublicIPOnLaunch (\s a -> s {_subMapPublicIPOnLaunch = a})
...
subAvailabilityZone =
  lens _subAvailabilityZone (\s a -> s {_subAvailabilityZone = a})
...
subAvailableIPAddressCount =
  lens _subAvailableIPAddressCount (\s a -> s {_subAvailableIPAddressCount = a})
...
instance FromXML SubnetCidrBlockState where
  parseXML x =
    SubnetCidrBlockState' <$> (x .@? "state") <*> (x .@? "statusMessage")
...
sicbaAssociationId =
  lens _sicbaAssociationId (\s a -> s {_sicbaAssociationId = a})

-- | The IPv6 CIDR block.
sicbaIPv6CidrBlock :: Lens' SubnetIPv6CidrBlockAssociation (Maybe Text)
sicbaIPv6CidrBlock =
  lens _sicbaIPv6CidrBlock (\s a -> s {_sicbaIPv6CidrBlock = a})

-- | Information about the state of the CIDR block.
sicbaIPv6CidrBlockState ::
     Lens' SubnetIPv6CidrBlockAssociation (Maybe SubnetCidrBlockState)
sicbaIPv6CidrBlockState =
  lens _sicbaIPv6CidrBlockState (\s a -> s {_sicbaIPv6CidrBlockState = a})

instance FromXML SubnetIPv6CidrBlockAssociation where
  parseXML x =
    SubnetIPv6CidrBlockAssociation' <$> (x .@? "associationId") <*>
    (x .@? "ipv6CidrBlock") <*>
...
instance FromXML SuccessfulInstanceCreditSpecificationItem where
  parseXML x =
    SuccessfulInstanceCreditSpecificationItem' <$> (x .@? "instanceId")
...
instance FromXML TagDescription where
  parseXML x =
    TagDescription' <$> (x .@ "resourceId") <*> (x .@ "resourceType") <*>
    (x .@ "key") <*>
    (x .@ "value")
...
tcsOnDemandTargetCapacity =
  lens _tcsOnDemandTargetCapacity (\s a -> s {_tcsOnDemandTargetCapacity = a})

-- | The default @TotalTargetCapacity@ , which is either @Spot@ or @On-Demand@ .
tcsDefaultTargetCapacityType ::
     Lens' TargetCapacitySpecification (Maybe DefaultTargetCapacityType)
tcsDefaultTargetCapacityType =
  lens
    _tcsDefaultTargetCapacityType
    (\s a -> s {_tcsDefaultTargetCapacityType = a})

-- | The number of units to request, filled using @DefaultTargetCapacityType@ .
tcsTotalTargetCapacity :: Lens' TargetCapacitySpecification (Maybe Int)
tcsTotalTargetCapacity =
  lens _tcsTotalTargetCapacity (\s a -> s {_tcsTotalTargetCapacity = a})

-- | The maximum number of Spot units to launch.
tcsSpotTargetCapacity :: Lens' TargetCapacitySpecification (Maybe Int)
tcsSpotTargetCapacity =
  lens _tcsSpotTargetCapacity (\s a -> s {_tcsSpotTargetCapacity = a})

instance FromXML TargetCapacitySpecification where
  parseXML x =
    TargetCapacitySpecification' <$> (x .@? "onDemandTargetCapacity") <*>
...
tcsrOnDemandTargetCapacity ::
     Lens' TargetCapacitySpecificationRequest (Maybe Int)
tcsrOnDemandTargetCapacity =
  lens _tcsrOnDemandTargetCapacity (\s a -> s {_tcsrOnDemandTargetCapacity = a})

-- | The default @TotalTargetCapacity@ , which is either @Spot@ or @On-Demand@ .
tcsrDefaultTargetCapacityType ::
     Lens' TargetCapacitySpecificationRequest (Maybe DefaultTargetCapacityType)
tcsrDefaultTargetCapacityType =
  lens
    _tcsrDefaultTargetCapacityType
    (\s a -> s {_tcsrDefaultTargetCapacityType = a})

-- | The number of Spot units to request.
tcsrSpotTargetCapacity :: Lens' TargetCapacitySpecificationRequest (Maybe Int)
tcsrSpotTargetCapacity =
  lens _tcsrSpotTargetCapacity (\s a -> s {_tcsrSpotTargetCapacity = a})

-- | The number of units to request, filled using @DefaultTargetCapacityType@ .
tcsrTotalTargetCapacity :: Lens' TargetCapacitySpecificationRequest Int
tcsrTotalTargetCapacity =
  lens _tcsrTotalTargetCapacity (\s a -> s {_tcsrTotalTargetCapacity = a})
...
instance FromXML TargetConfiguration where
  parseXML x =
    TargetConfiguration' <$> (x .@? "instanceCount") <*> (x .@? "offeringId")
...
instance ToQuery TargetConfigurationRequest where
  toQuery TargetConfigurationRequest' {..} =
    mconcat
      ["InstanceCount" =: _tcrInstanceCount, "OfferingId" =: _tcrOfferingId]
...
tgcTargetGroups =
  lens _tgcTargetGroups (\s a -> s {_tgcTargetGroups = a}) . _List1

instance FromXML TargetGroupsConfig where
  parseXML x =
    TargetGroupsConfig' <$>
    (x .@? "targetGroups" .!@ mempty >>= parseXMLList1 "item")
...
instance ToQuery TargetGroupsConfig where
  toQuery TargetGroupsConfig' {..} =
    mconcat [toQueryList "TargetGroups" _tgcTargetGroups]
...
trvReservationValue =
  lens _trvReservationValue (\s a -> s {_trvReservationValue = a})

-- | The configuration of the Convertible Reserved Instances that make up the exchange.
trvTargetConfiguration ::
     Lens' TargetReservationValue (Maybe TargetConfiguration)
trvTargetConfiguration =
  lens _trvTargetConfiguration (\s a -> s {_trvTargetConfiguration = a})

instance FromXML TargetReservationValue where
  parseXML x =
    TargetReservationValue' <$> (x .@? "reservationValue") <*>
    (x .@? "targetConfiguration")
...
-- | The ID of the instance.
uicsiInstanceId ::
     Lens' UnsuccessfulInstanceCreditSpecificationItem (Maybe Text)
...
uicsiError ::
     Lens' UnsuccessfulInstanceCreditSpecificationItem (Maybe UnsuccessfulInstanceCreditSpecificationItemError)
uicsiError = lens _uicsiError (\s a -> s {_uicsiError = a})

instance FromXML UnsuccessfulInstanceCreditSpecificationItem where
  parseXML x =
    UnsuccessfulInstanceCreditSpecificationItem' <$> (x .@? "instanceId") <*>
    (x .@? "error")
...
-- | The error code.
uicsieCode ::
     Lens' UnsuccessfulInstanceCreditSpecificationItemError (Maybe UnsuccessfulInstanceCreditSpecificationErrorCode)
uicsieCode = lens _uicsieCode (\s a -> s {_uicsieCode = a})

-- | The applicable error message.
uicsieMessage ::
     Lens' UnsuccessfulInstanceCreditSpecificationItemError (Maybe Text)
...
instance FromXML UnsuccessfulInstanceCreditSpecificationItemError where
  parseXML x =
    UnsuccessfulInstanceCreditSpecificationItemError' <$> (x .@? "code") <*>
    (x .@? "message")
...
instance FromXML UnsuccessfulItem where
  parseXML x = UnsuccessfulItem' <$> (x .@? "resourceId") <*> (x .@ "error")
...
instance FromXML UnsuccessfulItemError where
  parseXML x = UnsuccessfulItemError' <$> (x .@ "code") <*> (x .@ "message")
...
instance FromXML UserBucketDetails where
  parseXML x = UserBucketDetails' <$> (x .@? "s3Key") <*> (x .@? "s3Bucket")
...
uigpVPCPeeringConnectionId =
  lens _uigpVPCPeeringConnectionId (\s a -> s {_uigpVPCPeeringConnectionId = a})
...
instance FromXML UserIdGroupPair where
  parseXML x =
    UserIdGroupPair' <$> (x .@? "vpcPeeringConnectionId") <*> (x .@? "vpcId") <*>
    (x .@? "userId") <*>
    (x .@? "groupId") <*>
    (x .@? "groupName") <*>
    (x .@? "description") <*>
...
vtLastStatusChange =
  lens _vtLastStatusChange (\s a -> s {_vtLastStatusChange = a}) . mapping _Time
...
instance FromXML VGWTelemetry where
  parseXML x =
    VGWTelemetry' <$> (x .@? "status") <*> (x .@? "outsideIpAddress") <*>
    (x .@? "lastStatusChange") <*>
...
vpcIPv6CidrBlockAssociationSet =
  lens
    ...
    (\s a -> s {_vpcIPv6CidrBlockAssociationSet = a}) .
  _Default . _Coerce

-- | Information about the IPv4 CIDR blocks associated with the VPC.
vpcCidrBlockAssociationSet :: Lens' VPC [VPCCidrBlockAssociation]
vpcCidrBlockAssociationSet =
  lens _vpcCidrBlockAssociationSet (\s a -> s {_vpcCidrBlockAssociationSet = a}) .
  _Default . _Coerce
...
instance FromXML VPC where
  parseXML x =
    ...
    (x .@? "ipv6CidrBlockAssociationSet" .!@ mempty >>=
     may (parseXMLList "item")) <*>
    (x .@? "cidrBlockAssociationSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "isDefault") <*>
    (x .@ "cidrBlock") <*>
    (x .@ "dhcpOptionsId") <*>
...
vcbaCidrBlockState =
  lens _vcbaCidrBlockState (\s a -> s {_vcbaCidrBlockState = a})
...
instance FromXML VPCCidrBlockAssociation where
  parseXML x =
    VPCCidrBlockAssociation' <$> (x .@? "associationId") <*>
    (x .@? "cidrBlockState") <*>
    (x .@? "cidrBlock")
...
instance FromXML VPCCidrBlockState where
  parseXML x =
    VPCCidrBlockState' <$> (x .@? "state") <*> (x .@? "statusMessage")
...
veSubnetIds =
  lens _veSubnetIds (\s a -> s {_veSubnetIds = a}) . _Default . _Coerce

-- | (Interface endpoint) One or more network interfaces for the endpoint.
veNetworkInterfaceIds :: Lens' VPCEndpoint [Text]
veNetworkInterfaceIds =
  lens _veNetworkInterfaceIds (\s a -> s {_veNetworkInterfaceIds = a}) .
  _Default . _Coerce
...
veDNSEntries =
  lens _veDNSEntries (\s a -> s {_veDNSEntries = a}) . _Default . _Coerce
...
vePrivateDNSEnabled =
  lens _vePrivateDNSEnabled (\s a -> s {_vePrivateDNSEnabled = a})
...
veRouteTableIds =
  lens _veRouteTableIds (\s a -> s {_veRouteTableIds = a}) . _Default . _Coerce

instance FromXML VPCEndpoint where
  parseXML x =
    VPCEndpoint' <$> (x .@? "groupSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "state") <*>
    (x .@? "policyDocument") <*>
    (x .@? "subnetIdSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "networkInterfaceIdSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "vpcId") <*>
...
vecVPCEndpointOwner =
  lens _vecVPCEndpointOwner (\s a -> s {_vecVPCEndpointOwner = a})

-- | The state of the VPC endpoint.
vecVPCEndpointState :: Lens' VPCEndpointConnection (Maybe State)
vecVPCEndpointState =
  lens _vecVPCEndpointState (\s a -> s {_vecVPCEndpointState = a})

-- | The date and time the VPC endpoint was created.
vecCreationTimestamp :: Lens' VPCEndpointConnection (Maybe UTCTime)
vecCreationTimestamp =
  lens _vecCreationTimestamp (\s a -> s {_vecCreationTimestamp = a}) .
  mapping _Time
...
instance FromXML VPCEndpointConnection where
  parseXML x =
    VPCEndpointConnection' <$> (x .@? "vpcEndpointOwner") <*>
    (x .@? "vpcEndpointState") <*>
    (x .@? "creationTimestamp") <*>
    (x .@? "serviceId") <*>
    (x .@? "vpcEndpointId")
...
vicbaAssociationId =
  lens _vicbaAssociationId (\s a -> s {_vicbaAssociationId = a})

-- | The IPv6 CIDR block.
vicbaIPv6CidrBlock :: Lens' VPCIPv6CidrBlockAssociation (Maybe Text)
vicbaIPv6CidrBlock =
  lens _vicbaIPv6CidrBlock (\s a -> s {_vicbaIPv6CidrBlock = a})

-- | Information about the state of the CIDR block.
vicbaIPv6CidrBlockState ::
     Lens' VPCIPv6CidrBlockAssociation (Maybe VPCCidrBlockState)
vicbaIPv6CidrBlockState =
  lens _vicbaIPv6CidrBlockState (\s a -> s {_vicbaIPv6CidrBlockState = a})

instance FromXML VPCIPv6CidrBlockAssociation where
  parseXML x =
    VPCIPv6CidrBlockAssociation' <$> (x .@? "associationId") <*>
    (x .@? "ipv6CidrBlock") <*>
    (x .@? "ipv6CidrBlockState")
...
vpcpcVPCPeeringConnectionId =
  lens
    ...
    (\s a -> s {_vpcpcVPCPeeringConnectionId = a})

-- | The status of the VPC peering connection.
vpcpcStatus ::
     Lens' VPCPeeringConnection (Maybe VPCPeeringConnectionStateReason)
vpcpcStatus = lens _vpcpcStatus (\s a -> s {_vpcpcStatus = a})

-- | Information about the accepter VPC. CIDR block information is only returned when describing an active VPC peering connection.
vpcpcAccepterVPCInfo ::
     Lens' VPCPeeringConnection (Maybe VPCPeeringConnectionVPCInfo)
vpcpcAccepterVPCInfo =
  lens _vpcpcAccepterVPCInfo (\s a -> s {_vpcpcAccepterVPCInfo = a})

-- | Information about the requester VPC. CIDR block information is only returned when describing an active VPC peering connection.
vpcpcRequesterVPCInfo ::
     Lens' VPCPeeringConnection (Maybe VPCPeeringConnectionVPCInfo)
vpcpcRequesterVPCInfo =
  lens _vpcpcRequesterVPCInfo (\s a -> s {_vpcpcRequesterVPCInfo = a})
...
instance FromXML VPCPeeringConnection where
  parseXML x =
    VPCPeeringConnection' <$> (x .@? "vpcPeeringConnectionId") <*>
    (x .@? "status") <*>
    (x .@? "accepterVpcInfo") <*>
    (x .@? "requesterVpcInfo") <*>
    (x .@? "expirationTime") <*>
...
vpcodAllowEgressFromLocalVPCToRemoteClassicLink ::
     Lens' VPCPeeringConnectionOptionsDescription (Maybe Bool)
vpcodAllowEgressFromLocalVPCToRemoteClassicLink =
  lens
    _vpcodAllowEgressFromLocalVPCToRemoteClassicLink
    (\s a -> s {_vpcodAllowEgressFromLocalVPCToRemoteClassicLink = a})
...
vpcodAllowEgressFromLocalClassicLinkToRemoteVPC =
  lens
    ...
    (\s a -> s {_vpcodAllowEgressFromLocalClassicLinkToRemoteVPC = a})
...
vpcodAllowDNSResolutionFromRemoteVPC =
  lens
    ...
    (\s a -> s {_vpcodAllowDNSResolutionFromRemoteVPC = a})
...
-- | The status of the VPC peering connection.
vpcsrCode ::
     Lens' VPCPeeringConnectionStateReason (Maybe VPCPeeringConnectionStateReasonCode)
...
instance FromXML VPCPeeringConnectionStateReason where
  parseXML x =
    VPCPeeringConnectionStateReason' <$> (x .@? "code") <*> (x .@? "message")
...
vpcviCidrBlockSet =
  lens _vpcviCidrBlockSet (\s a -> s {_vpcviCidrBlockSet = a}) .
  _Default . _Coerce
...
vpcviPeeringOptions ::
     Lens' VPCPeeringConnectionVPCInfo (Maybe VPCPeeringConnectionOptionsDescription)
vpcviPeeringOptions =
  lens _vpcviPeeringOptions (\s a -> s {_vpcviPeeringOptions = a})
...
vpcviIPv6CidrBlockSet =
  lens _vpcviIPv6CidrBlockSet (\s a -> s {_vpcviIPv6CidrBlockSet = a}) .
  _Default . _Coerce
...
vcVGWTelemetry =
  lens _vcVGWTelemetry (\s a -> s {_vcVGWTelemetry = a}) . _Default . _Coerce
...
instance FromXML VPNConnection where
  parseXML x =
    VPNConnection' <$> (x .@? "customerGatewayConfiguration") <*>
...
instance FromXML VPNConnectionOptions where
  parseXML x = VPNConnectionOptions' <$> (x .@? "staticRoutesOnly")
...
vcosTunnelOptions ::
     Lens' VPNConnectionOptionsSpecification [VPNTunnelOptionsSpecification]
vcosTunnelOptions =
  lens _vcosTunnelOptions (\s a -> s {_vcosTunnelOptions = a}) .
  _Default . _Coerce
...
instance FromXML VPNStaticRoute where
  parseXML x =
    VPNStaticRoute' <$> (x .@? "state") <*> (x .@? "source") <*>
    (x .@? "destinationCidrBlock")
...
vtosTunnelInsideCidr =
  lens _vtosTunnelInsideCidr (\s a -> s {_vtosTunnelInsideCidr = a})
...
vAttachments =
  lens _vAttachments (\s a -> s {_vAttachments = a}) . _Default . _Coerce
...
instance FromXML Volume where
  parseXML x =
    Volume' <$> (x .@? "attachmentSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@? "iops") <*>
    (x .@? "kmsKeyId") <*>
    (x .@? "tagSet" .!@ mempty >>= may (parseXMLList "item")) <*>
    (x .@ "availabilityZone") <*>
...
volDeleteOnTermination =
  lens _volDeleteOnTermination (\s a -> s {_volDeleteOnTermination = a})
...
volAttachTime =
  lens _volAttachTime (\s a -> s {_volAttachTime = a}) . mapping _Time

instance FromXML VolumeAttachment where
  parseXML x =
    VolumeAttachment' <$> (x .@? "instanceId") <*> (x .@? "deleteOnTermination") <*>
    (x .@? "status") <*>
    (x .@? "device") <*>
    (x .@? "volumeId") <*>
    (x .@? "attachTime")
...
vmModificationState =
  lens _vmModificationState (\s a -> s {_vmModificationState = a})

-- | Target EBS volume type of the volume being modified.
vmTargetVolumeType :: Lens' VolumeModification (Maybe VolumeType)
vmTargetVolumeType =
  lens _vmTargetVolumeType (\s a -> s {_vmTargetVolumeType = a})

-- | Original EBS volume type of the volume being modified.
vmOriginalVolumeType :: Lens' VolumeModification (Maybe VolumeType)
vmOriginalVolumeType =
  lens _vmOriginalVolumeType (\s a -> s {_vmOriginalVolumeType = a})
...
instance FromXML VolumeModification where
  parseXML x =
    VolumeModification' <$> (x .@? "progress") <*> (x .@? "startTime") <*>
    (x .@? "modificationState") <*>
    (x .@? "targetVolumeType") <*>
...
instance FromXML VolumeStatusAction where
  parseXML x =
    VolumeStatusAction' <$> (x .@? "eventType") <*> (x .@? "code") <*>
    (x .@? "description") <*>
    (x .@? "eventId")
...
instance FromXML VolumeStatusDetails where
  parseXML x = VolumeStatusDetails' <$> (x .@? "status") <*> (x .@? "name")
...
vseNotBefore =
  lens _vseNotBefore (\s a -> s {_vseNotBefore = a}) . mapping _Time
...
instance FromXML VolumeStatusEvent where
  parseXML x =
    VolumeStatusEvent' <$> (x .@? "notBefore") <*> (x .@? "eventType") <*>
    (x .@? "description") <*>
    (x .@? "notAfter") <*>
    (x .@? "eventId")
...
instance FromXML VolumeStatusItem where
  parseXML x =
    VolumeStatusItem' <$> (x .@? "volumeStatus") <*>
