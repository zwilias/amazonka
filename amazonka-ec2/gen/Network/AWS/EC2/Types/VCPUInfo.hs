...
data VCPUInfo = VCPUInfo'{_vciValidThreadsPerCore ::
                          !(Maybe [Int]),
...
--
-- * 'vciValidThreadsPerCore' - List of the valid number of threads per core that can be configured for the instance type. 
--
...
--
-- * 'vciValidCores' - List of the valid number of cores that can be configured for the instance type.
vCPUInfo
    :: VCPUInfo
vCPUInfo
  = VCPUInfo'{_vciValidThreadsPerCore = Nothing,
              _vciDefaultThreadsPerCore = Nothing,
              _vciDefaultVCPUs = Nothing,
              _vciDefaultCores = Nothing, _vciValidCores = Nothing}
