...
data EnableFastSnapshotRestoreStateErrorItem = EnableFastSnapshotRestoreStateErrorItem'{_efsrseiError
                                                                                        ::
                                                                                        !(Maybe
...
enableFastSnapshotRestoreStateErrorItem
    :: EnableFastSnapshotRestoreStateErrorItem
enableFastSnapshotRestoreStateErrorItem
  = EnableFastSnapshotRestoreStateErrorItem'{_efsrseiError
                                               = Nothing,
