...
data TransitGatewayPeeringAttachment = TransitGatewayPeeringAttachment'{_tgpaCreationTime
                                                                        ::
                                                                        !(Maybe
                                                                            ISO8601),
...
--
-- * 'tgpaState' - The state of the transit gateway peering attachment.
--
...
transitGatewayPeeringAttachment
    :: TransitGatewayPeeringAttachment
transitGatewayPeeringAttachment
  = TransitGatewayPeeringAttachment'{_tgpaCreationTime
                                       = Nothing,
