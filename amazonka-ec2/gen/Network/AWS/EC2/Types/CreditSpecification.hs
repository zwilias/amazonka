...
newtype CreditSpecification = CreditSpecification'{_csCPUCredits
                                                   :: Maybe Text}
...
--
-- * 'csCPUCredits' - The credit option for CPU usage of a T2 or T3 instance. Valid values are @standard@ and @unlimited@ .
creditSpecification
    :: CreditSpecification
creditSpecification
