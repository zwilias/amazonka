...
data FpgaImage = FpgaImage'{_fiShellVersion ::
                            !(Maybe Text),
...
fpgaImage
    :: FpgaImage
fpgaImage
  = FpgaImage'{_fiShellVersion = Nothing,
               _fiPciId = Nothing, _fiState = Nothing,
               _fiOwnerAlias = Nothing, _fiFpgaImageId = Nothing,
               _fiDataRetentionSupport = Nothing,
               _fiOwnerId = Nothing, _fiUpdateTime = Nothing,
               _fiName = Nothing, _fiProductCodes = Nothing,
               _fiDescription = Nothing, _fiCreateTime = Nothing,
               _fiTags = Nothing, _fiPublic = Nothing,
