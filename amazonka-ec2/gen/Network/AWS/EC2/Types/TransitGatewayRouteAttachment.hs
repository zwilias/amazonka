...
data TransitGatewayRouteAttachment = TransitGatewayRouteAttachment'{_tgraResourceId
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _tgraResourceType
...
--
-- * 'tgraResourceType' - The resource type.
--
-- * 'tgraTransitGatewayAttachmentId' - The ID of the attachment.
transitGatewayRouteAttachment
    :: TransitGatewayRouteAttachment
transitGatewayRouteAttachment
  = TransitGatewayRouteAttachment'{_tgraResourceId =
                                     Nothing,
