...
data VPNTunnelOptionsSpecification = VPNTunnelOptionsSpecification'{_vtosReplayWindowSize
                                                                    ::
                                                                    !(Maybe
                                                                        Int),
...
--
-- * 'vtosPhase2IntegrityAlgorithms' - One or more integrity algorithms that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @SHA1@ | @SHA2-256@ 
--
...
--
-- * 'vtosPhase1EncryptionAlgorithms' - One or more encryption algorithms that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @AES128@ | @AES256@ 
--
-- * 'vtosPhase1DHGroupNumbers' - One or more Diffie-Hellman group numbers that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @2@ | @14@ | @15@ | @16@ | @17@ | @18@ | @22@ | @23@ | @24@ 
--
-- * 'vtosPhase1IntegrityAlgorithms' - One or more integrity algorithms that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @SHA1@ | @SHA2-256@ 
--
...
--
-- * 'vtosPhase2EncryptionAlgorithms' - One or more encryption algorithms that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @AES128@ | @AES256@ 
--
-- * 'vtosPhase2DHGroupNumbers' - One or more Diffie-Hellman group numbers that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @2@ | @5@ | @14@ | @15@ | @16@ | @17@ | @18@ | @22@ | @23@ | @24@ 
--
...
vpnTunnelOptionsSpecification
    :: VPNTunnelOptionsSpecification
vpnTunnelOptionsSpecification
  = VPNTunnelOptionsSpecification'{_vtosReplayWindowSize
                                     = Nothing,
