...
data TransitGateway = TransitGateway'{_tgCreationTime
                                      :: !(Maybe ISO8601),
...
transitGateway
    :: TransitGateway
transitGateway
  = TransitGateway'{_tgCreationTime = Nothing,
                    _tgState = Nothing, _tgOwnerId = Nothing,
                    _tgTransitGatewayARN = Nothing,
                    _tgTransitGatewayId = Nothing, _tgOptions = Nothing,
                    _tgDescription = Nothing, _tgTags = Nothing}
