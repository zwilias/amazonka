...
data VolumeStatusItem = VolumeStatusItem'{_vsiVolumeStatus
...
volumeStatusItem
    :: VolumeStatusItem
volumeStatusItem
  = VolumeStatusItem'{_vsiVolumeStatus = Nothing,
                      _vsiActions = Nothing, _vsiOutpostARN = Nothing,
                      _vsiEvents = Nothing, _vsiAvailabilityZone = Nothing,
