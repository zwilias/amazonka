...
data InstanceTypeInfo = InstanceTypeInfo'{_itiHypervisor
...
--
-- * 'itiHypervisor' - Indicates the hypervisor used for the instance type.
--
-- * 'itiCurrentGeneration' - Indicates whether the instance type is a current generation.
--
...
--
-- * 'itiSupportedRootDeviceTypes' - Indicates the supported root device types.
--
...
--
-- * 'itiBareMetal' - Indicates whether the instance is bare metal.
--
...
--
-- * 'itiInstanceStorageInfo' - Describes the disks for the instance type.
--
...
instanceTypeInfo
    :: InstanceTypeInfo
instanceTypeInfo
  = InstanceTypeInfo'{_itiHypervisor = Nothing,
                      ...
                      _itiInstanceType = Nothing, _itiGpuInfo = Nothing,
                      _itiEBSInfo = Nothing,
                      _itiAutoRecoverySupported = Nothing,
                      _itiInferenceAcceleratorInfo = Nothing,
                      _itiBareMetal = Nothing, _itiNetworkInfo = Nothing,
