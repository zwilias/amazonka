...
data ModifyVPNTunnelOptionsSpecification = ModifyVPNTunnelOptionsSpecification'{_mvtosReplayWindowSize
                                                                                ::
                                                                                !(Maybe
                                                                                    Int),
...
--
-- * 'mvtosPhase2IntegrityAlgorithms' - One or more integrity algorithms that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @SHA1@ | @SHA2-256@ 
--
...
--
-- * 'mvtosPhase1EncryptionAlgorithms' - One or more encryption algorithms that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @AES128@ | @AES256@ 
--
-- * 'mvtosPhase1DHGroupNumbers' - One or more Diffie-Hellman group numbers that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @2@ | @14@ | @15@ | @16@ | @17@ | @18@ | @22@ | @23@ | @24@ 
--
-- * 'mvtosPhase1IntegrityAlgorithms' - One or more integrity algorithms that are permitted for the VPN tunnel for phase 1 IKE negotiations. Valid values: @SHA1@ | @SHA2-256@ 
--
...
--
-- * 'mvtosTunnelInsideCidr' - The range of inside IP addresses for the tunnel. Any specified CIDR blocks must be unique across all VPN connections that use the same virtual private gateway.  Constraints: A size /30 CIDR block from the @169.254.0.0/16@ range. The following CIDR blocks are reserved and cannot be used:     * @169.254.0.0/30@      * @169.254.1.0/30@      * @169.254.2.0/30@      * @169.254.3.0/30@      * @169.254.4.0/30@      * @169.254.5.0/30@      * @169.254.169.252/30@ 
--
-- * 'mvtosPhase2EncryptionAlgorithms' - One or more encryption algorithms that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @AES128@ | @AES256@ 
--
-- * 'mvtosPhase2DHGroupNumbers' - One or more Diffie-Hellman group numbers that are permitted for the VPN tunnel for phase 2 IKE negotiations. Valid values: @2@ | @5@ | @14@ | @15@ | @16@ | @17@ | @18@ | @22@ | @23@ | @24@ 
--
...
modifyVPNTunnelOptionsSpecification
    :: ModifyVPNTunnelOptionsSpecification
modifyVPNTunnelOptionsSpecification
  = ModifyVPNTunnelOptionsSpecification'{_mvtosReplayWindowSize
                                           = Nothing,
