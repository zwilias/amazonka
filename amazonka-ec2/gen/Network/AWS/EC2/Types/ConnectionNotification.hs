...
data ConnectionNotification = ConnectionNotification'{_cnConnectionNotificationState
                                                      ::
                                                      !(Maybe
...
connectionNotification
    :: ConnectionNotification
connectionNotification
  = ConnectionNotification'{_cnConnectionNotificationState
                              = Nothing,
                            _cnConnectionNotificationType = Nothing,
                            _cnConnectionEvents = Nothing,
                            _cnServiceId = Nothing, _cnVPCEndpointId = Nothing,
