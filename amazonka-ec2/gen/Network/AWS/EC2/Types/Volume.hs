...
data Volume = Volume'{_vFastRestored ::
                      !(Maybe Bool),
                      ...
                      _vCreateTime :: !ISO8601, _vEncrypted :: !Bool,
                      _vSize :: !Int, _vSnapshotId :: !Text,
                      _vState :: !VolumeState, _vVolumeId :: !Text,
...
volume
    ...
    -> Volume
volume pAvailabilityZone_ pCreateTime_ pEncrypted_
  pSize_ pSnapshotId_ pState_ pVolumeId_ pVolumeType_
  = Volume'{_vFastRestored = Nothing,
            _vMultiAttachEnabled = Nothing,
            _vAttachments = Nothing, _vIOPS = Nothing,
            _vOutpostARN = Nothing, _vKMSKeyId = Nothing,
            _vTags = Nothing,
            _vAvailabilityZone = pAvailabilityZone_,
            _vCreateTime = _Time # pCreateTime_,
            _vEncrypted = pEncrypted_, _vSize = pSize_,
            _vSnapshotId = pSnapshotId_, _vState = pState_,
            _vVolumeId = pVolumeId_, _vVolumeType = pVolumeType_}
