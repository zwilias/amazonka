...
data ExportTaskS3LocationRequest = ExportTaskS3LocationRequest'{_etslrS3Prefix
                                                                ::
                                                                !(Maybe Text),
                                                                _etslrS3Bucket
                                                                :: !Text}
...
--
-- * 'etslrS3Bucket' - The destination S3 bucket.
exportTaskS3LocationRequest
    :: Text -- ^ 'etslrS3Bucket'
    -> ExportTaskS3LocationRequest
exportTaskS3LocationRequest pS3Bucket_
  = ExportTaskS3LocationRequest'{_etslrS3Prefix =
                                   Nothing,
