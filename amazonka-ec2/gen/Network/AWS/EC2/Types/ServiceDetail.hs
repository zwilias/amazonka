...
data ServiceDetail = ServiceDetail'{_sdPrivateDNSNameVerificationState
                                    :: !(Maybe DNSNameState),
...
serviceDetail
    :: ServiceDetail
serviceDetail
  = ServiceDetail'{_sdPrivateDNSNameVerificationState =
                     Nothing,
                   _sdVPCEndpointPolicySupported = Nothing,
                   _sdBaseEndpointDNSNames = Nothing,
                   _sdOwner = Nothing, _sdAvailabilityZones = Nothing,
                   _sdManagesVPCEndpoints = Nothing,
                   _sdServiceName = Nothing, _sdServiceType = Nothing,
                   _sdAcceptanceRequired = Nothing,
                   _sdServiceId = Nothing, _sdPrivateDNSName = Nothing,
                   _sdTags = Nothing}
