...
data TransitGatewayMulticastRegisteredGroupMembers = TransitGatewayMulticastRegisteredGroupMembers'{_tgmrgmTransitGatewayMulticastDomainId
                                                                                                    ::
                                                                                                    !(Maybe
                                                                                                        Text),
...
transitGatewayMulticastRegisteredGroupMembers
    :: TransitGatewayMulticastRegisteredGroupMembers
transitGatewayMulticastRegisteredGroupMembers
  = TransitGatewayMulticastRegisteredGroupMembers'{_tgmrgmTransitGatewayMulticastDomainId
                                                     = Nothing,
                                                   _tgmrgmRegisteredNetworkInterfaceIds
                                                     = Nothing,
                                                   _tgmrgmGroupIPAddress =
