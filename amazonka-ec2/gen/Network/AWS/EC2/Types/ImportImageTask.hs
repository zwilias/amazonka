...
data ImportImageTask = ImportImageTask'{_iitStatus ::
                                        !(Maybe Text),
...
importImageTask
    :: ImportImageTask
importImageTask
  = ImportImageTask'{_iitStatus = Nothing,
                     _iitHypervisor = Nothing, _iitPlatform = Nothing,
                     _iitProgress = Nothing,
                     _iitLicenseSpecifications = Nothing,
                     _iitLicenseType = Nothing,
                     _iitSnapshotDetails = Nothing,
                     _iitEncrypted = Nothing, _iitKMSKeyId = Nothing,
                     _iitStatusMessage = Nothing, _iitImageId = Nothing,
                     _iitImportTaskId = Nothing,
                     _iitArchitecture = Nothing,
                     _iitDescription = Nothing, _iitTags = Nothing}
