...
data TransitGatewayMulticastDeregisteredGroupMembers = TransitGatewayMulticastDeregisteredGroupMembers'{_tgmdgmDeregisteredNetworkInterfaceIds
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            [Text]),
...
transitGatewayMulticastDeregisteredGroupMembers
    :: TransitGatewayMulticastDeregisteredGroupMembers
transitGatewayMulticastDeregisteredGroupMembers
  = TransitGatewayMulticastDeregisteredGroupMembers'{_tgmdgmDeregisteredNetworkInterfaceIds
                                                       = Nothing,
                                                     _tgmdgmTransitGatewayMulticastDomainId
                                                       = Nothing,
                                                     _tgmdgmGroupIPAddress =
