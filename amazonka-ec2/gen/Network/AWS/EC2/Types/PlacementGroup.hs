...
data PlacementGroup = PlacementGroup'{_pgState ::
...
placementGroup
    :: PlacementGroup
placementGroup
  = PlacementGroup'{_pgState = Nothing,
                    _pgStrategy = Nothing, _pgGroupId = Nothing,
                    _pgGroupName = Nothing, _pgPartitionCount = Nothing,
                    _pgTags = Nothing}
