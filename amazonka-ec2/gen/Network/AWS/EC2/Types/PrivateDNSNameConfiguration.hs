...
data PrivateDNSNameConfiguration = PrivateDNSNameConfiguration'{_pdncState
                                                                ::
                                                                !(Maybe
                                                                    DNSNameState),
                                                                _pdncValue ::
...
privateDNSNameConfiguration
    :: PrivateDNSNameConfiguration
privateDNSNameConfiguration
  = PrivateDNSNameConfiguration'{_pdncState = Nothing,
                                 _pdncValue = Nothing, _pdncName = Nothing,
                                 _pdncType = Nothing}
