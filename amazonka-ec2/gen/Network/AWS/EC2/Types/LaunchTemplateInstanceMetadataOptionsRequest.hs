...
data LaunchTemplateInstanceMetadataOptionsRequest = LaunchTemplateInstanceMetadataOptionsRequest'{_ltimorHTTPEndpoint
                                                                                                  ::
                                                                                                  !(Maybe
...
launchTemplateInstanceMetadataOptionsRequest
    :: LaunchTemplateInstanceMetadataOptionsRequest
launchTemplateInstanceMetadataOptionsRequest
  = LaunchTemplateInstanceMetadataOptionsRequest'{_ltimorHTTPEndpoint
                                                    = Nothing,
                                                  _ltimorHTTPPutResponseHopLimit
                                                    = Nothing,
