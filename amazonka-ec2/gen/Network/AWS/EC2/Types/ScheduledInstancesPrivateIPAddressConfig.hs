...
data ScheduledInstancesPrivateIPAddressConfig = ScheduledInstancesPrivateIPAddressConfig'{_sipiacPrimary
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Bool),
...
scheduledInstancesPrivateIPAddressConfig
    :: ScheduledInstancesPrivateIPAddressConfig
scheduledInstancesPrivateIPAddressConfig
  = ScheduledInstancesPrivateIPAddressConfig'{_sipiacPrimary
                                                = Nothing,
