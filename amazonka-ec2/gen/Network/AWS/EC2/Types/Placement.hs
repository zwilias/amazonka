...
data Placement = Placement'{_plaAffinity ::
                            !(Maybe Text),
...
placement
    :: Placement
placement
  = Placement'{_plaAffinity = Nothing,
               _plaHostId = Nothing, _plaPartitionNumber = Nothing,
               _plaSpreadDomain = Nothing,
               _plaAvailabilityZone = Nothing,
               _plaTenancy = Nothing, _plaGroupName = Nothing,
