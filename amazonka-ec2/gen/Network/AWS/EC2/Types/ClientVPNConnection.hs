...
data ClientVPNConnection = ClientVPNConnection'{_cvcIngressPackets
                                                :: !(Maybe Text),
                                                _cvcStatus ::
                                                !(Maybe
