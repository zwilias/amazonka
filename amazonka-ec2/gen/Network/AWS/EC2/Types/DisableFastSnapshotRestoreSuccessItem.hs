...
data DisableFastSnapshotRestoreSuccessItem = DisableFastSnapshotRestoreSuccessItem'{_dDisablingTime
                                                                                    ::
                                                                                    !(Maybe
                                                                                        ISO8601),
                                                                                    _dState
...
--
-- * 'dOwnerAlias' - The alias of the snapshot owner.
--
...
--
-- * 'dOwnerId' - The ID of the AWS account that owns the snapshot.
--
...
disableFastSnapshotRestoreSuccessItem
    :: DisableFastSnapshotRestoreSuccessItem
disableFastSnapshotRestoreSuccessItem
  = DisableFastSnapshotRestoreSuccessItem'{_dDisablingTime
                                             = Nothing,
                                           _dState = Nothing,
