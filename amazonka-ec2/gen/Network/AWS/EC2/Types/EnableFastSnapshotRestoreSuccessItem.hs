...
data EnableFastSnapshotRestoreSuccessItem = EnableFastSnapshotRestoreSuccessItem'{_efsrsiDisablingTime
                                                                                  ::
                                                                                  !(Maybe
                                                                                      ISO8601),
                                                                                  _efsrsiState
...
--
-- * 'efsrsiOwnerAlias' - The alias of the snapshot owner.
--
...
--
-- * 'efsrsiOwnerId' - The ID of the AWS account that owns the snapshot.
--
...
enableFastSnapshotRestoreSuccessItem
    :: EnableFastSnapshotRestoreSuccessItem
enableFastSnapshotRestoreSuccessItem
  = EnableFastSnapshotRestoreSuccessItem'{_efsrsiDisablingTime
                                            = Nothing,
