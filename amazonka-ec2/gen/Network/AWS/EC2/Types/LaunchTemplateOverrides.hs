...
data LaunchTemplateOverrides = LaunchTemplateOverrides'{_ltoPriority
                                                        :: !(Maybe Double),
                                                        _ltoSpotPrice ::
                                                        !(Maybe Text),
...
launchTemplateOverrides
    :: LaunchTemplateOverrides
launchTemplateOverrides
  = LaunchTemplateOverrides'{_ltoPriority = Nothing,
                             _ltoSpotPrice = Nothing,
                             _ltoWeightedCapacity = Nothing,
                             _ltoSubnetId = Nothing, _ltoInstanceType = Nothing,
