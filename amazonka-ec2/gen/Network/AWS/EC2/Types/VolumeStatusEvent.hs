...
data VolumeStatusEvent = VolumeStatusEvent'{_vseInstanceId
                                            :: !(Maybe Text),
...
volumeStatusEvent
    :: VolumeStatusEvent
volumeStatusEvent
  = VolumeStatusEvent'{_vseInstanceId = Nothing,
                       _vseNotBefore = Nothing, _vseEventType = Nothing,
                       _vseDescription = Nothing, _vseNotAfter = Nothing,
                       _vseEventId = Nothing}
