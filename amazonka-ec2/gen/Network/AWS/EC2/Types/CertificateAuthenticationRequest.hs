...
newtype CertificateAuthenticationRequest = CertificateAuthenticationRequest'{_carClientRootCertificateChainARN
                                                                             ::
                                                                             Maybe
                                                                               Text}
...
certificateAuthenticationRequest
    :: CertificateAuthenticationRequest
certificateAuthenticationRequest
  = CertificateAuthenticationRequest'{_carClientRootCertificateChainARN
                                        = Nothing}
