...
data ConnectionLogOptions = ConnectionLogOptions'{_cloEnabled
                                                  :: !(Maybe Bool),
...
--
-- * 'cloCloudwatchLogGroup' - The name of the CloudWatch Logs log group.
connectionLogOptions
    :: ConnectionLogOptions
connectionLogOptions
  = ConnectionLogOptions'{_cloEnabled = Nothing,
