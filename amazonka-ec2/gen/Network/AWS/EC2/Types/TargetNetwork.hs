...
data TargetNetwork = TargetNetwork'{_tnAssociationId
                                    :: !(Maybe Text),
...
targetNetwork
    :: TargetNetwork
targetNetwork
  = TargetNetwork'{_tnAssociationId = Nothing,
                   _tnStatus = Nothing, _tnSecurityGroups = Nothing,
                   _tnTargetNetworkId = Nothing, _tnVPCId = Nothing,
