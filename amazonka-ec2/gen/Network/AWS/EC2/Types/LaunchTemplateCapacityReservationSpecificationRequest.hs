...
data LaunchTemplateCapacityReservationSpecificationRequest = LaunchTemplateCapacityReservationSpecificationRequest'{_ltcrsrCapacityReservationTarget
                                                                                                                    ::
                                                                                                                    !(Maybe
...
--
-- * 'ltcrsrCapacityReservationTarget' - Information about the target Capacity Reservation.
--
...
launchTemplateCapacityReservationSpecificationRequest
    :: LaunchTemplateCapacityReservationSpecificationRequest
launchTemplateCapacityReservationSpecificationRequest
  = LaunchTemplateCapacityReservationSpecificationRequest'{_ltcrsrCapacityReservationTarget
                                                             = Nothing,
                                                           _ltcrsrCapacityReservationPreference
                                                             = Nothing}
