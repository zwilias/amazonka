...
data TargetCapacitySpecificationRequest = TargetCapacitySpecificationRequest'{_tcsrOnDemandTargetCapacity
                                                                              ::
                                                                              !(Maybe
                                                                                  Int),
...
targetCapacitySpecificationRequest
  ...
  = TargetCapacitySpecificationRequest'{_tcsrOnDemandTargetCapacity
                                          = Nothing,
                                        _tcsrDefaultTargetCapacityType =
                                          Nothing,
