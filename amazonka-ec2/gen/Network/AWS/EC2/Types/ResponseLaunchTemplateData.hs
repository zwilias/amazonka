...
data ResponseLaunchTemplateData = ResponseLaunchTemplateData'{_rSecurityGroupIds
                                                              ::
                                                              !(Maybe [Text]),
                                                              _rSecurityGroups
                                                              ::
...
responseLaunchTemplateData
    :: ResponseLaunchTemplateData
responseLaunchTemplateData
  = ResponseLaunchTemplateData'{_rSecurityGroupIds =
                                  Nothing,
