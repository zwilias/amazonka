...
newtype ImportImageLicenseConfigurationResponse = ImportImageLicenseConfigurationResponse'{_iilcLicenseConfigurationARN
                                                                                           ::
                                                                                           Maybe
                                                                                             Text}
...
importImageLicenseConfigurationResponse
    :: ImportImageLicenseConfigurationResponse
importImageLicenseConfigurationResponse
  = ImportImageLicenseConfigurationResponse'{_iilcLicenseConfigurationARN
                                               = Nothing}
