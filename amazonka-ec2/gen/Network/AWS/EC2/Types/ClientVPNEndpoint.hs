...
data ClientVPNEndpoint = ClientVPNEndpoint'{_cveCreationTime
                                            :: !(Maybe Text),
                                            _cveStatus ::
...
clientVPNEndpoint
    :: ClientVPNEndpoint
clientVPNEndpoint
  = ClientVPNEndpoint'{_cveCreationTime = Nothing,
                       _cveStatus = Nothing,
                       _cveAssociatedTargetNetworks = Nothing,
                       _cveSecurityGroupIds = Nothing,
                       _cveConnectionLogOptions = Nothing,
                       _cveSplitTunnel = Nothing,
                       _cveTransportProtocol = Nothing, _cveVPCId = Nothing,
                       _cveVPNPort = Nothing, _cveDeletionTime = Nothing,
                       ...
                       _cveDescription = Nothing, _cveDNSName = Nothing,
                       _cveVPNProtocol = Nothing, _cveTags = Nothing}
