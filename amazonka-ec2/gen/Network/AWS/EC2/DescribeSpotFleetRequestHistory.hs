...
instance AWSRequest DescribeSpotFleetRequestHistory where
  ...
  response =
    receiveXML
      (\s h x ->
         DescribeSpotFleetRequestHistoryResponse' <$> (x .@? "nextToken") <*>
         (pure (fromEnum s)) <*>
         (x .@? "historyRecordSet" .!@ mempty >>= parseXMLList "item") <*>
         (x .@ "lastEvaluatedTime") <*>
...
dsfrhrsResponseStatus =
  lens _dsfrhrsResponseStatus (\s a -> s {_dsfrhrsResponseStatus = a})

-- | Information about the events in the history of the Spot Fleet request.
dsfrhrsHistoryRecords ::
     Lens' DescribeSpotFleetRequestHistoryResponse [HistoryRecord]
dsfrhrsHistoryRecords =
  lens _dsfrhrsHistoryRecords (\s a -> s {_dsfrhrsHistoryRecords = a}) . _Coerce
...
dsfrhrsLastEvaluatedTime ::
     Lens' DescribeSpotFleetRequestHistoryResponse UTCTime
dsfrhrsLastEvaluatedTime =
  lens _dsfrhrsLastEvaluatedTime (\s a -> s {_dsfrhrsLastEvaluatedTime = a}) .
  _Time

-- | The ID of the Spot Fleet request.
dsfrhrsSpotFleetRequestId :: Lens' DescribeSpotFleetRequestHistoryResponse Text
dsfrhrsSpotFleetRequestId =
  lens _dsfrhrsSpotFleetRequestId (\s a -> s {_dsfrhrsSpotFleetRequestId = a})

-- | The starting date and time for the events, in UTC format (for example, /YYYY/ -/MM/ -/DD/ T/HH/ :/MM/ :/SS/ Z).
dsfrhrsStartTime :: Lens' DescribeSpotFleetRequestHistoryResponse UTCTime
dsfrhrsStartTime =
  lens _dsfrhrsStartTime (\s a -> s {_dsfrhrsStartTime = a}) . _Time
