...
degElasticGpuIds =
  lens _degElasticGpuIds (\s a -> s {_degElasticGpuIds = a}) .
  _Default . _Coerce
...
degrsElasticGpuSet =
  lens _degrsElasticGpuSet (\s a -> s {_degrsElasticGpuSet = a}) .
  _Default . _Coerce
...
degrsResponseStatus =
  lens _degrsResponseStatus (\s a -> s {_degrsResponseStatus = a})
