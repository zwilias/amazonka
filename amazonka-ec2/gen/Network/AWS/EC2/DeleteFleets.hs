...
dfTerminateInstances =
  lens _dfTerminateInstances (\s a -> s {_dfTerminateInstances = a})
...
dfrsSuccessfulFleetDeletions ::
     Lens' DeleteFleetsResponse [DeleteFleetSuccessItem]
dfrsSuccessfulFleetDeletions =
  lens
    _dfrsSuccessfulFleetDeletions
    (\s a -> s {_dfrsSuccessfulFleetDeletions = a}) .
  _Default . _Coerce

-- | Information about the EC2 Fleets that are not successfully deleted.
dfrsUnsuccessfulFleetDeletions ::
     Lens' DeleteFleetsResponse [DeleteFleetErrorItem]
dfrsUnsuccessfulFleetDeletions =
  lens
    _dfrsUnsuccessfulFleetDeletions
    (\s a -> s {_dfrsUnsuccessfulFleetDeletions = a}) .
  _Default . _Coerce
