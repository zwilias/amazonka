...
dltvLaunchTemplateName =
  lens _dltvLaunchTemplateName (\s a -> s {_dltvLaunchTemplateName = a})

-- | The ID of the launch template. You must specify either the launch template ID or launch template name in the request.
dltvLaunchTemplateId :: Lens' DeleteLaunchTemplateVersions (Maybe Text)
dltvLaunchTemplateId =
  lens _dltvLaunchTemplateId (\s a -> s {_dltvLaunchTemplateId = a})
...
instance AWSRequest DeleteLaunchTemplateVersions where
  type Rs DeleteLaunchTemplateVersions = DeleteLaunchTemplateVersionsResponse
...
dltvsrsSuccessfullyDeletedLaunchTemplateVersions ::
     Lens' DeleteLaunchTemplateVersionsResponse [DeleteLaunchTemplateVersionsResponseSuccessItem]
dltvsrsSuccessfullyDeletedLaunchTemplateVersions =
  lens
    _dltvsrsSuccessfullyDeletedLaunchTemplateVersions
    (\s a -> s {_dltvsrsSuccessfullyDeletedLaunchTemplateVersions = a}) .
  _Default . _Coerce

-- | Information about the launch template versions that could not be deleted.
dltvsrsUnsuccessfullyDeletedLaunchTemplateVersions ::
     Lens' DeleteLaunchTemplateVersionsResponse [DeleteLaunchTemplateVersionsResponseErrorItem]
dltvsrsUnsuccessfullyDeletedLaunchTemplateVersions =
  lens
    _dltvsrsUnsuccessfullyDeletedLaunchTemplateVersions
    (\s a -> s {_dltvsrsUnsuccessfullyDeletedLaunchTemplateVersions = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dltvsrsResponseStatus :: Lens' DeleteLaunchTemplateVersionsResponse Int
dltvsrsResponseStatus =
  lens _dltvsrsResponseStatus (\s a -> s {_dltvsrsResponseStatus = a})
