...
risSecurityGroupIds =
  lens _risSecurityGroupIds (\s a -> s {_risSecurityGroupIds = a}) .
  _Default . _Coerce
...
risSecurityGroups =
  lens _risSecurityGroups (\s a -> s {_risSecurityGroups = a}) .
  _Default . _Coerce
...
risInstanceMarketOptions ::
     Lens' RunInstances (Maybe InstanceMarketOptionsRequest)
risInstanceMarketOptions =
  lens _risInstanceMarketOptions (\s a -> s {_risInstanceMarketOptions = a})

-- | If you set this parameter to @true@ , you can't terminate the instance using the Amazon EC2 console, CLI, or API; otherwise, you can. To change this attribute to @false@ after launch, use 'ModifyInstanceAttribute' . Alternatively, if you set @InstanceInitiatedShutdownBehavior@ to @terminate@ , you can terminate the instance by running the shutdown command from the instance. Default: @false@
risDisableAPITermination :: Lens' RunInstances (Maybe Bool)
risDisableAPITermination =
  lens _risDisableAPITermination (\s a -> s {_risDisableAPITermination = a})
...
risNetworkInterfaces ::
     Lens' RunInstances [InstanceNetworkInterfaceSpecification]
risNetworkInterfaces =
  lens _risNetworkInterfaces (\s a -> s {_risNetworkInterfaces = a}) .
  _Default . _Coerce
...
risTagSpecifications =
  lens _risTagSpecifications (\s a -> s {_risTagSpecifications = a}) .
  _Default . _Coerce

-- | [EC2-VPC] A number of IPv6 addresses to associate with the primary network interface. Amazon EC2 chooses the IPv6 addresses from the range of your subnet. You cannot specify this option and the option to assign specific IPv6 addresses in the same request. You can specify this option if you've specified a minimum number of instances to launch.
risIPv6AddressCount :: Lens' RunInstances (Maybe Int)
risIPv6AddressCount =
  lens _risIPv6AddressCount (\s a -> s {_risIPv6AddressCount = a})

-- | The IAM instance profile.
risIAMInstanceProfile ::
     Lens' RunInstances (Maybe IAMInstanceProfileSpecification)
risIAMInstanceProfile =
  lens _risIAMInstanceProfile (\s a -> s {_risIAMInstanceProfile = a})

-- | An elastic GPU to associate with the instance.
risElasticGpuSpecification :: Lens' RunInstances [ElasticGpuSpecification]
risElasticGpuSpecification =
  lens _risElasticGpuSpecification (\s a -> s {_risElasticGpuSpecification = a}) .
  _Default . _Coerce
...
risPrivateIPAddress =
  lens _risPrivateIPAddress (\s a -> s {_risPrivateIPAddress = a})

-- | Indicates whether an instance stops or terminates when you initiate shutdown from the instance (using the operating system command for system shutdown). Default: @stop@
risInstanceInitiatedShutdownBehavior ::
     Lens' RunInstances (Maybe ShutdownBehavior)
risInstanceInitiatedShutdownBehavior =
  lens
    _risInstanceInitiatedShutdownBehavior
    (\s a -> s {_risInstanceInitiatedShutdownBehavior = a})
...
risCreditSpecification =
  lens _risCreditSpecification (\s a -> s {_risCreditSpecification = a})

-- | One or more block device mapping entries. You can't specify both a snapshot ID and an encryption value. This is because only blank volumes can be encrypted on creation. If a snapshot is the basis for a volume, it is not blank and its encryption status is used for the volume encryption status.
risBlockDeviceMappings :: Lens' RunInstances [BlockDeviceMapping]
risBlockDeviceMappings =
  lens _risBlockDeviceMappings (\s a -> s {_risBlockDeviceMappings = a}) .
  _Default . _Coerce
...
risIPv6Addresses =
  lens _risIPv6Addresses (\s a -> s {_risIPv6Addresses = a}) .
  _Default . _Coerce
...
instance ToQuery RunInstances where
  toQuery RunInstances' {..} =
    mconcat
      ...
      , toQuery
          (toQueryList "ElasticGpuSpecification" <$> _risElasticGpuSpecification)
      , "ImageId" =: _risImageId
      ...
      , toQuery (toQueryList "BlockDeviceMapping" <$> _risBlockDeviceMappings)
      , "DryRun" =: _risDryRun
