...
instance AWSRequest DisassociateIAMInstanceProfile where
  type Rs DisassociateIAMInstanceProfile = DisassociateIAMInstanceProfileResponse
...
diaprsIAMInstanceProfileAssociation ::
     Lens' DisassociateIAMInstanceProfileResponse (Maybe IAMInstanceProfileAssociation)
diaprsIAMInstanceProfileAssociation =
  lens
    _diaprsIAMInstanceProfileAssociation
    (\s a -> s {_diaprsIAMInstanceProfileAssociation = a})

-- | -- | The response status code.
diaprsResponseStatus :: Lens' DisassociateIAMInstanceProfileResponse Int
diaprsResponseStatus =
  lens _diaprsResponseStatus (\s a -> s {_diaprsResponseStatus = a})
