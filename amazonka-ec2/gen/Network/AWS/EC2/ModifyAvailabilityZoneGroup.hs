...
--
--
-- Use <https://docs.aws.amazon.com/AWSEC2ApiDocReef/build/server-root/AWSEC2/latest/APIReference/API_DescribeAvailabilityZones.html describe-availability-zones> to view the value for @GroupName@ .
--
module Network.AWS.EC2.ModifyAvailabilityZoneGroup
    (
    -- * Creating a Request
...
--
-- * 'mazgGroupName' - The name of the Availability Zone Group.
--
-- * 'mazgOptInStatus' - Indicates whether to enable or disable membership. The valid values are @opted-in@ . You must contact <https://console.aws.amazon.com/support/home#/case/create%3FissueType=customer-service%26serviceCode=general-info%26getting-started%26categoryCode=using-aws%26services AWS Support> to disable an Availability Zone group.
modifyAvailabilityZoneGroup
    :: Text -- ^ 'mazgGroupName'
...
-- | Indicates whether to enable or disable membership. The valid values are @opted-in@ . You must contact <https://console.aws.amazon.com/support/home#/case/create%3FissueType=customer-service%26serviceCode=general-info%26getting-started%26categoryCode=using-aws%26services AWS Support> to disable an Availability Zone group.
