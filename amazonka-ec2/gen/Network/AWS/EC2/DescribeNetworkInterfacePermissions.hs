...
dnipFilters =
  lens _dnipFilters (\s a -> s {_dnipFilters = a}) . _Default . _Coerce
...
dnipNetworkInterfacePermissionIds ::
     Lens' DescribeNetworkInterfacePermissions [Text]
dnipNetworkInterfacePermissionIds =
  lens
    _dnipNetworkInterfacePermissionIds
    (\s a -> s {_dnipNetworkInterfacePermissionIds = a}) .
  _Default . _Coerce
...
instance AWSRequest DescribeNetworkInterfacePermissions where
  type Rs DescribeNetworkInterfacePermissions = DescribeNetworkInterfacePermissionsResponse
...
dnipsrsNetworkInterfacePermissions ::
     Lens' DescribeNetworkInterfacePermissionsResponse [NetworkInterfacePermission]
dnipsrsNetworkInterfacePermissions =
  lens
    _dnipsrsNetworkInterfacePermissions
    (\s a -> s {_dnipsrsNetworkInterfacePermissions = a}) .
  _Default . _Coerce

-- | The token to use to retrieve the next page of results.
dnipsrsNextToken ::
     Lens' DescribeNetworkInterfacePermissionsResponse (Maybe Text)
...
dnipsrsResponseStatus =
  lens _dnipsrsResponseStatus (\s a -> s {_dnipsrsResponseStatus = a})
