...
dvescFilters =
  lens _dvescFilters (\s a -> s {_dvescFilters = a}) . _Default . _Coerce

-- | The IDs of one or more services.
dvescServiceIds :: Lens' DescribeVPCEndpointServiceConfigurations [Text]
dvescServiceIds =
  lens _dvescServiceIds (\s a -> s {_dvescServiceIds = a}) . _Default . _Coerce
...
instance AWSRequest DescribeVPCEndpointServiceConfigurations where
  type Rs DescribeVPCEndpointServiceConfigurations = DescribeVPCEndpointServiceConfigurationsResponse
...
instance ToQuery DescribeVPCEndpointServiceConfigurations where
  toQuery DescribeVPCEndpointServiceConfigurations' {..} =
    mconcat
      [ "Action" =: ("DescribeVpcEndpointServiceConfigurations" :: ByteString)
...
dvescrsNextToken ::
     Lens' DescribeVPCEndpointServiceConfigurationsResponse (Maybe Text)
dvescrsNextToken = lens _dvescrsNextToken (\s a -> s {_dvescrsNextToken = a})

-- | Information about one or more services.
dvescrsServiceConfigurations ::
     Lens' DescribeVPCEndpointServiceConfigurationsResponse [ServiceConfiguration]
dvescrsServiceConfigurations =
  lens
    _dvescrsServiceConfigurations
    (\s a -> s {_dvescrsServiceConfigurations = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dvescrsResponseStatus ::
     Lens' DescribeVPCEndpointServiceConfigurationsResponse Int
dvescrsResponseStatus =
  lens _dvescrsResponseStatus (\s a -> s {_dvescrsResponseStatus = a})
