...
dvpcecnFilters =
  lens _dvpcecnFilters (\s a -> s {_dvpcecnFilters = a}) . _Default . _Coerce

-- | The token to request the next page of results.
dvpcecnNextToken ::
     Lens' DescribeVPCEndpointConnectionNotifications (Maybe Text)
...
dvpcecnConnectionNotificationId =
  lens
    ...
    (\s a -> s {_dvpcecnConnectionNotificationId = a})
...
dvpcecnMaxResults ::
     Lens' DescribeVPCEndpointConnectionNotifications (Maybe Int)
...
instance AWSRequest DescribeVPCEndpointConnectionNotifications where
  type Rs DescribeVPCEndpointConnectionNotifications = DescribeVPCEndpointConnectionNotificationsResponse
...
instance ToQuery DescribeVPCEndpointConnectionNotifications where
  toQuery DescribeVPCEndpointConnectionNotifications' {..} =
    mconcat
      [ "Action" =: ("DescribeVpcEndpointConnectionNotifications" :: ByteString)
...
dvpcecnrsConnectionNotificationSet ::
     Lens' DescribeVPCEndpointConnectionNotificationsResponse [ConnectionNotification]
dvpcecnrsConnectionNotificationSet =
  lens
    _dvpcecnrsConnectionNotificationSet
    (\s a -> s {_dvpcecnrsConnectionNotificationSet = a}) .
  _Default . _Coerce

-- | The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
dvpcecnrsNextToken ::
     Lens' DescribeVPCEndpointConnectionNotificationsResponse (Maybe Text)
dvpcecnrsNextToken =
  lens _dvpcecnrsNextToken (\s a -> s {_dvpcecnrsNextToken = a})

-- | -- | The response status code.
dvpcecnrsResponseStatus ::
     Lens' DescribeVPCEndpointConnectionNotificationsResponse Int
dvpcecnrsResponseStatus =
  lens _dvpcecnrsResponseStatus (\s a -> s {_dvpcecnrsResponseStatus = a})
