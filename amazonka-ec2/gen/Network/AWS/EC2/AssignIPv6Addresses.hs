...
aiaIPv6AddressCount =
  lens _aiaIPv6AddressCount (\s a -> s {_aiaIPv6AddressCount = a})

-- | One or more specific IPv6 addresses to be assigned to the network interface. You can't use this option if you're specifying a number of IPv6 addresses.
aiaIPv6Addresses :: Lens' AssignIPv6Addresses [Text]
aiaIPv6Addresses =
  lens _aiaIPv6Addresses (\s a -> s {_aiaIPv6Addresses = a}) .
  _Default . _Coerce

-- | The ID of the network interface.
aiaNetworkInterfaceId :: Lens' AssignIPv6Addresses Text
aiaNetworkInterfaceId =
  lens _aiaNetworkInterfaceId (\s a -> s {_aiaNetworkInterfaceId = a})
...
instance AWSRequest AssignIPv6Addresses where
  ...
  response =
    receiveXML
      (\s h x ->
         AssignIPv6AddressesResponse' <$> (x .@? "networkInterfaceId") <*>
         (x .@? "assignedIpv6Addresses" .!@ mempty >>= may (parseXMLList "item")) <*>
         (pure (fromEnum s)))
...
aiarsNetworkInterfaceId =
  lens _aiarsNetworkInterfaceId (\s a -> s {_aiarsNetworkInterfaceId = a})

-- | The IPv6 addresses assigned to the network interface.
aiarsAssignedIPv6Addresses :: Lens' AssignIPv6AddressesResponse [Text]
aiarsAssignedIPv6Addresses =
  lens _aiarsAssignedIPv6Addresses (\s a -> s {_aiarsAssignedIPv6Addresses = a}) .
  _Default . _Coerce
