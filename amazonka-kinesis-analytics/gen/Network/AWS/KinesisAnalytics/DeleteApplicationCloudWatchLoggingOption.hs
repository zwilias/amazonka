...
dacwloApplicationName =
  lens _dacwloApplicationName (\s a -> s {_dacwloApplicationName = a})

-- | The version ID of the Kinesis Analytics application.
dacwloCurrentApplicationVersionId ::
     Lens' DeleteApplicationCloudWatchLoggingOption Natural
dacwloCurrentApplicationVersionId =
  lens
    _dacwloCurrentApplicationVersionId
    (\s a -> s {_dacwloCurrentApplicationVersionId = a}) .
  _Nat
...
dacwloCloudWatchLoggingOptionId ::
     Lens' DeleteApplicationCloudWatchLoggingOption Text
dacwloCloudWatchLoggingOptionId =
  lens
    _dacwloCloudWatchLoggingOptionId
    (\s a -> s {_dacwloCloudWatchLoggingOptionId = a})

instance AWSRequest DeleteApplicationCloudWatchLoggingOption where
  type Rs DeleteApplicationCloudWatchLoggingOption = DeleteApplicationCloudWatchLoggingOptionResponse
...
instance ToHeaders DeleteApplicationCloudWatchLoggingOption where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("KinesisAnalytics_20150814.DeleteApplicationCloudWatchLoggingOption" :: ByteString)
...
dacwlorsResponseStatus ::
     Lens' DeleteApplicationCloudWatchLoggingOptionResponse Int
dacwlorsResponseStatus =
  lens _dacwlorsResponseStatus (\s a -> s {_dacwlorsResponseStatus = a})
