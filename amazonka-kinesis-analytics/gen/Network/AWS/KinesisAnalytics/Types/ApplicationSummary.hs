...
data ApplicationSummary = ApplicationSummary'{_asApplicationName
                                              :: !Text,
...
applicationSummary
    ...
    -> ApplicationSummary
applicationSummary pApplicationName_ pApplicationARN_
  pApplicationStatus_
  = ApplicationSummary'{_asApplicationName =
                          pApplicationName_,
