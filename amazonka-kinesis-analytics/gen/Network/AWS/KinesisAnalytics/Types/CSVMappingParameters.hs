...
data CSVMappingParameters = CSVMappingParameters'{_cmpRecordRowDelimiter
                                                  :: !Text,
...
csvMappingParameters
    ...
    -> CSVMappingParameters
csvMappingParameters pRecordRowDelimiter_
  pRecordColumnDelimiter_
  = CSVMappingParameters'{_cmpRecordRowDelimiter =
