...
data CloudWatchLoggingOptionDescription = CloudWatchLoggingOptionDescription'{_cwlodCloudWatchLoggingOptionId
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _cwlodLogStreamARN
...
cloudWatchLoggingOptionDescription
    ...
    -> Text -- ^ 'cwlodRoleARN'
    -> CloudWatchLoggingOptionDescription
cloudWatchLoggingOptionDescription pLogStreamARN_
  pRoleARN_
  = CloudWatchLoggingOptionDescription'{_cwlodCloudWatchLoggingOptionId
                                          = Nothing,
