...
data ApplicationDetail = ApplicationDetail'{_adApplicationDescription
                                            :: !(Maybe Text),
...
applicationDetail
    ...
    -> ApplicationDetail
applicationDetail pApplicationName_ pApplicationARN_
  pApplicationStatus_ pApplicationVersionId_
  = ApplicationDetail'{_adApplicationDescription =
                         Nothing,
