...
data InputDescription = InputDescription'{_idInputStartingPositionConfiguration
                                          ::
                                          !(Maybe
...
inputDescription
    :: InputDescription
inputDescription
  = InputDescription'{_idInputStartingPositionConfiguration
                        = Nothing,
                      _idInputParallelism = Nothing, _idInputId = Nothing,
