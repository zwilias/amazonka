...
newtype InputStartingPositionConfiguration = InputStartingPositionConfiguration'{_ispcInputStartingPosition
                                                                                 ::
                                                                                 Maybe
...
inputStartingPositionConfiguration
    :: InputStartingPositionConfiguration
inputStartingPositionConfiguration
  = InputStartingPositionConfiguration'{_ispcInputStartingPosition
                                          = Nothing}
