...
daipcApplicationName =
  lens _daipcApplicationName (\s a -> s {_daipcApplicationName = a})

-- | The version ID of the Kinesis Analytics application.
daipcCurrentApplicationVersionId ::
     Lens' DeleteApplicationInputProcessingConfiguration Natural
daipcCurrentApplicationVersionId =
  lens
    _daipcCurrentApplicationVersionId
    (\s a -> s {_daipcCurrentApplicationVersionId = a}) .
  _Nat
...
instance AWSRequest DeleteApplicationInputProcessingConfiguration where
  type Rs DeleteApplicationInputProcessingConfiguration = DeleteApplicationInputProcessingConfigurationResponse
...
instance ToHeaders DeleteApplicationInputProcessingConfiguration where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("KinesisAnalytics_20150814.DeleteApplicationInputProcessingConfiguration" :: ByteString)
  ...
  toJSON DeleteApplicationInputProcessingConfiguration' {..} =
    object
      (catMaybes
         ...
         , Just
             ("CurrentApplicationVersionId" .= _daipcCurrentApplicationVersionId)
...
daipcrsResponseStatus ::
     Lens' DeleteApplicationInputProcessingConfigurationResponse Int
daipcrsResponseStatus =
  lens _daipcrsResponseStatus (\s a -> s {_daipcrsResponseStatus = a})

instance NFData DeleteApplicationInputProcessingConfigurationResponse
