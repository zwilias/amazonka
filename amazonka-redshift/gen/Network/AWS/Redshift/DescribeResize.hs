...
drrsImportTablesNotStarted =
  lens _drrsImportTablesNotStarted (\s a -> s {_drrsImportTablesNotStarted = a}) .
  _Default . _Coerce
...
drrsEstimatedTimeToCompletionInSeconds ::
     Lens' DescribeResizeResponse (Maybe Integer)
drrsEstimatedTimeToCompletionInSeconds =
  lens
...
drrsAvgResizeRateInMegaBytesPerSecond ::
     Lens' DescribeResizeResponse (Maybe Double)
drrsAvgResizeRateInMegaBytesPerSecond =
  lens
...
drrsTargetNumberOfNodes =
  lens _drrsTargetNumberOfNodes (\s a -> s {_drrsTargetNumberOfNodes = a})
...
drrsImportTablesInProgress =
  lens _drrsImportTablesInProgress (\s a -> s {_drrsImportTablesInProgress = a}) .
  _Default . _Coerce
...
drrsImportTablesCompleted =
  lens _drrsImportTablesCompleted (\s a -> s {_drrsImportTablesCompleted = a}) .
  _Default . _Coerce

-- | While the resize operation is in progress, this value shows the current amount of data, in megabytes, that has been processed so far. When the resize operation is complete, this value shows the total amount of data, in megabytes, on the cluster, which may be more or less than TotalResizeDataInMegaBytes (the estimated total amount of data before resize).
drrsProgressInMegaBytes :: Lens' DescribeResizeResponse (Maybe Integer)
drrsProgressInMegaBytes =
  lens _drrsProgressInMegaBytes (\s a -> s {_drrsProgressInMegaBytes = a})
...
drrsElapsedTimeInSeconds =
  lens _drrsElapsedTimeInSeconds (\s a -> s {_drrsElapsedTimeInSeconds = a})
