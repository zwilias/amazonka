...
dSnapshotIdentifier =
  lens _dSnapshotIdentifier (\s a -> s {_dSnapshotIdentifier = a})
...
dClusterIdentifier =
  lens _dClusterIdentifier (\s a -> s {_dClusterIdentifier = a})
...
dcssrsSnapshots =
  lens _dcssrsSnapshots (\s a -> s {_dcssrsSnapshots = a}) . _Default . _Coerce
...
dcssrsResponseStatus =
  lens _dcssrsResponseStatus (\s a -> s {_dcssrsResponseStatus = a})
