...
data DescribeHSMClientCertificates = DescribeHSMClientCertificates'{_dhccTagValues
                                                                    ::
                                                                    !(Maybe
                                                                        [Text]),
                                                                    _dhccTagKeys
...
describeHSMClientCertificates
    :: DescribeHSMClientCertificates
describeHSMClientCertificates
  = DescribeHSMClientCertificates'{_dhccTagValues =
                                     Nothing,
...
data DescribeHSMClientCertificatesResponse = DescribeHSMClientCertificatesResponse'{_dhccrsMarker
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
describeHSMClientCertificatesResponse
  pResponseStatus_
  = DescribeHSMClientCertificatesResponse'{_dhccrsMarker
                                             = Nothing,
                                           _dhccrsHSMClientCertificates =
                                             Nothing,
                                           _dhccrsResponseStatus =
