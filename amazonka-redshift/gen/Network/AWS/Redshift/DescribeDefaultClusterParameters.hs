...
ddcpParameterGroupFamily =
  lens _ddcpParameterGroupFamily (\s a -> s {_ddcpParameterGroupFamily = a})

instance AWSPager DescribeDefaultClusterParameters where
  page rq rs
    | stop (rs ^? ddcprsDefaultClusterParameters . dcpMarker . _Just) = Nothing
    | stop (rs ^. ddcprsDefaultClusterParameters . dcpParameters) = Nothing
    | otherwise =
      Just $ rq & ddcpMarker .~ rs ^? ddcprsDefaultClusterParameters . dcpMarker .
      _Just
...
instance AWSRequest DescribeDefaultClusterParameters where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DescribeDefaultClusterParametersResponse' <$> (pure (fromEnum s)) <*>
...
-- | Undocumented member.
ddcprsDefaultClusterParameters ::
     Lens' DescribeDefaultClusterParametersResponse DefaultClusterParameters
ddcprsDefaultClusterParameters =
  lens
