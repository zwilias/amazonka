...
delSkipFinalClusterSnapshot =
  lens
    ...
    (\s a -> s {_delSkipFinalClusterSnapshot = a})
...
delFinalClusterSnapshotIdentifier =
  lens
    ...
    (\s a -> s {_delFinalClusterSnapshotIdentifier = a})
...
delClusterIdentifier =
  lens _delClusterIdentifier (\s a -> s {_delClusterIdentifier = a})
...
instance ToQuery DeleteCluster where
  toQuery DeleteCluster' {..} =
    mconcat
      ...
      , "FinalClusterSnapshotIdentifier" =: _delFinalClusterSnapshotIdentifier
