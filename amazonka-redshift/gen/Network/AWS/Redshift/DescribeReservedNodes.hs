...
data DescribeReservedNodes = DescribeReservedNodes'{_drnReservedNodeId
                                                    :: !(Maybe Text),
...
describeReservedNodes
    :: DescribeReservedNodes
describeReservedNodes
  = DescribeReservedNodes'{_drnReservedNodeId =
                             Nothing,
                           _drnMarker = Nothing, _drnMaxRecords = Nothing}
...
data DescribeReservedNodesResponse = DescribeReservedNodesResponse'{_drnrsReservedNodes
                                                                    ::
                                                                    !(Maybe
                                                                        [ReservedNode]),
                                                                    _drnrsMarker
...
describeReservedNodesResponse pResponseStatus_
  = DescribeReservedNodesResponse'{_drnrsReservedNodes
                                     = Nothing,
