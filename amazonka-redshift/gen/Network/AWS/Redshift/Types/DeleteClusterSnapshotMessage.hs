...
data DeleteClusterSnapshotMessage = DeleteClusterSnapshotMessage'{_dcsmSnapshotClusterIdentifier
                                                                  ::
                                                                  !(Maybe Text),
...
deleteClusterSnapshotMessage pSnapshotIdentifier_
  = DeleteClusterSnapshotMessage'{_dcsmSnapshotClusterIdentifier
                                    = Nothing,
                                  _dcsmSnapshotIdentifier =
