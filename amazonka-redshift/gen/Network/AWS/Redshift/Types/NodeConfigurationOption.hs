...
data NodeConfigurationOption = NodeConfigurationOption'{_ncoMode
                                                        :: !(Maybe Mode),
                                                        _ncoNumberOfNodes ::
                                                        !(Maybe Int),
                                                        _ncoNodeType ::
...
nodeConfigurationOption
    :: NodeConfigurationOption
nodeConfigurationOption
  = NodeConfigurationOption'{_ncoMode = Nothing,
...
instance FromXML NodeConfigurationOption where
        parseXML x
          = NodeConfigurationOption' <$>
              (x .@? "Mode") <*> (x .@? "NumberOfNodes") <*>
                (x .@? "NodeType")
                <*> (x .@? "EstimatedDiskUtilizationPercent")

instance Hashable NodeConfigurationOption where

instance NFData NodeConfigurationOption where
