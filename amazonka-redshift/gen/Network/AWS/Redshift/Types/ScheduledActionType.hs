...
data ScheduledActionType = ScheduledActionType'{_satResizeCluster
                                                ::
...
scheduledActionType
    :: ScheduledActionType
scheduledActionType
  = ScheduledActionType'{_satResizeCluster = Nothing,
...
instance FromXML ScheduledActionType where
        parseXML x
          = ScheduledActionType' <$>
              (x .@? "ResizeCluster") <*> (x .@? "ResumeCluster")
                <*> (x .@? "PauseCluster")

instance Hashable ScheduledActionType where

instance NFData ScheduledActionType where
