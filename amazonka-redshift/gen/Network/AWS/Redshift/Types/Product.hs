...
instance FromXML AccountWithRestoreAccess where
  parseXML x =
    AccountWithRestoreAccess' <$> (x .@? "AccountAlias") <*> (x .@? "AccountId")
...
azSupportedPlatforms =
  lens _azSupportedPlatforms (\s a -> s {_azSupportedPlatforms = a}) .
  _Default . _Coerce

instance FromXML AvailabilityZone where
  parseXML x =
    AvailabilityZone' <$> (x .@? "Name") <*>
...
cEnhancedVPCRouting =
  lens _cEnhancedVPCRouting (\s a -> s {_cEnhancedVPCRouting = a})

-- | A value that returns the destination region and retention period that are configured for cross-region snapshot copy.
cClusterSnapshotCopyStatus :: Lens' Cluster (Maybe ClusterSnapshotCopyStatus)
cClusterSnapshotCopyStatus =
  lens _cClusterSnapshotCopyStatus (\s a -> s {_cClusterSnapshotCopyStatus = a})
...
cAutomatedSnapshotRetentionPeriod =
  lens
    _cAutomatedSnapshotRetentionPeriod
...
cClusterCreateTime =
  lens _cClusterCreateTime (\s a -> s {_cClusterCreateTime = a}) . mapping _Time
...
cClusterNodes =
  lens _cClusterNodes (\s a -> s {_cClusterNodes = a}) . _Default . _Coerce
...
instance FromXML Cluster where
  parseXML x =
    Cluster' <$> (x .@? "RestoreStatus") <*> (x .@? "EnhancedVpcRouting") <*>
    ...
    (x .@? "HsmStatus") <*>
    (x .@? "IamRoles" .!@ mempty >>= may (parseXMLList "ClusterIamRole")) <*>
    (x .@? "ElasticIpStatus") <*>
    (x .@? "ClusterVersion") <*>
    (x .@? "NodeType") <*>
    (x .@? "ClusterCreateTime") <*>
...
instance FromXML ClusterIAMRole where
  parseXML x =
    ClusterIAMRole' <$> (x .@? "IamRoleArn") <*> (x .@? "ApplyStatus")
...
instance FromXML ClusterNode where
  parseXML x =
    ClusterNode' <$> (x .@? "NodeRole") <*> (x .@? "PrivateIPAddress") <*>
    (x .@? "PublicIPAddress")
...
instance FromXML ClusterParameterGroup where
  parseXML x =
    ClusterParameterGroup' <$> (x .@? "ParameterGroupFamily") <*>
    (x .@? "Description") <*>
    (x .@? "Tags" .!@ mempty >>= may (parseXMLList "Tag")) <*>
...
cpgnmParameterGroupStatus =
  lens _cpgnmParameterGroupStatus (\s a -> s {_cpgnmParameterGroupStatus = a})
...
instance FromXML ClusterParameterGroupNameMessage where
  parseXML x =
    ClusterParameterGroupNameMessage' <$> (x .@? "ParameterGroupStatus") <*>
    (x .@? "ParameterGroupName")
...
cpgsClusterParameterStatusList ::
     Lens' ClusterParameterGroupStatus [ClusterParameterStatus]
cpgsClusterParameterStatusList =
  lens
    _cpgsClusterParameterStatusList
    (\s a -> s {_cpgsClusterParameterStatusList = a}) .
  _Default . _Coerce
...
cpsParameterApplyErrorDescription =
  lens
    ...
    (\s a -> s {_cpsParameterApplyErrorDescription = a})
...
cpsParameterApplyStatus =
  lens _cpsParameterApplyStatus (\s a -> s {_cpsParameterApplyStatus = a})

instance FromXML ClusterParameterStatus where
  parseXML x =
    ClusterParameterStatus' <$> (x .@? "ParameterApplyErrorDescription") <*>
    (x .@? "ParameterName") <*>
    (x .@? "ParameterApplyStatus")
...
instance FromXML ClusterSecurityGroup where
  parseXML x =
    ClusterSecurityGroup' <$> (x .@? "ClusterSecurityGroupName") <*>
...
csgmClusterSecurityGroupName ::
     Lens' ClusterSecurityGroupMembership (Maybe Text)
csgmClusterSecurityGroupName =
  lens
...
instance FromXML ClusterSecurityGroupMembership where
  parseXML x =
    ClusterSecurityGroupMembership' <$> (x .@? "Status") <*>
...
cscsSnapshotCopyGrantName =
  lens _cscsSnapshotCopyGrantName (\s a -> s {_cscsSnapshotCopyGrantName = a})

instance FromXML ClusterSnapshotCopyStatus where
  parseXML x =
    ClusterSnapshotCopyStatus' <$> (x .@? "RetentionPeriod") <*>
    (x .@? "DestinationRegion") <*>
...
csgClusterSubnetGroupName =
  lens _csgClusterSubnetGroupName (\s a -> s {_csgClusterSubnetGroupName = a})

-- | The status of the cluster subnet group. Possible values are @Complete@ , @Incomplete@ and @Invalid@ .
csgSubnetGroupStatus :: Lens' ClusterSubnetGroup (Maybe Text)
csgSubnetGroupStatus =
  lens _csgSubnetGroupStatus (\s a -> s {_csgSubnetGroupStatus = a})
...
instance FromXML ClusterVersion where
  parseXML x =
    ClusterVersion' <$> (x .@? "ClusterParameterGroupFamily") <*>
    (x .@? "ClusterVersion") <*>
    (x .@? "Description")
...
dcpParameters =
  lens _dcpParameters (\s a -> s {_dcpParameters = a}) . _Default . _Coerce
...
instance FromXML DefaultClusterParameters where
  parseXML x =
    DefaultClusterParameters' <$> (x .@? "Marker") <*>
...
instance FromXML ElasticIPStatus where
  parseXML x = ElasticIPStatus' <$> (x .@? "Status") <*> (x .@? "ElasticIp")
...
instance FromXML EventInfoMap where
  parseXML x =
    EventInfoMap' <$> (x .@? "EventDescription") <*> (x .@? "Severity") <*>
    (x .@? "EventCategories" .!@ mempty >>= may (parseXMLList "EventCategory")) <*>
    (x .@? "EventId")
...
instance FromXML HSMClientCertificate where
  parseXML x =
    HSMClientCertificate' <$> (x .@? "HsmClientCertificateIdentifier") <*>
...
instance FromXML HSMConfiguration where
  parseXML x =
    HSMConfiguration' <$> (x .@? "HsmConfigurationIdentifier") <*>
    (x .@? "HsmPartitionName") <*>
    (x .@? "Description") <*>
    (x .@? "Tags" .!@ mempty >>= may (parseXMLList "Tag")) <*>
    (x .@? "HsmIpAddress")
...
hsHSMClientCertificateIdentifier =
  lens
    _hsHSMClientCertificateIdentifier
    (\s a -> s {_hsHSMClientCertificateIdentifier = a})

instance FromXML HSMStatus where
  parseXML x =
    HSMStatus' <$> (x .@? "Status") <*> (x .@? "HsmConfigurationIdentifier") <*>
...
lsLastFailureTime =
  lens _lsLastFailureTime (\s a -> s {_lsLastFailureTime = a}) . mapping _Time
...
instance FromXML LoggingStatus where
  parseXML x =
    LoggingStatus' <$> (x .@? "LastFailureTime") <*>
...
pmvEnhancedVPCRouting =
  lens _pmvEnhancedVPCRouting (\s a -> s {_pmvEnhancedVPCRouting = a})
...
pmvPubliclyAccessible =
  lens _pmvPubliclyAccessible (\s a -> s {_pmvPubliclyAccessible = a})
...
instance FromXML PendingModifiedValues where
  parseXML x =
    PendingModifiedValues' <$> (x .@? "EnhancedVpcRouting") <*>
...
rnReservedNodeOfferingType ::
     Lens' ReservedNode (Maybe ReservedNodeOfferingType)
rnReservedNodeOfferingType =
  lens _rnReservedNodeOfferingType (\s a -> s {_rnReservedNodeOfferingType = a})
...
rnReservedNodeOfferingId =
  lens _rnReservedNodeOfferingId (\s a -> s {_rnReservedNodeOfferingId = a})
...
instance FromXML ReservedNode where
  parseXML x =
    ReservedNode' <$> (x .@? "ReservedNodeOfferingType") <*> (x .@? "State") <*>
    (x .@? "CurrencyCode") <*>
    (x .@? "StartTime") <*>
    (x .@? "NodeCount") <*>
    (x .@? "ReservedNodeId") <*>
...
rnoReservedNodeOfferingType ::
     Lens' ReservedNodeOffering (Maybe ReservedNodeOfferingType)
rnoReservedNodeOfferingType =
  lens
    _rnoReservedNodeOfferingType
    (\s a -> s {_rnoReservedNodeOfferingType = a})
...
rnoReservedNodeOfferingId =
  lens _rnoReservedNodeOfferingId (\s a -> s {_rnoReservedNodeOfferingId = a})
...
instance FromXML ReservedNodeOffering where
  parseXML x =
    ReservedNodeOffering' <$> (x .@? "ReservedNodeOfferingType") <*>
    (x .@? "CurrencyCode") <*>
    (x .@? "ReservedNodeOfferingId") <*>
    (x .@? "RecurringCharges" .!@ mempty >>=
     may (parseXMLList "RecurringCharge")) <*>
...
sRestorableNodeTypes =
  lens _sRestorableNodeTypes (\s a -> s {_sRestorableNodeTypes = a}) .
  _Default . _Coerce

-- | A list of the AWS customer accounts authorized to restore the snapshot. Returns @null@ if no accounts are authorized. Visible only to the snapshot owner.
sAccountsWithRestoreAccess :: Lens' Snapshot [AccountWithRestoreAccess]
sAccountsWithRestoreAccess =
  lens _sAccountsWithRestoreAccess (\s a -> s {_sAccountsWithRestoreAccess = a}) .
  _Default . _Coerce

-- | An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that uses enhanced VPC routing, the cluster must be in a VPC. For more information, see <http://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html Enhanced VPC Routing> in the Amazon Redshift Cluster Management Guide. If this option is @true@ , enhanced VPC routing is enabled.  Default: false
sEnhancedVPCRouting :: Lens' Snapshot (Maybe Bool)
sEnhancedVPCRouting =
  lens _sEnhancedVPCRouting (\s a -> s {_sEnhancedVPCRouting = a})
...
sBackupProgressInMegaBytes =
  lens _sBackupProgressInMegaBytes (\s a -> s {_sBackupProgressInMegaBytes = a})
...
instance FromXML Snapshot where
  parseXML x =
    Snapshot' <$> (x .@? "Status") <*>
    (x .@? "RestorableNodeTypes" .!@ mempty >>= may (parseXMLList "NodeType")) <*>
...
scgSnapshotCopyGrantName =
  lens _scgSnapshotCopyGrantName (\s a -> s {_scgSnapshotCopyGrantName = a})
...
instance FromXML TableRestoreStatus where
  parseXML x =
    TableRestoreStatus' <$> (x .@? "Status") <*> (x .@? "TargetSchemaName") <*>
    (x .@? "SnapshotIdentifier") <*>
...
instance FromXML TaggedResource where
  parseXML x =
    TaggedResource' <$> (x .@? "Tag") <*> (x .@? "ResourceType") <*>
    (x .@? "ResourceName")
