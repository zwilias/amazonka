...
data NodeConfigurationOptionsFilter = NodeConfigurationOptionsFilter'{_ncofValues
                                                                      ::
                                                                      !(Maybe
                                                                          [Text]),
                                                                      _ncofOperator
...
nodeConfigurationOptionsFilter
    :: NodeConfigurationOptionsFilter
nodeConfigurationOptionsFilter
  = NodeConfigurationOptionsFilter'{_ncofValues =
                                      Nothing,
...
instance NFData NodeConfigurationOptionsFilter where
        ...
        toQuery NodeConfigurationOptionsFilter'{..}
          = mconcat
              ["Value" =:
               ...
               "Operator" =: _ncofOperator, "Name" =: _ncofName]
