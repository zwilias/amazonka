...
data HSMConfiguration = HSMConfiguration'{_hcHSMConfigurationIdentifier
                                          :: !(Maybe Text),
...
hsmConfiguration
    :: HSMConfiguration
hsmConfiguration
  = HSMConfiguration'{_hcHSMConfigurationIdentifier =
                        Nothing,
                      _hcHSMPartitionName = Nothing,
                      _hcDescription = Nothing, _hcTags = Nothing,
