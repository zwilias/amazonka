...
data ScheduledActionFilter = ScheduledActionFilter'{_safName
                                                    ::
...
scheduledActionFilter
    :: ScheduledActionFilterName -- ^ 'safName'
    -> ScheduledActionFilter
scheduledActionFilter pName_
  = ScheduledActionFilter'{_safName = pName_,
                           _safValues = mempty}
...
instance Hashable ScheduledActionFilter where

instance NFData ScheduledActionFilter where
