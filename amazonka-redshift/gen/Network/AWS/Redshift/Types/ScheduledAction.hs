...
data ScheduledAction = ScheduledAction'{_saState ::
...
scheduledAction
    :: ScheduledAction
scheduledAction
  = ScheduledAction'{_saState = Nothing,
                     _saTargetAction = Nothing, _saStartTime = Nothing,
                     _saSchedule = Nothing,
                     _saScheduledActionName = Nothing,
                     _saScheduledActionDescription = Nothing,
                     _saNextInvocations = Nothing, _saEndTime = Nothing,
                     _saIAMRole = Nothing}
