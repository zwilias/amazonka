...
data UsageLimit = UsageLimit'{_ulAmount ::
                              !(Maybe Integer),
...
usageLimit
    :: UsageLimit
usageLimit
  = UsageLimit'{_ulAmount = Nothing,
                _ulLimitType = Nothing, _ulUsageLimitId = Nothing,
                _ulPeriod = Nothing, _ulClusterIdentifier = Nothing,
                _ulBreachAction = Nothing, _ulFeatureType = Nothing,
                _ulTags = Nothing}
...
instance Hashable UsageLimit where

instance NFData UsageLimit where
