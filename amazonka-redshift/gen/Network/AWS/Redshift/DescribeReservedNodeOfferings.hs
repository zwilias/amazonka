...
drnoReservedNodeOfferingId =
  lens _drnoReservedNodeOfferingId (\s a -> s {_drnoReservedNodeOfferingId = a})
...
drnorsReservedNodeOfferings ::
     Lens' DescribeReservedNodeOfferingsResponse [ReservedNodeOffering]
drnorsReservedNodeOfferings =
  lens
...
drnorsResponseStatus =
  lens _drnorsResponseStatus (\s a -> s {_drnorsResponseStatus = a})
