...
ccEnhancedVPCRouting =
  lens _ccEnhancedVPCRouting (\s a -> s {_ccEnhancedVPCRouting = a})
...
ccClusterSubnetGroupName =
  lens _ccClusterSubnetGroupName (\s a -> s {_ccClusterSubnetGroupName = a})
  ...
  toQuery CreateCluster' {..} =
    mconcat
      ...
      , "ClusterSecurityGroups" =:
        toQuery
          (toQueryList "ClusterSecurityGroupName" <$> _ccClusterSecurityGroups)
      ...
      , "VpcSecurityGroupIds" =:
        toQuery (toQueryList "VpcSecurityGroupId" <$> _ccVPCSecurityGroupIds)
