...
uecEmailChannelRequest =
  lens _uecEmailChannelRequest (\s a -> s {_uecEmailChannelRequest = a})
...
instance AWSRequest UpdateEmailChannel where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdateEmailChannelResponse' <$> (pure (fromEnum s)) <*>
         (eitherParseJSON x))
...
instance ToJSON UpdateEmailChannel where
  toJSON UpdateEmailChannel' {..} =
    object (catMaybes [Just ("EmailChannelRequest" .= _uecEmailChannelRequest)])
...
-- | Undocumented member.
uecrsEmailChannelResponse ::
     Lens' UpdateEmailChannelResponse EmailChannelResponse
uecrsEmailChannelResponse =
  lens _uecrsEmailChannelResponse (\s a -> s {_uecrsEmailChannelResponse = a})
