...
newtype DeleteAPNSVoipSandboxChannel =
  DeleteAPNSVoipSandboxChannel'
...
davscApplicationId =
  lens _davscApplicationId (\s a -> s {_davscApplicationId = a})

instance AWSRequest DeleteAPNSVoipSandboxChannel where
  type Rs DeleteAPNSVoipSandboxChannel = DeleteAPNSVoipSandboxChannelResponse
  request = delete pinpoint
  response =
    receiveJSON
      (\s h x ->
         DeleteAPNSVoipSandboxChannelResponse' <$> (pure (fromEnum s)) <*>
         (eitherParseJSON x))
...
instance ToPath DeleteAPNSVoipSandboxChannel where
  toPath DeleteAPNSVoipSandboxChannel' {..} =
    mconcat
      ["/v1/apps/", toBS _davscApplicationId, "/channels/apns_voip_sandbox"]
...
davscrsResponseStatus =
  lens _davscrsResponseStatus (\s a -> s {_davscrsResponseStatus = a})

-- | Undocumented member.
davscrsAPNSVoipSandboxChannelResponse ::
     Lens' DeleteAPNSVoipSandboxChannelResponse APNSVoipSandboxChannelResponse
davscrsAPNSVoipSandboxChannelResponse =
  lens
    _davscrsAPNSVoipSandboxChannelResponse
    (\s a -> s {_davscrsAPNSVoipSandboxChannelResponse = a})
