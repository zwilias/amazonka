...
-- | Undocumented member.
uasWriteApplicationSettingsRequest ::
     Lens' UpdateApplicationSettings WriteApplicationSettingsRequest
uasWriteApplicationSettingsRequest =
  lens
    _uasWriteApplicationSettingsRequest
    (\s a -> s {_uasWriteApplicationSettingsRequest = a})

instance AWSRequest UpdateApplicationSettings where
  type Rs UpdateApplicationSettings = UpdateApplicationSettingsResponse
  request = putJSON pinpoint
  response =
    receiveJSON
      (\s h x ->
         UpdateApplicationSettingsResponse' <$> (pure (fromEnum s)) <*>
         (eitherParseJSON x))
...
uasrsResponseStatus =
  lens _uasrsResponseStatus (\s a -> s {_uasrsResponseStatus = a})

-- | Undocumented member.
uasrsApplicationSettingsResource ::
     Lens' UpdateApplicationSettingsResponse ApplicationSettingsResource
uasrsApplicationSettingsResource =
  lens
    _uasrsApplicationSettingsResource
    (\s a -> s {_uasrsApplicationSettingsResource = a})
