...
data TemplateVersionResponse = TemplateVersionResponse'{_tvTemplateDescription
                                                        :: !(Maybe Text),
                                                        _tvDefaultSubstitutions
                                                        :: !(Maybe Text),
                                                        _tvVersion ::
                                                        !(Maybe Text),
                                                        _tvLastModifiedDate ::
...
templateVersionResponse
    :: Text -- ^ 'tvLastModifiedDate'
    -> Text -- ^ 'tvCreationDate'
    -> Text -- ^ 'tvTemplateName'
    -> Text -- ^ 'tvTemplateType'
    -> TemplateVersionResponse
templateVersionResponse pLastModifiedDate_
  pCreationDate_ pTemplateName_ pTemplateType_
  = TemplateVersionResponse'{_tvTemplateDescription =
                               Nothing,
...
instance FromJSON TemplateVersionResponse where
        parseJSON
          = withObject "TemplateVersionResponse"
              (\ x ->
                 TemplateVersionResponse' <$>
...
instance Hashable TemplateVersionResponse where

instance NFData TemplateVersionResponse where
