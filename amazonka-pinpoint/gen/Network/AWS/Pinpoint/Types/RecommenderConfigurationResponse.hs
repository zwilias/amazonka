...
data RecommenderConfigurationResponse = RecommenderConfigurationResponse'{_rcRecommendationTransformerURI
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
recommenderConfigurationResponse
    :: Text -- ^ 'rcRecommendationProviderURI'
    -> Text -- ^ 'rcLastModifiedDate'
    -> Text -- ^ 'rcCreationDate'
    -> Text -- ^ 'rcRecommendationProviderRoleARN'
    -> Text -- ^ 'rcId'
    -> RecommenderConfigurationResponse
recommenderConfigurationResponse
  pRecommendationProviderURI_ pLastModifiedDate_
  pCreationDate_ pRecommendationProviderRoleARN_ pId_
  = RecommenderConfigurationResponse'{_rcRecommendationTransformerURI
                                        = Nothing,
...
instance FromJSON RecommenderConfigurationResponse
         where
        parseJSON
          = withObject "RecommenderConfigurationResponse"
              (\ x ->
                 RecommenderConfigurationResponse' <$>
