...
data TemplateResponse = TemplateResponse'{_temARN ::
                                          !(Maybe Text),
                                          _temTemplateDescription ::
                                          !(Maybe Text),
                                          _temDefaultSubstitutions ::
                                          !(Maybe Text),
...
templateResponse
    :: Text -- ^ 'temLastModifiedDate'
    -> Text -- ^ 'temCreationDate'
    -> Text -- ^ 'temTemplateName'
    -> TemplateType -- ^ 'temTemplateType'
    -> TemplateResponse
templateResponse pLastModifiedDate_ pCreationDate_
  pTemplateName_ pTemplateType_
  = TemplateResponse'{_temARN = Nothing,
                      _temTemplateDescription = Nothing,
                      _temDefaultSubstitutions = Nothing,
                      _temVersion = Nothing, _temTags = Nothing,
...
instance FromJSON TemplateResponse where
        parseJSON
          = withObject "TemplateResponse"
              (\ x ->
                 TemplateResponse' <$>
                   (x .:? "Arn") <*> (x .:? "TemplateDescription") <*>
...
instance Hashable TemplateResponse where

instance NFData TemplateResponse where
