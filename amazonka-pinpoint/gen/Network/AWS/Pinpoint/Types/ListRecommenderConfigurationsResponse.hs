...
data ListRecommenderConfigurationsResponse = ListRecommenderConfigurationsResponse'{_lrcNextToken
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
                                                                                    _lrcItem
...
listRecommenderConfigurationsResponse
    :: ListRecommenderConfigurationsResponse
listRecommenderConfigurationsResponse
  = ListRecommenderConfigurationsResponse'{_lrcNextToken
                                             = Nothing,
                                           _lrcItem = mempty}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ListRecommenderConfigurationsResponse"
              (\ x ->
                 ListRecommenderConfigurationsResponse' <$>
