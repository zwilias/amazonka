...
data EmailTemplateResponse = EmailTemplateResponse'{_etSubject
                                                    :: !(Maybe Text),
                                                    _etTextPart ::
                                                    !(Maybe Text),
                                                    _etARN :: !(Maybe Text),
                                                    _etTemplateDescription ::
                                                    !(Maybe Text),
                                                    _etDefaultSubstitutions ::
                                                    !(Maybe Text),
...
emailTemplateResponse
    :: Text -- ^ 'etLastModifiedDate'
    -> Text -- ^ 'etCreationDate'
    -> Text -- ^ 'etTemplateName'
    -> TemplateType -- ^ 'etTemplateType'
    -> EmailTemplateResponse
emailTemplateResponse pLastModifiedDate_
  pCreationDate_ pTemplateName_ pTemplateType_
  = EmailTemplateResponse'{_etSubject = Nothing,
                           _etTextPart = Nothing, _etARN = Nothing,
                           _etTemplateDescription = Nothing,
                           _etDefaultSubstitutions = Nothing,
                           _etVersion = Nothing, _etHTMLPart = Nothing,
                           _etRecommenderId = Nothing, _etTags = Nothing,
...
instance FromJSON EmailTemplateResponse where
        parseJSON
          = withObject "EmailTemplateResponse"
              (\ x ->
                 EmailTemplateResponse' <$>
                   (x .:? "Subject") <*> (x .:? "TextPart") <*>
                     (x .:? "Arn")
...
instance Hashable EmailTemplateResponse where

instance NFData EmailTemplateResponse where
