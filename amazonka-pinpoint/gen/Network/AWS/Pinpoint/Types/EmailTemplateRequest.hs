...
data EmailTemplateRequest = EmailTemplateRequest'{_etrSubject
                                                  :: !(Maybe Text),
...
emailTemplateRequest
    :: EmailTemplateRequest
emailTemplateRequest
  = EmailTemplateRequest'{_etrSubject = Nothing,
                          _etrTextPart = Nothing,
                          _etrTemplateDescription = Nothing,
                          _etrDefaultSubstitutions = Nothing,
                          _etrHTMLPart = Nothing, _etrRecommenderId = Nothing,
                          _etrTags = Nothing}
...
instance Hashable EmailTemplateRequest where

instance NFData EmailTemplateRequest where
