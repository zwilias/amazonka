...
data SimpleCondition = SimpleCondition'{_scSegmentDimensions
...
simpleCondition
    :: SimpleCondition
simpleCondition
  = SimpleCondition'{_scSegmentDimensions = Nothing,
...
instance Hashable SimpleCondition where

instance NFData SimpleCondition where
