...
data ChannelResponse = ChannelResponse'{_chaLastModifiedDate
                                        :: !(Maybe Text),
...
channelResponse
    :: ChannelResponse
channelResponse
  = ChannelResponse'{_chaLastModifiedDate = Nothing,
                     _chaEnabled = Nothing, _chaIsArchived = Nothing,
                     _chaApplicationId = Nothing, _chaVersion = Nothing,
                     _chaId = Nothing, _chaCreationDate = Nothing,
