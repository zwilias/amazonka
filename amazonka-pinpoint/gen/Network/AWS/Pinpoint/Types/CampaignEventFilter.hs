...
data CampaignEventFilter = CampaignEventFilter'{_cefFilterType
                                                :: !FilterType,
                                                _cefDimensions ::
                                                !EventDimensions}
...
campaignEventFilter
    :: FilterType -- ^ 'cefFilterType'
    -> EventDimensions -- ^ 'cefDimensions'
    -> CampaignEventFilter
campaignEventFilter pFilterType_ pDimensions_
  = CampaignEventFilter'{_cefFilterType = pFilterType_,
