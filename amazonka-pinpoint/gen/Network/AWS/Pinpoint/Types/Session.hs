...
data Session = Session'{_sesStopTimestamp ::
                        !(Maybe Text),
                        _sesDuration :: !(Maybe Int),
                        _sesStartTimestamp :: !Text, _sesId :: !Text}
...
session
    :: Text -- ^ 'sesStartTimestamp'
    -> Text -- ^ 'sesId'
    -> Session
session pStartTimestamp_ pId_
  = Session'{_sesStopTimestamp = Nothing,
             _sesDuration = Nothing,
             _sesStartTimestamp = pStartTimestamp_, _sesId = pId_}
