...
data RandomSplitEntry = RandomSplitEntry'{_rseNextActivity
                                          :: !(Maybe Text),
...
randomSplitEntry
    :: RandomSplitEntry
randomSplitEntry
  = RandomSplitEntry'{_rseNextActivity = Nothing,
...
instance FromJSON RandomSplitEntry where
        parseJSON
          = withObject "RandomSplitEntry"
              (\ x ->
                 RandomSplitEntry' <$>
                   (x .:? "NextActivity") <*> (x .:? "Percentage"))

instance Hashable RandomSplitEntry where

instance NFData RandomSplitEntry where
