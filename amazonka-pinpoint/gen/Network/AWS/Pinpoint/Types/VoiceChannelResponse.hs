...
data VoiceChannelResponse = VoiceChannelResponse'{_vcLastModifiedDate
                                                  :: !(Maybe Text),
...
voiceChannelResponse pPlatform_
  = VoiceChannelResponse'{_vcLastModifiedDate =
                            Nothing,
                          _vcEnabled = Nothing, _vcIsArchived = Nothing,
                          _vcApplicationId = Nothing, _vcVersion = Nothing,
                          _vcId = Nothing, _vcCreationDate = Nothing,
                          _vcLastModifiedBy = Nothing,
                          _vcHasCredential = Nothing, _vcPlatform = pPlatform_}
