...
data NumberValidateResponse = NumberValidateResponse'{_nvCarrier
                                                      :: !(Maybe Text),
                                                      _nvCounty ::
                                                      !(Maybe Text),
                                                      _nvCountry ::
                                                      !(Maybe Text),
                                                      _nvCountryCodeNumeric ::
                                                      !(Maybe Text),
                                                      _nvZipCode ::
                                                      !(Maybe Text),
                                                      _nvOriginalPhoneNumber ::
                                                      !(Maybe Text),
                                                      _nvPhoneTypeCode ::
                                                      !(Maybe Int),
                                                      _nvPhoneType ::
                                                      ...
                                                      _nvTimezone ::
                                                      !(Maybe Text),
                                                      _nvOriginalCountryCodeIso2
                                                      :: !(Maybe Text),
                                                      _nvCleansedPhoneNumberNational
                                                      :: !(Maybe Text),
                                                      _nvCleansedPhoneNumberE164
                                                      :: !(Maybe Text)}
...
numberValidateResponse
    :: NumberValidateResponse
numberValidateResponse
  = NumberValidateResponse'{_nvCarrier = Nothing,
                            _nvCounty = Nothing, _nvCountry = Nothing,
                            _nvCountryCodeNumeric = Nothing,
                            _nvZipCode = Nothing,
                            _nvOriginalPhoneNumber = Nothing,
                            _nvPhoneTypeCode = Nothing, _nvPhoneType = Nothing,
                            _nvCity = Nothing, _nvCountryCodeIso2 = Nothing,
                            _nvTimezone = Nothing,
