...
data JourneyDateRangeKpiResponse = JourneyDateRangeKpiResponse'{_jdrkNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _jdrkKpiResult
                                                                ::
...
journeyDateRangeKpiResponse
    :: BaseKpiResult -- ^ 'jdrkKpiResult'
    -> Text -- ^ 'jdrkKpiName'
    -> Text -- ^ 'jdrkJourneyId'
    -> UTCTime -- ^ 'jdrkEndTime'
    -> UTCTime -- ^ 'jdrkStartTime'
    -> Text -- ^ 'jdrkApplicationId'
    -> JourneyDateRangeKpiResponse
journeyDateRangeKpiResponse pKpiResult_ pKpiName_
  pJourneyId_ pEndTime_ pStartTime_ pApplicationId_
  = JourneyDateRangeKpiResponse'{_jdrkNextToken =
                                   Nothing,
...
instance FromJSON JourneyDateRangeKpiResponse where
        parseJSON
          = withObject "JourneyDateRangeKpiResponse"
              (\ x ->
                 JourneyDateRangeKpiResponse' <$>
...
instance Hashable JourneyDateRangeKpiResponse where

instance NFData JourneyDateRangeKpiResponse where
