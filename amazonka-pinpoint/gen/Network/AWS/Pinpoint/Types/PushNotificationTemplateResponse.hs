...
data PushNotificationTemplateResponse = PushNotificationTemplateResponse'{_pntARN
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _pntDefault
...
pushNotificationTemplateResponse
    :: Text -- ^ 'pntLastModifiedDate'
    -> Text -- ^ 'pntCreationDate'
    -> TemplateType -- ^ 'pntTemplateType'
    -> Text -- ^ 'pntTemplateName'
    -> PushNotificationTemplateResponse
pushNotificationTemplateResponse pLastModifiedDate_
  pCreationDate_ pTemplateType_ pTemplateName_
  = PushNotificationTemplateResponse'{_pntARN =
                                        Nothing,
                                      _pntDefault = Nothing,
                                      _pntTemplateDescription = Nothing,
                                      _pntGCM = Nothing, _pntAPNS = Nothing,
                                      _pntDefaultSubstitutions = Nothing,
                                      _pntVersion = Nothing, _pntADM = Nothing,
                                      _pntBaidu = Nothing,
...
instance FromJSON PushNotificationTemplateResponse
         where
        parseJSON
          = withObject "PushNotificationTemplateResponse"
              (\ x ->
                 PushNotificationTemplateResponse' <$>
                   (x .:? "Arn") <*> (x .:? "Default") <*>
