...
data VoiceTemplateRequest = VoiceTemplateRequest'{_vtrLanguageCode
                                                  :: !(Maybe Text),
                                                  _vtrBody :: !(Maybe Text),
...
voiceTemplateRequest
    :: VoiceTemplateRequest
voiceTemplateRequest
  = VoiceTemplateRequest'{_vtrLanguageCode = Nothing,
                          _vtrBody = Nothing,
                          _vtrTemplateDescription = Nothing,
                          _vtrDefaultSubstitutions = Nothing,
                          _vtrVoiceId = Nothing, _vtrTags = Nothing}
...
instance Hashable VoiceTemplateRequest where

instance NFData VoiceTemplateRequest where
