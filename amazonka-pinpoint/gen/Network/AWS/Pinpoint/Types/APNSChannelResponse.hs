...
data APNSChannelResponse = APNSChannelResponse'{_acLastModifiedDate
                                                :: !(Maybe Text),
...
apnsChannelResponse pPlatform_
  = APNSChannelResponse'{_acLastModifiedDate = Nothing,
                         _acEnabled = Nothing, _acHasTokenKey = Nothing,
                         ...
                         _acHasCredential = Nothing, _acPlatform = pPlatform_}
