...
data MultiConditionalBranch = MultiConditionalBranch'{_mcbNextActivity
                                                      :: !(Maybe Text),
                                                      _mcbCondition ::
...
multiConditionalBranch
    :: MultiConditionalBranch
multiConditionalBranch
  = MultiConditionalBranch'{_mcbNextActivity = Nothing,
...
instance FromJSON MultiConditionalBranch where
        parseJSON
          = withObject "MultiConditionalBranch"
              (\ x ->
                 MultiConditionalBranch' <$>
                   (x .:? "NextActivity") <*> (x .:? "Condition"))

instance Hashable MultiConditionalBranch where

instance NFData MultiConditionalBranch where
