...
newtype TemplateActiveVersionRequest = TemplateActiveVersionRequest'{_tavrVersion
                                                                     ::
                                                                     Maybe Text}
...
templateActiveVersionRequest
    :: TemplateActiveVersionRequest
templateActiveVersionRequest
  = TemplateActiveVersionRequest'{_tavrVersion =
                                    Nothing}
...
instance Hashable TemplateActiveVersionRequest where

instance NFData TemplateActiveVersionRequest where
