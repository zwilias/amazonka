...
data PushNotificationTemplateRequest = PushNotificationTemplateRequest'{_pntrDefault
                                                                        ::
                                                                        !(Maybe
...
pushNotificationTemplateRequest
    :: PushNotificationTemplateRequest
pushNotificationTemplateRequest
  = PushNotificationTemplateRequest'{_pntrDefault =
                                       Nothing,
                                     _pntrTemplateDescription = Nothing,
                                     _pntrGCM = Nothing, _pntrAPNS = Nothing,
                                     _pntrDefaultSubstitutions = Nothing,
                                     _pntrADM = Nothing, _pntrBaidu = Nothing,
...
instance NFData PushNotificationTemplateRequest where
          ...
          = object
              (catMaybes
                 [("Default" .=) <$> _pntrDefault,
                  ("TemplateDescription" .=) <$>
                    _pntrTemplateDescription,
                  ("GCM" .=) <$> _pntrGCM, ("APNS" .=) <$> _pntrAPNS,
                  ("DefaultSubstitutions" .=) <$>
                    _pntrDefaultSubstitutions,
                  ("ADM" .=) <$> _pntrADM, ("Baidu" .=) <$> _pntrBaidu,
