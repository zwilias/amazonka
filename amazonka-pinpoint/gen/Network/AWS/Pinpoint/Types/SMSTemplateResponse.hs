...
data SMSTemplateResponse = SMSTemplateResponse'{_smstARN
                                                :: !(Maybe Text),
                                                _smstBody :: !(Maybe Text),
                                                _smstTemplateDescription ::
                                                !(Maybe Text),
                                                _smstDefaultSubstitutions ::
                                                !(Maybe Text),
...
sMSTemplateResponse
    :: Text -- ^ 'smstLastModifiedDate'
    -> Text -- ^ 'smstCreationDate'
    -> Text -- ^ 'smstTemplateName'
    -> TemplateType -- ^ 'smstTemplateType'
    -> SMSTemplateResponse
sMSTemplateResponse pLastModifiedDate_ pCreationDate_
  pTemplateName_ pTemplateType_
  = SMSTemplateResponse'{_smstARN = Nothing,
                         _smstBody = Nothing,
                         _smstTemplateDescription = Nothing,
                         _smstDefaultSubstitutions = Nothing,
                         _smstVersion = Nothing, _smstRecommenderId = Nothing,
                         _smstTags = Nothing,
...
instance FromJSON SMSTemplateResponse where
        parseJSON
          = withObject "SMSTemplateResponse"
              (\ x ->
                 SMSTemplateResponse' <$>
                   (x .:? "Arn") <*> (x .:? "Body") <*>
...
instance Hashable SMSTemplateResponse where

instance NFData SMSTemplateResponse where
