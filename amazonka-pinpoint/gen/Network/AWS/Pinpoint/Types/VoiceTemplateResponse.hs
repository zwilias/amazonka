...
data VoiceTemplateResponse = VoiceTemplateResponse'{_vtLanguageCode
                                                    :: !(Maybe Text),
                                                    _vtARN :: !(Maybe Text),
                                                    _vtBody :: !(Maybe Text),
                                                    _vtTemplateDescription ::
                                                    !(Maybe Text),
                                                    _vtDefaultSubstitutions ::
                                                    !(Maybe Text),
...
voiceTemplateResponse
    :: Text -- ^ 'vtLastModifiedDate'
    -> Text -- ^ 'vtCreationDate'
    -> Text -- ^ 'vtTemplateName'
    -> TemplateType -- ^ 'vtTemplateType'
    -> VoiceTemplateResponse
voiceTemplateResponse pLastModifiedDate_
  pCreationDate_ pTemplateName_ pTemplateType_
  = VoiceTemplateResponse'{_vtLanguageCode = Nothing,
                           _vtARN = Nothing, _vtBody = Nothing,
                           _vtTemplateDescription = Nothing,
                           _vtDefaultSubstitutions = Nothing,
                           _vtVersion = Nothing, _vtVoiceId = Nothing,
                           _vtTags = Nothing,
...
instance FromJSON VoiceTemplateResponse where
        parseJSON
          = withObject "VoiceTemplateResponse"
              (\ x ->
                 VoiceTemplateResponse' <$>
                   (x .:? "LanguageCode") <*> (x .:? "Arn") <*>
                     (x .:? "Body")
...
instance Hashable VoiceTemplateResponse where

instance NFData VoiceTemplateResponse where
