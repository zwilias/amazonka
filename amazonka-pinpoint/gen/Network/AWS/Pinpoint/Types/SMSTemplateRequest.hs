...
data SMSTemplateRequest = SMSTemplateRequest'{_smstrBody
                                              :: !(Maybe Text),
...
sMSTemplateRequest
    :: SMSTemplateRequest
sMSTemplateRequest
  = SMSTemplateRequest'{_smstrBody = Nothing,
                        _smstrTemplateDescription = Nothing,
                        _smstrDefaultSubstitutions = Nothing,
                        _smstrRecommenderId = Nothing, _smstrTags = Nothing}
...
instance Hashable SMSTemplateRequest where

instance NFData SMSTemplateRequest where
