...
admcLastModifiedDate =
  lens _admcLastModifiedDate (\s a -> s {_admcLastModifiedDate = a})
...
admcLastModifiedBy =
  lens _admcLastModifiedBy (\s a -> s {_admcLastModifiedBy = a})
...
admmSubstitutions =
  lens _admmSubstitutions (\s a -> s {_admmSubstitutions = a}) . _Default . _Map
...
admmSmallImageIconURL =
  lens _admmSmallImageIconURL (\s a -> s {_admmSmallImageIconURL = a})
...
admmConsolidationKey =
  lens _admmConsolidationKey (\s a -> s {_admmConsolidationKey = a})
...
acrDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_acrDefaultAuthenticationMethod = a})
...
acLastModifiedDate =
  lens _acLastModifiedDate (\s a -> s {_acLastModifiedDate = a})
...
acDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_acDefaultAuthenticationMethod = a})
...
instance FromJSON APNSChannelResponse where
  parseJSON =
    withObject
      "APNSChannelResponse"
      (\x ->
         APNSChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "HasTokenKey") <*>
...
amSubstitutions =
  lens _amSubstitutions (\s a -> s {_amSubstitutions = a}) . _Default . _Map
...
amPreferredAuthenticationMethod =
  lens
    ...
    (\s a -> s {_amPreferredAuthenticationMethod = a})
...
ascrDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_ascrDefaultAuthenticationMethod = a})
...
ascLastModifiedDate =
  lens _ascLastModifiedDate (\s a -> s {_ascLastModifiedDate = a})
...
ascDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_ascDefaultAuthenticationMethod = a})
...
instance FromJSON APNSSandboxChannelResponse where
  parseJSON =
    withObject
      "APNSSandboxChannelResponse"
      (\x ->
         APNSSandboxChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "HasTokenKey") <*>
         (x .:? "DefaultAuthenticationMethod") <*>
...
avcrDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_avcrDefaultAuthenticationMethod = a})
...
avcLastModifiedDate =
  lens _avcLastModifiedDate (\s a -> s {_avcLastModifiedDate = a})
...
avcDefaultAuthenticationMethod =
  lens
    ...
    (\s a -> s {_avcDefaultAuthenticationMethod = a})
...
instance FromJSON APNSVoipChannelResponse where
  parseJSON =
    withObject
      "APNSVoipChannelResponse"
      (\x ->
         APNSVoipChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "HasTokenKey") <*>
         (x .:? "DefaultAuthenticationMethod") <*>
...
avscrDefaultAuthenticationMethod ::
     Lens' APNSVoipSandboxChannelRequest (Maybe Text)
avscrDefaultAuthenticationMethod =
  lens
    _avscrDefaultAuthenticationMethod
    (\s a -> s {_avscrDefaultAuthenticationMethod = a})
...
avscLastModifiedDate =
  lens _avscLastModifiedDate (\s a -> s {_avscLastModifiedDate = a})
...
avscDefaultAuthenticationMethod ::
     Lens' APNSVoipSandboxChannelResponse (Maybe Text)
avscDefaultAuthenticationMethod =
  lens
    _avscDefaultAuthenticationMethod
    (\s a -> s {_avscDefaultAuthenticationMethod = a})
...
avscLastModifiedBy =
  lens _avscLastModifiedBy (\s a -> s {_avscLastModifiedBy = a})
...
instance FromJSON APNSVoipSandboxChannelResponse where
  parseJSON =
    withObject
      "APNSVoipSandboxChannelResponse"
      (\x ->
         APNSVoipSandboxChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "HasTokenKey") <*>
         (x .:? "DefaultAuthenticationMethod") <*>
...
instance FromJSON ActivitiesResponse where
  parseJSON =
    withObject
      "ActivitiesResponse"
      (\x -> ActivitiesResponse' <$> (x .:? "Item" .!= mempty))
...
aTimezonesCompletedCount =
  lens _aTimezonesCompletedCount (\s a -> s {_aTimezonesCompletedCount = a})

-- | The total number of unique timezones present in the segment.
aTimezonesTotalCount :: Lens' ActivityResponse (Maybe Int)
aTimezonesTotalCount =
  lens _aTimezonesTotalCount (\s a -> s {_aTimezonesTotalCount = a})
...
aSuccessfulEndpointCount =
  lens _aSuccessfulEndpointCount (\s a -> s {_aSuccessfulEndpointCount = a})
...
aTotalEndpointCount =
  lens _aTotalEndpointCount (\s a -> s {_aTotalEndpointCount = a})
...
instance FromJSON ActivityResponse where
  parseJSON =
    withObject
      "ActivityResponse"
      (\x ->
         ActivityResponse' <$> (x .:? "State") <*> (x .:? "Start") <*>
         (x .:? "CampaignId") <*>
...
acSubstitutions =
  lens _acSubstitutions (\s a -> s {_acSubstitutions = a}) . _Default . _Map
...
instance FromJSON ApplicationResponse where
  parseJSON =
    withObject
      "ApplicationResponse"
      (\x -> ApplicationResponse' <$> (x .:? "Name") <*> (x .:? "Id"))
...
asrLastModifiedDate =
  lens _asrLastModifiedDate (\s a -> s {_asrLastModifiedDate = a})
...
instance FromJSON ApplicationSettingsResource where
  parseJSON =
    withObject
      "ApplicationSettingsResource"
      (\x ->
         ApplicationSettingsResource' <$> (x .:? "LastModifiedDate") <*>
         (x .:? "Limits") <*>
         (x .:? "QuietTime") <*>
         (x .:? "ApplicationId") <*>
         (x .:? "CampaignHook"))
...
instance FromJSON ApplicationsResponse where
  parseJSON =
    withObject
      "ApplicationsResponse"
      (\x ->
         ApplicationsResponse' <$> (x .:? "NextToken") <*>
         (x .:? "Item" .!= mempty))
...
instance FromJSON AttributeDimension where
  parseJSON =
    withObject
      "AttributeDimension"
      (\x ->
         AttributeDimension' <$> (x .:? "Values" .!= mempty) <*>
         (x .:? "AttributeType"))
...
bcLastModifiedDate =
  lens _bcLastModifiedDate (\s a -> s {_bcLastModifiedDate = a})
...
instance FromJSON BaiduChannelResponse where
  parseJSON =
    withObject
      "BaiduChannelResponse"
      (\x ->
         BaiduChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "Credential") <*>
         (x .:? "IsArchived") <*>
...
bmSubstitutions =
  lens _bmSubstitutions (\s a -> s {_bmSubstitutions = a}) . _Default . _Map
...
bmSmallImageIconURL =
  lens _bmSmallImageIconURL (\s a -> s {_bmSmallImageIconURL = a})
...
instance FromJSON CampaignEmailMessage where
  parseJSON =
    withObject
      "CampaignEmailMessage"
      (\x ->
         CampaignEmailMessage' <$> (x .:? "Body") <*> (x .:? "FromAddress") <*>
         (x .:? "HtmlBody") <*>
         (x .:? "Title"))
...
chLambdaFunctionName =
  lens _chLambdaFunctionName (\s a -> s {_chLambdaFunctionName = a})
...
instance FromJSON CampaignHook where
  parseJSON =
    withObject
      "CampaignHook"
      (\x ->
         CampaignHook' <$> (x .:? "LambdaFunctionName") <*> (x .:? "Mode") <*>
         (x .:? "WebUrl"))
...
clMessagesPerSecond =
  lens _clMessagesPerSecond (\s a -> s {_clMessagesPerSecond = a})
...
instance FromJSON CampaignLimits where
  parseJSON =
    withObject
      "CampaignLimits"
      (\x ->
         CampaignLimits' <$> (x .:? "MessagesPerSecond") <*> (x .:? "Daily") <*>
         (x .:? "Total") <*>
         (x .:? "MaximumDuration"))
...
cTreatmentDescription =
  lens _cTreatmentDescription (\s a -> s {_cTreatmentDescription = a})
...
cMessageConfiguration =
  lens _cMessageConfiguration (\s a -> s {_cMessageConfiguration = a})
...
cAdditionalTreatments =
  lens _cAdditionalTreatments (\s a -> s {_cAdditionalTreatments = a}) .
  _Default . _Coerce
...
instance FromJSON CampaignResponse where
  parseJSON =
    withObject
      "CampaignResponse"
      (\x ->
         CampaignResponse' <$> (x .:? "State") <*> (x .:? "LastModifiedDate") <*>
         (x .:? "Schedule") <*>
         (x .:? "Hook") <*>
         (x .:? "TreatmentName") <*>
         (x .:? "Limits") <*>
...
instance FromJSON CampaignSmsMessage where
  parseJSON =
    withObject
      "CampaignSmsMessage"
      (\x ->
         CampaignSmsMessage' <$> (x .:? "Body") <*> (x .:? "MessageType") <*>
         (x .:? "SenderId"))
...
dmSubstitutions =
  lens _dmSubstitutions (\s a -> s {_dmSubstitutions = a}) . _Default . _Map
...
instance ToJSON DefaultMessage where
  toJSON DefaultMessage' {..} =
    object
      (catMaybes
         [("Substitutions" .=) <$> _dmSubstitutions, ("Body" .=) <$> _dmBody])
...
dpnmSubstitutions =
  lens _dpnmSubstitutions (\s a -> s {_dpnmSubstitutions = a}) . _Default . _Map
...
dmcDefaultPushNotificationMessage ::
     Lens' DirectMessageConfiguration (Maybe DefaultPushNotificationMessage)
dmcDefaultPushNotificationMessage =
  lens
    _dmcDefaultPushNotificationMessage
    (\s a -> s {_dmcDefaultPushNotificationMessage = a})
...
ecLastModifiedDate =
  lens _ecLastModifiedDate (\s a -> s {_ecLastModifiedDate = a})
...
instance FromJSON EmailChannelResponse where
  parseJSON =
    withObject
      "EmailChannelResponse"
      (\x ->
         EmailChannelResponse' <$> (x .:? "Platform") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "FromAddress") <*>
         (x .:? "IsArchived") <*>
...
ebiAttributes =
  lens _ebiAttributes (\s a -> s {_ebiAttributes = a}) . _Default . _Map
...
instance FromJSON EndpointDemographic where
  parseJSON =
    withObject
      "EndpointDemographic"
      (\x ->
         EndpointDemographic' <$> (x .:? "Platform") <*>
         (x .:? "PlatformVersion") <*>
         (x .:? "Locale") <*>
         (x .:? "AppVersion") <*>
         (x .:? "Model") <*>
...
instance FromJSON EndpointLocation where
  parseJSON =
    withObject
      "EndpointLocation"
      (\x ->
         EndpointLocation' <$> (x .:? "PostalCode") <*> (x .:? "Latitude") <*>
         (x .:? "Country") <*>
         (x .:? "City") <*>
         (x .:? "Region") <*>
         (x .:? "Longitude"))
...
instance FromJSON EndpointMessageResult where
  parseJSON =
    withObject
      "EndpointMessageResult"
      (\x ->
         EndpointMessageResult' <$> (x .:? "DeliveryStatus") <*>
         (x .:? "Address") <*>
         (x .:? "StatusMessage") <*>
         (x .:? "UpdatedToken") <*>
         (x .:? "StatusCode"))
...
erAttributes =
  lens _erAttributes (\s a -> s {_erAttributes = a}) . _Default . _Map
...
escSubstitutions =
  lens _escSubstitutions (\s a -> s {_escSubstitutions = a}) . _Default . _Map
...
euUserAttributes =
  lens _euUserAttributes (\s a -> s {_euUserAttributes = a}) . _Default . _Map
...
instance FromJSON EndpointUser where
  parseJSON =
    withObject
      "EndpointUser"
      (\x ->
         EndpointUser' <$> (x .:? "UserAttributes" .!= mempty) <*>
         (x .:? "UserId"))
...
esLastModifiedDate =
  lens _esLastModifiedDate (\s a -> s {_esLastModifiedDate = a})
...
esDestinationStreamARN =
  lens _esDestinationStreamARN (\s a -> s {_esDestinationStreamARN = a})
...
instance FromJSON EventStream where
  parseJSON =
    withObject
      "EventStream"
      (\x ->
         EventStream' <$> (x .:? "LastUpdatedBy") <*> (x .:? "LastModifiedDate") <*>
...
instance FromJSON ExportJobResource where
  parseJSON =
    withObject
      "ExportJobResource"
      (\x ->
         ExportJobResource' <$> (x .:? "S3UrlPrefix") <*> (x .:? "SegmentId") <*>
         (x .:? "RoleArn"))
...
instance FromJSON ExportJobResponse where
  parseJSON =
    withObject
      "ExportJobResponse"
      (\x ->
         ExportJobResponse' <$> (x .:? "CompletedPieces") <*>
         (x .:? "FailedPieces") <*>
         (x .:? "Definition") <*>
         (x .:? "TotalProcessed") <*>
         (x .:? "Failures" .!= mempty) <*>
...
instance FromJSON ExportJobsResponse where
  parseJSON =
    withObject
      "ExportJobsResponse"
      (\x ->
         ExportJobsResponse' <$> (x .:? "NextToken") <*>
         (x .:? "Item" .!= mempty))
...
instance ToJSON GCMChannelRequest where
  toJSON GCMChannelRequest' {..} =
    object
      (catMaybes [("ApiKey" .=) <$> _gcrAPIKey, ("Enabled" .=) <$> _gcrEnabled])
...
gcLastModifiedDate =
  lens _gcLastModifiedDate (\s a -> s {_gcLastModifiedDate = a})
...
gmSubstitutions =
  lens _gmSubstitutions (\s a -> s {_gmSubstitutions = a}) . _Default . _Map
...
gmRestrictedPackageName =
  lens _gmRestrictedPackageName (\s a -> s {_gmRestrictedPackageName = a})

-- | The URL that points to an image used as the small icon for the notification which will be used to represent the notification in the status bar and content view
gmSmallImageIconURL :: Lens' GCMMessage (Maybe Text)
gmSmallImageIconURL =
  lens _gmSmallImageIconURL (\s a -> s {_gmSmallImageIconURL = a})
...
iRegisterEndpoints =
  lens _iRegisterEndpoints (\s a -> s {_iRegisterEndpoints = a})
...
ijrRegisterEndpoints =
  lens _ijrRegisterEndpoints (\s a -> s {_ijrRegisterEndpoints = a})
...
instance FromJSON ImportJobResource where
  parseJSON =
    withObject
      "ImportJobResource"
      (\x ->
         ImportJobResource' <$> (x .:? "SegmentName") <*> (x .:? "Format") <*>
         (x .:? "DefineSegment") <*>
         (x .:? "RegisterEndpoints") <*>
         (x .:? "ExternalId") <*>
         (x .:? "S3Url") <*>
...
instance FromJSON ImportJobResponse where
  parseJSON =
    withObject
      "ImportJobResponse"
      (\x ->
         ImportJobResponse' <$> (x .:? "CompletedPieces") <*>
         (x .:? "FailedPieces") <*>
         (x .:? "Definition") <*>
         (x .:? "TotalProcessed") <*>
         (x .:? "Failures" .!= mempty) <*>
...
instance FromJSON ImportJobsResponse where
  parseJSON =
    withObject
      "ImportJobsResponse"
      (\x ->
         ImportJobsResponse' <$> (x .:? "NextToken") <*>
         (x .:? "Item" .!= mempty))
...
mImageSmallIconURL =
  lens _mImageSmallIconURL (\s a -> s {_mImageSmallIconURL = a})
...
instance FromJSON Message where
  parseJSON =
    withObject
      "Message"
      (\x ->
         Message' <$> (x .:? "SilentPush") <*> (x .:? "ImageIconUrl") <*>
         (x .:? "RawContent") <*>
         (x .:? "Body") <*>
         (x .:? "ImageSmallIconUrl") <*>
         (x .:? "JsonBody") <*>
...
instance FromJSON MessageConfiguration where
  parseJSON =
    withObject
      "MessageConfiguration"
      (\x ->
         MessageConfiguration' <$> (x .:? "APNSMessage") <*>
         (x .:? "GCMMessage") <*>
         (x .:? "DefaultMessage") <*>
         (x .:? "ADMMessage") <*>
         (x .:? "SMSMessage") <*>
...
mrMessageConfiguration ::
     Lens' MessageRequest (Maybe DirectMessageConfiguration)
mrMessageConfiguration =
  lens _mrMessageConfiguration (\s a -> s {_mrMessageConfiguration = a})
...
mEndpointResult =
  lens _mEndpointResult (\s a -> s {_mEndpointResult = a}) . _Default . _Map
...
instance FromJSON MessageResult where
  parseJSON =
    withObject
      "MessageResult"
      (\x ->
         MessageResult' <$> (x .:? "DeliveryStatus") <*> (x .:? "StatusMessage") <*>
         (x .:? "UpdatedToken") <*>
         (x .:? "StatusCode"))
...
instance ToJSON QuietTime where
  toJSON QuietTime' {..} =
    object (catMaybes [("Start" .=) <$> _qtStart, ("End" .=) <$> _qtEnd])
...
instance FromJSON RecencyDimension where
  parseJSON =
    withObject
      "RecencyDimension"
      (\x -> RecencyDimension' <$> (x .:? "RecencyType") <*> (x .:? "Duration"))
...
smscLastModifiedDate =
  lens _smscLastModifiedDate (\s a -> s {_smscLastModifiedDate = a})
...
smscLastModifiedBy =
  lens _smscLastModifiedBy (\s a -> s {_smscLastModifiedBy = a})
...
instance FromJSON SMSChannelResponse where
  parseJSON =
    withObject
      "SMSChannelResponse"
      (\x ->
         SMSChannelResponse' <$> (x .:? "Platform") <*> (x .:? "ShortCode") <*>
         (x .:? "LastModifiedDate") <*>
         (x .:? "Enabled") <*>
         (x .:? "SenderId") <*>
         (x .:? "IsArchived") <*>
...
smsmSubstitutions =
  lens _smsmSubstitutions (\s a -> s {_smsmSubstitutions = a}) . _Default . _Map
...
smsmOriginationNumber =
  lens _smsmOriginationNumber (\s a -> s {_smsmOriginationNumber = a})
...
instance FromJSON Schedule where
  parseJSON =
    withObject
      "Schedule"
      (\x ->
         Schedule' <$> (x .:? "Frequency") <*> (x .:? "StartTime") <*>
         (x .:? "QuietTime") <*>
         (x .:? "IsLocalTime") <*>
         (x .:? "EndTime") <*>
         (x .:? "Timezone"))
...
instance FromJSON SegmentDemographics where
  parseJSON =
    withObject
      "SegmentDemographics"
      (\x ->
         SegmentDemographics' <$> (x .:? "Platform") <*> (x .:? "AppVersion") <*>
         (x .:? "Channel") <*>
         (x .:? "Model") <*>
         (x .:? "Make") <*>
         (x .:? "DeviceType"))
...
sdUserAttributes =
  lens _sdUserAttributes (\s a -> s {_sdUserAttributes = a}) . _Default . _Map
...
sdAttributes =
  lens _sdAttributes (\s a -> s {_sdAttributes = a}) . _Default . _Map
...
instance FromJSON SegmentDimensions where
  parseJSON =
    withObject
      "SegmentDimensions"
      (\x ->
         SegmentDimensions' <$> (x .:? "Location") <*> (x .:? "Demographic") <*>
...
sirChannelCounts =
  lens _sirChannelCounts (\s a -> s {_sirChannelCounts = a}) . _Default . _Map
...
instance FromJSON SegmentImportResource where
  parseJSON =
    withObject
      "SegmentImportResource"
      (\x ->
         SegmentImportResource' <$> (x .:? "Size") <*> (x .:? "Format") <*>
...
instance FromJSON SegmentLocation where
  parseJSON =
    withObject "SegmentLocation" (\x -> SegmentLocation' <$> (x .:? "Country"))
...
instance FromJSON SegmentResponse where
  parseJSON =
    withObject
      "SegmentResponse"
      (\x ->
         SegmentResponse' <$> (x .:? "LastModifiedDate") <*>
         (x .:? "SegmentType") <*>
         (x .:? "ApplicationId") <*>
         (x .:? "Name") <*>
         (x .:? "Version") <*>
...
instance FromJSON SegmentsResponse where
  parseJSON =
    withObject
      "SegmentsResponse"
      (\x ->
         SegmentsResponse' <$> (x .:? "NextToken") <*> (x .:? "Item" .!= mempty))
...
sumrUsers ::
     Lens' SendUsersMessageRequest (HashMap Text EndpointSendConfiguration)
sumrUsers = lens _sumrUsers (\s a -> s {_sumrUsers = a}) . _Default . _Map

-- | Message configuration.
sumrMessageConfiguration ::
     Lens' SendUsersMessageRequest (Maybe DirectMessageConfiguration)
sumrMessageConfiguration =
  lens _sumrMessageConfiguration (\s a -> s {_sumrMessageConfiguration = a})
  ...
  toJSON SendUsersMessageRequest' {..} =
    object
      (catMaybes
         ...
         , ("Users" .=) <$> _sumrUsers
         , ("MessageConfiguration" .=) <$> _sumrMessageConfiguration
         ])
...
sumResult ::
     Lens' SendUsersMessageResponse (HashMap Text (HashMap Text EndpointMessageResult))
...
instance FromJSON SendUsersMessageResponse where
  parseJSON =
    withObject
      "SendUsersMessageResponse"
      (\x ->
         SendUsersMessageResponse' <$> (x .:? "RequestId") <*>
         (x .:? "Result" .!= mempty) <*>
         (x .:? "ApplicationId"))
...
trTreatmentDescription =
  lens _trTreatmentDescription (\s a -> s {_trTreatmentDescription = a})
...
trMessageConfiguration =
  lens _trMessageConfiguration (\s a -> s {_trMessageConfiguration = a})
...
instance FromJSON TreatmentResource where
  parseJSON =
    withObject
      "TreatmentResource"
      (\x ->
         TreatmentResource' <$> (x .:? "State") <*> (x .:? "Schedule") <*>
         (x .:? "TreatmentName") <*>
         (x .:? "SizePercent") <*>
         (x .:? "TreatmentDescription") <*>
         (x .:? "Id") <*>
...
wcrTreatmentDescription =
  lens _wcrTreatmentDescription (\s a -> s {_wcrTreatmentDescription = a})

-- | The message configuration settings.
wcrMessageConfiguration ::
     Lens' WriteCampaignRequest (Maybe MessageConfiguration)
wcrMessageConfiguration =
  lens _wcrMessageConfiguration (\s a -> s {_wcrMessageConfiguration = a})
...
wcrAdditionalTreatments =
  lens _wcrAdditionalTreatments (\s a -> s {_wcrAdditionalTreatments = a}) .
  _Default . _Coerce
...
wesDestinationStreamARN =
  lens _wesDestinationStreamARN (\s a -> s {_wesDestinationStreamARN = a})
...
instance ToJSON WriteEventStream where
  toJSON WriteEventStream' {..} =
    object
      (catMaybes
         [ ("DestinationStreamArn" .=) <$> _wesDestinationStreamARN
         , ("RoleArn" .=) <$> _wesRoleARN
         ])
...
instance ToJSON WriteSegmentRequest where
  toJSON WriteSegmentRequest' {..} =
    object
      (catMaybes
         [("Name" .=) <$> _wsrName, ("Dimensions" .=) <$> _wsrDimensions])
...
wtrTreatmentDescription =
  lens _wtrTreatmentDescription (\s a -> s {_wtrTreatmentDescription = a})

-- | The message configuration settings.
wtrMessageConfiguration ::
     Lens' WriteTreatmentResource (Maybe MessageConfiguration)
wtrMessageConfiguration =
  lens _wtrMessageConfiguration (\s a -> s {_wtrMessageConfiguration = a})
