...
data Event = Event'{_eClientSDKVersion ::
                    !(Maybe Text),
                    ...
                    _eSession :: !(Maybe Session), _eEventType :: !Text,
                    _eTimestamp :: !Text}
...
event pEventType_ pTimestamp_
  = Event'{_eClientSDKVersion = Nothing,
           _eMetrics = Nothing, _eAppVersionCode = Nothing,
           _eAppTitle = Nothing, _eAppPackageName = Nothing,
           _eAttributes = Nothing, _eSDKName = Nothing,
           _eSession = Nothing, _eEventType = pEventType_,
