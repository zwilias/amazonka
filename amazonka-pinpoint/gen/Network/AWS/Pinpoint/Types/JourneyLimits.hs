...
data JourneyLimits = JourneyLimits'{_jlMessagesPerSecond
                                    :: !(Maybe Int),
...
journeyLimits
    :: JourneyLimits
journeyLimits
  = JourneyLimits'{_jlMessagesPerSecond = Nothing,
...
instance Hashable JourneyLimits where

instance NFData JourneyLimits where
