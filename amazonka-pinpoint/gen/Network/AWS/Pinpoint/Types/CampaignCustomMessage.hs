...
newtype CampaignCustomMessage = CampaignCustomMessage'{_ccmData
                                                       :: Maybe Text}
...
instance FromJSON CampaignCustomMessage where
        parseJSON
          = withObject "CampaignCustomMessage"
              (\ x -> CampaignCustomMessage' <$> (x .:? "Data"))

instance Hashable CampaignCustomMessage where

instance NFData CampaignCustomMessage where
