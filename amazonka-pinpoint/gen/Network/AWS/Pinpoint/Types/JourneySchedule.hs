...
data JourneySchedule = JourneySchedule'{_jsStartTime
                                        :: !(Maybe POSIX),
...
journeySchedule
    :: JourneySchedule
journeySchedule
  = JourneySchedule'{_jsStartTime = Nothing,
                     _jsEndTime = Nothing, _jsTimezone = Nothing}
...
instance FromJSON JourneySchedule where
        parseJSON
          = withObject "JourneySchedule"
              (\ x ->
                 JourneySchedule' <$>
                   (x .:? "StartTime") <*> (x .:? "EndTime") <*>
                     (x .:? "Timezone"))

instance Hashable JourneySchedule where

instance NFData JourneySchedule where
