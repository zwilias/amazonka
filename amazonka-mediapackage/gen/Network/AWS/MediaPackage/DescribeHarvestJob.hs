...
newtype DescribeHarvestJob = DescribeHarvestJob'{_dhjId
                                                 :: Text}
...
instance Hashable DescribeHarvestJob where

instance NFData DescribeHarvestJob where
...
data DescribeHarvestJobResponse = DescribeHarvestJobResponse'{_dhjrsStatus
                                                              ::
                                                              !(Maybe
                                                                  TaskStatus),
...
instance NFData DescribeHarvestJobResponse where
