...
uoeWhitelist =
  lens _uoeWhitelist (\s a -> s {_uoeWhitelist = a}) . _Default . _Coerce
...
uoeStartoverWindowSeconds =
  lens _uoeStartoverWindowSeconds (\s a -> s {_uoeStartoverWindowSeconds = a})
...
uoeTimeDelaySeconds =
  lens _uoeTimeDelaySeconds (\s a -> s {_uoeTimeDelaySeconds = a})

-- | Undocumented member.
uoeCmafPackage ::
     Lens' UpdateOriginEndpoint (Maybe CmafPackageCreateOrUpdateParameters)
...
instance AWSRequest UpdateOriginEndpoint where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdateOriginEndpointResponse' <$> (x .?> "whitelist" .!@ mempty) <*>
         (x .?> "hlsPackage") <*>
         (x .?> "arn") <*>
         (x .?> "manifestName") <*>
         (x .?> "url") <*>
...
uoersWhitelist =
  lens _uoersWhitelist (\s a -> s {_uoersWhitelist = a}) . _Default . _Coerce
...
uoersStartoverWindowSeconds =
  lens
    ...
    (\s a -> s {_uoersStartoverWindowSeconds = a})
...
uoersTimeDelaySeconds =
  lens _uoersTimeDelaySeconds (\s a -> s {_uoersTimeDelaySeconds = a})
...
uoersResponseStatus =
  lens _uoersResponseStatus (\s a -> s {_uoersResponseStatus = a})
