...
data Authorization = Authorization'{_aSecretsRoleARN
                                    :: !Text,
...
authorization
    :: Text -- ^ 'aSecretsRoleARN'
    -> Text -- ^ 'aCdnIdentifierSecret'
    -> Authorization
authorization pSecretsRoleARN_ pCdnIdentifierSecret_
  = Authorization'{_aSecretsRoleARN = pSecretsRoleARN_,
...
instance NFData Authorization where
