...
instance FromJSON Channel where
  parseJSON =
    withObject
      "Channel"
      (\x ->
         Channel' <$> (x .:? "hlsIngest") <*> (x .:? "arn") <*> (x .:? "id") <*>
         (x .:? "description"))
...
ceKeyRotationIntervalSeconds =
  lens
    ...
    (\s a -> s {_ceKeyRotationIntervalSeconds = a})

-- | Undocumented member.
ceSpekeKeyProvider :: Lens' CmafEncryption SpekeKeyProvider
ceSpekeKeyProvider =
  lens _ceSpekeKeyProvider (\s a -> s {_ceSpekeKeyProvider = a})
...
instance FromJSON CmafEncryption where
  parseJSON =
    withObject
      "CmafEncryption"
      (\x ->
         CmafEncryption' <$> (x .:? "keyRotationIntervalSeconds") <*>
         (x .: "spekeKeyProvider"))
...
instance ToJSON CmafEncryption where
  toJSON CmafEncryption' {..} =
    object
      (catMaybes
         [ ("keyRotationIntervalSeconds" .=) <$> _ceKeyRotationIntervalSeconds
...
cpHlsManifests =
  lens _cpHlsManifests (\s a -> s {_cpHlsManifests = a}) . _Default . _Coerce

-- | Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
cpSegmentDurationSeconds :: Lens' CmafPackage (Maybe Int)
cpSegmentDurationSeconds =
  lens _cpSegmentDurationSeconds (\s a -> s {_cpSegmentDurationSeconds = a})
...
instance FromJSON CmafPackage where
  parseJSON =
    withObject
      "CmafPackage"
      (\x ->
         CmafPackage' <$> (x .:? "hlsManifests" .!= mempty) <*>
...
-- | A list of HLS manifest configurations
cpcoupHlsManifests ::
     Lens' CmafPackageCreateOrUpdateParameters [HlsManifestCreateOrUpdateParameters]
cpcoupHlsManifests =
  lens _cpcoupHlsManifests (\s a -> s {_cpcoupHlsManifests = a}) .
  _Default . _Coerce

-- | Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
cpcoupSegmentDurationSeconds ::
     Lens' CmafPackageCreateOrUpdateParameters (Maybe Int)
cpcoupSegmentDurationSeconds =
  lens
    _cpcoupSegmentDurationSeconds
    (\s a -> s {_cpcoupSegmentDurationSeconds = a})

-- | Undocumented member.
cpcoupStreamSelection ::
     Lens' CmafPackageCreateOrUpdateParameters (Maybe StreamSelection)
cpcoupStreamSelection =
  lens _cpcoupStreamSelection (\s a -> s {_cpcoupStreamSelection = a})

-- | Undocumented member.
cpcoupEncryption ::
     Lens' CmafPackageCreateOrUpdateParameters (Maybe CmafEncryption)
...
cpcoupSegmentPrefix =
  lens _cpcoupSegmentPrefix (\s a -> s {_cpcoupSegmentPrefix = a})
...
deKeyRotationIntervalSeconds =
  lens
    ...
    (\s a -> s {_deKeyRotationIntervalSeconds = a})

-- | Undocumented member.
deSpekeKeyProvider :: Lens' DashEncryption SpekeKeyProvider
deSpekeKeyProvider =
  lens _deSpekeKeyProvider (\s a -> s {_deSpekeKeyProvider = a})
...
instance FromJSON DashEncryption where
  parseJSON =
    withObject
      "DashEncryption"
      (\x ->
         DashEncryption' <$> (x .:? "keyRotationIntervalSeconds") <*>
         (x .: "spekeKeyProvider"))
...
instance ToJSON DashEncryption where
  toJSON DashEncryption' {..} =
    object
      (catMaybes
         [ ("keyRotationIntervalSeconds" .=) <$> _deKeyRotationIntervalSeconds
...
dpMinBufferTimeSeconds =
  lens _dpMinBufferTimeSeconds (\s a -> s {_dpMinBufferTimeSeconds = a})
...
dpSegmentDurationSeconds =
  lens _dpSegmentDurationSeconds (\s a -> s {_dpSegmentDurationSeconds = a})
...
dpMinUpdatePeriodSeconds =
  lens _dpMinUpdatePeriodSeconds (\s a -> s {_dpMinUpdatePeriodSeconds = a})
...
dpSuggestedPresentationDelaySeconds =
  lens
    ...
    (\s a -> s {_dpSuggestedPresentationDelaySeconds = a})

-- | Time window (in seconds) contained in each manifest.
dpManifestWindowSeconds :: Lens' DashPackage (Maybe Int)
dpManifestWindowSeconds =
  lens _dpManifestWindowSeconds (\s a -> s {_dpManifestWindowSeconds = a})
...
instance FromJSON DashPackage where
  parseJSON =
    withObject
      "DashPackage"
      (\x ->
         DashPackage' <$> (x .:? "minBufferTimeSeconds") <*> (x .:? "profile") <*>
         (x .:? "segmentDurationSeconds") <*>
         (x .:? "streamSelection") <*>
         (x .:? "encryption") <*>
...
heEncryptionMethod =
  lens _heEncryptionMethod (\s a -> s {_heEncryptionMethod = a})
...
heKeyRotationIntervalSeconds =
  lens
    ...
    (\s a -> s {_heKeyRotationIntervalSeconds = a})
...
heConstantInitializationVector =
  lens
    ...
    (\s a -> s {_heConstantInitializationVector = a})
...
heSpekeKeyProvider =
  lens _heSpekeKeyProvider (\s a -> s {_heSpekeKeyProvider = a})
...
instance FromJSON HlsEncryption where
  parseJSON =
    withObject
      "HlsEncryption"
      (\x ->
         HlsEncryption' <$> (x .:? "encryptionMethod") <*>
  ...
  toJSON HlsEncryption' {..} =
    object
      (catMaybes
         ...
         , ("keyRotationIntervalSeconds" .=) <$> _heKeyRotationIntervalSeconds
...
hiIngestEndpoints =
  lens _hiIngestEndpoints (\s a -> s {_hiIngestEndpoints = a}) .
  _Default . _Coerce
...
hmProgramDateTimeIntervalSeconds =
  lens
    ...
    (\s a -> s {_hmProgramDateTimeIntervalSeconds = a})
...
hmIncludeIframeOnlyStream =
  lens _hmIncludeIframeOnlyStream (\s a -> s {_hmIncludeIframeOnlyStream = a})

-- | Time window (in seconds) contained in each parent manifest.
hmPlaylistWindowSeconds :: Lens' HlsManifest (Maybe Int)
hmPlaylistWindowSeconds =
  lens _hmPlaylistWindowSeconds (\s a -> s {_hmPlaylistWindowSeconds = a})
...
instance FromJSON HlsManifest where
  parseJSON =
    withObject
      "HlsManifest"
      (\x ->
         HlsManifest' <$> (x .:? "manifestName") <*> (x .:? "url") <*>
         (x .:? "playlistType") <*>
...
hmcoupManifestName =
  lens _hmcoupManifestName (\s a -> s {_hmcoupManifestName = a})

-- | The HTTP Live Streaming (HLS) playlist type. When either "EVENT" or "VOD" is specified, a corresponding EXT-X-PLAYLIST-TYPE entry will be included in the media playlist.
hmcoupPlaylistType ::
     Lens' HlsManifestCreateOrUpdateParameters (Maybe PlaylistType)
hmcoupPlaylistType =
  lens _hmcoupPlaylistType (\s a -> s {_hmcoupPlaylistType = a})

-- | The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
hmcoupProgramDateTimeIntervalSeconds ::
     Lens' HlsManifestCreateOrUpdateParameters (Maybe Int)
hmcoupProgramDateTimeIntervalSeconds =
  lens
    _hmcoupProgramDateTimeIntervalSeconds
    (\s a -> s {_hmcoupProgramDateTimeIntervalSeconds = a})
...
hmcoupIncludeIframeOnlyStream ::
     Lens' HlsManifestCreateOrUpdateParameters (Maybe Bool)
hmcoupIncludeIframeOnlyStream =
  lens
    _hmcoupIncludeIframeOnlyStream
    (\s a -> s {_hmcoupIncludeIframeOnlyStream = a})
...
hmcoupPlaylistWindowSeconds =
  lens
    ...
    (\s a -> s {_hmcoupPlaylistWindowSeconds = a})
...
hpUseAudioRenditionGroup =
  lens _hpUseAudioRenditionGroup (\s a -> s {_hpUseAudioRenditionGroup = a})
...
hpSegmentDurationSeconds =
  lens _hpSegmentDurationSeconds (\s a -> s {_hpSegmentDurationSeconds = a})
...
hpProgramDateTimeIntervalSeconds =
  lens
    ...
    (\s a -> s {_hpProgramDateTimeIntervalSeconds = a})
...
hpIncludeIframeOnlyStream =
  lens _hpIncludeIframeOnlyStream (\s a -> s {_hpIncludeIframeOnlyStream = a})

-- | Time window (in seconds) contained in each parent manifest.
hpPlaylistWindowSeconds :: Lens' HlsPackage (Maybe Int)
hpPlaylistWindowSeconds =
  lens _hpPlaylistWindowSeconds (\s a -> s {_hpPlaylistWindowSeconds = a})
...
instance FromJSON HlsPackage where
  parseJSON =
    withObject
      "HlsPackage"
      (\x ->
         HlsPackage' <$> (x .:? "useAudioRenditionGroup") <*>
         (x .:? "playlistType") <*>
         (x .:? "segmentDurationSeconds") <*>
         (x .:? "programDateTimeIntervalSeconds") <*>
         (x .:? "streamSelection") <*>
...
instance FromJSON IngestEndpoint where
  parseJSON =
    withObject
      "IngestEndpoint"
      (\x ->
         IngestEndpoint' <$> (x .:? "url") <*> (x .:? "username") <*>
         (x .:? "password"))
...
meSpekeKeyProvider =
  lens _meSpekeKeyProvider (\s a -> s {_meSpekeKeyProvider = a})
...
instance ToJSON MssEncryption where
  toJSON MssEncryption' {..} =
    object (catMaybes [Just ("spekeKeyProvider" .= _meSpekeKeyProvider)])
...
mpSegmentDurationSeconds =
  lens _mpSegmentDurationSeconds (\s a -> s {_mpSegmentDurationSeconds = a})
...
mpManifestWindowSeconds =
  lens _mpManifestWindowSeconds (\s a -> s {_mpManifestWindowSeconds = a})
...
instance FromJSON MssPackage where
  parseJSON =
    withObject
      "MssPackage"
      (\x ->
         MssPackage' <$> (x .:? "segmentDurationSeconds") <*>
         (x .:? "streamSelection") <*>
         (x .:? "encryption") <*>
         (x .:? "manifestWindowSeconds"))
...
oeWhitelist =
  lens _oeWhitelist (\s a -> s {_oeWhitelist = a}) . _Default . _Coerce
...
oeStartoverWindowSeconds =
  lens _oeStartoverWindowSeconds (\s a -> s {_oeStartoverWindowSeconds = a})
...
oeTimeDelaySeconds =
  lens _oeTimeDelaySeconds (\s a -> s {_oeTimeDelaySeconds = a})
...
instance FromJSON OriginEndpoint where
  parseJSON =
    withObject
      "OriginEndpoint"
      (\x ->
         OriginEndpoint' <$> (x .:? "whitelist" .!= mempty) <*>
         (x .:? "hlsPackage") <*>
         (x .:? "arn") <*>
         (x .:? "manifestName") <*>
         (x .:? "url") <*>
...
instance FromJSON SpekeKeyProvider where
  parseJSON =
    withObject
      "SpekeKeyProvider"
      (\x ->
         SpekeKeyProvider' <$> (x .: "url") <*> (x .: "resourceId") <*>
         (x .: "roleArn") <*>
         (x .:? "systemIds" .!= mempty))
...
ssMinVideoBitsPerSecond =
  lens _ssMinVideoBitsPerSecond (\s a -> s {_ssMinVideoBitsPerSecond = a})

-- | The maximum video bitrate (bps) to include in output.
ssMaxVideoBitsPerSecond :: Lens' StreamSelection (Maybe Int)
ssMaxVideoBitsPerSecond =
  lens _ssMaxVideoBitsPerSecond (\s a -> s {_ssMaxVideoBitsPerSecond = a})
