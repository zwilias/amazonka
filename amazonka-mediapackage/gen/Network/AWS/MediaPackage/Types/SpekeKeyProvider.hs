...
data SpekeKeyProvider = SpekeKeyProvider'{_skpCertificateARN
                                          :: !(Maybe Text),
                                          _skpResourceId :: !Text,
                                          _skpSystemIds :: ![Text],
                                          _skpURL :: !Text,
...
spekeKeyProvider pResourceId_ pURL_ pRoleARN_
  = SpekeKeyProvider'{_skpCertificateARN = Nothing,
                      _skpResourceId = pResourceId_,
                      _skpSystemIds = mempty, _skpURL = pURL_,
