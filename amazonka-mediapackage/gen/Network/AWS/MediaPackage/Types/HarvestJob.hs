...
data HarvestJob = HarvestJob'{_hjStatus ::
                              !(Maybe TaskStatus),
...
harvestJob
    :: HarvestJob
harvestJob
  = HarvestJob'{_hjStatus = Nothing,
                _hjOriginEndpointId = Nothing,
                _hjStartTime = Nothing, _hjARN = Nothing,
                _hjCreatedAt = Nothing, _hjChannelId = Nothing,
                _hjS3Destination = Nothing, _hjEndTime = Nothing,
                _hjId = Nothing}

-- | The current status of the HarvestJob. Consider setting up a CloudWatch Event to listen for HarvestJobs as they succeed or fail. In the event of failure, the CloudWatch Event will include an explanation of why the HarvestJob failed.
hjStatus :: Lens' HarvestJob (Maybe TaskStatus)
...
instance Hashable HarvestJob where

instance NFData HarvestJob where
