...
data CreateHarvestJob = CreateHarvestJob'{_chjS3Destination
                                          :: !S3Destination,
                                          _chjEndTime :: !Text,
...
createHarvestJob
    :: S3Destination -- ^ 'chjS3Destination'
    -> Text -- ^ 'chjEndTime'
    -> Text -- ^ 'chjOriginEndpointId'
    -> Text -- ^ 'chjStartTime'
    -> Text -- ^ 'chjId'
    -> CreateHarvestJob
createHarvestJob pS3Destination_ pEndTime_
  pOriginEndpointId_ pStartTime_ pId_
  = CreateHarvestJob'{_chjS3Destination =
                        pS3Destination_,
                      _chjEndTime = pEndTime_,
                      _chjOriginEndpointId = pOriginEndpointId_,
                      _chjStartTime = pStartTime_, _chjId = pId_}
...
instance Hashable CreateHarvestJob where

instance NFData CreateHarvestJob where
...
data CreateHarvestJobResponse = CreateHarvestJobResponse'{_chjrsStatus
                                                          ::
                                                          !(Maybe TaskStatus),
                                                          _chjrsOriginEndpointId
                                                          :: !(Maybe Text),
                                                          _chjrsStartTime ::
                                                          !(Maybe Text),
                                                          _chjrsARN ::
...
instance NFData CreateHarvestJobResponse where
