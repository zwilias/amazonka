...
dsfFilterNamePrefix =
  lens _dsfFilterNamePrefix (\s a -> s {_dsfFilterNamePrefix = a})
...
instance AWSRequest DescribeSubscriptionFilters where
  type Rs DescribeSubscriptionFilters = DescribeSubscriptionFiltersResponse
...
dsfrsSubscriptionFilters ::
     Lens' DescribeSubscriptionFiltersResponse [SubscriptionFilter]
dsfrsSubscriptionFilters =
  lens _dsfrsSubscriptionFilters (\s a -> s {_dsfrsSubscriptionFilters = a}) .
  _Default . _Coerce
...
dsfrsResponseStatus =
  lens _dsfrsResponseStatus (\s a -> s {_dsfrsResponseStatus = a})
