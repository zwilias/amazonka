...
data LogGroup = LogGroup'{_lgCreationTime ::
                          !(Maybe Nat),
...
logGroup
    :: LogGroup
logGroup
  = LogGroup'{_lgCreationTime = Nothing,
              _lgMetricFilterCount = Nothing, _lgArn = Nothing,
              _lgLogGroupName = Nothing,
              _lgRetentionInDays = Nothing, _lgKmsKeyId = Nothing,
