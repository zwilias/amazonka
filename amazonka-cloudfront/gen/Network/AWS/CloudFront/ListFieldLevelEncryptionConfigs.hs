...
instance AWSRequest ListFieldLevelEncryptionConfigs where
  type Rs ListFieldLevelEncryptionConfigs = ListFieldLevelEncryptionConfigsResponse
  request = get cloudFront
  response =
    receiveXML
      (\s h x ->
         ListFieldLevelEncryptionConfigsResponse' <$> (parseXML x) <*>
         (pure (fromEnum s)))
...
lflecrsFieldLevelEncryptionList ::
     Lens' ListFieldLevelEncryptionConfigsResponse (Maybe FieldLevelEncryptionList)
lflecrsFieldLevelEncryptionList =
  lens
    _lflecrsFieldLevelEncryptionList
    (\s a -> s {_lflecrsFieldLevelEncryptionList = a})

-- | -- | The response status code.
lflecrsResponseStatus :: Lens' ListFieldLevelEncryptionConfigsResponse Int
lflecrsResponseStatus =
  lens _lflecrsResponseStatus (\s a -> s {_lflecrsResponseStatus = a})
