...
uflepFieldLevelEncryptionProfileConfig ::
     Lens' UpdateFieldLevelEncryptionProfile FieldLevelEncryptionProfileConfig
uflepFieldLevelEncryptionProfileConfig =
  lens
    _uflepFieldLevelEncryptionProfileConfig
    (\s a -> s {_uflepFieldLevelEncryptionProfileConfig = a})
...
instance AWSRequest UpdateFieldLevelEncryptionProfile where
  type Rs UpdateFieldLevelEncryptionProfile = UpdateFieldLevelEncryptionProfileResponse
  request = putXML cloudFront
  response =
    receiveXML
      (\s h x ->
         UpdateFieldLevelEncryptionProfileResponse' <$> (h .#? "ETag") <*>
         (parseXML x) <*>
         (pure (fromEnum s)))
...
instance ToPath UpdateFieldLevelEncryptionProfile where
  toPath UpdateFieldLevelEncryptionProfile' {..} =
    mconcat
      ["/2017-10-30/field-level-encryption-profile/", toBS _uflepId, "/config"]
...
ufleprsFieldLevelEncryptionProfile ::
     Lens' UpdateFieldLevelEncryptionProfileResponse (Maybe FieldLevelEncryptionProfile)
ufleprsFieldLevelEncryptionProfile =
  lens
    _ufleprsFieldLevelEncryptionProfile
    (\s a -> s {_ufleprsFieldLevelEncryptionProfile = a})

-- | -- | The response status code.
ufleprsResponseStatus :: Lens' UpdateFieldLevelEncryptionProfileResponse Int
ufleprsResponseStatus =
  lens _ufleprsResponseStatus (\s a -> s {_ufleprsResponseStatus = a})
