...
uflecFieldLevelEncryptionConfig ::
     Lens' UpdateFieldLevelEncryptionConfig FieldLevelEncryptionConfig
uflecFieldLevelEncryptionConfig =
  lens
    _uflecFieldLevelEncryptionConfig
    (\s a -> s {_uflecFieldLevelEncryptionConfig = a})
...
instance AWSRequest UpdateFieldLevelEncryptionConfig where
  type Rs UpdateFieldLevelEncryptionConfig = UpdateFieldLevelEncryptionConfigResponse
  request = putXML cloudFront
  response =
    receiveXML
      (\s h x ->
         UpdateFieldLevelEncryptionConfigResponse' <$> (h .#? "ETag") <*>
         (parseXML x) <*>
         (pure (fromEnum s)))
...
instance ToPath UpdateFieldLevelEncryptionConfig where
  toPath UpdateFieldLevelEncryptionConfig' {..} =
    mconcat ["/2017-10-30/field-level-encryption/", toBS _uflecId, "/config"]
...
uflecrsFieldLevelEncryption ::
     Lens' UpdateFieldLevelEncryptionConfigResponse (Maybe FieldLevelEncryption)
uflecrsFieldLevelEncryption =
  lens
    _uflecrsFieldLevelEncryption
    (\s a -> s {_uflecrsFieldLevelEncryption = a})

-- | -- | The response status code.
uflecrsResponseStatus :: Lens' UpdateFieldLevelEncryptionConfigResponse Int
uflecrsResponseStatus =
  lens _uflecrsResponseStatus (\s a -> s {_uflecrsResponseStatus = a})
