...
cflepFieldLevelEncryptionProfileConfig ::
     Lens' CreateFieldLevelEncryptionProfile FieldLevelEncryptionProfileConfig
cflepFieldLevelEncryptionProfileConfig =
  lens
    _cflepFieldLevelEncryptionProfileConfig
    (\s a -> s {_cflepFieldLevelEncryptionProfileConfig = a})

instance AWSRequest CreateFieldLevelEncryptionProfile where
  type Rs CreateFieldLevelEncryptionProfile = CreateFieldLevelEncryptionProfileResponse
  request = postXML cloudFront
  response =
    receiveXML
      (\s h x ->
         CreateFieldLevelEncryptionProfileResponse' <$> (h .#? "ETag") <*>
         (h .#? "Location") <*>
         (parseXML x) <*>
         (pure (fromEnum s)))
...
instance ToPath CreateFieldLevelEncryptionProfile where
  toPath = const "/2017-10-30/field-level-encryption-profile"
...
cfleprsFieldLevelEncryptionProfile ::
     Lens' CreateFieldLevelEncryptionProfileResponse (Maybe FieldLevelEncryptionProfile)
cfleprsFieldLevelEncryptionProfile =
  lens
    _cfleprsFieldLevelEncryptionProfile
    (\s a -> s {_cfleprsFieldLevelEncryptionProfile = a})

-- | -- | The response status code.
cfleprsResponseStatus :: Lens' CreateFieldLevelEncryptionProfileResponse Int
cfleprsResponseStatus =
  lens _cfleprsResponseStatus (\s a -> s {_cfleprsResponseStatus = a})
