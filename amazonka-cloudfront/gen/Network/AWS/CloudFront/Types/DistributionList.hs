...
data DistributionList = DistributionList'{_dlItems ::
...
distributionList
    ...
    -> Int -- ^ 'dlQuantity'
    -> DistributionList
distributionList pMarker_ pMaxItems_ pIsTruncated_
  pQuantity_
  = DistributionList'{_dlItems = Nothing,
                      _dlNextMarker = Nothing, _dlMarker = pMarker_,
