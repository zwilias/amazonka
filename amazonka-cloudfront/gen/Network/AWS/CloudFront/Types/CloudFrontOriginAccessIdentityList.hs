...
data CloudFrontOriginAccessIdentityList = CloudFrontOriginAccessIdentityList'{_cfoailItems
                                                                              ::
                                                                              !(Maybe
...
cloudFrontOriginAccessIdentityList
    ...
    -> Int -- ^ 'cfoailQuantity'
    -> CloudFrontOriginAccessIdentityList
cloudFrontOriginAccessIdentityList pMarker_
  pMaxItems_ pIsTruncated_ pQuantity_
  = CloudFrontOriginAccessIdentityList'{_cfoailItems =
                                          Nothing,
