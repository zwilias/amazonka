...
data DistributionSummary = DistributionSummary'{_dsOriginGroups
                                                :: !(Maybe OriginGroups),
                                                _dsAliasICPRecordals ::
                                                !(Maybe [AliasICPRecordal]),
                                                _dsId :: !Text, _dsARN :: !Text,
                                                _dsStatus :: !Text,
...
distributionSummary
    ...
    -> DistributionSummary
distributionSummary pId_ pARN_ pStatus_
  pLastModifiedTime_ pDomainName_ pAliases_ pOrigins_
  pDefaultCacheBehavior_ pCacheBehaviors_
  pCustomErrorResponses_ pComment_ pPriceClass_
  pEnabled_ pViewerCertificate_ pRestrictions_
  pWebACLId_ pHTTPVersion_ pIsIPV6Enabled_
  = DistributionSummary'{_dsOriginGroups = Nothing,
                         _dsAliasICPRecordals = Nothing, _dsId = pId_,
                         _dsARN = pARN_, _dsStatus = pStatus_,
                         _dsLastModifiedTime = _Time # pLastModifiedTime_,
                         _dsDomainName = pDomainName_, _dsAliases = pAliases_,
                         ...
                         _dsComment = pComment_, _dsPriceClass = pPriceClass_,
