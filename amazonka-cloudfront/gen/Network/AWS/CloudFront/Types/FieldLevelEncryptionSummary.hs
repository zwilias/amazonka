...
data FieldLevelEncryptionSummary = FieldLevelEncryptionSummary'{_flesQueryArgProfileConfig
                                                                ::
                                                                !(Maybe
...
fieldLevelEncryptionSummary pId_ pLastModifiedTime_
  = FieldLevelEncryptionSummary'{_flesQueryArgProfileConfig
                                   = Nothing,
                                 _flesContentTypeProfileConfig = Nothing,
                                 _flesComment = Nothing, _flesId = pId_,
                                 _flesLastModifiedTime =
