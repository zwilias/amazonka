...
data FieldLevelEncryptionProfile = FieldLevelEncryptionProfile'{_flepId
                                                                :: !Text,
...
fieldLevelEncryptionProfile
    ...
    -> FieldLevelEncryptionProfile
fieldLevelEncryptionProfile pId_ pLastModifiedTime_
  pFieldLevelEncryptionProfileConfig_
  = FieldLevelEncryptionProfile'{_flepId = pId_,
                                 _flepLastModifiedTime =
