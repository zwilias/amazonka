...
instance FromXML Aliases where
  parseXML x =
    Aliases' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList "CNAME")) <*>
    (x .@ "Quantity")
...
instance FromXML AllowedMethods where
  parseXML x =
    AllowedMethods' <$> (x .@? "CachedMethods") <*> (x .@ "Quantity") <*>
...
cbLambdaFunctionAssociations ::
     Lens' CacheBehavior (Maybe LambdaFunctionAssociations)
cbLambdaFunctionAssociations =
  lens
    _cbLambdaFunctionAssociations
    (\s a -> s {_cbLambdaFunctionAssociations = a})
...
cbFieldLevelEncryptionId =
  lens _cbFieldLevelEncryptionId (\s a -> s {_cbFieldLevelEncryptionId = a})
...
instance FromXML CacheBehavior where
  parseXML x =
    CacheBehavior' <$> (x .@? "AllowedMethods") <*>
...
instance ToXML CachedMethods where
  toXML CachedMethods' {..} =
    mconcat ["Quantity" @= _cmQuantity, "Items" @= toXMLList "Method" _cmItems]
...
cfoaiCloudFrontOriginAccessIdentityConfig ::
     Lens' CloudFrontOriginAccessIdentity (Maybe CloudFrontOriginAccessIdentityConfig)
cfoaiCloudFrontOriginAccessIdentityConfig =
  lens
...
instance FromXML CloudFrontOriginAccessIdentityConfig where
  parseXML x =
    CloudFrontOriginAccessIdentityConfig' <$> (x .@ "CallerReference") <*>
    (x .@ "Comment")
...
instance ToXML CloudFrontOriginAccessIdentityConfig where
  toXML CloudFrontOriginAccessIdentityConfig' {..} =
    mconcat
      ["CallerReference" @= _cfoaicCallerReference, "Comment" @= _cfoaicComment]
...
cfoailItems ::
     Lens' CloudFrontOriginAccessIdentityList [CloudFrontOriginAccessIdentitySummary]
cfoailItems =
  lens _cfoailItems (\s a -> s {_cfoailItems = a}) . _Default . _Coerce
...
instance FromXML CloudFrontOriginAccessIdentitySummary where
  parseXML x =
    CloudFrontOriginAccessIdentitySummary' <$> (x .@ "Id") <*>
    (x .@ "S3CanonicalUserId") <*>
    (x .@ "Comment")
...
instance FromXML ContentTypeProfile where
  parseXML x =
    ContentTypeProfile' <$> (x .@? "ProfileId") <*> (x .@ "Format") <*>
    (x .@ "ContentType")
...
ctpcContentTypeProfiles ::
     Lens' ContentTypeProfileConfig (Maybe ContentTypeProfiles)
ctpcContentTypeProfiles =
  lens _ctpcContentTypeProfiles (\s a -> s {_ctpcContentTypeProfiles = a})
...
ctpcForwardWhenContentTypeIsUnknown =
  lens
    ...
    (\s a -> s {_ctpcForwardWhenContentTypeIsUnknown = a})

instance FromXML ContentTypeProfileConfig where
  parseXML x =
    ContentTypeProfileConfig' <$> (x .@? "ContentTypeProfiles") <*>
...
instance FromXML ContentTypeProfiles where
  parseXML x =
    ContentTypeProfiles' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "ContentTypeProfile")) <*>
    (x .@ "Quantity")
...
instance FromXML CookieNames where
  parseXML x =
    CookieNames' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList "Name")) <*>
    (x .@ "Quantity")
...
instance FromXML CookiePreference where
  parseXML x =
    CookiePreference' <$> (x .@? "WhitelistedNames") <*> (x .@ "Forward")
...
instance ToXML CookiePreference where
  toXML CookiePreference' {..} =
    mconcat ["WhitelistedNames" @= _cpWhitelistedNames, "Forward" @= _cpForward]
...
ceResponsePagePath =
  lens _ceResponsePagePath (\s a -> s {_ceResponsePagePath = a})
...
ceErrorCachingMinTTL =
  lens _ceErrorCachingMinTTL (\s a -> s {_ceErrorCachingMinTTL = a})
...
instance FromXML CustomErrorResponse where
  parseXML x =
    CustomErrorResponse' <$> (x .@? "ResponsePagePath") <*>
    (x .@? "ResponseCode") <*>
...
instance FromXML CustomErrorResponses where
  parseXML x =
    CustomErrorResponses' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "CustomErrorResponse")) <*>
    (x .@ "Quantity")
...
instance FromXML CustomHeaders where
  parseXML x =
    CustomHeaders' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "OriginCustomHeader")) <*>
    (x .@ "Quantity")
...
instance FromXML CustomOriginConfig where
  parseXML x =
    CustomOriginConfig' <$> (x .@? "OriginKeepaliveTimeout") <*>
    (x .@? "OriginReadTimeout") <*>
...
dcbLambdaFunctionAssociations ::
     Lens' DefaultCacheBehavior (Maybe LambdaFunctionAssociations)
dcbLambdaFunctionAssociations =
  lens
    _dcbLambdaFunctionAssociations
    (\s a -> s {_dcbLambdaFunctionAssociations = a})
...
dcbFieldLevelEncryptionId =
  lens _dcbFieldLevelEncryptionId (\s a -> s {_dcbFieldLevelEncryptionId = a})
...
instance FromXML DefaultCacheBehavior where
  parseXML x =
    DefaultCacheBehavior' <$> (x .@? "AllowedMethods") <*>
    (x .@? "LambdaFunctionAssociations") <*>
    (x .@? "MaxTTL") <*>
    (x .@? "Compress") <*>
    (x .@? "SmoothStreaming") <*>
...
dLastModifiedTime =
  lens _dLastModifiedTime (\s a -> s {_dLastModifiedTime = a}) . _Time
...
instance FromXML Distribution where
  parseXML x =
    Distribution' <$> (x .@ "Id") <*> (x .@ "ARN") <*> (x .@ "Status") <*>
    (x .@ "LastModifiedTime") <*>
...
instance FromXML DistributionConfig where
  parseXML x =
    DistributionConfig' <$> (x .@? "HttpVersion") <*> (x .@? "Aliases") <*>
    (x .@? "DefaultRootObject") <*>
    (x .@? "PriceClass") <*>
...
dcwtDistributionConfig =
  lens _dcwtDistributionConfig (\s a -> s {_dcwtDistributionConfig = a})
...
instance ToXML DistributionConfigWithTags where
  toXML DistributionConfigWithTags' {..} =
    mconcat
      ["DistributionConfig" @= _dcwtDistributionConfig, "Tags" @= _dcwtTags]
...
instance FromXML DistributionList where
  parseXML x =
    DistributionList' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "DistributionSummary")) <*>
    (x .@? "NextMarker") <*>
    (x .@ "Marker") <*>
    (x .@ "MaxItems") <*>
    (x .@ "IsTruncated") <*>
...
dsLastModifiedTime =
  lens _dsLastModifiedTime (\s a -> s {_dsLastModifiedTime = a}) . _Time
...
instance FromXML DistributionSummary where
  parseXML x =
    DistributionSummary' <$> (x .@ "Id") <*> (x .@ "ARN") <*> (x .@ "Status") <*>
    (x .@ "LastModifiedTime") <*>
    (x .@ "DomainName") <*>
    (x .@ "Aliases") <*>
    (x .@ "Origins") <*>
...
instance FromXML EncryptionEntities where
  parseXML x =
    EncryptionEntities' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "EncryptionEntity")) <*>
    (x .@ "Quantity")
...
instance FromXML EncryptionEntity where
  parseXML x =
    EncryptionEntity' <$> (x .@ "PublicKeyId") <*> (x .@ "ProviderId") <*>
    (x .@ "FieldPatterns")
...
fleLastModifiedTime =
  lens _fleLastModifiedTime (\s a -> s {_fleLastModifiedTime = a}) . _Time

-- | A complex data type that includes the profile configurations specified for field-level encryption.
fleFieldLevelEncryptionConfig ::
     Lens' FieldLevelEncryption FieldLevelEncryptionConfig
fleFieldLevelEncryptionConfig =
  lens
    _fleFieldLevelEncryptionConfig
    (\s a -> s {_fleFieldLevelEncryptionConfig = a})

instance FromXML FieldLevelEncryption where
  parseXML x =
    FieldLevelEncryption' <$> (x .@ "Id") <*> (x .@ "LastModifiedTime") <*>
...
flecQueryArgProfileConfig ::
     Lens' FieldLevelEncryptionConfig (Maybe QueryArgProfileConfig)
flecQueryArgProfileConfig =
  lens _flecQueryArgProfileConfig (\s a -> s {_flecQueryArgProfileConfig = a})

-- | A complex data type that specifies when to forward content if a content type isn't recognized and profiles to use as by default in a request if a query argument doesn't specify a profile to use.
flecContentTypeProfileConfig ::
     Lens' FieldLevelEncryptionConfig (Maybe ContentTypeProfileConfig)
flecContentTypeProfileConfig =
  lens
    _flecContentTypeProfileConfig
    (\s a -> s {_flecContentTypeProfileConfig = a})
...
flecCallerReference =
  lens _flecCallerReference (\s a -> s {_flecCallerReference = a})

instance FromXML FieldLevelEncryptionConfig where
  parseXML x =
    FieldLevelEncryptionConfig' <$> (x .@? "QueryArgProfileConfig") <*>
...
flepLastModifiedTime =
  lens _flepLastModifiedTime (\s a -> s {_flepLastModifiedTime = a}) . _Time
...
flepFieldLevelEncryptionProfileConfig =
  lens
    _flepFieldLevelEncryptionProfileConfig
    (\s a -> s {_flepFieldLevelEncryptionProfileConfig = a})

instance FromXML FieldLevelEncryptionProfile where
  parseXML x =
    FieldLevelEncryptionProfile' <$> (x .@ "Id") <*> (x .@ "LastModifiedTime") <*>
...
flepcCallerReference =
  lens _flepcCallerReference (\s a -> s {_flepcCallerReference = a})

-- | A complex data type of encryption entities for the field-level encryption profile that include the public key ID, provider, and field patterns for specifying which fields to encrypt with this key.
flepcEncryptionEntities ::
     Lens' FieldLevelEncryptionProfileConfig EncryptionEntities
flepcEncryptionEntities =
  lens _flepcEncryptionEntities (\s a -> s {_flepcEncryptionEntities = a})

instance FromXML FieldLevelEncryptionProfileConfig where
  parseXML x =
    FieldLevelEncryptionProfileConfig' <$> (x .@? "Comment") <*> (x .@ "Name") <*>
    (x .@ "CallerReference") <*>
...
fleplItems ::
     Lens' FieldLevelEncryptionProfileList [FieldLevelEncryptionProfileSummary]
...
flepsLastModifiedTime =
  lens _flepsLastModifiedTime (\s a -> s {_flepsLastModifiedTime = a}) . _Time
...
flepsEncryptionEntities ::
     Lens' FieldLevelEncryptionProfileSummary EncryptionEntities
flepsEncryptionEntities =
  lens _flepsEncryptionEntities (\s a -> s {_flepsEncryptionEntities = a})

instance FromXML FieldLevelEncryptionProfileSummary where
  parseXML x =
    FieldLevelEncryptionProfileSummary' <$> (x .@? "Comment") <*> (x .@ "Id") <*>
    (x .@ "LastModifiedTime") <*>
    (x .@ "Name") <*>
    (x .@ "EncryptionEntities")
...
flesQueryArgProfileConfig ::
     Lens' FieldLevelEncryptionSummary (Maybe QueryArgProfileConfig)
flesQueryArgProfileConfig =
  lens _flesQueryArgProfileConfig (\s a -> s {_flesQueryArgProfileConfig = a})

-- | A summary of a content type-profile mapping.
flesContentTypeProfileConfig ::
     Lens' FieldLevelEncryptionSummary (Maybe ContentTypeProfileConfig)
flesContentTypeProfileConfig =
  lens
    _flesContentTypeProfileConfig
    (\s a -> s {_flesContentTypeProfileConfig = a})
...
flesLastModifiedTime =
  lens _flesLastModifiedTime (\s a -> s {_flesLastModifiedTime = a}) . _Time

instance FromXML FieldLevelEncryptionSummary where
  parseXML x =
    FieldLevelEncryptionSummary' <$> (x .@? "QueryArgProfileConfig") <*>
    (x .@? "ContentTypeProfileConfig") <*>
    (x .@? "Comment") <*>
    (x .@ "Id") <*>
    (x .@ "LastModifiedTime")
...
fvQueryStringCacheKeys =
  lens _fvQueryStringCacheKeys (\s a -> s {_fvQueryStringCacheKeys = a})
...
instance FromXML ForwardedValues where
  parseXML x =
    ForwardedValues' <$> (x .@? "QueryStringCacheKeys") <*> (x .@? "Headers") <*>
    (x .@ "QueryString") <*>
    (x .@ "Cookies")
...
instance FromXML Headers where
  parseXML x =
    Headers' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList "Name")) <*>
    (x .@ "Quantity")
...
instance FromXML Invalidation where
  parseXML x =
    Invalidation' <$> (x .@ "Id") <*> (x .@ "Status") <*> (x .@ "CreateTime") <*>
    (x .@ "InvalidationBatch")
...
instance FromXML InvalidationBatch where
  parseXML x =
    InvalidationBatch' <$> (x .@ "Paths") <*> (x .@ "CallerReference")
...
instance ToXML InvalidationBatch where
  toXML InvalidationBatch' {..} =
    mconcat ["Paths" @= _ibPaths, "CallerReference" @= _ibCallerReference]
...
instance FromXML InvalidationList where
  parseXML x =
    InvalidationList' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "InvalidationSummary")) <*>
    (x .@? "NextMarker") <*>
    (x .@ "Marker") <*>
    (x .@ "MaxItems") <*>
    (x .@ "IsTruncated") <*>
...
instance FromXML InvalidationSummary where
  parseXML x =
    InvalidationSummary' <$> (x .@ "Id") <*> (x .@ "CreateTime") <*>
    (x .@ "Status")
...
lfaLambdaFunctionARN =
  lens _lfaLambdaFunctionARN (\s a -> s {_lfaLambdaFunctionARN = a})
...
instance FromXML LambdaFunctionAssociation where
  parseXML x =
    LambdaFunctionAssociation' <$> (x .@ "LambdaFunctionARN") <*>
    (x .@ "EventType")
...
instance FromXML LambdaFunctionAssociations where
  parseXML x =
    LambdaFunctionAssociations' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "LambdaFunctionAssociation")) <*>
    (x .@ "Quantity")
...
instance ToXML LambdaFunctionAssociations where
  toXML LambdaFunctionAssociations' {..} =
    mconcat
      [ "Items" @= toXML (toXMLList "LambdaFunctionAssociation" <$> _lfaItems)
...
instance FromXML LoggingConfig where
  parseXML x =
    LoggingConfig' <$> (x .@ "Enabled") <*> (x .@ "IncludeCookies") <*>
    (x .@ "Bucket") <*>
    (x .@ "Prefix")
...
instance FromXML Origin where
  parseXML x =
    Origin' <$> (x .@? "CustomHeaders") <*> (x .@? "CustomOriginConfig") <*>
    (x .@? "S3OriginConfig") <*>
    (x .@? "OriginPath") <*>
    (x .@ "Id") <*>
    (x .@ "DomainName")
...
instance FromXML OriginCustomHeader where
  parseXML x =
    OriginCustomHeader' <$> (x .@ "HeaderName") <*> (x .@ "HeaderValue")
...
instance ToXML OriginCustomHeader where
  toXML OriginCustomHeader' {..} =
    mconcat ["HeaderName" @= _ochHeaderName, "HeaderValue" @= _ochHeaderValue]
...
instance ToXML OriginSSLProtocols where
  toXML OriginSSLProtocols' {..} =
    mconcat
      ["Quantity" @= _ospQuantity, "Items" @= toXMLList "SslProtocol" _ospItems]
...
instance FromXML Origins where
  parseXML x =
    Origins' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList1 "Origin")) <*>
    (x .@ "Quantity")
...
instance FromXML Paths where
  parseXML x =
    Paths' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList "Path")) <*>
    (x .@ "Quantity")
...
pkcCallerReference =
  lens _pkcCallerReference (\s a -> s {_pkcCallerReference = a})
...
instance FromXML PublicKeyConfig where
  parseXML x =
    PublicKeyConfig' <$> (x .@? "Comment") <*> (x .@ "CallerReference") <*>
    (x .@ "Name") <*>
    (x .@ "EncodedKey")
...
instance FromXML PublicKeyList where
  parseXML x =
    PublicKeyList' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "PublicKeySummary")) <*>
    (x .@? "NextMarker") <*>
    (x .@ "MaxItems") <*>
    (x .@ "Quantity")
...
instance FromXML PublicKeySummary where
  parseXML x =
    PublicKeySummary' <$> (x .@? "Comment") <*> (x .@ "Id") <*> (x .@ "Name") <*>
    (x .@ "CreatedTime") <*>
    (x .@ "EncodedKey")
...
instance FromXML QueryArgProfile where
  parseXML x = QueryArgProfile' <$> (x .@ "QueryArg") <*> (x .@ "ProfileId")
...
instance ToXML QueryArgProfile where
  toXML QueryArgProfile' {..} =
    mconcat ["QueryArg" @= _qapQueryArg, "ProfileId" @= _qapProfileId]
...
qapcQueryArgProfiles =
  lens _qapcQueryArgProfiles (\s a -> s {_qapcQueryArgProfiles = a})
...
qapcForwardWhenQueryArgProfileIsUnknown =
  lens
    _qapcForwardWhenQueryArgProfileIsUnknown
    (\s a -> s {_qapcForwardWhenQueryArgProfileIsUnknown = a})

instance FromXML QueryArgProfileConfig where
  parseXML x =
    QueryArgProfileConfig' <$> (x .@? "QueryArgProfiles") <*>
...
instance ToXML Restrictions where
  toXML Restrictions' {..} = mconcat ["GeoRestriction" @= _rGeoRestriction]
...
instance FromXML S3Origin where
  parseXML x =
    S3Origin' <$> (x .@ "DomainName") <*> (x .@ "OriginAccessIdentity")
...
instance FromXML Signer where
  parseXML x = Signer' <$> (x .@? "AwsAccountNumber") <*> (x .@? "KeyPairIds")
...
sdLastModifiedTime =
  lens _sdLastModifiedTime (\s a -> s {_sdLastModifiedTime = a}) . mapping _Time
...
sdStreamingDistributionConfig ::
     Lens' StreamingDistribution StreamingDistributionConfig
sdStreamingDistributionConfig =
  lens
...
instance FromXML StreamingDistribution where
  parseXML x =
    StreamingDistribution' <$> (x .@? "LastModifiedTime") <*> (x .@ "Id") <*>
    (x .@ "ARN") <*>
    (x .@ "Status") <*>
    (x .@ "DomainName") <*>
    (x .@ "ActiveTrustedSigners") <*>
...
instance FromXML StreamingDistributionConfig where
  parseXML x =
    StreamingDistributionConfig' <$> (x .@? "Aliases") <*> (x .@? "PriceClass") <*>
    (x .@? "Logging") <*>
    (x .@ "CallerReference") <*>
    (x .@ "S3Origin") <*>
    (x .@ "Comment") <*>
...
sdcwtStreamingDistributionConfig ::
     Lens' StreamingDistributionConfigWithTags StreamingDistributionConfig
sdcwtStreamingDistributionConfig =
  lens
    _sdcwtStreamingDistributionConfig
    (\s a -> s {_sdcwtStreamingDistributionConfig = a})
...
instance ToXML StreamingDistributionConfigWithTags where
  toXML StreamingDistributionConfigWithTags' {..} =
    mconcat
      [ "StreamingDistributionConfig" @= _sdcwtStreamingDistributionConfig
      , "Tags" @= _sdcwtTags
      ]
...
sdsLastModifiedTime =
  lens _sdsLastModifiedTime (\s a -> s {_sdsLastModifiedTime = a}) . _Time
...
instance FromXML StreamingDistributionSummary where
  parseXML x =
    StreamingDistributionSummary' <$> (x .@ "Id") <*> (x .@ "ARN") <*>
    (x .@ "Status") <*>
    (x .@ "LastModifiedTime") <*>
    (x .@ "DomainName") <*>
    (x .@ "S3Origin") <*>
...
instance FromXML StreamingLoggingConfig where
  parseXML x =
    StreamingLoggingConfig' <$> (x .@ "Enabled") <*> (x .@ "Bucket") <*>
    (x .@ "Prefix")
...
instance ToXML StreamingLoggingConfig where
  toXML StreamingLoggingConfig' {..} =
    mconcat
      ["Enabled" @= _slcEnabled, "Bucket" @= _slcBucket, "Prefix" @= _slcPrefix]
...
instance FromXML Tags where
  parseXML x = Tags' <$> (x .@? "Items" .!@ mempty >>= may (parseXMLList "Tag"))
...
instance ToXML Tags where
  toXML Tags' {..} = mconcat ["Items" @= toXML (toXMLList "Tag" <$> _tItems)]
...
instance FromXML TrustedSigners where
  parseXML x =
    TrustedSigners' <$>
    (x .@? "Items" .!@ mempty >>= may (parseXMLList "AwsAccountNumber")) <*>
    (x .@ "Enabled") <*>
    (x .@ "Quantity")
...
vcACMCertificateARN =
  lens _vcACMCertificateARN (\s a -> s {_vcACMCertificateARN = a})
...
vcCertificateSource =
  lens _vcCertificateSource (\s a -> s {_vcCertificateSource = a})

-- | Specify the security policy that you want CloudFront to use for HTTPS connections. A security policy determines two settings:     * The minimum SSL/TLS protocol that CloudFront uses to communicate with viewers     * The cipher that CloudFront uses to encrypt the content that it returns to viewers We recommend that you specify @TLSv1.1_2016@ unless your users are using browsers or devices that do not support TLSv1.1 or later. When both of the following are true, you must specify @TLSv1@ or later for the security policy:      * You're using a custom certificate: you specified a value for @ACMCertificateArn@ or for @IAMCertificateId@      * You're using SNI: you specified @sni-only@ for @SSLSupportMethod@  If you specify @true@ for @CloudFrontDefaultCertificate@ , CloudFront automatically sets the security policy to @TLSv1@ regardless of the value that you specify for @MinimumProtocolVersion@ . For information about the relationship between the security policy that you choose and the protocols and ciphers that CloudFront uses to communicate with viewers, see <http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/secure-connections-supported-viewer-protocols-ciphers.html#secure-connections-supported-ciphers Supported SSL/TLS Protocols and Ciphers for Communication Between Viewers and CloudFront> in the /Amazon CloudFront Developer Guide/ .
vcMinimumProtocolVersion ::
     Lens' ViewerCertificate (Maybe MinimumProtocolVersion)
vcMinimumProtocolVersion =
  lens _vcMinimumProtocolVersion (\s a -> s {_vcMinimumProtocolVersion = a})
...
instance FromXML ViewerCertificate where
  parseXML x =
    ViewerCertificate' <$> (x .@? "SSLSupportMethod") <*>
    (x .@? "ACMCertificateArn") <*>
    (x .@? "CertificateSource") <*>
