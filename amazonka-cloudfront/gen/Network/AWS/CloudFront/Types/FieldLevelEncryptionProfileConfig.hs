...
data FieldLevelEncryptionProfileConfig = FieldLevelEncryptionProfileConfig'{_flepcComment
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _flepcName
...
fieldLevelEncryptionProfileConfig
    ...
    -> FieldLevelEncryptionProfileConfig
fieldLevelEncryptionProfileConfig pName_
  pCallerReference_ pEncryptionEntities_
  = FieldLevelEncryptionProfileConfig'{_flepcComment =
                                         Nothing,
                                       _flepcName = pName_,
                                       _flepcCallerReference =
                                         pCallerReference_,
