...
data CloudFrontOriginAccessIdentity = CloudFrontOriginAccessIdentity'{_cfoaiCloudFrontOriginAccessIdentityConfig
                                                                      ::
                                                                      !(Maybe
...
cloudFrontOriginAccessIdentity
    ...
    -> CloudFrontOriginAccessIdentity
cloudFrontOriginAccessIdentity pId_
  pS3CanonicalUserId_
  = CloudFrontOriginAccessIdentity'{_cfoaiCloudFrontOriginAccessIdentityConfig
                                      = Nothing,
                                    _cfoaiId = pId_,
                                    _cfoaiS3CanonicalUserId =
                                      pS3CanonicalUserId_}
