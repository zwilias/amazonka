...
data StreamingDistributionList = StreamingDistributionList'{_sdlItems
                                                            ::
                                                            !(Maybe
...
streamingDistributionList
    ...
    -> Int -- ^ 'sdlQuantity'
    -> StreamingDistributionList
streamingDistributionList pMarker_ pMaxItems_
  pIsTruncated_ pQuantity_
  = StreamingDistributionList'{_sdlItems = Nothing,
                               _sdlNextMarker = Nothing, _sdlMarker = pMarker_,
