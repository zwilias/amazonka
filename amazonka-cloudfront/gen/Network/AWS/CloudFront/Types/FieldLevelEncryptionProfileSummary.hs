...
data FieldLevelEncryptionProfileSummary = FieldLevelEncryptionProfileSummary'{_flepsComment
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _flepsId
...
fieldLevelEncryptionProfileSummary
    ...
    -> FieldLevelEncryptionProfileSummary
fieldLevelEncryptionProfileSummary pId_
  pLastModifiedTime_ pName_ pEncryptionEntities_
  = FieldLevelEncryptionProfileSummary'{_flepsComment =
                                          Nothing,
                                        _flepsId = pId_,
                                        _flepsLastModifiedTime =
