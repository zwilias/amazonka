...
data Invalidation = Invalidation'{_iId :: !Text,
                                  _iStatus :: !Text, _iCreateTime :: !ISO8601,
...
invalidation
    ...
    -> Invalidation
invalidation pId_ pStatus_ pCreateTime_
  pInvalidationBatch_
  = Invalidation'{_iId = pId_, _iStatus = pStatus_,
