...
instance AWSRequest ListFieldLevelEncryptionProfiles where
  type Rs ListFieldLevelEncryptionProfiles = ListFieldLevelEncryptionProfilesResponse
  request = get cloudFront
  response =
    receiveXML
      (\s h x ->
         ListFieldLevelEncryptionProfilesResponse' <$> (parseXML x) <*>
         (pure (fromEnum s)))
...
lfleprsFieldLevelEncryptionProfileList ::
     Lens' ListFieldLevelEncryptionProfilesResponse (Maybe FieldLevelEncryptionProfileList)
lfleprsFieldLevelEncryptionProfileList =
  lens
    _lfleprsFieldLevelEncryptionProfileList
    (\s a -> s {_lfleprsFieldLevelEncryptionProfileList = a})

-- | -- | The response status code.
lfleprsResponseStatus :: Lens' ListFieldLevelEncryptionProfilesResponse Int
lfleprsResponseStatus =
  lens _lfleprsResponseStatus (\s a -> s {_lfleprsResponseStatus = a})
