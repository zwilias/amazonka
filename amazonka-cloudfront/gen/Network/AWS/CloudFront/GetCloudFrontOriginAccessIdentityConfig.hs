...
instance AWSRequest GetCloudFrontOriginAccessIdentityConfig where
  ...
  response =
    receiveXML
      (\s h x ->
         GetCloudFrontOriginAccessIdentityConfigResponse' <$> (parseXML x) <*>
         (h .#? "ETag") <*>
         (pure (fromEnum s)))
...
gcfoaicrsCloudFrontOriginAccessIdentityConfig ::
     Lens' GetCloudFrontOriginAccessIdentityConfigResponse (Maybe CloudFrontOriginAccessIdentityConfig)
gcfoaicrsCloudFrontOriginAccessIdentityConfig =
  lens
...
gcfoaicrsETag ::
     Lens' GetCloudFrontOriginAccessIdentityConfigResponse (Maybe Text)
gcfoaicrsETag = lens _gcfoaicrsETag (\s a -> s {_gcfoaicrsETag = a})

-- | -- | The response status code.
gcfoaicrsResponseStatus ::
     Lens' GetCloudFrontOriginAccessIdentityConfigResponse Int
gcfoaicrsResponseStatus =
  lens _gcfoaicrsResponseStatus (\s a -> s {_gcfoaicrsResponseStatus = a})
