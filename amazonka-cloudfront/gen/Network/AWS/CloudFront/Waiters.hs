...
streamingDistributionDeployed
  = Wait{_waitName = "StreamingDistributionDeployed",
         _waitAttempts = 25, _waitDelay = 60,
         _waitAcceptors =
           [matchAll "Deployed" AcceptSuccess
              (gsdrsStreamingDistribution . _Just . sdStatus .
                 to toTextCI)]}
...
distributionDeployed
  = Wait{_waitName = "DistributionDeployed",
         _waitAttempts = 35, _waitDelay = 60,
         _waitAcceptors =
           [matchAll "Deployed" AcceptSuccess
...
invalidationCompleted
  = Wait{_waitName = "InvalidationCompleted",
         _waitAttempts = 30, _waitDelay = 20,
         _waitAcceptors =
