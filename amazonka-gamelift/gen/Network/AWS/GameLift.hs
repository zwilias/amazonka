...
--
-- __Get Amazon GameLift Tools and Resources__ 
--
-- This reference guide describes the low-level service API for Amazon GameLift and provides links to language-specific SDK reference topics. See also <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-components.html Amazon GameLift Tools and Resources> .
--
-- __API Summary__ 
--
...
--
--
-- __<https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html Task-based list of API actions> __ 
--
module Network.AWS.GameLift
    (
