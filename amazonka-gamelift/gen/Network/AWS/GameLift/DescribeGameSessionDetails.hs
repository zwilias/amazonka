...
instance AWSRequest DescribeGameSessionDetails where
  type Rs DescribeGameSessionDetails = DescribeGameSessionDetailsResponse
...
dgsdrsGameSessionDetails ::
     Lens' DescribeGameSessionDetailsResponse [GameSessionDetail]
dgsdrsGameSessionDetails =
  lens _dgsdrsGameSessionDetails (\s a -> s {_dgsdrsGameSessionDetails = a}) .
  _Default . _Coerce
...
dgsdrsResponseStatus =
  lens _dgsdrsResponseStatus (\s a -> s {_dgsdrsResponseStatus = a})
