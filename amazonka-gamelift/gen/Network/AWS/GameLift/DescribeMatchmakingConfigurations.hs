...
instance AWSRequest DescribeMatchmakingConfigurations where
  type Rs DescribeMatchmakingConfigurations = DescribeMatchmakingConfigurationsResponse
...
dmcsrsConfigurations ::
     Lens' DescribeMatchmakingConfigurationsResponse [MatchmakingConfiguration]
dmcsrsConfigurations =
  lens _dmcsrsConfigurations (\s a -> s {_dmcsrsConfigurations = a}) .
  _Default . _Coerce
...
dmcsrsResponseStatus =
  lens _dmcsrsResponseStatus (\s a -> s {_dmcsrsResponseStatus = a})
