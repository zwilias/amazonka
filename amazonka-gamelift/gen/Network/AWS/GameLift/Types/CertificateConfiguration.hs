...
newtype CertificateConfiguration = CertificateConfiguration'{_ccCertificateType
                                                             :: CertificateType}
...
certificateConfiguration
    :: CertificateType -- ^ 'ccCertificateType'
    -> CertificateConfiguration
certificateConfiguration pCertificateType_
  = CertificateConfiguration'{_ccCertificateType =
                                pCertificateType_}
...
instance FromJSON CertificateConfiguration where
        parseJSON
          = withObject "CertificateConfiguration"
              (\ x ->
                 CertificateConfiguration' <$>
                   (x .: "CertificateType"))

instance Hashable CertificateConfiguration where

instance NFData CertificateConfiguration where
