...
instance FromText AcceptanceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AcceptanceType from value: '" <>
        e <> "'. Accepted values: accept, reject"
...
instance FromText BuildStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BuildStatus from value: '" <>
        e <> "'. Accepted values: failed, initialized, ready"
...
instance FromText ComparisonOperatorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ComparisonOperatorType from value: '" <>
        e <>
...
instance FromText EC2InstanceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EC2InstanceType from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      "fleet_activation_failed_no_instances" ->
        pure FleetActivationFailedNoInstances
      ...
      "fleet_validation_launch_path_not_found" ->
        pure FleetValidationLaunchPathNotFound
      ...
      "server_process_process_exit_timeout" ->
        pure ServerProcessProcessExitTimeout
      "server_process_process_ready_timeout" ->
        pure ServerProcessProcessReadyTimeout
      "server_process_sdk_initialization_timeout" ->
        pure ServerProcessSDKInitializationTimeout
      "server_process_terminated_unhealthy" ->
        pure ServerProcessTerminatedUnhealthy
      e ->
        fromTextError $
...
instance FromText FleetAction where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetAction from value: '" <>
        e <> "'. Accepted values: auto_scaling"
...
instance FromText FleetStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FleetStatus from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: on_demand, spot"
...
instance FromText GameSessionPlacementState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GameSessionPlacementState from value: '" <>
        e <> "'. Accepted values: cancelled, fulfilled, pending, timed_out"
...
instance FromText GameSessionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GameSessionStatus from value: '" <>
        e <>
...
instance FromText GameSessionStatusReason where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GameSessionStatusReason from value: '" <>
        e <> "'. Accepted values: interrupted"
...
instance FromText IPProtocol where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing IPProtocol from value: '" <>
        e <> "'. Accepted values: tcp, udp"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: active, pending, terminating"
...
instance FromText MatchmakingConfigurationStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MatchmakingConfigurationStatus from value: '" <>
        e <>
...
instance FromText MetricName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MetricName from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: amazon_linux, windows_2012"
...
instance FromText PlayerSessionCreationPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PlayerSessionCreationPolicy from value: '" <>
        e <> "'. Accepted values: accept_all, deny_all"
...
instance FromText PlayerSessionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PlayerSessionStatus from value: '" <>
        e <> "'. Accepted values: active, completed, reserved, timedout"
...
instance FromText PolicyType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PolicyType from value: '" <>
        e <> "'. Accepted values: rulebased, targetbased"
...
instance FromText ProtectionPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProtectionPolicy from value: '" <>
        e <> "'. Accepted values: fullprotection, noprotection"
...
instance FromText RoutingStrategyType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RoutingStrategyType from value: '" <>
        e <> "'. Accepted values: simple, terminal"
...
instance FromText ScalingAdjustmentType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingAdjustmentType from value: '" <>
        e <>
...
instance FromText ScalingStatusType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingStatusType from value: '" <>
        e <>
