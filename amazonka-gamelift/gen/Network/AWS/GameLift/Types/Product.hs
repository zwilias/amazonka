...
instance FromJSON AWSCredentials where
  parseJSON =
    withObject
      "AWSCredentials"
      (\x ->
         AWSCredentials' <$> (x .:? "SecretAccessKey") <*>
         (x .:? "SessionToken") <*>
         (x .:? "AccessKeyId"))
...
aCreationTime =
  lens _aCreationTime (\s a -> s {_aCreationTime = a}) . mapping _Time

-- | Time stamp indicating when this data object was last modified. Format is a number expressed in Unix time as milliseconds (for example "1469498468.057").
aLastUpdatedTime :: Lens' Alias (Maybe UTCTime)
aLastUpdatedTime =
  lens _aLastUpdatedTime (\s a -> s {_aLastUpdatedTime = a}) . mapping _Time
...
instance FromJSON Alias where
  parseJSON =
    withObject
      "Alias"
      (\x ->
         Alias' <$> (x .:? "CreationTime") <*> (x .:? "LastUpdatedTime") <*>
         (x .:? "AliasId") <*>
         (x .:? "RoutingStrategy") <*>
         (x .:? "Name") <*>
         (x .:? "AliasArn") <*>
...
bCreationTime =
  lens _bCreationTime (\s a -> s {_bCreationTime = a}) . mapping _Time
...
eicTERMINATING =
  lens _eicTERMINATING (\s a -> s {_eicTERMINATING = a}) . mapping _Nat
...
instance FromJSON EC2InstanceCounts where
  parseJSON =
    withObject
      "EC2InstanceCounts"
      (\x ->
         EC2InstanceCounts' <$> (x .:? "IDLE") <*> (x .:? "TERMINATING") <*>
         (x .:? "PENDING") <*>
         (x .:? "MAXIMUM") <*>
         (x .:? "DESIRED") <*>
         (x .:? "MINIMUM") <*>
...
eilEC2InstanceType =
  lens _eilEC2InstanceType (\s a -> s {_eilEC2InstanceType = a})

-- | Number of instances of the specified type that are currently in use by this AWS account.
eilCurrentInstances :: Lens' EC2InstanceLimit (Maybe Natural)
eilCurrentInstances =
  lens _eilCurrentInstances (\s a -> s {_eilCurrentInstances = a}) .
  mapping _Nat

-- | Number of instances allowed.
eilInstanceLimit :: Lens' EC2InstanceLimit (Maybe Natural)
eilInstanceLimit =
  lens _eilInstanceLimit (\s a -> s {_eilInstanceLimit = a}) . mapping _Nat
...
instance FromJSON EC2InstanceLimit where
  parseJSON =
    withObject
      "EC2InstanceLimit"
      (\x ->
         EC2InstanceLimit' <$> (x .:? "EC2InstanceType") <*>
         (x .:? "CurrentInstances") <*>
         (x .:? "InstanceLimit"))
...
instance FromJSON Event where
  parseJSON =
    withObject
      "Event"
      (\x ->
         Event' <$> (x .:? "ResourceId") <*> (x .:? "PreSignedLogUrl") <*>
         (x .:? "EventTime") <*>
         (x .:? "Message") <*>
         (x .:? "EventCode") <*>
         (x .:? "EventId"))
...
faCreationTime =
  lens _faCreationTime (\s a -> s {_faCreationTime = a}) . mapping _Time
...
faServerLaunchParameters =
  lens _faServerLaunchParameters (\s a -> s {_faServerLaunchParameters = a})
...
faTerminationTime =
  lens _faTerminationTime (\s a -> s {_faTerminationTime = a}) . mapping _Time
...
faStoppedActions =
  lens _faStoppedActions (\s a -> s {_faStoppedActions = a}) . mapping _List1
...
faNewGameSessionProtectionPolicy ::
     Lens' FleetAttributes (Maybe ProtectionPolicy)
faNewGameSessionProtectionPolicy =
  lens
    _faNewGameSessionProtectionPolicy
    (\s a -> s {_faNewGameSessionProtectionPolicy = a})
...
faServerLaunchPath =
  lens _faServerLaunchPath (\s a -> s {_faServerLaunchPath = a})

-- | Names of metric groups that this fleet is included in. In Amazon CloudWatch, you can view metrics for an individual fleet or aggregated metrics for fleets that are in a fleet metric group. A fleet can be included in only one metric group at a time.
faMetricGroups :: Lens' FleetAttributes [Text]
faMetricGroups =
  lens _faMetricGroups (\s a -> s {_faMetricGroups = a}) . _Default . _Coerce
...
faResourceCreationLimitPolicy ::
     Lens' FleetAttributes (Maybe ResourceCreationLimitPolicy)
faResourceCreationLimitPolicy =
  lens
    _faResourceCreationLimitPolicy
    (\s a -> s {_faResourceCreationLimitPolicy = a})
...
instance FromJSON FleetAttributes where
  parseJSON =
    withObject
      "FleetAttributes"
      (\x ->
         FleetAttributes' <$> (x .:? "CreationTime") <*> (x .:? "Status") <*>
...
instance FromJSON FleetCapacity where
  parseJSON =
    withObject
      "FleetCapacity"
      (\x ->
         FleetCapacity' <$> (x .:? "InstanceType") <*> (x .:? "FleetId") <*>
         (x .:? "InstanceCounts"))
...
fuActiveGameSessionCount =
  lens _fuActiveGameSessionCount (\s a -> s {_fuActiveGameSessionCount = a}) .
  mapping _Nat
...
fuMaximumPlayerSessionCount =
  lens
    ...
    (\s a -> s {_fuMaximumPlayerSessionCount = a}) .
  mapping _Nat
...
fuCurrentPlayerSessionCount =
  lens
    ...
    (\s a -> s {_fuCurrentPlayerSessionCount = a}) .
  mapping _Nat
...
fuActiveServerProcessCount =
  lens _fuActiveServerProcessCount (\s a -> s {_fuActiveServerProcessCount = a}) .
  mapping _Nat
...
instance FromJSON FleetUtilization where
  parseJSON =
    withObject
      "FleetUtilization"
      (\x ->
         FleetUtilization' <$> (x .:? "ActiveGameSessionCount") <*>
...
instance ToJSON GameProperty where
  toJSON GameProperty' {..} =
    object (catMaybes [Just ("Key" .= _gpKey), Just ("Value" .= _gpValue)])
...
gsCreationTime =
  lens _gsCreationTime (\s a -> s {_gsCreationTime = a}) . mapping _Time
...
gsGameProperties =
  lens _gsGameProperties (\s a -> s {_gsGameProperties = a}) .
  _Default . _Coerce
...
gsMaximumPlayerSessionCount =
  lens
    _gsMaximumPlayerSessionCount
    (\s a -> s {_gsMaximumPlayerSessionCount = a}) .
  mapping _Nat

-- | Time stamp indicating when this data object was terminated. Format is a number expressed in Unix time as milliseconds (for example "1469498468.057").
gsTerminationTime :: Lens' GameSession (Maybe UTCTime)
gsTerminationTime =
  lens _gsTerminationTime (\s a -> s {_gsTerminationTime = a}) . mapping _Time

-- | Indicates whether or not the game session is accepting new players.
gsPlayerSessionCreationPolicy ::
     Lens' GameSession (Maybe PlayerSessionCreationPolicy)
gsPlayerSessionCreationPolicy =
  lens
    _gsPlayerSessionCreationPolicy
    (\s a -> s {_gsPlayerSessionCreationPolicy = a})
...
gsCurrentPlayerSessionCount =
  lens
    _gsCurrentPlayerSessionCount
    (\s a -> s {_gsCurrentPlayerSessionCount = a}) .
  mapping _Nat
...
instance FromJSON GameSession where
  parseJSON =
    withObject
      "GameSession"
      (\x ->
         GameSession' <$> (x .:? "CreationTime") <*> (x .:? "Status") <*>
...
gsciMatchedPlayerSessions ::
     Lens' GameSessionConnectionInfo [MatchedPlayerSession]
gsciMatchedPlayerSessions =
  lens _gsciMatchedPlayerSessions (\s a -> s {_gsciMatchedPlayerSessions = a}) .
  _Default . _Coerce
...
gsciGameSessionARN =
  lens _gsciGameSessionARN (\s a -> s {_gsciGameSessionARN = a})
...
gsdProtectionPolicy =
  lens _gsdProtectionPolicy (\s a -> s {_gsdProtectionPolicy = a})
...
instance FromJSON GameSessionDetail where
  parseJSON =
    withObject
      "GameSessionDetail"
      (\x ->
         GameSessionDetail' <$> (x .:? "GameSession") <*>
         (x .:? "ProtectionPolicy"))
...
gspGameProperties =
  lens _gspGameProperties (\s a -> s {_gspGameProperties = a}) .
  _Default . _Coerce
...
gspGameSessionName =
  lens _gspGameSessionName (\s a -> s {_gspGameSessionName = a})

-- | Time stamp indicating when this request was placed in the queue. Format is a number expressed in Unix time as milliseconds (for example "1469498468.057").
gspStartTime :: Lens' GameSessionPlacement (Maybe UTCTime)
gspStartTime =
  lens _gspStartTime (\s a -> s {_gspStartTime = a}) . mapping _Time
...
gspGameSessionRegion =
  lens _gspGameSessionRegion (\s a -> s {_gspGameSessionRegion = a})
...
gspMaximumPlayerSessionCount =
  lens
    ...
    (\s a -> s {_gspMaximumPlayerSessionCount = a}) .
  mapping _Nat
...
gspPlayerLatencies =
  lens _gspPlayerLatencies (\s a -> s {_gspPlayerLatencies = a}) .
  _Default . _Coerce

-- | Set of custom game session properties, formatted as a single string value. This data is passed to a game server process in the 'GameSession' object with a request to start a new game session (see <http://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-api.html#gamelift-sdk-server-startsession Start a Game Session> ).
gspGameSessionData :: Lens' GameSessionPlacement (Maybe Text)
gspGameSessionData =
  lens _gspGameSessionData (\s a -> s {_gspGameSessionData = a})

-- | Descriptive label that is associated with game session queue. Queue names must be unique within each region.
gspGameSessionQueueName :: Lens' GameSessionPlacement (Maybe Text)
gspGameSessionQueueName =
  lens _gspGameSessionQueueName (\s a -> s {_gspGameSessionQueueName = a})
...
gspPlacedPlayerSessions =
  lens _gspPlacedPlayerSessions (\s a -> s {_gspPlacedPlayerSessions = a}) .
  _Default . _Coerce
...
instance FromJSON GameSessionPlacement where
  parseJSON =
    withObject
      "GameSessionPlacement"
      (\x ->
         GameSessionPlacement' <$> (x .:? "Status") <*> (x .:? "PlacementId") <*>
         (x .:? "GameProperties" .!= mempty) <*>
         (x .:? "IpAddress") <*>
         (x .:? "GameSessionName") <*>
         (x .:? "StartTime") <*>
...
instance FromJSON GameSessionQueue where
  parseJSON =
    withObject
      "GameSessionQueue"
      (\x ->
         GameSessionQueue' <$> (x .:? "GameSessionQueueArn") <*>
...
gsqdDestinationARN =
  lens _gsqdDestinationARN (\s a -> s {_gsqdDestinationARN = a})
...
instance FromJSON IPPermission where
  parseJSON =
    withObject
      "IPPermission"
      (\x ->
         IPPermission' <$> (x .: "FromPort") <*> (x .: "ToPort") <*>
         (x .: "IpRange") <*>
         (x .: "Protocol"))
...
iCreationTime =
  lens _iCreationTime (\s a -> s {_iCreationTime = a}) . mapping _Time
...
instance FromJSON Instance where
  parseJSON =
    withObject
      "Instance"
      (\x ->
         Instance' <$> (x .:? "CreationTime") <*> (x .:? "InstanceId") <*>
         (x .:? "Status") <*>
         (x .:? "IpAddress") <*>
         (x .:? "OperatingSystem") <*>
         (x .:? "Type") <*>
...
iaCredentials =
  lens _iaCredentials (\s a -> s {_iaCredentials = a}) . mapping _Sensitive
...
instance FromJSON InstanceAccess where
  parseJSON =
    withObject
      "InstanceAccess"
      (\x ->
         InstanceAccess' <$> (x .:? "InstanceId") <*> (x .:? "IpAddress") <*>
         (x .:? "OperatingSystem") <*>
         (x .:? "Credentials") <*>
         (x .:? "FleetId"))
...
instance FromJSON InstanceCredentials where
  parseJSON =
    withObject
      "InstanceCredentials"
      (\x -> InstanceCredentials' <$> (x .:? "UserName") <*> (x .:? "Secret"))
...
mpsPlayerSessionId =
  lens _mpsPlayerSessionId (\s a -> s {_mpsPlayerSessionId = a})
...
instance FromJSON MatchedPlayerSession where
  parseJSON =
    withObject
      "MatchedPlayerSession"
      (\x ->
         MatchedPlayerSession' <$> (x .:? "PlayerSessionId") <*>
         (x .:? "PlayerId"))
...
mcCreationTime =
  lens _mcCreationTime (\s a -> s {_mcCreationTime = a}) . mapping _Time

-- | Set of custom properties for a game session, formatted as key:value pairs. These properties are passed to a game server process in the 'GameSession' object with a request to start a new game session (see <http://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-api.html#gamelift-sdk-server-startsession Start a Game Session> ). This information is added to the new 'GameSession' object that is created for a successful match.
mcGameProperties :: Lens' MatchmakingConfiguration [GameProperty]
mcGameProperties =
  lens _mcGameProperties (\s a -> s {_mcGameProperties = a}) .
  _Default . _Coerce
...
mcAcceptanceRequired =
  lens _mcAcceptanceRequired (\s a -> s {_mcAcceptanceRequired = a})
...
mcAdditionalPlayerCount =
  lens _mcAdditionalPlayerCount (\s a -> s {_mcAdditionalPlayerCount = a}) .
  mapping _Nat
...
instance FromJSON MatchmakingConfiguration where
  parseJSON =
    withObject
      "MatchmakingConfiguration"
      (\x ->
         MatchmakingConfiguration' <$> (x .:? "CreationTime") <*>
         (x .:? "GameProperties" .!= mempty) <*>
         (x .:? "RuleSetName") <*>
...
mrsCreationTime =
  lens _mrsCreationTime (\s a -> s {_mrsCreationTime = a}) . mapping _Time
...
instance FromJSON MatchmakingRuleSet where
  parseJSON =
    withObject
      "MatchmakingRuleSet"
      (\x ->
         MatchmakingRuleSet' <$> (x .:? "CreationTime") <*>
         (x .:? "RuleSetName") <*>
         (x .: "RuleSetBody"))
...
mtConfigurationName =
  lens _mtConfigurationName (\s a -> s {_mtConfigurationName = a})
...
mtGameSessionConnectionInfo ::
     Lens' MatchmakingTicket (Maybe GameSessionConnectionInfo)
mtGameSessionConnectionInfo =
  lens
    _mtGameSessionConnectionInfo
    (\s a -> s {_mtGameSessionConnectionInfo = a})
...
mtEstimatedWaitTime =
  lens _mtEstimatedWaitTime (\s a -> s {_mtEstimatedWaitTime = a}) .
  mapping _Nat
...
instance FromJSON MatchmakingTicket where
  parseJSON =
    withObject
      "MatchmakingTicket"
      (\x ->
         MatchmakingTicket' <$> (x .:? "Status") <*> (x .:? "ConfigurationName") <*>
         (x .:? "StartTime") <*>
...
ppsPlayerSessionId =
  lens _ppsPlayerSessionId (\s a -> s {_ppsPlayerSessionId = a})
...
instance FromJSON PlacedPlayerSession where
  parseJSON =
    withObject
      "PlacedPlayerSession"
      (\x ->
         PlacedPlayerSession' <$> (x .:? "PlayerSessionId") <*>
         (x .:? "PlayerId"))
...
pPlayerAttributes =
  lens _pPlayerAttributes (\s a -> s {_pPlayerAttributes = a}) . _Default . _Map
...
pLatencyInMs =
  lens _pLatencyInMs (\s a -> s {_pLatencyInMs = a}) . _Default . _Map
...
instance FromJSON Player where
  parseJSON =
    withObject
      "Player"
      (\x ->
         Player' <$> (x .:? "PlayerAttributes" .!= mempty) <*> (x .:? "Team") <*>
         (x .:? "PlayerId") <*>
...
plLatencyInMilliseconds =
  lens _plLatencyInMilliseconds (\s a -> s {_plLatencyInMilliseconds = a})

-- | Name of the region that is associated with the latency value.
plRegionIdentifier :: Lens' PlayerLatency (Maybe Text)
plRegionIdentifier =
  lens _plRegionIdentifier (\s a -> s {_plRegionIdentifier = a})
...
instance FromJSON PlayerLatency where
  parseJSON =
    withObject
      "PlayerLatency"
      (\x ->
         PlayerLatency' <$> (x .:? "LatencyInMilliseconds") <*>
         (x .:? "RegionIdentifier") <*>
         (x .:? "PlayerId"))
...
plpPolicyDurationSeconds =
  lens _plpPolicyDurationSeconds (\s a -> s {_plpPolicyDurationSeconds = a}) .
  mapping _Nat

-- | The maximum latency value that is allowed for any player, in milliseconds. All policies must have a value set for this property.
plpMaximumIndividualPlayerLatencyMilliseconds ::
     Lens' PlayerLatencyPolicy (Maybe Natural)
plpMaximumIndividualPlayerLatencyMilliseconds =
  lens
    _plpMaximumIndividualPlayerLatencyMilliseconds
    (\s a -> s {_plpMaximumIndividualPlayerLatencyMilliseconds = a}) .
  mapping _Nat
...
instance FromJSON PlayerLatencyPolicy where
  parseJSON =
    withObject
      "PlayerLatencyPolicy"
      (\x ->
         PlayerLatencyPolicy' <$> (x .:? "PolicyDurationSeconds") <*>
...
psCreationTime =
  lens _psCreationTime (\s a -> s {_psCreationTime = a}) . mapping _Time
...
psTerminationTime =
  lens _psTerminationTime (\s a -> s {_psTerminationTime = a}) . mapping _Time
...
instance FromJSON PlayerSession where
  parseJSON =
    withObject
      "PlayerSession"
      (\x ->
         PlayerSession' <$> (x .:? "CreationTime") <*> (x .:? "Status") <*>
         (x .:? "IpAddress") <*>
         (x .:? "GameSessionId") <*>
         (x .:? "TerminationTime") <*>
         (x .:? "PlayerSessionId") <*>
...
rclpNewGameSessionsPerCreator ::
     Lens' ResourceCreationLimitPolicy (Maybe Natural)
rclpNewGameSessionsPerCreator =
  lens
    _rclpNewGameSessionsPerCreator
    (\s a -> s {_rclpNewGameSessionsPerCreator = a}) .
  mapping _Nat

-- | Time span used in evaluating the resource creation limit policy.
rclpPolicyPeriodInMinutes :: Lens' ResourceCreationLimitPolicy (Maybe Natural)
rclpPolicyPeriodInMinutes =
  lens _rclpPolicyPeriodInMinutes (\s a -> s {_rclpPolicyPeriodInMinutes = a}) .
  mapping _Nat
...
instance FromJSON ResourceCreationLimitPolicy where
  parseJSON =
    withObject
      "ResourceCreationLimitPolicy"
      (\x ->
         ResourceCreationLimitPolicy' <$> (x .:? "NewGameSessionsPerCreator") <*>
...
instance ToJSON ResourceCreationLimitPolicy where
  toJSON ResourceCreationLimitPolicy' {..} =
    object
      (catMaybes
         [ ("NewGameSessionsPerCreator" .=) <$> _rclpNewGameSessionsPerCreator
...
instance FromJSON RoutingStrategy where
  parseJSON =
    withObject
      "RoutingStrategy"
      (\x ->
         RoutingStrategy' <$> (x .:? "Type") <*> (x .:? "Message") <*>
         (x .:? "FleetId"))
...
rcGameSessionActivationTimeoutSeconds ::
     Lens' RuntimeConfiguration (Maybe Natural)
rcGameSessionActivationTimeoutSeconds =
  lens
    _rcGameSessionActivationTimeoutSeconds
    (\s a -> s {_rcGameSessionActivationTimeoutSeconds = a}) .
  mapping _Nat

-- | Collection of server process configurations that describe which server processes to run on each instance in a fleet.
rcServerProcesses :: Lens' RuntimeConfiguration (Maybe (NonEmpty ServerProcess))
rcServerProcesses =
  lens _rcServerProcesses (\s a -> s {_rcServerProcesses = a}) . mapping _List1
...
rcMaxConcurrentGameSessionActivations =
  lens
    ...
    (\s a -> s {_rcMaxConcurrentGameSessionActivations = a}) .
  mapping _Nat
...
instance FromJSON RuntimeConfiguration where
  parseJSON =
    withObject
      "RuntimeConfiguration"
      (\x ->
         RuntimeConfiguration' <$> (x .:? "GameSessionActivationTimeoutSeconds") <*>
         (x .:? "ServerProcesses") <*>
...
spScalingAdjustmentType =
  lens _spScalingAdjustmentType (\s a -> s {_spScalingAdjustmentType = a})

-- | Length of time (in minutes) the metric must be at or beyond the threshold before a scaling event is triggered.
spEvaluationPeriods :: Lens' ScalingPolicy (Maybe Natural)
spEvaluationPeriods =
  lens _spEvaluationPeriods (\s a -> s {_spEvaluationPeriods = a}) .
  mapping _Nat
...
spComparisonOperator =
  lens _spComparisonOperator (\s a -> s {_spComparisonOperator = a})
...
spTargetConfiguration =
  lens _spTargetConfiguration (\s a -> s {_spTargetConfiguration = a})
...
instance FromJSON ScalingPolicy where
  parseJSON =
    withObject
      "ScalingPolicy"
      (\x ->
         ScalingPolicy' <$> (x .:? "Status") <*> (x .:? "ScalingAdjustmentType") <*>
         (x .:? "EvaluationPeriods") <*>
         (x .:? "PolicyType") <*>
         (x .:? "MetricName") <*>
...
spConcurrentExecutions =
  lens _spConcurrentExecutions (\s a -> s {_spConcurrentExecutions = a}) . _Nat
...
instance FromJSON ServerProcess where
  parseJSON =
    withObject
      "ServerProcess"
      (\x ->
         ServerProcess' <$> (x .:? "Parameters") <*> (x .: "LaunchPath") <*>
...
vpaCreationTime =
  lens _vpaCreationTime (\s a -> s {_vpaCreationTime = a}) . mapping _Time
...
instance FromJSON VPCPeeringAuthorization where
  parseJSON =
    withObject
      "VPCPeeringAuthorization"
      (\x ->
         VPCPeeringAuthorization' <$> (x .:? "CreationTime") <*>
         (x .:? "PeerVpcId") <*>
...
vpcVPCPeeringConnectionId =
  lens _vpcVPCPeeringConnectionId (\s a -> s {_vpcVPCPeeringConnectionId = a})
...
instance FromJSON VPCPeeringConnectionStatus where
  parseJSON =
    withObject
      "VPCPeeringConnectionStatus"
      (\x ->
         VPCPeeringConnectionStatus' <$> (x .:? "Code") <*> (x .:? "Message"))
