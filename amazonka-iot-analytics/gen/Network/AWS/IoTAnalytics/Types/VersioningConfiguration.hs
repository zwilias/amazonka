...
--
-- * 'vcUnlimited' - If true, unlimited versions of data set contents will be kept.
--
-- * 'vcMaxVersions' - How many versions of data set contents will be kept. The "unlimited" parameter must be false.
