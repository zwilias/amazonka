...
instance FromText DatasetContentState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DatasetContentState from value: '" <>
        e <> "'. Accepted values: creating, failed, succeeded"
...
instance FromText DatasetStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DatasetStatus from value: '" <>
        e <> "'. Accepted values: active, creating, deleting"
...
instance FromText DatastoreStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DatastoreStatus from value: '" <>
        e <> "'. Accepted values: active, creating, deleting"
...
instance FromText LoggingLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoggingLevel from value: '" <>
        e <> "'. Accepted values: error"
...
instance FromText ReprocessingStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ReprocessingStatus from value: '" <>
        e <> "'. Accepted values: cancelled, failed, running, succeeded"
