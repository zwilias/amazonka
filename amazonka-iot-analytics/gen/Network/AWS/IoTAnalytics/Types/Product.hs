...
instance FromJSON AddAttributesActivity where
  parseJSON =
    withObject
      "AddAttributesActivity"
      (\x ->
         AddAttributesActivity' <$> (x .:? "next") <*> (x .: "name") <*>
         (x .:? "attributes" .!= mempty))
...
instance FromJSON BatchPutMessageErrorEntry where
  parseJSON =
    withObject
      "BatchPutMessageErrorEntry"
      (\x ->
         BatchPutMessageErrorEntry' <$> (x .:? "errorCode") <*>
         (x .:? "errorMessage") <*>
         (x .:? "messageId"))
...
cLastUpdateTime =
  lens _cLastUpdateTime (\s a -> s {_cLastUpdateTime = a}) . mapping _Time
...
instance FromJSON Channel where
  parseJSON =
    withObject
      "Channel"
      (\x ->
         Channel' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "arn") <*>
         (x .:? "retentionPeriod") <*>
         (x .:? "name") <*>
         (x .:? "lastUpdateTime"))
...
csCreationTime =
  lens _csCreationTime (\s a -> s {_csCreationTime = a}) . mapping _Time
...
csLastUpdateTime =
  lens _csLastUpdateTime (\s a -> s {_csLastUpdateTime = a}) . mapping _Time
...
instance FromJSON ChannelSummary where
  parseJSON =
    withObject
      "ChannelSummary"
      (\x ->
         ChannelSummary' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "channelName") <*>
         (x .:? "lastUpdateTime"))
...
dCreationTime =
  lens _dCreationTime (\s a -> s {_dCreationTime = a}) . mapping _Time
...
dLastUpdateTime =
  lens _dLastUpdateTime (\s a -> s {_dLastUpdateTime = a}) . mapping _Time
...
instance FromJSON Dataset where
  parseJSON =
    withObject
      "Dataset"
      (\x ->
         Dataset' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "arn") <*>
         (x .:? "actions") <*>
         (x .:? "triggers" .!= mempty) <*>
         (x .:? "name") <*>
...
instance FromJSON DatasetAction where
  parseJSON =
    withObject
      "DatasetAction"
      (\x -> DatasetAction' <$> (x .:? "queryAction") <*> (x .:? "actionName"))
...
instance FromJSON DatasetContentStatus where
  parseJSON =
    withObject
      "DatasetContentStatus"
      (\x -> DatasetContentStatus' <$> (x .:? "state") <*> (x .:? "reason"))
...
instance FromJSON DatasetEntry where
  parseJSON =
    withObject
      "DatasetEntry"
      (\x -> DatasetEntry' <$> (x .:? "entryName") <*> (x .:? "dataURI"))
...
dssCreationTime =
  lens _dssCreationTime (\s a -> s {_dssCreationTime = a}) . mapping _Time
...
dssLastUpdateTime =
  lens _dssLastUpdateTime (\s a -> s {_dssLastUpdateTime = a}) . mapping _Time
...
instance FromJSON DatasetSummary where
  parseJSON =
    withObject
      "DatasetSummary"
      (\x ->
         DatasetSummary' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "datasetName") <*>
         (x .:? "lastUpdateTime"))
...
instance FromJSON DatasetTrigger where
  parseJSON =
    withObject "DatasetTrigger" (\x -> DatasetTrigger' <$> (x .:? "schedule"))
...
instance ToJSON DatasetTrigger where
  toJSON DatasetTrigger' {..} =
    object (catMaybes [("schedule" .=) <$> _dtSchedule])
...
datCreationTime =
  lens _datCreationTime (\s a -> s {_datCreationTime = a}) . mapping _Time
...
datRetentionPeriod =
  lens _datRetentionPeriod (\s a -> s {_datRetentionPeriod = a})
...
datLastUpdateTime =
  lens _datLastUpdateTime (\s a -> s {_datLastUpdateTime = a}) . mapping _Time
...
instance FromJSON Datastore where
  parseJSON =
    withObject
      "Datastore"
      (\x ->
         Datastore' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "arn") <*>
         (x .:? "retentionPeriod") <*>
         (x .:? "name") <*>
         (x .:? "lastUpdateTime"))
...
instance FromJSON DatastoreActivity where
  parseJSON =
    withObject
      "DatastoreActivity"
      (\x -> DatastoreActivity' <$> (x .: "name") <*> (x .: "datastoreName"))
...
instance ToJSON DatastoreActivity where
  toJSON DatastoreActivity' {..} =
    object
      (catMaybes
         [Just ("name" .= _daName), Just ("datastoreName" .= _daDatastoreName)])
...
dsCreationTime =
  lens _dsCreationTime (\s a -> s {_dsCreationTime = a}) . mapping _Time
...
dsLastUpdateTime =
  lens _dsLastUpdateTime (\s a -> s {_dsLastUpdateTime = a}) . mapping _Time
...
instance FromJSON DatastoreSummary where
  parseJSON =
    withObject
      "DatastoreSummary"
      (\x ->
         DatastoreSummary' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "datastoreName") <*>
         (x .:? "lastUpdateTime"))
...
instance FromJSON DeviceRegistryEnrichActivity where
  parseJSON =
    withObject
      "DeviceRegistryEnrichActivity"
      (\x ->
         DeviceRegistryEnrichActivity' <$> (x .:? "next") <*> (x .: "name") <*>
         (x .: "attribute") <*>
         (x .: "thingName") <*>
         (x .: "roleArn"))
...
instance FromJSON DeviceShadowEnrichActivity where
  parseJSON =
    withObject
      "DeviceShadowEnrichActivity"
      (\x ->
         DeviceShadowEnrichActivity' <$> (x .:? "next") <*> (x .: "name") <*>
         (x .: "attribute") <*>
         (x .: "thingName") <*>
         (x .: "roleArn"))
...
instance FromJSON LoggingOptions where
  parseJSON =
    withObject
      "LoggingOptions"
      (\x ->
         LoggingOptions' <$> (x .: "roleArn") <*> (x .: "level") <*>
         (x .: "enabled"))
...
pReprocessingSummaries =
  lens _pReprocessingSummaries (\s a -> s {_pReprocessingSummaries = a}) .
  _Default . _Coerce

-- | The last time the pipeline was updated.
pLastUpdateTime :: Lens' Pipeline (Maybe UTCTime)
pLastUpdateTime =
  lens _pLastUpdateTime (\s a -> s {_pLastUpdateTime = a}) . mapping _Time
...
paSelectAttributes =
  lens _paSelectAttributes (\s a -> s {_paSelectAttributes = a})
...
paDeviceRegistryEnrich ::
     Lens' PipelineActivity (Maybe DeviceRegistryEnrichActivity)
paDeviceRegistryEnrich =
  lens _paDeviceRegistryEnrich (\s a -> s {_paDeviceRegistryEnrich = a})

-- | Removes attributes from a message.
paRemoveAttributes :: Lens' PipelineActivity (Maybe RemoveAttributesActivity)
paRemoveAttributes =
  lens _paRemoveAttributes (\s a -> s {_paRemoveAttributes = a})
...
paDeviceShadowEnrich ::
     Lens' PipelineActivity (Maybe DeviceShadowEnrichActivity)
paDeviceShadowEnrich =
  lens _paDeviceShadowEnrich (\s a -> s {_paDeviceShadowEnrich = a})
...
instance FromJSON PipelineActivity where
  parseJSON =
    withObject
      "PipelineActivity"
      (\x ->
         PipelineActivity' <$> (x .:? "selectAttributes") <*> (x .:? "channel") <*>
         (x .:? "addAttributes") <*>
...
psReprocessingSummaries =
  lens _psReprocessingSummaries (\s a -> s {_psReprocessingSummaries = a}) .
  _Default . _Coerce

-- | When the pipeline was last updated.
psLastUpdateTime :: Lens' PipelineSummary (Maybe UTCTime)
psLastUpdateTime =
  lens _psLastUpdateTime (\s a -> s {_psLastUpdateTime = a}) . mapping _Time
...
instance FromJSON PipelineSummary where
  parseJSON =
    withObject
      "PipelineSummary"
      (\x ->
         PipelineSummary' <$> (x .:? "creationTime") <*> (x .:? "pipelineName") <*>
         (x .:? "reprocessingSummaries" .!= mempty) <*>
         (x .:? "lastUpdateTime"))
...
instance FromJSON RemoveAttributesActivity where
  parseJSON =
    withObject
      "RemoveAttributesActivity"
      (\x ->
         RemoveAttributesActivity' <$> (x .:? "next") <*> (x .: "name") <*>
         (x .: "attributes"))
...
rsCreationTime =
  lens _rsCreationTime (\s a -> s {_rsCreationTime = a}) . mapping _Time
...
instance FromJSON ReprocessingSummary where
  parseJSON =
    withObject
      "ReprocessingSummary"
      (\x ->
         ReprocessingSummary' <$> (x .:? "creationTime") <*> (x .:? "status") <*>
         (x .:? "id"))
...
rpNumberOfDays =
  lens _rpNumberOfDays (\s a -> s {_rpNumberOfDays = a}) . mapping _Nat

instance FromJSON RetentionPeriod where
  parseJSON =
    withObject
      "RetentionPeriod"
      (\x -> RetentionPeriod' <$> (x .:? "unlimited") <*> (x .:? "numberOfDays"))
...
instance FromJSON Schedule where
  parseJSON = withObject "Schedule" (\x -> Schedule' <$> (x .:? "expression"))
...
instance FromJSON SelectAttributesActivity where
  parseJSON =
    withObject
      "SelectAttributesActivity"
      (\x ->
         SelectAttributesActivity' <$> (x .:? "next") <*> (x .: "name") <*>
         (x .: "attributes"))
...
instance ToJSON SqlQueryDatasetAction where
  toJSON SqlQueryDatasetAction' {..} =
    object (catMaybes [Just ("sqlQuery" .= _sqdaSqlQuery)])
