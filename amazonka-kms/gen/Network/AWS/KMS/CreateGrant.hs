...
--
--
-- To create a grant that allows a cryptographic operation only when the request includes a particular <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context encryption context> , use the @Constraints@ parameter. For details, see 'GrantConstraints' .
--
...
--
-- * 'cgConstraints' - Allows a cryptographic operation only when the encryption context matches or includes the encryption context specified in this structure. For more information about encryption context, see <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context Encryption Context> in the /\/AWS Key Management Service Developer Guide\/ / .
--
