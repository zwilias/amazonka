...
data GatewaySummary = GatewaySummary'{_gsARN ::
                                      !(Maybe Text),
                                      _gsName :: !(Maybe Text),
...
gatewaySummary
    :: GatewaySummary
gatewaySummary
  = GatewaySummary'{_gsARN = Nothing,
                    _gsName = Nothing, _gsGatewayGroupARN = Nothing,
...
instance Hashable GatewaySummary where

instance NFData GatewaySummary where
