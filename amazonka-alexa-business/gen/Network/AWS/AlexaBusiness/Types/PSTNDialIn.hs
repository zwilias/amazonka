...
data PSTNDialIn = PSTNDialIn'{_pstndiCountryCode ::
                              !Text,
...
pSTNDialIn
    ...
    -> PSTNDialIn
pSTNDialIn pCountryCode_ pPhoneNumber_
  pOneClickIdDelay_ pOneClickPinDelay_
  = PSTNDialIn'{_pstndiCountryCode = pCountryCode_,
