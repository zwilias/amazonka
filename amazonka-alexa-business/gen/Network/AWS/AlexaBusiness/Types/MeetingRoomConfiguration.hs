...
data MeetingRoomConfiguration = MeetingRoomConfiguration'{_mrcInstantBooking
                                                          ::
                                                          !(Maybe
                                                              InstantBooking),
...
meetingRoomConfiguration
    :: MeetingRoomConfiguration
meetingRoomConfiguration
  = MeetingRoomConfiguration'{_mrcInstantBooking =
                                Nothing,
...
instance FromJSON MeetingRoomConfiguration where
        parseJSON
          = withObject "MeetingRoomConfiguration"
              (\ x ->
                 MeetingRoomConfiguration' <$>
                   (x .:? "InstantBooking") <*>
...
instance Hashable MeetingRoomConfiguration where

instance NFData MeetingRoomConfiguration where
