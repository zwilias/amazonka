...
data DeviceNetworkProfileInfo = DeviceNetworkProfileInfo'{_dnpiCertificateARN
                                                          :: !(Maybe Text),
...
deviceNetworkProfileInfo
    :: DeviceNetworkProfileInfo
deviceNetworkProfileInfo
  = DeviceNetworkProfileInfo'{_dnpiCertificateARN =
                                Nothing,
...
instance FromJSON DeviceNetworkProfileInfo where
        parseJSON
          = withObject "DeviceNetworkProfileInfo"
              (\ x ->
                 DeviceNetworkProfileInfo' <$>
                   (x .:? "CertificateArn") <*>
                     (x .:? "NetworkProfileArn")
...
instance Hashable DeviceNetworkProfileInfo where

instance NFData DeviceNetworkProfileInfo where
