...
instance FromJSON AddressBook where
  parseJSON =
    withObject
      "AddressBook"
      (\x ->
         AddressBook' <$> (x .:? "AddressBookArn") <*> (x .:? "Name") <*>
         (x .:? "Description"))
...
instance FromJSON AddressBookData where
  parseJSON =
    withObject
      "AddressBookData"
      (\x ->
         AddressBookData' <$> (x .:? "AddressBookArn") <*> (x .:? "Name") <*>
         (x .:? "Description"))
...
instance FromJSON Contact where
  parseJSON =
    withObject
      "Contact"
      (\x ->
         Contact' <$> (x .:? "LastName") <*> (x .:? "ContactArn") <*>
         (x .:? "PhoneNumber") <*>
         (x .:? "FirstName") <*>
         (x .:? "DisplayName"))
...
instance FromJSON ContactData where
  parseJSON =
    withObject
      "ContactData"
      (\x ->
         ContactData' <$> (x .:? "LastName") <*> (x .:? "ContactArn") <*>
         (x .:? "PhoneNumber") <*>
         (x .:? "FirstName") <*>
         (x .:? "DisplayName"))
...
dDeviceSerialNumber =
  lens _dDeviceSerialNumber (\s a -> s {_dDeviceSerialNumber = a})
...
instance FromJSON Device where
  parseJSON =
    withObject
      "Device"
      (\x ->
         Device' <$> (x .:? "DeviceStatus") <*> (x .:? "DeviceStatusInfo") <*>
         (x .:? "DeviceArn") <*>
         (x .:? "MacAddress") <*>
         (x .:? "DeviceName") <*>
         (x .:? "RoomArn") <*>
...
ddDeviceStatusInfo =
  lens _ddDeviceStatusInfo (\s a -> s {_ddDeviceStatusInfo = a})
...
ddDeviceSerialNumber =
  lens _ddDeviceSerialNumber (\s a -> s {_ddDeviceSerialNumber = a})
...
instance FromJSON DeviceData where
  parseJSON =
    withObject
      "DeviceData"
      (\x ->
         DeviceData' <$> (x .:? "DeviceStatus") <*> (x .:? "DeviceStatusInfo") <*>
         (x .:? "DeviceArn") <*>
         (x .:? "MacAddress") <*>
         (x .:? "DeviceName") <*>
         (x .:? "RoomArn") <*>
...
dsiDeviceStatusDetails =
  lens _dsiDeviceStatusDetails (\s a -> s {_dsiDeviceStatusDetails = a}) .
  _Default . _Coerce

-- | The latest available information about the connection status of a device.
dsiConnectionStatus :: Lens' DeviceStatusInfo (Maybe ConnectionStatus)
dsiConnectionStatus =
  lens _dsiConnectionStatus (\s a -> s {_dsiConnectionStatus = a})
...
instance FromJSON DeviceStatusInfo where
  parseJSON =
    withObject
      "DeviceStatusInfo"
      (\x ->
         DeviceStatusInfo' <$> (x .:? "DeviceStatusDetails" .!= mempty) <*>
         (x .:? "ConnectionStatus"))
...
instance ToJSON Filter where
  toJSON Filter' {..} =
    object (catMaybes [Just ("Key" .= _fKey), Just ("Values" .= _fValues)])
...
pSetupModeDisabled =
  lens _pSetupModeDisabled (\s a -> s {_pSetupModeDisabled = a})
...
instance FromJSON Profile where
  parseJSON =
    withObject
      "Profile"
      (\x ->
         Profile' <$> (x .:? "SetupModeDisabled") <*> (x .:? "PSTNEnabled") <*>
         (x .:? "DistanceUnit") <*>
         (x .:? "Address") <*>
         (x .:? "ProfileArn") <*>
         (x .:? "WakeWord") <*>
...
instance FromJSON ProfileData where
  parseJSON =
    withObject
      "ProfileData"
      (\x ->
         ProfileData' <$> (x .:? "DistanceUnit") <*> (x .:? "Address") <*>
         (x .:? "ProfileArn") <*>
         (x .:? "WakeWord") <*>
         (x .:? "ProfileName") <*>
         (x .:? "TemperatureUnit") <*>
...
rProviderCalendarId =
  lens _rProviderCalendarId (\s a -> s {_rProviderCalendarId = a})
...
instance FromJSON Room where
  parseJSON =
    withObject
      "Room"
      (\x ->
         Room' <$> (x .:? "ProfileArn") <*> (x .:? "ProviderCalendarId") <*>
         (x .:? "RoomArn") <*>
         (x .:? "RoomName") <*>
         (x .:? "Description"))
...
rdProviderCalendarId =
  lens _rdProviderCalendarId (\s a -> s {_rdProviderCalendarId = a})
...
instance FromJSON RoomData where
  parseJSON =
    withObject
      "RoomData"
      (\x ->
         RoomData' <$> (x .:? "ProfileArn") <*> (x .:? "ProviderCalendarId") <*>
         (x .:? "ProfileName") <*>
         (x .:? "RoomArn") <*>
         (x .:? "RoomName") <*>
         (x .:? "Description"))
...
instance FromJSON RoomSkillParameter where
  parseJSON =
    withObject
      "RoomSkillParameter"
      (\x ->
         RoomSkillParameter' <$> (x .: "ParameterKey") <*>
         (x .: "ParameterValue"))
...
instance FromJSON SkillGroup where
  parseJSON =
    withObject
      "SkillGroup"
      (\x ->
         SkillGroup' <$> (x .:? "SkillGroupArn") <*> (x .:? "Description") <*>
         (x .:? "SkillGroupName"))
...
instance FromJSON SkillGroupData where
  parseJSON =
    withObject
      "SkillGroupData"
      (\x ->
         SkillGroupData' <$> (x .:? "SkillGroupArn") <*> (x .:? "Description") <*>
         (x .:? "SkillGroupName"))
...
instance FromJSON SkillSummary where
  parseJSON =
    withObject
      "SkillSummary"
      (\x ->
         SkillSummary' <$> (x .:? "SkillId") <*> (x .:? "SupportsLinking") <*>
         (x .:? "SkillName"))
...
instance ToJSON Sort where
  toJSON Sort' {..} =
    object (catMaybes [Just ("Key" .= _sKey), Just ("Value" .= _sValue)])
...
udEnrollmentStatus =
  lens _udEnrollmentStatus (\s a -> s {_udEnrollmentStatus = a})
