...
data UpdateInstantBooking = UpdateInstantBooking'{_uibEnabled
                                                  :: !(Maybe Bool),
...
updateInstantBooking
    :: UpdateInstantBooking
updateInstantBooking
  = UpdateInstantBooking'{_uibEnabled = Nothing,
...
instance Hashable UpdateInstantBooking where

instance NFData UpdateInstantBooking where
