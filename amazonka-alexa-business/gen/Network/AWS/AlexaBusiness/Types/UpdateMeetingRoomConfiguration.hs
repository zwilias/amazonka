...
data UpdateMeetingRoomConfiguration = UpdateMeetingRoomConfiguration'{_umrcInstantBooking
                                                                      ::
                                                                      !(Maybe
...
updateMeetingRoomConfiguration
    :: UpdateMeetingRoomConfiguration
updateMeetingRoomConfiguration
  = UpdateMeetingRoomConfiguration'{_umrcInstantBooking
                                      = Nothing,
...
instance NFData UpdateMeetingRoomConfiguration where
