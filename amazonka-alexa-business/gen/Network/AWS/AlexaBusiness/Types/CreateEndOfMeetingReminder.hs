...
data CreateEndOfMeetingReminder = CreateEndOfMeetingReminder'{_ceomrReminderAtMinutes
                                                              :: !(List1 Int),
                                                              _ceomrReminderType
                                                              ::
...
createEndOfMeetingReminder
    :: NonEmpty Int -- ^ 'ceomrReminderAtMinutes'
    -> EndOfMeetingReminderType -- ^ 'ceomrReminderType'
    -> Bool -- ^ 'ceomrEnabled'
    -> CreateEndOfMeetingReminder
createEndOfMeetingReminder pReminderAtMinutes_
  pReminderType_ pEnabled_
  = CreateEndOfMeetingReminder'{_ceomrReminderAtMinutes
...
instance Hashable CreateEndOfMeetingReminder where

instance NFData CreateEndOfMeetingReminder where
