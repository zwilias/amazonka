...
data ConferenceProvider = ConferenceProvider'{_cpMeetingSetting
...
conferenceProvider
    :: ConferenceProvider
conferenceProvider
  = ConferenceProvider'{_cpMeetingSetting = Nothing,
                        _cpARN = Nothing, _cpPSTNDialIn = Nothing,
                        _cpName = Nothing, _cpType = Nothing,
                        _cpIPDialIn = Nothing}
