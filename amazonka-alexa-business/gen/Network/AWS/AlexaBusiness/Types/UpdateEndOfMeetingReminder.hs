...
data UpdateEndOfMeetingReminder = UpdateEndOfMeetingReminder'{_ueomrEnabled
                                                              :: !(Maybe Bool),
...
updateEndOfMeetingReminder
    :: UpdateEndOfMeetingReminder
updateEndOfMeetingReminder
  = UpdateEndOfMeetingReminder'{_ueomrEnabled =
                                  Nothing,
...
instance Hashable UpdateEndOfMeetingReminder where

instance NFData UpdateEndOfMeetingReminder where
