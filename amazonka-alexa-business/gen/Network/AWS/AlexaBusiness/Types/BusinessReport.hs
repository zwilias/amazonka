...
data BusinessReport = BusinessReport'{_brStatus ::
...
businessReport
    :: BusinessReport
businessReport
  = BusinessReport'{_brStatus = Nothing,
                    _brFailureCode = Nothing, _brDeliveryTime = Nothing,
                    _brDownloadURL = Nothing, _brS3Location = Nothing}
