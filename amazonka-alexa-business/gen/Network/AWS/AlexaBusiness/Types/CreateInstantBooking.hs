...
data CreateInstantBooking = CreateInstantBooking'{_cibDurationInMinutes
                                                  :: !Int,
                                                  _cibEnabled :: !Bool}
...
createInstantBooking
    :: Int -- ^ 'cibDurationInMinutes'
    -> Bool -- ^ 'cibEnabled'
    -> CreateInstantBooking
createInstantBooking pDurationInMinutes_ pEnabled_
  = CreateInstantBooking'{_cibDurationInMinutes =
                            pDurationInMinutes_,
...
instance Hashable CreateInstantBooking where

instance NFData CreateInstantBooking where
