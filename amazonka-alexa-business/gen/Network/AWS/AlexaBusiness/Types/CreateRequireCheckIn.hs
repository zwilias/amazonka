...
data CreateRequireCheckIn = CreateRequireCheckIn'{_crciReleaseAfterMinutes
                                                  :: !Int,
                                                  _crciEnabled :: !Bool}
...
createRequireCheckIn
    :: Int -- ^ 'crciReleaseAfterMinutes'
    -> Bool -- ^ 'crciEnabled'
    -> CreateRequireCheckIn
createRequireCheckIn pReleaseAfterMinutes_ pEnabled_
  = CreateRequireCheckIn'{_crciReleaseAfterMinutes =
...
instance Hashable CreateRequireCheckIn where

instance NFData CreateRequireCheckIn where
