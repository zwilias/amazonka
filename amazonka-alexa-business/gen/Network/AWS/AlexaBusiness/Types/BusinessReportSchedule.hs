...
data BusinessReportSchedule = BusinessReportSchedule'{_brsS3KeyPrefix
                                                      :: !(Maybe Text),
...
businessReportSchedule
    :: BusinessReportSchedule
businessReportSchedule
  = BusinessReportSchedule'{_brsS3KeyPrefix = Nothing,
                            _brsLastBusinessReport = Nothing,
                            _brsFormat = Nothing, _brsRecurrence = Nothing,
