...
data Gateway = Gateway'{_gARN :: !(Maybe Text),
                        _gName :: !(Maybe Text),
...
gateway
    :: Gateway
gateway
  = Gateway'{_gARN = Nothing, _gName = Nothing,
             _gGatewayGroupARN = Nothing,
             _gSoftwareVersion = Nothing, _gDescription = Nothing}
...
instance Hashable Gateway where

instance NFData Gateway where
