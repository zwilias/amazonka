...
data EndOfMeetingReminder = EndOfMeetingReminder'{_eomrEnabled
                                                  :: !(Maybe Bool),
...
endOfMeetingReminder
    :: EndOfMeetingReminder
endOfMeetingReminder
  = EndOfMeetingReminder'{_eomrEnabled = Nothing,
...
instance FromJSON EndOfMeetingReminder where
        parseJSON
          = withObject "EndOfMeetingReminder"
              (\ x ->
                 EndOfMeetingReminder' <$>
                   (x .:? "Enabled") <*> (x .:? "ReminderAtMinutes") <*>
                     (x .:? "ReminderType"))

instance Hashable EndOfMeetingReminder where

instance NFData EndOfMeetingReminder where
