...
data GatewayGroupSummary = GatewayGroupSummary'{_ggsARN
                                                :: !(Maybe Text),
                                                _ggsName :: !(Maybe Text),
                                                _ggsDescription ::
                                                !(Maybe Text)}
...
gatewayGroupSummary
    :: GatewayGroupSummary
gatewayGroupSummary
  = GatewayGroupSummary'{_ggsARN = Nothing,
                         _ggsName = Nothing, _ggsDescription = Nothing}
...
instance FromJSON GatewayGroupSummary where
        parseJSON
          = withObject "GatewayGroupSummary"
              (\ x ->
                 GatewayGroupSummary' <$>
                   (x .:? "Arn") <*> (x .:? "Name") <*>
                     (x .:? "Description"))

instance Hashable GatewayGroupSummary where

instance NFData GatewayGroupSummary where
