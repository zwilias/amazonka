...
data NetworkProfileData = NetworkProfileData'{_npdNetworkProfileName
                                              :: !(Maybe Text),
                                              _npdSsid :: !(Maybe Text),
...
networkProfileData
    :: NetworkProfileData
networkProfileData
  = NetworkProfileData'{_npdNetworkProfileName =
                          Nothing,
                        _npdSsid = Nothing, _npdNetworkProfileARN = Nothing,
                        _npdSecurityType = Nothing, _npdEapMethod = Nothing,
...
instance FromJSON NetworkProfileData where
        parseJSON
          = withObject "NetworkProfileData"
              (\ x ->
                 NetworkProfileData' <$>
                   (x .:? "NetworkProfileName") <*> (x .:? "Ssid") <*>
                     (x .:? "NetworkProfileArn")
                     <*> (x .:? "SecurityType")
                     <*> (x .:? "EapMethod")
                     <*> (x .:? "Description")
...
instance Hashable NetworkProfileData where

instance NFData NetworkProfileData where
