...
data CreateMeetingRoomConfiguration = CreateMeetingRoomConfiguration'{_cmrcInstantBooking
                                                                      ::
                                                                      !(Maybe
...
createMeetingRoomConfiguration
    :: CreateMeetingRoomConfiguration
createMeetingRoomConfiguration
  = CreateMeetingRoomConfiguration'{_cmrcInstantBooking
                                      = Nothing,
...
instance NFData CreateMeetingRoomConfiguration where
