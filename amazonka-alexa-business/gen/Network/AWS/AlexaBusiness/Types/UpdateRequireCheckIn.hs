...
data UpdateRequireCheckIn = UpdateRequireCheckIn'{_urciEnabled
                                                  :: !(Maybe Bool),
...
updateRequireCheckIn
    :: UpdateRequireCheckIn
updateRequireCheckIn
  = UpdateRequireCheckIn'{_urciEnabled = Nothing,
...
instance Hashable UpdateRequireCheckIn where

instance NFData UpdateRequireCheckIn where
