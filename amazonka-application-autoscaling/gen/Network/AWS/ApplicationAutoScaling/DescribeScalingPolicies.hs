...
dPolicyNames =
  lens _dPolicyNames (\s a -> s {_dPolicyNames = a}) . _Default . _Coerce
...
dScalableDimension =
  lens _dScalableDimension (\s a -> s {_dScalableDimension = a})
...
drsScalingPolicies =
  lens _drsScalingPolicies (\s a -> s {_drsScalingPolicies = a}) .
  _Default . _Coerce
