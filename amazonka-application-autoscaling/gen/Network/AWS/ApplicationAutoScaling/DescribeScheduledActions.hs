...
dsasScalableDimension =
  lens _dsasScalableDimension (\s a -> s {_dsasScalableDimension = a})
...
dsasScheduledActionNames =
  lens _dsasScheduledActionNames (\s a -> s {_dsasScheduledActionNames = a}) .
  _Default . _Coerce
...
dsasServiceNamespace =
  lens _dsasServiceNamespace (\s a -> s {_dsasServiceNamespace = a})
...
instance AWSRequest DescribeScheduledActions where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeScheduledActionsResponse' <$> (x .?> "NextToken") <*>
...
dsarsScheduledActions ::
     Lens' DescribeScheduledActionsResponse [ScheduledAction]
dsarsScheduledActions =
  lens _dsarsScheduledActions (\s a -> s {_dsarsScheduledActions = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dsarsResponseStatus :: Lens' DescribeScheduledActionsResponse Int
dsarsResponseStatus =
  lens _dsarsResponseStatus (\s a -> s {_dsarsResponseStatus = a})
