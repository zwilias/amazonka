...
desScalableDimension ::
     Lens' DescribeScalingActivities (Maybe ScalableDimension)
desScalableDimension =
  lens _desScalableDimension (\s a -> s {_desScalableDimension = a})
...
desServiceNamespace =
  lens _desServiceNamespace (\s a -> s {_desServiceNamespace = a})
...
instance ToHeaders DescribeScalingActivities where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AnyScaleFrontendService.DescribeScalingActivities" :: ByteString)
...
dsasrsScalingActivities ::
     Lens' DescribeScalingActivitiesResponse [ScalingActivity]
dsasrsScalingActivities =
  lens _dsasrsScalingActivities (\s a -> s {_dsasrsScalingActivities = a}) .
  _Default . _Coerce
...
dsasrsResponseStatus =
  lens _dsasrsResponseStatus (\s a -> s {_dsasrsResponseStatus = a})
