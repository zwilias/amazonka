...
psaScalableDimension =
  lens _psaScalableDimension (\s a -> s {_psaScalableDimension = a})

-- | The date and time for the scheduled action to start.
psaStartTime :: Lens' PutScheduledAction (Maybe UTCTime)
psaStartTime =
  lens _psaStartTime (\s a -> s {_psaStartTime = a}) . mapping _Time
...
psaScalableTargetAction =
  lens _psaScalableTargetAction (\s a -> s {_psaScalableTargetAction = a})
...
psaServiceNamespace =
  lens _psaServiceNamespace (\s a -> s {_psaServiceNamespace = a})

-- | The name of the scheduled action.
psaScheduledActionName :: Lens' PutScheduledAction Text
psaScheduledActionName =
  lens _psaScheduledActionName (\s a -> s {_psaScheduledActionName = a})
...
instance AWSRequest PutScheduledAction where
  ...
  response =
    receiveEmpty (\s h x -> PutScheduledActionResponse' <$> (pure (fromEnum s)))
...
psarsResponseStatus =
  lens _psarsResponseStatus (\s a -> s {_psarsResponseStatus = a})
