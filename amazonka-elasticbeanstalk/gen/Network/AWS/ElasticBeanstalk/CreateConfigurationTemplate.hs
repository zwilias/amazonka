...
cctOptionSettings ::
     Lens' CreateConfigurationTemplate [ConfigurationOptionSetting]
cctOptionSettings =
...
cctSourceConfiguration ::
     Lens' CreateConfigurationTemplate (Maybe SourceConfiguration)
cctSourceConfiguration =
...
instance AWSRequest CreateConfigurationTemplate where
  type Rs CreateConfigurationTemplate = ConfigurationSettingsDescription
  request = postQuery elasticBeanstalk
  response =
    receiveXMLWrapper "CreateConfigurationTemplateResult" (\s h x -> parseXML x)
