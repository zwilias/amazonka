...
demahEnvironmentName ::
     Lens' DescribeEnvironmentManagedActionHistory (Maybe Text)
demahEnvironmentName =
  lens _demahEnvironmentName (\s a -> s {_demahEnvironmentName = a})
...
demahEnvironmentId =
  lens _demahEnvironmentId (\s a -> s {_demahEnvironmentId = a})

instance AWSRequest DescribeEnvironmentManagedActionHistory where
  type Rs DescribeEnvironmentManagedActionHistory = DescribeEnvironmentManagedActionHistoryResponse
...
instance ToQuery DescribeEnvironmentManagedActionHistory where
  toQuery DescribeEnvironmentManagedActionHistory' {..} =
    mconcat
      [ "Action" =: ("DescribeEnvironmentManagedActionHistory" :: ByteString)
...
demahrsManagedActionHistoryItems ::
     Lens' DescribeEnvironmentManagedActionHistoryResponse (Maybe (NonEmpty ManagedActionHistoryItem))
demahrsManagedActionHistoryItems =
  lens
    _demahrsManagedActionHistoryItems
    (\s a -> s {_demahrsManagedActionHistoryItems = a}) .
  mapping _List1

-- | A pagination token that you pass to 'DescribeEnvironmentManagedActionHistory' to get the next page of results.
demahrsNextToken ::
     Lens' DescribeEnvironmentManagedActionHistoryResponse (Maybe Text)
demahrsNextToken = lens _demahrsNextToken (\s a -> s {_demahrsNextToken = a})

-- | -- | The response status code.
demahrsResponseStatus ::
     Lens' DescribeEnvironmentManagedActionHistoryResponse Int
demahrsResponseStatus =
  lens _demahrsResponseStatus (\s a -> s {_demahrsResponseStatus = a})
