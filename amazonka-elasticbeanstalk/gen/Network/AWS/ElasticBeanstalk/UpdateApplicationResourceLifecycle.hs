...
uarlApplicationName =
  lens _uarlApplicationName (\s a -> s {_uarlApplicationName = a})

-- | The lifecycle configuration.
uarlResourceLifecycleConfig ::
     Lens' UpdateApplicationResourceLifecycle ApplicationResourceLifecycleConfig
uarlResourceLifecycleConfig =
  lens
    _uarlResourceLifecycleConfig
    (\s a -> s {_uarlResourceLifecycleConfig = a})

instance AWSRequest UpdateApplicationResourceLifecycle where
  type Rs UpdateApplicationResourceLifecycle = UpdateApplicationResourceLifecycleResponse
...
-- | The name of the application.
uarlrsApplicationName ::
     Lens' UpdateApplicationResourceLifecycleResponse (Maybe Text)
uarlrsApplicationName =
  lens _uarlrsApplicationName (\s a -> s {_uarlrsApplicationName = a})

-- | The lifecycle configuration.
uarlrsResourceLifecycleConfig ::
     Lens' UpdateApplicationResourceLifecycleResponse (Maybe ApplicationResourceLifecycleConfig)
uarlrsResourceLifecycleConfig =
  lens
    _uarlrsResourceLifecycleConfig
    (\s a -> s {_uarlrsResourceLifecycleConfig = a})

-- | -- | The response status code.
uarlrsResponseStatus :: Lens' UpdateApplicationResourceLifecycleResponse Int
uarlrsResponseStatus =
  lens _uarlrsResponseStatus (\s a -> s {_uarlrsResponseStatus = a})
