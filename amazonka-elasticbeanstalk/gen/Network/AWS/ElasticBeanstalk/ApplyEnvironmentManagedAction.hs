...
aemaEnvironmentName =
  lens _aemaEnvironmentName (\s a -> s {_aemaEnvironmentName = a})
...
instance AWSRequest ApplyEnvironmentManagedAction where
  type Rs ApplyEnvironmentManagedAction = ApplyEnvironmentManagedActionResponse
  request = postQuery elasticBeanstalk
  response =
    receiveXMLWrapper
      "ApplyEnvironmentManagedActionResult"
      (\s h x ->
         ApplyEnvironmentManagedActionResponse' <$> (x .@? "Status") <*>
         (x .@? "ActionId") <*>
         (x .@? "ActionDescription") <*>
         (x .@? "ActionType") <*>
         (pure (fromEnum s)))
...
aemarsActionDescription ::
     Lens' ApplyEnvironmentManagedActionResponse (Maybe Text)
aemarsActionDescription =
  lens _aemarsActionDescription (\s a -> s {_aemarsActionDescription = a})

-- | The type of managed action.
aemarsActionType ::
     Lens' ApplyEnvironmentManagedActionResponse (Maybe ActionType)
...
aemarsResponseStatus =
  lens _aemarsResponseStatus (\s a -> s {_aemarsResponseStatus = a})
