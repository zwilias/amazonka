...
caResourceLifecycleConfig ::
     Lens' CreateApplication (Maybe ApplicationResourceLifecycleConfig)
caResourceLifecycleConfig =
  lens _caResourceLifecycleConfig (\s a -> s {_caResourceLifecycleConfig = a})
...
instance AWSRequest CreateApplication where
  ...
  response = receiveXMLWrapper "CreateApplicationResult" (\s h x -> parseXML x)
