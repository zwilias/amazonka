...
data SearchFilter = SearchFilter'{_sfAttribute ::
                                  !(Maybe Text),
...
searchFilter
    :: SearchFilter
searchFilter
  = SearchFilter'{_sfAttribute = Nothing,
                  _sfValues = Nothing, _sfOperator = Nothing}
...
instance Hashable SearchFilter where

instance NFData SearchFilter where
