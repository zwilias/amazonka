...
data SourceBuildInformation = SourceBuildInformation'{_sbiSourceType
                                                      :: !SourceType,
...
sourceBuildInformation
    ...
    -> SourceBuildInformation
sourceBuildInformation pSourceType_
  pSourceRepository_ pSourceLocation_
  = SourceBuildInformation'{_sbiSourceType =
                              pSourceType_,
