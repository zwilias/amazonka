...
data ApplicationDescription = ApplicationDescription'{_adApplicationARN
                                                      :: !(Maybe Text),
                                                      _adVersions ::
                                                      !(Maybe [Text]),
                                                      _adDateUpdated ::
...
applicationDescription
    :: ApplicationDescription
applicationDescription
  = ApplicationDescription'{_adApplicationARN =
                              Nothing,
                            _adVersions = Nothing, _adDateUpdated = Nothing,
