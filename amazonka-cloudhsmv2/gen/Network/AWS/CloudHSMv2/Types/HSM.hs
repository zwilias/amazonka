...
data HSM = HSM'{_hsmStateMessage :: !(Maybe Text),
                ...
                _hsmEniIP :: !(Maybe Text), _hsmHSMId :: !Text}
...
hsm
    ...
    -> HSM
hsm pHSMId_
  = HSM'{_hsmStateMessage = Nothing,
         _hsmState = Nothing, _hsmEniId = Nothing,
         _hsmSubnetId = Nothing,
         _hsmAvailabilityZone = Nothing,
         _hsmClusterId = Nothing, _hsmEniIP = Nothing,
         _hsmHSMId = pHSMId_}
