...
data Search = Search'{_seaExpr :: !(Maybe Text),
                      ...
                      _seaPartial :: !(Maybe Bool), _seaQuery :: !Text}
...
search
    ...
    -> Search
search pQuery_
  = Search'{_seaExpr = Nothing, _seaCursor = Nothing,
            _seaReturn = Nothing, _seaQueryOptions = Nothing,
            _seaFilterQuery = Nothing, _seaSize = Nothing,
            _seaQueryParser = Nothing, _seaStart = Nothing,
            _seaHighlight = Nothing, _seaStats = Nothing,
            _seaSort = Nothing, _seaFacet = Nothing,
            _seaPartial = Nothing, _seaQuery = pQuery_}
...
data SearchResponse = SearchResponse'{_searsStatus ::
                                      !(Maybe SearchStatus),
                                      _searsFacets ::
...
searchResponse pResponseStatus_
  = SearchResponse'{_searsStatus = Nothing,
                    _searsFacets = Nothing, _searsStats = Nothing,
                    _searsHits = Nothing,
