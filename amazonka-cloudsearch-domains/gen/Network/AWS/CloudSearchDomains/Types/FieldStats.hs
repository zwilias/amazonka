...
data FieldStats = FieldStats'{_fsMax ::
                              !(Maybe Text),
                              _fsMean :: !(Maybe Text),
...
fieldStats
    :: FieldStats
fieldStats
  = FieldStats'{_fsMax = Nothing, _fsMean = Nothing,
                _fsCount = Nothing, _fsMissing = Nothing,
                _fsStddev = Nothing, _fsMin = Nothing,
                _fsSumOfSquares = Nothing, _fsSum = Nothing}
