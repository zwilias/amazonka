...
dsElasticsearchConfig =
  lens _dsElasticsearchConfig (\s a -> s {_dsElasticsearchConfig = a})
...
instance FromJSON DataSource where
  parseJSON =
    withObject
      "DataSource"
      (\x ->
         DataSource' <$> (x .:? "serviceRoleArn") <*> (x .:? "dataSourceArn") <*>
         (x .:? "dynamodbConfig") <*>
         (x .:? "name") <*>
         (x .:? "lambdaConfig") <*>
         (x .:? "type") <*>
...
ddscUseCallerCredentials =
  lens _ddscUseCallerCredentials (\s a -> s {_ddscUseCallerCredentials = a})
...
instance FromJSON DynamodbDataSourceConfig where
  parseJSON =
    withObject
      "DynamodbDataSourceConfig"
      (\x ->
         DynamodbDataSourceConfig' <$> (x .:? "useCallerCredentials") <*>
         (x .: "tableName") <*>
         (x .: "awsRegion"))
...
instance FromJSON ElasticsearchDataSourceConfig where
  parseJSON =
    withObject
      "ElasticsearchDataSourceConfig"
      (\x ->
         ElasticsearchDataSourceConfig' <$> (x .: "endpoint") <*>
         (x .: "awsRegion"))
...
gaOpenIdConnectConfig =
  lens _gaOpenIdConnectConfig (\s a -> s {_gaOpenIdConnectConfig = a})
...
gaAuthenticationType =
  lens _gaAuthenticationType (\s a -> s {_gaAuthenticationType = a})
...
ldscLambdaFunctionARN =
  lens _ldscLambdaFunctionARN (\s a -> s {_ldscLambdaFunctionARN = a})
...
instance ToJSON LambdaDataSourceConfig where
  toJSON LambdaDataSourceConfig' {..} =
    object (catMaybes [Just ("lambdaFunctionArn" .= _ldscLambdaFunctionARN)])
...
lcCloudWatchLogsRoleARN =
  lens _lcCloudWatchLogsRoleARN (\s a -> s {_lcCloudWatchLogsRoleARN = a})
...
instance FromJSON OpenIdConnectConfig where
  parseJSON =
    withObject
      "OpenIdConnectConfig"
      (\x ->
         OpenIdConnectConfig' <$> (x .:? "authTTL") <*> (x .:? "clientId") <*>
         (x .:? "iatTTL") <*>
         (x .: "issuer"))
...
rRequestMappingTemplate =
  lens _rRequestMappingTemplate (\s a -> s {_rRequestMappingTemplate = a})
...
rResponseMappingTemplate =
  lens _rResponseMappingTemplate (\s a -> s {_rResponseMappingTemplate = a})
...
instance FromJSON Resolver where
  parseJSON =
    withObject
      "Resolver"
      (\x ->
         Resolver' <$> (x .:? "typeName") <*> (x .:? "dataSourceName") <*>
...
instance FromJSON Type where
  parseJSON =
    withObject
      "Type"
      (\x ->
         Type' <$> (x .:? "arn") <*> (x .:? "definition") <*> (x .:? "format") <*>
         (x .:? "name") <*>
         (x .:? "description"))
...
upcAppIdClientRegex =
  lens _upcAppIdClientRegex (\s a -> s {_upcAppIdClientRegex = a})
...
instance FromJSON UserPoolConfig where
  parseJSON =
    withObject
      "UserPoolConfig"
      (\x ->
         UserPoolConfig' <$> (x .:? "appIdClientRegex") <*> (x .: "userPoolId") <*>
         (x .: "awsRegion") <*>
         (x .: "defaultAction"))
