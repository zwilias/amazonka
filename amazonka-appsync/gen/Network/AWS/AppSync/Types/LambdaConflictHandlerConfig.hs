...
newtype LambdaConflictHandlerConfig = LambdaConflictHandlerConfig'{_lchcLambdaConflictHandlerARN
                                                                   ::
                                                                   Maybe Text}
...
lambdaConflictHandlerConfig
    :: LambdaConflictHandlerConfig
lambdaConflictHandlerConfig
  = LambdaConflictHandlerConfig'{_lchcLambdaConflictHandlerARN
                                   = Nothing}
