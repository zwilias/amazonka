...
data DataSource = DataSource'{_dsServiceRoleARN ::
                              !(Maybe Text),
...
dataSource
    :: DataSource
dataSource
  = DataSource'{_dsServiceRoleARN = Nothing,
                _dsRelationalDatabaseConfig = Nothing,
                _dsDataSourceARN = Nothing,
                _dsDynamodbConfig = Nothing, _dsName = Nothing,
                _dsHttpConfig = Nothing, _dsLambdaConfig = Nothing,
                _dsType = Nothing, _dsDescription = Nothing,
