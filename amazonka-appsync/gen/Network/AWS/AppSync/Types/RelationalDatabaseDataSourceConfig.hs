...
data RelationalDatabaseDataSourceConfig = RelationalDatabaseDataSourceConfig'{_rddscRelationalDatabaseSourceType
                                                                              ::
                                                                              !(Maybe
...
relationalDatabaseDataSourceConfig
    :: RelationalDatabaseDataSourceConfig
relationalDatabaseDataSourceConfig
  = RelationalDatabaseDataSourceConfig'{_rddscRelationalDatabaseSourceType
                                          = Nothing,
