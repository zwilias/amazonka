...
data AdditionalAuthenticationProvider = AdditionalAuthenticationProvider'{_aapOpenIdConnectConfig
                                                                          ::
                                                                          !(Maybe
                                                                              OpenIdConnectConfig),
                                                                          _aapUserPoolConfig
...
additionalAuthenticationProvider
    :: AdditionalAuthenticationProvider
additionalAuthenticationProvider
  = AdditionalAuthenticationProvider'{_aapOpenIdConnectConfig
                                        = Nothing,
