...
data Resolver = Resolver'{_rTypeName ::
                          !(Maybe Text),
...
resolver
    :: Resolver
resolver
  = Resolver'{_rTypeName = Nothing,
              _rDataSourceName = Nothing,
              _rRequestMappingTemplate = Nothing, _rKind = Nothing,
              _rResolverARN = Nothing, _rCachingConfig = Nothing,
              _rResponseMappingTemplate = Nothing,
              _rFieldName = Nothing, _rSyncConfig = Nothing,
