...
boAutoDeclineConflictingRequests =
  lens
    ...
    (\s a -> s {_boAutoDeclineConflictingRequests = a})
...
boAutoDeclineRecurringRequests =
  lens
    ...
    (\s a -> s {_boAutoDeclineRecurringRequests = a})

-- | The resource's ability to automatically reply to requests. If disabled, delegates must be associated to the resource.
boAutoAcceptRequests :: Lens' BookingOptions (Maybe Bool)
boAutoAcceptRequests =
  lens _boAutoAcceptRequests (\s a -> s {_boAutoAcceptRequests = a})
...
instance FromJSON BookingOptions where
  parseJSON =
    withObject
      "BookingOptions"
      (\x ->
         BookingOptions' <$> (x .:? "AutoDeclineConflictingRequests") <*>
...
instance FromJSON Delegate where
  parseJSON =
    withObject "Delegate" (\x -> Delegate' <$> (x .: "Id") <*> (x .: "Type"))
...
gDisabledDate =
  lens _gDisabledDate (\s a -> s {_gDisabledDate = a}) . mapping _Time
...
gEnabledDate =
  lens _gEnabledDate (\s a -> s {_gEnabledDate = a}) . mapping _Time
...
mDisabledDate =
  lens _mDisabledDate (\s a -> s {_mDisabledDate = a}) . mapping _Time
...
mEnabledDate =
  lens _mEnabledDate (\s a -> s {_mEnabledDate = a}) . mapping _Time
...
instance FromJSON OrganizationSummary where
  parseJSON =
    withObject
      "OrganizationSummary"
      (\x ->
         OrganizationSummary' <$> (x .:? "State") <*> (x .:? "Alias") <*>
         (x .:? "ErrorMessage") <*>
         (x .:? "OrganizationId"))
...
pPermissionValues =
  lens _pPermissionValues (\s a -> s {_pPermissionValues = a}) . _Coerce
...
instance FromJSON Permission where
  parseJSON =
    withObject
      "Permission"
      (\x ->
         Permission' <$> (x .: "GranteeId") <*> (x .: "GranteeType") <*>
...
rDisabledDate =
  lens _rDisabledDate (\s a -> s {_rDisabledDate = a}) . mapping _Time
...
rEnabledDate =
  lens _rEnabledDate (\s a -> s {_rEnabledDate = a}) . mapping _Time
...
uDisabledDate =
  lens _uDisabledDate (\s a -> s {_uDisabledDate = a}) . mapping _Time
...
uEnabledDate =
  lens _uEnabledDate (\s a -> s {_uEnabledDate = a}) . mapping _Time
