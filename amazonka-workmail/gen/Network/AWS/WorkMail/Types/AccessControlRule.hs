...
data AccessControlRule = AccessControlRule'{_acrEffect
...
accessControlRule
    :: AccessControlRule
accessControlRule
  = AccessControlRule'{_acrEffect = Nothing,
                       _acrUserIds = Nothing, _acrActions = Nothing,
                       _acrDateCreated = Nothing, _acrName = Nothing,
                       _acrNotUserIds = Nothing, _acrDateModified = Nothing,
                       _acrIPRanges = Nothing, _acrNotIPRanges = Nothing,
                       _acrNotActions = Nothing, _acrDescription = Nothing}
...
instance FromJSON AccessControlRule where
        parseJSON
          = withObject "AccessControlRule"
              (\ x ->
                 AccessControlRule' <$>
                   (x .:? "Effect") <*> (x .:? "UserIds" .!= mempty) <*>
                     (x .:? "Actions" .!= mempty)
                     <*> (x .:? "DateCreated")
                     <*> (x .:? "Name")
                     <*> (x .:? "NotUserIds" .!= mempty)
...
instance Hashable AccessControlRule where

instance NFData AccessControlRule where
