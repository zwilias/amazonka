...
instance AWSRequest DescribeGroup where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeGroupResponse' <$> (x .?> "Email") <*> (x .?> "State") <*>
         (x .?> "DisabledDate") <*>
         (x .?> "Name") <*>
         (x .?> "GroupId") <*>
         (x .?> "EnabledDate") <*>
...
desrsDisabledDate =
  lens _desrsDisabledDate (\s a -> s {_desrsDisabledDate = a}) . mapping _Time
...
desrsEnabledDate =
  lens _desrsEnabledDate (\s a -> s {_desrsEnabledDate = a}) . mapping _Time
