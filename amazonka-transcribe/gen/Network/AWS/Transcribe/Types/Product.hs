...
instance FromJSON Media where
  parseJSON = withObject "Media" (\x -> Media' <$> (x .:? "MediaFileUri"))
...
sMaxSpeakerLabels =
  lens _sMaxSpeakerLabels (\s a -> s {_sMaxSpeakerLabels = a}) . mapping _Nat
...
sShowSpeakerLabels =
  lens _sShowSpeakerLabels (\s a -> s {_sShowSpeakerLabels = a})
...
instance FromJSON Settings where
  parseJSON =
    withObject
      "Settings"
      (\x ->
         Settings' <$> (x .:? "VocabularyName") <*> (x .:? "MaxSpeakerLabels") <*>
         (x .:? "ShowSpeakerLabels"))
...
tTranscriptFileURI =
  lens _tTranscriptFileURI (\s a -> s {_tTranscriptFileURI = a})

instance FromJSON Transcript where
  parseJSON =
    withObject "Transcript" (\x -> Transcript' <$> (x .:? "TranscriptFileUri"))
...
tjCreationTime =
  lens _tjCreationTime (\s a -> s {_tjCreationTime = a}) . mapping _Time
...
tjCompletionTime =
  lens _tjCompletionTime (\s a -> s {_tjCompletionTime = a}) . mapping _Time
...
tjTranscriptionJobStatus ::
     Lens' TranscriptionJob (Maybe TranscriptionJobStatus)
tjTranscriptionJobStatus =
  lens _tjTranscriptionJobStatus (\s a -> s {_tjTranscriptionJobStatus = a})

-- | A name to identify the transcription job.
tjTranscriptionJobName :: Lens' TranscriptionJob (Maybe Text)
tjTranscriptionJobName =
  lens _tjTranscriptionJobName (\s a -> s {_tjTranscriptionJobName = a})
...
tjMediaSampleRateHertz =
  lens _tjMediaSampleRateHertz (\s a -> s {_tjMediaSampleRateHertz = a}) .
  mapping _Nat
...
instance FromJSON TranscriptionJob where
  parseJSON =
    withObject
      "TranscriptionJob"
      (\x ->
         TranscriptionJob' <$> (x .:? "CreationTime") <*>
         (x .:? "FailureReason") <*>
         (x .:? "LanguageCode") <*>
         (x .:? "Settings") <*>
         (x .:? "CompletionTime") <*>
...
tjsCreationTime =
  lens _tjsCreationTime (\s a -> s {_tjsCreationTime = a}) . mapping _Time
...
tjsCompletionTime =
  lens _tjsCompletionTime (\s a -> s {_tjsCompletionTime = a}) . mapping _Time

-- | The status of the transcription job. When the status is @COMPLETED@ , use the @GetTranscriptionJob@ operation to get the results of the transcription.
tjsTranscriptionJobStatus ::
     Lens' TranscriptionJobSummary (Maybe TranscriptionJobStatus)
tjsTranscriptionJobStatus =
  lens _tjsTranscriptionJobStatus (\s a -> s {_tjsTranscriptionJobStatus = a})
...
tjsTranscriptionJobName =
  lens _tjsTranscriptionJobName (\s a -> s {_tjsTranscriptionJobName = a})
...
instance FromJSON TranscriptionJobSummary where
  parseJSON =
    withObject
      "TranscriptionJobSummary"
      (\x ->
         TranscriptionJobSummary' <$> (x .:? "CreationTime") <*>
         (x .:? "FailureReason") <*>
         (x .:? "LanguageCode") <*>
         (x .:? "CompletionTime") <*>
         (x .:? "TranscriptionJobStatus") <*>
...
viLastModifiedTime =
  lens _viLastModifiedTime (\s a -> s {_viLastModifiedTime = a}) . mapping _Time
...
instance FromJSON VocabularyInfo where
  parseJSON =
    withObject
      "VocabularyInfo"
      (\x ->
         VocabularyInfo' <$> (x .:? "LanguageCode") <*> (x .:? "VocabularyName") <*>
         (x .:? "LastModifiedTime") <*>
         (x .:? "VocabularyState"))
