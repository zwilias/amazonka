...
data VocabularyFilterInfo = VocabularyFilterInfo'{_vfiLanguageCode
                                                  :: !(Maybe LanguageCode),
...
vocabularyFilterInfo
    :: VocabularyFilterInfo
vocabularyFilterInfo
  = VocabularyFilterInfo'{_vfiLanguageCode = Nothing,
...
instance FromJSON VocabularyFilterInfo where
        parseJSON
          = withObject "VocabularyFilterInfo"
              (\ x ->
                 VocabularyFilterInfo' <$>
                   (x .:? "LanguageCode") <*> (x .:? "LastModifiedTime")
                     <*> (x .:? "VocabularyFilterName"))

instance Hashable VocabularyFilterInfo where

instance NFData VocabularyFilterInfo where
