...
data MedicalTranscriptionJobSummary = MedicalTranscriptionJobSummary'{_mtjsCreationTime
                                                                      ::
                                                                      !(Maybe
                                                                          POSIX),
                                                                      _mtjsSpecialty
...
medicalTranscriptionJobSummary
    :: MedicalTranscriptionJobSummary
medicalTranscriptionJobSummary
  = MedicalTranscriptionJobSummary'{_mtjsCreationTime =
                                      Nothing,
...
instance FromJSON MedicalTranscriptionJobSummary
         where
        parseJSON
          = withObject "MedicalTranscriptionJobSummary"
              (\ x ->
                 MedicalTranscriptionJobSummary' <$>
...
instance NFData MedicalTranscriptionJobSummary where
