...
--
-- * 'uvfVocabularyFilterName' - The name of the vocabulary filter to update. If you try to update a vocabulary filter with the same name as a previous vocabulary filter you will receive a @ConflictException@ error.
updateVocabularyFilter
