...
newtype HTTPRequestMethodConditionConfig = HTTPRequestMethodConditionConfig'{_httprmccValues
                                                                             ::
                                                                             Maybe
                                                                               [Text]}
...
hTTPRequestMethodConditionConfig
    :: HTTPRequestMethodConditionConfig
hTTPRequestMethodConditionConfig
  = HTTPRequestMethodConditionConfig'{_httprmccValues =
                                        Nothing}
...
instance FromXML HTTPRequestMethodConditionConfig
         where
        parseXML x
          = HTTPRequestMethodConditionConfig' <$>
              (x .@? "Values" .!@ mempty >>=
...
instance ToQuery HTTPRequestMethodConditionConfig
         where
