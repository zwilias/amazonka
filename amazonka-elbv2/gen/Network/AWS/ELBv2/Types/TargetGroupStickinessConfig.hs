...
data TargetGroupStickinessConfig = TargetGroupStickinessConfig'{_tgscEnabled
                                                                ::
                                                                !(Maybe Bool),
...
targetGroupStickinessConfig
    :: TargetGroupStickinessConfig
targetGroupStickinessConfig
  = TargetGroupStickinessConfig'{_tgscEnabled =
                                   Nothing,
...
instance Hashable TargetGroupStickinessConfig where

instance NFData TargetGroupStickinessConfig where
