...
newtype HostHeaderConditionConfig = HostHeaderConditionConfig'{_hhccValues
                                                               :: Maybe [Text]}
...
instance Hashable HostHeaderConditionConfig where

instance NFData HostHeaderConditionConfig where
