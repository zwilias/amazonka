...
newtype QueryStringConditionConfig = QueryStringConditionConfig'{_qsccValues
                                                                 ::
                                                                 Maybe
...
instance Hashable QueryStringConditionConfig where

instance NFData QueryStringConditionConfig where
