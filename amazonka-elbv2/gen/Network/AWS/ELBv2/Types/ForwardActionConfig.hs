...
data ForwardActionConfig = ForwardActionConfig'{_facTargetGroups
...
forwardActionConfig
    :: ForwardActionConfig
forwardActionConfig
  = ForwardActionConfig'{_facTargetGroups = Nothing,
...
instance Hashable ForwardActionConfig where

instance NFData ForwardActionConfig where
