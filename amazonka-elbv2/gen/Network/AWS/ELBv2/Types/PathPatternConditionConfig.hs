...
newtype PathPatternConditionConfig = PathPatternConditionConfig'{_ppccValues
                                                                 ::
                                                                 Maybe [Text]}
...
instance Hashable PathPatternConditionConfig where

instance NFData PathPatternConditionConfig where
