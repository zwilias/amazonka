...
data QueryStringKeyValuePair = QueryStringKeyValuePair'{_qskvpValue
                                                        :: !(Maybe Text),
                                                        _qskvpKey ::
                                                        !(Maybe Text)}
...
queryStringKeyValuePair
    :: QueryStringKeyValuePair
queryStringKeyValuePair
  = QueryStringKeyValuePair'{_qskvpValue = Nothing,
                             _qskvpKey = Nothing}
...
instance Hashable QueryStringKeyValuePair where

instance NFData QueryStringKeyValuePair where

instance ToQuery QueryStringKeyValuePair where
        toQuery QueryStringKeyValuePair'{..}
          = mconcat
              ["Value" =: _qskvpValue, "Key" =: _qskvpKey]
