...
data TargetGroupTuple = TargetGroupTuple'{_tgtWeight
                                          :: !(Maybe Int),
...
targetGroupTuple
    :: TargetGroupTuple
targetGroupTuple
  = TargetGroupTuple'{_tgtWeight = Nothing,
...
instance Hashable TargetGroupTuple where

instance NFData TargetGroupTuple where
