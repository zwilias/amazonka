...
data HTTPHeaderConditionConfig = HTTPHeaderConditionConfig'{_httphccValues
                                                            :: !(Maybe [Text]),
...
hTTPHeaderConditionConfig
    :: HTTPHeaderConditionConfig
hTTPHeaderConditionConfig
  = HTTPHeaderConditionConfig'{_httphccValues =
                                 Nothing,
...
instance Hashable HTTPHeaderConditionConfig where

instance NFData HTTPHeaderConditionConfig where
