...
data AuthenticateCognitoActionConfig = AuthenticateCognitoActionConfig'{_acacAuthenticationRequestExtraParams
                                                                        ::
                                                                        !(Maybe
                                                                            (Map
                                                                               Text
...
authenticateCognitoActionConfig
    ...
    -> AuthenticateCognitoActionConfig
authenticateCognitoActionConfig pUserPoolARN_
  pUserPoolClientId_ pUserPoolDomain_
  = AuthenticateCognitoActionConfig'{_acacAuthenticationRequestExtraParams
                                       = Nothing,
                                     _acacScope = Nothing,
