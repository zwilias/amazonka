...
data AuthenticateOidcActionConfig = AuthenticateOidcActionConfig'{_aoacClientSecret
                                                                  ::
                                                                  !(Maybe Text),
...
authenticateOidcActionConfig
    ...
    -> Text -- ^ 'aoacClientId'
    -> AuthenticateOidcActionConfig
authenticateOidcActionConfig pIssuer_
  pAuthorizationEndpoint_ pTokenEndpoint_
  pUserInfoEndpoint_ pClientId_
  = AuthenticateOidcActionConfig'{_aoacClientSecret =
                                    Nothing,
