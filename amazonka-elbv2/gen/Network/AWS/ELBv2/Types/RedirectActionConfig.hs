...
data RedirectActionConfig = RedirectActionConfig'{_racPath
                                                  :: !(Maybe Text),
...
redirectActionConfig pStatusCode_
  = RedirectActionConfig'{_racPath = Nothing,
                          _racProtocol = Nothing, _racQuery = Nothing,
                          _racHost = Nothing, _racPort = Nothing,
