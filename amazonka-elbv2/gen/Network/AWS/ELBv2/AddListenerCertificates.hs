...
alcCertificates =
  lens _alcCertificates (\s a -> s {_alcCertificates = a}) . _Coerce
...
alcrsCertificates =
  lens _alcrsCertificates (\s a -> s {_alcrsCertificates = a}) .
  _Default . _Coerce

-- | -- | The response status code.
alcrsResponseStatus :: Lens' AddListenerCertificatesResponse Int
alcrsResponseStatus =
  lens _alcrsResponseStatus (\s a -> s {_alcrsResponseStatus = a})
