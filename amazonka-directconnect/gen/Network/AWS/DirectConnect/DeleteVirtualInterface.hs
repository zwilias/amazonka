...
newtype DeleteVirtualInterface = DeleteVirtualInterface'{_delVirtualInterfaceId
                                                         :: Text}
...
deleteVirtualInterface pVirtualInterfaceId_
  = DeleteVirtualInterface'{_delVirtualInterfaceId =
...
data DeleteVirtualInterfaceResponse = DeleteVirtualInterfaceResponse'{_dvirsVirtualInterfaceState
                                                                      ::
                                                                      !(Maybe
                                                                          VirtualInterfaceState),
                                                                      _dvirsResponseStatus
                                                                      :: !Int}
...
deleteVirtualInterfaceResponse pResponseStatus_
  = DeleteVirtualInterfaceResponse'{_dvirsVirtualInterfaceState
                                      = Nothing,
