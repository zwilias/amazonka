...
instance FromJSON BGPPeer where
  parseJSON =
    withObject
      "BGPPeer"
      (\x ->
         BGPPeer' <$> (x .:? "customerAddress") <*> (x .:? "amazonAddress") <*>
         (x .:? "addressFamily") <*>
         (x .:? "bgpStatus") <*>
         (x .:? "asn") <*>
         (x .:? "authKey") <*>
...
cLoaIssueTime =
  lens _cLoaIssueTime (\s a -> s {_cLoaIssueTime = a}) . mapping _Time
...
cConnections =
  lens _cConnections (\s a -> s {_cConnections = a}) . _Default . _Coerce
...
dcgDirectConnectGatewayId =
  lens _dcgDirectConnectGatewayId (\s a -> s {_dcgDirectConnectGatewayId = a})

-- | Undocumented member.
dcgStateChangeError :: Lens' DirectConnectGateway (Maybe Text)
dcgStateChangeError =
  lens _dcgStateChangeError (\s a -> s {_dcgStateChangeError = a})
...
dcgDirectConnectGatewayName =
  lens
    ...
    (\s a -> s {_dcgDirectConnectGatewayName = a})

-- | Undocumented member.
dcgDirectConnectGatewayState ::
     Lens' DirectConnectGateway (Maybe DirectConnectGatewayState)
dcgDirectConnectGatewayState =
  lens
    _dcgDirectConnectGatewayState
    (\s a -> s {_dcgDirectConnectGatewayState = a})
...
instance FromJSON DirectConnectGateway where
  parseJSON =
    withObject
      "DirectConnectGateway"
      (\x ->
         DirectConnectGateway' <$> (x .:? "directConnectGatewayId") <*>
         (x .:? "stateChangeError") <*>
         (x .:? "amazonSideAsn") <*>
...
dcgaVirtualGatewayId =
  lens _dcgaVirtualGatewayId (\s a -> s {_dcgaVirtualGatewayId = a})

-- | Undocumented member.
dcgaDirectConnectGatewayId :: Lens' DirectConnectGatewayAssociation (Maybe Text)
dcgaDirectConnectGatewayId =
  lens _dcgaDirectConnectGatewayId (\s a -> s {_dcgaDirectConnectGatewayId = a})

-- | The AWS account ID of the owner of the virtual private gateway.
dcgaVirtualGatewayOwnerAccount ::
     Lens' DirectConnectGatewayAssociation (Maybe Text)
dcgaVirtualGatewayOwnerAccount =
  lens
    _dcgaVirtualGatewayOwnerAccount
    (\s a -> s {_dcgaVirtualGatewayOwnerAccount = a})

-- | Undocumented member.
dcgaStateChangeError :: Lens' DirectConnectGatewayAssociation (Maybe Text)
dcgaStateChangeError =
  lens _dcgaStateChangeError (\s a -> s {_dcgaStateChangeError = a})

-- | Undocumented member.
dcgaVirtualGatewayRegion :: Lens' DirectConnectGatewayAssociation (Maybe Text)
dcgaVirtualGatewayRegion =
  lens _dcgaVirtualGatewayRegion (\s a -> s {_dcgaVirtualGatewayRegion = a})

-- | Undocumented member.
dcgaAssociationState ::
     Lens' DirectConnectGatewayAssociation (Maybe DirectConnectGatewayAssociationState)
dcgaAssociationState =
  lens _dcgaAssociationState (\s a -> s {_dcgaAssociationState = a})
...
instance FromJSON DirectConnectGatewayAssociation where
  parseJSON =
    withObject
      "DirectConnectGatewayAssociation"
      (\x ->
         DirectConnectGatewayAssociation' <$> (x .:? "virtualGatewayId") <*>
...
dDirectConnectGatewayId =
  lens _dDirectConnectGatewayId (\s a -> s {_dDirectConnectGatewayId = a})

-- | Undocumented member.
dAttachmentState ::
     Lens' DirectConnectGatewayAttachment (Maybe DirectConnectGatewayAttachmentState)
...
dVirtualInterfaceRegion =
  lens _dVirtualInterfaceRegion (\s a -> s {_dVirtualInterfaceRegion = a})

-- | The AWS account ID of the owner of the virtual interface.
dVirtualInterfaceOwnerAccount ::
     Lens' DirectConnectGatewayAttachment (Maybe Text)
dVirtualInterfaceOwnerAccount =
  lens
    _dVirtualInterfaceOwnerAccount
    (\s a -> s {_dVirtualInterfaceOwnerAccount = a})

-- | Undocumented member.
dVirtualInterfaceId :: Lens' DirectConnectGatewayAttachment (Maybe Text)
dVirtualInterfaceId =
  lens _dVirtualInterfaceId (\s a -> s {_dVirtualInterfaceId = a})
...
instance FromJSON DirectConnectGatewayAttachment where
  parseJSON =
    withObject
      "DirectConnectGatewayAttachment"
      (\x ->
         DirectConnectGatewayAttachment' <$> (x .:? "directConnectGatewayId") <*>
         (x .:? "attachmentState") <*>
         (x .:? "stateChangeError") <*>
...
iLoaIssueTime =
  lens _iLoaIssueTime (\s a -> s {_iLoaIssueTime = a}) . mapping _Time
...
instance FromJSON Interconnect where
  parseJSON =
    withObject
      "Interconnect"
      (\x ->
         Interconnect' <$> (x .:? "lagId") <*> (x .:? "interconnectId") <*>
         (x .:? "location") <*>
         (x .:? "interconnectName") <*>
         (x .:? "awsDevice") <*>
         (x .:? "loaIssueTime") <*>
...
lagConnectionsBandwidth =
  lens _lagConnectionsBandwidth (\s a -> s {_lagConnectionsBandwidth = a})
...
lagConnections =
  lens _lagConnections (\s a -> s {_lagConnections = a}) . _Default . _Coerce
...
lagAllowsHostedConnections =
  lens _lagAllowsHostedConnections (\s a -> s {_lagAllowsHostedConnections = a})

-- | The number of physical connections bundled by the LAG, up to a maximum of 10.
lagNumberOfConnections :: Lens' Lag (Maybe Int)
lagNumberOfConnections =
  lens _lagNumberOfConnections (\s a -> s {_lagNumberOfConnections = a})
...
instance FromJSON Lag where
  parseJSON =
    withObject
      "Lag"
      (\x ->
         Lag' <$> (x .:? "lagId") <*> (x .:? "connectionsBandwidth") <*>
         (x .:? "minimumLinks") <*>
         (x .:? "lagName") <*>
         (x .:? "location") <*>
...
instance FromJSON Location where
  parseJSON =
    withObject
      "Location"
      (\x -> Location' <$> (x .:? "locationName") <*> (x .:? "locationCode"))
...
nbpCustomerAddress =
  lens _nbpCustomerAddress (\s a -> s {_nbpCustomerAddress = a})
...
nDirectConnectGatewayId =
  lens _nDirectConnectGatewayId (\s a -> s {_nDirectConnectGatewayId = a})
...
nVirtualInterfaceName =
  lens _nVirtualInterfaceName (\s a -> s {_nVirtualInterfaceName = a})
...
-- | Undocumented member.
npviaAddressFamily ::
     Lens' NewPrivateVirtualInterfaceAllocation (Maybe AddressFamily)
npviaAddressFamily =
  lens _npviaAddressFamily (\s a -> s {_npviaAddressFamily = a})
...
npviaVirtualInterfaceName =
  lens _npviaVirtualInterfaceName (\s a -> s {_npviaVirtualInterfaceName = a})
...
npviVirtualInterfaceName =
  lens _npviVirtualInterfaceName (\s a -> s {_npviVirtualInterfaceName = a})
...
newRouteFilterPrefixes ::
     Lens' NewPublicVirtualInterfaceAllocation [RouteFilterPrefix]
newRouteFilterPrefixes =
  lens _newRouteFilterPrefixes (\s a -> s {_newRouteFilterPrefixes = a}) .
  _Default . _Coerce

-- | Undocumented member.
newCustomerAddress :: Lens' NewPublicVirtualInterfaceAllocation (Maybe Text)
newCustomerAddress =
  lens _newCustomerAddress (\s a -> s {_newCustomerAddress = a})
...
-- | Undocumented member.
newAddressFamily ::
     Lens' NewPublicVirtualInterfaceAllocation (Maybe AddressFamily)
...
newVirtualInterfaceName =
  lens _newVirtualInterfaceName (\s a -> s {_newVirtualInterfaceName = a})
...
instance FromJSON RouteFilterPrefix where
  parseJSON =
    withObject "RouteFilterPrefix" (\x -> RouteFilterPrefix' <$> (x .:? "cidr"))
...
instance ToJSON RouteFilterPrefix where
  toJSON RouteFilterPrefix' {..} = object (catMaybes [("cidr" .=) <$> _rfpCidr])
...
instance FromJSON VirtualGateway where
  parseJSON =
    withObject
      "VirtualGateway"
      (\x ->
         VirtualGateway' <$> (x .:? "virtualGatewayId") <*>
...
viDirectConnectGatewayId =
  lens _viDirectConnectGatewayId (\s a -> s {_viDirectConnectGatewayId = a})
...
instance FromJSON VirtualInterface where
  parseJSON =
    withObject
      "VirtualInterface"
      (\x ->
         VirtualInterface' <$> (x .:? "bgpPeers" .!= mempty) <*>
         (x .:? "virtualGatewayId") <*>
