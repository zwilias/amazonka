...
instance Hashable AssociatedGateway where

instance NFData AssociatedGateway where
...
data DirectConnectGatewayAssociation =
  DirectConnectGatewayAssociation'
    ...
    , _dcgaAssociatedGateway :: !(Maybe AssociatedGateway)
    , _dcgaDirectConnectGatewayOwnerAccount :: !(Maybe Text)
    , _dcgaAllowedPrefixesToDirectConnectGateway :: !(Maybe [RouteFilterPrefix])
...
data DirectConnectGatewayAssociationProposal =
  DirectConnectGatewayAssociationProposal'
    { _dcgapExistingAllowedPrefixesToDirectConnectGateway :: !(Maybe [RouteFilterPrefix])
    , _dcgapDirectConnectGatewayId :: !(Maybe Text)
    , _dcgapProposalId :: !(Maybe Text)
    , _dcgapAssociatedGateway :: !(Maybe AssociatedGateway)
    , _dcgapProposalState :: !(Maybe DirectConnectGatewayAssociationProposalState)
    , _dcgapDirectConnectGatewayOwnerAccount :: !(Maybe Text)
    , _dcgapRequestedAllowedPrefixesToDirectConnectGateway :: !(Maybe [RouteFilterPrefix])
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
directConnectGatewayAssociationProposal =
  DirectConnectGatewayAssociationProposal'
    { _dcgapExistingAllowedPrefixesToDirectConnectGateway = Nothing
    ...
    , _dcgapRequestedAllowedPrefixesToDirectConnectGateway = Nothing
    }
...
data DirectConnectGatewayAttachment =
  DirectConnectGatewayAttachment'
    ...
    , _dAttachmentType :: !(Maybe DirectConnectGatewayAttachmentType)
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
data NewTransitVirtualInterface =
  NewTransitVirtualInterface'
    ...
    , _ntviAddressFamily          :: !(Maybe AddressFamily)
    , _ntviDirectConnectGatewayId :: !(Maybe Text)
    , _ntviAsn                    :: !(Maybe Int)
    , _ntviAuthKey                :: !(Maybe Text)
    , _ntviVirtualInterfaceName   :: !(Maybe Text)
...
--
-- * 'ntviVirtualInterfaceName' - The name of the virtual interface assigned by the customer network.
--
...
data NewTransitVirtualInterfaceAllocation =
  NewTransitVirtualInterfaceAllocation'
    { _ntviaMtu                  :: !(Maybe Int)
    , _ntviaCustomerAddress      :: !(Maybe Text)
    , _ntviaVlan                 :: !(Maybe Int)
    , _ntviaAmazonAddress        :: !(Maybe Text)
    , _ntviaAddressFamily        :: !(Maybe AddressFamily)
    , _ntviaAsn                  :: !(Maybe Int)
    , _ntviaAuthKey              :: !(Maybe Text)
    , _ntviaVirtualInterfaceName :: !(Maybe Text)
    , _ntviaTags                 :: !(Maybe (List1 Tag))
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
--
-- * 'ntviaVirtualInterfaceName' - The name of the virtual interface assigned by the customer network.
--
