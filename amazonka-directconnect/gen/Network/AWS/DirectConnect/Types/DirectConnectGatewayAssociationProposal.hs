...
data DirectConnectGatewayAssociationProposal = DirectConnectGatewayAssociationProposal'{_dcgapExistingAllowedPrefixesToDirectConnectGateway
                                                                                        ::
                                                                                        !(Maybe
                                                                                            [RouteFilterPrefix]),
...
directConnectGatewayAssociationProposal
    :: DirectConnectGatewayAssociationProposal
directConnectGatewayAssociationProposal
  = DirectConnectGatewayAssociationProposal'{_dcgapExistingAllowedPrefixesToDirectConnectGateway
                                               = Nothing,
                                             _dcgapDirectConnectGatewayId =
                                               Nothing,
