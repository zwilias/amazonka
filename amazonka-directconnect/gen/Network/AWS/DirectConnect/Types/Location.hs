...
data Location = Location'{_lAvailablePortSpeeds ::
                          !(Maybe [Text]),
...
location
    :: Location
location
  = Location'{_lAvailablePortSpeeds = Nothing,
              _lLocationName = Nothing, _lLocationCode = Nothing,
              _lRegion = Nothing, _lAvailableProviders = Nothing}
