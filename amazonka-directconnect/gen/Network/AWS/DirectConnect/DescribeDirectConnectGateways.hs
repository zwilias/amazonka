...
ddcgDirectConnectGatewayId =
  lens _ddcgDirectConnectGatewayId (\s a -> s {_ddcgDirectConnectGatewayId = a})
...
instance AWSRequest DescribeDirectConnectGateways where
  type Rs DescribeDirectConnectGateways = DescribeDirectConnectGatewaysResponse
...
ddcgrsDirectConnectGateways ::
     Lens' DescribeDirectConnectGatewaysResponse [DirectConnectGateway]
ddcgrsDirectConnectGateways =
  lens
    _ddcgrsDirectConnectGateways
    (\s a -> s {_ddcgrsDirectConnectGateways = a}) .
  _Default . _Coerce
...
ddcgrsResponseStatus =
  lens _ddcgrsResponseStatus (\s a -> s {_ddcgrsResponseStatus = a})
