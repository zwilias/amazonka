...
cdcgaDirectConnectGatewayId =
  lens
    ...
    (\s a -> s {_cdcgaDirectConnectGatewayId = a})
...
cdcgaVirtualGatewayId =
  lens _cdcgaVirtualGatewayId (\s a -> s {_cdcgaVirtualGatewayId = a})

instance AWSRequest CreateDirectConnectGatewayAssociation where
  type Rs CreateDirectConnectGatewayAssociation = CreateDirectConnectGatewayAssociationResponse
...
instance ToHeaders CreateDirectConnectGatewayAssociation where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("OvertureService.CreateDirectConnectGatewayAssociation" :: ByteString)
...
cdcgarsDirectConnectGatewayAssociation ::
     Lens' CreateDirectConnectGatewayAssociationResponse (Maybe DirectConnectGatewayAssociation)
cdcgarsDirectConnectGatewayAssociation =
  lens
    _cdcgarsDirectConnectGatewayAssociation
    (\s a -> s {_cdcgarsDirectConnectGatewayAssociation = a})

-- | -- | The response status code.
cdcgarsResponseStatus :: Lens' CreateDirectConnectGatewayAssociationResponse Int
cdcgarsResponseStatus =
  lens _cdcgarsResponseStatus (\s a -> s {_cdcgarsResponseStatus = a})
