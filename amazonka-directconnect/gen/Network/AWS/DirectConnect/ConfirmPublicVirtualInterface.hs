...
cVirtualInterfaceId =
  lens _cVirtualInterfaceId (\s a -> s {_cVirtualInterfaceId = a})
...
instance ToJSON ConfirmPublicVirtualInterface where
  toJSON ConfirmPublicVirtualInterface' {..} =
    object (catMaybes [Just ("virtualInterfaceId" .= _cVirtualInterfaceId)])
...
-- | Undocumented member.
crsVirtualInterfaceState ::
     Lens' ConfirmPublicVirtualInterfaceResponse (Maybe VirtualInterfaceState)
crsVirtualInterfaceState =
  lens _crsVirtualInterfaceState (\s a -> s {_crsVirtualInterfaceState = a})
