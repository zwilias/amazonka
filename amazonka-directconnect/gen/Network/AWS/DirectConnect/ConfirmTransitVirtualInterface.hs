...
instance AWSRequest ConfirmTransitVirtualInterface
         where
...
instance NFData ConfirmTransitVirtualInterface where

instance ToHeaders ConfirmTransitVirtualInterface
         where
        toHeaders
          = const
              (mconcat
