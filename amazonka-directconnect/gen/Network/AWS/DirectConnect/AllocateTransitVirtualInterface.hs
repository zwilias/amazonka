...
instance AWSRequest AllocateTransitVirtualInterface
         where
...
instance NFData AllocateTransitVirtualInterface where

instance ToHeaders AllocateTransitVirtualInterface
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery AllocateTransitVirtualInterface
         where
