...
data NamedQuery = NamedQuery'{_nqNamedQueryId ::
                              !(Maybe Text),
                              _nqDescription :: !(Maybe Text),
                              _nqWorkGroup :: !(Maybe Text), _nqName :: !Text,
                              _nqDatabase :: !Text, _nqQueryString :: !Text}
...
namedQuery pName_ pDatabase_ pQueryString_
  = NamedQuery'{_nqNamedQueryId = Nothing,
                _nqDescription = Nothing, _nqWorkGroup = Nothing,
                _nqName = pName_, _nqDatabase = pDatabase_,
