...
instance FromJSON ColumnInfo where
  parseJSON =
    withObject
      "ColumnInfo"
      (\x ->
         ColumnInfo' <$> (x .:? "Scale") <*> (x .:? "Precision") <*>
         (x .:? "SchemaName") <*>
         (x .:? "CatalogName") <*>
         (x .:? "CaseSensitive") <*>
         (x .:? "Label") <*>
...
instance FromJSON Datum where
  parseJSON = withObject "Datum" (\x -> Datum' <$> (x .:? "VarCharValue"))
...
ecEncryptionOption =
  lens _ecEncryptionOption (\s a -> s {_ecEncryptionOption = a})
...
instance FromJSON EncryptionConfiguration where
  parseJSON =
    withObject
      "EncryptionConfiguration"
      (\x ->
         EncryptionConfiguration' <$> (x .:? "KmsKey") <*>
         (x .: "EncryptionOption"))
...
instance FromJSON NamedQuery where
  parseJSON =
    withObject
      "NamedQuery"
      (\x ->
         NamedQuery' <$> (x .:? "NamedQueryId") <*> (x .:? "Description") <*>
         (x .: "Name") <*>
         (x .: "Database") <*>
         (x .: "QueryString"))
...
qeQueryExecutionContext =
  lens _qeQueryExecutionContext (\s a -> s {_qeQueryExecutionContext = a})
...
qeResultConfiguration =
  lens _qeResultConfiguration (\s a -> s {_qeResultConfiguration = a})
...
qeQueryExecutionId =
  lens _qeQueryExecutionId (\s a -> s {_qeQueryExecutionId = a})
...
instance FromJSON QueryExecutionContext where
  parseJSON =
    withObject
      "QueryExecutionContext"
      (\x -> QueryExecutionContext' <$> (x .:? "Database"))
...
instance ToJSON QueryExecutionContext where
  toJSON QueryExecutionContext' {..} =
    object (catMaybes [("Database" .=) <$> _qecDatabase])
...
qesEngineExecutionTimeInMillis =
  lens
    ...
    (\s a -> s {_qesEngineExecutionTimeInMillis = a})

-- | The number of bytes in the data that was queried.
qesDataScannedInBytes :: Lens' QueryExecutionStatistics (Maybe Integer)
qesDataScannedInBytes =
  lens _qesDataScannedInBytes (\s a -> s {_qesDataScannedInBytes = a})
...
instance FromJSON QueryExecutionStatistics where
  parseJSON =
    withObject
      "QueryExecutionStatistics"
      (\x ->
         QueryExecutionStatistics' <$> (x .:? "EngineExecutionTimeInMillis") <*>
...
rcEncryptionConfiguration ::
     Lens' ResultConfiguration (Maybe EncryptionConfiguration)
rcEncryptionConfiguration =
  lens _rcEncryptionConfiguration (\s a -> s {_rcEncryptionConfiguration = a})
...
instance FromJSON ResultConfiguration where
  parseJSON =
    withObject
      "ResultConfiguration"
      (\x ->
         ResultConfiguration' <$> (x .:? "EncryptionConfiguration") <*>
         (x .: "OutputLocation"))
...
rsResultSetMetadata =
  lens _rsResultSetMetadata (\s a -> s {_rsResultSetMetadata = a})
...
rsmColumnInfo =
  lens _rsmColumnInfo (\s a -> s {_rsmColumnInfo = a}) . _Default . _Coerce
...
instance FromJSON Row where
  parseJSON = withObject "Row" (\x -> Row' <$> (x .:? "Data" .!= mempty))
...
instance FromJSON UnprocessedNamedQueryId where
  parseJSON =
    withObject
      "UnprocessedNamedQueryId"
      (\x ->
         UnprocessedNamedQueryId' <$> (x .:? "NamedQueryId") <*>
         (x .:? "ErrorCode") <*>
         (x .:? "ErrorMessage"))
...
uqeiQueryExecutionId =
  lens _uqeiQueryExecutionId (\s a -> s {_uqeiQueryExecutionId = a})
...
instance FromJSON UnprocessedQueryExecutionId where
  parseJSON =
    withObject
      "UnprocessedQueryExecutionId"
      (\x ->
         UnprocessedQueryExecutionId' <$> (x .:? "ErrorCode") <*>
         (x .:? "QueryExecutionId") <*>
         (x .:? "ErrorMessage"))
