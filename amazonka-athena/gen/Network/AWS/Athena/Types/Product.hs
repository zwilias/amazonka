...
data QueryExecutionStatistics =
  QueryExecutionStatistics'
    { _qesTotalExecutionTimeInMillis    :: !(Maybe Integer)
    , _qesEngineExecutionTimeInMillis   :: !(Maybe Integer)
    , _qesQueryPlanningTimeInMillis     :: !(Maybe Integer)
    , _qesDataScannedInBytes            :: !(Maybe Integer)
    , _qesQueryQueueTimeInMillis        :: !(Maybe Integer)
    , _qesDataManifestLocation          :: !(Maybe Text)
    , _qesServiceProcessingTimeInMillis :: !(Maybe Integer)
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
queryExecutionStatistics =
  QueryExecutionStatistics'
    { _qesTotalExecutionTimeInMillis = Nothing
...
data WorkGroupConfiguration =
  WorkGroupConfiguration'
    { _wgcRequesterPaysEnabled            :: !(Maybe Bool)
...
data WorkGroupConfigurationUpdates =
  WorkGroupConfigurationUpdates'
    { _wgcuRequesterPaysEnabled :: !(Maybe Bool)
