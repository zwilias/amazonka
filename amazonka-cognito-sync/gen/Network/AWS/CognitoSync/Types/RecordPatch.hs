...
data RecordPatch = RecordPatch'{_rpDeviceLastModifiedDate
                                :: !(Maybe POSIX),
                                _rpValue :: !(Maybe Text), _rpOp :: !Operation,
                                _rpKey :: !Text, _rpSyncCount :: !Integer}
...
recordPatch pOp_ pKey_ pSyncCount_
  = RecordPatch'{_rpDeviceLastModifiedDate = Nothing,
                 _rpValue = Nothing, _rpOp = pOp_, _rpKey = pKey_,
