...
data Dataset = Dataset'{_dLastModifiedDate ::
                        !(Maybe POSIX),
...
dataset
    :: Dataset
dataset
  = Dataset'{_dLastModifiedDate = Nothing,
             _dNumRecords = Nothing, _dDataStorage = Nothing,
             _dDatasetName = Nothing, _dCreationDate = Nothing,
             _dLastModifiedBy = Nothing, _dIdentityId = Nothing}
