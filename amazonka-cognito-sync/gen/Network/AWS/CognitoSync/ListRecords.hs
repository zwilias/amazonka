...
lrrsDatasetDeletedAfterRequestedSyncCount ::
     Lens' ListRecordsResponse (Maybe Bool)
lrrsDatasetDeletedAfterRequestedSyncCount =
  lens
    _lrrsDatasetDeletedAfterRequestedSyncCount
    (\s a -> s {_lrrsDatasetDeletedAfterRequestedSyncCount = a})
...
lrrsRecords =
  lens _lrrsRecords (\s a -> s {_lrrsRecords = a}) . _Default . _Coerce
...
lrrsMergedDatasetNames =
  lens _lrrsMergedDatasetNames (\s a -> s {_lrrsMergedDatasetNames = a}) .
  _Default . _Coerce

-- | A token containing a session ID, identity ID, and expiration.
lrrsSyncSessionToken :: Lens' ListRecordsResponse (Maybe Text)
lrrsSyncSessionToken =
  lens _lrrsSyncSessionToken (\s a -> s {_lrrsSyncSessionToken = a})

-- | The user/device that made the last change to this record.
lrrsLastModifiedBy :: Lens' ListRecordsResponse (Maybe Text)
lrrsLastModifiedBy =
  lens _lrrsLastModifiedBy (\s a -> s {_lrrsLastModifiedBy = a})

-- | Server sync count for this dataset.
lrrsDatasetSyncCount :: Lens' ListRecordsResponse (Maybe Integer)
lrrsDatasetSyncCount =
  lens _lrrsDatasetSyncCount (\s a -> s {_lrrsDatasetSyncCount = a})

-- | -- | The response status code.
lrrsResponseStatus :: Lens' ListRecordsResponse Int
lrrsResponseStatus =
  lens _lrrsResponseStatus (\s a -> s {_lrrsResponseStatus = a})
