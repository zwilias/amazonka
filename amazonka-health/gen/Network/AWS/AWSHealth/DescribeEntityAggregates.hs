...
deaEventARNs =
  lens _deaEventARNs (\s a -> s {_deaEventARNs = a}) . mapping _List1
...
dearsEntityAggregates ::
     Lens' DescribeEntityAggregatesResponse [EntityAggregate]
dearsEntityAggregates =
  lens _dearsEntityAggregates (\s a -> s {_dearsEntityAggregates = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dearsResponseStatus :: Lens' DescribeEntityAggregatesResponse Int
dearsResponseStatus =
  lens _dearsResponseStatus (\s a -> s {_dearsResponseStatus = a})
