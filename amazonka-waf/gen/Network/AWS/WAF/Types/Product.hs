...
instance FromJSON ActivatedRule where
  parseJSON =
    withObject
      "ActivatedRule"
      (\x ->
         ActivatedRule' <$> (x .:? "OverrideAction") <*> (x .:? "Action") <*>
         (x .:? "Type") <*>
         (x .: "Priority") <*>
         (x .: "RuleId"))
...
bmsByteMatchTuples =
  lens _bmsByteMatchTuples (\s a -> s {_bmsByteMatchTuples = a}) . _Coerce
...
instance FromJSON ByteMatchSet where
  parseJSON =
    withObject
      "ByteMatchSet"
      (\x ->
         ByteMatchSet' <$> (x .:? "Name") <*> (x .: "ByteMatchSetId") <*>
...
bmssByteMatchSetId =
  lens _bmssByteMatchSetId (\s a -> s {_bmssByteMatchSetId = a})
...
instance FromJSON ByteMatchSetSummary where
  parseJSON =
    withObject
      "ByteMatchSetSummary"
      (\x -> ByteMatchSetSummary' <$> (x .: "ByteMatchSetId") <*> (x .: "Name"))
...
bmsuByteMatchTuple =
  lens _bmsuByteMatchTuple (\s a -> s {_bmsuByteMatchTuple = a})
...
bmtTargetString =
  lens _bmtTargetString (\s a -> s {_bmtTargetString = a}) . _Base64
...
bmtTextTransformation =
  lens _bmtTextTransformation (\s a -> s {_bmtTextTransformation = a})
...
bmtPositionalConstraint =
  lens _bmtPositionalConstraint (\s a -> s {_bmtPositionalConstraint = a})
...
instance FromJSON ByteMatchTuple where
  parseJSON =
    withObject
      "ByteMatchTuple"
      (\x ->
         ByteMatchTuple' <$> (x .: "FieldToMatch") <*> (x .: "TargetString") <*>
...
instance ToJSON FieldToMatch where
  toJSON FieldToMatch' {..} =
    object (catMaybes [("Data" .=) <$> _ftmData, Just ("Type" .= _ftmType)])
...
instance ToJSON GeoMatchConstraint where
  toJSON GeoMatchConstraint' {..} =
    object (catMaybes [Just ("Type" .= _gmcType), Just ("Value" .= _gmcValue)])
...
gmsGeoMatchConstraints =
  lens _gmsGeoMatchConstraints (\s a -> s {_gmsGeoMatchConstraints = a}) .
  _Coerce
...
instance FromJSON GeoMatchSet where
  parseJSON =
    withObject
      "GeoMatchSet"
      (\x ->
         GeoMatchSet' <$> (x .:? "Name") <*> (x .: "GeoMatchSetId") <*>
...
instance FromJSON GeoMatchSetSummary where
  parseJSON =
    withObject
      "GeoMatchSetSummary"
      (\x -> GeoMatchSetSummary' <$> (x .: "GeoMatchSetId") <*> (x .: "Name"))
...
gmsuGeoMatchConstraint =
  lens _gmsuGeoMatchConstraint (\s a -> s {_gmsuGeoMatchConstraint = a})
...
httprHeaders =
  lens _httprHeaders (\s a -> s {_httprHeaders = a}) . _Default . _Coerce
...
instance FromJSON HTTPRequest where
  parseJSON =
    withObject
      "HTTPRequest"
      (\x ->
         HTTPRequest' <$> (x .:? "HTTPVersion") <*> (x .:? "Country") <*>
         (x .:? "URI") <*>
         (x .:? "Headers" .!= mempty) <*>
         (x .:? "Method") <*>
         (x .:? "ClientIP"))
...
isIPSetDescriptors =
  lens _isIPSetDescriptors (\s a -> s {_isIPSetDescriptors = a}) . _Coerce
...
instance ToJSON IPSetDescriptor where
  toJSON IPSetDescriptor' {..} =
    object (catMaybes [Just ("Type" .= _isdType), Just ("Value" .= _isdValue)])
...
isuIPSetDescriptor =
  lens _isuIPSetDescriptor (\s a -> s {_isuIPSetDescriptor = a})
...
instance FromJSON Predicate where
  parseJSON =
    withObject
      "Predicate"
      (\x ->
         Predicate' <$> (x .: "Negated") <*> (x .: "Type") <*> (x .: "DataId"))
...
rbrMatchPredicates =
  lens _rbrMatchPredicates (\s a -> s {_rbrMatchPredicates = a}) . _Coerce
...
instance FromJSON RateBasedRule where
  parseJSON =
    withObject
      "RateBasedRule"
      (\x ->
         RateBasedRule' <$> (x .:? "MetricName") <*> (x .:? "Name") <*>
         (x .: "RuleId") <*>
...
rmsRegexMatchTuples =
  lens _rmsRegexMatchTuples (\s a -> s {_rmsRegexMatchTuples = a}) .
  _Default . _Coerce

-- | The @RegexMatchSetId@ for a @RegexMatchSet@ . You use @RegexMatchSetId@ to get information about a @RegexMatchSet@ (see 'GetRegexMatchSet' ), update a @RegexMatchSet@ (see 'UpdateRegexMatchSet' ), insert a @RegexMatchSet@ into a @Rule@ or delete one from a @Rule@ (see 'UpdateRule' ), and delete a @RegexMatchSet@ from AWS WAF (see 'DeleteRegexMatchSet' ). @RegexMatchSetId@ is returned by 'CreateRegexMatchSet' and by 'ListRegexMatchSets' .
rmsRegexMatchSetId :: Lens' RegexMatchSet (Maybe Text)
rmsRegexMatchSetId =
  lens _rmsRegexMatchSetId (\s a -> s {_rmsRegexMatchSetId = a})
...
rmssRegexMatchSetId =
  lens _rmssRegexMatchSetId (\s a -> s {_rmssRegexMatchSetId = a})
...
instance FromJSON RegexMatchSetSummary where
  parseJSON =
    withObject
      "RegexMatchSetSummary"
      (\x ->
         RegexMatchSetSummary' <$> (x .: "RegexMatchSetId") <*> (x .: "Name"))
...
rmsuRegexMatchTuple =
  lens _rmsuRegexMatchTuple (\s a -> s {_rmsuRegexMatchTuple = a})
...
rmtTextTransformation =
  lens _rmtTextTransformation (\s a -> s {_rmtTextTransformation = a})

-- | The @RegexPatternSetId@ for a @RegexPatternSet@ . You use @RegexPatternSetId@ to get information about a @RegexPatternSet@ (see 'GetRegexPatternSet' ), update a @RegexPatternSet@ (see 'UpdateRegexPatternSet' ), insert a @RegexPatternSet@ into a @RegexMatchSet@ or delete one from a @RegexMatchSet@ (see 'UpdateRegexMatchSet' ), and delete an @RegexPatternSet@ from AWS WAF (see 'DeleteRegexPatternSet' ). @RegexPatternSetId@ is returned by 'CreateRegexPatternSet' and by 'ListRegexPatternSets' .
rmtRegexPatternSetId :: Lens' RegexMatchTuple Text
rmtRegexPatternSetId =
  lens _rmtRegexPatternSetId (\s a -> s {_rmtRegexPatternSetId = a})
...
instance FromJSON RegexMatchTuple where
  parseJSON =
    withObject
      "RegexMatchTuple"
      (\x ->
         RegexMatchTuple' <$> (x .: "FieldToMatch") <*>
         (x .: "TextTransformation") <*>
         (x .: "RegexPatternSetId"))
...
rpsRegexPatternSetId =
  lens _rpsRegexPatternSetId (\s a -> s {_rpsRegexPatternSetId = a})

-- | Specifies the regular expression (regex) patterns that you want AWS WAF to search for, such as @B[a@]dB[o0]t@ .
rpsRegexPatternStrings :: Lens' RegexPatternSet [Text]
rpsRegexPatternStrings =
  lens _rpsRegexPatternStrings (\s a -> s {_rpsRegexPatternStrings = a}) .
  _Coerce
...
instance FromJSON RegexPatternSet where
  parseJSON =
    withObject
      "RegexPatternSet"
      (\x ->
         RegexPatternSet' <$> (x .:? "Name") <*> (x .: "RegexPatternSetId") <*>
...
rpssRegexPatternSetId =
  lens _rpssRegexPatternSetId (\s a -> s {_rpssRegexPatternSetId = a})
...
instance FromJSON RegexPatternSetSummary where
  parseJSON =
    withObject
      "RegexPatternSetSummary"
      (\x ->
         RegexPatternSetSummary' <$> (x .: "RegexPatternSetId") <*>
         (x .: "Name"))
...
rpsuRegexPatternString =
  lens _rpsuRegexPatternString (\s a -> s {_rpsuRegexPatternString = a})
...
instance FromJSON Rule where
  parseJSON =
    withObject
      "Rule"
      (\x ->
         Rule' <$> (x .:? "MetricName") <*> (x .:? "Name") <*> (x .: "RuleId") <*>
         (x .:? "Predicates" .!= mempty))
...
instance FromJSON RuleGroupSummary where
  parseJSON =
    withObject
      "RuleGroupSummary"
      (\x -> RuleGroupSummary' <$> (x .: "RuleGroupId") <*> (x .: "Name"))
...
shttprRuleWithinRuleGroup =
  lens _shttprRuleWithinRuleGroup (\s a -> s {_shttprRuleWithinRuleGroup = a})
...
shttprTimestamp =
  lens _shttprTimestamp (\s a -> s {_shttprTimestamp = a}) . mapping _Time
...
instance FromJSON SampledHTTPRequest where
  parseJSON =
    withObject
      "SampledHTTPRequest"
      (\x ->
         SampledHTTPRequest' <$> (x .:? "RuleWithinRuleGroup") <*>
         (x .:? "Action") <*>
         (x .:? "Timestamp") <*>
         (x .: "Request") <*>
         (x .: "Weight"))
...
scTextTransformation =
  lens _scTextTransformation (\s a -> s {_scTextTransformation = a})
...
scComparisonOperator =
  lens _scComparisonOperator (\s a -> s {_scComparisonOperator = a})
...
scsSizeConstraintSetId =
  lens _scsSizeConstraintSetId (\s a -> s {_scsSizeConstraintSetId = a})

-- | Specifies the parts of web requests that you want to inspect the size of.
scsSizeConstraints :: Lens' SizeConstraintSet [SizeConstraint]
scsSizeConstraints =
  lens _scsSizeConstraints (\s a -> s {_scsSizeConstraints = a}) . _Coerce
...
instance FromJSON SizeConstraintSet where
  parseJSON =
    withObject
      "SizeConstraintSet"
      (\x ->
         SizeConstraintSet' <$> (x .:? "Name") <*> (x .: "SizeConstraintSetId") <*>
...
scssSizeConstraintSetId =
  lens _scssSizeConstraintSetId (\s a -> s {_scssSizeConstraintSetId = a})
...
instance FromJSON SizeConstraintSetSummary where
  parseJSON =
    withObject
      "SizeConstraintSetSummary"
      (\x ->
         SizeConstraintSetSummary' <$> (x .: "SizeConstraintSetId") <*>
         (x .: "Name"))
...
scsuSizeConstraint =
  lens _scsuSizeConstraint (\s a -> s {_scsuSizeConstraint = a})
...
simsSqlInjectionMatchSetId =
  lens _simsSqlInjectionMatchSetId (\s a -> s {_simsSqlInjectionMatchSetId = a})

-- | Specifies the parts of web requests that you want to inspect for snippets of malicious SQL code.
simsSqlInjectionMatchTuples ::
     Lens' SqlInjectionMatchSet [SqlInjectionMatchTuple]
simsSqlInjectionMatchTuples =
  lens
    _simsSqlInjectionMatchTuples
    (\s a -> s {_simsSqlInjectionMatchTuples = a}) .
  _Coerce
...
simssSqlInjectionMatchSetId =
  lens
    ...
    (\s a -> s {_simssSqlInjectionMatchSetId = a})
...
instance FromJSON SqlInjectionMatchSetSummary where
  parseJSON =
    withObject
      "SqlInjectionMatchSetSummary"
      (\x ->
         SqlInjectionMatchSetSummary' <$> (x .: "SqlInjectionMatchSetId") <*>
         (x .: "Name"))
...
simsuSqlInjectionMatchTuple ::
     Lens' SqlInjectionMatchSetUpdate SqlInjectionMatchTuple
simsuSqlInjectionMatchTuple =
  lens
    _simsuSqlInjectionMatchTuple
    (\s a -> s {_simsuSqlInjectionMatchTuple = a})
...
simtTextTransformation =
  lens _simtTextTransformation (\s a -> s {_simtTextTransformation = a})
...
instance FromJSON SqlInjectionMatchTuple where
  parseJSON =
    withObject
      "SqlInjectionMatchTuple"
      (\x ->
         SqlInjectionMatchTuple' <$> (x .: "FieldToMatch") <*>
         (x .: "TextTransformation"))
...
instance FromJSON SubscribedRuleGroupSummary where
  parseJSON =
    withObject
      "SubscribedRuleGroupSummary"
      (\x ->
         SubscribedRuleGroupSummary' <$> (x .: "RuleGroupId") <*> (x .: "Name") <*>
         (x .: "MetricName"))
...
instance ToJSON TimeWindow where
  toJSON TimeWindow' {..} =
    object
      (catMaybes
         [Just ("StartTime" .= _twStartTime), Just ("EndTime" .= _twEndTime)])
...
instance FromJSON WafAction where
  parseJSON = withObject "WafAction" (\x -> WafAction' <$> (x .: "Type"))
...
instance ToJSON WafAction where
  toJSON WafAction' {..} = object (catMaybes [Just ("Type" .= _waType)])
...
instance FromJSON WafOverrideAction where
  parseJSON =
    withObject "WafOverrideAction" (\x -> WafOverrideAction' <$> (x .: "Type"))
...
xmsXSSMatchTuples =
  lens _xmsXSSMatchTuples (\s a -> s {_xmsXSSMatchTuples = a}) . _Coerce
...
instance FromJSON XSSMatchSet where
  parseJSON =
    withObject
      "XSSMatchSet"
      (\x ->
         XSSMatchSet' <$> (x .:? "Name") <*> (x .: "XssMatchSetId") <*>
...
instance FromJSON XSSMatchSetSummary where
  parseJSON =
    withObject
      "XSSMatchSetSummary"
      (\x -> XSSMatchSetSummary' <$> (x .: "XssMatchSetId") <*> (x .: "Name"))
