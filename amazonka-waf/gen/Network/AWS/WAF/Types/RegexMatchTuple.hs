...
data RegexMatchTuple = RegexMatchTuple'{_rmtFieldToMatch
                                        :: !FieldToMatch,
...
regexMatchTuple
    ...
    -> RegexMatchTuple
regexMatchTuple pFieldToMatch_ pTextTransformation_
  pRegexPatternSetId_
  = RegexMatchTuple'{_rmtFieldToMatch = pFieldToMatch_,
