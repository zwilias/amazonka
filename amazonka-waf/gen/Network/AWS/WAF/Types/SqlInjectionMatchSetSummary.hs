...
data SqlInjectionMatchSetSummary = SqlInjectionMatchSetSummary'{_simssSqlInjectionMatchSetId
                                                                :: !Text,
                                                                _simssName ::
                                                                !Text}
...
sqlInjectionMatchSetSummary
    ...
    -> Text -- ^ 'simssName'
    -> SqlInjectionMatchSetSummary
sqlInjectionMatchSetSummary pSqlInjectionMatchSetId_
  pName_
  = SqlInjectionMatchSetSummary'{_simssSqlInjectionMatchSetId
