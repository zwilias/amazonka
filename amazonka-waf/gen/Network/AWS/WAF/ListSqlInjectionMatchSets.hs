...
data ListSqlInjectionMatchSets = ListSqlInjectionMatchSets'{_lsimsNextMarker
                                                            :: !(Maybe Text),
                                                            _lsimsLimit ::
                                                            !(Maybe Nat)}
...
listSqlInjectionMatchSets
    :: ListSqlInjectionMatchSets
listSqlInjectionMatchSets
  = ListSqlInjectionMatchSets'{_lsimsNextMarker =
                                 Nothing,
                               _lsimsLimit = Nothing}
...
data ListSqlInjectionMatchSetsResponse = ListSqlInjectionMatchSetsResponse'{_lsimsrsNextMarker
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
listSqlInjectionMatchSetsResponse pResponseStatus_
  = ListSqlInjectionMatchSetsResponse'{_lsimsrsNextMarker
                                         = Nothing,
