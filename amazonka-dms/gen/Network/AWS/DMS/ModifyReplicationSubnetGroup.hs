...
mrsgReplicationSubnetGroupDescription ::
     Lens' ModifyReplicationSubnetGroup (Maybe Text)
mrsgReplicationSubnetGroupDescription =
  lens
    _mrsgReplicationSubnetGroupDescription
    (\s a -> s {_mrsgReplicationSubnetGroupDescription = a})
...
mrsgReplicationSubnetGroupIdentifier =
  lens
    ...
    (\s a -> s {_mrsgReplicationSubnetGroupIdentifier = a})
...
instance AWSRequest ModifyReplicationSubnetGroup where
  type Rs ModifyReplicationSubnetGroup = ModifyReplicationSubnetGroupResponse
...
mrsgrsReplicationSubnetGroup ::
     Lens' ModifyReplicationSubnetGroupResponse (Maybe ReplicationSubnetGroup)
mrsgrsReplicationSubnetGroup =
  lens
    _mrsgrsReplicationSubnetGroup
    (\s a -> s {_mrsgrsReplicationSubnetGroup = a})

-- | -- | The response status code.
mrsgrsResponseStatus :: Lens' ModifyReplicationSubnetGroupResponse Int
mrsgrsResponseStatus =
  lens _mrsgrsResponseStatus (\s a -> s {_mrsgrsResponseStatus = a})
