...
--
-- * 'crtReplicationTaskIdentifier' - An identifier for the replication task. Constraints:     * Must contain from 1 to 255 alphanumeric characters or hyphens.     * First character must be a letter.     * Cannot end with a hyphen or contain two consecutive hyphens.
--
