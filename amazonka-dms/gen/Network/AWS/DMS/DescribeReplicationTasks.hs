...
drtsrsReplicationTasks ::
     Lens' DescribeReplicationTasksResponse [ReplicationTask]
drtsrsReplicationTasks =
  lens _drtsrsReplicationTasks (\s a -> s {_drtsrsReplicationTasks = a}) .
  _Default . _Coerce
...
drtsrsResponseStatus =
  lens _drtsrsResponseStatus (\s a -> s {_drtsrsResponseStatus = a})
