...
mriAutoMinorVersionUpgrade =
  lens _mriAutoMinorVersionUpgrade (\s a -> s {_mriAutoMinorVersionUpgrade = a})
...
mriAllowMajorVersionUpgrade =
  lens
    ...
    (\s a -> s {_mriAllowMajorVersionUpgrade = a})
...
mriPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_mriPreferredMaintenanceWindow = a})

-- | Specifies the VPC security group to be used with the replication instance. The VPC security group must work with the VPC containing the replication instance.
mriVPCSecurityGroupIds :: Lens' ModifyReplicationInstance [Text]
mriVPCSecurityGroupIds =
  lens _mriVPCSecurityGroupIds (\s a -> s {_mriVPCSecurityGroupIds = a}) .
  _Default . _Coerce
...
mriAllocatedStorage =
  lens _mriAllocatedStorage (\s a -> s {_mriAllocatedStorage = a})

-- | Indicates whether the changes should be applied immediately or during the next maintenance window.
mriApplyImmediately :: Lens' ModifyReplicationInstance (Maybe Bool)
mriApplyImmediately =
  lens _mriApplyImmediately (\s a -> s {_mriApplyImmediately = a})
...
mriReplicationInstanceClass =
  lens
    ...
    (\s a -> s {_mriReplicationInstanceClass = a})
...
mriReplicationInstanceIdentifier =
  lens
    ...
    (\s a -> s {_mriReplicationInstanceIdentifier = a})

-- | The Amazon Resource Name (ARN) of the replication instance.
mriReplicationInstanceARN :: Lens' ModifyReplicationInstance Text
mriReplicationInstanceARN =
  lens _mriReplicationInstanceARN (\s a -> s {_mriReplicationInstanceARN = a})

instance AWSRequest ModifyReplicationInstance where
  type Rs ModifyReplicationInstance = ModifyReplicationInstanceResponse
  request = postJSON dms
  response =
    receiveJSON
      (\s h x ->
         ModifyReplicationInstanceResponse' <$> (x .?> "ReplicationInstance") <*>
         (pure (fromEnum s)))
  ...
  toJSON ModifyReplicationInstance' {..} =
    object
      (catMaybes
         ...
         , ("PreferredMaintenanceWindow" .=) <$> _mriPreferredMaintenanceWindow
...
mrirsReplicationInstance ::
     Lens' ModifyReplicationInstanceResponse (Maybe ReplicationInstance)
mrirsReplicationInstance =
  lens _mrirsReplicationInstance (\s a -> s {_mrirsReplicationInstance = a})

-- | -- | The response status code.
mrirsResponseStatus :: Lens' ModifyReplicationInstanceResponse Int
mrirsResponseStatus =
  lens _mrirsResponseStatus (\s a -> s {_mrirsResponseStatus = a})
