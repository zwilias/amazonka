...
instance FromJSON AvailabilityZone where
  parseJSON =
    withObject "AvailabilityZone" (\x -> AvailabilityZone' <$> (x .:? "Name"))
...
cValidFromDate =
  lens _cValidFromDate (\s a -> s {_cValidFromDate = a}) . mapping _Time
...
cCertificateCreationDate =
  lens _cCertificateCreationDate (\s a -> s {_cCertificateCreationDate = a}) .
  mapping _Time
...
cCertificateWallet =
  lens _cCertificateWallet (\s a -> s {_cCertificateWallet = a}) .
  mapping _Base64
...
cValidToDate =
  lens _cValidToDate (\s a -> s {_cValidToDate = a}) . mapping _Time
...
instance FromJSON Certificate where
  parseJSON =
    withObject
      "Certificate"
      (\x ->
         Certificate' <$> (x .:? "CertificateOwner") <*>
         (x .:? "SigningAlgorithm") <*>
         (x .:? "ValidFromDate") <*>
         (x .:? "CertificatePem") <*>
         (x .:? "CertificateArn") <*>
...
cReplicationInstanceARN =
  lens _cReplicationInstanceARN (\s a -> s {_cReplicationInstanceARN = a})

-- | The identifier of the endpoint. Identifiers must begin with a letter; must contain only ASCII letters, digits, and hyphens; and must not end with a hyphen or contain two consecutive hyphens.
cEndpointIdentifier :: Lens' Connection (Maybe Text)
cEndpointIdentifier =
  lens _cEndpointIdentifier (\s a -> s {_cEndpointIdentifier = a})

-- | The replication instance identifier. This parameter is stored as a lowercase string.
cReplicationInstanceIdentifier :: Lens' Connection (Maybe Text)
cReplicationInstanceIdentifier =
  lens
    _cReplicationInstanceIdentifier
    (\s a -> s {_cReplicationInstanceIdentifier = a})
...
cLastFailureMessage =
  lens _cLastFailureMessage (\s a -> s {_cLastFailureMessage = a})
...
instance FromJSON Connection where
  parseJSON =
    withObject
      "Connection"
      (\x ->
         Connection' <$> (x .:? "Status") <*> (x .:? "ReplicationInstanceArn") <*>
...
ddsServiceAccessRoleARN =
  lens _ddsServiceAccessRoleARN (\s a -> s {_ddsServiceAccessRoleARN = a})
...
instance ToJSON DynamoDBSettings where
  toJSON DynamoDBSettings' {..} =
    object
      (catMaybes [Just ("ServiceAccessRoleArn" .= _ddsServiceAccessRoleARN)])
...
eServiceAccessRoleARN =
  lens _eServiceAccessRoleARN (\s a -> s {_eServiceAccessRoleARN = a})

-- | The expanded name for the engine name. For example, if the @EngineName@ parameter is "aurora," this value would be "Amazon Aurora MySQL."
eEngineDisplayName :: Lens' Endpoint (Maybe Text)
eEngineDisplayName =
  lens _eEngineDisplayName (\s a -> s {_eEngineDisplayName = a})

-- | Additional connection attributes used to connect to the endpoint.
eExtraConnectionAttributes :: Lens' Endpoint (Maybe Text)
eExtraConnectionAttributes =
  lens _eExtraConnectionAttributes (\s a -> s {_eExtraConnectionAttributes = a})
...
eExternalTableDefinition =
  lens _eExternalTableDefinition (\s a -> s {_eExternalTableDefinition = a})
...
eEndpointIdentifier =
  lens _eEndpointIdentifier (\s a -> s {_eEndpointIdentifier = a})
...
instance FromJSON Endpoint where
  parseJSON =
    withObject
      "Endpoint"
      (\x ->
         Endpoint' <$> (x .:? "Status") <*> (x .:? "ServerName") <*>
         (x .:? "CertificateArn") <*>
...
ecgEventCategories =
  lens _ecgEventCategories (\s a -> s {_ecgEventCategories = a}) .
  _Default . _Coerce
...
instance FromJSON EventCategoryGroup where
  parseJSON =
    withObject
      "EventCategoryGroup"
      (\x ->
         EventCategoryGroup' <$> (x .:? "SourceType") <*>
         (x .:? "EventCategories" .!= mempty))
...
instance ToJSON Filter where
  toJSON Filter' {..} =
    object (catMaybes [Just ("Name" .= _fName), Just ("Values" .= _fValues)])
...
mdsPassword =
  lens _mdsPassword (\s a -> s {_mdsPassword = a}) . mapping _Sensitive
...
mdsDocsToInvestigate =
  lens _mdsDocsToInvestigate (\s a -> s {_mdsDocsToInvestigate = a})
...
instance FromJSON MongoDBSettings where
  parseJSON =
    withObject
      "MongoDBSettings"
      (\x ->
         MongoDBSettings' <$> (x .:? "ServerName") <*> (x .:? "AuthMechanism") <*>
         (x .:? "Username") <*>
         (x .:? "KmsKeyId") <*>
         (x .:? "Password") <*>
         (x .:? "NestingLevel") <*>
...
oriMinAllocatedStorage =
  lens _oriMinAllocatedStorage (\s a -> s {_oriMinAllocatedStorage = a})
...
oriIncludedAllocatedStorage =
  lens
    ...
    (\s a -> s {_oriIncludedAllocatedStorage = a})

-- | The minimum amount of storage (in gigabytes) that can be allocated for the replication instance.
oriMaxAllocatedStorage :: Lens' OrderableReplicationInstance (Maybe Int)
oriMaxAllocatedStorage =
  lens _oriMaxAllocatedStorage (\s a -> s {_oriMaxAllocatedStorage = a})
...
instance FromJSON OrderableReplicationInstance where
  parseJSON =
    withObject
      "OrderableReplicationInstance"
      (\x ->
         OrderableReplicationInstance' <$> (x .:? "EngineVersion") <*>
...
rssLastRefreshDate =
  lens _rssLastRefreshDate (\s a -> s {_rssLastRefreshDate = a}) . mapping _Time

-- | The Amazon Resource Name (ARN) of the replication instance.
rssReplicationInstanceARN :: Lens' RefreshSchemasStatus (Maybe Text)
rssReplicationInstanceARN =
  lens _rssReplicationInstanceARN (\s a -> s {_rssReplicationInstanceARN = a})
...
rssLastFailureMessage =
  lens _rssLastFailureMessage (\s a -> s {_rssLastFailureMessage = a})
...
riPubliclyAccessible =
  lens _riPubliclyAccessible (\s a -> s {_riPubliclyAccessible = a})

-- | Boolean value indicating if minor version upgrades will be automatically applied to the instance.
riAutoMinorVersionUpgrade :: Lens' ReplicationInstance (Maybe Bool)
riAutoMinorVersionUpgrade =
  lens _riAutoMinorVersionUpgrade (\s a -> s {_riAutoMinorVersionUpgrade = a})
...
riReplicationInstancePublicIPAddresses =
  lens
    ...
    (\s a -> s {_riReplicationInstancePublicIPAddresses = a}) .
  _Default . _Coerce

-- | The subnet group for the replication instance.
riReplicationSubnetGroup ::
     Lens' ReplicationInstance (Maybe ReplicationSubnetGroup)
riReplicationSubnetGroup =
  lens _riReplicationSubnetGroup (\s a -> s {_riReplicationSubnetGroup = a})

-- | The time the replication instance was created.
riInstanceCreateTime :: Lens' ReplicationInstance (Maybe UTCTime)
riInstanceCreateTime =
  lens _riInstanceCreateTime (\s a -> s {_riInstanceCreateTime = a}) .
  mapping _Time
...
riReplicationInstanceStatus =
  lens
    ...
    (\s a -> s {_riReplicationInstanceStatus = a})
...
riReplicationInstancePrivateIPAddresses =
  lens
    ...
    (\s a -> s {_riReplicationInstancePrivateIPAddresses = a}) .
  _Default . _Coerce
...
riPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_riPreferredMaintenanceWindow = a})
...
riReplicationInstancePrivateIPAddress =
  lens
    ...
    (\s a -> s {_riReplicationInstancePrivateIPAddress = a})
...
riVPCSecurityGroups =
  lens _riVPCSecurityGroups (\s a -> s {_riVPCSecurityGroups = a}) .
  _Default . _Coerce
...
riSecondaryAvailabilityZone =
  lens
    ...
    (\s a -> s {_riSecondaryAvailabilityZone = a})

-- | The Amazon Resource Name (ARN) of the replication instance.
riReplicationInstanceARN :: Lens' ReplicationInstance (Maybe Text)
riReplicationInstanceARN =
  lens _riReplicationInstanceARN (\s a -> s {_riReplicationInstanceARN = a})

-- | The amount of storage (in gigabytes) that is allocated for the replication instance.
riAllocatedStorage :: Lens' ReplicationInstance (Maybe Int)
riAllocatedStorage =
  lens _riAllocatedStorage (\s a -> s {_riAllocatedStorage = a})
...
riReplicationInstancePublicIPAddress =
  lens
    ...
    (\s a -> s {_riReplicationInstancePublicIPAddress = a})

-- | The compute and memory capacity of the replication instance. Valid Values: @dms.t2.micro | dms.t2.small | dms.t2.medium | dms.t2.large | dms.c4.large | dms.c4.xlarge | dms.c4.2xlarge | dms.c4.4xlarge @
riReplicationInstanceClass :: Lens' ReplicationInstance (Maybe Text)
riReplicationInstanceClass =
  lens _riReplicationInstanceClass (\s a -> s {_riReplicationInstanceClass = a})
...
riReplicationInstanceIdentifier =
  lens
    ...
    (\s a -> s {_riReplicationInstanceIdentifier = a})

-- | The pending modification values.
riPendingModifiedValues ::
     Lens' ReplicationInstance (Maybe ReplicationPendingModifiedValues)
riPendingModifiedValues =
  lens _riPendingModifiedValues (\s a -> s {_riPendingModifiedValues = a})
...
instance FromJSON ReplicationInstance where
  parseJSON =
    withObject
      "ReplicationInstance"
      (\x ->
         ReplicationInstance' <$> (x .:? "EngineVersion") <*>
...
ritlReplicationTaskName =
  lens _ritlReplicationTaskName (\s a -> s {_ritlReplicationTaskName = a})

-- | The Amazon Resource Name (ARN) of the replication task.
ritlReplicationTaskARN :: Lens' ReplicationInstanceTaskLog (Maybe Text)
ritlReplicationTaskARN =
  lens _ritlReplicationTaskARN (\s a -> s {_ritlReplicationTaskARN = a})

-- | The size, in bytes, of the replication task log.
ritlReplicationInstanceTaskLogSize ::
     Lens' ReplicationInstanceTaskLog (Maybe Integer)
ritlReplicationInstanceTaskLogSize =
  lens
    _ritlReplicationInstanceTaskLogSize
    (\s a -> s {_ritlReplicationInstanceTaskLogSize = a})
...
instance FromJSON ReplicationInstanceTaskLog where
  parseJSON =
    withObject
      "ReplicationInstanceTaskLog"
      (\x ->
         ReplicationInstanceTaskLog' <$> (x .:? "ReplicationTaskName") <*>
...
rpmvAllocatedStorage =
  lens _rpmvAllocatedStorage (\s a -> s {_rpmvAllocatedStorage = a})

-- | The compute and memory capacity of the replication instance. Valid Values: @dms.t2.micro | dms.t2.small | dms.t2.medium | dms.t2.large | dms.c4.large | dms.c4.xlarge | dms.c4.2xlarge | dms.c4.4xlarge @
rpmvReplicationInstanceClass ::
     Lens' ReplicationPendingModifiedValues (Maybe Text)
rpmvReplicationInstanceClass =
  lens
    _rpmvReplicationInstanceClass
    (\s a -> s {_rpmvReplicationInstanceClass = a})
...
instance FromJSON ReplicationPendingModifiedValues where
  parseJSON =
    withObject
      "ReplicationPendingModifiedValues"
      (\x ->
         ReplicationPendingModifiedValues' <$> (x .:? "EngineVersion") <*>
         (x .:? "MultiAZ") <*>
         (x .:? "AllocatedStorage") <*>
         (x .:? "ReplicationInstanceClass"))
...
rsgReplicationSubnetGroupIdentifier =
  lens
    ...
    (\s a -> s {_rsgReplicationSubnetGroupIdentifier = a})

-- | The status of the subnet group.
rsgSubnetGroupStatus :: Lens' ReplicationSubnetGroup (Maybe Text)
rsgSubnetGroupStatus =
  lens _rsgSubnetGroupStatus (\s a -> s {_rsgSubnetGroupStatus = a})

-- | The description of the replication subnet group.
rsgReplicationSubnetGroupDescription ::
     Lens' ReplicationSubnetGroup (Maybe Text)
rsgReplicationSubnetGroupDescription =
  lens
    _rsgReplicationSubnetGroupDescription
    (\s a -> s {_rsgReplicationSubnetGroupDescription = a})
...
instance FromJSON ReplicationSubnetGroup where
  parseJSON =
    withObject
      "ReplicationSubnetGroup"
      (\x ->
         ReplicationSubnetGroup' <$> (x .:? "VpcId") <*>
         (x .:? "Subnets" .!= mempty) <*>
...
rReplicationTaskSettings =
  lens _rReplicationTaskSettings (\s a -> s {_rReplicationTaskSettings = a})
...
rTargetEndpointARN =
  lens _rTargetEndpointARN (\s a -> s {_rTargetEndpointARN = a})
...
rReplicationTaskIdentifier =
  lens _rReplicationTaskIdentifier (\s a -> s {_rReplicationTaskIdentifier = a})
...
rReplicationTaskStartDate =
  lens _rReplicationTaskStartDate (\s a -> s {_rReplicationTaskStartDate = a}) .
  mapping _Time

-- | The Amazon Resource Name (ARN) string that uniquely identifies the endpoint.
rSourceEndpointARN :: Lens' ReplicationTask (Maybe Text)
rSourceEndpointARN =
  lens _rSourceEndpointARN (\s a -> s {_rSourceEndpointARN = a})

-- | Indicates the last checkpoint that occurred during a change data capture (CDC) operation. You can provide this value to the @CdcStartPosition@ parameter to start a CDC operation that begins at that checkpoint.
rRecoveryCheckpoint :: Lens' ReplicationTask (Maybe Text)
rRecoveryCheckpoint =
  lens _rRecoveryCheckpoint (\s a -> s {_rRecoveryCheckpoint = a})
...
rReplicationTaskCreationDate =
  lens
    ...
    (\s a -> s {_rReplicationTaskCreationDate = a}) .
  mapping _Time
...
rReplicationTaskARN =
  lens _rReplicationTaskARN (\s a -> s {_rReplicationTaskARN = a})
...
rReplicationTaskStats =
  lens _rReplicationTaskStats (\s a -> s {_rReplicationTaskStats = a})

-- | The Amazon Resource Name (ARN) of the replication instance.
rReplicationInstanceARN :: Lens' ReplicationTask (Maybe Text)
rReplicationInstanceARN =
  lens _rReplicationInstanceARN (\s a -> s {_rReplicationInstanceARN = a})

-- | The last error (failure) message generated for the replication instance.
rLastFailureMessage :: Lens' ReplicationTask (Maybe Text)
rLastFailureMessage =
  lens _rLastFailureMessage (\s a -> s {_rLastFailureMessage = a})
...
instance FromJSON ReplicationTask where
  parseJSON =
    withObject
      "ReplicationTask"
      (\x ->
         ReplicationTask' <$> (x .:? "ReplicationTaskSettings") <*>
         (x .:? "Status") <*>
         (x .:? "StopReason") <*>
         (x .:? "TargetEndpointArn") <*>
...
rtarReplicationTaskLastAssessmentDate ::
     Lens' ReplicationTaskAssessmentResult (Maybe UTCTime)
rtarReplicationTaskLastAssessmentDate =
  lens
    _rtarReplicationTaskLastAssessmentDate
    (\s a -> s {_rtarReplicationTaskLastAssessmentDate = a}) .
  mapping _Time

-- | The Amazon Resource Name (ARN) of the replication task.
rtarReplicationTaskARN :: Lens' ReplicationTaskAssessmentResult (Maybe Text)
rtarReplicationTaskARN =
  lens _rtarReplicationTaskARN (\s a -> s {_rtarReplicationTaskARN = a})
...
instance FromJSON ReplicationTaskAssessmentResult where
  parseJSON =
    withObject
      "ReplicationTaskAssessmentResult"
      (\x ->
         ReplicationTaskAssessmentResult' <$> (x .:? "AssessmentResults") <*>
...
rtsFullLoadProgressPercent =
  lens _rtsFullLoadProgressPercent (\s a -> s {_rtsFullLoadProgressPercent = a})

-- | The elapsed time of the task, in milliseconds.
rtsElapsedTimeMillis :: Lens' ReplicationTaskStats (Maybe Integer)
rtsElapsedTimeMillis =
  lens _rtsElapsedTimeMillis (\s a -> s {_rtsElapsedTimeMillis = a})
...
instance FromJSON ReplicationTaskStats where
  parseJSON =
    withObject
      "ReplicationTaskStats"
      (\x ->
         ReplicationTaskStats' <$> (x .:? "FullLoadProgressPercent") <*>
         (x .:? "ElapsedTimeMillis") <*>
         (x .:? "TablesErrored") <*>
         (x .:? "TablesLoaded") <*>
         (x .:? "TablesQueued") <*>
...
ssServiceAccessRoleARN =
  lens _ssServiceAccessRoleARN (\s a -> s {_ssServiceAccessRoleARN = a})
...
ssExternalTableDefinition =
  lens _ssExternalTableDefinition (\s a -> s {_ssExternalTableDefinition = a})
...
setEngineDisplayName =
  lens _setEngineDisplayName (\s a -> s {_setEngineDisplayName = a})

-- | The type of endpoint.
setEndpointType ::
     Lens' SupportedEndpointType (Maybe ReplicationEndpointTypeValue)
...
instance FromJSON SupportedEndpointType where
  parseJSON =
    withObject
      "SupportedEndpointType"
      (\x ->
         SupportedEndpointType' <$> (x .:? "EngineDisplayName") <*>
         (x .:? "EndpointType") <*>
         (x .:? "EngineName") <*>
         (x .:? "SupportsCDC"))
...
tsFullLoadCondtnlChkFailedRows =
  lens
    ...
    (\s a -> s {_tsFullLoadCondtnlChkFailedRows = a})

-- | The number of records that failed validation.
tsValidationFailedRecords :: Lens' TableStatistics (Maybe Integer)
tsValidationFailedRecords =
  lens _tsValidationFailedRecords (\s a -> s {_tsValidationFailedRecords = a})
...
tsValidationSuspendedRecords =
  lens
    ...
    (\s a -> s {_tsValidationSuspendedRecords = a})
...
tsFullLoadErrorRows =
  lens _tsFullLoadErrorRows (\s a -> s {_tsFullLoadErrorRows = a})
...
tsValidationPendingRecords =
  lens _tsValidationPendingRecords (\s a -> s {_tsValidationPendingRecords = a})

-- | The last time the table was updated.
tsLastUpdateTime :: Lens' TableStatistics (Maybe UTCTime)
tsLastUpdateTime =
  lens _tsLastUpdateTime (\s a -> s {_tsLastUpdateTime = a}) . mapping _Time
...
instance FromJSON TableStatistics where
  parseJSON =
    withObject
      "TableStatistics"
      (\x ->
         TableStatistics' <$> (x .:? "ValidationState") <*>
         (x .:? "FullLoadRows") <*>
         (x .:? "Inserts") <*>
