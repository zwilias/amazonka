...
criPubliclyAccessible =
  lens _criPubliclyAccessible (\s a -> s {_criPubliclyAccessible = a})
...
criAutoMinorVersionUpgrade =
  lens _criAutoMinorVersionUpgrade (\s a -> s {_criAutoMinorVersionUpgrade = a})

-- | A subnet group to associate with the replication instance.
criReplicationSubnetGroupIdentifier ::
     Lens' CreateReplicationInstance (Maybe Text)
criReplicationSubnetGroupIdentifier =
  lens
    _criReplicationSubnetGroupIdentifier
    (\s a -> s {_criReplicationSubnetGroupIdentifier = a})
...
criPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_criPreferredMaintenanceWindow = a})
...
criAvailabilityZone =
  lens _criAvailabilityZone (\s a -> s {_criAvailabilityZone = a})

-- | Specifies the VPC security group to be used with the replication instance. The VPC security group must work with the VPC containing the replication instance.
criVPCSecurityGroupIds :: Lens' CreateReplicationInstance [Text]
criVPCSecurityGroupIds =
  lens _criVPCSecurityGroupIds (\s a -> s {_criVPCSecurityGroupIds = a}) .
  _Default . _Coerce
...
criAllocatedStorage =
  lens _criAllocatedStorage (\s a -> s {_criAllocatedStorage = a})
...
criReplicationInstanceIdentifier =
  lens
    ...
    (\s a -> s {_criReplicationInstanceIdentifier = a})
...
criReplicationInstanceClass =
  lens
    ...
    (\s a -> s {_criReplicationInstanceClass = a})

instance AWSRequest CreateReplicationInstance where
  type Rs CreateReplicationInstance = CreateReplicationInstanceResponse
  request = postJSON dms
  response =
    receiveJSON
      (\s h x ->
         CreateReplicationInstanceResponse' <$> (x .?> "ReplicationInstance") <*>
         (pure (fromEnum s)))
    ...
    object
      (catMaybes
         ...
         , ("ReplicationSubnetGroupIdentifier" .=) <$>
           _criReplicationSubnetGroupIdentifier
         , ("PreferredMaintenanceWindow" .=) <$> _criPreferredMaintenanceWindow
...
crirsReplicationInstance ::
     Lens' CreateReplicationInstanceResponse (Maybe ReplicationInstance)
crirsReplicationInstance =
  lens _crirsReplicationInstance (\s a -> s {_crirsReplicationInstance = a})

-- | -- | The response status code.
crirsResponseStatus :: Lens' CreateReplicationInstanceResponse Int
crirsResponseStatus =
  lens _crirsResponseStatus (\s a -> s {_crirsResponseStatus = a})
