...
--
--
-- Before you can delete a CA that you have created and activated, you must disable it. To do this, call the 'UpdateCertificateAuthority' action and set the __CertificateAuthorityStatus__ parameter to @DISABLED@ . 
--
