...
usDisableAutomatedBackup =
  lens _usDisableAutomatedBackup (\s a -> s {_usDisableAutomatedBackup = a})
...
usPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_usPreferredMaintenanceWindow = a})

-- | Undocumented member.
usPreferredBackupWindow :: Lens' UpdateServer (Maybe Text)
usPreferredBackupWindow =
  lens _usPreferredBackupWindow (\s a -> s {_usPreferredBackupWindow = a})

-- | Sets the number of automated backups that you want to keep.
usBackupRetentionCount :: Lens' UpdateServer (Maybe Int)
usBackupRetentionCount =
  lens _usBackupRetentionCount (\s a -> s {_usBackupRetentionCount = a})
