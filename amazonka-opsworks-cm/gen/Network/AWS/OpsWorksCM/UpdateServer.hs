...
data UpdateServer = UpdateServer'{_usDisableAutomatedBackup
                                  :: !(Maybe Bool),
...
updateServer pServerName_
  = UpdateServer'{_usDisableAutomatedBackup = Nothing,
...
data UpdateServerResponse = UpdateServerResponse'{_usrsServer
                                                  :: !(Maybe Server),
...
updateServerResponse pResponseStatus_
  = UpdateServerResponse'{_usrsServer = Nothing,
