...
instance FromJSON AccountAttribute where
  parseJSON =
    withObject
      "AccountAttribute"
      (\x ->
         AccountAttribute' <$> (x .:? "Used") <*> (x .:? "Maximum") <*>
         (x .:? "Name"))
...
bInstanceProfileARN =
  lens _bInstanceProfileARN (\s a -> s {_bInstanceProfileARN = a})

-- | The security group IDs that are obtained from the server when the backup is created.
bSecurityGroupIds :: Lens' Backup [Text]
bSecurityGroupIds =
  lens _bSecurityGroupIds (\s a -> s {_bSecurityGroupIds = a}) .
  _Default . _Coerce

-- | An informational message about backup status.
bStatusDescription :: Lens' Backup (Maybe Text)
bStatusDescription =
  lens _bStatusDescription (\s a -> s {_bStatusDescription = a})
...
bPreferredMaintenanceWindow =
  lens
    _bPreferredMaintenanceWindow
    (\s a -> s {_bPreferredMaintenanceWindow = a})
...
bPreferredBackupWindow =
  lens _bPreferredBackupWindow (\s a -> s {_bPreferredBackupWindow = a})
...
instance FromJSON Backup where
  parseJSON =
    withObject
      "Backup"
      (\x ->
         Backup' <$> (x .:? "EngineVersion") <*> (x .:? "ServiceRoleArn") <*>
         (x .:? "Status") <*>
...
instance ToJSON EngineAttribute where
  toJSON EngineAttribute' {..} =
    object (catMaybes [("Value" .=) <$> _eaValue, ("Name" .=) <$> _eaName])
...
sDisableAutomatedBackup =
  lens _sDisableAutomatedBackup (\s a -> s {_sDisableAutomatedBackup = a})
...
sInstanceProfileARN =
  lens _sInstanceProfileARN (\s a -> s {_sInstanceProfileARN = a})

-- | The security group IDs for the server, as specified in the CloudFormation stack. These might not be the same security groups that are shown in the EC2 console.
sSecurityGroupIds :: Lens' Server [Text]
sSecurityGroupIds =
  lens _sSecurityGroupIds (\s a -> s {_sSecurityGroupIds = a}) .
  _Default . _Coerce

-- | Associate a public IP address with a server that you are launching.
sAssociatePublicIPAddress :: Lens' Server (Maybe Bool)
sAssociatePublicIPAddress =
  lens _sAssociatePublicIPAddress (\s a -> s {_sAssociatePublicIPAddress = a})
...
sMaintenanceStatus =
  lens _sMaintenanceStatus (\s a -> s {_sMaintenanceStatus = a})
...
sEngineAttributes =
  lens _sEngineAttributes (\s a -> s {_sEngineAttributes = a}) .
  _Default . _Coerce
...
sPreferredBackupWindow =
  lens _sPreferredBackupWindow (\s a -> s {_sPreferredBackupWindow = a})
...
sCloudFormationStackARN =
  lens _sCloudFormationStackARN (\s a -> s {_sCloudFormationStackARN = a})

-- | The number of automated backups to keep.
sBackupRetentionCount :: Lens' Server (Maybe Int)
sBackupRetentionCount =
  lens _sBackupRetentionCount (\s a -> s {_sBackupRetentionCount = a})
...
instance FromJSON Server where
  parseJSON =
    withObject
      "Server"
      (\x ->
         Server' <$> (x .:? "EngineVersion") <*> (x .:? "ServiceRoleArn") <*>
...
instance FromJSON ServerEvent where
  parseJSON =
    withObject
      "ServerEvent"
      (\x ->
         ServerEvent' <$> (x .:? "LogUrl") <*> (x .:? "ServerName") <*>
         (x .:? "CreatedAt") <*>
         (x .:? "Message"))
