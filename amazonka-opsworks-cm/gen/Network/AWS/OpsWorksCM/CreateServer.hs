...
csDisableAutomatedBackup =
  lens _csDisableAutomatedBackup (\s a -> s {_csDisableAutomatedBackup = a})
...
csSecurityGroupIds =
  lens _csSecurityGroupIds (\s a -> s {_csSecurityGroupIds = a}) .
  _Default . _Coerce

-- | Associate a public IP address with a server that you are launching. Valid values are @true@ or @false@ . The default value is @true@ .
csAssociatePublicIPAddress :: Lens' CreateServer (Maybe Bool)
csAssociatePublicIPAddress =
  lens _csAssociatePublicIPAddress (\s a -> s {_csAssociatePublicIPAddress = a})
...
csSubnetIds =
  lens _csSubnetIds (\s a -> s {_csSubnetIds = a}) . _Default . _Coerce
...
csEngineAttributes =
  lens _csEngineAttributes (\s a -> s {_csEngineAttributes = a}) .
  _Default . _Coerce
...
csPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_csPreferredMaintenanceWindow = a})
...
csPreferredBackupWindow =
  lens _csPreferredBackupWindow (\s a -> s {_csPreferredBackupWindow = a})

-- | The number of automated backups that you want to keep. Whenever a new backup is created, AWS OpsWorks CM deletes the oldest backups if this number is exceeded. The default value is @1@ .
csBackupRetentionCount :: Lens' CreateServer (Maybe Natural)
csBackupRetentionCount =
  lens _csBackupRetentionCount (\s a -> s {_csBackupRetentionCount = a}) .
  mapping _Nat
...
csInstanceProfileARN =
  lens _csInstanceProfileARN (\s a -> s {_csInstanceProfileARN = a})
  ...
  toJSON CreateServer' {..} =
    object
      (catMaybes
         ...
         , ("PreferredMaintenanceWindow" .=) <$> _csPreferredMaintenanceWindow
