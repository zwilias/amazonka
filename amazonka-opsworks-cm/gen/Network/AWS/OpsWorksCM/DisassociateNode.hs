...
data DisassociateNode = DisassociateNode'{_dnEngineAttributes
...
disassociateNode pServerName_ pNodeName_
  = DisassociateNode'{_dnEngineAttributes = Nothing,
...
data DisassociateNodeResponse = DisassociateNodeResponse'{_dnrsNodeAssociationStatusToken
                                                          :: !(Maybe Text),
                                                          _dnrsResponseStatus ::
                                                          !Int}
...
disassociateNodeResponse pResponseStatus_
  = DisassociateNodeResponse'{_dnrsNodeAssociationStatusToken
                                = Nothing,
