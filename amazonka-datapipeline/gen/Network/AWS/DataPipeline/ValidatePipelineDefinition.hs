...
vpdPipelineObjects =
  lens _vpdPipelineObjects (\s a -> s {_vpdPipelineObjects = a}) . _Coerce
...
vpdrsValidationErrors ::
     Lens' ValidatePipelineDefinitionResponse [ValidationError]
vpdrsValidationErrors =
...
vpdrsValidationWarnings ::
     Lens' ValidatePipelineDefinitionResponse [ValidationWarning]
vpdrsValidationWarnings =
  lens _vpdrsValidationWarnings (\s a -> s {_vpdrsValidationWarnings = a}) .
  _Default . _Coerce

-- | -- | The response status code.
vpdrsResponseStatus :: Lens' ValidatePipelineDefinitionResponse Int
vpdrsResponseStatus =
  lens _vpdrsResponseStatus (\s a -> s {_vpdrsResponseStatus = a})
