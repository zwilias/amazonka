...
data Item = Item'{_iETag :: !(Maybe Text),
                  _iContentLength :: !(Maybe Nat),
                  _iName :: !(Maybe Text), _iType :: !(Maybe ItemType),
...
item
    :: Item
item
  = Item'{_iETag = Nothing, _iContentLength = Nothing,
          _iName = Nothing, _iType = Nothing,
          _iLastModified = Nothing, _iContentType = Nothing}
