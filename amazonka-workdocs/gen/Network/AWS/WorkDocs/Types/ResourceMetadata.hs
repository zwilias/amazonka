...
data ResourceMetadata = ResourceMetadata'{_rmVersionId
                                          :: !(Maybe Text),
...
resourceMetadata
    :: ResourceMetadata
resourceMetadata
  = ResourceMetadata'{_rmVersionId = Nothing,
                      _rmOwner = Nothing, _rmName = Nothing,
                      _rmId = Nothing, _rmType = Nothing,
                      _rmOriginalName = Nothing, _rmParentId = Nothing}
