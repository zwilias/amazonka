...
data DocumentMetadata = DocumentMetadata'{_dmLatestVersionMetadata
...
documentMetadata
    :: DocumentMetadata
documentMetadata
  = DocumentMetadata'{_dmLatestVersionMetadata =
                        Nothing,
                      _dmParentFolderId = Nothing,
                      _dmModifiedTimestamp = Nothing, _dmId = Nothing,
                      _dmLabels = Nothing, _dmResourceState = Nothing,
