...
data FolderMetadata = FolderMetadata'{_fmSignature ::
                                      !(Maybe Text),
...
folderMetadata
    :: FolderMetadata
folderMetadata
  = FolderMetadata'{_fmSignature = Nothing,
                    _fmParentFolderId = Nothing, _fmSize = Nothing,
                    _fmLatestVersionSize = Nothing, _fmName = Nothing,
                    _fmModifiedTimestamp = Nothing, _fmId = Nothing,
                    _fmLabels = Nothing, _fmResourceState = Nothing,
