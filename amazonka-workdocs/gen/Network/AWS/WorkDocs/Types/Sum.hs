  ...
  parser =
    takeLowerText >>= \case
      ...
      "document_shareable_link_permission_changed" ->
        pure DocumentShareableLinkPermissionChanged
      ...
      "folder_shareable_link_permission_changed" ->
        pure FolderShareableLinkPermissionChanged
      ...
      e ->
        fromTextError $
        "Failure parsing ActivityType from value: '" <>
        e <>
...
instance FromText BooleanEnumType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BooleanEnumType from value: '" <>
        e <> "'. Accepted values: false, true"
...
instance FromText CommentStatusType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommentStatusType from value: '" <>
        e <> "'. Accepted values: deleted, draft, published"
...
instance FromText CommentVisibilityType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommentVisibilityType from value: '" <>
...
instance FromText DocumentSourceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentSourceType from value: '" <>
        e <> "'. Accepted values: original, with_comments"
...
instance FromText DocumentStatusType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentStatusType from value: '" <>
        e <> "'. Accepted values: active, initialized"
...
instance FromText DocumentThumbnailType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentThumbnailType from value: '" <>
        e <> "'. Accepted values: large, small, small_hq"
...
instance FromText DocumentVersionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentVersionStatus from value: '" <>
        e <> "'. Accepted values: active"
...
instance FromText FolderContentType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FolderContentType from value: '" <>
        e <> "'. Accepted values: all, document, folder"
...
instance FromText LocaleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LocaleType from value: '" <>
        e <>
...
instance FromText OrderType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OrderType from value: '" <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: anonymous, group, invite, organization, user"
...
instance FromText ResourceSortType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResourceSortType from value: '" <>
        e <> "'. Accepted values: date, name"
...
instance FromText ResourceStateType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResourceStateType from value: '" <>
        e <> "'. Accepted values: active, recycled, recycling, restoring"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: document, folder"
...
instance FromText RolePermissionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RolePermissionType from value: '" <>
        e <> "'. Accepted values: direct, inherited"
...
instance FromText RoleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RoleType from value: '" <>
        e <> "'. Accepted values: contributor, coowner, owner, viewer"
...
instance FromText ShareStatusType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ShareStatusType from value: '" <>
...
instance FromText StorageType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StorageType from value: '" <>
        e <> "'. Accepted values: quota, unlimited"
...
instance FromText SubscriptionProtocolType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SubscriptionProtocolType from value: '" <>
        e <> "'. Accepted values: https"
...
instance FromText UserFilterType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing UserFilterType from value: '" <>
        e <> "'. Accepted values: active_pending, all"
...
instance FromText UserSortType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing UserSortType from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: active, inactive, pending"
...
instance FromText UserType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing UserType from value: '" <>
        e <>
