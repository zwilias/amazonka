...
data UserMetadata = UserMetadata'{_umGivenName ::
                                  !(Maybe Text),
...
userMetadata
    :: UserMetadata
userMetadata
  = UserMetadata'{_umGivenName = Nothing,
                  _umUsername = Nothing, _umEmailAddress = Nothing,
                  _umId = Nothing, _umSurname = Nothing}
