...
ddvAuthenticationToken =
  lens _ddvAuthenticationToken (\s a -> s {_ddvAuthenticationToken = a}) .
  mapping _Sensitive
...
ddvrsDocumentVersions ::
     Lens' DescribeDocumentVersionsResponse [DocumentVersionMetadata]
ddvrsDocumentVersions =
  lens _ddvrsDocumentVersions (\s a -> s {_ddvrsDocumentVersions = a}) .
  _Default . _Coerce
...
ddvrsResponseStatus =
  lens _ddvrsResponseStatus (\s a -> s {_ddvrsResponseStatus = a})
