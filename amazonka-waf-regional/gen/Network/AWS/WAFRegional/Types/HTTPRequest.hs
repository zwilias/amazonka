...
data HTTPRequest = HTTPRequest'{_httprHTTPVersion ::
                                !(Maybe Text),
...
hTTPRequest
    :: HTTPRequest
hTTPRequest
  = HTTPRequest'{_httprHTTPVersion = Nothing,
                 _httprCountry = Nothing, _httprURI = Nothing,
                 _httprHeaders = Nothing, _httprMethod = Nothing,
