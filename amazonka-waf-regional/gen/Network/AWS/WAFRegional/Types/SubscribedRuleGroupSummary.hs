...
data SubscribedRuleGroupSummary = SubscribedRuleGroupSummary'{_srgsRuleGroupId
                                                              :: !Text,
                                                              _srgsName ::
                                                              !Text,
                                                              _srgsMetricName ::
...
subscribedRuleGroupSummary
    ...
    -> Text -- ^ 'srgsMetricName'
    -> SubscribedRuleGroupSummary
subscribedRuleGroupSummary pRuleGroupId_ pName_
  pMetricName_
  = SubscribedRuleGroupSummary'{_srgsRuleGroupId =
                                  pRuleGroupId_,
                                _srgsName = pName_,
