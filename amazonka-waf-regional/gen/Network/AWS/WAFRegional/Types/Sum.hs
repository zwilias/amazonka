  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: delete, insert"
...
instance FromText ChangeTokenStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ChangeTokenStatus from value: '" <>
        e <> "'. Accepted values: insync, pending, provisioned"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: eq, ge, gt, le, lt, ne"
...
instance FromText GeoMatchConstraintType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GeoMatchConstraintType from value: '" <>
        e <> "'. Accepted values: country"
...
instance FromText GeoMatchConstraintValue where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing GeoMatchConstraintValue from value: '" <>
        e <>
...
instance FromText IPSetDescriptorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing IPSetDescriptorType from value: '" <>
...
instance FromText MatchFieldType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MatchFieldType from value: '" <>
        e <> "'. Accepted values: body, header, method, query_string, uri"
...
instance FromText PositionalConstraint where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PositionalConstraint from value: '" <>
        e <>
...
instance FromText PredicateType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PredicateType from value: '" <>
        e <>
...
instance FromText RateKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RateKey from value: '" <> e <> "'. Accepted values: ip"
...
instance FromText TextTransformation where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TextTransformation from value: '" <>
        e <>
...
instance FromText WafActionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WafActionType from value: '" <>
        e <> "'. Accepted values: allow, block, count"
...
instance FromText WafOverrideActionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WafOverrideActionType from value: '" <>
        e <> "'. Accepted values: count, none"
...
instance FromText WafRuleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WafRuleType from value: '" <>
        e <> "'. Accepted values: group, rate_based, regular"
