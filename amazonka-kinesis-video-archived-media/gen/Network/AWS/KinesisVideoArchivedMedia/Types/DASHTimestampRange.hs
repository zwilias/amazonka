...
data DASHTimestampRange = DASHTimestampRange'{_dashtrEndTimestamp
                                              :: !(Maybe POSIX),
...
dASHTimestampRange
    :: DASHTimestampRange
dASHTimestampRange
  = DASHTimestampRange'{_dashtrEndTimestamp = Nothing,
...
instance Hashable DASHTimestampRange where

instance NFData DASHTimestampRange where
