...
data ClipFragmentSelector = ClipFragmentSelector'{_cfsFragmentSelectorType
...
clipFragmentSelector
    :: ClipFragmentSelectorType -- ^ 'cfsFragmentSelectorType'
    -> ClipTimestampRange -- ^ 'cfsTimestampRange'
    -> ClipFragmentSelector
clipFragmentSelector pFragmentSelectorType_
  pTimestampRange_
  = ClipFragmentSelector'{_cfsFragmentSelectorType =
...
instance Hashable ClipFragmentSelector where

instance NFData ClipFragmentSelector where
