...
cmvbEntries ::
     Lens' ChangeMessageVisibilityBatch [ChangeMessageVisibilityBatchRequestEntry]
...
instance AWSRequest ChangeMessageVisibilityBatch where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         ChangeMessageVisibilityBatchResponse' <$> (pure (fromEnum s)) <*>
...
instance ToQuery ChangeMessageVisibilityBatch where
  toQuery ChangeMessageVisibilityBatch' {..} =
    mconcat
      ...
      , toQueryList "ChangeMessageVisibilityBatchRequestEntry" _cmvbEntries
      ]
...
cmvbrsResponseStatus =
  lens _cmvbrsResponseStatus (\s a -> s {_cmvbrsResponseStatus = a})

-- | A list of @'ChangeMessageVisibilityBatchResultEntry' @ items.
cmvbrsSuccessful ::
     Lens' ChangeMessageVisibilityBatchResponse [ChangeMessageVisibilityBatchResultEntry]
cmvbrsSuccessful =
  lens _cmvbrsSuccessful (\s a -> s {_cmvbrsSuccessful = a}) . _Coerce

-- | A list of @'BatchResultErrorEntry' @ items.
cmvbrsFailed ::
     Lens' ChangeMessageVisibilityBatchResponse [BatchResultErrorEntry]
