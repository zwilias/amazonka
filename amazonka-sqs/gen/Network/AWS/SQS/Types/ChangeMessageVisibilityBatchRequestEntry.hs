...
data ChangeMessageVisibilityBatchRequestEntry = ChangeMessageVisibilityBatchRequestEntry'{_cVisibilityTimeout
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Int),
                                                                                          _cId
...
changeMessageVisibilityBatchRequestEntry
    ...
    -> Text -- ^ 'cReceiptHandle'
    -> ChangeMessageVisibilityBatchRequestEntry
changeMessageVisibilityBatchRequestEntry pId_
  pReceiptHandle_
  = ChangeMessageVisibilityBatchRequestEntry'{_cVisibilityTimeout
                                                = Nothing,
                                              _cId = pId_,
