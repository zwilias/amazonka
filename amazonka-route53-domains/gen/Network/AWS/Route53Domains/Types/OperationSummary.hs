...
data OperationSummary = OperationSummary'{_osOperationId
                                          :: !Text,
...
operationSummary
    ...
    -> OperationSummary
operationSummary pOperationId_ pStatus_ pType_
  pSubmittedDate_
  = OperationSummary'{_osOperationId = pOperationId_,
                      _osStatus = pStatus_, _osType = pType_,
