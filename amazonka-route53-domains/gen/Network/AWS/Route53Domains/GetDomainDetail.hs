...
instance AWSRequest GetDomainDetail where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetDomainDetailResponse' <$> (x .?> "TechPrivacy") <*> (x .?> "DnsSec") <*>
         (x .?> "WhoIsServer") <*>
         (x .?> "RegistryDomainId") <*>
         (x .?> "RegistrantPrivacy") <*>
         (x .?> "UpdatedDate") <*>
...
gddrsUpdatedDate =
  lens _gddrsUpdatedDate (\s a -> s {_gddrsUpdatedDate = a}) . mapping _Time
...
gddrsCreationDate =
  lens _gddrsCreationDate (\s a -> s {_gddrsCreationDate = a}) . mapping _Time
...
gddrsStatusList =
  lens _gddrsStatusList (\s a -> s {_gddrsStatusList = a}) . _Default . _Coerce

-- | -- | The response status code.
gddrsResponseStatus :: Lens' GetDomainDetailResponse Int
gddrsResponseStatus =
  lens _gddrsResponseStatus (\s a -> s {_gddrsResponseStatus = a})
...
gddrsNameservers =
  lens _gddrsNameservers (\s a -> s {_gddrsNameservers = a}) . _Coerce

-- | Provides details about the domain administrative contact.
gddrsAdminContact :: Lens' GetDomainDetailResponse ContactDetail
gddrsAdminContact =
  lens _gddrsAdminContact (\s a -> s {_gddrsAdminContact = a}) . _Sensitive
...
gddrsTechContact =
  lens _gddrsTechContact (\s a -> s {_gddrsTechContact = a}) . _Sensitive
