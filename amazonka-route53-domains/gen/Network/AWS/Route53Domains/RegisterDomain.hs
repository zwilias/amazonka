...
rPrivacyProtectTechContact =
  lens _rPrivacyProtectTechContact (\s a -> s {_rPrivacyProtectTechContact = a})
...
rPrivacyProtectRegistrantContact =
  lens
    ...
    (\s a -> s {_rPrivacyProtectRegistrantContact = a})
...
rPrivacyProtectAdminContact =
  lens
    ...
    (\s a -> s {_rPrivacyProtectAdminContact = a})
...
rDurationInYears =
  lens _rDurationInYears (\s a -> s {_rDurationInYears = a}) . _Nat

-- | Provides detailed contact information.
rAdminContact :: Lens' RegisterDomain ContactDetail
rAdminContact =
  lens _rAdminContact (\s a -> s {_rAdminContact = a}) . _Sensitive

-- | Provides detailed contact information.
rRegistrantContact :: Lens' RegisterDomain ContactDetail
rRegistrantContact =
  lens _rRegistrantContact (\s a -> s {_rRegistrantContact = a}) . _Sensitive
...
instance AWSRequest RegisterDomain where
  ...
  response =
    receiveJSON
      (\s h x ->
         RegisterDomainResponse' <$> (pure (fromEnum s)) <*>
         (x .:> "OperationId"))
...
rdrsResponseStatus =
  lens _rdrsResponseStatus (\s a -> s {_rdrsResponseStatus = a})
