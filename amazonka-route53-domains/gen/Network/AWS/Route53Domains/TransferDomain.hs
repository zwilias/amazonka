...
tdNameservers =
  lens _tdNameservers (\s a -> s {_tdNameservers = a}) . _Default . _Coerce
...
tdDurationInYears =
  lens _tdDurationInYears (\s a -> s {_tdDurationInYears = a}) . _Nat

-- | Provides detailed contact information.
tdAdminContact :: Lens' TransferDomain ContactDetail
tdAdminContact =
  lens _tdAdminContact (\s a -> s {_tdAdminContact = a}) . _Sensitive

-- | Provides detailed contact information.
tdRegistrantContact :: Lens' TransferDomain ContactDetail
tdRegistrantContact =
  lens _tdRegistrantContact (\s a -> s {_tdRegistrantContact = a}) . _Sensitive

-- | Provides detailed contact information.
tdTechContact :: Lens' TransferDomain ContactDetail
tdTechContact =
  lens _tdTechContact (\s a -> s {_tdTechContact = a}) . _Sensitive
...
instance AWSRequest TransferDomain where
  ...
  response =
    receiveJSON
      (\s h x ->
         TransferDomainResponse' <$> (pure (fromEnum s)) <*>
         (x .:> "OperationId"))
...
tdrsResponseStatus =
  lens _tdrsResponseStatus (\s a -> s {_tdrsResponseStatus = a})
