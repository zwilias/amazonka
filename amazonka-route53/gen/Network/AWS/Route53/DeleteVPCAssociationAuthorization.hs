...
instance AWSRequest DeleteVPCAssociationAuthorization where
  type Rs DeleteVPCAssociationAuthorization = DeleteVPCAssociationAuthorizationResponse
...
instance ToXML DeleteVPCAssociationAuthorization where
  toXML DeleteVPCAssociationAuthorization' {..} = mconcat ["VPC" @= _dvaaVPC]
...
dvaarsResponseStatus =
  lens _dvaarsResponseStatus (\s a -> s {_dvaarsResponseStatus = a})
