...
data HostedZone = HostedZone'{_hzLinkedService ::
                              !(Maybe LinkedService),
                              _hzConfig :: !(Maybe HostedZoneConfig),
                              _hzResourceRecordSetCount :: !(Maybe Integer),
                              _hzId :: !ResourceId, _hzName :: !Text,
...
hostedZone pId_ pName_ pCallerReference_
  = HostedZone'{_hzLinkedService = Nothing,
                _hzConfig = Nothing,
                _hzResourceRecordSetCount = Nothing, _hzId = pId_,
                _hzName = pName_,
