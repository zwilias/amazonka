...
grprTermInYears ::
     Lens' GetReservationPurchaseRecommendation (Maybe TermInYears)
...
grprServiceSpecification ::
     Lens' GetReservationPurchaseRecommendation (Maybe ServiceSpecification)
grprServiceSpecification =
  lens _grprServiceSpecification (\s a -> s {_grprServiceSpecification = a})
...
grprAccountScope ::
     Lens' GetReservationPurchaseRecommendation (Maybe AccountScope)
...
grprLookbackPeriodInDays ::
     Lens' GetReservationPurchaseRecommendation (Maybe LookbackPeriodInDays)
grprLookbackPeriodInDays =
  lens _grprLookbackPeriodInDays (\s a -> s {_grprLookbackPeriodInDays = a})

-- | The reservation purchase option that you want recommendations for.
grprPaymentOption ::
     Lens' GetReservationPurchaseRecommendation (Maybe PaymentOption)
...
instance AWSRequest GetReservationPurchaseRecommendation where
  type Rs GetReservationPurchaseRecommendation = GetReservationPurchaseRecommendationResponse
...
instance ToHeaders GetReservationPurchaseRecommendation where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AWSInsightsIndexService.GetReservationPurchaseRecommendation" :: ByteString)
...
grprrsNextPageToken ::
     Lens' GetReservationPurchaseRecommendationResponse (Maybe Text)
grprrsNextPageToken =
  lens _grprrsNextPageToken (\s a -> s {_grprrsNextPageToken = a})

-- | Recommendations for reservations to purchase.
grprrsRecommendations ::
     Lens' GetReservationPurchaseRecommendationResponse [ReservationPurchaseRecommendation]
grprrsRecommendations =
  lens _grprrsRecommendations (\s a -> s {_grprrsRecommendations = a}) .
  _Default . _Coerce

-- | Information about this specific recommendation call, such as the time stamp for when Cost Explorer generated this recommendation.
grprrsMetadata ::
     Lens' GetReservationPurchaseRecommendationResponse (Maybe ReservationPurchaseRecommendationMetadata)
...
grprrsResponseStatus =
  lens _grprrsResponseStatus (\s a -> s {_grprrsResponseStatus = a})
