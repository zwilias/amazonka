...
instance AWSRequest CreateCostCategoryDefinition
         where
...
instance Hashable CreateCostCategoryDefinition where

instance NFData CreateCostCategoryDefinition where
