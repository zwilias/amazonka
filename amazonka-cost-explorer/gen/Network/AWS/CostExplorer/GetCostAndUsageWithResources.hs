...
--
-- * 'gcauwrGroupBy' - You can group Amazon Web Services costs using up to two different groups: either dimensions, tag keys, or both.
--
...
gcauwrFilter :: Lens' GetCostAndUsageWithResources (Maybe Expression)
