...
instance AWSRequest GetSavingsPlansUtilizationDetails
         where
...
instance ToHeaders GetSavingsPlansUtilizationDetails
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON GetSavingsPlansUtilizationDetails
         where
...
instance ToPath GetSavingsPlansUtilizationDetails
         where
        toPath = const "/"

instance ToQuery GetSavingsPlansUtilizationDetails
         where
