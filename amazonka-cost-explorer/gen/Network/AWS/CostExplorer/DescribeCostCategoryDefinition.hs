...
instance AWSRequest DescribeCostCategoryDefinition
         where
...
instance NFData DescribeCostCategoryDefinition where

instance ToHeaders DescribeCostCategoryDefinition
         where
        toHeaders
          = const
              (mconcat
