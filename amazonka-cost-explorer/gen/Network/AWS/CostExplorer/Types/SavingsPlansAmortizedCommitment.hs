...
data SavingsPlansAmortizedCommitment = SavingsPlansAmortizedCommitment'{_spacAmortizedUpfrontCommitment
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
savingsPlansAmortizedCommitment
    :: SavingsPlansAmortizedCommitment
savingsPlansAmortizedCommitment
  = SavingsPlansAmortizedCommitment'{_spacAmortizedUpfrontCommitment
                                       = Nothing,
