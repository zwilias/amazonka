...
data SavingsPlansDetails = SavingsPlansDetails'{_spdInstanceFamily
                                                :: !(Maybe Text),
...
savingsPlansDetails
    :: SavingsPlansDetails
savingsPlansDetails
  = SavingsPlansDetails'{_spdInstanceFamily = Nothing,
                         _spdOfferingId = Nothing, _spdRegion = Nothing}
