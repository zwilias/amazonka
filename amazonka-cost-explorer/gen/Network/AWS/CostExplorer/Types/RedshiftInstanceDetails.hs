...
data RedshiftInstanceDetails = RedshiftInstanceDetails'{_rCurrentGeneration
                                                        :: !(Maybe Bool),
                                                        _rFamily ::
                                                        !(Maybe Text),
                                                        _rSizeFlexEligible ::
...
redshiftInstanceDetails
    :: RedshiftInstanceDetails
redshiftInstanceDetails
  = RedshiftInstanceDetails'{_rCurrentGeneration =
                               Nothing,
                             _rFamily = Nothing, _rSizeFlexEligible = Nothing,
                             _rRegion = Nothing, _rNodeType = Nothing}
