...
data SavingsPlansUtilizationByTime = SavingsPlansUtilizationByTime'{_spubtAmortizedCommitment
                                                                    ::
                                                                    !(Maybe
...
savingsPlansUtilizationByTime
    ...
    -> SavingsPlansUtilizationByTime
savingsPlansUtilizationByTime pTimePeriod_
  pUtilization_
  = SavingsPlansUtilizationByTime'{_spubtAmortizedCommitment
                                     = Nothing,
