...
--
-- * 'gspprAccountScope' - The account scope that you want your recommendations for. Amazon Web Services calculates recommendations including the payer account and linked accounts if the value is set to @PAYER@ . If the value is @LINKED@ , recommendations are calculated for individual linked accounts only.
--
...
--
-- * 'gspprTermInYears' - The savings plan recommendation term used to generated these recommendations.
--
