...
instance AWSRequest UpdateCostCategoryDefinition
         where
...
instance Hashable UpdateCostCategoryDefinition where

instance NFData UpdateCostCategoryDefinition where
