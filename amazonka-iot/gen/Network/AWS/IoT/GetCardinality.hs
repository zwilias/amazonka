...
data GetCardinality = GetCardinality'{_gcQueryVersion
                                      :: !(Maybe Text),
...
getCardinality pQueryString_
  = GetCardinality'{_gcQueryVersion = Nothing,
...
instance Hashable GetCardinality where

instance NFData GetCardinality where
...
data GetCardinalityResponse = GetCardinalityResponse'{_gcrsCardinality
                                                      :: !(Maybe Int),
                                                      _gcrsResponseStatus ::
                                                      !Int}
...
getCardinalityResponse pResponseStatus_
  = GetCardinalityResponse'{_gcrsCardinality = Nothing,
...
instance NFData GetCardinalityResponse where
