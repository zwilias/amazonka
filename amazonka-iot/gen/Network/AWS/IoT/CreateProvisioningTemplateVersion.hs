...
data CreateProvisioningTemplateVersion = CreateProvisioningTemplateVersion'{_cptvSetAsDefault
                                                                            ::
                                                                            !(Maybe
                                                                                Bool),
                                                                            _cptvTemplateName
...
createProvisioningTemplateVersion
    :: Text -- ^ 'cptvTemplateName'
    -> Text -- ^ 'cptvTemplateBody'
    -> CreateProvisioningTemplateVersion
createProvisioningTemplateVersion pTemplateName_
  pTemplateBody_
  = CreateProvisioningTemplateVersion'{_cptvSetAsDefault
                                         = Nothing,
...
instance AWSRequest CreateProvisioningTemplateVersion
         where
...
instance ToHeaders CreateProvisioningTemplateVersion
         where
        toHeaders = const mempty

instance ToJSON CreateProvisioningTemplateVersion
         where
...
instance ToPath CreateProvisioningTemplateVersion
         where
        toPath CreateProvisioningTemplateVersion'{..}
          = mconcat
              ["/provisioning-templates/", toBS _cptvTemplateName,
               "/versions"]

instance ToQuery CreateProvisioningTemplateVersion
         where
...
data CreateProvisioningTemplateVersionResponse = CreateProvisioningTemplateVersionResponse'{_cptvrsVersionId
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Int),
                                                                                            _cptvrsTemplateName
...
createProvisioningTemplateVersionResponse
    :: Int -- ^ 'cptvrsResponseStatus'
    -> CreateProvisioningTemplateVersionResponse
createProvisioningTemplateVersionResponse
  pResponseStatus_
  = CreateProvisioningTemplateVersionResponse'{_cptvrsVersionId
                                                 = Nothing,
