...
data ListAuditTasks = ListAuditTasks'{_latTaskType ::
                                      !(Maybe AuditTaskType),
...
--
-- * 'latStartTime' - The beginning of the time period. Audit information is retained for a limited time (180 days). Requesting a start time prior to what is retained results in an "InvalidRequestException".
--
-- * 'latEndTime' - The end of the time period.
listAuditTasks
    :: UTCTime -- ^ 'latStartTime'
    -> UTCTime -- ^ 'latEndTime'
    -> ListAuditTasks
listAuditTasks pStartTime_ pEndTime_
  = ListAuditTasks'{_latTaskType = Nothing,
                    _latNextToken = Nothing, _latMaxResults = Nothing,
...
instance Hashable ListAuditTasks where

instance NFData ListAuditTasks where
...
data ListAuditTasksResponse = ListAuditTasksResponse'{_latrsTasks
                                                      ::
                                                      !(Maybe
                                                          [AuditTaskMetadata]),
                                                      _latrsNextToken ::
...
listAuditTasksResponse pResponseStatus_
  = ListAuditTasksResponse'{_latrsTasks = Nothing,
...
instance NFData ListAuditTasksResponse where
