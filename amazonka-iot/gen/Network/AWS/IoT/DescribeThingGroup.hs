...
instance AWSRequest DescribeThingGroup where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeThingGroupResponse' <$> (x .?> "thingGroupArn") <*>
         (x .?> "thingGroupId") <*>
...
dtgrsThingGroupARN =
  lens _dtgrsThingGroupARN (\s a -> s {_dtgrsThingGroupARN = a})
...
dtgrsThingGroupMetadata ::
     Lens' DescribeThingGroupResponse (Maybe ThingGroupMetadata)
dtgrsThingGroupMetadata =
  lens _dtgrsThingGroupMetadata (\s a -> s {_dtgrsThingGroupMetadata = a})

-- | The name of the thing group.
dtgrsThingGroupName :: Lens' DescribeThingGroupResponse (Maybe Text)
dtgrsThingGroupName =
  lens _dtgrsThingGroupName (\s a -> s {_dtgrsThingGroupName = a})
...
dtgrsThingGroupProperties ::
     Lens' DescribeThingGroupResponse (Maybe ThingGroupProperties)
dtgrsThingGroupProperties =
  lens _dtgrsThingGroupProperties (\s a -> s {_dtgrsThingGroupProperties = a})
