...
data ListAuditMitigationActionsTasks = ListAuditMitigationActionsTasks'{_lamatAuditTaskId
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _lamatNextToken
...
listAuditMitigationActionsTasks
    :: UTCTime -- ^ 'lamatStartTime'
    -> UTCTime -- ^ 'lamatEndTime'
    -> ListAuditMitigationActionsTasks
listAuditMitigationActionsTasks pStartTime_ pEndTime_
  = ListAuditMitigationActionsTasks'{_lamatAuditTaskId
                                       = Nothing,
...
instance AWSRequest ListAuditMitigationActionsTasks
         where
...
instance NFData ListAuditMitigationActionsTasks where

instance ToHeaders ListAuditMitigationActionsTasks
         where
...
instance ToQuery ListAuditMitigationActionsTasks
         where
...
data ListAuditMitigationActionsTasksResponse = ListAuditMitigationActionsTasksResponse'{_lamatrsTasks
                                                                                        ::
                                                                                        !(Maybe
...
listAuditMitigationActionsTasksResponse
    :: Int -- ^ 'lamatrsResponseStatus'
    -> ListAuditMitigationActionsTasksResponse
listAuditMitigationActionsTasksResponse
  pResponseStatus_
  = ListAuditMitigationActionsTasksResponse'{_lamatrsTasks
                                               = Nothing,
