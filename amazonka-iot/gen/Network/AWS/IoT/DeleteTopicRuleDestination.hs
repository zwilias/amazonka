...
newtype DeleteTopicRuleDestination = DeleteTopicRuleDestination'{_dtrdArn
                                                                 :: Text}
...
instance Hashable DeleteTopicRuleDestination where

instance NFData DeleteTopicRuleDestination where
...
newtype DeleteTopicRuleDestinationResponse = DeleteTopicRuleDestinationResponse'{_dtrdrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
deleteTopicRuleDestinationResponse
    :: Int -- ^ 'dtrdrsResponseStatus'
    -> DeleteTopicRuleDestinationResponse
deleteTopicRuleDestinationResponse pResponseStatus_
  = DeleteTopicRuleDestinationResponse'{_dtrdrsResponseStatus
                                          = pResponseStatus_}
