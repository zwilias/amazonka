...
data ListDomainConfigurations = ListDomainConfigurations'{_ldcMarker
                                                          :: !(Maybe Text),
                                                          _ldcServiceType ::
                                                          !(Maybe ServiceType),
                                                          _ldcPageSize ::
...
listDomainConfigurations
    :: ListDomainConfigurations
listDomainConfigurations
  = ListDomainConfigurations'{_ldcMarker = Nothing,
                              _ldcServiceType = Nothing, _ldcPageSize = Nothing}
...
instance AWSRequest ListDomainConfigurations where
        type Rs ListDomainConfigurations =
             ListDomainConfigurationsResponse
        request = get ioT
        response
          = receiveJSON
...
instance Hashable ListDomainConfigurations where

instance NFData ListDomainConfigurations where
...
data ListDomainConfigurationsResponse = ListDomainConfigurationsResponse'{_ldcrsDomainConfigurations
                                                                          ::
                                                                          !(Maybe
...
listDomainConfigurationsResponse pResponseStatus_
  = ListDomainConfigurationsResponse'{_ldcrsDomainConfigurations
                                        = Nothing,
