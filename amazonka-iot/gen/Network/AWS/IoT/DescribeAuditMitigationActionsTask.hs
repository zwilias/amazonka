...
newtype DescribeAuditMitigationActionsTask = DescribeAuditMitigationActionsTask'{_damatTaskId
                                                                                 ::
                                                                                 Text}
...
describeAuditMitigationActionsTask pTaskId_
  = DescribeAuditMitigationActionsTask'{_damatTaskId =
                                          pTaskId_}
...
instance ToHeaders DescribeAuditMitigationActionsTask
         where
        toHeaders = const mempty

instance ToPath DescribeAuditMitigationActionsTask
         where
...
instance ToQuery DescribeAuditMitigationActionsTask
         where
        toQuery = const mempty

-- | /See:/ 'describeAuditMitigationActionsTaskResponse' smart constructor.
data DescribeAuditMitigationActionsTaskResponse = DescribeAuditMitigationActionsTaskResponse'{_damatrsStartTime
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  POSIX),
...
describeAuditMitigationActionsTaskResponse
    :: Int -- ^ 'damatrsResponseStatus'
    -> DescribeAuditMitigationActionsTaskResponse
describeAuditMitigationActionsTaskResponse
  pResponseStatus_
  = DescribeAuditMitigationActionsTaskResponse'{_damatrsStartTime
                                                  = Nothing,
                                                _damatrsTaskStatistics =
                                                  Nothing,
                                                _damatrsActionsDefinition =
