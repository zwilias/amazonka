...
data ListTopicRuleDestinations = ListTopicRuleDestinations'{_ltrdNextToken
                                                            :: !(Maybe Text),
                                                            _ltrdMaxResults ::
                                                            !(Maybe Nat)}
...
--
-- * 'ltrdNextToken' - The token to retrieve the next set of results.
--
-- * 'ltrdMaxResults' - The maximum number of results to return at one time.
listTopicRuleDestinations
    :: ListTopicRuleDestinations
listTopicRuleDestinations
  = ListTopicRuleDestinations'{_ltrdNextToken =
                                 Nothing,
...
instance Hashable ListTopicRuleDestinations where

instance NFData ListTopicRuleDestinations where
...
data ListTopicRuleDestinationsResponse = ListTopicRuleDestinationsResponse'{_ltrdrsDestinationSummaries
                                                                            ::
                                                                            !(Maybe
...
--
-- * 'ltrdrsNextToken' - The token to retrieve the next set of results.
--
-- * 'ltrdrsResponseStatus' - -- | The response status code.
listTopicRuleDestinationsResponse
    :: Int -- ^ 'ltrdrsResponseStatus'
    -> ListTopicRuleDestinationsResponse
listTopicRuleDestinationsResponse pResponseStatus_
  = ListTopicRuleDestinationsResponse'{_ltrdrsDestinationSummaries
                                         = Nothing,
