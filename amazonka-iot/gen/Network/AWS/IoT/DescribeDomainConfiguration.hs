...
newtype DescribeDomainConfiguration = DescribeDomainConfiguration'{_ddcDomainConfigurationName
                                                                   :: Text}
...
describeDomainConfiguration
    :: Text -- ^ 'ddcDomainConfigurationName'
    -> DescribeDomainConfiguration
describeDomainConfiguration pDomainConfigurationName_
  = DescribeDomainConfiguration'{_ddcDomainConfigurationName
...
instance Hashable DescribeDomainConfiguration where

instance NFData DescribeDomainConfiguration where
...
data DescribeDomainConfigurationResponse = DescribeDomainConfigurationResponse'{_ddcrsDomainConfigurationName
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
describeDomainConfigurationResponse pResponseStatus_
  = DescribeDomainConfigurationResponse'{_ddcrsDomainConfigurationName
                                           = Nothing,
