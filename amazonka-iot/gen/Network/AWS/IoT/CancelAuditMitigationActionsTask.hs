...
newtype CancelAuditMitigationActionsTask = CancelAuditMitigationActionsTask'{_camatTaskId
                                                                             ::
                                                                             Text}
...
cancelAuditMitigationActionsTask pTaskId_
  = CancelAuditMitigationActionsTask'{_camatTaskId =
                                        pTaskId_}
...
instance AWSRequest CancelAuditMitigationActionsTask
         where
...
instance ToHeaders CancelAuditMitigationActionsTask
         where
        toHeaders = const mempty

instance ToJSON CancelAuditMitigationActionsTask
         where
        toJSON = const (Object mempty)

instance ToPath CancelAuditMitigationActionsTask
         where
        toPath CancelAuditMitigationActionsTask'{..}
          = mconcat
              ["/audit/mitigationactions/tasks/",
               toBS _camatTaskId, "/cancel"]

instance ToQuery CancelAuditMitigationActionsTask
         where
        toQuery = const mempty

-- | /See:/ 'cancelAuditMitigationActionsTaskResponse' smart constructor.
newtype CancelAuditMitigationActionsTaskResponse = CancelAuditMitigationActionsTaskResponse'{_camatrsResponseStatus
                                                                                             ::
                                                                                             Int}
...
cancelAuditMitigationActionsTaskResponse
    :: Int -- ^ 'camatrsResponseStatus'
    -> CancelAuditMitigationActionsTaskResponse
cancelAuditMitigationActionsTaskResponse
  pResponseStatus_
  = CancelAuditMitigationActionsTaskResponse'{_camatrsResponseStatus
                                                = pResponseStatus_}
