...
data GetStatistics = GetStatistics'{_gsQueryVersion
                                    :: !(Maybe Text),
...
getStatistics pQueryString_
  = GetStatistics'{_gsQueryVersion = Nothing,
...
instance Hashable GetStatistics where

instance NFData GetStatistics where
...
data GetStatisticsResponse = GetStatisticsResponse'{_gsrsStatistics
                                                    :: !(Maybe Statistics),
...
getStatisticsResponse pResponseStatus_
  = GetStatisticsResponse'{_gsrsStatistics = Nothing,
...
instance NFData GetStatisticsResponse where
