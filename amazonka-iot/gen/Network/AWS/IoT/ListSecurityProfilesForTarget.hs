...
data ListSecurityProfilesForTarget = ListSecurityProfilesForTarget'{_lspftNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _lspftRecursive
...
listSecurityProfilesForTarget
    :: Text -- ^ 'lspftSecurityProfileTargetARN'
    -> ListSecurityProfilesForTarget
listSecurityProfilesForTarget
  pSecurityProfileTargetARN_
  = ListSecurityProfilesForTarget'{_lspftNextToken =
                                     Nothing,
...
instance AWSPager ListSecurityProfilesForTarget where
        page rq rs
          ...
          | stop (rs ^. lspftrsSecurityProfileTargetMappings) =
            Nothing
          | otherwise =
            Just $ rq & lspftNextToken .~ rs ^. lspftrsNextToken

instance AWSRequest ListSecurityProfilesForTarget
         where
...
instance Hashable ListSecurityProfilesForTarget where

instance NFData ListSecurityProfilesForTarget where

instance ToHeaders ListSecurityProfilesForTarget
         where
...
data ListSecurityProfilesForTargetResponse = ListSecurityProfilesForTargetResponse'{_lspftrsNextToken
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
listSecurityProfilesForTargetResponse
    :: Int -- ^ 'lspftrsResponseStatus'
    -> ListSecurityProfilesForTargetResponse
listSecurityProfilesForTargetResponse
  pResponseStatus_
  = ListSecurityProfilesForTargetResponse'{_lspftrsNextToken
                                             = Nothing,
                                           _lspftrsSecurityProfileTargetMappings
                                             = Nothing,
                                           _lspftrsResponseStatus =
