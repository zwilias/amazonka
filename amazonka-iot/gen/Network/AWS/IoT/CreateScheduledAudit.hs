...
data CreateScheduledAudit = CreateScheduledAudit'{_csaDayOfMonth
                                                  :: !(Maybe Text),
                                                  _csaDayOfWeek ::
                                                  !(Maybe DayOfWeek),
                                                  _csaTags :: !(Maybe [Tag]),
...
createScheduledAudit
    :: AuditFrequency -- ^ 'csaFrequency'
    -> Text -- ^ 'csaScheduledAuditName'
    -> CreateScheduledAudit
createScheduledAudit pFrequency_ pScheduledAuditName_
  = CreateScheduledAudit'{_csaDayOfMonth = Nothing,
                          _csaDayOfWeek = Nothing, _csaTags = Nothing,
...
instance Hashable CreateScheduledAudit where

instance NFData CreateScheduledAudit where
...
data CreateScheduledAuditResponse = CreateScheduledAuditResponse'{_csarsScheduledAuditARN
                                                                  ::
                                                                  !(Maybe Text),
...
createScheduledAuditResponse pResponseStatus_
  = CreateScheduledAuditResponse'{_csarsScheduledAuditARN
                                    = Nothing,
...
instance NFData CreateScheduledAuditResponse where
