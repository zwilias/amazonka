...
newtype DescribeMitigationAction = DescribeMitigationAction'{_dActionName
                                                             :: Text}
...
describeMitigationAction pActionName_
  = DescribeMitigationAction'{_dActionName =
                                pActionName_}
...
instance AWSRequest DescribeMitigationAction where
        type Rs DescribeMitigationAction =
             DescribeMitigationActionResponse
        request = get ioT
        response
          = receiveJSON
              (\ s h x ->
                 DescribeMitigationActionResponse' <$>
                   (x .?> "lastModifiedDate") <*> (x .?> "actionParams")
                     <*> (x .?> "actionId")
                     <*> (x .?> "actionName")
                     <*> (x .?> "creationDate")
                     <*> (x .?> "actionArn")
...
instance Hashable DescribeMitigationAction where

instance NFData DescribeMitigationAction where
...
data DescribeMitigationActionResponse = DescribeMitigationActionResponse'{_desrsLastModifiedDate
                                                                          ::
                                                                          !(Maybe
                                                                              POSIX),
                                                                          _desrsActionParams
...
describeMitigationActionResponse pResponseStatus_
  = DescribeMitigationActionResponse'{_desrsLastModifiedDate
                                        = Nothing,
