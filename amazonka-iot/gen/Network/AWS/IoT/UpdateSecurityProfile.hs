...
data UpdateSecurityProfile = UpdateSecurityProfile'{_uspAlertTargets
                                                    ::
                                                    !(Maybe
                                                        (Map AlertTargetType
                                                           AlertTarget)),
...
--
-- * 'uspAdditionalMetricsToRetain' - A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's @behaviors@ , but it is also retained for any metric specified here. __Note:__ This API field is deprecated. Please use 'UpdateSecurityProfileRequest$additionalMetricsToRetainV2' instead.
--
...
updateSecurityProfile
    :: Text -- ^ 'uspSecurityProfileName'
    -> UpdateSecurityProfile
updateSecurityProfile pSecurityProfileName_
  = UpdateSecurityProfile'{_uspAlertTargets = Nothing,
...
-- | A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's @behaviors@ , but it is also retained for any metric specified here. __Note:__ This API field is deprecated. Please use 'UpdateSecurityProfileRequest$additionalMetricsToRetainV2' instead.
...
instance Hashable UpdateSecurityProfile where

instance NFData UpdateSecurityProfile where
...
data UpdateSecurityProfileResponse = UpdateSecurityProfileResponse'{_usprsAlertTargets
                                                                    ::
                                                                    !(Maybe
                                                                        (Map
                                                                           AlertTargetType
...
--
-- * 'usprsAdditionalMetricsToRetain' - A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the security profile's @behaviors@ , but it is also retained for any metric specified here. __Note:__ This API field is deprecated. Please use 'UpdateSecurityProfileResponse$additionalMetricsToRetainV2' instead.
--
...
updateSecurityProfileResponse pResponseStatus_
  = UpdateSecurityProfileResponse'{_usprsAlertTargets =
                                     Nothing,
...
instance NFData UpdateSecurityProfileResponse where
