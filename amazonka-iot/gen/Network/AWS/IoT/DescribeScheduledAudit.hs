...
newtype DescribeScheduledAudit = DescribeScheduledAudit'{_dScheduledAuditName
                                                         :: Text}
...
describeScheduledAudit
    :: Text -- ^ 'dScheduledAuditName'
    -> DescribeScheduledAudit
describeScheduledAudit pScheduledAuditName_
  = DescribeScheduledAudit'{_dScheduledAuditName =
...
instance AWSRequest DescribeScheduledAudit where
        type Rs DescribeScheduledAudit =
             DescribeScheduledAuditResponse
        request = get ioT
        response
          = receiveJSON
              (\ s h x ->
                 DescribeScheduledAuditResponse' <$>
                   (x .?> "frequency") <*> (x .?> "scheduledAuditName")
                     <*> (x .?> "dayOfMonth")
...
instance Hashable DescribeScheduledAudit where

instance NFData DescribeScheduledAudit where
...
data DescribeScheduledAuditResponse = DescribeScheduledAuditResponse'{_dsarsFrequency
                                                                      ::
                                                                      !(Maybe
                                                                          AuditFrequency),
...
describeScheduledAuditResponse pResponseStatus_
  = DescribeScheduledAuditResponse'{_dsarsFrequency =
                                      Nothing,
...
instance NFData DescribeScheduledAuditResponse where
