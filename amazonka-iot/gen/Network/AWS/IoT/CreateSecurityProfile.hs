...
data CreateSecurityProfile = CreateSecurityProfile'{_cspAlertTargets
                                                    ::
                                                    !(Maybe
                                                        (Map AlertTargetType
                                                           AlertTarget)),
...
--
-- * 'cspAdditionalMetricsToRetain' - A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's @behaviors@ , but it is also retained for any metric specified here. __Note:__ This API field is deprecated. Please use 'CreateSecurityProfileRequest$additionalMetricsToRetainV2' instead.
--
...
createSecurityProfile
    :: Text -- ^ 'cspSecurityProfileName'
    -> CreateSecurityProfile
createSecurityProfile pSecurityProfileName_
  = CreateSecurityProfile'{_cspAlertTargets = Nothing,
...
-- | A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's @behaviors@ , but it is also retained for any metric specified here. __Note:__ This API field is deprecated. Please use 'CreateSecurityProfileRequest$additionalMetricsToRetainV2' instead.
...
instance Hashable CreateSecurityProfile where

instance NFData CreateSecurityProfile where
...
data CreateSecurityProfileResponse = CreateSecurityProfileResponse'{_csprsSecurityProfileName
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
createSecurityProfileResponse pResponseStatus_
  = CreateSecurityProfileResponse'{_csprsSecurityProfileName
                                     = Nothing,
...
instance NFData CreateSecurityProfileResponse where
