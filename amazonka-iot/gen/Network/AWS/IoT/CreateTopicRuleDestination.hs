...
newtype CreateTopicRuleDestination = CreateTopicRuleDestination'{_ctrdDestinationConfiguration
                                                                 ::
...
createTopicRuleDestination
    :: TopicRuleDestinationConfiguration -- ^ 'ctrdDestinationConfiguration'
    -> CreateTopicRuleDestination
createTopicRuleDestination pDestinationConfiguration_
  = CreateTopicRuleDestination'{_ctrdDestinationConfiguration
...
instance Hashable CreateTopicRuleDestination where

instance NFData CreateTopicRuleDestination where
...
data CreateTopicRuleDestinationResponse = CreateTopicRuleDestinationResponse'{_crsTopicRuleDestination
                                                                              ::
                                                                              !(Maybe
...
createTopicRuleDestinationResponse pResponseStatus_
  = CreateTopicRuleDestinationResponse'{_crsTopicRuleDestination
                                          = Nothing,
