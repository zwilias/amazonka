...
data CreateMitigationAction = CreateMitigationAction'{_cTags
                                                      :: !(Maybe [Tag]),
                                                      _cActionName :: !Text,
                                                      _cRoleARN :: !Text,
                                                      _cActionParams ::
...
createMitigationAction
    :: Text -- ^ 'cActionName'
    -> Text -- ^ 'cRoleARN'
    -> MitigationActionParams -- ^ 'cActionParams'
    -> CreateMitigationAction
createMitigationAction pActionName_ pRoleARN_
  pActionParams_
  = CreateMitigationAction'{_cTags = Nothing,
                            _cActionName = pActionName_, _cRoleARN = pRoleARN_,
...
instance AWSRequest CreateMitigationAction where
        type Rs CreateMitigationAction =
             CreateMitigationActionResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CreateMitigationActionResponse' <$>
                   (x .?> "actionId") <*> (x .?> "actionArn") <*>
                     (pure (fromEnum s)))

instance Hashable CreateMitigationAction where

instance NFData CreateMitigationAction where
...
data CreateMitigationActionResponse = CreateMitigationActionResponse'{_cmarsActionId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _cmarsActionARN
...
createMitigationActionResponse
    :: Int -- ^ 'cmarsResponseStatus'
    -> CreateMitigationActionResponse
createMitigationActionResponse pResponseStatus_
  = CreateMitigationActionResponse'{_cmarsActionId =
                                      Nothing,
...
instance NFData CreateMitigationActionResponse where
