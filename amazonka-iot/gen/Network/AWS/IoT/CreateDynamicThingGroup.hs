...
data CreateDynamicThingGroup = CreateDynamicThingGroup'{_cdtgQueryVersion
                                                        :: !(Maybe Text),
...
createDynamicThingGroup
    :: Text -- ^ 'cdtgThingGroupName'
    -> Text -- ^ 'cdtgQueryString'
    -> CreateDynamicThingGroup
createDynamicThingGroup pThingGroupName_
  pQueryString_
  = CreateDynamicThingGroup'{_cdtgQueryVersion =
                               Nothing,
                             _cdtgThingGroupProperties = Nothing,
                             _cdtgIndexName = Nothing, _cdtgTags = Nothing,
...
instance AWSRequest CreateDynamicThingGroup where
        type Rs CreateDynamicThingGroup =
             CreateDynamicThingGroupResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CreateDynamicThingGroupResponse' <$>
                   (x .?> "queryVersion") <*> (x .?> "thingGroupArn")
                     <*> (x .?> "thingGroupId")
                     <*> (x .?> "thingGroupName")
                     <*> (x .?> "queryString")
                     <*> (x .?> "indexName")
...
instance Hashable CreateDynamicThingGroup where

instance NFData CreateDynamicThingGroup where
...
data CreateDynamicThingGroupResponse = CreateDynamicThingGroupResponse'{_cdtgrsQueryVersion
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
createDynamicThingGroupResponse
    :: Int -- ^ 'cdtgrsResponseStatus'
    -> CreateDynamicThingGroupResponse
createDynamicThingGroupResponse pResponseStatus_
  = CreateDynamicThingGroupResponse'{_cdtgrsQueryVersion
                                       = Nothing,
...
instance NFData CreateDynamicThingGroupResponse where
