...
data RegisterCertificateWithoutCA = RegisterCertificateWithoutCA'{_rcwcaStatus
                                                                  ::
                                                                  !(Maybe
                                                                      CertificateStatus),
...
registerCertificateWithoutCA
    :: Text -- ^ 'rcwcaCertificatePem'
    -> RegisterCertificateWithoutCA
registerCertificateWithoutCA pCertificatePem_
  = RegisterCertificateWithoutCA'{_rcwcaStatus =
                                    Nothing,
...
instance AWSRequest RegisterCertificateWithoutCA
         where
...
instance Hashable RegisterCertificateWithoutCA where

instance NFData RegisterCertificateWithoutCA where
...
data RegisterCertificateWithoutCAResponse = RegisterCertificateWithoutCAResponse'{_rcwcarsCertificateARN
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
registerCertificateWithoutCAResponse
    :: Int -- ^ 'rcwcarsResponseStatus'
    -> RegisterCertificateWithoutCAResponse
registerCertificateWithoutCAResponse pResponseStatus_
  = RegisterCertificateWithoutCAResponse'{_rcwcarsCertificateARN
                                            = Nothing,
