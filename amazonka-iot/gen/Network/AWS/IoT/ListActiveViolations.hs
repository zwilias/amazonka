...
data ListActiveViolations = ListActiveViolations'{_lavNextToken
                                                  :: !(Maybe Text),
...
listActiveViolations
    :: ListActiveViolations
listActiveViolations
  = ListActiveViolations'{_lavNextToken = Nothing,
                          _lavSecurityProfileName = Nothing,
                          _lavThingName = Nothing, _lavMaxResults = Nothing}
...
instance Hashable ListActiveViolations where

instance NFData ListActiveViolations where
...
data ListActiveViolationsResponse = ListActiveViolationsResponse'{_lavrsActiveViolations
                                                                  ::
                                                                  !(Maybe
                                                                      [ActiveViolation]),
                                                                  _lavrsNextToken
...
listActiveViolationsResponse pResponseStatus_
  = ListActiveViolationsResponse'{_lavrsActiveViolations
                                    = Nothing,
...
instance NFData ListActiveViolationsResponse where
