...
data AddThingToBillingGroup = AddThingToBillingGroup'{_attbgThingARN
                                                      :: !(Maybe Text),
...
addThingToBillingGroup
    :: AddThingToBillingGroup
addThingToBillingGroup
  = AddThingToBillingGroup'{_attbgThingARN = Nothing,
...
instance AWSRequest AddThingToBillingGroup where
        type Rs AddThingToBillingGroup =
             AddThingToBillingGroupResponse
        request = putJSON ioT
        response
          = receiveEmpty
...
instance Hashable AddThingToBillingGroup where

instance NFData AddThingToBillingGroup where
...
newtype AddThingToBillingGroupResponse = AddThingToBillingGroupResponse'{_attbgrsResponseStatus
                                                                         :: Int}
...
addThingToBillingGroupResponse
    :: Int -- ^ 'attbgrsResponseStatus'
    -> AddThingToBillingGroupResponse
addThingToBillingGroupResponse pResponseStatus_
  = AddThingToBillingGroupResponse'{_attbgrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData AddThingToBillingGroupResponse where
