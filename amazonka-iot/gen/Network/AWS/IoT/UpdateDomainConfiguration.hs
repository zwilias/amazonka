...
data UpdateDomainConfiguration = UpdateDomainConfiguration'{_udcAuthorizerConfig
                                                            ::
                                                            !(Maybe
                                                                AuthorizerConfig),
...
updateDomainConfiguration
    :: Text -- ^ 'udcDomainConfigurationName'
    -> UpdateDomainConfiguration
updateDomainConfiguration pDomainConfigurationName_
  = UpdateDomainConfiguration'{_udcAuthorizerConfig =
                                 Nothing,
...
instance Hashable UpdateDomainConfiguration where

instance NFData UpdateDomainConfiguration where
...
data UpdateDomainConfigurationResponse = UpdateDomainConfigurationResponse'{_udcrsDomainConfigurationName
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
updateDomainConfigurationResponse pResponseStatus_
  = UpdateDomainConfigurationResponse'{_udcrsDomainConfigurationName
                                         = Nothing,
