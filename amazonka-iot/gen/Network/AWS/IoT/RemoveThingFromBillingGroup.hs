...
data RemoveThingFromBillingGroup = RemoveThingFromBillingGroup'{_rtfbgThingARN
                                                                ::
                                                                !(Maybe Text),
...
removeThingFromBillingGroup
    :: RemoveThingFromBillingGroup
removeThingFromBillingGroup
  = RemoveThingFromBillingGroup'{_rtfbgThingARN =
                                   Nothing,
...
instance Hashable RemoveThingFromBillingGroup where

instance NFData RemoveThingFromBillingGroup where
...
newtype RemoveThingFromBillingGroupResponse = RemoveThingFromBillingGroupResponse'{_rtfbgrsResponseStatus
                                                                                   ::
                                                                                   Int}
...
removeThingFromBillingGroupResponse
    :: Int -- ^ 'rtfbgrsResponseStatus'
    -> RemoveThingFromBillingGroupResponse
removeThingFromBillingGroupResponse pResponseStatus_
  = RemoveThingFromBillingGroupResponse'{_rtfbgrsResponseStatus
                                           = pResponseStatus_}
