...
instance AWSRequest GetPolicy where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetPolicyResponse' <$> (x .?> "lastModifiedDate") <*>
         (x .?> "policyName") <*>
         (x .?> "policyDocument") <*>
         (x .?> "defaultVersionId") <*>
         (x .?> "policyArn") <*>
...
gprsLastModifiedDate =
  lens _gprsLastModifiedDate (\s a -> s {_gprsLastModifiedDate = a}) .
  mapping _Time
...
gprsPolicyDocument =
  lens _gprsPolicyDocument (\s a -> s {_gprsPolicyDocument = a})

-- | The default policy version ID.
gprsDefaultVersionId :: Lens' GetPolicyResponse (Maybe Text)
gprsDefaultVersionId =
  lens _gprsDefaultVersionId (\s a -> s {_gprsDefaultVersionId = a})
...
gprsCreationDate =
  lens _gprsCreationDate (\s a -> s {_gprsCreationDate = a}) . mapping _Time
