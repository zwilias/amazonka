...
newtype StartOnDemandAuditTask = StartOnDemandAuditTask'{_sodatTargetCheckNames
                                                         :: [Text]}
...
startOnDemandAuditTask
    :: StartOnDemandAuditTask
startOnDemandAuditTask
  = StartOnDemandAuditTask'{_sodatTargetCheckNames =
                              mempty}
...
instance AWSRequest StartOnDemandAuditTask where
        type Rs StartOnDemandAuditTask =
             StartOnDemandAuditTaskResponse
...
instance Hashable StartOnDemandAuditTask where

instance NFData StartOnDemandAuditTask where
...
data StartOnDemandAuditTaskResponse = StartOnDemandAuditTaskResponse'{_sodatrsTaskId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
startOnDemandAuditTaskResponse
    :: Int -- ^ 'sodatrsResponseStatus'
    -> StartOnDemandAuditTaskResponse
startOnDemandAuditTaskResponse pResponseStatus_
  = StartOnDemandAuditTaskResponse'{_sodatrsTaskId =
                                      Nothing,
...
instance NFData StartOnDemandAuditTaskResponse where
