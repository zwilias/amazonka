...
data UpdateDynamicThingGroup = UpdateDynamicThingGroup'{_udtgQueryVersion
                                                        :: !(Maybe Text),
...
updateDynamicThingGroup
    :: Text -- ^ 'udtgThingGroupName'
    -> ThingGroupProperties -- ^ 'udtgThingGroupProperties'
    -> UpdateDynamicThingGroup
updateDynamicThingGroup pThingGroupName_
  pThingGroupProperties_
  = UpdateDynamicThingGroup'{_udtgQueryVersion =
                               Nothing,
...
instance AWSRequest UpdateDynamicThingGroup where
        type Rs UpdateDynamicThingGroup =
             UpdateDynamicThingGroupResponse
...
instance Hashable UpdateDynamicThingGroup where

instance NFData UpdateDynamicThingGroup where
...
data UpdateDynamicThingGroupResponse = UpdateDynamicThingGroupResponse'{_udtgrsVersion
                                                                        ::
                                                                        !(Maybe
                                                                            Integer),
...
updateDynamicThingGroupResponse
    :: Int -- ^ 'udtgrsResponseStatus'
    -> UpdateDynamicThingGroupResponse
updateDynamicThingGroupResponse pResponseStatus_
  = UpdateDynamicThingGroupResponse'{_udtgrsVersion =
                                       Nothing,
...
instance NFData UpdateDynamicThingGroupResponse where
