...
newtype ValidateSecurityProfileBehaviors = ValidateSecurityProfileBehaviors'{_vspbBehaviors
                                                                             ::
                                                                             [Behavior]}
...
validateSecurityProfileBehaviors
    :: ValidateSecurityProfileBehaviors
validateSecurityProfileBehaviors
  = ValidateSecurityProfileBehaviors'{_vspbBehaviors =
                                        mempty}
...
instance AWSRequest ValidateSecurityProfileBehaviors
         where
...
instance ToHeaders ValidateSecurityProfileBehaviors
         where
        toHeaders = const mempty

instance ToJSON ValidateSecurityProfileBehaviors
         where
        toJSON ValidateSecurityProfileBehaviors'{..}
          = object
              (catMaybes [Just ("behaviors" .= _vspbBehaviors)])

instance ToPath ValidateSecurityProfileBehaviors
         where
        toPath = const "/security-profile-behaviors/validate"

instance ToQuery ValidateSecurityProfileBehaviors
         where
        toQuery = const mempty

-- | /See:/ 'validateSecurityProfileBehaviorsResponse' smart constructor.
data ValidateSecurityProfileBehaviorsResponse = ValidateSecurityProfileBehaviorsResponse'{_vspbrsValidationErrors
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [ValidationError]),
                                                                                          _vspbrsValid
...
validateSecurityProfileBehaviorsResponse
    :: Int -- ^ 'vspbrsResponseStatus'
    -> ValidateSecurityProfileBehaviorsResponse
validateSecurityProfileBehaviorsResponse
  pResponseStatus_
  = ValidateSecurityProfileBehaviorsResponse'{_vspbrsValidationErrors
                                                = Nothing,
