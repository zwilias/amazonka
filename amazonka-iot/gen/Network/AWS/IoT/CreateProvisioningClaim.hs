...
newtype CreateProvisioningClaim = CreateProvisioningClaim'{_cpcTemplateName
                                                           :: Text}
...
createProvisioningClaim
    :: Text -- ^ 'cpcTemplateName'
    -> CreateProvisioningClaim
createProvisioningClaim pTemplateName_
  = CreateProvisioningClaim'{_cpcTemplateName =
                               pTemplateName_}
...
instance AWSRequest CreateProvisioningClaim where
        type Rs CreateProvisioningClaim =
             CreateProvisioningClaimResponse
...
instance Hashable CreateProvisioningClaim where

instance NFData CreateProvisioningClaim where
...
instance ToPath CreateProvisioningClaim where
        toPath CreateProvisioningClaim'{..}
          = mconcat
              ["/provisioning-templates/", toBS _cpcTemplateName,
               "/provisioning-claim"]
...
data CreateProvisioningClaimResponse = CreateProvisioningClaimResponse'{_cpcrsKeyPair
                                                                        ::
                                                                        !(Maybe
                                                                            KeyPair),
...
createProvisioningClaimResponse
    :: Int -- ^ 'cpcrsResponseStatus'
    -> CreateProvisioningClaimResponse
createProvisioningClaimResponse pResponseStatus_
  = CreateProvisioningClaimResponse'{_cpcrsKeyPair =
                                       Nothing,
...
instance NFData CreateProvisioningClaimResponse where
