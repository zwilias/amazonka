...
newtype ConfirmTopicRuleDestination = ConfirmTopicRuleDestination'{_ctrdConfirmationToken
                                                                   :: Text}
...
confirmTopicRuleDestination
    :: Text -- ^ 'ctrdConfirmationToken'
    -> ConfirmTopicRuleDestination
confirmTopicRuleDestination pConfirmationToken_
  = ConfirmTopicRuleDestination'{_ctrdConfirmationToken
                                   = pConfirmationToken_}
...
instance Hashable ConfirmTopicRuleDestination where

instance NFData ConfirmTopicRuleDestination where
...
newtype ConfirmTopicRuleDestinationResponse = ConfirmTopicRuleDestinationResponse'{_ctrdrsResponseStatus
                                                                                   ::
                                                                                   Int}
                                                deriving (Eq, Read, Show, Data,
                                                          Typeable, Generic)
...
confirmTopicRuleDestinationResponse
    :: Int -- ^ 'ctrdrsResponseStatus'
    -> ConfirmTopicRuleDestinationResponse
confirmTopicRuleDestinationResponse pResponseStatus_
  = ConfirmTopicRuleDestinationResponse'{_ctrdrsResponseStatus
                                           = pResponseStatus_}
