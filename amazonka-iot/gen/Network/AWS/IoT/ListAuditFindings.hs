...
data ListAuditFindings = ListAuditFindings'{_lafStartTime
                                            :: !(Maybe POSIX),
...
listAuditFindings
    :: ListAuditFindings
listAuditFindings
  = ListAuditFindings'{_lafStartTime = Nothing,
                       _lafTaskId = Nothing, _lafCheckName = Nothing,
                       _lafNextToken = Nothing, _lafEndTime = Nothing,
...
instance AWSRequest ListAuditFindings where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListAuditFindingsResponse' <$>
                   (x .?> "nextToken") <*> (x .?> "findings" .!@ mempty)
                     <*> (pure (fromEnum s)))

instance Hashable ListAuditFindings where

instance NFData ListAuditFindings where
...
data ListAuditFindingsResponse = ListAuditFindingsResponse'{_lafrsNextToken
                                                            :: !(Maybe Text),
                                                            _lafrsFindings ::
                                                            !(Maybe
                                                                [AuditFinding]),
...
listAuditFindingsResponse pResponseStatus_
  = ListAuditFindingsResponse'{_lafrsNextToken =
                                 Nothing,
...
instance NFData ListAuditFindingsResponse where
