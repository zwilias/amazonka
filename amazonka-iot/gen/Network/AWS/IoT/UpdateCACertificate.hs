...
ucacRemoveAutoRegistration =
  lens _ucacRemoveAutoRegistration (\s a -> s {_ucacRemoveAutoRegistration = a})
...
ucacRegistrationConfig =
  lens _ucacRegistrationConfig (\s a -> s {_ucacRegistrationConfig = a})

-- | The new value for the auto registration status. Valid values are: "ENABLE" or "DISABLE".
ucacNewAutoRegistrationStatus ::
     Lens' UpdateCACertificate (Maybe AutoRegistrationStatus)
ucacNewAutoRegistrationStatus =
  lens
    _ucacNewAutoRegistrationStatus
    (\s a -> s {_ucacNewAutoRegistrationStatus = a})
