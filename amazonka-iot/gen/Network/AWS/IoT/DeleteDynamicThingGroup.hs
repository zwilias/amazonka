...
data DeleteDynamicThingGroup = DeleteDynamicThingGroup'{_ddtgExpectedVersion
                                                        :: !(Maybe Integer),
                                                        _ddtgThingGroupName ::
                                                        !Text}
...
deleteDynamicThingGroup
    :: Text -- ^ 'ddtgThingGroupName'
    -> DeleteDynamicThingGroup
deleteDynamicThingGroup pThingGroupName_
  = DeleteDynamicThingGroup'{_ddtgExpectedVersion =
                               Nothing,
...
instance AWSRequest DeleteDynamicThingGroup where
        type Rs DeleteDynamicThingGroup =
             DeleteDynamicThingGroupResponse
        request = delete ioT
        response
          = receiveEmpty
...
instance Hashable DeleteDynamicThingGroup where

instance NFData DeleteDynamicThingGroup where
...
newtype DeleteDynamicThingGroupResponse = DeleteDynamicThingGroupResponse'{_ddtgrsResponseStatus
                                                                           ::
                                                                           Int}
...
deleteDynamicThingGroupResponse
    :: Int -- ^ 'ddtgrsResponseStatus'
    -> DeleteDynamicThingGroupResponse
deleteDynamicThingGroupResponse pResponseStatus_
  = DeleteDynamicThingGroupResponse'{_ddtgrsResponseStatus
                                       = pResponseStatus_}
...
instance NFData DeleteDynamicThingGroupResponse where
