...
instance AWSRequest DescribeAccountAuditConfiguration
         where
...
instance ToHeaders DescribeAccountAuditConfiguration
         where
        toHeaders = const mempty

instance ToPath DescribeAccountAuditConfiguration
         where
        toPath = const "/audit/configuration"

instance ToQuery DescribeAccountAuditConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'describeAccountAuditConfigurationResponse' smart constructor.
data DescribeAccountAuditConfigurationResponse = DescribeAccountAuditConfigurationResponse'{_daacrsAuditCheckConfigurations
                                                                                            ::
                                                                                            !(Maybe
                                                                                                (Map
                                                                                                   Text
...
describeAccountAuditConfigurationResponse
    :: Int -- ^ 'daacrsResponseStatus'
    -> DescribeAccountAuditConfigurationResponse
describeAccountAuditConfigurationResponse
  pResponseStatus_
  = DescribeAccountAuditConfigurationResponse'{_daacrsAuditCheckConfigurations
                                                 = Nothing,
                                               _daacrsAuditNotificationTargetConfigurations
                                                 = Nothing,
