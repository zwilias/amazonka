...
data UpdateProvisioningTemplate = UpdateProvisioningTemplate'{_uptPreProvisioningHook
                                                              ::
                                                              !(Maybe
                                                                  ProvisioningHook),
                                                              _uptEnabled ::
...
updateProvisioningTemplate pTemplateName_
  = UpdateProvisioningTemplate'{_uptPreProvisioningHook
                                  = Nothing,
                                _uptEnabled = Nothing,
...
instance Hashable UpdateProvisioningTemplate where

instance NFData UpdateProvisioningTemplate where
...
newtype UpdateProvisioningTemplateResponse = UpdateProvisioningTemplateResponse'{_uptrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
updateProvisioningTemplateResponse pResponseStatus_
  = UpdateProvisioningTemplateResponse'{_uptrsResponseStatus
                                          = pResponseStatus_}
