...
instance AWSRequest DescribeThingType where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeThingTypeResponse' <$> (x .?> "thingTypeProperties") <*>
         (x .?> "thingTypeName") <*>
         (x .?> "thingTypeId") <*>
         (x .?> "thingTypeMetadata") <*>
         (x .?> "thingTypeArn") <*>
...
desrsThingTypeProperties ::
     Lens' DescribeThingTypeResponse (Maybe ThingTypeProperties)
desrsThingTypeProperties =
  lens _desrsThingTypeProperties (\s a -> s {_desrsThingTypeProperties = a})

-- | The name of the thing type.
desrsThingTypeName :: Lens' DescribeThingTypeResponse (Maybe Text)
desrsThingTypeName =
  lens _desrsThingTypeName (\s a -> s {_desrsThingTypeName = a})
...
desrsThingTypeMetadata ::
     Lens' DescribeThingTypeResponse (Maybe ThingTypeMetadata)
desrsThingTypeMetadata =
  lens _desrsThingTypeMetadata (\s a -> s {_desrsThingTypeMetadata = a})
