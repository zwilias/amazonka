...
newtype GetTopicRuleDestination = GetTopicRuleDestination'{_gtrdArn
                                                           :: Text}
...
instance AWSRequest GetTopicRuleDestination where
        type Rs GetTopicRuleDestination =
             GetTopicRuleDestinationResponse
        request = get ioT
        response
          = receiveJSON
...
instance Hashable GetTopicRuleDestination where

instance NFData GetTopicRuleDestination where
...
data GetTopicRuleDestinationResponse = GetTopicRuleDestinationResponse'{_gtrdrsTopicRuleDestination
                                                                        ::
                                                                        !(Maybe
...
getTopicRuleDestinationResponse
    :: Int -- ^ 'gtrdrsResponseStatus'
    -> GetTopicRuleDestinationResponse
getTopicRuleDestinationResponse pResponseStatus_
  = GetTopicRuleDestinationResponse'{_gtrdrsTopicRuleDestination
                                       = Nothing,
...
instance NFData GetTopicRuleDestinationResponse where
