...
data DetachSecurityProfile = DetachSecurityProfile'{_detSecurityProfileName
                                                    :: !Text,
                                                    _detSecurityProfileTargetARN
                                                    :: !Text}
...
detachSecurityProfile
    :: Text -- ^ 'detSecurityProfileName'
    -> Text -- ^ 'detSecurityProfileTargetARN'
    -> DetachSecurityProfile
detachSecurityProfile pSecurityProfileName_
  pSecurityProfileTargetARN_
  = DetachSecurityProfile'{_detSecurityProfileName =
...
instance Hashable DetachSecurityProfile where

instance NFData DetachSecurityProfile where
...
instance ToPath DetachSecurityProfile where
        toPath DetachSecurityProfile'{..}
          = mconcat
              ["/security-profiles/", toBS _detSecurityProfileName,
               "/targets"]
...
newtype DetachSecurityProfileResponse = DetachSecurityProfileResponse'{_detrsResponseStatus
                                                                       :: Int}
...
detachSecurityProfileResponse pResponseStatus_
  = DetachSecurityProfileResponse'{_detrsResponseStatus
                                     = pResponseStatus_}
...
instance NFData DetachSecurityProfileResponse where
