...
data UpdateBillingGroup = UpdateBillingGroup'{_ubgExpectedVersion
                                              :: !(Maybe Integer),
...
updateBillingGroup
    :: Text -- ^ 'ubgBillingGroupName'
    -> BillingGroupProperties -- ^ 'ubgBillingGroupProperties'
    -> UpdateBillingGroup
updateBillingGroup pBillingGroupName_
  pBillingGroupProperties_
  = UpdateBillingGroup'{_ubgExpectedVersion = Nothing,
...
instance Hashable UpdateBillingGroup where

instance NFData UpdateBillingGroup where
...
data UpdateBillingGroupResponse = UpdateBillingGroupResponse'{_ubgrsVersion
                                                              ::
                                                              !(Maybe Integer),
                                                              _ubgrsResponseStatus
                                                              :: !Int}
...
updateBillingGroupResponse
    :: Int -- ^ 'ubgrsResponseStatus'
    -> UpdateBillingGroupResponse
updateBillingGroupResponse pResponseStatus_
  = UpdateBillingGroupResponse'{_ubgrsVersion =
                                  Nothing,
...
instance NFData UpdateBillingGroupResponse where
