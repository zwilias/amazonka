...
data UpdateDimension = UpdateDimension'{_udName ::
                                        !Text,
...
updateDimension
    :: Text -- ^ 'udName'
    -> NonEmpty Text -- ^ 'udStringValues'
    -> UpdateDimension
updateDimension pName_ pStringValues_
  = UpdateDimension'{_udName = pName_,
...
instance Hashable UpdateDimension where

instance NFData UpdateDimension where
...
data UpdateDimensionResponse = UpdateDimensionResponse'{_udrsLastModifiedDate
                                                        :: !(Maybe POSIX),
                                                        _udrsArn ::
                                                        !(Maybe Text),
                                                        _udrsStringValues ::
...
updateDimensionResponse pResponseStatus_
  = UpdateDimensionResponse'{_udrsLastModifiedDate =
                               Nothing,
                             _udrsArn = Nothing, _udrsStringValues = Nothing,
                             _udrsName = Nothing, _udrsCreationDate = Nothing,
                             _udrsType = Nothing,
...
instance NFData UpdateDimensionResponse where
