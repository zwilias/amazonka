...
newtype DescribeProvisioningTemplate = DescribeProvisioningTemplate'{_dptTemplateName
                                                                     :: Text}
...
describeProvisioningTemplate pTemplateName_
  = DescribeProvisioningTemplate'{_dptTemplateName =
                                    pTemplateName_}
...
instance AWSRequest DescribeProvisioningTemplate
         where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeProvisioningTemplateResponse' <$>
                   (x .?> "lastModifiedDate") <*> (x .?> "templateName")
...
instance Hashable DescribeProvisioningTemplate where

instance NFData DescribeProvisioningTemplate where
...
data DescribeProvisioningTemplateResponse = DescribeProvisioningTemplateResponse'{_dptrsLastModifiedDate
                                                                                  ::
                                                                                  !(Maybe
                                                                                      POSIX),
                                                                                  _dptrsTemplateName
...
describeProvisioningTemplateResponse pResponseStatus_
  = DescribeProvisioningTemplateResponse'{_dptrsLastModifiedDate
                                            = Nothing,
