...
data ListAuditMitigationActionsExecutions = ListAuditMitigationActionsExecutions'{_lamaeNextToken
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
                                                                                  _lamaeActionStatus
...
listAuditMitigationActionsExecutions
    ...
    -> Text -- ^ 'lamaeFindingId'
    -> ListAuditMitigationActionsExecutions
listAuditMitigationActionsExecutions pTaskId_
  pFindingId_
  = ListAuditMitigationActionsExecutions'{_lamaeNextToken
                                            = Nothing,
...
instance ToPath ListAuditMitigationActionsExecutions
         where
        toPath = const "/audit/mitigationactions/executions"

instance ToQuery ListAuditMitigationActionsExecutions
         where
...
data ListAuditMitigationActionsExecutionsResponse = ListAuditMitigationActionsExecutionsResponse'{_lamaersActionsExecutions
                                                                                                  ::
                                                                                                  !(Maybe
...
listAuditMitigationActionsExecutionsResponse
    :: Int -- ^ 'lamaersResponseStatus'
    -> ListAuditMitigationActionsExecutionsResponse
listAuditMitigationActionsExecutionsResponse
  pResponseStatus_
  = ListAuditMitigationActionsExecutionsResponse'{_lamaersActionsExecutions
                                                    = Nothing,
