...
data UpdateScheduledAudit = UpdateScheduledAudit'{_usaFrequency
...
updateScheduledAudit
    :: Text -- ^ 'usaScheduledAuditName'
    -> UpdateScheduledAudit
updateScheduledAudit pScheduledAuditName_
  = UpdateScheduledAudit'{_usaFrequency = Nothing,
...
instance Hashable UpdateScheduledAudit where

instance NFData UpdateScheduledAudit where
...
data UpdateScheduledAuditResponse = UpdateScheduledAuditResponse'{_usarsScheduledAuditARN
                                                                  ::
                                                                  !(Maybe Text),
...
updateScheduledAuditResponse pResponseStatus_
  = UpdateScheduledAuditResponse'{_usarsScheduledAuditARN
                                    = Nothing,
...
instance NFData UpdateScheduledAuditResponse where
