...
data ListProvisioningTemplates = ListProvisioningTemplates'{_lNextToken
                                                            :: !(Maybe Text),
                                                            _lMaxResults ::
                                                            !(Maybe Nat)}
...
listProvisioningTemplates
    :: ListProvisioningTemplates
listProvisioningTemplates
  = ListProvisioningTemplates'{_lNextToken = Nothing,
...
instance Hashable ListProvisioningTemplates where

instance NFData ListProvisioningTemplates where
...
data ListProvisioningTemplatesResponse = ListProvisioningTemplatesResponse'{_lrsTemplates
                                                                            ::
                                                                            !(Maybe
...
listProvisioningTemplatesResponse pResponseStatus_
  = ListProvisioningTemplatesResponse'{_lrsTemplates =
                                         Nothing,
