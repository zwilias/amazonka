...
newtype DeleteMitigationAction = DeleteMitigationAction'{_dmaActionName
                                                         :: Text}
...
deleteMitigationAction pActionName_
  = DeleteMitigationAction'{_dmaActionName =
                              pActionName_}
...
instance AWSRequest DeleteMitigationAction where
        type Rs DeleteMitigationAction =
             DeleteMitigationActionResponse
        request = delete ioT
        response
          = receiveEmpty
...
instance Hashable DeleteMitigationAction where

instance NFData DeleteMitigationAction where
...
newtype DeleteMitigationActionResponse = DeleteMitigationActionResponse'{_dmarsResponseStatus
                                                                         :: Int}
...
deleteMitigationActionResponse pResponseStatus_
  = DeleteMitigationActionResponse'{_dmarsResponseStatus
                                      = pResponseStatus_}
...
instance NFData DeleteMitigationActionResponse where
