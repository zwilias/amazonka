...
data ListTargetsForSecurityProfile = ListTargetsForSecurityProfile'{_ltfspNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _ltfspMaxResults
...
listTargetsForSecurityProfile
    :: Text -- ^ 'ltfspSecurityProfileName'
    -> ListTargetsForSecurityProfile
listTargetsForSecurityProfile pSecurityProfileName_
  = ListTargetsForSecurityProfile'{_ltfspNextToken =
                                     Nothing,
...
instance AWSPager ListTargetsForSecurityProfile where
        page rq rs
          ...
          | stop (rs ^. ltfsprsSecurityProfileTargets) =
            Nothing
          | otherwise =
            Just $ rq & ltfspNextToken .~ rs ^. ltfsprsNextToken

instance AWSRequest ListTargetsForSecurityProfile
         where
...
instance Hashable ListTargetsForSecurityProfile where

instance NFData ListTargetsForSecurityProfile where

instance ToHeaders ListTargetsForSecurityProfile
         where
...
instance ToPath ListTargetsForSecurityProfile where
        toPath ListTargetsForSecurityProfile'{..}
          = mconcat
              ["/security-profiles/",
               toBS _ltfspSecurityProfileName, "/targets"]
...
data ListTargetsForSecurityProfileResponse = ListTargetsForSecurityProfileResponse'{_ltfsprsSecurityProfileTargets
                                                                                    ::
                                                                                    !(Maybe
...
listTargetsForSecurityProfileResponse
    :: Int -- ^ 'ltfsprsResponseStatus'
    -> ListTargetsForSecurityProfileResponse
listTargetsForSecurityProfileResponse
  pResponseStatus_
  = ListTargetsForSecurityProfileResponse'{_ltfsprsSecurityProfileTargets
                                             = Nothing,
