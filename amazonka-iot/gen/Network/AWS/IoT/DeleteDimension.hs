...
newtype DeleteDimension = DeleteDimension'{_dName ::
                                           Text}
...
instance Hashable DeleteDimension where

instance NFData DeleteDimension where
...
newtype DeleteDimensionResponse = DeleteDimensionResponse'{_ddrsResponseStatus
                                                           :: Int}
...
deleteDimensionResponse pResponseStatus_
  = DeleteDimensionResponse'{_ddrsResponseStatus =
                               pResponseStatus_}
...
instance NFData DeleteDimensionResponse where
