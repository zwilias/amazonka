...
data AttachSecurityProfile = AttachSecurityProfile'{_aspSecurityProfileName
                                                    :: !Text,
...
attachSecurityProfile
    :: Text -- ^ 'aspSecurityProfileName'
    -> Text -- ^ 'aspSecurityProfileTargetARN'
    -> AttachSecurityProfile
attachSecurityProfile pSecurityProfileName_
  pSecurityProfileTargetARN_
  = AttachSecurityProfile'{_aspSecurityProfileName =
...
instance Hashable AttachSecurityProfile where

instance NFData AttachSecurityProfile where
...
instance ToPath AttachSecurityProfile where
        toPath AttachSecurityProfile'{..}
          = mconcat
              ["/security-profiles/", toBS _aspSecurityProfileName,
               "/targets"]
...
newtype AttachSecurityProfileResponse = AttachSecurityProfileResponse'{_asprsResponseStatus
                                                                       :: Int}
...
attachSecurityProfileResponse
    :: Int -- ^ 'asprsResponseStatus'
    -> AttachSecurityProfileResponse
attachSecurityProfileResponse pResponseStatus_
  = AttachSecurityProfileResponse'{_asprsResponseStatus
                                     = pResponseStatus_}
...
instance NFData AttachSecurityProfileResponse where
