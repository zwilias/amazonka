...
newtype DescribeAuditFinding = DescribeAuditFinding'{_dafFindingId
                                                     :: Text}
...
instance Hashable DescribeAuditFinding where

instance NFData DescribeAuditFinding where
...
data DescribeAuditFindingResponse = DescribeAuditFindingResponse'{_dafrsFinding
                                                                  ::
                                                                  !(Maybe
                                                                      AuditFinding),
                                                                  _dafrsResponseStatus
                                                                  :: !Int}
                                      deriving (Eq, Read, Show, Data, Typeable,
                                                Generic)
...
describeAuditFindingResponse
    :: Int -- ^ 'dafrsResponseStatus'
    -> DescribeAuditFindingResponse
describeAuditFindingResponse pResponseStatus_
  = DescribeAuditFindingResponse'{_dafrsFinding =
                                    Nothing,
...
instance NFData DescribeAuditFindingResponse where
