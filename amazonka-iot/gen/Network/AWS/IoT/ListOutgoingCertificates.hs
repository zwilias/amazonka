...
instance AWSRequest ListOutgoingCertificates where
  ...
  response =
    receiveJSON
      (\s h x ->
         ListOutgoingCertificatesResponse' <$> (x .?> "nextMarker") <*>
...
locrsOutgoingCertificates ::
     Lens' ListOutgoingCertificatesResponse [OutgoingCertificate]
locrsOutgoingCertificates =
  lens _locrsOutgoingCertificates (\s a -> s {_locrsOutgoingCertificates = a}) .
  _Default . _Coerce
