...
data UpdateAccountAuditConfiguration = UpdateAccountAuditConfiguration'{_uaacAuditCheckConfigurations
                                                                        ::
                                                                        !(Maybe
                                                                            (Map
                                                                               Text
...
updateAccountAuditConfiguration
    :: UpdateAccountAuditConfiguration
updateAccountAuditConfiguration
  = UpdateAccountAuditConfiguration'{_uaacAuditCheckConfigurations
                                       = Nothing,
                                     _uaacAuditNotificationTargetConfigurations
                                       = Nothing,
...
instance AWSRequest UpdateAccountAuditConfiguration
         where
...
instance NFData UpdateAccountAuditConfiguration where

instance ToHeaders UpdateAccountAuditConfiguration
         where
...
instance ToQuery UpdateAccountAuditConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'updateAccountAuditConfigurationResponse' smart constructor.
newtype UpdateAccountAuditConfigurationResponse = UpdateAccountAuditConfigurationResponse'{_uaacrsResponseStatus
                                                                                           ::
                                                                                           Int}
...
updateAccountAuditConfigurationResponse
    :: Int -- ^ 'uaacrsResponseStatus'
    -> UpdateAccountAuditConfigurationResponse
updateAccountAuditConfigurationResponse
  pResponseStatus_
  = UpdateAccountAuditConfigurationResponse'{_uaacrsResponseStatus
                                               = pResponseStatus_}
