...
data GetPercentiles = GetPercentiles'{_gpPercents ::
                                      !(Maybe [Double]),
...
getPercentiles pQueryString_
  = GetPercentiles'{_gpPercents = Nothing,
...
instance Hashable GetPercentiles where

instance NFData GetPercentiles where
...
data GetPercentilesResponse = GetPercentilesResponse'{_grsPercentiles
                                                      :: !(Maybe [PercentPair]),
                                                      _grsResponseStatus ::
                                                      !Int}
...
getPercentilesResponse pResponseStatus_
  = GetPercentilesResponse'{_grsPercentiles = Nothing,
...
instance NFData GetPercentilesResponse where
