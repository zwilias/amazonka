...
data UpdateMitigationAction = UpdateMitigationAction'{_umaActionParams
                                                      ::
                                                      !(Maybe
...
updateMitigationAction pActionName_
  = UpdateMitigationAction'{_umaActionParams = Nothing,
                            _umaRoleARN = Nothing,
...
instance AWSRequest UpdateMitigationAction where
        type Rs UpdateMitigationAction =
             UpdateMitigationActionResponse
...
instance Hashable UpdateMitigationAction where

instance NFData UpdateMitigationAction where
...
data UpdateMitigationActionResponse = UpdateMitigationActionResponse'{_umarsActionId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _umarsActionARN
...
updateMitigationActionResponse
    :: Int -- ^ 'umarsResponseStatus'
    -> UpdateMitigationActionResponse
updateMitigationActionResponse pResponseStatus_
  = UpdateMitigationActionResponse'{_umarsActionId =
                                      Nothing,
...
instance NFData UpdateMitigationActionResponse where
