...
newtype DeleteProvisioningTemplate = DeleteProvisioningTemplate'{_dTemplateName
                                                                 :: Text}
...
deleteProvisioningTemplate pTemplateName_
  = DeleteProvisioningTemplate'{_dTemplateName =
                                  pTemplateName_}
...
instance Hashable DeleteProvisioningTemplate where

instance NFData DeleteProvisioningTemplate where
...
newtype DeleteProvisioningTemplateResponse = DeleteProvisioningTemplateResponse'{_delrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
deleteProvisioningTemplateResponse pResponseStatus_
  = DeleteProvisioningTemplateResponse'{_delrsResponseStatus
                                          = pResponseStatus_}
