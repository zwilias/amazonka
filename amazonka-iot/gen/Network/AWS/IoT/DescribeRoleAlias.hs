...
instance AWSRequest DescribeRoleAlias where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeRoleAliasResponse' <$> (x .?> "roleAliasDescription") <*>
         (pure (fromEnum s)))
...
drarsRoleAliasDescription ::
     Lens' DescribeRoleAliasResponse (Maybe RoleAliasDescription)
drarsRoleAliasDescription =
  lens _drarsRoleAliasDescription (\s a -> s {_drarsRoleAliasDescription = a})

-- | -- | The response status code.
drarsResponseStatus :: Lens' DescribeRoleAliasResponse Int
drarsResponseStatus =
  lens _drarsResponseStatus (\s a -> s {_drarsResponseStatus = a})
