...
instance AWSRequest DescribeThingRegistrationTask where
  type Rs DescribeThingRegistrationTask = DescribeThingRegistrationTaskResponse
  request = get ioT
  response =
    receiveJSON
      (\s h x ->
         DescribeThingRegistrationTaskResponse' <$> (x .?> "status") <*>
         (x .?> "lastModifiedDate") <*>
         (x .?> "inputFileKey") <*>
         (x .?> "taskId") <*>
         (x .?> "creationDate") <*>
...
dtrtrsLastModifiedDate ::
     Lens' DescribeThingRegistrationTaskResponse (Maybe UTCTime)
dtrtrsLastModifiedDate =
  lens _dtrtrsLastModifiedDate (\s a -> s {_dtrtrsLastModifiedDate = a}) .
  mapping _Time

-- | The input file key.
dtrtrsInputFileKey :: Lens' DescribeThingRegistrationTaskResponse (Maybe Text)
dtrtrsInputFileKey =
  lens _dtrtrsInputFileKey (\s a -> s {_dtrtrsInputFileKey = a})
...
dtrtrsCreationDate ::
     Lens' DescribeThingRegistrationTaskResponse (Maybe UTCTime)
dtrtrsCreationDate =
  lens _dtrtrsCreationDate (\s a -> s {_dtrtrsCreationDate = a}) . mapping _Time

-- | The progress of the bulk provisioning task expressed as a percentage.
dtrtrsPercentageProgress ::
     Lens' DescribeThingRegistrationTaskResponse (Maybe Natural)
dtrtrsPercentageProgress =
  lens _dtrtrsPercentageProgress (\s a -> s {_dtrtrsPercentageProgress = a}) .
  mapping _Nat

-- | The task's template.
dtrtrsTemplateBody :: Lens' DescribeThingRegistrationTaskResponse (Maybe Text)
dtrtrsTemplateBody =
  lens _dtrtrsTemplateBody (\s a -> s {_dtrtrsTemplateBody = a})

-- | The number of things successfully provisioned.
dtrtrsSuccessCount :: Lens' DescribeThingRegistrationTaskResponse (Maybe Int)
dtrtrsSuccessCount =
  lens _dtrtrsSuccessCount (\s a -> s {_dtrtrsSuccessCount = a})
...
dtrtrsFailureCount =
  lens _dtrtrsFailureCount (\s a -> s {_dtrtrsFailureCount = a})

-- | The S3 bucket that contains the input file.
dtrtrsInputFileBucket ::
     Lens' DescribeThingRegistrationTaskResponse (Maybe Text)
dtrtrsInputFileBucket =
  lens _dtrtrsInputFileBucket (\s a -> s {_dtrtrsInputFileBucket = a})
...
dtrtrsResponseStatus =
  lens _dtrtrsResponseStatus (\s a -> s {_dtrtrsResponseStatus = a})
