...
newtype DescribeAuditTask = DescribeAuditTask'{_datTaskId
                                               :: Text}
...
instance Hashable DescribeAuditTask where

instance NFData DescribeAuditTask where
...
data DescribeAuditTaskResponse = DescribeAuditTaskResponse'{_datrsAuditDetails
                                                            ::
                                                            !(Maybe
                                                                (Map Text
                                                                   AuditCheckDetails)),
...
describeAuditTaskResponse pResponseStatus_
  = DescribeAuditTaskResponse'{_datrsAuditDetails =
                                 Nothing,
...
instance NFData DescribeAuditTaskResponse where
