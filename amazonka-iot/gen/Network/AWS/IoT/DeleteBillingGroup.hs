...
data DeleteBillingGroup = DeleteBillingGroup'{_dbgExpectedVersion
                                              :: !(Maybe Integer),
...
deleteBillingGroup
    :: Text -- ^ 'dbgBillingGroupName'
    -> DeleteBillingGroup
deleteBillingGroup pBillingGroupName_
  = DeleteBillingGroup'{_dbgExpectedVersion = Nothing,
...
instance Hashable DeleteBillingGroup where

instance NFData DeleteBillingGroup where
...
newtype DeleteBillingGroupResponse = DeleteBillingGroupResponse'{_dbgrsResponseStatus
                                                                 :: Int}
...
deleteBillingGroupResponse
    :: Int -- ^ 'dbgrsResponseStatus'
    -> DeleteBillingGroupResponse
deleteBillingGroupResponse pResponseStatus_
  = DeleteBillingGroupResponse'{_dbgrsResponseStatus =
                                  pResponseStatus_}
...
instance NFData DeleteBillingGroupResponse where
