...
data CreateBillingGroup = CreateBillingGroup'{_cbgBillingGroupProperties
                                              ::
...
createBillingGroup
    :: Text -- ^ 'cbgBillingGroupName'
    -> CreateBillingGroup
createBillingGroup pBillingGroupName_
  = CreateBillingGroup'{_cbgBillingGroupProperties =
                          Nothing,
                        _cbgTags = Nothing,
...
instance Hashable CreateBillingGroup where

instance NFData CreateBillingGroup where
...
data CreateBillingGroupResponse = CreateBillingGroupResponse'{_cbgrsBillingGroupARN
                                                              :: !(Maybe Text),
                                                              _cbgrsBillingGroupName
                                                              :: !(Maybe Text),
                                                              _cbgrsBillingGroupId
                                                              :: !(Maybe Text),
                                                              _cbgrsResponseStatus
                                                              :: !Int}
...
createBillingGroupResponse
    :: Int -- ^ 'cbgrsResponseStatus'
    -> CreateBillingGroupResponse
createBillingGroupResponse pResponseStatus_
  = CreateBillingGroupResponse'{_cbgrsBillingGroupARN =
                                  Nothing,
...
instance NFData CreateBillingGroupResponse where
