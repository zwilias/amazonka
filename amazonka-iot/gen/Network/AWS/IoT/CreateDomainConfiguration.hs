...
data CreateDomainConfiguration = CreateDomainConfiguration'{_cdcAuthorizerConfig
                                                            ::
                                                            !(Maybe
                                                                AuthorizerConfig),
...
createDomainConfiguration
    :: Text -- ^ 'cdcDomainConfigurationName'
    -> CreateDomainConfiguration
createDomainConfiguration pDomainConfigurationName_
  = CreateDomainConfiguration'{_cdcAuthorizerConfig =
                                 Nothing,
...
instance Hashable CreateDomainConfiguration where

instance NFData CreateDomainConfiguration where
...
data CreateDomainConfigurationResponse = CreateDomainConfigurationResponse'{_cdcrsDomainConfigurationName
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
createDomainConfigurationResponse pResponseStatus_
  = CreateDomainConfigurationResponse'{_cdcrsDomainConfigurationName
                                         = Nothing,
