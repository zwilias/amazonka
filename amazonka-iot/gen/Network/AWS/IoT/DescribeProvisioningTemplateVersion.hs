...
data DescribeProvisioningTemplateVersion = DescribeProvisioningTemplateVersion'{_dptvTemplateName
                                                                                ::
                                                                                !Text,
                                                                                _dptvVersionId
                                                                                ::
...
describeProvisioningTemplateVersion
    :: Text -- ^ 'dptvTemplateName'
    -> Int -- ^ 'dptvVersionId'
    -> DescribeProvisioningTemplateVersion
describeProvisioningTemplateVersion pTemplateName_
  pVersionId_
  = DescribeProvisioningTemplateVersion'{_dptvTemplateName
                                           = pTemplateName_,
...
instance ToPath DescribeProvisioningTemplateVersion
         where
        toPath DescribeProvisioningTemplateVersion'{..}
          = mconcat
              ["/provisioning-templates/", toBS _dptvTemplateName,
               "/versions/", toBS _dptvVersionId]

instance ToQuery DescribeProvisioningTemplateVersion
         where
        toQuery = const mempty

-- | /See:/ 'describeProvisioningTemplateVersionResponse' smart constructor.
data DescribeProvisioningTemplateVersionResponse = DescribeProvisioningTemplateVersionResponse'{_dptvrsVersionId
                                                                                                ::
                                                                                                !(Maybe
                                                                                                    Int),
                                                                                                _dptvrsCreationDate
...
describeProvisioningTemplateVersionResponse
    :: Int -- ^ 'dptvrsResponseStatus'
    -> DescribeProvisioningTemplateVersionResponse
describeProvisioningTemplateVersionResponse
  pResponseStatus_
  = DescribeProvisioningTemplateVersionResponse'{_dptvrsVersionId
                                                   = Nothing,
