...
data StartAuditMitigationActionsTask = StartAuditMitigationActionsTask'{_samatTaskId
                                                                        ::
                                                                        !Text,
                                                                        _samatTarget
                                                                        ::
...
startAuditMitigationActionsTask
    :: Text -- ^ 'samatTaskId'
    -> AuditMitigationActionsTaskTarget -- ^ 'samatTarget'
    -> Text -- ^ 'samatClientRequestToken'
    -> StartAuditMitigationActionsTask
startAuditMitigationActionsTask pTaskId_ pTarget_
  pClientRequestToken_
  = StartAuditMitigationActionsTask'{_samatTaskId =
                                       pTaskId_,
...
instance AWSRequest StartAuditMitigationActionsTask
         where
...
instance NFData StartAuditMitigationActionsTask where

instance ToHeaders StartAuditMitigationActionsTask
         where
...
instance ToQuery StartAuditMitigationActionsTask
         where
        toQuery = const mempty

-- | /See:/ 'startAuditMitigationActionsTaskResponse' smart constructor.
data StartAuditMitigationActionsTaskResponse = StartAuditMitigationActionsTaskResponse'{_samatrsTaskId
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
startAuditMitigationActionsTaskResponse
    :: Int -- ^ 'samatrsResponseStatus'
    -> StartAuditMitigationActionsTaskResponse
startAuditMitigationActionsTaskResponse
  pResponseStatus_
  = StartAuditMitigationActionsTaskResponse'{_samatrsTaskId
                                               = Nothing,
                                             _samatrsResponseStatus =
                                               pResponseStatus_}
