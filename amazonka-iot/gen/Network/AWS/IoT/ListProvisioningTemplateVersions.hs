...
data ListProvisioningTemplateVersions = ListProvisioningTemplateVersions'{_lptvNextToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _lptvMaxResults
...
listProvisioningTemplateVersions
    :: Text -- ^ 'lptvTemplateName'
    -> ListProvisioningTemplateVersions
listProvisioningTemplateVersions pTemplateName_
  = ListProvisioningTemplateVersions'{_lptvNextToken =
                                        Nothing,
...
instance AWSRequest ListProvisioningTemplateVersions
         where
...
instance ToHeaders ListProvisioningTemplateVersions
         where
        toHeaders = const mempty

instance ToPath ListProvisioningTemplateVersions
         where
        toPath ListProvisioningTemplateVersions'{..}
          = mconcat
              ["/provisioning-templates/", toBS _lptvTemplateName,
               "/versions"]

instance ToQuery ListProvisioningTemplateVersions
         where
...
data ListProvisioningTemplateVersionsResponse = ListProvisioningTemplateVersionsResponse'{_lptvrsVersions
                                                                                          ::
                                                                                          !(Maybe
...
listProvisioningTemplateVersionsResponse
    :: Int -- ^ 'lptvrsResponseStatus'
    -> ListProvisioningTemplateVersionsResponse
listProvisioningTemplateVersionsResponse
  pResponseStatus_
  = ListProvisioningTemplateVersionsResponse'{_lptvrsVersions
                                                = Nothing,
