...
data CancelJob = CancelJob'{_cForce :: !(Maybe Bool),
                            _cReasonCode :: !(Maybe Text),
                            _cComment :: !(Maybe Text), _cJobId :: !Text}
...
cancelJob
    ...
    -> CancelJob
cancelJob pJobId_
  = CancelJob'{_cForce = Nothing,
               _cReasonCode = Nothing, _cComment = Nothing,
               _cJobId = pJobId_}
...
data CancelJobResponse = CancelJobResponse'{_canrsJobId
                                            :: !(Maybe Text),
...
cancelJobResponse pResponseStatus_
  = CancelJobResponse'{_canrsJobId = Nothing,
                       _canrsJobARN = Nothing, _canrsDescription = Nothing,
