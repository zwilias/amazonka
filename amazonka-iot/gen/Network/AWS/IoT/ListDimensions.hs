...
data ListDimensions = ListDimensions'{_ldNextToken ::
                                      !(Maybe Text),
...
listDimensions
    :: ListDimensions
listDimensions
  = ListDimensions'{_ldNextToken = Nothing,
...
instance Hashable ListDimensions where

instance NFData ListDimensions where
...
data ListDimensionsResponse = ListDimensionsResponse'{_ldrsNextToken
                                                      :: !(Maybe Text),
                                                      _ldrsDimensionNames ::
                                                      !(Maybe [Text]),
                                                      _ldrsResponseStatus ::
...
listDimensionsResponse pResponseStatus_
  = ListDimensionsResponse'{_ldrsNextToken = Nothing,
...
instance NFData ListDimensionsResponse where
