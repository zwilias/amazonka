...
data ListScheduledAudits = ListScheduledAudits'{_lsaNextToken
                                                :: !(Maybe Text),
...
listScheduledAudits
    :: ListScheduledAudits
listScheduledAudits
  = ListScheduledAudits'{_lsaNextToken = Nothing,
...
instance AWSPager ListScheduledAudits where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lsaNextToken .~ rs ^. lsarsNextToken

instance AWSRequest ListScheduledAudits where
        type Rs ListScheduledAudits =
             ListScheduledAuditsResponse
        request = get ioT
        response
          = receiveJSON
...
instance Hashable ListScheduledAudits where

instance NFData ListScheduledAudits where
...
data ListScheduledAuditsResponse = ListScheduledAuditsResponse'{_lsarsScheduledAudits
                                                                ::
                                                                !(Maybe
...
listScheduledAuditsResponse pResponseStatus_
  = ListScheduledAuditsResponse'{_lsarsScheduledAudits
                                   = Nothing,
...
instance NFData ListScheduledAuditsResponse where
