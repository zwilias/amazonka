...
newtype HTTPURLDestinationProperties = HTTPURLDestinationProperties'{_httpudpConfirmationURL
                                                                     ::
                                                                     Maybe Text}
...
hTTPURLDestinationProperties
    :: HTTPURLDestinationProperties
hTTPURLDestinationProperties
  = HTTPURLDestinationProperties'{_httpudpConfirmationURL
                                    = Nothing}
...
instance FromJSON HTTPURLDestinationProperties where
        parseJSON
          = withObject "HTTPURLDestinationProperties"
              (\ x ->
                 HTTPURLDestinationProperties' <$>
                   (x .:? "confirmationUrl"))

instance Hashable HTTPURLDestinationProperties where

instance NFData HTTPURLDestinationProperties where
