...
data ProvisioningTemplateSummary = ProvisioningTemplateSummary'{_ptsLastModifiedDate
                                                                ::
                                                                !(Maybe POSIX),
                                                                _ptsTemplateName
                                                                ::
...
provisioningTemplateSummary
    :: ProvisioningTemplateSummary
provisioningTemplateSummary
  = ProvisioningTemplateSummary'{_ptsLastModifiedDate =
                                   Nothing,
...
instance FromJSON ProvisioningTemplateSummary where
        parseJSON
          = withObject "ProvisioningTemplateSummary"
              (\ x ->
                 ProvisioningTemplateSummary' <$>
...
instance Hashable ProvisioningTemplateSummary where

instance NFData ProvisioningTemplateSummary where
