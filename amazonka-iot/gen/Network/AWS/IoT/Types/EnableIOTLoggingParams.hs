...
data EnableIOTLoggingParams = EnableIOTLoggingParams'{_eiotlpRoleARNForLogging
                                                      :: !Text,
                                                      _eiotlpLogLevel ::
                                                      !LogLevel}
...
enableIOTLoggingParams
    :: Text -- ^ 'eiotlpRoleARNForLogging'
    -> LogLevel -- ^ 'eiotlpLogLevel'
    -> EnableIOTLoggingParams
enableIOTLoggingParams pRoleARNForLogging_ pLogLevel_
  = EnableIOTLoggingParams'{_eiotlpRoleARNForLogging =
                              pRoleARNForLogging_,
...
instance FromJSON EnableIOTLoggingParams where
        parseJSON
          = withObject "EnableIOTLoggingParams"
              (\ x ->
                 EnableIOTLoggingParams' <$>
                   (x .: "roleArnForLogging") <*> (x .: "logLevel"))

instance Hashable EnableIOTLoggingParams where

instance NFData EnableIOTLoggingParams where
