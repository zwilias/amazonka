...
data RateIncreaseCriteria = RateIncreaseCriteria'{_ricNumberOfNotifiedThings
                                                  :: !(Maybe Nat),
...
rateIncreaseCriteria
    :: RateIncreaseCriteria
rateIncreaseCriteria
  = RateIncreaseCriteria'{_ricNumberOfNotifiedThings =
                            Nothing,
...
instance FromJSON RateIncreaseCriteria where
        parseJSON
          = withObject "RateIncreaseCriteria"
              (\ x ->
                 RateIncreaseCriteria' <$>
                   (x .:? "numberOfNotifiedThings") <*>
                     (x .:? "numberOfSucceededThings"))

instance Hashable RateIncreaseCriteria where

instance NFData RateIncreaseCriteria where
