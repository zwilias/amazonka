...
newtype TopicRuleDestinationConfiguration = TopicRuleDestinationConfiguration'{_trdcHttpURLConfiguration
                                                                               ::
                                                                               Maybe
...
topicRuleDestinationConfiguration
    :: TopicRuleDestinationConfiguration
topicRuleDestinationConfiguration
  = TopicRuleDestinationConfiguration'{_trdcHttpURLConfiguration
                                         = Nothing}
...
instance ToJSON TopicRuleDestinationConfiguration
         where
