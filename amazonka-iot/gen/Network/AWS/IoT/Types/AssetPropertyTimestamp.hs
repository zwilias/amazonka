...
data AssetPropertyTimestamp = AssetPropertyTimestamp'{_aptOffsetInNanos
                                                      :: !(Maybe Text),
                                                      _aptTimeInSeconds ::
                                                      !Text}
...
assetPropertyTimestamp
    :: Text -- ^ 'aptTimeInSeconds'
    -> AssetPropertyTimestamp
assetPropertyTimestamp pTimeInSeconds_
  = AssetPropertyTimestamp'{_aptOffsetInNanos =
                              Nothing,
...
instance FromJSON AssetPropertyTimestamp where
        parseJSON
          = withObject "AssetPropertyTimestamp"
              (\ x ->
                 AssetPropertyTimestamp' <$>
                   (x .:? "offsetInNanos") <*> (x .: "timeInSeconds"))

instance Hashable AssetPropertyTimestamp where

instance NFData AssetPropertyTimestamp where
