...
data DomainConfigurationSummary = DomainConfigurationSummary'{_dcsDomainConfigurationName
                                                              :: !(Maybe Text),
...
domainConfigurationSummary
    :: DomainConfigurationSummary
domainConfigurationSummary
  = DomainConfigurationSummary'{_dcsDomainConfigurationName
                                  = Nothing,
...
instance FromJSON DomainConfigurationSummary where
        parseJSON
          = withObject "DomainConfigurationSummary"
              (\ x ->
                 DomainConfigurationSummary' <$>
...
instance Hashable DomainConfigurationSummary where

instance NFData DomainConfigurationSummary where
