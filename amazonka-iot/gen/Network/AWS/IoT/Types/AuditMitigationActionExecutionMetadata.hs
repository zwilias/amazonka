...
data AuditMitigationActionExecutionMetadata = AuditMitigationActionExecutionMetadata'{_amaemStatus
                                                                                      ::
                                                                                      !(Maybe
...
auditMitigationActionExecutionMetadata
    :: AuditMitigationActionExecutionMetadata
auditMitigationActionExecutionMetadata
  = AuditMitigationActionExecutionMetadata'{_amaemStatus
                                              = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "AuditMitigationActionExecutionMetadata"
              (\ x ->
                 AuditMitigationActionExecutionMetadata' <$>
