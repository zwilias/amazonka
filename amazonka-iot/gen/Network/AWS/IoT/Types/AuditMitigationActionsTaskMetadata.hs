...
data AuditMitigationActionsTaskMetadata = AuditMitigationActionsTaskMetadata'{_amatmStartTime
                                                                              ::
                                                                              !(Maybe
                                                                                  POSIX),
                                                                              _amatmTaskId
...
auditMitigationActionsTaskMetadata
    :: AuditMitigationActionsTaskMetadata
auditMitigationActionsTaskMetadata
  = AuditMitigationActionsTaskMetadata'{_amatmStartTime
                                          = Nothing,
...
instance FromJSON AuditMitigationActionsTaskMetadata
         where
        parseJSON
          = withObject "AuditMitigationActionsTaskMetadata"
              (\ x ->
                 AuditMitigationActionsTaskMetadata' <$>
                   (x .:? "startTime") <*> (x .:? "taskId") <*>
                     (x .:? "taskStatus"))
