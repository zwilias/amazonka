...
data MitigationActionParams = MitigationActionParams'{_mapEnableIOTLoggingParams
                                                      ::
                                                      !(Maybe
...
mitigationActionParams
    :: MitigationActionParams
mitigationActionParams
  = MitigationActionParams'{_mapEnableIOTLoggingParams
                              = Nothing,
...
instance FromJSON MitigationActionParams where
        parseJSON
          = withObject "MitigationActionParams"
              (\ x ->
                 MitigationActionParams' <$>
...
instance Hashable MitigationActionParams where

instance NFData MitigationActionParams where
