...
action
  = Action'{_aCloudwatchMetric = Nothing,
            _aCloudwatchLogs = Nothing, _aDynamoDBv2 = Nothing,
            _aStepFunctions = Nothing,
            _aCloudwatchAlarm = Nothing, _aSns = Nothing,
            _aDynamoDB = Nothing, _aFirehose = Nothing,
            _aIotSiteWise = Nothing, _aIotAnalytics = Nothing,
            _aLambda = Nothing, _aIotEvents = Nothing,
            _aSalesforce = Nothing, _aKinesis = Nothing,
            _aS3 = Nothing, _aHttp = Nothing,
