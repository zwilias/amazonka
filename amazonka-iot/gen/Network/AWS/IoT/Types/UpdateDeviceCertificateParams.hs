...
newtype UpdateDeviceCertificateParams = UpdateDeviceCertificateParams'{_udcpAction
                                                                       ::
...
updateDeviceCertificateParams
    :: DeviceCertificateUpdateAction -- ^ 'udcpAction'
    -> UpdateDeviceCertificateParams
updateDeviceCertificateParams pAction_
  = UpdateDeviceCertificateParams'{_udcpAction =
                                     pAction_}
...
instance FromJSON UpdateDeviceCertificateParams where
        parseJSON
          = withObject "UpdateDeviceCertificateParams"
              (\ x ->
                 UpdateDeviceCertificateParams' <$> (x .: "action"))

instance Hashable UpdateDeviceCertificateParams where

instance NFData UpdateDeviceCertificateParams where
