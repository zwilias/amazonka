...
data AuthorizerConfig = AuthorizerConfig'{_acAllowAuthorizerOverride
                                          :: !(Maybe Bool),
...
authorizerConfig
    :: AuthorizerConfig
authorizerConfig
  = AuthorizerConfig'{_acAllowAuthorizerOverride =
                        Nothing,
...
instance FromJSON AuthorizerConfig where
        parseJSON
          = withObject "AuthorizerConfig"
              (\ x ->
                 AuthorizerConfig' <$>
                   (x .:? "allowAuthorizerOverride") <*>
                     (x .:? "defaultAuthorizerName"))

instance Hashable AuthorizerConfig where

instance NFData AuthorizerConfig where
