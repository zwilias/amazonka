...
data MqttContext = MqttContext'{_mcClientId ::
                                !(Maybe Text),
...
mqttContext
    :: MqttContext
mqttContext
  = MqttContext'{_mcClientId = Nothing,
                 _mcUsername = Nothing, _mcPassword = Nothing}
...
instance Hashable MqttContext where

instance NFData MqttContext where
