...
data StartSigningJobParameter = StartSigningJobParameter'{_ssjpDestination
                                                          ::
                                                          !(Maybe Destination),
...
startSigningJobParameter
    :: StartSigningJobParameter
startSigningJobParameter
  = StartSigningJobParameter'{_ssjpDestination =
                                Nothing,
...
instance FromJSON StartSigningJobParameter where
        parseJSON
          = withObject "StartSigningJobParameter"
              (\ x ->
                 StartSigningJobParameter' <$>
                   (x .:? "destination") <*>
...
instance Hashable StartSigningJobParameter where

instance NFData StartSigningJobParameter where
