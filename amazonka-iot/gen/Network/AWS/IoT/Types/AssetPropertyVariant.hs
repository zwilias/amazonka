...
data AssetPropertyVariant = AssetPropertyVariant'{_apvIntegerValue
                                                  :: !(Maybe Text),
                                                  _apvDoubleValue ::
                                                  !(Maybe Text),
                                                  _apvStringValue ::
...
assetPropertyVariant
    :: AssetPropertyVariant
assetPropertyVariant
  = AssetPropertyVariant'{_apvIntegerValue = Nothing,
                          _apvDoubleValue = Nothing, _apvStringValue = Nothing,
...
instance FromJSON AssetPropertyVariant where
        parseJSON
          = withObject "AssetPropertyVariant"
              (\ x ->
                 AssetPropertyVariant' <$>
...
instance Hashable AssetPropertyVariant where

instance NFData AssetPropertyVariant where
