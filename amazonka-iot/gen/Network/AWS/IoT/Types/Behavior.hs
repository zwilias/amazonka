...
data Behavior = Behavior'{_bMetricDimension ::
...
behavior
    ...
    -> Behavior
behavior pName_
  = Behavior'{_bMetricDimension = Nothing,
              _bMetric = Nothing, _bCriteria = Nothing,
              _bName = pName_}
...
instance Hashable Behavior where

instance NFData Behavior where
