...
newtype HTTPURLDestinationConfiguration = HTTPURLDestinationConfiguration'{_httpudcConfirmationURL
                                                                           ::
                                                                           Text}
...
hTTPURLDestinationConfiguration
    :: Text -- ^ 'httpudcConfirmationURL'
    -> HTTPURLDestinationConfiguration
hTTPURLDestinationConfiguration pConfirmationURL_
  = HTTPURLDestinationConfiguration'{_httpudcConfirmationURL
                                       = pConfirmationURL_}
...
instance NFData HTTPURLDestinationConfiguration where
