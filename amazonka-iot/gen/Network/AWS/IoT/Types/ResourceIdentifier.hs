...
data ResourceIdentifier = ResourceIdentifier'{_riIamRoleARN
                                              :: !(Maybe Text),
...
resourceIdentifier
    :: ResourceIdentifier
resourceIdentifier
  = ResourceIdentifier'{_riIamRoleARN = Nothing,
                        _riClientId = Nothing, _riRoleAliasARN = Nothing,
