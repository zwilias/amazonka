...
newtype HTTPURLDestinationSummary = HTTPURLDestinationSummary'{_httpudsConfirmationURL
                                                               :: Maybe Text}
...
hTTPURLDestinationSummary
    :: HTTPURLDestinationSummary
hTTPURLDestinationSummary
  = HTTPURLDestinationSummary'{_httpudsConfirmationURL
                                 = Nothing}
...
instance FromJSON HTTPURLDestinationSummary where
        parseJSON
          = withObject "HTTPURLDestinationSummary"
              (\ x ->
                 HTTPURLDestinationSummary' <$>
                   (x .:? "confirmationUrl"))

instance Hashable HTTPURLDestinationSummary where

instance NFData HTTPURLDestinationSummary where
