...
data MitigationActionIdentifier = MitigationActionIdentifier'{_maiActionName
                                                              :: !(Maybe Text),
                                                              _maiCreationDate
                                                              :: !(Maybe POSIX),
                                                              _maiActionARN ::
...
mitigationActionIdentifier
    :: MitigationActionIdentifier
mitigationActionIdentifier
  = MitigationActionIdentifier'{_maiActionName =
                                  Nothing,
...
instance FromJSON MitigationActionIdentifier where
        parseJSON
          = withObject "MitigationActionIdentifier"
              (\ x ->
                 MitigationActionIdentifier' <$>
                   (x .:? "actionName") <*> (x .:? "creationDate") <*>
                     (x .:? "actionArn"))

instance Hashable MitigationActionIdentifier where

instance NFData MitigationActionIdentifier where
