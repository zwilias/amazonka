...
data NonCompliantResource = NonCompliantResource'{_ncrAdditionalInfo
                                                  :: !(Maybe (Map Text Text)),
                                                  _ncrResourceType ::
                                                  !(Maybe ResourceType),
...
nonCompliantResource
    :: NonCompliantResource
nonCompliantResource
  = NonCompliantResource'{_ncrAdditionalInfo = Nothing,
...
instance FromJSON NonCompliantResource where
        parseJSON
          = withObject "NonCompliantResource"
              (\ x ->
                 NonCompliantResource' <$>
...
instance Hashable NonCompliantResource where

instance NFData NonCompliantResource where
