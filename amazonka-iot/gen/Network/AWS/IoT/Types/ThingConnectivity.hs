...
data ThingConnectivity = ThingConnectivity'{_tcConnected
                                            :: !(Maybe Bool),
...
thingConnectivity
    :: ThingConnectivity
thingConnectivity
  = ThingConnectivity'{_tcConnected = Nothing,
...
instance FromJSON ThingConnectivity where
        parseJSON
          = withObject "ThingConnectivity"
              (\ x ->
                 ThingConnectivity' <$>
                   (x .:? "connected") <*> (x .:? "timestamp"))

instance Hashable ThingConnectivity where

instance NFData ThingConnectivity where
