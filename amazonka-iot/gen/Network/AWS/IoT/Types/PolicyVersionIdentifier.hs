...
data PolicyVersionIdentifier = PolicyVersionIdentifier'{_pviPolicyName
                                                        :: !(Maybe Text),
                                                        _pviPolicyVersionId ::
                                                        !(Maybe Text)}
...
policyVersionIdentifier
    :: PolicyVersionIdentifier
policyVersionIdentifier
  = PolicyVersionIdentifier'{_pviPolicyName = Nothing,
...
instance FromJSON PolicyVersionIdentifier where
        parseJSON
          = withObject "PolicyVersionIdentifier"
              (\ x ->
                 PolicyVersionIdentifier' <$>
                   (x .:? "policyName") <*> (x .:? "policyVersionId"))

instance Hashable PolicyVersionIdentifier where

instance NFData PolicyVersionIdentifier where
