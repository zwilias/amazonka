...
data CertificateValidity = CertificateValidity'{_cvNotBefore
                                                :: !(Maybe POSIX),
...
certificateValidity
    :: CertificateValidity
certificateValidity
  = CertificateValidity'{_cvNotBefore = Nothing,
                         _cvNotAfter = Nothing}
...
instance FromJSON CertificateValidity where
        parseJSON
          = withObject "CertificateValidity"
              (\ x ->
                 CertificateValidity' <$>
                   (x .:? "notBefore") <*> (x .:? "notAfter"))

instance Hashable CertificateValidity where

instance NFData CertificateValidity where
