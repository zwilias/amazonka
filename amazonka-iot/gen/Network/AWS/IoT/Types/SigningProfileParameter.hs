...
data SigningProfileParameter = SigningProfileParameter'{_sppPlatform
                                                        :: !(Maybe Text),
                                                        _sppCertificateARN ::
                                                        !(Maybe Text),
...
signingProfileParameter
    :: SigningProfileParameter
signingProfileParameter
  = SigningProfileParameter'{_sppPlatform = Nothing,
...
instance FromJSON SigningProfileParameter where
        parseJSON
          = withObject "SigningProfileParameter"
              (\ x ->
                 SigningProfileParameter' <$>
                   (x .:? "platform") <*> (x .:? "certificateArn") <*>
                     (x .:? "certificatePathOnDevice"))

instance Hashable SigningProfileParameter where

instance NFData SigningProfileParameter where
