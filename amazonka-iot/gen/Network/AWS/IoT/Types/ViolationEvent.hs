...
data ViolationEvent = ViolationEvent'{_veViolationEventType
...
violationEvent
    :: ViolationEvent
violationEvent
  = ViolationEvent'{_veViolationEventType = Nothing,
                    _veViolationId = Nothing, _veBehavior = Nothing,
...
instance Hashable ViolationEvent where

instance NFData ViolationEvent where
