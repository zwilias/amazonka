...
data Statistics = Statistics'{_sStdDeviation ::
                              !(Maybe Double),
...
statistics
    :: Statistics
statistics
  = Statistics'{_sStdDeviation = Nothing,
                _sMaximum = Nothing, _sAverage = Nothing,
                _sCount = Nothing, _sMinimum = Nothing,
                _sVariance = Nothing, _sSumOfSquares = Nothing,
                _sSum = Nothing}
...
instance FromJSON Statistics where
        parseJSON
          = withObject "Statistics"
              (\ x ->
                 Statistics' <$>
                   (x .:? "stdDeviation") <*> (x .:? "maximum") <*>
                     (x .:? "average")
                     <*> (x .:? "count")
                     <*> (x .:? "minimum")
                     <*> (x .:? "variance")
...
instance Hashable Statistics where
