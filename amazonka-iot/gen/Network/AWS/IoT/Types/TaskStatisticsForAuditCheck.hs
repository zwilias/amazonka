...
data TaskStatisticsForAuditCheck = TaskStatisticsForAuditCheck'{_tsfacCanceledFindingsCount
                                                                ::
                                                                !(Maybe
                                                                    Integer),
...
taskStatisticsForAuditCheck
    :: TaskStatisticsForAuditCheck
taskStatisticsForAuditCheck
  = TaskStatisticsForAuditCheck'{_tsfacCanceledFindingsCount
                                   = Nothing,
...
instance FromJSON TaskStatisticsForAuditCheck where
        parseJSON
          = withObject "TaskStatisticsForAuditCheck"
              (\ x ->
                 TaskStatisticsForAuditCheck' <$>
...
instance Hashable TaskStatisticsForAuditCheck where

instance NFData TaskStatisticsForAuditCheck where
