...
newtype ReplaceDefaultPolicyVersionParams = ReplaceDefaultPolicyVersionParams'{_rdpvpTemplateName
                                                                               ::
                                                                               PolicyTemplateName}
...
replaceDefaultPolicyVersionParams
    :: PolicyTemplateName -- ^ 'rdpvpTemplateName'
    -> ReplaceDefaultPolicyVersionParams
replaceDefaultPolicyVersionParams pTemplateName_
  = ReplaceDefaultPolicyVersionParams'{_rdpvpTemplateName
                                         = pTemplateName_}
...
instance FromJSON ReplaceDefaultPolicyVersionParams
         where
        parseJSON
          = withObject "ReplaceDefaultPolicyVersionParams"
              (\ x ->
                 ReplaceDefaultPolicyVersionParams' <$>
                   (x .: "templateName"))
...
instance ToJSON ReplaceDefaultPolicyVersionParams
         where
