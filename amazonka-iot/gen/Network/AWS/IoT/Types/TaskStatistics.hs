...
data TaskStatistics = TaskStatistics'{_tsNonCompliantChecks
                                      :: !(Maybe Int),
...
taskStatistics
    :: TaskStatistics
taskStatistics
  = TaskStatistics'{_tsNonCompliantChecks = Nothing,
                    _tsWaitingForDataCollectionChecks = Nothing,
                    _tsFailedChecks = Nothing, _tsTotalChecks = Nothing,
...
instance Hashable TaskStatistics where

instance NFData TaskStatistics where
