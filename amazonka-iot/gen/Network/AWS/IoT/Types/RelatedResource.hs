...
data RelatedResource = RelatedResource'{_rrAdditionalInfo
                                        :: !(Maybe (Map Text Text)),
                                        _rrResourceType ::
                                        !(Maybe ResourceType),
...
relatedResource
    :: RelatedResource
relatedResource
  = RelatedResource'{_rrAdditionalInfo = Nothing,
...
instance Hashable RelatedResource where

instance NFData RelatedResource where
