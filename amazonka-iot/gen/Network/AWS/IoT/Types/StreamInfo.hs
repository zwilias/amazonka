...
data StreamInfo = StreamInfo'{_siLastUpdatedAt ::
                              !(Maybe POSIX),
...
streamInfo
    :: StreamInfo
streamInfo
  = StreamInfo'{_siLastUpdatedAt = Nothing,
                _siCreatedAt = Nothing, _siStreamVersion = Nothing,
                _siStreamARN = Nothing, _siFiles = Nothing,
                _siDescription = Nothing, _siStreamId = Nothing,
                _siRoleARN = Nothing}
