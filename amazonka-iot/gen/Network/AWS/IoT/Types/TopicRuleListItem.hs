...
data TopicRuleListItem = TopicRuleListItem'{_trliCreatedAt
                                            :: !(Maybe POSIX),
...
topicRuleListItem
    :: TopicRuleListItem
topicRuleListItem
  = TopicRuleListItem'{_trliCreatedAt = Nothing,
                       _trliRuleDisabled = Nothing, _trliRuleName = Nothing,
                       _trliRuleARN = Nothing, _trliTopicPattern = Nothing}
