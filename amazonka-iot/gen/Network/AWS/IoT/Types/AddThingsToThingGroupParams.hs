...
data AddThingsToThingGroupParams = AddThingsToThingGroupParams'{_atttgpOverrideDynamicGroups
                                                                ::
                                                                !(Maybe Bool),
...
addThingsToThingGroupParams
    :: NonEmpty Text -- ^ 'atttgpThingGroupNames'
    -> AddThingsToThingGroupParams
addThingsToThingGroupParams pThingGroupNames_
  = AddThingsToThingGroupParams'{_atttgpOverrideDynamicGroups
                                   = Nothing,
                                 _atttgpThingGroupNames =
...
instance FromJSON AddThingsToThingGroupParams where
        parseJSON
          = withObject "AddThingsToThingGroupParams"
              (\ x ->
                 AddThingsToThingGroupParams' <$>
                   (x .:? "overrideDynamicGroups") <*>
                     (x .: "thingGroupNames"))

instance Hashable AddThingsToThingGroupParams where

instance NFData AddThingsToThingGroupParams where
