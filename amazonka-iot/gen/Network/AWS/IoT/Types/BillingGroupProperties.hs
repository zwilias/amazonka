...
newtype BillingGroupProperties = BillingGroupProperties'{_bgpBillingGroupDescription
                                                         :: Maybe Text}
...
billingGroupProperties
    :: BillingGroupProperties
billingGroupProperties
  = BillingGroupProperties'{_bgpBillingGroupDescription
                              = Nothing}
...
instance FromJSON BillingGroupProperties where
        parseJSON
          = withObject "BillingGroupProperties"
              (\ x ->
                 BillingGroupProperties' <$>
                   (x .:? "billingGroupDescription"))

instance Hashable BillingGroupProperties where

instance NFData BillingGroupProperties where
