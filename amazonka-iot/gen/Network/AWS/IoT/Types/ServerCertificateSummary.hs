...
data ServerCertificateSummary = ServerCertificateSummary'{_scsServerCertificateStatusDetail
                                                          :: !(Maybe Text),
...
serverCertificateSummary
    :: ServerCertificateSummary
serverCertificateSummary
  = ServerCertificateSummary'{_scsServerCertificateStatusDetail
                                = Nothing,
...
instance FromJSON ServerCertificateSummary where
        parseJSON
          = withObject "ServerCertificateSummary"
              (\ x ->
                 ServerCertificateSummary' <$>
...
instance Hashable ServerCertificateSummary where

instance NFData ServerCertificateSummary where
