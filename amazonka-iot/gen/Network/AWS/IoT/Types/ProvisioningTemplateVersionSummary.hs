...
data ProvisioningTemplateVersionSummary = ProvisioningTemplateVersionSummary'{_ptvsVersionId
                                                                              ::
                                                                              !(Maybe
                                                                                  Int),
                                                                              _ptvsCreationDate
...
provisioningTemplateVersionSummary
    :: ProvisioningTemplateVersionSummary
provisioningTemplateVersionSummary
  = ProvisioningTemplateVersionSummary'{_ptvsVersionId
                                          = Nothing,
...
instance FromJSON ProvisioningTemplateVersionSummary
         where
        parseJSON
          = withObject "ProvisioningTemplateVersionSummary"
              (\ x ->
                 ProvisioningTemplateVersionSummary' <$>
