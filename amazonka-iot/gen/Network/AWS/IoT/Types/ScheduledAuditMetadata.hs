...
data ScheduledAuditMetadata = ScheduledAuditMetadata'{_samFrequency
                                                      ::
...
scheduledAuditMetadata
    :: ScheduledAuditMetadata
scheduledAuditMetadata
  = ScheduledAuditMetadata'{_samFrequency = Nothing,
                            _samScheduledAuditName = Nothing,
                            _samDayOfMonth = Nothing, _samDayOfWeek = Nothing,
...
instance FromJSON ScheduledAuditMetadata where
        parseJSON
          = withObject "ScheduledAuditMetadata"
              (\ x ->
                 ScheduledAuditMetadata' <$>
...
instance Hashable ScheduledAuditMetadata where

instance NFData ScheduledAuditMetadata where
