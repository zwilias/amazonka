...
data IotSiteWiseAction = IotSiteWiseAction'{_iswaPutAssetPropertyValueEntries
                                            ::
...
iotSiteWiseAction
    :: NonEmpty PutAssetPropertyValueEntry -- ^ 'iswaPutAssetPropertyValueEntries'
    -> Text -- ^ 'iswaRoleARN'
    -> IotSiteWiseAction
iotSiteWiseAction pPutAssetPropertyValueEntries_
  pRoleARN_
  = IotSiteWiseAction'{_iswaPutAssetPropertyValueEntries
...
instance FromJSON IotSiteWiseAction where
        parseJSON
          = withObject "IotSiteWiseAction"
              (\ x ->
                 IotSiteWiseAction' <$>
                   (x .: "putAssetPropertyValueEntries") <*>
                     (x .: "roleArn"))

instance Hashable IotSiteWiseAction where

instance NFData IotSiteWiseAction where
