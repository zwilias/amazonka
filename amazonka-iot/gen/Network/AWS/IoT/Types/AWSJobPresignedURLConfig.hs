...
newtype AWSJobPresignedURLConfig = AWSJobPresignedURLConfig'{_ajpucExpiresInSec
                                                             :: Maybe Integer}
...
awsJobPresignedURLConfig
    :: AWSJobPresignedURLConfig
awsJobPresignedURLConfig
  = AWSJobPresignedURLConfig'{_ajpucExpiresInSec =
                                Nothing}
...
instance FromJSON AWSJobPresignedURLConfig where
        parseJSON
          = withObject "AWSJobPresignedURLConfig"
              (\ x ->
                 AWSJobPresignedURLConfig' <$> (x .:? "expiresInSec"))

instance Hashable AWSJobPresignedURLConfig where

instance NFData AWSJobPresignedURLConfig where
