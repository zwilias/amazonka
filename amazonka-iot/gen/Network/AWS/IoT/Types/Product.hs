...
instance FromJSON Action where
  parseJSON =
    withObject
      "Action"
      (\x ->
         Action' <$> (x .:? "cloudwatchMetric") <*> (x .:? "dynamoDBv2") <*>
         (x .:? "cloudwatchAlarm") <*>
         (x .:? "sns") <*>
         (x .:? "dynamoDB") <*>
         (x .:? "firehose") <*>
...
instance FromJSON Allowed where
  parseJSON =
    withObject "Allowed" (\x -> Allowed' <$> (x .:? "policies" .!= mempty))
...
apAttributes =
  lens _apAttributes (\s a -> s {_apAttributes = a}) . _Default . _Map
...
instance FromJSON AttributePayload where
  parseJSON =
    withObject
      "AttributePayload"
      (\x ->
         AttributePayload' <$> (x .:? "attributes" .!= mempty) <*>
         (x .:? "merge"))
...
aiResources =
  lens _aiResources (\s a -> s {_aiResources = a}) . _Default . _Coerce
...
instance FromJSON AuthInfo where
  parseJSON =
    withObject
      "AuthInfo"
      (\x ->
         AuthInfo' <$> (x .:? "resources" .!= mempty) <*> (x .:? "actionType"))
...
arMissingContextValues =
  lens _arMissingContextValues (\s a -> s {_arMissingContextValues = a}) .
  _Default . _Coerce
...
instance FromJSON AuthResult where
  parseJSON =
    withObject
      "AuthResult"
      (\x ->
         AuthResult' <$> (x .:? "denied") <*> (x .:? "authDecision") <*>
         (x .:? "allowed") <*>
...
adLastModifiedDate =
  lens _adLastModifiedDate (\s a -> s {_adLastModifiedDate = a}) . mapping _Time
...
adAuthorizerFunctionARN =
  lens _adAuthorizerFunctionARN (\s a -> s {_adAuthorizerFunctionARN = a})
...
adCreationDate =
  lens _adCreationDate (\s a -> s {_adCreationDate = a}) . mapping _Time

-- | The public keys used to validate the token signature returned by your custom authentication service.
adTokenSigningPublicKeys :: Lens' AuthorizerDescription (HashMap Text Text)
adTokenSigningPublicKeys =
  lens _adTokenSigningPublicKeys (\s a -> s {_adTokenSigningPublicKeys = a}) .
  _Default . _Map
...
instance FromJSON AuthorizerDescription where
  parseJSON =
    withObject
      "AuthorizerDescription"
      (\x ->
         AuthorizerDescription' <$> (x .:? "status") <*>
         (x .:? "lastModifiedDate") <*>
         (x .:? "authorizerName") <*>
...
instance FromJSON AuthorizerSummary where
  parseJSON =
    withObject
      "AuthorizerSummary"
      (\x ->
         AuthorizerSummary' <$> (x .:? "authorizerName") <*>
         (x .:? "authorizerArn"))
...
cacCreationDate =
  lens _cacCreationDate (\s a -> s {_cacCreationDate = a}) . mapping _Time
...
instance FromJSON CACertificate where
  parseJSON =
    withObject
      "CACertificate"
      (\x ->
         CACertificate' <$> (x .:? "status") <*> (x .:? "certificateArn") <*>
         (x .:? "certificateId") <*>
         (x .:? "creationDate"))
...
cacdLastModifiedDate =
  lens _cacdLastModifiedDate (\s a -> s {_cacdLastModifiedDate = a}) .
  mapping _Time

-- | The CA certificate data, in PEM format.
cacdCertificatePem :: Lens' CACertificateDescription (Maybe Text)
cacdCertificatePem =
  lens _cacdCertificatePem (\s a -> s {_cacdCertificatePem = a})

-- | The CA certificate ARN.
cacdCertificateARN :: Lens' CACertificateDescription (Maybe Text)
cacdCertificateARN =
  lens _cacdCertificateARN (\s a -> s {_cacdCertificateARN = a})
...
cacdAutoRegistrationStatus ::
     Lens' CACertificateDescription (Maybe AutoRegistrationStatus)
cacdAutoRegistrationStatus =
  lens _cacdAutoRegistrationStatus (\s a -> s {_cacdAutoRegistrationStatus = a})

-- | The date the CA certificate was created.
cacdCreationDate :: Lens' CACertificateDescription (Maybe UTCTime)
cacdCreationDate =
  lens _cacdCreationDate (\s a -> s {_cacdCreationDate = a}) . mapping _Time
...
cacdCustomerVersion =
  lens _cacdCustomerVersion (\s a -> s {_cacdCustomerVersion = a}) .
  mapping _Nat
...
instance FromJSON CACertificateDescription where
  parseJSON =
    withObject
      "CACertificateDescription"
      (\x ->
         CACertificateDescription' <$> (x .:? "status") <*> (x .:? "ownedBy") <*>
         (x .:? "lastModifiedDate") <*>
         (x .:? "certificatePem") <*>
         (x .:? "certificateArn") <*>
         (x .:? "certificateId") <*>
...
cCreationDate =
  lens _cCreationDate (\s a -> s {_cCreationDate = a}) . mapping _Time
...
instance FromJSON Certificate where
  parseJSON =
    withObject
      "Certificate"
      (\x ->
         Certificate' <$> (x .:? "status") <*> (x .:? "certificateArn") <*>
         (x .:? "certificateId") <*>
         (x .:? "creationDate"))
...
cdLastModifiedDate =
  lens _cdLastModifiedDate (\s a -> s {_cdLastModifiedDate = a}) . mapping _Time
...
cdCreationDate =
  lens _cdCreationDate (\s a -> s {_cdCreationDate = a}) . mapping _Time
...
cdCustomerVersion =
  lens _cdCustomerVersion (\s a -> s {_cdCustomerVersion = a}) . mapping _Nat
...
instance FromJSON CertificateDescription where
  parseJSON =
    withObject
      "CertificateDescription"
      (\x ->
         CertificateDescription' <$> (x .:? "status") <*> (x .:? "ownedBy") <*>
         (x .:? "lastModifiedDate") <*>
         (x .:? "caCertificateId") <*>
         (x .:? "previousOwnedBy") <*>
         (x .:? "certificatePem") <*>
...
instance FromJSON CloudwatchAlarmAction where
  parseJSON =
    withObject
      "CloudwatchAlarmAction"
      (\x ->
         CloudwatchAlarmAction' <$> (x .: "roleArn") <*> (x .: "alarmName") <*>
         (x .: "stateReason") <*>
         (x .: "stateValue"))
...
cmaMetricTimestamp =
  lens _cmaMetricTimestamp (\s a -> s {_cmaMetricTimestamp = a})
...
cmaMetricNamespace =
  lens _cmaMetricNamespace (\s a -> s {_cmaMetricNamespace = a})
...
instance FromJSON CloudwatchMetricAction where
  parseJSON =
    withObject
      "CloudwatchMetricAction"
      (\x ->
         CloudwatchMetricAction' <$> (x .:? "metricTimestamp") <*>
         (x .: "roleArn") <*>
         (x .: "metricNamespace") <*>
         (x .: "metricName") <*>
         (x .: "metricValue") <*>
...
csCustomCodeSigning =
  lens _csCustomCodeSigning (\s a -> s {_csCustomCodeSigning = a})
...
instance FromJSON CodeSigning where
  parseJSON =
    withObject
      "CodeSigning"
      (\x ->
         CodeSigning' <$> (x .:? "customCodeSigning") <*>
         (x .:? "awsSignerJobId"))
...
csccCertificateName =
  lens _csccCertificateName (\s a -> s {_csccCertificateName = a})

-- | A base64 encoded binary representation of the code signing certificate chain.
csccInlineDocument :: Lens' CodeSigningCertificateChain (Maybe Text)
csccInlineDocument =
  lens _csccInlineDocument (\s a -> s {_csccInlineDocument = a})
...
instance FromJSON CodeSigningCertificateChain where
  parseJSON =
    withObject
      "CodeSigningCertificateChain"
      (\x ->
         CodeSigningCertificateChain' <$> (x .:? "stream") <*>
         (x .:? "certificateName") <*>
         (x .:? "inlineDocument"))
...
cssInlineDocument =
  lens _cssInlineDocument (\s a -> s {_cssInlineDocument = a}) . mapping _Base64
...
instance FromJSON CodeSigningSignature where
  parseJSON =
    withObject
      "CodeSigningSignature"
      (\x ->
         CodeSigningSignature' <$> (x .:? "stream") <*> (x .:? "inlineDocument"))
...
instance FromJSON Configuration where
  parseJSON =
    withObject "Configuration" (\x -> Configuration' <$> (x .:? "Enabled"))
...
instance ToJSON Configuration where
  toJSON Configuration' {..} = object (catMaybes [("Enabled" .=) <$> _cEnabled])
...
ccsCertificateChain ::
     Lens' CustomCodeSigning (Maybe CodeSigningCertificateChain)
ccsCertificateChain =
  lens _ccsCertificateChain (\s a -> s {_ccsCertificateChain = a})

-- | The signature algorithm used to code sign the file.
ccsSignatureAlgorithm :: Lens' CustomCodeSigning (Maybe Text)
ccsSignatureAlgorithm =
  lens _ccsSignatureAlgorithm (\s a -> s {_ccsSignatureAlgorithm = a})
...
instance FromJSON CustomCodeSigning where
  parseJSON =
    withObject
      "CustomCodeSigning"
      (\x ->
         CustomCodeSigning' <$> (x .:? "signature") <*> (x .:? "hashAlgorithm") <*>
         (x .:? "certificateChain") <*>
...
instance FromJSON Denied where
  parseJSON =
    withObject
      "Denied"
      (\x -> Denied' <$> (x .:? "implicitDeny") <*> (x .:? "explicitDeny"))
...
instance FromJSON DynamoDBAction where
  parseJSON =
    withObject
      "DynamoDBAction"
      (\x ->
         DynamoDBAction' <$> (x .:? "hashKeyType") <*> (x .:? "operation") <*>
         (x .:? "rangeKeyType") <*>
         (x .:? "payloadField") <*>
         (x .:? "rangeKeyField") <*>
         (x .:? "rangeKeyValue") <*>
...
instance FromJSON DynamoDBv2Action where
  parseJSON =
    withObject
      "DynamoDBv2Action"
      (\x -> DynamoDBv2Action' <$> (x .:? "putItem") <*> (x .:? "roleArn"))
...
instance ToJSON DynamoDBv2Action where
  toJSON DynamoDBv2Action' {..} =
    object
      (catMaybes
         [("putItem" .=) <$> _ddaPutItem, ("roleArn" .=) <$> _ddaRoleARN])
...
instance FromJSON EffectivePolicy where
  parseJSON =
    withObject
      "EffectivePolicy"
      (\x ->
         EffectivePolicy' <$> (x .:? "policyName") <*> (x .:? "policyDocument") <*>
         (x .:? "policyArn"))
...
instance FromJSON ElasticsearchAction where
  parseJSON =
    withObject
      "ElasticsearchAction"
      (\x ->
         ElasticsearchAction' <$> (x .: "roleArn") <*> (x .: "endpoint") <*>
         (x .: "index") <*>
         (x .: "type") <*>
         (x .: "id"))
...
faDeliveryStreamName =
  lens _faDeliveryStreamName (\s a -> s {_faDeliveryStreamName = a})
...
instance FromJSON FirehoseAction where
  parseJSON =
    withObject
      "FirehoseAction"
      (\x ->
         FirehoseAction' <$> (x .:? "separator") <*> (x .: "roleArn") <*>
...
instance FromJSON GroupNameAndARN where
  parseJSON =
    withObject
      "GroupNameAndARN"
      (\x -> GroupNameAndARN' <$> (x .:? "groupArn") <*> (x .:? "groupName"))
...
instance FromJSON IotAnalyticsAction where
  parseJSON =
    withObject
      "IotAnalyticsAction"
      (\x ->
         IotAnalyticsAction' <$> (x .:? "channelArn") <*> (x .:? "channelName") <*>
         (x .:? "roleArn"))
...
jobJobExecutionsRolloutConfig =
  lens
    ...
    (\s a -> s {_jobJobExecutionsRolloutConfig = a})
...
jobLastUpdatedAt =
  lens _jobLastUpdatedAt (\s a -> s {_jobLastUpdatedAt = a}) . mapping _Time
...
jobCompletedAt =
  lens _jobCompletedAt (\s a -> s {_jobCompletedAt = a}) . mapping _Time
...
jobTargetSelection =
  lens _jobTargetSelection (\s a -> s {_jobTargetSelection = a})
...
instance FromJSON Job where
  parseJSON =
    withObject
      "Job"
      (\x ->
         Job' <$> (x .:? "status") <*> (x .:? "jobExecutionsRolloutConfig") <*>
         (x .:? "jobId") <*>
         (x .:? "lastUpdatedAt") <*>
         (x .:? "jobArn") <*>
         (x .:? "createdAt") <*>
...
jeLastUpdatedAt =
  lens _jeLastUpdatedAt (\s a -> s {_jeLastUpdatedAt = a}) . mapping _Time
...
jesdDetailsMap =
  lens _jesdDetailsMap (\s a -> s {_jesdDetailsMap = a}) . _Default . _Map

instance FromJSON JobExecutionStatusDetails where
  parseJSON =
    withObject
      "JobExecutionStatusDetails"
      (\x -> JobExecutionStatusDetails' <$> (x .:? "detailsMap" .!= mempty))
...
jesLastUpdatedAt =
  lens _jesLastUpdatedAt (\s a -> s {_jesLastUpdatedAt = a}) . mapping _Time
...
jesExecutionNumber =
  lens _jesExecutionNumber (\s a -> s {_jesExecutionNumber = a})

-- | The time, in milliseconds since the epoch, when the job execution started.
jesStartedAt :: Lens' JobExecutionSummary (Maybe UTCTime)
jesStartedAt =
  lens _jesStartedAt (\s a -> s {_jesStartedAt = a}) . mapping _Time
...
instance FromJSON JobExecutionSummary where
  parseJSON =
    withObject
      "JobExecutionSummary"
      (\x ->
         JobExecutionSummary' <$> (x .:? "status") <*> (x .:? "lastUpdatedAt") <*>
         (x .:? "queuedAt") <*>
         (x .:? "executionNumber") <*>
         (x .:? "startedAt"))
...
jesfjJobExecutionSummary ::
     Lens' JobExecutionSummaryForJob (Maybe JobExecutionSummary)
jesfjJobExecutionSummary =
  lens _jesfjJobExecutionSummary (\s a -> s {_jesfjJobExecutionSummary = a})
...
instance FromJSON JobExecutionSummaryForJob where
  parseJSON =
    withObject
      "JobExecutionSummaryForJob"
      (\x ->
         JobExecutionSummaryForJob' <$> (x .:? "jobExecutionSummary") <*>
         (x .:? "thingArn"))
...
jesftJobExecutionSummary ::
     Lens' JobExecutionSummaryForThing (Maybe JobExecutionSummary)
jesftJobExecutionSummary =
  lens _jesftJobExecutionSummary (\s a -> s {_jesftJobExecutionSummary = a})
...
instance FromJSON JobExecutionSummaryForThing where
  parseJSON =
    withObject
      "JobExecutionSummaryForThing"
      (\x ->
         JobExecutionSummaryForThing' <$> (x .:? "jobId") <*>
...
jercMaximumPerMinute =
  lens _jercMaximumPerMinute (\s a -> s {_jercMaximumPerMinute = a}) .
  mapping _Nat
...
instance FromJSON JobExecutionsRolloutConfig where
  parseJSON =
    withObject
      "JobExecutionsRolloutConfig"
      (\x -> JobExecutionsRolloutConfig' <$> (x .:? "maximumPerMinute"))
...
instance ToJSON JobExecutionsRolloutConfig where
  toJSON JobExecutionsRolloutConfig' {..} =
    object (catMaybes [("maximumPerMinute" .=) <$> _jercMaximumPerMinute])
...
instance FromJSON JobProcessDetails where
  parseJSON =
    withObject
      "JobProcessDetails"
      (\x ->
         JobProcessDetails' <$> (x .:? "numberOfRemovedThings") <*>
...
jsLastUpdatedAt =
  lens _jsLastUpdatedAt (\s a -> s {_jsLastUpdatedAt = a}) . mapping _Time
...
jsCompletedAt =
  lens _jsCompletedAt (\s a -> s {_jsCompletedAt = a}) . mapping _Time
...
kpPrivateKey =
  lens _kpPrivateKey (\s a -> s {_kpPrivateKey = a}) . mapping _Sensitive
...
instance FromJSON KinesisAction where
  parseJSON =
    withObject
      "KinesisAction"
      (\x ->
         KinesisAction' <$> (x .:? "partitionKey") <*> (x .: "roleArn") <*>
         (x .: "streamName"))
...
instance FromJSON LambdaAction where
  parseJSON =
    withObject "LambdaAction" (\x -> LambdaAction' <$> (x .: "functionArn"))
...
instance FromJSON LogTarget where
  parseJSON =
    withObject
      "LogTarget"
      (\x -> LogTarget' <$> (x .:? "targetName") <*> (x .: "targetType"))
...
instance FromJSON LogTargetConfiguration where
  parseJSON =
    withObject
      "LogTargetConfiguration"
      (\x ->
         LogTargetConfiguration' <$> (x .:? "logLevel") <*> (x .:? "logTarget"))
...
instance ToJSON LoggingOptionsPayload where
  toJSON LoggingOptionsPayload' {..} =
    object
      (catMaybes
         [("logLevel" .=) <$> _lopLogLevel, Just ("roleArn" .= _lopRoleARN)])
...
otaufAttributes =
  lens _otaufAttributes (\s a -> s {_otaufAttributes = a}) . _Default . _Map
...
otauiLastModifiedDate =
  lens _otauiLastModifiedDate (\s a -> s {_otauiLastModifiedDate = a}) .
  mapping _Time
...
otauiOtaUpdateFiles =
  lens _otauiOtaUpdateFiles (\s a -> s {_otauiOtaUpdateFiles = a}) .
  mapping _List1

-- | The status of the OTA update.
otauiOtaUpdateStatus :: Lens' OTAUpdateInfo (Maybe OTAUpdateStatus)
otauiOtaUpdateStatus =
  lens _otauiOtaUpdateStatus (\s a -> s {_otauiOtaUpdateStatus = a})

-- | The targets of the OTA update.
otauiTargets :: Lens' OTAUpdateInfo (Maybe (NonEmpty Text))
otauiTargets =
  lens _otauiTargets (\s a -> s {_otauiTargets = a}) . mapping _List1
...
otauiCreationDate =
  lens _otauiCreationDate (\s a -> s {_otauiCreationDate = a}) . mapping _Time

-- | A collection of name/value pairs
otauiAdditionalParameters :: Lens' OTAUpdateInfo (HashMap Text Text)
otauiAdditionalParameters =
  lens _otauiAdditionalParameters (\s a -> s {_otauiAdditionalParameters = a}) .
  _Default . _Map
...
otauiTargetSelection =
  lens _otauiTargetSelection (\s a -> s {_otauiTargetSelection = a})
...
instance FromJSON OTAUpdateInfo where
  parseJSON =
    withObject
      "OTAUpdateInfo"
      (\x ->
         OTAUpdateInfo' <$> (x .:? "lastModifiedDate") <*> (x .:? "awsIotJobId") <*>
         (x .:? "otaUpdateFiles") <*>
         (x .:? "otaUpdateStatus") <*>
         (x .:? "targets") <*>
         (x .:? "awsIotJobArn") <*>
...
otausCreationDate =
  lens _otausCreationDate (\s a -> s {_otausCreationDate = a}) . mapping _Time
...
instance FromJSON OTAUpdateSummary where
  parseJSON =
    withObject
      "OTAUpdateSummary"
      (\x ->
         OTAUpdateSummary' <$> (x .:? "creationDate") <*> (x .:? "otaUpdateId") <*>
         (x .:? "otaUpdateArn"))
...
ocTransferDate =
  lens _ocTransferDate (\s a -> s {_ocTransferDate = a}) . mapping _Time
...
ocCreationDate =
  lens _ocCreationDate (\s a -> s {_ocCreationDate = a}) . mapping _Time
...
instance FromJSON OutgoingCertificate where
  parseJSON =
    withObject
      "OutgoingCertificate"
      (\x ->
         OutgoingCertificate' <$> (x .:? "transferDate") <*>
         (x .:? "certificateArn") <*>
         (x .:? "certificateId") <*>
         (x .:? "transferredTo") <*>
         (x .:? "creationDate") <*>
...
pvCreateDate =
  lens _pvCreateDate (\s a -> s {_pvCreateDate = a}) . mapping _Time
...
instance FromJSON PolicyVersion where
  parseJSON =
    withObject
      "PolicyVersion"
      (\x ->
         PolicyVersion' <$> (x .:? "versionId") <*> (x .:? "createDate") <*>
         (x .:? "isDefaultVersion"))
...
pucExpiresInSec =
  lens _pucExpiresInSec (\s a -> s {_pucExpiresInSec = a}) . mapping _Nat
...
instance FromJSON PresignedURLConfig where
  parseJSON =
    withObject
      "PresignedURLConfig"
      (\x ->
         PresignedURLConfig' <$> (x .:? "expiresInSec") <*> (x .:? "roleArn"))
...
instance FromJSON PutItemInput where
  parseJSON =
    withObject "PutItemInput" (\x -> PutItemInput' <$> (x .: "tableName"))
...
instance FromJSON RegistrationConfig where
  parseJSON =
    withObject
      "RegistrationConfig"
      (\x ->
         RegistrationConfig' <$> (x .:? "templateBody") <*> (x .:? "roleArn"))
...
instance FromJSON RepublishAction where
  parseJSON =
    withObject
      "RepublishAction"
      (\x -> RepublishAction' <$> (x .: "roleArn") <*> (x .: "topic"))
...
instance ToJSON RepublishAction where
  toJSON RepublishAction' {..} =
    object
      (catMaybes [Just ("roleArn" .= _raRoleARN), Just ("topic" .= _raTopic)])
...
radLastModifiedDate =
  lens _radLastModifiedDate (\s a -> s {_radLastModifiedDate = a}) .
  mapping _Time
...
radCreationDate =
  lens _radCreationDate (\s a -> s {_radCreationDate = a}) . mapping _Time
...
radCredentialDurationSeconds =
  lens
    ...
    (\s a -> s {_radCredentialDurationSeconds = a}) .
  mapping _Nat
...
instance FromJSON RoleAliasDescription where
  parseJSON =
    withObject
      "RoleAliasDescription"
      (\x ->
         RoleAliasDescription' <$> (x .:? "roleAliasArn") <*>
         (x .:? "lastModifiedDate") <*>
         (x .:? "roleAlias") <*>
         (x .:? "owner") <*>
         (x .:? "creationDate") <*>
...
instance FromJSON S3Action where
  parseJSON =
    withObject
      "S3Action"
      (\x ->
         S3Action' <$> (x .:? "cannedAcl") <*> (x .: "roleArn") <*>
         (x .: "bucketName") <*>
         (x .: "key"))
...
instance FromJSON S3Location where
  parseJSON =
    withObject
      "S3Location"
      (\x ->
         S3Location' <$> (x .:? "version") <*> (x .: "bucket") <*> (x .: "key"))
...
instance FromJSON SNSAction where
  parseJSON =
    withObject
      "SNSAction"
      (\x ->
         SNSAction' <$> (x .:? "messageFormat") <*> (x .: "targetArn") <*>
         (x .: "roleArn"))
...
instance ToJSON SalesforceAction where
  toJSON SalesforceAction' {..} =
    object (catMaybes [Just ("token" .= _saToken), Just ("url" .= _saUrl)])
...
instance FromJSON SqsAction where
  parseJSON =
    withObject
      "SqsAction"
      (\x ->
         SqsAction' <$> (x .:? "useBase64") <*> (x .: "roleArn") <*>
         (x .: "queueUrl"))
...
instance ToJSON Stream where
  toJSON Stream' {..} =
    object
      (catMaybes [("fileId" .=) <$> _sFileId, ("streamId" .=) <$> _sStreamId])
...
siLastUpdatedAt =
  lens _siLastUpdatedAt (\s a -> s {_siLastUpdatedAt = a}) . mapping _Time
...
siStreamVersion =
  lens _siStreamVersion (\s a -> s {_siStreamVersion = a}) . mapping _Nat
...
instance FromJSON StreamInfo where
  parseJSON =
    withObject
      "StreamInfo"
      (\x ->
         StreamInfo' <$> (x .:? "lastUpdatedAt") <*> (x .:? "createdAt") <*>
         (x .:? "streamVersion") <*>
         (x .:? "streamArn") <*>
         (x .:? "files") <*>
         (x .:? "description") <*>
...
ssStreamVersion =
  lens _ssStreamVersion (\s a -> s {_ssStreamVersion = a}) . mapping _Nat
...
instance FromJSON StreamSummary where
  parseJSON =
    withObject
      "StreamSummary"
      (\x ->
         StreamSummary' <$> (x .:? "streamVersion") <*> (x .:? "streamArn") <*>
         (x .:? "description") <*>
         (x .:? "streamId"))
...
taAttributes =
  lens _taAttributes (\s a -> s {_taAttributes = a}) . _Default . _Map
...
instance FromJSON ThingAttribute where
  parseJSON =
    withObject
      "ThingAttribute"
      (\x ->
         ThingAttribute' <$> (x .:? "thingTypeName") <*> (x .:? "thingArn") <*>
         (x .:? "attributes" .!= mempty) <*>
         (x .:? "version") <*>
         (x .:? "thingName"))
...
tdThingGroupNames =
  lens _tdThingGroupNames (\s a -> s {_tdThingGroupNames = a}) .
  _Default . _Coerce
...
tdAttributes =
  lens _tdAttributes (\s a -> s {_tdAttributes = a}) . _Default . _Map
...
instance FromJSON ThingDocument where
  parseJSON =
    withObject
      "ThingDocument"
      (\x ->
         ThingDocument' <$> (x .:? "thingGroupNames" .!= mempty) <*>
         (x .:? "thingTypeName") <*>
         (x .:? "shadow") <*>
         (x .:? "attributes" .!= mempty) <*>
         (x .:? "thingName") <*>
...
tgmRootToParentThingGroups =
  lens _tgmRootToParentThingGroups (\s a -> s {_tgmRootToParentThingGroups = a}) .
  _Default . _Coerce

-- | The parent thing group name.
tgmParentGroupName :: Lens' ThingGroupMetadata (Maybe Text)
tgmParentGroupName =
  lens _tgmParentGroupName (\s a -> s {_tgmParentGroupName = a})

-- | The UNIX timestamp of when the thing group was created.
tgmCreationDate :: Lens' ThingGroupMetadata (Maybe UTCTime)
tgmCreationDate =
  lens _tgmCreationDate (\s a -> s {_tgmCreationDate = a}) . mapping _Time
...
instance FromJSON ThingGroupMetadata where
  parseJSON =
    withObject
      "ThingGroupMetadata"
      (\x ->
         ThingGroupMetadata' <$> (x .:? "rootToParentThingGroups" .!= mempty) <*>
         (x .:? "parentGroupName") <*>
         (x .:? "creationDate"))
...
tgpAttributePayload =
  lens _tgpAttributePayload (\s a -> s {_tgpAttributePayload = a})

-- | The thing group description.
tgpThingGroupDescription :: Lens' ThingGroupProperties (Maybe Text)
tgpThingGroupDescription =
  lens _tgpThingGroupDescription (\s a -> s {_tgpThingGroupDescription = a})
...
instance FromJSON ThingGroupProperties where
  parseJSON =
    withObject
      "ThingGroupProperties"
      (\x ->
         ThingGroupProperties' <$> (x .:? "attributePayload") <*>
...
ticThingIndexingMode ::
     Lens' ThingIndexingConfiguration (Maybe ThingIndexingMode)
ticThingIndexingMode =
  lens _ticThingIndexingMode (\s a -> s {_ticThingIndexingMode = a})

instance FromJSON ThingIndexingConfiguration where
  parseJSON =
    withObject
      "ThingIndexingConfiguration"
      (\x -> ThingIndexingConfiguration' <$> (x .:? "thingIndexingMode"))
...
instance ToJSON ThingIndexingConfiguration where
  toJSON ThingIndexingConfiguration' {..} =
    object (catMaybes [("thingIndexingMode" .=) <$> _ticThingIndexingMode])
...
ttdThingTypeProperties =
  lens _ttdThingTypeProperties (\s a -> s {_ttdThingTypeProperties = a})
...
ttdThingTypeMetadata =
  lens _ttdThingTypeMetadata (\s a -> s {_ttdThingTypeMetadata = a})
...
instance FromJSON ThingTypeDefinition where
  parseJSON =
    withObject
      "ThingTypeDefinition"
      (\x ->
         ThingTypeDefinition' <$> (x .:? "thingTypeProperties") <*>
         (x .:? "thingTypeName") <*>
         (x .:? "thingTypeMetadata") <*>
         (x .:? "thingTypeArn"))
...
ttmDeprecationDate =
  lens _ttmDeprecationDate (\s a -> s {_ttmDeprecationDate = a}) . mapping _Time

-- | The date and time when the thing type was created.
ttmCreationDate :: Lens' ThingTypeMetadata (Maybe UTCTime)
ttmCreationDate =
  lens _ttmCreationDate (\s a -> s {_ttmCreationDate = a}) . mapping _Time
...
instance FromJSON ThingTypeMetadata where
  parseJSON =
    withObject
      "ThingTypeMetadata"
      (\x ->
         ThingTypeMetadata' <$> (x .:? "deprecationDate") <*>
         (x .:? "creationDate") <*>
         (x .:? "deprecated"))
...
ttpSearchableAttributes =
  lens _ttpSearchableAttributes (\s a -> s {_ttpSearchableAttributes = a}) .
  _Default . _Coerce

-- | The description of the thing type.
ttpThingTypeDescription :: Lens' ThingTypeProperties (Maybe Text)
ttpThingTypeDescription =
  lens _ttpThingTypeDescription (\s a -> s {_ttpThingTypeDescription = a})
...
instance FromJSON ThingTypeProperties where
  parseJSON =
    withObject
      "ThingTypeProperties"
      (\x ->
         ThingTypeProperties' <$> (x .:? "searchableAttributes" .!= mempty) <*>
...
trAwsIotSqlVersion =
  lens _trAwsIotSqlVersion (\s a -> s {_trAwsIotSqlVersion = a})
...
instance FromJSON TopicRule where
  parseJSON =
    withObject
      "TopicRule"
      (\x ->
         TopicRule' <$> (x .:? "createdAt") <*> (x .:? "actions" .!= mempty) <*>
         (x .:? "awsIotSqlVersion") <*>
         (x .:? "errorAction") <*>
         (x .:? "ruleDisabled") <*>
         (x .:? "ruleName") <*>
...
trliCreatedAt =
  lens _trliCreatedAt (\s a -> s {_trliCreatedAt = a}) . mapping _Time
...
instance FromJSON TopicRuleListItem where
  parseJSON =
    withObject
      "TopicRuleListItem"
      (\x ->
         TopicRuleListItem' <$> (x .:? "createdAt") <*> (x .:? "ruleDisabled") <*>
         (x .:? "ruleName") <*>
         (x .:? "ruleArn") <*>
         (x .:? "topicPattern"))
...
trpAwsIotSqlVersion =
  lens _trpAwsIotSqlVersion (\s a -> s {_trpAwsIotSqlVersion = a})
...
tdTransferDate =
  lens _tdTransferDate (\s a -> s {_tdTransferDate = a}) . mapping _Time

-- | The date the transfer was accepted.
tdAcceptDate :: Lens' TransferData (Maybe UTCTime)
tdAcceptDate =
  lens _tdAcceptDate (\s a -> s {_tdAcceptDate = a}) . mapping _Time
...
tdRejectDate =
  lens _tdRejectDate (\s a -> s {_tdRejectDate = a}) . mapping _Time
...
instance FromJSON TransferData where
  parseJSON =
    withObject
      "TransferData"
      (\x ->
         TransferData' <$> (x .:? "transferDate") <*> (x .:? "acceptDate") <*>
         (x .:? "transferMessage") <*>
         (x .:? "rejectDate") <*>
         (x .:? "rejectReason"))
