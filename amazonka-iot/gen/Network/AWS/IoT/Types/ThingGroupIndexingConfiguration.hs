...
data ThingGroupIndexingConfiguration = ThingGroupIndexingConfiguration'{_tgicManagedFields
                                                                        ::
                                                                        !(Maybe
                                                                            [Field]),
                                                                        _tgicCustomFields
...
thingGroupIndexingConfiguration
    :: ThingGroupIndexingMode -- ^ 'tgicThingGroupIndexingMode'
    -> ThingGroupIndexingConfiguration
thingGroupIndexingConfiguration
  pThingGroupIndexingMode_
  = ThingGroupIndexingConfiguration'{_tgicManagedFields
                                       = Nothing,
...
instance FromJSON ThingGroupIndexingConfiguration
         where
        parseJSON
          = withObject "ThingGroupIndexingConfiguration"
              (\ x ->
                 ThingGroupIndexingConfiguration' <$>
...
instance NFData ThingGroupIndexingConfiguration where
