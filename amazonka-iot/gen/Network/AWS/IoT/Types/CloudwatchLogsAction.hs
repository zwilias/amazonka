...
data CloudwatchLogsAction = CloudwatchLogsAction'{_claRoleARN
                                                  :: !Text,
...
cloudwatchLogsAction
    :: Text -- ^ 'claRoleARN'
    -> Text -- ^ 'claLogGroupName'
    -> CloudwatchLogsAction
cloudwatchLogsAction pRoleARN_ pLogGroupName_
  = CloudwatchLogsAction'{_claRoleARN = pRoleARN_,
...
instance FromJSON CloudwatchLogsAction where
        parseJSON
          = withObject "CloudwatchLogsAction"
              (\ x ->
                 CloudwatchLogsAction' <$>
                   (x .: "roleArn") <*> (x .: "logGroupName"))

instance Hashable CloudwatchLogsAction where

instance NFData CloudwatchLogsAction where
