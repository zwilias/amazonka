...
data PutAssetPropertyValueEntry = PutAssetPropertyValueEntry'{_papveEntryId
                                                              :: !(Maybe Text),
                                                              _papvePropertyAlias
                                                              :: !(Maybe Text),
                                                              _papvePropertyId
...
putAssetPropertyValueEntry
    :: NonEmpty AssetPropertyValue -- ^ 'papvePropertyValues'
    -> PutAssetPropertyValueEntry
putAssetPropertyValueEntry pPropertyValues_
  = PutAssetPropertyValueEntry'{_papveEntryId =
                                  Nothing,
...
instance FromJSON PutAssetPropertyValueEntry where
        parseJSON
          = withObject "PutAssetPropertyValueEntry"
              (\ x ->
                 PutAssetPropertyValueEntry' <$>
                   (x .:? "entryId") <*> (x .:? "propertyAlias") <*>
                     (x .:? "propertyId")
                     <*> (x .:? "assetId")
                     <*> (x .: "propertyValues"))

instance Hashable PutAssetPropertyValueEntry where

instance NFData PutAssetPropertyValueEntry where
