...
data ThingAttribute = ThingAttribute'{_taThingTypeName
                                      :: !(Maybe Text),
...
thingAttribute
    :: ThingAttribute
thingAttribute
  = ThingAttribute'{_taThingTypeName = Nothing,
                    _taThingARN = Nothing, _taAttributes = Nothing,
                    _taVersion = Nothing, _taThingName = Nothing}
