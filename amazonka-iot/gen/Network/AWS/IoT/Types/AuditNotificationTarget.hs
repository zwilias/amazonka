...
data AuditNotificationTarget = AuditNotificationTarget'{_antTargetARN
                                                        :: !(Maybe Text),
                                                        _antEnabled ::
                                                        !(Maybe Bool),
                                                        _antRoleARN ::
...
auditNotificationTarget
    :: AuditNotificationTarget
auditNotificationTarget
  = AuditNotificationTarget'{_antTargetARN = Nothing,
                             _antEnabled = Nothing, _antRoleARN = Nothing}
...
instance FromJSON AuditNotificationTarget where
        parseJSON
          = withObject "AuditNotificationTarget"
              (\ x ->
                 AuditNotificationTarget' <$>
                   (x .:? "targetArn") <*> (x .:? "enabled") <*>
                     (x .:? "roleArn"))

instance Hashable AuditNotificationTarget where

instance NFData AuditNotificationTarget where
