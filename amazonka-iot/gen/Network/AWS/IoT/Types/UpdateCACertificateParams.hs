...
newtype UpdateCACertificateParams = UpdateCACertificateParams'{_ucacpAction
                                                               ::
...
updateCACertificateParams
    :: CACertificateUpdateAction -- ^ 'ucacpAction'
    -> UpdateCACertificateParams
...
instance FromJSON UpdateCACertificateParams where
        parseJSON
          = withObject "UpdateCACertificateParams"
              (\ x ->
                 UpdateCACertificateParams' <$> (x .: "action"))

instance Hashable UpdateCACertificateParams where

instance NFData UpdateCACertificateParams where
