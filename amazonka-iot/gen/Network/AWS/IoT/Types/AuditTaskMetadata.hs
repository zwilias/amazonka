...
data AuditTaskMetadata = AuditTaskMetadata'{_atmTaskType
                                            :: !(Maybe AuditTaskType),
...
auditTaskMetadata
    :: AuditTaskMetadata
auditTaskMetadata
  = AuditTaskMetadata'{_atmTaskType = Nothing,
                       _atmTaskId = Nothing, _atmTaskStatus = Nothing}
...
instance FromJSON AuditTaskMetadata where
        parseJSON
          = withObject "AuditTaskMetadata"
              (\ x ->
                 AuditTaskMetadata' <$>
                   (x .:? "taskType") <*> (x .:? "taskId") <*>
                     (x .:? "taskStatus"))

instance Hashable AuditTaskMetadata where

instance NFData AuditTaskMetadata where
