...
newtype PublishFindingToSNSParams = PublishFindingToSNSParams'{_pftspTopicARN
                                                               :: Text}
...
publishFindingToSNSParams pTopicARN_
  = PublishFindingToSNSParams'{_pftspTopicARN =
                                 pTopicARN_}
...
instance FromJSON PublishFindingToSNSParams where
        parseJSON
          = withObject "PublishFindingToSNSParams"
              (\ x ->
                 PublishFindingToSNSParams' <$> (x .: "topicArn"))

instance Hashable PublishFindingToSNSParams where

instance NFData PublishFindingToSNSParams where
