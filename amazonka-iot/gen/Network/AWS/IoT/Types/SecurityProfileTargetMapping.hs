...
data SecurityProfileTargetMapping = SecurityProfileTargetMapping'{_sptmSecurityProfileIdentifier
                                                                  ::
                                                                  !(Maybe
...
securityProfileTargetMapping
    :: SecurityProfileTargetMapping
securityProfileTargetMapping
  = SecurityProfileTargetMapping'{_sptmSecurityProfileIdentifier
                                    = Nothing,
                                  _sptmTarget = Nothing}
...
instance FromJSON SecurityProfileTargetMapping where
        parseJSON
          = withObject "SecurityProfileTargetMapping"
              (\ x ->
                 SecurityProfileTargetMapping' <$>
                   (x .:? "securityProfileIdentifier") <*>
                     (x .:? "target"))

instance Hashable SecurityProfileTargetMapping where

instance NFData SecurityProfileTargetMapping where
