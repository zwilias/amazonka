...
data ThingTypeMetadata = ThingTypeMetadata'{_ttmDeprecationDate
                                            :: !(Maybe POSIX),
...
thingTypeMetadata
    :: ThingTypeMetadata
thingTypeMetadata
  = ThingTypeMetadata'{_ttmDeprecationDate = Nothing,
                       _ttmCreationDate = Nothing, _ttmDeprecated = Nothing}
