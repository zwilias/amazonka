...
data StepFunctionsAction = StepFunctionsAction'{_sfaExecutionNamePrefix
                                                :: !(Maybe Text),
...
stepFunctionsAction
    :: Text -- ^ 'sfaStateMachineName'
    -> Text -- ^ 'sfaRoleARN'
    -> StepFunctionsAction
stepFunctionsAction pStateMachineName_ pRoleARN_
  = StepFunctionsAction'{_sfaExecutionNamePrefix =
                           Nothing,
...
instance FromJSON StepFunctionsAction where
        parseJSON
          = withObject "StepFunctionsAction"
              (\ x ->
                 StepFunctionsAction' <$>
...
instance Hashable StepFunctionsAction where

instance NFData StepFunctionsAction where
