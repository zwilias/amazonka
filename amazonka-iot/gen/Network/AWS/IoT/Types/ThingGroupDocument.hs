...
data ThingGroupDocument = ThingGroupDocument'{_tgdParentGroupNames
                                              :: !(Maybe [Text]),
...
thingGroupDocument
    :: ThingGroupDocument
thingGroupDocument
  = ThingGroupDocument'{_tgdParentGroupNames = Nothing,
...
instance Hashable ThingGroupDocument where

instance NFData ThingGroupDocument where
