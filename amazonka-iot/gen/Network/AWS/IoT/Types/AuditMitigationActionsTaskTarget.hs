...
data AuditMitigationActionsTaskTarget = AuditMitigationActionsTaskTarget'{_amattAuditTaskId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _amattFindingIds
...
auditMitigationActionsTaskTarget
    :: AuditMitigationActionsTaskTarget
auditMitigationActionsTaskTarget
  = AuditMitigationActionsTaskTarget'{_amattAuditTaskId
                                        = Nothing,
...
instance FromJSON AuditMitigationActionsTaskTarget
         where
        parseJSON
          = withObject "AuditMitigationActionsTaskTarget"
              (\ x ->
                 AuditMitigationActionsTaskTarget' <$>
                   (x .:? "auditTaskId") <*> (x .:? "findingIds") <*>
...
instance ToJSON AuditMitigationActionsTaskTarget
         where
