...
newtype CancelAuditTask = CancelAuditTask'{_catTaskId
                                           :: Text}
...
instance Hashable CancelAuditTask where

instance NFData CancelAuditTask where
...
newtype CancelAuditTaskResponse = CancelAuditTaskResponse'{_catrsResponseStatus
                                                           :: Int}
...
cancelAuditTaskResponse pResponseStatus_
  = CancelAuditTaskResponse'{_catrsResponseStatus =
                               pResponseStatus_}
...
instance NFData CancelAuditTaskResponse where
