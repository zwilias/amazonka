...
data DeleteSecurityProfile = DeleteSecurityProfile'{_dspExpectedVersion
                                                    :: !(Maybe Integer),
...
deleteSecurityProfile
    :: Text -- ^ 'dspSecurityProfileName'
    -> DeleteSecurityProfile
deleteSecurityProfile pSecurityProfileName_
  = DeleteSecurityProfile'{_dspExpectedVersion =
                             Nothing,
...
instance Hashable DeleteSecurityProfile where

instance NFData DeleteSecurityProfile where
...
instance ToPath DeleteSecurityProfile where
        toPath DeleteSecurityProfile'{..}
          = mconcat
              ["/security-profiles/", toBS _dspSecurityProfileName]
...
newtype DeleteSecurityProfileResponse = DeleteSecurityProfileResponse'{_dsprsResponseStatus
                                                                       :: Int}
...
deleteSecurityProfileResponse pResponseStatus_
  = DeleteSecurityProfileResponse'{_dsprsResponseStatus
                                     = pResponseStatus_}
...
instance NFData DeleteSecurityProfileResponse where
