...
data ListMitigationActions = ListMitigationActions'{_lmaNextToken
                                                    :: !(Maybe Text),
                                                    _lmaActionType ::
                                                    !(Maybe
...
listMitigationActions
    :: ListMitigationActions
listMitigationActions
  = ListMitigationActions'{_lmaNextToken = Nothing,
                           _lmaActionType = Nothing, _lmaMaxResults = Nothing}
...
instance Hashable ListMitigationActions where

instance NFData ListMitigationActions where
...
data ListMitigationActionsResponse = ListMitigationActionsResponse'{_lmarsActionIdentifiers
                                                                    ::
                                                                    !(Maybe
...
listMitigationActionsResponse pResponseStatus_
  = ListMitigationActionsResponse'{_lmarsActionIdentifiers
                                     = Nothing,
...
instance NFData ListMitigationActionsResponse where
