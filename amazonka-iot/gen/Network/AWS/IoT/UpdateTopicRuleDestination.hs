...
data UpdateTopicRuleDestination = UpdateTopicRuleDestination'{_utrdArn
                                                              :: !Text,
                                                              _utrdStatus ::
...
updateTopicRuleDestination
    :: Text -- ^ 'utrdArn'
    -> TopicRuleDestinationStatus -- ^ 'utrdStatus'
    -> UpdateTopicRuleDestination
updateTopicRuleDestination pArn_ pStatus_
  = UpdateTopicRuleDestination'{_utrdArn = pArn_,
...
instance Hashable UpdateTopicRuleDestination where

instance NFData UpdateTopicRuleDestination where
...
newtype UpdateTopicRuleDestinationResponse = UpdateTopicRuleDestinationResponse'{_utrdrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
updateTopicRuleDestinationResponse
    :: Int -- ^ 'utrdrsResponseStatus'
    -> UpdateTopicRuleDestinationResponse
updateTopicRuleDestinationResponse pResponseStatus_
  = UpdateTopicRuleDestinationResponse'{_utrdrsResponseStatus
                                          = pResponseStatus_}
