...
atttgThingGroupARN =
  lens _atttgThingGroupARN (\s a -> s {_atttgThingGroupARN = a})
...
atttgThingGroupName =
  lens _atttgThingGroupName (\s a -> s {_atttgThingGroupName = a})
...
atttgrsResponseStatus =
  lens _atttgrsResponseStatus (\s a -> s {_atttgrsResponseStatus = a})
