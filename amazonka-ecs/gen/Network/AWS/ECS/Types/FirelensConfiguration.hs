...
data FirelensConfiguration = FirelensConfiguration'{_fcOptions
                                                    :: !(Maybe (Map Text Text)),
                                                    _fcType ::
...
firelensConfiguration
    :: FirelensConfigurationType -- ^ 'fcType'
    -> FirelensConfiguration
firelensConfiguration pType_
  = FirelensConfiguration'{_fcOptions = Nothing,
                           _fcType = pType_}
...
instance FromJSON FirelensConfiguration where
        parseJSON
          = withObject "FirelensConfiguration"
              (\ x ->
                 FirelensConfiguration' <$>
                   (x .:? "options" .!= mempty) <*> (x .: "type"))

instance Hashable FirelensConfiguration where

instance NFData FirelensConfiguration where
