...
data AutoScalingGroupProvider = AutoScalingGroupProvider'{_asgpManagedScaling
                                                          ::
                                                          !(Maybe
                                                              ManagedScaling),
...
autoScalingGroupProvider
    :: Text -- ^ 'asgpAutoScalingGroupARN'
    -> AutoScalingGroupProvider
autoScalingGroupProvider pAutoScalingGroupARN_
  = AutoScalingGroupProvider'{_asgpManagedScaling =
                                Nothing,
...
instance FromJSON AutoScalingGroupProvider where
        parseJSON
          = withObject "AutoScalingGroupProvider"
              (\ x ->
                 AutoScalingGroupProvider' <$>
                   (x .:? "managedScaling") <*>
...
instance Hashable AutoScalingGroupProvider where

instance NFData AutoScalingGroupProvider where
