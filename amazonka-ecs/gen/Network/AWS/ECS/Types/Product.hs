...
avcSecurityGroups =
  lens _avcSecurityGroups (\s a -> s {_avcSecurityGroups = a}) .
  _Default . _Coerce
...
instance FromJSON AWSVPCConfiguration where
  parseJSON =
    withObject
      "AWSVPCConfiguration"
      (\x ->
         AWSVPCConfiguration' <$> (x .:? "securityGroups" .!= mempty) <*>
         (x .:? "assignPublicIp") <*>
         (x .:? "subnets" .!= mempty))
...
instance FromJSON Attachment where
  parseJSON =
    withObject
      "Attachment"
      (\x ->
         Attachment' <$> (x .:? "status") <*> (x .:? "details" .!= mempty) <*>
         (x .:? "id") <*>
         (x .:? "type"))
...
cRegisteredContainerInstancesCount =
  lens
    _cRegisteredContainerInstancesCount
...
cStatistics =
  lens _cStatistics (\s a -> s {_cStatistics = a}) . _Default . _Coerce

-- | The number of services that are running on the cluster in an @ACTIVE@ state. You can view these services with 'ListServices' .
cActiveServicesCount :: Lens' Cluster (Maybe Int)
cActiveServicesCount =
  lens _cActiveServicesCount (\s a -> s {_cActiveServicesCount = a})
...
cNetworkBindings =
  lens _cNetworkBindings (\s a -> s {_cNetworkBindings = a}) .
  _Default . _Coerce
...
cNetworkInterfaces =
  lens _cNetworkInterfaces (\s a -> s {_cNetworkInterfaces = a}) .
  _Default . _Coerce
...
instance FromJSON Container where
  parseJSON =
    withObject
      "Container"
      (\x ->
         Container' <$> (x .:? "networkBindings" .!= mempty) <*>
         (x .:? "containerArn") <*>
...
cdDockerSecurityOptions =
  lens _cdDockerSecurityOptions (\s a -> s {_cdDockerSecurityOptions = a}) .
  _Default . _Coerce
...
cdDisableNetworking =
  lens _cdDisableNetworking (\s a -> s {_cdDisableNetworking = a})

-- | Data volumes to mount from another container. This parameter maps to @VolumesFrom@ in the <https://docs.docker.com/engine/reference/api/docker_remote_api_v1.27/#create-a-container Create a container> section of the <https://docs.docker.com/engine/reference/api/docker_remote_api_v1.27/ Docker Remote API> and the @--volumes-from@ option to <https://docs.docker.com/engine/reference/run/ docker run> .
cdVolumesFrom :: Lens' ContainerDefinition [VolumeFrom]
cdVolumesFrom =
  lens _cdVolumesFrom (\s a -> s {_cdVolumesFrom = a}) . _Default . _Coerce
...
cdEntryPoint =
  lens _cdEntryPoint (\s a -> s {_cdEntryPoint = a}) . _Default . _Coerce
...
cdWorkingDirectory =
  lens _cdWorkingDirectory (\s a -> s {_cdWorkingDirectory = a})
...
cdPortMappings =
  lens _cdPortMappings (\s a -> s {_cdPortMappings = a}) . _Default . _Coerce
...
cdDockerLabels =
  lens _cdDockerLabels (\s a -> s {_cdDockerLabels = a}) . _Default . _Map

-- | A list of hostnames and IP address mappings to append to the @/etc/hosts@ file on the container. If using the Fargate launch type, this may be used to list non-Fargate hosts you want the container to talk to. This parameter maps to @ExtraHosts@ in the <https://docs.docker.com/engine/reference/api/docker_remote_api_v1.27/#create-a-container Create a container> section of the <https://docs.docker.com/engine/reference/api/docker_remote_api_v1.27/ Docker Remote API> and the @--add-host@ option to <https://docs.docker.com/engine/reference/run/ docker run> .
cdExtraHosts :: Lens' ContainerDefinition [HostEntry]
cdExtraHosts =
  lens _cdExtraHosts (\s a -> s {_cdExtraHosts = a}) . _Default . _Coerce
...
cdDnsSearchDomains =
  lens _cdDnsSearchDomains (\s a -> s {_cdDnsSearchDomains = a}) .
  _Default . _Coerce
...
cdDnsServers =
  lens _cdDnsServers (\s a -> s {_cdDnsServers = a}) . _Default . _Coerce
...
cdMemoryReservation =
  lens _cdMemoryReservation (\s a -> s {_cdMemoryReservation = a})
...
ciAttachments =
  lens _ciAttachments (\s a -> s {_ciAttachments = a}) . _Default . _Coerce
...
ciAgentUpdateStatus =
  lens _ciAgentUpdateStatus (\s a -> s {_ciAgentUpdateStatus = a})

-- | The attributes set for the container instance, either by the Amazon ECS container agent at instance registration or manually with the 'PutAttributes' operation.
ciAttributes :: Lens' ContainerInstance [Attribute]
ciAttributes =
  lens _ciAttributes (\s a -> s {_ciAttributes = a}) . _Default . _Coerce
...
ciRegisteredAt =
  lens _ciRegisteredAt (\s a -> s {_ciRegisteredAt = a}) . mapping _Time
...
coMemoryReservation =
  lens _coMemoryReservation (\s a -> s {_coMemoryReservation = a})
...
instance FromJSON ContainerOverride where
  parseJSON =
    withObject
      "ContainerOverride"
      (\x ->
         ContainerOverride' <$> (x .:? "command" .!= mempty) <*>
         (x .:? "environment" .!= mempty) <*>
         (x .:? "memory") <*>
         (x .:? "name") <*>
         (x .:? "cpu") <*>
...
csLoadBalancers =
  lens _csLoadBalancers (\s a -> s {_csLoadBalancers = a}) . _Default . _Coerce
...
csPlacementConstraints =
  lens _csPlacementConstraints (\s a -> s {_csPlacementConstraints = a}) .
  _Default . _Coerce
...
csPlacementStrategy =
  lens _csPlacementStrategy (\s a -> s {_csPlacementStrategy = a}) .
  _Default . _Coerce

-- | The current state of deployments for the service.
csDeployments :: Lens' ContainerService [Deployment]
csDeployments =
  lens _csDeployments (\s a -> s {_csDeployments = a}) . _Default . _Coerce
...
csHealthCheckGracePeriodSeconds =
  lens
    ...
    (\s a -> s {_csHealthCheckGracePeriodSeconds = a})
...
csNetworkConfiguration =
  lens _csNetworkConfiguration (\s a -> s {_csNetworkConfiguration = a})

-- |
csServiceRegistries :: Lens' ContainerService [ServiceRegistry]
csServiceRegistries =
  lens _csServiceRegistries (\s a -> s {_csServiceRegistries = a}) .
  _Default . _Coerce
...
csDeploymentConfiguration ::
     Lens' ContainerService (Maybe DeploymentConfiguration)
csDeploymentConfiguration =
  lens _csDeploymentConfiguration (\s a -> s {_csDeploymentConfiguration = a})
...
instance FromJSON ContainerService where
  parseJSON =
    withObject
      "ContainerService"
      (\x ->
         ContainerService' <$> (x .:? "runningCount") <*> (x .:? "status") <*>
         (x .:? "clusterArn") <*>
         (x .:? "createdAt") <*>
         (x .:? "platformVersion") <*>
         (x .:? "desiredCount") <*>
...
cscNetworkBindings =
  lens _cscNetworkBindings (\s a -> s {_cscNetworkBindings = a}) .
  _Default . _Coerce
...
dNetworkConfiguration =
  lens _dNetworkConfiguration (\s a -> s {_dNetworkConfiguration = a})
...
instance FromJSON Deployment where
  parseJSON =
    withObject
      "Deployment"
      (\x ->
         Deployment' <$> (x .:? "runningCount") <*> (x .:? "status") <*>
         (x .:? "createdAt") <*>
         (x .:? "platformVersion") <*>
         (x .:? "desiredCount") <*>
         (x .:? "pendingCount") <*>
...
dcMinimumHealthyPercent =
  lens _dcMinimumHealthyPercent (\s a -> s {_dcMinimumHealthyPercent = a})
...
instance FromJSON DeploymentConfiguration where
  parseJSON =
    withObject
      "DeploymentConfiguration"
      (\x ->
         DeploymentConfiguration' <$> (x .:? "minimumHealthyPercent") <*>
         (x .:? "maximumPercent"))
...
instance FromJSON Failure where
  parseJSON =
    withObject "Failure" (\x -> Failure' <$> (x .:? "arn") <*> (x .:? "reason"))
...
instance FromJSON HealthCheck where
  parseJSON =
    withObject
      "HealthCheck"
      (\x ->
         HealthCheck' <$> (x .:? "startPeriod") <*> (x .:? "retries") <*>
         (x .:? "interval") <*>
         (x .:? "timeout") <*>
         (x .:? "command" .!= mempty))
...
instance ToJSON HostEntry where
  toJSON HostEntry' {..} =
    object
      (catMaybes
         [Just ("hostname" .= _heHostname), Just ("ipAddress" .= _heIpAddress)])
...
instance FromJSON KernelCapabilities where
  parseJSON =
    withObject
      "KernelCapabilities"
      (\x ->
         KernelCapabilities' <$> (x .:? "drop" .!= mempty) <*>
         (x .:? "add" .!= mempty))
...
instance ToJSON KernelCapabilities where
  toJSON KernelCapabilities' {..} =
    object (catMaybes [("drop" .=) <$> _kcDrop, ("add" .=) <$> _kcAdd])
...
instance FromJSON LinuxParameters where
  parseJSON =
    withObject
      "LinuxParameters"
      (\x ->
         LinuxParameters' <$> (x .:? "sharedMemorySize") <*>
...
instance FromJSON LoadBalancer where
  parseJSON =
    withObject
      "LoadBalancer"
      (\x ->
         LoadBalancer' <$> (x .:? "loadBalancerName") <*>
         (x .:? "containerName") <*>
         (x .:? "targetGroupArn") <*>
         (x .:? "containerPort"))
...
instance FromJSON LogConfiguration where
  parseJSON =
    withObject
      "LogConfiguration"
      (\x ->
         LogConfiguration' <$> (x .:? "options" .!= mempty) <*>
         (x .: "logDriver"))
...
instance ToJSON LogConfiguration where
  toJSON LogConfiguration' {..} =
    object
      (catMaybes
         [("options" .=) <$> _lcOptions, Just ("logDriver" .= _lcLogDriver)])
...
instance FromJSON MountPoint where
  parseJSON =
    withObject
      "MountPoint"
      (\x ->
         MountPoint' <$> (x .:? "containerPath") <*> (x .:? "sourceVolume") <*>
         (x .:? "readOnly"))
...
instance FromJSON NetworkBinding where
  parseJSON =
    withObject
      "NetworkBinding"
      (\x ->
         NetworkBinding' <$> (x .:? "bindIP") <*> (x .:? "protocol") <*>
         (x .:? "hostPort") <*>
         (x .:? "containerPort"))
...
ncAwsvpcConfiguration =
  lens _ncAwsvpcConfiguration (\s a -> s {_ncAwsvpcConfiguration = a})
...
instance ToJSON NetworkConfiguration where
  toJSON NetworkConfiguration' {..} =
    object (catMaybes [("awsvpcConfiguration" .=) <$> _ncAwsvpcConfiguration])
...
instance FromJSON NetworkInterface where
  parseJSON =
    withObject
      "NetworkInterface"
      (\x ->
         NetworkInterface' <$> (x .:? "ipv6Address") <*>
...
instance FromJSON PlacementConstraint where
  parseJSON =
    withObject
      "PlacementConstraint"
      (\x -> PlacementConstraint' <$> (x .:? "expression") <*> (x .:? "type"))
...
instance ToJSON PlacementConstraint where
  toJSON PlacementConstraint' {..} =
    object
      (catMaybes [("expression" .=) <$> _pcExpression, ("type" .=) <$> _pcType])
...
instance ToJSON PlacementStrategy where
  toJSON PlacementStrategy' {..} =
    object (catMaybes [("field" .=) <$> _psField, ("type" .=) <$> _psType])
...
instance FromJSON PortMapping where
  parseJSON =
    withObject
      "PortMapping"
      (\x ->
         PortMapping' <$> (x .:? "protocol") <*> (x .:? "hostPort") <*>
         (x .:? "containerPort"))
...
rStringSetValue =
  lens _rStringSetValue (\s a -> s {_rStringSetValue = a}) . _Default . _Coerce
...
instance FromJSON Resource where
  parseJSON =
    withObject
      "Resource"
      (\x ->
         Resource' <$> (x .:? "stringSetValue" .!= mempty) <*>
         (x .:? "integerValue") <*>
         (x .:? "doubleValue") <*>
         (x .:? "longValue") <*>
         (x .:? "name") <*>
...
instance FromJSON ServiceRegistry where
  parseJSON =
    withObject
      "ServiceRegistry"
      (\x -> ServiceRegistry' <$> (x .:? "registryArn") <*> (x .:? "port"))
...
instance ToJSON ServiceRegistry where
  toJSON ServiceRegistry' {..} =
    object
      (catMaybes
         [("registryArn" .=) <$> _srRegistryARN, ("port" .=) <$> _srPort])
...
tAttachments =
  lens _tAttachments (\s a -> s {_tAttachments = a}) . _Default . _Coerce
...
tExecutionStoppedAt =
  lens _tExecutionStoppedAt (\s a -> s {_tExecutionStoppedAt = a}) .
  mapping _Time
...
tPullStoppedAt =
  lens _tPullStoppedAt (\s a -> s {_tPullStoppedAt = a}) . mapping _Time

-- | The containers associated with the task.
tContainers :: Lens' Task [Container]
tContainers =
  lens _tContainers (\s a -> s {_tContainers = a}) . _Default . _Coerce
...
tConnectivityAt =
  lens _tConnectivityAt (\s a -> s {_tConnectivityAt = a}) . mapping _Time
...
tPullStartedAt =
  lens _tPullStartedAt (\s a -> s {_tPullStartedAt = a}) . mapping _Time
...
instance FromJSON Task where
  parseJSON =
    withObject
      "Task"
      (\x ->
         Task' <$> (x .:? "stoppedAt") <*> (x .:? "desiredStatus") <*>
         (x .:? "overrides") <*>
         (x .:? "clusterArn") <*>
         (x .:? "group") <*>
         (x .:? "attachments" .!= mempty) <*>
...
tdExecutionRoleARN =
  lens _tdExecutionRoleARN (\s a -> s {_tdExecutionRoleARN = a})

-- | The launch type the task is using.
tdRequiresCompatibilities :: Lens' TaskDefinition [Compatibility]
tdRequiresCompatibilities =
  lens _tdRequiresCompatibilities (\s a -> s {_tdRequiresCompatibilities = a}) .
  _Default . _Coerce
...
tdPlacementConstraints ::
     Lens' TaskDefinition [TaskDefinitionPlacementConstraint]
tdPlacementConstraints =
  lens _tdPlacementConstraints (\s a -> s {_tdPlacementConstraints = a}) .
  _Default . _Coerce
...
tdCompatibilities =
  lens _tdCompatibilities (\s a -> s {_tdCompatibilities = a}) .
  _Default . _Coerce
...
tdRequiresAttributes =
  lens _tdRequiresAttributes (\s a -> s {_tdRequiresAttributes = a}) .
  _Default . _Coerce
...
instance FromJSON TaskDefinition where
  parseJSON =
    withObject
      "TaskDefinition"
      (\x ->
         TaskDefinition' <$> (x .:? "status") <*> (x .:? "executionRoleArn") <*>
...
tdpcType ::
     Lens' TaskDefinitionPlacementConstraint (Maybe TaskDefinitionPlacementConstraintType)
...
instance FromJSON TaskDefinitionPlacementConstraint where
  parseJSON =
    withObject
      "TaskDefinitionPlacementConstraint"
      (\x ->
         TaskDefinitionPlacementConstraint' <$> (x .:? "expression") <*>
         (x .:? "type"))
...
toExecutionRoleARN =
  lens _toExecutionRoleARN (\s a -> s {_toExecutionRoleARN = a})
...
instance FromJSON TaskOverride where
  parseJSON =
    withObject
      "TaskOverride"
      (\x ->
         TaskOverride' <$> (x .:? "containerOverrides" .!= mempty) <*>
         (x .:? "executionRoleArn") <*>
         (x .:? "taskRoleArn"))
...
instance FromJSON Tmpfs where
  parseJSON =
    withObject
      "Tmpfs"
      (\x ->
         Tmpfs' <$> (x .:? "mountOptions" .!= mempty) <*> (x .: "containerPath") <*>
         (x .: "size"))
...
instance FromJSON Ulimit where
  parseJSON =
    withObject
      "Ulimit"
      (\x ->
         Ulimit' <$> (x .: "name") <*> (x .: "softLimit") <*> (x .: "hardLimit"))
...
instance FromJSON VersionInfo where
  parseJSON =
    withObject
      "VersionInfo"
      (\x ->
         VersionInfo' <$> (x .:? "agentHash") <*> (x .:? "agentVersion") <*>
         (x .:? "dockerVersion"))
...
instance FromJSON VolumeFrom where
  parseJSON =
    withObject
      "VolumeFrom"
      (\x -> VolumeFrom' <$> (x .:? "sourceContainer") <*> (x .:? "readOnly"))
