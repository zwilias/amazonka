...
data CustomizedScalingMetricSpecification = CustomizedScalingMetricSpecification'{_csmsDimensions
                                                                                  ::
                                                                                  !(Maybe
                                                                                      [MetricDimension]),
                                                                                  _csmsUnit
...
customizedScalingMetricSpecification
    ...
    -> CustomizedScalingMetricSpecification
customizedScalingMetricSpecification pMetricName_
  pNamespace_ pStatistic_
  = CustomizedScalingMetricSpecification'{_csmsDimensions
                                            = Nothing,
                                          _csmsUnit = Nothing,
