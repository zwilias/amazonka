...
data ScalingInstruction = ScalingInstruction'{_siScheduledActionBufferTime
                                              :: !(Maybe Nat),
...
scalingInstruction
    ...
    -> Int -- ^ 'siMaxCapacity'
    -> ScalingInstruction
scalingInstruction pServiceNamespace_ pResourceId_
  pScalableDimension_ pMinCapacity_ pMaxCapacity_
  = ScalingInstruction'{_siScheduledActionBufferTime =
                          Nothing,
