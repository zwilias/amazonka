...
asTagFilters =
  lens _asTagFilters (\s a -> s {_asTagFilters = a}) . _Default . _Coerce

-- | The Amazon Resource Name (ARN) of a CloudFormation stack.
asCloudFormationStackARN :: Lens' ApplicationSource (Maybe Text)
asCloudFormationStackARN =
  lens _asCloudFormationStackARN (\s a -> s {_asCloudFormationStackARN = a})
...
instance FromJSON ApplicationSource where
  parseJSON =
    withObject
      "ApplicationSource"
      (\x ->
         ApplicationSource' <$> (x .:? "TagFilters" .!= mempty) <*>
...
csmsDimensions =
  lens _csmsDimensions (\s a -> s {_csmsDimensions = a}) . _Default . _Coerce
...
psmsPredefinedScalingMetricType ::
     Lens' PredefinedScalingMetricSpecification ScalingMetricType
psmsPredefinedScalingMetricType =
  lens
    _psmsPredefinedScalingMetricType
    (\s a -> s {_psmsPredefinedScalingMetricType = a})
...
instance FromJSON PredefinedScalingMetricSpecification where
  parseJSON =
    withObject
      "PredefinedScalingMetricSpecification"
      (\x ->
         PredefinedScalingMetricSpecification' <$> (x .:? "ResourceLabel") <*>
  ...
  toJSON PredefinedScalingMetricSpecification' {..} =
    object
      (catMaybes
         ...
         , Just
             ("PredefinedScalingMetricType" .= _psmsPredefinedScalingMetricType)
         ])
...
siServiceNamespace =
  lens _siServiceNamespace (\s a -> s {_siServiceNamespace = a})
...
siScalableDimension =
  lens _siScalableDimension (\s a -> s {_siScalableDimension = a})
...
siTargetTrackingConfigurations ::
     Lens' ScalingInstruction [TargetTrackingConfiguration]
siTargetTrackingConfigurations =
  lens
    _siTargetTrackingConfigurations
    (\s a -> s {_siTargetTrackingConfigurations = a}) .
  _Coerce
...
instance FromJSON ScalingInstruction where
  parseJSON =
    withObject
      "ScalingInstruction"
      (\x ->
         ScalingInstruction' <$> (x .: "ServiceNamespace") <*>
         (x .: "ResourceId") <*>
         (x .: "ScalableDimension") <*>
         (x .: "MinCapacity") <*>
         (x .: "MaxCapacity") <*>
  ...
  toJSON ScalingInstruction' {..} =
    object
      (catMaybes
         ...
         , Just
             ("TargetTrackingConfigurations" .= _siTargetTrackingConfigurations)
         ])
...
spCreationTime =
  lens _spCreationTime (\s a -> s {_spCreationTime = a}) . mapping _Time

-- | The Unix timestamp when the scaling plan entered the current status.
spStatusStartTime :: Lens' ScalingPlan (Maybe UTCTime)
spStatusStartTime =
  lens _spStatusStartTime (\s a -> s {_spStatusStartTime = a}) . mapping _Time
...
spScalingPlanVersion =
  lens _spScalingPlanVersion (\s a -> s {_spScalingPlanVersion = a})

-- | The application source.
spApplicationSource :: Lens' ScalingPlan ApplicationSource
spApplicationSource =
  lens _spApplicationSource (\s a -> s {_spApplicationSource = a})

-- | The scaling instructions.
spScalingInstructions :: Lens' ScalingPlan [ScalingInstruction]
spScalingInstructions =
  lens _spScalingInstructions (\s a -> s {_spScalingInstructions = a}) . _Coerce
...
instance FromJSON ScalingPlan where
  parseJSON =
    withObject
      "ScalingPlan"
      (\x ->
         ScalingPlan' <$> (x .:? "CreationTime") <*> (x .:? "StatusStartTime") <*>
         (x .:? "StatusMessage") <*>
         (x .: "ScalingPlanName") <*>
...
sprScalingStatusMessage =
  lens _sprScalingStatusMessage (\s a -> s {_sprScalingStatusMessage = a})

-- | The scaling policies.
sprScalingPolicies :: Lens' ScalingPlanResource [ScalingPolicy]
sprScalingPolicies =
  lens _sprScalingPolicies (\s a -> s {_sprScalingPolicies = a}) .
  _Default . _Coerce

-- | The name of the scaling plan.
sprScalingPlanName :: Lens' ScalingPlanResource Text
sprScalingPlanName =
  lens _sprScalingPlanName (\s a -> s {_sprScalingPlanName = a})

-- | The version of the scaling plan.
sprScalingPlanVersion :: Lens' ScalingPlanResource Integer
sprScalingPlanVersion =
  lens _sprScalingPlanVersion (\s a -> s {_sprScalingPlanVersion = a})

-- | The namespace of the AWS service.
sprServiceNamespace :: Lens' ScalingPlanResource ServiceNamespace
sprServiceNamespace =
  lens _sprServiceNamespace (\s a -> s {_sprServiceNamespace = a})
...
sprScalableDimension =
  lens _sprScalableDimension (\s a -> s {_sprScalableDimension = a})
...
sprScalingStatusCode =
  lens _sprScalingStatusCode (\s a -> s {_sprScalingStatusCode = a})
...
instance FromJSON ScalingPlanResource where
  parseJSON =
    withObject
      "ScalingPlanResource"
      (\x ->
         ScalingPlanResource' <$> (x .:? "ScalingStatusMessage") <*>
...
spTargetTrackingConfiguration =
  lens
    ...
    (\s a -> s {_spTargetTrackingConfiguration = a})
...
instance FromJSON ScalingPolicy where
  parseJSON =
    withObject
      "ScalingPolicy"
      (\x ->
         ScalingPolicy' <$> (x .:? "TargetTrackingConfiguration") <*>
         (x .: "PolicyName") <*>
         (x .: "PolicyType"))
...
instance FromJSON TagFilter where
  parseJSON =
    withObject
      "TagFilter"
      (\x -> TagFilter' <$> (x .:? "Values" .!= mempty) <*> (x .:? "Key"))
...
instance ToJSON TagFilter where
  toJSON TagFilter' {..} =
    object (catMaybes [("Values" .=) <$> _tfValues, ("Key" .=) <$> _tfKey])
...
ttcEstimatedInstanceWarmup =
  lens _ttcEstimatedInstanceWarmup (\s a -> s {_ttcEstimatedInstanceWarmup = a})

-- | A predefined metric.
ttcPredefinedScalingMetricSpecification ::
     Lens' TargetTrackingConfiguration (Maybe PredefinedScalingMetricSpecification)
ttcPredefinedScalingMetricSpecification =
  lens
    _ttcPredefinedScalingMetricSpecification
    (\s a -> s {_ttcPredefinedScalingMetricSpecification = a})

-- | The amount of time, in seconds, after a scale in activity completes before another scale in activity can start. This value is not used if the scalable resource is an Auto Scaling group. The cooldown period is used to block subsequent scale in requests until it has expired. The intention is to scale in conservatively to protect your application's availability. However, if another alarm triggers a scale out policy during the cooldown period after a scale-in, AWS Auto Scaling scales out your scalable target immediately.
ttcScaleInCooldown :: Lens' TargetTrackingConfiguration (Maybe Int)
ttcScaleInCooldown =
  lens _ttcScaleInCooldown (\s a -> s {_ttcScaleInCooldown = a})
...
ttcCustomizedScalingMetricSpecification =
  lens
    ...
    (\s a -> s {_ttcCustomizedScalingMetricSpecification = a})

-- | The amount of time, in seconds, after a scale out activity completes before another scale out activity can start. This value is not used if the scalable resource is an Auto Scaling group. While the cooldown period is in effect, the capacity that has been added by the previous scale out event that initiated the cooldown is calculated as part of the desired capacity for the next scale out. The intention is to continuously (but not excessively) scale out.
ttcScaleOutCooldown :: Lens' TargetTrackingConfiguration (Maybe Int)
ttcScaleOutCooldown =
  lens _ttcScaleOutCooldown (\s a -> s {_ttcScaleOutCooldown = a})
...
instance FromJSON TargetTrackingConfiguration where
  parseJSON =
    withObject
      "TargetTrackingConfiguration"
      (\x ->
         TargetTrackingConfiguration' <$> (x .:? "EstimatedInstanceWarmup") <*>
