...
data ScalingPlanResource = ScalingPlanResource'{_sprScalingStatusMessage
                                                :: !(Maybe Text),
                                                _sprScalingPolicies ::
                                                !(Maybe [ScalingPolicy]),
...
scalingPlanResource
    ...
    -> ScalingPlanResource
scalingPlanResource pScalingPlanName_
  pScalingPlanVersion_ pServiceNamespace_ pResourceId_
  pScalableDimension_ pScalingStatusCode_
  = ScalingPlanResource'{_sprScalingStatusMessage =
                           Nothing,
