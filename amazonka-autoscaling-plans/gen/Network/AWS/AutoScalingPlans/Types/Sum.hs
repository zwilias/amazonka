  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: targettrackingscaling"
  ...
  parser =
    takeLowerText >>= \case
      "autoscaling:autoscalinggroup:desiredcapacity" ->
        pure AutoscalingAutoScalingGroupDesiredCapacity
...
instance FromText ScalingMetricType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingMetricType from value: '" <>
        e <>
...
instance FromText ScalingPlanStatusCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingPlanStatusCode from value: '" <>
        e <>
...
instance FromText ScalingStatusCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingStatusCode from value: '" <>
        e <> "'. Accepted values: active, inactive, partiallyactive"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: autoscaling, dynamodb, ec2, ecs, rds"
