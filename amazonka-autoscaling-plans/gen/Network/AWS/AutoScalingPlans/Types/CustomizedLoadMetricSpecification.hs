...
data CustomizedLoadMetricSpecification = CustomizedLoadMetricSpecification'{_clmsDimensions
                                                                            ::
                                                                            !(Maybe
                                                                                [MetricDimension]),
                                                                            _clmsUnit
...
customizedLoadMetricSpecification
    ...
    -> CustomizedLoadMetricSpecification
customizedLoadMetricSpecification pMetricName_
  pNamespace_ pStatistic_
  = CustomizedLoadMetricSpecification'{_clmsDimensions
                                         = Nothing,
                                       _clmsUnit = Nothing,
