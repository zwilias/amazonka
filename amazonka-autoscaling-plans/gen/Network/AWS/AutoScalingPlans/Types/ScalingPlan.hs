...
data ScalingPlan = ScalingPlan'{_spCreationTime ::
                                !(Maybe POSIX),
...
scalingPlan
    ...
    -> ScalingPlan
scalingPlan pScalingPlanName_ pScalingPlanVersion_
  pApplicationSource_ pStatusCode_
  = ScalingPlan'{_spCreationTime = Nothing,
