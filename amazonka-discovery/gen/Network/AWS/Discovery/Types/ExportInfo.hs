...
data ExportInfo = ExportInfo'{_eiConfigurationsDownloadURL
                              :: !(Maybe Text),
...
exportInfo
    ...
    -> ExportInfo
exportInfo pExportId_ pExportStatus_ pStatusMessage_
  pExportRequestTime_
  = ExportInfo'{_eiConfigurationsDownloadURL = Nothing,
                _eiRequestedStartTime = Nothing,
                _eiRequestedEndTime = Nothing,
                _eiIsTruncated = Nothing, _eiExportId = pExportId_,
