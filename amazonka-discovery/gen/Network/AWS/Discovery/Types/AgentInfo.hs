...
data AgentInfo = AgentInfo'{_aiHostName ::
                            !(Maybe Text),
...
agentInfo
    :: AgentInfo
agentInfo
  = AgentInfo'{_aiHostName = Nothing,
               _aiLastHealthPingTime = Nothing,
               _aiAgentNetworkInfoList = Nothing,
               _aiConnectorId = Nothing, _aiHealth = Nothing,
               _aiAgentId = Nothing, _aiVersion = Nothing,
               _aiCollectionStatus = Nothing,
               _aiRegisteredTime = Nothing, _aiAgentType = Nothing}
