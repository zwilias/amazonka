...
data CustomerConnectorInfo = CustomerConnectorInfo'{_cciActiveConnectors
                                                    :: !Int,
...
customerConnectorInfo
    ...
    -> CustomerConnectorInfo
customerConnectorInfo pActiveConnectors_
  pHealthyConnectors_ pBlackListedConnectors_
  pShutdownConnectors_ pUnhealthyConnectors_
  pTotalConnectors_ pUnknownConnectors_
  = CustomerConnectorInfo'{_cciActiveConnectors =
                             pActiveConnectors_,
