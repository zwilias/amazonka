...
data NeighborConnectionDetail = NeighborConnectionDetail'{_ncdTransportProtocol
                                                          :: !(Maybe Text),
                                                          _ncdDestinationPort ::
                                                          !(Maybe Int),
                                                          _ncdSourceServerId ::
...
neighborConnectionDetail
    ...
    -> NeighborConnectionDetail
neighborConnectionDetail pSourceServerId_
  pDestinationServerId_ pConnectionsCount_
  = NeighborConnectionDetail'{_ncdTransportProtocol =
                                Nothing,
