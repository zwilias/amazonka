...
acsOperationSucceeded =
  lens _acsOperationSucceeded (\s a -> s {_acsOperationSucceeded = a})
...
instance FromJSON AgentConfigurationStatus where
  parseJSON =
    withObject
      "AgentConfigurationStatus"
      (\x ->
         AgentConfigurationStatus' <$> (x .:? "agentId") <*>
...
aiLastHealthPingTime =
  lens _aiLastHealthPingTime (\s a -> s {_aiLastHealthPingTime = a})

-- | Network details about the host where the agent or connector resides.
aiAgentNetworkInfoList :: Lens' AgentInfo [AgentNetworkInfo]
aiAgentNetworkInfoList =
  lens _aiAgentNetworkInfoList (\s a -> s {_aiAgentNetworkInfoList = a}) .
  _Default . _Coerce
...
aiCollectionStatus =
  lens _aiCollectionStatus (\s a -> s {_aiCollectionStatus = a})
...
instance FromJSON AgentInfo where
  parseJSON =
    withObject
      "AgentInfo"
      (\x ->
         AgentInfo' <$> (x .:? "hostName") <*> (x .:? "lastHealthPingTime") <*>
...
instance FromJSON AgentNetworkInfo where
  parseJSON =
    withObject
      "AgentNetworkInfo"
      (\x -> AgentNetworkInfo' <$> (x .:? "ipAddress") <*> (x .:? "macAddress"))
...
ctTimeOfCreation =
  lens _ctTimeOfCreation (\s a -> s {_ctTimeOfCreation = a}) . mapping _Time
...
ctConfigurationType =
  lens _ctConfigurationType (\s a -> s {_ctConfigurationType = a})
...
instance FromJSON ConfigurationTag where
  parseJSON =
    withObject
      "ConfigurationTag"
      (\x ->
         ConfigurationTag' <$> (x .:? "timeOfCreation") <*>
         (x .:? "configurationId") <*>
         (x .:? "configurationType") <*>
         (x .:? "value") <*>
         (x .:? "key"))
...
caiBlackListedAgents =
  lens _caiBlackListedAgents (\s a -> s {_caiBlackListedAgents = a})
...
caiUnhealthyAgents =
  lens _caiUnhealthyAgents (\s a -> s {_caiUnhealthyAgents = a})
...
instance FromJSON CustomerAgentInfo where
  parseJSON =
    withObject
      "CustomerAgentInfo"
      (\x ->
         CustomerAgentInfo' <$> (x .: "activeAgents") <*> (x .: "healthyAgents") <*>
         (x .: "blackListedAgents") <*>
         (x .: "shutdownAgents") <*>
         (x .: "unhealthyAgents") <*>
         (x .: "totalAgents") <*>
...
instance FromJSON CustomerConnectorInfo where
  parseJSON =
    withObject
      "CustomerConnectorInfo"
      (\x ->
         CustomerConnectorInfo' <$> (x .: "activeConnectors") <*>
         (x .: "healthyConnectors") <*>
...
eiExportRequestTime =
  lens _eiExportRequestTime (\s a -> s {_eiExportRequestTime = a}) . _Time
...
instance FromJSON ExportInfo where
  parseJSON =
    withObject
      "ExportInfo"
      (\x ->
         ExportInfo' <$> (x .:? "configurationsDownloadUrl") <*>
...
ncdTransportProtocol =
  lens _ncdTransportProtocol (\s a -> s {_ncdTransportProtocol = a})

-- | The destination network port for the connection.
ncdDestinationPort :: Lens' NeighborConnectionDetail (Maybe Int)
ncdDestinationPort =
  lens _ncdDestinationPort (\s a -> s {_ncdDestinationPort = a})
...
ncdDestinationServerId =
  lens _ncdDestinationServerId (\s a -> s {_ncdDestinationServerId = a})

-- | The number of open network connections with the neighboring server.
ncdConnectionsCount :: Lens' NeighborConnectionDetail Integer
ncdConnectionsCount =
  lens _ncdConnectionsCount (\s a -> s {_ncdConnectionsCount = a})
...
instance FromJSON NeighborConnectionDetail where
  parseJSON =
    withObject
      "NeighborConnectionDetail"
      (\x ->
         NeighborConnectionDetail' <$> (x .:? "transportProtocol") <*>
         (x .:? "destinationPort") <*>
         (x .: "sourceServerId") <*>
...
instance ToJSON TagFilter where
  toJSON TagFilter' {..} =
    object (catMaybes [Just ("name" .= _tfName), Just ("values" .= _tfValues)])
