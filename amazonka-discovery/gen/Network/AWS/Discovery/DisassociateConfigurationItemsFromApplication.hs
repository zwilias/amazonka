...
dcifaApplicationConfigurationId ::
     Lens' DisassociateConfigurationItemsFromApplication Text
dcifaApplicationConfigurationId =
  lens
    _dcifaApplicationConfigurationId
    (\s a -> s {_dcifaApplicationConfigurationId = a})

-- | Configuration ID of each item to be disassociated from an application.
dcifaConfigurationIds ::
     Lens' DisassociateConfigurationItemsFromApplication [Text]
dcifaConfigurationIds =
  lens _dcifaConfigurationIds (\s a -> s {_dcifaConfigurationIds = a}) . _Coerce

instance AWSRequest DisassociateConfigurationItemsFromApplication where
  type Rs DisassociateConfigurationItemsFromApplication = DisassociateConfigurationItemsFromApplicationResponse
...
instance ToHeaders DisassociateConfigurationItemsFromApplication where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication" :: ByteString)
...
dcifarsResponseStatus ::
     Lens' DisassociateConfigurationItemsFromApplicationResponse Int
dcifarsResponseStatus =
  lens _dcifarsResponseStatus (\s a -> s {_dcifarsResponseStatus = a})

instance NFData DisassociateConfigurationItemsFromApplicationResponse
