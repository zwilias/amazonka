...
data GenericAttachment = GenericAttachment'{_gaButtons
                                            :: !(Maybe [Button]),
...
genericAttachment
    :: GenericAttachment
genericAttachment
  = GenericAttachment'{_gaButtons = Nothing,
                       _gaSubTitle = Nothing, _gaImageURL = Nothing,
                       _gaAttachmentLinkURL = Nothing, _gaTitle = Nothing}
