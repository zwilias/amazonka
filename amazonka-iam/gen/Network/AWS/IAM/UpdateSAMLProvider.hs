...
instance AWSRequest UpdateSAMLProvider where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         UpdateSAMLProviderResponse' <$> (x .@? "SAMLProviderArn") <*>
         (pure (fromEnum s)))
...
usamlprsSAMLProviderARN =
  lens _usamlprsSAMLProviderARN (\s a -> s {_usamlprsSAMLProviderARN = a})

-- | -- | The response status code.
usamlprsResponseStatus :: Lens' UpdateSAMLProviderResponse Int
usamlprsResponseStatus =
  lens _usamlprsResponseStatus (\s a -> s {_usamlprsResponseStatus = a})
