...
goicpOpenIdConnectProviderARN =
  lens
    ...
    (\s a -> s {_goicpOpenIdConnectProviderARN = a})
...
instance AWSRequest GetOpenIdConnectProvider where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         GetOpenIdConnectProviderResponse' <$> (x .@? "CreateDate") <*>
         (x .@? "Url") <*>
...
goicprsCreateDate =
  lens _goicprsCreateDate (\s a -> s {_goicprsCreateDate = a}) . mapping _Time
...
goicprsThumbprintList =
  lens _goicprsThumbprintList (\s a -> s {_goicprsThumbprintList = a}) .
  _Default . _Coerce

-- | A list of client IDs (also known as audiences) that are associated with the specified IAM OIDC provider resource object. For more information, see 'CreateOpenIDConnectProvider' .
goicprsClientIdList :: Lens' GetOpenIdConnectProviderResponse [Text]
goicprsClientIdList =
  lens _goicprsClientIdList (\s a -> s {_goicprsClientIdList = a}) .
  _Default . _Coerce

-- | -- | The response status code.
goicprsResponseStatus :: Lens' GetOpenIdConnectProviderResponse Int
goicprsResponseStatus =
  lens _goicprsResponseStatus (\s a -> s {_goicprsResponseStatus = a})
