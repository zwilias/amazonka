...
--
--
-- For information about the number of instance profiles you can create, see <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html Limitations on IAM Entities> in the /IAM User Guide/ .
--
module Network.AWS.IAM.CreateInstanceProfile
    (
    -- * Creating a Request
