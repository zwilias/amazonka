...
coicpClientIdList =
  lens _coicpClientIdList (\s a -> s {_coicpClientIdList = a}) .
  _Default . _Coerce
...
coicpThumbprintList =
  lens _coicpThumbprintList (\s a -> s {_coicpThumbprintList = a}) . _Coerce
...
instance ToQuery CreateOpenIdConnectProvider where
  toQuery CreateOpenIdConnectProvider' {..} =
    mconcat
      ...
      , "ClientIDList" =: toQuery (toQueryList "member" <$> _coicpClientIdList)
      , "Url" =: _coicpURL
...
coicprsOpenIdConnectProviderARN ::
     Lens' CreateOpenIdConnectProviderResponse (Maybe Text)
coicprsOpenIdConnectProviderARN =
  lens
    _coicprsOpenIdConnectProviderARN
    (\s a -> s {_coicprsOpenIdConnectProviderARN = a})

-- | -- | The response status code.
coicprsResponseStatus :: Lens' CreateOpenIdConnectProviderResponse Int
coicprsResponseStatus =
  lens _coicprsResponseStatus (\s a -> s {_coicprsResponseStatus = a})
