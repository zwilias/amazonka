...
data GroupDetail = GroupDetail'{_gdARN ::
                                !(Maybe Text),
                                _gdPath :: !(Maybe Text),
...
groupDetail
    :: GroupDetail
groupDetail
  = GroupDetail'{_gdARN = Nothing, _gdPath = Nothing,
                 _gdCreateDate = Nothing, _gdGroupId = Nothing,
                 _gdGroupPolicyList = Nothing, _gdGroupName = Nothing,
