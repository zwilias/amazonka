...
data InstanceProfile = InstanceProfile'{_ipPath ::
                                        !Text,
...
instanceProfile
    ...
    -> InstanceProfile
instanceProfile pPath_ pInstanceProfileName_
  pInstanceProfileId_ pARN_ pCreateDate_
  = InstanceProfile'{_ipPath = pPath_,
