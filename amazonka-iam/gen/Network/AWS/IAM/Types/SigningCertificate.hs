...
data SigningCertificate = SigningCertificate'{_scUploadDate
                                              :: !(Maybe ISO8601),
                                              _scUserName :: !Text,
...
signingCertificate
    ...
    -> StatusType -- ^ 'scStatus'
    -> SigningCertificate
signingCertificate pUserName_ pCertificateId_
  pCertificateBody_ pStatus_
  = SigningCertificate'{_scUploadDate = Nothing,
