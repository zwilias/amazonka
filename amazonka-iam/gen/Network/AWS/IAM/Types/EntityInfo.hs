...
data EntityInfo = EntityInfo'{_eiPath ::
                              !(Maybe Text),
                              _eiARN :: !Text, _eiName :: !Text,
                              _eiType :: !PolicyOwnerEntityType, _eiId :: !Text}
...
entityInfo pARN_ pName_ pType_ pId_
  = EntityInfo'{_eiPath = Nothing, _eiARN = pARN_,
                _eiName = pName_, _eiType = pType_, _eiId = pId_}
