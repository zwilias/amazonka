...
data ServiceSpecificCredentialMetadata = ServiceSpecificCredentialMetadata'{_sscmUserName
                                                                            ::
                                                                            !Text,
                                                                            _sscmStatus
                                                                            ::
...
serviceSpecificCredentialMetadata
    ...
    -> ServiceSpecificCredentialMetadata
serviceSpecificCredentialMetadata pUserName_ pStatus_
  pServiceUserName_ pCreateDate_
  pServiceSpecificCredentialId_ pServiceName_
  = ServiceSpecificCredentialMetadata'{_sscmUserName =
                                         pUserName_,
