...
data ServiceSpecificCredential = ServiceSpecificCredential'{_sscCreateDate
                                                            :: !ISO8601,
                                                            _sscServiceName ::
                                                            !Text,
                                                            _sscServiceUserName
...
serviceSpecificCredential
    ...
    -> ServiceSpecificCredential
serviceSpecificCredential pCreateDate_ pServiceName_
  pServiceUserName_ pServicePassword_
  pServiceSpecificCredentialId_ pUserName_ pStatus_
  = ServiceSpecificCredential'{_sscCreateDate =
                                 _Time # pCreateDate_,
                               ...
                               _sscUserName = pUserName_, _sscStatus = pStatus_}
