...
data Group = Group'{_gPath :: !Text,
                    _gGroupName :: !Text, _gGroupId :: !Text,
                    _gARN :: !Text, _gCreateDate :: !ISO8601}
...
group'
    ...
    -> UTCTime -- ^ 'gCreateDate'
    -> Group
group' pPath_ pGroupName_ pGroupId_ pARN_
  pCreateDate_
  = Group'{_gPath = pPath_, _gGroupName = pGroupName_,
