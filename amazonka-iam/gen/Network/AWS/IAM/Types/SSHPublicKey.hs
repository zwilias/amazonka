...
data SSHPublicKey = SSHPublicKey'{_spkUploadDate ::
                                  !(Maybe ISO8601),
                                  _spkUserName :: !Text,
...
sshPublicKey
    ...
    -> SSHPublicKey
sshPublicKey pUserName_ pSSHPublicKeyId_
  pFingerprint_ pSSHPublicKeyBody_ pStatus_
  = SSHPublicKey'{_spkUploadDate = Nothing,
