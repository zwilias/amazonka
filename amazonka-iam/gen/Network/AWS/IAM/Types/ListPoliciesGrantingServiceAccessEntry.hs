...
data ListPoliciesGrantingServiceAccessEntry = ListPoliciesGrantingServiceAccessEntry'{_lpgsaeServiceNamespace
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
                                                                                      _lpgsaePolicies
...
listPoliciesGrantingServiceAccessEntry
    :: ListPoliciesGrantingServiceAccessEntry
listPoliciesGrantingServiceAccessEntry
  = ListPoliciesGrantingServiceAccessEntry'{_lpgsaeServiceNamespace
                                              = Nothing,
