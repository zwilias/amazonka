...
data SSHPublicKeyMetadata = SSHPublicKeyMetadata'{_spkmUserName
                                                  :: !Text,
...
sshPublicKeyMetadata
    ...
    -> SSHPublicKeyMetadata
sshPublicKeyMetadata pUserName_ pSSHPublicKeyId_
  pStatus_ pUploadDate_
  = SSHPublicKeyMetadata'{_spkmUserName = pUserName_,
