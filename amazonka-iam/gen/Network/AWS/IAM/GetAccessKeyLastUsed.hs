...
instance AWSRequest GetAccessKeyLastUsed where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         GetAccessKeyLastUsedResponse' <$> (x .@? "UserName") <*>
         (x .@? "AccessKeyLastUsed") <*>
         (pure (fromEnum s)))
...
gaklursAccessKeyLastUsed ::
     Lens' GetAccessKeyLastUsedResponse (Maybe AccessKeyLastUsed)
gaklursAccessKeyLastUsed =
  lens _gaklursAccessKeyLastUsed (\s a -> s {_gaklursAccessKeyLastUsed = a})

-- | -- | The response status code.
gaklursResponseStatus :: Lens' GetAccessKeyLastUsedResponse Int
gaklursResponseStatus =
  lens _gaklursResponseStatus (\s a -> s {_gaklursResponseStatus = a})
