...
csamlpSAMLMetadataDocument =
  lens _csamlpSAMLMetadataDocument (\s a -> s {_csamlpSAMLMetadataDocument = a})
...
instance AWSRequest CreateSAMLProvider where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CreateSAMLProviderResponse' <$> (x .@? "SAMLProviderArn") <*>
         (pure (fromEnum s)))
...
csamlprsSAMLProviderARN =
  lens _csamlprsSAMLProviderARN (\s a -> s {_csamlprsSAMLProviderARN = a})

-- | -- | The response status code.
csamlprsResponseStatus :: Lens' CreateSAMLProviderResponse Int
csamlprsResponseStatus =
  lens _csamlprsResponseStatus (\s a -> s {_csamlprsResponseStatus = a})
