...
--
--
-- For information about limits on the number of MFA devices you can create, see <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html Limitations on Entities> in the /IAM User Guide/ .
--
