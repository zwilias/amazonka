...
lipfrMaxItems =
  lens _lipfrMaxItems (\s a -> s {_lipfrMaxItems = a}) . mapping _Nat
...
instance AWSRequest ListInstanceProfilesForRole where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         ListInstanceProfilesForRoleResponse' <$> (x .@? "Marker") <*>
         (x .@? "IsTruncated") <*>
         (pure (fromEnum s)) <*>
...
lipfrrsResponseStatus =
  lens _lipfrrsResponseStatus (\s a -> s {_lipfrrsResponseStatus = a})

-- | A list of instance profiles.
lipfrrsInstanceProfiles ::
     Lens' ListInstanceProfilesForRoleResponse [InstanceProfile]
lipfrrsInstanceProfiles =
  lens _lipfrrsInstanceProfiles (\s a -> s {_lipfrrsInstanceProfiles = a}) .
  _Coerce
