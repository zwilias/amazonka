...
larprsAttachedPolicies ::
     Lens' ListAttachedRolePoliciesResponse [AttachedPolicy]
larprsAttachedPolicies =
  lens _larprsAttachedPolicies (\s a -> s {_larprsAttachedPolicies = a}) .
  _Default . _Coerce
...
larprsResponseStatus =
  lens _larprsResponseStatus (\s a -> s {_larprsResponseStatus = a})
