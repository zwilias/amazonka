...
gpbfpgOperatingSystem ::
     Lens' GetPatchBaselineForPatchGroup (Maybe OperatingSystem)
gpbfpgOperatingSystem =
  lens _gpbfpgOperatingSystem (\s a -> s {_gpbfpgOperatingSystem = a})
...
instance AWSRequest GetPatchBaselineForPatchGroup where
  type Rs GetPatchBaselineForPatchGroup = GetPatchBaselineForPatchGroupResponse
  request = postJSON ssm
  response =
    receiveJSON
      (\s h x ->
         GetPatchBaselineForPatchGroupResponse' <$> (x .?> "OperatingSystem") <*>
         (x .?> "BaselineId") <*>
         (x .?> "PatchGroup") <*>
         (pure (fromEnum s)))
...
gpbfpgrsOperatingSystem ::
     Lens' GetPatchBaselineForPatchGroupResponse (Maybe OperatingSystem)
gpbfpgrsOperatingSystem =
  lens _gpbfpgrsOperatingSystem (\s a -> s {_gpbfpgrsOperatingSystem = a})

-- | The ID of the patch baseline that should be used for the patch group.
gpbfpgrsBaselineId :: Lens' GetPatchBaselineForPatchGroupResponse (Maybe Text)
gpbfpgrsBaselineId =
  lens _gpbfpgrsBaselineId (\s a -> s {_gpbfpgrsBaselineId = a})

-- | The name of the patch group.
gpbfpgrsPatchGroup :: Lens' GetPatchBaselineForPatchGroupResponse (Maybe Text)
gpbfpgrsPatchGroup =
  lens _gpbfpgrsPatchGroup (\s a -> s {_gpbfpgrsPatchGroup = a})

-- | -- | The response status code.
gpbfpgrsResponseStatus :: Lens' GetPatchBaselineForPatchGroupResponse Int
gpbfpgrsResponseStatus =
  lens _gpbfpgrsResponseStatus (\s a -> s {_gpbfpgrsResponseStatus = a})
