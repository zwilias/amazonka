...
newtype CancelMaintenanceWindowExecution = CancelMaintenanceWindowExecution'{_cmweWindowExecutionId
                                                                             ::
                                                                             Text}
...
cancelMaintenanceWindowExecution pWindowExecutionId_
  = CancelMaintenanceWindowExecution'{_cmweWindowExecutionId
                                        = pWindowExecutionId_}
...
data CancelMaintenanceWindowExecutionResponse = CancelMaintenanceWindowExecutionResponse'{_cmwersWindowExecutionId
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
...
cancelMaintenanceWindowExecutionResponse
  pResponseStatus_
  = CancelMaintenanceWindowExecutionResponse'{_cmwersWindowExecutionId
                                                = Nothing,
                                              _cmwersResponseStatus =
                                                pResponseStatus_}
