...
data DescribeInstancePatchStatesForPatchGroup = DescribeInstancePatchStatesForPatchGroup'{_dipsfpgFilters
                                                                                          ::
                                                                                          !(Maybe
...
describeInstancePatchStatesForPatchGroup pPatchGroup_
  = DescribeInstancePatchStatesForPatchGroup'{_dipsfpgFilters
                                                = Nothing,
...
data DescribeInstancePatchStatesForPatchGroupResponse = DescribeInstancePatchStatesForPatchGroupResponse'{_dipsfpgrsNextToken
                                                                                                          ::
                                                                                                          !(Maybe
                                                                                                              Text),
...
describeInstancePatchStatesForPatchGroupResponse
  pResponseStatus_
  = DescribeInstancePatchStatesForPatchGroupResponse'{_dipsfpgrsNextToken
                                                        = Nothing,
                                                      _dipsfpgrsInstancePatchStates
                                                        = Nothing,
                                                      _dipsfpgrsResponseStatus =
