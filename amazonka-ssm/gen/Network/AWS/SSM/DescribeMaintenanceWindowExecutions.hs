...
dmweFilters ::
     Lens' DescribeMaintenanceWindowExecutions [MaintenanceWindowFilter]
dmweFilters =
  lens _dmweFilters (\s a -> s {_dmweFilters = a}) . _Default . _Coerce
...
dmweMaxResults =
  lens _dmweMaxResults (\s a -> s {_dmweMaxResults = a}) . mapping _Nat
...
instance AWSRequest DescribeMaintenanceWindowExecutions where
  type Rs DescribeMaintenanceWindowExecutions = DescribeMaintenanceWindowExecutionsResponse
...
dmwersWindowExecutions =
  lens _dmwersWindowExecutions (\s a -> s {_dmwersWindowExecutions = a}) .
  _Default . _Coerce
...
dmwersResponseStatus =
  lens _dmwersResponseStatus (\s a -> s {_dmwersResponseStatus = a})
