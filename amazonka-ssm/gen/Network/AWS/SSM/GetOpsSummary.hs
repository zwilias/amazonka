...
data GetOpsSummary = GetOpsSummary'{_gosAggregators
...
getOpsSummary
    :: GetOpsSummary
getOpsSummary
  = GetOpsSummary'{_gosAggregators = Nothing,
                   _gosSyncName = Nothing, _gosFilters = Nothing,
                   _gosResultAttributes = Nothing,
                   _gosNextToken = Nothing, _gosMaxResults = Nothing}
...
instance Hashable GetOpsSummary where

instance NFData GetOpsSummary where
...
data GetOpsSummaryResponse = GetOpsSummaryResponse'{_gosrsEntities
                                                    :: !(Maybe [OpsEntity]),
                                                    _gosrsNextToken ::
                                                    !(Maybe Text),
...
getOpsSummaryResponse pResponseStatus_
  = GetOpsSummaryResponse'{_gosrsEntities = Nothing,
...
instance NFData GetOpsSummaryResponse where
