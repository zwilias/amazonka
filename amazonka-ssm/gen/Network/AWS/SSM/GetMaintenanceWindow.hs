...
instance AWSRequest GetMaintenanceWindow where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetMaintenanceWindowResponse' <$> (x .?> "Enabled") <*>
         (x .?> "Schedule") <*>
         (x .?> "CreatedDate") <*>
         (x .?> "Name") <*>
         (x .?> "ModifiedDate") <*>
...
instance ToHeaders GetMaintenanceWindow where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =# ("AmazonSSM.GetMaintenanceWindow" :: ByteString)
...
gmwrsCreatedDate =
  lens _gmwrsCreatedDate (\s a -> s {_gmwrsCreatedDate = a}) . mapping _Time
...
gmwrsModifiedDate =
  lens _gmwrsModifiedDate (\s a -> s {_gmwrsModifiedDate = a}) . mapping _Time
...
gmwrsAllowUnassociatedTargets =
  lens
    ...
    (\s a -> s {_gmwrsAllowUnassociatedTargets = a})

-- | The description of the Maintenance Window.
gmwrsDescription :: Lens' GetMaintenanceWindowResponse (Maybe Text)
gmwrsDescription =
  lens _gmwrsDescription (\s a -> s {_gmwrsDescription = a}) .
  mapping _Sensitive

-- | The duration of the Maintenance Window in hours.
gmwrsDuration :: Lens' GetMaintenanceWindowResponse (Maybe Natural)
gmwrsDuration =
  lens _gmwrsDuration (\s a -> s {_gmwrsDuration = a}) . mapping _Nat
...
gmwrsResponseStatus =
  lens _gmwrsResponseStatus (\s a -> s {_gmwrsResponseStatus = a})
