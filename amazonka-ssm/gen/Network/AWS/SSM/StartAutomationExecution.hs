...
saeTargetParameterName =
  lens _saeTargetParameterName (\s a -> s {_saeTargetParameterName = a})
...
saeParameters =
  lens _saeParameters (\s a -> s {_saeParameters = a}) . _Default . _Map

-- | The version of the Automation document to use for this execution.
saeDocumentVersion :: Lens' StartAutomationExecution (Maybe Text)
saeDocumentVersion =
  lens _saeDocumentVersion (\s a -> s {_saeDocumentVersion = a})
...
instance AWSRequest StartAutomationExecution where
  ...
  response =
    receiveJSON
      (\s h x ->
         StartAutomationExecutionResponse' <$> (x .?> "AutomationExecutionId") <*>
         (pure (fromEnum s)))
...
srsAutomationExecutionId =
  lens _srsAutomationExecutionId (\s a -> s {_srsAutomationExecutionId = a})
