...
newtype TerminateSession = TerminateSession'{_tsSessionId
                                             :: Text}
...
data TerminateSessionResponse = TerminateSessionResponse'{_tsrsSessionId
                                                          :: !(Maybe Text),
                                                          _tsrsResponseStatus ::
                                                          !Int}
...
terminateSessionResponse pResponseStatus_
  = TerminateSessionResponse'{_tsrsSessionId = Nothing,
