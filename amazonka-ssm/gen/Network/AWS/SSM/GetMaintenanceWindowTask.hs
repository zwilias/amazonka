...
instance AWSRequest GetMaintenanceWindowTask where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetMaintenanceWindowTaskResponse' <$> (x .?> "ServiceRoleArn") <*>
         (x .?> "WindowTaskId") <*>
...
gmwtrsServiceRoleARN =
  lens _gmwtrsServiceRoleARN (\s a -> s {_gmwtrsServiceRoleARN = a})

-- | The retrieved Maintenance Window task ID.
gmwtrsWindowTaskId :: Lens' GetMaintenanceWindowTaskResponse (Maybe Text)
gmwtrsWindowTaskId =
  lens _gmwtrsWindowTaskId (\s a -> s {_gmwtrsWindowTaskId = a})

-- | The parameters to pass to the task when it executes.
gmwtrsTaskParameters ::
     Lens' GetMaintenanceWindowTaskResponse (Maybe (HashMap Text MaintenanceWindowTaskParameterValueExpression))
gmwtrsTaskParameters =
  lens _gmwtrsTaskParameters (\s a -> s {_gmwtrsTaskParameters = a}) .
...
gmwtrsPriority =
  lens _gmwtrsPriority (\s a -> s {_gmwtrsPriority = a}) . mapping _Nat

-- | The type of task to execute.
gmwtrsTaskType ::
     Lens' GetMaintenanceWindowTaskResponse (Maybe MaintenanceWindowTaskType)
...
-- | The parameters to pass to the task when it executes.
gmwtrsTaskInvocationParameters ::
     Lens' GetMaintenanceWindowTaskResponse (Maybe MaintenanceWindowTaskInvocationParameters)
gmwtrsTaskInvocationParameters =
  lens
    _gmwtrsTaskInvocationParameters
    (\s a -> s {_gmwtrsTaskInvocationParameters = a})
...
gmwtrsTargets =
  lens _gmwtrsTargets (\s a -> s {_gmwtrsTargets = a}) . _Default . _Coerce
...
gmwtrsDescription =
  lens _gmwtrsDescription (\s a -> s {_gmwtrsDescription = a}) .
  mapping _Sensitive

-- | The maximum number of targets allowed to run this task in parallel.
gmwtrsMaxConcurrency :: Lens' GetMaintenanceWindowTaskResponse (Maybe Text)
gmwtrsMaxConcurrency =
  lens _gmwtrsMaxConcurrency (\s a -> s {_gmwtrsMaxConcurrency = a})
...
gmwtrsResponseStatus =
  lens _gmwtrsResponseStatus (\s a -> s {_gmwtrsResponseStatus = a})
