...
newtype StartAssociationsOnce = StartAssociationsOnce'{_saoAssociationIds
                                                       :: List1 Text}
...
startAssociationsOnce pAssociationIds_
  = StartAssociationsOnce'{_saoAssociationIds =
...
newtype StartAssociationsOnceResponse = StartAssociationsOnceResponse'{_saorsResponseStatus
                                                                       :: Int}
...
startAssociationsOnceResponse pResponseStatus_
  = StartAssociationsOnceResponse'{_saorsResponseStatus
                                     = pResponseStatus_}
