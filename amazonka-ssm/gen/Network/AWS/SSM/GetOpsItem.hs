...
newtype GetOpsItem = GetOpsItem'{_goiOpsItemId ::
                                 Text}
...
instance Hashable GetOpsItem where

instance NFData GetOpsItem where
...
data GetOpsItemResponse = GetOpsItemResponse'{_goirsOpsItem
                                              :: !(Maybe OpsItem),
...
getOpsItemResponse pResponseStatus_
  = GetOpsItemResponse'{_goirsOpsItem = Nothing,
...
instance NFData GetOpsItemResponse where
