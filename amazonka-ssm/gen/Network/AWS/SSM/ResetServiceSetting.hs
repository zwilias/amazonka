...
newtype ResetServiceSetting = ResetServiceSetting'{_rssSettingId
                                                   :: Text}
...
data ResetServiceSettingResponse = ResetServiceSettingResponse'{_rssrsServiceSetting
                                                                ::
                                                                !(Maybe
                                                                    ServiceSetting),
                                                                _rssrsResponseStatus
                                                                :: !Int}
                                     deriving (Eq, Read, Show, Data, Typeable,
                                               Generic)
...
resetServiceSettingResponse pResponseStatus_
  = ResetServiceSettingResponse'{_rssrsServiceSetting =
                                   Nothing,
