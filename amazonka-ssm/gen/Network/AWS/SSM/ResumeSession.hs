...
newtype ResumeSession = ResumeSession'{_rsSessionId
                                       :: Text}
...
data ResumeSessionResponse = ResumeSessionResponse'{_rsrsStreamURL
                                                    :: !(Maybe Text),
                                                    _rsrsTokenValue ::
                                                    !(Maybe Text),
                                                    _rsrsSessionId ::
...
resumeSessionResponse pResponseStatus_
  = ResumeSessionResponse'{_rsrsStreamURL = Nothing,
                           _rsrsTokenValue = Nothing, _rsrsSessionId = Nothing,
