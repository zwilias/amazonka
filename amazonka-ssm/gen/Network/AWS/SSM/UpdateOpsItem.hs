...
data UpdateOpsItem = UpdateOpsItem'{_uoiStatus ::
                                    !(Maybe OpsItemStatus),
...
updateOpsItem pOpsItemId_
  = UpdateOpsItem'{_uoiStatus = Nothing,
                   _uoiOperationalDataToDelete = Nothing,
                   _uoiPriority = Nothing, _uoiCategory = Nothing,
                   _uoiSeverity = Nothing,
                   _uoiRelatedOpsItems = Nothing, _uoiTitle = Nothing,
...
instance Hashable UpdateOpsItem where

instance NFData UpdateOpsItem where
...
newtype UpdateOpsItemResponse = UpdateOpsItemResponse'{_uoirsResponseStatus
                                                       :: Int}
...
updateOpsItemResponse
    :: Int -- ^ 'uoirsResponseStatus'
    -> UpdateOpsItemResponse
updateOpsItemResponse pResponseStatus_
  = UpdateOpsItemResponse'{_uoirsResponseStatus =
                             pResponseStatus_}
...
instance NFData UpdateOpsItemResponse where
