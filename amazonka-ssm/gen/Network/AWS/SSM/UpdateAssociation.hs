...
data UpdateAssociation = UpdateAssociation'{_uaMaxErrors
                                            :: !(Maybe Text),
...
updateAssociation pAssociationId_
  = UpdateAssociation'{_uaMaxErrors = Nothing,
                       _uaScheduleExpression = Nothing, _uaName = Nothing,
                       _uaOutputLocation = Nothing,
                       _uaSyncCompliance = Nothing, _uaTargets = Nothing,
