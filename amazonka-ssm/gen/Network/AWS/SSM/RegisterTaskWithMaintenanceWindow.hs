...
rtwmwTaskParameters ::
     Lens' RegisterTaskWithMaintenanceWindow (Maybe (HashMap Text MaintenanceWindowTaskParameterValueExpression))
rtwmwTaskParameters =
  lens _rtwmwTaskParameters (\s a -> s {_rtwmwTaskParameters = a}) .
...
rtwmwPriority =
  lens _rtwmwPriority (\s a -> s {_rtwmwPriority = a}) . mapping _Nat
...
rtwmwTaskInvocationParameters ::
     Lens' RegisterTaskWithMaintenanceWindow (Maybe MaintenanceWindowTaskInvocationParameters)
rtwmwTaskInvocationParameters =
  lens
    _rtwmwTaskInvocationParameters
    (\s a -> s {_rtwmwTaskInvocationParameters = a})
...
rtwmwDescription =
  lens _rtwmwDescription (\s a -> s {_rtwmwDescription = a}) .
  mapping _Sensitive
...
rtwmwServiceRoleARN =
  lens _rtwmwServiceRoleARN (\s a -> s {_rtwmwServiceRoleARN = a})

-- | The type of task being registered.
rtwmwTaskType ::
     Lens' RegisterTaskWithMaintenanceWindow MaintenanceWindowTaskType
...
rtwmwMaxConcurrency =
  lens _rtwmwMaxConcurrency (\s a -> s {_rtwmwMaxConcurrency = a})
...
instance AWSRequest RegisterTaskWithMaintenanceWindow where
  type Rs RegisterTaskWithMaintenanceWindow = RegisterTaskWithMaintenanceWindowResponse
  request = postJSON ssm
  response =
    receiveJSON
      (\s h x ->
         RegisterTaskWithMaintenanceWindowResponse' <$> (x .?> "WindowTaskId") <*>
         (pure (fromEnum s)))
...
rtwmwrsWindowTaskId ::
     Lens' RegisterTaskWithMaintenanceWindowResponse (Maybe Text)
rtwmwrsWindowTaskId =
  lens _rtwmwrsWindowTaskId (\s a -> s {_rtwmwrsWindowTaskId = a})

-- | -- | The response status code.
rtwmwrsResponseStatus :: Lens' RegisterTaskWithMaintenanceWindowResponse Int
rtwmwrsResponseStatus =
  lens _rtwmwrsResponseStatus (\s a -> s {_rtwmwrsResponseStatus = a})
