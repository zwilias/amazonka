...
data OpsAggregator = OpsAggregator'{_oaTypeName ::
                                    !(Maybe Text),
                                    _oaAggregators ::
...
opsAggregator
    :: OpsAggregator
opsAggregator
  = OpsAggregator'{_oaTypeName = Nothing,
                   _oaAggregators = Nothing, _oaValues = Nothing,
                   _oaFilters = Nothing, _oaAttributeName = Nothing,
...
instance Hashable OpsAggregator where

instance NFData OpsAggregator where
