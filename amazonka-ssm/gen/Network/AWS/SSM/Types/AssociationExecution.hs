...
data AssociationExecution = AssociationExecution'{_aeAssociationId
                                                  :: !(Maybe Text),
                                                  _aeDetailedStatus ::
                                                  !(Maybe Text),
...
associationExecution
    :: AssociationExecution
associationExecution
  = AssociationExecution'{_aeAssociationId = Nothing,
                          _aeDetailedStatus = Nothing, _aeStatus = Nothing,
                          _aeExecutionId = Nothing, _aeCreatedTime = Nothing,
