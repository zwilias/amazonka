...
data InventoryResultItem = InventoryResultItem'{_iriContentHash
                                                :: !(Maybe Text),
                                                _iriCaptureTime ::
                                                !(Maybe Text),
                                                _iriTypeName :: !Text,
...
inventoryResultItem pTypeName_ pSchemaVersion_
  = InventoryResultItem'{_iriContentHash = Nothing,
                         _iriCaptureTime = Nothing, _iriTypeName = pTypeName_,
