...
newtype ResourceDataSyncDestinationDataSharing = ResourceDataSyncDestinationDataSharing'{_rdsddsDestinationDataSharingType
                                                                                         ::
                                                                                         Maybe
                                                                                           Text}
...
resourceDataSyncDestinationDataSharing
    :: ResourceDataSyncDestinationDataSharing
resourceDataSyncDestinationDataSharing
  = ResourceDataSyncDestinationDataSharing'{_rdsddsDestinationDataSharingType
                                              = Nothing}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ResourceDataSyncDestinationDataSharing"
              (\ x ->
                 ResourceDataSyncDestinationDataSharing' <$>
