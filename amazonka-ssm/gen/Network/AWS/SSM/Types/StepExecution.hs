...
stepExecution
  = StepExecution'{_seFailureDetails = Nothing,
                   _seIsEnd = Nothing, _seInputs = Nothing,
                   _seStepName = Nothing, _seExecutionEndTime = Nothing,
                   _seFailureMessage = Nothing, _seResponse = Nothing,
                   _seAction = Nothing, _seResponseCode = Nothing,
                   _seStepStatus = Nothing, _seTargetLocation = Nothing,
                   _seOverriddenParameters = Nothing,
                   _seOutputs = Nothing,
                   _seExecutionStartTime = Nothing,
                   _seMaxAttempts = Nothing, _seTargets = Nothing,
                   _seNextStep = Nothing, _seStepExecutionId = Nothing,
