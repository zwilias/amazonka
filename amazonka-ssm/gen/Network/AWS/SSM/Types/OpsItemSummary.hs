...
data OpsItemSummary = OpsItemSummary'{_oisOpsItemId
                                      :: !(Maybe Text),
...
opsItemSummary
    :: OpsItemSummary
opsItemSummary
  = OpsItemSummary'{_oisOpsItemId = Nothing,
                    _oisStatus = Nothing, _oisPriority = Nothing,
                    _oisCreatedTime = Nothing, _oisCategory = Nothing,
                    _oisSeverity = Nothing, _oisCreatedBy = Nothing,
                    _oisLastModifiedTime = Nothing, _oisSource = Nothing,
                    _oisTitle = Nothing, _oisLastModifiedBy = Nothing,
...
instance Hashable OpsItemSummary where

instance NFData OpsItemSummary where
