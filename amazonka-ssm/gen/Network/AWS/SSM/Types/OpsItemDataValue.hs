...
data OpsItemDataValue = OpsItemDataValue'{_oidvValue
                                          :: !(Maybe Text),
...
opsItemDataValue
    :: OpsItemDataValue
opsItemDataValue
  = OpsItemDataValue'{_oidvValue = Nothing,
                      _oidvType = Nothing}
...
instance FromJSON OpsItemDataValue where
        parseJSON
          = withObject "OpsItemDataValue"
              (\ x ->
                 OpsItemDataValue' <$>
                   (x .:? "Value") <*> (x .:? "Type"))

instance Hashable OpsItemDataValue where

instance NFData OpsItemDataValue where
