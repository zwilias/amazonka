...
data Session = Session'{_sesStatus ::
                        !(Maybe SessionStatus),
...
session
    :: Session
session
  = Session'{_sesStatus = Nothing,
             _sesOutputURL = Nothing, _sesDocumentName = Nothing,
             _sesEndDate = Nothing, _sesOwner = Nothing,
             _sesStartDate = Nothing, _sesDetails = Nothing,
             _sesSessionId = Nothing, _sesTarget = Nothing}
