...
data OpsItemFilter = OpsItemFilter'{_oifKey ::
                                    !OpsItemFilterKey,
                                    _oifValues :: ![Text],
...
opsItemFilter
    :: OpsItemFilterKey -- ^ 'oifKey'
    -> OpsItemFilterOperator -- ^ 'oifOperator'
    -> OpsItemFilter
opsItemFilter pKey_ pOperator_
  = OpsItemFilter'{_oifKey = pKey_,
                   _oifValues = mempty, _oifOperator = pOperator_}
...
instance Hashable OpsItemFilter where

instance NFData OpsItemFilter where
