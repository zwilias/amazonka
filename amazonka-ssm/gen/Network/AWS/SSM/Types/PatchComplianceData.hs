...
data PatchComplianceData = PatchComplianceData'{_pcdTitle
                                                :: !Text,
                                                _pcdKBId :: !Text,
...
patchComplianceData
    ...
    -> PatchComplianceData
patchComplianceData pTitle_ pKBId_ pClassification_
  pSeverity_ pState_ pInstalledTime_
  = PatchComplianceData'{_pcdTitle = pTitle_,
                         _pcdKBId = pKBId_,
                         _pcdClassification = pClassification_,
                         _pcdSeverity = pSeverity_, _pcdState = pState_,
