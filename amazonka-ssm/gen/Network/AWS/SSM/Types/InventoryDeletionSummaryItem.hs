...
data InventoryDeletionSummaryItem = InventoryDeletionSummaryItem'{_idsiRemainingCount
                                                                  ::
                                                                  !(Maybe Int),
                                                                  _idsiCount ::
                                                                  !(Maybe Int),
...
inventoryDeletionSummaryItem
    :: InventoryDeletionSummaryItem
inventoryDeletionSummaryItem
  = InventoryDeletionSummaryItem'{_idsiRemainingCount =
                                    Nothing,
                                  _idsiCount = Nothing, _idsiVersion = Nothing}
