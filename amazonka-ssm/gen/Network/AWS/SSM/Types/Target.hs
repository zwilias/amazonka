...
--
--
-- For information about how to send commands that target instances using @Key,Value@ parameters, see <https://docs.aws.amazon.com/systems-manager/latest/userguide/send-commands-multiple.html#send-commands-targeting Targeting multiple instances> in the /AWS Systems Manager User Guide/ .
--
--
