...
data ComplianceItemEntry = ComplianceItemEntry'{_cieDetails
                                                :: !(Maybe (Map Text Text)),
                                                _cieId :: !(Maybe Text),
...
complianceItemEntry pSeverity_ pStatus_
  = ComplianceItemEntry'{_cieDetails = Nothing,
                         _cieId = Nothing, _cieTitle = Nothing,
                         _cieSeverity = pSeverity_, _cieStatus = pStatus_}
