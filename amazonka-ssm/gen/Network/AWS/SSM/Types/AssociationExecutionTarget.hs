...
data AssociationExecutionTarget = AssociationExecutionTarget'{_aetAssociationId
                                                              :: !(Maybe Text),
                                                              _aetDetailedStatus
                                                              :: !(Maybe Text),
                                                              _aetStatus ::
...
associationExecutionTarget
    :: AssociationExecutionTarget
associationExecutionTarget
  = AssociationExecutionTarget'{_aetAssociationId =
                                  Nothing,
                                _aetDetailedStatus = Nothing,
                                _aetStatus = Nothing, _aetExecutionId = Nothing,
