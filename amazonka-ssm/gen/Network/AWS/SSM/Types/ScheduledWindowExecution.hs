...
data ScheduledWindowExecution = ScheduledWindowExecution'{_sweExecutionTime
                                                          :: !(Maybe Text),
                                                          _sweName ::
                                                          !(Maybe Text),
                                                          _sweWindowId ::
...
scheduledWindowExecution
    :: ScheduledWindowExecution
scheduledWindowExecution
  = ScheduledWindowExecution'{_sweExecutionTime =
                                Nothing,
                              _sweName = Nothing, _sweWindowId = Nothing}
