...
aDefaultInstanceName =
  lens _aDefaultInstanceName (\s a -> s {_aDefaultInstanceName = a})
...
aCreatedDate =
  lens _aCreatedDate (\s a -> s {_aCreatedDate = a}) . mapping _Time

-- | The maximum number of managed instances that can be registered using this activation.
aRegistrationLimit :: Lens' Activation (Maybe Natural)
aRegistrationLimit =
  lens _aRegistrationLimit (\s a -> s {_aRegistrationLimit = a}) . mapping _Nat

-- | The date when this activation can no longer be used to register managed instances.
aExpirationDate :: Lens' Activation (Maybe UTCTime)
aExpirationDate =
  lens _aExpirationDate (\s a -> s {_aExpirationDate = a}) . mapping _Time
...
aRegistrationsCount =
  lens _aRegistrationsCount (\s a -> s {_aRegistrationsCount = a}) .
  mapping _Nat
...
instance FromJSON Activation where
  parseJSON =
    withObject
      "Activation"
      (\x ->
         Activation' <$> (x .:? "Expired") <*> (x .:? "DefaultInstanceName") <*>
         (x .:? "ActivationId") <*>
         (x .:? "CreatedDate") <*>
         (x .:? "RegistrationLimit") <*>
         (x .:? "ExpirationDate") <*>
...
aLastExecutionDate =
  lens _aLastExecutionDate (\s a -> s {_aLastExecutionDate = a}) . mapping _Time

-- | A cron expression that specifies a schedule when the association runs.
aScheduleExpression :: Lens' Association (Maybe Text)
aScheduleExpression =
  lens _aScheduleExpression (\s a -> s {_aScheduleExpression = a})
...
aAssociationVersion =
  lens _aAssociationVersion (\s a -> s {_aAssociationVersion = a})
...
instance FromJSON Association where
  parseJSON =
    withObject
      "Association"
      (\x ->
         Association' <$> (x .:? "AssociationId") <*> (x .:? "InstanceId") <*>
         (x .:? "Overview") <*>
         (x .:? "LastExecutionDate") <*>
...
adLastSuccessfulExecutionDate =
  lens
    ...
    (\s a -> s {_adLastSuccessfulExecutionDate = a}) .
  mapping _Time
...
adLastUpdateAssociationDate =
  lens
    ...
    (\s a -> s {_adLastUpdateAssociationDate = a}) .
  mapping _Time
...
adLastExecutionDate =
  lens _adLastExecutionDate (\s a -> s {_adLastExecutionDate = a}) .
  mapping _Time

-- | A cron expression that specifies a schedule when the association runs.
adScheduleExpression :: Lens' AssociationDescription (Maybe Text)
adScheduleExpression =
  lens _adScheduleExpression (\s a -> s {_adScheduleExpression = a})
...
adOutputLocation ::
     Lens' AssociationDescription (Maybe InstanceAssociationOutputLocation)
...
adParameters =
  lens _adParameters (\s a -> s {_adParameters = a}) . _Default . _Map
...
adAssociationVersion =
  lens _adAssociationVersion (\s a -> s {_adAssociationVersion = a})
...
instance FromJSON AssociationDescription where
  parseJSON =
    withObject
      "AssociationDescription"
      (\x ->
         AssociationDescription' <$> (x .:? "AssociationId") <*>
         (x .:? "InstanceId") <*>
         (x .:? "Status") <*>
...
instance ToJSON AssociationFilter where
  toJSON AssociationFilter' {..} =
    object (catMaybes [Just ("key" .= _afKey), Just ("value" .= _afValue)])
...
aoAssociationStatusAggregatedCount ::
     Lens' AssociationOverview (HashMap Text Int)
aoAssociationStatusAggregatedCount =
  lens
    _aoAssociationStatusAggregatedCount
    (\s a -> s {_aoAssociationStatusAggregatedCount = a}) .
  _Default . _Map
...
instance FromJSON AssociationOverview where
  parseJSON =
    withObject
      "AssociationOverview"
      (\x ->
         AssociationOverview' <$> (x .:? "DetailedStatus") <*> (x .:? "Status") <*>
...
instance FromJSON AssociationStatus where
  parseJSON =
    withObject
      "AssociationStatus"
      (\x ->
         AssociationStatus' <$> (x .:? "AdditionalInfo") <*> (x .: "Date") <*>
         (x .: "Name") <*>
         (x .: "Message"))
...
aviCreatedDate =
  lens _aviCreatedDate (\s a -> s {_aviCreatedDate = a}) . mapping _Time

-- | The cron or rate schedule specified for the association when the association version was created.
aviScheduleExpression :: Lens' AssociationVersionInfo (Maybe Text)
aviScheduleExpression =
  lens _aviScheduleExpression (\s a -> s {_aviScheduleExpression = a})
...
aviOutputLocation ::
     Lens' AssociationVersionInfo (Maybe InstanceAssociationOutputLocation)
...
instance FromJSON AssociationVersionInfo where
  parseJSON =
    withObject
      "AssociationVersionInfo"
      (\x ->
         AssociationVersionInfo' <$> (x .:? "AssociationId") <*>
         (x .:? "CreatedDate") <*>
         (x .:? "ScheduleExpression") <*>
         (x .:? "Name") <*>
         (x .:? "OutputLocation") <*>
...
aeTargetParameterName =
  lens _aeTargetParameterName (\s a -> s {_aeTargetParameterName = a})
...
aeExecutionEndTime =
  lens _aeExecutionEndTime (\s a -> s {_aeExecutionEndTime = a}) . mapping _Time
...
aeAutomationExecutionStatus ::
     Lens' AutomationExecution (Maybe AutomationExecutionStatus)
aeAutomationExecutionStatus =
  lens
    _aeAutomationExecutionStatus
    (\s a -> s {_aeAutomationExecutionStatus = a})
...
aeParentAutomationExecutionId =
  lens
    ...
    (\s a -> s {_aeParentAutomationExecutionId = a})
...
aeExecutionStartTime =
  lens _aeExecutionStartTime (\s a -> s {_aeExecutionStartTime = a}) .
  mapping _Time
...
aeParameters =
  lens _aeParameters (\s a -> s {_aeParameters = a}) . _Default . _Map
...
aeAutomationExecutionId =
  lens _aeAutomationExecutionId (\s a -> s {_aeAutomationExecutionId = a})
...
aeStepExecutions =
  lens _aeStepExecutions (\s a -> s {_aeStepExecutions = a}) .
  _Default . _Coerce
...
instance FromJSON AutomationExecution where
  parseJSON =
    withObject
      "AutomationExecution"
      (\x ->
         AutomationExecution' <$> (x .:? "CurrentStepName") <*>
...
instance ToJSON AutomationExecutionFilter where
  toJSON AutomationExecutionFilter' {..} =
    object (catMaybes [Just ("Key" .= _aefKey), Just ("Values" .= _aefValues)])
...
aemCurrentStepName =
  lens _aemCurrentStepName (\s a -> s {_aemCurrentStepName = a})

-- | The list of execution outputs as defined in the Automation document.
aemTargetParameterName :: Lens' AutomationExecutionMetadata (Maybe Text)
aemTargetParameterName =
  lens _aemTargetParameterName (\s a -> s {_aemTargetParameterName = a})
...
aemExecutionEndTime =
  lens _aemExecutionEndTime (\s a -> s {_aemExecutionEndTime = a}) .
  mapping _Time
...
aemAutomationExecutionStatus ::
     Lens' AutomationExecutionMetadata (Maybe AutomationExecutionStatus)
aemAutomationExecutionStatus =
  lens
    _aemAutomationExecutionStatus
    (\s a -> s {_aemAutomationExecutionStatus = a})
...
aemParentAutomationExecutionId =
  lens
    ...
    (\s a -> s {_aemParentAutomationExecutionId = a})
...
aemExecutionStartTime =
  lens _aemExecutionStartTime (\s a -> s {_aemExecutionStartTime = a}) .
  mapping _Time
...
aemResolvedTargets =
  lens _aemResolvedTargets (\s a -> s {_aemResolvedTargets = a})

-- | The document version used during the execution.
aemDocumentVersion :: Lens' AutomationExecutionMetadata (Maybe Text)
aemDocumentVersion =
  lens _aemDocumentVersion (\s a -> s {_aemDocumentVersion = a})

-- | The execution ID.
aemAutomationExecutionId :: Lens' AutomationExecutionMetadata (Maybe Text)
aemAutomationExecutionId =
  lens _aemAutomationExecutionId (\s a -> s {_aemAutomationExecutionId = a})
...
instance FromJSON AutomationExecutionMetadata where
  parseJSON =
    withObject
      "AutomationExecutionMetadata"
      (\x ->
         AutomationExecutionMetadata' <$> (x .:? "CurrentStepName") <*>
         (x .:? "TargetParameterName") <*>
         (x .:? "LogFile") <*>
         (x .:? "ExecutedBy") <*>
         (x .:? "DocumentName") <*>
...
cExpiresAfter =
  lens _cExpiresAfter (\s a -> s {_cExpiresAfter = a}) . mapping _Time

-- | Configurations for sending notifications about command status changes.
cNotificationConfig :: Lens' Command (Maybe NotificationConfig)
cNotificationConfig =
  lens _cNotificationConfig (\s a -> s {_cNotificationConfig = a})
...
cOutputS3KeyPrefix =
  lens _cOutputS3KeyPrefix (\s a -> s {_cOutputS3KeyPrefix = a})
...
cInstanceIds =
  lens _cInstanceIds (\s a -> s {_cInstanceIds = a}) . _Default . _Coerce
...
cOutputS3BucketName =
  lens _cOutputS3BucketName (\s a -> s {_cOutputS3BucketName = a})
...
cRequestedDateTime =
  lens _cRequestedDateTime (\s a -> s {_cRequestedDateTime = a}) . mapping _Time
...
instance FromJSON Command where
  parseJSON =
    withObject
      "Command"
      (\x ->
         Command' <$> (x .:? "Status") <*> (x .:? "ExpiresAfter") <*>
...
instance ToJSON CommandFilter where
  toJSON CommandFilter' {..} =
    object (catMaybes [Just ("key" .= _cfKey), Just ("value" .= _cfValue)])
...
comNotificationConfig =
  lens _comNotificationConfig (\s a -> s {_comNotificationConfig = a})

-- | Undocumented member.
comCommandPlugins :: Lens' CommandInvocation [CommandPlugin]
comCommandPlugins =
  lens _comCommandPlugins (\s a -> s {_comCommandPlugins = a}) .
  _Default . _Coerce
...
comStandardErrorURL =
  lens _comStandardErrorURL (\s a -> s {_comStandardErrorURL = a})
...
comStandardOutputURL =
  lens _comStandardOutputURL (\s a -> s {_comStandardOutputURL = a})
...
comDocumentVersion =
  lens _comDocumentVersion (\s a -> s {_comDocumentVersion = a})
...
comRequestedDateTime =
  lens _comRequestedDateTime (\s a -> s {_comRequestedDateTime = a}) .
  mapping _Time
...
instance FromJSON CommandInvocation where
  parseJSON =
    withObject
      "CommandInvocation"
      (\x ->
         CommandInvocation' <$> (x .:? "InstanceId") <*> (x .:? "Status") <*>
         (x .:? "NotificationConfig") <*>
...
cpResponseStartDateTime =
  lens _cpResponseStartDateTime (\s a -> s {_cpResponseStartDateTime = a}) .
  mapping _Time

-- | The S3 directory path inside the bucket where the responses to the command executions should be stored. This was requested when issuing the command. For example, in the following response: test_folder/ab19cb99-a030-46dd-9dfc-8eSAMPLEPre-Fix/i-1234567876543/awsrunShellScript  test_folder is the name of the Amazon S3 bucket; ab19cb99-a030-46dd-9dfc-8eSAMPLEPre-Fix is the name of the S3 prefix; i-1234567876543 is the instance ID; awsrunShellScript is the name of the plugin.
cpOutputS3KeyPrefix :: Lens' CommandPlugin (Maybe Text)
cpOutputS3KeyPrefix =
  lens _cpOutputS3KeyPrefix (\s a -> s {_cpOutputS3KeyPrefix = a})

-- | The URL for the complete text written by the plugin to stderr. If execution is not yet complete, then this string is empty.
cpStandardErrorURL :: Lens' CommandPlugin (Maybe Text)
cpStandardErrorURL =
  lens _cpStandardErrorURL (\s a -> s {_cpStandardErrorURL = a})
...
cpStandardOutputURL =
  lens _cpStandardOutputURL (\s a -> s {_cpStandardOutputURL = a})
...
cpOutputS3BucketName =
  lens _cpOutputS3BucketName (\s a -> s {_cpOutputS3BucketName = a})

-- | The time the plugin stopped executing. Could stop prematurely if, for example, a cancel command was sent.
cpResponseFinishDateTime :: Lens' CommandPlugin (Maybe UTCTime)
cpResponseFinishDateTime =
  lens _cpResponseFinishDateTime (\s a -> s {_cpResponseFinishDateTime = a}) .
  mapping _Time
...
instance FromJSON CommandPlugin where
  parseJSON =
    withObject
      "CommandPlugin"
      (\x ->
         CommandPlugin' <$> (x .:? "Status") <*> (x .:? "ResponseStartDateTime") <*>
         (x .:? "OutputS3KeyPrefix") <*>
         (x .:? "StandardErrorUrl") <*>
         (x .:? "ResponseCode") <*>
         (x .:? "StatusDetails") <*>
...
cesExecutionTime =
  lens _cesExecutionTime (\s a -> s {_cesExecutionTime = a}) . _Time
...
instance FromJSON ComplianceExecutionSummary where
  parseJSON =
    withObject
      "ComplianceExecutionSummary"
      (\x ->
         ComplianceExecutionSummary' <$> (x .:? "ExecutionId") <*>
         (x .:? "ExecutionType") <*>
         (x .: "ExecutionTime"))
...
ciExecutionSummary =
  lens _ciExecutionSummary (\s a -> s {_ciExecutionSummary = a})
...
instance FromJSON ComplianceItem where
  parseJSON =
    withObject
      "ComplianceItem"
      (\x ->
         ComplianceItem' <$> (x .:? "Status") <*> (x .:? "ResourceId") <*>
         (x .:? "ResourceType") <*>
         (x .:? "Severity") <*>
         (x .:? "ExecutionSummary") <*>
         (x .:? "Details" .!= mempty) <*>
...
csiNonCompliantSummary ::
     Lens' ComplianceSummaryItem (Maybe NonCompliantSummary)
csiNonCompliantSummary =
  lens _csiNonCompliantSummary (\s a -> s {_csiNonCompliantSummary = a})

-- | A list of COMPLIANT items for the specified compliance type.
csiCompliantSummary :: Lens' ComplianceSummaryItem (Maybe CompliantSummary)
csiCompliantSummary =
  lens _csiCompliantSummary (\s a -> s {_csiCompliantSummary = a})
...
instance FromJSON ComplianceSummaryItem where
  parseJSON =
    withObject
      "ComplianceSummaryItem"
      (\x ->
         ComplianceSummaryItem' <$> (x .:? "NonCompliantSummary") <*>
         (x .:? "CompliantSummary") <*>
         (x .:? "ComplianceType"))
...
instance FromJSON CompliantSummary where
  parseJSON =
    withObject
      "CompliantSummary"
      (\x ->
         CompliantSummary' <$> (x .:? "CompliantCount") <*>
         (x .:? "SeveritySummary"))
...
cabreScheduleExpression =
  lens _cabreScheduleExpression (\s a -> s {_cabreScheduleExpression = a})

-- | An Amazon S3 bucket where you want to store the results of this request.
cabreOutputLocation ::
     Lens' CreateAssociationBatchRequestEntry (Maybe InstanceAssociationOutputLocation)
cabreOutputLocation =
  lens _cabreOutputLocation (\s a -> s {_cabreOutputLocation = a})

-- | The instances targeted by the request.
cabreTargets :: Lens' CreateAssociationBatchRequestEntry [Target]
cabreTargets =
  lens _cabreTargets (\s a -> s {_cabreTargets = a}) . _Default . _Coerce

-- | A description of the parameters for a document.
cabreParameters ::
     Lens' CreateAssociationBatchRequestEntry (HashMap Text [Text])
cabreParameters =
  lens _cabreParameters (\s a -> s {_cabreParameters = a}) . _Default . _Map

-- | The document version.
cabreDocumentVersion :: Lens' CreateAssociationBatchRequestEntry (Maybe Text)
cabreDocumentVersion =
  lens _cabreDocumentVersion (\s a -> s {_cabreDocumentVersion = a})

-- | Specify a descriptive name for the association.
cabreAssociationName :: Lens' CreateAssociationBatchRequestEntry (Maybe Text)
cabreAssociationName =
  lens _cabreAssociationName (\s a -> s {_cabreAssociationName = a})
...
instance FromJSON CreateAssociationBatchRequestEntry where
  parseJSON =
    withObject
      "CreateAssociationBatchRequestEntry"
      (\x ->
         CreateAssociationBatchRequestEntry' <$> (x .:? "InstanceId") <*>
         (x .:? "ScheduleExpression") <*>
         (x .:? "OutputLocation") <*>
         (x .:? "Targets" .!= mempty) <*>
         (x .:? "Parameters" .!= mempty) <*>
...
-- | The name of the filter.
dafFilterKey ::
     Lens' DescribeActivationsFilter (Maybe DescribeActivationsFilterKeys)
dafFilterKey = lens _dafFilterKey (\s a -> s {_dafFilterKey = a})

-- | The filter values.
dafFilterValues :: Lens' DescribeActivationsFilter [Text]
dafFilterValues =
  lens _dafFilterValues (\s a -> s {_dafFilterValues = a}) . _Default . _Coerce
...
ddvdDefaultVersion =
  lens _ddvdDefaultVersion (\s a -> s {_ddvdDefaultVersion = a})
...
instance FromJSON DocumentDefaultVersionDescription where
  parseJSON =
    withObject
      "DocumentDefaultVersionDescription"
      (\x ->
         DocumentDefaultVersionDescription' <$> (x .:? "DefaultVersion") <*>
         (x .:? "Name"))
...
dPlatformTypes =
  lens _dPlatformTypes (\s a -> s {_dPlatformTypes = a}) . _Default . _Coerce

-- | The date when the document was created.
dCreatedDate :: Lens' DocumentDescription (Maybe UTCTime)
dCreatedDate =
  lens _dCreatedDate (\s a -> s {_dCreatedDate = a}) . mapping _Time
...
dParameters =
  lens _dParameters (\s a -> s {_dParameters = a}) . _Default . _Coerce
...
instance FromJSON DocumentDescription where
  parseJSON =
    withObject
      "DocumentDescription"
      (\x ->
         DocumentDescription' <$> (x .:? "Status") <*> (x .:? "DocumentType") <*>
         (x .:? "Hash") <*>
         (x .:? "SchemaVersion") <*>
         (x .:? "Sha1") <*>
         (x .:? "DefaultVersion") <*>
...
instance ToJSON DocumentFilter where
  toJSON DocumentFilter' {..} =
    object (catMaybes [Just ("key" .= _dfKey), Just ("value" .= _dfValue)])
...
diPlatformTypes =
  lens _diPlatformTypes (\s a -> s {_diPlatformTypes = a}) . _Default . _Coerce
...
instance FromJSON DocumentIdentifier where
  parseJSON =
    withObject
      "DocumentIdentifier"
      (\x ->
         DocumentIdentifier' <$> (x .:? "DocumentType") <*>
         (x .:? "SchemaVersion") <*>
         (x .:? "TargetType") <*>
         (x .:? "Owner") <*>
         (x .:? "PlatformTypes" .!= mempty) <*>
...
instance ToJSON DocumentKeyValuesFilter where
  toJSON DocumentKeyValuesFilter' {..} =
    object (catMaybes [("Values" .=) <$> _dkvfValues, ("Key" .=) <$> _dkvfKey])
...
instance FromJSON DocumentParameter where
  parseJSON =
    withObject
      "DocumentParameter"
      (\x ->
         DocumentParameter' <$> (x .:? "Name") <*> (x .:? "DefaultValue") <*>
         (x .:? "Type") <*>
         (x .:? "Description"))
...
dviCreatedDate =
  lens _dviCreatedDate (\s a -> s {_dviCreatedDate = a}) . mapping _Time
...
dviDocumentVersion =
  lens _dviDocumentVersion (\s a -> s {_dviDocumentVersion = a})

-- | An identifier for the default version of the document.
dviIsDefaultVersion :: Lens' DocumentVersionInfo (Maybe Bool)
dviIsDefaultVersion =
  lens _dviIsDefaultVersion (\s a -> s {_dviIsDefaultVersion = a})
...
instance FromJSON DocumentVersionInfo where
  parseJSON =
    withObject
      "DocumentVersionInfo"
      (\x ->
         DocumentVersionInfo' <$> (x .:? "CreatedDate") <*>
         (x .:? "DocumentFormat") <*>
         (x .:? "Name") <*>
         (x .:? "DocumentVersion") <*>
         (x .:? "IsDefaultVersion"))
...
instance FromJSON EffectivePatch where
  parseJSON =
    withObject
      "EffectivePatch"
      (\x -> EffectivePatch' <$> (x .:? "Patch") <*> (x .:? "PatchStatus"))
...
-- | The association.
fcaEntry ::
     Lens' FailedCreateAssociation (Maybe CreateAssociationBatchRequestEntry)
...
instance FromJSON FailedCreateAssociation where
  parseJSON =
    withObject
      "FailedCreateAssociation"
      (\x ->
         FailedCreateAssociation' <$> (x .:? "Entry") <*> (x .:? "Fault") <*>
         (x .:? "Message"))
...
instance FromJSON FailureDetails where
  parseJSON =
    withObject
      "FailureDetails"
      (\x ->
         FailureDetails' <$> (x .:? "FailureType") <*> (x .:? "FailureStage") <*>
         (x .:? "Details" .!= mempty))
...
iaaoDetailedStatus =
  lens _iaaoDetailedStatus (\s a -> s {_iaaoDetailedStatus = a})

-- | The number of associations for the instance(s).
iaaoInstanceAssociationStatusAggregatedCount ::
     Lens' InstanceAggregatedAssociationOverview (HashMap Text Int)
iaaoInstanceAssociationStatusAggregatedCount =
  lens
    _iaaoInstanceAssociationStatusAggregatedCount
    (\s a -> s {_iaaoInstanceAssociationStatusAggregatedCount = a}) .
  _Default . _Map
...
instance FromJSON InstanceAggregatedAssociationOverview where
  parseJSON =
    withObject
      "InstanceAggregatedAssociationOverview"
      (\x ->
         InstanceAggregatedAssociationOverview' <$> (x .:? "DetailedStatus") <*>
...
iaAssociationVersion =
  lens _iaAssociationVersion (\s a -> s {_iaAssociationVersion = a})
...
instance FromJSON InstanceAssociation where
  parseJSON =
    withObject
      "InstanceAssociation"
      (\x ->
         InstanceAssociation' <$> (x .:? "AssociationId") <*>
         (x .:? "InstanceId") <*>
         (x .:? "Content") <*>
         (x .:? "AssociationVersion"))
...
-- | An Amazon S3 bucket where you want to store the results of this request.
iaolS3Location ::
     Lens' InstanceAssociationOutputLocation (Maybe S3OutputLocation)
...
instance FromJSON InstanceAssociationOutputLocation where
  parseJSON =
    withObject
      "InstanceAssociationOutputLocation"
      (\x -> InstanceAssociationOutputLocation' <$> (x .:? "S3Location"))
...
iasiDetailedStatus =
  lens _iasiDetailedStatus (\s a -> s {_iasiDetailedStatus = a})
...
iasiOutputURL ::
     Lens' InstanceAssociationStatusInfo (Maybe InstanceAssociationOutputURL)
...
iasiExecutionSummary =
  lens _iasiExecutionSummary (\s a -> s {_iasiExecutionSummary = a})
...
instance FromJSON InstanceAssociationStatusInfo where
  parseJSON =
    withObject
      "InstanceAssociationStatusInfo"
      (\x ->
         InstanceAssociationStatusInfo' <$> (x .:? "AssociationId") <*>
         (x .:? "InstanceId") <*>
         (x .:? "DetailedStatus") <*>
         (x .:? "Status") <*>
         (x .:? "OutputUrl") <*>
...
iiRegistrationDate =
  lens _iiRegistrationDate (\s a -> s {_iiRegistrationDate = a}) . mapping _Time
...
iiLastPingDateTime =
  lens _iiLastPingDateTime (\s a -> s {_iiLastPingDateTime = a}) . mapping _Time

-- | The last date the association was successfully run.
iiLastSuccessfulAssociationExecutionDate ::
     Lens' InstanceInformation (Maybe UTCTime)
iiLastSuccessfulAssociationExecutionDate =
  lens
    _iiLastSuccessfulAssociationExecutionDate
    (\s a -> s {_iiLastSuccessfulAssociationExecutionDate = a}) .
  mapping _Time
...
iiAssociationOverview ::
     Lens' InstanceInformation (Maybe InstanceAggregatedAssociationOverview)
iiAssociationOverview =
  lens _iiAssociationOverview (\s a -> s {_iiAssociationOverview = a})

-- | The status of the association.
iiAssociationStatus :: Lens' InstanceInformation (Maybe Text)
iiAssociationStatus =
  lens _iiAssociationStatus (\s a -> s {_iiAssociationStatus = a})
...
iiLastAssociationExecutionDate =
  lens
    ...
    (\s a -> s {_iiLastAssociationExecutionDate = a}) .
  mapping _Time
...
instance FromJSON InstanceInformation where
  parseJSON =
    withObject
      "InstanceInformation"
      (\x ->
         InstanceInformation' <$> (x .:? "InstanceId") <*> (x .:? "PingStatus") <*>
         (x .:? "IPAddress") <*>
         (x .:? "ResourceType") <*>
         (x .:? "RegistrationDate") <*>
         (x .:? "PlatformVersion") <*>
...
instance ToJSON InstanceInformationFilter where
  toJSON InstanceInformationFilter' {..} =
    object
      (catMaybes [Just ("key" .= _iifKey), Just ("valueSet" .= _iifValueSet)])
...
instance ToJSON InstanceInformationStringFilter where
  toJSON InstanceInformationStringFilter' {..} =
    object
      (catMaybes [Just ("Key" .= _iisfKey), Just ("Values" .= _iisfValues)])
...
ipsOwnerInformation =
  lens _ipsOwnerInformation (\s a -> s {_ipsOwnerInformation = a}) .
  mapping _Sensitive
...
ipsInstalledOtherCount =
  lens _ipsInstalledOtherCount (\s a -> s {_ipsInstalledOtherCount = a})
...
ipsNotApplicableCount =
  lens _ipsNotApplicableCount (\s a -> s {_ipsNotApplicableCount = a})
...
ipsOperationStartTime =
  lens _ipsOperationStartTime (\s a -> s {_ipsOperationStartTime = a}) . _Time

-- | The time the most recent patching operation completed on the instance.
ipsOperationEndTime :: Lens' InstancePatchState UTCTime
ipsOperationEndTime =
  lens _ipsOperationEndTime (\s a -> s {_ipsOperationEndTime = a}) . _Time
...
instance FromJSON InstancePatchState where
  parseJSON =
    withObject
      "InstancePatchState"
      (\x ->
         InstancePatchState' <$> (x .:? "OwnerInformation") <*>
         (x .:? "FailedCount") <*>
...
iaAggregators ::
     Lens' InventoryAggregator (Maybe (NonEmpty InventoryAggregator))
iaAggregators =
  lens _iaAggregators (\s a -> s {_iaAggregators = a}) . mapping _List1
...
idsiLastStatusUpdateTime =
  lens _idsiLastStatusUpdateTime (\s a -> s {_idsiLastStatusUpdateTime = a}) .
  mapping _Time

-- | Information about the status.
idsiLastStatusMessage :: Lens' InventoryDeletionStatusItem (Maybe Text)
idsiLastStatusMessage =
  lens _idsiLastStatusMessage (\s a -> s {_idsiLastStatusMessage = a})
...
idsiDeletionSummary ::
     Lens' InventoryDeletionStatusItem (Maybe InventoryDeletionSummary)
idsiDeletionSummary =
  lens _idsiDeletionSummary (\s a -> s {_idsiDeletionSummary = a})

-- | The status of the operation. Possible values are InProgress and Complete.
idsiLastStatus ::
     Lens' InventoryDeletionStatusItem (Maybe InventoryDeletionStatus)
...
idsiDeletionStartTime =
  lens _idsiDeletionStartTime (\s a -> s {_idsiDeletionStartTime = a}) .
  mapping _Time
...
instance FromJSON InventoryDeletionStatusItem where
  parseJSON =
    withObject
      "InventoryDeletionStatusItem"
      (\x ->
         InventoryDeletionStatusItem' <$> (x .:? "TypeName") <*>
...
idsSummaryItems =
  lens _idsSummaryItems (\s a -> s {_idsSummaryItems = a}) . _Default . _Coerce
...
instance FromJSON InventoryDeletionSummary where
  parseJSON =
    withObject
      "InventoryDeletionSummary"
      (\x ->
         InventoryDeletionSummary' <$> (x .:? "RemainingCount") <*>
...
idsiRemainingCount =
  lens _idsiRemainingCount (\s a -> s {_idsiRemainingCount = a})
...
instance FromJSON InventoryDeletionSummaryItem where
  parseJSON =
    withObject
      "InventoryDeletionSummaryItem"
      (\x ->
         InventoryDeletionSummaryItem' <$> (x .:? "RemainingCount") <*>
         (x .:? "Count") <*>
         (x .:? "Version"))
...
instance FromJSON InventoryItemAttribute where
  parseJSON =
    withObject
      "InventoryItemAttribute"
      (\x -> InventoryItemAttribute' <$> (x .: "Name") <*> (x .: "DataType"))
...
instance FromJSON InventoryItemSchema where
  parseJSON =
    withObject
      "InventoryItemSchema"
      (\x ->
         InventoryItemSchema' <$> (x .:? "Version") <*> (x .:? "DisplayName") <*>
         (x .: "TypeName") <*>
         (x .: "Attributes"))
...
instance FromJSON InventoryResultEntity where
  parseJSON =
    withObject
      "InventoryResultEntity"
      (\x ->
         InventoryResultEntity' <$> (x .:? "Data" .!= mempty) <*> (x .:? "Id"))
...
instance FromJSON InventoryResultItem where
  parseJSON =
    withObject
      "InventoryResultItem"
      (\x ->
         InventoryResultItem' <$> (x .:? "ContentHash") <*>
         (x .:? "CaptureTime") <*>
         (x .: "TypeName") <*>
         (x .: "SchemaVersion") <*>
         (x .:? "Content" .!= mempty))
...
instance FromJSON LoggingInfo where
  parseJSON =
    withObject
      "LoggingInfo"
      (\x ->
         LoggingInfo' <$> (x .:? "S3KeyPrefix") <*> (x .: "S3BucketName") <*>
         (x .: "S3Region"))
...
mwapParameters ::
     Lens' MaintenanceWindowAutomationParameters (HashMap Text [Text])
mwapParameters =
  lens _mwapParameters (\s a -> s {_mwapParameters = a}) . _Default . _Map

-- | The version of an Automation document to use during task execution.
mwapDocumentVersion :: Lens' MaintenanceWindowAutomationParameters (Maybe Text)
mwapDocumentVersion =
  lens _mwapDocumentVersion (\s a -> s {_mwapDocumentVersion = a})
...
instance FromJSON MaintenanceWindowExecution where
  parseJSON =
    withObject
      "MaintenanceWindowExecution"
      (\x ->
         MaintenanceWindowExecution' <$> (x .:? "Status") <*>
         (x .:? "StartTime") <*>
         (x .:? "WindowExecutionId") <*>
         (x .:? "StatusDetails") <*>
         (x .:? "EndTime") <*>
...
mwetiStatus ::
     Lens' MaintenanceWindowExecutionTaskIdentity (Maybe MaintenanceWindowExecutionStatus)
mwetiStatus = lens _mwetiStatus (\s a -> s {_mwetiStatus = a})

-- | The ID of the specific task execution in the Maintenance Window execution.
mwetiTaskExecutionId ::
     Lens' MaintenanceWindowExecutionTaskIdentity (Maybe Text)
mwetiTaskExecutionId =
  lens _mwetiTaskExecutionId (\s a -> s {_mwetiTaskExecutionId = a})

-- | The time the task execution started.
mwetiStartTime :: Lens' MaintenanceWindowExecutionTaskIdentity (Maybe UTCTime)
mwetiStartTime =
  lens _mwetiStartTime (\s a -> s {_mwetiStartTime = a}) . mapping _Time

-- | The type of executed task.
mwetiTaskType ::
     Lens' MaintenanceWindowExecutionTaskIdentity (Maybe MaintenanceWindowTaskType)
...
instance FromJSON MaintenanceWindowExecutionTaskIdentity where
  parseJSON =
    withObject
      "MaintenanceWindowExecutionTaskIdentity"
      (\x ->
         MaintenanceWindowExecutionTaskIdentity' <$> (x .:? "Status") <*>
         (x .:? "TaskExecutionId") <*>
         (x .:? "StartTime") <*>
         (x .:? "TaskType") <*>
         (x .:? "TaskArn") <*>
...
mwetiiStatus ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe MaintenanceWindowExecutionStatus)
mwetiiStatus = lens _mwetiiStatus (\s a -> s {_mwetiiStatus = a})

-- | The ID of the action performed in the service that actually handled the task invocation. If the task type is RUN_COMMAND, this value is the command ID.
mwetiiExecutionId ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
...
mwetiiTaskExecutionId ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiTaskExecutionId =
  lens _mwetiiTaskExecutionId (\s a -> s {_mwetiiTaskExecutionId = a})

-- | The time the invocation started.
mwetiiStartTime ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe UTCTime)
mwetiiStartTime =
  lens _mwetiiStartTime (\s a -> s {_mwetiiStartTime = a}) . mapping _Time

-- | The ID of the task invocation.
mwetiiInvocationId ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiInvocationId =
  lens _mwetiiInvocationId (\s a -> s {_mwetiiInvocationId = a})

-- | User-provided value that was specified when the target was registered with the Maintenance Window. This was also included in any CloudWatch events raised during the task invocation.
mwetiiOwnerInformation ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiOwnerInformation =
  lens _mwetiiOwnerInformation (\s a -> s {_mwetiiOwnerInformation = a}) .
  mapping _Sensitive

-- | The task type.
mwetiiTaskType ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe MaintenanceWindowTaskType)
...
mwetiiWindowTargetId ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiWindowTargetId =
  lens _mwetiiWindowTargetId (\s a -> s {_mwetiiWindowTargetId = a})

-- | The ID of the Maintenance Window execution that ran the task.
mwetiiWindowExecutionId ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiWindowExecutionId =
  lens _mwetiiWindowExecutionId (\s a -> s {_mwetiiWindowExecutionId = a})

-- | The details explaining the status of the task invocation. Only available for certain Status values.
mwetiiStatusDetails ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiStatusDetails =
  lens _mwetiiStatusDetails (\s a -> s {_mwetiiStatusDetails = a})

-- | The time the invocation finished.
mwetiiEndTime ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe UTCTime)
mwetiiEndTime =
  lens _mwetiiEndTime (\s a -> s {_mwetiiEndTime = a}) . mapping _Time

-- | The parameters that were provided for the invocation when it was executed.
mwetiiParameters ::
     Lens' MaintenanceWindowExecutionTaskInvocationIdentity (Maybe Text)
mwetiiParameters =
  lens _mwetiiParameters (\s a -> s {_mwetiiParameters = a}) .
  mapping _Sensitive
...
instance FromJSON MaintenanceWindowExecutionTaskInvocationIdentity where
  parseJSON =
    withObject
      "MaintenanceWindowExecutionTaskInvocationIdentity"
      (\x ->
         MaintenanceWindowExecutionTaskInvocationIdentity' <$> (x .:? "Status") <*>
         (x .:? "ExecutionId") <*>
         (x .:? "TaskExecutionId") <*>
         (x .:? "StartTime") <*>
         (x .:? "InvocationId") <*>
...
instance ToJSON MaintenanceWindowFilter where
  toJSON MaintenanceWindowFilter' {..} =
    object (catMaybes [("Values" .=) <$> _mwfValues, ("Key" .=) <$> _mwfKey])
...
mwiDescription =
  lens _mwiDescription (\s a -> s {_mwiDescription = a}) . mapping _Sensitive
...
instance FromJSON MaintenanceWindowIdentity where
  parseJSON =
    withObject
      "MaintenanceWindowIdentity"
      (\x ->
         MaintenanceWindowIdentity' <$> (x .:? "Enabled") <*> (x .:? "Name") <*>
         (x .:? "Cutoff") <*>
         (x .:? "Description") <*>
         (x .:? "Duration") <*>
         (x .:? "WindowId"))
...
mwlpPayload =
  lens _mwlpPayload (\s a -> s {_mwlpPayload = a}) .
  mapping (_Sensitive . _Base64)
...
instance FromJSON MaintenanceWindowLambdaParameters where
  parseJSON =
    withObject
      "MaintenanceWindowLambdaParameters"
      (\x ->
         MaintenanceWindowLambdaParameters' <$> (x .:? "Payload") <*>
         (x .:? "Qualifier") <*>
         (x .:? "ClientContext"))
...
mwrcpServiceRoleARN =
  lens _mwrcpServiceRoleARN (\s a -> s {_mwrcpServiceRoleARN = a})

-- | Configurations for sending notifications about command status changes on a per-instance basis.
mwrcpNotificationConfig ::
     Lens' MaintenanceWindowRunCommandParameters (Maybe NotificationConfig)
mwrcpNotificationConfig =
  lens _mwrcpNotificationConfig (\s a -> s {_mwrcpNotificationConfig = a})

-- | SHA-256 or SHA-1. SHA-1 hashes have been deprecated.
mwrcpDocumentHashType ::
     Lens' MaintenanceWindowRunCommandParameters (Maybe DocumentHashType)
mwrcpDocumentHashType =
  lens _mwrcpDocumentHashType (\s a -> s {_mwrcpDocumentHashType = a})

-- | The Amazon S3 bucket subfolder.
mwrcpOutputS3KeyPrefix ::
     Lens' MaintenanceWindowRunCommandParameters (Maybe Text)
mwrcpOutputS3KeyPrefix =
  lens _mwrcpOutputS3KeyPrefix (\s a -> s {_mwrcpOutputS3KeyPrefix = a})

-- | The parameters for the RUN_COMMAND task execution.
mwrcpParameters ::
     Lens' MaintenanceWindowRunCommandParameters (HashMap Text [Text])
mwrcpParameters =
  lens _mwrcpParameters (\s a -> s {_mwrcpParameters = a}) . _Default . _Map
...
mwrcpTimeoutSeconds ::
     Lens' MaintenanceWindowRunCommandParameters (Maybe Natural)
mwrcpTimeoutSeconds =
  lens _mwrcpTimeoutSeconds (\s a -> s {_mwrcpTimeoutSeconds = a}) .
  mapping _Nat
...
mwrcpOutputS3BucketName ::
     Lens' MaintenanceWindowRunCommandParameters (Maybe Text)
mwrcpOutputS3BucketName =
  lens _mwrcpOutputS3BucketName (\s a -> s {_mwrcpOutputS3BucketName = a})
...
instance FromJSON MaintenanceWindowRunCommandParameters where
  parseJSON =
    withObject
      "MaintenanceWindowRunCommandParameters"
      (\x ->
         MaintenanceWindowRunCommandParameters' <$> (x .:? "ServiceRoleArn") <*>
         (x .:? "NotificationConfig") <*>
         (x .:? "DocumentHashType") <*>
         (x .:? "OutputS3KeyPrefix") <*>
         (x .:? "Parameters" .!= mempty) <*>
...
instance FromJSON MaintenanceWindowStepFunctionsParameters where
  parseJSON =
    withObject
      "MaintenanceWindowStepFunctionsParameters"
      (\x ->
         MaintenanceWindowStepFunctionsParameters' <$> (x .:? "Input") <*>
         (x .:? "Name"))
...
instance ToJSON MaintenanceWindowStepFunctionsParameters where
  toJSON MaintenanceWindowStepFunctionsParameters' {..} =
    object
      (catMaybes [("Input" .=) <$> _mwsfpInput, ("Name" .=) <$> _mwsfpName])
...
-- | The type of target.
mResourceType ::
     Lens' MaintenanceWindowTarget (Maybe MaintenanceWindowResourceType)
...
mOwnerInformation =
  lens _mOwnerInformation (\s a -> s {_mOwnerInformation = a}) .
  mapping _Sensitive
...
mDescription =
  lens _mDescription (\s a -> s {_mDescription = a}) . mapping _Sensitive
...
instance FromJSON MaintenanceWindowTarget where
  parseJSON =
    withObject
      "MaintenanceWindowTarget"
      (\x ->
         MaintenanceWindowTarget' <$> (x .:? "ResourceType") <*>
         (x .:? "OwnerInformation") <*>
         (x .:? "WindowTargetId") <*>
         (x .:? "Name") <*>
         (x .:? "Targets" .!= mempty) <*>
...
mwtTaskParameters ::
     Lens' MaintenanceWindowTask (Maybe (HashMap Text MaintenanceWindowTaskParameterValueExpression))
mwtTaskParameters =
  lens _mwtTaskParameters (\s a -> s {_mwtTaskParameters = a}) .
...
mwtDescription =
  lens _mwtDescription (\s a -> s {_mwtDescription = a}) . mapping _Sensitive
...
instance FromJSON MaintenanceWindowTask where
  parseJSON =
    withObject
      "MaintenanceWindowTask"
      (\x ->
         MaintenanceWindowTask' <$> (x .:? "ServiceRoleArn") <*>
         (x .:? "WindowTaskId") <*>
...
-- | The parameters for an AUTOMATION task type.
mwtipAutomation ::
     Lens' MaintenanceWindowTaskInvocationParameters (Maybe MaintenanceWindowAutomationParameters)
mwtipAutomation = lens _mwtipAutomation (\s a -> s {_mwtipAutomation = a})

-- | The parameters for a STEP_FUNCTION task type.
mwtipStepFunctions ::
     Lens' MaintenanceWindowTaskInvocationParameters (Maybe MaintenanceWindowStepFunctionsParameters)
mwtipStepFunctions =
  lens _mwtipStepFunctions (\s a -> s {_mwtipStepFunctions = a})

-- | The parameters for a RUN_COMMAND task type.
mwtipRunCommand ::
     Lens' MaintenanceWindowTaskInvocationParameters (Maybe MaintenanceWindowRunCommandParameters)
mwtipRunCommand = lens _mwtipRunCommand (\s a -> s {_mwtipRunCommand = a})

-- | The parameters for a LAMBDA task type.
mwtipLambda ::
     Lens' MaintenanceWindowTaskInvocationParameters (Maybe MaintenanceWindowLambdaParameters)
...
instance FromJSON MaintenanceWindowTaskInvocationParameters where
  parseJSON =
    withObject
      "MaintenanceWindowTaskInvocationParameters"
      (\x ->
         MaintenanceWindowTaskInvocationParameters' <$> (x .:? "Automation") <*>
         (x .:? "StepFunctions") <*>
         (x .:? "RunCommand") <*>
         (x .:? "Lambda"))
...
mwtpveValues ::
     Lens' MaintenanceWindowTaskParameterValueExpression (Maybe [Text])
mwtpveValues =
  lens _mwtpveValues (\s a -> s {_mwtpveValues = a}) .
  mapping (_Sensitive . _Coerce)
...
ncsNonCompliantCount =
  lens _ncsNonCompliantCount (\s a -> s {_ncsNonCompliantCount = a})

-- | A summary of the non-compliance severity by compliance type
ncsSeveritySummary :: Lens' NonCompliantSummary (Maybe SeveritySummary)
ncsSeveritySummary =
  lens _ncsSeveritySummary (\s a -> s {_ncsSeveritySummary = a})
...
instance FromJSON NonCompliantSummary where
  parseJSON =
    withObject
      "NonCompliantSummary"
      (\x ->
         NonCompliantSummary' <$> (x .:? "NonCompliantCount") <*>
         (x .:? "SeveritySummary"))
...
ncNotificationEvents =
  lens _ncNotificationEvents (\s a -> s {_ncNotificationEvents = a}) .
  _Default . _Coerce
...
instance FromJSON NotificationConfig where
  parseJSON =
    withObject
      "NotificationConfig"
      (\x ->
         NotificationConfig' <$> (x .:? "NotificationEvents" .!= mempty) <*>
         (x .:? "NotificationType") <*>
         (x .:? "NotificationArn"))
...
instance FromJSON Parameter where
  parseJSON =
    withObject
      "Parameter"
      (\x ->
         Parameter' <$> (x .:? "Value") <*> (x .:? "Name") <*> (x .:? "Version") <*>
         (x .:? "Type"))
...
phLastModifiedDate =
  lens _phLastModifiedDate (\s a -> s {_phLastModifiedDate = a}) . mapping _Time
...
phLastModifiedUser =
  lens _phLastModifiedUser (\s a -> s {_phLastModifiedUser = a})
...
instance FromJSON ParameterHistory where
  parseJSON =
    withObject
      "ParameterHistory"
      (\x ->
         ParameterHistory' <$> (x .:? "LastModifiedDate") <*> (x .:? "KeyId") <*>
         (x .:? "Value") <*>
         (x .:? "Name") <*>
         (x .:? "Version") <*>
         (x .:? "LastModifiedUser") <*>
...
pmLastModifiedDate =
  lens _pmLastModifiedDate (\s a -> s {_pmLastModifiedDate = a}) . mapping _Time
...
pmLastModifiedUser =
  lens _pmLastModifiedUser (\s a -> s {_pmLastModifiedUser = a})
...
instance FromJSON ParameterMetadata where
  parseJSON =
    withObject
      "ParameterMetadata"
      (\x ->
         ParameterMetadata' <$> (x .:? "LastModifiedDate") <*> (x .:? "KeyId") <*>
         (x .:? "Name") <*>
         (x .:? "Version") <*>
         (x .:? "LastModifiedUser") <*>
         (x .:? "AllowedPattern") <*>
...
instance ToJSON ParametersFilter where
  toJSON ParametersFilter' {..} =
    object (catMaybes [Just ("Key" .= _pKey), Just ("Values" .= _pValues)])
...
pReleaseDate =
  lens _pReleaseDate (\s a -> s {_pReleaseDate = a}) . mapping _Time
...
instance FromJSON PatchBaselineIdentity where
  parseJSON =
    withObject
      "PatchBaselineIdentity"
      (\x ->
         PatchBaselineIdentity' <$> (x .:? "BaselineName") <*>
...
pcdInstalledTime =
  lens _pcdInstalledTime (\s a -> s {_pcdInstalledTime = a}) . _Time
...
instance FromJSON PatchComplianceData where
  parseJSON =
    withObject
      "PatchComplianceData"
      (\x ->
         PatchComplianceData' <$> (x .: "Title") <*> (x .: "KBId") <*>
         (x .: "Classification") <*>
         (x .: "Severity") <*>
         (x .: "State") <*>
         (x .: "InstalledTime"))
...
instance ToJSON PatchFilter where
  toJSON PatchFilter' {..} =
    object (catMaybes [Just ("Key" .= _pfKey), Just ("Values" .= _pfValues)])
...
pfgPatchFilters =
  lens _pfgPatchFilters (\s a -> s {_pfgPatchFilters = a}) . _Coerce
...
pgpbmBaselineIdentity ::
     Lens' PatchGroupPatchBaselineMapping (Maybe PatchBaselineIdentity)
pgpbmBaselineIdentity =
  lens _pgpbmBaselineIdentity (\s a -> s {_pgpbmBaselineIdentity = a})
...
instance FromJSON PatchGroupPatchBaselineMapping where
  parseJSON =
    withObject
      "PatchGroupPatchBaselineMapping"
      (\x ->
         PatchGroupPatchBaselineMapping' <$> (x .:? "BaselineIdentity") <*>
         (x .:? "PatchGroup"))
...
instance ToJSON PatchOrchestratorFilter where
  toJSON PatchOrchestratorFilter' {..} =
    object (catMaybes [("Values" .=) <$> _pofValues, ("Key" .=) <$> _pofKey])
...
prEnableNonSecurity =
  lens _prEnableNonSecurity (\s a -> s {_prEnableNonSecurity = a})
...
prPatchFilterGroup =
  lens _prPatchFilterGroup (\s a -> s {_prPatchFilterGroup = a})

-- | The number of days after the release date of each patch matched by the rule the patch is marked as approved in the patch baseline.
prApproveAfterDays :: Lens' PatchRule Natural
prApproveAfterDays =
  lens _prApproveAfterDays (\s a -> s {_prApproveAfterDays = a}) . _Nat
...
psConfiguration =
  lens _psConfiguration (\s a -> s {_psConfiguration = a}) . _Sensitive
...
psApprovalDate =
  lens _psApprovalDate (\s a -> s {_psApprovalDate = a}) . mapping _Time

-- | The approval status of a patch (APPROVED, PENDING_APPROVAL, EXPLICIT_APPROVED, EXPLICIT_REJECTED).
psDeploymentStatus :: Lens' PatchStatus (Maybe PatchDeploymentStatus)
psDeploymentStatus =
  lens _psDeploymentStatus (\s a -> s {_psDeploymentStatus = a})
...
instance FromJSON PatchStatus where
  parseJSON =
    withObject
      "PatchStatus"
      (\x ->
         PatchStatus' <$> (x .:? "ApprovalDate") <*> (x .:? "DeploymentStatus") <*>
         (x .:? "ComplianceLevel"))
...
rtParameterValues =
  lens _rtParameterValues (\s a -> s {_rtParameterValues = a}) .
  _Default . _Coerce
...
rcsiNonCompliantSummary ::
     Lens' ResourceComplianceSummaryItem (Maybe NonCompliantSummary)
rcsiNonCompliantSummary =
  lens _rcsiNonCompliantSummary (\s a -> s {_rcsiNonCompliantSummary = a})
...
rcsiCompliantSummary ::
     Lens' ResourceComplianceSummaryItem (Maybe CompliantSummary)
rcsiCompliantSummary =
  lens _rcsiCompliantSummary (\s a -> s {_rcsiCompliantSummary = a})

-- | Information about the execution.
rcsiExecutionSummary ::
     Lens' ResourceComplianceSummaryItem (Maybe ComplianceExecutionSummary)
rcsiExecutionSummary =
  lens _rcsiExecutionSummary (\s a -> s {_rcsiExecutionSummary = a})

-- | The highest severity item found for the resource. The resource is compliant for this item.
rcsiOverallSeverity ::
     Lens' ResourceComplianceSummaryItem (Maybe ComplianceSeverity)
rcsiOverallSeverity =
  lens _rcsiOverallSeverity (\s a -> s {_rcsiOverallSeverity = a})

-- | The compliance type.
rcsiComplianceType :: Lens' ResourceComplianceSummaryItem (Maybe Text)
rcsiComplianceType =
  lens _rcsiComplianceType (\s a -> s {_rcsiComplianceType = a})
...
instance FromJSON ResourceComplianceSummaryItem where
  parseJSON =
    withObject
      "ResourceComplianceSummaryItem"
      (\x ->
         ResourceComplianceSummaryItem' <$> (x .:? "NonCompliantSummary") <*>
         (x .:? "Status") <*>
         (x .:? "ResourceId") <*>
         (x .:? "ResourceType") <*>
         (x .:? "CompliantSummary") <*>
...
rdsiLastSyncStatusMessage =
  lens _rdsiLastSyncStatusMessage (\s a -> s {_rdsiLastSyncStatusMessage = a})

-- | The date and time the configuration was created (UTC).
rdsiSyncCreatedTime :: Lens' ResourceDataSyncItem (Maybe UTCTime)
rdsiSyncCreatedTime =
  lens _rdsiSyncCreatedTime (\s a -> s {_rdsiSyncCreatedTime = a}) .
  mapping _Time

-- | The last time the configuration attempted to sync (UTC).
rdsiLastSyncTime :: Lens' ResourceDataSyncItem (Maybe UTCTime)
rdsiLastSyncTime =
  lens _rdsiLastSyncTime (\s a -> s {_rdsiLastSyncTime = a}) . mapping _Time
...
rdsiS3Destination ::
     Lens' ResourceDataSyncItem (Maybe ResourceDataSyncS3Destination)
...
rdsiLastSuccessfulSyncTime =
  lens _rdsiLastSuccessfulSyncTime (\s a -> s {_rdsiLastSuccessfulSyncTime = a}) .
  mapping _Time
...
instance FromJSON ResourceDataSyncItem where
  parseJSON =
    withObject
      "ResourceDataSyncItem"
      (\x ->
         ResourceDataSyncItem' <$> (x .:? "LastSyncStatusMessage") <*>
         (x .:? "SyncCreatedTime") <*>
         (x .:? "LastSyncTime") <*>
         (x .:? "SyncName") <*>
         (x .:? "LastStatus") <*>
...
instance FromJSON ResourceDataSyncS3Destination where
  parseJSON =
    withObject
      "ResourceDataSyncS3Destination"
      (\x ->
         ResourceDataSyncS3Destination' <$> (x .:? "Prefix") <*>
         (x .:? "AWSKMSKeyARN") <*>
         (x .: "BucketName") <*>
         (x .: "SyncFormat") <*>
         (x .: "Region"))
...
solOutputS3KeyPrefix =
  lens _solOutputS3KeyPrefix (\s a -> s {_solOutputS3KeyPrefix = a})
...
solOutputS3BucketName =
  lens _solOutputS3BucketName (\s a -> s {_solOutputS3BucketName = a})
...
instance FromJSON S3OutputLocation where
  parseJSON =
    withObject
      "S3OutputLocation"
      (\x ->
         S3OutputLocation' <$> (x .:? "OutputS3KeyPrefix") <*>
         (x .:? "OutputS3Region") <*>
         (x .:? "OutputS3BucketName"))
...
instance FromJSON S3OutputURL where
  parseJSON =
    withObject "S3OutputURL" (\x -> S3OutputURL' <$> (x .:? "OutputUrl"))
...
ssUnspecifiedCount =
  lens _ssUnspecifiedCount (\s a -> s {_ssUnspecifiedCount = a})
...
ssInformationalCount =
  lens _ssInformationalCount (\s a -> s {_ssInformationalCount = a})
...
instance FromJSON SeveritySummary where
  parseJSON =
    withObject
      "SeveritySummary"
      (\x ->
         SeveritySummary' <$> (x .:? "LowCount") <*> (x .:? "UnspecifiedCount") <*>
         (x .:? "HighCount") <*>
         (x .:? "MediumCount") <*>
...
seExecutionEndTime =
  lens _seExecutionEndTime (\s a -> s {_seExecutionEndTime = a}) . mapping _Time
...
seOverriddenParameters =
  lens _seOverriddenParameters (\s a -> s {_seOverriddenParameters = a}) .
  _Default . _Map
...
seExecutionStartTime =
  lens _seExecutionStartTime (\s a -> s {_seExecutionStartTime = a}) .
  mapping _Time
...
instance FromJSON StepExecution where
  parseJSON =
    withObject
      "StepExecution"
      (\x ->
         StepExecution' <$> (x .:? "FailureDetails") <*>
         (x .:? "Inputs" .!= mempty) <*>
         (x .:? "StepName") <*>
         (x .:? "ExecutionEndTime") <*>
         (x .:? "FailureMessage") <*>
...
instance ToJSON StepExecutionFilter where
  toJSON StepExecutionFilter' {..} =
    object (catMaybes [Just ("Key" .= _sefKey), Just ("Values" .= _sefValues)])
...
instance ToJSON Target where
  toJSON Target' {..} =
    object (catMaybes [("Values" .=) <$> _tValues, ("Key" .=) <$> _tKey])
