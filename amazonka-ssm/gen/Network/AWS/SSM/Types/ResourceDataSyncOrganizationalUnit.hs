...
newtype ResourceDataSyncOrganizationalUnit = ResourceDataSyncOrganizationalUnit'{_rdsouOrganizationalUnitId
                                                                                 ::
                                                                                 Maybe
                                                                                   Text}
...
resourceDataSyncOrganizationalUnit
    :: ResourceDataSyncOrganizationalUnit
resourceDataSyncOrganizationalUnit
  = ResourceDataSyncOrganizationalUnit'{_rdsouOrganizationalUnitId
                                          = Nothing}
...
instance FromJSON ResourceDataSyncOrganizationalUnit
         where
        parseJSON
          = withObject "ResourceDataSyncOrganizationalUnit"
              (\ x ->
                 ResourceDataSyncOrganizationalUnit' <$>
...
instance ToJSON ResourceDataSyncOrganizationalUnit
         where
