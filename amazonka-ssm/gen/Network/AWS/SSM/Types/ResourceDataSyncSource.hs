...
data ResourceDataSyncSource = ResourceDataSyncSource'{_rdssIncludeFutureRegions
                                                      :: !(Maybe Bool),
...
resourceDataSyncSource pSourceType_
  = ResourceDataSyncSource'{_rdssIncludeFutureRegions =
                              Nothing,
...
instance Hashable ResourceDataSyncSource where

instance NFData ResourceDataSyncSource where
