...
data AccountSharingInfo = AccountSharingInfo'{_asiSharedDocumentVersion
                                              :: !(Maybe Text),
...
accountSharingInfo
    :: AccountSharingInfo
accountSharingInfo
  = AccountSharingInfo'{_asiSharedDocumentVersion =
                          Nothing,
...
instance FromJSON AccountSharingInfo where
        parseJSON
          = withObject "AccountSharingInfo"
              (\ x ->
                 AccountSharingInfo' <$>
                   (x .:? "SharedDocumentVersion") <*>
                     (x .:? "AccountId"))

instance Hashable AccountSharingInfo where

instance NFData AccountSharingInfo where
