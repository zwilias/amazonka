...
instance FromText AssociationFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AssociationFilterKey from value: '" <>
        e <>
...
instance FromText AssociationStatusName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AssociationStatusName from value: '" <>
        e <> "'. Accepted values: failed, pending, success"
...
instance FromText AutomationExecutionFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutomationExecutionFilterKey from value: '" <>
        e <>
...
instance FromText AutomationExecutionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutomationExecutionStatus from value: '" <>
        e <>
...
instance FromText CommandFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommandFilterKey from value: '" <>
        e <> "'. Accepted values: invokedafter, invokedbefore, status"
...
instance FromText CommandInvocationStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommandInvocationStatus from value: '" <>
        e <>
...
instance FromText CommandPluginStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommandPluginStatus from value: '" <>
        e <>
...
instance FromText CommandStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CommandStatus from value: '" <>
        e <>
...
instance FromText ComplianceQueryOperatorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ComplianceQueryOperatorType from value: '" <>
        e <>
...
instance FromText ComplianceSeverity where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ComplianceSeverity from value: '" <>
        e <>
...
instance FromText ComplianceStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ComplianceStatus from value: '" <>
        e <> "'. Accepted values: compliant, non_compliant"
...
instance FromText DescribeActivationsFilterKeys where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DescribeActivationsFilterKeys from value: '" <>
        e <> "'. Accepted values: activationids, defaultinstancename, iamrole"
...
instance FromText DocumentFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentFilterKey from value: '" <>
        e <> "'. Accepted values: documenttype, name, owner, platformtypes"
...
instance FromText DocumentFormat where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentFormat from value: '" <>
        e <> "'. Accepted values: json, yaml"
...
instance FromText DocumentHashType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentHashType from value: '" <>
        e <> "'. Accepted values: sha1, sha256"
...
instance FromText DocumentParameterType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentParameterType from value: '" <>
        e <> "'. Accepted values: string, stringlist"
...
instance FromText DocumentPermissionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentPermissionType from value: '" <>
        e <> "'. Accepted values: share"
...
instance FromText DocumentStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentStatus from value: '" <>
        e <> "'. Accepted values: active, creating, deleting, updating"
...
instance FromText DocumentType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DocumentType from value: '" <>
        e <> "'. Accepted values: automation, command, policy"
...
instance FromText ExecutionMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExecutionMode from value: '" <>
        e <> "'. Accepted values: auto, interactive"
...
instance FromText Fault where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Fault from value: '" <>
        e <> "'. Accepted values: client, server, unknown"
...
instance FromText InstanceInformationFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceInformationFilterKey from value: '" <>
        e <>
...
instance FromText InstancePatchStateOperatorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstancePatchStateOperatorType from value: '" <>
        e <> "'. Accepted values: equal, greaterthan, lessthan, notequal"
...
instance FromText InventoryAttributeDataType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InventoryAttributeDataType from value: '" <>
        e <> "'. Accepted values: number, string"
...
instance FromText InventoryDeletionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InventoryDeletionStatus from value: '" <>
        e <> "'. Accepted values: complete, inprogress"
...
instance FromText InventoryQueryOperatorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InventoryQueryOperatorType from value: '" <>
        e <>
...
instance FromText InventorySchemaDeleteOption where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InventorySchemaDeleteOption from value: '" <>
        e <> "'. Accepted values: deleteschema, disableschema"
...
instance FromText LastResourceDataSyncStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LastResourceDataSyncStatus from value: '" <>
        e <> "'. Accepted values: failed, inprogress, successful"
...
instance FromText MaintenanceWindowExecutionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MaintenanceWindowExecutionStatus from value: '" <>
        e <>
...
instance FromText MaintenanceWindowResourceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MaintenanceWindowResourceType from value: '" <>
        e <> "'. Accepted values: instance"
...
instance FromText MaintenanceWindowTaskType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MaintenanceWindowTaskType from value: '" <>
        e <>
...
instance FromText NotificationEvent where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NotificationEvent from value: '" <>
        e <>
...
instance FromText NotificationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NotificationType from value: '" <>
        e <> "'. Accepted values: command, invocation"
...
instance FromText OperatingSystem where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OperatingSystem from value: '" <>
        e <>
...
instance FromText ParameterType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ParameterType from value: '" <>
        e <> "'. Accepted values: securestring, string, stringlist"
...
instance FromText ParametersFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ParametersFilterKey from value: '" <>
        e <> "'. Accepted values: keyid, name, type"
...
instance FromText PatchComplianceDataState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PatchComplianceDataState from value: '" <>
        e <>
...
instance FromText PatchComplianceLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PatchComplianceLevel from value: '" <>
        e <>
        "'. Accepted values: critical, high, informational, low, medium, unspecified"
...
instance FromText PatchDeploymentStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PatchDeploymentStatus from value: '" <>
        e <>
...
instance FromText PatchFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PatchFilterKey from value: '" <>
        e <>
...
instance FromText PatchOperationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PatchOperationType from value: '" <>
        e <> "'. Accepted values: install, scan"
...
instance FromText PingStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PingStatus from value: '" <>
        e <> "'. Accepted values: connectionlost, inactive, online"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: linux, windows"
...
instance FromText ResourceDataSyncS3Format where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResourceDataSyncS3Format from value: '" <>
        e <> "'. Accepted values: jsonserde"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: document, ec2instance, managedinstance"
...
instance FromText ResourceTypeForTagging where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ResourceTypeForTagging from value: '" <>
        e <>
...
instance FromText SignalType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SignalType from value: '" <>
        e <> "'. Accepted values: approve, reject, resume, startstep, stopstep"
...
instance FromText StepExecutionFilterKey where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StepExecutionFilterKey from value: '" <>
        e <>
...
instance FromText StopType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StopType from value: '" <>
        e <> "'. Accepted values: cancel, complete"
