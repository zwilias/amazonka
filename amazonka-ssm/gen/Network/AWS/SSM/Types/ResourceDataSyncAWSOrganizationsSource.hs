...
data ResourceDataSyncAWSOrganizationsSource = ResourceDataSyncAWSOrganizationsSource'{_rdsaosOrganizationalUnits
                                                                                      ::
                                                                                      !(Maybe
                                                                                          (List1
...
resourceDataSyncAWSOrganizationsSource
    :: Text -- ^ 'rdsaosOrganizationSourceType'
    -> ResourceDataSyncAWSOrganizationsSource
resourceDataSyncAWSOrganizationsSource
  pOrganizationSourceType_
  = ResourceDataSyncAWSOrganizationsSource'{_rdsaosOrganizationalUnits
                                              = Nothing,
                                            _rdsaosOrganizationSourceType =
                                              pOrganizationSourceType_}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ResourceDataSyncAWSOrganizationsSource"
              (\ x ->
                 ResourceDataSyncAWSOrganizationsSource' <$>
