...
documentDescription
  = DocumentDescription'{_dStatus = Nothing,
                         ...
                         _dVersionName = Nothing, _dSchemaVersion = Nothing,
                         _dSha1 = Nothing, _dAttachmentsInformation = Nothing,
                         ...
                         _dDescription = Nothing, _dRequires = Nothing,
                         _dTags = Nothing, _dLatestVersion = Nothing}
