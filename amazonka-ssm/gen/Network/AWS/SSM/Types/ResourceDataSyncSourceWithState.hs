...
data ResourceDataSyncSourceWithState = ResourceDataSyncSourceWithState'{_rdsswsState
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
resourceDataSyncSourceWithState
    :: ResourceDataSyncSourceWithState
resourceDataSyncSourceWithState
  = ResourceDataSyncSourceWithState'{_rdsswsState =
                                       Nothing,
...
instance FromJSON ResourceDataSyncSourceWithState
         where
        parseJSON
          = withObject "ResourceDataSyncSourceWithState"
              (\ x ->
                 ResourceDataSyncSourceWithState' <$>
                   (x .:? "State") <*> (x .:? "IncludeFutureRegions")
                     <*> (x .:? "SourceType")
...
instance NFData ResourceDataSyncSourceWithState where
