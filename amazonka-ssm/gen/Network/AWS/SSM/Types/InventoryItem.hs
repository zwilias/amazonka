...
data InventoryItem = InventoryItem'{_iiContext ::
                                    !(Maybe (Map Text Text)),
...
inventoryItem
    ...
    -> Text -- ^ 'iiCaptureTime'
    -> InventoryItem
inventoryItem pTypeName_ pSchemaVersion_
  pCaptureTime_
  = InventoryItem'{_iiContext = Nothing,
                   _iiContentHash = Nothing, _iiContent = Nothing,
