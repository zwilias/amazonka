...
newtype GetServiceSetting = GetServiceSetting'{_gssSettingId
                                               :: Text}
...
data GetServiceSettingResponse = GetServiceSettingResponse'{_gssrsServiceSetting
                                                            ::
                                                            !(Maybe
                                                                ServiceSetting),
...
getServiceSettingResponse pResponseStatus_
  = GetServiceSettingResponse'{_gssrsServiceSetting =
                                 Nothing,
