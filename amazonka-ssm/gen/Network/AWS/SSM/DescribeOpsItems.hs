...
data DescribeOpsItems = DescribeOpsItems'{_doiOpsItemFilters
                                          :: !(Maybe [OpsItemFilter]),
...
describeOpsItems
    :: DescribeOpsItems
describeOpsItems
  = DescribeOpsItems'{_doiOpsItemFilters = Nothing,
                      _doiNextToken = Nothing, _doiMaxResults = Nothing}
...
instance Hashable DescribeOpsItems where

instance NFData DescribeOpsItems where
...
data DescribeOpsItemsResponse = DescribeOpsItemsResponse'{_doirsNextToken
                                                          :: !(Maybe Text),
                                                          _doirsOpsItemSummaries
                                                          ::
                                                          !(Maybe
                                                              [OpsItemSummary]),
                                                          _doirsResponseStatus
                                                          :: !Int}
...
describeOpsItemsResponse
    :: Int -- ^ 'doirsResponseStatus'
    -> DescribeOpsItemsResponse
describeOpsItemsResponse pResponseStatus_
  = DescribeOpsItemsResponse'{_doirsNextToken =
                                Nothing,
...
instance NFData DescribeOpsItemsResponse where
