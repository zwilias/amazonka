...
data GetCalendarState = GetCalendarState'{_gcsAtTime
                                          :: !(Maybe Text),
...
getCalendarState
    :: GetCalendarState
getCalendarState
  = GetCalendarState'{_gcsAtTime = Nothing,
...
instance AWSRequest GetCalendarState where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 GetCalendarStateResponse' <$>
                   (x .?> "State") <*> (x .?> "NextTransitionTime") <*>
                     (x .?> "AtTime")
                     <*> (pure (fromEnum s)))

instance Hashable GetCalendarState where

instance NFData GetCalendarState where
...
data GetCalendarStateResponse = GetCalendarStateResponse'{_getrsState
                                                          ::
                                                          !(Maybe
                                                              CalendarState),
                                                          _getrsNextTransitionTime
                                                          :: !(Maybe Text),
                                                          _getrsAtTime ::
                                                          !(Maybe Text),
...
getCalendarStateResponse pResponseStatus_
  = GetCalendarStateResponse'{_getrsState = Nothing,
...
instance NFData GetCalendarStateResponse where
