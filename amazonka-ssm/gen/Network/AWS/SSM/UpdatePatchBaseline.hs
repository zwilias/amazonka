...
upbApprovedPatchesComplianceLevel ::
     Lens' UpdatePatchBaseline (Maybe PatchComplianceLevel)
upbApprovedPatchesComplianceLevel =
  lens
    _upbApprovedPatchesComplianceLevel
    (\s a -> s {_upbApprovedPatchesComplianceLevel = a})
...
upbApprovedPatches =
  lens _upbApprovedPatches (\s a -> s {_upbApprovedPatches = a}) .
  _Default . _Coerce
...
upbApprovedPatchesEnableNonSecurity =
  lens
    ...
    (\s a -> s {_upbApprovedPatchesEnableNonSecurity = a})
...
upbRejectedPatches =
  lens _upbRejectedPatches (\s a -> s {_upbRejectedPatches = a}) .
  _Default . _Coerce
...
instance AWSRequest UpdatePatchBaseline where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdatePatchBaselineResponse' <$> (x .?> "ApprovalRules") <*>
         (x .?> "OperatingSystem") <*>
         (x .?> "GlobalFilters") <*>
...
upbrsApprovalRules =
  lens _upbrsApprovalRules (\s a -> s {_upbrsApprovalRules = a})

-- | The operating system rule used by the updated patch baseline.
upbrsOperatingSystem ::
     Lens' UpdatePatchBaselineResponse (Maybe OperatingSystem)
upbrsOperatingSystem =
  lens _upbrsOperatingSystem (\s a -> s {_upbrsOperatingSystem = a})

-- | A set of global filters used to exclude patches from the baseline.
upbrsGlobalFilters :: Lens' UpdatePatchBaselineResponse (Maybe PatchFilterGroup)
upbrsGlobalFilters =
  lens _upbrsGlobalFilters (\s a -> s {_upbrsGlobalFilters = a})

-- | The compliance severity level assigned to the patch baseline after the update completed.
upbrsApprovedPatchesComplianceLevel ::
     Lens' UpdatePatchBaselineResponse (Maybe PatchComplianceLevel)
upbrsApprovedPatchesComplianceLevel =
  lens
    _upbrsApprovedPatchesComplianceLevel
    (\s a -> s {_upbrsApprovedPatchesComplianceLevel = a})

-- | A list of explicitly approved patches for the baseline.
upbrsApprovedPatches :: Lens' UpdatePatchBaselineResponse [Text]
upbrsApprovedPatches =
  lens _upbrsApprovedPatches (\s a -> s {_upbrsApprovedPatches = a}) .
  _Default . _Coerce

-- | Indicates whether the list of approved patches includes non-security updates that should be applied to the instances. The default value is 'false'. Applies to Linux instances only.
upbrsApprovedPatchesEnableNonSecurity ::
     Lens' UpdatePatchBaselineResponse (Maybe Bool)
upbrsApprovedPatchesEnableNonSecurity =
  lens
    _upbrsApprovedPatchesEnableNonSecurity
    (\s a -> s {_upbrsApprovedPatchesEnableNonSecurity = a})

-- | A list of explicitly rejected patches for the baseline.
upbrsRejectedPatches :: Lens' UpdatePatchBaselineResponse [Text]
upbrsRejectedPatches =
  lens _upbrsRejectedPatches (\s a -> s {_upbrsRejectedPatches = a}) .
  _Default . _Coerce

-- | Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.
upbrsSources :: Lens' UpdatePatchBaselineResponse [PatchSource]
upbrsSources =
  lens _upbrsSources (\s a -> s {_upbrsSources = a}) . _Default . _Coerce

-- | The date when the patch baseline was created.
upbrsCreatedDate :: Lens' UpdatePatchBaselineResponse (Maybe UTCTime)
upbrsCreatedDate =
  lens _upbrsCreatedDate (\s a -> s {_upbrsCreatedDate = a}) . mapping _Time
...
upbrsModifiedDate =
  lens _upbrsModifiedDate (\s a -> s {_upbrsModifiedDate = a}) . mapping _Time
...
upbrsResponseStatus =
  lens _upbrsResponseStatus (\s a -> s {_upbrsResponseStatus = a})
