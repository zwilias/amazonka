...
data PutParameter = PutParameter'{_ppKeyId ::
                                  ...
                                  _ppTags :: !(Maybe [Tag]), _ppName :: !Text,
                                  _ppValue :: !Text, _ppType :: !ParameterType}
...
putParameter pName_ pValue_ pType_
  = PutParameter'{_ppKeyId = Nothing,
                  _ppTier = Nothing, _ppAllowedPattern = Nothing,
                  _ppOverwrite = Nothing, _ppDescription = Nothing,
                  _ppPolicies = Nothing, _ppTags = Nothing,
                  _ppName = pName_, _ppValue = pValue_,
                  _ppType = pType_}
...
data PutParameterResponse = PutParameterResponse'{_pprsTier
                                                  :: !(Maybe ParameterTier),
                                                  _pprsVersion ::
                                                  !(Maybe Integer),
...
putParameterResponse pResponseStatus_
  = PutParameterResponse'{_pprsTier = Nothing,
