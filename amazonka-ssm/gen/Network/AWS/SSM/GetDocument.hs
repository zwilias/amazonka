...
data GetDocument = GetDocument'{_gdVersionName ::
                                !(Maybe Text),
...
getDocument
    ...
    -> GetDocument
getDocument pName_
  = GetDocument'{_gdVersionName = Nothing,
...
data GetDocumentResponse = GetDocumentResponse'{_gdrsStatus
...
getDocumentResponse pResponseStatus_
  = GetDocumentResponse'{_gdrsStatus = Nothing,
