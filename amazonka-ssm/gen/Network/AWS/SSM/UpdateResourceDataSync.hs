...
data UpdateResourceDataSync = UpdateResourceDataSync'{_urdsSyncName
                                                      :: !Text,
                                                      _urdsSyncType :: !Text,
                                                      _urdsSyncSource ::
...
updateResourceDataSync
    :: Text -- ^ 'urdsSyncName'
    -> Text -- ^ 'urdsSyncType'
    -> ResourceDataSyncSource -- ^ 'urdsSyncSource'
    -> UpdateResourceDataSync
updateResourceDataSync pSyncName_ pSyncType_
  pSyncSource_
  = UpdateResourceDataSync'{_urdsSyncName = pSyncName_,
...
instance AWSRequest UpdateResourceDataSync where
        type Rs UpdateResourceDataSync =
             UpdateResourceDataSyncResponse
...
instance Hashable UpdateResourceDataSync where

instance NFData UpdateResourceDataSync where
...
newtype UpdateResourceDataSyncResponse = UpdateResourceDataSyncResponse'{_urdsrsResponseStatus
                                                                         :: Int}
...
updateResourceDataSyncResponse
    :: Int -- ^ 'urdsrsResponseStatus'
    -> UpdateResourceDataSyncResponse
updateResourceDataSyncResponse pResponseStatus_
  = UpdateResourceDataSyncResponse'{_urdsrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData UpdateResourceDataSyncResponse where
