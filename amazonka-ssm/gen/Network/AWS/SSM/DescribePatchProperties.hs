...
data DescribePatchProperties = DescribePatchProperties'{_dppPatchSet
                                                        :: !(Maybe PatchSet),
                                                        _dppNextToken ::
                                                        !(Maybe Text),
                                                        _dppMaxResults ::
...
describePatchProperties
    :: OperatingSystem -- ^ 'dppOperatingSystem'
    -> PatchProperty -- ^ 'dppProperty'
    -> DescribePatchProperties
describePatchProperties pOperatingSystem_ pProperty_
  = DescribePatchProperties'{_dppPatchSet = Nothing,
                             _dppNextToken = Nothing, _dppMaxResults = Nothing,
...
instance AWSRequest DescribePatchProperties where
        type Rs DescribePatchProperties =
             DescribePatchPropertiesResponse
...
instance Hashable DescribePatchProperties where

instance NFData DescribePatchProperties where
...
data DescribePatchPropertiesResponse = DescribePatchPropertiesResponse'{_dpprsNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _dpprsProperties
...
describePatchPropertiesResponse pResponseStatus_
  = DescribePatchPropertiesResponse'{_dpprsNextToken =
                                       Nothing,
...
instance NFData DescribePatchPropertiesResponse where
