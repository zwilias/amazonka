...
newtype GetConnectionStatus = GetConnectionStatus'{_gcsTarget
                                                   :: Text}
...
data GetConnectionStatusResponse = GetConnectionStatusResponse'{_gcsrsStatus
                                                                ::
                                                                !(Maybe
                                                                    ConnectionStatus),
                                                                _gcsrsTarget ::
...
getConnectionStatusResponse pResponseStatus_
  = GetConnectionStatusResponse'{_gcsrsStatus =
                                   Nothing,
