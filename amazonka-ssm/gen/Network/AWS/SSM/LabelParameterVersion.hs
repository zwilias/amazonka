...
data LabelParameterVersion = LabelParameterVersion'{_lpvParameterVersion
                                                    :: !(Maybe Integer),
                                                    _lpvName :: !Text,
...
labelParameterVersion pName_ pLabels_
  = LabelParameterVersion'{_lpvParameterVersion =
                             Nothing,
                           _lpvName = pName_, _lpvLabels = _List1 # pLabels_}
...
data LabelParameterVersionResponse = LabelParameterVersionResponse'{_lpvrsInvalidLabels
                                                                    ::
                                                                    !(Maybe
                                                                        (List1
                                                                           Text)),
...
labelParameterVersionResponse pResponseStatus_
  = LabelParameterVersionResponse'{_lpvrsInvalidLabels
                                     = Nothing,
