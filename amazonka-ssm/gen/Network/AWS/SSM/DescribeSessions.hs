...
data DescribeSessions = DescribeSessions'{_dsFilters
...
describeSessions pState_
  = DescribeSessions'{_dsFilters = Nothing,
                      _dsNextToken = Nothing, _dsMaxResults = Nothing,
                      _dsState = pState_}
...
data DescribeSessionsResponse = DescribeSessionsResponse'{_dsrsNextToken
                                                          :: !(Maybe Text),
                                                          _dsrsSessions ::
                                                          !(Maybe [Session]),
                                                          _dsrsResponseStatus ::
...
describeSessionsResponse pResponseStatus_
  = DescribeSessionsResponse'{_dsrsNextToken = Nothing,
