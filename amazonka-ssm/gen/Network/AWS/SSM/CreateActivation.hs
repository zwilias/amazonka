...
data CreateActivation = CreateActivation'{_caDefaultInstanceName
                                          :: !(Maybe Text),
...
createActivation pIAMRole_
  = CreateActivation'{_caDefaultInstanceName = Nothing,
                      _caRegistrationLimit = Nothing,
                      _caExpirationDate = Nothing,
                      _caDescription = Nothing, _caIAMRole = pIAMRole_}
...
data CreateActivationResponse = CreateActivationResponse'{_carsActivationId
                                                          :: !(Maybe Text),
                                                          _carsActivationCode ::
                                                          !(Maybe Text),
                                                          _carsResponseStatus ::
...
createActivationResponse pResponseStatus_
  = CreateActivationResponse'{_carsActivationId =
                                Nothing,
