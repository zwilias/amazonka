...
data CreateOpsItem = CreateOpsItem'{_coiPriority ::
                                    !(Maybe Nat),
                                    ...
                                    _coiSource :: !Text, _coiTitle :: !Text}
...
--
-- * 'coiSource' - The origin of the OpsItem, such as EC2 or Systems Manager.
--
...
createOpsItem pDescription_ pSource_ pTitle_
  = CreateOpsItem'{_coiPriority = Nothing,
                   _coiCategory = Nothing, _coiSeverity = Nothing,
                   _coiRelatedOpsItems = Nothing,
                   _coiOperationalData = Nothing,
                   _coiNotifications = Nothing, _coiTags = Nothing,
                   _coiDescription = pDescription_,
                   _coiSource = pSource_, _coiTitle = pTitle_}
...
instance Hashable CreateOpsItem where

instance NFData CreateOpsItem where
...
data CreateOpsItemResponse = CreateOpsItemResponse'{_coirsOpsItemId
                                                    :: !(Maybe Text),
                                                    _coirsResponseStatus ::
                                                    !Int}
...
createOpsItemResponse
    :: Int -- ^ 'coirsResponseStatus'
    -> CreateOpsItemResponse
createOpsItemResponse pResponseStatus_
  = CreateOpsItemResponse'{_coirsOpsItemId = Nothing,
...
instance NFData CreateOpsItemResponse where
