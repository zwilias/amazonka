...
gmwetiWindowExecutionId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocation Text
gmwetiWindowExecutionId =
  lens _gmwetiWindowExecutionId (\s a -> s {_gmwetiWindowExecutionId = a})
...
gmwetiInvocationId =
  lens _gmwetiInvocationId (\s a -> s {_gmwetiInvocationId = a})

instance AWSRequest GetMaintenanceWindowExecutionTaskInvocation where
  type Rs GetMaintenanceWindowExecutionTaskInvocation = GetMaintenanceWindowExecutionTaskInvocationResponse
...
instance ToHeaders GetMaintenanceWindowExecutionTaskInvocation where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation" :: ByteString)
...
gmwetirsStatus ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe MaintenanceWindowExecutionStatus)
gmwetirsStatus = lens _gmwetirsStatus (\s a -> s {_gmwetirsStatus = a})

-- | The execution ID.
gmwetirsExecutionId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsExecutionId =
  lens _gmwetirsExecutionId (\s a -> s {_gmwetirsExecutionId = a})

-- | The task execution ID.
gmwetirsTaskExecutionId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsTaskExecutionId =
  lens _gmwetirsTaskExecutionId (\s a -> s {_gmwetirsTaskExecutionId = a})

-- | The time that the task started executing on the target.
gmwetirsStartTime ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe UTCTime)
gmwetirsStartTime =
  lens _gmwetirsStartTime (\s a -> s {_gmwetirsStartTime = a}) . mapping _Time

-- | The invocation ID.
gmwetirsInvocationId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsInvocationId =
  lens _gmwetirsInvocationId (\s a -> s {_gmwetirsInvocationId = a})

-- | User-provided value to be included in any CloudWatch events raised while running tasks for these targets in this Maintenance Window.
gmwetirsOwnerInformation ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsOwnerInformation =
  lens _gmwetirsOwnerInformation (\s a -> s {_gmwetirsOwnerInformation = a}) .
  mapping _Sensitive
...
gmwetirsTaskType ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe MaintenanceWindowTaskType)
...
gmwetirsWindowTargetId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsWindowTargetId =
  lens _gmwetirsWindowTargetId (\s a -> s {_gmwetirsWindowTargetId = a})

-- | The Maintenance Window execution ID.
gmwetirsWindowExecutionId ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsWindowExecutionId =
  lens _gmwetirsWindowExecutionId (\s a -> s {_gmwetirsWindowExecutionId = a})

-- | The details explaining the status. Details are only available for certain status values.
gmwetirsStatusDetails ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsStatusDetails =
  lens _gmwetirsStatusDetails (\s a -> s {_gmwetirsStatusDetails = a})

-- | The time that the task finished executing on the target.
gmwetirsEndTime ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe UTCTime)
gmwetirsEndTime =
  lens _gmwetirsEndTime (\s a -> s {_gmwetirsEndTime = a}) . mapping _Time

-- | The parameters used at the time that the task executed.
gmwetirsParameters ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse (Maybe Text)
gmwetirsParameters =
  lens _gmwetirsParameters (\s a -> s {_gmwetirsParameters = a}) .
  mapping _Sensitive

-- | -- | The response status code.
gmwetirsResponseStatus ::
     Lens' GetMaintenanceWindowExecutionTaskInvocationResponse Int
gmwetirsResponseStatus =
  lens _gmwetirsResponseStatus (\s a -> s {_gmwetirsResponseStatus = a})
