...
data UpdateServiceSetting = UpdateServiceSetting'{_ussSettingId
                                                  :: !Text,
...
updateServiceSetting pSettingId_ pSettingValue_
  = UpdateServiceSetting'{_ussSettingId = pSettingId_,
...
newtype UpdateServiceSettingResponse = UpdateServiceSettingResponse'{_ussrsResponseStatus
                                                                     :: Int}
...
updateServiceSettingResponse pResponseStatus_
  = UpdateServiceSettingResponse'{_ussrsResponseStatus
                                    = pResponseStatus_}
