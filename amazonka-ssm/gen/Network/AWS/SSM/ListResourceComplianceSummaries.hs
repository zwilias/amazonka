...
lrcsFilters =
  lens _lrcsFilters (\s a -> s {_lrcsFilters = a}) . _Default . _Coerce
...
lrcsMaxResults =
  lens _lrcsMaxResults (\s a -> s {_lrcsMaxResults = a}) . mapping _Nat

instance AWSRequest ListResourceComplianceSummaries where
  type Rs ListResourceComplianceSummaries = ListResourceComplianceSummariesResponse
...
lrcsrsResourceComplianceSummaryItems ::
     Lens' ListResourceComplianceSummariesResponse [ResourceComplianceSummaryItem]
lrcsrsResourceComplianceSummaryItems =
  lens
    _lrcsrsResourceComplianceSummaryItems
    (\s a -> s {_lrcsrsResourceComplianceSummaryItems = a}) .
  _Default . _Coerce
...
lrcsrsResponseStatus =
  lens _lrcsrsResponseStatus (\s a -> s {_lrcsrsResponseStatus = a})
