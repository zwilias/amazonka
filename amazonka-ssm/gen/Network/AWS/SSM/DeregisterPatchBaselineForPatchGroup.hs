...
instance AWSRequest DeregisterPatchBaselineForPatchGroup where
  type Rs DeregisterPatchBaselineForPatchGroup = DeregisterPatchBaselineForPatchGroupResponse
  request = postJSON ssm
  response =
    receiveJSON
      (\s h x ->
         DeregisterPatchBaselineForPatchGroupResponse' <$> (x .?> "BaselineId") <*>
         (x .?> "PatchGroup") <*>
         (pure (fromEnum s)))
...
dpbfpgrsBaselineId ::
     Lens' DeregisterPatchBaselineForPatchGroupResponse (Maybe Text)
dpbfpgrsBaselineId =
  lens _dpbfpgrsBaselineId (\s a -> s {_dpbfpgrsBaselineId = a})

-- | The name of the patch group deregistered from the patch baseline.
dpbfpgrsPatchGroup ::
     Lens' DeregisterPatchBaselineForPatchGroupResponse (Maybe Text)
dpbfpgrsPatchGroup =
  lens _dpbfpgrsPatchGroup (\s a -> s {_dpbfpgrsPatchGroup = a})

-- | -- | The response status code.
dpbfpgrsResponseStatus :: Lens' DeregisterPatchBaselineForPatchGroupResponse Int
dpbfpgrsResponseStatus =
  lens _dpbfpgrsResponseStatus (\s a -> s {_dpbfpgrsResponseStatus = a})
