...
data DescribeMaintenanceWindowSchedule = DescribeMaintenanceWindowSchedule'{_dmwsResourceType
                                                                            ::
                                                                            !(Maybe
...
describeMaintenanceWindowSchedule
    :: DescribeMaintenanceWindowSchedule
describeMaintenanceWindowSchedule
  = DescribeMaintenanceWindowSchedule'{_dmwsResourceType
                                         = Nothing,
...
data DescribeMaintenanceWindowScheduleResponse = DescribeMaintenanceWindowScheduleResponse'{_dmwsrsScheduledWindowExecutions
                                                                                            ::
                                                                                            !(Maybe
...
describeMaintenanceWindowScheduleResponse
  pResponseStatus_
  = DescribeMaintenanceWindowScheduleResponse'{_dmwsrsScheduledWindowExecutions
                                                 = Nothing,
