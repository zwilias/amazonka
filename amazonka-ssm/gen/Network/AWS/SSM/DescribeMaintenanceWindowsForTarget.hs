...
data DescribeMaintenanceWindowsForTarget = DescribeMaintenanceWindowsForTarget'{_dmwftNextToken
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
                                                                                _dmwftMaxResults
...
describeMaintenanceWindowsForTarget pResourceType_
  = DescribeMaintenanceWindowsForTarget'{_dmwftNextToken
                                           = Nothing,
...
data DescribeMaintenanceWindowsForTargetResponse = DescribeMaintenanceWindowsForTargetResponse'{_dmwftrsWindowIdentities
                                                                                                ::
                                                                                                !(Maybe
...
describeMaintenanceWindowsForTargetResponse
  pResponseStatus_
  = DescribeMaintenanceWindowsForTargetResponse'{_dmwftrsWindowIdentities
                                                   = Nothing,
