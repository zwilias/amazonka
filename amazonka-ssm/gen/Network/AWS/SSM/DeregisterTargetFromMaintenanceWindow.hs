...
dtfmwWindowTargetId =
  lens _dtfmwWindowTargetId (\s a -> s {_dtfmwWindowTargetId = a})

instance AWSRequest DeregisterTargetFromMaintenanceWindow where
  type Rs DeregisterTargetFromMaintenanceWindow = DeregisterTargetFromMaintenanceWindowResponse
...
dtfmwrsWindowTargetId ::
     Lens' DeregisterTargetFromMaintenanceWindowResponse (Maybe Text)
dtfmwrsWindowTargetId =
  lens _dtfmwrsWindowTargetId (\s a -> s {_dtfmwrsWindowTargetId = a})
...
dtfmwrsResponseStatus =
  lens _dtfmwrsResponseStatus (\s a -> s {_dtfmwrsResponseStatus = a})
