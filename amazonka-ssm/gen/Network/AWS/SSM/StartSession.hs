...
data StartSession = StartSession'{_ssDocumentName ::
                                  !(Maybe Text),
...
startSession pTarget_
  = StartSession'{_ssDocumentName = Nothing,
                  _ssParameters = Nothing, _ssTarget = pTarget_}
...
data StartSessionResponse = StartSessionResponse'{_ssrsStreamURL
                                                  :: !(Maybe Text),
                                                  _ssrsTokenValue ::
                                                  !(Maybe Text),
                                                  _ssrsSessionId ::
...
startSessionResponse pResponseStatus_
  = StartSessionResponse'{_ssrsStreamURL = Nothing,
                          _ssrsTokenValue = Nothing, _ssrsSessionId = Nothing,
