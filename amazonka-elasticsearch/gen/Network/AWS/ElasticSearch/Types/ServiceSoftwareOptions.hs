...
data ServiceSoftwareOptions = ServiceSoftwareOptions'{_ssoAutomatedUpdateDate
                                                      :: !(Maybe POSIX),
                                                      _ssoCurrentVersion ::
                                                      !(Maybe Text),
...
serviceSoftwareOptions
    :: ServiceSoftwareOptions
serviceSoftwareOptions
  = ServiceSoftwareOptions'{_ssoAutomatedUpdateDate =
                              Nothing,
                            ...
                            _ssoDescription = Nothing, _ssoNewVersion = Nothing}
