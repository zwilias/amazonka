...
instance FromJSON AdvancedOptionsStatus where
  parseJSON =
    withObject
      "AdvancedOptionsStatus"
      (\x ->
         AdvancedOptionsStatus' <$> (x .:? "Options" .!= mempty) <*>
         (x .: "Status"))
...
instance FromJSON CognitoOptions where
  parseJSON =
    withObject
      "CognitoOptions"
      (\x ->
         CognitoOptions' <$> (x .:? "IdentityPoolId") <*> (x .:? "Enabled") <*>
         (x .:? "UserPoolId") <*>
         (x .:? "RoleArn"))
...
instance FromJSON EBSOptions where
  parseJSON =
    withObject
      "EBSOptions"
      (\x ->
         EBSOptions' <$> (x .:? "VolumeSize") <*> (x .:? "Iops") <*>
         (x .:? "VolumeType") <*>
         (x .:? "EBSEnabled"))
...
instance FromJSON ElasticsearchClusterConfig where
  parseJSON =
    withObject
      "ElasticsearchClusterConfig"
      (\x ->
         ElasticsearchClusterConfig' <$> (x .:? "DedicatedMasterCount") <*>
...
instance FromJSON ElasticsearchClusterConfigStatus where
  parseJSON =
    withObject
      "ElasticsearchClusterConfigStatus"
      (\x ->
         ElasticsearchClusterConfigStatus' <$> (x .: "Options") <*>
         (x .: "Status"))
...
edcEncryptionAtRestOptions =
  lens _edcEncryptionAtRestOptions (\s a -> s {_edcEncryptionAtRestOptions = a})
...
instance FromJSON ElasticsearchDomainConfig where
  parseJSON =
    withObject
      "ElasticsearchDomainConfig"
      (\x ->
         ElasticsearchDomainConfig' <$> (x .:? "EBSOptions") <*>
         (x .:? "AccessPolicies") <*>
...
edsEncryptionAtRestOptions =
  lens _edsEncryptionAtRestOptions (\s a -> s {_edsEncryptionAtRestOptions = a})
...
instance FromJSON ElasticsearchDomainStatus where
  parseJSON =
    withObject
      "ElasticsearchDomainStatus"
      (\x ->
         ElasticsearchDomainStatus' <$> (x .:? "EBSOptions") <*>
         (x .:? "AccessPolicies") <*>
...
instance FromJSON ElasticsearchVersionStatus where
  parseJSON =
    withObject
      "ElasticsearchVersionStatus"
      (\x ->
         ElasticsearchVersionStatus' <$> (x .: "Options") <*> (x .: "Status"))
...
instance FromJSON EncryptionAtRestOptions where
  parseJSON =
    withObject
      "EncryptionAtRestOptions"
      (\x ->
         EncryptionAtRestOptions' <$> (x .:? "Enabled") <*> (x .:? "KmsKeyId"))
...
instance FromJSON InstanceCountLimits where
  parseJSON =
    withObject
      "InstanceCountLimits"
      (\x ->
         InstanceCountLimits' <$> (x .:? "MaximumInstanceCount") <*>
...
instance FromJSON LogPublishingOptionsStatus where
  parseJSON =
    withObject
      "LogPublishingOptionsStatus"
      (\x ->
         LogPublishingOptionsStatus' <$> (x .:? "Status") <*>
         (x .:? "Options" .!= mempty))
...
reiPaymentOption ::
     Lens' ReservedElasticsearchInstance (Maybe ReservedElasticsearchInstancePaymentOption)
...
instance FromJSON ReservedElasticsearchInstance where
  parseJSON =
    withObject
      "ReservedElasticsearchInstance"
      (\x ->
         ReservedElasticsearchInstance' <$> (x .:? "State") <*>
         (x .:? "CurrencyCode") <*>
         (x .:? "StartTime") <*>
...
reioPaymentOption ::
     Lens' ReservedElasticsearchInstanceOffering (Maybe ReservedElasticsearchInstancePaymentOption)
...
instance FromJSON ReservedElasticsearchInstanceOffering where
  parseJSON =
    withObject
      "ReservedElasticsearchInstanceOffering"
      (\x ->
         ReservedElasticsearchInstanceOffering' <$> (x .:? "CurrencyCode") <*>
         (x .:? "ReservedElasticsearchInstanceOfferingId") <*>
         (x .:? "ElasticsearchInstanceType") <*>
         (x .:? "RecurringCharges" .!= mempty) <*>
         (x .:? "UsagePrice") <*>
...
instance FromJSON StorageType where
  parseJSON =
    withObject
      "StorageType"
      (\x ->
         StorageType' <$> (x .:? "StorageTypeLimits" .!= mempty) <*>
...
instance FromJSON VPCDerivedInfo where
  parseJSON =
    withObject
      "VPCDerivedInfo"
      (\x ->
         VPCDerivedInfo' <$> (x .:? "SecurityGroupIds" .!= mempty) <*>
         (x .:? "SubnetIds" .!= mempty) <*>
         (x .:? "VPCId") <*>
