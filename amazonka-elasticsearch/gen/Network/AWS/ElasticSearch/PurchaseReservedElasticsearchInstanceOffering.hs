...
preioInstanceCount ::
     Lens' PurchaseReservedElasticsearchInstanceOffering (Maybe Natural)
preioInstanceCount =
  lens _preioInstanceCount (\s a -> s {_preioInstanceCount = a}) . mapping _Nat

-- | The ID of the reserved Elasticsearch instance offering to purchase.
preioReservedElasticsearchInstanceOfferingId ::
     Lens' PurchaseReservedElasticsearchInstanceOffering Text
preioReservedElasticsearchInstanceOfferingId =
  lens
    _preioReservedElasticsearchInstanceOfferingId
    (\s a -> s {_preioReservedElasticsearchInstanceOfferingId = a})

-- | A customer-specified identifier to track this reservation.
preioReservationName :: Lens' PurchaseReservedElasticsearchInstanceOffering Text
preioReservationName =
  lens _preioReservationName (\s a -> s {_preioReservationName = a})

instance AWSRequest PurchaseReservedElasticsearchInstanceOffering where
  type Rs PurchaseReservedElasticsearchInstanceOffering = PurchaseReservedElasticsearchInstanceOfferingResponse
...
preiorsReservedElasticsearchInstanceId ::
     Lens' PurchaseReservedElasticsearchInstanceOfferingResponse (Maybe Text)
preiorsReservedElasticsearchInstanceId =
  lens
    _preiorsReservedElasticsearchInstanceId
    (\s a -> s {_preiorsReservedElasticsearchInstanceId = a})

-- | The customer-specified identifier used to track this reservation.
preiorsReservationName ::
     Lens' PurchaseReservedElasticsearchInstanceOfferingResponse (Maybe Text)
preiorsReservationName =
  lens _preiorsReservationName (\s a -> s {_preiorsReservationName = a})

-- | -- | The response status code.
preiorsResponseStatus ::
     Lens' PurchaseReservedElasticsearchInstanceOfferingResponse Int
preiorsResponseStatus =
  lens _preiorsResponseStatus (\s a -> s {_preiorsResponseStatus = a})

instance NFData PurchaseReservedElasticsearchInstanceOfferingResponse
