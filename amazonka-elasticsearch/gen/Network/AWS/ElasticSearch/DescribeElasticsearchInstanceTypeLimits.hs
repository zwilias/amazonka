...
deitlInstanceType ::
     Lens' DescribeElasticsearchInstanceTypeLimits ESPartitionInstanceType
...
deitlElasticsearchVersion =
  lens _deitlElasticsearchVersion (\s a -> s {_deitlElasticsearchVersion = a})

instance AWSRequest DescribeElasticsearchInstanceTypeLimits where
  type Rs DescribeElasticsearchInstanceTypeLimits = DescribeElasticsearchInstanceTypeLimitsResponse
...
-- | Undocumented member.
deitlrsLimitsByRole ::
     Lens' DescribeElasticsearchInstanceTypeLimitsResponse (HashMap Text Limits)
deitlrsLimitsByRole =
  lens _deitlrsLimitsByRole (\s a -> s {_deitlrsLimitsByRole = a}) .
  _Default . _Map

-- | -- | The response status code.
deitlrsResponseStatus ::
     Lens' DescribeElasticsearchInstanceTypeLimitsResponse Int
deitlrsResponseStatus =
  lens _deitlrsResponseStatus (\s a -> s {_deitlrsResponseStatus = a})
