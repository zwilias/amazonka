...
leitElasticsearchVersion =
  lens _leitElasticsearchVersion (\s a -> s {_leitElasticsearchVersion = a})
...
instance AWSRequest ListElasticsearchInstanceTypes where
  type Rs ListElasticsearchInstanceTypes = ListElasticsearchInstanceTypesResponse
...
instance ToPath ListElasticsearchInstanceTypes where
  toPath ListElasticsearchInstanceTypes' {..} =
    mconcat ["/2015-01-01/es/instanceTypes/", toBS _leitElasticsearchVersion]
...
leitrsElasticsearchInstanceTypes ::
     Lens' ListElasticsearchInstanceTypesResponse [ESPartitionInstanceType]
leitrsElasticsearchInstanceTypes =
  lens
    _leitrsElasticsearchInstanceTypes
    (\s a -> s {_leitrsElasticsearchInstanceTypes = a}) .
  _Default . _Coerce
...
leitrsResponseStatus =
  lens _leitrsResponseStatus (\s a -> s {_leitrsResponseStatus = a})
