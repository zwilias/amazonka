...
aPrefectureOrDistrict =
  lens _aPrefectureOrDistrict (\s a -> s {_aPrefectureOrDistrict = a})
...
instance FromJSON Address where
  parseJSON =
    withObject
      "Address"
      (\x ->
         Address' <$> (x .:? "IsRestricted") <*> (x .:? "Street3") <*>
         (x .:? "Landmark") <*>
         (x .:? "PostalCode") <*>
         (x .:? "Country") <*>
         (x .:? "StateOrProvince") <*>
...
cleCreationDate =
  lens _cleCreationDate (\s a -> s {_cleCreationDate = a}) . mapping _Time
...
instance FromJSON ClusterListEntry where
  parseJSON =
    withObject
      "ClusterListEntry"
      (\x ->
         ClusterListEntry' <$> (x .:? "ClusterState") <*> (x .:? "ClusterId") <*>
         (x .:? "CreationDate") <*>
         (x .:? "Description"))
...
cmForwardingAddressId =
  lens _cmForwardingAddressId (\s a -> s {_cmForwardingAddressId = a})
...
cmCreationDate =
  lens _cmCreationDate (\s a -> s {_cmCreationDate = a}) . mapping _Time
...
instance FromJSON ClusterMetadata where
  parseJSON =
    withObject
      "ClusterMetadata"
      (\x ->
         ClusterMetadata' <$> (x .:? "JobType") <*> (x .:? "KmsKeyARN") <*>
         (x .:? "ClusterState") <*>
         (x .:? "Notification") <*>
...
dtObjectsTransferred =
  lens _dtObjectsTransferred (\s a -> s {_dtObjectsTransferred = a})

-- | The number of bytes transferred between a Snowball and Amazon S3.
dtBytesTransferred :: Lens' DataTransfer (Maybe Integer)
dtBytesTransferred =
  lens _dtBytesTransferred (\s a -> s {_dtBytesTransferred = a})
...
instance FromJSON DataTransfer where
  parseJSON =
    withObject
      "DataTransfer"
      (\x ->
         DataTransfer' <$> (x .:? "TotalObjects") <*> (x .:? "TotalBytes") <*>
...
etdEventResourceARN =
  lens _etdEventResourceARN (\s a -> s {_etdEventResourceARN = a})
...
instance ToJSON EventTriggerDefinition where
  toJSON EventTriggerDefinition' {..} =
    object (catMaybes [("EventResourceARN" .=) <$> _etdEventResourceARN])
...
jleCreationDate =
  lens _jleCreationDate (\s a -> s {_jleCreationDate = a}) . mapping _Time
...
instance FromJSON JobListEntry where
  parseJSON =
    withObject
      "JobListEntry"
      (\x ->
         JobListEntry' <$> (x .:? "JobType") <*> (x .:? "JobId") <*>
         (x .:? "JobState") <*>
         (x .:? "SnowballType") <*>
         (x .:? "CreationDate") <*>
         (x .:? "Description") <*>
...
jlJobFailureLogURI =
  lens _jlJobFailureLogURI (\s a -> s {_jlJobFailureLogURI = a})

-- | A link to an Amazon S3 presigned URL where the job completion report is located.
jlJobCompletionReportURI :: Lens' JobLogs (Maybe Text)
jlJobCompletionReportURI =
  lens _jlJobCompletionReportURI (\s a -> s {_jlJobCompletionReportURI = a})

-- | A link to an Amazon S3 presigned URL where the job success log is located.
jlJobSuccessLogURI :: Lens' JobLogs (Maybe Text)
jlJobSuccessLogURI =
  lens _jlJobSuccessLogURI (\s a -> s {_jlJobSuccessLogURI = a})
...
jmForwardingAddressId =
  lens _jmForwardingAddressId (\s a -> s {_jmForwardingAddressId = a})
...
jmDataTransferProgress =
  lens _jmDataTransferProgress (\s a -> s {_jmDataTransferProgress = a})
...
jmCreationDate =
  lens _jmCreationDate (\s a -> s {_jmCreationDate = a}) . mapping _Time
...
jmSnowballCapacityPreference =
  lens
    ...
    (\s a -> s {_jmSnowballCapacityPreference = a})
...
instance FromJSON JobMetadata where
  parseJSON =
    withObject
      "JobMetadata"
      (\x ->
         JobMetadata' <$> (x .:? "JobType") <*> (x .:? "KmsKeyARN") <*>
         (x .:? "JobId") <*>
         (x .:? "JobLogInfo") <*>
         (x .:? "Notification") <*>
         (x .:? "JobState") <*>
...
jrLambdaResources =
  lens _jrLambdaResources (\s a -> s {_jrLambdaResources = a}) .
  _Default . _Coerce

-- | An array of @S3Resource@ objects.
jrS3Resources :: Lens' JobResource [S3Resource]
jrS3Resources =
  lens _jrS3Resources (\s a -> s {_jrS3Resources = a}) . _Default . _Coerce
...
instance FromJSON JobResource where
  parseJSON =
    withObject
      "JobResource"
      (\x ->
         JobResource' <$> (x .:? "LambdaResources" .!= mempty) <*>
...
instance FromJSON KeyRange where
  parseJSON =
    withObject
      "KeyRange"
      (\x -> KeyRange' <$> (x .:? "EndMarker") <*> (x .:? "BeginMarker"))
...
lrEventTriggers =
  lens _lrEventTriggers (\s a -> s {_lrEventTriggers = a}) . _Default . _Coerce
...
instance FromJSON LambdaResource where
  parseJSON =
    withObject
      "LambdaResource"
      (\x ->
         LambdaResource' <$> (x .:? "EventTriggers" .!= mempty) <*>
         (x .:? "LambdaArn"))
...
nJobStatesToNotify =
  lens _nJobStatesToNotify (\s a -> s {_nJobStatesToNotify = a}) .
  _Default . _Coerce
...
instance FromJSON Notification where
  parseJSON =
    withObject
      "Notification"
      (\x ->
         Notification' <$> (x .:? "NotifyAll") <*> (x .:? "SnsTopicARN") <*>
...
instance ToJSON S3Resource where
  toJSON S3Resource' {..} =
    object
      (catMaybes
         [("KeyRange" .=) <$> _srKeyRange, ("BucketArn" .=) <$> _srBucketARN])
...
instance FromJSON Shipment where
  parseJSON =
    withObject
      "Shipment"
      (\x -> Shipment' <$> (x .:? "Status") <*> (x .:? "TrackingNumber"))
...
sdOutboundShipment =
  lens _sdOutboundShipment (\s a -> s {_sdOutboundShipment = a})
...
instance FromJSON ShippingDetails where
  parseJSON =
    withObject
      "ShippingDetails"
      (\x ->
         ShippingDetails' <$> (x .:? "ShippingOption") <*>
         (x .:? "OutboundShipment") <*>
         (x .:? "InboundShipment"))
