...
data Summary = Summary'{_sTargetId :: !(Maybe Text),
...
summary
    :: Summary
summary
  = Summary'{_sTargetId = Nothing,
             _sLastUpdated = Nothing, _sResourceType = Nothing,
             _sNonCompliantResources = Nothing,
             _sTargetIdType = Nothing, _sRegion = Nothing}
