...
data ComplianceDetails = ComplianceDetails'{_cdKeysWithNoncompliantValues
                                            :: !(Maybe [Text]),
                                            _cdComplianceStatus ::
                                            !(Maybe Bool),
                                            _cdNoncompliantKeys ::
...
complianceDetails
    :: ComplianceDetails
complianceDetails
  = ComplianceDetails'{_cdKeysWithNoncompliantValues =
                         Nothing,
...
instance Hashable ComplianceDetails where

instance NFData ComplianceDetails where
