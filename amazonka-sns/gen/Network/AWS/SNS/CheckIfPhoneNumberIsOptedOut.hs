...
cipniooPhoneNumber =
  lens _cipniooPhoneNumber (\s a -> s {_cipniooPhoneNumber = a})
...
instance AWSRequest CheckIfPhoneNumberIsOptedOut where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CheckIfPhoneNumberIsOptedOutResponse' <$> (x .@? "isOptedOut") <*>
         (pure (fromEnum s)))
...
cipnioorsIsOptedOut =
  lens _cipnioorsIsOptedOut (\s a -> s {_cipnioorsIsOptedOut = a})

-- | -- | The response status code.
cipnioorsResponseStatus :: Lens' CheckIfPhoneNumberIsOptedOutResponse Int
cipnioorsResponseStatus =
  lens _cipnioorsResponseStatus (\s a -> s {_cipnioorsResponseStatus = a})
