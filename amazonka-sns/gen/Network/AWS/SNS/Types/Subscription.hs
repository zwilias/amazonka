...
data Subscription = Subscription'{_sProtocol ::
                                  !(Maybe Text),
                                  _sOwner :: !(Maybe Text),
...
subscription
    :: Subscription
subscription
  = Subscription'{_sProtocol = Nothing,
                  _sOwner = Nothing, _sTopicARN = Nothing,
                  _sEndpoint = Nothing, _sSubscriptionARN = Nothing}
