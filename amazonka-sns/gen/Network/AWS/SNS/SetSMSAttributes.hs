...
--
--
-- You can override some of these settings for a single message when you use the @Publish@ action with the @MessageAttributes.entry.N@ parameter. For more information, see <https://docs.aws.amazon.com/sns/latest/dg/sms_publish-to-phone.html Sending an SMS Message> in the /Amazon SNS Developer Guide/ .
--
module Network.AWS.SNS.SetSMSAttributes
    (
    -- * Creating a Request
