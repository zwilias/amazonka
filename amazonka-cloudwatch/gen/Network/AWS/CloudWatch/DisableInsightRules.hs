...
instance AWSRequest DisableInsightRules where
        type Rs DisableInsightRules =
             DisableInsightRulesResponse
        request = postQuery cloudWatch
        response
          = receiveXMLWrapper "DisableInsightRulesResult"
              (\ s h x ->
                 DisableInsightRulesResponse' <$>
                   (x .@? "Failures" .!@ mempty >>=
...
instance Hashable DisableInsightRules where

instance NFData DisableInsightRules where
...
instance NFData DisableInsightRulesResponse where
