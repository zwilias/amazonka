...
data InsightRule = InsightRule'{_irName :: !Text,
                                _irState :: !Text, _irSchema :: !Text,
                                _irDefinition :: !Text}
...
insightRule pName_ pState_ pSchema_ pDefinition_
  = InsightRule'{_irName = pName_, _irState = pState_,
                 _irSchema = pSchema_, _irDefinition = pDefinition_}
