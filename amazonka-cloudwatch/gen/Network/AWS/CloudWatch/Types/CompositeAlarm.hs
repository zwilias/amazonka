...
data CompositeAlarm = CompositeAlarm'{_caAlarmName ::
                                      !(Maybe Text),
...
compositeAlarm
    :: CompositeAlarm
compositeAlarm
  = CompositeAlarm'{_caAlarmName = Nothing,
                    _caStateUpdatedTimestamp = Nothing,
                    _caAlarmDescription = Nothing,
                    _caAlarmRule = Nothing, _caOKActions = Nothing,
                    ...
                    _caStateReasonData = Nothing, _caAlarmARN = Nothing,
