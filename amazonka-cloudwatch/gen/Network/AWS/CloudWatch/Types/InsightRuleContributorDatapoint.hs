...
data InsightRuleContributorDatapoint = InsightRuleContributorDatapoint'{_ircdTimestamp
                                                                        ::
                                                                        !ISO8601,
...
insightRuleContributorDatapoint
    ...
    -> InsightRuleContributorDatapoint
insightRuleContributorDatapoint pTimestamp_
  pApproximateValue_
  = InsightRuleContributorDatapoint'{_ircdTimestamp =
                                       _Time # pTimestamp_,
