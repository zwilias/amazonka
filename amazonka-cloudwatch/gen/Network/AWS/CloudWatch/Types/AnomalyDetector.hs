...
data AnomalyDetector = AnomalyDetector'{_adMetricName
                                        :: !(Maybe Text),
...
anomalyDetector
    :: AnomalyDetector
anomalyDetector
  = AnomalyDetector'{_adMetricName = Nothing,
                     _adNamespace = Nothing, _adStateValue = Nothing,
                     _adStat = Nothing, _adConfiguration = Nothing,
