...
instance AWSRequest EnableInsightRules where
        type Rs EnableInsightRules =
             EnableInsightRulesResponse
        request = postQuery cloudWatch
        response
          = receiveXMLWrapper "EnableInsightRulesResult"
              (\ s h x ->
                 EnableInsightRulesResponse' <$>
                   (x .@? "Failures" .!@ mempty >>=
...
instance Hashable EnableInsightRules where

instance NFData EnableInsightRules where
...
instance NFData EnableInsightRulesResponse where
