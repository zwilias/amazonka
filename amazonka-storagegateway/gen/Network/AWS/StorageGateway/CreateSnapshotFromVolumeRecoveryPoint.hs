...
csfvrpSnapshotDescription =
  lens _csfvrpSnapshotDescription (\s a -> s {_csfvrpSnapshotDescription = a})
...
instance ToHeaders CreateSnapshotFromVolumeRecoveryPoint where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint" :: ByteString)
...
-- | Undocumented member.
csfvrprsVolumeRecoveryPointTime ::
     Lens' CreateSnapshotFromVolumeRecoveryPointResponse (Maybe Text)
csfvrprsVolumeRecoveryPointTime =
  lens
...
csfvrprsResponseStatus ::
     Lens' CreateSnapshotFromVolumeRecoveryPointResponse Int
csfvrprsResponseStatus =
  lens _csfvrprsResponseStatus (\s a -> s {_csfvrprsResponseStatus = a})
