...
cscsivVolumeiSCSIAttributes ::
     Lens' CachediSCSIVolume (Maybe VolumeiSCSIAttributes)
cscsivVolumeiSCSIAttributes =
  lens
...
cscsivVolumeUsedInBytes =
  lens _cscsivVolumeUsedInBytes (\s a -> s {_cscsivVolumeUsedInBytes = a})

-- | The date the volume was created. Volumes created prior to March 28, 2017 don’t have this time stamp.
cscsivCreatedDate :: Lens' CachediSCSIVolume (Maybe UTCTime)
cscsivCreatedDate =
  lens _cscsivCreatedDate (\s a -> s {_cscsivCreatedDate = a}) . mapping _Time
...
instance FromJSON CachediSCSIVolume where
  parseJSON =
    withObject
      "CachediSCSIVolume"
      (\x ->
         CachediSCSIVolume' <$> (x .:? "VolumeiSCSIAttributes") <*>
         (x .:? "VolumeStatus") <*>
         (x .:? "SourceSnapshotId") <*>
         (x .:? "VolumeARN") <*>
         (x .:? "VolumeProgress") <*>
...
dscsiaNetworkInterfaceId =
  lens _dscsiaNetworkInterfaceId (\s a -> s {_dscsiaNetworkInterfaceId = a})

-- | The port used to communicate with iSCSI VTL device targets.
dscsiaNetworkInterfacePort :: Lens' DeviceiSCSIAttributes (Maybe Int)
dscsiaNetworkInterfacePort =
  lens _dscsiaNetworkInterfacePort (\s a -> s {_dscsiaNetworkInterfacePort = a})
...
instance FromJSON DeviceiSCSIAttributes where
  parseJSON =
    withObject
      "DeviceiSCSIAttributes"
      (\x ->
         DeviceiSCSIAttributes' <$> (x .:? "TargetARN") <*>
         (x .:? "ChapEnabled") <*>
...
fsiFileShareStatus =
  lens _fsiFileShareStatus (\s a -> s {_fsiFileShareStatus = a})
...
instance FromJSON FileShareInfo where
  parseJSON =
    withObject
      "FileShareInfo"
      (\x ->
         FileShareInfo' <$> (x .:? "FileShareStatus") <*> (x .:? "GatewayARN") <*>
         (x .:? "FileShareId") <*>
         (x .:? "FileShareARN"))
...
giGatewayOperationalState =
  lens _giGatewayOperationalState (\s a -> s {_giGatewayOperationalState = a})
...
nfsfsdOwnerId =
  lens _nfsfsdOwnerId (\s a -> s {_nfsfsdOwnerId = a}) . mapping _Nat

-- | The Unix directory mode in the form "nnnn". For example, "0666" represents the default access mode for all directories inside the file share. The default value is 0777.
nfsfsdDirectoryMode :: Lens' NFSFileShareDefaults (Maybe Text)
nfsfsdDirectoryMode =
  lens _nfsfsdDirectoryMode (\s a -> s {_nfsfsdDirectoryMode = a})

-- | The default group ID for the file share (unless the files have another group ID specified). The default value is nfsnobody.
nfsfsdGroupId :: Lens' NFSFileShareDefaults (Maybe Natural)
nfsfsdGroupId =
  lens _nfsfsdGroupId (\s a -> s {_nfsfsdGroupId = a}) . mapping _Nat
...
instance FromJSON NFSFileShareDefaults where
  parseJSON =
    withObject
      "NFSFileShareDefaults"
      (\x ->
         NFSFileShareDefaults' <$> (x .:? "FileMode") <*> (x .:? "OwnerId") <*>
         (x .:? "DirectoryMode") <*>
         (x .:? "GroupId"))
...
nfsfsiFileShareStatus =
  lens _nfsfsiFileShareStatus (\s a -> s {_nfsfsiFileShareStatus = a})
...
nfsfsiKMSEncrypted =
  lens _nfsfsiKMSEncrypted (\s a -> s {_nfsfsiKMSEncrypted = a})
...
nfsfsiFileShareARN =
  lens _nfsfsiFileShareARN (\s a -> s {_nfsfsiFileShareARN = a})
...
nfsfsiDefaultStorageClass =
  lens _nfsfsiDefaultStorageClass (\s a -> s {_nfsfsiDefaultStorageClass = a})
...
nfsfsiRequesterPays =
  lens _nfsfsiRequesterPays (\s a -> s {_nfsfsiRequesterPays = a})

-- | Undocumented member.
nfsfsiNFSFileShareDefaults ::
     Lens' NFSFileShareInfo (Maybe NFSFileShareDefaults)
nfsfsiNFSFileShareDefaults =
  lens _nfsfsiNFSFileShareDefaults (\s a -> s {_nfsfsiNFSFileShareDefaults = a})
...
nfsfsiClientList =
  lens _nfsfsiClientList (\s a -> s {_nfsfsiClientList = a}) . mapping _List1
...
nfsfsiGuessMIMETypeEnabled =
  lens _nfsfsiGuessMIMETypeEnabled (\s a -> s {_nfsfsiGuessMIMETypeEnabled = a})
...
instance FromJSON NFSFileShareInfo where
  parseJSON =
    withObject
      "NFSFileShareInfo"
      (\x ->
         NFSFileShareInfo' <$> (x .:? "FileShareStatus") <*> (x .:? "KMSKey") <*>
         (x .:? "GatewayARN") <*>
         (x .:? "Path") <*>
         (x .:? "ObjectACL") <*>
         (x .:? "KMSEncrypted") <*>
...
instance FromJSON NetworkInterface where
  parseJSON =
    withObject
      "NetworkInterface"
      (\x ->
         NetworkInterface' <$> (x .:? "Ipv6Address") <*> (x .:? "MacAddress") <*>
         (x .:? "Ipv4Address"))
...
sscsivVolumeiSCSIAttributes ::
     Lens' StorediSCSIVolume (Maybe VolumeiSCSIAttributes)
sscsivVolumeiSCSIAttributes =
  lens
...
sscsivVolumeUsedInBytes =
  lens _sscsivVolumeUsedInBytes (\s a -> s {_sscsivVolumeUsedInBytes = a})

-- | The date the volume was created. Volumes created prior to March 28, 2017 don’t have this time stamp.
sscsivCreatedDate :: Lens' StorediSCSIVolume (Maybe UTCTime)
sscsivCreatedDate =
  lens _sscsivCreatedDate (\s a -> s {_sscsivCreatedDate = a}) . mapping _Time
...
instance FromJSON StorediSCSIVolume where
  parseJSON =
    withObject
      "StorediSCSIVolume"
      (\x ->
         StorediSCSIVolume' <$> (x .:? "VolumeiSCSIAttributes") <*>
         (x .:? "VolumeStatus") <*>
         (x .:? "SourceSnapshotId") <*>
...
tTapeCreatedDate =
  lens _tTapeCreatedDate (\s a -> s {_tTapeCreatedDate = a}) . mapping _Time
...
instance FromJSON Tape where
  parseJSON =
    withObject
      "Tape"
      (\x ->
         Tape' <$> (x .:? "TapeBarcode") <*> (x .:? "TapeStatus") <*>
         (x .:? "TapeARN") <*>
         (x .:? "Progress") <*>
         (x .:? "TapeSizeInBytes") <*>
         (x .:? "VTLDevice") <*>
...
taCompletionTime =
  lens _taCompletionTime (\s a -> s {_taCompletionTime = a}) . mapping _Time
...
taTapeCreatedDate =
  lens _taTapeCreatedDate (\s a -> s {_taTapeCreatedDate = a}) . mapping _Time
...
instance FromJSON TapeArchive where
  parseJSON =
    withObject
      "TapeArchive"
      (\x ->
         TapeArchive' <$> (x .:? "TapeBarcode") <*> (x .:? "TapeStatus") <*>
         (x .:? "TapeARN") <*>
         (x .:? "TapeSizeInBytes") <*>
         (x .:? "CompletionTime") <*>
         (x .:? "TapeUsedInBytes") <*>
...
instance FromJSON TapeInfo where
  parseJSON =
    withObject
      "TapeInfo"
      (\x ->
         TapeInfo' <$> (x .:? "TapeBarcode") <*> (x .:? "TapeStatus") <*>
         (x .:? "TapeARN") <*>
         (x .:? "GatewayARN") <*>
         (x .:? "TapeSizeInBytes"))
...
trpiTapeRecoveryPointTime =
  lens _trpiTapeRecoveryPointTime (\s a -> s {_trpiTapeRecoveryPointTime = a}) .
  mapping _Time
...
instance FromJSON TapeRecoveryPointInfo where
  parseJSON =
    withObject
      "TapeRecoveryPointInfo"
      (\x ->
         TapeRecoveryPointInfo' <$> (x .:? "TapeStatus") <*>
...
vtldDeviceiSCSIAttributes =
  lens _vtldDeviceiSCSIAttributes (\s a -> s {_vtldDeviceiSCSIAttributes = a})
...
instance FromJSON VTLDevice where
  parseJSON =
    withObject
      "VTLDevice"
      (\x ->
         VTLDevice' <$> (x .:? "DeviceiSCSIAttributes") <*>
         (x .:? "VTLDeviceVendor") <*>
         (x .:? "VTLDeviceARN") <*>
         (x .:? "VTLDeviceType") <*>
...
viVolumeSizeInBytes =
  lens _viVolumeSizeInBytes (\s a -> s {_viVolumeSizeInBytes = a})
...
instance FromJSON VolumeInfo where
  parseJSON =
    withObject
      "VolumeInfo"
      (\x ->
         VolumeInfo' <$> (x .:? "GatewayARN") <*> (x .:? "VolumeARN") <*>
         (x .:? "VolumeSizeInBytes") <*>
         (x .:? "VolumeId") <*>
         (x .:? "GatewayId") <*>
         (x .:? "VolumeType"))
...
instance FromJSON VolumeRecoveryPointInfo where
  parseJSON =
    withObject
      "VolumeRecoveryPointInfo"
      (\x ->
         VolumeRecoveryPointInfo' <$> (x .:? "VolumeRecoveryPointTime") <*>
         (x .:? "VolumeARN") <*>
         (x .:? "VolumeSizeInBytes") <*>
...
vscsiaLunNumber =
  lens _vscsiaLunNumber (\s a -> s {_vscsiaLunNumber = a}) . mapping _Nat
...
vscsiaNetworkInterfaceId =
  lens _vscsiaNetworkInterfaceId (\s a -> s {_vscsiaNetworkInterfaceId = a})

-- | The port used to communicate with iSCSI targets.
vscsiaNetworkInterfacePort :: Lens' VolumeiSCSIAttributes (Maybe Int)
vscsiaNetworkInterfacePort =
  lens _vscsiaNetworkInterfacePort (\s a -> s {_vscsiaNetworkInterfacePort = a})
...
instance FromJSON VolumeiSCSIAttributes where
  parseJSON =
    withObject
      "VolumeiSCSIAttributes"
      (\x ->
         VolumeiSCSIAttributes' <$> (x .:? "LunNumber") <*> (x .:? "TargetARN") <*>
         (x .:? "ChapEnabled") <*>
         (x .:? "NetworkInterfaceId") <*>
         (x .:? "NetworkInterfacePort"))
