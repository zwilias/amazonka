...
data AutomaticTapeCreationPolicyInfo = AutomaticTapeCreationPolicyInfo'{_atcpiGatewayARN
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
automaticTapeCreationPolicyInfo
    :: AutomaticTapeCreationPolicyInfo
automaticTapeCreationPolicyInfo
  = AutomaticTapeCreationPolicyInfo'{_atcpiGatewayARN =
                                       Nothing,
...
instance FromJSON AutomaticTapeCreationPolicyInfo
         where
        parseJSON
          = withObject "AutomaticTapeCreationPolicyInfo"
              (\ x ->
                 AutomaticTapeCreationPolicyInfo' <$>
                   (x .:? "GatewayARN") <*>
...
instance NFData AutomaticTapeCreationPolicyInfo where
