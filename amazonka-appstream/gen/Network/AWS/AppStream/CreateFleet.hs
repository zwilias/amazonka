...
cfDisconnectTimeoutInSeconds =
  lens
    ...
    (\s a -> s {_cfDisconnectTimeoutInSeconds = a})

-- | The maximum time that a streaming session can run, in seconds. Specify a value between 600 and 57600.
cfMaxUserDurationInSeconds :: Lens' CreateFleet (Maybe Int)
cfMaxUserDurationInSeconds =
  lens _cfMaxUserDurationInSeconds (\s a -> s {_cfMaxUserDurationInSeconds = a})
...
cfEnableDefaultInternetAccess =
  lens
    ...
    (\s a -> s {_cfEnableDefaultInternetAccess = a})
  ...
  toJSON CreateFleet' {..} =
    object
      (catMaybes
         ...
         , ("DisconnectTimeoutInSeconds" .=) <$> _cfDisconnectTimeoutInSeconds
         ...
         , ("EnableDefaultInternetAccess" .=) <$> _cfEnableDefaultInternetAccess
