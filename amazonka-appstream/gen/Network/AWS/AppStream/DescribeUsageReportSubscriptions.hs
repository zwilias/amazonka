...
instance AWSRequest DescribeUsageReportSubscriptions
         where
...
instance ToHeaders DescribeUsageReportSubscriptions
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DescribeUsageReportSubscriptions
         where
...
instance ToPath DescribeUsageReportSubscriptions
         where
        toPath = const "/"

instance ToQuery DescribeUsageReportSubscriptions
         where
