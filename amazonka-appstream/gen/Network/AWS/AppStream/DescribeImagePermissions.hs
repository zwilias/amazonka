...
data DescribeImagePermissions = DescribeImagePermissions'{_dipsNextToken
                                                          :: !(Maybe Text),
...
describeImagePermissions pName_
  = DescribeImagePermissions'{_dipsNextToken = Nothing,
                              _dipsSharedAWSAccountIds = Nothing,
                              _dipsMaxResults = Nothing, _dipsName = pName_}
...
data DescribeImagePermissionsResponse = DescribeImagePermissionsResponse'{_dipsrsSharedImagePermissionsList
                                                                          ::
                                                                          !(Maybe
...
describeImagePermissionsResponse pResponseStatus_
  = DescribeImagePermissionsResponse'{_dipsrsSharedImagePermissionsList
                                        = Nothing,
