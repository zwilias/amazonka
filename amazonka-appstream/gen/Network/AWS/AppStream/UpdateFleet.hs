...
ufDisconnectTimeoutInSeconds =
  lens
    ...
    (\s a -> s {_ufDisconnectTimeoutInSeconds = a})

-- | The maximum time that a streaming session can run, in seconds. Specify a value between 600 and 57600.
ufMaxUserDurationInSeconds :: Lens' UpdateFleet (Maybe Int)
ufMaxUserDurationInSeconds =
  lens _ufMaxUserDurationInSeconds (\s a -> s {_ufMaxUserDurationInSeconds = a})

-- | The fleet attributes to delete.
ufAttributesToDelete :: Lens' UpdateFleet [FleetAttribute]
ufAttributesToDelete =
  lens _ufAttributesToDelete (\s a -> s {_ufAttributesToDelete = a}) .
  _Default . _Coerce
...
ufEnableDefaultInternetAccess =
  lens
    ...
    (\s a -> s {_ufEnableDefaultInternetAccess = a})
  ...
  toJSON UpdateFleet' {..} =
    object
      (catMaybes
         ...
         , ("DisconnectTimeoutInSeconds" .=) <$> _ufDisconnectTimeoutInSeconds
         ...
         , ("EnableDefaultInternetAccess" .=) <$> _ufEnableDefaultInternetAccess
