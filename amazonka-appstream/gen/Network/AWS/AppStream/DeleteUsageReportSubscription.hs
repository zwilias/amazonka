...
instance Hashable DeleteUsageReportSubscription where

instance NFData DeleteUsageReportSubscription where

instance ToHeaders DeleteUsageReportSubscription
         where
        toHeaders
          = const
              (mconcat
