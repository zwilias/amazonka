...
data Session = Session'{_sNetworkAccessConfiguration
                        ...
                        _sId :: !Text, _sUserId :: !Text,
                        _sStackName :: !Text, _sFleetName :: !Text,
...
session pId_ pUserId_ pStackName_ pFleetName_ pState_
  = Session'{_sNetworkAccessConfiguration = Nothing,
             _sMaxExpirationTime = Nothing, _sStartTime = Nothing,
             _sAuthenticationType = Nothing,
             _sConnectionState = Nothing, _sId = pId_,
             _sUserId = pUserId_, _sStackName = pStackName_,
             _sFleetName = pFleetName_, _sState = pState_}
