...
data UserStackAssociation = UserStackAssociation'{_usaSendEmailNotification
                                                  :: !(Maybe Bool),
                                                  _usaStackName :: !Text,
                                                  _usaUserName ::
                                                  !(Sensitive Text),
...
userStackAssociation
    ...
    -> UserStackAssociation
userStackAssociation pStackName_ pUserName_
  pAuthenticationType_
  = UserStackAssociation'{_usaSendEmailNotification =
                            Nothing,
