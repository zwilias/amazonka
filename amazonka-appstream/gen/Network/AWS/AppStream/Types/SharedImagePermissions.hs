...
data SharedImagePermissions = SharedImagePermissions'{_sipSharedAccountId
                                                      :: !Text,
...
sharedImagePermissions
    ...
    -> SharedImagePermissions
sharedImagePermissions pSharedAccountId_
  pImagePermissions_
  = SharedImagePermissions'{_sipSharedAccountId =
                              pSharedAccountId_,
