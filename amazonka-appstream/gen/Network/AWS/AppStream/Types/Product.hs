...
instance FromJSON Application where
  parseJSON =
    withObject
      "Application"
      (\x ->
         Application' <$> (x .:? "Enabled") <*> (x .:? "LaunchPath") <*>
         (x .:? "LaunchParameters") <*>
         (x .:? "Name") <*>
         (x .:? "DisplayName") <*>
         (x .:? "Metadata" .!= mempty) <*>
...
ccDesiredInstances =
  lens _ccDesiredInstances (\s a -> s {_ccDesiredInstances = a})
...
instance ToJSON ComputeCapacity where
  toJSON ComputeCapacity' {..} =
    object (catMaybes [Just ("DesiredInstances" .= _ccDesiredInstances)])
...
instance FromJSON ComputeCapacityStatus where
  parseJSON =
    withObject
      "ComputeCapacityStatus"
      (\x ->
         ComputeCapacityStatus' <$> (x .:? "InUse") <*> (x .:? "Running") <*>
         (x .:? "Available") <*>
         (x .: "Desired"))
...
dcCreatedTime =
  lens _dcCreatedTime (\s a -> s {_dcCreatedTime = a}) . mapping _Time

-- | The credentials for the service account used by the streaming instance to connect to the directory.
dcServiceAccountCredentials ::
     Lens' DirectoryConfig (Maybe ServiceAccountCredentials)
dcServiceAccountCredentials =
  lens
    _dcServiceAccountCredentials
    (\s a -> s {_dcServiceAccountCredentials = a})
...
dcOrganizationalUnitDistinguishedNames =
  lens
    ...
    (\s a -> s {_dcOrganizationalUnitDistinguishedNames = a}) .
  _Default . _Coerce
...
djiOrganizationalUnitDistinguishedName =
  lens
    ...
    (\s a -> s {_djiOrganizationalUnitDistinguishedName = a})
...
instance FromJSON DomainJoinInfo where
  parseJSON =
    withObject
      "DomainJoinInfo"
      (\x ->
         DomainJoinInfo' <$> (x .:? "OrganizationalUnitDistinguishedName") <*>
         (x .:? "DirectoryName"))
...
fDisconnectTimeoutInSeconds =
  lens
    _fDisconnectTimeoutInSeconds
    (\s a -> s {_fDisconnectTimeoutInSeconds = a})

-- | The maximum time that a streaming session can run, in seconds. Specify a value between 600 and 57600.
fMaxUserDurationInSeconds :: Lens' Fleet (Maybe Int)
fMaxUserDurationInSeconds =
  lens _fMaxUserDurationInSeconds (\s a -> s {_fMaxUserDurationInSeconds = a})

-- | The time the fleet was created.
fCreatedTime :: Lens' Fleet (Maybe UTCTime)
fCreatedTime =
  lens _fCreatedTime (\s a -> s {_fCreatedTime = a}) . mapping _Time
...
fFleetErrors =
  lens _fFleetErrors (\s a -> s {_fFleetErrors = a}) . _Default . _Coerce
...
fEnableDefaultInternetAccess =
  lens
    _fEnableDefaultInternetAccess
    (\s a -> s {_fEnableDefaultInternetAccess = a})
...
fComputeCapacityStatus =
  lens _fComputeCapacityStatus (\s a -> s {_fComputeCapacityStatus = a})
...
instance FromJSON FleetError where
  parseJSON =
    withObject
      "FleetError"
      (\x -> FleetError' <$> (x .:? "ErrorCode") <*> (x .:? "ErrorMessage"))
...
iPublicBaseImageReleasedDate =
  lens
    _iPublicBaseImageReleasedDate
    (\s a -> s {_iPublicBaseImageReleasedDate = a}) .
  mapping _Time

-- | The reason why the last state change occurred.
iStateChangeReason :: Lens' Image (Maybe ImageStateChangeReason)
iStateChangeReason =
  lens _iStateChangeReason (\s a -> s {_iStateChangeReason = a})
...
iCreatedTime =
  lens _iCreatedTime (\s a -> s {_iCreatedTime = a}) . mapping _Time

-- | Indicates whether an image builder can be launched from this image.
iImageBuilderSupported :: Lens' Image (Maybe Bool)
iImageBuilderSupported =
  lens _iImageBuilderSupported (\s a -> s {_iImageBuilderSupported = a})
...
iAppstreamAgentVersion =
  lens _iAppstreamAgentVersion (\s a -> s {_iAppstreamAgentVersion = a})

-- | The applications associated with the image.
iApplications :: Lens' Image [Application]
iApplications =
  lens _iApplications (\s a -> s {_iApplications = a}) . _Default . _Coerce
...
ibStateChangeReason =
  lens _ibStateChangeReason (\s a -> s {_ibStateChangeReason = a})
...
ibCreatedTime =
  lens _ibCreatedTime (\s a -> s {_ibCreatedTime = a}) . mapping _Time

-- | The image builder errors.
ibImageBuilderErrors :: Lens' ImageBuilder [ResourceError]
ibImageBuilderErrors =
  lens _ibImageBuilderErrors (\s a -> s {_ibImageBuilderErrors = a}) .
  _Default . _Coerce
...
ibEnableDefaultInternetAccess =
  lens
    ...
    (\s a -> s {_ibEnableDefaultInternetAccess = a})
...
ibAppstreamAgentVersion =
  lens _ibAppstreamAgentVersion (\s a -> s {_ibAppstreamAgentVersion = a})
...
instance FromJSON ImageBuilder where
  parseJSON =
    withObject
      "ImageBuilder"
      (\x ->
         ImageBuilder' <$> (x .:? "DomainJoinInfo") <*> (x .:? "State") <*>
         (x .:? "Platform") <*>
         (x .:? "StateChangeReason") <*>
         (x .:? "Arn") <*>
         (x .:? "CreatedTime") <*>
...
ibscrCode ::
     Lens' ImageBuilderStateChangeReason (Maybe ImageBuilderStateChangeReasonCode)
...
instance FromJSON ImageBuilderStateChangeReason where
  parseJSON =
    withObject
      "ImageBuilderStateChangeReason"
      (\x ->
         ImageBuilderStateChangeReason' <$> (x .:? "Code") <*> (x .:? "Message"))
...
instance FromJSON ImageStateChangeReason where
  parseJSON =
    withObject
      "ImageStateChangeReason"
      (\x -> ImageStateChangeReason' <$> (x .:? "Code") <*> (x .:? "Message"))
...
reErrorTimestamp =
  lens _reErrorTimestamp (\s a -> s {_reErrorTimestamp = a}) . mapping _Time
...
instance FromJSON ResourceError where
  parseJSON =
    withObject
      "ResourceError"
      (\x ->
         ResourceError' <$> (x .:? "ErrorCode") <*> (x .:? "ErrorMessage") <*>
         (x .:? "ErrorTimestamp"))
...
sacAccountName =
  lens _sacAccountName (\s a -> s {_sacAccountName = a}) . _Sensitive

-- | The password for the account.
sacAccountPassword :: Lens' ServiceAccountCredentials Text
sacAccountPassword =
  lens _sacAccountPassword (\s a -> s {_sacAccountPassword = a}) . _Sensitive
...
instance FromJSON ServiceAccountCredentials where
  parseJSON =
    withObject
      "ServiceAccountCredentials"
      (\x ->
         ServiceAccountCredentials' <$> (x .: "AccountName") <*>
         (x .: "AccountPassword"))
...
sAuthenticationType =
  lens _sAuthenticationType (\s a -> s {_sAuthenticationType = a})
...
instance FromJSON Session where
  parseJSON =
    withObject
      "Session"
      (\x ->
         Session' <$> (x .:? "AuthenticationType") <*> (x .: "Id") <*>
         (x .: "UserId") <*>
         (x .: "StackName") <*>
         (x .: "FleetName") <*>
         (x .: "State"))
...
sCreatedTime =
  lens _sCreatedTime (\s a -> s {_sCreatedTime = a}) . mapping _Time

-- | The storage connectors to enable.
sStorageConnectors :: Lens' Stack [StorageConnector]
sStorageConnectors =
  lens _sStorageConnectors (\s a -> s {_sStorageConnectors = a}) .
  _Default . _Coerce
...
sStackErrors =
  lens _sStackErrors (\s a -> s {_sStackErrors = a}) . _Default . _Coerce
...
instance FromJSON StackError where
  parseJSON =
    withObject
      "StackError"
      (\x -> StackError' <$> (x .:? "ErrorCode") <*> (x .:? "ErrorMessage"))
...
scResourceIdentifier =
  lens _scResourceIdentifier (\s a -> s {_scResourceIdentifier = a})
...
instance FromJSON StorageConnector where
  parseJSON =
    withObject
      "StorageConnector"
      (\x ->
         StorageConnector' <$> (x .:? "ResourceIdentifier") <*>
         (x .: "ConnectorType"))
...
vcSecurityGroupIds =
  lens _vcSecurityGroupIds (\s a -> s {_vcSecurityGroupIds = a}) .
  _Default . _Coerce

-- | The subnets to which a network interface is established from the fleet instance.
vcSubnetIds :: Lens' VPCConfig [Text]
vcSubnetIds =
  lens _vcSubnetIds (\s a -> s {_vcSubnetIds = a}) . _Default . _Coerce
...
instance FromJSON VPCConfig where
  parseJSON =
    withObject
      "VPCConfig"
      (\x ->
         VPCConfig' <$> (x .:? "SecurityGroupIds" .!= mempty) <*>
         (x .:? "SubnetIds" .!= mempty))
