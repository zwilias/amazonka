...
data Application = Application'{_appEnabled ::
                                !(Maybe Bool),
...
application
    :: Application
application
  = Application'{_appEnabled = Nothing,
                 _appLaunchPath = Nothing,
                 _appLaunchParameters = Nothing, _appName = Nothing,
                 _appDisplayName = Nothing, _appMetadata = Nothing,
                 _appIconURL = Nothing}
