...
data Stack = Stack'{_sUserSettings ::
                    ...
                    _sRedirectURL :: !(Maybe Text), _sName :: !Text}
...
stack
    ...
    -> Stack
stack pName_
  = Stack'{_sUserSettings = Nothing,
           _sApplicationSettings = Nothing,
           _sFeedbackURL = Nothing, _sARN = Nothing,
           _sCreatedTime = Nothing,
           _sStorageConnectors = Nothing,
           _sAccessEndpoints = Nothing, _sDisplayName = Nothing,
           _sStackErrors = Nothing,
           _sEmbedHostDomains = Nothing,
           _sDescription = Nothing, _sRedirectURL = Nothing,
           _sName = pName_}
