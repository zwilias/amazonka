...
data ListTrials = ListTrials'{_ltsCreatedAfter ::
                              !(Maybe POSIX),
...
listTrials
    :: ListTrials
listTrials
  = ListTrials'{_ltsCreatedAfter = Nothing,
                _ltsExperimentName = Nothing,
                _ltsNextToken = Nothing, _ltsSortOrder = Nothing,
                _ltsTrialComponentName = Nothing,
                _ltsMaxResults = Nothing,
                _ltsCreatedBefore = Nothing, _ltsSortBy = Nothing}
...
instance AWSPager ListTrials where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ltsNextToken .~ rs ^. ltsrsNextToken
...
instance Hashable ListTrials where

instance NFData ListTrials where
...
data ListTrialsResponse = ListTrialsResponse'{_ltsrsNextToken
                                              :: !(Maybe Text),
                                              _ltsrsTrialSummaries ::
                                              !(Maybe [TrialSummary]),
...
listTrialsResponse
    :: Int -- ^ 'ltsrsResponseStatus'
    -> ListTrialsResponse
listTrialsResponse pResponseStatus_
  = ListTrialsResponse'{_ltsrsNextToken = Nothing,
...
instance NFData ListTrialsResponse where
