...
data DeleteApp = DeleteApp'{_dDomainId :: !Text,
                            _dUserProfileName :: !Text, _dAppType :: !AppType,
                            _dAppName :: !Text}
...
deleteApp
    :: Text -- ^ 'dDomainId'
    -> Text -- ^ 'dUserProfileName'
    -> AppType -- ^ 'dAppType'
    -> Text -- ^ 'dAppName'
    -> DeleteApp
deleteApp pDomainId_ pUserProfileName_ pAppType_
  pAppName_
  = DeleteApp'{_dDomainId = pDomainId_,
               _dUserProfileName = pUserProfileName_,
               _dAppType = pAppType_, _dAppName = pAppName_}
