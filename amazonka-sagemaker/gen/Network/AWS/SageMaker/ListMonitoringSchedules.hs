...
data ListMonitoringSchedules = ListMonitoringSchedules'{_lmsNameContains
                                                        :: !(Maybe Text),
                                                        _lmsEndpointName ::
                                                        !(Maybe Text),
...
instance AWSPager ListMonitoringSchedules where
        page rq rs
          ...
          | stop (rs ^. lmsrsMonitoringScheduleSummaries) =
            Nothing
          | otherwise =
            Just $ rq & lmsNextToken .~ rs ^. lmsrsNextToken

instance AWSRequest ListMonitoringSchedules where
        type Rs ListMonitoringSchedules =
             ListMonitoringSchedulesResponse
...
instance Hashable ListMonitoringSchedules where

instance NFData ListMonitoringSchedules where
...
data ListMonitoringSchedulesResponse = ListMonitoringSchedulesResponse'{_lmsrsNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
listMonitoringSchedulesResponse
    :: Int -- ^ 'lmsrsResponseStatus'
    -> ListMonitoringSchedulesResponse
listMonitoringSchedulesResponse pResponseStatus_
  = ListMonitoringSchedulesResponse'{_lmsrsNextToken =
                                       Nothing,
...
instance NFData ListMonitoringSchedulesResponse where
