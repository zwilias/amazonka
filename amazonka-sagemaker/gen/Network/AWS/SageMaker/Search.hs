...
data Search = Search'{_sNextToken :: !(Maybe Text),
...
search
    ...
    -> Search
search pResource_
  = Search'{_sNextToken = Nothing,
            _sSearchExpression = Nothing, _sSortOrder = Nothing,
            _sMaxResults = Nothing, _sSortBy = Nothing,
...
data SearchResponse = SearchResponse'{_srsResults ::
                                      !(Maybe [SearchRecord]),
...
searchResponse pResponseStatus_
  = SearchResponse'{_srsResults = Nothing,
