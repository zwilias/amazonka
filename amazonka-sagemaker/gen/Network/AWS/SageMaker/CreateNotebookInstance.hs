...
data CreateNotebookInstance = CreateNotebookInstance'{_cniAcceleratorTypes
                                                      ::
                                                      !(Maybe
...
createNotebookInstance
    ...
    -> Text -- ^ 'cniRoleARN'
    -> CreateNotebookInstance
createNotebookInstance pNotebookInstanceName_
  pInstanceType_ pRoleARN_
  = CreateNotebookInstance'{_cniAcceleratorTypes =
                              Nothing,
                            ...
                            _cniKMSKeyId = Nothing, _cniRootAccess = Nothing,
...
data CreateNotebookInstanceResponse = CreateNotebookInstanceResponse'{_cnirsNotebookInstanceARN
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
createNotebookInstanceResponse pResponseStatus_
  = CreateNotebookInstanceResponse'{_cnirsNotebookInstanceARN
                                      = Nothing,
