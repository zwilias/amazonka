...
data ListHumanTaskUis = ListHumanTaskUis'{_lhtuCreationTimeAfter
                                          :: !(Maybe POSIX),
...
listHumanTaskUis
    :: ListHumanTaskUis
listHumanTaskUis
  = ListHumanTaskUis'{_lhtuCreationTimeAfter = Nothing,
                      _lhtuNextToken = Nothing, _lhtuSortOrder = Nothing,
...
instance AWSPager ListHumanTaskUis where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lhtuNextToken .~ rs ^. lhtursNextToken
...
instance Hashable ListHumanTaskUis where

instance NFData ListHumanTaskUis where
...
data ListHumanTaskUisResponse = ListHumanTaskUisResponse'{_lhtursNextToken
                                                          :: !(Maybe Text),
                                                          _lhtursResponseStatus
                                                          :: !Int,
...
listHumanTaskUisResponse
    :: Int -- ^ 'lhtursResponseStatus'
    -> ListHumanTaskUisResponse
listHumanTaskUisResponse pResponseStatus_
  = ListHumanTaskUisResponse'{_lhtursNextToken =
                                Nothing,
...
instance NFData ListHumanTaskUisResponse where
