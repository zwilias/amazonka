...
newtype DescribeAutoMLJob = DescribeAutoMLJob'{_damljAutoMLJobName
                                               :: Text}
...
describeAutoMLJob
    :: Text -- ^ 'damljAutoMLJobName'
    -> DescribeAutoMLJob
describeAutoMLJob pAutoMLJobName_
  = DescribeAutoMLJob'{_damljAutoMLJobName =
                         pAutoMLJobName_}
...
instance Hashable DescribeAutoMLJob where

instance NFData DescribeAutoMLJob where
...
data DescribeAutoMLJobResponse = DescribeAutoMLJobResponse'{_damljrsGenerateCandidateDefinitionsOnly
                                                            :: !(Maybe Bool),
                                                            _damljrsFailureReason
                                                            :: !(Maybe Text),
                                                            _damljrsProblemType
                                                            ::
                                                            !(Maybe
                                                            ...
                                                            !(Maybe
                                                                AutoMLCandidate),
                                                            _damljrsResponseStatus
                                                            :: !Int,
                                                            _damljrsAutoMLJobName
                                                            :: !Text,
                                                            _damljrsAutoMLJobARN
                                                            :: !Text,
                                                            ...
                                                            _damljrsRoleARN ::
                                                            !Text,
                                                            _damljrsCreationTime
                                                            :: !POSIX,
                                                            _damljrsLastModifiedTime
                                                            :: !POSIX,
...
describeAutoMLJobResponse
    :: Int -- ^ 'damljrsResponseStatus'
    -> Text -- ^ 'damljrsAutoMLJobName'
    -> Text -- ^ 'damljrsAutoMLJobARN'
    -> NonEmpty AutoMLChannel -- ^ 'damljrsInputDataConfig'
    -> AutoMLOutputDataConfig -- ^ 'damljrsOutputDataConfig'
    -> Text -- ^ 'damljrsRoleARN'
    -> UTCTime -- ^ 'damljrsCreationTime'
    -> UTCTime -- ^ 'damljrsLastModifiedTime'
    -> AutoMLJobStatus -- ^ 'damljrsAutoMLJobStatus'
    -> AutoMLJobSecondaryStatus -- ^ 'damljrsAutoMLJobSecondaryStatus'
    -> DescribeAutoMLJobResponse
describeAutoMLJobResponse pResponseStatus_
  pAutoMLJobName_ pAutoMLJobARN_ pInputDataConfig_
  pOutputDataConfig_ pRoleARN_ pCreationTime_
  pLastModifiedTime_ pAutoMLJobStatus_
  pAutoMLJobSecondaryStatus_
  = DescribeAutoMLJobResponse'{_damljrsGenerateCandidateDefinitionsOnly
                                 = Nothing,
...
instance NFData DescribeAutoMLJobResponse where
