...
data CreateExperiment = CreateExperiment'{_cDisplayName
                                          :: !(Maybe Text),
...
createExperiment
    :: Text -- ^ 'cExperimentName'
    -> CreateExperiment
createExperiment pExperimentName_
  = CreateExperiment'{_cDisplayName = Nothing,
...
instance Hashable CreateExperiment where

instance NFData CreateExperiment where
...
data CreateExperimentResponse = CreateExperimentResponse'{_crsExperimentARN
                                                          :: !(Maybe Text),
                                                          _crsResponseStatus ::
                                                          !Int}
...
createExperimentResponse pResponseStatus_
  = CreateExperimentResponse'{_crsExperimentARN =
                                Nothing,
...
instance NFData CreateExperimentResponse where
