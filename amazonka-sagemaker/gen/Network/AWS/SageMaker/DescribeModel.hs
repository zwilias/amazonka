...
instance AWSRequest DescribeModel where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeModelResponse' <$> (x .?> "VpcConfig") <*> (pure (fromEnum s)) <*>
         (x .:> "ModelName") <*>
         (x .:> "PrimaryContainer") <*>
         (x .:> "ExecutionRoleArn") <*>
         (x .:> "CreationTime") <*>
...
dmrsPrimaryContainer =
  lens _dmrsPrimaryContainer (\s a -> s {_dmrsPrimaryContainer = a})

-- | The Amazon Resource Name (ARN) of the IAM role that you specified for the model.
dmrsExecutionRoleARN :: Lens' DescribeModelResponse Text
dmrsExecutionRoleARN =
  lens _dmrsExecutionRoleARN (\s a -> s {_dmrsExecutionRoleARN = a})

-- | A timestamp that shows when the model was created.
dmrsCreationTime :: Lens' DescribeModelResponse UTCTime
dmrsCreationTime =
  lens _dmrsCreationTime (\s a -> s {_dmrsCreationTime = a}) . _Time
