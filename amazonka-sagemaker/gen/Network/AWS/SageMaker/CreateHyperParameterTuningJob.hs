...
data CreateHyperParameterTuningJob = CreateHyperParameterTuningJob'{_chptjTrainingJobDefinition
                                                                    ::
                                                                    !(Maybe
...
createHyperParameterTuningJob
  ...
  = CreateHyperParameterTuningJob'{_chptjTrainingJobDefinition
                                     = Nothing,
...
data CreateHyperParameterTuningJobResponse = CreateHyperParameterTuningJobResponse'{_chptjrsResponseStatus
                                                                                    ::
                                                                                    !Int,
...
createHyperParameterTuningJobResponse
    ...
    -> CreateHyperParameterTuningJobResponse
createHyperParameterTuningJobResponse
  pResponseStatus_ pHyperParameterTuningJobARN_
  = CreateHyperParameterTuningJobResponse'{_chptjrsResponseStatus
                                             = pResponseStatus_,
                                           _chptjrsHyperParameterTuningJobARN =
