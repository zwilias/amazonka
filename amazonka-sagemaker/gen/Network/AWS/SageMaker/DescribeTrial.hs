...
newtype DescribeTrial = DescribeTrial'{_dtTrialName
                                       :: Text}
...
instance Hashable DescribeTrial where

instance NFData DescribeTrial where
...
data DescribeTrialResponse = DescribeTrialResponse'{_dtrsCreationTime
                                                    :: !(Maybe POSIX),
                                                    _dtrsTrialARN ::
                                                    !(Maybe Text),
                                                    _dtrsCreatedBy ::
                                                    !(Maybe UserContext),
                                                    _dtrsLastModifiedTime ::
                                                    !(Maybe POSIX),
                                                    _dtrsExperimentName ::
                                                    !(Maybe Text),
                                                    _dtrsSource ::
...
describeTrialResponse pResponseStatus_
  = DescribeTrialResponse'{_dtrsCreationTime = Nothing,
                           _dtrsTrialARN = Nothing, _dtrsCreatedBy = Nothing,
                           _dtrsLastModifiedTime = Nothing,
                           _dtrsExperimentName = Nothing, _dtrsSource = Nothing,
                           _dtrsDisplayName = Nothing, _dtrsTrialName = Nothing,
...
instance NFData DescribeTrialResponse where
