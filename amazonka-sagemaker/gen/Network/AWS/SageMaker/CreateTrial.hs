...
data CreateTrial = CreateTrial'{_ctDisplayName ::
                                !(Maybe Text),
                                _ctTags :: !(Maybe [Tag]),
                                _ctTrialName :: !Text,
...
createTrial
    :: Text -- ^ 'ctTrialName'
    -> Text -- ^ 'ctExperimentName'
    -> CreateTrial
createTrial pTrialName_ pExperimentName_
  = CreateTrial'{_ctDisplayName = Nothing,
                 _ctTags = Nothing, _ctTrialName = pTrialName_,
...
instance Hashable CreateTrial where

instance NFData CreateTrial where
...
data CreateTrialResponse = CreateTrialResponse'{_ctrsTrialARN
                                                :: !(Maybe Text),
...
createTrialResponse pResponseStatus_
  = CreateTrialResponse'{_ctrsTrialARN = Nothing,
...
instance NFData CreateTrialResponse where
