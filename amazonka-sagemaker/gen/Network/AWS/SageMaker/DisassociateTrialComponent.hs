...
data DisassociateTrialComponent = DisassociateTrialComponent'{_dtcTrialComponentName
                                                              :: !Text,
                                                              _dtcTrialName ::
                                                              !Text}
...
disassociateTrialComponent
    :: Text -- ^ 'dtcTrialComponentName'
    -> Text -- ^ 'dtcTrialName'
    -> DisassociateTrialComponent
disassociateTrialComponent pTrialComponentName_
  pTrialName_
  = DisassociateTrialComponent'{_dtcTrialComponentName
...
instance Hashable DisassociateTrialComponent where

instance NFData DisassociateTrialComponent where
...
data DisassociateTrialComponentResponse = DisassociateTrialComponentResponse'{_dtcrsTrialARN
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
disassociateTrialComponentResponse pResponseStatus_
  = DisassociateTrialComponentResponse'{_dtcrsTrialARN
                                          = Nothing,
