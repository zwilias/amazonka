...
data ListDomains = ListDomains'{_ldNextToken ::
                                !(Maybe Text),
...
listDomains
    :: ListDomains
listDomains
  = ListDomains'{_ldNextToken = Nothing,
...
data ListDomainsResponse = ListDomainsResponse'{_ldrsNextToken
                                                :: !(Maybe Text),
                                                _ldrsDomains ::
                                                !(Maybe [DomainDetails]),
...
listDomainsResponse pResponseStatus_
  = ListDomainsResponse'{_ldrsNextToken = Nothing,
