...
newtype StopProcessingJob = StopProcessingJob'{_spjProcessingJobName
                                               :: Text}
...
stopProcessingJob
    :: Text -- ^ 'spjProcessingJobName'
    -> StopProcessingJob
stopProcessingJob pProcessingJobName_
  = StopProcessingJob'{_spjProcessingJobName =
                         pProcessingJobName_}
...
instance Hashable StopProcessingJob where

instance NFData StopProcessingJob where
...
instance NFData StopProcessingJobResponse where
