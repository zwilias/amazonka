...
newtype DeleteWorkteam = DeleteWorkteam'{_dwWorkteamName
                                         :: Text}
...
data DeleteWorkteamResponse = DeleteWorkteamResponse'{_delrsResponseStatus
                                                      :: !Int,
                                                      _delrsSuccess :: !Bool}
...
deleteWorkteamResponse pResponseStatus_ pSuccess_
  = DeleteWorkteamResponse'{_delrsResponseStatus =
                              pResponseStatus_,
