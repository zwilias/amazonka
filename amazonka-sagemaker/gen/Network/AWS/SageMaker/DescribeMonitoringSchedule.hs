...
newtype DescribeMonitoringSchedule = DescribeMonitoringSchedule'{_dmsMonitoringScheduleName
                                                                 :: Text}
...
describeMonitoringSchedule
    :: Text -- ^ 'dmsMonitoringScheduleName'
    -> DescribeMonitoringSchedule
describeMonitoringSchedule pMonitoringScheduleName_
  = DescribeMonitoringSchedule'{_dmsMonitoringScheduleName
...
instance AWSRequest DescribeMonitoringSchedule where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeMonitoringScheduleResponse' <$>
                   (x .?> "FailureReason") <*> (x .?> "EndpointName")
...
instance Hashable DescribeMonitoringSchedule where

instance NFData DescribeMonitoringSchedule where
...
data DescribeMonitoringScheduleResponse = DescribeMonitoringScheduleResponse'{_dmsrsFailureReason
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _dmsrsEndpointName
...
describeMonitoringScheduleResponse
    ...
    -> Text -- ^ 'dmsrsMonitoringScheduleARN'
    -> Text -- ^ 'dmsrsMonitoringScheduleName'
    -> ScheduleStatus -- ^ 'dmsrsMonitoringScheduleStatus'
    -> UTCTime -- ^ 'dmsrsCreationTime'
    -> UTCTime -- ^ 'dmsrsLastModifiedTime'
    -> MonitoringScheduleConfig -- ^ 'dmsrsMonitoringScheduleConfig'
    -> DescribeMonitoringScheduleResponse
describeMonitoringScheduleResponse pResponseStatus_
  pMonitoringScheduleARN_ pMonitoringScheduleName_
  pMonitoringScheduleStatus_ pCreationTime_
  pLastModifiedTime_ pMonitoringScheduleConfig_
  = DescribeMonitoringScheduleResponse'{_dmsrsFailureReason
                                          = Nothing,
