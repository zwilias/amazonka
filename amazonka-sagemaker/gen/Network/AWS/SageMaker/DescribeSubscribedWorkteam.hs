...
newtype DescribeSubscribedWorkteam = DescribeSubscribedWorkteam'{_dswWorkteamARN
                                                                 :: Text}
...
describeSubscribedWorkteam pWorkteamARN_
  = DescribeSubscribedWorkteam'{_dswWorkteamARN =
                                  pWorkteamARN_}
...
data DescribeSubscribedWorkteamResponse = DescribeSubscribedWorkteamResponse'{_dswrsResponseStatus
                                                                              ::
                                                                              !Int,
...
describeSubscribedWorkteamResponse
    ...
    -> DescribeSubscribedWorkteamResponse
describeSubscribedWorkteamResponse pResponseStatus_
  pSubscribedWorkteam_
  = DescribeSubscribedWorkteamResponse'{_dswrsResponseStatus
                                          = pResponseStatus_,
                                        _dswrsSubscribedWorkteam =
                                          pSubscribedWorkteam_}
