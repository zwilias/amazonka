...
data UpdateCodeRepository = UpdateCodeRepository'{_ucrGitConfig
                                                  ::
...
updateCodeRepository pCodeRepositoryName_
  = UpdateCodeRepository'{_ucrGitConfig = Nothing,
...
data UpdateCodeRepositoryResponse = UpdateCodeRepositoryResponse'{_ucrrsResponseStatus
                                                                  :: !Int,
                                                                  _ucrrsCodeRepositoryARN
                                                                  :: !Text}
...
updateCodeRepositoryResponse
    ...
    -> UpdateCodeRepositoryResponse
updateCodeRepositoryResponse pResponseStatus_
  pCodeRepositoryARN_
  = UpdateCodeRepositoryResponse'{_ucrrsResponseStatus
                                    = pResponseStatus_,
