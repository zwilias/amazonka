...
data ListApps = ListApps'{_laDomainIdEquals ::
                          !(Maybe Text),
...
listApps
    :: ListApps
listApps
  = ListApps'{_laDomainIdEquals = Nothing,
              _laNextToken = Nothing, _laSortOrder = Nothing,
              _laUserProfileNameEquals = Nothing,
              _laMaxResults = Nothing, _laSortBy = Nothing}
