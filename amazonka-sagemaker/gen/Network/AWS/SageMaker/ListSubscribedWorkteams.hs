...
data ListSubscribedWorkteams = ListSubscribedWorkteams'{_lswNameContains
                                                        :: !(Maybe Text),
                                                        _lswNextToken ::
                                                        !(Maybe Text),
                                                        _lswMaxResults ::
...
listSubscribedWorkteams
    :: ListSubscribedWorkteams
listSubscribedWorkteams
  = ListSubscribedWorkteams'{_lswNameContains =
                               Nothing,
                             _lswNextToken = Nothing, _lswMaxResults = Nothing}
...
data ListSubscribedWorkteamsResponse = ListSubscribedWorkteamsResponse'{_lswrsNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
listSubscribedWorkteamsResponse pResponseStatus_
  = ListSubscribedWorkteamsResponse'{_lswrsNextToken =
                                       Nothing,
