...
newtype StopHyperParameterTuningJob = StopHyperParameterTuningJob'{_shptjHyperParameterTuningJobName
                                                                   :: Text}
...
stopHyperParameterTuningJob
  ...
  = StopHyperParameterTuningJob'{_shptjHyperParameterTuningJobName
                                   = pHyperParameterTuningJobName_}
