...
newtype DeleteMonitoringSchedule = DeleteMonitoringSchedule'{_dMonitoringScheduleName
                                                             :: Text}
...
deleteMonitoringSchedule
    :: Text -- ^ 'dMonitoringScheduleName'
    -> DeleteMonitoringSchedule
deleteMonitoringSchedule pMonitoringScheduleName_
  = DeleteMonitoringSchedule'{_dMonitoringScheduleName
...
instance AWSRequest DeleteMonitoringSchedule where
        type Rs DeleteMonitoringSchedule =
             DeleteMonitoringScheduleResponse
        request = postJSON sageMaker
        response
          = receiveNull DeleteMonitoringScheduleResponse'

instance Hashable DeleteMonitoringSchedule where

instance NFData DeleteMonitoringSchedule where
