...
data ListLabelingJobsForWorkteam = ListLabelingJobsForWorkteam'{_lljfwJobReferenceCodeContains
                                                                ::
                                                                !(Maybe Text),
...
listLabelingJobsForWorkteam pWorkteamARN_
  = ListLabelingJobsForWorkteam'{_lljfwJobReferenceCodeContains
                                   = Nothing,
...
data ListLabelingJobsForWorkteamResponse = ListLabelingJobsForWorkteamResponse'{_lljfwrsNextToken
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
listLabelingJobsForWorkteamResponse pResponseStatus_
  = ListLabelingJobsForWorkteamResponse'{_lljfwrsNextToken
                                           = Nothing,
                                         _lljfwrsResponseStatus =
                                           pResponseStatus_,
                                         _lljfwrsLabelingJobSummaryList =
