...
data ModelPackageSummary = ModelPackageSummary'{_mpsModelPackageDescription
                                                :: !(Maybe Text),
...
modelPackageSummary
    ...
    -> ModelPackageSummary
modelPackageSummary pModelPackageName_
  pModelPackageARN_ pCreationTime_ pModelPackageStatus_
  = ModelPackageSummary'{_mpsModelPackageDescription =
                           Nothing,
