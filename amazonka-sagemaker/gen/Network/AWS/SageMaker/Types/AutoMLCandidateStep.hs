...
data AutoMLCandidateStep = AutoMLCandidateStep'{_amlcsCandidateStepType
                                                :: !CandidateStepType,
...
autoMLCandidateStep
    :: CandidateStepType -- ^ 'amlcsCandidateStepType'
    -> Text -- ^ 'amlcsCandidateStepARN'
    -> Text -- ^ 'amlcsCandidateStepName'
    -> AutoMLCandidateStep
autoMLCandidateStep pCandidateStepType_
  pCandidateStepARN_ pCandidateStepName_
  = AutoMLCandidateStep'{_amlcsCandidateStepType =
                           pCandidateStepType_,
...
instance FromJSON AutoMLCandidateStep where
        parseJSON
          = withObject "AutoMLCandidateStep"
              (\ x ->
                 AutoMLCandidateStep' <$>
                   (x .: "CandidateStepType") <*>
                     (x .: "CandidateStepArn")
...
instance Hashable AutoMLCandidateStep where

instance NFData AutoMLCandidateStep where
