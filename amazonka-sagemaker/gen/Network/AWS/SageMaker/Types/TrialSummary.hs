...
data TrialSummary = TrialSummary'{_tsCreationTime ::
                                  !(Maybe POSIX),
...
trialSummary
    :: TrialSummary
trialSummary
  = TrialSummary'{_tsCreationTime = Nothing,
                  _tsTrialARN = Nothing, _tsLastModifiedTime = Nothing,
                  _tsTrialSource = Nothing, _tsDisplayName = Nothing,
...
instance Hashable TrialSummary where

instance NFData TrialSummary where
