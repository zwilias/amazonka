...
data TransformJobDefinition = TransformJobDefinition'{_tjdBatchStrategy
                                                      :: !(Maybe BatchStrategy),
                                                      _tjdMaxPayloadInMB ::
                                                      !(Maybe Nat),
                                                      _tjdEnvironment ::
...
transformJobDefinition
    ...
    -> TransformJobDefinition
transformJobDefinition pTransformInput_
  pTransformOutput_ pTransformResources_
  = TransformJobDefinition'{_tjdBatchStrategy =
                              Nothing,
