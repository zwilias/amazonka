...
asTrainingInputMode =
  lens _asTrainingInputMode (\s a -> s {_asTrainingInputMode = a})
...
instance FromJSON AlgorithmSpecification where
  parseJSON =
    withObject
      "AlgorithmSpecification"
      (\x ->
         AlgorithmSpecification' <$> (x .: "TrainingImage") <*>
         (x .: "TrainingInputMode"))
...
cRecordWrapperType =
  lens _cRecordWrapperType (\s a -> s {_cRecordWrapperType = a})
...
instance FromJSON Channel where
  parseJSON =
    withObject
      "Channel"
      (\x ->
         Channel' <$> (x .:? "RecordWrapperType") <*> (x .:? "CompressionType") <*>
         (x .:? "ContentType") <*>
         (x .: "ChannelName") <*>
         (x .: "DataSource"))
...
cdEnvironment =
  lens _cdEnvironment (\s a -> s {_cdEnvironment = a}) . _Default . _Map

-- | The DNS host name for the container after Amazon SageMaker deploys it.
cdContainerHostname :: Lens' ContainerDefinition (Maybe Text)
cdContainerHostname =
  lens _cdContainerHostname (\s a -> s {_cdContainerHostname = a})
...
instance FromJSON ContainerDefinition where
  parseJSON =
    withObject
      "ContainerDefinition"
      (\x ->
         ContainerDefinition' <$> (x .:? "ModelDataUrl") <*>
...
instance FromJSON DataSource where
  parseJSON =
    withObject "DataSource" (\x -> DataSource' <$> (x .: "S3DataSource"))
...
instance ToJSON DataSource where
  toJSON DataSource' {..} =
    object (catMaybes [Just ("S3DataSource" .= _dsS3DataSource)])
...
dwacDesiredInstanceCount =
  lens _dwacDesiredInstanceCount (\s a -> s {_dwacDesiredInstanceCount = a}) .
  mapping _Nat
...
ecsEndpointConfigName =
  lens _ecsEndpointConfigName (\s a -> s {_ecsEndpointConfigName = a})

-- | The Amazon Resource Name (ARN) of the endpoint configuration.
ecsEndpointConfigARN :: Lens' EndpointConfigSummary Text
ecsEndpointConfigARN =
  lens _ecsEndpointConfigARN (\s a -> s {_ecsEndpointConfigARN = a})

-- | A timestamp that shows when the endpoint configuration was created.
ecsCreationTime :: Lens' EndpointConfigSummary UTCTime
ecsCreationTime =
  lens _ecsCreationTime (\s a -> s {_ecsCreationTime = a}) . _Time
...
instance FromJSON EndpointConfigSummary where
  parseJSON =
    withObject
      "EndpointConfigSummary"
      (\x ->
         EndpointConfigSummary' <$> (x .: "EndpointConfigName") <*>
         (x .: "EndpointConfigArn") <*>
         (x .: "CreationTime"))
...
esLastModifiedTime =
  lens _esLastModifiedTime (\s a -> s {_esLastModifiedTime = a}) . _Time
...
instance FromJSON EndpointSummary where
  parseJSON =
    withObject
      "EndpointSummary"
      (\x ->
         EndpointSummary' <$> (x .: "EndpointName") <*> (x .: "EndpointArn") <*>
         (x .: "CreationTime") <*>
         (x .: "LastModifiedTime") <*>
         (x .: "EndpointStatus"))
...
maS3ModelArtifacts =
  lens _maS3ModelArtifacts (\s a -> s {_maS3ModelArtifacts = a})
...
instance FromJSON ModelSummary where
  parseJSON =
    withObject
      "ModelSummary"
      (\x ->
         ModelSummary' <$> (x .: "ModelName") <*> (x .: "ModelArn") <*>
         (x .: "CreationTime"))
...
nilcsCreationTime ::
     Lens' NotebookInstanceLifecycleConfigSummary (Maybe UTCTime)
nilcsCreationTime =
  lens _nilcsCreationTime (\s a -> s {_nilcsCreationTime = a}) . mapping _Time

-- | A timestamp that tells when the lifecycle configuration was last modified.
nilcsLastModifiedTime ::
     Lens' NotebookInstanceLifecycleConfigSummary (Maybe UTCTime)
nilcsLastModifiedTime =
  lens _nilcsLastModifiedTime (\s a -> s {_nilcsLastModifiedTime = a}) .
  mapping _Time

-- | The name of the lifecycle configuration.
nilcsNotebookInstanceLifecycleConfigName ::
     Lens' NotebookInstanceLifecycleConfigSummary Text
nilcsNotebookInstanceLifecycleConfigName =
  lens
    _nilcsNotebookInstanceLifecycleConfigName
    (\s a -> s {_nilcsNotebookInstanceLifecycleConfigName = a})
...
nilcsNotebookInstanceLifecycleConfigARN =
  lens
    _nilcsNotebookInstanceLifecycleConfigARN
    (\s a -> s {_nilcsNotebookInstanceLifecycleConfigARN = a})
...
instance FromJSON NotebookInstanceLifecycleConfigSummary where
  parseJSON =
    withObject
      "NotebookInstanceLifecycleConfigSummary"
      (\x ->
         NotebookInstanceLifecycleConfigSummary' <$> (x .:? "CreationTime") <*>
         (x .:? "LastModifiedTime") <*>
...
nisCreationTime =
  lens _nisCreationTime (\s a -> s {_nisCreationTime = a}) . mapping _Time
...
nisLastModifiedTime =
  lens _nisLastModifiedTime (\s a -> s {_nisLastModifiedTime = a}) .
  mapping _Time
...
nisNotebookInstanceStatus ::
     Lens' NotebookInstanceSummary (Maybe NotebookInstanceStatus)
nisNotebookInstanceStatus =
  lens _nisNotebookInstanceStatus (\s a -> s {_nisNotebookInstanceStatus = a})
...
instance FromJSON NotebookInstanceSummary where
  parseJSON =
    withObject
      "NotebookInstanceSummary"
      (\x ->
         NotebookInstanceSummary' <$> (x .:? "CreationTime") <*> (x .:? "Url") <*>
         (x .:? "LastModifiedTime") <*>
         (x .:? "InstanceType") <*>
...
instance FromJSON OutputDataConfig where
  parseJSON =
    withObject
      "OutputDataConfig"
      (\x -> OutputDataConfig' <$> (x .:? "KmsKeyId") <*> (x .: "S3OutputPath"))
...
pvInitialVariantWeight =
  lens _pvInitialVariantWeight (\s a -> s {_pvInitialVariantWeight = a})
...
pvInitialInstanceCount =
  lens _pvInitialInstanceCount (\s a -> s {_pvInitialInstanceCount = a}) . _Nat
...
instance FromJSON ProductionVariant where
  parseJSON =
    withObject
      "ProductionVariant"
      (\x ->
         ProductionVariant' <$> (x .:? "InitialVariantWeight") <*>
         (x .: "VariantName") <*>
         (x .: "ModelName") <*>
...
pvsDesiredInstanceCount =
  lens _pvsDesiredInstanceCount (\s a -> s {_pvsDesiredInstanceCount = a}) .
  mapping _Nat
...
pvsCurrentInstanceCount =
  lens _pvsCurrentInstanceCount (\s a -> s {_pvsCurrentInstanceCount = a}) .
  mapping _Nat
...
instance FromJSON ProductionVariantSummary where
  parseJSON =
    withObject
      "ProductionVariantSummary"
      (\x ->
         ProductionVariantSummary' <$> (x .:? "DesiredInstanceCount") <*>
         (x .:? "DesiredWeight") <*>
         (x .:? "CurrentWeight") <*>
...
rcInstanceCount =
  lens _rcInstanceCount (\s a -> s {_rcInstanceCount = a}) . _Nat

-- | The size of the ML storage volume that you want to provision.  ML storage volumes store model artifacts and incremental states. Training algorithms might also use the ML storage volume for scratch space. If you want to store the training data in the ML storage volume, choose @File@ as the @TrainingInputMode@ in the algorithm specification.  You must specify sufficient ML storage for your scenario.
rcVolumeSizeInGB :: Lens' ResourceConfig Natural
rcVolumeSizeInGB =
  lens _rcVolumeSizeInGB (\s a -> s {_rcVolumeSizeInGB = a}) . _Nat
...
instance FromJSON ResourceConfig where
  parseJSON =
    withObject
      "ResourceConfig"
      (\x ->
         ResourceConfig' <$> (x .:? "VolumeKmsKeyId") <*> (x .: "InstanceType") <*>
         (x .: "InstanceCount") <*>
         (x .: "VolumeSizeInGB"))
...
sdsS3DataDistributionType =
  lens _sdsS3DataDistributionType (\s a -> s {_sdsS3DataDistributionType = a})
...
instance FromJSON S3DataSource where
  parseJSON =
    withObject
      "S3DataSource"
      (\x ->
         S3DataSource' <$> (x .:? "S3DataDistributionType") <*>
         (x .: "S3DataType") <*>
         (x .: "S3Uri"))
...
scMaxRuntimeInSeconds =
  lens _scMaxRuntimeInSeconds (\s a -> s {_scMaxRuntimeInSeconds = a}) .
  mapping _Nat
...
instance FromJSON StoppingCondition where
  parseJSON =
    withObject
      "StoppingCondition"
      (\x -> StoppingCondition' <$> (x .:? "MaxRuntimeInSeconds"))
...
instance ToJSON StoppingCondition where
  toJSON StoppingCondition' {..} =
    object (catMaybes [("MaxRuntimeInSeconds" .=) <$> _scMaxRuntimeInSeconds])
...
tjsTrainingEndTime =
  lens _tjsTrainingEndTime (\s a -> s {_tjsTrainingEndTime = a}) . mapping _Time

-- | Timestamp when the training job was last modified.
tjsLastModifiedTime :: Lens' TrainingJobSummary (Maybe UTCTime)
tjsLastModifiedTime =
  lens _tjsLastModifiedTime (\s a -> s {_tjsLastModifiedTime = a}) .
  mapping _Time

-- | The name of the training job that you want a summary for.
tjsTrainingJobName :: Lens' TrainingJobSummary Text
tjsTrainingJobName =
  lens _tjsTrainingJobName (\s a -> s {_tjsTrainingJobName = a})
...
tjsCreationTime =
  lens _tjsCreationTime (\s a -> s {_tjsCreationTime = a}) . _Time

-- | The status of the training job.
tjsTrainingJobStatus :: Lens' TrainingJobSummary TrainingJobStatus
tjsTrainingJobStatus =
  lens _tjsTrainingJobStatus (\s a -> s {_tjsTrainingJobStatus = a})
...
instance FromJSON TrainingJobSummary where
  parseJSON =
    withObject
      "TrainingJobSummary"
      (\x ->
         TrainingJobSummary' <$> (x .:? "TrainingEndTime") <*>
         (x .:? "LastModifiedTime") <*>
         (x .: "TrainingJobName") <*>
         (x .: "TrainingJobArn") <*>
         (x .: "CreationTime") <*>
...
vcSecurityGroupIds =
  lens _vcSecurityGroupIds (\s a -> s {_vcSecurityGroupIds = a}) . _List1
...
instance FromJSON VPCConfig where
  parseJSON =
    withObject
      "VPCConfig"
      (\x -> VPCConfig' <$> (x .: "SecurityGroupIds") <*> (x .: "Subnets"))
