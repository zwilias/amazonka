...
data TrialComponentParameterValue = TrialComponentParameterValue'{_tcpvNumberValue
                                                                  ::
                                                                  !(Maybe
                                                                      Double),
                                                                  _tcpvStringValue
...
trialComponentParameterValue
    :: TrialComponentParameterValue
trialComponentParameterValue
  = TrialComponentParameterValue'{_tcpvNumberValue =
                                    Nothing,
...
instance FromJSON TrialComponentParameterValue where
        parseJSON
          = withObject "TrialComponentParameterValue"
              (\ x ->
                 TrialComponentParameterValue' <$>
                   (x .:? "NumberValue") <*> (x .:? "StringValue"))

instance Hashable TrialComponentParameterValue where

instance NFData TrialComponentParameterValue where
