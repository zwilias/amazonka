...
data NotebookInstanceLifecycleConfigSummary = NotebookInstanceLifecycleConfigSummary'{_nilcsCreationTime
                                                                                      ::
                                                                                      !(Maybe
                                                                                          POSIX),
...
notebookInstanceLifecycleConfigSummary
  ...
  = NotebookInstanceLifecycleConfigSummary'{_nilcsCreationTime
                                              = Nothing,
