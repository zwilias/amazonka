...
data CognitoMemberDefinition = CognitoMemberDefinition'{_cmdUserPool
                                                        :: !Text,
                                                        _cmdUserGroup :: !Text,
                                                        _cmdClientId :: !Text}
...
cognitoMemberDefinition
    ...
    -> Text -- ^ 'cmdClientId'
    -> CognitoMemberDefinition
cognitoMemberDefinition pUserPool_ pUserGroup_
  pClientId_
  = CognitoMemberDefinition'{_cmdUserPool = pUserPool_,
