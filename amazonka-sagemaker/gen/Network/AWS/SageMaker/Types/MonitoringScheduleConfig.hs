...
data MonitoringScheduleConfig = MonitoringScheduleConfig'{_mscScheduleConfig
                                                          ::
                                                          !(Maybe
                                                              ScheduleConfig),
...
monitoringScheduleConfig
    :: MonitoringJobDefinition -- ^ 'mscMonitoringJobDefinition'
    -> MonitoringScheduleConfig
monitoringScheduleConfig pMonitoringJobDefinition_
  = MonitoringScheduleConfig'{_mscScheduleConfig =
                                Nothing,
                              _mscMonitoringJobDefinition =
                                pMonitoringJobDefinition_}
...
instance FromJSON MonitoringScheduleConfig where
        parseJSON
          = withObject "MonitoringScheduleConfig"
              (\ x ->
                 MonitoringScheduleConfig' <$>
                   (x .:? "ScheduleConfig") <*>
                     (x .: "MonitoringJobDefinition"))

instance Hashable MonitoringScheduleConfig where

instance NFData MonitoringScheduleConfig where
