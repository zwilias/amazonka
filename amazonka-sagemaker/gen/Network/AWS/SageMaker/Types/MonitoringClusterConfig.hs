...
data MonitoringClusterConfig = MonitoringClusterConfig'{_mccVolumeKMSKeyId
                                                        :: !(Maybe Text),
                                                        _mccInstanceCount ::
                                                        !Nat,
                                                        _mccInstanceType ::
...
monitoringClusterConfig
    :: Natural -- ^ 'mccInstanceCount'
    -> ProcessingInstanceType -- ^ 'mccInstanceType'
    -> Natural -- ^ 'mccVolumeSizeInGB'
    -> MonitoringClusterConfig
monitoringClusterConfig pInstanceCount_
  pInstanceType_ pVolumeSizeInGB_
  = MonitoringClusterConfig'{_mccVolumeKMSKeyId =
                               Nothing,
...
instance FromJSON MonitoringClusterConfig where
        parseJSON
          = withObject "MonitoringClusterConfig"
              (\ x ->
                 MonitoringClusterConfig' <$>
...
instance Hashable MonitoringClusterConfig where

instance NFData MonitoringClusterConfig where
