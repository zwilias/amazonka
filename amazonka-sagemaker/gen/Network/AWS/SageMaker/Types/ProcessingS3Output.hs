...
data ProcessingS3Output = ProcessingS3Output'{_psoS3URI
                                              :: !Text,
                                              _psoLocalPath :: !Text,
                                              _psoS3UploadMode ::
...
processingS3Output
    :: Text -- ^ 'psoS3URI'
    -> Text -- ^ 'psoLocalPath'
    -> ProcessingS3UploadMode -- ^ 'psoS3UploadMode'
    -> ProcessingS3Output
processingS3Output pS3URI_ pLocalPath_ pS3UploadMode_
  = ProcessingS3Output'{_psoS3URI = pS3URI_,
...
instance FromJSON ProcessingS3Output where
        parseJSON
          = withObject "ProcessingS3Output"
              (\ x ->
                 ProcessingS3Output' <$>
                   (x .: "S3Uri") <*> (x .: "LocalPath") <*>
                     (x .: "S3UploadMode"))

instance Hashable ProcessingS3Output where

instance NFData ProcessingS3Output where
