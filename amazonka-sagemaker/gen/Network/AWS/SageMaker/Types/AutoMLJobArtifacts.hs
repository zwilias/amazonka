...
data AutoMLJobArtifacts = AutoMLJobArtifacts'{_amljaCandidateDefinitionNotebookLocation
                                              :: !(Maybe Text),
...
autoMLJobArtifacts
    :: AutoMLJobArtifacts
autoMLJobArtifacts
  = AutoMLJobArtifacts'{_amljaCandidateDefinitionNotebookLocation
                          = Nothing,
...
instance FromJSON AutoMLJobArtifacts where
        parseJSON
          = withObject "AutoMLJobArtifacts"
              (\ x ->
                 AutoMLJobArtifacts' <$>
                   (x .:? "CandidateDefinitionNotebookLocation") <*>
                     (x .:? "DataExplorationNotebookLocation"))

instance Hashable AutoMLJobArtifacts where

instance NFData AutoMLJobArtifacts where
