...
data HyperParameterAlgorithmSpecification = HyperParameterAlgorithmSpecification'{_hpasAlgorithmName
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
                                                                                  _hpasTrainingImage
...
hyperParameterAlgorithmSpecification
  pTrainingInputMode_
  = HyperParameterAlgorithmSpecification'{_hpasAlgorithmName
                                            = Nothing,
