...
data ResolvedAttributes = ResolvedAttributes'{_raProblemType
                                              :: !(Maybe ProblemType),
...
resolvedAttributes
    :: ResolvedAttributes
resolvedAttributes
  = ResolvedAttributes'{_raProblemType = Nothing,
...
instance Hashable ResolvedAttributes where

instance NFData ResolvedAttributes where
