...
data ProcessingJobSummary = ProcessingJobSummary'{_pjsFailureReason
                                                  :: !(Maybe Text),
...
processingJobSummary
    :: Text -- ^ 'pjsProcessingJobName'
    -> Text -- ^ 'pjsProcessingJobARN'
    -> UTCTime -- ^ 'pjsCreationTime'
    -> ProcessingJobStatus -- ^ 'pjsProcessingJobStatus'
    -> ProcessingJobSummary
processingJobSummary pProcessingJobName_
  pProcessingJobARN_ pCreationTime_
  pProcessingJobStatus_
  = ProcessingJobSummary'{_pjsFailureReason = Nothing,
...
instance FromJSON ProcessingJobSummary where
        parseJSON
          = withObject "ProcessingJobSummary"
              (\ x ->
                 ProcessingJobSummary' <$>
                   (x .:? "FailureReason") <*>
                     (x .:? "LastModifiedTime")
...
instance Hashable ProcessingJobSummary where

instance NFData ProcessingJobSummary where
