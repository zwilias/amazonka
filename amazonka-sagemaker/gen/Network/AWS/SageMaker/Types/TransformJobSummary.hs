...
data TransformJobSummary = TransformJobSummary'{_tjsFailureReason
                                                :: !(Maybe Text),
...
transformJobSummary
    ...
    -> TransformJobSummary
transformJobSummary pTransformJobName_
  pTransformJobARN_ pCreationTime_ pTransformJobStatus_
  = TransformJobSummary'{_tjsFailureReason = Nothing,
