...
data FileSystemDataSource = FileSystemDataSource'{_fsdsFileSystemId
                                                  :: !Text,
...
fileSystemDataSource
    :: Text -- ^ 'fsdsFileSystemId'
    -> FileSystemAccessMode -- ^ 'fsdsFileSystemAccessMode'
    -> FileSystemType -- ^ 'fsdsFileSystemType'
    -> Text -- ^ 'fsdsDirectoryPath'
    -> FileSystemDataSource
fileSystemDataSource pFileSystemId_
  pFileSystemAccessMode_ pFileSystemType_
  pDirectoryPath_
  = FileSystemDataSource'{_fsdsFileSystemId =
                            pFileSystemId_,
...
instance FromJSON FileSystemDataSource where
        parseJSON
          = withObject "FileSystemDataSource"
              (\ x ->
                 FileSystemDataSource' <$>
                   (x .: "FileSystemId") <*>
...
instance Hashable FileSystemDataSource where

instance NFData FileSystemDataSource where
