...
data TrialComponentSource = TrialComponentSource'{_tcsSourceType
                                                  :: !(Maybe Text),
                                                  _tcsSourceARN :: !Text}
...
trialComponentSource pSourceARN_
  = TrialComponentSource'{_tcsSourceType = Nothing,
...
instance FromJSON TrialComponentSource where
        parseJSON
          = withObject "TrialComponentSource"
              (\ x ->
                 TrialComponentSource' <$>
                   (x .:? "SourceType") <*> (x .: "SourceArn"))

instance Hashable TrialComponentSource where

instance NFData TrialComponentSource where
