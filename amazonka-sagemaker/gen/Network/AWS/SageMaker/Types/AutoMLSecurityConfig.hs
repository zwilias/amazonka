...
data AutoMLSecurityConfig = AutoMLSecurityConfig'{_amlscVPCConfig
                                                  :: !(Maybe VPCConfig),
...
autoMLSecurityConfig
    :: AutoMLSecurityConfig
autoMLSecurityConfig
  = AutoMLSecurityConfig'{_amlscVPCConfig = Nothing,
...
instance FromJSON AutoMLSecurityConfig where
        parseJSON
          = withObject "AutoMLSecurityConfig"
              (\ x ->
                 AutoMLSecurityConfig' <$>
                   (x .:? "VpcConfig") <*> (x .:? "VolumeKmsKeyId") <*>
                     (x .:? "EnableInterContainerTrafficEncryption"))

instance Hashable AutoMLSecurityConfig where

instance NFData AutoMLSecurityConfig where
