...
data TrialComponentArtifact = TrialComponentArtifact'{_tcaMediaType
                                                      :: !(Maybe Text),
                                                      _tcaValue :: !Text}
...
trialComponentArtifact pValue_
  = TrialComponentArtifact'{_tcaMediaType = Nothing,
                            _tcaValue = pValue_}
...
instance FromJSON TrialComponentArtifact where
        parseJSON
          = withObject "TrialComponentArtifact"
              (\ x ->
                 TrialComponentArtifact' <$>
                   (x .:? "MediaType") <*> (x .: "Value"))

instance Hashable TrialComponentArtifact where

instance NFData TrialComponentArtifact where
