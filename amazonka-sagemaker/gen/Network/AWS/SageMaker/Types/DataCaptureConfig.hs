...
data DataCaptureConfig = DataCaptureConfig'{_dccCaptureContentTypeHeader
                                            ::
...
-- * 'dccCaptureOptions' - 
dataCaptureConfig
    :: Natural -- ^ 'dccInitialSamplingPercentage'
    -> Text -- ^ 'dccDestinationS3URI'
    -> NonEmpty CaptureOption -- ^ 'dccCaptureOptions'
    -> DataCaptureConfig
dataCaptureConfig pInitialSamplingPercentage_
  pDestinationS3URI_ pCaptureOptions_
  = DataCaptureConfig'{_dccCaptureContentTypeHeader =
                         Nothing,
                       _dccKMSKeyId = Nothing, _dccEnableCapture = Nothing,
                       _dccInitialSamplingPercentage =
...
instance Hashable DataCaptureConfig where

instance NFData DataCaptureConfig where
