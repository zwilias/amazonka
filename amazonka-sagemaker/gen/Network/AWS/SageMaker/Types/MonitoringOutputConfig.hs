...
data MonitoringOutputConfig = MonitoringOutputConfig'{_mocKMSKeyId
                                                      :: !(Maybe Text),
...
monitoringOutputConfig
    :: NonEmpty MonitoringOutput -- ^ 'mocMonitoringOutputs'
    -> MonitoringOutputConfig
monitoringOutputConfig pMonitoringOutputs_
  = MonitoringOutputConfig'{_mocKMSKeyId = Nothing,
                            _mocMonitoringOutputs =
...
instance FromJSON MonitoringOutputConfig where
        parseJSON
          = withObject "MonitoringOutputConfig"
              (\ x ->
                 MonitoringOutputConfig' <$>
                   (x .:? "KmsKeyId") <*> (x .: "MonitoringOutputs"))

instance Hashable MonitoringOutputConfig where

instance NFData MonitoringOutputConfig where
