...
data IntegerParameterRangeSpecification = IntegerParameterRangeSpecification'{_iprsMinValue
                                                                              ::
                                                                              !Text,
                                                                              _iprsMaxValue
                                                                              ::
...
integerParameterRangeSpecification
    ...
    -> Text -- ^ 'iprsMaxValue'
    -> IntegerParameterRangeSpecification
integerParameterRangeSpecification pMinValue_
  pMaxValue_
  = IntegerParameterRangeSpecification'{_iprsMinValue =
                                          pMinValue_,
