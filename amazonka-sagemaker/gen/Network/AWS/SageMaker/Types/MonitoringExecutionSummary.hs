...
data MonitoringExecutionSummary = MonitoringExecutionSummary'{_mesFailureReason
                                                              :: !(Maybe Text),
                                                              _mesEndpointName
                                                              :: !(Maybe Text),
...
monitoringExecutionSummary
    :: Text -- ^ 'mesMonitoringScheduleName'
    -> UTCTime -- ^ 'mesScheduledTime'
    -> UTCTime -- ^ 'mesCreationTime'
    -> UTCTime -- ^ 'mesLastModifiedTime'
    -> ExecutionStatus -- ^ 'mesMonitoringExecutionStatus'
    -> MonitoringExecutionSummary
monitoringExecutionSummary pMonitoringScheduleName_
  pScheduledTime_ pCreationTime_ pLastModifiedTime_
  pMonitoringExecutionStatus_
  = MonitoringExecutionSummary'{_mesFailureReason =
                                  Nothing,
...
instance FromJSON MonitoringExecutionSummary where
        parseJSON
          = withObject "MonitoringExecutionSummary"
              (\ x ->
                 MonitoringExecutionSummary' <$>
...
instance Hashable MonitoringExecutionSummary where

instance NFData MonitoringExecutionSummary where
