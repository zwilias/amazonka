...
newtype VariantProperty = VariantProperty'{_vpVariantPropertyType
                                           :: VariantPropertyType}
...
variantProperty
    :: VariantPropertyType -- ^ 'vpVariantPropertyType'
    -> VariantProperty
variantProperty pVariantPropertyType_
  = VariantProperty'{_vpVariantPropertyType =
...
instance Hashable VariantProperty where

instance NFData VariantProperty where
