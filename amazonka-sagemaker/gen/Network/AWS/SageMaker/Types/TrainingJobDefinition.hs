...
data TrainingJobDefinition = TrainingJobDefinition'{_tjdHyperParameters
                                                    :: !(Maybe (Map Text Text)),
...
trainingJobDefinition
    ...
    -> TrainingJobDefinition
trainingJobDefinition pTrainingInputMode_
  pInputDataConfig_ pOutputDataConfig_ pResourceConfig_
  pStoppingCondition_
  = TrainingJobDefinition'{_tjdHyperParameters =
                             Nothing,
