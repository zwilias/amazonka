...
data LabelingJobForWorkteamSummary = LabelingJobForWorkteamSummary'{_ljfwsNumberOfHumanWorkersPerDataObject
                                                                    ::
                                                                    !(Maybe
                                                                        Nat),
                                                                    _ljfwsLabelCounters
...
labelingJobForWorkteamSummary
    ...
    -> LabelingJobForWorkteamSummary
labelingJobForWorkteamSummary pJobReferenceCode_
  pWorkRequesterAccountId_ pCreationTime_
  = LabelingJobForWorkteamSummary'{_ljfwsNumberOfHumanWorkersPerDataObject
                                     = Nothing,
