...
data ProcessingJob = ProcessingJob'{_pjCreationTime
                                    :: !(Maybe POSIX),
...
processingJob
    :: ProcessingJob
processingJob
  = ProcessingJob'{_pjCreationTime = Nothing,
                   ...
                   _pjProcessingEndTime = Nothing, _pjTags = Nothing,
                   _pjProcessingJobARN = Nothing, _pjRoleARN = Nothing}
...
instance Hashable ProcessingJob where

instance NFData ProcessingJob where
