...
data EndpointConfigSummary = EndpointConfigSummary'{_ecsEndpointConfigName
                                                    :: !Text,
...
endpointConfigSummary
    ...
    -> EndpointConfigSummary
endpointConfigSummary pEndpointConfigName_
  pEndpointConfigARN_ pCreationTime_
  = EndpointConfigSummary'{_ecsEndpointConfigName =
