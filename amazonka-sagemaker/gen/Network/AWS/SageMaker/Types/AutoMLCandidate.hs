...
data AutoMLCandidate = AutoMLCandidate'{_amlcFailureReason
                                        :: !(Maybe Text),
...
autoMLCandidate
    :: Text -- ^ 'amlcCandidateName'
    -> ObjectiveStatus -- ^ 'amlcObjectiveStatus'
    -> CandidateStatus -- ^ 'amlcCandidateStatus'
    -> UTCTime -- ^ 'amlcCreationTime'
    -> UTCTime -- ^ 'amlcLastModifiedTime'
    -> AutoMLCandidate
autoMLCandidate pCandidateName_ pObjectiveStatus_
  pCandidateStatus_ pCreationTime_ pLastModifiedTime_
  = AutoMLCandidate'{_amlcFailureReason = Nothing,
...
instance Hashable AutoMLCandidate where

instance NFData AutoMLCandidate where
