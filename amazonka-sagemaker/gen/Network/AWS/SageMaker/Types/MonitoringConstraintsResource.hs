...
newtype MonitoringConstraintsResource = MonitoringConstraintsResource'{_mcrS3URI
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
instance FromJSON MonitoringConstraintsResource where
        parseJSON
          = withObject "MonitoringConstraintsResource"
              (\ x ->
                 MonitoringConstraintsResource' <$> (x .:? "S3Uri"))

instance Hashable MonitoringConstraintsResource where

instance NFData MonitoringConstraintsResource where
