...
data FlowDefinitionSummary = FlowDefinitionSummary'{_fdsFailureReason
                                                    :: !(Maybe Text),
...
flowDefinitionSummary
    :: Text -- ^ 'fdsFlowDefinitionName'
    -> Text -- ^ 'fdsFlowDefinitionARN'
    -> FlowDefinitionStatus -- ^ 'fdsFlowDefinitionStatus'
    -> UTCTime -- ^ 'fdsCreationTime'
    -> FlowDefinitionSummary
flowDefinitionSummary pFlowDefinitionName_
  pFlowDefinitionARN_ pFlowDefinitionStatus_
  pCreationTime_
  = FlowDefinitionSummary'{_fdsFailureReason = Nothing,
...
instance FromJSON FlowDefinitionSummary where
        parseJSON
          = withObject "FlowDefinitionSummary"
              (\ x ->
                 FlowDefinitionSummary' <$>
                   (x .:? "FailureReason") <*>
...
instance Hashable FlowDefinitionSummary where

instance NFData FlowDefinitionSummary where
