...
data UserProfileDetails = UserProfileDetails'{_updCreationTime
                                              :: !(Maybe POSIX),
                                              _updStatus ::
...
userProfileDetails
    :: UserProfileDetails
userProfileDetails
  = UserProfileDetails'{_updCreationTime = Nothing,
                        _updStatus = Nothing, _updUserProfileName = Nothing,
...
instance Hashable UserProfileDetails where

instance NFData UserProfileDetails where
