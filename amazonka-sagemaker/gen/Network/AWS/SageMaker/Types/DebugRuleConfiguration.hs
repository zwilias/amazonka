...
data DebugRuleConfiguration = DebugRuleConfiguration'{_drcRuleParameters
                                                      ::
                                                      !(Maybe (Map Text Text)),
                                                      _drcS3OutputPath ::
                                                      !(Maybe Text),
...
debugRuleConfiguration
    :: Text -- ^ 'drcRuleConfigurationName'
    -> Text -- ^ 'drcRuleEvaluatorImage'
    -> DebugRuleConfiguration
debugRuleConfiguration pRuleConfigurationName_
  pRuleEvaluatorImage_
  = DebugRuleConfiguration'{_drcRuleParameters =
                              Nothing,
                            _drcS3OutputPath = Nothing, _drcLocalPath = Nothing,
...
instance FromJSON DebugRuleConfiguration where
        parseJSON
          = withObject "DebugRuleConfiguration"
              (\ x ->
                 DebugRuleConfiguration' <$>
...
instance Hashable DebugRuleConfiguration where

instance NFData DebugRuleConfiguration where
