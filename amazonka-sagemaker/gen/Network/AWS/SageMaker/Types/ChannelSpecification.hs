...
data ChannelSpecification = ChannelSpecification'{_csSupportedCompressionTypes
...
channelSpecification pName_ pSupportedInputModes_
  = ChannelSpecification'{_csSupportedCompressionTypes
                            = Nothing,
                          _csIsRequired = Nothing, _csDescription = Nothing,
                          _csName = pName_, _csSupportedContentTypes = mempty,
                          _csSupportedInputModes =
