...
data FinalHyperParameterTuningJobObjectiveMetric = FinalHyperParameterTuningJobObjectiveMetric'{_fhptjomType
                                                                                                ::
                                                                                                !(Maybe
...
finalHyperParameterTuningJobObjectiveMetric
    ...
    -> FinalHyperParameterTuningJobObjectiveMetric
finalHyperParameterTuningJobObjectiveMetric
  pMetricName_ pValue_
  = FinalHyperParameterTuningJobObjectiveMetric'{_fhptjomType
                                                   = Nothing,
                                                 _fhptjomMetricName =
                                                   pMetricName_,
