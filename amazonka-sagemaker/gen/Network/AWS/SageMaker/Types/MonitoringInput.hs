...
newtype MonitoringInput = MonitoringInput'{_miEndpointInput
                                           :: EndpointInput}
...
monitoringInput
    :: EndpointInput -- ^ 'miEndpointInput'
    -> MonitoringInput
monitoringInput pEndpointInput_
  = MonitoringInput'{_miEndpointInput =
                       pEndpointInput_}
...
instance FromJSON MonitoringInput where
        parseJSON
          = withObject "MonitoringInput"
              (\ x -> MonitoringInput' <$> (x .: "EndpointInput"))

instance Hashable MonitoringInput where

instance NFData MonitoringInput where
