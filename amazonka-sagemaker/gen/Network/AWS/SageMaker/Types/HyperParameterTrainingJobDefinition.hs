...
data HyperParameterTrainingJobDefinition = HyperParameterTrainingJobDefinition'{_hptjdTuningObjective
                                                                                ::
                                                                                !(Maybe
...
hyperParameterTrainingJobDefinition
  ...
  = HyperParameterTrainingJobDefinition'{_hptjdTuningObjective
                                           = Nothing,
