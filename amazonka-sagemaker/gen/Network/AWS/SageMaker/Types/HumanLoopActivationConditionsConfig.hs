...
newtype HumanLoopActivationConditionsConfig = HumanLoopActivationConditionsConfig'{_hlaccHumanLoopActivationConditions
                                                                                   ::
                                                                                   Text}
...
humanLoopActivationConditionsConfig
    :: Text -- ^ 'hlaccHumanLoopActivationConditions'
    -> HumanLoopActivationConditionsConfig
humanLoopActivationConditionsConfig
  pHumanLoopActivationConditions_
  = HumanLoopActivationConditionsConfig'{_hlaccHumanLoopActivationConditions
                                           = pHumanLoopActivationConditions_}
...
instance FromJSON HumanLoopActivationConditionsConfig
         where
        parseJSON
          = withObject "HumanLoopActivationConditionsConfig"
              (\ x ->
                 HumanLoopActivationConditionsConfig' <$>
...
instance ToJSON HumanLoopActivationConditionsConfig
         where
