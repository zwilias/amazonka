...
data AlgorithmValidationSpecification = AlgorithmValidationSpecification'{_avsValidationRole
                                                                          ::
                                                                          !Text,
...
algorithmValidationSpecification
    ...
    -> AlgorithmValidationSpecification
algorithmValidationSpecification pValidationRole_
  pValidationProfiles_
  = AlgorithmValidationSpecification'{_avsValidationRole
                                        = pValidationRole_,
                                      _avsValidationProfiles =
