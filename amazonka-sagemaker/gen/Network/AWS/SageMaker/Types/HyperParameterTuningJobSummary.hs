...
data HyperParameterTuningJobSummary = HyperParameterTuningJobSummary'{_hResourceLimits
                                                                      ::
                                                                      !(Maybe
                                                                          ResourceLimits),
                                                                      _hLastModifiedTime
...
hyperParameterTuningJobSummary
  ...
  pHyperParameterTuningJobStatus_ pStrategy_
  pCreationTime_ pTrainingJobStatusCounters_
  pObjectiveStatusCounters_
  = HyperParameterTuningJobSummary'{_hResourceLimits =
                                      Nothing,
