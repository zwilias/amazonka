...
data MonitoringJobDefinition = MonitoringJobDefinition'{_mjdEnvironment
                                                        ::
                                                        !(Maybe
                                                            (Map Text Text)),
...
monitoringJobDefinition
    :: NonEmpty MonitoringInput -- ^ 'mjdMonitoringInputs'
    -> MonitoringOutputConfig -- ^ 'mjdMonitoringOutputConfig'
    -> MonitoringResources -- ^ 'mjdMonitoringResources'
    -> MonitoringAppSpecification -- ^ 'mjdMonitoringAppSpecification'
    -> Text -- ^ 'mjdRoleARN'
    -> MonitoringJobDefinition
monitoringJobDefinition pMonitoringInputs_
  pMonitoringOutputConfig_ pMonitoringResources_
  pMonitoringAppSpecification_ pRoleARN_
  = MonitoringJobDefinition'{_mjdEnvironment = Nothing,
...
instance FromJSON MonitoringJobDefinition where
        parseJSON
          = withObject "MonitoringJobDefinition"
              (\ x ->
                 MonitoringJobDefinition' <$>
...
instance Hashable MonitoringJobDefinition where

instance NFData MonitoringJobDefinition where
