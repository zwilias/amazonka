...
newtype ParentHyperParameterTuningJob = ParentHyperParameterTuningJob'{_phptjHyperParameterTuningJobName
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
parentHyperParameterTuningJob
    :: ParentHyperParameterTuningJob
parentHyperParameterTuningJob
  = ParentHyperParameterTuningJob'{_phptjHyperParameterTuningJobName
                                     = Nothing}
