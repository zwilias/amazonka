...
data LabelingJobSummary = LabelingJobSummary'{_ljsFailureReason
                                              :: !(Maybe Text),
...
labelingJobSummary
    ...
    -> LabelingJobSummary
labelingJobSummary pLabelingJobName_ pLabelingJobARN_
  pCreationTime_ pLastModifiedTime_ pLabelingJobStatus_
  pLabelCounters_ pWorkteamARN_ pPreHumanTaskLambdaARN_
  = LabelingJobSummary'{_ljsFailureReason = Nothing,
