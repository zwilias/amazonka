...
data MonitoringAppSpecification = MonitoringAppSpecification'{_masContainerArguments
                                                              ::
                                                              !(Maybe
                                                                  (List1 Text)),
...
monitoringAppSpecification pImageURI_
  = MonitoringAppSpecification'{_masContainerArguments
                                  = Nothing,
...
instance FromJSON MonitoringAppSpecification where
        parseJSON
          = withObject "MonitoringAppSpecification"
              (\ x ->
                 MonitoringAppSpecification' <$>
...
instance Hashable MonitoringAppSpecification where

instance NFData MonitoringAppSpecification where
