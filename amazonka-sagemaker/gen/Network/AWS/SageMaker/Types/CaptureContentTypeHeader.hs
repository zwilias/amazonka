...
data CaptureContentTypeHeader = CaptureContentTypeHeader'{_ccthCSVContentTypes
                                                          ::
                                                          !(Maybe (List1 Text)),
...
captureContentTypeHeader
    :: CaptureContentTypeHeader
captureContentTypeHeader
  = CaptureContentTypeHeader'{_ccthCSVContentTypes =
                                Nothing,
...
instance FromJSON CaptureContentTypeHeader where
        parseJSON
          = withObject "CaptureContentTypeHeader"
              (\ x ->
                 CaptureContentTypeHeader' <$>
                   (x .:? "CsvContentTypes") <*>
                     (x .:? "JsonContentTypes"))

instance Hashable CaptureContentTypeHeader where

instance NFData CaptureContentTypeHeader where
