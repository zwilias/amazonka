...
data Trial = Trial'{_tCreationTime :: !(Maybe POSIX),
...
trial
    :: Trial
trial
  = Trial'{_tCreationTime = Nothing,
           _tTrialComponentSummaries = Nothing,
           _tTrialARN = Nothing, _tCreatedBy = Nothing,
           _tLastModifiedTime = Nothing,
           _tExperimentName = Nothing, _tSource = Nothing,
           _tDisplayName = Nothing, _tTrialName = Nothing,
           _tLastModifiedBy = Nothing, _tTags = Nothing}
...
instance Hashable Trial where

instance NFData Trial where
