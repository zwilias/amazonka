...
newtype HumanLoopActivationConfig = HumanLoopActivationConfig'{_hlacHumanLoopActivationConditionsConfig
                                                               ::
...
humanLoopActivationConfig
    :: HumanLoopActivationConditionsConfig -- ^ 'hlacHumanLoopActivationConditionsConfig'
    -> HumanLoopActivationConfig
humanLoopActivationConfig
  pHumanLoopActivationConditionsConfig_
  = HumanLoopActivationConfig'{_hlacHumanLoopActivationConditionsConfig
                                 = pHumanLoopActivationConditionsConfig_}
...
instance FromJSON HumanLoopActivationConfig where
        parseJSON
          = withObject "HumanLoopActivationConfig"
              (\ x ->
                 HumanLoopActivationConfig' <$>
                   (x .: "HumanLoopActivationConditionsConfig"))

instance Hashable HumanLoopActivationConfig where

instance NFData HumanLoopActivationConfig where
