...
data HyperParameterSpecification = HyperParameterSpecification'{_hpsIsTunable
                                                                ::
                                                                !(Maybe Bool),
                                                                _hpsRange ::
                                                                !(Maybe
...
hyperParameterSpecification pName_ pType_
  = HyperParameterSpecification'{_hpsIsTunable =
                                   Nothing,
                                 _hpsRange = Nothing,
                                 _hpsDefaultValue = Nothing,
                                 _hpsIsRequired = Nothing,
                                 _hpsDescription = Nothing, _hpsName = pName_,
                                 _hpsType = pType_}
