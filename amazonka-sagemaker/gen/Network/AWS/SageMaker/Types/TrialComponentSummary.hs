...
data TrialComponentSummary = TrialComponentSummary'{_tcsCreationTime
                                                    :: !(Maybe POSIX),
                                                    _tcsStatus ::
                                                    !(Maybe
...
trialComponentSummary
    :: TrialComponentSummary
trialComponentSummary
  = TrialComponentSummary'{_tcsCreationTime = Nothing,
                           _tcsStatus = Nothing, _tcsStartTime = Nothing,
...
instance FromJSON TrialComponentSummary where
        parseJSON
          = withObject "TrialComponentSummary"
              (\ x ->
                 TrialComponentSummary' <$>
...
instance Hashable TrialComponentSummary where

instance NFData TrialComponentSummary where
