...
data HumanTaskUiSummary = HumanTaskUiSummary'{_htusHumanTaskUiName
                                              :: !Text,
...
humanTaskUiSummary
    :: Text -- ^ 'htusHumanTaskUiName'
    -> Text -- ^ 'htusHumanTaskUiARN'
    -> UTCTime -- ^ 'htusCreationTime'
    -> HumanTaskUiSummary
humanTaskUiSummary pHumanTaskUiName_ pHumanTaskUiARN_
  pCreationTime_
  = HumanTaskUiSummary'{_htusHumanTaskUiName =
                          pHumanTaskUiName_,
...
instance FromJSON HumanTaskUiSummary where
        parseJSON
          = withObject "HumanTaskUiSummary"
              (\ x ->
                 HumanTaskUiSummary' <$>
                   (x .: "HumanTaskUiName") <*> (x .: "HumanTaskUiArn")
                     <*> (x .: "CreationTime"))

instance Hashable HumanTaskUiSummary where

instance NFData HumanTaskUiSummary where
