...
data ContinuousParameterRangeSpecification = ContinuousParameterRangeSpecification'{_cprsMinValue
                                                                                    ::
                                                                                    !Text,
                                                                                    _cprsMaxValue
                                                                                    ::
...
continuousParameterRangeSpecification
    ...
    -> Text -- ^ 'cprsMaxValue'
    -> ContinuousParameterRangeSpecification
continuousParameterRangeSpecification pMinValue_
  pMaxValue_
  = ContinuousParameterRangeSpecification'{_cprsMinValue
                                             = pMinValue_,
