...
newtype ProcessingStoppingCondition = ProcessingStoppingCondition'{_pscMaxRuntimeInSeconds
                                                                   :: Nat}
...
processingStoppingCondition
    :: Natural -- ^ 'pscMaxRuntimeInSeconds'
    -> ProcessingStoppingCondition
processingStoppingCondition pMaxRuntimeInSeconds_
  = ProcessingStoppingCondition'{_pscMaxRuntimeInSeconds
...
instance FromJSON ProcessingStoppingCondition where
        parseJSON
          = withObject "ProcessingStoppingCondition"
              (\ x ->
                 ProcessingStoppingCondition' <$>
                   (x .: "MaxRuntimeInSeconds"))

instance Hashable ProcessingStoppingCondition where

instance NFData ProcessingStoppingCondition where
