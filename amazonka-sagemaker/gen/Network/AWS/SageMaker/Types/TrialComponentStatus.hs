...
data TrialComponentStatus = TrialComponentStatus'{_tcsPrimaryStatus
                                                  ::
                                                  !(Maybe
...
trialComponentStatus
    :: TrialComponentStatus
trialComponentStatus
  = TrialComponentStatus'{_tcsPrimaryStatus = Nothing,
                          _tcsMessage = Nothing}
...
instance FromJSON TrialComponentStatus where
        parseJSON
          = withObject "TrialComponentStatus"
              (\ x ->
                 TrialComponentStatus' <$>
                   (x .:? "PrimaryStatus") <*> (x .:? "Message"))

instance Hashable TrialComponentStatus where

instance NFData TrialComponentStatus where
