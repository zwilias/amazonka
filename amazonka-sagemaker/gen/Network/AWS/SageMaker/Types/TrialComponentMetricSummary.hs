...
data TrialComponentMetricSummary = TrialComponentMetricSummary'{_tcmsMax
                                                                ::
                                                                !(Maybe Double),
                                                                _tcmsSourceARN
                                                                ::
...
trialComponentMetricSummary
    :: TrialComponentMetricSummary
trialComponentMetricSummary
  = TrialComponentMetricSummary'{_tcmsMax = Nothing,
                                 _tcmsSourceARN = Nothing, _tcmsAvg = Nothing,
                                 _tcmsCount = Nothing,
                                 _tcmsMetricName = Nothing,
                                 _tcmsStdDev = Nothing, _tcmsMin = Nothing,
                                 _tcmsLast = Nothing, _tcmsTimeStamp = Nothing}
...
instance FromJSON TrialComponentMetricSummary where
        parseJSON
          = withObject "TrialComponentMetricSummary"
              (\ x ->
                 TrialComponentMetricSummary' <$>
                   (x .:? "Max") <*> (x .:? "SourceArn") <*>
                     (x .:? "Avg")
...
instance Hashable TrialComponentMetricSummary where

instance NFData TrialComponentMetricSummary where
