...
data ProcessingS3Input = ProcessingS3Input'{_psiS3DataDistributionType
                                            ::
                                            !(Maybe
...
processingS3Input
    :: Text -- ^ 'psiS3URI'
    -> Text -- ^ 'psiLocalPath'
    -> ProcessingS3DataType -- ^ 'psiS3DataType'
    -> ProcessingS3InputMode -- ^ 'psiS3InputMode'
    -> ProcessingS3Input
processingS3Input pS3URI_ pLocalPath_ pS3DataType_
  pS3InputMode_
  = ProcessingS3Input'{_psiS3DataDistributionType =
                         Nothing,
                       _psiS3CompressionType = Nothing, _psiS3URI = pS3URI_,
...
instance Hashable ProcessingS3Input where

instance NFData ProcessingS3Input where
