...
data AlgorithmValidationProfile = AlgorithmValidationProfile'{_avpTransformJobDefinition
                                                              ::
                                                              !(Maybe
...
algorithmValidationProfile
    ...
    -> AlgorithmValidationProfile
algorithmValidationProfile pProfileName_
  pTrainingJobDefinition_
  = AlgorithmValidationProfile'{_avpTransformJobDefinition
                                  = Nothing,
