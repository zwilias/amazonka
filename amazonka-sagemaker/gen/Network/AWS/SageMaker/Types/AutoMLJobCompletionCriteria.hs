...
data AutoMLJobCompletionCriteria = AutoMLJobCompletionCriteria'{_amljccMaxCandidates
                                                                :: !(Maybe Nat),
...
autoMLJobCompletionCriteria
    :: AutoMLJobCompletionCriteria
autoMLJobCompletionCriteria
  = AutoMLJobCompletionCriteria'{_amljccMaxCandidates =
                                   Nothing,
                                 _amljccMaxRuntimePerTrainingJobInSeconds =
                                   Nothing,
...
instance FromJSON AutoMLJobCompletionCriteria where
        parseJSON
          = withObject "AutoMLJobCompletionCriteria"
              (\ x ->
                 AutoMLJobCompletionCriteria' <$>
                   (x .:? "MaxCandidates") <*>
...
instance Hashable AutoMLJobCompletionCriteria where

instance NFData AutoMLJobCompletionCriteria where
