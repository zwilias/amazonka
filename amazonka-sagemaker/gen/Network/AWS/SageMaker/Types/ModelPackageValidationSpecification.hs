...
data ModelPackageValidationSpecification = ModelPackageValidationSpecification'{_mpvsValidationRole
                                                                                ::
                                                                                !Text,
...
modelPackageValidationSpecification
    ...
    -> ModelPackageValidationSpecification
modelPackageValidationSpecification pValidationRole_
  pValidationProfiles_
  = ModelPackageValidationSpecification'{_mpvsValidationRole
                                           = pValidationRole_,
                                         _mpvsValidationProfiles =
