...
newtype HumanLoopRequestSource = HumanLoopRequestSource'{_hlrsAWSManagedHumanLoopRequestSource
                                                         ::
...
humanLoopRequestSource
    :: AWSManagedHumanLoopRequestSource -- ^ 'hlrsAWSManagedHumanLoopRequestSource'
    -> HumanLoopRequestSource
humanLoopRequestSource
  pAWSManagedHumanLoopRequestSource_
  = HumanLoopRequestSource'{_hlrsAWSManagedHumanLoopRequestSource
                              = pAWSManagedHumanLoopRequestSource_}
...
instance FromJSON HumanLoopRequestSource where
        parseJSON
          = withObject "HumanLoopRequestSource"
              (\ x ->
                 HumanLoopRequestSource' <$>
                   (x .: "AwsManagedHumanLoopRequestSource"))

instance Hashable HumanLoopRequestSource where

instance NFData HumanLoopRequestSource where
