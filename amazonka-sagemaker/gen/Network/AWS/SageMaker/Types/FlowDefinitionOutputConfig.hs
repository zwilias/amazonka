...
data FlowDefinitionOutputConfig = FlowDefinitionOutputConfig'{_fdocKMSKeyId
                                                              :: !(Maybe Text),
                                                              _fdocS3OutputPath
                                                              :: !Text}
...
flowDefinitionOutputConfig
    :: Text -- ^ 'fdocS3OutputPath'
    -> FlowDefinitionOutputConfig
flowDefinitionOutputConfig pS3OutputPath_
  = FlowDefinitionOutputConfig'{_fdocKMSKeyId =
                                  Nothing,
...
instance FromJSON FlowDefinitionOutputConfig where
        parseJSON
          = withObject "FlowDefinitionOutputConfig"
              (\ x ->
                 FlowDefinitionOutputConfig' <$>
                   (x .:? "KmsKeyId") <*> (x .: "S3OutputPath"))

instance Hashable FlowDefinitionOutputConfig where

instance NFData FlowDefinitionOutputConfig where
