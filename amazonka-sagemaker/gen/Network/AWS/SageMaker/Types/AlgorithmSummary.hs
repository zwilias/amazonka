...
data AlgorithmSummary = AlgorithmSummary'{_aAlgorithmDescription
                                          :: !(Maybe Text),
...
algorithmSummary
    ...
    -> AlgorithmSummary
algorithmSummary pAlgorithmName_ pAlgorithmARN_
  pCreationTime_ pAlgorithmStatus_
  = AlgorithmSummary'{_aAlgorithmDescription = Nothing,
