...
data MonitoringScheduleSummary = MonitoringScheduleSummary'{_mssEndpointName
                                                            :: !(Maybe Text),
...
monitoringScheduleSummary
    :: Text -- ^ 'mssMonitoringScheduleName'
    -> Text -- ^ 'mssMonitoringScheduleARN'
    -> UTCTime -- ^ 'mssCreationTime'
    -> UTCTime -- ^ 'mssLastModifiedTime'
    -> ScheduleStatus -- ^ 'mssMonitoringScheduleStatus'
    -> MonitoringScheduleSummary
monitoringScheduleSummary pMonitoringScheduleName_
  pMonitoringScheduleARN_ pCreationTime_
  pLastModifiedTime_ pMonitoringScheduleStatus_
  = MonitoringScheduleSummary'{_mssEndpointName =
                                 Nothing,
                               _mssMonitoringScheduleName =
...
instance FromJSON MonitoringScheduleSummary where
        parseJSON
          = withObject "MonitoringScheduleSummary"
              (\ x ->
                 MonitoringScheduleSummary' <$>
                   (x .:? "EndpointName") <*>
...
instance Hashable MonitoringScheduleSummary where

instance NFData MonitoringScheduleSummary where
