...
data ModelPackageValidationProfile = ModelPackageValidationProfile'{_mpvpProfileName
                                                                    :: !Text,
...
modelPackageValidationProfile
    ...
    -> ModelPackageValidationProfile
modelPackageValidationProfile pProfileName_
  pTransformJobDefinition_
  = ModelPackageValidationProfile'{_mpvpProfileName =
                                     pProfileName_,
                                   _mpvpTransformJobDefinition =
                                     pTransformJobDefinition_}
