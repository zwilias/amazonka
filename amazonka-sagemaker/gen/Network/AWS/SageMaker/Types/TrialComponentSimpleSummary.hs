...
data TrialComponentSimpleSummary = TrialComponentSimpleSummary'{_tcssCreationTime
                                                                ::
                                                                !(Maybe POSIX),
                                                                _tcssCreatedBy
                                                                ::
...
trialComponentSimpleSummary
    :: TrialComponentSimpleSummary
trialComponentSimpleSummary
  = TrialComponentSimpleSummary'{_tcssCreationTime =
                                   Nothing,
...
instance FromJSON TrialComponentSimpleSummary where
        parseJSON
          = withObject "TrialComponentSimpleSummary"
              (\ x ->
                 TrialComponentSimpleSummary' <$>
...
instance Hashable TrialComponentSimpleSummary where

instance NFData TrialComponentSimpleSummary where
