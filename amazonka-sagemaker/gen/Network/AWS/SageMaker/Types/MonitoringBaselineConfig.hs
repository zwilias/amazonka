...
data MonitoringBaselineConfig = MonitoringBaselineConfig'{_mbcConstraintsResource
                                                          ::
                                                          !(Maybe
...
monitoringBaselineConfig
    :: MonitoringBaselineConfig
monitoringBaselineConfig
  = MonitoringBaselineConfig'{_mbcConstraintsResource =
                                Nothing,
...
instance FromJSON MonitoringBaselineConfig where
        parseJSON
          = withObject "MonitoringBaselineConfig"
              (\ x ->
                 MonitoringBaselineConfig' <$>
                   (x .:? "ConstraintsResource") <*>
                     (x .:? "StatisticsResource"))

instance Hashable MonitoringBaselineConfig where

instance NFData MonitoringBaselineConfig where
