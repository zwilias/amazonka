...
data ExperimentSummary = ExperimentSummary'{_expCreationTime
                                            :: !(Maybe POSIX),
...
experimentSummary
    :: ExperimentSummary
experimentSummary
  = ExperimentSummary'{_expCreationTime = Nothing,
...
instance Hashable ExperimentSummary where

instance NFData ExperimentSummary where
