...
data DebugRuleEvaluationStatus = DebugRuleEvaluationStatus'{_dresLastModifiedTime
                                                            :: !(Maybe POSIX),
                                                            _dresStatusDetails
                                                            :: !(Maybe Text),
...
debugRuleEvaluationStatus
    :: DebugRuleEvaluationStatus
debugRuleEvaluationStatus
  = DebugRuleEvaluationStatus'{_dresLastModifiedTime =
                                 Nothing,
...
instance FromJSON DebugRuleEvaluationStatus where
        parseJSON
          = withObject "DebugRuleEvaluationStatus"
              (\ x ->
                 DebugRuleEvaluationStatus' <$>
                   (x .:? "LastModifiedTime") <*>
                     (x .:? "StatusDetails")
...
instance Hashable DebugRuleEvaluationStatus where

instance NFData DebugRuleEvaluationStatus where
