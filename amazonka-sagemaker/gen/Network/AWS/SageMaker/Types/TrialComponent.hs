...
data TrialComponent = TrialComponent'{_tcCreationTime
                                      :: !(Maybe POSIX),
                                      _tcStatus ::
...
trialComponent
    :: TrialComponent
trialComponent
  = TrialComponent'{_tcCreationTime = Nothing,
                    _tcStatus = Nothing, _tcSourceDetail = Nothing,
                    _tcMetrics = Nothing, _tcOutputArtifacts = Nothing,
                    _tcStartTime = Nothing, _tcCreatedBy = Nothing,
                    _tcLastModifiedTime = Nothing, _tcParents = Nothing,
                    _tcEndTime = Nothing,
                    _tcTrialComponentName = Nothing,
                    _tcParameters = Nothing, _tcSource = Nothing,
                    _tcDisplayName = Nothing,
                    _tcLastModifiedBy = Nothing,
                    _tcTrialComponentARN = Nothing,
                    _tcInputArtifacts = Nothing, _tcTags = Nothing}
...
instance Hashable TrialComponent where

instance NFData TrialComponent where
