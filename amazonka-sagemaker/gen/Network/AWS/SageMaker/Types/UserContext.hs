...
data UserContext = UserContext'{_ucUserProfileName ::
                                !(Maybe Text),
...
userContext
    :: UserContext
userContext
  = UserContext'{_ucUserProfileName = Nothing,
                 _ucUserProfileARN = Nothing, _ucDomainId = Nothing}
...
instance Hashable UserContext where

instance NFData UserContext where
