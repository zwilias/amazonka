...
data CodeRepositorySummary = CodeRepositorySummary'{_crsGitConfig
                                                    :: !(Maybe GitConfig),
...
codeRepositorySummary
    ...
    -> CodeRepositorySummary
codeRepositorySummary pCodeRepositoryName_
  pCodeRepositoryARN_ pCreationTime_ pLastModifiedTime_
  = CodeRepositorySummary'{_crsGitConfig = Nothing,
