...
data DebugHookConfig = DebugHookConfig'{_dhcLocalPath
                                        :: !(Maybe Text),
...
debugHookConfig
    :: Text -- ^ 'dhcS3OutputPath'
    -> DebugHookConfig
debugHookConfig pS3OutputPath_
  = DebugHookConfig'{_dhcLocalPath = Nothing,
...
instance Hashable DebugHookConfig where

instance NFData DebugHookConfig where
