...
data DomainDetails = DomainDetails'{_ddCreationTime
                                    :: !(Maybe POSIX),
...
domainDetails
    :: DomainDetails
domainDetails
  = DomainDetails'{_ddCreationTime = Nothing,
                   _ddStatus = Nothing, _ddDomainARN = Nothing,
                   _ddURL = Nothing, _ddLastModifiedTime = Nothing,
                   _ddDomainName = Nothing, _ddDomainId = Nothing}
