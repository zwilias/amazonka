...
data AutoMLS3DataSource = AutoMLS3DataSource'{_amlsdsS3DataType
                                              :: !AutoMLS3DataType,
                                              _amlsdsS3URI :: !Text}
...
autoMLS3DataSource
    :: AutoMLS3DataType -- ^ 'amlsdsS3DataType'
    -> Text -- ^ 'amlsdsS3URI'
    -> AutoMLS3DataSource
autoMLS3DataSource pS3DataType_ pS3URI_
  = AutoMLS3DataSource'{_amlsdsS3DataType =
                          pS3DataType_,
...
instance FromJSON AutoMLS3DataSource where
        parseJSON
          = withObject "AutoMLS3DataSource"
              (\ x ->
                 AutoMLS3DataSource' <$>
                   (x .: "S3DataType") <*> (x .: "S3Uri"))

instance Hashable AutoMLS3DataSource where

instance NFData AutoMLS3DataSource where
