...
newtype ProcessingResources = ProcessingResources'{_prClusterConfig
...
processingResources
    :: ProcessingClusterConfig -- ^ 'prClusterConfig'
    -> ProcessingResources
processingResources pClusterConfig_
  = ProcessingResources'{_prClusterConfig =
                           pClusterConfig_}
...
instance FromJSON ProcessingResources where
        parseJSON
          = withObject "ProcessingResources"
              (\ x ->
                 ProcessingResources' <$> (x .: "ClusterConfig"))

instance Hashable ProcessingResources where

instance NFData ProcessingResources where
