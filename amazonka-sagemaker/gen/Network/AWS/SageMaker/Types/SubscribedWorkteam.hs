...
data SubscribedWorkteam = SubscribedWorkteam'{_swMarketplaceTitle
                                              :: !(Maybe Text),
...
subscribedWorkteam pWorkteamARN_
  = SubscribedWorkteam'{_swMarketplaceTitle = Nothing,
                        _swSellerName = Nothing, _swListingId = Nothing,
