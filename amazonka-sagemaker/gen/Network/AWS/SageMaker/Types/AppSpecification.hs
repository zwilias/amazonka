...
data AppSpecification = AppSpecification'{_asContainerArguments
                                          :: !(Maybe (List1 Text)),
...
appSpecification pImageURI_
  = AppSpecification'{_asContainerArguments = Nothing,
...
instance Hashable AppSpecification where

instance NFData AppSpecification where
