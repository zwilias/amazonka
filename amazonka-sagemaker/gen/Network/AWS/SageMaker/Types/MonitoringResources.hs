...
newtype MonitoringResources = MonitoringResources'{_mrClusterConfig
...
monitoringResources
    :: MonitoringClusterConfig -- ^ 'mrClusterConfig'
    -> MonitoringResources
monitoringResources pClusterConfig_
  = MonitoringResources'{_mrClusterConfig =
                           pClusterConfig_}
...
instance FromJSON MonitoringResources where
        parseJSON
          = withObject "MonitoringResources"
              (\ x ->
                 MonitoringResources' <$> (x .: "ClusterConfig"))

instance Hashable MonitoringResources where

instance NFData MonitoringResources where
