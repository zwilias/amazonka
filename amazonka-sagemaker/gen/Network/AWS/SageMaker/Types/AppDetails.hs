...
data AppDetails = AppDetails'{_adCreationTime ::
                              !(Maybe POSIX),
...
appDetails
    :: AppDetails
appDetails
  = AppDetails'{_adCreationTime = Nothing,
                _adStatus = Nothing, _adUserProfileName = Nothing,
                _adAppName = Nothing, _adDomainId = Nothing,
                _adAppType = Nothing}
...
instance Hashable AppDetails where

instance NFData AppDetails where
