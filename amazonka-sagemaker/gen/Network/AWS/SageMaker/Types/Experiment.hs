...
data Experiment = Experiment'{_eCreationTime ::
                              !(Maybe POSIX),
...
experiment
    :: Experiment
experiment
  = Experiment'{_eCreationTime = Nothing,
                _eCreatedBy = Nothing, _eLastModifiedTime = Nothing,
                _eExperimentName = Nothing,
                _eExperimentARN = Nothing, _eSource = Nothing,
                _eDisplayName = Nothing, _eLastModifiedBy = Nothing,
                _eDescription = Nothing, _eTags = Nothing}
...
instance Hashable Experiment where

instance NFData Experiment where
