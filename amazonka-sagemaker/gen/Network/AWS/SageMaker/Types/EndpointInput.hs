...
data EndpointInput = EndpointInput'{_eiS3DataDistributionType
                                    ::
...
endpointInput pEndpointName_ pLocalPath_
  = EndpointInput'{_eiS3DataDistributionType = Nothing,
...
instance Hashable EndpointInput where

instance NFData EndpointInput where
