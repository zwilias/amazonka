...
data AutoMLOutputDataConfig = AutoMLOutputDataConfig'{_amlodcKMSKeyId
                                                      :: !(Maybe Text),
                                                      _amlodcS3OutputPath ::
                                                      !Text}
...
autoMLOutputDataConfig
    :: Text -- ^ 'amlodcS3OutputPath'
    -> AutoMLOutputDataConfig
autoMLOutputDataConfig pS3OutputPath_
  = AutoMLOutputDataConfig'{_amlodcKMSKeyId = Nothing,
...
instance FromJSON AutoMLOutputDataConfig where
        parseJSON
          = withObject "AutoMLOutputDataConfig"
              (\ x ->
                 AutoMLOutputDataConfig' <$>
                   (x .:? "KmsKeyId") <*> (x .: "S3OutputPath"))

instance Hashable AutoMLOutputDataConfig where

instance NFData AutoMLOutputDataConfig where
