...
data HyperParameterTuningJobConfig = HyperParameterTuningJobConfig'{_hptjcTuningJobCompletionCriteria
                                                                    ::
                                                                    !(Maybe
...
hyperParameterTuningJobConfig
    ...
    -> HyperParameterTuningJobConfig
hyperParameterTuningJobConfig pStrategy_
  pResourceLimits_
  = HyperParameterTuningJobConfig'{_hptjcTuningJobCompletionCriteria
                                     = Nothing,
