...
data LabelCountersForWorkteam = LabelCountersForWorkteam'{_lcfwPendingHuman
                                                          :: !(Maybe Nat),
                                                          _lcfwTotal ::
                                                          !(Maybe Nat),
                                                          _lcfwHumanLabeled ::
...
labelCountersForWorkteam
    :: LabelCountersForWorkteam
labelCountersForWorkteam
  = LabelCountersForWorkteam'{_lcfwPendingHuman =
                                Nothing,
                              _lcfwTotal = Nothing, _lcfwHumanLabeled = Nothing}
