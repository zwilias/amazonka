...
newtype MonitoringStoppingCondition = MonitoringStoppingCondition'{_mscMaxRuntimeInSeconds
                                                                   :: Nat}
...
monitoringStoppingCondition
    :: Natural -- ^ 'mscMaxRuntimeInSeconds'
    -> MonitoringStoppingCondition
monitoringStoppingCondition pMaxRuntimeInSeconds_
  = MonitoringStoppingCondition'{_mscMaxRuntimeInSeconds
...
instance FromJSON MonitoringStoppingCondition where
        parseJSON
          = withObject "MonitoringStoppingCondition"
              (\ x ->
                 MonitoringStoppingCondition' <$>
                   (x .: "MaxRuntimeInSeconds"))

instance Hashable MonitoringStoppingCondition where

instance NFData MonitoringStoppingCondition where
