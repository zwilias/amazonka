...
data UserSettings = UserSettings'{_usTensorBoardAppSettings
...
--
-- * 'usSecurityGroups' - The security groups.
--
...
userSettings
    :: UserSettings
userSettings
  = UserSettings'{_usTensorBoardAppSettings = Nothing,
...
instance Hashable UserSettings where

instance NFData UserSettings where
