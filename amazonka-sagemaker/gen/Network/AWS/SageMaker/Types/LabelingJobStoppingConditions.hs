...
data LabelingJobStoppingConditions = LabelingJobStoppingConditions'{_ljscMaxHumanLabeledObjectCount
                                                                    ::
                                                                    !(Maybe
                                                                        Nat),
...
labelingJobStoppingConditions
    :: LabelingJobStoppingConditions
labelingJobStoppingConditions
  = LabelingJobStoppingConditions'{_ljscMaxHumanLabeledObjectCount
                                     = Nothing,
                                   _ljscMaxPercentageOfInputDatasetLabeled =
                                     Nothing}
