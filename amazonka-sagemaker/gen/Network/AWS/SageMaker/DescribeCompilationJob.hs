...
newtype DescribeCompilationJob = DescribeCompilationJob'{_dcjCompilationJobName
                                                         :: Text}
...
describeCompilationJob pCompilationJobName_
  = DescribeCompilationJob'{_dcjCompilationJobName =
...
data DescribeCompilationJobResponse = DescribeCompilationJobResponse'{_dcjrsCompilationStartTime
                                                                      ::
                                                                      !(Maybe
                                                                          POSIX),
...
describeCompilationJobResponse
    ...
    -> DescribeCompilationJobResponse
describeCompilationJobResponse pResponseStatus_
  pCompilationJobName_ pCompilationJobARN_
  pCompilationJobStatus_ pStoppingCondition_
  pCreationTime_ pLastModifiedTime_ pFailureReason_
  pModelArtifacts_ pRoleARN_ pInputConfig_
  pOutputConfig_
  = DescribeCompilationJobResponse'{_dcjrsCompilationStartTime
                                      = Nothing,
