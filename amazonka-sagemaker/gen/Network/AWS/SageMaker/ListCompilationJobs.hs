...
data ListCompilationJobs = ListCompilationJobs'{_lcjNameContains
                                                :: !(Maybe Text),
...
listCompilationJobs
    :: ListCompilationJobs
listCompilationJobs
  = ListCompilationJobs'{_lcjNameContains = Nothing,
                         _lcjLastModifiedTimeBefore = Nothing,
                         _lcjCreationTimeAfter = Nothing,
                         _lcjNextToken = Nothing, _lcjSortOrder = Nothing,
                         _lcjLastModifiedTimeAfter = Nothing,
                         _lcjCreationTimeBefore = Nothing,
                         _lcjStatusEquals = Nothing, _lcjMaxResults = Nothing,
                         _lcjSortBy = Nothing}
...
data ListCompilationJobsResponse = ListCompilationJobsResponse'{_lcjrsNextToken
                                                                ::
                                                                !(Maybe Text),
...
listCompilationJobsResponse pResponseStatus_
  = ListCompilationJobsResponse'{_lcjrsNextToken =
                                   Nothing,
