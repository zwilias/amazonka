...
newtype DescribeHyperParameterTuningJob = DescribeHyperParameterTuningJob'{_dhptjHyperParameterTuningJobName
                                                                           ::
                                                                           Text}
...
describeHyperParameterTuningJob
  ...
  = DescribeHyperParameterTuningJob'{_dhptjHyperParameterTuningJobName
                                       = pHyperParameterTuningJobName_}
...
data DescribeHyperParameterTuningJobResponse = DescribeHyperParameterTuningJobResponse'{_dhptjrsFailureReason
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
describeHyperParameterTuningJobResponse
    ...
    -> DescribeHyperParameterTuningJobResponse
describeHyperParameterTuningJobResponse
  pResponseStatus_ pHyperParameterTuningJobName_
  pHyperParameterTuningJobARN_
  pHyperParameterTuningJobConfig_
  pHyperParameterTuningJobStatus_ pCreationTime_
  pTrainingJobStatusCounters_ pObjectiveStatusCounters_
  = DescribeHyperParameterTuningJobResponse'{_dhptjrsFailureReason
                                               = Nothing,
                                             _dhptjrsTrainingJobDefinition =
                                               Nothing,
