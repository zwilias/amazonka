...
newtype DescribeLabelingJob = DescribeLabelingJob'{_dljLabelingJobName
                                                   :: Text}
...
describeLabelingJob pLabelingJobName_
  = DescribeLabelingJob'{_dljLabelingJobName =
                           pLabelingJobName_}
...
data DescribeLabelingJobResponse = DescribeLabelingJobResponse'{_dljrsFailureReason
                                                                ::
                                                                !(Maybe Text),
                                                                ...
                                                                _dljrsCreationTime
                                                                :: !POSIX,
                                                                _dljrsLastModifiedTime
                                                                :: !POSIX,
                                                                _dljrsJobReferenceCode
                                                                :: !Text,
                                                                _dljrsLabelingJobName
                                                                :: !Text,
                                                                _dljrsLabelingJobARN
                                                                :: !Text,
                                                                _dljrsInputConfig
                                                                ::
...
describeLabelingJobResponse
    ...
    -> DescribeLabelingJobResponse
describeLabelingJobResponse pResponseStatus_
  pLabelingJobStatus_ pLabelCounters_ pCreationTime_
  pLastModifiedTime_ pJobReferenceCode_
  pLabelingJobName_ pLabelingJobARN_ pInputConfig_
  pOutputConfig_ pRoleARN_ pHumanTaskConfig_
  = DescribeLabelingJobResponse'{_dljrsFailureReason =
                                   Nothing,
