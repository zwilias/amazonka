...
data CreateModelPackage = CreateModelPackage'{_cmpSourceAlgorithmSpecification
                                              ::
                                              !(Maybe
...
createModelPackage pModelPackageName_
  = CreateModelPackage'{_cmpSourceAlgorithmSpecification
                          = Nothing,
...
data CreateModelPackageResponse = CreateModelPackageResponse'{_cmprsResponseStatus
                                                              :: !Int,
                                                              _cmprsModelPackageARN
                                                              :: !Text}
...
createModelPackageResponse
    ...
    -> CreateModelPackageResponse
createModelPackageResponse pResponseStatus_
  pModelPackageARN_
  = CreateModelPackageResponse'{_cmprsResponseStatus =
                                  pResponseStatus_,
