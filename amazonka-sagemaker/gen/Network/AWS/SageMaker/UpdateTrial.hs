...
data UpdateTrial = UpdateTrial'{_utDisplayName ::
                                !(Maybe Text),
                                _utTrialName :: !Text}
...
updateTrial pTrialName_
  = UpdateTrial'{_utDisplayName = Nothing,
...
instance Hashable UpdateTrial where

instance NFData UpdateTrial where
...
data UpdateTrialResponse = UpdateTrialResponse'{_utrsTrialARN
                                                :: !(Maybe Text),
...
updateTrialResponse pResponseStatus_
  = UpdateTrialResponse'{_utrsTrialARN = Nothing,
...
instance NFData UpdateTrialResponse where
