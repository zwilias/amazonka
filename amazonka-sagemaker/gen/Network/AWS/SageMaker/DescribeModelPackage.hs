...
newtype DescribeModelPackage = DescribeModelPackage'{_dModelPackageName
                                                     :: Text}
...
describeModelPackage pModelPackageName_
  = DescribeModelPackage'{_dModelPackageName =
                            pModelPackageName_}
...
data DescribeModelPackageResponse = DescribeModelPackageResponse'{_dmprsSourceAlgorithmSpecification
                                                                  ::
                                                                  !(Maybe
                                                                  ...
                                                                  :: !Int,
                                                                  _dmprsModelPackageName
                                                                  :: !Text,
                                                                  _dmprsModelPackageARN
                                                                  :: !Text,
                                                                  _dmprsCreationTime
                                                                  :: !POSIX,
...
describeModelPackageResponse
    ...
    -> DescribeModelPackageResponse
describeModelPackageResponse pResponseStatus_
  pModelPackageName_ pModelPackageARN_ pCreationTime_
  pModelPackageStatus_ pModelPackageStatusDetails_
  = DescribeModelPackageResponse'{_dmprsSourceAlgorithmSpecification
                                    = Nothing,
