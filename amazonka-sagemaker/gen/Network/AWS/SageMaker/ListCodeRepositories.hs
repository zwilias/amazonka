...
data ListCodeRepositories = ListCodeRepositories'{_lcrNameContains
                                                  :: !(Maybe Text),
...
listCodeRepositories
    :: ListCodeRepositories
listCodeRepositories
  = ListCodeRepositories'{_lcrNameContains = Nothing,
                          _lcrLastModifiedTimeBefore = Nothing,
                          _lcrCreationTimeAfter = Nothing,
                          _lcrNextToken = Nothing, _lcrSortOrder = Nothing,
                          _lcrLastModifiedTimeAfter = Nothing,
                          _lcrCreationTimeBefore = Nothing,
                          _lcrMaxResults = Nothing, _lcrSortBy = Nothing}
...
data ListCodeRepositoriesResponse = ListCodeRepositoriesResponse'{_lcrrsNextToken
                                                                  ::
                                                                  !(Maybe Text),
...
listCodeRepositoriesResponse pResponseStatus_
  = ListCodeRepositoriesResponse'{_lcrrsNextToken =
                                    Nothing,
