...
data CreatePresignedDomainURL = CreatePresignedDomainURL'{_cpduSessionExpirationDurationInSeconds
                                                          :: !(Maybe Nat),
                                                          _cpduDomainId ::
                                                          !Text,
...
createPresignedDomainURL
    :: Text -- ^ 'cpduDomainId'
    -> Text -- ^ 'cpduUserProfileName'
    -> CreatePresignedDomainURL
createPresignedDomainURL pDomainId_ pUserProfileName_
  = CreatePresignedDomainURL'{_cpduSessionExpirationDurationInSeconds
                                = Nothing,
...
instance AWSRequest CreatePresignedDomainURL where
        type Rs CreatePresignedDomainURL =
             CreatePresignedDomainURLResponse
...
instance Hashable CreatePresignedDomainURL where

instance NFData CreatePresignedDomainURL where
...
data CreatePresignedDomainURLResponse = CreatePresignedDomainURLResponse'{_cpdursAuthorizedURL
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
createPresignedDomainURLResponse
    :: Int -- ^ 'cpdursResponseStatus'
    -> CreatePresignedDomainURLResponse
createPresignedDomainURLResponse pResponseStatus_
  = CreatePresignedDomainURLResponse'{_cpdursAuthorizedURL
                                        = Nothing,
