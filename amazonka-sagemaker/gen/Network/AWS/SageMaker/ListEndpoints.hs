...
data ListEndpoints = ListEndpoints'{_lesNameContains
                                    :: !(Maybe Text),
                                    _lesLastModifiedTimeBefore ::
                                    !(Maybe POSIX),
...
listEndpoints
    :: ListEndpoints
listEndpoints
  = ListEndpoints'{_lesNameContains = Nothing,
                   _lesLastModifiedTimeBefore = Nothing,
                   _lesCreationTimeAfter = Nothing,
                   _lesNextToken = Nothing, _lesSortOrder = Nothing,
                   _lesLastModifiedTimeAfter = Nothing,
                   _lesCreationTimeBefore = Nothing,
                   _lesStatusEquals = Nothing, _lesMaxResults = Nothing,
                   _lesSortBy = Nothing}
...
data ListEndpointsResponse = ListEndpointsResponse'{_lesrsNextToken
                                                    :: !(Maybe Text),
...
listEndpointsResponse pResponseStatus_
  = ListEndpointsResponse'{_lesrsNextToken = Nothing,
