...
newtype DeleteFlowDefinition = DeleteFlowDefinition'{_dfdFlowDefinitionName
                                                     :: Text}
...
deleteFlowDefinition
    :: Text -- ^ 'dfdFlowDefinitionName'
    -> DeleteFlowDefinition
deleteFlowDefinition pFlowDefinitionName_
  = DeleteFlowDefinition'{_dfdFlowDefinitionName =
...
instance Hashable DeleteFlowDefinition where

instance NFData DeleteFlowDefinition where
...
newtype DeleteFlowDefinitionResponse = DeleteFlowDefinitionResponse'{_dfdrsResponseStatus
                                                                     :: Int}
...
deleteFlowDefinitionResponse pResponseStatus_
  = DeleteFlowDefinitionResponse'{_dfdrsResponseStatus
                                    = pResponseStatus_}
...
instance NFData DeleteFlowDefinitionResponse where
