...
data ListTransformJobs = ListTransformJobs'{_ltjNameContains
                                            :: !(Maybe Text),
...
listTransformJobs
    :: ListTransformJobs
listTransformJobs
  = ListTransformJobs'{_ltjNameContains = Nothing,
...
instance AWSPager ListTransformJobs where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ltjNextToken .~ rs ^. ltjsrsNextToken
...
data ListTransformJobsResponse = ListTransformJobsResponse'{_ltjsrsNextToken
                                                            :: !(Maybe Text),
                                                            _ltjsrsResponseStatus
                                                            :: !Int,
...
listTransformJobsResponse
    :: Int -- ^ 'ltjsrsResponseStatus'
    -> ListTransformJobsResponse
listTransformJobsResponse pResponseStatus_
  = ListTransformJobsResponse'{_ltjsrsNextToken =
                                 Nothing,
