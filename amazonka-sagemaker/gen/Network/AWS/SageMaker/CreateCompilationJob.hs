...
data CreateCompilationJob = CreateCompilationJob'{_ccjCompilationJobName
                                                  :: !Text,
                                                  _ccjRoleARN :: !Text,
                                                  _ccjInputConfig ::
                                                  !InputConfig,
...
createCompilationJob
    ...
    -> CreateCompilationJob
createCompilationJob pCompilationJobName_ pRoleARN_
  pInputConfig_ pOutputConfig_ pStoppingCondition_
  = CreateCompilationJob'{_ccjCompilationJobName =
...
data CreateCompilationJobResponse = CreateCompilationJobResponse'{_ccjrsResponseStatus
                                                                  :: !Int,
                                                                  _ccjrsCompilationJobARN
                                                                  :: !Text}
...
createCompilationJobResponse
    ...
    -> CreateCompilationJobResponse
createCompilationJobResponse pResponseStatus_
  pCompilationJobARN_
  = CreateCompilationJobResponse'{_ccjrsResponseStatus
                                    = pResponseStatus_,
