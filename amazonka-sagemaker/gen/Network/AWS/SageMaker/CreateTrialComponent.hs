...
data CreateTrialComponent = CreateTrialComponent'{_ctcStatus
                                                  ::
...
createTrialComponent
    :: Text -- ^ 'ctcTrialComponentName'
    -> CreateTrialComponent
createTrialComponent pTrialComponentName_
  = CreateTrialComponent'{_ctcStatus = Nothing,
                          _ctcOutputArtifacts = Nothing,
                          _ctcStartTime = Nothing, _ctcEndTime = Nothing,
                          _ctcParameters = Nothing, _ctcDisplayName = Nothing,
                          _ctcInputArtifacts = Nothing, _ctcTags = Nothing,
...
instance Hashable CreateTrialComponent where

instance NFData CreateTrialComponent where
...
data CreateTrialComponentResponse = CreateTrialComponentResponse'{_ctcrsTrialComponentARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _ctcrsResponseStatus
                                                                  :: !Int}
...
createTrialComponentResponse
    :: Int -- ^ 'ctcrsResponseStatus'
    -> CreateTrialComponentResponse
createTrialComponentResponse pResponseStatus_
  = CreateTrialComponentResponse'{_ctcrsTrialComponentARN
                                    = Nothing,
...
instance NFData CreateTrialComponentResponse where
