...
data GetSearchSuggestions = GetSearchSuggestions'{_gssSuggestionQuery
...
getSearchSuggestions pResource_
  = GetSearchSuggestions'{_gssSuggestionQuery =
                            Nothing,
...
data GetSearchSuggestionsResponse = GetSearchSuggestionsResponse'{_gssrsPropertyNameSuggestions
                                                                  ::
                                                                  !(Maybe
...
getSearchSuggestionsResponse pResponseStatus_
  = GetSearchSuggestionsResponse'{_gssrsPropertyNameSuggestions
                                    = Nothing,
