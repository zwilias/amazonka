...
dtjTrainingJobName =
  lens _dtjTrainingJobName (\s a -> s {_dtjTrainingJobName = a})
...
instance AWSRequest DescribeTrainingJob where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeTrainingJobResponse' <$> (x .?> "FailureReason") <*>
         (x .?> "TrainingEndTime") <*>
         (x .?> "LastModifiedTime") <*>
...
instance ToJSON DescribeTrainingJob where
  toJSON DescribeTrainingJob' {..} =
    object (catMaybes [Just ("TrainingJobName" .= _dtjTrainingJobName)])
...
dtjrsOutputDataConfig ::
     Lens' DescribeTrainingJobResponse (Maybe OutputDataConfig)
dtjrsOutputDataConfig =
  lens _dtjrsOutputDataConfig (\s a -> s {_dtjrsOutputDataConfig = a})

-- | A timestamp that indicates when training started.
dtjrsTrainingStartTime :: Lens' DescribeTrainingJobResponse (Maybe UTCTime)
dtjrsTrainingStartTime =
  lens _dtjrsTrainingStartTime (\s a -> s {_dtjrsTrainingStartTime = a}) .
  mapping _Time
...
dtjrsResponseStatus =
  lens _dtjrsResponseStatus (\s a -> s {_dtjrsResponseStatus = a})

-- | Name of the model training job.
dtjrsTrainingJobName :: Lens' DescribeTrainingJobResponse Text
dtjrsTrainingJobName =
  lens _dtjrsTrainingJobName (\s a -> s {_dtjrsTrainingJobName = a})

-- | The Amazon Resource Name (ARN) of the training job.
dtjrsTrainingJobARN :: Lens' DescribeTrainingJobResponse Text
dtjrsTrainingJobARN =
  lens _dtjrsTrainingJobARN (\s a -> s {_dtjrsTrainingJobARN = a})

-- | Information about the Amazon S3 location that is configured for storing model artifacts.
dtjrsModelArtifacts :: Lens' DescribeTrainingJobResponse ModelArtifacts
dtjrsModelArtifacts =
  lens _dtjrsModelArtifacts (\s a -> s {_dtjrsModelArtifacts = a})
...
dtjrsTrainingJobStatus =
  lens _dtjrsTrainingJobStatus (\s a -> s {_dtjrsTrainingJobStatus = a})
...
dtjrsSecondaryStatus =
  lens _dtjrsSecondaryStatus (\s a -> s {_dtjrsSecondaryStatus = a})

-- | Information about the algorithm used for training, and algorithm metadata.
dtjrsAlgorithmSpecification ::
     Lens' DescribeTrainingJobResponse AlgorithmSpecification
dtjrsAlgorithmSpecification =
  lens
    _dtjrsAlgorithmSpecification
    (\s a -> s {_dtjrsAlgorithmSpecification = a})

-- | An array of @Channel@ objects that describes each data input channel.
dtjrsInputDataConfig :: Lens' DescribeTrainingJobResponse (NonEmpty Channel)
dtjrsInputDataConfig =
  lens _dtjrsInputDataConfig (\s a -> s {_dtjrsInputDataConfig = a}) . _List1

-- | Resources, including ML compute instances and ML storage volumes, that are configured for model training.
dtjrsResourceConfig :: Lens' DescribeTrainingJobResponse ResourceConfig
dtjrsResourceConfig =
  lens _dtjrsResourceConfig (\s a -> s {_dtjrsResourceConfig = a})

-- | The condition under which to stop the training job.
dtjrsStoppingCondition :: Lens' DescribeTrainingJobResponse StoppingCondition
dtjrsStoppingCondition =
  lens _dtjrsStoppingCondition (\s a -> s {_dtjrsStoppingCondition = a})

-- | A timestamp that indicates when the training job was created.
dtjrsCreationTime :: Lens' DescribeTrainingJobResponse UTCTime
dtjrsCreationTime =
  lens _dtjrsCreationTime (\s a -> s {_dtjrsCreationTime = a}) . _Time
