...
data DescribeApp = DescribeApp'{_daDomainId :: !Text,
                                _daUserProfileName :: !Text,
                                _daAppType :: !AppType, _daAppName :: !Text}
...
describeApp
    :: Text -- ^ 'daDomainId'
    -> Text -- ^ 'daUserProfileName'
    -> AppType -- ^ 'daAppType'
    -> Text -- ^ 'daAppName'
    -> DescribeApp
describeApp pDomainId_ pUserProfileName_ pAppType_
  pAppName_
  = DescribeApp'{_daDomainId = pDomainId_,
                 _daUserProfileName = pUserProfileName_,
                 _daAppType = pAppType_, _daAppName = pAppName_}
...
instance Hashable DescribeApp where

instance NFData DescribeApp where
...
data DescribeAppResponse = DescribeAppResponse'{_darsCreationTime
                                                :: !(Maybe POSIX),
                                                _darsStatus ::
                                                !(Maybe AppStatus),
                                                _darsFailureReason ::
                                                ...
                                                _darsResourceSpec ::
                                                !(Maybe ResourceSpec),
                                                _darsUserProfileName ::
                                                !(Maybe Text),
                                                _darsLastUserActivityTimestamp
                                                :: !(Maybe POSIX),
                                                _darsLastHealthCheckTimestamp ::
                                                !(Maybe POSIX),
...
--
-- * 'darsResourceSpec' - The instance type and quantity.
--
...
--
-- * 'darsAppARN' - The app's Amazon Resource Name (ARN).
--
...
describeAppResponse pResponseStatus_
  = DescribeAppResponse'{_darsCreationTime = Nothing,
                         _darsStatus = Nothing, _darsFailureReason = Nothing,
                         ...
                         _darsAppName = Nothing, _darsAppARN = Nothing,
                         _darsDomainId = Nothing, _darsAppType = Nothing,
...
instance NFData DescribeAppResponse where
