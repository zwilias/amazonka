...
data CreateModel = CreateModel'{_cmPrimaryContainer
...
createModel pModelName_ pExecutionRoleARN_
  = CreateModel'{_cmPrimaryContainer = Nothing,
                 _cmEnableNetworkIsolation = Nothing,
                 _cmContainers = Nothing, _cmVPCConfig = Nothing,
                 _cmTags = Nothing, _cmModelName = pModelName_,
...
data CreateModelResponse = CreateModelResponse'{_cmrsResponseStatus
                                                :: !Int,
                                                _cmrsModelARN :: !Text}
                             deriving (Eq, Read, Show, Data, Typeable, Generic)
...
createModelResponse pResponseStatus_ pModelARN_
  = CreateModelResponse'{_cmrsResponseStatus =
                           pResponseStatus_,
