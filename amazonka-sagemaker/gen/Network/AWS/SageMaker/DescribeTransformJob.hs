...
newtype DescribeTransformJob = DescribeTransformJob'{_dtjTransformJobName
                                                     :: Text}
...
describeTransformJob pTransformJobName_
  = DescribeTransformJob'{_dtjTransformJobName =
                            pTransformJobName_}
...
data DescribeTransformJobResponse = DescribeTransformJobResponse'{_dtjrsLabelingJobARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _dtjrsFailureReason
                                                                  ::
                                                                  ...
                                                                  :: !Int,
                                                                  _dtjrsTransformJobName
                                                                  :: !Text,
                                                                  _dtjrsTransformJobARN
                                                                  :: !Text,
...
describeTransformJobResponse
    ...
    -> DescribeTransformJobResponse
describeTransformJobResponse pResponseStatus_
  pTransformJobName_ pTransformJobARN_
  pTransformJobStatus_ pModelName_ pTransformInput_
  pTransformResources_ pCreationTime_
  = DescribeTransformJobResponse'{_dtjrsLabelingJobARN
                                    = Nothing,
