...
newtype DeleteTrial = DeleteTrial'{_dTrialName ::
                                   Text}
...
instance Hashable DeleteTrial where

instance NFData DeleteTrial where
...
data DeleteTrialResponse = DeleteTrialResponse'{_drsTrialARN
                                                :: !(Maybe Text),
...
deleteTrialResponse pResponseStatus_
  = DeleteTrialResponse'{_drsTrialARN = Nothing,
...
instance NFData DeleteTrialResponse where
