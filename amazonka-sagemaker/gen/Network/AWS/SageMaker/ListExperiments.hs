...
data ListExperiments = ListExperiments'{_leCreatedAfter
                                        :: !(Maybe POSIX),
...
listExperiments
    :: ListExperiments
listExperiments
  = ListExperiments'{_leCreatedAfter = Nothing,
                     _leNextToken = Nothing, _leSortOrder = Nothing,
                     _leMaxResults = Nothing, _leCreatedBefore = Nothing,
                     _leSortBy = Nothing}
...
instance Hashable ListExperiments where

instance NFData ListExperiments where
...
data ListExperimentsResponse = ListExperimentsResponse'{_lersExperimentSummaries
                                                        ::
                                                        !(Maybe
                                                            [ExperimentSummary]),
                                                        _lersNextToken ::
...
listExperimentsResponse pResponseStatus_
  = ListExperimentsResponse'{_lersExperimentSummaries =
                               Nothing,
...
instance NFData ListExperimentsResponse where
