...
data CreateTransformJob = CreateTransformJob'{_ctjBatchStrategy
                                              :: !(Maybe BatchStrategy),
                                              _ctjMaxPayloadInMB ::
                                              !(Maybe Nat),
                                              _ctjEnvironment ::
...
createTransformJob
    ...
    -> CreateTransformJob
createTransformJob pTransformJobName_ pModelName_
  pTransformInput_ pTransformOutput_
  pTransformResources_
  = CreateTransformJob'{_ctjBatchStrategy = Nothing,
                        _ctjMaxPayloadInMB = Nothing,
                        _ctjEnvironment = Nothing,
                        _ctjExperimentConfig = Nothing,
                        _ctjMaxConcurrentTransforms = Nothing,
                        _ctjDataProcessing = Nothing, _ctjTags = Nothing,
...
data CreateTransformJobResponse = CreateTransformJobResponse'{_ctjrsResponseStatus
                                                              :: !Int,
                                                              _ctjrsTransformJobARN
                                                              :: !Text}
...
createTransformJobResponse
    ...
    -> CreateTransformJobResponse
createTransformJobResponse pResponseStatus_
  pTransformJobARN_
  = CreateTransformJobResponse'{_ctjrsResponseStatus =
                                  pResponseStatus_,
