...
data UpdateMonitoringSchedule = UpdateMonitoringSchedule'{_umsMonitoringScheduleName
                                                          :: !Text,
...
updateMonitoringSchedule
    :: Text -- ^ 'umsMonitoringScheduleName'
    -> MonitoringScheduleConfig -- ^ 'umsMonitoringScheduleConfig'
    -> UpdateMonitoringSchedule
updateMonitoringSchedule pMonitoringScheduleName_
  pMonitoringScheduleConfig_
  = UpdateMonitoringSchedule'{_umsMonitoringScheduleName
...
instance AWSRequest UpdateMonitoringSchedule where
        type Rs UpdateMonitoringSchedule =
             UpdateMonitoringScheduleResponse
...
instance Hashable UpdateMonitoringSchedule where

instance NFData UpdateMonitoringSchedule where
...
data UpdateMonitoringScheduleResponse = UpdateMonitoringScheduleResponse'{_umsrsResponseStatus
                                                                          ::
                                                                          !Int,
...
updateMonitoringScheduleResponse
    :: Int -- ^ 'umsrsResponseStatus'
    -> Text -- ^ 'umsrsMonitoringScheduleARN'
    -> UpdateMonitoringScheduleResponse
updateMonitoringScheduleResponse pResponseStatus_
  pMonitoringScheduleARN_
  = UpdateMonitoringScheduleResponse'{_umsrsResponseStatus
                                        = pResponseStatus_,
                                      _umsrsMonitoringScheduleARN =
                                        pMonitoringScheduleARN_}
