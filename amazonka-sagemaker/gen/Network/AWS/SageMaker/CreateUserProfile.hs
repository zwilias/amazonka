...
data CreateUserProfile = CreateUserProfile'{_cupUserSettings
                                            :: !(Maybe UserSettings),
...
data CreateUserProfileResponse = CreateUserProfileResponse'{_cuprsUserProfileARN
                                                            :: !(Maybe Text),
...
createUserProfileResponse pResponseStatus_
  = CreateUserProfileResponse'{_cuprsUserProfileARN =
                                 Nothing,
