...
newtype DescribeCodeRepository = DescribeCodeRepository'{_dcrCodeRepositoryName
                                                         :: Text}
...
describeCodeRepository pCodeRepositoryName_
  = DescribeCodeRepository'{_dcrCodeRepositoryName =
...
data DescribeCodeRepositoryResponse = DescribeCodeRepositoryResponse'{_dcrrsGitConfig
                                                                      ::
                                                                      !(Maybe
                                                                          GitConfig),
...
describeCodeRepositoryResponse
    ...
    -> DescribeCodeRepositoryResponse
describeCodeRepositoryResponse pResponseStatus_
  pCodeRepositoryName_ pCodeRepositoryARN_
  pCreationTime_ pLastModifiedTime_
  = DescribeCodeRepositoryResponse'{_dcrrsGitConfig =
                                      Nothing,
