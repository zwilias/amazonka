...
dniNotebookInstanceName =
  lens _dniNotebookInstanceName (\s a -> s {_dniNotebookInstanceName = a})
...
instance AWSRequest DescribeNotebookInstance where
  ...
  response =
    receiveJSON
      (\s h x ->
         DescribeNotebookInstanceResponse' <$> (x .?> "CreationTime") <*>
         (x .?> "FailureReason") <*>
...
instance ToJSON DescribeNotebookInstance where
  toJSON DescribeNotebookInstance' {..} =
    object
      (catMaybes [Just ("NotebookInstanceName" .= _dniNotebookInstanceName)])
...
dnirsCreationTime =
  lens _dnirsCreationTime (\s a -> s {_dnirsCreationTime = a}) . mapping _Time

-- | If status is failed, the reason it failed.
dnirsFailureReason :: Lens' DescribeNotebookInstanceResponse (Maybe Text)
dnirsFailureReason =
  lens _dnirsFailureReason (\s a -> s {_dnirsFailureReason = a})

-- | Name of the Amazon SageMaker notebook instance.
dnirsNotebookInstanceName :: Lens' DescribeNotebookInstanceResponse (Maybe Text)
dnirsNotebookInstanceName =
  lens _dnirsNotebookInstanceName (\s a -> s {_dnirsNotebookInstanceName = a})

-- | The IDs of the VPC security groups.
dnirsSecurityGroups :: Lens' DescribeNotebookInstanceResponse [Text]
dnirsSecurityGroups =
  lens _dnirsSecurityGroups (\s a -> s {_dnirsSecurityGroups = a}) .
  _Default . _Coerce
...
dnirsLastModifiedTime =
  lens _dnirsLastModifiedTime (\s a -> s {_dnirsLastModifiedTime = a}) .
  mapping _Time
...
dnirsNetworkInterfaceId =
  lens _dnirsNetworkInterfaceId (\s a -> s {_dnirsNetworkInterfaceId = a})
...
dnirsDirectInternetAccess ::
     Lens' DescribeNotebookInstanceResponse (Maybe DirectInternetAccess)
dnirsDirectInternetAccess =
...
dnirsNotebookInstanceARN =
  lens _dnirsNotebookInstanceARN (\s a -> s {_dnirsNotebookInstanceARN = a})
...
dnirsNotebookInstanceLifecycleConfigName ::
     Lens' DescribeNotebookInstanceResponse (Maybe Text)
dnirsNotebookInstanceLifecycleConfigName =
  lens
    _dnirsNotebookInstanceLifecycleConfigName
    (\s a -> s {_dnirsNotebookInstanceLifecycleConfigName = a})
...
dnirsResponseStatus =
  lens _dnirsResponseStatus (\s a -> s {_dnirsResponseStatus = a})

-- | The status of the notebook instance.
dnirsNotebookInstanceStatus ::
     Lens' DescribeNotebookInstanceResponse NotebookInstanceStatus
dnirsNotebookInstanceStatus =
  lens
    _dnirsNotebookInstanceStatus
    (\s a -> s {_dnirsNotebookInstanceStatus = a})
