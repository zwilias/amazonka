...
data CreateTrainingJob = CreateTrainingJob'{_ctjHyperParameters
                                            :: !(Maybe (Map Text Text)),
                                            ...
                                            _ctjInputDataConfig ::
                                            !(List1 Channel),
                                            _ctjOutputDataConfig ::
                                            !OutputDataConfig,
                                            _ctjResourceConfig ::
                                            !ResourceConfig,
                                            _ctjStoppingCondition ::
                                            !StoppingCondition}
...
createTrainingJob pTrainingJobName_
  pAlgorithmSpecification_ pRoleARN_ pInputDataConfig_
  pOutputDataConfig_ pResourceConfig_
  pStoppingCondition_
  = CreateTrainingJob'{_ctjHyperParameters = Nothing,
                       _ctjVPCConfig = Nothing, _ctjTags = Nothing,
...
data CreateTrainingJobResponse = CreateTrainingJobResponse'{_ctjrsResponseStatus
                                                            :: !Int,
                                                            _ctjrsTrainingJobARN
                                                            :: !Text}
...
createTrainingJobResponse pResponseStatus_
  pTrainingJobARN_
  = CreateTrainingJobResponse'{_ctjrsResponseStatus =
                                 pResponseStatus_,
