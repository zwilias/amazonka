...
data DescribeUserProfile = DescribeUserProfile'{_dupDomainId
                                                :: !Text,
...
describeUserProfile
    :: Text -- ^ 'dupDomainId'
    -> Text -- ^ 'dupUserProfileName'
    -> DescribeUserProfile
describeUserProfile pDomainId_ pUserProfileName_
  = DescribeUserProfile'{_dupDomainId = pDomainId_,
...
data DescribeUserProfileResponse = DescribeUserProfileResponse'{_duprsCreationTime
                                                                ::
                                                                !(Maybe POSIX),
                                                                _duprsUserSettings
                                                                ::
...
describeUserProfileResponse pResponseStatus_
  = DescribeUserProfileResponse'{_duprsCreationTime =
                                   Nothing,
