...
data CreateApp = CreateApp'{_caResourceSpec ::
                            !(Maybe ResourceSpec),
                            _caTags :: !(Maybe [Tag]), _caDomainId :: !Text,
                            _caUserProfileName :: !Text, _caAppType :: !AppType,
                            _caAppName :: !Text}
...
--
-- * 'caResourceSpec' - The instance type and quantity.
--
...
createApp
    :: Text -- ^ 'caDomainId'
    -> Text -- ^ 'caUserProfileName'
    -> AppType -- ^ 'caAppType'
    -> Text -- ^ 'caAppName'
    -> CreateApp
createApp pDomainId_ pUserProfileName_ pAppType_
  pAppName_
  = CreateApp'{_caResourceSpec = Nothing,
               _caTags = Nothing, _caDomainId = pDomainId_,
               _caUserProfileName = pUserProfileName_,
               _caAppType = pAppType_, _caAppName = pAppName_}
...
data CreateAppResponse = CreateAppResponse'{_crersAppARN
                                            :: !(Maybe Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'crersAppARN' - The app's Amazon Resource Name (ARN).
--
...
createAppResponse pResponseStatus_
  = CreateAppResponse'{_crersAppARN = Nothing,
