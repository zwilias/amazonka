...
data CreateProcessingJob = CreateProcessingJob'{_cpjEnvironment
                                                :: !(Maybe (Map Text Text)),
...
createProcessingJob
    :: Text -- ^ 'cpjProcessingJobName'
    -> ProcessingResources -- ^ 'cpjProcessingResources'
    -> AppSpecification -- ^ 'cpjAppSpecification'
    -> Text -- ^ 'cpjRoleARN'
    -> CreateProcessingJob
createProcessingJob pProcessingJobName_
  pProcessingResources_ pAppSpecification_ pRoleARN_
  = CreateProcessingJob'{_cpjEnvironment = Nothing,
...
instance Hashable CreateProcessingJob where

instance NFData CreateProcessingJob where
...
data CreateProcessingJobResponse = CreateProcessingJobResponse'{_cpjrsResponseStatus
                                                                :: !Int,
                                                                _cpjrsProcessingJobARN
                                                                :: !Text}
...
createProcessingJobResponse
    :: Int -- ^ 'cpjrsResponseStatus'
    -> Text -- ^ 'cpjrsProcessingJobARN'
    -> CreateProcessingJobResponse
createProcessingJobResponse pResponseStatus_
  pProcessingJobARN_
  = CreateProcessingJobResponse'{_cpjrsResponseStatus =
                                   pResponseStatus_,
...
instance NFData CreateProcessingJobResponse where
