...
data UpdateDomain = UpdateDomain'{_udDefaultUserSettings
                                  :: !(Maybe UserSettings),
                                  _udDomainId :: !Text}
...
--
-- * 'udDomainId' - The domain ID.
updateDomain
    :: Text -- ^ 'udDomainId'
    -> UpdateDomain
updateDomain pDomainId_
  = UpdateDomain'{_udDefaultUserSettings = Nothing,
...
instance Hashable UpdateDomain where

instance NFData UpdateDomain where
...
data UpdateDomainResponse = UpdateDomainResponse'{_udrsDomainARN
                                                  :: !(Maybe Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'udrsDomainARN' - The domain Amazon Resource Name (ARN).
--
...
updateDomainResponse pResponseStatus_
  = UpdateDomainResponse'{_udrsDomainARN = Nothing,
...
instance NFData UpdateDomainResponse where
