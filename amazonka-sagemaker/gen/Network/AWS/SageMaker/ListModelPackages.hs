...
data ListModelPackages = ListModelPackages'{_lmpNameContains
                                            :: !(Maybe Text),
...
listModelPackages
    :: ListModelPackages
listModelPackages
  = ListModelPackages'{_lmpNameContains = Nothing,
                       _lmpCreationTimeAfter = Nothing,
                       _lmpNextToken = Nothing, _lmpSortOrder = Nothing,
                       _lmpCreationTimeBefore = Nothing,
                       _lmpMaxResults = Nothing, _lmpSortBy = Nothing}
...
data ListModelPackagesResponse = ListModelPackagesResponse'{_lmprsNextToken
                                                            :: !(Maybe Text),
...
listModelPackagesResponse pResponseStatus_
  = ListModelPackagesResponse'{_lmprsNextToken =
                                 Nothing,
