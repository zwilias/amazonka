...
data UpdateWorkteam = UpdateWorkteam'{_uwNotificationConfiguration
...
updateWorkteam pWorkteamName_
  = UpdateWorkteam'{_uwNotificationConfiguration =
                      Nothing,
...
data UpdateWorkteamResponse = UpdateWorkteamResponse'{_uwrsResponseStatus
                                                      :: !Int,
                                                      _uwrsWorkteam ::
                                                      !Workteam}
...
updateWorkteamResponse pResponseStatus_ pWorkteam_
  = UpdateWorkteamResponse'{_uwrsResponseStatus =
                              pResponseStatus_,
