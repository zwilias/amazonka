...
dnilcNotebookInstanceLifecycleConfigName ::
     Lens' DeleteNotebookInstanceLifecycleConfig Text
dnilcNotebookInstanceLifecycleConfigName =
  lens
    _dnilcNotebookInstanceLifecycleConfigName
    (\s a -> s {_dnilcNotebookInstanceLifecycleConfigName = a})

instance AWSRequest DeleteNotebookInstanceLifecycleConfig where
  type Rs DeleteNotebookInstanceLifecycleConfig = DeleteNotebookInstanceLifecycleConfigResponse
  request = postJSON sageMaker
  response = receiveNull DeleteNotebookInstanceLifecycleConfigResponse'
