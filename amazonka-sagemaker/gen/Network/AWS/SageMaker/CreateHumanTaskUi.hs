...
data CreateHumanTaskUi = CreateHumanTaskUi'{_chtuTags
                                            :: !(Maybe [Tag]),
...
createHumanTaskUi
    :: Text -- ^ 'chtuHumanTaskUiName'
    -> UiTemplate -- ^ 'chtuUiTemplate'
    -> CreateHumanTaskUi
createHumanTaskUi pHumanTaskUiName_ pUiTemplate_
  = CreateHumanTaskUi'{_chtuTags = Nothing,
...
instance Hashable CreateHumanTaskUi where

instance NFData CreateHumanTaskUi where
...
data CreateHumanTaskUiResponse = CreateHumanTaskUiResponse'{_chtursResponseStatus
                                                            :: !Int,
                                                            _chtursHumanTaskUiARN
                                                            :: !Text}
...
createHumanTaskUiResponse
    :: Int -- ^ 'chtursResponseStatus'
    -> Text -- ^ 'chtursHumanTaskUiARN'
    -> CreateHumanTaskUiResponse
createHumanTaskUiResponse pResponseStatus_
  pHumanTaskUiARN_
  = CreateHumanTaskUiResponse'{_chtursResponseStatus =
                                 pResponseStatus_,
...
instance NFData CreateHumanTaskUiResponse where
