...
data ListMonitoringExecutions = ListMonitoringExecutions'{_lmeEndpointName
                                                          :: !(Maybe Text),
...
listMonitoringExecutions
  = ListMonitoringExecutions'{_lmeEndpointName =
                              ...
                              _lmeMaxResults = Nothing, _lmeSortBy = Nothing}
...
instance AWSPager ListMonitoringExecutions where
        page rq rs
          ...
          | stop (rs ^. lmersMonitoringExecutionSummaries) =
            Nothing
          | otherwise =
            Just $ rq & lmeNextToken .~ rs ^. lmersNextToken

instance AWSRequest ListMonitoringExecutions where
        type Rs ListMonitoringExecutions =
             ListMonitoringExecutionsResponse
...
instance Hashable ListMonitoringExecutions where

instance NFData ListMonitoringExecutions where
...
data ListMonitoringExecutionsResponse = ListMonitoringExecutionsResponse'{_lmersNextToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
listMonitoringExecutionsResponse
    :: Int -- ^ 'lmersResponseStatus'
    -> ListMonitoringExecutionsResponse
listMonitoringExecutionsResponse pResponseStatus_
  = ListMonitoringExecutionsResponse'{_lmersNextToken =
                                        Nothing,
