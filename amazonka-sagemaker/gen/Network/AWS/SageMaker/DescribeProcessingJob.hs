...
newtype DescribeProcessingJob = DescribeProcessingJob'{_dpjProcessingJobName
                                                       :: Text}
...
describeProcessingJob
    :: Text -- ^ 'dpjProcessingJobName'
    -> DescribeProcessingJob
describeProcessingJob pProcessingJobName_
  = DescribeProcessingJob'{_dpjProcessingJobName =
                             pProcessingJobName_}
...
instance Hashable DescribeProcessingJob where

instance NFData DescribeProcessingJob where
...
data DescribeProcessingJobResponse = DescribeProcessingJobResponse'{_dpjrsFailureReason
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
describeProcessingJobResponse
    :: Int -- ^ 'dpjrsResponseStatus'
    -> Text -- ^ 'dpjrsProcessingJobName'
    -> ProcessingResources -- ^ 'dpjrsProcessingResources'
    -> AppSpecification -- ^ 'dpjrsAppSpecification'
    -> Text -- ^ 'dpjrsProcessingJobARN'
    -> ProcessingJobStatus -- ^ 'dpjrsProcessingJobStatus'
    -> UTCTime -- ^ 'dpjrsCreationTime'
    -> DescribeProcessingJobResponse
describeProcessingJobResponse pResponseStatus_
  pProcessingJobName_ pProcessingResources_
  pAppSpecification_ pProcessingJobARN_
  pProcessingJobStatus_ pCreationTime_
  = DescribeProcessingJobResponse'{_dpjrsFailureReason
                                     = Nothing,
...
instance NFData DescribeProcessingJobResponse where
