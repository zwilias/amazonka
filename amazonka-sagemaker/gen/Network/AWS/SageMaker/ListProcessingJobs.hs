...
data ListProcessingJobs = ListProcessingJobs'{_lpjNameContains
                                              :: !(Maybe Text),
...
listProcessingJobs
    :: ListProcessingJobs
listProcessingJobs
  = ListProcessingJobs'{_lpjNameContains = Nothing,
                        _lpjLastModifiedTimeBefore = Nothing,
                        _lpjCreationTimeAfter = Nothing,
                        _lpjNextToken = Nothing, _lpjSortOrder = Nothing,
                        _lpjLastModifiedTimeAfter = Nothing,
                        _lpjCreationTimeBefore = Nothing,
                        _lpjStatusEquals = Nothing, _lpjMaxResults = Nothing,
                        _lpjSortBy = Nothing}
...
instance AWSPager ListProcessingJobs where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lpjNextToken .~ rs ^. lpjrsNextToken

instance AWSRequest ListProcessingJobs where
        type Rs ListProcessingJobs =
             ListProcessingJobsResponse
...
instance Hashable ListProcessingJobs where

instance NFData ListProcessingJobs where
...
data ListProcessingJobsResponse = ListProcessingJobsResponse'{_lpjrsNextToken
                                                              :: !(Maybe Text),
                                                              _lpjrsResponseStatus
                                                              :: !Int,
...
listProcessingJobsResponse
    :: Int -- ^ 'lpjrsResponseStatus'
    -> ListProcessingJobsResponse
listProcessingJobsResponse pResponseStatus_
  = ListProcessingJobsResponse'{_lpjrsNextToken =
                                  Nothing,
...
instance NFData ListProcessingJobsResponse where
