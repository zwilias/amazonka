...
data AssociateTrialComponent = AssociateTrialComponent'{_atcTrialComponentName
                                                        :: !Text,
                                                        _atcTrialName :: !Text}
...
associateTrialComponent
    :: Text -- ^ 'atcTrialComponentName'
    -> Text -- ^ 'atcTrialName'
    -> AssociateTrialComponent
associateTrialComponent pTrialComponentName_
  pTrialName_
  = AssociateTrialComponent'{_atcTrialComponentName =
...
instance AWSRequest AssociateTrialComponent where
        type Rs AssociateTrialComponent =
             AssociateTrialComponentResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 AssociateTrialComponentResponse' <$>
                   (x .?> "TrialArn") <*> (x .?> "TrialComponentArn")
                     <*> (pure (fromEnum s)))

instance Hashable AssociateTrialComponent where

instance NFData AssociateTrialComponent where
...
data AssociateTrialComponentResponse = AssociateTrialComponentResponse'{_atcrsTrialARN
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
associateTrialComponentResponse
    :: Int -- ^ 'atcrsResponseStatus'
    -> AssociateTrialComponentResponse
associateTrialComponentResponse pResponseStatus_
  = AssociateTrialComponentResponse'{_atcrsTrialARN =
                                       Nothing,
...
instance NFData AssociateTrialComponentResponse where
