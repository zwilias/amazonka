...
newtype StartMonitoringSchedule = StartMonitoringSchedule'{_sMonitoringScheduleName
                                                           :: Text}
...
startMonitoringSchedule
    :: Text -- ^ 'sMonitoringScheduleName'
    -> StartMonitoringSchedule
startMonitoringSchedule pMonitoringScheduleName_
  = StartMonitoringSchedule'{_sMonitoringScheduleName =
...
instance AWSRequest StartMonitoringSchedule where
        type Rs StartMonitoringSchedule =
             StartMonitoringScheduleResponse
        request = postJSON sageMaker
        response
          = receiveNull StartMonitoringScheduleResponse'

instance Hashable StartMonitoringSchedule where

instance NFData StartMonitoringSchedule where
...
instance NFData StartMonitoringScheduleResponse where
