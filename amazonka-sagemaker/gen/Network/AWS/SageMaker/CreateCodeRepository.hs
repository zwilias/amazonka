...
data CreateCodeRepository = CreateCodeRepository'{_ccrCodeRepositoryName
                                                  :: !Text,
...
createCodeRepository pCodeRepositoryName_ pGitConfig_
  = CreateCodeRepository'{_ccrCodeRepositoryName =
...
data CreateCodeRepositoryResponse = CreateCodeRepositoryResponse'{_ccrrsResponseStatus
                                                                  :: !Int,
                                                                  _ccrrsCodeRepositoryARN
                                                                  :: !Text}
...
createCodeRepositoryResponse
    ...
    -> CreateCodeRepositoryResponse
createCodeRepositoryResponse pResponseStatus_
  pCodeRepositoryARN_
  = CreateCodeRepositoryResponse'{_ccrrsResponseStatus
                                    = pResponseStatus_,
