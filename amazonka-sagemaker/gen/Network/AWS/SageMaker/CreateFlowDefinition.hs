...
data CreateFlowDefinition = CreateFlowDefinition'{_cfdHumanLoopRequestSource
                                                  ::
                                                  !(Maybe
...
createFlowDefinition
    :: Text -- ^ 'cfdFlowDefinitionName'
    -> HumanLoopConfig -- ^ 'cfdHumanLoopConfig'
    -> FlowDefinitionOutputConfig -- ^ 'cfdOutputConfig'
    -> Text -- ^ 'cfdRoleARN'
    -> CreateFlowDefinition
createFlowDefinition pFlowDefinitionName_
  pHumanLoopConfig_ pOutputConfig_ pRoleARN_
  = CreateFlowDefinition'{_cfdHumanLoopRequestSource =
                            Nothing,
...
instance Hashable CreateFlowDefinition where

instance NFData CreateFlowDefinition where
...
data CreateFlowDefinitionResponse = CreateFlowDefinitionResponse'{_cfdrsResponseStatus
                                                                  :: !Int,
                                                                  _cfdrsFlowDefinitionARN
                                                                  :: !Text}
...
createFlowDefinitionResponse
    ...
    -> Text -- ^ 'cfdrsFlowDefinitionARN'
    -> CreateFlowDefinitionResponse
createFlowDefinitionResponse pResponseStatus_
  pFlowDefinitionARN_
  = CreateFlowDefinitionResponse'{_cfdrsResponseStatus
                                    = pResponseStatus_,
...
instance NFData CreateFlowDefinitionResponse where
