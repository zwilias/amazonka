...
data ListLabelingJobs = ListLabelingJobs'{_lljNameContains
                                          :: !(Maybe Text),
...
listLabelingJobs
    :: ListLabelingJobs
listLabelingJobs
  = ListLabelingJobs'{_lljNameContains = Nothing,
                      _lljLastModifiedTimeBefore = Nothing,
                      _lljCreationTimeAfter = Nothing,
                      _lljNextToken = Nothing, _lljSortOrder = Nothing,
                      _lljLastModifiedTimeAfter = Nothing,
                      _lljCreationTimeBefore = Nothing,
                      _lljStatusEquals = Nothing, _lljMaxResults = Nothing,
                      _lljSortBy = Nothing}
...
data ListLabelingJobsResponse = ListLabelingJobsResponse'{_lljrsLabelingJobSummaryList
                                                          ::
                                                          !(Maybe
                                                              [LabelingJobSummary]),
                                                          _lljrsNextToken ::
                                                          !(Maybe Text),
                                                          _lljrsResponseStatus
                                                          :: !Int}
...
listLabelingJobsResponse pResponseStatus_
  = ListLabelingJobsResponse'{_lljrsLabelingJobSummaryList
                                = Nothing,
