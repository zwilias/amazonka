...
newtype StopAutoMLJob = StopAutoMLJob'{_samljAutoMLJobName
                                       :: Text}
...
stopAutoMLJob
    :: Text -- ^ 'samljAutoMLJobName'
    -> StopAutoMLJob
stopAutoMLJob pAutoMLJobName_
  = StopAutoMLJob'{_samljAutoMLJobName =
                     pAutoMLJobName_}
...
instance Hashable StopAutoMLJob where

instance NFData StopAutoMLJob where
...
instance NFData StopAutoMLJobResponse where
