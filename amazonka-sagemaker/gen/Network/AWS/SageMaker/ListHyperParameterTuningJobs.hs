...
data ListHyperParameterTuningJobs = ListHyperParameterTuningJobs'{_lhptjNameContains
                                                                  ::
                                                                  !(Maybe Text),
...
listHyperParameterTuningJobs
    :: ListHyperParameterTuningJobs
listHyperParameterTuningJobs
  = ListHyperParameterTuningJobs'{_lhptjNameContains =
                                    Nothing,
...
data ListHyperParameterTuningJobsResponse = ListHyperParameterTuningJobsResponse'{_lhptjrsNextToken
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
listHyperParameterTuningJobsResponse pResponseStatus_
  = ListHyperParameterTuningJobsResponse'{_lhptjrsNextToken
                                            = Nothing,
                                          _lhptjrsResponseStatus =
                                            pResponseStatus_,
                                          _lhptjrsHyperParameterTuningJobSummaries
