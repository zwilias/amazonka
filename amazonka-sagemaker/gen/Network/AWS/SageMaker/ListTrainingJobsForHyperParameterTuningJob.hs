...
data ListTrainingJobsForHyperParameterTuningJob = ListTrainingJobsForHyperParameterTuningJob'{_ltjfhptjNextToken
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  Text),
                                                                                              _ltjfhptjSortOrder
...
listTrainingJobsForHyperParameterTuningJob
  ...
  = ListTrainingJobsForHyperParameterTuningJob'{_ltjfhptjNextToken
                                                  = Nothing,
...
data ListTrainingJobsForHyperParameterTuningJobResponse = ListTrainingJobsForHyperParameterTuningJobResponse'{_ltjfhptjrsNextToken
                                                                                                              ::
                                                                                                              !(Maybe
                                                                                                                  Text),
...
listTrainingJobsForHyperParameterTuningJobResponse
  pResponseStatus_
  = ListTrainingJobsForHyperParameterTuningJobResponse'{_ltjfhptjrsNextToken
                                                          = Nothing,
                                                        _ltjfhptjrsResponseStatus
                                                          = pResponseStatus_,
                                                        _ltjfhptjrsTrainingJobSummaries
