...
data UpdateTrialComponent = UpdateTrialComponent'{_utcStatus
                                                  ::
...
instance Hashable UpdateTrialComponent where

instance NFData UpdateTrialComponent where
...
data UpdateTrialComponentResponse = UpdateTrialComponentResponse'{_utcrsTrialComponentARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _utcrsResponseStatus
                                                                  :: !Int}
...
updateTrialComponentResponse
    :: Int -- ^ 'utcrsResponseStatus'
    -> UpdateTrialComponentResponse
updateTrialComponentResponse pResponseStatus_
  = UpdateTrialComponentResponse'{_utcrsTrialComponentARN
                                    = Nothing,
...
instance NFData UpdateTrialComponentResponse where
