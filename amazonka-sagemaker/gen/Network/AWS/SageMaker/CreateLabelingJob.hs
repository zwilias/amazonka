...
data CreateLabelingJob = CreateLabelingJob'{_cljLabelingJobAlgorithmsConfig
                                            ::
                                            !(Maybe
...
createLabelingJob
    ...
    -> CreateLabelingJob
createLabelingJob pLabelingJobName_
  pLabelAttributeName_ pInputConfig_ pOutputConfig_
  pRoleARN_ pHumanTaskConfig_
  = CreateLabelingJob'{_cljLabelingJobAlgorithmsConfig
                         = Nothing,
                       _cljLabelCategoryConfigS3URI = Nothing,
                       _cljStoppingConditions = Nothing, _cljTags = Nothing,
...
data CreateLabelingJobResponse = CreateLabelingJobResponse'{_cljrsResponseStatus
                                                            :: !Int,
                                                            _cljrsLabelingJobARN
                                                            :: !Text}
...
createLabelingJobResponse
    ...
    -> CreateLabelingJobResponse
createLabelingJobResponse pResponseStatus_
  pLabelingJobARN_
  = CreateLabelingJobResponse'{_cljrsResponseStatus =
                                 pResponseStatus_,
