...
data CreateMonitoringSchedule = CreateMonitoringSchedule'{_cmsTags
                                                          :: !(Maybe [Tag]),
...
createMonitoringSchedule
    :: Text -- ^ 'cmsMonitoringScheduleName'
    -> MonitoringScheduleConfig -- ^ 'cmsMonitoringScheduleConfig'
    -> CreateMonitoringSchedule
createMonitoringSchedule pMonitoringScheduleName_
  pMonitoringScheduleConfig_
  = CreateMonitoringSchedule'{_cmsTags = Nothing,
                              _cmsMonitoringScheduleName =
...
instance AWSRequest CreateMonitoringSchedule where
        type Rs CreateMonitoringSchedule =
             CreateMonitoringScheduleResponse
...
instance Hashable CreateMonitoringSchedule where

instance NFData CreateMonitoringSchedule where
...
data CreateMonitoringScheduleResponse = CreateMonitoringScheduleResponse'{_cmsrsResponseStatus
                                                                          ::
                                                                          !Int,
...
createMonitoringScheduleResponse
    ...
    -> Text -- ^ 'cmsrsMonitoringScheduleARN'
    -> CreateMonitoringScheduleResponse
createMonitoringScheduleResponse pResponseStatus_
  pMonitoringScheduleARN_
  = CreateMonitoringScheduleResponse'{_cmsrsResponseStatus
                                        = pResponseStatus_,
                                      _cmsrsMonitoringScheduleARN =
                                        pMonitoringScheduleARN_}
