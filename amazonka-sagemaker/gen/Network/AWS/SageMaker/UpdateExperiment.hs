...
data UpdateExperiment = UpdateExperiment'{_ueDisplayName
                                          :: !(Maybe Text),
...
updateExperiment
    :: Text -- ^ 'ueExperimentName'
    -> UpdateExperiment
updateExperiment pExperimentName_
  = UpdateExperiment'{_ueDisplayName = Nothing,
...
instance Hashable UpdateExperiment where

instance NFData UpdateExperiment where
...
data UpdateExperimentResponse = UpdateExperimentResponse'{_ursExperimentARN
                                                          :: !(Maybe Text),
                                                          _ursResponseStatus ::
                                                          !Int}
...
updateExperimentResponse pResponseStatus_
  = UpdateExperimentResponse'{_ursExperimentARN =
                                Nothing,
...
instance NFData UpdateExperimentResponse where
