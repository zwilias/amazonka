...
data UpdateUserProfile = UpdateUserProfile'{_uupUserSettings
                                            :: !(Maybe UserSettings),
                                            _uupDomainId :: !Text,
...
updateUserProfile
    :: Text -- ^ 'uupDomainId'
    -> Text -- ^ 'uupUserProfileName'
    -> UpdateUserProfile
updateUserProfile pDomainId_ pUserProfileName_
  = UpdateUserProfile'{_uupUserSettings = Nothing,
...
data UpdateUserProfileResponse = UpdateUserProfileResponse'{_uuprsUserProfileARN
                                                            :: !(Maybe Text),
...
updateUserProfileResponse pResponseStatus_
  = UpdateUserProfileResponse'{_uuprsUserProfileARN =
                                 Nothing,
