...
data RenderUiTemplate = RenderUiTemplate'{_rutUiTemplate
                                          :: !UiTemplate,
...
renderUiTemplate pUiTemplate_ pTask_ pRoleARN_
  = RenderUiTemplate'{_rutUiTemplate = pUiTemplate_,
                      _rutTask = pTask_, _rutRoleARN = pRoleARN_}
...
data RenderUiTemplateResponse = RenderUiTemplateResponse'{_rutrsResponseStatus
                                                          :: !Int,
                                                          _rutrsRenderedContent
                                                          :: !Text,
                                                          _rutrsErrors ::
                                                          ![RenderingError]}
...
renderUiTemplateResponse
    ...
    -> RenderUiTemplateResponse
renderUiTemplateResponse pResponseStatus_
  pRenderedContent_
  = RenderUiTemplateResponse'{_rutrsResponseStatus =
                                pResponseStatus_,
