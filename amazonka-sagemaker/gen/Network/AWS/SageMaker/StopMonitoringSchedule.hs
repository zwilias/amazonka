...
newtype StopMonitoringSchedule = StopMonitoringSchedule'{_smsMonitoringScheduleName
                                                         :: Text}
...
stopMonitoringSchedule
    :: Text -- ^ 'smsMonitoringScheduleName'
    -> StopMonitoringSchedule
stopMonitoringSchedule pMonitoringScheduleName_
  = StopMonitoringSchedule'{_smsMonitoringScheduleName
...
instance AWSRequest StopMonitoringSchedule where
        type Rs StopMonitoringSchedule =
             StopMonitoringScheduleResponse
        request = postJSON sageMaker
        response
          = receiveNull StopMonitoringScheduleResponse'

instance Hashable StopMonitoringSchedule where

instance NFData StopMonitoringSchedule where
...
instance NFData StopMonitoringScheduleResponse where
