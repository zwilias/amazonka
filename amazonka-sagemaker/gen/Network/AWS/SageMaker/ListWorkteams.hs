...
data ListWorkteams = ListWorkteams'{_lwNameContains
                                    :: !(Maybe Text),
...
listWorkteams
    :: ListWorkteams
listWorkteams
  = ListWorkteams'{_lwNameContains = Nothing,
                   _lwNextToken = Nothing, _lwSortOrder = Nothing,
                   _lwMaxResults = Nothing, _lwSortBy = Nothing}
...
data ListWorkteamsResponse = ListWorkteamsResponse'{_lwrsNextToken
                                                    :: !(Maybe Text),
...
listWorkteamsResponse pResponseStatus_
  = ListWorkteamsResponse'{_lwrsNextToken = Nothing,
