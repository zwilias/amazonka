...
data ListFlowDefinitions = ListFlowDefinitions'{_lfdCreationTimeAfter
                                                :: !(Maybe POSIX),
...
listFlowDefinitions
    :: ListFlowDefinitions
listFlowDefinitions
  = ListFlowDefinitions'{_lfdCreationTimeAfter =
                           Nothing,
                         _lfdNextToken = Nothing, _lfdSortOrder = Nothing,
...
instance Hashable ListFlowDefinitions where

instance NFData ListFlowDefinitions where
...
data ListFlowDefinitionsResponse = ListFlowDefinitionsResponse'{_lfdrsNextToken
                                                                ::
                                                                !(Maybe Text),
...
listFlowDefinitionsResponse pResponseStatus_
  = ListFlowDefinitionsResponse'{_lfdrsNextToken =
                                   Nothing,
...
instance NFData ListFlowDefinitionsResponse where
