...
data ListTrialComponents = ListTrialComponents'{_ltcCreatedAfter
                                                :: !(Maybe POSIX),
...
listTrialComponents
    :: ListTrialComponents
listTrialComponents
  = ListTrialComponents'{_ltcCreatedAfter = Nothing,
                         _ltcSourceARN = Nothing,
                         _ltcExperimentName = Nothing,
                         _ltcNextToken = Nothing, _ltcSortOrder = Nothing,
                         _ltcTrialName = Nothing, _ltcMaxResults = Nothing,
                         _ltcCreatedBefore = Nothing, _ltcSortBy = Nothing}
...
instance AWSPager ListTrialComponents where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ltcNextToken .~ rs ^. ltcrsNextToken

instance AWSRequest ListTrialComponents where
        type Rs ListTrialComponents =
             ListTrialComponentsResponse
...
instance Hashable ListTrialComponents where

instance NFData ListTrialComponents where
...
data ListTrialComponentsResponse = ListTrialComponentsResponse'{_ltcrsTrialComponentSummaries
                                                                ::
                                                                !(Maybe
...
listTrialComponentsResponse
    :: Int -- ^ 'ltcrsResponseStatus'
    -> ListTrialComponentsResponse
listTrialComponentsResponse pResponseStatus_
  = ListTrialComponentsResponse'{_ltcrsTrialComponentSummaries
                                   = Nothing,
...
instance NFData ListTrialComponentsResponse where
