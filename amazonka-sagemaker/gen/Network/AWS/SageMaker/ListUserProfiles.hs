...
data ListUserProfiles = ListUserProfiles'{_lupDomainIdEquals
                                          :: !(Maybe Text),
...
listUserProfiles
    :: ListUserProfiles
listUserProfiles
  = ListUserProfiles'{_lupDomainIdEquals = Nothing,
                      _lupUserProfileNameContains = Nothing,
                      _lupNextToken = Nothing, _lupSortOrder = Nothing,
                      _lupMaxResults = Nothing, _lupSortBy = Nothing}
...
data ListUserProfilesResponse = ListUserProfilesResponse'{_luprsUserProfiles
                                                          ::
                                                          !(Maybe
                                                              [UserProfileDetails]),
                                                          _luprsNextToken ::
...
listUserProfilesResponse pResponseStatus_
  = ListUserProfilesResponse'{_luprsUserProfiles =
                                Nothing,
