...
data CreateFunction = CreateFunction'{_cfMemorySize
                                      ...
                                      _cfRuntime :: !Runtime, _cfRole :: !Text,
                                      _cfHandler :: !Text,
...
createFunction
    ...
    -> FunctionCode -- ^ 'cfCode'
    -> CreateFunction
createFunction pFunctionName_ pRuntime_ pRole_
  pHandler_ pCode_
  = CreateFunction'{_cfMemorySize = Nothing,
                    _cfKMSKeyARN = Nothing, _cfEnvironment = Nothing,
                    _cfDeadLetterConfig = Nothing,
                    _cfVPCConfig = Nothing, _cfLayers = Nothing,
                    _cfTimeout = Nothing, _cfTracingConfig = Nothing,
                    _cfDescription = Nothing, _cfTags = Nothing,
                    _cfPublish = Nothing,
                    _cfFunctionName = pFunctionName_,
                    _cfRuntime = pRuntime_, _cfRole = pRole_,
                    _cfHandler = pHandler_, _cfCode = pCode_}
