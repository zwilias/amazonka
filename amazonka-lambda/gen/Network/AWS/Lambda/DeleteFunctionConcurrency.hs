...
newtype DeleteFunctionConcurrency =
  DeleteFunctionConcurrency'
...
instance AWSRequest DeleteFunctionConcurrency where
  type Rs DeleteFunctionConcurrency = DeleteFunctionConcurrencyResponse
...
instance ToPath DeleteFunctionConcurrency where
  toPath DeleteFunctionConcurrency' {..} =
    mconcat ["/2017-10-31/functions/", toBS _dfcFunctionName, "/concurrency"]
