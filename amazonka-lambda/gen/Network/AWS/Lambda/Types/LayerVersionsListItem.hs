...
data LayerVersionsListItem = LayerVersionsListItem'{_lvliLayerVersionARN
                                                    :: !(Maybe Text),
                                                    _lvliCreatedDate ::
                                                    !(Maybe Text),
                                                    _lvliVersion ::
...
layerVersionsListItem
    :: LayerVersionsListItem
layerVersionsListItem
  = LayerVersionsListItem'{_lvliLayerVersionARN =
                             Nothing,
                           _lvliCreatedDate = Nothing, _lvliVersion = Nothing,
