...
data DestinationConfig = DestinationConfig'{_dcOnSuccess
                                            :: !(Maybe OnSuccess),
...
destinationConfig
    :: DestinationConfig
destinationConfig
  = DestinationConfig'{_dcOnSuccess = Nothing,
...
instance FromJSON DestinationConfig where
        parseJSON
          = withObject "DestinationConfig"
              (\ x ->
                 DestinationConfig' <$>
                   (x .:? "OnSuccess") <*> (x .:? "OnFailure"))

instance Hashable DestinationConfig where

instance NFData DestinationConfig where
