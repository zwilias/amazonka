...
data GetLayerVersionResponse = GetLayerVersionResponse'{_glvLayerVersionARN
                                                        :: !(Maybe Text),
                                                        _glvContent ::
                                                        !(Maybe
...
getLayerVersionResponse
    :: GetLayerVersionResponse
getLayerVersionResponse
  = GetLayerVersionResponse'{_glvLayerVersionARN =
                               Nothing,
                             _glvContent = Nothing, _glvCreatedDate = Nothing,
                             _glvVersion = Nothing, _glvLicenseInfo = Nothing,
                             _glvLayerARN = Nothing, _glvDescription = Nothing,
