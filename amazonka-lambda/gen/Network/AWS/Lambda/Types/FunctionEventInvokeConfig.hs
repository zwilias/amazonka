...
data FunctionEventInvokeConfig = FunctionEventInvokeConfig'{_feicFunctionARN
                                                            :: !(Maybe Text),
...
functionEventInvokeConfig
    :: FunctionEventInvokeConfig
functionEventInvokeConfig
  = FunctionEventInvokeConfig'{_feicFunctionARN =
                                 Nothing,
...
instance FromJSON FunctionEventInvokeConfig where
        parseJSON
          = withObject "FunctionEventInvokeConfig"
              (\ x ->
                 FunctionEventInvokeConfig' <$>
                   (x .:? "FunctionArn") <*>
...
instance Hashable FunctionEventInvokeConfig where

instance NFData FunctionEventInvokeConfig where
