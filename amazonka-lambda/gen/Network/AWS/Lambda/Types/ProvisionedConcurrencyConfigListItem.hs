...
data ProvisionedConcurrencyConfigListItem = ProvisionedConcurrencyConfigListItem'{_pccliStatus
                                                                                  ::
                                                                                  !(Maybe
...
provisionedConcurrencyConfigListItem
    :: ProvisionedConcurrencyConfigListItem
provisionedConcurrencyConfigListItem
  = ProvisionedConcurrencyConfigListItem'{_pccliStatus
                                            = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ProvisionedConcurrencyConfigListItem"
              (\ x ->
                 ProvisionedConcurrencyConfigListItem' <$>
                   (x .:? "Status") <*> (x .:? "FunctionArn") <*>
