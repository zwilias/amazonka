...
data LayerVersionContentInput = LayerVersionContentInput'{_lvciS3ObjectVersion
                                                          :: !(Maybe Text),
                                                          _lvciS3Key ::
                                                          !(Maybe Text),
                                                          _lvciZipFile ::
...
layerVersionContentInput
    :: LayerVersionContentInput
layerVersionContentInput
  = LayerVersionContentInput'{_lvciS3ObjectVersion =
                                Nothing,
                              _lvciS3Key = Nothing, _lvciZipFile = Nothing,
