...
data GitHubCodeDestination = GitHubCodeDestination'{_ghcdDescription
                                                    :: !(Maybe Text),
                                                    _ghcdName :: !Text,
                                                    _ghcdType :: !Text,
                                                    _ghcdOwner :: !Text,
...
gitHubCodeDestination
    ...
    -> Text -- ^ 'ghcdToken'
    -> GitHubCodeDestination
gitHubCodeDestination pName_ pType_ pOwner_
  pPrivateRepository_ pIssuesEnabled_ pToken_
  = GitHubCodeDestination'{_ghcdDescription = Nothing,
                           _ghcdName = pName_, _ghcdType = pType_,
                           _ghcdOwner = pOwner_,
