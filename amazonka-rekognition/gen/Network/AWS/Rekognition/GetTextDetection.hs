...
--
-- * 'gtdJobId' - Job identifier for the label detection operation for which you want results returned. You get the job identifer from an initial call to @StartTextDetection@ .
getTextDetection
    :: Text -- ^ 'gtdJobId'
    -> GetTextDetection
