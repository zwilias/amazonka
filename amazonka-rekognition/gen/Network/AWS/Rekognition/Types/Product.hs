...
instance FromJSON AgeRange where
  parseJSON =
    withObject "AgeRange" (\x -> AgeRange' <$> (x .:? "Low") <*> (x .:? "High"))
...
instance FromJSON Celebrity where
  parseJSON =
    withObject
      "Celebrity"
      (\x ->
         Celebrity' <$> (x .:? "MatchConfidence") <*> (x .:? "Urls" .!= mempty) <*>
         (x .:? "Name") <*>
         (x .:? "Id") <*>
         (x .:? "Face"))
...
instance FromJSON CelebrityRecognition where
  parseJSON =
    withObject
      "CelebrityRecognition"
      (\x ->
         CelebrityRecognition' <$> (x .:? "Celebrity") <*> (x .:? "Timestamp"))
...
instance FromJSON CompareFacesMatch where
  parseJSON =
    withObject
      "CompareFacesMatch"
      (\x -> CompareFacesMatch' <$> (x .:? "Similarity") <*> (x .:? "Face"))
...
cfLandmarks =
  lens _cfLandmarks (\s a -> s {_cfLandmarks = a}) . _Default . _Coerce
...
instance FromJSON ComparedFace where
  parseJSON =
    withObject
      "ComparedFace"
      (\x ->
         ComparedFace' <$> (x .:? "BoundingBox") <*> (x .:? "Pose") <*>
         (x .:? "Confidence") <*>
         (x .:? "Quality") <*>
         (x .:? "Landmarks" .!= mempty))
...
instance FromJSON ComparedSourceImageFace where
  parseJSON =
    withObject
      "ComparedSourceImageFace"
      (\x ->
         ComparedSourceImageFace' <$> (x .:? "BoundingBox") <*>
         (x .:? "Confidence"))
...
cmdModerationLabel =
  lens _cmdModerationLabel (\s a -> s {_cmdModerationLabel = a})
...
instance FromJSON ContentModerationDetection where
  parseJSON =
    withObject
      "ContentModerationDetection"
      (\x ->
         ContentModerationDetection' <$> (x .:? "ModerationLabel") <*>
         (x .:? "Timestamp"))
...
fdLandmarks =
  lens _fdLandmarks (\s a -> s {_fdLandmarks = a}) . _Default . _Coerce
...
instance FromJSON FaceDetail where
  parseJSON =
    withObject
      "FaceDetail"
      (\x ->
         FaceDetail' <$> (x .:? "AgeRange") <*> (x .:? "Sunglasses") <*>
         (x .:? "MouthOpen") <*>
         (x .:? "BoundingBox") <*>
         (x .:? "Emotions" .!= mempty) <*>
         (x .:? "EyesOpen") <*>
...
fssFaceMatchThreshold =
  lens _fssFaceMatchThreshold (\s a -> s {_fssFaceMatchThreshold = a})
...
instance FromJSON FaceSearchSettings where
  parseJSON =
    withObject
      "FaceSearchSettings"
      (\x ->
         FaceSearchSettings' <$> (x .:? "FaceMatchThreshold") <*>
         (x .:? "CollectionId"))
...
instance FromJSON Geometry where
  parseJSON =
    withObject
      "Geometry"
      (\x ->
         Geometry' <$> (x .:? "BoundingBox") <*> (x .:? "Polygon" .!= mempty))
...
instance ToJSON Image where
  toJSON Image' {..} =
    object
      (catMaybes [("S3Object" .=) <$> _iS3Object, ("Bytes" .=) <$> _iBytes])
...
instance FromJSON ImageQuality where
  parseJSON =
    withObject
      "ImageQuality"
      (\x -> ImageQuality' <$> (x .:? "Sharpness") <*> (x .:? "Brightness"))
...
instance FromJSON KinesisDataStream where
  parseJSON =
    withObject "KinesisDataStream" (\x -> KinesisDataStream' <$> (x .:? "Arn"))
...
instance ToJSON KinesisDataStream where
  toJSON KinesisDataStream' {..} = object (catMaybes [("Arn" .=) <$> _kdsARN])
...
instance ToJSON KinesisVideoStream where
  toJSON KinesisVideoStream' {..} = object (catMaybes [("Arn" .=) <$> _kvsARN])
...
instance FromJSON LabelDetection where
  parseJSON =
    withObject
      "LabelDetection"
      (\x -> LabelDetection' <$> (x .:? "Label") <*> (x .:? "Timestamp"))
...
instance FromJSON ModerationLabel where
  parseJSON =
    withObject
      "ModerationLabel"
      (\x ->
         ModerationLabel' <$> (x .:? "Confidence") <*> (x .:? "Name") <*>
         (x .:? "ParentName"))
...
instance FromJSON PersonDetail where
  parseJSON =
    withObject
      "PersonDetail"
      (\x ->
         PersonDetail' <$> (x .:? "BoundingBox") <*> (x .:? "Index") <*>
         (x .:? "Face"))
...
instance FromJSON PersonDetection where
  parseJSON =
    withObject
      "PersonDetection"
      (\x -> PersonDetection' <$> (x .:? "Person") <*> (x .:? "Timestamp"))
...
pmFaceMatches =
  lens _pmFaceMatches (\s a -> s {_pmFaceMatches = a}) . _Default . _Coerce
...
instance FromJSON PersonMatch where
  parseJSON =
    withObject
      "PersonMatch"
      (\x ->
         PersonMatch' <$> (x .:? "FaceMatches" .!= mempty) <*> (x .:? "Person") <*>
         (x .:? "Timestamp"))
...
instance FromJSON Point where
  parseJSON = withObject "Point" (\x -> Point' <$> (x .:? "X") <*> (x .:? "Y"))
...
spiKinesisVideoStream =
  lens _spiKinesisVideoStream (\s a -> s {_spiKinesisVideoStream = a})
...
instance ToJSON StreamProcessorInput where
  toJSON StreamProcessorInput' {..} =
    object (catMaybes [("KinesisVideoStream" .=) <$> _spiKinesisVideoStream])
...
spoKinesisDataStream =
  lens _spoKinesisDataStream (\s a -> s {_spoKinesisDataStream = a})
...
instance ToJSON StreamProcessorOutput where
  toJSON StreamProcessorOutput' {..} =
    object (catMaybes [("KinesisDataStream" .=) <$> _spoKinesisDataStream])
...
instance FromJSON TextDetection where
  parseJSON =
    withObject
      "TextDetection"
      (\x ->
         TextDetection' <$> (x .:? "DetectedText") <*> (x .:? "Confidence") <*>
         (x .:? "Geometry") <*>
         (x .:? "Id") <*>
         (x .:? "Type") <*>
         (x .:? "ParentId"))
...
instance ToJSON Video where
  toJSON Video' {..} = object (catMaybes [("S3Object" .=) <$> _vS3Object])
...
vmFrameHeight =
  lens _vmFrameHeight (\s a -> s {_vmFrameHeight = a}) . mapping _Nat

-- | Length of the video in milliseconds.
vmDurationMillis :: Lens' VideoMetadata (Maybe Natural)
vmDurationMillis =
  lens _vmDurationMillis (\s a -> s {_vmDurationMillis = a}) . mapping _Nat
...
instance FromJSON VideoMetadata where
  parseJSON =
    withObject
      "VideoMetadata"
      (\x ->
         VideoMetadata' <$> (x .:? "FrameRate") <*> (x .:? "Format") <*>
         (x .:? "Codec") <*>
         (x .:? "FrameHeight") <*>
         (x .:? "DurationMillis") <*>
         (x .:? "FrameWidth"))
