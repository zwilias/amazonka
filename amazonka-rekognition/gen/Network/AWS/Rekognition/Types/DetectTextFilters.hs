...
data DetectTextFilters = DetectTextFilters'{_dtfRegionsOfInterest
...
detectTextFilters
    :: DetectTextFilters
detectTextFilters
  = DetectTextFilters'{_dtfRegionsOfInterest = Nothing,
...
instance Hashable DetectTextFilters where

instance NFData DetectTextFilters where
