...
--
-- * 'pvdTestingDataResult' - The manifest file that represents the testing results.
--
...
--
-- * 'pvdTrainingDataResult' - The manifest file that represents the training results.
