...
data CelebrityDetail = CelebrityDetail'{_cdBoundingBox
                                        :: !(Maybe BoundingBox),
                                        _cdURLs :: !(Maybe [Text]),
...
celebrityDetail
    :: CelebrityDetail
celebrityDetail
  = CelebrityDetail'{_cdBoundingBox = Nothing,
                     _cdURLs = Nothing, _cdConfidence = Nothing,
                     _cdName = Nothing, _cdId = Nothing,
                     _cdFace = Nothing}
