...
data ProjectDescription = ProjectDescription'{_pdStatus
                                              :: !(Maybe ProjectStatus),
...
projectDescription
    :: ProjectDescription
projectDescription
  = ProjectDescription'{_pdStatus = Nothing,
...
instance FromJSON ProjectDescription where
        parseJSON
          = withObject "ProjectDescription"
              (\ x ->
                 ProjectDescription' <$>
                   (x .:? "Status") <*> (x .:? "CreationTimestamp") <*>
                     (x .:? "ProjectArn"))

instance Hashable ProjectDescription where

instance NFData ProjectDescription where
