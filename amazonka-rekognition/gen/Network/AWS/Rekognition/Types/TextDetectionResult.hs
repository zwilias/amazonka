...
data TextDetectionResult = TextDetectionResult'{_tdrTextDetection
                                                :: !(Maybe TextDetection),
                                                _tdrTimestamp ::
                                                !(Maybe Integer)}
...
textDetectionResult
    :: TextDetectionResult
textDetectionResult
  = TextDetectionResult'{_tdrTextDetection = Nothing,
...
instance FromJSON TextDetectionResult where
        parseJSON
          = withObject "TextDetectionResult"
              (\ x ->
                 TextDetectionResult' <$>
                   (x .:? "TextDetection") <*> (x .:? "Timestamp"))

instance Hashable TextDetectionResult where

instance NFData TextDetectionResult where
