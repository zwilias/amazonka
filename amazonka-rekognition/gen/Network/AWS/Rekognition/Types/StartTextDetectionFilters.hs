...
data StartTextDetectionFilters = StartTextDetectionFilters'{_stdfRegionsOfInterest
                                                            ::
                                                            !(Maybe
                                                                [RegionOfInterest]),
                                                            _stdfWordFilter ::
...
startTextDetectionFilters
    :: StartTextDetectionFilters
startTextDetectionFilters
  = StartTextDetectionFilters'{_stdfRegionsOfInterest =
                                 Nothing,
...
instance Hashable StartTextDetectionFilters where

instance NFData StartTextDetectionFilters where
