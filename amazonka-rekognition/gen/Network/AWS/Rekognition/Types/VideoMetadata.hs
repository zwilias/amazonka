...
data VideoMetadata = VideoMetadata'{_vmFrameRate ::
                                    !(Maybe Double),
...
videoMetadata
    :: VideoMetadata
videoMetadata
  = VideoMetadata'{_vmFrameRate = Nothing,
                   _vmFormat = Nothing, _vmCodec = Nothing,
                   _vmFrameHeight = Nothing,
                   _vmDurationMillis = Nothing, _vmFrameWidth = Nothing}
