...
instance FromText BudgetType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BudgetType from value: '" <>
        e <> "'. Accepted values: cost, ri_coverage, ri_utilization, usage"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: equal_to, greater_than, less_than"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: actual, forecasted"
...
instance FromText ThresholdType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ThresholdType from value: '" <>
        e <> "'. Accepted values: absolute_value, percentage"
...
instance FromText TimeUnit where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TimeUnit from value: '" <>
        e <> "'. Accepted values: annually, daily, monthly, quarterly"
