...
data BudgetPerformanceHistory = BudgetPerformanceHistory'{_bphBudgetedAndActualAmountsList
                                                          ::
                                                          !(Maybe
...
budgetPerformanceHistory
    :: BudgetPerformanceHistory
budgetPerformanceHistory
  = BudgetPerformanceHistory'{_bphBudgetedAndActualAmountsList
                                = Nothing,
                              _bphTimeUnit = Nothing, _bphBudgetName = Nothing,
                              _bphBudgetType = Nothing, _bphCostTypes = Nothing,
