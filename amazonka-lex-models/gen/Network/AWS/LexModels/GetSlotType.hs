...
instance AWSRequest GetSlotType where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetSlotTypeResponse' <$> (x .?> "checksum") <*>
...
instance ToPath GetSlotType where
  toPath GetSlotType' {..} =
    mconcat ["/slottypes/", toBS _gstName, "/versions/", toBS _gstVersion]
...
gstsrsValueSelectionStrategy ::
     Lens' GetSlotTypeResponse (Maybe SlotValueSelectionStrategy)
gstsrsValueSelectionStrategy =
  lens
    _gstsrsValueSelectionStrategy
    (\s a -> s {_gstsrsValueSelectionStrategy = a})

-- | The date that the slot type was created.
gstsrsCreatedDate :: Lens' GetSlotTypeResponse (Maybe UTCTime)
gstsrsCreatedDate =
  lens _gstsrsCreatedDate (\s a -> s {_gstsrsCreatedDate = a}) . mapping _Time
...
gstsrsLastUpdatedDate =
  lens _gstsrsLastUpdatedDate (\s a -> s {_gstsrsLastUpdatedDate = a}) .
  mapping _Time
...
gstsrsEnumerationValues ::
     Lens' GetSlotTypeResponse (Maybe (NonEmpty EnumerationValue))
gstsrsEnumerationValues =
  lens _gstsrsEnumerationValues (\s a -> s {_gstsrsEnumerationValues = a}) .
  mapping _List1

-- | -- | The response status code.
gstsrsResponseStatus :: Lens' GetSlotTypeResponse Int
gstsrsResponseStatus =
  lens _gstsrsResponseStatus (\s a -> s {_gstsrsResponseStatus = a})
