...
instance AWSRequest GetBotChannelAssociation where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetBotChannelAssociationResponse' <$> (x .?> "failureReason") <*>
         (x .?> "status") <*>
         (x .?> "botAlias") <*>
         (x .?> "botName") <*>
...
gbcarsFailureReason =
  lens _gbcarsFailureReason (\s a -> s {_gbcarsFailureReason = a})
...
gbcarsBotConfiguration ::
     Lens' GetBotChannelAssociationResponse (Maybe (HashMap Text Text))
gbcarsBotConfiguration =
  lens _gbcarsBotConfiguration (\s a -> s {_gbcarsBotConfiguration = a}) .
  mapping (_Sensitive . _Map)

-- | The date that the association between the bot and the channel was created.
gbcarsCreatedDate :: Lens' GetBotChannelAssociationResponse (Maybe UTCTime)
gbcarsCreatedDate =
  lens _gbcarsCreatedDate (\s a -> s {_gbcarsCreatedDate = a}) . mapping _Time
...
gbcarsResponseStatus =
  lens _gbcarsResponseStatus (\s a -> s {_gbcarsResponseStatus = a})
