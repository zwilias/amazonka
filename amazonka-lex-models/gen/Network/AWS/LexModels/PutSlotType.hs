...
pstValueSelectionStrategy ::
     Lens' PutSlotType (Maybe SlotValueSelectionStrategy)
pstValueSelectionStrategy =
  lens _pstValueSelectionStrategy (\s a -> s {_pstValueSelectionStrategy = a})
...
pstEnumerationValues =
  lens _pstEnumerationValues (\s a -> s {_pstEnumerationValues = a}) .
  mapping _List1
...
instance AWSRequest PutSlotType where
  ...
  response =
    receiveJSON
      (\s h x ->
         PutSlotTypeResponse' <$> (x .?> "checksum") <*>
...
pstrsValueSelectionStrategy ::
     Lens' PutSlotTypeResponse (Maybe SlotValueSelectionStrategy)
pstrsValueSelectionStrategy =
  lens
    _pstrsValueSelectionStrategy
    (\s a -> s {_pstrsValueSelectionStrategy = a})

-- | The date that the slot type was created.
pstrsCreatedDate :: Lens' PutSlotTypeResponse (Maybe UTCTime)
pstrsCreatedDate =
  lens _pstrsCreatedDate (\s a -> s {_pstrsCreatedDate = a}) . mapping _Time
...
pstrsLastUpdatedDate =
  lens _pstrsLastUpdatedDate (\s a -> s {_pstrsLastUpdatedDate = a}) .
  mapping _Time

-- | Undocumented member.
pstrsCreateVersion :: Lens' PutSlotTypeResponse (Maybe Bool)
pstrsCreateVersion =
  lens _pstrsCreateVersion (\s a -> s {_pstrsCreateVersion = a})
...
pstrsEnumerationValues ::
     Lens' PutSlotTypeResponse (Maybe (NonEmpty EnumerationValue))
pstrsEnumerationValues =
  lens _pstrsEnumerationValues (\s a -> s {_pstrsEnumerationValues = a}) .
  mapping _List1

-- | -- | The response status code.
pstrsResponseStatus :: Lens' PutSlotTypeResponse Int
pstrsResponseStatus =
  lens _pstrsResponseStatus (\s a -> s {_pstrsResponseStatus = a})
