...
piFulfillmentActivity =
  lens _piFulfillmentActivity (\s a -> s {_piFulfillmentActivity = a})
...
piRejectionStatement =
  lens _piRejectionStatement (\s a -> s {_piRejectionStatement = a})
...
piConclusionStatement =
  lens _piConclusionStatement (\s a -> s {_piConclusionStatement = a})
...
piSampleUtterances =
  lens _piSampleUtterances (\s a -> s {_piSampleUtterances = a}) .
  _Default . _Coerce
...
piParentIntentSignature =
  lens _piParentIntentSignature (\s a -> s {_piParentIntentSignature = a})
...
piConfirmationPrompt =
  lens _piConfirmationPrompt (\s a -> s {_piConfirmationPrompt = a})
...
instance AWSRequest PutIntent where
  ...
  response =
    receiveJSON
      (\s h x ->
         PutIntentResponse' <$> (x .?> "fulfillmentActivity") <*>
         (x .?> "slots" .!@ mempty) <*>
...
pirsFulfillmentActivity =
  lens _pirsFulfillmentActivity (\s a -> s {_pirsFulfillmentActivity = a})
...
pirsRejectionStatement =
  lens _pirsRejectionStatement (\s a -> s {_pirsRejectionStatement = a})
...
pirsConclusionStatement =
  lens _pirsConclusionStatement (\s a -> s {_pirsConclusionStatement = a})

-- | An array of sample utterances that are configured for the intent.
pirsSampleUtterances :: Lens' PutIntentResponse [Text]
pirsSampleUtterances =
  lens _pirsSampleUtterances (\s a -> s {_pirsSampleUtterances = a}) .
  _Default . _Coerce

-- | A unique identifier for the built-in intent that this intent is based on.
pirsParentIntentSignature :: Lens' PutIntentResponse (Maybe Text)
pirsParentIntentSignature =
  lens _pirsParentIntentSignature (\s a -> s {_pirsParentIntentSignature = a})

-- | The date that the intent was created.
pirsCreatedDate :: Lens' PutIntentResponse (Maybe UTCTime)
pirsCreatedDate =
  lens _pirsCreatedDate (\s a -> s {_pirsCreatedDate = a}) . mapping _Time
...
pirsFollowUpPrompt =
  lens _pirsFollowUpPrompt (\s a -> s {_pirsFollowUpPrompt = a})

-- | The date that the intent was updated. When you create a resource, the creation date and last update dates are the same.
pirsLastUpdatedDate :: Lens' PutIntentResponse (Maybe UTCTime)
pirsLastUpdatedDate =
  lens _pirsLastUpdatedDate (\s a -> s {_pirsLastUpdatedDate = a}) .
  mapping _Time

-- | If defined in the intent, Amazon Lex prompts the user to confirm the intent before fulfilling it.
pirsConfirmationPrompt :: Lens' PutIntentResponse (Maybe Prompt)
pirsConfirmationPrompt =
  lens _pirsConfirmationPrompt (\s a -> s {_pirsConfirmationPrompt = a})
...
pirsDialogCodeHook =
  lens _pirsDialogCodeHook (\s a -> s {_pirsDialogCodeHook = a})
...
pirsResponseStatus =
  lens _pirsResponseStatus (\s a -> s {_pirsResponseStatus = a})
