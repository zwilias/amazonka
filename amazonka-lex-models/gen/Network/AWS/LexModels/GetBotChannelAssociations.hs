...
gbcaMaxResults =
  lens _gbcaMaxResults (\s a -> s {_gbcaMaxResults = a}) . mapping _Nat
...
instance AWSRequest GetBotChannelAssociations where
  type Rs GetBotChannelAssociations = GetBotChannelAssociationsResponse
...
gbcasrsBotChannelAssociations ::
     Lens' GetBotChannelAssociationsResponse [BotChannelAssociation]
gbcasrsBotChannelAssociations =
  lens
    _gbcasrsBotChannelAssociations
    (\s a -> s {_gbcasrsBotChannelAssociations = a}) .
  _Default . _Coerce
...
gbcasrsResponseStatus =
  lens _gbcasrsResponseStatus (\s a -> s {_gbcasrsResponseStatus = a})
