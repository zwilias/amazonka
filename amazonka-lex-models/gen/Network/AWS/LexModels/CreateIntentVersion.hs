...
instance AWSRequest CreateIntentVersion where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateIntentVersionResponse' <$> (x .?> "fulfillmentActivity") <*>
         (x .?> "slots" .!@ mempty) <*>
...
civrsFulfillmentActivity ::
     Lens' CreateIntentVersionResponse (Maybe FulfillmentActivity)
civrsFulfillmentActivity =
  lens _civrsFulfillmentActivity (\s a -> s {_civrsFulfillmentActivity = a})
...
civrsRejectionStatement =
  lens _civrsRejectionStatement (\s a -> s {_civrsRejectionStatement = a})
...
civrsConclusionStatement =
  lens _civrsConclusionStatement (\s a -> s {_civrsConclusionStatement = a})

-- | An array of sample utterances configured for the intent.
civrsSampleUtterances :: Lens' CreateIntentVersionResponse [Text]
civrsSampleUtterances =
  lens _civrsSampleUtterances (\s a -> s {_civrsSampleUtterances = a}) .
  _Default . _Coerce

-- | A unique identifier for a built-in intent.
civrsParentIntentSignature :: Lens' CreateIntentVersionResponse (Maybe Text)
civrsParentIntentSignature =
  lens _civrsParentIntentSignature (\s a -> s {_civrsParentIntentSignature = a})

-- | The date that the intent was created.
civrsCreatedDate :: Lens' CreateIntentVersionResponse (Maybe UTCTime)
civrsCreatedDate =
  lens _civrsCreatedDate (\s a -> s {_civrsCreatedDate = a}) . mapping _Time
...
civrsResponseStatus =
  lens _civrsResponseStatus (\s a -> s {_civrsResponseStatus = a})
