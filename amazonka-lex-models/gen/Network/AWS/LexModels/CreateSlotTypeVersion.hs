...
instance AWSRequest CreateSlotTypeVersion where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateSlotTypeVersionResponse' <$> (x .?> "checksum") <*>
...
cstvrsValueSelectionStrategy ::
     Lens' CreateSlotTypeVersionResponse (Maybe SlotValueSelectionStrategy)
cstvrsValueSelectionStrategy =
  lens
    _cstvrsValueSelectionStrategy
    (\s a -> s {_cstvrsValueSelectionStrategy = a})

-- | The date that the slot type was created.
cstvrsCreatedDate :: Lens' CreateSlotTypeVersionResponse (Maybe UTCTime)
cstvrsCreatedDate =
  lens _cstvrsCreatedDate (\s a -> s {_cstvrsCreatedDate = a}) . mapping _Time
...
cstvrsLastUpdatedDate =
  lens _cstvrsLastUpdatedDate (\s a -> s {_cstvrsLastUpdatedDate = a}) .
  mapping _Time
...
cstvrsEnumerationValues ::
     Lens' CreateSlotTypeVersionResponse (Maybe (NonEmpty EnumerationValue))
cstvrsEnumerationValues =
  lens _cstvrsEnumerationValues (\s a -> s {_cstvrsEnumerationValues = a}) .
  mapping _List1

-- | -- | The response status code.
cstvrsResponseStatus :: Lens' CreateSlotTypeVersionResponse Int
cstvrsResponseStatus =
  lens _cstvrsResponseStatus (\s a -> s {_cstvrsResponseStatus = a})
