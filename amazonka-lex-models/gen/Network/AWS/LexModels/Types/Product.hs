...
bamCreatedDate =
  lens _bamCreatedDate (\s a -> s {_bamCreatedDate = a}) . mapping _Time
...
bamLastUpdatedDate =
  lens _bamLastUpdatedDate (\s a -> s {_bamLastUpdatedDate = a}) . mapping _Time
...
instance FromJSON BotAliasMetadata where
  parseJSON =
    withObject
      "BotAliasMetadata"
      (\x ->
         BotAliasMetadata' <$> (x .:? "checksum") <*> (x .:? "botVersion") <*>
         (x .:? "botName") <*>
         (x .:? "createdDate") <*>
         (x .:? "name") <*>
         (x .:? "lastUpdatedDate") <*>
...
bcaBotConfiguration =
  lens _bcaBotConfiguration (\s a -> s {_bcaBotConfiguration = a}) .
  mapping (_Sensitive . _Map)

-- | The date that the association between the Amazon Lex bot and the channel was created.
bcaCreatedDate :: Lens' BotChannelAssociation (Maybe UTCTime)
bcaCreatedDate =
  lens _bcaCreatedDate (\s a -> s {_bcaCreatedDate = a}) . mapping _Time
...
instance FromJSON BotChannelAssociation where
  parseJSON =
    withObject
      "BotChannelAssociation"
      (\x ->
         BotChannelAssociation' <$> (x .:? "failureReason") <*> (x .:? "status") <*>
         (x .:? "botAlias") <*>
         (x .:? "botName") <*>
...
bmCreatedDate =
  lens _bmCreatedDate (\s a -> s {_bmCreatedDate = a}) . mapping _Time
...
bmLastUpdatedDate =
  lens _bmLastUpdatedDate (\s a -> s {_bmLastUpdatedDate = a}) . mapping _Time
...
instance FromJSON BotMetadata where
  parseJSON =
    withObject
      "BotMetadata"
      (\x ->
         BotMetadata' <$> (x .:? "status") <*> (x .:? "createdDate") <*>
         (x .:? "name") <*>
         (x .:? "version") <*>
         (x .:? "lastUpdatedDate") <*>
         (x .:? "description"))
...
bimSupportedLocales =
  lens _bimSupportedLocales (\s a -> s {_bimSupportedLocales = a}) .
  _Default . _Coerce
...
instance FromJSON BuiltinIntentMetadata where
  parseJSON =
    withObject
      "BuiltinIntentMetadata"
      (\x ->
         BuiltinIntentMetadata' <$> (x .:? "signature") <*>
...
instance FromJSON BuiltinIntentSlot where
  parseJSON =
    withObject "BuiltinIntentSlot" (\x -> BuiltinIntentSlot' <$> (x .:? "name"))
...
bstmSupportedLocales =
  lens _bstmSupportedLocales (\s a -> s {_bstmSupportedLocales = a}) .
  _Default . _Coerce
...
instance FromJSON BuiltinSlotTypeMetadata where
  parseJSON =
    withObject
      "BuiltinSlotTypeMetadata"
      (\x ->
         BuiltinSlotTypeMetadata' <$> (x .:? "signature") <*>
         (x .:? "supportedLocales" .!= mempty))
...
instance ToJSON CodeHook where
  toJSON CodeHook' {..} =
    object
      (catMaybes
         [Just ("uri" .= _chUri), Just ("messageVersion" .= _chMessageVersion)])
...
instance FromJSON EnumerationValue where
  parseJSON =
    withObject
      "EnumerationValue"
      (\x ->
         EnumerationValue' <$> (x .:? "synonyms" .!= mempty) <*> (x .: "value"))
...
instance ToJSON EnumerationValue where
  toJSON EnumerationValue' {..} =
    object
      (catMaybes [("synonyms" .=) <$> _evSynonyms, Just ("value" .= _evValue)])
...
fupRejectionStatement =
  lens _fupRejectionStatement (\s a -> s {_fupRejectionStatement = a})

instance FromJSON FollowUpPrompt where
  parseJSON =
    withObject
      "FollowUpPrompt"
      (\x -> FollowUpPrompt' <$> (x .: "prompt") <*> (x .: "rejectionStatement"))
...
instance FromJSON FulfillmentActivity where
  parseJSON =
    withObject
      "FulfillmentActivity"
      (\x -> FulfillmentActivity' <$> (x .:? "codeHook") <*> (x .: "type"))
...
instance ToJSON FulfillmentActivity where
  toJSON FulfillmentActivity' {..} =
    object
      (catMaybes [("codeHook" .=) <$> _faCodeHook, Just ("type" .= _faType)])
...
imCreatedDate =
  lens _imCreatedDate (\s a -> s {_imCreatedDate = a}) . mapping _Time
...
imLastUpdatedDate =
  lens _imLastUpdatedDate (\s a -> s {_imLastUpdatedDate = a}) . mapping _Time
...
instance FromJSON IntentMetadata where
  parseJSON =
    withObject
      "IntentMetadata"
      (\x ->
         IntentMetadata' <$> (x .:? "createdDate") <*> (x .:? "name") <*>
         (x .:? "version") <*>
         (x .:? "lastUpdatedDate") <*>
         (x .:? "description"))
...
instance FromJSON Message where
  parseJSON =
    withObject
      "Message"
      (\x ->
         Message' <$> (x .:? "groupNumber") <*> (x .: "contentType") <*>
         (x .: "content"))
...
instance FromJSON Prompt where
  parseJSON =
    withObject
      "Prompt"
      (\x ->
         Prompt' <$> (x .:? "responseCard") <*> (x .: "messages") <*>
         (x .: "maxAttempts"))
...
sValueElicitationPrompt =
  lens _sValueElicitationPrompt (\s a -> s {_sValueElicitationPrompt = a})
...
sSampleUtterances =
  lens _sSampleUtterances (\s a -> s {_sSampleUtterances = a}) .
  _Default . _Coerce
...
instance FromJSON Slot where
  parseJSON =
    withObject
      "Slot"
      (\x ->
         Slot' <$> (x .:? "slotType") <*> (x .:? "valueElicitationPrompt") <*>
         (x .:? "responseCard") <*>
         (x .:? "priority") <*>
         (x .:? "slotTypeVersion") <*>
...
stmCreatedDate =
  lens _stmCreatedDate (\s a -> s {_stmCreatedDate = a}) . mapping _Time
...
stmLastUpdatedDate =
  lens _stmLastUpdatedDate (\s a -> s {_stmLastUpdatedDate = a}) . mapping _Time
...
instance FromJSON SlotTypeMetadata where
  parseJSON =
    withObject
      "SlotTypeMetadata"
      (\x ->
         SlotTypeMetadata' <$> (x .:? "createdDate") <*> (x .:? "name") <*>
         (x .:? "version") <*>
         (x .:? "lastUpdatedDate") <*>
         (x .:? "description"))
...
instance FromJSON Statement where
  parseJSON =
    withObject
      "Statement"
      (\x -> Statement' <$> (x .:? "responseCard") <*> (x .: "messages"))
...
udFirstUtteredDate =
  lens _udFirstUtteredDate (\s a -> s {_udFirstUtteredDate = a}) . mapping _Time
...
udLastUtteredDate =
  lens _udLastUtteredDate (\s a -> s {_udLastUtteredDate = a}) . mapping _Time
...
instance FromJSON UtteranceData where
  parseJSON =
    withObject
      "UtteranceData"
      (\x ->
         UtteranceData' <$> (x .:? "firstUtteredDate") <*> (x .:? "count") <*>
         (x .:? "utteranceString") <*>
         (x .:? "lastUtteredDate") <*>
         (x .:? "distinctUsers"))
...
ulUtterances =
  lens _ulUtterances (\s a -> s {_ulUtterances = a}) . _Default . _Coerce
