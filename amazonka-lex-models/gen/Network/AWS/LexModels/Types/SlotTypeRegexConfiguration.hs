...
newtype SlotTypeRegexConfiguration = SlotTypeRegexConfiguration'{_strcPattern
                                                                 :: Text}
...
slotTypeRegexConfiguration pPattern_
  = SlotTypeRegexConfiguration'{_strcPattern =
                                  pPattern_}
...
instance FromJSON SlotTypeRegexConfiguration where
        parseJSON
          = withObject "SlotTypeRegexConfiguration"
              (\ x ->
                 SlotTypeRegexConfiguration' <$> (x .: "pattern"))

instance Hashable SlotTypeRegexConfiguration where

instance NFData SlotTypeRegexConfiguration where
