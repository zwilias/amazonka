...
data LogSettingsRequest = LogSettingsRequest'{_lsrKmsKeyARN
                                              :: !(Maybe Text),
                                              _lsrLogType :: !LogType,
...
logSettingsRequest
    :: LogType -- ^ 'lsrLogType'
    -> Destination -- ^ 'lsrDestination'
    -> Text -- ^ 'lsrResourceARN'
    -> LogSettingsRequest
logSettingsRequest pLogType_ pDestination_
  pResourceARN_
  = LogSettingsRequest'{_lsrKmsKeyARN = Nothing,
...
instance Hashable LogSettingsRequest where

instance NFData LogSettingsRequest where
