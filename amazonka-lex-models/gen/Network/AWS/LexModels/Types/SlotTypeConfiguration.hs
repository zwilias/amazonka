...
newtype SlotTypeConfiguration = SlotTypeConfiguration'{_stcRegexConfiguration
                                                       ::
                                                       Maybe
...
slotTypeConfiguration
    :: SlotTypeConfiguration
slotTypeConfiguration
  = SlotTypeConfiguration'{_stcRegexConfiguration =
                             Nothing}
...
instance FromJSON SlotTypeConfiguration where
        parseJSON
          = withObject "SlotTypeConfiguration"
              (\ x ->
                 SlotTypeConfiguration' <$>
                   (x .:? "regexConfiguration"))

instance Hashable SlotTypeConfiguration where

instance NFData SlotTypeConfiguration where
