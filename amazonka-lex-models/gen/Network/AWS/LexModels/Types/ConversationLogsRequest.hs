...
data ConversationLogsRequest = ConversationLogsRequest'{_clrLogSettings
                                                        ::
                                                        ![LogSettingsRequest],
                                                        _clrIamRoleARN :: !Text}
...
conversationLogsRequest pIamRoleARN_
  = ConversationLogsRequest'{_clrLogSettings = mempty,
...
instance Hashable ConversationLogsRequest where

instance NFData ConversationLogsRequest where
