...
data Message = Message'{_mGroupNumber ::
                        !(Maybe Nat),
                        _mContentType :: !ContentType, _mContent :: !Text}
...
message pContentType_ pContent_
  = Message'{_mGroupNumber = Nothing,
             _mContentType = pContentType_, _mContent = pContent_}
