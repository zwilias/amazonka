...
data CopySnapshot = CopySnapshot'{_csUseLatestRestorableAutoSnapshot
                                  :: !(Maybe Bool),
...
copySnapshot pTargetSnapshotName_ pSourceRegion_
  = CopySnapshot'{_csUseLatestRestorableAutoSnapshot =
                    Nothing,
...
data CopySnapshotResponse = CopySnapshotResponse'{_csrsOperations
                                                  :: !(Maybe [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'csrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
copySnapshotResponse pResponseStatus_
  = CopySnapshotResponse'{_csrsOperations = Nothing,
