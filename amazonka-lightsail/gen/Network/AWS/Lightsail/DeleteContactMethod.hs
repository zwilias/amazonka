...
newtype DeleteContactMethod = DeleteContactMethod'{_dcmProtocol
                                                   :: ContactProtocol}
...
instance Hashable DeleteContactMethod where

instance NFData DeleteContactMethod where
...
data DeleteContactMethodResponse = DeleteContactMethodResponse'{_dcmrsOperations
                                                                ::
                                                                !(Maybe
                                                                    [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dcmrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
deleteContactMethodResponse pResponseStatus_
  = DeleteContactMethodResponse'{_dcmrsOperations =
                                   Nothing,
...
instance NFData DeleteContactMethodResponse where
