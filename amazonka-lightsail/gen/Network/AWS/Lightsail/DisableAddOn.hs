...
data DisableAddOn = DisableAddOn'{_daoAddOnType ::
                                  !AddOnType,
...
disableAddOn
    :: AddOnType -- ^ 'daoAddOnType'
    -> Text -- ^ 'daoResourceName'
    -> DisableAddOn
disableAddOn pAddOnType_ pResourceName_
  = DisableAddOn'{_daoAddOnType = pAddOnType_,
...
instance Hashable DisableAddOn where

instance NFData DisableAddOn where
...
data DisableAddOnResponse = DisableAddOnResponse'{_daorsOperations
                                                  :: !(Maybe [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'daorsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
disableAddOnResponse pResponseStatus_
  = DisableAddOnResponse'{_daorsOperations = Nothing,
...
instance NFData DisableAddOnResponse where
