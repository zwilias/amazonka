...
newtype GetRelationalDatabaseSnapshot = GetRelationalDatabaseSnapshot'{_grdsRelationalDatabaseSnapshotName
                                                                       :: Text}
...
getRelationalDatabaseSnapshot
  ...
  = GetRelationalDatabaseSnapshot'{_grdsRelationalDatabaseSnapshotName
                                     = pRelationalDatabaseSnapshotName_}
...
data GetRelationalDatabaseSnapshotResponse = GetRelationalDatabaseSnapshotResponse'{_getrsRelationalDatabaseSnapshot
                                                                                    ::
                                                                                    !(Maybe
...
getRelationalDatabaseSnapshotResponse
  pResponseStatus_
  = GetRelationalDatabaseSnapshotResponse'{_getrsRelationalDatabaseSnapshot
                                             = Nothing,
                                           _getrsResponseStatus =
                                             pResponseStatus_}
