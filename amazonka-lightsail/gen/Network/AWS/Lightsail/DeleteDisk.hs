...
data DeleteDisk = DeleteDisk'{_dForceDeleteAddOns ::
                              !(Maybe Bool),
                              _dDiskName :: !Text}
...
deleteDisk pDiskName_
  = DeleteDisk'{_dForceDeleteAddOns = Nothing,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
