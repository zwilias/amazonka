...
data CreateRelationalDatabaseFromSnapshot = CreateRelationalDatabaseFromSnapshot'{_crdfsSourceRelationalDatabaseName
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
createRelationalDatabaseFromSnapshot
  ...
  = CreateRelationalDatabaseFromSnapshot'{_crdfsSourceRelationalDatabaseName
                                            = Nothing,
                                          _crdfsRelationalDatabaseBundleId =
                                            Nothing,
...
data CreateRelationalDatabaseFromSnapshotResponse = CreateRelationalDatabaseFromSnapshotResponse'{_crdfsrsOperations
                                                                                                  ::
                                                                                                  !(Maybe
                                                                                                      [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'crdfsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
createRelationalDatabaseFromSnapshotResponse
  pResponseStatus_
  = CreateRelationalDatabaseFromSnapshotResponse'{_crdfsrsOperations
                                                    = Nothing,
                                                  _crdfsrsResponseStatus =
                                                    pResponseStatus_}
