...
newtype SendContactMethodVerification = SendContactMethodVerification'{_scmvProtocol
                                                                       ::
...
sendContactMethodVerification
    :: ContactMethodVerificationProtocol -- ^ 'scmvProtocol'
    -> SendContactMethodVerification
sendContactMethodVerification pProtocol_
  = SendContactMethodVerification'{_scmvProtocol =
                                     pProtocol_}
...
instance AWSRequest SendContactMethodVerification
         where
...
instance Hashable SendContactMethodVerification where

instance NFData SendContactMethodVerification where

instance ToHeaders SendContactMethodVerification
         where
        toHeaders
          = const
              (mconcat
...
data SendContactMethodVerificationResponse = SendContactMethodVerificationResponse'{_scmvrsOperations
                                                                                    ::
                                                                                    !(Maybe
                                                                                        [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'scmvrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
-- * 'scmvrsResponseStatus' - -- | The response status code.
sendContactMethodVerificationResponse
    :: Int -- ^ 'scmvrsResponseStatus'
    -> SendContactMethodVerificationResponse
sendContactMethodVerificationResponse
  pResponseStatus_
  = SendContactMethodVerificationResponse'{_scmvrsOperations
                                             = Nothing,
                                           _scmvrsResponseStatus =
                                             pResponseStatus_}
