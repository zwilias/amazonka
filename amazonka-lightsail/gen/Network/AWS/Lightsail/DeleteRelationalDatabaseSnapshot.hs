...
newtype DeleteRelationalDatabaseSnapshot = DeleteRelationalDatabaseSnapshot'{_drdsRelationalDatabaseSnapshotName
                                                                             ::
                                                                             Text}
...
deleteRelationalDatabaseSnapshot
  ...
  = DeleteRelationalDatabaseSnapshot'{_drdsRelationalDatabaseSnapshotName
                                        = pRelationalDatabaseSnapshotName_}
...
data DeleteRelationalDatabaseSnapshotResponse = DeleteRelationalDatabaseSnapshotResponse'{_drdsrsOperations
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drdsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
deleteRelationalDatabaseSnapshotResponse
  pResponseStatus_
  = DeleteRelationalDatabaseSnapshotResponse'{_drdsrsOperations
                                                = Nothing,
                                              _drdsrsResponseStatus =
                                                pResponseStatus_}
