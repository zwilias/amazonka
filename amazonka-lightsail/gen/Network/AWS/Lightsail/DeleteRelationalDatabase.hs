...
data DeleteRelationalDatabase = DeleteRelationalDatabase'{_drdSkipFinalSnapshot
                                                          :: !(Maybe Bool),
...
deleteRelationalDatabase pRelationalDatabaseName_
  = DeleteRelationalDatabase'{_drdSkipFinalSnapshot =
                                Nothing,
...
data DeleteRelationalDatabaseResponse = DeleteRelationalDatabaseResponse'{_drdrsOperations
                                                                          ::
                                                                          !(Maybe
                                                                              [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drdrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
deleteRelationalDatabaseResponse pResponseStatus_
  = DeleteRelationalDatabaseResponse'{_drdrsOperations
                                        = Nothing,
