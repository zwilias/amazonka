...
data GetRelationalDatabaseEvents = GetRelationalDatabaseEvents'{_grdeDurationInMinutes
                                                                :: !(Maybe Int),
                                                                _grdePageToken
                                                                ::
                                                                !(Maybe Text),
...
getRelationalDatabaseEvents pRelationalDatabaseName_
  = GetRelationalDatabaseEvents'{_grdeDurationInMinutes
                                   = Nothing,
...
data GetRelationalDatabaseEventsResponse = GetRelationalDatabaseEventsResponse'{_grdersNextPageToken
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
getRelationalDatabaseEventsResponse pResponseStatus_
  = GetRelationalDatabaseEventsResponse'{_grdersNextPageToken
                                           = Nothing,
                                         _grdersRelationalDatabaseEvents =
                                           Nothing,
                                         _grdersResponseStatus =
