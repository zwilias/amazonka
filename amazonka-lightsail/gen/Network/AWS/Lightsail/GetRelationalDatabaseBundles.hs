...
newtype GetRelationalDatabaseBundles = GetRelationalDatabaseBundles'{_gPageToken
                                                                     ::
                                                                     Maybe Text}
...
getRelationalDatabaseBundles
    :: GetRelationalDatabaseBundles
getRelationalDatabaseBundles
  = GetRelationalDatabaseBundles'{_gPageToken =
                                    Nothing}
...
data GetRelationalDatabaseBundlesResponse = GetRelationalDatabaseBundlesResponse'{_grdbrsNextPageToken
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
                                                                                  _grdbrsBundles
...
getRelationalDatabaseBundlesResponse pResponseStatus_
  = GetRelationalDatabaseBundlesResponse'{_grdbrsNextPageToken
                                            = Nothing,
