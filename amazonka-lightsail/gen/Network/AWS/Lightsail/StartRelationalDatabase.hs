...
newtype StartRelationalDatabase = StartRelationalDatabase'{_sRelationalDatabaseName
                                                           :: Text}
...
startRelationalDatabase pRelationalDatabaseName_
  = StartRelationalDatabase'{_sRelationalDatabaseName =
...
data StartRelationalDatabaseResponse = StartRelationalDatabaseResponse'{_srdrsOperations
                                                                        ::
                                                                        !(Maybe
                                                                            [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'srdrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
startRelationalDatabaseResponse pResponseStatus_
  = StartRelationalDatabaseResponse'{_srdrsOperations =
                                       Nothing,
