...
data GetRelationalDatabaseParameters = GetRelationalDatabaseParameters'{_grdpPageToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
getRelationalDatabaseParameters
  ...
  = GetRelationalDatabaseParameters'{_grdpPageToken =
                                       Nothing,
                                     _grdpRelationalDatabaseName =
                                       pRelationalDatabaseName_}
...
data GetRelationalDatabaseParametersResponse = GetRelationalDatabaseParametersResponse'{_grdprsNextPageToken
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
                                                                                        _grdprsParameters
...
getRelationalDatabaseParametersResponse
  pResponseStatus_
  = GetRelationalDatabaseParametersResponse'{_grdprsNextPageToken
                                               = Nothing,
