...
data TagResource = TagResource'{_trResourceARN ::
                                !(Maybe Text),
                                _trResourceName :: !Text, _trTags :: ![Tag]}
...
tagResource pResourceName_
  = TagResource'{_trResourceARN = Nothing,
                 _trResourceName = pResourceName_, _trTags = mempty}
...
data TagResourceResponse = TagResourceResponse'{_trrsOperations
                                                :: !(Maybe [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'trrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
tagResourceResponse pResponseStatus_
  = TagResourceResponse'{_trrsOperations = Nothing,
