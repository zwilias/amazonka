...
newtype GetRelationalDatabaseLogStreams = GetRelationalDatabaseLogStreams'{_grdlsRelationalDatabaseName
                                                                           ::
                                                                           Text}
...
getRelationalDatabaseLogStreams
  ...
  = GetRelationalDatabaseLogStreams'{_grdlsRelationalDatabaseName
                                       = pRelationalDatabaseName_}
...
data GetRelationalDatabaseLogStreamsResponse = GetRelationalDatabaseLogStreamsResponse'{_grdlsrsLogStreams
                                                                                        ::
                                                                                        !(Maybe
                                                                                            [Text]),
...
getRelationalDatabaseLogStreamsResponse
  pResponseStatus_
  = GetRelationalDatabaseLogStreamsResponse'{_grdlsrsLogStreams
                                               = Nothing,
                                             _grdlsrsResponseStatus =
                                               pResponseStatus_}
