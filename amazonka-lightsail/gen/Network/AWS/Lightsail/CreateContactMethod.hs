...
data CreateContactMethod = CreateContactMethod'{_ccmProtocol
                                                :: !ContactProtocol,
...
instance Hashable CreateContactMethod where

instance NFData CreateContactMethod where
...
data CreateContactMethodResponse = CreateContactMethodResponse'{_ccmrsOperations
                                                                ::
                                                                !(Maybe
                                                                    [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccmrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
createContactMethodResponse pResponseStatus_
  = CreateContactMethodResponse'{_ccmrsOperations =
                                   Nothing,
...
instance NFData CreateContactMethodResponse where
