...
newtype GetCloudFormationStackRecords = GetCloudFormationStackRecords'{_gcfsrPageToken
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
getCloudFormationStackRecords
    :: GetCloudFormationStackRecords
getCloudFormationStackRecords
  = GetCloudFormationStackRecords'{_gcfsrPageToken =
                                     Nothing}
...
data GetCloudFormationStackRecordsResponse = GetCloudFormationStackRecordsResponse'{_gcfsrrsNextPageToken
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
getCloudFormationStackRecordsResponse
  pResponseStatus_
  = GetCloudFormationStackRecordsResponse'{_gcfsrrsNextPageToken
                                             = Nothing,
                                           _gcfsrrsCloudFormationStackRecords =
                                             Nothing,
                                           _gcfsrrsResponseStatus =
