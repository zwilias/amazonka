...
newtype RebootRelationalDatabase = RebootRelationalDatabase'{_rrdRelationalDatabaseName
                                                             :: Text}
...
rebootRelationalDatabase pRelationalDatabaseName_
  = RebootRelationalDatabase'{_rrdRelationalDatabaseName
...
data RebootRelationalDatabaseResponse = RebootRelationalDatabaseResponse'{_rrdrsOperations
                                                                          ::
                                                                          !(Maybe
                                                                              [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rrdrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
rebootRelationalDatabaseResponse pResponseStatus_
  = RebootRelationalDatabaseResponse'{_rrdrsOperations
                                        = Nothing,
