...
newtype CreateCloudFormationStack = CreateCloudFormationStack'{_ccfsInstances
                                                               ::
                                                               [InstanceEntry]}
...
data CreateCloudFormationStackResponse = CreateCloudFormationStackResponse'{_ccfsrsOperations
                                                                            ::
                                                                            !(Maybe
                                                                                [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccfsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
createCloudFormationStackResponse pResponseStatus_
  = CreateCloudFormationStackResponse'{_ccfsrsOperations
                                         = Nothing,
