...
newtype ExportSnapshot = ExportSnapshot'{_esSourceSnapshotName
                                         :: Text}
...
exportSnapshot pSourceSnapshotName_
  = ExportSnapshot'{_esSourceSnapshotName =
...
data ExportSnapshotResponse = ExportSnapshotResponse'{_esrsOperations
                                                      :: !(Maybe [Operation]),
                                                      _esrsResponseStatus ::
                                                      !Int}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'esrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
exportSnapshotResponse pResponseStatus_
  = ExportSnapshotResponse'{_esrsOperations = Nothing,
