...
data UpdateRelationalDatabaseParameters = UpdateRelationalDatabaseParameters'{_urdpRelationalDatabaseName
                                                                              ::
                                                                              !Text,
                                                                              _urdpParameters
                                                                              ::
...
updateRelationalDatabaseParameters
  ...
  = UpdateRelationalDatabaseParameters'{_urdpRelationalDatabaseName
                                          = pRelationalDatabaseName_,
...
data UpdateRelationalDatabaseParametersResponse = UpdateRelationalDatabaseParametersResponse'{_urdprsOperations
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'urdprsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
updateRelationalDatabaseParametersResponse
  pResponseStatus_
  = UpdateRelationalDatabaseParametersResponse'{_urdprsOperations
                                                  = Nothing,
                                                _urdprsResponseStatus =
                                                  pResponseStatus_}
