...
data GetRelationalDatabaseLogEvents = GetRelationalDatabaseLogEvents'{_grdleStartTime
                                                                      ::
                                                                      !(Maybe
                                                                          POSIX),
                                                                      _grdleStartFromHead
...
getRelationalDatabaseLogEvents
    ...
    -> GetRelationalDatabaseLogEvents
getRelationalDatabaseLogEvents
  pRelationalDatabaseName_ pLogStreamName_
  = GetRelationalDatabaseLogEvents'{_grdleStartTime =
                                      Nothing,
...
data GetRelationalDatabaseLogEventsResponse = GetRelationalDatabaseLogEventsResponse'{_grdlersNextBackwardToken
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
getRelationalDatabaseLogEventsResponse
  pResponseStatus_
  = GetRelationalDatabaseLogEventsResponse'{_grdlersNextBackwardToken
                                              = Nothing,
