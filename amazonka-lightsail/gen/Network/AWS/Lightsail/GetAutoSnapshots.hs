...
newtype GetAutoSnapshots = GetAutoSnapshots'{_gasResourceName
                                             :: Text}
...
getAutoSnapshots
    :: Text -- ^ 'gasResourceName'
    -> GetAutoSnapshots
getAutoSnapshots pResourceName_
  = GetAutoSnapshots'{_gasResourceName =
                        pResourceName_}
...
instance Hashable GetAutoSnapshots where

instance NFData GetAutoSnapshots where
...
data GetAutoSnapshotsResponse = GetAutoSnapshotsResponse'{_gasrsResourceType
                                                          ::
                                                          !(Maybe ResourceType),
                                                          _gasrsResourceName ::
                                                          !(Maybe Text),
...
getAutoSnapshotsResponse pResponseStatus_
  = GetAutoSnapshotsResponse'{_gasrsResourceType =
                                Nothing,
...
instance NFData GetAutoSnapshotsResponse where
