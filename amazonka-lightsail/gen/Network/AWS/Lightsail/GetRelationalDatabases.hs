...
newtype GetRelationalDatabases = GetRelationalDatabases'{_grdPageToken
                                                         :: Maybe Text}
...
data GetRelationalDatabasesResponse = GetRelationalDatabasesResponse'{_grdrsNextPageToken
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'grdrsNextPageToken' - The token to advance to the next page of resutls from your request. A next page token is not returned if there are no more results to display. To get the next page of results, perform another @GetRelationalDatabases@ request and specify the next page token using the @pageToken@ parameter.
--
...
getRelationalDatabasesResponse pResponseStatus_
  = GetRelationalDatabasesResponse'{_grdrsNextPageToken
                                      = Nothing,
