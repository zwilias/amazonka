...
albtcLoadBalancerName =
  lens _albtcLoadBalancerName (\s a -> s {_albtcLoadBalancerName = a})

-- | The name of your SSL/TLS certificate.
albtcCertificateName :: Lens' AttachLoadBalancerTLSCertificate Text
albtcCertificateName =
  lens _albtcCertificateName (\s a -> s {_albtcCertificateName = a})

instance AWSRequest AttachLoadBalancerTLSCertificate where
  type Rs AttachLoadBalancerTLSCertificate = AttachLoadBalancerTLSCertificateResponse
...
instance ToHeaders AttachLoadBalancerTLSCertificate where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("Lightsail_20161128.AttachLoadBalancerTlsCertificate" :: ByteString)
...
albtcrsOperations =
  lens _albtcrsOperations (\s a -> s {_albtcrsOperations = a}) .
  _Default . _Coerce

-- | -- | The response status code.
albtcrsResponseStatus :: Lens' AttachLoadBalancerTLSCertificateResponse Int
albtcrsResponseStatus =
  lens _albtcrsResponseStatus (\s a -> s {_albtcrsResponseStatus = a})
