...
data CreateRelationalDatabase = CreateRelationalDatabase'{_crdMasterUserPassword
                                                          ::
                                                          !(Maybe
                                                              (Sensitive Text)),
...
createRelationalDatabase
    ...
    -> CreateRelationalDatabase
createRelationalDatabase pRelationalDatabaseName_
  pRelationalDatabaseBlueprintId_
  pRelationalDatabaseBundleId_ pMasterDatabaseName_
  pMasterUsername_
  = CreateRelationalDatabase'{_crdMasterUserPassword =
                                Nothing,
...
data CreateRelationalDatabaseResponse = CreateRelationalDatabaseResponse'{_crdrsOperations
                                                                          ::
                                                                          !(Maybe
                                                                              [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'crdrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
createRelationalDatabaseResponse pResponseStatus_
  = CreateRelationalDatabaseResponse'{_crdrsOperations
                                        = Nothing,
