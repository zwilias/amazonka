...
newtype GetRelationalDatabaseBlueprints = GetRelationalDatabaseBlueprints'{_grdbPageToken
                                                                           ::
                                                                           Maybe
                                                                             Text}
...
getRelationalDatabaseBlueprints
    :: GetRelationalDatabaseBlueprints
getRelationalDatabaseBlueprints
  = GetRelationalDatabaseBlueprints'{_grdbPageToken =
                                       Nothing}
...
data GetRelationalDatabaseBlueprintsResponse = GetRelationalDatabaseBlueprintsResponse'{_grdbsrsBlueprints
                                                                                        ::
                                                                                        !(Maybe
...
getRelationalDatabaseBlueprintsResponse
  pResponseStatus_
  = GetRelationalDatabaseBlueprintsResponse'{_grdbsrsBlueprints
                                               = Nothing,
