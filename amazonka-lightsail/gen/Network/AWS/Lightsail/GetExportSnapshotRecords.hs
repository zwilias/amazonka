...
newtype GetExportSnapshotRecords = GetExportSnapshotRecords'{_gesrPageToken
                                                             :: Maybe Text}
...
data GetExportSnapshotRecordsResponse = GetExportSnapshotRecordsResponse'{_gesrrsNextPageToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
getExportSnapshotRecordsResponse pResponseStatus_
  = GetExportSnapshotRecordsResponse'{_gesrrsNextPageToken
                                        = Nothing,
