...
data CreateRelationalDatabaseSnapshot = CreateRelationalDatabaseSnapshot'{_crdsTags
                                                                          ::
                                                                          !(Maybe
                                                                              [Tag]),
...
createRelationalDatabaseSnapshot
  ...
  = CreateRelationalDatabaseSnapshot'{_crdsTags =
                                        Nothing,
                                      _crdsRelationalDatabaseName =
                                        pRelationalDatabaseName_,
                                      _crdsRelationalDatabaseSnapshotName =
...
data CreateRelationalDatabaseSnapshotResponse = CreateRelationalDatabaseSnapshotResponse'{_crdsrsOperations
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'crdsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
createRelationalDatabaseSnapshotResponse
  pResponseStatus_
  = CreateRelationalDatabaseSnapshotResponse'{_crdsrsOperations
                                                = Nothing,
                                              _crdsrsResponseStatus =
                                                pResponseStatus_}
