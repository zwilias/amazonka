...
data CreateDiskFromSnapshot = CreateDiskFromSnapshot'{_cdfsUseLatestRestorableAutoSnapshot
                                                      :: !(Maybe Bool),
                                                      _cdfsSourceDiskName ::
                                                      !(Maybe Text),
                                                      _cdfsAddOns ::
...
createDiskFromSnapshot
    ...
    -> Int -- ^ 'cdfsSizeInGb'
    -> CreateDiskFromSnapshot
createDiskFromSnapshot pDiskName_ pAvailabilityZone_
  pSizeInGb_
  = CreateDiskFromSnapshot'{_cdfsUseLatestRestorableAutoSnapshot
                              = Nothing,
                            _cdfsSourceDiskName = Nothing,
                            _cdfsAddOns = Nothing,
                            _cdfsDiskSnapshotName = Nothing,
                            _cdfsRestoreDate = Nothing, _cdfsTags = Nothing,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdfsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
