...
data CreateInstancesFromSnapshot = CreateInstancesFromSnapshot'{_cifsUseLatestRestorableAutoSnapshot
                                                                ::
                                                                !(Maybe Bool),
...
createInstancesFromSnapshot pAvailabilityZone_
  pBundleId_
  = CreateInstancesFromSnapshot'{_cifsUseLatestRestorableAutoSnapshot
                                   = Nothing,
                                 _cifsInstanceSnapshotName = Nothing,
                                 _cifsAddOns = Nothing, _cifsUserData = Nothing,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cifsrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
