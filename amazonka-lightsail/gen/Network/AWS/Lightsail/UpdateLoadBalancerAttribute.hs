...
ulbaLoadBalancerName =
  lens _ulbaLoadBalancerName (\s a -> s {_ulbaLoadBalancerName = a})
...
ulbaAttributeValue =
  lens _ulbaAttributeValue (\s a -> s {_ulbaAttributeValue = a})

instance AWSRequest UpdateLoadBalancerAttribute where
  type Rs UpdateLoadBalancerAttribute = UpdateLoadBalancerAttributeResponse
...
ulbarsOperations =
  lens _ulbarsOperations (\s a -> s {_ulbarsOperations = a}) .
  _Default . _Coerce

-- | -- | The response status code.
ulbarsResponseStatus :: Lens' UpdateLoadBalancerAttributeResponse Int
ulbarsResponseStatus =
  lens _ulbarsResponseStatus (\s a -> s {_ulbarsResponseStatus = a})
