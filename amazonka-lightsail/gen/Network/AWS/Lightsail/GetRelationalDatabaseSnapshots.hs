...
newtype GetRelationalDatabaseSnapshots = GetRelationalDatabaseSnapshots'{_grdsPageToken
                                                                         ::
                                                                         Maybe
                                                                           Text}
...
getRelationalDatabaseSnapshots
    :: GetRelationalDatabaseSnapshots
getRelationalDatabaseSnapshots
  = GetRelationalDatabaseSnapshots'{_grdsPageToken =
                                      Nothing}
...
data GetRelationalDatabaseSnapshotsResponse = GetRelationalDatabaseSnapshotsResponse'{_grdsrsNextPageToken
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
getRelationalDatabaseSnapshotsResponse
  pResponseStatus_
  = GetRelationalDatabaseSnapshotsResponse'{_grdsrsNextPageToken
                                              = Nothing,
                                            _grdsrsRelationalDatabaseSnapshots =
                                              Nothing,
                                            _grdsrsResponseStatus =
