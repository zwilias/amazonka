...
data GetRelationalDatabaseMasterUserPassword = GetRelationalDatabaseMasterUserPassword'{_grdmupPasswordVersion
                                                                                        ::
                                                                                        !(Maybe
...
getRelationalDatabaseMasterUserPassword
  ...
  = GetRelationalDatabaseMasterUserPassword'{_grdmupPasswordVersion
                                               = Nothing,
                                             _grdmupRelationalDatabaseName =
                                               pRelationalDatabaseName_}
...
data GetRelationalDatabaseMasterUserPasswordResponse = GetRelationalDatabaseMasterUserPasswordResponse'{_grdmuprsMasterUserPassword
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            (Sensitive
                                                                                                               Text)),
...
getRelationalDatabaseMasterUserPasswordResponse
  pResponseStatus_
  = GetRelationalDatabaseMasterUserPasswordResponse'{_grdmuprsMasterUserPassword
                                                       = Nothing,
                                                     _grdmuprsCreatedAt =
                                                       Nothing,
                                                     _grdmuprsResponseStatus =
