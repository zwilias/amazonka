...
newtype GetContactMethods = GetContactMethods'{_gcmProtocols
...
instance Hashable GetContactMethods where

instance NFData GetContactMethods where
...
data GetContactMethodsResponse = GetContactMethodsResponse'{_gcmrsContactMethods
                                                            ::
                                                            !(Maybe
                                                                [ContactMethod]),
...
getContactMethodsResponse pResponseStatus_
  = GetContactMethodsResponse'{_gcmrsContactMethods =
                                 Nothing,
...
instance NFData GetContactMethodsResponse where
