...
data PendingModifiedRelationalDatabaseValues = PendingModifiedRelationalDatabaseValues'{_pmrdvEngineVersion
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
pendingModifiedRelationalDatabaseValues
    :: PendingModifiedRelationalDatabaseValues
pendingModifiedRelationalDatabaseValues
  = PendingModifiedRelationalDatabaseValues'{_pmrdvEngineVersion
                                               = Nothing,
