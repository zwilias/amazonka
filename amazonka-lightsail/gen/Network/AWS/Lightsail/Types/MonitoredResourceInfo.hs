...
data MonitoredResourceInfo = MonitoredResourceInfo'{_mriResourceType
                                                    :: !(Maybe ResourceType),
                                                    _mriArn :: !(Maybe Text),
                                                    _mriName :: !(Maybe Text)}
...
monitoredResourceInfo
    :: MonitoredResourceInfo
monitoredResourceInfo
  = MonitoredResourceInfo'{_mriResourceType = Nothing,
                           _mriArn = Nothing, _mriName = Nothing}
...
instance FromJSON MonitoredResourceInfo where
        parseJSON
          = withObject "MonitoredResourceInfo"
              (\ x ->
                 MonitoredResourceInfo' <$>
                   (x .:? "resourceType") <*> (x .:? "arn") <*>
                     (x .:? "name"))

instance Hashable MonitoredResourceInfo where

instance NFData MonitoredResourceInfo where
