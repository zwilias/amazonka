...
data LoadBalancerTLSCertificateDomainValidationRecord = LoadBalancerTLSCertificateDomainValidationRecord'{_lbtcdvrValue
                                                                                                          ::
                                                                                                          !(Maybe
                                                                                                              Text),
                                                                                                          _lbtcdvrDomainName
...
loadBalancerTLSCertificateDomainValidationRecord
    :: LoadBalancerTLSCertificateDomainValidationRecord
loadBalancerTLSCertificateDomainValidationRecord
  = LoadBalancerTLSCertificateDomainValidationRecord'{_lbtcdvrValue
                                                        = Nothing,
                                                      _lbtcdvrDomainName =
                                                        Nothing,
