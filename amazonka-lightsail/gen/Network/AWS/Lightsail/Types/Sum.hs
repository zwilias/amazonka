...
instance FromText AccessDirection where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AccessDirection from value: '" <>
        e <> "'. Accepted values: inbound, outbound"
...
instance FromText BlueprintType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BlueprintType from value: '" <>
        e <> "'. Accepted values: app, os"
...
instance FromText DiskSnapshotState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DiskSnapshotState from value: '" <>
        e <> "'. Accepted values: completed, error, pending, unknown"
...
instance FromText DiskState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DiskState from value: '" <>
        e <> "'. Accepted values: available, error, in-use, pending, unknown"
...
instance FromText InstanceAccessProtocol where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceAccessProtocol from value: '" <>
        e <> "'. Accepted values: rdp, ssh"
  ...
  parser =
    takeLowerText >>= \case
      "instance.deregistrationinprogress" ->
        pure Instance_DeregistrationInProgress
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceHealthReason from value: '" <>
        e <>
...
instance FromText InstanceHealthState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceHealthState from value: '" <>
        e <>
...
instance FromText InstanceMetricName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceMetricName from value: '" <>
        e <>
...
instance FromText InstancePlatform where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstancePlatform from value: '" <>
        e <> "'. Accepted values: linux_unix, windows"
...
instance FromText InstanceSnapshotState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceSnapshotState from value: '" <>
        e <> "'. Accepted values: available, error, pending"
  ...
  parser =
    takeLowerText >>= \case
      ...
      "sessionstickiness_lb_cookiedurationseconds" ->
        pure SessionStickinessLbCookieDurationSeconds
      e ->
        fromTextError $
        "Failure parsing LoadBalancerAttributeName from value: '" <>
        e <>
...
instance FromText LoadBalancerMetricName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerMetricName from value: '" <>
        e <>
...
instance FromText LoadBalancerProtocol where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerProtocol from value: '" <>
        e <> "'. Accepted values: http, http_https"
...
instance FromText LoadBalancerState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerState from value: '" <>
        e <>
...
instance FromText LoadBalancerTLSCertificateDomainStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerTLSCertificateDomainStatus from value: '" <>
        e <> "'. Accepted values: failed, pending_validation, success"
...
instance FromText LoadBalancerTLSCertificateFailureReason where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerTLSCertificateFailureReason from value: '" <>
        e <>
...
instance FromText LoadBalancerTLSCertificateRenewalStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerTLSCertificateRenewalStatus from value: '" <>
        e <>
...
instance FromText LoadBalancerTLSCertificateRevocationReason where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerTLSCertificateRevocationReason from value: '" <>
        e <>
...
instance FromText LoadBalancerTLSCertificateStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LoadBalancerTLSCertificateStatus from value: '" <>
        e <>
...
instance FromText MetricStatistic where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MetricStatistic from value: '" <>
...
instance FromText MetricUnit where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MetricUnit from value: '" <>
        e <>
...
instance FromText NetworkProtocol where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkProtocol from value: '" <>
        e <> "'. Accepted values: all, tcp, udp"
...
instance FromText OperationStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OperationStatus from value: '" <>
        e <>
...
instance FromText OperationType where
  parser =
    takeLowerText >>= \case
      ...
      "attachloadbalancertlscertificate" ->
        pure AttachLoadBalancerTLSCertificate
      ...
      "createloadbalancertlscertificate" ->
        pure CreateLoadBalancerTLSCertificate
      ...
      "deleteloadbalancertlscertificate" ->
        pure DeleteLoadBalancerTLSCertificate
...
instance FromText PortAccessType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PortAccessType from value: '" <>
        e <> "'. Accepted values: private, public"
...
instance FromText PortState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PortState from value: '" <>
...
instance FromText RegionName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RegionName from value: '" <>
        e <>
