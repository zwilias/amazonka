...
data RelationalDatabase = RelationalDatabase'{_rdEngineVersion
                                              :: !(Maybe Text),
...
relationalDatabase
    :: RelationalDatabase
relationalDatabase
  = RelationalDatabase'{_rdEngineVersion = Nothing,
                        _rdRelationalDatabaseBundleId = Nothing,
                        _rdMasterEndpoint = Nothing, _rdState = Nothing,
                        _rdResourceType = Nothing,
                        _rdPubliclyAccessible = Nothing,
                        _rdMasterUsername = Nothing, _rdArn = Nothing,
                        _rdCreatedAt = Nothing, _rdLocation = Nothing,
                        _rdEngine = Nothing,
                        ...
                        _rdHardware = Nothing,
                        _rdParameterApplyStatus = Nothing, _rdTags = Nothing}
