...
data RelationalDatabaseSnapshot = RelationalDatabaseSnapshot'{_rdsEngineVersion
                                                              :: !(Maybe Text),
                                                              _rdsState ::
                                                              !(Maybe Text),
...
relationalDatabaseSnapshot
    :: RelationalDatabaseSnapshot
relationalDatabaseSnapshot
  = RelationalDatabaseSnapshot'{_rdsEngineVersion =
                                  Nothing,
                                _rdsState = Nothing,
                                _rdsFromRelationalDatabaseName = Nothing,
                                _rdsResourceType = Nothing,
                                _rdsFromRelationalDatabaseBlueprintId = Nothing,
                                _rdsArn = Nothing, _rdsCreatedAt = Nothing,
                                _rdsLocation = Nothing, _rdsEngine = Nothing,
                                _rdsName = Nothing, _rdsSizeInGb = Nothing,
