...
data Blueprint = Blueprint'{_bVersionCode ::
                            !(Maybe Text),
                            ...
                            _bName :: !(Maybe Text), _bVersion :: !(Maybe Text),
...
blueprint
    :: Blueprint
blueprint
  = Blueprint'{_bVersionCode = Nothing,
               _bPlatform = Nothing, _bGroup = Nothing,
               _bMinPower = Nothing, _bProductURL = Nothing,
               _bLicenseURL = Nothing, _bName = Nothing,
               _bVersion = Nothing, _bBlueprintId = Nothing,
               _bType = Nothing, _bIsActive = Nothing,
