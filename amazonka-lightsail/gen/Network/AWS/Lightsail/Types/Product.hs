...
instance FromJSON AvailabilityZone where
  parseJSON =
    withObject
      "AvailabilityZone"
      (\x -> AvailabilityZone' <$> (x .:? "state") <*> (x .:? "zoneName"))
...
instance FromJSON Blueprint where
  parseJSON =
    withObject
      "Blueprint"
      (\x ->
         Blueprint' <$> (x .:? "versionCode") <*> (x .:? "platform") <*>
         (x .:? "group") <*>
         (x .:? "minPower") <*>
         (x .:? "productUrl") <*>
         (x .:? "licenseUrl") <*>
...
bunTransferPerMonthInGb =
  lens _bunTransferPerMonthInGb (\s a -> s {_bunTransferPerMonthInGb = a})
...
bunSupportedPlatforms =
  lens _bunSupportedPlatforms (\s a -> s {_bunSupportedPlatforms = a}) .
  _Default . _Coerce
...
instance FromJSON Bundle where
  parseJSON =
    withObject
      "Bundle"
      (\x ->
         Bundle' <$> (x .:? "cpuCount") <*> (x .:? "transferPerMonthInGb") <*>
         (x .:? "bundleId") <*>
         (x .:? "instanceType") <*>
         (x .:? "name") <*>
         (x .:? "power") <*>
...
instance FromJSON Disk where
  parseJSON =
    withObject
      "Disk"
      (\x ->
         Disk' <$> (x .:? "state") <*> (x .:? "resourceType") <*> (x .:? "arn") <*>
         (x .:? "path") <*>
         (x .:? "createdAt") <*>
         (x .:? "location") <*>
         (x .:? "iops") <*>
...
dmOriginalDiskPath =
  lens _dmOriginalDiskPath (\s a -> s {_dmOriginalDiskPath = a})
...
instance FromJSON DiskSnapshot where
  parseJSON =
    withObject
      "DiskSnapshot"
      (\x ->
         DiskSnapshot' <$> (x .:? "fromDiskName") <*> (x .:? "state") <*>
         (x .:? "resourceType") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "location") <*>
...
domDomainEntries =
  lens _domDomainEntries (\s a -> s {_domDomainEntries = a}) .
  _Default . _Coerce
...
domCreatedAt =
  lens _domCreatedAt (\s a -> s {_domCreatedAt = a}) . mapping _Time
...
instance FromJSON DomainEntry where
  parseJSON =
    withObject
      "DomainEntry"
      (\x ->
         DomainEntry' <$> (x .:? "isAlias") <*> (x .:? "name") <*> (x .:? "id") <*>
         (x .:? "options" .!= mempty) <*>
         (x .:? "type") <*>
         (x .:? "target"))
...
instance FromJSON Instance where
  parseJSON =
    withObject
      "Instance"
      (\x ->
         Instance' <$> (x .:? "state") <*> (x .:? "ipv6Address") <*>
         (x .:? "resourceType") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "location") <*>
...
iadExpiresAt =
  lens _iadExpiresAt (\s a -> s {_iadExpiresAt = a}) . mapping _Time
...
instance FromJSON InstanceAccessDetails where
  parseJSON =
    withObject
      "InstanceAccessDetails"
      (\x ->
         InstanceAccessDetails' <$> (x .:? "certKey") <*> (x .:? "ipAddress") <*>
         (x .:? "privateKey") <*>
         (x .:? "expiresAt") <*>
         (x .:? "username") <*>
         (x .:? "protocol") <*>
...
instance FromJSON InstanceHardware where
  parseJSON =
    withObject
      "InstanceHardware"
      (\x ->
         InstanceHardware' <$> (x .:? "cpuCount") <*> (x .:? "disks" .!= mempty) <*>
         (x .:? "ramSizeInGb"))
...
ihsInstanceHealthReason ::
     Lens' InstanceHealthSummary (Maybe InstanceHealthReason)
ihsInstanceHealthReason =
  lens _ihsInstanceHealthReason (\s a -> s {_ihsInstanceHealthReason = a})
...
instance FromJSON InstanceHealthSummary where
  parseJSON =
    withObject
      "InstanceHealthSummary"
      (\x ->
         InstanceHealthSummary' <$> (x .:? "instanceHealth") <*>
         (x .:? "instanceName") <*>
...
instance FromJSON InstanceNetworking where
  parseJSON =
    withObject
      "InstanceNetworking"
      (\x ->
         InstanceNetworking' <$> (x .:? "monthlyTransfer") <*>
         (x .:? "ports" .!= mempty))
...
ipiAccessDirection =
  lens _ipiAccessDirection (\s a -> s {_ipiAccessDirection = a})
...
instance FromJSON InstancePortInfo where
  parseJSON =
    withObject
      "InstancePortInfo"
      (\x ->
         InstancePortInfo' <$> (x .:? "fromPort") <*> (x .:? "commonName") <*>
         (x .:? "protocol") <*>
         (x .:? "accessDirection") <*>
         (x .:? "accessType") <*>
         (x .:? "toPort") <*>
...
instance FromJSON InstancePortState where
  parseJSON =
    withObject
      "InstancePortState"
      (\x ->
         InstancePortState' <$> (x .:? "fromPort") <*> (x .:? "state") <*>
         (x .:? "protocol") <*>
         (x .:? "toPort"))
...
insFromBlueprintId =
  lens _insFromBlueprintId (\s a -> s {_insFromBlueprintId = a})
...
insFromAttachedDisks =
  lens _insFromAttachedDisks (\s a -> s {_insFromAttachedDisks = a}) .
  _Default . _Coerce
...
insCreatedAt =
  lens _insCreatedAt (\s a -> s {_insCreatedAt = a}) . mapping _Time
...
insFromInstanceARN =
  lens _insFromInstanceARN (\s a -> s {_insFromInstanceARN = a})

-- | The instance from which the snapshot was created.
insFromInstanceName :: Lens' InstanceSnapshot (Maybe Text)
insFromInstanceName =
  lens _insFromInstanceName (\s a -> s {_insFromInstanceName = a})
...
instance FromJSON InstanceSnapshot where
  parseJSON =
    withObject
      "InstanceSnapshot"
      (\x ->
         InstanceSnapshot' <$> (x .:? "fromBlueprintId") <*> (x .:? "state") <*>
         (x .:? "resourceType") <*>
...
lbConfigurationOptions ::
     Lens' LoadBalancer (HashMap LoadBalancerAttributeName Text)
lbConfigurationOptions =
  lens _lbConfigurationOptions (\s a -> s {_lbConfigurationOptions = a}) .
  _Default . _Map
...
lbTlsCertificateSummaries ::
     Lens' LoadBalancer [LoadBalancerTLSCertificateSummary]
lbTlsCertificateSummaries =
  lens _lbTlsCertificateSummaries (\s a -> s {_lbTlsCertificateSummaries = a}) .
  _Default . _Coerce
...
lbPublicPorts =
  lens _lbPublicPorts (\s a -> s {_lbPublicPorts = a}) . _Default . _Coerce
...
lbInstanceHealthSummary =
  lens _lbInstanceHealthSummary (\s a -> s {_lbInstanceHealthSummary = a}) .
  _Default . _Coerce
...
instance FromJSON LoadBalancer where
  parseJSON =
    withObject
      "LoadBalancer"
      (\x ->
         LoadBalancer' <$> (x .:? "healthCheckPath") <*> (x .:? "state") <*>
         (x .:? "resourceType") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "location") <*>
...
lbtcFailureReason ::
     Lens' LoadBalancerTLSCertificate (Maybe LoadBalancerTLSCertificateFailureReason)
...
lbtcStatus ::
     Lens' LoadBalancerTLSCertificate (Maybe LoadBalancerTLSCertificateStatus)
...
lbtcSubjectAlternativeNames =
  lens
    ...
    (\s a -> s {_lbtcSubjectAlternativeNames = a}) .
  _Default . _Coerce
...
lbtcCreatedAt =
  lens _lbtcCreatedAt (\s a -> s {_lbtcCreatedAt = a}) . mapping _Time
...
lbtcLoadBalancerName =
  lens _lbtcLoadBalancerName (\s a -> s {_lbtcLoadBalancerName = a})
...
lbtcRevokedAt =
  lens _lbtcRevokedAt (\s a -> s {_lbtcRevokedAt = a}) . mapping _Time

-- | The timestamp when the SSL/TLS certificate is first valid.
lbtcNotBefore :: Lens' LoadBalancerTLSCertificate (Maybe UTCTime)
lbtcNotBefore =
  lens _lbtcNotBefore (\s a -> s {_lbtcNotBefore = a}) . mapping _Time

-- | The reason the certificate was revoked. Valid values are below.
lbtcRevocationReason ::
     Lens' LoadBalancerTLSCertificate (Maybe LoadBalancerTLSCertificateRevocationReason)
lbtcRevocationReason =
  lens _lbtcRevocationReason (\s a -> s {_lbtcRevocationReason = a})
...
lbtcRenewalSummary ::
     Lens' LoadBalancerTLSCertificate (Maybe LoadBalancerTLSCertificateRenewalSummary)
lbtcRenewalSummary =
  lens _lbtcRenewalSummary (\s a -> s {_lbtcRenewalSummary = a})
...
lbtcDomainValidationRecords ::
     Lens' LoadBalancerTLSCertificate [LoadBalancerTLSCertificateDomainValidationRecord]
lbtcDomainValidationRecords =
  lens
    _lbtcDomainValidationRecords
    (\s a -> s {_lbtcDomainValidationRecords = a}) .
  _Default . _Coerce

-- | The time when the SSL/TLS certificate was issued.
lbtcIssuedAt :: Lens' LoadBalancerTLSCertificate (Maybe UTCTime)
lbtcIssuedAt =
  lens _lbtcIssuedAt (\s a -> s {_lbtcIssuedAt = a}) . mapping _Time
...
lbtcSignatureAlgorithm =
  lens _lbtcSignatureAlgorithm (\s a -> s {_lbtcSignatureAlgorithm = a})
...
lbtcNotAfter =
  lens _lbtcNotAfter (\s a -> s {_lbtcNotAfter = a}) . mapping _Time
...
instance FromJSON LoadBalancerTLSCertificate where
  parseJSON =
    withObject
      "LoadBalancerTLSCertificate"
      (\x ->
         LoadBalancerTLSCertificate' <$> (x .:? "failureReason") <*>
         (x .:? "subject") <*>
         (x .:? "status") <*>
...
lbtcdvoDomainName ::
     Lens' LoadBalancerTLSCertificateDomainValidationOption (Maybe Text)
lbtcdvoDomainName = lens _lbtcdvoDomainName (\s a -> s {_lbtcdvoDomainName = a})

-- | The status of the domain validation. Valid values are listed below.
lbtcdvoValidationStatus ::
     Lens' LoadBalancerTLSCertificateDomainValidationOption (Maybe LoadBalancerTLSCertificateDomainStatus)
lbtcdvoValidationStatus =
  lens _lbtcdvoValidationStatus (\s a -> s {_lbtcdvoValidationStatus = a})
...
lbtcdvrValue ::
     Lens' LoadBalancerTLSCertificateDomainValidationRecord (Maybe Text)
...
lbtcdvrValidationStatus ::
     Lens' LoadBalancerTLSCertificateDomainValidationRecord (Maybe LoadBalancerTLSCertificateDomainStatus)
lbtcdvrValidationStatus =
  lens _lbtcdvrValidationStatus (\s a -> s {_lbtcdvrValidationStatus = a})
...
instance FromJSON LoadBalancerTLSCertificateDomainValidationRecord where
  parseJSON =
    withObject
      "LoadBalancerTLSCertificateDomainValidationRecord"
      (\x ->
         LoadBalancerTLSCertificateDomainValidationRecord' <$> (x .:? "value") <*>
         (x .:? "domainName") <*>
         (x .:? "name") <*>
         (x .:? "validationStatus") <*>
         (x .:? "type"))
...
lbtcrsRenewalStatus ::
     Lens' LoadBalancerTLSCertificateRenewalSummary (Maybe LoadBalancerTLSCertificateRenewalStatus)
lbtcrsRenewalStatus =
  lens _lbtcrsRenewalStatus (\s a -> s {_lbtcrsRenewalStatus = a})

-- | Contains information about the validation of each domain name in the certificate, as it pertains to Lightsail's managed renewal. This is different from the initial validation that occurs as a result of the RequestCertificate request.
lbtcrsDomainValidationOptions ::
     Lens' LoadBalancerTLSCertificateRenewalSummary [LoadBalancerTLSCertificateDomainValidationOption]
lbtcrsDomainValidationOptions =
  lens
    _lbtcrsDomainValidationOptions
    (\s a -> s {_lbtcrsDomainValidationOptions = a}) .
  _Default . _Coerce
...
instance FromJSON LoadBalancerTLSCertificateRenewalSummary where
  parseJSON =
    withObject
      "LoadBalancerTLSCertificateRenewalSummary"
      (\x ->
         LoadBalancerTLSCertificateRenewalSummary' <$> (x .:? "renewalStatus") <*>
...
instance FromJSON LoadBalancerTLSCertificateSummary where
  parseJSON =
    withObject
      "LoadBalancerTLSCertificateSummary"
      (\x ->
         LoadBalancerTLSCertificateSummary' <$> (x .:? "isAttached") <*>
         (x .:? "name"))
...
instance FromJSON MetricDatapoint where
  parseJSON =
    withObject
      "MetricDatapoint"
      (\x ->
         MetricDatapoint' <$> (x .:? "sampleCount") <*> (x .:? "maximum") <*>
         (x .:? "average") <*>
         (x .:? "minimum") <*>
         (x .:? "sum") <*>
         (x .:? "timestamp") <*>
...
mtGbPerMonthAllocated =
  lens _mtGbPerMonthAllocated (\s a -> s {_mtGbPerMonthAllocated = a})
...
oStatusChangedAt =
  lens _oStatusChangedAt (\s a -> s {_oStatusChangedAt = a}) . mapping _Time
...
instance FromJSON Operation where
  parseJSON =
    withObject
      "Operation"
      (\x ->
         Operation' <$> (x .:? "status") <*> (x .:? "operationDetails") <*>
         (x .:? "resourceType") <*>
         (x .:? "createdAt") <*>
         (x .:? "resourceName") <*>
         (x .:? "location") <*>
...
instance FromJSON PasswordData where
  parseJSON =
    withObject
      "PasswordData"
      (\x -> PasswordData' <$> (x .:? "keyPairName") <*> (x .:? "ciphertext"))
...
riAvailabilityZones =
  lens _riAvailabilityZones (\s a -> s {_riAvailabilityZones = a}) .
  _Default . _Coerce
...
instance FromJSON RegionInfo where
  parseJSON =
    withObject
      "RegionInfo"
      (\x ->
         RegionInfo' <$> (x .:? "availabilityZones" .!= mempty) <*>
         (x .:? "name") <*>
         (x .:? "displayName") <*>
         (x .:? "continentCode") <*>
         (x .:? "description"))
...
rlAvailabilityZone =
  lens _rlAvailabilityZone (\s a -> s {_rlAvailabilityZone = a})
...
instance FromJSON StaticIP where
  parseJSON =
    withObject
      "StaticIP"
      (\x ->
         StaticIP' <$> (x .:? "ipAddress") <*> (x .:? "resourceType") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "location") <*>
         (x .:? "isAttached") <*>
