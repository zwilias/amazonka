...
data CloudFormationStackRecordSourceInfo = CloudFormationStackRecordSourceInfo'{_cfsrsiResourceType
                                                                                ::
                                                                                !(Maybe
...
cloudFormationStackRecordSourceInfo
    :: CloudFormationStackRecordSourceInfo
cloudFormationStackRecordSourceInfo
  = CloudFormationStackRecordSourceInfo'{_cfsrsiResourceType
                                           = Nothing,
                                         _cfsrsiArn = Nothing,
                                         _cfsrsiName = Nothing}
