...
data AutoSnapshotDetails = AutoSnapshotDetails'{_asdStatus
...
autoSnapshotDetails
    :: AutoSnapshotDetails
autoSnapshotDetails
  = AutoSnapshotDetails'{_asdStatus = Nothing,
                         _asdFromAttachedDisks = Nothing,
                         _asdCreatedAt = Nothing, _asdDate = Nothing}
...
instance FromJSON AutoSnapshotDetails where
        parseJSON
          = withObject "AutoSnapshotDetails"
              (\ x ->
                 AutoSnapshotDetails' <$>
                   (x .:? "status") <*>
...
instance Hashable AutoSnapshotDetails where

instance NFData AutoSnapshotDetails where
