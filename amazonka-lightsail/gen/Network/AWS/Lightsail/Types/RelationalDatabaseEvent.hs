...
data RelationalDatabaseEvent = RelationalDatabaseEvent'{_rdeCreatedAt
                                                        :: !(Maybe POSIX),
                                                        _rdeEventCategories ::
                                                        !(Maybe [Text]),
                                                        _rdeResource ::
...
relationalDatabaseEvent
    :: RelationalDatabaseEvent
relationalDatabaseEvent
  = RelationalDatabaseEvent'{_rdeCreatedAt = Nothing,
                             _rdeEventCategories = Nothing,
                             _rdeResource = Nothing, _rdeMessage = Nothing}
