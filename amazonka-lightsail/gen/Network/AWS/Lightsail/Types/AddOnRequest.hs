...
data AddOnRequest = AddOnRequest'{_aorAutoSnapshotAddOnRequest
...
addOnRequest
    :: AddOnType -- ^ 'aorAddOnType'
    -> AddOnRequest
addOnRequest pAddOnType_
  = AddOnRequest'{_aorAutoSnapshotAddOnRequest =
                    Nothing,
...
instance Hashable AddOnRequest where

instance NFData AddOnRequest where
