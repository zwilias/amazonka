...
data RelationalDatabaseBundle = RelationalDatabaseBundle'{_rdbIsEncrypted
                                                          :: !(Maybe Bool),
                                                          _rdbCpuCount ::
                                                          !(Maybe Int),
...
relationalDatabaseBundle
    :: RelationalDatabaseBundle
relationalDatabaseBundle
  = RelationalDatabaseBundle'{_rdbIsEncrypted =
                                Nothing,
                              _rdbCpuCount = Nothing,
                              _rdbTransferPerMonthInGb = Nothing,
                              _rdbBundleId = Nothing, _rdbName = Nothing,
                              _rdbDiskSizeInGb = Nothing, _rdbPrice = Nothing,
                              _rdbIsActive = Nothing, _rdbRamSizeInGb = Nothing}
