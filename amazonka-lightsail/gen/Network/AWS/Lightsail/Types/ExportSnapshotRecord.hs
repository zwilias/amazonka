...
data ExportSnapshotRecord = ExportSnapshotRecord'{_esrState
                                                  :: !(Maybe RecordState),
                                                  _esrDestinationInfo ::
...
exportSnapshotRecord
    :: ExportSnapshotRecord
exportSnapshotRecord
  = ExportSnapshotRecord'{_esrState = Nothing,
                          _esrDestinationInfo = Nothing,
                          _esrResourceType = Nothing, _esrArn = Nothing,
                          _esrCreatedAt = Nothing, _esrLocation = Nothing,
                          _esrName = Nothing, _esrSourceInfo = Nothing}
