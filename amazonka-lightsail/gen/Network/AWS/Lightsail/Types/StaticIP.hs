...
data StaticIP = StaticIP'{_siIpAddress ::
                          !(Maybe Text),
...
staticIP
    :: StaticIP
staticIP
  = StaticIP'{_siIpAddress = Nothing,
              _siResourceType = Nothing, _siArn = Nothing,
              _siCreatedAt = Nothing, _siLocation = Nothing,
              _siIsAttached = Nothing, _siName = Nothing,
              _siSupportCode = Nothing, _siAttachedTo = Nothing}
