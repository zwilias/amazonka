...
data MetricDatapoint = MetricDatapoint'{_mdSampleCount
                                        :: !(Maybe Double),
...
metricDatapoint
    :: MetricDatapoint
metricDatapoint
  = MetricDatapoint'{_mdSampleCount = Nothing,
                     _mdMaximum = Nothing, _mdAverage = Nothing,
                     _mdMinimum = Nothing, _mdSum = Nothing,
                     _mdTimestamp = Nothing, _mdUnit = Nothing}
