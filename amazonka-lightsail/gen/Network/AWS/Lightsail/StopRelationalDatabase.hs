...
data StopRelationalDatabase = StopRelationalDatabase'{_srdRelationalDatabaseSnapshotName
                                                      :: !(Maybe Text),
...
stopRelationalDatabase pRelationalDatabaseName_
  = StopRelationalDatabase'{_srdRelationalDatabaseSnapshotName
                              = Nothing,
                            _srdRelationalDatabaseName =
...
data StopRelationalDatabaseResponse = StopRelationalDatabaseResponse'{_storsOperations
                                                                      ::
                                                                      !(Maybe
                                                                          [Operation]),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'storsOperations' - An array of objects that describe the result of the action, such as the status of the request, the time stamp of the request, and the resources affected by the request.
--
...
stopRelationalDatabaseResponse pResponseStatus_
  = StopRelationalDatabaseResponse'{_storsOperations =
                                      Nothing,
