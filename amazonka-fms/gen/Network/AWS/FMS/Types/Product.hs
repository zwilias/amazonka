...
instance FromJSON ComplianceViolator where
  parseJSON =
    withObject
      "ComplianceViolator"
      (\x ->
         ComplianceViolator' <$> (x .:? "ResourceId") <*> (x .:? "ResourceType") <*>
         (x .:? "ViolationReason"))
...
erViolatorCount =
  lens _erViolatorCount (\s a -> s {_erViolatorCount = a}) . mapping _Nat

-- | Describes an AWS account's compliance with the AWS Firewall Manager policy.
erComplianceStatus :: Lens' EvaluationResult (Maybe PolicyComplianceStatusType)
erComplianceStatus =
  lens _erComplianceStatus (\s a -> s {_erComplianceStatus = a})
...
erEvaluationLimitExceeded =
  lens _erEvaluationLimitExceeded (\s a -> s {_erEvaluationLimitExceeded = a})
...
instance FromJSON EvaluationResult where
  parseJSON =
    withObject
      "EvaluationResult"
      (\x ->
         EvaluationResult' <$> (x .:? "ViolatorCount") <*>
         (x .:? "ComplianceStatus") <*>
...
pResourceTags =
  lens _pResourceTags (\s a -> s {_pResourceTags = a}) . _Default . _Coerce

-- | A unique identifier for each update to the policy. When issuing a @PutPolicy@ request, the @PolicyUpdateToken@ in the request must match the @PolicyUpdateToken@ of the current policy version. To get the @PolicyUpdateToken@ of the current policy version, use a @GetPolicy@ request.
pPolicyUpdateToken :: Lens' Policy (Maybe Text)
pPolicyUpdateToken =
  lens _pPolicyUpdateToken (\s a -> s {_pPolicyUpdateToken = a})
...
pSecurityServicePolicyData =
  lens _pSecurityServicePolicyData (\s a -> s {_pSecurityServicePolicyData = a})
...
pExcludeResourceTags =
  lens _pExcludeResourceTags (\s a -> s {_pExcludeResourceTags = a})

-- | Indicates if the policy should be automatically applied to new resources.
pRemediationEnabled :: Lens' Policy Bool
pRemediationEnabled =
  lens _pRemediationEnabled (\s a -> s {_pRemediationEnabled = a})
...
instance FromJSON Policy where
  parseJSON =
    withObject
      "Policy"
      (\x ->
         Policy' <$> (x .:? "PolicyId") <*> (x .:? "ResourceTags" .!= mempty) <*>
         (x .:? "PolicyUpdateToken") <*>
         (x .: "PolicyName") <*>
...
pcdExpiredAt =
  lens _pcdExpiredAt (\s a -> s {_pcdExpiredAt = a}) . mapping _Time
...
pcdViolators =
  lens _pcdViolators (\s a -> s {_pcdViolators = a}) . _Default . _Coerce
...
pcdEvaluationLimitExceeded =
  lens _pcdEvaluationLimitExceeded (\s a -> s {_pcdEvaluationLimitExceeded = a})
...
instance FromJSON PolicyComplianceDetail where
  parseJSON =
    withObject
      "PolicyComplianceDetail"
      (\x ->
         PolicyComplianceDetail' <$> (x .:? "ExpiredAt") <*> (x .:? "PolicyId") <*>
         (x .:? "Violators" .!= mempty) <*>
         (x .:? "EvaluationLimitExceeded") <*>
         (x .:? "PolicyOwner") <*>
         (x .:? "MemberAccount"))
...
pcsEvaluationResults =
  lens _pcsEvaluationResults (\s a -> s {_pcsEvaluationResults = a}) .
  _Default . _Coerce

-- | Time stamp of the last update to the @EvaluationResult@ objects.
pcsLastUpdated :: Lens' PolicyComplianceStatus (Maybe UTCTime)
pcsLastUpdated =
  lens _pcsLastUpdated (\s a -> s {_pcsLastUpdated = a}) . mapping _Time
...
instance FromJSON PolicyComplianceStatus where
  parseJSON =
    withObject
      "PolicyComplianceStatus"
      (\x ->
         PolicyComplianceStatus' <$> (x .:? "EvaluationResults" .!= mempty) <*>
         (x .:? "LastUpdated") <*>
         (x .:? "PolicyName") <*>
         (x .:? "PolicyId") <*>
         (x .:? "PolicyOwner") <*>
...
psRemediationEnabled =
  lens _psRemediationEnabled (\s a -> s {_psRemediationEnabled = a})
...
psSecurityServiceType =
  lens _psSecurityServiceType (\s a -> s {_psSecurityServiceType = a})
...
instance ToJSON ResourceTag where
  toJSON ResourceTag' {..} =
    object (catMaybes [("Value" .=) <$> _rtValue, Just ("Key" .= _rtKey)])
...
sspdManagedServiceData =
  lens _sspdManagedServiceData (\s a -> s {_sspdManagedServiceData = a})
...
instance FromJSON SecurityServicePolicyData where
  parseJSON =
    withObject
      "SecurityServicePolicyData"
      (\x ->
         SecurityServicePolicyData' <$> (x .:? "ManagedServiceData") <*>
         (x .: "Type"))
