...
data PutConfigurationAggregator = PutConfigurationAggregator'{_pcaOrganizationAggregationSource
                                                              ::
                                                              !(Maybe
...
putConfigurationAggregator
  ...
  = PutConfigurationAggregator'{_pcaOrganizationAggregationSource
                                  = Nothing,
...
data PutConfigurationAggregatorResponse = PutConfigurationAggregatorResponse'{_pcarsConfigurationAggregator
                                                                              ::
                                                                              !(Maybe
...
putConfigurationAggregatorResponse pResponseStatus_
  = PutConfigurationAggregatorResponse'{_pcarsConfigurationAggregator
                                          = Nothing,
