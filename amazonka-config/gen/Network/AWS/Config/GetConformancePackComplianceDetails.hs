...
instance ToJSON GetConformancePackComplianceDetails
         where
...
instance ToPath GetConformancePackComplianceDetails
         where
        toPath = const "/"

instance ToQuery GetConformancePackComplianceDetails
         where
