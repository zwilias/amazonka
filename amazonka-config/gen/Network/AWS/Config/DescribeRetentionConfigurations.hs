...
data DescribeRetentionConfigurations = DescribeRetentionConfigurations'{_drcRetentionConfigurationNames
                                                                        ::
                                                                        !(Maybe
                                                                            [Text]),
                                                                        _drcNextToken
...
describeRetentionConfigurations
    :: DescribeRetentionConfigurations
describeRetentionConfigurations
  = DescribeRetentionConfigurations'{_drcRetentionConfigurationNames
                                       = Nothing,
...
data DescribeRetentionConfigurationsResponse = DescribeRetentionConfigurationsResponse'{_drsRetentionConfigurations
                                                                                        ::
                                                                                        !(Maybe
...
describeRetentionConfigurationsResponse
  pResponseStatus_
  = DescribeRetentionConfigurationsResponse'{_drsRetentionConfigurations
                                               = Nothing,
