...
ldrResourceIds =
  lens _ldrResourceIds (\s a -> s {_ldrResourceIds = a}) . _Default . _Coerce
...
ldrIncludeDeletedResources =
  lens _ldrIncludeDeletedResources (\s a -> s {_ldrIncludeDeletedResources = a})
...
instance AWSRequest ListDiscoveredResources where
  ...
  response =
    receiveJSON
      (\s h x ->
         ListDiscoveredResourcesResponse' <$> (x .?> "nextToken") <*>
...
ldrrsResourceIdentifiers ::
     Lens' ListDiscoveredResourcesResponse [ResourceIdentifier]
ldrrsResourceIdentifiers =
  lens _ldrrsResourceIdentifiers (\s a -> s {_ldrrsResourceIdentifiers = a}) .
  _Default . _Coerce

-- | -- | The response status code.
ldrrsResponseStatus :: Lens' ListDiscoveredResourcesResponse Int
ldrrsResponseStatus =
  lens _ldrrsResponseStatus (\s a -> s {_ldrrsResponseStatus = a})
