...
instance ToJSON GetConformancePackComplianceSummary
         where
...
instance ToPath GetConformancePackComplianceSummary
         where
        toPath = const "/"

instance ToQuery GetConformancePackComplianceSummary
         where
