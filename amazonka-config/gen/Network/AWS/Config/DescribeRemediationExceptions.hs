...
instance AWSRequest DescribeRemediationExceptions
         where
...
instance Hashable DescribeRemediationExceptions where

instance NFData DescribeRemediationExceptions where

instance ToHeaders DescribeRemediationExceptions
         where
        toHeaders
          = const
              (mconcat
