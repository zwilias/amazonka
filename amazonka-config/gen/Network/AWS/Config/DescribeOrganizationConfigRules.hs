...
data DescribeOrganizationConfigRules =
  DescribeOrganizationConfigRules'
    { _docrOrganizationConfigRuleNames :: !(Maybe [Text])
    , _docrNextToken                   :: !(Maybe Text)
...
data DescribeOrganizationConfigRulesResponse =
  DescribeOrganizationConfigRulesResponse'
    { _docrrsOrganizationConfigRules :: !(Maybe [OrganizationConfigRule])
    , _docrrsNextToken               :: !(Maybe Text)
    , _docrrsResponseStatus          :: !Int
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeOrganizationConfigRulesResponse pResponseStatus_ =
  DescribeOrganizationConfigRulesResponse'
    { _docrrsOrganizationConfigRules = Nothing
