...
dcbrComplianceTypes =
  lens _dcbrComplianceTypes (\s a -> s {_dcbrComplianceTypes = a}) .
  _Default . _Coerce
...
instance AWSRequest DescribeComplianceByResource where
  type Rs DescribeComplianceByResource = DescribeComplianceByResourceResponse
...
dcbrrsComplianceByResources ::
     Lens' DescribeComplianceByResourceResponse [ComplianceByResource]
dcbrrsComplianceByResources =
  lens
    _dcbrrsComplianceByResources
    (\s a -> s {_dcbrrsComplianceByResources = a}) .
  _Default . _Coerce
...
dcbrrsResponseStatus =
  lens _dcbrrsResponseStatus (\s a -> s {_dcbrrsResponseStatus = a})
