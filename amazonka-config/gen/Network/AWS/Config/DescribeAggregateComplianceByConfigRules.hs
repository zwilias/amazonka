...
dacbcrFilters ::
     Lens' DescribeAggregateComplianceByConfigRules (Maybe ConfigRuleComplianceFilters)
...
dacbcrConfigurationAggregatorName ::
     Lens' DescribeAggregateComplianceByConfigRules Text
dacbcrConfigurationAggregatorName =
  lens
    _dacbcrConfigurationAggregatorName
    (\s a -> s {_dacbcrConfigurationAggregatorName = a})

instance AWSRequest DescribeAggregateComplianceByConfigRules where
  type Rs DescribeAggregateComplianceByConfigRules = DescribeAggregateComplianceByConfigRulesResponse
...
instance ToHeaders DescribeAggregateComplianceByConfigRules where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("StarlingDoveService.DescribeAggregateComplianceByConfigRules" :: ByteString)
...
-- | The nextToken string returned on a previous page that you use to get the next page of results in a paginated response.
dacbcrrsNextToken ::
     Lens' DescribeAggregateComplianceByConfigRulesResponse (Maybe Text)
dacbcrrsNextToken = lens _dacbcrrsNextToken (\s a -> s {_dacbcrrsNextToken = a})

-- | Returns a list of AggregateComplianceByConfigRule object.
dacbcrrsAggregateComplianceByConfigRules ::
     Lens' DescribeAggregateComplianceByConfigRulesResponse [AggregateComplianceByConfigRule]
dacbcrrsAggregateComplianceByConfigRules =
  lens
    _dacbcrrsAggregateComplianceByConfigRules
    (\s a -> s {_dacbcrrsAggregateComplianceByConfigRules = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dacbcrrsResponseStatus ::
     Lens' DescribeAggregateComplianceByConfigRulesResponse Int
dacbcrrsResponseStatus =
  lens _dacbcrrsResponseStatus (\s a -> s {_dacbcrrsResponseStatus = a})
