...
instance AWSRequest DescribeConformancePackCompliance
         where
...
instance ToHeaders DescribeConformancePackCompliance
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DescribeConformancePackCompliance
         where
...
instance ToPath DescribeConformancePackCompliance
         where
        toPath = const "/"

instance ToQuery DescribeConformancePackCompliance
         where
