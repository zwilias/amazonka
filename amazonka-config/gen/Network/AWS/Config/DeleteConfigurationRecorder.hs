...
dcrConfigurationRecorderName =
  lens
    ...
    (\s a -> s {_dcrConfigurationRecorderName = a})

instance AWSRequest DeleteConfigurationRecorder where
  type Rs DeleteConfigurationRecorder = DeleteConfigurationRecorderResponse
...
instance ToJSON DeleteConfigurationRecorder where
  toJSON DeleteConfigurationRecorder' {..} =
    object
      (catMaybes
         [Just ("ConfigurationRecorderName" .= _dcrConfigurationRecorderName)])
