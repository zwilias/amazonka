...
instance AWSRequest DescribeConformancePackStatus
         where
...
instance Hashable DescribeConformancePackStatus where

instance NFData DescribeConformancePackStatus where

instance ToHeaders DescribeConformancePackStatus
         where
        toHeaders
          = const
              (mconcat
