...
gacdbcrComplianceType ::
     Lens' GetAggregateComplianceDetailsByConfigRule (Maybe ComplianceType)
gacdbcrComplianceType =
  lens _gacdbcrComplianceType (\s a -> s {_gacdbcrComplianceType = a})

-- | The name of the configuration aggregator.
gacdbcrConfigurationAggregatorName ::
     Lens' GetAggregateComplianceDetailsByConfigRule Text
gacdbcrConfigurationAggregatorName =
  lens
    _gacdbcrConfigurationAggregatorName
    (\s a -> s {_gacdbcrConfigurationAggregatorName = a})

-- | The name of the AWS Config rule for which you want compliance information.
gacdbcrConfigRuleName :: Lens' GetAggregateComplianceDetailsByConfigRule Text
gacdbcrConfigRuleName =
  lens _gacdbcrConfigRuleName (\s a -> s {_gacdbcrConfigRuleName = a})
...
instance AWSRequest GetAggregateComplianceDetailsByConfigRule where
  type Rs GetAggregateComplianceDetailsByConfigRule = GetAggregateComplianceDetailsByConfigRuleResponse
...
instance ToHeaders GetAggregateComplianceDetailsByConfigRule where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("StarlingDoveService.GetAggregateComplianceDetailsByConfigRule" :: ByteString)
...
-- | The nextToken string returned on a previous page that you use to get the next page of results in a paginated response.
gacdbcrrsNextToken ::
     Lens' GetAggregateComplianceDetailsByConfigRuleResponse (Maybe Text)
gacdbcrrsNextToken =
  lens _gacdbcrrsNextToken (\s a -> s {_gacdbcrrsNextToken = a})

-- | Returns an AggregateEvaluationResults object.
gacdbcrrsAggregateEvaluationResults ::
     Lens' GetAggregateComplianceDetailsByConfigRuleResponse [AggregateEvaluationResult]
gacdbcrrsAggregateEvaluationResults =
  lens
    _gacdbcrrsAggregateEvaluationResults
    (\s a -> s {_gacdbcrrsAggregateEvaluationResults = a}) .
  _Default . _Coerce

-- | -- | The response status code.
gacdbcrrsResponseStatus ::
     Lens' GetAggregateComplianceDetailsByConfigRuleResponse Int
gacdbcrrsResponseStatus =
  lens _gacdbcrrsResponseStatus (\s a -> s {_gacdbcrrsResponseStatus = a})
