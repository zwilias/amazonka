...
instance AWSRequest DescribeAggregationAuthorizations where
  type Rs DescribeAggregationAuthorizations = DescribeAggregationAuthorizationsResponse
...
instance ToHeaders DescribeAggregationAuthorizations where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("StarlingDoveService.DescribeAggregationAuthorizations" :: ByteString)
...
-- | Returns a list of authorizations granted to various aggregator accounts and regions.
daarsAggregationAuthorizations ::
     Lens' DescribeAggregationAuthorizationsResponse [AggregationAuthorization]
daarsAggregationAuthorizations =
  lens
