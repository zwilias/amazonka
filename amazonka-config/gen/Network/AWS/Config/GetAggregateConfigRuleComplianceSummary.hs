...
gacrcsFilters ::
     Lens' GetAggregateConfigRuleComplianceSummary (Maybe ConfigRuleComplianceSummaryFilters)
...
gacrcsGroupByKey ::
     Lens' GetAggregateConfigRuleComplianceSummary (Maybe ConfigRuleComplianceSummaryGroupKey)
gacrcsGroupByKey = lens _gacrcsGroupByKey (\s a -> s {_gacrcsGroupByKey = a})

-- | The name of the configuration aggregator.
gacrcsConfigurationAggregatorName ::
     Lens' GetAggregateConfigRuleComplianceSummary Text
gacrcsConfigurationAggregatorName =
  lens
    _gacrcsConfigurationAggregatorName
    (\s a -> s {_gacrcsConfigurationAggregatorName = a})

instance AWSRequest GetAggregateConfigRuleComplianceSummary where
  type Rs GetAggregateConfigRuleComplianceSummary = GetAggregateConfigRuleComplianceSummaryResponse
...
instance ToHeaders GetAggregateConfigRuleComplianceSummary where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("StarlingDoveService.GetAggregateConfigRuleComplianceSummary" :: ByteString)
...
gacrcsrsAggregateComplianceCounts ::
     Lens' GetAggregateConfigRuleComplianceSummaryResponse [AggregateComplianceCount]
gacrcsrsAggregateComplianceCounts =
  lens
    _gacrcsrsAggregateComplianceCounts
    (\s a -> s {_gacrcsrsAggregateComplianceCounts = a}) .
  _Default . _Coerce

-- | The nextToken string returned on a previous page that you use to get the next page of results in a paginated response.
gacrcsrsNextToken ::
     Lens' GetAggregateConfigRuleComplianceSummaryResponse (Maybe Text)
...
gacrcsrsGroupByKey ::
     Lens' GetAggregateConfigRuleComplianceSummaryResponse (Maybe Text)
gacrcsrsGroupByKey =
  lens _gacrcsrsGroupByKey (\s a -> s {_gacrcsrsGroupByKey = a})

-- | -- | The response status code.
gacrcsrsResponseStatus ::
     Lens' GetAggregateConfigRuleComplianceSummaryResponse Int
gacrcsrsResponseStatus =
  lens _gacrcsrsResponseStatus (\s a -> s {_gacrcsrsResponseStatus = a})
