...
aasAWSRegions =
  lens _aasAWSRegions (\s a -> s {_aasAWSRegions = a}) . mapping _List1
...
instance FromJSON AccountAggregationSource where
  parseJSON =
    withObject
      "AccountAggregationSource"
      (\x ->
         AccountAggregationSource' <$> (x .:? "AwsRegions") <*>
         (x .:? "AllAwsRegions") <*>
         (x .: "AccountIds"))
...
acbcrConfigRuleName =
  lens _acbcrConfigRuleName (\s a -> s {_acbcrConfigRuleName = a})
...
instance FromJSON AggregateComplianceByConfigRule where
  parseJSON =
    withObject
      "AggregateComplianceByConfigRule"
      (\x ->
         AggregateComplianceByConfigRule' <$> (x .:? "Compliance") <*>
         (x .:? "ConfigRuleName") <*>
         (x .:? "AccountId") <*>
         (x .:? "AwsRegion"))
...
accComplianceSummary =
  lens _accComplianceSummary (\s a -> s {_accComplianceSummary = a})
...
instance FromJSON AggregateComplianceCount where
  parseJSON =
    withObject
      "AggregateComplianceCount"
      (\x ->
         AggregateComplianceCount' <$> (x .:? "GroupName") <*>
         (x .:? "ComplianceSummary"))
...
aerEvaluationResultIdentifier ::
     Lens' AggregateEvaluationResult (Maybe EvaluationResultIdentifier)
aerEvaluationResultIdentifier =
  lens
    _aerEvaluationResultIdentifier
    (\s a -> s {_aerEvaluationResultIdentifier = a})
...
aerConfigRuleInvokedTime =
  lens _aerConfigRuleInvokedTime (\s a -> s {_aerConfigRuleInvokedTime = a}) .
  mapping _Time

-- | The time when AWS Config recorded the aggregate evaluation result.
aerResultRecordedTime :: Lens' AggregateEvaluationResult (Maybe UTCTime)
aerResultRecordedTime =
  lens _aerResultRecordedTime (\s a -> s {_aerResultRecordedTime = a}) .
  mapping _Time
...
instance FromJSON AggregateEvaluationResult where
  parseJSON =
    withObject
      "AggregateEvaluationResult"
      (\x ->
         AggregateEvaluationResult' <$> (x .:? "EvaluationResultIdentifier") <*>
         (x .:? "Annotation") <*>
...
assLastUpdateStatus ::
     Lens' AggregatedSourceStatus (Maybe AggregatedSourceStatusType)
assLastUpdateStatus =
  lens _assLastUpdateStatus (\s a -> s {_assLastUpdateStatus = a})
...
assLastErrorMessage =
  lens _assLastErrorMessage (\s a -> s {_assLastErrorMessage = a})
...
assLastUpdateTime =
  lens _assLastUpdateTime (\s a -> s {_assLastUpdateTime = a}) . mapping _Time
...
instance FromJSON AggregatedSourceStatus where
  parseJSON =
    withObject
      "AggregatedSourceStatus"
      (\x ->
         AggregatedSourceStatus' <$> (x .:? "LastErrorCode") <*>
         (x .:? "LastUpdateStatus") <*>
         (x .:? "SourceType") <*>
         (x .:? "SourceId") <*>
         (x .:? "LastErrorMessage") <*>
...
aaCreationTime =
  lens _aaCreationTime (\s a -> s {_aaCreationTime = a}) . mapping _Time

-- | The region authorized to collect aggregated data.
aaAuthorizedAWSRegion :: Lens' AggregationAuthorization (Maybe Text)
aaAuthorizedAWSRegion =
  lens _aaAuthorizedAWSRegion (\s a -> s {_aaAuthorizedAWSRegion = a})
...
aaAggregationAuthorizationARN =
  lens
    ...
    (\s a -> s {_aaAggregationAuthorizationARN = a})

-- | The 12-digit account ID of the account authorized to aggregate data.
aaAuthorizedAccountId :: Lens' AggregationAuthorization (Maybe Text)
aaAuthorizedAccountId =
  lens _aaAuthorizedAccountId (\s a -> s {_aaAuthorizedAccountId = a})
...
instance FromJSON AggregationAuthorization where
  parseJSON =
    withObject
      "AggregationAuthorization"
      (\x ->
         AggregationAuthorization' <$> (x .:? "CreationTime") <*>
...
bciConfigurationStateId =
  lens _bciConfigurationStateId (\s a -> s {_bciConfigurationStateId = a})
...
bciResourceCreationTime =
  lens _bciResourceCreationTime (\s a -> s {_bciResourceCreationTime = a}) .
  mapping _Time

-- | The configuration item status.
bciConfigurationItemStatus ::
     Lens' BaseConfigurationItem (Maybe ConfigurationItemStatus)
bciConfigurationItemStatus =
  lens _bciConfigurationItemStatus (\s a -> s {_bciConfigurationItemStatus = a})
...
bciConfigurationItemCaptureTime =
  lens
    ...
    (\s a -> s {_bciConfigurationItemCaptureTime = a}) .
  mapping _Time
...
bciSupplementaryConfiguration =
  lens
    ...
    (\s a -> s {_bciSupplementaryConfiguration = a}) .
  _Default . _Map

-- | The Availability Zone associated with the resource.
bciAvailabilityZone :: Lens' BaseConfigurationItem (Maybe Text)
bciAvailabilityZone =
  lens _bciAvailabilityZone (\s a -> s {_bciAvailabilityZone = a})
...
instance FromJSON BaseConfigurationItem where
  parseJSON =
    withObject
      "BaseConfigurationItem"
      (\x ->
         BaseConfigurationItem' <$> (x .:? "resourceId") <*>
         (x .:? "resourceType") <*>
...
cComplianceContributorCount ::
     Lens' Compliance (Maybe ComplianceContributorCount)
cComplianceContributorCount =
  lens
    _cComplianceContributorCount
    (\s a -> s {_cComplianceContributorCount = a})
...
instance FromJSON Compliance where
  parseJSON =
    withObject
      "Compliance"
      (\x ->
         Compliance' <$> (x .:? "ComplianceContributorCount") <*>
         (x .:? "ComplianceType"))
...
cbcrConfigRuleName =
  lens _cbcrConfigRuleName (\s a -> s {_cbcrConfigRuleName = a})
...
instance FromJSON ComplianceByConfigRule where
  parseJSON =
    withObject
      "ComplianceByConfigRule"
      (\x ->
         ComplianceByConfigRule' <$> (x .:? "Compliance") <*>
         (x .:? "ConfigRuleName"))
...
instance FromJSON ComplianceByResource where
  parseJSON =
    withObject
      "ComplianceByResource"
      (\x ->
         ComplianceByResource' <$> (x .:? "ResourceId") <*>
         (x .:? "ResourceType") <*>
         (x .:? "Compliance"))
...
instance FromJSON ComplianceContributorCount where
  parseJSON =
    withObject
      "ComplianceContributorCount"
      (\x ->
         ComplianceContributorCount' <$> (x .:? "CappedCount") <*>
         (x .:? "CapExceeded"))
...
csComplianceSummaryTimestamp =
  lens
    ...
    (\s a -> s {_csComplianceSummaryTimestamp = a}) .
  mapping _Time

-- | The number of AWS Config rules or AWS resources that are compliant, up to a maximum of 25 for rules and 100 for resources.
csCompliantResourceCount ::
     Lens' ComplianceSummary (Maybe ComplianceContributorCount)
csCompliantResourceCount =
  lens _csCompliantResourceCount (\s a -> s {_csCompliantResourceCount = a})
...
csNonCompliantResourceCount =
  lens
    ...
    (\s a -> s {_csNonCompliantResourceCount = a})
...
instance FromJSON ComplianceSummary where
  parseJSON =
    withObject
      "ComplianceSummary"
      (\x ->
         ComplianceSummary' <$> (x .:? "ComplianceSummaryTimestamp") <*>
...
csbrtComplianceSummary ::
     Lens' ComplianceSummaryByResourceType (Maybe ComplianceSummary)
csbrtComplianceSummary =
  lens _csbrtComplianceSummary (\s a -> s {_csbrtComplianceSummary = a})
...
instance FromJSON ComplianceSummaryByResourceType where
  parseJSON =
    withObject
      "ComplianceSummaryByResourceType"
      (\x ->
         ComplianceSummaryByResourceType' <$> (x .:? "ResourceType") <*>
         (x .:? "ComplianceSummary"))
...
cediNextDeliveryTime =
  lens _cediNextDeliveryTime (\s a -> s {_cediNextDeliveryTime = a}) .
  mapping _Time
...
instance FromJSON ConfigExportDeliveryInfo where
  parseJSON =
    withObject
      "ConfigExportDeliveryInfo"
      (\x ->
         ConfigExportDeliveryInfo' <$> (x .:? "lastErrorCode") <*>
         (x .:? "lastAttemptTime") <*>
...
crMaximumExecutionFrequency ::
     Lens' ConfigRule (Maybe MaximumExecutionFrequency)
crMaximumExecutionFrequency =
  lens
    _crMaximumExecutionFrequency
    (\s a -> s {_crMaximumExecutionFrequency = a})
...
instance FromJSON ConfigRule where
  parseJSON =
    withObject
      "ConfigRule"
      (\x ->
         ConfigRule' <$> (x .:? "InputParameters") <*> (x .:? "ConfigRuleName") <*>
...
crcfConfigRuleName =
  lens _crcfConfigRuleName (\s a -> s {_crcfConfigRuleName = a})
...
crcfComplianceType =
  lens _crcfComplianceType (\s a -> s {_crcfComplianceType = a})
...
cresLastFailedInvocationTime =
  lens
    ...
    (\s a -> s {_cresLastFailedInvocationTime = a}) .
  mapping _Time
...
cresFirstEvaluationStarted =
  lens _cresFirstEvaluationStarted (\s a -> s {_cresFirstEvaluationStarted = a})
...
cresLastSuccessfulInvocationTime =
  lens
    ...
    (\s a -> s {_cresLastSuccessfulInvocationTime = a}) .
  mapping _Time
...
instance FromJSON ConfigRuleEvaluationStatus where
  parseJSON =
    withObject
      "ConfigRuleEvaluationStatus"
      (\x ->
         ConfigRuleEvaluationStatus' <$> (x .:? "LastErrorCode") <*>
...
csdpDeliveryFrequency ::
     Lens' ConfigSnapshotDeliveryProperties (Maybe MaximumExecutionFrequency)
csdpDeliveryFrequency =
  lens _csdpDeliveryFrequency (\s a -> s {_csdpDeliveryFrequency = a})

instance FromJSON ConfigSnapshotDeliveryProperties where
  parseJSON =
    withObject
      "ConfigSnapshotDeliveryProperties"
      (\x -> ConfigSnapshotDeliveryProperties' <$> (x .:? "deliveryFrequency"))
...
instance ToJSON ConfigSnapshotDeliveryProperties where
  toJSON ConfigSnapshotDeliveryProperties' {..} =
    object (catMaybes [("deliveryFrequency" .=) <$> _csdpDeliveryFrequency])
...
csdiLastStatusChangeTime =
  lens _csdiLastStatusChangeTime (\s a -> s {_csdiLastStatusChangeTime = a}) .
  mapping _Time
...
instance FromJSON ConfigStreamDeliveryInfo where
  parseJSON =
    withObject
      "ConfigStreamDeliveryInfo"
      (\x ->
         ConfigStreamDeliveryInfo' <$> (x .:? "lastErrorCode") <*>
...
caConfigurationAggregatorARN =
  lens
    ...
    (\s a -> s {_caConfigurationAggregatorARN = a})

-- | The time stamp when the configuration aggregator was created.
caCreationTime :: Lens' ConfigurationAggregator (Maybe UTCTime)
caCreationTime =
  lens _caCreationTime (\s a -> s {_caCreationTime = a}) . mapping _Time

-- | Provides an organization and list of regions to be aggregated.
caOrganizationAggregationSource ::
     Lens' ConfigurationAggregator (Maybe OrganizationAggregationSource)
caOrganizationAggregationSource =
  lens
    _caOrganizationAggregationSource
    (\s a -> s {_caOrganizationAggregationSource = a})

-- | The time of the last update.
caLastUpdatedTime :: Lens' ConfigurationAggregator (Maybe UTCTime)
caLastUpdatedTime =
  lens _caLastUpdatedTime (\s a -> s {_caLastUpdatedTime = a}) . mapping _Time

-- | Provides a list of source accounts and regions to be aggregated.
caAccountAggregationSources ::
     Lens' ConfigurationAggregator [AccountAggregationSource]
caAccountAggregationSources =
  lens
    _caAccountAggregationSources
    (\s a -> s {_caAccountAggregationSources = a}) .
  _Default . _Coerce
...
caConfigurationAggregatorName =
  lens
    ...
    (\s a -> s {_caConfigurationAggregatorName = a})
...
instance FromJSON ConfigurationAggregator where
  parseJSON =
    withObject
      "ConfigurationAggregator"
      (\x ->
         ConfigurationAggregator' <$> (x .:? "ConfigurationAggregatorArn") <*>
         (x .:? "CreationTime") <*>
...
ciConfigurationItemStatus ::
     Lens' ConfigurationItem (Maybe ConfigurationItemStatus)
ciConfigurationItemStatus =
  lens _ciConfigurationItemStatus (\s a -> s {_ciConfigurationItemStatus = a})
...
ciSupplementaryConfiguration =
  lens
    ...
    (\s a -> s {_ciSupplementaryConfiguration = a}) .
  _Default . _Map
...
ciRelationships =
  lens _ciRelationships (\s a -> s {_ciRelationships = a}) . _Default . _Coerce
...
ciRelatedEvents =
  lens _ciRelatedEvents (\s a -> s {_ciRelatedEvents = a}) . _Default . _Coerce
...
ciConfigurationItemMD5Hash =
  lens _ciConfigurationItemMD5Hash (\s a -> s {_ciConfigurationItemMD5Hash = a})
...
instance FromJSON ConfigurationItem where
  parseJSON =
    withObject
      "ConfigurationItem"
      (\x ->
         ConfigurationItem' <$> (x .:? "resourceId") <*> (x .:? "resourceType") <*>
         (x .:? "configurationStateId") <*>
         (x .:? "arn") <*>
         (x .:? "resourceName") <*>
         (x .:? "resourceCreationTime") <*>
...
instance FromJSON ConfigurationRecorder where
  parseJSON =
    withObject
      "ConfigurationRecorder"
      (\x ->
         ConfigurationRecorder' <$> (x .:? "name") <*> (x .:? "recordingGroup") <*>
         (x .:? "roleARN"))
...
crsLastStopTime =
  lens _crsLastStopTime (\s a -> s {_crsLastStopTime = a}) . mapping _Time
...
crsLastStartTime =
  lens _crsLastStartTime (\s a -> s {_crsLastStartTime = a}) . mapping _Time
...
instance FromJSON ConfigurationRecorderStatus where
  parseJSON =
    withObject
      "ConfigurationRecorderStatus"
      (\x ->
         ConfigurationRecorderStatus' <$> (x .:? "lastErrorCode") <*>
         (x .:? "lastStopTime") <*>
         (x .:? "lastStatusChangeTime") <*>
         (x .:? "recording") <*>
         (x .:? "lastStatus") <*>
...
dcConfigSnapshotDeliveryProperties ::
     Lens' DeliveryChannel (Maybe ConfigSnapshotDeliveryProperties)
dcConfigSnapshotDeliveryProperties =
  lens
    _dcConfigSnapshotDeliveryProperties
    (\s a -> s {_dcConfigSnapshotDeliveryProperties = a})
...
instance FromJSON DeliveryChannel where
  parseJSON =
    withObject
      "DeliveryChannel"
      (\x ->
         DeliveryChannel' <$> (x .:? "s3KeyPrefix") <*> (x .:? "snsTopicARN") <*>
         (x .:? "name") <*>
...
dcsConfigSnapshotDeliveryInfo ::
     Lens' DeliveryChannelStatus (Maybe ConfigExportDeliveryInfo)
dcsConfigSnapshotDeliveryInfo =
  lens
...
dcsConfigStreamDeliveryInfo ::
     Lens' DeliveryChannelStatus (Maybe ConfigStreamDeliveryInfo)
dcsConfigStreamDeliveryInfo =
  lens
...
instance FromJSON DeliveryChannelStatus where
  parseJSON =
    withObject
      "DeliveryChannelStatus"
      (\x ->
         DeliveryChannelStatus' <$> (x .:? "configSnapshotDeliveryInfo") <*>
...
eComplianceResourceType =
  lens _eComplianceResourceType (\s a -> s {_eComplianceResourceType = a})

-- | The ID of the AWS resource that was evaluated.
eComplianceResourceId :: Lens' Evaluation Text
eComplianceResourceId =
  lens _eComplianceResourceId (\s a -> s {_eComplianceResourceId = a})
...
eOrderingTimestamp =
  lens _eOrderingTimestamp (\s a -> s {_eOrderingTimestamp = a}) . _Time
...
erEvaluationResultIdentifier ::
     Lens' EvaluationResult (Maybe EvaluationResultIdentifier)
erEvaluationResultIdentifier =
  lens
    _erEvaluationResultIdentifier
    (\s a -> s {_erEvaluationResultIdentifier = a})
...
erConfigRuleInvokedTime =
  lens _erConfigRuleInvokedTime (\s a -> s {_erConfigRuleInvokedTime = a}) .
  mapping _Time

-- | The time when AWS Config recorded the evaluation result.
erResultRecordedTime :: Lens' EvaluationResult (Maybe UTCTime)
erResultRecordedTime =
  lens _erResultRecordedTime (\s a -> s {_erResultRecordedTime = a}) .
  mapping _Time
...
instance FromJSON EvaluationResult where
  parseJSON =
    withObject
      "EvaluationResult"
      (\x ->
         EvaluationResult' <$> (x .:? "EvaluationResultIdentifier") <*>
         (x .:? "Annotation") <*>
         (x .:? "ConfigRuleInvokedTime") <*>
         (x .:? "ResultRecordedTime") <*>
         (x .:? "ResultToken") <*>
...
eriEvaluationResultQualifier ::
     Lens' EvaluationResultIdentifier (Maybe EvaluationResultQualifier)
eriEvaluationResultQualifier =
  lens
    _eriEvaluationResultQualifier
    (\s a -> s {_eriEvaluationResultQualifier = a})
...
eriOrderingTimestamp =
  lens _eriOrderingTimestamp (\s a -> s {_eriOrderingTimestamp = a}) .
  mapping _Time
...
instance FromJSON EvaluationResultIdentifier where
  parseJSON =
    withObject
      "EvaluationResultIdentifier"
      (\x ->
         EvaluationResultIdentifier' <$> (x .:? "EvaluationResultQualifier") <*>
         (x .:? "OrderingTimestamp"))
...
instance FromJSON EvaluationResultQualifier where
  parseJSON =
    withObject
      "EvaluationResultQualifier"
      (\x ->
         EvaluationResultQualifier' <$> (x .:? "ResourceId") <*>
         (x .:? "ResourceType") <*>
         (x .:? "ConfigRuleName"))
...
oasAWSRegions =
  lens _oasAWSRegions (\s a -> s {_oasAWSRegions = a}) . mapping _List1
...
instance FromJSON OrganizationAggregationSource where
  parseJSON =
    withObject
      "OrganizationAggregationSource"
      (\x ->
         OrganizationAggregationSource' <$> (x .:? "AwsRegions") <*>
         (x .:? "AllAwsRegions") <*>
         (x .: "RoleArn"))
...
parRequesterAccountId =
  lens _parRequesterAccountId (\s a -> s {_parRequesterAccountId = a})

-- | The region requesting to aggregate data.
parRequesterAWSRegion :: Lens' PendingAggregationRequest (Maybe Text)
parRequesterAWSRegion =
  lens _parRequesterAWSRegion (\s a -> s {_parRequesterAWSRegion = a})
...
instance FromJSON PendingAggregationRequest where
  parseJSON =
    withObject
      "PendingAggregationRequest"
      (\x ->
         PendingAggregationRequest' <$> (x .:? "RequesterAccountId") <*>
...
rgIncludeGlobalResourceTypes =
  lens
    ...
    (\s a -> s {_rgIncludeGlobalResourceTypes = a})

-- | A comma-separated list that specifies the types of AWS resources for which AWS Config records configuration changes (for example, @AWS::EC2::Instance@ or @AWS::CloudTrail::Trail@ ). Before you can set this option to @true@ , you must set the @allSupported@ option to @false@ . If you set this option to @true@ , when AWS Config adds support for a new type of resource, it will not record resources of that type unless you manually add that type to your recording group. For a list of valid @resourceTypes@ values, see the __resourceType Value__ column in <http://docs.aws.amazon.com/config/latest/developerguide/resource-config-reference.html#supported-resources Supported AWS Resource Types> .
rgResourceTypes :: Lens' RecordingGroup [ResourceType]
rgResourceTypes =
  lens _rgResourceTypes (\s a -> s {_rgResourceTypes = a}) . _Default . _Coerce
  ...
  toJSON RecordingGroup' {..} =
    object
      (catMaybes
         ...
         , ("includeGlobalResourceTypes" .=) <$> _rgIncludeGlobalResourceTypes
...
instance FromJSON Relationship where
  parseJSON =
    withObject
      "Relationship"
      (\x ->
         Relationship' <$> (x .:? "resourceId") <*> (x .:? "resourceType") <*>
         (x .:? "resourceName") <*>
         (x .:? "relationshipName"))
...
instance FromJSON ResourceCount where
  parseJSON =
    withObject
      "ResourceCount"
      (\x -> ResourceCount' <$> (x .:? "resourceType") <*> (x .:? "count"))
...
riResourceDeletionTime =
  lens _riResourceDeletionTime (\s a -> s {_riResourceDeletionTime = a}) .
  mapping _Time
...
instance FromJSON ResourceIdentifier where
  parseJSON =
    withObject
      "ResourceIdentifier"
      (\x ->
         ResourceIdentifier' <$> (x .:? "resourceId") <*> (x .:? "resourceType") <*>
         (x .:? "resourceName") <*>
...
instance FromJSON ResourceKey where
  parseJSON =
    withObject
      "ResourceKey"
      (\x -> ResourceKey' <$> (x .: "resourceType") <*> (x .: "resourceId"))
...
sComplianceResourceTypes =
  lens _sComplianceResourceTypes (\s a -> s {_sComplianceResourceTypes = a}) .
  _Default . _Coerce

-- | The ID of the only AWS resource that you want to trigger an evaluation for the rule. If you specify a resource ID, you must specify one resource type for @ComplianceResourceTypes@ .
sComplianceResourceId :: Lens' Scope (Maybe Text)
sComplianceResourceId =
  lens _sComplianceResourceId (\s a -> s {_sComplianceResourceId = a})
...
instance FromJSON Scope where
  parseJSON =
    withObject
      "Scope"
      (\x ->
         Scope' <$> (x .:? "ComplianceResourceTypes" .!= mempty) <*>
         (x .:? "ComplianceResourceId") <*>
         (x .:? "TagValue") <*>
         (x .:? "TagKey"))
...
sSourceDetails =
  lens _sSourceDetails (\s a -> s {_sSourceDetails = a}) . _Default . _Coerce
...
instance FromJSON Source where
  parseJSON =
    withObject
      "Source"
      (\x ->
         Source' <$> (x .:? "SourceDetails" .!= mempty) <*> (x .: "Owner") <*>
         (x .: "SourceIdentifier"))
...
sdMaximumExecutionFrequency ::
     Lens' SourceDetail (Maybe MaximumExecutionFrequency)
sdMaximumExecutionFrequency =
  lens
    _sdMaximumExecutionFrequency
    (\s a -> s {_sdMaximumExecutionFrequency = a})
