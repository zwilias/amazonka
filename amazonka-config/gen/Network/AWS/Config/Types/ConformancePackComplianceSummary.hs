...
data ConformancePackComplianceSummary = ConformancePackComplianceSummary'{_cpcsConformancePackName
                                                                          ::
                                                                          !Text,
...
conformancePackComplianceSummary
  ...
  = ConformancePackComplianceSummary'{_cpcsConformancePackName
                                        = pConformancePackName_,
                                      _cpcsConformancePackComplianceStatus =
                                        pConformancePackComplianceStatus_}
