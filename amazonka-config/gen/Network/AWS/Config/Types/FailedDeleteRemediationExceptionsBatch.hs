...
data FailedDeleteRemediationExceptionsBatch = FailedDeleteRemediationExceptionsBatch'{_fdrebFailureMessage
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
                                                                                      _fdrebFailedItems
...
failedDeleteRemediationExceptionsBatch
    :: FailedDeleteRemediationExceptionsBatch
failedDeleteRemediationExceptionsBatch
  = FailedDeleteRemediationExceptionsBatch'{_fdrebFailureMessage
                                              = Nothing,
