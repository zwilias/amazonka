...
data ConformancePackEvaluationResult = ConformancePackEvaluationResult'{_cperAnnotation
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _cperComplianceType
...
conformancePackEvaluationResult
    ...
    -> ConformancePackEvaluationResult
conformancePackEvaluationResult pComplianceType_
  pEvaluationResultIdentifier_ pConfigRuleInvokedTime_
  pResultRecordedTime_
  = ConformancePackEvaluationResult'{_cperAnnotation =
                                       Nothing,
