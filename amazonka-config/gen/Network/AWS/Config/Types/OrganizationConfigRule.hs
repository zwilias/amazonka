...
data OrganizationConfigRule = OrganizationConfigRule'{_ocrOrganizationManagedRuleMetadata
                                                      ::
                                                      !(Maybe
...
organizationConfigRule
    ...
    -> OrganizationConfigRule
organizationConfigRule pOrganizationConfigRuleName_
  pOrganizationConfigRuleARN_
  = OrganizationConfigRule'{_ocrOrganizationManagedRuleMetadata
                              = Nothing,
