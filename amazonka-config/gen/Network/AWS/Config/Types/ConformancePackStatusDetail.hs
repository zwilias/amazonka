...
data ConformancePackStatusDetail = ConformancePackStatusDetail'{_cpsdConformancePackStatusReason
                                                                ::
                                                                !(Maybe Text),
...
conformancePackStatusDetail
    ...
    -> ConformancePackStatusDetail
conformancePackStatusDetail pConformancePackName_
  pConformancePackId_ pConformancePackARN_
  pConformancePackState_ pStackARN_
  pLastUpdateRequestedTime_
  = ConformancePackStatusDetail'{_cpsdConformancePackStatusReason
                                   = Nothing,
