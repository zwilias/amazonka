...
data AggregateResourceIdentifier = AggregateResourceIdentifier'{_ariResourceName
                                                                ::
                                                                !(Maybe Text),
                                                                _ariSourceAccountId
                                                                :: !Text,
...
aggregateResourceIdentifier
    ...
    -> AggregateResourceIdentifier
aggregateResourceIdentifier pSourceAccountId_
  pSourceRegion_ pResourceId_ pResourceType_
  = AggregateResourceIdentifier'{_ariResourceName =
                                   Nothing,
