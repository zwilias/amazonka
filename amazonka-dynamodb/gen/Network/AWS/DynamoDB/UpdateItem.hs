...
data UpdateItem = UpdateItem'{_uiExpressionAttributeNames
                              :: !(Maybe (Map Text Text)),
...
updateItem pTableName_
  = UpdateItem'{_uiExpressionAttributeNames = Nothing,
                ...
                _uiExpected = Nothing, _uiTableName = pTableName_,
                _uiKey = mempty}
...
data UpdateItemResponse = UpdateItemResponse'{_uirsItemCollectionMetrics
                                              :: !(Maybe ItemCollectionMetrics),
                                              _uirsConsumedCapacity ::
...
updateItemResponse pResponseStatus_
  = UpdateItemResponse'{_uirsItemCollectionMetrics =
                          Nothing,
