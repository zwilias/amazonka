...
lgtExclusiveStartGlobalTableName =
  lens
    ...
    (\s a -> s {_lgtExclusiveStartGlobalTableName = a})
...
instance AWSRequest ListGlobalTables where
  ...
  response =
    receiveJSON
      (\s h x ->
         ListGlobalTablesResponse' <$> (x .?> "LastEvaluatedGlobalTableName") <*>
...
lgtrsLastEvaluatedGlobalTableName =
  lens
    ...
    (\s a -> s {_lgtrsLastEvaluatedGlobalTableName = a})

-- | List of global table names.
lgtrsGlobalTables :: Lens' ListGlobalTablesResponse [GlobalTable]
lgtrsGlobalTables =
  lens _lgtrsGlobalTables (\s a -> s {_lgtrsGlobalTables = a}) .
  _Default . _Coerce

-- | -- | The response status code.
lgtrsResponseStatus :: Lens' ListGlobalTablesResponse Int
lgtrsResponseStatus =
  lens _lgtrsResponseStatus (\s a -> s {_lgtrsResponseStatus = a})
