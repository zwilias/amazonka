...
data ConsumedCapacity = ConsumedCapacity'{_cReadCapacityUnits
                                          :: !(Maybe Double),
...
consumedCapacity
    :: ConsumedCapacity
consumedCapacity
  = ConsumedCapacity'{_cReadCapacityUnits = Nothing,
                      _cGlobalSecondaryIndexes = Nothing,
                      _cCapacityUnits = Nothing,
                      _cWriteCapacityUnits = Nothing,
                      _cLocalSecondaryIndexes = Nothing, _cTable = Nothing,
                      _cTableName = Nothing}
