...
data ReplicaSettingsUpdate = ReplicaSettingsUpdate'{_rsuReplicaProvisionedReadCapacityAutoScalingSettingsUpdate
                                                    ::
                                                    !(Maybe
...
replicaSettingsUpdate pRegionName_
  = ReplicaSettingsUpdate'{_rsuReplicaProvisionedReadCapacityAutoScalingSettingsUpdate
                             = Nothing,
