...
data ReplicaGlobalSecondaryIndex = ReplicaGlobalSecondaryIndex'{_rgsiProvisionedThroughputOverride
                                                                ::
                                                                !(Maybe
...
replicaGlobalSecondaryIndex pIndexName_
  = ReplicaGlobalSecondaryIndex'{_rgsiProvisionedThroughputOverride
                                   = Nothing,
