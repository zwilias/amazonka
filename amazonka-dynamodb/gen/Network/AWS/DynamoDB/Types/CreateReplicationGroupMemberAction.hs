...
data CreateReplicationGroupMemberAction = CreateReplicationGroupMemberAction'{_crgmaKMSMasterKeyId
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
createReplicationGroupMemberAction pRegionName_
  = CreateReplicationGroupMemberAction'{_crgmaKMSMasterKeyId
                                          = Nothing,
                                        _crgmaProvisionedThroughputOverride =
                                          Nothing,
