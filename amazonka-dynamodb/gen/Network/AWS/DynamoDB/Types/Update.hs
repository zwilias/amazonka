...
data Update = Update'{_uExpressionAttributeNames ::
                      !(Maybe (Map Text Text)),
                      ...
                      _uUpdateExpression :: !Text, _uTableName :: !Text}
...
update pUpdateExpression_ pTableName_
  = Update'{_uExpressionAttributeNames = Nothing,
            _uExpressionAttributeValues = Nothing,
            _uReturnValuesOnConditionCheckFailure = Nothing,
            _uConditionExpression = Nothing, _uKey = mempty,
