...
newtype PointInTimeRecoverySpecification = PointInTimeRecoverySpecification'{_pitrsPointInTimeRecoveryEnabled
                                                                             ::
                                                                             Bool}
...
pointInTimeRecoverySpecification
  ...
  = PointInTimeRecoverySpecification'{_pitrsPointInTimeRecoveryEnabled
                                        = pPointInTimeRecoveryEnabled_}
