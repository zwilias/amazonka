...
data ReplicaGlobalSecondaryIndexDescription = ReplicaGlobalSecondaryIndexDescription'{_rgsidProvisionedThroughputOverride
                                                                                      ::
                                                                                      !(Maybe
...
replicaGlobalSecondaryIndexDescription
    :: ReplicaGlobalSecondaryIndexDescription
replicaGlobalSecondaryIndexDescription
  = ReplicaGlobalSecondaryIndexDescription'{_rgsidProvisionedThroughputOverride
                                              = Nothing,
