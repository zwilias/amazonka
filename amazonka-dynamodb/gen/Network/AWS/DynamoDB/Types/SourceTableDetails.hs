...
data SourceTableDetails = SourceTableDetails'{_stdTableSizeBytes
                                              :: !(Maybe Integer),
...
sourceTableDetails
    ...
    -> SourceTableDetails
sourceTableDetails pTableName_ pTableId_ pKeySchema_
  pTableCreationDateTime_ pProvisionedThroughput_
  = SourceTableDetails'{_stdTableSizeBytes = Nothing,
                        _stdTableARN = Nothing, _stdBillingMode = Nothing,
                        _stdItemCount = Nothing, _stdTableName = pTableName_,
