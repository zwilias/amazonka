...
data ReplicaGlobalSecondaryIndexAutoScalingUpdate = ReplicaGlobalSecondaryIndexAutoScalingUpdate'{_rgsiasuProvisionedReadCapacityAutoScalingUpdate
                                                                                                  ::
                                                                                                  !(Maybe
...
replicaGlobalSecondaryIndexAutoScalingUpdate
    :: ReplicaGlobalSecondaryIndexAutoScalingUpdate
replicaGlobalSecondaryIndexAutoScalingUpdate
  = ReplicaGlobalSecondaryIndexAutoScalingUpdate'{_rgsiasuProvisionedReadCapacityAutoScalingUpdate
                                                    = Nothing,
