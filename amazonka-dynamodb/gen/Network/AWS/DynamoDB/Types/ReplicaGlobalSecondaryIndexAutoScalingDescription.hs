...
data ReplicaGlobalSecondaryIndexAutoScalingDescription = ReplicaGlobalSecondaryIndexAutoScalingDescription'{_rgsiasdIndexStatus
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                IndexStatus),
...
replicaGlobalSecondaryIndexAutoScalingDescription
    :: ReplicaGlobalSecondaryIndexAutoScalingDescription
replicaGlobalSecondaryIndexAutoScalingDescription
  = ReplicaGlobalSecondaryIndexAutoScalingDescription'{_rgsiasdIndexStatus
                                                         = Nothing,
                                                       _rgsiasdProvisionedWriteCapacityAutoScalingSettings
                                                         = Nothing,
                                                       _rgsiasdProvisionedReadCapacityAutoScalingSettings
