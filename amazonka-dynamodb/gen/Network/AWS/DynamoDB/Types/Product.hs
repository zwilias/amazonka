...
instance FromJSON AttributeDefinition where
  parseJSON =
    withObject
      "AttributeDefinition"
      (\x ->
         AttributeDefinition' <$> (x .: "AttributeName") <*>
         (x .: "AttributeType"))
...
instance ToJSON AttributeValueUpdate where
  toJSON AttributeValueUpdate' {..} =
    object
      (catMaybes [("Value" .=) <$> _avuValue, ("Action" .=) <$> _avuAction])
...
bdSourceTableDetails =
  lens _bdSourceTableDetails (\s a -> s {_bdSourceTableDetails = a})

-- | Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.
bdSourceTableFeatureDetails ::
     Lens' BackupDescription (Maybe SourceTableFeatureDetails)
bdSourceTableFeatureDetails =
  lens
    _bdSourceTableFeatureDetails
    (\s a -> s {_bdSourceTableFeatureDetails = a})
...
instance FromJSON BackupDescription where
  parseJSON =
    withObject
      "BackupDescription"
      (\x ->
         BackupDescription' <$> (x .:? "BackupDetails") <*>
...
bdBackupSizeBytes =
  lens _bdBackupSizeBytes (\s a -> s {_bdBackupSizeBytes = a}) . mapping _Nat
...
bdBackupCreationDateTime =
  lens _bdBackupCreationDateTime (\s a -> s {_bdBackupCreationDateTime = a}) .
  _Time
...
instance FromJSON BackupDetails where
  parseJSON =
    withObject
      "BackupDetails"
      (\x ->
         BackupDetails' <$> (x .:? "BackupSizeBytes") <*> (x .: "BackupArn") <*>
         (x .: "BackupName") <*>
         (x .: "BackupStatus") <*>
...
bsBackupSizeBytes =
  lens _bsBackupSizeBytes (\s a -> s {_bsBackupSizeBytes = a}) . mapping _Nat
...
bsBackupCreationDateTime =
  lens _bsBackupCreationDateTime (\s a -> s {_bsBackupCreationDateTime = a}) .
  mapping _Time
...
instance FromJSON BackupSummary where
  parseJSON =
    withObject
      "BackupSummary"
      (\x ->
         BackupSummary' <$> (x .:? "TableArn") <*> (x .:? "BackupName") <*>
         (x .:? "BackupStatus") <*>
         (x .:? "BackupSizeBytes") <*>
         (x .:? "BackupArn") <*>
         (x .:? "TableId") <*>
...
instance FromJSON Capacity where
  parseJSON =
    withObject "Capacity" (\x -> Capacity' <$> (x .:? "CapacityUnits"))
...
ccGlobalSecondaryIndexes =
  lens _ccGlobalSecondaryIndexes (\s a -> s {_ccGlobalSecondaryIndexes = a}) .
  _Default . _Map
...
instance FromJSON ConsumedCapacity where
  parseJSON =
    withObject
      "ConsumedCapacity"
      (\x ->
         ConsumedCapacity' <$> (x .:? "GlobalSecondaryIndexes" .!= mempty) <*>
         (x .:? "CapacityUnits") <*>
...
cbdPointInTimeRecoveryDescription ::
     Lens' ContinuousBackupsDescription (Maybe PointInTimeRecoveryDescription)
cbdPointInTimeRecoveryDescription =
  lens
    _cbdPointInTimeRecoveryDescription
    (\s a -> s {_cbdPointInTimeRecoveryDescription = a})

-- | @ContinuousBackupsStatus@ can be one of the following states : ENABLED, DISABLED
cbdContinuousBackupsStatus ::
     Lens' ContinuousBackupsDescription ContinuousBackupsStatus
cbdContinuousBackupsStatus =
  lens _cbdContinuousBackupsStatus (\s a -> s {_cbdContinuousBackupsStatus = a})
...
cgsiaKeySchema ::
     Lens' CreateGlobalSecondaryIndexAction (NonEmpty KeySchemaElement)
...
cgsiaProvisionedThroughput ::
     Lens' CreateGlobalSecondaryIndexAction ProvisionedThroughput
cgsiaProvisionedThroughput =
  lens _cgsiaProvisionedThroughput (\s a -> s {_cgsiaProvisionedThroughput = a})
  ...
  toJSON CreateGlobalSecondaryIndexAction' {..} =
    object
      (catMaybes
         ...
         , Just ("ProvisionedThroughput" .= _cgsiaProvisionedThroughput)
         ])
...
instance ToJSON DeleteRequest where
  toJSON DeleteRequest' {..} = object (catMaybes [Just ("Key" .= _drKey)])
...
gsiProvisionedThroughput =
  lens _gsiProvisionedThroughput (\s a -> s {_gsiProvisionedThroughput = a})
  ...
  toJSON GlobalSecondaryIndex' {..} =
    object
      (catMaybes
         ...
         , Just ("ProvisionedThroughput" .= _gsiProvisionedThroughput)
         ])
...
gsidProvisionedThroughput ::
     Lens' GlobalSecondaryIndexDescription (Maybe ProvisionedThroughputDescription)
gsidProvisionedThroughput =
  lens _gsidProvisionedThroughput (\s a -> s {_gsidProvisionedThroughput = a})
...
-- | The complete key schema for a global secondary index, which consists of one or more pairs of attribute names and key types:     * @HASH@ - partition key     * @RANGE@ - sort key
gsidKeySchema ::
     Lens' GlobalSecondaryIndexDescription (Maybe (NonEmpty KeySchemaElement))
gsidKeySchema =
  lens _gsidKeySchema (\s a -> s {_gsidKeySchema = a}) . mapping _List1
...
instance FromJSON GlobalSecondaryIndexDescription where
  parseJSON =
    withObject
      "GlobalSecondaryIndexDescription"
      (\x ->
         GlobalSecondaryIndexDescription' <$> (x .:? "Backfilling") <*>
         (x .:? "IndexSizeBytes") <*>
         (x .:? "IndexStatus") <*>
...
gsiiProvisionedThroughput ::
     Lens' GlobalSecondaryIndexInfo (Maybe ProvisionedThroughput)
gsiiProvisionedThroughput =
  lens _gsiiProvisionedThroughput (\s a -> s {_gsiiProvisionedThroughput = a})

-- | The complete key schema for a global secondary index, which consists of one or more pairs of attribute names and key types:     * @HASH@ - partition key     * @RANGE@ - sort key
gsiiKeySchema ::
     Lens' GlobalSecondaryIndexInfo (Maybe (NonEmpty KeySchemaElement))
gsiiKeySchema =
  lens _gsiiKeySchema (\s a -> s {_gsiiKeySchema = a}) . mapping _List1
...
instance FromJSON GlobalSecondaryIndexInfo where
  parseJSON =
    withObject
      "GlobalSecondaryIndexInfo"
      (\x ->
         GlobalSecondaryIndexInfo' <$> (x .:? "ProvisionedThroughput") <*>
         (x .:? "KeySchema") <*>
         (x .:? "Projection") <*>
         (x .:? "IndexName"))
...
gsiuCreate ::
     Lens' GlobalSecondaryIndexUpdate (Maybe CreateGlobalSecondaryIndexAction)
gsiuCreate = lens _gsiuCreate (\s a -> s {_gsiuCreate = a})

-- | The name of an existing global secondary index to be removed.
gsiuDelete ::
     Lens' GlobalSecondaryIndexUpdate (Maybe DeleteGlobalSecondaryIndexAction)
gsiuDelete = lens _gsiuDelete (\s a -> s {_gsiuDelete = a})

-- | The name of an existing global secondary index, along with new provisioned throughput settings to be applied to that index.
gsiuUpdate ::
     Lens' GlobalSecondaryIndexUpdate (Maybe UpdateGlobalSecondaryIndexAction)
...
gtReplicationGroup =
  lens _gtReplicationGroup (\s a -> s {_gtReplicationGroup = a}) .
  _Default . _Coerce
...
gtdGlobalTableStatus =
  lens _gtdGlobalTableStatus (\s a -> s {_gtdGlobalTableStatus = a})

-- | The global table name.
gtdGlobalTableName :: Lens' GlobalTableDescription (Maybe Text)
gtdGlobalTableName =
  lens _gtdGlobalTableName (\s a -> s {_gtdGlobalTableName = a})
...
gtdCreationDateTime =
  lens _gtdCreationDateTime (\s a -> s {_gtdCreationDateTime = a}) .
  mapping _Time

-- | The regions where the global table has replicas.
gtdReplicationGroup :: Lens' GlobalTableDescription [ReplicaDescription]
gtdReplicationGroup =
  lens _gtdReplicationGroup (\s a -> s {_gtdReplicationGroup = a}) .
  _Default . _Coerce
...
instance FromJSON GlobalTableDescription where
  parseJSON =
    withObject
      "GlobalTableDescription"
      (\x ->
         GlobalTableDescription' <$> (x .:? "GlobalTableStatus") <*>
         (x .:? "GlobalTableName") <*>
         (x .:? "GlobalTableArn") <*>
         (x .:? "CreationDateTime") <*>
         (x .:? "ReplicationGroup" .!= mempty))
...
gtgsisuProvisionedWriteCapacityUnits ::
     Lens' GlobalTableGlobalSecondaryIndexSettingsUpdate (Maybe Natural)
gtgsisuProvisionedWriteCapacityUnits =
  lens
    _gtgsisuProvisionedWriteCapacityUnits
    (\s a -> s {_gtgsisuProvisionedWriteCapacityUnits = a}) .
  mapping _Nat
...
icmItemCollectionKey ::
     Lens' ItemCollectionMetrics (HashMap Text AttributeValue)
icmItemCollectionKey =
...
instance FromJSON ItemCollectionMetrics where
  parseJSON =
    withObject
      "ItemCollectionMetrics"
      (\x ->
         ItemCollectionMetrics' <$> (x .:? "ItemCollectionKey" .!= mempty) <*>
...
instance FromJSON KeysAndAttributes where
  parseJSON =
    withObject
      "KeysAndAttributes"
      (\x ->
         KeysAndAttributes' <$> (x .:? "ProjectionExpression") <*>
         (x .:? "AttributesToGet") <*>
...
-- | The complete key schema for the local secondary index, consisting of one or more pairs of attribute names and key types:     * @HASH@ - partition key     * @RANGE@ - sort key
lsidKeySchema ::
     Lens' LocalSecondaryIndexDescription (Maybe (NonEmpty KeySchemaElement))
lsidKeySchema =
  lens _lsidKeySchema (\s a -> s {_lsidKeySchema = a}) . mapping _List1
...
instance FromJSON LocalSecondaryIndexDescription where
  parseJSON =
    withObject
      "LocalSecondaryIndexDescription"
      (\x ->
         LocalSecondaryIndexDescription' <$> (x .:? "IndexSizeBytes") <*>
         (x .:? "IndexArn") <*>
         (x .:? "KeySchema") <*>
         (x .:? "Projection") <*>
         (x .:? "ItemCount") <*>
...
lsiiKeySchema ::
     Lens' LocalSecondaryIndexInfo (Maybe (NonEmpty KeySchemaElement))
lsiiKeySchema =
  lens _lsiiKeySchema (\s a -> s {_lsiiKeySchema = a}) . mapping _List1
...
instance FromJSON LocalSecondaryIndexInfo where
  parseJSON =
    withObject
      "LocalSecondaryIndexInfo"
      (\x ->
         LocalSecondaryIndexInfo' <$> (x .:? "KeySchema") <*>
         (x .:? "Projection") <*>
         (x .:? "IndexName"))
...
pitrdPointInTimeRecoveryStatus ::
     Lens' PointInTimeRecoveryDescription (Maybe PointInTimeRecoveryStatus)
pitrdPointInTimeRecoveryStatus =
  lens
    _pitrdPointInTimeRecoveryStatus
    (\s a -> s {_pitrdPointInTimeRecoveryStatus = a})
...
pitrdEarliestRestorableDateTime ::
     Lens' PointInTimeRecoveryDescription (Maybe UTCTime)
pitrdEarliestRestorableDateTime =
  lens
    _pitrdEarliestRestorableDateTime
    (\s a -> s {_pitrdEarliestRestorableDateTime = a}) .
  mapping _Time
...
pitrdLatestRestorableDateTime =
  lens
    ...
    (\s a -> s {_pitrdLatestRestorableDateTime = a}) .
  mapping _Time
...
instance FromJSON PointInTimeRecoveryDescription where
  parseJSON =
    withObject
      "PointInTimeRecoveryDescription"
      (\x ->
         PointInTimeRecoveryDescription' <$> (x .:? "PointInTimeRecoveryStatus") <*>
...
pitrsPointInTimeRecoveryEnabled =
  lens
    ...
    (\s a -> s {_pitrsPointInTimeRecoveryEnabled = a})
...
instance ToJSON PointInTimeRecoverySpecification where
  toJSON PointInTimeRecoverySpecification' {..} =
    object
      (catMaybes
         [ Just
             ("PointInTimeRecoveryEnabled" .= _pitrsPointInTimeRecoveryEnabled)
         ])
...
pNonKeyAttributes =
  lens _pNonKeyAttributes (\s a -> s {_pNonKeyAttributes = a}) . mapping _List1
...
instance FromJSON Projection where
  parseJSON =
    withObject
      "Projection"
      (\x ->
         Projection' <$> (x .:? "ProjectionType") <*> (x .:? "NonKeyAttributes"))
...
ptReadCapacityUnits =
  lens _ptReadCapacityUnits (\s a -> s {_ptReadCapacityUnits = a}) . _Nat
...
ptWriteCapacityUnits =
  lens _ptWriteCapacityUnits (\s a -> s {_ptWriteCapacityUnits = a}) . _Nat
...
instance FromJSON ProvisionedThroughput where
  parseJSON =
    withObject
      "ProvisionedThroughput"
      (\x ->
         ProvisionedThroughput' <$> (x .: "ReadCapacityUnits") <*>
...
ptdLastDecreaseDateTime ::
     Lens' ProvisionedThroughputDescription (Maybe UTCTime)
ptdLastDecreaseDateTime =
...
ptdNumberOfDecreasesToday ::
     Lens' ProvisionedThroughputDescription (Maybe Natural)
ptdNumberOfDecreasesToday =
  lens _ptdNumberOfDecreasesToday (\s a -> s {_ptdNumberOfDecreasesToday = a}) .
  mapping _Nat
...
instance FromJSON ProvisionedThroughputDescription where
  parseJSON =
    withObject
      "ProvisionedThroughputDescription"
      (\x ->
         ProvisionedThroughputDescription' <$> (x .:? "ReadCapacityUnits") <*>
...
instance FromJSON PutRequest where
  parseJSON =
    withObject "PutRequest" (\x -> PutRequest' <$> (x .:? "Item" .!= mempty))
...
instance ToJSON PutRequest where
  toJSON PutRequest' {..} = object (catMaybes [Just ("Item" .= _prItem)])
...
instance FromJSON Replica where
  parseJSON = withObject "Replica" (\x -> Replica' <$> (x .:? "RegionName"))
...
instance ToJSON Replica where
  toJSON Replica' {..} = object (catMaybes [("RegionName" .=) <$> _rRegionName])
...
rgsisdIndexStatus ::
     Lens' ReplicaGlobalSecondaryIndexSettingsDescription (Maybe IndexStatus)
...
rgsisdProvisionedReadCapacityUnits ::
     Lens' ReplicaGlobalSecondaryIndexSettingsDescription (Maybe Natural)
rgsisdProvisionedReadCapacityUnits =
  lens
    _rgsisdProvisionedReadCapacityUnits
    (\s a -> s {_rgsisdProvisionedReadCapacityUnits = a}) .
  mapping _Nat
...
rgsisdProvisionedWriteCapacityUnits =
  lens
    ...
    (\s a -> s {_rgsisdProvisionedWriteCapacityUnits = a}) .
  mapping _Nat
...
rgsisuProvisionedReadCapacityUnits ::
     Lens' ReplicaGlobalSecondaryIndexSettingsUpdate (Maybe Natural)
rgsisuProvisionedReadCapacityUnits =
  lens
    _rgsisuProvisionedReadCapacityUnits
    (\s a -> s {_rgsisuProvisionedReadCapacityUnits = a}) .
  mapping _Nat
...
rsdReplicaProvisionedReadCapacityUnits ::
     Lens' ReplicaSettingsDescription (Maybe Natural)
rsdReplicaProvisionedReadCapacityUnits =
  lens
    _rsdReplicaProvisionedReadCapacityUnits
    (\s a -> s {_rsdReplicaProvisionedReadCapacityUnits = a}) .
  mapping _Nat
...
rsdReplicaProvisionedWriteCapacityUnits =
  lens
    ...
    (\s a -> s {_rsdReplicaProvisionedWriteCapacityUnits = a}) .
  mapping _Nat

-- | Replica global secondary index settings for the global table.
rsdReplicaGlobalSecondaryIndexSettings ::
     Lens' ReplicaSettingsDescription [ReplicaGlobalSecondaryIndexSettingsDescription]
rsdReplicaGlobalSecondaryIndexSettings =
  lens
    _rsdReplicaGlobalSecondaryIndexSettings
    (\s a -> s {_rsdReplicaGlobalSecondaryIndexSettings = a}) .
  _Default . _Coerce
...
instance FromJSON ReplicaSettingsDescription where
  parseJSON =
    withObject
      "ReplicaSettingsDescription"
      (\x ->
         ReplicaSettingsDescription' <$> (x .:? "ReplicaStatus") <*>
...
rsuReplicaProvisionedReadCapacityUnits ::
     Lens' ReplicaSettingsUpdate (Maybe Natural)
rsuReplicaProvisionedReadCapacityUnits =
  lens
    _rsuReplicaProvisionedReadCapacityUnits
    (\s a -> s {_rsuReplicaProvisionedReadCapacityUnits = a}) .
  mapping _Nat

-- | Represents the settings of a global secondary index for a global table that will be modified.
rsuReplicaGlobalSecondaryIndexSettingsUpdate ::
     Lens' ReplicaSettingsUpdate (Maybe (NonEmpty ReplicaGlobalSecondaryIndexSettingsUpdate))
rsuReplicaGlobalSecondaryIndexSettingsUpdate =
  lens
    _rsuReplicaGlobalSecondaryIndexSettingsUpdate
    (\s a -> s {_rsuReplicaGlobalSecondaryIndexSettingsUpdate = a}) .
  mapping _List1
...
instance ToJSON ReplicaUpdate where
  toJSON ReplicaUpdate' {..} =
    object
      (catMaybes [("Create" .=) <$> _ruCreate, ("Delete" .=) <$> _ruDelete])
...
rsRestoreDateTime =
  lens _rsRestoreDateTime (\s a -> s {_rsRestoreDateTime = a}) . _Time

-- | Indicates if a restore is in progress or not.
rsRestoreInProgress :: Lens' RestoreSummary Bool
rsRestoreInProgress =
  lens _rsRestoreInProgress (\s a -> s {_rsRestoreInProgress = a})
...
instance FromJSON RestoreSummary where
  parseJSON =
    withObject
      "RestoreSummary"
      (\x ->
         RestoreSummary' <$> (x .:? "SourceTableArn") <*>
         (x .:? "SourceBackupArn") <*>
         (x .: "RestoreDateTime") <*>
         (x .: "RestoreInProgress"))
...
instance FromJSON SSEDescription where
  parseJSON =
    withObject "SSEDescription" (\x -> SSEDescription' <$> (x .:? "Status"))
...
stdTableCreationDateTime =
  lens _stdTableCreationDateTime (\s a -> s {_stdTableCreationDateTime = a}) .
  _Time

-- | Read IOPs and Write IOPS on the table when the backup was created.
stdProvisionedThroughput :: Lens' SourceTableDetails ProvisionedThroughput
stdProvisionedThroughput =
  lens _stdProvisionedThroughput (\s a -> s {_stdProvisionedThroughput = a})
...
instance FromJSON SourceTableDetails where
  parseJSON =
    withObject
      "SourceTableDetails"
      (\x ->
         SourceTableDetails' <$> (x .:? "TableSizeBytes") <*> (x .:? "TableArn") <*>
         (x .:? "ItemCount") <*>
         (x .: "TableName") <*>
         (x .: "TableId") <*>
         (x .: "KeySchema") <*>
...
stfdStreamDescription ::
     Lens' SourceTableFeatureDetails (Maybe StreamSpecification)
stfdStreamDescription =
  lens _stfdStreamDescription (\s a -> s {_stfdStreamDescription = a})

-- | Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection and ProvisionedThroughput for the GSIs on the table at the time of backup.
stfdGlobalSecondaryIndexes ::
     Lens' SourceTableFeatureDetails [GlobalSecondaryIndexInfo]
stfdGlobalSecondaryIndexes =
  lens _stfdGlobalSecondaryIndexes (\s a -> s {_stfdGlobalSecondaryIndexes = a}) .
  _Default . _Coerce

-- | Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup.
stfdLocalSecondaryIndexes ::
     Lens' SourceTableFeatureDetails [LocalSecondaryIndexInfo]
stfdLocalSecondaryIndexes =
  lens _stfdLocalSecondaryIndexes (\s a -> s {_stfdLocalSecondaryIndexes = a}) .
  _Default . _Coerce

-- | The description of the server-side encryption status on the table when the backup was created.
stfdSSEDescription :: Lens' SourceTableFeatureDetails (Maybe SSEDescription)
stfdSSEDescription =
  lens _stfdSSEDescription (\s a -> s {_stfdSSEDescription = a})

-- | Time to Live settings on the table when the backup was created.
stfdTimeToLiveDescription ::
     Lens' SourceTableFeatureDetails (Maybe TimeToLiveDescription)
stfdTimeToLiveDescription =
  lens _stfdTimeToLiveDescription (\s a -> s {_stfdTimeToLiveDescription = a})
...
instance FromJSON SourceTableFeatureDetails where
  parseJSON =
    withObject
      "SourceTableFeatureDetails"
      (\x ->
         SourceTableFeatureDetails' <$> (x .:? "StreamDescription") <*>
...
instance FromJSON StreamSpecification where
  parseJSON =
    withObject
      "StreamSpecification"
      (\x ->
         StreamSpecification' <$> (x .:? "StreamViewType") <*>
         (x .:? "StreamEnabled"))
...
tdProvisionedThroughput ::
     Lens' TableDescription (Maybe ProvisionedThroughputDescription)
tdProvisionedThroughput =
...
tdGlobalSecondaryIndexes ::
     Lens' TableDescription [GlobalSecondaryIndexDescription]
tdGlobalSecondaryIndexes =
  lens _tdGlobalSecondaryIndexes (\s a -> s {_tdGlobalSecondaryIndexes = a}) .
  _Default . _Coerce

-- | A timestamp, in ISO 8601 format, for this stream. Note that @LatestStreamLabel@ is not a unique identifier for the stream, because it is possible that a stream from another table might have the same timestamp. However, the combination of the following three elements is guaranteed to be unique:     * the AWS customer ID.     * the table name.     * the @StreamLabel@ .
tdLatestStreamLabel :: Lens' TableDescription (Maybe Text)
tdLatestStreamLabel =
  lens _tdLatestStreamLabel (\s a -> s {_tdLatestStreamLabel = a})
...
tdCreationDateTime =
  lens _tdCreationDateTime (\s a -> s {_tdCreationDateTime = a}) . mapping _Time
...
tdStreamSpecification =
  lens _tdStreamSpecification (\s a -> s {_tdStreamSpecification = a})
...
instance FromJSON TableDescription where
  parseJSON =
    withObject
      "TableDescription"
      (\x ->
         TableDescription' <$> (x .:? "RestoreSummary") <*>
         (x .:? "TableSizeBytes") <*>
...
ttldTimeToLiveStatus =
  lens _ttldTimeToLiveStatus (\s a -> s {_ttldTimeToLiveStatus = a})
...
instance FromJSON TimeToLiveDescription where
  parseJSON =
    withObject
      "TimeToLiveDescription"
      (\x ->
         TimeToLiveDescription' <$> (x .:? "TimeToLiveStatus") <*>
         (x .:? "AttributeName"))
...
instance FromJSON TimeToLiveSpecification where
  parseJSON =
    withObject
      "TimeToLiveSpecification"
      (\x ->
         TimeToLiveSpecification' <$> (x .: "Enabled") <*>
         (x .: "AttributeName"))
...
ugsiaProvisionedThroughput ::
     Lens' UpdateGlobalSecondaryIndexAction ProvisionedThroughput
ugsiaProvisionedThroughput =
  lens _ugsiaProvisionedThroughput (\s a -> s {_ugsiaProvisionedThroughput = a})
...
instance FromJSON WriteRequest where
  parseJSON =
    withObject
      "WriteRequest"
      (\x -> WriteRequest' <$> (x .:? "DeleteRequest") <*> (x .:? "PutRequest"))
