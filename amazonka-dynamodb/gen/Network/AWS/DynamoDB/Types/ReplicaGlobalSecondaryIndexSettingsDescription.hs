...
data ReplicaGlobalSecondaryIndexSettingsDescription = ReplicaGlobalSecondaryIndexSettingsDescription'{_rgsisdIndexStatus
                                                                                                      ::
                                                                                                      !(Maybe
                                                                                                          IndexStatus),
...
replicaGlobalSecondaryIndexSettingsDescription
  pIndexName_
  = ReplicaGlobalSecondaryIndexSettingsDescription'{_rgsisdIndexStatus
                                                      = Nothing,
                                                    _rgsisdProvisionedReadCapacityUnits
                                                      = Nothing,
                                                    _rgsisdProvisionedWriteCapacityUnits
