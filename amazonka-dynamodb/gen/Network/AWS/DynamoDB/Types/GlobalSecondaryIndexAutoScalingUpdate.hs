...
data GlobalSecondaryIndexAutoScalingUpdate = GlobalSecondaryIndexAutoScalingUpdate'{_gsiasuProvisionedWriteCapacityAutoScalingUpdate
                                                                                    ::
                                                                                    !(Maybe
...
globalSecondaryIndexAutoScalingUpdate
    :: GlobalSecondaryIndexAutoScalingUpdate
globalSecondaryIndexAutoScalingUpdate
  = GlobalSecondaryIndexAutoScalingUpdate'{_gsiasuProvisionedWriteCapacityAutoScalingUpdate
                                             = Nothing,
