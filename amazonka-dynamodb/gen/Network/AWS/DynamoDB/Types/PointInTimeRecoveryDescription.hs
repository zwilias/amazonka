...
data PointInTimeRecoveryDescription = PointInTimeRecoveryDescription'{_pitrdPointInTimeRecoveryStatus
                                                                      ::
                                                                      !(Maybe
...
pointInTimeRecoveryDescription
    :: PointInTimeRecoveryDescription
pointInTimeRecoveryDescription
  = PointInTimeRecoveryDescription'{_pitrdPointInTimeRecoveryStatus
                                      = Nothing,
