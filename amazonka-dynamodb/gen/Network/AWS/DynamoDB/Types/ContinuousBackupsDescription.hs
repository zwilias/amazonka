...
data ContinuousBackupsDescription = ContinuousBackupsDescription'{_cbdPointInTimeRecoveryDescription
                                                                  ::
                                                                  !(Maybe
...
continuousBackupsDescription
  ...
  = ContinuousBackupsDescription'{_cbdPointInTimeRecoveryDescription
                                    = Nothing,
                                  _cbdContinuousBackupsStatus =
                                    pContinuousBackupsStatus_}
