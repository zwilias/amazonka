...
data UpdateReplicationGroupMemberAction = UpdateReplicationGroupMemberAction'{_urgmaKMSMasterKeyId
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
updateReplicationGroupMemberAction pRegionName_
  = UpdateReplicationGroupMemberAction'{_urgmaKMSMasterKeyId
                                          = Nothing,
                                        _urgmaProvisionedThroughputOverride =
                                          Nothing,
