...
data ReplicaAutoScalingUpdate = ReplicaAutoScalingUpdate'{_rasuReplicaProvisionedReadCapacityAutoScalingUpdate
                                                          ::
                                                          !(Maybe
...
replicaAutoScalingUpdate pRegionName_
  = ReplicaAutoScalingUpdate'{_rasuReplicaProvisionedReadCapacityAutoScalingUpdate
                                = Nothing,
