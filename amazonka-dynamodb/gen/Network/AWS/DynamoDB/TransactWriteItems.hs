...
data TransactWriteItems = TransactWriteItems'{_twiReturnConsumedCapacity
                                              ::
...
transactWriteItems pTransactItems_
  = TransactWriteItems'{_twiReturnConsumedCapacity =
                          Nothing,
...
data TransactWriteItemsResponse = TransactWriteItemsResponse'{_twirsItemCollectionMetrics
                                                              ::
                                                              !(Maybe
                                                                  (Map Text
...
transactWriteItemsResponse pResponseStatus_
  = TransactWriteItemsResponse'{_twirsItemCollectionMetrics
                                  = Nothing,
