...
newtype DeleteTable = DeleteTable'{_dtTableName ::
                                   Text}
...
data DeleteTableResponse = DeleteTableResponse'{_dtrsTableDescription
...
deleteTableResponse pResponseStatus_
  = DeleteTableResponse'{_dtrsTableDescription =
                           Nothing,
