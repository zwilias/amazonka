...
data CreationInfo = CreationInfo'{_ciOwnerUid ::
                                  !Nat,
                                  _ciOwnerGid :: !Nat, _ciPermissions :: !Text}
...
creationInfo pOwnerUid_ pOwnerGid_ pPermissions_
  = CreationInfo'{_ciOwnerUid = _Nat # pOwnerUid_,
...
instance FromJSON CreationInfo where
        parseJSON
          = withObject "CreationInfo"
              (\ x ->
                 CreationInfo' <$>
                   (x .: "OwnerUid") <*> (x .: "OwnerGid") <*>
                     (x .: "Permissions"))

instance Hashable CreationInfo where

instance NFData CreationInfo where
