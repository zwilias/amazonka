...
data FileSystemPolicyDescription = FileSystemPolicyDescription'{_fspdFileSystemId
                                                                ::
                                                                !(Maybe Text),
                                                                _fspdPolicy ::
                                                                !(Maybe Text)}
...
fileSystemPolicyDescription
    :: FileSystemPolicyDescription
fileSystemPolicyDescription
  = FileSystemPolicyDescription'{_fspdFileSystemId =
                                   Nothing,
                                 _fspdPolicy = Nothing}
...
instance FromJSON FileSystemPolicyDescription where
        parseJSON
          = withObject "FileSystemPolicyDescription"
              (\ x ->
                 FileSystemPolicyDescription' <$>
                   (x .:? "FileSystemId") <*> (x .:? "Policy"))

instance Hashable FileSystemPolicyDescription where

instance NFData FileSystemPolicyDescription where
