...
data AccessPointDescription = AccessPointDescription'{_apdPosixUser
                                                      :: !(Maybe PosixUser),
                                                      _apdRootDirectory ::
                                                      !(Maybe RootDirectory),
                                                      _apdClientToken ::
...
accessPointDescription
    :: AccessPointDescription
accessPointDescription
  = AccessPointDescription'{_apdPosixUser = Nothing,
                            _apdRootDirectory = Nothing,
                            _apdClientToken = Nothing,
                            _apdAccessPointId = Nothing,
                            _apdFileSystemId = Nothing, _apdOwnerId = Nothing,
                            _apdName = Nothing, _apdAccessPointARN = Nothing,
                            _apdLifeCycleState = Nothing, _apdTags = Nothing}
...
instance FromJSON AccessPointDescription where
        parseJSON
          = withObject "AccessPointDescription"
              (\ x ->
                 AccessPointDescription' <$>
                   (x .:? "PosixUser") <*> (x .:? "RootDirectory") <*>
                     (x .:? "ClientToken")
                     <*> (x .:? "AccessPointId")
                     <*> (x .:? "FileSystemId")
                     <*> (x .:? "OwnerId")
...
instance Hashable AccessPointDescription where

instance NFData AccessPointDescription where
