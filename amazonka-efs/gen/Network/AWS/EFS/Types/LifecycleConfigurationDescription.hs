...
newtype LifecycleConfigurationDescription = LifecycleConfigurationDescription'{_lcdLifecyclePolicies
                                                                               ::
                                                                               Maybe
                                                                                 [LifecyclePolicy]}
...
lifecycleConfigurationDescription
    :: LifecycleConfigurationDescription
lifecycleConfigurationDescription
  = LifecycleConfigurationDescription'{_lcdLifecyclePolicies
                                         = Nothing}
