...
dpfpAcceptLanguage =
  lens _dpfpAcceptLanguage (\s a -> s {_dpfpAcceptLanguage = a})
...
instance AWSRequest DisassociateProductFromPortfolio where
  type Rs DisassociateProductFromPortfolio = DisassociateProductFromPortfolioResponse
...
instance ToHeaders DisassociateProductFromPortfolio where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AWS242ServiceCatalogService.DisassociateProductFromPortfolio" :: ByteString)
