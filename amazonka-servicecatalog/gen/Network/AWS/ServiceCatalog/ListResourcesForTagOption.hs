...
lrftoPageSize =
  lens _lrftoPageSize (\s a -> s {_lrftoPageSize = a}) . mapping _Nat
...
instance AWSRequest ListResourcesForTagOption where
  type Rs ListResourcesForTagOption = ListResourcesForTagOptionResponse
...
instance ToHeaders ListResourcesForTagOption where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("AWS242ServiceCatalogService.ListResourcesForTagOption" :: ByteString)
...
lrftorsResourceDetails ::
     Lens' ListResourcesForTagOptionResponse [ResourceDetail]
lrftorsResourceDetails =
  lens _lrftorsResourceDetails (\s a -> s {_lrftorsResourceDetails = a}) .
  _Default . _Coerce
...
lrftorsResponseStatus =
  lens _lrftorsResponseStatus (\s a -> s {_lrftorsResponseStatus = a})
