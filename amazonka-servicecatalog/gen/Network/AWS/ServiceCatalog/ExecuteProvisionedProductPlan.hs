...
data ExecuteProvisionedProductPlan = ExecuteProvisionedProductPlan'{_epppAcceptLanguage
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _epppPlanId
...
executeProvisionedProductPlan
    ...
    -> ExecuteProvisionedProductPlan
executeProvisionedProductPlan pPlanId_
  pIdempotencyToken_
  = ExecuteProvisionedProductPlan'{_epppAcceptLanguage
                                     = Nothing,
...
data ExecuteProvisionedProductPlanResponse = ExecuteProvisionedProductPlanResponse'{_eppprsRecordDetail
                                                                                    ::
                                                                                    !(Maybe
                                                                                        RecordDetail),
...
executeProvisionedProductPlanResponse
  pResponseStatus_
  = ExecuteProvisionedProductPlanResponse'{_eppprsRecordDetail
                                             = Nothing,
                                           _eppprsResponseStatus =
                                             pResponseStatus_}
