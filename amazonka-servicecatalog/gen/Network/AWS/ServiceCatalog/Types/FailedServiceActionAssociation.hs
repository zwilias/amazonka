...
data FailedServiceActionAssociation = FailedServiceActionAssociation'{_fsaaProvisioningArtifactId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _fsaaErrorCode
...
failedServiceActionAssociation
    :: FailedServiceActionAssociation
failedServiceActionAssociation
  = FailedServiceActionAssociation'{_fsaaProvisioningArtifactId
                                      = Nothing,
