...
data ServiceActionAssociation = ServiceActionAssociation'{_saaServiceActionId
                                                          :: !Text,
                                                          _saaProductId ::
                                                          !Text,
...
serviceActionAssociation
    ...
    -> ServiceActionAssociation
serviceActionAssociation pServiceActionId_
  pProductId_ pProvisioningArtifactId_
  = ServiceActionAssociation'{_saaServiceActionId =
                                pServiceActionId_,
