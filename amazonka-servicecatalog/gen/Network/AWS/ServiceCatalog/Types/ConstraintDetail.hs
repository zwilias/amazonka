...
data ConstraintDetail = ConstraintDetail'{_cdPortfolioId
                                          :: !(Maybe Text),
...
constraintDetail
    :: ConstraintDetail
constraintDetail
  = ConstraintDetail'{_cdPortfolioId = Nothing,
                      _cdConstraintId = Nothing, _cdOwner = Nothing,
                      _cdType = Nothing, _cdDescription = Nothing,
