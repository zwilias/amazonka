...
data ProvisioningArtifact = ProvisioningArtifact'{_paCreatedTime
                                                  :: !(Maybe POSIX),
                                                  _paName :: !(Maybe Text),
                                                  _paId :: !(Maybe Text),
                                                  _paGuidance ::
...
provisioningArtifact
    :: ProvisioningArtifact
provisioningArtifact
  = ProvisioningArtifact'{_paCreatedTime = Nothing,
                          _paName = Nothing, _paId = Nothing,
                          _paGuidance = Nothing, _paDescription = Nothing}
