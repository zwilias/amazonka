...
instance AWSRequest UpdateConstraint where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdateConstraintResponse' <$> (x .?> "Status") <*>
         (x .?> "ConstraintDetail") <*>
...
ucrsConstraintDetail =
  lens _ucrsConstraintDetail (\s a -> s {_ucrsConstraintDetail = a})

-- | The constraint parameters.
ucrsConstraintParameters :: Lens' UpdateConstraintResponse (Maybe Text)
ucrsConstraintParameters =
  lens _ucrsConstraintParameters (\s a -> s {_ucrsConstraintParameters = a})
