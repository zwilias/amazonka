...
imtProgressUpdateStream =
  lens _imtProgressUpdateStream (\s a -> s {_imtProgressUpdateStream = a})

-- | Unique identifier that references the migration task.
imtMigrationTaskName :: Lens' ImportMigrationTask Text
imtMigrationTaskName =
  lens _imtMigrationTaskName (\s a -> s {_imtMigrationTaskName = a})
...
imtrsResponseStatus =
  lens _imtrsResponseStatus (\s a -> s {_imtrsResponseStatus = a})
