...
ldrMaxResults =
  lens _ldrMaxResults (\s a -> s {_ldrMaxResults = a}) . mapping _Nat

-- | The name of the ProgressUpdateStream.
ldrProgressUpdateStream :: Lens' ListDiscoveredResources Text
ldrProgressUpdateStream =
  lens _ldrProgressUpdateStream (\s a -> s {_ldrProgressUpdateStream = a})

-- | The name of the MigrationTask.
ldrMigrationTaskName :: Lens' ListDiscoveredResources Text
ldrMigrationTaskName =
  lens _ldrMigrationTaskName (\s a -> s {_ldrMigrationTaskName = a})
...
ldrrsDiscoveredResourceList ::
     Lens' ListDiscoveredResourcesResponse [DiscoveredResource]
ldrrsDiscoveredResourceList =
  lens
    _ldrrsDiscoveredResourceList
    (\s a -> s {_ldrrsDiscoveredResourceList = a}) .
  _Default . _Coerce
