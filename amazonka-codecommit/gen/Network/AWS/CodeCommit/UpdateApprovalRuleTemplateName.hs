...
instance AWSRequest UpdateApprovalRuleTemplateName
         where
...
instance NFData UpdateApprovalRuleTemplateName where

instance ToHeaders UpdateApprovalRuleTemplateName
         where
        toHeaders
          = const
              (mconcat
