...
instance Hashable GetMergeOptions where

instance NFData GetMergeOptions where
...
getMergeOptionsResponse
    :: Int -- ^ 'gmorsResponseStatus'
    -> Text -- ^ 'gmorsSourceCommitId'
...
instance NFData GetMergeOptionsResponse where
