...
instance AWSRequest OverridePullRequestApprovalRules
         where
...
instance ToHeaders OverridePullRequestApprovalRules
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON OverridePullRequestApprovalRules
         where
...
instance ToPath OverridePullRequestApprovalRules
         where
        toPath = const "/"

instance ToQuery OverridePullRequestApprovalRules
         where
