...
instance AWSRequest GetPullRequestApprovalStates
         where
...
instance Hashable GetPullRequestApprovalStates where

instance NFData GetPullRequestApprovalStates where
