...
batchDescribeMergeConflicts
    :: Text -- ^ 'bdmcRepositoryName'
    -> Text -- ^ 'bdmcDestinationCommitSpecifier'
...
instance Hashable BatchDescribeMergeConflicts where

instance NFData BatchDescribeMergeConflicts where
