...
instance AWSRequest EvaluatePullRequestApprovalRules
         where
...
instance ToHeaders EvaluatePullRequestApprovalRules
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON EvaluatePullRequestApprovalRules
         where
...
instance ToPath EvaluatePullRequestApprovalRules
         where
        toPath = const "/"

instance ToQuery EvaluatePullRequestApprovalRules
         where
