...
instance AWSRequest DescribeMergeConflicts where
        type Rs DescribeMergeConflicts =
             DescribeMergeConflictsResponse
...
instance Hashable DescribeMergeConflicts where

instance NFData DescribeMergeConflicts where
...
describeMergeConflictsResponse
    ...
    -> ConflictMetadata -- ^ 'dmcrsConflictMetadata'
...
instance NFData DescribeMergeConflictsResponse where
