...
instance AWSRequest GetApprovalRuleTemplate where
        type Rs GetApprovalRuleTemplate =
             GetApprovalRuleTemplateResponse
...
instance Hashable GetApprovalRuleTemplate where

instance NFData GetApprovalRuleTemplate where
...
instance NFData GetApprovalRuleTemplateResponse where
