...
instance AWSRequest MergeBranchesByThreeWay where
        type Rs MergeBranchesByThreeWay =
             MergeBranchesByThreeWayResponse
...
instance Hashable MergeBranchesByThreeWay where

instance NFData MergeBranchesByThreeWay where
...
instance NFData MergeBranchesByThreeWayResponse where
