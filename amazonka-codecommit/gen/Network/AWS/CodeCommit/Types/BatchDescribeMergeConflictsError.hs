...
data BatchDescribeMergeConflictsError = BatchDescribeMergeConflictsError'{_bdmceFilePath
                                                                          ::
                                                                          !Text,
                                                                          _bdmceExceptionName
                                                                          ::
...
batchDescribeMergeConflictsError
    ...
    -> Text -- ^ 'bdmceMessage'
    -> BatchDescribeMergeConflictsError
batchDescribeMergeConflictsError pFilePath_
  pExceptionName_ pMessage_
  = BatchDescribeMergeConflictsError'{_bdmceFilePath =
                                        pFilePath_,
