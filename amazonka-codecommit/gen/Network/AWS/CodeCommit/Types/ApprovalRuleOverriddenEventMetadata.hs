...
data ApprovalRuleOverriddenEventMetadata = ApprovalRuleOverriddenEventMetadata'{_aroemOverrideStatus
                                                                                ::
                                                                                !(Maybe
                                                                                    OverrideStatus),
                                                                                _aroemRevisionId
...
approvalRuleOverriddenEventMetadata
    :: ApprovalRuleOverriddenEventMetadata
approvalRuleOverriddenEventMetadata
  = ApprovalRuleOverriddenEventMetadata'{_aroemOverrideStatus
                                           = Nothing,
