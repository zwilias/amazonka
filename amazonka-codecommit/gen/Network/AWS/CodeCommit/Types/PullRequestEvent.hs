...
data PullRequestEvent = PullRequestEvent'{_prePullRequestMergedStateChangedEventMetadata
                                          ::
                                          !(Maybe
...
pullRequestEvent
    :: PullRequestEvent
pullRequestEvent
  = PullRequestEvent'{_prePullRequestMergedStateChangedEventMetadata
                        = Nothing,
                      ...
                      _preActorARN = Nothing, _prePullRequestId = Nothing,
