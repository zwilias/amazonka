...
instance FromJSON BranchInfo where
  parseJSON =
    withObject
      "BranchInfo"
      (\x -> BranchInfo' <$> (x .:? "commitId") <*> (x .:? "branchName"))
...
cLastModifiedDate =
  lens _cLastModifiedDate (\s a -> s {_cLastModifiedDate = a}) . mapping _Time
...
cClientRequestToken =
  lens _cClientRequestToken (\s a -> s {_cClientRequestToken = a})
...
instance FromJSON Comment where
  parseJSON =
    withObject
      "Comment"
      (\x ->
         Comment' <$> (x .:? "lastModifiedDate") <*> (x .:? "authorArn") <*>
         (x .:? "content") <*>
         (x .:? "creationDate") <*>
         (x .:? "deleted") <*>
...
cfccBeforeCommitId =
  lens _cfccBeforeCommitId (\s a -> s {_cfccBeforeCommitId = a})

-- | The name of the repository that contains the compared commits.
cfccRepositoryName :: Lens' CommentsForComparedCommit (Maybe Text)
cfccRepositoryName =
  lens _cfccRepositoryName (\s a -> s {_cfccRepositoryName = a})

-- | An array of comment objects. Each comment object contains information about a comment on the comparison between commits.
cfccComments :: Lens' CommentsForComparedCommit [Comment]
cfccComments =
  lens _cfccComments (\s a -> s {_cfccComments = a}) . _Default . _Coerce
...
instance FromJSON CommentsForComparedCommit where
  parseJSON =
    withObject
      "CommentsForComparedCommit"
      (\x ->
         CommentsForComparedCommit' <$> (x .:? "beforeBlobId") <*>
         (x .:? "location") <*>
         (x .:? "afterCommitId") <*>
         (x .:? "afterBlobId") <*>
         (x .:? "beforeCommitId") <*>
...
cfprBeforeCommitId =
  lens _cfprBeforeCommitId (\s a -> s {_cfprBeforeCommitId = a})

-- | The name of the repository that contains the pull request.
cfprRepositoryName :: Lens' CommentsForPullRequest (Maybe Text)
cfprRepositoryName =
  lens _cfprRepositoryName (\s a -> s {_cfprRepositoryName = a})

-- | An array of comment objects. Each comment object contains information about a comment on the pull request.
cfprComments :: Lens' CommentsForPullRequest [Comment]
cfprComments =
  lens _cfprComments (\s a -> s {_cfprComments = a}) . _Default . _Coerce
...
instance FromJSON CommentsForPullRequest where
  parseJSON =
    withObject
      "CommentsForPullRequest"
      (\x ->
         CommentsForPullRequest' <$> (x .:? "beforeBlobId") <*>
         (x .:? "location") <*>
         (x .:? "afterCommitId") <*>
         (x .:? "pullRequestId") <*>
         (x .:? "afterBlobId") <*>
...
instance FromJSON Difference where
  parseJSON =
    withObject
      "Difference"
      (\x ->
         Difference' <$> (x .:? "afterBlob") <*> (x .:? "beforeBlob") <*>
         (x .:? "changeType"))
...
lRelativeFileVersion =
  lens _lRelativeFileVersion (\s a -> s {_lRelativeFileVersion = a})
...
instance FromJSON Location where
  parseJSON =
    withObject
      "Location"
      (\x ->
         Location' <$> (x .:? "relativeFileVersion") <*> (x .:? "filePath") <*>
         (x .:? "filePosition"))
...
instance FromJSON MergeMetadata where
  parseJSON =
    withObject
      "MergeMetadata"
      (\x -> MergeMetadata' <$> (x .:? "mergedBy") <*> (x .:? "isMerged"))
...
prCreationDate =
  lens _prCreationDate (\s a -> s {_prCreationDate = a}) . mapping _Time

-- | The status of the pull request. Pull request status can only change from @OPEN@ to @CLOSED@ .
prPullRequestStatus :: Lens' PullRequest (Maybe PullRequestStatusEnum)
prPullRequestStatus =
  lens _prPullRequestStatus (\s a -> s {_prPullRequestStatus = a})
...
prClientRequestToken =
  lens _prClientRequestToken (\s a -> s {_prClientRequestToken = a})

-- | The day and time of the last user or system activity on the pull request, in timestamp format.
prLastActivityDate :: Lens' PullRequest (Maybe UTCTime)
prLastActivityDate =
  lens _prLastActivityDate (\s a -> s {_prLastActivityDate = a}) . mapping _Time

-- | The targets of the pull request, including the source branch and destination branch for the pull request.
prPullRequestTargets :: Lens' PullRequest [PullRequestTarget]
prPullRequestTargets =
  lens _prPullRequestTargets (\s a -> s {_prPullRequestTargets = a}) .
  _Default . _Coerce
...
instance FromJSON PullRequest where
  parseJSON =
    withObject
      "PullRequest"
      (\x ->
         PullRequest' <$> (x .:? "authorArn") <*> (x .:? "pullRequestId") <*>
         (x .:? "creationDate") <*>
         (x .:? "pullRequestStatus") <*>
         (x .:? "title") <*>
         (x .:? "clientRequestToken") <*>
...
prePullRequestMergedStateChangedEventMetadata ::
     Lens' PullRequestEvent (Maybe PullRequestMergedStateChangedEventMetadata)
prePullRequestMergedStateChangedEventMetadata =
  lens
    _prePullRequestMergedStateChangedEventMetadata
    (\s a -> s {_prePullRequestMergedStateChangedEventMetadata = a})
...
prePullRequestEventType =
  lens _prePullRequestEventType (\s a -> s {_prePullRequestEventType = a})

-- | Information about the change in status for the pull request event.
prePullRequestStatusChangedEventMetadata ::
     Lens' PullRequestEvent (Maybe PullRequestStatusChangedEventMetadata)
prePullRequestStatusChangedEventMetadata =
  lens
    _prePullRequestStatusChangedEventMetadata
    (\s a -> s {_prePullRequestStatusChangedEventMetadata = a})
...
preEventDate =
  lens _preEventDate (\s a -> s {_preEventDate = a}) . mapping _Time
...
prePullRequestSourceReferenceUpdatedEventMetadata =
  lens
    ...
    (\s a -> s {_prePullRequestSourceReferenceUpdatedEventMetadata = a})
...
prmscemDestinationReference ::
     Lens' PullRequestMergedStateChangedEventMetadata (Maybe Text)
prmscemDestinationReference =
  lens
    _prmscemDestinationReference
    (\s a -> s {_prmscemDestinationReference = a})

-- | Information about the merge state change event.
prmscemMergeMetadata ::
     Lens' PullRequestMergedStateChangedEventMetadata (Maybe MergeMetadata)
prmscemMergeMetadata =
  lens _prmscemMergeMetadata (\s a -> s {_prmscemMergeMetadata = a})

-- | The name of the repository where the pull request was created.
prmscemRepositoryName ::
     Lens' PullRequestMergedStateChangedEventMetadata (Maybe Text)
prmscemRepositoryName =
  lens _prmscemRepositoryName (\s a -> s {_prmscemRepositoryName = a})
...
prsruemAfterCommitId ::
     Lens' PullRequestSourceReferenceUpdatedEventMetadata (Maybe Text)
prsruemAfterCommitId =
  lens _prsruemAfterCommitId (\s a -> s {_prsruemAfterCommitId = a})

-- | The full commit ID of the commit in the destination branch that was the tip of the branch at the time the pull request was updated.
prsruemBeforeCommitId ::
     Lens' PullRequestSourceReferenceUpdatedEventMetadata (Maybe Text)
prsruemBeforeCommitId =
  lens _prsruemBeforeCommitId (\s a -> s {_prsruemBeforeCommitId = a})

-- | The name of the repository where the pull request was updated.
prsruemRepositoryName ::
     Lens' PullRequestSourceReferenceUpdatedEventMetadata (Maybe Text)
prsruemRepositoryName =
  lens _prsruemRepositoryName (\s a -> s {_prsruemRepositoryName = a})
...
prscemPullRequestStatus ::
     Lens' PullRequestStatusChangedEventMetadata (Maybe PullRequestStatusEnum)
prscemPullRequestStatus =
  lens _prscemPullRequestStatus (\s a -> s {_prscemPullRequestStatus = a})
...
instance FromJSON PullRequestStatusChangedEventMetadata where
  parseJSON =
    withObject
      "PullRequestStatusChangedEventMetadata"
      (\x ->
         PullRequestStatusChangedEventMetadata' <$> (x .:? "pullRequestStatus"))
...
prtDestinationReference =
  lens _prtDestinationReference (\s a -> s {_prtDestinationReference = a})
...
prtDestinationCommit =
  lens _prtDestinationCommit (\s a -> s {_prtDestinationCommit = a})
...
prtSourceReference =
  lens _prtSourceReference (\s a -> s {_prtSourceReference = a})
...
instance FromJSON PullRequestTarget where
  parseJSON =
    withObject
      "PullRequestTarget"
      (\x ->
         PullRequestTarget' <$> (x .:? "sourceCommit") <*>
         (x .:? "destinationReference") <*>
         (x .:? "mergeMetadata") <*>
         (x .:? "destinationCommit") <*>
         (x .:? "repositoryName") <*>
...
rmRepositoryDescription =
  lens _rmRepositoryDescription (\s a -> s {_rmRepositoryDescription = a})

-- | The date and time the repository was last modified, in timestamp format.
rmLastModifiedDate :: Lens' RepositoryMetadata (Maybe UTCTime)
rmLastModifiedDate =
  lens _rmLastModifiedDate (\s a -> s {_rmLastModifiedDate = a}) . mapping _Time
...
rmCreationDate =
  lens _rmCreationDate (\s a -> s {_rmCreationDate = a}) . mapping _Time
...
instance FromJSON RepositoryMetadata where
  parseJSON =
    withObject
      "RepositoryMetadata"
      (\x ->
         RepositoryMetadata' <$> (x .:? "repositoryDescription") <*>
         (x .:? "lastModifiedDate") <*>
         (x .:? "Arn") <*>
         (x .:? "cloneUrlHttp") <*>
         (x .:? "accountId") <*>
...
rnipRepositoryName =
  lens _rnipRepositoryName (\s a -> s {_rnipRepositoryName = a})
...
instance FromJSON RepositoryNameIdPair where
  parseJSON =
    withObject
      "RepositoryNameIdPair"
      (\x ->
         RepositoryNameIdPair' <$> (x .:? "repositoryId") <*>
         (x .:? "repositoryName"))
...
instance FromJSON RepositoryTrigger where
  parseJSON =
    withObject
      "RepositoryTrigger"
      (\x ->
         RepositoryTrigger' <$> (x .:? "branches" .!= mempty) <*>
         (x .:? "customData") <*>
         (x .: "name") <*>
         (x .: "destinationArn") <*>
         (x .:? "events" .!= mempty))
...
rtefFailureMessage =
  lens _rtefFailureMessage (\s a -> s {_rtefFailureMessage = a})
...
instance FromJSON RepositoryTriggerExecutionFailure where
  parseJSON =
    withObject
      "RepositoryTriggerExecutionFailure"
      (\x ->
         RepositoryTriggerExecutionFailure' <$> (x .:? "failureMessage") <*>
         (x .:? "trigger"))
...
tDestinationReference =
  lens _tDestinationReference (\s a -> s {_tDestinationReference = a})
...
instance FromJSON UserInfo where
  parseJSON =
    withObject
      "UserInfo"
      (\x -> UserInfo' <$> (x .:? "email") <*> (x .:? "date") <*> (x .:? "name"))
