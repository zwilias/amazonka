...
data PullRequest = PullRequest'{_prApprovalRules ::
                                !(Maybe [ApprovalRule]),
...
pullRequest
    :: PullRequest
pullRequest
  = PullRequest'{_prApprovalRules = Nothing,
                 _prAuthorARN = Nothing, _prPullRequestId = Nothing,
                 _prCreationDate = Nothing,
                 _prPullRequestStatus = Nothing, _prTitle = Nothing,
