...
data PullRequestCreatedEventMetadata = PullRequestCreatedEventMetadata'{_prcemDestinationCommitId
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _prcemMergeBase
...
pullRequestCreatedEventMetadata
    :: PullRequestCreatedEventMetadata
pullRequestCreatedEventMetadata
  = PullRequestCreatedEventMetadata'{_prcemDestinationCommitId
                                       = Nothing,
