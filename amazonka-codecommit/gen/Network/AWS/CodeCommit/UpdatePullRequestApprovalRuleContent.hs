...
instance ToJSON UpdatePullRequestApprovalRuleContent
         where
...
instance ToPath UpdatePullRequestApprovalRuleContent
         where
        toPath = const "/"

instance ToQuery UpdatePullRequestApprovalRuleContent
         where
