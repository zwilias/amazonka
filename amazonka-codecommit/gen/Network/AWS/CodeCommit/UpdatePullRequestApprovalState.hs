...
instance AWSRequest UpdatePullRequestApprovalState
         where
...
instance NFData UpdatePullRequestApprovalState where

instance ToHeaders UpdatePullRequestApprovalState
         where
        toHeaders
          = const
              (mconcat
