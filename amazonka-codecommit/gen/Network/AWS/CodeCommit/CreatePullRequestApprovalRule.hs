...
instance AWSRequest CreatePullRequestApprovalRule
         where
...
instance Hashable CreatePullRequestApprovalRule where

instance NFData CreatePullRequestApprovalRule where

instance ToHeaders CreatePullRequestApprovalRule
         where
        toHeaders
          = const
              (mconcat
