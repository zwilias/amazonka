...
instance AWSRequest UpdateApprovalRuleTemplateContent
         where
...
instance ToHeaders UpdateApprovalRuleTemplateContent
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON UpdateApprovalRuleTemplateContent
         where
...
instance ToPath UpdateApprovalRuleTemplateContent
         where
        toPath = const "/"

instance ToQuery UpdateApprovalRuleTemplateContent
         where
