...
data BulkEmailDestinationStatus = BulkEmailDestinationStatus'{_bedsStatus
                                                              ::
                                                              !(Maybe
                                                                  BulkEmailStatus),
                                                              _bedsError ::
...
bulkEmailDestinationStatus
    :: BulkEmailDestinationStatus
bulkEmailDestinationStatus
  = BulkEmailDestinationStatus'{_bedsStatus = Nothing,
                                _bedsError = Nothing, _bedsMessageId = Nothing}
