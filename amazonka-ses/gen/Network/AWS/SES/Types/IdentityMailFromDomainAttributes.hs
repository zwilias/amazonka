...
data IdentityMailFromDomainAttributes = IdentityMailFromDomainAttributes'{_imfdaMailFromDomain
                                                                          ::
                                                                          !Text,
...
identityMailFromDomainAttributes
    ...
    -> IdentityMailFromDomainAttributes
identityMailFromDomainAttributes pMailFromDomain_
  pMailFromDomainStatus_ pBehaviorOnMXFailure_
  = IdentityMailFromDomainAttributes'{_imfdaMailFromDomain
                                        = pMailFromDomain_,
                                      _imfdaMailFromDomainStatus =
