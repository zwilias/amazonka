...
data KinesisFirehoseDestination = KinesisFirehoseDestination'{_kfdIAMRoleARN
                                                              :: !Text,
...
kinesisFirehoseDestination
    ...
    -> KinesisFirehoseDestination
kinesisFirehoseDestination pIAMRoleARN_
  pDeliveryStreamARN_
  = KinesisFirehoseDestination'{_kfdIAMRoleARN =
                                  pIAMRoleARN_,
