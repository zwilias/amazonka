...
data IdentityNotificationAttributes = IdentityNotificationAttributes'{_inaHeadersInDeliveryNotificationsEnabled
                                                                      ::
                                                                      !(Maybe
                                                                          Bool),
...
identityNotificationAttributes
    ...
    -> IdentityNotificationAttributes
identityNotificationAttributes pBounceTopic_
  pComplaintTopic_ pDeliveryTopic_ pForwardingEnabled_
  = IdentityNotificationAttributes'{_inaHeadersInDeliveryNotificationsEnabled
                                      = Nothing,
                                    _inaHeadersInComplaintNotificationsEnabled =
                                      Nothing,
                                    _inaHeadersInBounceNotificationsEnabled =
