...
ginaIdentities =
  lens _ginaIdentities (\s a -> s {_ginaIdentities = a}) . _Coerce
...
instance AWSRequest GetIdentityNotificationAttributes where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         GetIdentityNotificationAttributesResponse' <$> (pure (fromEnum s)) <*>
...
ginarsResponseStatus =
  lens _ginarsResponseStatus (\s a -> s {_ginarsResponseStatus = a})

-- | A map of Identity to IdentityNotificationAttributes.
ginarsNotificationAttributes ::
     Lens' GetIdentityNotificationAttributesResponse (HashMap Text IdentityNotificationAttributes)
ginarsNotificationAttributes =
  lens
