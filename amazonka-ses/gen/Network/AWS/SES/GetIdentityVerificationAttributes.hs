...
givaIdentities =
  lens _givaIdentities (\s a -> s {_givaIdentities = a}) . _Coerce
...
instance AWSRequest GetIdentityVerificationAttributes where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         GetIdentityVerificationAttributesResponse' <$> (pure (fromEnum s)) <*>
...
givarsResponseStatus =
  lens _givarsResponseStatus (\s a -> s {_givarsResponseStatus = a})

-- | A map of Identities to IdentityVerificationAttributes objects.
givarsVerificationAttributes ::
     Lens' GetIdentityVerificationAttributesResponse (HashMap Text IdentityVerificationAttributes)
givarsVerificationAttributes =
  lens
