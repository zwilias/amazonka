...
emShardLevelMetrics =
  lens _emShardLevelMetrics (\s a -> s {_emShardLevelMetrics = a}) .
  _Default . _Coerce
...
instance FromJSON EnhancedMetrics where
  parseJSON =
    withObject
      "EnhancedMetrics"
      (\x -> EnhancedMetrics' <$> (x .:? "ShardLevelMetrics" .!= mempty))
...
emoDesiredShardLevelMetrics =
  lens
    ...
    (\s a -> s {_emoDesiredShardLevelMetrics = a}) .
  _Default . _Coerce
...
emoCurrentShardLevelMetrics =
  lens
    ...
    (\s a -> s {_emoCurrentShardLevelMetrics = a}) .
  _Default . _Coerce
...
instance FromJSON HashKeyRange where
  parseJSON =
    withObject
      "HashKeyRange"
      (\x ->
         HashKeyRange' <$> (x .: "StartingHashKey") <*> (x .: "EndingHashKey"))
...
instance FromJSON PutRecordsResultEntry where
  parseJSON =
    withObject
      "PutRecordsResultEntry"
      (\x ->
         PutRecordsResultEntry' <$> (x .:? "SequenceNumber") <*>
         (x .:? "ErrorCode") <*>
         (x .:? "ErrorMessage") <*>
         (x .:? "ShardId"))
...
rApproximateArrivalTimestamp =
  lens
    _rApproximateArrivalTimestamp
    (\s a -> s {_rApproximateArrivalTimestamp = a}) .
  mapping _Time
...
instance FromJSON SequenceNumberRange where
  parseJSON =
    withObject
      "SequenceNumberRange"
      (\x ->
         SequenceNumberRange' <$> (x .:? "EndingSequenceNumber") <*>
...
instance FromJSON Shard where
  parseJSON =
    withObject
      "Shard"
      (\x ->
         Shard' <$> (x .:? "AdjacentParentShardId") <*> (x .:? "ParentShardId") <*>
         (x .: "ShardId") <*>
         (x .: "HashKeyRange") <*>
...
sdRetentionPeriodHours =
  lens _sdRetentionPeriodHours (\s a -> s {_sdRetentionPeriodHours = a}) . _Nat

-- | The approximate time that the stream was created.
sdStreamCreationTimestamp :: Lens' StreamDescription UTCTime
sdStreamCreationTimestamp =
  lens _sdStreamCreationTimestamp (\s a -> s {_sdStreamCreationTimestamp = a}) .
  _Time

-- | Represents the current enhanced monitoring settings of the stream.
sdEnhancedMonitoring :: Lens' StreamDescription [EnhancedMetrics]
sdEnhancedMonitoring =
  lens _sdEnhancedMonitoring (\s a -> s {_sdEnhancedMonitoring = a}) . _Coerce
...
instance FromJSON StreamDescription where
  parseJSON =
    withObject
      "StreamDescription"
      (\x ->
         StreamDescription' <$> (x .:? "EncryptionType") <*> (x .:? "KeyId") <*>
         (x .: "StreamName") <*>
         (x .: "StreamARN") <*>
         (x .: "StreamStatus") <*>
         (x .:? "Shards" .!= mempty) <*>
...
sdsRetentionPeriodHours =
  lens _sdsRetentionPeriodHours (\s a -> s {_sdsRetentionPeriodHours = a}) .
  _Nat

-- | The approximate time that the stream was created.
sdsStreamCreationTimestamp :: Lens' StreamDescriptionSummary UTCTime
sdsStreamCreationTimestamp =
  lens _sdsStreamCreationTimestamp (\s a -> s {_sdsStreamCreationTimestamp = a}) .
  _Time

-- | Represents the current enhanced monitoring settings of the stream.
sdsEnhancedMonitoring :: Lens' StreamDescriptionSummary [EnhancedMetrics]
sdsEnhancedMonitoring =
  lens _sdsEnhancedMonitoring (\s a -> s {_sdsEnhancedMonitoring = a}) . _Coerce

-- | The number of open shards in the stream.
sdsOpenShardCount :: Lens' StreamDescriptionSummary Natural
sdsOpenShardCount =
  lens _sdsOpenShardCount (\s a -> s {_sdsOpenShardCount = a}) . _Nat
...
instance FromJSON StreamDescriptionSummary where
  parseJSON =
    withObject
      "StreamDescriptionSummary"
      (\x ->
         StreamDescriptionSummary' <$> (x .:? "EncryptionType") <*>
         (x .:? "KeyId") <*>
         (x .: "StreamName") <*>
         (x .: "StreamARN") <*>
         (x .: "StreamStatus") <*>
