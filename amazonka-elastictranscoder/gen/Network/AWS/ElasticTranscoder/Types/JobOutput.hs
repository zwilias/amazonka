...
jobOutput
    :: JobOutput
jobOutput
  = JobOutput'{_joAppliedColorSpaceConversion =
                 Nothing,
               _joThumbnailPattern = Nothing, _joStatus = Nothing,
               _joHeight = Nothing, _joFrameRate = Nothing,
               _joCaptions = Nothing, _joPresetId = Nothing,
               _joComposition = Nothing, _joAlbumArt = Nothing,
               _joFileSize = Nothing, _joWatermarks = Nothing,
               _joWidth = Nothing, _joEncryption = Nothing,
               _joKey = Nothing, _joStatusDetail = Nothing,
               _joId = Nothing, _joSegmentDuration = Nothing,
               _joDurationMillis = Nothing,
               _joThumbnailEncryption = Nothing,
               _joDuration = Nothing, _joRotate = Nothing}
