...
preset
    :: Preset
preset
  = Preset'{_preARN = Nothing, _preVideo = Nothing,
            _preThumbnails = Nothing, _preName = Nothing,
            _preContainer = Nothing, _preId = Nothing,
            _preType = Nothing, _preDescription = Nothing,
            _preAudio = Nothing}
