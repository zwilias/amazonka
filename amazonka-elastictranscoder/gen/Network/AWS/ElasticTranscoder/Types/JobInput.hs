...
data JobInput = JobInput'{_jiFrameRate ::
                          !(Maybe Text),
...
jobInput
    :: JobInput
jobInput
  = JobInput'{_jiFrameRate = Nothing,
              _jiResolution = Nothing, _jiAspectRatio = Nothing,
              _jiTimeSpan = Nothing, _jiEncryption = Nothing,
              _jiKey = Nothing, _jiDetectedProperties = Nothing,
              _jiContainer = Nothing, _jiInterlaced = Nothing,
