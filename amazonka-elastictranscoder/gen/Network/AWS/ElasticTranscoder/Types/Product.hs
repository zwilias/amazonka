...
instance FromJSON Artwork where
  parseJSON =
    withObject
      "Artwork"
      (\x ->
         Artwork' <$> (x .:? "SizingPolicy") <*> (x .:? "AlbumArtFormat") <*>
         (x .:? "MaxHeight") <*>
         (x .:? "InputKey") <*>
         (x .:? "PaddingPolicy") <*>
         (x .:? "Encryption") <*>
...
instance FromJSON AudioCodecOptions where
  parseJSON =
    withObject
      "AudioCodecOptions"
      (\x ->
         AudioCodecOptions' <$> (x .:? "Signed") <*> (x .:? "BitDepth") <*>
         (x .:? "Profile") <*>
         (x .:? "BitOrder"))
...
instance FromJSON AudioParameters where
  parseJSON =
    withObject
      "AudioParameters"
      (\x ->
         AudioParameters' <$> (x .:? "Channels") <*> (x .:? "Codec") <*>
         (x .:? "AudioPackingMode") <*>
         (x .:? "SampleRate") <*>
         (x .:? "BitRate") <*>
         (x .:? "CodecOptions"))
...
instance FromJSON CaptionFormat where
  parseJSON =
    withObject
      "CaptionFormat"
      (\x ->
         CaptionFormat' <$> (x .:? "Pattern") <*> (x .:? "Format") <*>
         (x .:? "Encryption"))
...
instance FromJSON CaptionSource where
  parseJSON =
    withObject
      "CaptionSource"
      (\x ->
         CaptionSource' <$> (x .:? "TimeOffset") <*> (x .:? "Encryption") <*>
         (x .:? "Key") <*>
         (x .:? "Language") <*>
         (x .:? "Label"))
...
cCaptionSources =
  lens _cCaptionSources (\s a -> s {_cCaptionSources = a}) . _Default . _Coerce

-- | The array of file formats for the output captions. If you leave this value blank, Elastic Transcoder returns an error.
cCaptionFormats :: Lens' Captions [CaptionFormat]
cCaptionFormats =
  lens _cCaptionFormats (\s a -> s {_cCaptionFormats = a}) . _Default . _Coerce
...
instance ToJSON Clip where
  toJSON Clip' {..} = object (catMaybes [("TimeSpan" .=) <$> _cTimeSpan])
...
cjoComposition =
  lens _cjoComposition (\s a -> s {_cjoComposition = a}) . _Default . _Coerce
...
cjoWatermarks =
  lens _cjoWatermarks (\s a -> s {_cjoWatermarks = a}) . _Default . _Coerce
...
cjpOutputKeys =
  lens _cjpOutputKeys (\s a -> s {_cjpOutputKeys = a}) . _Default . _Coerce
...
instance FromJSON DetectedProperties where
  parseJSON =
    withObject
      "DetectedProperties"
      (\x ->
         DetectedProperties' <$> (x .:? "Height") <*> (x .:? "FrameRate") <*>
         (x .:? "FileSize") <*>
         (x .:? "Width") <*>
         (x .:? "DurationMillis"))
...
instance FromJSON Encryption where
  parseJSON =
    withObject
      "Encryption"
      (\x ->
         Encryption' <$> (x .:? "Mode") <*> (x .:? "KeyMd5") <*> (x .:? "Key") <*>
...
hcpLicenseAcquisitionURL =
  lens _hcpLicenseAcquisitionURL (\s a -> s {_hcpLicenseAcquisitionURL = a})
...
icCaptionSources =
  lens _icCaptionSources (\s a -> s {_icCaptionSources = a}) .
  _Default . _Coerce
...
instance FromJSON Job' where
  parseJSON =
    withObject
      "Job'"
      (\x ->
         Job'' <$> (x .:? "Status") <*> (x .:? "PipelineId") <*> (x .:? "Arn") <*>
         (x .:? "Inputs" .!= mempty) <*>
         (x .:? "Input") <*>
...
instance FromJSON JobAlbumArt where
  parseJSON =
    withObject
      "JobAlbumArt"
      (\x ->
         JobAlbumArt' <$> (x .:? "MergePolicy") <*> (x .:? "Artwork" .!= mempty))
...
instance FromJSON JobInput where
  parseJSON =
    withObject
      "JobInput"
      (\x ->
         JobInput' <$> (x .:? "FrameRate") <*> (x .:? "Resolution") <*>
         (x .:? "AspectRatio") <*>
         (x .:? "TimeSpan") <*>
         (x .:? "Encryption") <*>
         (x .:? "Key") <*>
...
joComposition =
  lens _joComposition (\s a -> s {_joComposition = a}) . _Default . _Coerce
...
joWatermarks =
  lens _joWatermarks (\s a -> s {_joWatermarks = a}) . _Default . _Coerce
...
instance FromJSON JobOutput where
  parseJSON =
    withObject
      "JobOutput"
      (\x ->
         JobOutput' <$> (x .:? "AppliedColorSpaceConversion") <*>
         (x .:? "ThumbnailPattern") <*>
         (x .:? "Status") <*>
         (x .:? "Height") <*>
         (x .:? "FrameRate") <*>
...
instance FromJSON JobWatermark where
  parseJSON =
    withObject
      "JobWatermark"
      (\x ->
         JobWatermark' <$> (x .:? "PresetWatermarkId") <*> (x .:? "InputKey") <*>
         (x .:? "Encryption"))
...
instance FromJSON Notifications where
  parseJSON =
    withObject
      "Notifications"
      (\x ->
         Notifications' <$> (x .:? "Error") <*> (x .:? "Warning") <*>
         (x .:? "Progressing") <*>
         (x .:? "Completed"))
...
instance FromJSON Permission where
  parseJSON =
    withObject
      "Permission"
      (\x ->
         Permission' <$> (x .:? "Access" .!= mempty) <*> (x .:? "GranteeType") <*>
         (x .:? "Grantee"))
...
pipThumbnailConfig =
  lens _pipThumbnailConfig (\s a -> s {_pipThumbnailConfig = a})
...
pocPermissions =
  lens _pocPermissions (\s a -> s {_pocPermissions = a}) . _Default . _Coerce
...
instance FromJSON PipelineOutputConfig where
  parseJSON =
    withObject
      "PipelineOutputConfig"
      (\x ->
         PipelineOutputConfig' <$> (x .:? "Bucket") <*> (x .:? "StorageClass") <*>
...
prdLicenseAcquisitionURL =
  lens _prdLicenseAcquisitionURL (\s a -> s {_prdLicenseAcquisitionURL = a})
...
pOutputKeys =
  lens _pOutputKeys (\s a -> s {_pOutputKeys = a}) . _Default . _Coerce
...
pHlsContentProtection =
  lens _pHlsContentProtection (\s a -> s {_pHlsContentProtection = a})
...
instance FromJSON Playlist where
  parseJSON =
    withObject
      "Playlist"
      (\x ->
         Playlist' <$> (x .:? "Status") <*> (x .:? "PlayReadyDrm") <*>
         (x .:? "Format") <*>
         (x .:? "OutputKeys" .!= mempty) <*>
         (x .:? "Name") <*>
         (x .:? "StatusDetail") <*>
...
instance FromJSON Preset where
  parseJSON =
    withObject
      "Preset"
      (\x ->
         Preset' <$> (x .:? "Arn") <*> (x .:? "Video") <*> (x .:? "Thumbnails") <*>
         (x .:? "Name") <*>
         (x .:? "Container") <*>
         (x .:? "Id") <*>
         (x .:? "Type") <*>
...
instance FromJSON PresetWatermark where
  parseJSON =
    withObject
      "PresetWatermark"
      (\x ->
         PresetWatermark' <$> (x .:? "VerticalAlign") <*> (x .:? "SizingPolicy") <*>
         (x .:? "HorizontalOffset") <*>
         (x .:? "MaxHeight") <*>
         (x .:? "Opacity") <*>
         (x .:? "VerticalOffset") <*>
...
instance FromJSON Thumbnails where
  parseJSON =
    withObject
      "Thumbnails"
      (\x ->
         Thumbnails' <$> (x .:? "SizingPolicy") <*> (x .:? "Format") <*>
         (x .:? "MaxHeight") <*>
         (x .:? "Resolution") <*>
         (x .:? "AspectRatio") <*>
         (x .:? "PaddingPolicy") <*>
...
instance ToJSON TimeSpan where
  toJSON TimeSpan' {..} =
    object
      (catMaybes
         [("StartTime" .=) <$> _tsStartTime, ("Duration" .=) <$> _tsDuration])
...
instance FromJSON Timing where
  parseJSON =
    withObject
      "Timing"
      (\x ->
         Timing' <$> (x .:? "SubmitTimeMillis") <*> (x .:? "FinishTimeMillis") <*>
         (x .:? "StartTimeMillis"))
...
vpWatermarks =
  lens _vpWatermarks (\s a -> s {_vpWatermarks = a}) . _Default . _Coerce
...
vpCodecOptions =
  lens _vpCodecOptions (\s a -> s {_vpCodecOptions = a}) . _Default . _Map
...
instance FromJSON VideoParameters where
  parseJSON =
    withObject
      "VideoParameters"
      (\x ->
         VideoParameters' <$> (x .:? "KeyframesMaxDist") <*> (x .:? "FrameRate") <*>
         (x .:? "SizingPolicy") <*>
         (x .:? "MaxFrameRate") <*>
         (x .:? "MaxHeight") <*>
         (x .:? "Watermarks" .!= mempty) <*>
