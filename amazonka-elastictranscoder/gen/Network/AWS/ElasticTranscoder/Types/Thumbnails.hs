...
data Thumbnails = Thumbnails'{_tSizingPolicy ::
                              !(Maybe Text),
                              _tFormat :: !(Maybe Text),
...
thumbnails
    :: Thumbnails
thumbnails
  = Thumbnails'{_tSizingPolicy = Nothing,
                _tFormat = Nothing, _tMaxHeight = Nothing,
                _tResolution = Nothing, _tAspectRatio = Nothing,
                _tPaddingPolicy = Nothing, _tInterval = Nothing,
                _tMaxWidth = Nothing}
