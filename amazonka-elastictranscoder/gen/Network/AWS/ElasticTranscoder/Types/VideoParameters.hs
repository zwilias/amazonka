...
data VideoParameters = VideoParameters'{_vpKeyframesMaxDist
                                        :: !(Maybe Text),
...
videoParameters
    :: VideoParameters
videoParameters
  = VideoParameters'{_vpKeyframesMaxDist = Nothing,
                     _vpFrameRate = Nothing, _vpSizingPolicy = Nothing,
                     _vpMaxFrameRate = Nothing, _vpMaxHeight = Nothing,
                     _vpWatermarks = Nothing,
                     _vpDisplayAspectRatio = Nothing,
                     _vpResolution = Nothing, _vpCodec = Nothing,
                     _vpAspectRatio = Nothing, _vpPaddingPolicy = Nothing,
                     _vpMaxWidth = Nothing, _vpBitRate = Nothing,
                     _vpFixedGOP = Nothing, _vpCodecOptions = Nothing}
