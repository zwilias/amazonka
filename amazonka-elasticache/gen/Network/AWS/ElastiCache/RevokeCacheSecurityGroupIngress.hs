...
rcsgiEC2SecurityGroupName =
  lens _rcsgiEC2SecurityGroupName (\s a -> s {_rcsgiEC2SecurityGroupName = a})
...
-- | Undocumented member.
rcsgirsCacheSecurityGroup ::
     Lens' RevokeCacheSecurityGroupIngressResponse (Maybe CacheSecurityGroup)
rcsgirsCacheSecurityGroup =
  lens _rcsgirsCacheSecurityGroup (\s a -> s {_rcsgirsCacheSecurityGroup = a})

-- | -- | The response status code.
rcsgirsResponseStatus :: Lens' RevokeCacheSecurityGroupIngressResponse Int
rcsgirsResponseStatus =
  lens _rcsgirsResponseStatus (\s a -> s {_rcsgirsResponseStatus = a})
