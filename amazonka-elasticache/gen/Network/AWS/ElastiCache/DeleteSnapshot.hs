...
newtype DeleteSnapshot = DeleteSnapshot'{_dSnapshotName
                                         :: Text}
...
data DeleteSnapshotResponse = DeleteSnapshotResponse'{_dsrsSnapshot
                                                      :: !(Maybe Snapshot),
                                                      _dsrsResponseStatus ::
                                                      !Int}
...
deleteSnapshotResponse pResponseStatus_
  = DeleteSnapshotResponse'{_dsrsSnapshot = Nothing,
