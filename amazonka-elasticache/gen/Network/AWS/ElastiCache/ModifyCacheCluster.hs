...
mccAutoMinorVersionUpgrade =
  lens _mccAutoMinorVersionUpgrade (\s a -> s {_mccAutoMinorVersionUpgrade = a})
...
mccCacheParameterGroupName =
  lens _mccCacheParameterGroupName (\s a -> s {_mccCacheParameterGroupName = a})
...
mccSnapshotRetentionLimit =
  lens _mccSnapshotRetentionLimit (\s a -> s {_mccSnapshotRetentionLimit = a})
...
mccNotificationTopicStatus =
  lens _mccNotificationTopicStatus (\s a -> s {_mccNotificationTopicStatus = a})
...
mccCacheSecurityGroupNames =
  lens _mccCacheSecurityGroupNames (\s a -> s {_mccCacheSecurityGroupNames = a}) .
  _Default . _Coerce
  ...
  toQuery ModifyCacheCluster' {..} =
    mconcat
      ...
      , "NewAvailabilityZones" =:
        toQuery
          (toQueryList "PreferredAvailabilityZone" <$> _mccNewAvailabilityZones)
      ...
      , "CacheSecurityGroupNames" =:
        toQuery
          (toQueryList "CacheSecurityGroupName" <$> _mccCacheSecurityGroupNames)
