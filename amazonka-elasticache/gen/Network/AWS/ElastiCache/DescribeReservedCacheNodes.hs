...
drcnReservedCacheNodesOfferingId ::
     Lens' DescribeReservedCacheNodes (Maybe Text)
drcnReservedCacheNodesOfferingId =
  lens
...
instance AWSRequest DescribeReservedCacheNodes where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DescribeReservedCacheNodesResponse' <$> (x .@? "Marker") <*>
...
drcnrsReservedCacheNodes ::
     Lens' DescribeReservedCacheNodesResponse [ReservedCacheNode]
drcnrsReservedCacheNodes =
  lens _drcnrsReservedCacheNodes (\s a -> s {_drcnrsReservedCacheNodes = a}) .
  _Default . _Coerce

-- | -- | The response status code.
drcnrsResponseStatus :: Lens' DescribeReservedCacheNodesResponse Int
drcnrsResponseStatus =
  lens _drcnrsResponseStatus (\s a -> s {_drcnrsResponseStatus = a})
