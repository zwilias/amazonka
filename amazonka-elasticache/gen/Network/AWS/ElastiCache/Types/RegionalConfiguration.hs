...
data RegionalConfiguration = RegionalConfiguration'{_rcReplicationGroupId
                                                    :: !Text,
...
regionalConfiguration
    :: Text -- ^ 'rcReplicationGroupId'
    -> Text -- ^ 'rcReplicationGroupRegion'
    -> RegionalConfiguration
regionalConfiguration pReplicationGroupId_
  pReplicationGroupRegion_
  = RegionalConfiguration'{_rcReplicationGroupId =
...
instance Hashable RegionalConfiguration where

instance NFData RegionalConfiguration where
