...
data UpdateActionResultsMessage = UpdateActionResultsMessage'{_uarmUnprocessedUpdateActions
                                                              ::
                                                              !(Maybe
...
updateActionResultsMessage
    :: UpdateActionResultsMessage
updateActionResultsMessage
  = UpdateActionResultsMessage'{_uarmUnprocessedUpdateActions
                                  = Nothing,
...
instance Hashable UpdateActionResultsMessage where

instance NFData UpdateActionResultsMessage where
