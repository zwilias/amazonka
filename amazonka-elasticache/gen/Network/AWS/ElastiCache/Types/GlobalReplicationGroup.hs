...
--
--
--     * The __GlobalReplicationGroupId__ represents the name of the Global Datastore, which is what you use to associate a secondary cluster.
--
--
--
--
...
--
-- * 'grgEngineVersion' - The Elasticache Redis engine version. For preview, it is Redis version 5.0.5 only.
--
...
--
-- * 'grgEngine' - The Elasticache engine. For preview, it is Redis only.
--
