...
data NodeGroupMemberUpdateStatus = NodeGroupMemberUpdateStatus'{_ngmusNodeUpdateEndDate
                                                                ::
                                                                !(Maybe
                                                                    ISO8601),
...
nodeGroupMemberUpdateStatus
    :: NodeGroupMemberUpdateStatus
nodeGroupMemberUpdateStatus
  = NodeGroupMemberUpdateStatus'{_ngmusNodeUpdateEndDate
                                   = Nothing,
...
instance Hashable NodeGroupMemberUpdateStatus where

instance NFData NodeGroupMemberUpdateStatus where
