...
data UpdateAction = UpdateAction'{_uaServiceUpdateType
...
updateAction
    :: UpdateAction
updateAction
  = UpdateAction'{_uaServiceUpdateType = Nothing,
                  _uaSlaMet = Nothing, _uaCacheClusterId = Nothing,
                  _uaServiceUpdateName = Nothing,
                  _uaUpdateActionStatus = Nothing, _uaEngine = Nothing,
...
instance Hashable UpdateAction where

instance NFData UpdateAction where
