...
data GlobalNodeGroup = GlobalNodeGroup'{_gngSlots ::
                                        !(Maybe Text),
...
globalNodeGroup
    :: GlobalNodeGroup
globalNodeGroup
  = GlobalNodeGroup'{_gngSlots = Nothing,
...
instance Hashable GlobalNodeGroup where

instance NFData GlobalNodeGroup where
