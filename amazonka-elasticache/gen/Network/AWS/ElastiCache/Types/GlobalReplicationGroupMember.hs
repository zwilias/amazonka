...
data GlobalReplicationGroupMember = GlobalReplicationGroupMember'{_grgmStatus
                                                                  ::
                                                                  !(Maybe Text),
...
globalReplicationGroupMember
    :: GlobalReplicationGroupMember
globalReplicationGroupMember
  = GlobalReplicationGroupMember'{_grgmStatus =
                                    Nothing,
...
instance FromXML GlobalReplicationGroupMember where
        parseXML x
          = GlobalReplicationGroupMember' <$>
              (x .@? "Status") <*> (x .@? "ReplicationGroupRegion")
                <*> (x .@? "Role")
                <*> (x .@? "ReplicationGroupId")
                <*> (x .@? "AutomaticFailover")

instance Hashable GlobalReplicationGroupMember where

instance NFData GlobalReplicationGroupMember where
