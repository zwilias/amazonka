...
data UnprocessedUpdateAction = UnprocessedUpdateAction'{_uuaCacheClusterId
                                                        :: !(Maybe Text),
...
unprocessedUpdateAction
    :: UnprocessedUpdateAction
unprocessedUpdateAction
  = UnprocessedUpdateAction'{_uuaCacheClusterId =
                               Nothing,
...
instance Hashable UnprocessedUpdateAction where

instance NFData UnprocessedUpdateAction where
