...
data ServiceUpdate = ServiceUpdate'{_suEngineVersion
                                    :: !(Maybe Text),
...
serviceUpdate
    :: ServiceUpdate
serviceUpdate
  = ServiceUpdate'{_suEngineVersion = Nothing,
                   _suServiceUpdateType = Nothing,
                   _suServiceUpdateName = Nothing, _suEngine = Nothing,
...
instance Hashable ServiceUpdate where

instance NFData ServiceUpdate where
