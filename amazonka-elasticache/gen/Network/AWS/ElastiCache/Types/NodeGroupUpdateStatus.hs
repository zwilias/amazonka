...
data NodeGroupUpdateStatus = NodeGroupUpdateStatus'{_ngusNodeGroupMemberUpdateStatus
                                                    ::
                                                    !(Maybe
...
nodeGroupUpdateStatus
    :: NodeGroupUpdateStatus
nodeGroupUpdateStatus
  = NodeGroupUpdateStatus'{_ngusNodeGroupMemberUpdateStatus
                             = Nothing,
...
instance Hashable NodeGroupUpdateStatus where

instance NFData NodeGroupUpdateStatus where
