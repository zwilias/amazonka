...
data GlobalReplicationGroupInfo = GlobalReplicationGroupInfo'{_grgiGlobalReplicationGroupMemberRole
                                                              :: !(Maybe Text),
...
globalReplicationGroupInfo
    :: GlobalReplicationGroupInfo
globalReplicationGroupInfo
  = GlobalReplicationGroupInfo'{_grgiGlobalReplicationGroupMemberRole
                                  = Nothing,
...
instance Hashable GlobalReplicationGroupInfo where

instance NFData GlobalReplicationGroupInfo where
