...
data TimeRangeFilter = TimeRangeFilter'{_trfStartTime
                                        :: !(Maybe ISO8601),
...
timeRangeFilter
    :: TimeRangeFilter
timeRangeFilter
  = TimeRangeFilter'{_trfStartTime = Nothing,
                     _trfEndTime = Nothing}
...
instance Hashable TimeRangeFilter where

instance NFData TimeRangeFilter where
