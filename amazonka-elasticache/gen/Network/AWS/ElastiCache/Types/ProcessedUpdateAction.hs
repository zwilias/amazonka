...
data ProcessedUpdateAction = ProcessedUpdateAction'{_puaCacheClusterId
                                                    :: !(Maybe Text),
...
processedUpdateAction
    :: ProcessedUpdateAction
processedUpdateAction
  = ProcessedUpdateAction'{_puaCacheClusterId =
                             Nothing,
...
instance Hashable ProcessedUpdateAction where

instance NFData ProcessedUpdateAction where
