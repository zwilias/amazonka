...
data CustomerNodeEndpoint = CustomerNodeEndpoint'{_cneAddress
                                                  :: !(Maybe Text),
                                                  _cnePort :: !(Maybe Int)}
...
customerNodeEndpoint
    :: CustomerNodeEndpoint
customerNodeEndpoint
  = CustomerNodeEndpoint'{_cneAddress = Nothing,
                          _cnePort = Nothing}
...
instance Hashable CustomerNodeEndpoint where

instance NFData CustomerNodeEndpoint where
