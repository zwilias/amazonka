...
data CacheNodeUpdateStatus = CacheNodeUpdateStatus'{_cnusNodeUpdateEndDate
                                                    :: !(Maybe ISO8601),
...
cacheNodeUpdateStatus
    :: CacheNodeUpdateStatus
cacheNodeUpdateStatus
  = CacheNodeUpdateStatus'{_cnusNodeUpdateEndDate =
                             Nothing,
...
instance Hashable CacheNodeUpdateStatus where

instance NFData CacheNodeUpdateStatus where
