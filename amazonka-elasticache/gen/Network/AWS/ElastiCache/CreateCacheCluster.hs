...
cccSnapshotARNs =
  lens _cccSnapshotARNs (\s a -> s {_cccSnapshotARNs = a}) . _Default . _Coerce

-- | This parameter is currently disabled.
cccAutoMinorVersionUpgrade :: Lens' CreateCacheCluster (Maybe Bool)
cccAutoMinorVersionUpgrade =
  lens _cccAutoMinorVersionUpgrade (\s a -> s {_cccAutoMinorVersionUpgrade = a})

-- | The name of the parameter group to associate with this cluster. If this argument is omitted, the default parameter group for the specified engine is used. You cannot use any parameter group which has @cluster-enabled='yes'@ when creating a cluster.
cccCacheParameterGroupName :: Lens' CreateCacheCluster (Maybe Text)
cccCacheParameterGroupName =
  lens _cccCacheParameterGroupName (\s a -> s {_cccCacheParameterGroupName = a})
...
cccSnapshotRetentionLimit =
  lens _cccSnapshotRetentionLimit (\s a -> s {_cccSnapshotRetentionLimit = a})
...
cccCacheSecurityGroupNames =
  lens _cccCacheSecurityGroupNames (\s a -> s {_cccCacheSecurityGroupNames = a}) .
  _Default . _Coerce
  ...
  toQuery CreateCacheCluster' {..} =
    mconcat
      ...
      , "CacheSecurityGroupNames" =:
        toQuery
          (toQueryList "CacheSecurityGroupName" <$> _cccCacheSecurityGroupNames)
...
cccrsResponseStatus =
  lens _cccrsResponseStatus (\s a -> s {_cccrsResponseStatus = a})
