...
data ProjectDetails = ProjectDetails'{_pdState ::
                                      !(Maybe ProjectState),
...
projectDetails
    :: ProjectDetails
projectDetails
  = ProjectDetails'{_pdState = Nothing,
                    _pdResources = Nothing, _pdCreatedDate = Nothing,
                    _pdConsoleURL = Nothing, _pdName = Nothing,
                    _pdRegion = Nothing, _pdProjectId = Nothing,
