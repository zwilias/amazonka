...
data Resource = Resource'{_rFeature :: !(Maybe Text),
                          _rArn :: !(Maybe Text), _rName :: !(Maybe Text),
...
resource
    :: Resource
resource
  = Resource'{_rFeature = Nothing, _rArn = Nothing,
              _rName = Nothing, _rAttributes = Nothing,
              _rType = Nothing}
