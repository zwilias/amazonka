...
data BundleDetails = BundleDetails'{_bdAvailablePlatforms
                                    :: !(Maybe [Platform]),
...
bundleDetails
    :: BundleDetails
bundleDetails
  = BundleDetails'{_bdAvailablePlatforms = Nothing,
                   _bdBundleId = Nothing, _bdVersion = Nothing,
                   _bdIconURL = Nothing, _bdTitle = Nothing,
