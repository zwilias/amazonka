...
bdAvailablePlatforms =
  lens _bdAvailablePlatforms (\s a -> s {_bdAvailablePlatforms = a}) .
  _Default . _Coerce
...
instance FromJSON BundleDetails where
  parseJSON =
    withObject
      "BundleDetails"
      (\x ->
         BundleDetails' <$> (x .:? "availablePlatforms" .!= mempty) <*>
         (x .:? "bundleId") <*>
         (x .:? "version") <*>
         (x .:? "iconUrl") <*>
         (x .:? "title") <*>
...
pdResources =
  lens _pdResources (\s a -> s {_pdResources = a}) . _Default . _Coerce

-- | Date the project was created.
pdCreatedDate :: Lens' ProjectDetails (Maybe UTCTime)
pdCreatedDate =
  lens _pdCreatedDate (\s a -> s {_pdCreatedDate = a}) . mapping _Time
...
pdLastUpdatedDate =
  lens _pdLastUpdatedDate (\s a -> s {_pdLastUpdatedDate = a}) . mapping _Time
...
instance FromJSON ProjectDetails where
  parseJSON =
    withObject
      "ProjectDetails"
      (\x ->
         ProjectDetails' <$> (x .:? "state") <*> (x .:? "resources" .!= mempty) <*>
         (x .:? "createdDate") <*>
         (x .:? "consoleUrl") <*>
         (x .:? "name") <*>
         (x .:? "region") <*>
...
instance FromJSON Resource where
  parseJSON =
    withObject
      "Resource"
      (\x ->
         Resource' <$> (x .:? "feature") <*> (x .:? "arn") <*> (x .:? "name") <*>
         (x .:? "attributes" .!= mempty) <*>
         (x .:? "type"))
