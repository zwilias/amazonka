...
rrtAutomaticallyAfterDays =
  lens _rrtAutomaticallyAfterDays (\s a -> s {_rrtAutomaticallyAfterDays = a}) .
  mapping _Nat
...
instance ToJSON RotationRulesType where
  toJSON RotationRulesType' {..} =
    object
      (catMaybes [("AutomaticallyAfterDays" .=) <$> _rrtAutomaticallyAfterDays])
...
sleLastChangedDate =
  lens _sleLastChangedDate (\s a -> s {_sleLastChangedDate = a}) . mapping _Time
...
sleSecretVersionsToStages ::
     Lens' SecretListEntry (HashMap Text (NonEmpty Text))
sleSecretVersionsToStages =
  lens _sleSecretVersionsToStages (\s a -> s {_sleSecretVersionsToStages = a}) .
  _Default . _Map
...
sleDeletedDate =
  lens _sleDeletedDate (\s a -> s {_sleDeletedDate = a}) . mapping _Time
...
sleRotationEnabled =
  lens _sleRotationEnabled (\s a -> s {_sleRotationEnabled = a})
...
sleLastRotatedDate =
  lens _sleLastRotatedDate (\s a -> s {_sleLastRotatedDate = a}) . mapping _Time

-- | The last date that this secret was accessed. This value is truncated to midnight of the date and therefore shows only the date, not the time.
sleLastAccessedDate :: Lens' SecretListEntry (Maybe UTCTime)
sleLastAccessedDate =
  lens _sleLastAccessedDate (\s a -> s {_sleLastAccessedDate = a}) .
  mapping _Time
...
sleRotationLambdaARN =
  lens _sleRotationLambdaARN (\s a -> s {_sleRotationLambdaARN = a})
...
instance FromJSON SecretListEntry where
  parseJSON =
    withObject
      "SecretListEntry"
      (\x ->
         SecretListEntry' <$> (x .:? "LastChangedDate") <*> (x .:? "ARN") <*>
...
svleVersionStages =
  lens _svleVersionStages (\s a -> s {_svleVersionStages = a}) . mapping _List1

-- | The date and time this version of the secret was created.
svleCreatedDate :: Lens' SecretVersionsListEntry (Maybe UTCTime)
svleCreatedDate =
  lens _svleCreatedDate (\s a -> s {_svleCreatedDate = a}) . mapping _Time

-- | The date that this version of the secret was last accessed. Note that the resolution of this field is at the date level and does not include the time.
svleLastAccessedDate :: Lens' SecretVersionsListEntry (Maybe UTCTime)
svleLastAccessedDate =
  lens _svleLastAccessedDate (\s a -> s {_svleLastAccessedDate = a}) .
  mapping _Time
...
instance FromJSON SecretVersionsListEntry where
  parseJSON =
    withObject
      "SecretVersionsListEntry"
      (\x ->
         SecretVersionsListEntry' <$> (x .:? "VersionId") <*>
         (x .:? "VersionStages") <*>
         (x .:? "CreatedDate") <*>
         (x .:? "LastAccessedDate"))
