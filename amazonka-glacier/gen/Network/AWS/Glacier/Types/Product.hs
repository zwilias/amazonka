...
instance FromJSON ArchiveCreationOutput where
  parseJSON =
    withObject
      "ArchiveCreationOutput"
      (\x ->
         ArchiveCreationOutput' <$> (x .:? "x-amz-archive-id") <*>
...
instance FromJSON CSVInput where
  parseJSON =
    withObject
      "CSVInput"
      (\x ->
         CSVInput' <$> (x .:? "QuoteCharacter") <*> (x .:? "RecordDelimiter") <*>
         (x .:? "FileHeaderInfo") <*>
...
instance FromJSON CSVOutput where
  parseJSON =
    withObject
      "CSVOutput"
      (\x ->
         CSVOutput' <$> (x .:? "QuoteCharacter") <*> (x .:? "QuoteFields") <*>
         (x .:? "RecordDelimiter") <*>
         (x .:? "QuoteEscapeCharacter") <*>
         (x .:? "FieldDelimiter"))
...
instance FromJSON DataRetrievalRule where
  parseJSON =
    withObject
      "DataRetrievalRule"
      (\x ->
         DataRetrievalRule' <$> (x .:? "Strategy") <*> (x .:? "BytesPerHour"))
...
instance FromJSON DescribeVaultOutput where
  parseJSON =
    withObject
      "DescribeVaultOutput"
      (\x ->
         DescribeVaultOutput' <$> (x .:? "VaultName") <*> (x .:? "SizeInBytes") <*>
         (x .:? "LastInventoryDate") <*>
         (x .:? "VaultARN") <*>
         (x .:? "CreationDate") <*>
         (x .:? "NumberOfArchives"))
...
instance FromJSON Encryption where
  parseJSON =
    withObject
      "Encryption"
      (\x ->
         Encryption' <$> (x .:? "EncryptionType") <*> (x .:? "KMSKeyId") <*>
         (x .:? "KMSContext"))
...
gjdSelectParameters =
  lens _gjdSelectParameters (\s a -> s {_gjdSelectParameters = a})
...
gjdInventoryRetrievalParameters ::
     Lens' GlacierJobDescription (Maybe InventoryRetrievalJobDescription)
gjdInventoryRetrievalParameters =
  lens
...
gjdArchiveSHA256TreeHash =
  lens _gjdArchiveSHA256TreeHash (\s a -> s {_gjdArchiveSHA256TreeHash = a})
...
instance FromJSON GlacierJobDescription where
  parseJSON =
    withObject
      "GlacierJobDescription"
      (\x ->
         GlacierJobDescription' <$> (x .:? "SHA256TreeHash") <*>
         (x .:? "ArchiveId") <*>
         (x .:? "SelectParameters") <*>
         (x .:? "JobId") <*>
         (x .:? "JobOutputPath") <*>
...
instance ToJSON InputSerialization where
  toJSON InputSerialization' {..} = object (catMaybes [("csv" .=) <$> _isCsv])
...
instance FromJSON InventoryRetrievalJobDescription where
  parseJSON =
    withObject
      "InventoryRetrievalJobDescription"
      (\x ->
         InventoryRetrievalJobDescription' <$> (x .:? "Format") <*>
         (x .:? "EndDate") <*>
         (x .:? "StartDate") <*>
         (x .:? "Marker") <*>
         (x .:? "Limit"))
...
jpSelectParameters =
  lens _jpSelectParameters (\s a -> s {_jpSelectParameters = a})
...
jpInventoryRetrievalParameters ::
     Lens' JobParameters (Maybe InventoryRetrievalJobInput)
jpInventoryRetrievalParameters =
  lens
...
instance FromJSON OutputLocation where
  parseJSON =
    withObject "OutputLocation" (\x -> OutputLocation' <$> (x .:? "S3"))
...
instance ToJSON OutputLocation where
  toJSON OutputLocation' {..} = object (catMaybes [("S3" .=) <$> _olS3])
...
instance ToJSON OutputSerialization where
  toJSON OutputSerialization' {..} = object (catMaybes [("csv" .=) <$> _osCsv])
...
instance FromJSON PartListElement where
  parseJSON =
    withObject
      "PartListElement"
      (\x ->
         PartListElement' <$> (x .:? "SHA256TreeHash") <*>
         (x .:? "RangeInBytes"))
...
instance FromJSON ProvisionedCapacityDescription where
  parseJSON =
    withObject
      "ProvisionedCapacityDescription"
      (\x ->
         ProvisionedCapacityDescription' <$> (x .:? "CapacityId") <*>
         (x .:? "StartDate") <*>
         (x .:? "ExpirationDate"))
...
slUserMetadata =
  lens _slUserMetadata (\s a -> s {_slUserMetadata = a}) . _Default . _Map
...
instance FromJSON S3Location where
  parseJSON =
    withObject
      "S3Location"
      (\x ->
         S3Location' <$> (x .:? "CannedACL") <*> (x .:? "Prefix") <*>
         (x .:? "BucketName") <*>
...
instance FromJSON SelectParameters where
  parseJSON =
    withObject
      "SelectParameters"
      (\x ->
         SelectParameters' <$> (x .:? "ExpressionType") <*>
...
instance FromJSON UploadListElement where
  parseJSON =
    withObject
      "UploadListElement"
      (\x ->
         UploadListElement' <$> (x .:? "MultipartUploadId") <*>
         (x .:? "PartSizeInBytes") <*>
...
instance FromJSON VaultNotificationConfig where
  parseJSON =
    withObject
      "VaultNotificationConfig"
      (\x ->
         VaultNotificationConfig' <$> (x .:? "SNSTopic") <*>
         (x .:? "Events" .!= mempty))
