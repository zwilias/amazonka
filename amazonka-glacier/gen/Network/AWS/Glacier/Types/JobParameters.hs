...
data JobParameters = JobParameters'{_jpArchiveId ::
                                    !(Maybe Text),
                                    _jpSelectParameters ::
...
jobParameters
    :: JobParameters
jobParameters
  = JobParameters'{_jpArchiveId = Nothing,
                   _jpSelectParameters = Nothing, _jpFormat = Nothing,
                   _jpRetrievalByteRange = Nothing,
                   _jpInventoryRetrievalParameters = Nothing,
                   _jpSNSTopic = Nothing, _jpOutputLocation = Nothing,
                   _jpTier = Nothing, _jpType = Nothing,
