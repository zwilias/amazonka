...
data GlacierJobDescription = GlacierJobDescription'{_gjdSHA256TreeHash
                                                    :: !(Maybe Text),
                                                    _gjdArchiveId ::
                                                    !(Maybe Text),
...
glacierJobDescription
    :: GlacierJobDescription
glacierJobDescription
  = GlacierJobDescription'{_gjdSHA256TreeHash =
                             Nothing,
                           _gjdArchiveId = Nothing,
                           _gjdSelectParameters = Nothing, _gjdJobId = Nothing,
                           _gjdJobOutputPath = Nothing,
                           _gjdRetrievalByteRange = Nothing,
                           _gjdInventoryRetrievalParameters = Nothing,
                           _gjdAction = Nothing, _gjdJobDescription = Nothing,
                           _gjdSNSTopic = Nothing, _gjdStatusMessage = Nothing,
                           _gjdVaultARN = Nothing, _gjdOutputLocation = Nothing,
                           _gjdTier = Nothing,
                           _gjdArchiveSHA256TreeHash = Nothing,
                           _gjdCreationDate = Nothing, _gjdCompleted = Nothing,
