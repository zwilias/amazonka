...
instance FromText ActionCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ActionCode from value: '" <>
        e <> "'. Accepted values: archiveretrieval, inventoryretrieval, select"
...
instance FromText CannedACL where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CannedACL from value: '" <>
        e <>
...
instance FromText EncryptionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EncryptionType from value: '" <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: reduced_redundancy, standard, standard_ia"
