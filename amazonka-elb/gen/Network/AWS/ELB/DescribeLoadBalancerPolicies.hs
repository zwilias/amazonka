...
dlbpPolicyNames =
  lens _dlbpPolicyNames (\s a -> s {_dlbpPolicyNames = a}) . _Default . _Coerce
...
instance AWSRequest DescribeLoadBalancerPolicies where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DescribeLoadBalancerPoliciesResponse' <$>
         (x .@? "PolicyDescriptions" .!@ mempty >>= may (parseXMLList "member")) <*>
         (pure (fromEnum s)))
...
instance ToQuery DescribeLoadBalancerPolicies where
  toQuery DescribeLoadBalancerPolicies' {..} =
    mconcat
      ...
      , "PolicyNames" =: toQuery (toQueryList "member" <$> _dlbpPolicyNames)
...
dlbprsPolicyDescriptions ::
     Lens' DescribeLoadBalancerPoliciesResponse [PolicyDescription]
dlbprsPolicyDescriptions =
  lens _dlbprsPolicyDescriptions (\s a -> s {_dlbprsPolicyDescriptions = a}) .
  _Default . _Coerce
