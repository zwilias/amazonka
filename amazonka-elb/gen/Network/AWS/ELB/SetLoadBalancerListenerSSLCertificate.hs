...
slblscLoadBalancerName =
  lens _slblscLoadBalancerName (\s a -> s {_slblscLoadBalancerName = a})

-- | The port that uses the specified SSL certificate.
slblscLoadBalancerPort :: Lens' SetLoadBalancerListenerSSLCertificate Int
slblscLoadBalancerPort =
  lens _slblscLoadBalancerPort (\s a -> s {_slblscLoadBalancerPort = a})

-- | The Amazon Resource Name (ARN) of the SSL certificate.
slblscSSLCertificateId :: Lens' SetLoadBalancerListenerSSLCertificate Text
slblscSSLCertificateId =
  lens _slblscSSLCertificateId (\s a -> s {_slblscSSLCertificateId = a})
...
instance AWSRequest SetLoadBalancerListenerSSLCertificate where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         SetLoadBalancerListenerSSLCertificateResponse' <$> (pure (fromEnum s)))
...
instance ToQuery SetLoadBalancerListenerSSLCertificate where
  toQuery SetLoadBalancerListenerSSLCertificate' {..} =
    mconcat
      [ "Action" =: ("SetLoadBalancerListenerSSLCertificate" :: ByteString)
...
slblscrsResponseStatus ::
     Lens' SetLoadBalancerListenerSSLCertificateResponse Int
slblscrsResponseStatus =
  lens _slblscrsResponseStatus (\s a -> s {_slblscrsResponseStatus = a})
