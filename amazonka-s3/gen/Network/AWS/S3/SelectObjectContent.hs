...
--
-- For more information about using SQL with Amazon S3 Select, see <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-glacier-select-sql-reference.html SQL Reference for Amazon S3 Select and Glacier Select> in the /Amazon Simple Storage Service Developer Guide/ .
--
--
--
-- __Permissions__ 
...
--
-- For objects that are encrypted with customer-provided encryption keys (SSE-C), you must use HTTPS, and you must use the headers that are documented in the 'GetObject' . For more information about SSE-C, see <https://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys)> in the /Amazon Simple Storage Service Developer Guide/ .
--
...
selectObjectContent pBucket_ pKey_ pExpression_
  ...
  = SelectObjectContent'{_socSSECustomerAlgorithm =
                         ...
                         _socScanRange = Nothing, _socBucket = pBucket_,
                         _socKey = pKey_, _socExpression = pExpression_,
