...
pblcLifecycleConfiguration =
  lens _pblcLifecycleConfiguration (\s a -> s {_pblcLifecycleConfiguration = a})
...
instance AWSRequest PutBucketLifecycleConfiguration where
  type Rs PutBucketLifecycleConfiguration = PutBucketLifecycleConfigurationResponse
  request = putXML s3
...
instance ToPath PutBucketLifecycleConfiguration where
  toPath PutBucketLifecycleConfiguration' {..} = mconcat ["/", toBS _pblcBucket]
