...
data ActionExecutionInput = ActionExecutionInput'{_aeiNamespace
                                                  :: !(Maybe Text),
...
actionExecutionInput
    :: ActionExecutionInput
actionExecutionInput
  = ActionExecutionInput'{_aeiNamespace = Nothing,
                          _aeiResolvedConfiguration = Nothing,
                          _aeiRegion = Nothing, _aeiConfiguration = Nothing,
                          _aeiActionTypeId = Nothing,
                          _aeiInputArtifacts = Nothing, _aeiRoleARN = Nothing}
