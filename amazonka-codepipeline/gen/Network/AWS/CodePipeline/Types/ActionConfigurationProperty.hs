...
data ActionConfigurationProperty = ActionConfigurationProperty'{_acpQueryable
                                                                ::
                                                                !(Maybe Bool),
                                                                _acpType ::
                                                                !(Maybe
...
actionConfigurationProperty
    ...
    -> Bool -- ^ 'acpSecret'
    -> ActionConfigurationProperty
actionConfigurationProperty pName_ pRequired_ pKey_
  pSecret_
  = ActionConfigurationProperty'{_acpQueryable =
                                   Nothing,
                                 _acpType = Nothing, _acpDescription = Nothing,
                                 _acpName = pName_, _acpRequired = pRequired_,
                                 _acpKey = pKey_, _acpSecret = pSecret_}
