...
data ListWebhookItem = ListWebhookItem'{_lwiArn ::
                                        !(Maybe Text),
...
listWebhookItem pDefinition_ pUrl_
  = ListWebhookItem'{_lwiArn = Nothing,
                     _lwiErrorCode = Nothing, _lwiLastTriggered = Nothing,
                     _lwiErrorMessage = Nothing, _lwiTags = Nothing,
                     _lwiDefinition = pDefinition_, _lwiUrl = pUrl_}
