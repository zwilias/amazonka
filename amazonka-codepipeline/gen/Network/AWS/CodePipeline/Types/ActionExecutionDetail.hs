...
data ActionExecutionDetail = ActionExecutionDetail'{_aedStatus
                                                    ::
                                                    !(Maybe
...
actionExecutionDetail
    :: ActionExecutionDetail
actionExecutionDetail
  = ActionExecutionDetail'{_aedStatus = Nothing,
                           _aedStartTime = Nothing,
                           _aedPipelineVersion = Nothing, _aedInput = Nothing,
                           _aedActionName = Nothing, _aedOutput = Nothing,
