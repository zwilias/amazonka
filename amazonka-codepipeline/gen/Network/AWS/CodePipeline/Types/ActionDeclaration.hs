...
data ActionDeclaration = ActionDeclaration'{_adOutputArtifacts
...
actionDeclaration pName_ pActionTypeId_
  = ActionDeclaration'{_adOutputArtifacts = Nothing,
                       _adNamespace = Nothing, _adRunOrder = Nothing,
                       _adRegion = Nothing, _adConfiguration = Nothing,
                       _adInputArtifacts = Nothing, _adRoleARN = Nothing,
                       _adName = pName_, _adActionTypeId = pActionTypeId_}
