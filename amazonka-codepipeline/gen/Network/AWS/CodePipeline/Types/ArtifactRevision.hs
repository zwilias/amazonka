...
data ArtifactRevision = ArtifactRevision'{_arRevisionSummary
                                          :: !(Maybe Text),
...
artifactRevision
    :: ArtifactRevision
artifactRevision
  = ArtifactRevision'{_arRevisionSummary = Nothing,
                      _arRevisionURL = Nothing, _arCreated = Nothing,
                      _arName = Nothing, _arRevisionId = Nothing,
