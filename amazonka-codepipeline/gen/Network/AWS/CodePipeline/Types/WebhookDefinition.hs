...
data WebhookDefinition = WebhookDefinition'{_wdName
                                            :: !Text,
...
webhookDefinition
    ...
    -> WebhookDefinition
webhookDefinition pName_ pTargetPipeline_
  pTargetAction_ pAuthentication_
  pAuthenticationConfiguration_
  = WebhookDefinition'{_wdName = pName_,
