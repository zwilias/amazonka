...
cavSemanticVersion =
  lens _cavSemanticVersion (\s a -> s {_cavSemanticVersion = a})
...
instance AWSRequest CreateApplicationVersion where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateApplicationVersionResponse' <$> (x .?> "creationTime") <*>
...
cavrsParameterDefinitions ::
     Lens' CreateApplicationVersionResponse [ParameterDefinition]
cavrsParameterDefinitions =
  lens _cavrsParameterDefinitions (\s a -> s {_cavrsParameterDefinitions = a}) .
  _Default . _Coerce
...
cavrsSemanticVersion =
  lens _cavrsSemanticVersion (\s a -> s {_cavrsSemanticVersion = a})

-- | A link to a public repository for the source code of your application.
cavrsSourceCodeURL :: Lens' CreateApplicationVersionResponse (Maybe Text)
cavrsSourceCodeURL =
  lens _cavrsSourceCodeURL (\s a -> s {_cavrsSourceCodeURL = a})

-- | The application Amazon Resource Name (ARN).
cavrsApplicationId :: Lens' CreateApplicationVersionResponse (Maybe Text)
cavrsApplicationId =
  lens _cavrsApplicationId (\s a -> s {_cavrsApplicationId = a})
...
cavrsResponseStatus =
  lens _cavrsResponseStatus (\s a -> s {_cavrsResponseStatus = a})
