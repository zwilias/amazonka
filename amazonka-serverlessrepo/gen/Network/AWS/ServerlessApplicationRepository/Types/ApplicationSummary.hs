...
data ApplicationSummary = ApplicationSummary'{_asCreationTime
                                              :: !(Maybe Text),
...
applicationSummary
    ...
    -> Text -- ^ 'asName'
    -> ApplicationSummary
applicationSummary pDescription_ pAuthor_
  pApplicationId_ pName_
  = ApplicationSummary'{_asCreationTime = Nothing,
                        _asHomePageURL = Nothing, _asLabels = Nothing,
