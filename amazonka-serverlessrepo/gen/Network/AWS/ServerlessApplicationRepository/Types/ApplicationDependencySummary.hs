...
data ApplicationDependencySummary = ApplicationDependencySummary'{_adsApplicationId
                                                                  :: !Text,
                                                                  _adsSemanticVersion
                                                                  :: !Text}
...
applicationDependencySummary
    ...
    -> ApplicationDependencySummary
applicationDependencySummary pApplicationId_
  pSemanticVersion_
  = ApplicationDependencySummary'{_adsApplicationId =
                                    pApplicationId_,
