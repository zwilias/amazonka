...
data TrustedAdvisorCheckRefreshStatus = TrustedAdvisorCheckRefreshStatus'{_tacrsCheckId
                                                                          ::
                                                                          !Text,
                                                                          _tacrsStatus
                                                                          ::
...
trustedAdvisorCheckRefreshStatus
    ...
    -> TrustedAdvisorCheckRefreshStatus
trustedAdvisorCheckRefreshStatus pCheckId_ pStatus_
  pMillisUntilNextRefreshable_
  = TrustedAdvisorCheckRefreshStatus'{_tacrsCheckId =
                                        pCheckId_,
