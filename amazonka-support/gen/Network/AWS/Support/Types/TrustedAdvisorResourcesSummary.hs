...
data TrustedAdvisorResourcesSummary = TrustedAdvisorResourcesSummary'{_tarsResourcesProcessed
                                                                      ::
                                                                      !Integer,
...
trustedAdvisorResourcesSummary
    ...
    -> TrustedAdvisorResourcesSummary
trustedAdvisorResourcesSummary pResourcesProcessed_
  pResourcesFlagged_ pResourcesIgnored_
  pResourcesSuppressed_
  = TrustedAdvisorResourcesSummary'{_tarsResourcesProcessed
