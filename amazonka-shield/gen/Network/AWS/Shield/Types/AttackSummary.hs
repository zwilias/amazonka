...
data AttackSummary = AttackSummary'{_asAttackVectors
...
attackSummary
    :: AttackSummary
attackSummary
  = AttackSummary'{_asAttackVectors = Nothing,
                   _asAttackId = Nothing, _asStartTime = Nothing,
                   _asResourceARN = Nothing, _asEndTime = Nothing}
