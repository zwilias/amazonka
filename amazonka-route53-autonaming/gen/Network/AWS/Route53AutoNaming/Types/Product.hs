...
instance FromJSON DNSConfig where
  parseJSON =
    withObject
      "DNSConfig"
      (\x ->
         DNSConfig' <$> (x .:? "RoutingPolicy") <*> (x .: "NamespaceId") <*>
         (x .:? "DnsRecords" .!= mempty))
...
instance FromJSON DNSProperties where
  parseJSON =
    withObject "DNSProperties" (\x -> DNSProperties' <$> (x .:? "HostedZoneId"))
...
instance FromJSON DNSRecord where
  parseJSON =
    withObject "DNSRecord" (\x -> DNSRecord' <$> (x .: "Type") <*> (x .: "TTL"))
...
instance ToJSON DNSRecord where
  toJSON DNSRecord' {..} =
    object (catMaybes [Just ("Type" .= _drType), Just ("TTL" .= _drTTL)])
...
instance FromJSON HealthCheckConfig where
  parseJSON =
    withObject
      "HealthCheckConfig"
      (\x ->
         HealthCheckConfig' <$> (x .:? "FailureThreshold") <*>
         (x .:? "ResourcePath") <*>
         (x .:? "Type"))
...
hcccFailureThreshold =
  lens _hcccFailureThreshold (\s a -> s {_hcccFailureThreshold = a}) .
  mapping _Nat
...
instance ToJSON HealthCheckCustomConfig where
  toJSON HealthCheckCustomConfig' {..} =
    object (catMaybes [("FailureThreshold" .=) <$> _hcccFailureThreshold])
...
isAttributes =
  lens _isAttributes (\s a -> s {_isAttributes = a}) . _Default . _Map
...
instance FromJSON InstanceSummary where
  parseJSON =
    withObject
      "InstanceSummary"
      (\x ->
         InstanceSummary' <$> (x .:? "Attributes" .!= mempty) <*> (x .:? "Id"))
...
instance FromJSON Namespace where
  parseJSON =
    withObject
      "Namespace"
      (\x ->
         Namespace' <$> (x .:? "Arn") <*> (x .:? "CreatorRequestId") <*>
         (x .:? "CreateDate") <*>
         (x .:? "ServiceCount") <*>
         (x .:? "Name") <*>
         (x .:? "Id") <*>
...
instance FromJSON NamespaceProperties where
  parseJSON =
    withObject
      "NamespaceProperties"
      (\x -> NamespaceProperties' <$> (x .:? "DnsProperties"))
...
instance FromJSON NamespaceSummary where
  parseJSON =
    withObject
      "NamespaceSummary"
      (\x ->
         NamespaceSummary' <$> (x .:? "Arn") <*> (x .:? "Name") <*> (x .:? "Id") <*>
         (x .:? "Type"))
...
instance FromJSON Operation where
  parseJSON =
    withObject
      "Operation"
      (\x ->
         Operation' <$> (x .:? "Status") <*> (x .:? "UpdateDate") <*>
         (x .:? "CreateDate") <*>
         (x .:? "Targets" .!= mempty) <*>
         (x .:? "ErrorCode") <*>
         (x .:? "Id") <*>
...
scHealthCheckConfig =
  lens _scHealthCheckConfig (\s a -> s {_scHealthCheckConfig = a})
...
siHealthCheckConfig =
  lens _siHealthCheckConfig (\s a -> s {_siHealthCheckConfig = a})

-- | A unique string that identifies the request and that allows failed requests to be retried without the risk of executing the operation twice. @CreatorRequestId@ can be any unique string, for example, a date/time stamp.
siCreatorRequestId :: Lens' ServiceInfo (Maybe Text)
siCreatorRequestId =
  lens _siCreatorRequestId (\s a -> s {_siCreatorRequestId = a})
...
siHealthCheckCustomConfig =
  lens _siHealthCheckCustomConfig (\s a -> s {_siHealthCheckCustomConfig = a})
...
instance FromJSON ServiceInfo where
  parseJSON =
    withObject
      "ServiceInfo"
      (\x ->
         ServiceInfo' <$> (x .:? "InstanceCount") <*> (x .:? "Arn") <*>
         (x .:? "HealthCheckConfig") <*>
         (x .:? "CreatorRequestId") <*>
         (x .:? "CreateDate") <*>
...
instance FromJSON ServiceSummary where
  parseJSON =
    withObject
      "ServiceSummary"
      (\x ->
         ServiceSummary' <$> (x .:? "InstanceCount") <*> (x .:? "Arn") <*>
         (x .:? "Name") <*>
         (x .:? "Id") <*>
         (x .:? "Description"))
