...
namespace
    :: Namespace
namespace
  = Namespace'{_nARN = Nothing,
               _nCreatorRequestId = Nothing, _nCreateDate = Nothing,
               _nServiceCount = Nothing, _nName = Nothing,
