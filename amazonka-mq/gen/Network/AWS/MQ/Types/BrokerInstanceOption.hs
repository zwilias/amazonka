...
data BrokerInstanceOption = BrokerInstanceOption'{_bioSupportedEngineVersions
                                                  :: !(Maybe [Text]),
...
brokerInstanceOption
    :: BrokerInstanceOption
brokerInstanceOption
  = BrokerInstanceOption'{_bioSupportedEngineVersions =
                            Nothing,
...
instance FromJSON BrokerInstanceOption where
        parseJSON
          = withObject "BrokerInstanceOption"
              (\ x ->
                 BrokerInstanceOption' <$>
...
instance Hashable BrokerInstanceOption where

instance NFData BrokerInstanceOption where
