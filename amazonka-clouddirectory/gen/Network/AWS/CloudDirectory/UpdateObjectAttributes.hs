...
uoaObjectReference =
  lens _uoaObjectReference (\s a -> s {_uoaObjectReference = a})

-- | The attributes update structure.
uoaAttributeUpdates :: Lens' UpdateObjectAttributes [ObjectAttributeUpdate]
uoaAttributeUpdates =
  lens _uoaAttributeUpdates (\s a -> s {_uoaAttributeUpdates = a}) . _Coerce
...
instance AWSRequest UpdateObjectAttributes where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdateObjectAttributesResponse' <$> (x .?> "ObjectIdentifier") <*>
         (pure (fromEnum s)))
...
uoarsObjectIdentifier =
  lens _uoarsObjectIdentifier (\s a -> s {_uoarsObjectIdentifier = a})

-- | -- | The response status code.
uoarsResponseStatus :: Lens' UpdateObjectAttributesResponse Int
uoarsResponseStatus =
  lens _uoarsResponseStatus (\s a -> s {_uoarsResponseStatus = a})
