...
data BatchGetObjectAttributes = BatchGetObjectAttributes'{_bgoaObjectReference
                                                          :: !ObjectReference,
                                                          _bgoaSchemaFacet ::
                                                          !SchemaFacet,
                                                          _bgoaAttributeNames ::
...
batchGetObjectAttributes
    ...
    -> BatchGetObjectAttributes
batchGetObjectAttributes pObjectReference_
  pSchemaFacet_
  = BatchGetObjectAttributes'{_bgoaObjectReference =
                                pObjectReference_,
