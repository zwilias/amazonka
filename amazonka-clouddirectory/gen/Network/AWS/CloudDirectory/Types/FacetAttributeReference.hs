...
data FacetAttributeReference = FacetAttributeReference'{_farTargetFacetName
                                                        :: !Text,
...
facetAttributeReference
    ...
    -> FacetAttributeReference
facetAttributeReference pTargetFacetName_
  pTargetAttributeName_
  = FacetAttributeReference'{_farTargetFacetName =
                               pTargetFacetName_,
