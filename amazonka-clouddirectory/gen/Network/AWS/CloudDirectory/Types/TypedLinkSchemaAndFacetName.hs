...
data TypedLinkSchemaAndFacetName = TypedLinkSchemaAndFacetName'{_tlsafnSchemaARN
                                                                :: !Text,
...
typedLinkSchemaAndFacetName
    ...
    -> TypedLinkSchemaAndFacetName
typedLinkSchemaAndFacetName pSchemaARN_
  pTypedLinkName_
  = TypedLinkSchemaAndFacetName'{_tlsafnSchemaARN =
                                   pSchemaARN_,
