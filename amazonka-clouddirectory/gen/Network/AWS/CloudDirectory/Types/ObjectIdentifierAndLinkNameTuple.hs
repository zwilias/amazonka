...
data ObjectIdentifierAndLinkNameTuple = ObjectIdentifierAndLinkNameTuple'{_oialntObjectIdentifier
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _oialntLinkName
...
objectIdentifierAndLinkNameTuple
    :: ObjectIdentifierAndLinkNameTuple
objectIdentifierAndLinkNameTuple
  = ObjectIdentifierAndLinkNameTuple'{_oialntObjectIdentifier
                                        = Nothing,
