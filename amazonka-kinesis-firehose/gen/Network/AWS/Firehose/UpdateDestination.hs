...
udSplunkDestinationUpdate ::
     Lens' UpdateDestination (Maybe SplunkDestinationUpdate)
udSplunkDestinationUpdate =
  lens _udSplunkDestinationUpdate (\s a -> s {_udSplunkDestinationUpdate = a})

-- | [Deprecated] Describes an update for a destination in Amazon S3.
udS3DestinationUpdate :: Lens' UpdateDestination (Maybe S3DestinationUpdate)
udS3DestinationUpdate =
  lens _udS3DestinationUpdate (\s a -> s {_udS3DestinationUpdate = a})

-- | Describes an update for a destination in Amazon Redshift.
udRedshiftDestinationUpdate ::
     Lens' UpdateDestination (Maybe RedshiftDestinationUpdate)
udRedshiftDestinationUpdate =
  lens
    _udRedshiftDestinationUpdate
    (\s a -> s {_udRedshiftDestinationUpdate = a})

-- | Describes an update for a destination in Amazon ES.
udElasticsearchDestinationUpdate ::
     Lens' UpdateDestination (Maybe ElasticsearchDestinationUpdate)
udElasticsearchDestinationUpdate =
  lens
    _udElasticsearchDestinationUpdate
    (\s a -> s {_udElasticsearchDestinationUpdate = a})

-- | Describes an update for a destination in Amazon S3.
udExtendedS3DestinationUpdate ::
     Lens' UpdateDestination (Maybe ExtendedS3DestinationUpdate)
udExtendedS3DestinationUpdate =
  lens
    _udExtendedS3DestinationUpdate
    (\s a -> s {_udExtendedS3DestinationUpdate = a})

-- | The name of the delivery stream.
udDeliveryStreamName :: Lens' UpdateDestination Text
udDeliveryStreamName =
  lens _udDeliveryStreamName (\s a -> s {_udDeliveryStreamName = a})
...
udCurrentDeliveryStreamVersionId =
  lens
    ...
    (\s a -> s {_udCurrentDeliveryStreamVersionId = a})
...
instance AWSRequest UpdateDestination where
  ...
  response =
    receiveEmpty (\s h x -> UpdateDestinationResponse' <$> (pure (fromEnum s)))
    ...
    object
      (catMaybes
         ...
         , ("ElasticsearchDestinationUpdate" .=) <$>
           _udElasticsearchDestinationUpdate
         , ("ExtendedS3DestinationUpdate" .=) <$> _udExtendedS3DestinationUpdate
