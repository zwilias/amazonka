...
data DeliveryStreamDescription = DeliveryStreamDescription'{_dsdFailureDescription
                                                            ::
                                                            !(Maybe
                                                                FailureDescription),
...
deliveryStreamDescription
    ...
    -> DeliveryStreamDescription
deliveryStreamDescription pDeliveryStreamName_
  pDeliveryStreamARN_ pDeliveryStreamStatus_
  pDeliveryStreamType_ pVersionId_
  pHasMoreDestinations_
  = DeliveryStreamDescription'{_dsdFailureDescription =
                                 Nothing,
                               _dsdDeliveryStreamEncryptionConfiguration =
                                 Nothing,
