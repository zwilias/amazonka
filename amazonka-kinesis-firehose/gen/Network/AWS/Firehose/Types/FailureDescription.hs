...
data FailureDescription = FailureDescription'{_fdType
...
failureDescription
    :: DeliveryStreamFailureType -- ^ 'fdType'
    -> Text -- ^ 'fdDetails'
    -> FailureDescription
failureDescription pType_ pDetails_
  = FailureDescription'{_fdType = pType_,
...
instance FromJSON FailureDescription where
        parseJSON
          = withObject "FailureDescription"
              (\ x ->
                 FailureDescription' <$>
                   (x .: "Type") <*> (x .: "Details"))

instance Hashable FailureDescription where

instance NFData FailureDescription where
