...
data DataFormatConversionConfiguration = DataFormatConversionConfiguration'{_dfccOutputFormatConfiguration
                                                                            ::
                                                                            !(Maybe
...
dataFormatConversionConfiguration
    :: DataFormatConversionConfiguration
dataFormatConversionConfiguration
  = DataFormatConversionConfiguration'{_dfccOutputFormatConfiguration
                                         = Nothing,
