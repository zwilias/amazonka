...
data SchemaConfiguration = SchemaConfiguration'{_scVersionId
                                                :: !(Maybe Text),
...
schemaConfiguration
    :: SchemaConfiguration
schemaConfiguration
  = SchemaConfiguration'{_scVersionId = Nothing,
                         _scCatalogId = Nothing, _scDatabaseName = Nothing,
                         _scRegion = Nothing, _scTableName = Nothing,
                         _scRoleARN = Nothing}
