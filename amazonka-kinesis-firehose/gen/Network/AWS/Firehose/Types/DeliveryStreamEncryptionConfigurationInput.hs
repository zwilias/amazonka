...
data DeliveryStreamEncryptionConfigurationInput = DeliveryStreamEncryptionConfigurationInput'{_dseciKeyARN
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  Text),
                                                                                              _dseciKeyType
...
deliveryStreamEncryptionConfigurationInput
    :: KeyType -- ^ 'dseciKeyType'
    -> DeliveryStreamEncryptionConfigurationInput
deliveryStreamEncryptionConfigurationInput pKeyType_
  = DeliveryStreamEncryptionConfigurationInput'{_dseciKeyARN
                                                  = Nothing,
