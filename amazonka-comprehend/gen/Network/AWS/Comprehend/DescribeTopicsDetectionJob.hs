...
instance AWSRequest DescribeTopicsDetectionJob where
  type Rs DescribeTopicsDetectionJob = DescribeTopicsDetectionJobResponse
...
dtdjrsTopicsDetectionJobProperties ::
     Lens' DescribeTopicsDetectionJobResponse (Maybe TopicsDetectionJobProperties)
dtdjrsTopicsDetectionJobProperties =
  lens
    _dtdjrsTopicsDetectionJobProperties
    (\s a -> s {_dtdjrsTopicsDetectionJobProperties = a})

-- | -- | The response status code.
dtdjrsResponseStatus :: Lens' DescribeTopicsDetectionJobResponse Int
dtdjrsResponseStatus =
  lens _dtdjrsResponseStatus (\s a -> s {_dtdjrsResponseStatus = a})
