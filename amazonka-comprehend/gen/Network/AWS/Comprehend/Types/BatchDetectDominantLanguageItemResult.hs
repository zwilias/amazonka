...
data BatchDetectDominantLanguageItemResult = BatchDetectDominantLanguageItemResult'{_bddlirLanguages
                                                                                    ::
                                                                                    !(Maybe
                                                                                        [DominantLanguage]),
                                                                                    _bddlirIndex
...
batchDetectDominantLanguageItemResult
    :: BatchDetectDominantLanguageItemResult
batchDetectDominantLanguageItemResult
  = BatchDetectDominantLanguageItemResult'{_bddlirLanguages
                                             = Nothing,
