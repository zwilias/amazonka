...
bddlirLanguages ::
     Lens' BatchDetectDominantLanguageItemResult [DominantLanguage]
bddlirLanguages =
  lens _bddlirLanguages (\s a -> s {_bddlirLanguages = a}) . _Default . _Coerce
...
bdeirEntities =
  lens _bdeirEntities (\s a -> s {_bdeirEntities = a}) . _Default . _Coerce
...
instance FromJSON BatchDetectEntitiesItemResult where
  parseJSON =
    withObject
      "BatchDetectEntitiesItemResult"
      (\x ->
         BatchDetectEntitiesItemResult' <$> (x .:? "Entities" .!= mempty) <*>
         (x .:? "Index"))
...
bdkpirKeyPhrases =
  lens _bdkpirKeyPhrases (\s a -> s {_bdkpirKeyPhrases = a}) .
  _Default . _Coerce
...
instance FromJSON BatchDetectKeyPhrasesItemResult where
  parseJSON =
    withObject
      "BatchDetectKeyPhrasesItemResult"
      (\x ->
         BatchDetectKeyPhrasesItemResult' <$> (x .:? "Index") <*>
         (x .:? "KeyPhrases" .!= mempty))
...
bdsirSentimentScore ::
     Lens' BatchDetectSentimentItemResult (Maybe SentimentScore)
bdsirSentimentScore =
  lens _bdsirSentimentScore (\s a -> s {_bdsirSentimentScore = a})
...
instance FromJSON BatchDetectSentimentItemResult where
  parseJSON =
    withObject
      "BatchDetectSentimentItemResult"
      (\x ->
         BatchDetectSentimentItemResult' <$> (x .:? "Sentiment") <*>
         (x .:? "SentimentScore") <*>
         (x .:? "Index"))
...
instance FromJSON BatchItemError where
  parseJSON =
    withObject
      "BatchItemError"
      (\x ->
         BatchItemError' <$> (x .:? "ErrorCode") <*> (x .:? "ErrorMessage") <*>
         (x .:? "Index"))
...
instance FromJSON DominantLanguage where
  parseJSON =
    withObject
      "DominantLanguage"
      (\x -> DominantLanguage' <$> (x .:? "LanguageCode") <*> (x .:? "Score"))
...
instance FromJSON InputDataConfig where
  parseJSON =
    withObject
      "InputDataConfig"
      (\x -> InputDataConfig' <$> (x .:? "InputFormat") <*> (x .: "S3Uri"))
...
instance ToJSON InputDataConfig where
  toJSON InputDataConfig' {..} =
    object
      (catMaybes
         [("InputFormat" .=) <$> _idcInputFormat, Just ("S3Uri" .= _idcS3URI)])
...
instance FromJSON KeyPhrase where
  parseJSON =
    withObject
      "KeyPhrase"
      (\x ->
         KeyPhrase' <$> (x .:? "BeginOffset") <*> (x .:? "Text") <*>
         (x .:? "Score") <*>
         (x .:? "EndOffset"))
...
instance FromJSON OutputDataConfig where
  parseJSON =
    withObject "OutputDataConfig" (\x -> OutputDataConfig' <$> (x .: "S3Uri"))
...
instance FromJSON SentimentScore where
  parseJSON =
    withObject
      "SentimentScore"
      (\x ->
         SentimentScore' <$> (x .:? "Mixed") <*> (x .:? "Negative") <*>
         (x .:? "Neutral") <*>
         (x .:? "Positive"))
...
tdjfSubmitTimeAfter =
  lens _tdjfSubmitTimeAfter (\s a -> s {_tdjfSubmitTimeAfter = a}) .
  mapping _Time
...
tdjfSubmitTimeBefore =
  lens _tdjfSubmitTimeBefore (\s a -> s {_tdjfSubmitTimeBefore = a}) .
  mapping _Time
...
tdjpInputDataConfig ::
     Lens' TopicsDetectionJobProperties (Maybe InputDataConfig)
tdjpInputDataConfig =
  lens _tdjpInputDataConfig (\s a -> s {_tdjpInputDataConfig = a})
...
tdjpOutputDataConfig =
  lens _tdjpOutputDataConfig (\s a -> s {_tdjpOutputDataConfig = a})

-- | The number of topics to detect supplied when you created the topic detection job. The default is 10.
tdjpNumberOfTopics :: Lens' TopicsDetectionJobProperties (Maybe Int)
tdjpNumberOfTopics =
  lens _tdjpNumberOfTopics (\s a -> s {_tdjpNumberOfTopics = a})
...
tdjpSubmitTime =
  lens _tdjpSubmitTime (\s a -> s {_tdjpSubmitTime = a}) . mapping _Time
...
instance FromJSON TopicsDetectionJobProperties where
  parseJSON =
    withObject
      "TopicsDetectionJobProperties"
      (\x ->
         TopicsDetectionJobProperties' <$> (x .:? "JobId") <*> (x .:? "JobName") <*>
         (x .:? "InputDataConfig") <*>
         (x .:? "EndTime") <*>
         (x .:? "OutputDataConfig") <*>
         (x .:? "NumberOfTopics") <*>
