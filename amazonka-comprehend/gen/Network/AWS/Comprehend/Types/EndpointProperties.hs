...
data EndpointProperties = EndpointProperties'{_epCreationTime
                                              :: !(Maybe POSIX),
                                              _epStatus ::
...
endpointProperties
    :: EndpointProperties
endpointProperties
  = EndpointProperties'{_epCreationTime = Nothing,
                        _epStatus = Nothing, _epModelARN = Nothing,
                        _epLastModifiedTime = Nothing,
                        _epDesiredInferenceUnits = Nothing,
                        _epCurrentInferenceUnits = Nothing,
                        _epMessage = Nothing, _epEndpointARN = Nothing}
