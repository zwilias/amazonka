...
data SyntaxToken = SyntaxToken'{_stBeginOffset ::
                                !(Maybe Int),
                                _stText :: !(Maybe Text),
...
syntaxToken
    :: SyntaxToken
syntaxToken
  = SyntaxToken'{_stBeginOffset = Nothing,
                 _stText = Nothing, _stTokenId = Nothing,
                 _stEndOffset = Nothing, _stPartOfSpeech = Nothing}
