...
data StartDocumentClassificationJob = StartDocumentClassificationJob'{_sdcjJobName
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _sdcjVPCConfig
...
startDocumentClassificationJob
    ...
    -> StartDocumentClassificationJob
startDocumentClassificationJob
  pDocumentClassifierARN_ pInputDataConfig_
  pOutputDataConfig_ pDataAccessRoleARN_
  = StartDocumentClassificationJob'{_sdcjJobName =
                                      Nothing,
...
data StartDocumentClassificationJobResponse = StartDocumentClassificationJobResponse'{_sdcjrsJobId
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
                                                                                      _sdcjrsJobStatus
...
startDocumentClassificationJobResponse
  pResponseStatus_
  = StartDocumentClassificationJobResponse'{_sdcjrsJobId
                                              = Nothing,
