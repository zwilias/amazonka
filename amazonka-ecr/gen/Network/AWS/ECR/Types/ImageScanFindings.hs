...
data ImageScanFindings = ImageScanFindings'{_isfImageScanCompletedAt
                                            :: !(Maybe POSIX),
                                            _isfFindings ::
...
imageScanFindings
    :: ImageScanFindings
imageScanFindings
  = ImageScanFindings'{_isfImageScanCompletedAt =
                         Nothing,
...
instance Hashable ImageScanFindings where

instance NFData ImageScanFindings where
