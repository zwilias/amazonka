...
newtype ImageScanningConfiguration = ImageScanningConfiguration'{_iscScanOnPush
                                                                 :: Maybe Bool}
...
imageScanningConfiguration
    :: ImageScanningConfiguration
imageScanningConfiguration
  = ImageScanningConfiguration'{_iscScanOnPush =
                                  Nothing}
...
instance FromJSON ImageScanningConfiguration where
        parseJSON
          = withObject "ImageScanningConfiguration"
              (\ x ->
                 ImageScanningConfiguration' <$> (x .:? "scanOnPush"))

instance Hashable ImageScanningConfiguration where

instance NFData ImageScanningConfiguration where
