...
newtype LifecyclePolicyPreviewSummary = LifecyclePolicyPreviewSummary'{_lppsExpiringImageTotalCount
                                                                       ::
                                                                       Maybe
                                                                         Nat}
...
lifecyclePolicyPreviewSummary
    :: LifecyclePolicyPreviewSummary
lifecyclePolicyPreviewSummary
  = LifecyclePolicyPreviewSummary'{_lppsExpiringImageTotalCount
                                     = Nothing}
