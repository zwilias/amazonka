...
data ImageScanFindingsSummary = ImageScanFindingsSummary'{_isfsImageScanCompletedAt
                                                          :: !(Maybe POSIX),
...
imageScanFindingsSummary
    :: ImageScanFindingsSummary
imageScanFindingsSummary
  = ImageScanFindingsSummary'{_isfsImageScanCompletedAt
                                = Nothing,
...
instance FromJSON ImageScanFindingsSummary where
        parseJSON
          = withObject "ImageScanFindingsSummary"
              (\ x ->
                 ImageScanFindingsSummary' <$>
...
instance Hashable ImageScanFindingsSummary where

instance NFData ImageScanFindingsSummary where
