...
data ImageScanFinding = ImageScanFinding'{_isfSeverity
...
imageScanFinding
    :: ImageScanFinding
imageScanFinding
  = ImageScanFinding'{_isfSeverity = Nothing,
                      _isfUri = Nothing, _isfName = Nothing,
                      _isfAttributes = Nothing, _isfDescription = Nothing}
...
instance Hashable ImageScanFinding where

instance NFData ImageScanFinding where
