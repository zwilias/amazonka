...
data TaskSubmitFailedEventDetails = TaskSubmitFailedEventDetails'{_tsfedError
                                                                  ::
                                                                  !(Maybe
                                                                      (Sensitive
                                                                         Text)),
...
taskSubmitFailedEventDetails
    ...
    -> Text -- ^ 'tsfedResource'
    -> TaskSubmitFailedEventDetails
taskSubmitFailedEventDetails pResourceType_
  pResource_
  = TaskSubmitFailedEventDetails'{_tsfedError =
                                    Nothing,
                                  _tsfedCause = Nothing,
