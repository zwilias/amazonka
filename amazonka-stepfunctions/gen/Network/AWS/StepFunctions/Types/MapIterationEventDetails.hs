...
data MapIterationEventDetails = MapIterationEventDetails'{_miedName
                                                          :: !(Maybe Text),
                                                          _miedIndex ::
                                                          !(Maybe Nat)}
...
mapIterationEventDetails
    :: MapIterationEventDetails
mapIterationEventDetails
  = MapIterationEventDetails'{_miedName = Nothing,
                              _miedIndex = Nothing}
...
instance FromJSON MapIterationEventDetails where
        parseJSON
          = withObject "MapIterationEventDetails"
              (\ x ->
                 MapIterationEventDetails' <$>
                   (x .:? "name") <*> (x .:? "index"))

instance Hashable MapIterationEventDetails where

instance NFData MapIterationEventDetails where
