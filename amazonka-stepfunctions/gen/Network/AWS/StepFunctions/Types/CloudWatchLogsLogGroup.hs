...
newtype CloudWatchLogsLogGroup = CloudWatchLogsLogGroup'{_cwllgLogGroupARN
                                                         :: Maybe Text}
...
cloudWatchLogsLogGroup
    :: CloudWatchLogsLogGroup
cloudWatchLogsLogGroup
  = CloudWatchLogsLogGroup'{_cwllgLogGroupARN =
                              Nothing}
...
instance FromJSON CloudWatchLogsLogGroup where
        parseJSON
          = withObject "CloudWatchLogsLogGroup"
              (\ x ->
                 CloudWatchLogsLogGroup' <$> (x .:? "logGroupArn"))

instance Hashable CloudWatchLogsLogGroup where

instance NFData CloudWatchLogsLogGroup where
