...
newtype MapStateStartedEventDetails = MapStateStartedEventDetails'{_mssedLength
                                                                   :: Maybe Nat}
...
mapStateStartedEventDetails
    :: MapStateStartedEventDetails
mapStateStartedEventDetails
  = MapStateStartedEventDetails'{_mssedLength =
                                   Nothing}
...
instance FromJSON MapStateStartedEventDetails where
        parseJSON
          = withObject "MapStateStartedEventDetails"
              (\ x ->
                 MapStateStartedEventDetails' <$> (x .:? "length"))

instance Hashable MapStateStartedEventDetails where

instance NFData MapStateStartedEventDetails where
