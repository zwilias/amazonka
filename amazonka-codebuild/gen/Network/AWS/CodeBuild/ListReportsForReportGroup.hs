...
data ListReportsForReportGroup =
  ListReportsForReportGroup'
    { _lrfrgSortOrder      :: !(Maybe SortOrderType)
...
data ListReportsForReportGroupResponse =
  ListReportsForReportGroupResponse'
    { _lrfrgrsReports        :: !(Maybe (List1 Text))
    , _lrfrgrsNextToken      :: !(Maybe Text)
    , _lrfrgrsResponseStatus :: !Int
    }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'lrfrgrsReports' - The list of returned report group ARNs.
--
