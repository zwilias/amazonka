...
data LogsLocation = LogsLocation'{_llDeepLink ::
                                  !(Maybe Text),
...
logsLocation
    :: LogsLocation
logsLocation
  = LogsLocation'{_llDeepLink = Nothing,
                  _llS3Logs = Nothing, _llCloudWatchLogs = Nothing,
                  _llS3DeepLink = Nothing, _llS3LogsARN = Nothing,
                  _llCloudWatchLogsARN = Nothing,
                  _llGroupName = Nothing, _llStreamName = Nothing}
