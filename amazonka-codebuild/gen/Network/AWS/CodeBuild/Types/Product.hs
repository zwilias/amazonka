...
instance FromJSON Build where
  parseJSON =
    withObject
      "Build"
      (\x ->
         Build' <$> (x .:? "phases" .!= mempty) <*> (x .:? "buildComplete") <*>
         (x .:? "arn") <*>
         (x .:? "startTime") <*>
         (x .:? "artifacts") <*>
         (x .:? "environment") <*>
...
instance FromJSON BuildArtifacts where
  parseJSON =
    withObject
      "BuildArtifacts"
      (\x ->
         BuildArtifacts' <$> (x .:? "location") <*> (x .:? "md5sum") <*>
         (x .:? "sha256sum"))
...
bpDurationInSeconds =
  lens _bpDurationInSeconds (\s a -> s {_bpDurationInSeconds = a})
...
instance FromJSON BuildPhase where
  parseJSON =
    withObject
      "BuildPhase"
      (\x ->
         BuildPhase' <$> (x .:? "contexts" .!= mempty) <*> (x .:? "startTime") <*>
         (x .:? "phaseStatus") <*>
         (x .:? "phaseType") <*>
         (x .:? "endTime") <*>
         (x .:? "durationInSeconds"))
...
instance FromJSON EnvironmentImage where
  parseJSON =
    withObject
      "EnvironmentImage"
      (\x ->
         EnvironmentImage' <$> (x .:? "versions" .!= mempty) <*> (x .:? "name") <*>
         (x .:? "description"))
...
instance FromJSON EnvironmentLanguage where
  parseJSON =
    withObject
      "EnvironmentLanguage"
      (\x ->
         EnvironmentLanguage' <$> (x .:? "images" .!= mempty) <*>
         (x .:? "language"))
...
epLanguages =
  lens _epLanguages (\s a -> s {_epLanguages = a}) . _Default . _Coerce
...
instance FromJSON EnvironmentPlatform where
  parseJSON =
    withObject
      "EnvironmentPlatform"
      (\x ->
         EnvironmentPlatform' <$> (x .:? "platform") <*>
         (x .:? "languages" .!= mempty))
...
instance FromJSON EnvironmentVariable where
  parseJSON =
    withObject
      "EnvironmentVariable"
      (\x ->
         EnvironmentVariable' <$> (x .:? "type") <*> (x .: "name") <*>
         (x .: "value"))
...
instance FromJSON LogsLocation where
  parseJSON =
    withObject
      "LogsLocation"
      (\x ->
         LogsLocation' <$> (x .:? "deepLink") <*> (x .:? "groupName") <*>
         (x .:? "streamName"))
...
instance FromJSON PhaseContext where
  parseJSON =
    withObject
      "PhaseContext"
      (\x -> PhaseContext' <$> (x .:? "message") <*> (x .:? "statusCode"))
...
pTimeoutInMinutes =
  lens _pTimeoutInMinutes (\s a -> s {_pTimeoutInMinutes = a}) . mapping _Nat
...
instance FromJSON ProjectArtifacts where
  parseJSON =
    withObject
      "ProjectArtifacts"
      (\x ->
         ProjectArtifacts' <$> (x .:? "packaging") <*> (x .:? "path") <*>
         (x .:? "location") <*>
         (x .:? "name") <*>
         (x .:? "namespaceType") <*>
         (x .: "type"))
...
instance FromJSON ProjectBadge where
  parseJSON =
    withObject
      "ProjectBadge"
      (\x ->
         ProjectBadge' <$> (x .:? "badgeEnabled") <*> (x .:? "badgeRequestUrl"))
...
instance FromJSON ProjectCache where
  parseJSON =
    withObject
      "ProjectCache"
      (\x -> ProjectCache' <$> (x .:? "location") <*> (x .: "type"))
...
instance ToJSON ProjectCache where
  toJSON ProjectCache' {..} =
    object
      (catMaybes [("location" .=) <$> _pcLocation, Just ("type" .= _pcType)])
...
peEnvironmentVariables =
  lens _peEnvironmentVariables (\s a -> s {_peEnvironmentVariables = a}) .
  _Default . _Coerce
...
instance FromJSON ProjectEnvironment where
  parseJSON =
    withObject
      "ProjectEnvironment"
      (\x ->
         ProjectEnvironment' <$> (x .:? "privilegedMode") <*>
         (x .:? "certificate") <*>
...
psGitCloneDepth =
  lens _psGitCloneDepth (\s a -> s {_psGitCloneDepth = a}) . mapping _Nat
...
instance FromJSON ProjectSource where
  parseJSON =
    withObject
      "ProjectSource"
      (\x ->
         ProjectSource' <$> (x .:? "insecureSsl") <*> (x .:? "location") <*>
         (x .:? "auth") <*>
         (x .:? "buildspec") <*>
         (x .:? "gitCloneDepth") <*>
         (x .: "type"))
...
instance ToJSON SourceAuth where
  toJSON SourceAuth' {..} =
    object
      (catMaybes [("resource" .=) <$> _saResource, Just ("type" .= _saType)])
...
wLastModifiedSecret =
  lens _wLastModifiedSecret (\s a -> s {_wLastModifiedSecret = a}) .
  mapping _Time
...
instance FromJSON Webhook where
  parseJSON =
    withObject
      "Webhook"
      (\x ->
         Webhook' <$> (x .:? "branchFilter") <*> (x .:? "lastModifiedSecret") <*>
         (x .:? "url") <*>
         (x .:? "secret") <*>
         (x .:? "payloadUrl"))
