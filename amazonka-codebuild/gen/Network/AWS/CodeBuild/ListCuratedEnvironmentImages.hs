...
instance AWSRequest ListCuratedEnvironmentImages where
  type Rs ListCuratedEnvironmentImages = ListCuratedEnvironmentImagesResponse
...
lceirsPlatforms ::
     Lens' ListCuratedEnvironmentImagesResponse [EnvironmentPlatform]
lceirsPlatforms =
  lens _lceirsPlatforms (\s a -> s {_lceirsPlatforms = a}) . _Default . _Coerce

-- | -- | The response status code.
lceirsResponseStatus :: Lens' ListCuratedEnvironmentImagesResponse Int
lceirsResponseStatus =
  lens _lceirsResponseStatus (\s a -> s {_lceirsResponseStatus = a})
