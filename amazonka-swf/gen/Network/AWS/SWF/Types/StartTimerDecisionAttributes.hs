...
data StartTimerDecisionAttributes = StartTimerDecisionAttributes'{_stdaControl
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _stdaTimerId
                                                                  :: !Text,
...
startTimerDecisionAttributes
    ...
    -> StartTimerDecisionAttributes
startTimerDecisionAttributes pTimerId_
  pStartToFireTimeout_
  = StartTimerDecisionAttributes'{_stdaControl =
                                    Nothing,
