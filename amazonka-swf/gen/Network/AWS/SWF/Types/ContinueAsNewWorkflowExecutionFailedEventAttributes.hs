...
data ContinueAsNewWorkflowExecutionFailedEventAttributes = ContinueAsNewWorkflowExecutionFailedEventAttributes'{_canwefeaCause
                                                                                                                ::
...
continueAsNewWorkflowExecutionFailedEventAttributes
  ...
  = ContinueAsNewWorkflowExecutionFailedEventAttributes'{_canwefeaCause
                                                           = pCause_,
                                                         _canwefeaDecisionTaskCompletedEventId
                                                           =
