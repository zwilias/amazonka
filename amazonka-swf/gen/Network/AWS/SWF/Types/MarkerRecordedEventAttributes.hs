...
data MarkerRecordedEventAttributes = MarkerRecordedEventAttributes'{_mreaDetails
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _mreaMarkerName
...
markerRecordedEventAttributes
    ...
    -> MarkerRecordedEventAttributes
markerRecordedEventAttributes pMarkerName_
  pDecisionTaskCompletedEventId_
  = MarkerRecordedEventAttributes'{_mreaDetails =
                                     Nothing,
