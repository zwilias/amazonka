...
data CancelWorkflowExecutionFailedEventAttributes = CancelWorkflowExecutionFailedEventAttributes'{_cCause
                                                                                                  ::
...
cancelWorkflowExecutionFailedEventAttributes
    ...
    -> CancelWorkflowExecutionFailedEventAttributes
cancelWorkflowExecutionFailedEventAttributes pCause_
  pDecisionTaskCompletedEventId_
  = CancelWorkflowExecutionFailedEventAttributes'{_cCause
                                                    = pCause_,
                                                  _cDecisionTaskCompletedEventId
                                                    =
                                                    pDecisionTaskCompletedEventId_}
