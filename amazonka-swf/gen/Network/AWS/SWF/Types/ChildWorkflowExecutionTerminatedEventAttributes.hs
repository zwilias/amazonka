...
data ChildWorkflowExecutionTerminatedEventAttributes = ChildWorkflowExecutionTerminatedEventAttributes'{_cweteaWorkflowExecution
                                                                                                        ::
                                                                                                        !WorkflowExecution,
                                                                                                        _cweteaWorkflowType
                                                                                                        ::
...
childWorkflowExecutionTerminatedEventAttributes
    ...
    -> ChildWorkflowExecutionTerminatedEventAttributes
childWorkflowExecutionTerminatedEventAttributes
  pWorkflowExecution_ pWorkflowType_ pInitiatedEventId_
  pStartedEventId_
  = ChildWorkflowExecutionTerminatedEventAttributes'{_cweteaWorkflowExecution
                                                       = pWorkflowExecution_,
                                                     _cweteaWorkflowType =
                                                       pWorkflowType_,
                                                     _cweteaInitiatedEventId =
