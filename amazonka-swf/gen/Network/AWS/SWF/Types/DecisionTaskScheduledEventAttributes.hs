...
data DecisionTaskScheduledEventAttributes = DecisionTaskScheduledEventAttributes'{_dtseaTaskPriority
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
decisionTaskScheduledEventAttributes pTaskList_
  = DecisionTaskScheduledEventAttributes'{_dtseaTaskPriority
                                            = Nothing,
