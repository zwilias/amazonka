...
data SignalExternalWorkflowExecutionDecisionAttributes = SignalExternalWorkflowExecutionDecisionAttributes'{_sewedaControl
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
                                                                                                            _sewedaInput
...
signalExternalWorkflowExecutionDecisionAttributes
  ...
  = SignalExternalWorkflowExecutionDecisionAttributes'{_sewedaControl
                                                         = Nothing,
