...
data ScheduleActivityTaskDecisionAttributes = ScheduleActivityTaskDecisionAttributes'{_satdaControl
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
scheduleActivityTaskDecisionAttributes
    ...
    -> ScheduleActivityTaskDecisionAttributes
scheduleActivityTaskDecisionAttributes pActivityType_
  pActivityId_
  = ScheduleActivityTaskDecisionAttributes'{_satdaControl
                                              = Nothing,
