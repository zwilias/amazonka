...
data ScheduleLambdaFunctionDecisionAttributes = ScheduleLambdaFunctionDecisionAttributes'{_slfdaControl
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
                                                                                          _slfdaInput
...
scheduleLambdaFunctionDecisionAttributes pId_ pName_
  = ScheduleLambdaFunctionDecisionAttributes'{_slfdaControl
                                                = Nothing,
                                              _slfdaInput = Nothing,
                                              _slfdaStartToCloseTimeout =
                                                Nothing,
