...
data ScheduleActivityTaskFailedEventAttributes = ScheduleActivityTaskFailedEventAttributes'{_satfeaActivityType
                                                                                            ::
                                                                                            !ActivityType,
                                                                                            _satfeaActivityId
                                                                                            ::
...
scheduleActivityTaskFailedEventAttributes
    ...
    -> ScheduleActivityTaskFailedEventAttributes
scheduleActivityTaskFailedEventAttributes
  pActivityType_ pActivityId_ pCause_
  pDecisionTaskCompletedEventId_
  = ScheduleActivityTaskFailedEventAttributes'{_satfeaActivityType
                                                 = pActivityType_,
