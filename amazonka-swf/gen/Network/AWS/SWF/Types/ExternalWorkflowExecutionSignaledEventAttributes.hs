...
data ExternalWorkflowExecutionSignaledEventAttributes = ExternalWorkflowExecutionSignaledEventAttributes'{_eweseaWorkflowExecution
                                                                                                          ::
                                                                                                          !WorkflowExecution,
...
externalWorkflowExecutionSignaledEventAttributes
  ...
  = ExternalWorkflowExecutionSignaledEventAttributes'{_eweseaWorkflowExecution
                                                        = pWorkflowExecution_,
                                                      _eweseaInitiatedEventId =
                                                        pInitiatedEventId_}
