...
data ScheduleLambdaFunctionFailedEventAttributes = ScheduleLambdaFunctionFailedEventAttributes'{_slffeaId
                                                                                                ::
                                                                                                !Text,
                                                                                                _slffeaName
                                                                                                ::
...
scheduleLambdaFunctionFailedEventAttributes
    ...
    -> ScheduleLambdaFunctionFailedEventAttributes
scheduleLambdaFunctionFailedEventAttributes pId_
  pName_ pCause_ pDecisionTaskCompletedEventId_
  = ScheduleLambdaFunctionFailedEventAttributes'{_slffeaId
                                                   = pId_,
                                                 _slffeaName = pName_,
