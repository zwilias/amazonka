...
data TimerCanceledEventAttributes = TimerCanceledEventAttributes'{_tceaTimerId
                                                                  :: !Text,
                                                                  _tceaStartedEventId
                                                                  :: !Integer,
...
timerCanceledEventAttributes
    ...
    -> TimerCanceledEventAttributes
timerCanceledEventAttributes pTimerId_
  pStartedEventId_ pDecisionTaskCompletedEventId_
  = TimerCanceledEventAttributes'{_tceaTimerId =
                                    pTimerId_,
