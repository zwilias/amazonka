...
data LambdaFunctionScheduledEventAttributes = LambdaFunctionScheduledEventAttributes'{_lfseaControl
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
                                                                                      _lfseaInput
...
lambdaFunctionScheduledEventAttributes
    ...
    -> LambdaFunctionScheduledEventAttributes
lambdaFunctionScheduledEventAttributes pId_ pName_
  pDecisionTaskCompletedEventId_
  = LambdaFunctionScheduledEventAttributes'{_lfseaControl
                                              = Nothing,
                                            _lfseaInput = Nothing,
