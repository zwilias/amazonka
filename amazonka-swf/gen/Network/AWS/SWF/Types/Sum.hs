...
instance FromText ActivityTaskTimeoutType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ActivityTaskTimeoutType from value: '" <>
        e <>
...
instance FromText CancelTimerFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CancelTimerFailedCause from value: '" <>
        e <> "'. Accepted values: operation_not_permitted, timer_id_unknown"
...
instance FromText CancelWorkflowExecutionFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CancelWorkflowExecutionFailedCause from value: '" <>
        e <> "'. Accepted values: operation_not_permitted, unhandled_decision"
...
instance FromText ChildPolicy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ChildPolicy from value: '" <>
        e <> "'. Accepted values: abandon, request_cancel, terminate"
...
instance FromText CloseStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CloseStatus from value: '" <>
        e <>
...
instance FromText CompleteWorkflowExecutionFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CompleteWorkflowExecutionFailedCause from value: '" <>
        e <> "'. Accepted values: operation_not_permitted, unhandled_decision"
  ...
  parser =
    takeLowerText >>= \case
      "continue_as_new_workflow_execution_rate_exceeded" ->
        pure CANWEFCContinueAsNewWorkflowExecutionRateExceeded
      "default_child_policy_undefined" ->
        pure CANWEFCDefaultChildPolicyUndefined
      "default_execution_start_to_close_timeout_undefined" ->
        pure CANWEFCDefaultExecutionStartToCloseTimeoutUndefined
      "default_task_list_undefined" -> pure CANWEFCDefaultTaskListUndefined
      "default_task_start_to_close_timeout_undefined" ->
        pure CANWEFCDefaultTaskStartToCloseTimeoutUndefined
      ...
      e ->
        fromTextError $
        "Failure parsing ContinueAsNewWorkflowExecutionFailedCause from value: '" <>
        e <>
...
instance FromText DecisionTaskTimeoutType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DecisionTaskTimeoutType from value: '" <>
        e <> "'. Accepted values: start_to_close"
...
instance FromText DecisionType where
  parser =
    takeLowerText >>= \case
      ...
      "requestcancelexternalworkflowexecution" ->
        pure RequestCancelExternalWorkflowExecution
      ...
      e ->
        fromTextError $
        "Failure parsing DecisionType from value: '" <>
        e <>
...
instance FromText EventType where
  parser =
    takeLowerText >>= \case
      ...
      "childworkflowexecutionterminated" ->
        pure ChildWorkflowExecutionTerminated
      ...
      "continueasnewworkflowexecutionfailed" ->
        pure ContinueAsNewWorkflowExecutionFailed
      ...
      "externalworkflowexecutioncancelrequested" ->
        pure ExternalWorkflowExecutionCancelRequested
      "externalworkflowexecutionsignaled" ->
        pure ExternalWorkflowExecutionSignaled
      ...
      "requestcancelexternalworkflowexecutionfailed" ->
        pure RequestCancelExternalWorkflowExecutionFailed
      "requestcancelexternalworkflowexecutioninitiated" ->
        pure RequestCancelExternalWorkflowExecutionInitiated
      ...
      "signalexternalworkflowexecutioninitiated" ->
        pure SignalExternalWorkflowExecutionInitiated
      "startchildworkflowexecutionfailed" ->
        pure StartChildWorkflowExecutionFailed
      "startchildworkflowexecutioninitiated" ->
        pure StartChildWorkflowExecutionInitiated
      ...
      "workflowexecutioncancelrequested" ->
        pure WorkflowExecutionCancelRequested
...
instance FromText ExecutionStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExecutionStatus from value: '" <>
        e <> "'. Accepted values: closed, open"
...
instance FromText FailWorkflowExecutionFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FailWorkflowExecutionFailedCause from value: '" <>
        e <> "'. Accepted values: operation_not_permitted, unhandled_decision"
...
instance FromText LambdaFunctionTimeoutType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LambdaFunctionTimeoutType from value: '" <>
        e <> "'. Accepted values: start_to_close"
...
instance FromText RecordMarkerFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RecordMarkerFailedCause from value: '" <>
        e <> "'. Accepted values: operation_not_permitted"
...
instance FromText RegistrationStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RegistrationStatus from value: '" <>
        e <> "'. Accepted values: deprecated, registered"
...
instance FromText RequestCancelActivityTaskFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RequestCancelActivityTaskFailedCause from value: '" <>
        e <> "'. Accepted values: activity_id_unknown, operation_not_permitted"
  ...
  parser =
    takeLowerText >>= \case
      ...
      "request_cancel_external_workflow_execution_rate_exceeded" ->
        pure RCEWEFCRequestCancelExternalWorkflowExecutionRateExceeded
      "unknown_external_workflow_execution" ->
        pure RCEWEFCUnknownExternalWorkflowExecution
      e ->
        fromTextError $
        "Failure parsing RequestCancelExternalWorkflowExecutionFailedCause from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      "activity_creation_rate_exceeded" ->
        pure SATFCActivityCreationRateExceeded
      ...
      "default_heartbeat_timeout_undefined" ->
        pure SATFCDefaultHeartbeatTimeoutUndefined
      "default_schedule_to_close_timeout_undefined" ->
        pure SATFCDefaultScheduleToCloseTimeoutUndefined
      "default_schedule_to_start_timeout_undefined" ->
        pure SATFCDefaultScheduleToStartTimeoutUndefined
      ...
      e ->
        fromTextError $
        "Failure parsing ScheduleActivityTaskFailedCause from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      "lambda_function_creation_rate_exceeded" ->
        pure LambdaFunctionCreationRateExceeded
      "lambda_service_not_available_in_region" ->
        pure LambdaServiceNotAvailableInRegion
      "open_lambda_functions_limit_exceeded" ->
        pure OpenLambdaFunctionsLimitExceeded
      e ->
        fromTextError $
        "Failure parsing ScheduleLambdaFunctionFailedCause from value: '" <>
        e <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      "signal_external_workflow_execution_rate_exceeded" ->
        pure SEWEFCSignalExternalWorkflowExecutionRateExceeded
      "unknown_external_workflow_execution" ->
        pure SEWEFCUnknownExternalWorkflowExecution
      e ->
        fromTextError $
        "Failure parsing SignalExternalWorkflowExecutionFailedCause from value: '" <>
        e <>
...
instance FromText StartChildWorkflowExecutionFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      "default_execution_start_to_close_timeout_undefined" ->
        pure SCWEFCDefaultExecutionStartToCloseTimeoutUndefined
      ...
      e ->
        fromTextError $
        "Failure parsing StartChildWorkflowExecutionFailedCause from value: '" <>
        e <>
...
instance FromText StartLambdaFunctionFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StartLambdaFunctionFailedCause from value: '" <>
        e <> "'. Accepted values: assume_role_failed"
...
instance FromText StartTimerFailedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StartTimerFailedCause from value: '" <>
        e <>
...
instance FromText WorkflowExecutionCancelRequestedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WorkflowExecutionCancelRequestedCause from value: '" <>
        e <> "'. Accepted values: child_policy_applied"
...
instance FromText WorkflowExecutionTerminatedCause where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WorkflowExecutionTerminatedCause from value: '" <>
        e <>
...
instance FromText WorkflowExecutionTimeoutType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing WorkflowExecutionTimeoutType from value: '" <>
        e <> "'. Accepted values: start_to_close"
