...
data ChildWorkflowExecutionStartedEventAttributes = ChildWorkflowExecutionStartedEventAttributes'{_cweseaWorkflowExecution
                                                                                                  ::
                                                                                                  !WorkflowExecution,
                                                                                                  _cweseaWorkflowType
                                                                                                  ::
...
childWorkflowExecutionStartedEventAttributes
  ...
  = ChildWorkflowExecutionStartedEventAttributes'{_cweseaWorkflowExecution
                                                    = pWorkflowExecution_,
                                                  _cweseaWorkflowType =
                                                    pWorkflowType_,
                                                  _cweseaInitiatedEventId =
