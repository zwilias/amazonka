...
data CancelTimerFailedEventAttributes = CancelTimerFailedEventAttributes'{_ctfeaTimerId
                                                                          ::
                                                                          !Text,
                                                                          _ctfeaCause
                                                                          ::
...
cancelTimerFailedEventAttributes
    ...
    -> CancelTimerFailedEventAttributes
cancelTimerFailedEventAttributes pTimerId_ pCause_
  pDecisionTaskCompletedEventId_
  = CancelTimerFailedEventAttributes'{_ctfeaTimerId =
                                        pTimerId_,
                                      _ctfeaCause = pCause_,
                                      _ctfeaDecisionTaskCompletedEventId =
                                        pDecisionTaskCompletedEventId_}
