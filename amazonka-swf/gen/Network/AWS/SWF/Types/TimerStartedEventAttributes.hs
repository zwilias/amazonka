...
data TimerStartedEventAttributes = TimerStartedEventAttributes'{_tseaControl
                                                                ::
                                                                !(Maybe Text),
                                                                _tseaTimerId ::
                                                                !Text,
...
timerStartedEventAttributes
    ...
    -> TimerStartedEventAttributes
timerStartedEventAttributes pTimerId_
  pStartToFireTimeout_ pDecisionTaskCompletedEventId_
  = TimerStartedEventAttributes'{_tseaControl =
                                   Nothing,
