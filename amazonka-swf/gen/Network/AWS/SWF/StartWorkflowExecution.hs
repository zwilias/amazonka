...
sTaskStartToCloseTimeout =
  lens _sTaskStartToCloseTimeout (\s a -> s {_sTaskStartToCloseTimeout = a})
...
sExecutionStartToCloseTimeout =
  lens
    ...
    (\s a -> s {_sExecutionStartToCloseTimeout = a})
...
swersResponseStatus =
  lens _swersResponseStatus (\s a -> s {_swersResponseStatus = a})
