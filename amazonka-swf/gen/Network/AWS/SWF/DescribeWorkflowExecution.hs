...
instance ToJSON DescribeWorkflowExecution where
  toJSON DescribeWorkflowExecution' {..} =
    object
      (catMaybes
         [Just ("domain" .= _dweDomain), Just ("execution" .= _dweExecution)])
...
dwersLatestActivityTaskTimestamp ::
     Lens' DescribeWorkflowExecutionResponse (Maybe UTCTime)
dwersLatestActivityTaskTimestamp =
  lens
...
dwersLatestExecutionContext ::
     Lens' DescribeWorkflowExecutionResponse (Maybe Text)
dwersLatestExecutionContext =
  lens
...
dwersResponseStatus =
  lens _dwersResponseStatus (\s a -> s {_dwersResponseStatus = a})

-- | Information about the workflow execution.
dwersExecutionInfo ::
     Lens' DescribeWorkflowExecutionResponse WorkflowExecutionInfo
dwersExecutionInfo =
  lens _dwersExecutionInfo (\s a -> s {_dwersExecutionInfo = a})

-- | The configuration settings for this workflow execution including timeout values, tasklist etc.
dwersExecutionConfiguration ::
     Lens' DescribeWorkflowExecutionResponse WorkflowExecutionConfiguration
dwersExecutionConfiguration =
  lens
...
dwersOpenCounts ::
     Lens' DescribeWorkflowExecutionResponse WorkflowExecutionOpenCounts
