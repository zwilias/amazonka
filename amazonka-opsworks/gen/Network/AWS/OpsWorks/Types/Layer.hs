...
data Layer = Layer'{_lCustomInstanceProfileARN ::
                    !(Maybe Text),
                    ...
                    _lARN :: !(Maybe Text), _lCreatedAt :: !(Maybe Text),
...
layer
    :: Layer
layer
  = Layer'{_lCustomInstanceProfileARN = Nothing,
           ...
           _lARN = Nothing, _lCreatedAt = Nothing,
           _lShortname = Nothing, _lDefaultRecipes = Nothing,
           _lCustomRecipes = Nothing, _lCustomJSON = Nothing,
           _lVolumeConfigurations = Nothing,
           _lEnableAutoHealing = Nothing, _lPackages = Nothing,
           _lAttributes = Nothing, _lName = Nothing,
           _lAutoAssignPublicIPs = Nothing, _lType = Nothing,
           _lUseEBSOptimizedInstances = Nothing,
           _lStackId = Nothing, _lLayerId = Nothing,
