...
avConfigurationManager =
  lens _avConfigurationManager (\s a -> s {_avConfigurationManager = a})
...
instance FromJSON AgentVersion where
  parseJSON =
    withObject
      "AgentVersion"
      (\x ->
         AgentVersion' <$> (x .:? "Version") <*> (x .:? "ConfigurationManager"))
...
appEnvironment =
  lens _appEnvironment (\s a -> s {_appEnvironment = a}) . _Default . _Coerce
...
appDataSources =
  lens _appDataSources (\s a -> s {_appDataSources = a}) . _Default . _Coerce
...
appAttributes =
  lens _appAttributes (\s a -> s {_appAttributes = a}) . _Default . _Map
...
instance FromJSON AutoScalingThresholds where
  parseJSON =
    withObject
      "AutoScalingThresholds"
      (\x ->
         AutoScalingThresholds' <$> (x .:? "InstanceCount") <*>
         (x .:? "IgnoreMetricsTime") <*>
         (x .:? "LoadThreshold") <*>
...
instance FromJSON ChefConfiguration where
  parseJSON =
    withObject
      "ChefConfiguration"
      (\x ->
         ChefConfiguration' <$> (x .:? "BerkshelfVersion") <*>
         (x .:? "ManageBerkshelf"))
...
cwlcLogStreams =
  lens _cwlcLogStreams (\s a -> s {_cwlcLogStreams = a}) . _Default . _Coerce
...
instance FromJSON CloudWatchLogsConfiguration where
  parseJSON =
    withObject
      "CloudWatchLogsConfiguration"
      (\x ->
         CloudWatchLogsConfiguration' <$> (x .:? "Enabled") <*>
         (x .:? "LogStreams" .!= mempty))
...
cwllsFileFingerprintLines =
  lens _cwllsFileFingerprintLines (\s a -> s {_cwllsFileFingerprintLines = a})

-- | Specifies the time duration for the batching of log events. The minimum value is 5000ms and default value is 5000ms.
cwllsBufferDuration :: Lens' CloudWatchLogsLogStream (Maybe Int)
cwllsBufferDuration =
  lens _cwllsBufferDuration (\s a -> s {_cwllsBufferDuration = a})
...
cwllsMultiLineStartPattern =
  lens _cwllsMultiLineStartPattern (\s a -> s {_cwllsMultiLineStartPattern = a})

-- | Specifies where to start to read data (start_of_file or end_of_file). The default is start_of_file. This setting is only used if there is no state persisted for that log stream.
cwllsInitialPosition ::
     Lens' CloudWatchLogsLogStream (Maybe CloudWatchLogsInitialPosition)
cwllsInitialPosition =
  lens _cwllsInitialPosition (\s a -> s {_cwllsInitialPosition = a})
...
cwllsDatetimeFormat =
  lens _cwllsDatetimeFormat (\s a -> s {_cwllsDatetimeFormat = a})
...
instance FromJSON CloudWatchLogsLogStream where
  parseJSON =
    withObject
      "CloudWatchLogsLogStream"
      (\x ->
         CloudWatchLogsLogStream' <$> (x .:? "BatchCount") <*>
...
instance FromJSON Command where
  parseJSON =
    withObject
      "Command"
      (\x ->
         Command' <$> (x .:? "DeploymentId") <*> (x .:? "InstanceId") <*>
         (x .:? "Status") <*>
         (x .:? "LogUrl") <*>
         (x .:? "CreatedAt") <*>
         (x .:? "CommandId") <*>
...
instance FromJSON DataSource where
  parseJSON =
    withObject
      "DataSource"
      (\x ->
         DataSource' <$> (x .:? "Arn") <*> (x .:? "DatabaseName") <*>
         (x .:? "Type"))
...
dInstanceIds =
  lens _dInstanceIds (\s a -> s {_dInstanceIds = a}) . _Default . _Coerce
...
instance FromJSON DeploymentCommand where
  parseJSON =
    withObject
      "DeploymentCommand"
      (\x -> DeploymentCommand' <$> (x .:? "Args" .!= mempty) <*> (x .: "Name"))
...
instance ToJSON DeploymentCommand where
  toJSON DeploymentCommand' {..} =
    object (catMaybes [("Args" .=) <$> _dcArgs, Just ("Name" .= _dcName)])
...
instance FromJSON EBSBlockDevice where
  parseJSON =
    withObject
      "EBSBlockDevice"
      (\x ->
         EBSBlockDevice' <$> (x .:? "DeleteOnTermination") <*>
         (x .:? "VolumeSize") <*>
         (x .:? "Iops") <*>
         (x .:? "VolumeType") <*>
         (x .:? "SnapshotId"))
...
instance FromJSON EcsCluster where
  parseJSON =
    withObject
      "EcsCluster"
      (\x ->
         EcsCluster' <$> (x .:? "EcsClusterArn") <*> (x .:? "EcsClusterName") <*>
         (x .:? "RegisteredAt") <*>
         (x .:? "StackId"))
...
instance FromJSON ElasticIP where
  parseJSON =
    withObject
      "ElasticIP"
      (\x ->
         ElasticIP' <$> (x .:? "InstanceId") <*> (x .:? "Domain") <*>
         (x .:? "Ip") <*>
         (x .:? "Name") <*>
         (x .:? "Region"))
...
elbSubnetIds =
  lens _elbSubnetIds (\s a -> s {_elbSubnetIds = a}) . _Default . _Coerce
...
elbElasticLoadBalancerName =
  lens _elbElasticLoadBalancerName (\s a -> s {_elbElasticLoadBalancerName = a})
...
instance FromJSON ElasticLoadBalancer where
  parseJSON =
    withObject
      "ElasticLoadBalancer"
      (\x ->
         ElasticLoadBalancer' <$> (x .:? "SubnetIds" .!= mempty) <*>
         (x .:? "VpcId") <*>
...
instance FromJSON EnvironmentVariable where
  parseJSON =
    withObject
      "EnvironmentVariable"
      (\x ->
         EnvironmentVariable' <$> (x .:? "Secure") <*> (x .: "Key") <*>
         (x .: "Value"))
...
iSSHHostRsaKeyFingerprint =
  lens _iSSHHostRsaKeyFingerprint (\s a -> s {_iSSHHostRsaKeyFingerprint = a})
...
iSSHHostDsaKeyFingerprint =
  lens _iSSHHostDsaKeyFingerprint (\s a -> s {_iSSHHostDsaKeyFingerprint = a})
...
iEcsContainerInstanceARN =
  lens _iEcsContainerInstanceARN (\s a -> s {_iEcsContainerInstanceARN = a})
...
instance FromJSON Instance where
  parseJSON =
    withObject
      "Instance"
      (\x ->
         Instance' <$> (x .:? "PrivateDns") <*> (x .:? "ReportedAgentVersion") <*>
         (x .:? "InstanceId") <*>
         (x .:? "Status") <*>
         (x .:? "PrivateIp") <*>
...
instance ToJSON InstanceIdentity where
  toJSON InstanceIdentity' {..} =
    object
      (catMaybes
         [("Signature" .=) <$> _iiSignature, ("Document" .=) <$> _iiDocument])
...
instance FromJSON InstancesCount where
  parseJSON =
    withObject
      "InstancesCount"
      (\x ->
         InstancesCount' <$> (x .:? "Terminating") <*> (x .:? "Pending") <*>
         (x .:? "Online") <*>
         (x .:? "Unassigning") <*>
         (x .:? "Deregistering") <*>
         (x .:? "RunningSetup") <*>
...
lCustomInstanceProfileARN =
  lens _lCustomInstanceProfileARN (\s a -> s {_lCustomInstanceProfileARN = a})
...
lCloudWatchLogsConfiguration =
  lens
    ...
    (\s a -> s {_lCloudWatchLogsConfiguration = a})
...
lUseEBSOptimizedInstances =
  lens _lUseEBSOptimizedInstances (\s a -> s {_lUseEBSOptimizedInstances = a})
...
lDefaultSecurityGroupNames =
  lens _lDefaultSecurityGroupNames (\s a -> s {_lDefaultSecurityGroupNames = a}) .
  _Default . _Coerce
...
instance FromJSON Layer where
  parseJSON =
    withObject
      "Layer"
      (\x ->
         Layer' <$> (x .:? "CustomInstanceProfileArn") <*>
...
lecShutdown ::
     Lens' LifecycleEventConfiguration (Maybe ShutdownEventConfiguration)
...
lbascUpScaling ::
     Lens' LoadBasedAutoScalingConfiguration (Maybe AutoScalingThresholds)
...
instance FromJSON LoadBasedAutoScalingConfiguration where
  parseJSON =
    withObject
      "LoadBasedAutoScalingConfiguration"
      (\x ->
         LoadBasedAutoScalingConfiguration' <$> (x .:? "UpScaling") <*>
         (x .:? "Enable") <*>
         (x .:? "DownScaling") <*>
         (x .:? "LayerId"))
...
osConfigurationManagers ::
     Lens' OperatingSystem [OperatingSystemConfigurationManager]
osConfigurationManagers =
  lens _osConfigurationManagers (\s a -> s {_osConfigurationManagers = a}) .
  _Default . _Coerce
...
instance FromJSON OperatingSystem where
  parseJSON =
    withObject
      "OperatingSystem"
      (\x ->
         OperatingSystem' <$> (x .:? "ReportedVersion") <*> (x .:? "Supported") <*>
         (x .:? "Name") <*>
         (x .:? "Id") <*>
...
data OperatingSystemConfigurationManager =
...
instance FromJSON OperatingSystemConfigurationManager where
  parseJSON =
    withObject
      "OperatingSystemConfigurationManager"
      (\x ->
         OperatingSystemConfigurationManager' <$> (x .:? "Name") <*>
         (x .:? "Version"))
...
instance FromJSON Permission where
  parseJSON =
    withObject
      "Permission"
      (\x ->
         Permission' <$> (x .:? "IamUserArn") <*> (x .:? "AllowSudo") <*>
         (x .:? "StackId") <*>
         (x .:? "Level") <*>
         (x .:? "AllowSsh"))
...
raiaAvailabilityZone =
  lens _raiaAvailabilityZone (\s a -> s {_raiaAvailabilityZone = a})
...
instance FromJSON RDSDBInstance where
  parseJSON =
    withObject
      "RDSDBInstance"
      (\x ->
         RDSDBInstance' <$> (x .:? "RdsDbInstanceArn") <*> (x .:? "DbUser") <*>
         (x .:? "MissingOnRds") <*>
         (x .:? "Engine") <*>
         (x .:? "Address") <*>
...
instance FromJSON SSLConfiguration where
  parseJSON =
    withObject
      "SSLConfiguration"
      (\x ->
         SSLConfiguration' <$> (x .:? "PrivateKey") <*> (x .:? "Certificate") <*>
         (x .:? "Chain"))
...
instance FromJSON SelfUserProfile where
  parseJSON =
    withObject
      "SelfUserProfile"
      (\x ->
         SelfUserProfile' <$> (x .:? "SshPublicKey") <*> (x .:? "SshUsername") <*>
         (x .:? "IamUserArn") <*>
         (x .:? "Name"))
...
instance FromJSON ServiceError' where
  parseJSON =
    withObject
      "ServiceError'"
      (\x ->
         ServiceError'' <$> (x .:? "InstanceId") <*> (x .:? "CreatedAt") <*>
         (x .:? "ServiceErrorId") <*>
         (x .:? "Type") <*>
         (x .:? "StackId") <*>
         (x .:? "Message"))
...
secDelayUntilElbConnectionsDrained ::
     Lens' ShutdownEventConfiguration (Maybe Bool)
secDelayUntilElbConnectionsDrained =
  lens
...
instance FromJSON ShutdownEventConfiguration where
  parseJSON =
    withObject
      "ShutdownEventConfiguration"
      (\x ->
         ShutdownEventConfiguration' <$> (x .:? "ExecutionTimeout") <*>
...
instance FromJSON Source where
  parseJSON =
    withObject
      "Source"
      (\x ->
         Source' <$> (x .:? "Url") <*> (x .:? "Username") <*> (x .:? "SshKey") <*>
         (x .:? "Password") <*>
         (x .:? "Type") <*>
         (x .:? "Revision"))
...
sDefaultInstanceProfileARN =
  lens _sDefaultInstanceProfileARN (\s a -> s {_sDefaultInstanceProfileARN = a})
...
sDefaultAvailabilityZone =
  lens _sDefaultAvailabilityZone (\s a -> s {_sDefaultAvailabilityZone = a})
...
sUseOpsworksSecurityGroups =
  lens _sUseOpsworksSecurityGroups (\s a -> s {_sUseOpsworksSecurityGroups = a})
...
instance FromJSON Stack where
  parseJSON =
    withObject
      "Stack"
      (\x ->
         Stack' <$> (x .:? "DefaultInstanceProfileArn") <*>
         (x .:? "ServiceRoleArn") <*>
...
instance FromJSON StackConfigurationManager where
  parseJSON =
    withObject
      "StackConfigurationManager"
      (\x -> StackConfigurationManager' <$> (x .:? "Name") <*> (x .:? "Version"))
...
instance ToJSON StackConfigurationManager where
  toJSON StackConfigurationManager' {..} =
    object
      (catMaybes [("Name" .=) <$> _scmName, ("Version" .=) <$> _scmVersion])
...
instance FromJSON StackSummary where
  parseJSON =
    withObject
      "StackSummary"
      (\x ->
         StackSummary' <$> (x .:? "Arn") <*> (x .:? "AppsCount") <*>
         (x .:? "Name") <*>
         (x .:? "StackId") <*>
         (x .:? "LayersCount") <*>
         (x .:? "InstancesCount"))
...
instance FromJSON TemporaryCredential where
  parseJSON =
    withObject
      "TemporaryCredential"
      (\x ->
         TemporaryCredential' <$> (x .:? "InstanceId") <*> (x .:? "Username") <*>
         (x .:? "Password") <*>
         (x .:? "ValidForInMinutes"))
...
tbascAutoScalingSchedule ::
     Lens' TimeBasedAutoScalingConfiguration (Maybe WeeklyAutoScalingSchedule)
tbascAutoScalingSchedule =
  lens _tbascAutoScalingSchedule (\s a -> s {_tbascAutoScalingSchedule = a})
...
instance FromJSON TimeBasedAutoScalingConfiguration where
  parseJSON =
    withObject
      "TimeBasedAutoScalingConfiguration"
      (\x ->
         TimeBasedAutoScalingConfiguration' <$> (x .:? "InstanceId") <*>
...
instance FromJSON UserProfile where
  parseJSON =
    withObject
      "UserProfile"
      (\x ->
         UserProfile' <$> (x .:? "AllowSelfManagement") <*>
         (x .:? "SshPublicKey") <*>
         (x .:? "SshUsername") <*>
         (x .:? "IamUserArn") <*>
         (x .:? "Name"))
...
instance FromJSON VolumeConfiguration where
  parseJSON =
    withObject
      "VolumeConfiguration"
      (\x ->
         VolumeConfiguration' <$> (x .:? "Iops") <*> (x .:? "RaidLevel") <*>
         (x .:? "Encrypted") <*>
         (x .:? "VolumeType") <*>
         (x .: "MountPoint") <*>
         (x .: "NumberOfDisks") <*>
...
wassThursday =
  lens _wassThursday (\s a -> s {_wassThursday = a}) . _Default . _Map

-- | The schedule for Wednesday.
wassWednesday :: Lens' WeeklyAutoScalingSchedule (HashMap Text Text)
wassWednesday =
  lens _wassWednesday (\s a -> s {_wassWednesday = a}) . _Default . _Map

-- | The schedule for Saturday.
wassSaturday :: Lens' WeeklyAutoScalingSchedule (HashMap Text Text)
wassSaturday =
  lens _wassSaturday (\s a -> s {_wassSaturday = a}) . _Default . _Map
...
instance FromJSON WeeklyAutoScalingSchedule where
  parseJSON =
    withObject
      "WeeklyAutoScalingSchedule"
      (\x ->
         WeeklyAutoScalingSchedule' <$> (x .:? "Thursday" .!= mempty) <*>
         (x .:? "Wednesday" .!= mempty) <*>
         (x .:? "Saturday" .!= mempty) <*>
         (x .:? "Monday" .!= mempty) <*>
         (x .:? "Friday" .!= mempty) <*>
