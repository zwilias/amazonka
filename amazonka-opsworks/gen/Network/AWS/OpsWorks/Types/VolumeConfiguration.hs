...
data VolumeConfiguration = VolumeConfiguration'{_vcIOPS
                                                :: !(Maybe Int),
...
volumeConfiguration
    ...
    -> Int -- ^ 'vcSize'
    -> VolumeConfiguration
volumeConfiguration pMountPoint_ pNumberOfDisks_
  pSize_
  = VolumeConfiguration'{_vcIOPS = Nothing,
                         _vcRAIdLevel = Nothing, _vcEncrypted = Nothing,
                         _vcVolumeType = Nothing,
                         _vcMountPoint = pMountPoint_,
                         _vcNumberOfDisks = pNumberOfDisks_, _vcSize = pSize_}
