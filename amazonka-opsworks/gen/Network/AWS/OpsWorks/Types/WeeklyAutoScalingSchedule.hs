...
data WeeklyAutoScalingSchedule = WeeklyAutoScalingSchedule'{_wassThursday
                                                            ::
                                                            !(Maybe
                                                                (Map Text
                                                                   Text)),
...
weeklyAutoScalingSchedule
    :: WeeklyAutoScalingSchedule
weeklyAutoScalingSchedule
  = WeeklyAutoScalingSchedule'{_wassThursday = Nothing,
                               _wassWednesday = Nothing,
                               _wassSaturday = Nothing, _wassMonday = Nothing,
                               _wassFriday = Nothing, _wassSunday = Nothing,
