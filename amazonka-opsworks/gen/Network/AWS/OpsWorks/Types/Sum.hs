...
instance FromText AppAttributesKeys where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AppAttributesKeys from value: '" <>
        e <>
...
instance FromText AppType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AppType from value: '" <>
        e <>
...
instance FromText Architecture where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Architecture from value: '" <>
...
instance FromText AutoScalingType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutoScalingType from value: '" <>
        e <> "'. Accepted values: load, timer"
...
instance FromText CloudWatchLogsEncoding where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CloudWatchLogsEncoding from value: '" <>
        e <>
...
instance FromText CloudWatchLogsInitialPosition where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CloudWatchLogsInitialPosition from value: '" <>
        e <> "'. Accepted values: end_of_file, start_of_file"
...
instance FromText CloudWatchLogsTimeZone where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CloudWatchLogsTimeZone from value: '" <>
        e <> "'. Accepted values: local, utc"
...
instance FromText DeploymentCommandName where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeploymentCommandName from value: '" <>
        e <>
...
instance FromText LayerAttributesKeys where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LayerAttributesKeys from value: '" <>
        e <>
...
instance FromText LayerType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LayerType from value: '" <>
        e <>
...
instance FromText RootDeviceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RootDeviceType from value: '" <>
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: archive, git, s3, svn"
...
instance FromText StackAttributesKeys where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StackAttributesKeys from value: '" <>
        e <> "'. Accepted values: color"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: gp2, io1, standard"
