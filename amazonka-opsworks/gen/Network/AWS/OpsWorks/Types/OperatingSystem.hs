...
data OperatingSystem = OperatingSystem'{_osReportedVersion
                                        :: !(Maybe Text),
...
operatingSystem
    :: OperatingSystem
operatingSystem
  = OperatingSystem'{_osReportedVersion = Nothing,
                     _osSupported = Nothing, _osName = Nothing,
                     _osId = Nothing, _osConfigurationManagers = Nothing,
                     _osType = Nothing, _osReportedName = Nothing}
