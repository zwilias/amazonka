...
data ElasticIP = ElasticIP'{_eiInstanceId ::
                            !(Maybe Text),
                            _eiDomain :: !(Maybe Text), _eiIP :: !(Maybe Text),
                            _eiName :: !(Maybe Text),
...
elasticIP
    :: ElasticIP
elasticIP
  = ElasticIP'{_eiInstanceId = Nothing,
               _eiDomain = Nothing, _eiIP = Nothing,
               _eiName = Nothing, _eiRegion = Nothing}
