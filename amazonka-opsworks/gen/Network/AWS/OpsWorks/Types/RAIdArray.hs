...
data RAIdArray = RAIdArray'{_raiaInstanceId ::
                            !(Maybe Text),
                            _raiaSize :: !(Maybe Int),
                            _raiaIOPS :: !(Maybe Int),
...
rAIdArray
    :: RAIdArray
rAIdArray
  = RAIdArray'{_raiaInstanceId = Nothing,
               _raiaSize = Nothing, _raiaIOPS = Nothing,
               _raiaCreatedAt = Nothing, _raiaRAIdLevel = Nothing,
               _raiaDevice = Nothing, _raiaNumberOfDisks = Nothing,
               _raiaAvailabilityZone = Nothing, _raiaName = Nothing,
               _raiaRAIdArrayId = Nothing,
               _raiaVolumeType = Nothing, _raiaStackId = Nothing,
