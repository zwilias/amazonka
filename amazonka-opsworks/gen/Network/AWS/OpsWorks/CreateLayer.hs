...
clCustomInstanceProfileARN =
  lens _clCustomInstanceProfileARN (\s a -> s {_clCustomInstanceProfileARN = a})

-- | An array containing the layer custom security group IDs.
clCustomSecurityGroupIds :: Lens' CreateLayer [Text]
clCustomSecurityGroupIds =
  lens _clCustomSecurityGroupIds (\s a -> s {_clCustomSecurityGroupIds = a}) .
  _Default . _Coerce
...
clCloudWatchLogsConfiguration ::
     Lens' CreateLayer (Maybe CloudWatchLogsConfiguration)
clCloudWatchLogsConfiguration =
  lens
    _clCloudWatchLogsConfiguration
    (\s a -> s {_clCloudWatchLogsConfiguration = a})
...
clAttributes =
  lens _clAttributes (\s a -> s {_clAttributes = a}) . _Default . _Map
...
clUseEBSOptimizedInstances =
  lens _clUseEBSOptimizedInstances (\s a -> s {_clUseEBSOptimizedInstances = a})
  ...
  toJSON CreateLayer' {..} =
    object
      (catMaybes
         ...
         , ("CloudWatchLogsConfiguration" .=) <$> _clCloudWatchLogsConfiguration
