...
-- | Undocumented member.
dosrsOperatingSystems ::
     Lens' DescribeOperatingSystemsResponse [OperatingSystem]
dosrsOperatingSystems =
  lens _dosrsOperatingSystems (\s a -> s {_dosrsOperatingSystems = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dosrsResponseStatus :: Lens' DescribeOperatingSystemsResponse Int
dosrsResponseStatus =
  lens _dosrsResponseStatus (\s a -> s {_dosrsResponseStatus = a})
