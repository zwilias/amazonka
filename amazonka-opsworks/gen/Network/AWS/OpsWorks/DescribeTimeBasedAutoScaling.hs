...
dtbasInstanceIds =
  lens _dtbasInstanceIds (\s a -> s {_dtbasInstanceIds = a}) . _Coerce
...
dtbasrsTimeBasedAutoScalingConfigurations ::
     Lens' DescribeTimeBasedAutoScalingResponse [TimeBasedAutoScalingConfiguration]
dtbasrsTimeBasedAutoScalingConfigurations =
  lens
...
dtbasrsResponseStatus =
  lens _dtbasrsResponseStatus (\s a -> s {_dtbasrsResponseStatus = a})
