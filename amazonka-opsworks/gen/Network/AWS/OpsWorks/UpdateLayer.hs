...
ulCustomInstanceProfileARN =
  lens _ulCustomInstanceProfileARN (\s a -> s {_ulCustomInstanceProfileARN = a})

-- | An array containing the layer's custom security group IDs.
ulCustomSecurityGroupIds :: Lens' UpdateLayer [Text]
ulCustomSecurityGroupIds =
  lens _ulCustomSecurityGroupIds (\s a -> s {_ulCustomSecurityGroupIds = a}) .
  _Default . _Coerce
...
ulCloudWatchLogsConfiguration ::
     Lens' UpdateLayer (Maybe CloudWatchLogsConfiguration)
ulCloudWatchLogsConfiguration =
  lens
    _ulCloudWatchLogsConfiguration
    (\s a -> s {_ulCloudWatchLogsConfiguration = a})
...
ulAttributes =
  lens _ulAttributes (\s a -> s {_ulAttributes = a}) . _Default . _Map
...
ulUseEBSOptimizedInstances =
  lens _ulUseEBSOptimizedInstances (\s a -> s {_ulUseEBSOptimizedInstances = a})
  ...
  toJSON UpdateLayer' {..} =
    object
      (catMaybes
         ...
         , ("CloudWatchLogsConfiguration" .=) <$> _ulCloudWatchLogsConfiguration
