...
cDefaultInstanceProfileARN =
  lens _cDefaultInstanceProfileARN (\s a -> s {_cDefaultInstanceProfileARN = a})

-- | A list of source stack app IDs to be included in the cloned stack.
cCloneAppIds :: Lens' CloneStack [Text]
cCloneAppIds =
  lens _cCloneAppIds (\s a -> s {_cCloneAppIds = a}) . _Default . _Coerce
...
cDefaultRootDeviceType =
  lens _cDefaultRootDeviceType (\s a -> s {_cDefaultRootDeviceType = a})
...
cChefConfiguration =
  lens _cChefConfiguration (\s a -> s {_cChefConfiguration = a})
...
cDefaultSSHKeyName =
  lens _cDefaultSSHKeyName (\s a -> s {_cDefaultSSHKeyName = a})
...
cCustomCookbooksSource =
  lens _cCustomCookbooksSource (\s a -> s {_cCustomCookbooksSource = a})
...
cDefaultAvailabilityZone =
  lens _cDefaultAvailabilityZone (\s a -> s {_cDefaultAvailabilityZone = a})
...
cUseOpsworksSecurityGroups =
  lens _cUseOpsworksSecurityGroups (\s a -> s {_cUseOpsworksSecurityGroups = a})

-- | Whether to use custom cookbooks.
cUseCustomCookbooks :: Lens' CloneStack (Maybe Bool)
cUseCustomCookbooks =
  lens _cUseCustomCookbooks (\s a -> s {_cUseCustomCookbooks = a})
...
cConfigurationManager =
  lens _cConfigurationManager (\s a -> s {_cConfigurationManager = a})
