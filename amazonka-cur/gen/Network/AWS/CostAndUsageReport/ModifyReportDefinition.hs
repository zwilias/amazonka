...
instance AWSRequest ModifyReportDefinition where
        type Rs ModifyReportDefinition =
             ModifyReportDefinitionResponse
...
instance Hashable ModifyReportDefinition where

instance NFData ModifyReportDefinition where
...
instance NFData ModifyReportDefinitionResponse where
