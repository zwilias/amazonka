...
data ReportDefinition = ReportDefinition'{_rdReportVersioning
...
reportDefinition
    ...
    -> ReportDefinition
reportDefinition pReportName_ pTimeUnit_ pFormat_
  pCompression_ pS3Bucket_ pS3Prefix_ pS3Region_
  = ReportDefinition'{_rdReportVersioning = Nothing,
                      _rdAdditionalArtifacts = Nothing,
                      _rdRefreshClosedReports = Nothing,
                      _rdReportName = pReportName_,
                      _rdTimeUnit = pTimeUnit_, _rdFormat = pFormat_,
                      _rdCompression = pCompression_,
                      _rdAdditionalSchemaElements = mempty,
                      _rdS3Bucket = pS3Bucket_, _rdS3Prefix = pS3Prefix_,
