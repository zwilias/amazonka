...
data StackSet = StackSet'{_ssStatus ::
...
stackSet
    :: StackSet
stackSet
  = StackSet'{_ssStatus = Nothing,
              _ssAdministrationRoleARN = Nothing,
              _ssStackSetARN = Nothing, _ssParameters = Nothing,
              _ssTemplateBody = Nothing, _ssStackSetName = Nothing,
              _ssDescription = Nothing, _ssCapabilities = Nothing,
              _ssTags = Nothing, _ssStackSetId = Nothing}
