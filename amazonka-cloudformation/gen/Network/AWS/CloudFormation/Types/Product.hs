...
instance FromXML AccountGateResult where
  parseXML x =
    AccountGateResult' <$> (x .@? "Status") <*> (x .@? "StatusReason")
...
instance FromXML Change where
  parseXML x = Change' <$> (x .@? "ResourceChange") <*> (x .@? "Type")
...
cCreationTime =
  lens _cCreationTime (\s a -> s {_cCreationTime = a}) . mapping _Time
...
instance FromXML ChangeSetSummary where
  parseXML x =
    ChangeSetSummary' <$> (x .@? "CreationTime") <*> (x .@? "Status") <*>
    (x .@? "ChangeSetName") <*>
    (x .@? "ExecutionStatus") <*>
    (x .@? "ChangeSetId") <*>
    (x .@? "StatusReason") <*>
...
instance FromXML Export where
  parseXML x =
    Export' <$> (x .@? "Value") <*> (x .@? "ExportingStackId") <*>
    (x .@? "Name")
...
instance FromXML Output where
  parseXML x =
    Output' <$> (x .@? "OutputValue") <*> (x .@? "OutputKey") <*>
    (x .@? "ExportName") <*>
    (x .@? "Description")
...
instance FromXML Parameter where
  parseXML x =
    Parameter' <$> (x .@? "ParameterValue") <*> (x .@? "ResolvedValue") <*>
    (x .@? "ParameterKey") <*>
    (x .@? "UsePreviousValue")
...
instance FromXML ParameterDeclaration where
  parseXML x =
    ParameterDeclaration' <$> (x .@? "ParameterKey") <*> (x .@? "ParameterType") <*>
...
instance FromXML ResourceChangeDetail where
  parseXML x =
    ResourceChangeDetail' <$> (x .@? "CausingEntity") <*> (x .@? "ChangeSource") <*>
    (x .@? "Evaluation") <*>
    (x .@? "Target")
...
rcRollbackTriggers =
  lens _rcRollbackTriggers (\s a -> s {_rcRollbackTriggers = a}) .
  _Default . _Coerce

-- | The amount of time, in minutes, during which CloudFormation should monitor all the rollback triggers after the stack creation or update operation deploys all necessary resources. The default is 0 minutes. If you specify a monitoring period but do not specify any rollback triggers, CloudFormation still waits the specified period of time before cleaning up old resources after update operations. You can use this monitoring period to perform any manual stack validation desired, and manually cancel the stack creation or update (using <http://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_CancelUpdateStack.html CancelUpdateStack> , for example) as necessary. If you specify 0 for this parameter, CloudFormation still monitors the specified rollback triggers during stack creation and update operations. Then, for update operations, it begins disposing of old resources immediately once the operation completes.
rcMonitoringTimeInMinutes :: Lens' RollbackConfiguration (Maybe Natural)
rcMonitoringTimeInMinutes =
  lens _rcMonitoringTimeInMinutes (\s a -> s {_rcMonitoringTimeInMinutes = a}) .
  mapping _Nat

instance FromXML RollbackConfiguration where
  parseXML x =
    RollbackConfiguration' <$>
    (x .@? "RollbackTriggers" .!@ mempty >>= may (parseXMLList "member")) <*>
...
instance ToQuery RollbackTrigger where
  toQuery RollbackTrigger' {..} = mconcat ["Arn" =: _rtARN, "Type" =: _rtType]
...
sLastUpdatedTime =
  lens _sLastUpdatedTime (\s a -> s {_sLastUpdatedTime = a}) . mapping _Time
...
sEnableTerminationProtection =
  lens
    _sEnableTerminationProtection
    (\s a -> s {_sEnableTerminationProtection = a})
...
sDeletionTime =
  lens _sDeletionTime (\s a -> s {_sDeletionTime = a}) . mapping _Time
...
sParameters =
  lens _sParameters (\s a -> s {_sParameters = a}) . _Default . _Coerce
...
sCapabilities =
  lens _sCapabilities (\s a -> s {_sCapabilities = a}) . _Default . _Coerce

-- | The rollback triggers for AWS CloudFormation to monitor during stack creation and updating operations, and for the specified monitoring period afterwards.
sRollbackConfiguration :: Lens' Stack (Maybe RollbackConfiguration)
sRollbackConfiguration =
  lens _sRollbackConfiguration (\s a -> s {_sRollbackConfiguration = a})
...
sTimeoutInMinutes =
  lens _sTimeoutInMinutes (\s a -> s {_sTimeoutInMinutes = a}) . mapping _Nat
...
instance FromXML Stack where
  parseXML x =
    Stack' <$> (x .@? "DisableRollback") <*> (x .@? "LastUpdatedTime") <*>
    (x .@? "RootId") <*>
    (x .@? "NotificationARNs" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "StackStatusReason") <*>
...
seClientRequestToken =
  lens _seClientRequestToken (\s a -> s {_seClientRequestToken = a})
...
instance FromXML StackEvent where
  parseXML x =
    StackEvent' <$> (x .@? "LogicalResourceId") <*> (x .@? "PhysicalResourceId") <*>
    (x .@? "ResourceType") <*>
...
siParameterOverrides =
  lens _siParameterOverrides (\s a -> s {_siParameterOverrides = a}) .
  _Default . _Coerce
...
instance FromXML StackInstance where
  parseXML x =
    StackInstance' <$> (x .@? "Status") <*> (x .@? "Account") <*>
    (x .@? "Region") <*>
    (x .@? "StatusReason") <*>
    (x .@? "StackId") <*>
    (x .@? "ParameterOverrides" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "StackSetId")
...
instance FromXML StackInstanceSummary where
  parseXML x =
    StackInstanceSummary' <$> (x .@? "Status") <*> (x .@? "Account") <*>
    (x .@? "Region") <*>
    (x .@? "StatusReason") <*>
    (x .@? "StackId") <*>
    (x .@? "StackSetId")
...
instance FromXML StackResource where
  parseXML x =
    StackResource' <$> (x .@? "PhysicalResourceId") <*>
    (x .@? "ResourceStatusReason") <*>
    (x .@? "StackId") <*>
    (x .@? "Description") <*>
    (x .@? "StackName") <*>
...
instance FromXML StackResourceDetail where
  parseXML x =
    StackResourceDetail' <$> (x .@? "PhysicalResourceId") <*>
    (x .@? "ResourceStatusReason") <*>
    (x .@? "Metadata") <*>
    (x .@? "StackId") <*>
    (x .@? "Description") <*>
...
instance FromXML StackResourceSummary where
  parseXML x =
    StackResourceSummary' <$> (x .@? "PhysicalResourceId") <*>
    (x .@? "ResourceStatusReason") <*>
    (x .@ "LogicalResourceId") <*>
    (x .@ "ResourceType") <*>
    (x .@ "LastUpdatedTimestamp") <*>
...
ssAdministrationRoleARN =
  lens _ssAdministrationRoleARN (\s a -> s {_ssAdministrationRoleARN = a})
...
ssParameters =
  lens _ssParameters (\s a -> s {_ssParameters = a}) . _Default . _Coerce
...
ssCapabilities =
  lens _ssCapabilities (\s a -> s {_ssCapabilities = a}) . _Default . _Coerce
...
instance FromXML StackSet where
  parseXML x =
    StackSet' <$> (x .@? "Status") <*> (x .@? "AdministrationRoleARN") <*>
    (x .@? "StackSetARN") <*>
    (x .@? "Parameters" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "TemplateBody") <*>
    (x .@? "StackSetName") <*>
...
ssoAdministrationRoleARN =
  lens _ssoAdministrationRoleARN (\s a -> s {_ssoAdministrationRoleARN = a})
...
ssoEndTimestamp =
  lens _ssoEndTimestamp (\s a -> s {_ssoEndTimestamp = a}) . mapping _Time

-- | The time at which the operation was initiated. Note that the creation times for the stack set operation might differ from the creation time of the individual stacks themselves. This is because AWS CloudFormation needs to perform preparatory work for the operation, such as dispatching the work to the requested regions, before actually creating the first stacks.
ssoCreationTimestamp :: Lens' StackSetOperation (Maybe UTCTime)
ssoCreationTimestamp =
  lens _ssoCreationTimestamp (\s a -> s {_ssoCreationTimestamp = a}) .
  mapping _Time

-- | The preferences for how AWS CloudFormation performs this stack set operation.
ssoOperationPreferences ::
     Lens' StackSetOperation (Maybe StackSetOperationPreferences)
ssoOperationPreferences =
  lens _ssoOperationPreferences (\s a -> s {_ssoOperationPreferences = a})
...
instance FromXML StackSetOperation where
  parseXML x =
    StackSetOperation' <$> (x .@? "Status") <*> (x .@? "AdministrationRoleARN") <*>
    (x .@? "Action") <*>
    (x .@? "EndTimestamp") <*>
    (x .@? "CreationTimestamp") <*>
...
ssopRegionOrder =
  lens _ssopRegionOrder (\s a -> s {_ssopRegionOrder = a}) . _Default . _Coerce
...
ssopMaxConcurrentCount =
  lens _ssopMaxConcurrentCount (\s a -> s {_ssopMaxConcurrentCount = a}) .
  mapping _Nat

-- | The maximum percentage of accounts in which to perform this operation at one time. When calculating the number of accounts based on the specified percentage, AWS CloudFormation rounds down to the next whole number. This is true except in cases where rounding down would result is zero. In this case, CloudFormation sets the number as one instead. Note that this setting lets you specify the /maximum/ for operations. For large deployments, under certain circumstances the actual number of accounts acted upon concurrently may be lower due to service throttling. Conditional: You must specify either @MaxConcurrentCount@ or @MaxConcurrentPercentage@ , but not both.
ssopMaxConcurrentPercentage ::
     Lens' StackSetOperationPreferences (Maybe Natural)
ssopMaxConcurrentPercentage =
  lens
    _ssopMaxConcurrentPercentage
    (\s a -> s {_ssopMaxConcurrentPercentage = a}) .
  mapping _Nat

-- | The number of accounts, per region, for which this operation can fail before AWS CloudFormation stops the operation in that region. If the operation is stopped in a region, AWS CloudFormation doesn't attempt the operation in any subsequent regions. Conditional: You must specify either @FailureToleranceCount@ or @FailureTolerancePercentage@ (but not both).
ssopFailureToleranceCount :: Lens' StackSetOperationPreferences (Maybe Natural)
ssopFailureToleranceCount =
  lens _ssopFailureToleranceCount (\s a -> s {_ssopFailureToleranceCount = a}) .
  mapping _Nat
...
ssopFailureTolerancePercentage =
  lens
    ...
    (\s a -> s {_ssopFailureTolerancePercentage = a}) .
  mapping _Nat
...
instance ToQuery StackSetOperationPreferences where
  toQuery StackSetOperationPreferences' {..} =
    mconcat
      [ "RegionOrder" =: toQuery (toQueryList "member" <$> _ssopRegionOrder)
...
ssorsStatus ::
     Lens' StackSetOperationResultSummary (Maybe StackSetOperationResultStatus)
...
ssorsAccountGateResult ::
     Lens' StackSetOperationResultSummary (Maybe AccountGateResult)
ssorsAccountGateResult =
  lens _ssorsAccountGateResult (\s a -> s {_ssorsAccountGateResult = a})
...
instance FromXML StackSetOperationResultSummary where
  parseXML x =
    StackSetOperationResultSummary' <$> (x .@? "Status") <*> (x .@? "Account") <*>
    (x .@? "AccountGateResult") <*>
    (x .@? "Region") <*>
    (x .@? "StatusReason")
...
ssosEndTimestamp =
  lens _ssosEndTimestamp (\s a -> s {_ssosEndTimestamp = a}) . mapping _Time

-- | The time at which the operation was initiated. Note that the creation times for the stack set operation might differ from the creation time of the individual stacks themselves. This is because AWS CloudFormation needs to perform preparatory work for the operation, such as dispatching the work to the requested regions, before actually creating the first stacks.
ssosCreationTimestamp :: Lens' StackSetOperationSummary (Maybe UTCTime)
ssosCreationTimestamp =
  lens _ssosCreationTimestamp (\s a -> s {_ssosCreationTimestamp = a}) .
  mapping _Time
...
instance FromXML StackSetOperationSummary where
  parseXML x =
    StackSetOperationSummary' <$> (x .@? "Status") <*> (x .@? "Action") <*>
    (x .@? "EndTimestamp") <*>
    (x .@? "CreationTimestamp") <*>
    (x .@? "OperationId")
...
instance FromXML StackSetSummary where
  parseXML x =
    StackSetSummary' <$> (x .@? "Status") <*> (x .@? "StackSetName") <*>
    (x .@? "Description") <*>
    (x .@? "StackSetId")
...
ssLastUpdatedTime =
  lens _ssLastUpdatedTime (\s a -> s {_ssLastUpdatedTime = a}) . mapping _Time
...
ssDeletionTime =
  lens _ssDeletionTime (\s a -> s {_ssDeletionTime = a}) . mapping _Time
...
instance FromXML StackSummary where
  parseXML x =
    StackSummary' <$> (x .@? "LastUpdatedTime") <*> (x .@? "RootId") <*>
    (x .@? "StackStatusReason") <*>
...
instance FromXML TemplateParameter where
  parseXML x =
    TemplateParameter' <$> (x .@? "ParameterKey") <*> (x .@? "DefaultValue") <*>
    (x .@? "NoEcho") <*>
    (x .@? "Description")
