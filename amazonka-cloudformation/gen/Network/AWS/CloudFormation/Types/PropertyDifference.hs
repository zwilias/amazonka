...
data PropertyDifference = PropertyDifference'{_pdPropertyPath
                                              :: !Text,
...
propertyDifference
    ...
    -> PropertyDifference
propertyDifference pPropertyPath_ pExpectedValue_
  pActualValue_ pDifferenceType_
  = PropertyDifference'{_pdPropertyPath =
                          pPropertyPath_,
