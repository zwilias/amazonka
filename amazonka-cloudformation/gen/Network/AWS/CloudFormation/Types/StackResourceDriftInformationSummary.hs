...
data StackResourceDriftInformationSummary = StackResourceDriftInformationSummary'{_srdisLastCheckTimestamp
                                                                                  ::
                                                                                  !(Maybe
                                                                                      ISO8601),
...
stackResourceDriftInformationSummary
  ...
  = StackResourceDriftInformationSummary'{_srdisLastCheckTimestamp
                                            = Nothing,
                                          _srdisStackResourceDriftStatus =
                                            pStackResourceDriftStatus_}
