...
data TypeSummary = TypeSummary'{_tsLastUpdated ::
                                !(Maybe ISO8601),
...
typeSummary
    :: TypeSummary
typeSummary
  = TypeSummary'{_tsLastUpdated = Nothing,
                 _tsTypeName = Nothing, _tsDefaultVersionId = Nothing,
                 _tsTypeARN = Nothing, _tsType = Nothing,
