...
data UpdateStackInstances = UpdateStackInstances'{_usiOperationPreferences
                                                  ::
                                                  !(Maybe
