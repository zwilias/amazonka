...
data CreateStackInstances = CreateStackInstances'{_csiOperationPreferences
                                                  ::
                                                  !(Maybe
