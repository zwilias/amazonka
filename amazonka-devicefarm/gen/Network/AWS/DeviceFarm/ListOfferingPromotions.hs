...
instance AWSRequest ListOfferingPromotions where
  ...
  response =
    receiveJSON
      (\s h x ->
         ListOfferingPromotionsResponse' <$> (x .?> "nextToken") <*>
...
loprsOfferingPromotions ::
     Lens' ListOfferingPromotionsResponse [OfferingPromotion]
loprsOfferingPromotions =
  lens _loprsOfferingPromotions (\s a -> s {_loprsOfferingPromotions = a}) .
  _Default . _Coerce

-- | -- | The response status code.
loprsResponseStatus :: Lens' ListOfferingPromotionsResponse Int
loprsResponseStatus =
  lens _loprsResponseStatus (\s a -> s {_loprsResponseStatus = a})
