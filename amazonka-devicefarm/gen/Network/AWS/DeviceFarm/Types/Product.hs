...
asAwsAccountNumber =
  lens _asAwsAccountNumber (\s a -> s {_asAwsAccountNumber = a})

-- | The maximum number of minutes a test run will execute before it times out.
asMaxJobTimeoutMinutes :: Lens' AccountSettings (Maybe Int)
asMaxJobTimeoutMinutes =
  lens _asMaxJobTimeoutMinutes (\s a -> s {_asMaxJobTimeoutMinutes = a})
...
asUnmeteredDevices =
  lens _asUnmeteredDevices (\s a -> s {_asUnmeteredDevices = a}) .
  _Default . _Map

-- | Returns the unmetered remote access devices you have purchased or want to purchase.
asUnmeteredRemoteAccessDevices ::
     Lens' AccountSettings (HashMap DevicePlatform Int)
asUnmeteredRemoteAccessDevices =
  lens
    _asUnmeteredRemoteAccessDevices
    (\s a -> s {_asUnmeteredRemoteAccessDevices = a}) .
  _Default . _Map

-- | The default number of minutes (at the account level) a test run will execute before it times out. Default value is 60 minutes.
asDefaultJobTimeoutMinutes :: Lens' AccountSettings (Maybe Int)
asDefaultJobTimeoutMinutes =
  lens _asDefaultJobTimeoutMinutes (\s a -> s {_asDefaultJobTimeoutMinutes = a})
...
instance FromJSON AccountSettings where
  parseJSON =
    withObject
      "AccountSettings"
      (\x ->
         AccountSettings' <$> (x .:? "skipAppResign") <*>
         (x .:? "awsAccountNumber") <*>
...
instance FromJSON Artifact where
  parseJSON =
    withObject
      "Artifact"
      (\x ->
         Artifact' <$> (x .:? "arn") <*> (x .:? "url") <*> (x .:? "extension") <*>
         (x .:? "name") <*>
         (x .:? "type"))
...
crascBillingMethod ::
     Lens' CreateRemoteAccessSessionConfiguration (Maybe BillingMethod)
crascBillingMethod =
  lens _crascBillingMethod (\s a -> s {_crascBillingMethod = a})
...
capAndroidPaths =
  lens _capAndroidPaths (\s a -> s {_capAndroidPaths = a}) . _Default . _Coerce
...
capDeviceHostPaths =
  lens _capDeviceHostPaths (\s a -> s {_capDeviceHostPaths = a}) .
  _Default . _Coerce
...
capIosPaths =
  lens _capIosPaths (\s a -> s {_capIosPaths = a}) . _Default . _Coerce
...
instance FromJSON CustomerArtifactPaths where
  parseJSON =
    withObject
      "CustomerArtifactPaths"
      (\x ->
         CustomerArtifactPaths' <$> (x .:? "androidPaths" .!= mempty) <*>
...
devRemoteAccessEnabled =
  lens _devRemoteAccessEnabled (\s a -> s {_devRemoteAccessEnabled = a})
...
devInstances =
  lens _devInstances (\s a -> s {_devInstances = a}) . _Default . _Coerce

-- | This flag is set to @true@ if remote debugging is enabled for the device.
devRemoteDebugEnabled :: Lens' Device (Maybe Bool)
devRemoteDebugEnabled =
  lens _devRemoteDebugEnabled (\s a -> s {_devRemoteDebugEnabled = a})
...
instance FromJSON DeviceInstance where
  parseJSON =
    withObject
      "DeviceInstance"
      (\x ->
         DeviceInstance' <$> (x .:? "status") <*> (x .:? "udid") <*>
         (x .:? "instanceProfile") <*>
         (x .:? "arn") <*>
         (x .:? "deviceArn") <*>
         (x .:? "labels" .!= mempty))
...
instance FromJSON DeviceMinutes where
  parseJSON =
    withObject
      "DeviceMinutes"
      (\x ->
         DeviceMinutes' <$> (x .:? "metered") <*> (x .:? "total") <*>
         (x .:? "unmetered"))
...
instance FromJSON DevicePool where
  parseJSON =
    withObject
      "DevicePool"
      (\x ->
         DevicePool' <$> (x .:? "arn") <*> (x .:? "rules" .!= mempty) <*>
         (x .:? "name") <*>
         (x .:? "type") <*>
         (x .:? "description"))
...
dpcrIncompatibilityMessages ::
     Lens' DevicePoolCompatibilityResult [IncompatibilityMessage]
dpcrIncompatibilityMessages =
  lens
    _dpcrIncompatibilityMessages
    (\s a -> s {_dpcrIncompatibilityMessages = a}) .
  _Default . _Coerce
...
instance FromJSON DevicePoolCompatibilityResult where
  parseJSON =
    withObject
      "DevicePoolCompatibilityResult"
      (\x ->
         DevicePoolCompatibilityResult' <$> (x .:? "device") <*>
         (x .:? "compatible") <*>
...
ecAppPackagesCleanup =
  lens _ecAppPackagesCleanup (\s a -> s {_ecAppPackagesCleanup = a})

-- | The number of minutes a test run will execute before it times out.
ecJobTimeoutMinutes :: Lens' ExecutionConfiguration (Maybe Int)
ecJobTimeoutMinutes =
  lens _ecJobTimeoutMinutes (\s a -> s {_ecJobTimeoutMinutes = a})
...
instance FromJSON IncompatibilityMessage where
  parseJSON =
    withObject
      "IncompatibilityMessage"
      (\x -> IncompatibilityMessage' <$> (x .:? "type") <*> (x .:? "message"))
...
ipExcludeAppPackagesFromCleanup =
  lens
    ...
    (\s a -> s {_ipExcludeAppPackagesFromCleanup = a}) .
  _Default . _Coerce
...
instance FromJSON InstanceProfile where
  parseJSON =
    withObject
      "InstanceProfile"
      (\x ->
         InstanceProfile' <$> (x .:? "arn") <*> (x .:? "rebootAfterUse") <*>
         (x .:? "name") <*>
         (x .:? "packageCleanup") <*>
...
instance ToJSON Location where
  toJSON Location' {..} =
    object
      (catMaybes
         [Just ("latitude" .= _lLatitude), Just ("longitude" .= _lLongitude)])
...
instance FromJSON MonetaryAmount where
  parseJSON =
    withObject
      "MonetaryAmount"
      (\x -> MonetaryAmount' <$> (x .:? "amount") <*> (x .:? "currencyCode"))
...
npUplinkLossPercent =
  lens _npUplinkLossPercent (\s a -> s {_npUplinkLossPercent = a}) .
  mapping _Nat

-- | Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
npDownlinkJitterMs :: Lens' NetworkProfile (Maybe Integer)
npDownlinkJitterMs =
  lens _npDownlinkJitterMs (\s a -> s {_npDownlinkJitterMs = a})
...
npDownlinkLossPercent =
  lens _npDownlinkLossPercent (\s a -> s {_npDownlinkLossPercent = a}) .
  mapping _Nat
...
npUplinkBandwidthBits =
  lens _npUplinkBandwidthBits (\s a -> s {_npUplinkBandwidthBits = a})
...
npDownlinkBandwidthBits =
  lens _npDownlinkBandwidthBits (\s a -> s {_npDownlinkBandwidthBits = a})
...
instance FromJSON NetworkProfile where
  parseJSON =
    withObject
      "NetworkProfile"
      (\x ->
         NetworkProfile' <$> (x .:? "uplinkJitterMs") <*> (x .:? "arn") <*>
         (x .:? "uplinkLossPercent") <*>
         (x .:? "downlinkJitterMs") <*>
         (x .:? "name") <*>
...
oRecurringCharges =
  lens _oRecurringCharges (\s a -> s {_oRecurringCharges = a}) .
  _Default . _Coerce
...
instance FromJSON OfferingPromotion where
  parseJSON =
    withObject
      "OfferingPromotion"
      (\x -> OfferingPromotion' <$> (x .:? "id") <*> (x .:? "description"))
...
osEffectiveOn =
  lens _osEffectiveOn (\s a -> s {_osEffectiveOn = a}) . mapping _Time
...
instance FromJSON OfferingStatus where
  parseJSON =
    withObject
      "OfferingStatus"
      (\x ->
         OfferingStatus' <$> (x .:? "effectiveOn") <*> (x .:? "offering") <*>
         (x .:? "quantity") <*>
         (x .:? "type"))
...
otOfferingPromotionId =
  lens _otOfferingPromotionId (\s a -> s {_otOfferingPromotionId = a})
...
instance FromJSON OfferingTransaction where
  parseJSON =
    withObject
      "OfferingTransaction"
      (\x ->
         OfferingTransaction' <$> (x .:? "offeringStatus") <*> (x .:? "cost") <*>
         (x .:? "transactionId") <*>
...
instance FromJSON Problem where
  parseJSON =
    withObject
      "Problem"
      (\x ->
         Problem' <$> (x .:? "device") <*> (x .:? "test") <*> (x .:? "result") <*>
         (x .:? "run") <*>
         (x .:? "job") <*>
         (x .:? "message") <*>
         (x .:? "suite"))
...
pDefaultJobTimeoutMinutes =
  lens _pDefaultJobTimeoutMinutes (\s a -> s {_pDefaultJobTimeoutMinutes = a})
...
instance FromJSON Project where
  parseJSON =
    withObject
      "Project"
      (\x ->
         Project' <$> (x .:? "arn") <*> (x .:? "created") <*> (x .:? "name") <*>
         (x .:? "defaultJobTimeoutMinutes"))
...
instance FromJSON Radios where
  parseJSON =
    withObject
      "Radios"
      (\x ->
         Radios' <$> (x .:? "nfc") <*> (x .:? "gps") <*> (x .:? "bluetooth") <*>
         (x .:? "wifi"))
...
instance FromJSON RecurringCharge where
  parseJSON =
    withObject
      "RecurringCharge"
      (\x -> RecurringCharge' <$> (x .:? "frequency") <*> (x .:? "cost"))
...
rasRemoteRecordEnabled =
  lens _rasRemoteRecordEnabled (\s a -> s {_rasRemoteRecordEnabled = a})
...
rasRemoteRecordAppARN =
  lens _rasRemoteRecordAppARN (\s a -> s {_rasRemoteRecordAppARN = a})
...
rasRemoteDebugEnabled =
  lens _rasRemoteDebugEnabled (\s a -> s {_rasRemoteDebugEnabled = a})
...
rasInteractionMode =
  lens _rasInteractionMode (\s a -> s {_rasInteractionMode = a})
...
instance FromJSON RemoteAccessSession where
  parseJSON =
    withObject
      "RemoteAccessSession"
      (\x ->
         RemoteAccessSession' <$> (x .:? "billingMethod") <*> (x .:? "clientId") <*>
         (x .:? "deviceUdid") <*>
         (x .:? "skipAppResign") <*>
         (x .:? "instanceArn") <*>
         (x .:? "status") <*>
...
runCustomerArtifactPaths =
  lens _runCustomerArtifactPaths (\s a -> s {_runCustomerArtifactPaths = a})
...
runJobTimeoutMinutes =
  lens _runJobTimeoutMinutes (\s a -> s {_runJobTimeoutMinutes = a})
...
runParsingResultURL =
  lens _runParsingResultURL (\s a -> s {_runParsingResultURL = a})
...
instance FromJSON Run where
  parseJSON =
    withObject
      "Run"
      (\x ->
         Run' <$> (x .:? "billingMethod") <*> (x .:? "skipAppResign") <*>
         (x .:? "status") <*>
...
srcCustomerArtifactPaths ::
     Lens' ScheduleRunConfiguration (Maybe CustomerArtifactPaths)
srcCustomerArtifactPaths =
  lens _srcCustomerArtifactPaths (\s a -> s {_srcCustomerArtifactPaths = a})
...
srcVpceConfigurationARNs =
  lens _srcVpceConfigurationARNs (\s a -> s {_srcVpceConfigurationARNs = a}) .
  _Default . _Coerce
...
srtParameters =
  lens _srtParameters (\s a -> s {_srtParameters = a}) . _Default . _Map
...
instance FromJSON Suite where
  parseJSON =
    withObject
      "Suite"
      (\x ->
         Suite' <$> (x .:? "status") <*> (x .:? "counters") <*> (x .:? "arn") <*>
         (x .:? "created") <*>
         (x .:? "stopped") <*>
         (x .:? "result") <*>
         (x .:? "name") <*>
...
instance FromJSON Test where
  parseJSON =
    withObject
      "Test"
      (\x ->
         Test' <$> (x .:? "status") <*> (x .:? "counters") <*> (x .:? "arn") <*>
         (x .:? "created") <*>
         (x .:? "stopped") <*>
         (x .:? "result") <*>
         (x .:? "name") <*>
...
instance FromJSON UniqueProblem where
  parseJSON =
    withObject
      "UniqueProblem"
      (\x ->
         UniqueProblem' <$> (x .:? "problems" .!= mempty) <*> (x .:? "message"))
...
instance FromJSON Upload where
  parseJSON =
    withObject
      "Upload"
      (\x ->
         Upload' <$> (x .:? "status") <*> (x .:? "arn") <*> (x .:? "created") <*>
         (x .:? "url") <*>
         (x .:? "name") <*>
         (x .:? "metadata") <*>
         (x .:? "type") <*>
...
vecVpceServiceName =
  lens _vecVpceServiceName (\s a -> s {_vecVpceServiceName = a})
...
vecVpceConfigurationName =
  lens _vecVpceConfigurationName (\s a -> s {_vecVpceConfigurationName = a})
...
vecVpceConfigurationDescription =
  lens
    ...
    (\s a -> s {_vecVpceConfigurationDescription = a})
...
instance FromJSON VPCEConfiguration where
  parseJSON =
    withObject
      "VPCEConfiguration"
      (\x ->
         VPCEConfiguration' <$> (x .:? "vpceServiceName") <*> (x .:? "arn") <*>
