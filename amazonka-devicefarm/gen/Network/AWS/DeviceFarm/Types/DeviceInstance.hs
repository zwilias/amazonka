...
data DeviceInstance = DeviceInstance'{_diStatus ::
...
deviceInstance
    :: DeviceInstance
deviceInstance
  = DeviceInstance'{_diStatus = Nothing,
                    _diUdid = Nothing, _diInstanceProfile = Nothing,
                    _diArn = Nothing, _diDeviceARN = Nothing,
                    _diLabels = Nothing}
