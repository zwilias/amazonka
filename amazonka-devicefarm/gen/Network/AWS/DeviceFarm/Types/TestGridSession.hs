...
data TestGridSession = TestGridSession'{_tgsStatus ::
...
testGridSession
    :: TestGridSession
testGridSession
  = TestGridSession'{_tgsStatus = Nothing,
                     _tgsArn = Nothing, _tgsCreated = Nothing,
                     _tgsBillingMinutes = Nothing, _tgsEnded = Nothing,
