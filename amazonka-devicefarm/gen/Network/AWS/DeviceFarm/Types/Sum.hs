...
instance FromText ArtifactCategory where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ArtifactCategory from value: '" <>
        e <> "'. Accepted values: file, log, screenshot"
...
instance FromText ArtifactType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ArtifactType from value: '" <>
        e <>
...
instance FromText BillingMethod where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BillingMethod from value: '" <>
        e <> "'. Accepted values: metered, unmetered"
...
instance FromText CurrencyCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CurrencyCode from value: '" <>
...
instance FromText DeviceAttribute where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeviceAttribute from value: '" <>
        e <>
...
instance FromText DeviceFormFactor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeviceFormFactor from value: '" <>
        e <> "'. Accepted values: phone, tablet"
...
instance FromText DevicePlatform where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DevicePlatform from value: '" <>
        e <> "'. Accepted values: android, ios"
...
instance FromText DevicePoolType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DevicePoolType from value: '" <>
        e <> "'. Accepted values: curated, private"
...
instance FromText ExecutionResult where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExecutionResult from value: '" <>
        e <>
...
instance FromText ExecutionResultCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ExecutionResultCode from value: '" <>
        e <> "'. Accepted values: parsing_failed, vpc_endpoint_setup_failed"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: available, in_use, not_available, preparing"
...
instance FromText InteractionMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InteractionMode from value: '" <>
        e <> "'. Accepted values: interactive, no_video, video_only"
...
instance FromText NetworkProfileType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NetworkProfileType from value: '" <>
        e <> "'. Accepted values: curated, private"
...
instance FromText OfferingTransactionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OfferingTransactionType from value: '" <>
        e <> "'. Accepted values: purchase, renew, system"
...
instance FromText OfferingType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OfferingType from value: '" <>
        e <> "'. Accepted values: recurring"
...
instance FromText RuleOperator where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RuleOperator from value: '" <>
        e <>
...
instance FromText SampleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SampleType from value: '" <>
        e <>
...
instance FromText TestType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TestType from value: '" <>
        e <>
...
instance FromText UploadStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing UploadStatus from value: '" <>
        e <> "'. Accepted values: failed, initialized, processing, succeeded"
  ...
  parser =
    takeLowerText >>= \case
      ...
      "appium_web_java_testng_test_package" ->
        pure AppiumWebJavaTestngTestPackage
      ...
      e ->
        fromTextError $
        "Failure parsing UploadType from value: '" <>
        e <>
