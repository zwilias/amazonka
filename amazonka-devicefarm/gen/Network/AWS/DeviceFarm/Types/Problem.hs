...
data Problem = Problem'{_pDevice :: !(Maybe Device),
...
problem
    :: Problem
problem
  = Problem'{_pDevice = Nothing, _pTest = Nothing,
             _pResult = Nothing, _pRun = Nothing, _pJob = Nothing,
             _pMessage = Nothing, _pSuite = Nothing}
