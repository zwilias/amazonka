...
data Upload = Upload'{_uStatus ::
                      !(Maybe UploadStatus),
                      _uArn :: !(Maybe Text), _uCreated :: !(Maybe POSIX),
                      _uCategory :: !(Maybe UploadCategory),
                      _uUrl :: !(Maybe Text), _uName :: !(Maybe Text),
...
upload
    :: Upload
upload
  = Upload'{_uStatus = Nothing, _uArn = Nothing,
            _uCreated = Nothing, _uCategory = Nothing,
            _uUrl = Nothing, _uName = Nothing,
            _uMetadata = Nothing, _uType = Nothing,
            _uMessage = Nothing, _uContentType = Nothing}
