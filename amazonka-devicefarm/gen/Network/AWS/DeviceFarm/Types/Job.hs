...
data Job = Job'{_jobInstanceARN :: !(Maybe Text),
...
job
    :: Job
job
  = Job'{_jobInstanceARN = Nothing,
         _jobStatus = Nothing, _jobCounters = Nothing,
         _jobArn = Nothing, _jobCreated = Nothing,
         _jobDevice = Nothing, _jobStopped = Nothing,
         _jobResult = Nothing, _jobName = Nothing,
         _jobVideoEndpoint = Nothing,
         _jobDeviceMinutes = Nothing,
         _jobVideoCapture = Nothing, _jobType = Nothing,
         _jobMessage = Nothing, _jobStarted = Nothing}
