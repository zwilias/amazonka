...
data DeviceSelectionResult = DeviceSelectionResult'{_dsrMatchedDevicesCount
                                                    :: !(Maybe Int),
                                                    _dsrFilters ::
                                                    !(Maybe [DeviceFilter]),
                                                    _dsrMaxDevices ::
...
deviceSelectionResult
    :: DeviceSelectionResult
deviceSelectionResult
  = DeviceSelectionResult'{_dsrMatchedDevicesCount =
                             Nothing,
                           _dsrFilters = Nothing, _dsrMaxDevices = Nothing}
