...
uvecVpceServiceName =
  lens _uvecVpceServiceName (\s a -> s {_uvecVpceServiceName = a})

-- | The friendly name you give to your VPC endpoint configuration, to manage your configurations more easily.
uvecVpceConfigurationName :: Lens' UpdateVPCEConfiguration (Maybe Text)
uvecVpceConfigurationName =
  lens _uvecVpceConfigurationName (\s a -> s {_uvecVpceConfigurationName = a})
...
uvecServiceDNSName =
  lens _uvecServiceDNSName (\s a -> s {_uvecServiceDNSName = a})
...
uvecVpceConfigurationDescription =
  lens
    ...
    (\s a -> s {_uvecVpceConfigurationDescription = a})
...
instance AWSRequest UpdateVPCEConfiguration where
  ...
  response =
    receiveJSON
      (\s h x ->
         UpdateVPCEConfigurationResponse' <$> (x .?> "vpceConfiguration") <*>
         (pure (fromEnum s)))
...
uvecrsVpceConfiguration ::
     Lens' UpdateVPCEConfigurationResponse (Maybe VPCEConfiguration)
uvecrsVpceConfiguration =
  lens _uvecrsVpceConfiguration (\s a -> s {_uvecrsVpceConfiguration = a})

-- | -- | The response status code.
uvecrsResponseStatus :: Lens' UpdateVPCEConfigurationResponse Int
uvecrsResponseStatus =
  lens _uvecrsResponseStatus (\s a -> s {_uvecrsResponseStatus = a})
