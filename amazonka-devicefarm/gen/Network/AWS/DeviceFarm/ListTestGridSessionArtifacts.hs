...
instance AWSRequest ListTestGridSessionArtifacts
         where
...
instance Hashable ListTestGridSessionArtifacts where

instance NFData ListTestGridSessionArtifacts where
