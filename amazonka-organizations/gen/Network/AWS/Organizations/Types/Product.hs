...
aJoinedTimestamp =
  lens _aJoinedTimestamp (\s a -> s {_aJoinedTimestamp = a}) . mapping _Time
...
instance FromJSON Account where
  parseJSON =
    withObject
      "Account"
      (\x ->
         Account' <$> (x .:? "Status") <*> (x .:? "JoinedMethod") <*>
         (x .:? "Email") <*>
         (x .:? "Arn") <*>
         (x .:? "JoinedTimestamp") <*>
         (x .:? "Name") <*>
...
instance FromJSON Child where
  parseJSON =
    withObject "Child" (\x -> Child' <$> (x .:? "Id") <*> (x .:? "Type"))
...
casCompletedTimestamp =
  lens _casCompletedTimestamp (\s a -> s {_casCompletedTimestamp = a}) .
  mapping _Time

-- | The account name given to the account when it was created.
casAccountName :: Lens' CreateAccountStatus (Maybe Text)
casAccountName =
  lens _casAccountName (\s a -> s {_casAccountName = a}) . mapping _Sensitive
...
casRequestedTimestamp =
  lens _casRequestedTimestamp (\s a -> s {_casRequestedTimestamp = a}) .
  mapping _Time
...
instance FromJSON CreateAccountStatus where
  parseJSON =
    withObject
      "CreateAccountStatus"
      (\x ->
         CreateAccountStatus' <$> (x .:? "FailureReason") <*> (x .:? "State") <*>
...
espServicePrincipal =
  lens _espServicePrincipal (\s a -> s {_espServicePrincipal = a})

-- | The date that the service principal was enabled for integration with AWS Organizations.
espDateEnabled :: Lens' EnabledServicePrincipal (Maybe UTCTime)
espDateEnabled =
  lens _espDateEnabled (\s a -> s {_espDateEnabled = a}) . mapping _Time
...
instance FromJSON EnabledServicePrincipal where
  parseJSON =
    withObject
      "EnabledServicePrincipal"
      (\x ->
         EnabledServicePrincipal' <$> (x .:? "ServicePrincipal") <*>
         (x .:? "DateEnabled"))
...
hExpirationTimestamp =
  lens _hExpirationTimestamp (\s a -> s {_hExpirationTimestamp = a}) .
  mapping _Time
...
hRequestedTimestamp =
  lens _hRequestedTimestamp (\s a -> s {_hRequestedTimestamp = a}) .
  mapping _Time
...
instance FromJSON Handshake where
  parseJSON =
    withObject
      "Handshake"
      (\x ->
         Handshake' <$> (x .:? "State") <*> (x .:? "Arn") <*> (x .:? "Action") <*>
         (x .:? "Resources" .!= mempty) <*>
         (x .:? "Id") <*>
...
hfParentHandshakeId =
  lens _hfParentHandshakeId (\s a -> s {_hfParentHandshakeId = a})
...
instance ToJSON HandshakeParty where
  toJSON HandshakeParty' {..} =
    object (catMaybes [Just ("Id" .= _hpId), Just ("Type" .= _hpType)])
...
hrResources =
  lens _hrResources (\s a -> s {_hrResources = a}) . _Default . _Coerce
...
oMasterAccountEmail =
  lens _oMasterAccountEmail (\s a -> s {_oMasterAccountEmail = a}) .
  mapping _Sensitive
...
oAvailablePolicyTypes =
  lens _oAvailablePolicyTypes (\s a -> s {_oAvailablePolicyTypes = a}) .
  _Default . _Coerce
...
instance FromJSON Organization where
  parseJSON =
    withObject
      "Organization"
      (\x ->
         Organization' <$> (x .:? "Arn") <*> (x .:? "MasterAccountId") <*>
         (x .:? "MasterAccountArn") <*>
...
instance FromJSON OrganizationalUnit where
  parseJSON =
    withObject
      "OrganizationalUnit"
      (\x ->
         OrganizationalUnit' <$> (x .:? "Arn") <*> (x .:? "Name") <*>
         (x .:? "Id"))
...
instance FromJSON Parent where
  parseJSON =
    withObject "Parent" (\x -> Parent' <$> (x .:? "Id") <*> (x .:? "Type"))
...
instance FromJSON PolicySummary where
  parseJSON =
    withObject
      "PolicySummary"
      (\x ->
         PolicySummary' <$> (x .:? "Arn") <*> (x .:? "Name") <*> (x .:? "Id") <*>
         (x .:? "AwsManaged") <*>
         (x .:? "Type") <*>
         (x .:? "Description"))
...
instance FromJSON PolicyTargetSummary where
  parseJSON =
    withObject
      "PolicyTargetSummary"
      (\x ->
         PolicyTargetSummary' <$> (x .:? "TargetId") <*> (x .:? "Arn") <*>
         (x .:? "Name") <*>
         (x .:? "Type"))
...
rPolicyTypes =
  lens _rPolicyTypes (\s a -> s {_rPolicyTypes = a}) . _Default . _Coerce
