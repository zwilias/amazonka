...
data DelegatedAdministrator = DelegatedAdministrator'{_daStatus
                                                      :: !(Maybe AccountStatus),
                                                      _daJoinedMethod ::
                                                      !(Maybe
                                                          AccountJoinedMethod),
...
delegatedAdministrator
    :: DelegatedAdministrator
delegatedAdministrator
  = DelegatedAdministrator'{_daStatus = Nothing,
                            _daJoinedMethod = Nothing, _daEmail = Nothing,
                            _daARN = Nothing, _daJoinedTimestamp = Nothing,
                            _daDelegationEnabledDate = Nothing,
                            _daName = Nothing, _daId = Nothing}
...
instance FromJSON DelegatedAdministrator where
        parseJSON
          = withObject "DelegatedAdministrator"
              (\ x ->
                 DelegatedAdministrator' <$>
...
instance Hashable DelegatedAdministrator where

instance NFData DelegatedAdministrator where
