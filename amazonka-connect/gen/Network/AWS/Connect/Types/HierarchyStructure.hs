...
data HierarchyStructure = HierarchyStructure'{_hsLevelFive
...
hierarchyStructure
    :: HierarchyStructure
hierarchyStructure
  = HierarchyStructure'{_hsLevelFive = Nothing,
                        _hsLevelThree = Nothing, _hsLevelFour = Nothing,
                        _hsLevelTwo = Nothing, _hsLevelOne = Nothing}
