...
data HierarchyPath = HierarchyPath'{_hpLevelFive ::
...
hierarchyPath
    :: HierarchyPath
hierarchyPath
  = HierarchyPath'{_hpLevelFive = Nothing,
                   _hpLevelThree = Nothing, _hpLevelFour = Nothing,
                   _hpLevelTwo = Nothing, _hpLevelOne = Nothing}
