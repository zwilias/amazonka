...
user
    :: User
user
  = User'{_uRoutingProfileId = Nothing,
          _uDirectoryUserId = Nothing, _uARN = Nothing,
          _uIdentityInfo = Nothing,
          _uSecurityProfileIds = Nothing, _uUsername = Nothing,
          _uId = Nothing, _uHierarchyGroupId = Nothing,
          _uPhoneConfig = Nothing, _uTags = Nothing}
