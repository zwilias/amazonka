...
data AddIPRoutes = AddIPRoutes'{_airUpdateSecurityGroupForDirectoryControllers
                                :: !(Maybe Bool),
...
addIPRoutes pDirectoryId_
  = AddIPRoutes'{_airUpdateSecurityGroupForDirectoryControllers
                   = Nothing,
...
newtype AddIPRoutesResponse = AddIPRoutesResponse'{_airrsResponseStatus
                                                   :: Int}
...
addIPRoutesResponse pResponseStatus_
  = AddIPRoutesResponse'{_airrsResponseStatus =
                           pResponseStatus_}
