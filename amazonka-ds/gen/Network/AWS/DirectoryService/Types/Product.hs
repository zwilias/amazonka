...
instance ToJSON Attribute where
  toJSON Attribute' {..} =
    object (catMaybes [("Value" .=) <$> _aValue, ("Name" .=) <$> _aName])
...
cComputerAttributes =
  lens _cComputerAttributes (\s a -> s {_cComputerAttributes = a}) .
  _Default . _Coerce
...
instance FromJSON ConditionalForwarder where
  parseJSON =
    withObject
      "ConditionalForwarder"
      (\x ->
         ConditionalForwarder' <$> (x .:? "DnsIpAddrs" .!= mempty) <*>
         (x .:? "RemoteDomainName") <*>
         (x .:? "ReplicationScope"))
...
dcsCustomerDNSIPs =
  lens _dcsCustomerDNSIPs (\s a -> s {_dcsCustomerDNSIPs = a}) . _Coerce
...
dcsCustomerUserName =
  lens _dcsCustomerUserName (\s a -> s {_dcsCustomerUserName = a})
...
dcsdCustomerUserName =
  lens _dcsdCustomerUserName (\s a -> s {_dcsdCustomerUserName = a})

-- | A list of subnet identifiers in the VPC that the AD connector is in.
dcsdSubnetIds :: Lens' DirectoryConnectSettingsDescription [Text]
dcsdSubnetIds =
  lens _dcsdSubnetIds (\s a -> s {_dcsdSubnetIds = a}) . _Default . _Coerce
...
dcsdSecurityGroupId =
  lens _dcsdSecurityGroupId (\s a -> s {_dcsdSecurityGroupId = a})

-- | The IP addresses of the AD Connector servers.
dcsdConnectIPs :: Lens' DirectoryConnectSettingsDescription [Text]
dcsdConnectIPs =
  lens _dcsdConnectIPs (\s a -> s {_dcsdConnectIPs = a}) . _Default . _Coerce

-- | A list of the Availability Zones that the directory is in.
dcsdAvailabilityZones :: Lens' DirectoryConnectSettingsDescription [Text]
dcsdAvailabilityZones =
  lens _dcsdAvailabilityZones (\s a -> s {_dcsdAvailabilityZones = a}) .
  _Default . _Coerce
...
instance FromJSON DirectoryConnectSettingsDescription where
  parseJSON =
    withObject
      "DirectoryConnectSettingsDescription"
      (\x ->
         DirectoryConnectSettingsDescription' <$> (x .:? "CustomerUserName") <*>
         (x .:? "SubnetIds" .!= mempty) <*>
         (x .:? "VpcId") <*>
         (x .:? "SecurityGroupId") <*>
         (x .:? "ConnectIps" .!= mempty) <*>
...
ddDesiredNumberOfDomainControllers =
  lens
    ...
    (\s a -> s {_ddDesiredNumberOfDomainControllers = a}) .
  mapping _Nat
...
ddLaunchTime =
  lens _ddLaunchTime (\s a -> s {_ddLaunchTime = a}) . mapping _Time
...
ddStageLastUpdatedDateTime =
  lens _ddStageLastUpdatedDateTime (\s a -> s {_ddStageLastUpdatedDateTime = a}) .
  mapping _Time
...
ddDNSIPAddrs =
  lens _ddDNSIPAddrs (\s a -> s {_ddDNSIPAddrs = a}) . _Default . _Coerce

-- | A 'DirectoryVpcSettingsDescription' object that contains additional information about a directory. This member is only present if the directory is a Simple AD or Managed AD directory.
ddVPCSettings ::
     Lens' DirectoryDescription (Maybe DirectoryVPCSettingsDescription)
...
ddConnectSettings ::
     Lens' DirectoryDescription (Maybe DirectoryConnectSettingsDescription)
...
instance FromJSON DirectoryDescription where
  parseJSON =
    withObject
      "DirectoryDescription"
      (\x ->
         DirectoryDescription' <$> (x .:? "Edition") <*> (x .:? "RadiusStatus") <*>
         (x .:? "Stage") <*>
         (x .:? "DirectoryId") <*>
         (x .:? "AccessUrl") <*>
         (x .:? "ShortName") <*>
...
dlConnectedDirectoriesCurrentCount =
  lens
    ...
    (\s a -> s {_dlConnectedDirectoriesCurrentCount = a}) .
  mapping _Nat
...
dlCloudOnlyMicrosoftADLimitReached =
  lens
    ...
    (\s a -> s {_dlCloudOnlyMicrosoftADLimitReached = a})
...
dlConnectedDirectoriesLimit =
  lens
    ...
    (\s a -> s {_dlConnectedDirectoriesLimit = a}) .
  mapping _Nat
...
dlConnectedDirectoriesLimitReached =
  lens
    ...
    (\s a -> s {_dlConnectedDirectoriesLimitReached = a})
...
dlCloudOnlyMicrosoftADLimit =
  lens
    ...
    (\s a -> s {_dlCloudOnlyMicrosoftADLimit = a}) .
  mapping _Nat
...
dlCloudOnlyDirectoriesLimit =
  lens
    ...
    (\s a -> s {_dlCloudOnlyDirectoriesLimit = a}) .
  mapping _Nat
...
dlCloudOnlyDirectoriesCurrentCount =
  lens
    ...
    (\s a -> s {_dlCloudOnlyDirectoriesCurrentCount = a}) .
  mapping _Nat
...
dlCloudOnlyDirectoriesLimitReached =
  lens
    ...
    (\s a -> s {_dlCloudOnlyDirectoriesLimitReached = a})
...
dlCloudOnlyMicrosoftADCurrentCount =
  lens
    ...
    (\s a -> s {_dlCloudOnlyMicrosoftADCurrentCount = a}) .
  mapping _Nat
...
instance FromJSON DirectoryLimits where
  parseJSON =
    withObject
      "DirectoryLimits"
      (\x ->
         DirectoryLimits' <$> (x .:? "ConnectedDirectoriesCurrentCount") <*>
...
dvsdSubnetIds =
  lens _dvsdSubnetIds (\s a -> s {_dvsdSubnetIds = a}) . _Default . _Coerce
...
dvsdSecurityGroupId =
  lens _dvsdSecurityGroupId (\s a -> s {_dvsdSecurityGroupId = a})

-- | The list of Availability Zones that the directory is in.
dvsdAvailabilityZones :: Lens' DirectoryVPCSettingsDescription [Text]
dvsdAvailabilityZones =
  lens _dvsdAvailabilityZones (\s a -> s {_dvsdAvailabilityZones = a}) .
  _Default . _Coerce
...
instance FromJSON DirectoryVPCSettingsDescription where
  parseJSON =
    withObject
      "DirectoryVPCSettingsDescription"
      (\x ->
         DirectoryVPCSettingsDescription' <$> (x .:? "SubnetIds" .!= mempty) <*>
         (x .:? "VpcId") <*>
         (x .:? "SecurityGroupId") <*>
         (x .:? "AvailabilityZones" .!= mempty))
...
dcLaunchTime =
  lens _dcLaunchTime (\s a -> s {_dcLaunchTime = a}) . mapping _Time
...
dcAvailabilityZone =
  lens _dcAvailabilityZone (\s a -> s {_dcAvailabilityZone = a})
...
dcStatusLastUpdatedDateTime =
  lens
    ...
    (\s a -> s {_dcStatusLastUpdatedDateTime = a}) .
  mapping _Time
...
dcDomainControllerId =
  lens _dcDomainControllerId (\s a -> s {_dcDomainControllerId = a})
...
instance FromJSON DomainController where
  parseJSON =
    withObject
      "DomainController"
      (\x ->
         DomainController' <$> (x .:? "Status") <*> (x .:? "DirectoryId") <*>
         (x .:? "VpcId") <*>
         (x .:? "LaunchTime") <*>
         (x .:? "SubnetId") <*>
         (x .:? "AvailabilityZone") <*>
...
etCreatedDateTime =
  lens _etCreatedDateTime (\s a -> s {_etCreatedDateTime = a}) . mapping _Time
...
instance FromJSON EventTopic where
  parseJSON =
    withObject
      "EventTopic"
      (\x ->
         EventTopic' <$> (x .:? "Status") <*> (x .:? "DirectoryId") <*>
         (x .:? "TopicName") <*>
         (x .:? "TopicArn") <*>
         (x .:? "CreatedDateTime"))
...
instance ToJSON IPRoute where
  toJSON IPRoute' {..} =
    object
      (catMaybes
         [("CidrIp" .=) <$> _irCidrIP, ("Description" .=) <$> _irDescription])
...
iriIPRouteStatusReason =
  lens _iriIPRouteStatusReason (\s a -> s {_iriIPRouteStatusReason = a})

-- | The date and time the address block was added to the directory.
iriAddedDateTime :: Lens' IPRouteInfo (Maybe UTCTime)
iriAddedDateTime =
  lens _iriAddedDateTime (\s a -> s {_iriAddedDateTime = a}) . mapping _Time
...
iriIPRouteStatusMsg =
  lens _iriIPRouteStatusMsg (\s a -> s {_iriIPRouteStatusMsg = a})
...
rsRadiusRetries =
  lens _rsRadiusRetries (\s a -> s {_rsRadiusRetries = a}) . mapping _Nat

-- | The protocol specified for your RADIUS endpoints.
rsAuthenticationProtocol ::
     Lens' RadiusSettings (Maybe RadiusAuthenticationProtocol)
rsAuthenticationProtocol =
  lens _rsAuthenticationProtocol (\s a -> s {_rsAuthenticationProtocol = a})

-- | An array of strings that contains the IP addresses of the RADIUS server endpoints, or the IP addresses of your RADIUS server load balancer.
rsRadiusServers :: Lens' RadiusSettings [Text]
rsRadiusServers =
  lens _rsRadiusServers (\s a -> s {_rsRadiusServers = a}) . _Default . _Coerce
...
rsSharedSecret =
  lens _rsSharedSecret (\s a -> s {_rsSharedSecret = a}) . mapping _Sensitive

-- | The amount of time, in seconds, to wait for the RADIUS server to respond.
rsRadiusTimeout :: Lens' RadiusSettings (Maybe Natural)
rsRadiusTimeout =
  lens _rsRadiusTimeout (\s a -> s {_rsRadiusTimeout = a}) . mapping _Nat
...
instance FromJSON RadiusSettings where
  parseJSON =
    withObject
      "RadiusSettings"
      (\x ->
         RadiusSettings' <$> (x .:? "DisplayLabel") <*> (x .:? "RadiusRetries") <*>
...
seiSchemaExtensionId =
  lens _seiSchemaExtensionId (\s a -> s {_seiSchemaExtensionId = a})
...
seiSchemaExtensionStatusReason =
  lens
    ...
    (\s a -> s {_seiSchemaExtensionStatusReason = a})

-- | The current status of the schema extension.
seiSchemaExtensionStatus ::
     Lens' SchemaExtensionInfo (Maybe SchemaExtensionStatus)
seiSchemaExtensionStatus =
  lens _seiSchemaExtensionStatus (\s a -> s {_seiSchemaExtensionStatus = a})
...
seiEndDateTime =
  lens _seiEndDateTime (\s a -> s {_seiEndDateTime = a}) . mapping _Time

-- | The date and time that the schema extension started being applied to the directory.
seiStartDateTime :: Lens' SchemaExtensionInfo (Maybe UTCTime)
seiStartDateTime =
  lens _seiStartDateTime (\s a -> s {_seiStartDateTime = a}) . mapping _Time
...
instance FromJSON SchemaExtensionInfo where
  parseJSON =
    withObject
      "SchemaExtensionInfo"
      (\x ->
         SchemaExtensionInfo' <$> (x .:? "DirectoryId") <*>
         (x .:? "SchemaExtensionId") <*>
...
instance FromJSON Snapshot where
  parseJSON =
    withObject
      "Snapshot"
      (\x ->
         Snapshot' <$> (x .:? "Status") <*> (x .:? "DirectoryId") <*>
         (x .:? "StartTime") <*>
         (x .:? "Name") <*>
         (x .:? "Type") <*>
         (x .:? "SnapshotId"))
...
slManualSnapshotsLimitReached =
  lens
    ...
    (\s a -> s {_slManualSnapshotsLimitReached = a})
...
slManualSnapshotsCurrentCount =
  lens
    ...
    (\s a -> s {_slManualSnapshotsCurrentCount = a}) .
  mapping _Nat

-- | The maximum number of manual snapshots allowed.
slManualSnapshotsLimit :: Lens' SnapshotLimits (Maybe Natural)
slManualSnapshotsLimit =
  lens _slManualSnapshotsLimit (\s a -> s {_slManualSnapshotsLimit = a}) .
  mapping _Nat
...
instance FromJSON SnapshotLimits where
  parseJSON =
    withObject
      "SnapshotLimits"
      (\x ->
         SnapshotLimits' <$> (x .:? "ManualSnapshotsLimitReached") <*>
...
tLastUpdatedDateTime =
  lens _tLastUpdatedDateTime (\s a -> s {_tLastUpdatedDateTime = a}) .
  mapping _Time
...
tStateLastUpdatedDateTime =
  lens _tStateLastUpdatedDateTime (\s a -> s {_tStateLastUpdatedDateTime = a}) .
  mapping _Time
...
tCreatedDateTime =
  lens _tCreatedDateTime (\s a -> s {_tCreatedDateTime = a}) . mapping _Time
...
instance FromJSON Trust where
  parseJSON =
    withObject
      "Trust"
      (\x ->
         Trust' <$> (x .:? "DirectoryId") <*> (x .:? "TrustState") <*>
