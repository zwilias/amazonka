...
data LDAPSSettingInfo = LDAPSSettingInfo'{_ldapssiLastUpdatedDateTime
                                          :: !(Maybe POSIX),
...
lDAPSSettingInfo
    :: LDAPSSettingInfo
lDAPSSettingInfo
  = LDAPSSettingInfo'{_ldapssiLastUpdatedDateTime =
                        Nothing,
...
instance Hashable LDAPSSettingInfo where

instance NFData LDAPSSettingInfo where
