...
data EventTopic = EventTopic'{_etStatus ::
                              !(Maybe TopicStatus),
...
eventTopic
    :: EventTopic
eventTopic
  = EventTopic'{_etStatus = Nothing,
                _etDirectoryId = Nothing, _etTopicName = Nothing,
                _etTopicARN = Nothing, _etCreatedDateTime = Nothing}
