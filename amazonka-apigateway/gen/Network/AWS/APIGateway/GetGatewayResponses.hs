...
data GetGatewayResponses = GetGatewayResponses'{_ggrLimit
                                                :: !(Maybe Int),
...
getGatewayResponses pRestAPIId_
  = GetGatewayResponses'{_ggrLimit = Nothing,
                         _ggrPosition = Nothing, _ggrRestAPIId = pRestAPIId_}
...
data GetGatewayResponsesResponse = GetGatewayResponsesResponse'{_ggrrsItems
                                                                ::
                                                                !(Maybe
                                                                    [GatewayResponse]),
                                                                _ggrrsPosition
...
getGatewayResponsesResponse pResponseStatus_
  = GetGatewayResponsesResponse'{_ggrrsItems = Nothing,
