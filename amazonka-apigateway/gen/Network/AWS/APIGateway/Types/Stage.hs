...
data Stage = Stage'{_sDeploymentId :: !(Maybe Text),
...
stage
    :: Stage
stage
  = Stage'{_sDeploymentId = Nothing,
           _sVariables = Nothing, _sAccessLogSettings = Nothing,
           _sDocumentationVersion = Nothing,
           _sClientCertificateId = Nothing,
           _sTracingEnabled = Nothing, _sCreatedDate = Nothing,
           _sCacheClusterStatus = Nothing,
           _sMethodSettings = Nothing,
           _sLastUpdatedDate = Nothing,
           _sCacheClusterSize = Nothing, _sWebACLARN = Nothing,
           _sCanarySettings = Nothing,
           _sCacheClusterEnabled = Nothing,
           _sStageName = Nothing, _sDescription = Nothing,
           _sTags = Nothing}
