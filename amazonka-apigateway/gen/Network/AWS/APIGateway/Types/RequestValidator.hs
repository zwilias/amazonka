...
data RequestValidator = RequestValidator'{_rvValidateRequestParameters
                                          :: !(Maybe Bool),
                                          _rvName :: !(Maybe Text),
...
requestValidator
    :: RequestValidator
requestValidator
  = RequestValidator'{_rvValidateRequestParameters =
                        Nothing,
                      _rvName = Nothing, _rvValidateRequestBody = Nothing,
                      _rvId = Nothing}
