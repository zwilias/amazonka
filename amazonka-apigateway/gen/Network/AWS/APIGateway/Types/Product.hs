...
akCreatedDate =
  lens _akCreatedDate (\s a -> s {_akCreatedDate = a}) . mapping _Time
...
akStageKeys =
  lens _akStageKeys (\s a -> s {_akStageKeys = a}) . _Default . _Coerce

-- | The timestamp when the API Key was last updated.
akLastUpdatedDate :: Lens' APIKey (Maybe UTCTime)
akLastUpdatedDate =
  lens _akLastUpdatedDate (\s a -> s {_akLastUpdatedDate = a}) . mapping _Time
...
instance ToJSON APIStage where
  toJSON APIStage' {..} =
    object (catMaybes [("stage" .=) <$> _asStage, ("apiId" .=) <$> _asApiId])
...
instance FromJSON AccessLogSettings where
  parseJSON =
    withObject
      "AccessLogSettings"
      (\x ->
         AccessLogSettings' <$> (x .:? "format") <*> (x .:? "destinationArn"))
...
aCloudwatchRoleARN =
  lens _aCloudwatchRoleARN (\s a -> s {_aCloudwatchRoleARN = a})
...
instance FromJSON Account where
  parseJSON =
    withObject
      "Account"
      (\x ->
         Account' <$> (x .:? "apiKeyVersion") <*> (x .:? "cloudwatchRoleArn") <*>
         (x .:? "features" .!= mempty) <*>
         (x .:? "throttleSettings"))
...
aIdentityValidationExpression =
  lens
    ...
    (\s a -> s {_aIdentityValidationExpression = a})

-- | A list of the Amazon Cognito user pool ARNs for the @COGNITO_USER_POOLS@ authorizer. Each element is of this format: @arn:aws:cognito-idp:{region}:{account_id}:userpool/{user_pool_id}@ . For a @TOKEN@ or @REQUEST@ authorizer, this is not defined.
aProviderARNs :: Lens' Authorizer [Text]
aProviderARNs =
  lens _aProviderARNs (\s a -> s {_aProviderARNs = a}) . _Default . _Coerce
...
aAuthorizerResultTtlInSeconds =
  lens
    _aAuthorizerResultTtlInSeconds
    (\s a -> s {_aAuthorizerResultTtlInSeconds = a})
...
aAuthorizerCredentials =
  lens _aAuthorizerCredentials (\s a -> s {_aAuthorizerCredentials = a})
...
instance FromJSON BasePathMapping where
  parseJSON =
    withObject
      "BasePathMapping"
      (\x ->
         BasePathMapping' <$> (x .:? "stage") <*> (x .:? "basePath") <*>
         (x .:? "restApiId"))
...
csStageVariableOverrides =
  lens _csStageVariableOverrides (\s a -> s {_csStageVariableOverrides = a}) .
  _Default . _Map
...
ccPemEncodedCertificate =
  lens _ccPemEncodedCertificate (\s a -> s {_ccPemEncodedCertificate = a})

-- | The identifier of the client certificate.
ccClientCertificateId :: Lens' ClientCertificate (Maybe Text)
ccClientCertificateId =
  lens _ccClientCertificateId (\s a -> s {_ccClientCertificateId = a})

-- | The timestamp when the client certificate was created.
ccCreatedDate :: Lens' ClientCertificate (Maybe UTCTime)
ccCreatedDate =
  lens _ccCreatedDate (\s a -> s {_ccCreatedDate = a}) . mapping _Time

-- | The timestamp when the client certificate will expire.
ccExpirationDate :: Lens' ClientCertificate (Maybe UTCTime)
ccExpirationDate =
  lens _ccExpirationDate (\s a -> s {_ccExpirationDate = a}) . mapping _Time
...
instance FromJSON ClientCertificate where
  parseJSON =
    withObject
      "ClientCertificate"
      (\x ->
         ClientCertificate' <$> (x .:? "pemEncodedCertificate") <*>
...
instance FromJSON Deployment where
  parseJSON =
    withObject
      "Deployment"
      (\x ->
         Deployment' <$> (x .:? "apiSummary" .!= mempty) <*>
         (x .:? "createdDate") <*>
         (x .:? "id") <*>
         (x .:? "description"))
...
dcsStageVariableOverrides =
  lens _dcsStageVariableOverrides (\s a -> s {_dcsStageVariableOverrides = a}) .
  _Default . _Map
...
instance FromJSON DocumentationPart where
  parseJSON =
    withObject
      "DocumentationPart"
      (\x ->
         DocumentationPart' <$> (x .:? "location") <*> (x .:? "id") <*>
         (x .:? "properties"))
...
instance FromJSON DocumentationPartLocation where
  parseJSON =
    withObject
      "DocumentationPartLocation"
      (\x ->
         DocumentationPartLocation' <$> (x .:? "path") <*> (x .:? "name") <*>
         (x .:? "method") <*>
         (x .:? "statusCode") <*>
         (x .: "type"))
...
dvCreatedDate =
  lens _dvCreatedDate (\s a -> s {_dvCreatedDate = a}) . mapping _Time
...
instance FromJSON DocumentationVersion where
  parseJSON =
    withObject
      "DocumentationVersion"
      (\x ->
         DocumentationVersion' <$> (x .:? "createdDate") <*> (x .:? "version") <*>
         (x .:? "description"))
...
dnRegionalHostedZoneId =
  lens _dnRegionalHostedZoneId (\s a -> s {_dnRegionalHostedZoneId = a})
...
dnRegionalCertificateARN =
  lens _dnRegionalCertificateARN (\s a -> s {_dnRegionalCertificateARN = a})
...
dnDistributionHostedZoneId =
  lens _dnDistributionHostedZoneId (\s a -> s {_dnDistributionHostedZoneId = a})
...
dnRegionalCertificateName =
  lens _dnRegionalCertificateName (\s a -> s {_dnRegionalCertificateName = a})
...
instance FromJSON DomainName where
  parseJSON =
    withObject
      "DomainName"
      (\x ->
         DomainName' <$> (x .:? "regionalHostedZoneId") <*>
         (x .:? "certificateName") <*>
...
instance FromJSON EndpointConfiguration where
  parseJSON =
    withObject
      "EndpointConfiguration"
      (\x -> EndpointConfiguration' <$> (x .:? "types" .!= mempty))
...
gResponseTemplates =
  lens _gResponseTemplates (\s a -> s {_gResponseTemplates = a}) .
  _Default . _Map
...
gResponseParameters =
  lens _gResponseParameters (\s a -> s {_gResponseParameters = a}) .
  _Default . _Map
...
instance FromJSON GatewayResponse where
  parseJSON =
    withObject
      "GatewayResponse"
      (\x ->
         GatewayResponse' <$> (x .:? "defaultResponse") <*>
...
iRequestTemplates =
  lens _iRequestTemplates (\s a -> s {_iRequestTemplates = a}) . _Default . _Map
...
iRequestParameters =
  lens _iRequestParameters (\s a -> s {_iRequestParameters = a}) .
  _Default . _Map
...
iPassthroughBehavior =
  lens _iPassthroughBehavior (\s a -> s {_iPassthroughBehavior = a})
...
iIntegrationResponses =
  lens _iIntegrationResponses (\s a -> s {_iIntegrationResponses = a}) .
  _Default . _Map
...
iCacheKeyParameters =
  lens _iCacheKeyParameters (\s a -> s {_iCacheKeyParameters = a}) .
  _Default . _Coerce
...
intResponseParameters =
  lens _intResponseParameters (\s a -> s {_intResponseParameters = a}) .
  _Default . _Map
...
instance FromJSON IntegrationResponse where
  parseJSON =
    withObject
      "IntegrationResponse"
      (\x ->
         IntegrationResponse' <$> (x .:? "contentHandling") <*>
         (x .:? "responseTemplates" .!= mempty) <*>
         (x .:? "selectionPattern") <*>
         (x .:? "statusCode") <*>
         (x .:? "responseParameters" .!= mempty))
...
mMethodResponses =
  lens _mMethodResponses (\s a -> s {_mMethodResponses = a}) . _Default . _Map
...
mAuthorizationScopes =
  lens _mAuthorizationScopes (\s a -> s {_mAuthorizationScopes = a}) .
  _Default . _Coerce

-- | The identifier of a 'RequestValidator' for request validation.
mRequestValidatorId :: Lens' Method (Maybe Text)
mRequestValidatorId =
  lens _mRequestValidatorId (\s a -> s {_mRequestValidatorId = a})

-- | A key-value map specifying data schemas, represented by 'Model' resources, (as the mapped value) of the request payloads of given content types (as the mapping key).
mRequestModels :: Lens' Method (HashMap Text Text)
mRequestModels =
  lens _mRequestModels (\s a -> s {_mRequestModels = a}) . _Default . _Map

-- | A key-value map defining required or optional method request parameters that can be accepted by API Gateway. A key is a method request parameter name matching the pattern of @method.request.{location}.{name}@ , where @location@ is @querystring@ , @path@ , or @header@ and @name@ is a valid and unique parameter name. The value associated with the key is a Boolean flag indicating whether the parameter is required (@true@ ) or optional (@false@ ). The method request parameter names defined here are available in 'Integration' to be mapped to integration request parameters or templates.
mRequestParameters :: Lens' Method (HashMap Text Bool)
mRequestParameters =
  lens _mRequestParameters (\s a -> s {_mRequestParameters = a}) .
  _Default . _Map
...
mMethodIntegration =
  lens _mMethodIntegration (\s a -> s {_mMethodIntegration = a})
...
instance FromJSON Method where
  parseJSON =
    withObject
      "Method"
      (\x ->
         Method' <$> (x .:? "methodResponses" .!= mempty) <*>
         (x .:? "httpMethod") <*>
...
mResponseModels =
  lens _mResponseModels (\s a -> s {_mResponseModels = a}) . _Default . _Map
...
mResponseParameters =
  lens _mResponseParameters (\s a -> s {_mResponseParameters = a}) .
  _Default . _Map
...
instance FromJSON MethodResponse where
  parseJSON =
    withObject
      "MethodResponse"
      (\x ->
         MethodResponse' <$> (x .:? "responseModels" .!= mempty) <*>
         (x .:? "statusCode") <*>
         (x .:? "responseParameters" .!= mempty))
...
msCacheTtlInSeconds =
  lens _msCacheTtlInSeconds (\s a -> s {_msCacheTtlInSeconds = a})
...
msRequireAuthorizationForCacheControl =
  lens
    ...
    (\s a -> s {_msRequireAuthorizationForCacheControl = a})
...
msThrottlingRateLimit =
  lens _msThrottlingRateLimit (\s a -> s {_msThrottlingRateLimit = a})

-- | Specifies how to handle unauthorized requests for cache invalidation. The PATCH path for this setting is @/{method_setting_key}/caching/unauthorizedCacheControlHeaderStrategy@ , and the available values are @FAIL_WITH_403@ , @SUCCEED_WITH_RESPONSE_HEADER@ , @SUCCEED_WITHOUT_RESPONSE_HEADER@ .
msUnauthorizedCacheControlHeaderStrategy ::
     Lens' MethodSetting (Maybe UnauthorizedCacheControlHeaderStrategy)
msUnauthorizedCacheControlHeaderStrategy =
  lens
    _msUnauthorizedCacheControlHeaderStrategy
    (\s a -> s {_msUnauthorizedCacheControlHeaderStrategy = a})
...
instance FromJSON MethodSetting where
  parseJSON =
    withObject
      "MethodSetting"
      (\x ->
         MethodSetting' <$> (x .:? "cacheTtlInSeconds") <*>
         (x .:? "dataTraceEnabled") <*>
...
msAuthorizationType =
  lens _msAuthorizationType (\s a -> s {_msAuthorizationType = a})
...
instance FromJSON MethodSnapshot where
  parseJSON =
    withObject
      "MethodSnapshot"
      (\x ->
         MethodSnapshot' <$> (x .:? "authorizationType") <*>
         (x .:? "apiKeyRequired"))
...
instance FromJSON QuotaSettings where
  parseJSON =
    withObject
      "QuotaSettings"
      (\x ->
         QuotaSettings' <$> (x .:? "offset") <*> (x .:? "period") <*>
         (x .:? "limit"))
...
rvValidateRequestParameters =
  lens
    ...
    (\s a -> s {_rvValidateRequestParameters = a})
...
rvValidateRequestBody =
  lens _rvValidateRequestBody (\s a -> s {_rvValidateRequestBody = a})
...
instance FromJSON RequestValidator where
  parseJSON =
    withObject
      "RequestValidator"
      (\x ->
         RequestValidator' <$> (x .:? "validateRequestParameters") <*>
         (x .:? "name") <*>
...
rResourceMethods =
  lens _rResourceMethods (\s a -> s {_rResourceMethods = a}) . _Default . _Map
...
instance FromJSON Resource where
  parseJSON =
    withObject
      "Resource"
      (\x ->
         Resource' <$> (x .:? "pathPart") <*> (x .:? "path") <*> (x .:? "id") <*>
...
raMinimumCompressionSize =
  lens _raMinimumCompressionSize (\s a -> s {_raMinimumCompressionSize = a})

-- | The list of binary media types supported by the 'RestApi' . By default, the 'RestApi' supports only UTF-8-encoded text payloads.
raBinaryMediaTypes :: Lens' RestAPI [Text]
raBinaryMediaTypes =
  lens _raBinaryMediaTypes (\s a -> s {_raBinaryMediaTypes = a}) .
  _Default . _Coerce
...
raCreatedDate =
  lens _raCreatedDate (\s a -> s {_raCreatedDate = a}) . mapping _Time
...
raEndpointConfiguration =
  lens _raEndpointConfiguration (\s a -> s {_raEndpointConfiguration = a})
...
instance FromJSON RestAPI where
  parseJSON =
    withObject
      "RestAPI"
      (\x ->
         RestAPI' <$> (x .:? "minimumCompressionSize") <*>
...
instance FromJSON SDKConfigurationProperty where
  parseJSON =
    withObject
      "SDKConfigurationProperty"
      (\x ->
         SDKConfigurationProperty' <$> (x .:? "friendlyName") <*>
         (x .:? "required") <*>
         (x .:? "name") <*>
         (x .:? "defaultValue") <*>
         (x .:? "description"))
...
stConfigurationProperties =
  lens _stConfigurationProperties (\s a -> s {_stConfigurationProperties = a}) .
  _Default . _Coerce
...
sAccessLogSettings =
  lens _sAccessLogSettings (\s a -> s {_sAccessLogSettings = a})

-- | The version of the associated API documentation.
sDocumentationVersion :: Lens' Stage (Maybe Text)
sDocumentationVersion =
  lens _sDocumentationVersion (\s a -> s {_sDocumentationVersion = a})

-- | The identifier of a client certificate for an API stage.
sClientCertificateId :: Lens' Stage (Maybe Text)
sClientCertificateId =
  lens _sClientCertificateId (\s a -> s {_sClientCertificateId = a})

-- | The timestamp when the stage was created.
sCreatedDate :: Lens' Stage (Maybe UTCTime)
sCreatedDate =
  lens _sCreatedDate (\s a -> s {_sCreatedDate = a}) . mapping _Time

-- | The status of the cache cluster for the stage, if enabled.
sCacheClusterStatus :: Lens' Stage (Maybe CacheClusterStatus)
sCacheClusterStatus =
  lens _sCacheClusterStatus (\s a -> s {_sCacheClusterStatus = a})

-- | A map that defines the method settings for a 'Stage' resource. Keys (designated as @/{method_setting_key@ below) are method paths defined as @{resource_path}/{http_method}@ for an individual method override, or @/\*/\*@ for overriding all methods in the stage.
sMethodSettings :: Lens' Stage (HashMap Text MethodSetting)
sMethodSettings =
  lens _sMethodSettings (\s a -> s {_sMethodSettings = a}) . _Default . _Map

-- | The timestamp when the stage last updated.
sLastUpdatedDate :: Lens' Stage (Maybe UTCTime)
sLastUpdatedDate =
  lens _sLastUpdatedDate (\s a -> s {_sLastUpdatedDate = a}) . mapping _Time
...
sCacheClusterEnabled =
  lens _sCacheClusterEnabled (\s a -> s {_sCacheClusterEnabled = a})
...
instance FromJSON Stage where
  parseJSON =
    withObject
      "Stage"
      (\x ->
         Stage' <$> (x .:? "deploymentId") <*> (x .:? "variables" .!= mempty) <*>
         (x .:? "accessLogSettings") <*>
...
instance ToJSON StageKey where
  toJSON StageKey' {..} =
    object
      (catMaybes
         [("restApiId" .=) <$> _skRestAPIId, ("stageName" .=) <$> _skStageName])
...
instance FromJSON ThrottleSettings where
  parseJSON =
    withObject
      "ThrottleSettings"
      (\x -> ThrottleSettings' <$> (x .:? "burstLimit") <*> (x .:? "rateLimit"))
...
upApiStages =
  lens _upApiStages (\s a -> s {_upApiStages = a}) . _Default . _Coerce
...
instance FromJSON UsagePlan where
  parseJSON =
    withObject
      "UsagePlan"
      (\x ->
         UsagePlan' <$> (x .:? "apiStages" .!= mempty) <*> (x .:? "name") <*>
         (x .:? "id") <*>
         (x .:? "throttle") <*>
         (x .:? "quota") <*>
         (x .:? "description") <*>
...
instance FromJSON UsagePlanKey where
  parseJSON =
    withObject
      "UsagePlanKey"
      (\x ->
         UsagePlanKey' <$> (x .:? "value") <*> (x .:? "name") <*> (x .:? "id") <*>
         (x .:? "type"))
...
vlTargetARNs =
  lens _vlTargetARNs (\s a -> s {_vlTargetARNs = a}) . _Default . _Coerce
...
instance FromJSON VPCLink where
  parseJSON =
    withObject
      "VPCLink"
      (\x ->
         VPCLink' <$> (x .:? "status") <*> (x .:? "targetArns" .!= mempty) <*>
         (x .:? "name") <*>
         (x .:? "statusMessage") <*>
         (x .:? "id") <*>
         (x .:? "description"))
