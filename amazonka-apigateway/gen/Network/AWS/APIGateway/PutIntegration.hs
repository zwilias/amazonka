...
pRequestTemplates =
  lens _pRequestTemplates (\s a -> s {_pRequestTemplates = a}) . _Default . _Map
...
pRequestParameters =
  lens _pRequestParameters (\s a -> s {_pRequestParameters = a}) .
  _Default . _Map
...
pPassthroughBehavior =
  lens _pPassthroughBehavior (\s a -> s {_pPassthroughBehavior = a})
...
pIntegrationHTTPMethod =
  lens _pIntegrationHTTPMethod (\s a -> s {_pIntegrationHTTPMethod = a})

-- | Specifies a put integration input's cache key parameters.
pCacheKeyParameters :: Lens' PutIntegration [Text]
pCacheKeyParameters =
  lens _pCacheKeyParameters (\s a -> s {_pCacheKeyParameters = a}) .
  _Default . _Coerce
