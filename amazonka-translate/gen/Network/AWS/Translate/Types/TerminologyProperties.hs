...
data TerminologyProperties = TerminologyProperties'{_tpSizeBytes
                                                    :: !(Maybe Int),
                                                    _tpLastUpdatedAt ::
                                                    !(Maybe POSIX),
                                                    _tpARN :: !(Maybe Text),
...
terminologyProperties
    :: TerminologyProperties
terminologyProperties
  = TerminologyProperties'{_tpSizeBytes = Nothing,
                           _tpLastUpdatedAt = Nothing, _tpARN = Nothing,
                           _tpTargetLanguageCodes = Nothing,
                           _tpCreatedAt = Nothing, _tpName = Nothing,
                           _tpSourceLanguageCode = Nothing,
                           _tpTermCount = Nothing, _tpEncryptionKey = Nothing,
