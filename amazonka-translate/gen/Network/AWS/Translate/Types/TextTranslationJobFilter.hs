...
data TextTranslationJobFilter = TextTranslationJobFilter'{_ttjfSubmittedBeforeTime
                                                          :: !(Maybe POSIX),
...
textTranslationJobFilter
    :: TextTranslationJobFilter
textTranslationJobFilter
  = TextTranslationJobFilter'{_ttjfSubmittedBeforeTime
                                = Nothing,
                              _ttjfSubmittedAfterTime = Nothing,
                              _ttjfJobName = Nothing, _ttjfJobStatus = Nothing}
...
instance Hashable TextTranslationJobFilter where

instance NFData TextTranslationJobFilter where
