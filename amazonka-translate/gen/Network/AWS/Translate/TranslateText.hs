...
ttSourceLanguageCode =
  lens _ttSourceLanguageCode (\s a -> s {_ttSourceLanguageCode = a})
...
ttTargetLanguageCode =
  lens _ttTargetLanguageCode (\s a -> s {_ttTargetLanguageCode = a})
...
instance AWSRequest TranslateText where
  ...
  response =
    receiveJSON
      (\s h x ->
         TranslateTextResponse' <$> (pure (fromEnum s)) <*>
         (x .:> "TranslatedText") <*>
...
ttrsResponseStatus =
  lens _ttrsResponseStatus (\s a -> s {_ttrsResponseStatus = a})

-- | The text translated into the target language.
ttrsTranslatedText :: Lens' TranslateTextResponse Text
ttrsTranslatedText =
  lens _ttrsTranslatedText (\s a -> s {_ttrsTranslatedText = a})

-- | The language code for the language of the input text.
ttrsSourceLanguageCode :: Lens' TranslateTextResponse Text
ttrsSourceLanguageCode =
  lens _ttrsSourceLanguageCode (\s a -> s {_ttrsSourceLanguageCode = a})

-- | The language code for the language of the translated text.
ttrsTargetLanguageCode :: Lens' TranslateTextResponse Text
ttrsTargetLanguageCode =
  lens _ttrsTargetLanguageCode (\s a -> s {_ttrsTargetLanguageCode = a})
