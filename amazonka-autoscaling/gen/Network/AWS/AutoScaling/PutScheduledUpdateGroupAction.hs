...
--
-- * 'psugaMaxSize' - The maximum number of instances in the Auto Scaling group.
--
...
--
-- * 'psugaDesiredCapacity' - The number of EC2 instances that should be running in the Auto Scaling group.
--
-- * 'psugaMinSize' - The minimum number of instances in the Auto Scaling group.
--
