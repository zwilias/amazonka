...
dAutoScalingGroupName =
  lens _dAutoScalingGroupName (\s a -> s {_dAutoScalingGroupName = a})

-- | The names of the load balancers. You can specify up to 10 load balancers.
dLoadBalancerNames :: Lens' DetachLoadBalancers [Text]
dLoadBalancerNames =
  lens _dLoadBalancerNames (\s a -> s {_dLoadBalancerNames = a}) . _Coerce
...
dlbsrsResponseStatus =
  lens _dlbsrsResponseStatus (\s a -> s {_dlbsrsResponseStatus = a})
