...
instance FromXML Activity where
  parseXML x =
    Activity' <$> (x .@? "Progress") <*> (x .@? "StatusMessage") <*>
    (x .@? "EndTime") <*>
    (x .@? "Details") <*>
    (x .@? "Description") <*>
    (x .@ "ActivityId") <*>
...
asgHealthCheckGracePeriod =
  lens _asgHealthCheckGracePeriod (\s a -> s {_asgHealthCheckGracePeriod = a})

-- | The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other AWS services on your behalf.
asgServiceLinkedRoleARN :: Lens' AutoScalingGroup (Maybe Text)
asgServiceLinkedRoleARN =
  lens _asgServiceLinkedRoleARN (\s a -> s {_asgServiceLinkedRoleARN = a})
...
asgNewInstancesProtectedFromScaleIn =
  lens
    ...
    (\s a -> s {_asgNewInstancesProtectedFromScaleIn = a})
...
asgTargetGroupARNs =
  lens _asgTargetGroupARNs (\s a -> s {_asgTargetGroupARNs = a}) .
  _Default . _Coerce
...
asgLaunchConfigurationName =
  lens _asgLaunchConfigurationName (\s a -> s {_asgLaunchConfigurationName = a})

-- | The EC2 instances associated with the group.
asgInstances :: Lens' AutoScalingGroup [Instance]
asgInstances =
  lens _asgInstances (\s a -> s {_asgInstances = a}) . _Default . _Coerce
...
asgAvailabilityZones =
  lens _asgAvailabilityZones (\s a -> s {_asgAvailabilityZones = a}) . _List1
...
instance FromXML AutoScalingGroup where
  parseXML x =
    AutoScalingGroup' <$> (x .@? "Status") <*>
    (x .@? "TerminationPolicies" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "HealthCheckGracePeriod") <*>
    (x .@? "ServiceLinkedRoleARN") <*>
    (x .@? "NewInstancesProtectedFromScaleIn") <*>
    (x .@? "VPCZoneIdentifier") <*>
    (x .@? "TargetGroupARNs" .!@ mempty >>= may (parseXMLList "member")) <*>
    ...
    (x .@? "PlacementGroup") <*>
    (x .@? "SuspendedProcesses" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "LoadBalancerNames" .!@ mempty >>= may (parseXMLList "member")) <*>
...
asidLaunchTemplate ::
     Lens' AutoScalingInstanceDetails (Maybe LaunchTemplateSpecification)
asidLaunchTemplate =
  lens _asidLaunchTemplate (\s a -> s {_asidLaunchTemplate = a})
...
asidAutoScalingGroupName =
  lens _asidAutoScalingGroupName (\s a -> s {_asidAutoScalingGroupName = a})
...
asidProtectedFromScaleIn =
  lens _asidProtectedFromScaleIn (\s a -> s {_asidProtectedFromScaleIn = a})

instance FromXML AutoScalingInstanceDetails where
  parseXML x =
    AutoScalingInstanceDetails' <$> (x .@? "LaunchConfigurationName") <*>
    (x .@? "LaunchTemplate") <*>
    (x .@ "InstanceId") <*>
    (x .@ "AutoScalingGroupName") <*>
    (x .@ "AvailabilityZone") <*>
...
cmsDimensions =
  lens _cmsDimensions (\s a -> s {_cmsDimensions = a}) . _Default . _Coerce
...
ebsVolumeSize =
  lens _ebsVolumeSize (\s a -> s {_ebsVolumeSize = a}) . mapping _Nat
...
instance FromXML EBS where
  parseXML x =
    EBS' <$> (x .@? "DeleteOnTermination") <*> (x .@? "VolumeSize") <*>
    (x .@? "Iops") <*>
    (x .@? "Encrypted") <*>
    (x .@? "VolumeType") <*>
    (x .@? "SnapshotId")
...
instance FromXML EnabledMetric where
  parseXML x = EnabledMetric' <$> (x .@? "Granularity") <*> (x .@? "Metric")
...
iLaunchConfigurationName =
  lens _iLaunchConfigurationName (\s a -> s {_iLaunchConfigurationName = a})
...
iProtectedFromScaleIn =
  lens _iProtectedFromScaleIn (\s a -> s {_iProtectedFromScaleIn = a})

instance FromXML Instance where
  parseXML x =
    Instance' <$> (x .@? "LaunchConfigurationName") <*> (x .@? "LaunchTemplate") <*>
    (x .@ "InstanceId") <*>
    (x .@ "AvailabilityZone") <*>
    (x .@ "LifecycleState") <*>
    (x .@ "HealthStatus") <*>
...
lcAssociatePublicIPAddress =
  lens _lcAssociatePublicIPAddress (\s a -> s {_lcAssociatePublicIPAddress = a})
...
lcLaunchConfigurationARN =
  lens _lcLaunchConfigurationARN (\s a -> s {_lcLaunchConfigurationARN = a})
...
lcLaunchConfigurationName =
  lens _lcLaunchConfigurationName (\s a -> s {_lcLaunchConfigurationName = a})
...
instance FromXML LaunchConfiguration where
  parseXML x =
    LaunchConfiguration' <$> (x .@? "AssociatePublicIpAddress") <*>
    ...
    (x .@? "PlacementTenancy") <*>
    (x .@? "BlockDeviceMappings" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@ "LaunchConfigurationName") <*>
    (x .@ "ImageId") <*>
    (x .@ "InstanceType") <*>
    (x .@ "CreatedTime")
...
instance FromXML LaunchTemplateSpecification where
  parseXML x =
    LaunchTemplateSpecification' <$> (x .@? "LaunchTemplateName") <*>
    (x .@? "LaunchTemplateId") <*>
    (x .@? "Version")
...
instance FromXML LifecycleHook where
  parseXML x =
    LifecycleHook' <$> (x .@? "DefaultResult") <*> (x .@? "LifecycleHookName") <*>
    (x .@? "HeartbeatTimeout") <*>
    (x .@? "AutoScalingGroupName") <*>
...
lhsHeartbeatTimeout =
  lens _lhsHeartbeatTimeout (\s a -> s {_lhsHeartbeatTimeout = a})

-- | Additional information that you want to include any time Auto Scaling sends a message to the notification target.
lhsNotificationMetadata :: Lens' LifecycleHookSpecification (Maybe Text)
lhsNotificationMetadata =
  lens _lhsNotificationMetadata (\s a -> s {_lhsNotificationMetadata = a})

-- | The ARN of the target that Auto Scaling sends notifications to when an instance is in the transition state for the lifecycle hook. The notification target can be either an SQS queue or an SNS topic.
lhsNotificationTargetARN :: Lens' LifecycleHookSpecification (Maybe Text)
lhsNotificationTargetARN =
  lens _lhsNotificationTargetARN (\s a -> s {_lhsNotificationTargetARN = a})
...
lhsLifecycleHookName =
  lens _lhsLifecycleHookName (\s a -> s {_lhsLifecycleHookName = a})

-- | The state of the EC2 instance to which you want to attach the lifecycle hook. For a list of lifecycle hook types, see 'DescribeLifecycleHookTypes' .
lhsLifecycleTransition :: Lens' LifecycleHookSpecification Text
lhsLifecycleTransition =
  lens _lhsLifecycleTransition (\s a -> s {_lhsLifecycleTransition = a})
...
lbsLoadBalancerName =
  lens _lbsLoadBalancerName (\s a -> s {_lbsLoadBalancerName = a})

instance FromXML LoadBalancerState where
  parseXML x =
    LoadBalancerState' <$> (x .@? "State") <*> (x .@? "LoadBalancerName")
...
lbtgsLoadBalancerTargetGroupARN ::
     Lens' LoadBalancerTargetGroupState (Maybe Text)
lbtgsLoadBalancerTargetGroupARN =
  lens
    _lbtgsLoadBalancerTargetGroupARN
    (\s a -> s {_lbtgsLoadBalancerTargetGroupARN = a})

instance FromXML LoadBalancerTargetGroupState where
  parseXML x =
    LoadBalancerTargetGroupState' <$> (x .@? "State") <*>
...
instance FromXML NotificationConfiguration where
  parseXML x =
    NotificationConfiguration' <$> (x .@? "TopicARN") <*>
    (x .@? "AutoScalingGroupName") <*>
    (x .@? "NotificationType")
...
pmsPredefinedMetricType =
  lens _pmsPredefinedMetricType (\s a -> s {_pmsPredefinedMetricType = a})

instance FromXML PredefinedMetricSpecification where
  parseXML x =
    PredefinedMetricSpecification' <$> (x .@? "ResourceLabel") <*>
...
sMinAdjustmentStep =
  lens _sMinAdjustmentStep (\s a -> s {_sMinAdjustmentStep = a})

-- | The estimated time, in seconds, until a newly launched instance can contribute to the CloudWatch metrics.
sEstimatedInstanceWarmup :: Lens' ScalingPolicy (Maybe Int)
sEstimatedInstanceWarmup =
  lens _sEstimatedInstanceWarmup (\s a -> s {_sEstimatedInstanceWarmup = a})
...
sStepAdjustments =
  lens _sStepAdjustments (\s a -> s {_sStepAdjustments = a}) .
  _Default . _Coerce

-- | A target tracking policy.
sTargetTrackingConfiguration ::
     Lens' ScalingPolicy (Maybe TargetTrackingConfiguration)
sTargetTrackingConfiguration =
  lens
    _sTargetTrackingConfiguration
    (\s a -> s {_sTargetTrackingConfiguration = a})
...
sAutoScalingGroupName =
  lens _sAutoScalingGroupName (\s a -> s {_sAutoScalingGroupName = a})

-- | The amount by which to scale, based on the specified adjustment type. A positive value adds to the current capacity while a negative number removes from the current capacity.
sScalingAdjustment :: Lens' ScalingPolicy (Maybe Int)
sScalingAdjustment =
  lens _sScalingAdjustment (\s a -> s {_sScalingAdjustment = a})
...
sMetricAggregationType =
  lens _sMetricAggregationType (\s a -> s {_sMetricAggregationType = a})
...
sMinAdjustmentMagnitude =
  lens _sMinAdjustmentMagnitude (\s a -> s {_sMinAdjustmentMagnitude = a})

instance FromXML ScalingPolicy where
  parseXML x =
    ScalingPolicy' <$> (x .@? "MinAdjustmentStep") <*>
    (x .@? "EstimatedInstanceWarmup") <*>
    (x .@? "PolicyName") <*>
    (x .@? "PolicyType") <*>
    (x .@? "StepAdjustments" .!@ mempty >>= may (parseXMLList "member")) <*>
...
sugaStartTime =
  lens _sugaStartTime (\s a -> s {_sugaStartTime = a}) . mapping _Time
...
sugaAutoScalingGroupName =
  lens _sugaAutoScalingGroupName (\s a -> s {_sugaAutoScalingGroupName = a})
...
instance FromXML ScheduledUpdateGroupAction where
  parseXML x =
    ScheduledUpdateGroupAction' <$> (x .@? "ScheduledActionARN") <*>
    (x .@? "StartTime") <*>
    (x .@? "Time") <*>
...
saMetricIntervalLowerBound =
  lens _saMetricIntervalLowerBound (\s a -> s {_saMetricIntervalLowerBound = a})

-- | The upper bound for the difference between the alarm threshold and the CloudWatch metric. If the metric value is above the breach threshold, the upper bound is exclusive (the metric must be less than the threshold plus the upper bound). Otherwise, it is inclusive (the metric must be less than or equal to the threshold plus the upper bound). A null value indicates positive infinity. The upper bound must be greater than the lower bound.
saMetricIntervalUpperBound :: Lens' StepAdjustment (Maybe Double)
saMetricIntervalUpperBound =
  lens _saMetricIntervalUpperBound (\s a -> s {_saMetricIntervalUpperBound = a})

-- | The amount by which to scale, based on the specified adjustment type. A positive value adds to the current capacity while a negative number removes from the current capacity.
saScalingAdjustment :: Lens' StepAdjustment Int
saScalingAdjustment =
  lens _saScalingAdjustment (\s a -> s {_saScalingAdjustment = a})

instance FromXML StepAdjustment where
  parseXML x =
    StepAdjustment' <$> (x .@? "MetricIntervalLowerBound") <*>
...
instance FromXML SuspendedProcess where
  parseXML x =
    SuspendedProcess' <$> (x .@? "ProcessName") <*> (x .@? "SuspensionReason")
...
ttcPredefinedMetricSpecification ::
     Lens' TargetTrackingConfiguration (Maybe PredefinedMetricSpecification)
ttcPredefinedMetricSpecification =
  lens
    _ttcPredefinedMetricSpecification
    (\s a -> s {_ttcPredefinedMetricSpecification = a})

-- | A customized metric.
ttcCustomizedMetricSpecification ::
     Lens' TargetTrackingConfiguration (Maybe CustomizedMetricSpecification)
ttcCustomizedMetricSpecification =
  lens
    _ttcCustomizedMetricSpecification
    (\s a -> s {_ttcCustomizedMetricSpecification = a})
...
instance FromXML TargetTrackingConfiguration where
  parseXML x =
    TargetTrackingConfiguration' <$> (x .@? "PredefinedMetricSpecification") <*>
...
instance ToQuery TargetTrackingConfiguration where
  toQuery TargetTrackingConfiguration' {..} =
    mconcat
      [ "PredefinedMetricSpecification" =: _ttcPredefinedMetricSpecification
      , "CustomizedMetricSpecification" =: _ttcCustomizedMetricSpecification
