...
data FailedScheduledUpdateGroupActionRequest = FailedScheduledUpdateGroupActionRequest'{_fsugarErrorCode
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
                                                                                        _fsugarErrorMessage
...
failedScheduledUpdateGroupActionRequest
  ...
  = FailedScheduledUpdateGroupActionRequest'{_fsugarErrorCode
                                               = Nothing,
