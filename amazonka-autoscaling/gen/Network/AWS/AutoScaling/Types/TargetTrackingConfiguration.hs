...
data TargetTrackingConfiguration = TargetTrackingConfiguration'{_ttcPredefinedMetricSpecification
                                                                ::
                                                                !(Maybe
...
targetTrackingConfiguration pTargetValue_
  = TargetTrackingConfiguration'{_ttcPredefinedMetricSpecification
                                   = Nothing,
