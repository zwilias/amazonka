...
data AutoScalingInstanceDetails = AutoScalingInstanceDetails'{_asidWeightedCapacity
                                                              :: !(Maybe Text),
                                                              _asidInstanceType
                                                              :: !(Maybe Text),
...
autoScalingInstanceDetails
    ...
    -> AutoScalingInstanceDetails
autoScalingInstanceDetails pInstanceId_
  pAutoScalingGroupName_ pAvailabilityZone_
  pLifecycleState_ pHealthStatus_
  pProtectedFromScaleIn_
  = AutoScalingInstanceDetails'{_asidWeightedCapacity =
                                  Nothing,
