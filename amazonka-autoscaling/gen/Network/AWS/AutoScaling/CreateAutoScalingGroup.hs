...
casgHealthCheckGracePeriod =
  lens _casgHealthCheckGracePeriod (\s a -> s {_casgHealthCheckGracePeriod = a})
...
casgServiceLinkedRoleARN =
  lens _casgServiceLinkedRoleARN (\s a -> s {_casgServiceLinkedRoleARN = a})

-- | Indicates whether newly launched instances are protected from termination by Auto Scaling when scaling in.
casgNewInstancesProtectedFromScaleIn ::
     Lens' CreateAutoScalingGroup (Maybe Bool)
casgNewInstancesProtectedFromScaleIn =
  lens
    _casgNewInstancesProtectedFromScaleIn
    (\s a -> s {_casgNewInstancesProtectedFromScaleIn = a})
...
casgTargetGroupARNs =
  lens _casgTargetGroupARNs (\s a -> s {_casgTargetGroupARNs = a}) .
  _Default . _Coerce
...
casgLifecycleHookSpecificationList ::
     Lens' CreateAutoScalingGroup [LifecycleHookSpecification]
casgLifecycleHookSpecificationList =
  lens
    _casgLifecycleHookSpecificationList
    (\s a -> s {_casgLifecycleHookSpecificationList = a}) .
  _Default . _Coerce
...
casgLaunchTemplate ::
     Lens' CreateAutoScalingGroup (Maybe LaunchTemplateSpecification)
casgLaunchTemplate =
  lens _casgLaunchTemplate (\s a -> s {_casgLaunchTemplate = a})
  ...
  toQuery CreateAutoScalingGroup' {..} =
    mconcat
      ...
      , "LifecycleHookSpecificationList" =:
        toQuery (toQueryList "member" <$> _casgLifecycleHookSpecificationList)
