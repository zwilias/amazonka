...
sipInstanceIds =
  lens _sipInstanceIds (\s a -> s {_sipInstanceIds = a}) . _Coerce

-- | The name of the Auto Scaling group.
sipAutoScalingGroupName :: Lens' SetInstanceProtection Text
sipAutoScalingGroupName =
  lens _sipAutoScalingGroupName (\s a -> s {_sipAutoScalingGroupName = a})

-- | Indicates whether the instance is protected from termination by Auto Scaling when scaling in.
sipProtectedFromScaleIn :: Lens' SetInstanceProtection Bool
sipProtectedFromScaleIn =
  lens _sipProtectedFromScaleIn (\s a -> s {_sipProtectedFromScaleIn = a})
...
siprsResponseStatus =
  lens _siprsResponseStatus (\s a -> s {_siprsResponseStatus = a})
