...
instance ToQuery DescribeAutoScalingNotificationTypes where
  toQuery =
    const
      (mconcat
         [ "Action" =: ("DescribeAutoScalingNotificationTypes" :: ByteString)
...
dasntrsAutoScalingNotificationTypes ::
     Lens' DescribeAutoScalingNotificationTypesResponse [Text]
dasntrsAutoScalingNotificationTypes =
  lens
...
dasntrsResponseStatus =
  lens _dasntrsResponseStatus (\s a -> s {_dasntrsResponseStatus = a})
