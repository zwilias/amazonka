...
dasiInstanceIds =
  lens _dasiInstanceIds (\s a -> s {_dasiInstanceIds = a}) . _Default . _Coerce
...
instance AWSRequest DescribeAutoScalingInstances where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DescribeAutoScalingInstancesResponse' <$> (x .@? "NextToken") <*>
...
instance ToQuery DescribeAutoScalingInstances where
  toQuery DescribeAutoScalingInstances' {..} =
    mconcat
      ...
      , "InstanceIds" =: toQuery (toQueryList "member" <$> _dasiInstanceIds)
...
-- | The instances.
dasirsAutoScalingInstances ::
     Lens' DescribeAutoScalingInstancesResponse [AutoScalingInstanceDetails]
dasirsAutoScalingInstances =
  lens _dasirsAutoScalingInstances (\s a -> s {_dasirsAutoScalingInstances = a}) .
  _Default . _Coerce

-- | -- | The response status code.
dasirsResponseStatus :: Lens' DescribeAutoScalingInstancesResponse Int
dasirsResponseStatus =
  lens _dasirsResponseStatus (\s a -> s {_dasirsResponseStatus = a})
