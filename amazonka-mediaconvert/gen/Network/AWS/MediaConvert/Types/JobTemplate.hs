...
data JobTemplate = JobTemplate'{_jtAccelerationSettings
...
jobTemplate pSettings_ pName_
  = JobTemplate'{_jtAccelerationSettings = Nothing,
                 _jtLastUpdated = Nothing, _jtPriority = Nothing,
                 _jtStatusUpdateInterval = Nothing, _jtARN = Nothing,
                 _jtCreatedAt = Nothing, _jtCategory = Nothing,
                 _jtHopDestinations = Nothing, _jtQueue = Nothing,
                 _jtType = Nothing, _jtDescription = Nothing,
                 _jtSettings = pSettings_, _jtName = pName_}
