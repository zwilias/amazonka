...
data JobTemplateSettings = JobTemplateSettings'{_jtsEsam
                                                :: !(Maybe EsamSettings),
                                                _jtsInputs ::
                                                !(Maybe [InputTemplate]),
...
--
-- * 'jtsTimedMetadataInsertion' - Enable Timed metadata insertion (TimedMetadataInsertion) to include ID3 tags in your job. To include timed metadata, you must enable it here, enable it in each output container, and specify tags and timecodes in ID3 insertion (Id3Insertion) objects.
--
...
jobTemplateSettings
    :: JobTemplateSettings
jobTemplateSettings
  = JobTemplateSettings'{_jtsEsam = Nothing,
                         _jtsInputs = Nothing,
