...
data DashAdditionalManifest = DashAdditionalManifest'{_damManifestNameModifier
                                                      :: !(Maybe Text),
                                                      _damSelectedOutputs ::
                                                      !(Maybe [Text])}
...
dashAdditionalManifest
    :: DashAdditionalManifest
dashAdditionalManifest
  = DashAdditionalManifest'{_damManifestNameModifier =
                              Nothing,
...
instance FromJSON DashAdditionalManifest where
        parseJSON
          = withObject "DashAdditionalManifest"
              (\ x ->
                 DashAdditionalManifest' <$>
                   (x .:? "manifestNameModifier") <*>
                     (x .:? "selectedOutputs" .!= mempty))

instance Hashable DashAdditionalManifest where

instance NFData DashAdditionalManifest where
