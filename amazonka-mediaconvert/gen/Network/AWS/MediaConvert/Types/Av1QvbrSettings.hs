...
data Av1QvbrSettings = Av1QvbrSettings'{_aqsQvbrQualityLevelFineTune
                                        :: !(Maybe Double),
...
av1QvbrSettings
    :: Av1QvbrSettings
av1QvbrSettings
  = Av1QvbrSettings'{_aqsQvbrQualityLevelFineTune =
                       Nothing,
...
instance FromJSON Av1QvbrSettings where
        parseJSON
          = withObject "Av1QvbrSettings"
              (\ x ->
                 Av1QvbrSettings' <$>
                   (x .:? "qvbrQualityLevelFineTune") <*>
                     (x .:? "qvbrQualityLevel"))

instance Hashable Av1QvbrSettings where

instance NFData Av1QvbrSettings where
