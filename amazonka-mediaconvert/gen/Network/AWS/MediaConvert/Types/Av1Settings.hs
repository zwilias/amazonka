...
--
-- * 'asFramerateConversionAlgorithm' - When set to INTERPOLATE, produces smoother motion during frame rate conversion.
--
...
--
-- * 'asAdaptiveQuantization' - Adaptive quantization. Allows intra-frame quantizers to vary to improve visual quality.
--
...
--
-- * 'asSpatialAdaptiveQuantization' - Adjust quantization within each frame based on spatial variation of content complexity.
av1Settings
    :: Av1Settings
av1Settings
