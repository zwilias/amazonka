...
data CmafEncryptionSettings = CmafEncryptionSettings'{_cesEncryptionMethod
                                                      ::
                                                      !(Maybe
                                                          CmafEncryptionType),
...
cmafEncryptionSettings
    :: CmafEncryptionSettings
cmafEncryptionSettings
  = CmafEncryptionSettings'{_cesEncryptionMethod =
                              Nothing,
                            _cesConstantInitializationVector = Nothing,
                            _cesType = Nothing, _cesStaticKeyProvider = Nothing,
