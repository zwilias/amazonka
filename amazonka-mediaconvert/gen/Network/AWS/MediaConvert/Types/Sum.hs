...
instance FromText AacAudioDescriptionBroadcasterMix where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacAudioDescriptionBroadcasterMix from value: '" <>
        e <> "'. Accepted values: broadcaster_mixed_ad, normal"
...
instance FromText AacCodecProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacCodecProfile from value: '" <>
        e <> "'. Accepted values: hev1, hev2, lc"
...
instance FromText AacCodingMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacCodingMode from value: '" <>
        e <>
...
instance FromText AacRateControlMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacRateControlMode from value: '" <>
        e <> "'. Accepted values: cbr, vbr"
...
instance FromText AacRawFormat where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacRawFormat from value: '" <>
        e <> "'. Accepted values: latm_loas, none"
...
instance FromText AacSpecification where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacSpecification from value: '" <>
        e <> "'. Accepted values: mpeg2, mpeg4"
...
instance FromText AacVbrQuality where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AacVbrQuality from value: '" <>
        e <> "'. Accepted values: high, low, medium_high, medium_low"
...
instance FromText Ac3BitstreamMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3BitstreamMode from value: '" <>
        e <>
...
instance FromText Ac3CodingMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3CodingMode from value: '" <>
        e <>
...
instance FromText Ac3DynamicRangeCompressionProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3DynamicRangeCompressionProfile from value: '" <>
        e <> "'. Accepted values: film_standard, none"
...
instance FromText Ac3LfeFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3LfeFilter from value: '" <>
...
instance FromText Ac3MetadataControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Ac3MetadataControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText AfdSignaling where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AfdSignaling from value: '" <>
        e <> "'. Accepted values: auto, fixed, none"
...
instance FromText AntiAlias where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AntiAlias from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText AudioCodec where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioCodec from value: '" <>
        e <> "'. Accepted values: ac3, aac, aiff, eac3, mp2, passthrough, wav"
...
instance FromText AudioDefaultSelection where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioDefaultSelection from value: '" <>
        e <> "'. Accepted values: default, not_default"
...
instance FromText AudioLanguageCodeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioLanguageCodeControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText AudioNormalizationAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioNormalizationAlgorithm from value: '" <>
        e <> "'. Accepted values: itu_bs_1770_1, itu_bs_1770_2"
...
instance FromText AudioNormalizationAlgorithmControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioNormalizationAlgorithmControl from value: '" <>
        e <> "'. Accepted values: correct_audio, measure_only"
...
instance FromText AudioNormalizationLoudnessLogging where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioNormalizationLoudnessLogging from value: '" <>
        e <> "'. Accepted values: dont_log, log"
...
instance FromText AudioNormalizationPeakCalculation where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioNormalizationPeakCalculation from value: '" <>
        e <> "'. Accepted values: none, true_peak"
...
instance FromText AudioSelectorType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioSelectorType from value: '" <>
        e <> "'. Accepted values: language_code, pid, track"
...
instance FromText AudioTypeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AudioTypeControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText BurninSubtitleAlignment where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleAlignment from value: '" <>
        e <> "'. Accepted values: centered, left"
...
instance FromText BurninSubtitleBackgroundColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleBackgroundColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText BurninSubtitleFontColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleFontColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText BurninSubtitleOutlineColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleOutlineColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText BurninSubtitleShadowColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleShadowColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText BurninSubtitleTeletextSpacing where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing BurninSubtitleTeletextSpacing from value: '" <>
        e <> "'. Accepted values: fixed_grid, proportional"
...
instance FromText CaptionDestinationType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CaptionDestinationType from value: '" <>
        e <>
...
instance FromText CaptionSourceType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CaptionSourceType from value: '" <>
        e <>
...
instance FromText ColorMetadata where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ColorMetadata from value: '" <>
        e <> "'. Accepted values: ignore, insert"
...
instance FromText ColorSpace where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ColorSpace from value: '" <>
        e <> "'. Accepted values: follow, hdr10, hlg_2020, rec_601, rec_709"
...
instance FromText ColorSpaceConversion where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ColorSpaceConversion from value: '" <>
        e <>
...
instance FromText ColorSpaceUsage where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ColorSpaceUsage from value: '" <>
        e <> "'. Accepted values: fallback, force"
...
instance FromText ContainerType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ContainerType from value: '" <>
        e <>
...
instance FromText DashIsoHbbtvCompliance where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DashIsoHbbtvCompliance from value: '" <>
        e <> "'. Accepted values: hbbtv_1_5, none"
...
instance FromText DashIsoSegmentControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DashIsoSegmentControl from value: '" <>
        e <> "'. Accepted values: segmented_files, single_file"
...
instance FromText DeinterlaceAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeinterlaceAlgorithm from value: '" <>
        e <>
...
instance FromText DeinterlacerControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeinterlacerControl from value: '" <>
        e <> "'. Accepted values: force_all_frames, normal"
...
instance FromText DeinterlacerMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DeinterlacerMode from value: '" <>
        e <> "'. Accepted values: adaptive, deinterlace, inverse_telecine"
...
instance FromText DropFrameTimecode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DropFrameTimecode from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText DvbSubtitleAlignment where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleAlignment from value: '" <>
        e <> "'. Accepted values: centered, left"
...
instance FromText DvbSubtitleBackgroundColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleBackgroundColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText DvbSubtitleFontColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleFontColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText DvbSubtitleOutlineColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleOutlineColor from value: '" <>
        e <> "'. Accepted values: black, blue, green, red, white, yellow"
...
instance FromText DvbSubtitleShadowColor where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleShadowColor from value: '" <>
        e <> "'. Accepted values: black, none, white"
...
instance FromText DvbSubtitleTeletextSpacing where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing DvbSubtitleTeletextSpacing from value: '" <>
        e <> "'. Accepted values: fixed_grid, proportional"
...
instance FromText Eac3AttenuationControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3AttenuationControl from value: '" <>
        e <> "'. Accepted values: attenuate_3_db, none"
...
instance FromText Eac3BitstreamMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3BitstreamMode from value: '" <>
        e <>
...
instance FromText Eac3CodingMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3CodingMode from value: '" <>
        e <>
...
instance FromText Eac3DcFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3DcFilter from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText Eac3DynamicRangeCompressionLine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3DynamicRangeCompressionLine from value: '" <>
        e <>
...
instance FromText Eac3DynamicRangeCompressionRf where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3DynamicRangeCompressionRf from value: '" <>
        e <>
        "'. Accepted values: film_light, film_standard, music_light, music_standard, none, speech"
...
instance FromText Eac3LfeControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3LfeControl from value: '" <>
        e <> "'. Accepted values: lfe, no_lfe"
...
instance FromText Eac3LfeFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3LfeFilter from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText Eac3MetadataControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3MetadataControl from value: '" <>
        e <> "'. Accepted values: follow_input, use_configured"
...
instance FromText Eac3PassthroughControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3PassthroughControl from value: '" <>
        e <> "'. Accepted values: no_passthrough, when_possible"
...
instance FromText Eac3PhaseControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3PhaseControl from value: '" <>
        e <> "'. Accepted values: no_shift, shift_90_degrees"
...
instance FromText Eac3StereoDownmix where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3StereoDownmix from value: '" <>
        e <> "'. Accepted values: dpl2, lo_ro, lt_rt, not_indicated"
...
instance FromText Eac3SurroundExMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3SurroundExMode from value: '" <>
        e <> "'. Accepted values: disabled, enabled, not_indicated"
...
instance FromText Eac3SurroundMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Eac3SurroundMode from value: '" <>
        e <> "'. Accepted values: disabled, enabled, not_indicated"
...
instance FromText EmbeddedConvert608To708 where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing EmbeddedConvert608To708 from value: '" <>
        e <> "'. Accepted values: disabled, upconvert"
...
instance FromText F4vMoovPlacement where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing F4vMoovPlacement from value: '" <>
        e <> "'. Accepted values: normal, progressive_download"
...
instance FromText FileSourceConvert608To708 where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing FileSourceConvert608To708 from value: '" <>
        e <> "'. Accepted values: disabled, upconvert"
...
instance FromText H264AdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264AdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: high, higher, low, max, medium, off"
...
instance FromText H264CodecLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264CodecLevel from value: '" <>
        e <>
...
instance FromText H264CodecProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264CodecProfile from value: '" <>
        e <>
...
instance FromText H264EntropyEncoding where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264EntropyEncoding from value: '" <>
        e <> "'. Accepted values: cabac, cavlc"
...
instance FromText H264FieldEncoding where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264FieldEncoding from value: '" <>
        e <> "'. Accepted values: force_field, paff"
...
instance FromText H264FlickerAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264FlickerAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264FramerateControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264FramerateControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText H264FramerateConversionAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264FramerateConversionAlgorithm from value: '" <>
        e <> "'. Accepted values: duplicate_drop, interpolate"
...
instance FromText H264GopBReference where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264GopBReference from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264GopSizeUnits where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264GopSizeUnits from value: '" <>
        e <> "'. Accepted values: frames, seconds"
...
instance FromText H264InterlaceMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264InterlaceMode from value: '" <>
        e <>
...
instance FromText H264ParControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264ParControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText H264QualityTuningLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264QualityTuningLevel from value: '" <>
        e <> "'. Accepted values: multi_pass_hq, single_pass, single_pass_hq"
...
instance FromText H264RateControlMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264RateControlMode from value: '" <>
        e <> "'. Accepted values: cbr, vbr"
...
instance FromText H264RepeatPps where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264RepeatPps from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264SceneChangeDetect where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264SceneChangeDetect from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264SlowPal where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264SlowPal from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264SpatialAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264SpatialAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264Syntax where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264Syntax from value: '" <>
        e <> "'. Accepted values: default, rp2027"
...
instance FromText H264Telecine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264Telecine from value: '" <>
        e <> "'. Accepted values: hard, none, soft"
...
instance FromText H264TemporalAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264TemporalAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H264UnregisteredSeiTimecode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H264UnregisteredSeiTimecode from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265AdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265AdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: high, higher, low, max, medium, off"
...
instance FromText H265AlternateTransferFunctionSei where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265AlternateTransferFunctionSei from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265CodecLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265CodecLevel from value: '" <>
        e <>
...
instance FromText H265CodecProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265CodecProfile from value: '" <>
        e <>
...
instance FromText H265FlickerAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265FlickerAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265FramerateControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265FramerateControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText H265FramerateConversionAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265FramerateConversionAlgorithm from value: '" <>
        e <> "'. Accepted values: duplicate_drop, interpolate"
...
instance FromText H265GopBReference where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265GopBReference from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265GopSizeUnits where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265GopSizeUnits from value: '" <>
        e <> "'. Accepted values: frames, seconds"
...
instance FromText H265InterlaceMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265InterlaceMode from value: '" <>
        e <>
        "'. Accepted values: bottom_field, follow_bottom_field, follow_top_field, progressive, top_field"
...
instance FromText H265ParControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265ParControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText H265QualityTuningLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265QualityTuningLevel from value: '" <>
        e <> "'. Accepted values: multi_pass_hq, single_pass, single_pass_hq"
...
instance FromText H265RateControlMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265RateControlMode from value: '" <>
        e <> "'. Accepted values: cbr, vbr"
...
instance FromText H265SampleAdaptiveOffsetFilterMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265SampleAdaptiveOffsetFilterMode from value: '" <>
        e <> "'. Accepted values: adaptive, default, off"
...
instance FromText H265SceneChangeDetect where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265SceneChangeDetect from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265SlowPal where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265SlowPal from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265SpatialAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265SpatialAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265Telecine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265Telecine from value: '" <>
        e <> "'. Accepted values: hard, none, soft"
...
instance FromText H265TemporalAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265TemporalAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265TemporalIds where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265TemporalIds from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265Tiles where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265Tiles from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText H265UnregisteredSeiTimecode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing H265UnregisteredSeiTimecode from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText HlsAdMarkers where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsAdMarkers from value: '" <>
        e <> "'. Accepted values: elemental, elemental_scte35"
...
instance FromText HlsCaptionLanguageSetting where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsCaptionLanguageSetting from value: '" <>
        e <> "'. Accepted values: insert, none, omit"
...
instance FromText HlsClientCache where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsClientCache from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText HlsCodecSpecification where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsCodecSpecification from value: '" <>
        e <> "'. Accepted values: rfc_4281, rfc_6381"
...
instance FromText HlsDirectoryStructure where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsDirectoryStructure from value: '" <>
        e <> "'. Accepted values: single_directory, subdirectory_per_stream"
...
instance FromText HlsEncryptionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsEncryptionType from value: '" <>
        e <> "'. Accepted values: aes128, sample_aes"
...
instance FromText HlsIFrameOnlyManifest where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsIFrameOnlyManifest from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText HlsInitializationVectorInManifest where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsInitializationVectorInManifest from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText HlsKeyProviderType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsKeyProviderType from value: '" <>
        e <> "'. Accepted values: speke, static_key"
...
instance FromText HlsManifestCompression where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsManifestCompression from value: '" <>
        e <> "'. Accepted values: gzip, none"
...
instance FromText HlsManifestDurationFormat where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsManifestDurationFormat from value: '" <>
        e <> "'. Accepted values: floating_point, integer"
...
instance FromText HlsOutputSelection where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsOutputSelection from value: '" <>
        e <> "'. Accepted values: manifests_and_segments, segments_only"
...
instance FromText HlsProgramDateTime where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsProgramDateTime from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText HlsSegmentControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsSegmentControl from value: '" <>
        e <> "'. Accepted values: segmented_files, single_file"
...
instance FromText HlsStreamInfResolution where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsStreamInfResolution from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText HlsTimedMetadataId3Frame where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing HlsTimedMetadataId3Frame from value: '" <>
        e <> "'. Accepted values: none, priv, tdrl"
...
instance FromText InputDeblockFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputDeblockFilter from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText InputDenoiseFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputDenoiseFilter from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText InputFilterEnable where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputFilterEnable from value: '" <>
        e <> "'. Accepted values: auto, disable, force"
...
instance FromText InputPsiControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputPsiControl from value: '" <>
        e <> "'. Accepted values: ignore_psi, use_psi"
...
instance FromText InputTimecodeSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InputTimecodeSource from value: '" <>
        e <> "'. Accepted values: embedded, specifiedstart, zerobased"
...
instance FromText JobTemplateListBy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing JobTemplateListBy from value: '" <>
        e <> "'. Accepted values: creation_date, name, system"
...
instance FromText LanguageCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing LanguageCode from value: '" <>
        e <>
...
instance FromText M2tsAudioBufferModel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsAudioBufferModel from value: '" <>
        e <> "'. Accepted values: atsc, dvb"
...
instance FromText M2tsBufferModel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsBufferModel from value: '" <>
        e <> "'. Accepted values: multiplex, none"
...
instance FromText M2tsEbpAudioInterval where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsEbpAudioInterval from value: '" <>
        e <> "'. Accepted values: video_and_fixed_intervals, video_interval"
...
instance FromText M2tsEbpPlacement where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsEbpPlacement from value: '" <>
        e <> "'. Accepted values: video_and_audio_pids, video_pid"
...
instance FromText M2tsEsRateInPes where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsEsRateInPes from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText M2tsNielsenId3 where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsNielsenId3 from value: '" <>
        e <> "'. Accepted values: insert, none"
...
instance FromText M2tsPcrControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsPcrControl from value: '" <>
        e <> "'. Accepted values: configured_pcr_period, pcr_every_pes_packet"
...
instance FromText M2tsRateMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsRateMode from value: '" <>
        e <> "'. Accepted values: cbr, vbr"
...
instance FromText M2tsScte35Source where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsScte35Source from value: '" <>
        e <> "'. Accepted values: none, passthrough"
...
instance FromText M2tsSegmentationMarkers where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsSegmentationMarkers from value: '" <>
        e <>
...
instance FromText M2tsSegmentationStyle where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M2tsSegmentationStyle from value: '" <>
        e <> "'. Accepted values: maintain_cadence, reset_cadence"
...
instance FromText M3u8NielsenId3 where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M3u8NielsenId3 from value: '" <>
        e <> "'. Accepted values: insert, none"
...
instance FromText M3u8PcrControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M3u8PcrControl from value: '" <>
        e <> "'. Accepted values: configured_pcr_period, pcr_every_pes_packet"
...
instance FromText M3u8Scte35Source where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing M3u8Scte35Source from value: '" <>
        e <> "'. Accepted values: none, passthrough"
...
instance FromText MovClapAtom where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MovClapAtom from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText MovCslgAtom where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MovCslgAtom from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText MovMpeg2FourCCControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MovMpeg2FourCCControl from value: '" <>
        e <> "'. Accepted values: mpeg, xdcam"
...
instance FromText MovPaddingControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MovPaddingControl from value: '" <>
        e <> "'. Accepted values: none, omneon"
...
instance FromText MovReference where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MovReference from value: '" <>
        e <> "'. Accepted values: external, self_contained"
...
instance FromText Mp4CslgAtom where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mp4CslgAtom from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText Mp4FreeSpaceBox where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mp4FreeSpaceBox from value: '" <>
        e <> "'. Accepted values: exclude, include"
...
instance FromText Mp4MoovPlacement where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mp4MoovPlacement from value: '" <>
        e <> "'. Accepted values: normal, progressive_download"
...
instance FromText Mpeg2AdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2AdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: high, low, medium, off"
...
instance FromText Mpeg2CodecLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2CodecLevel from value: '" <>
        e <> "'. Accepted values: auto, high1440, high, low, main"
...
instance FromText Mpeg2CodecProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2CodecProfile from value: '" <>
        e <> "'. Accepted values: main, profile_422"
...
instance FromText Mpeg2FramerateControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2FramerateControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText Mpeg2FramerateConversionAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2FramerateConversionAlgorithm from value: '" <>
        e <> "'. Accepted values: duplicate_drop, interpolate"
...
instance FromText Mpeg2GopSizeUnits where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2GopSizeUnits from value: '" <>
        e <> "'. Accepted values: frames, seconds"
...
instance FromText Mpeg2InterlaceMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2InterlaceMode from value: '" <>
        e <>
        "'. Accepted values: bottom_field, follow_bottom_field, follow_top_field, progressive, top_field"
...
instance FromText Mpeg2IntraDcPrecision where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2IntraDcPrecision from value: '" <>
        e <>
...
instance FromText Mpeg2ParControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2ParControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText Mpeg2QualityTuningLevel where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2QualityTuningLevel from value: '" <>
        e <> "'. Accepted values: multi_pass, single_pass"
...
instance FromText Mpeg2RateControlMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2RateControlMode from value: '" <>
        e <> "'. Accepted values: cbr, vbr"
...
instance FromText Mpeg2SceneChangeDetect where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2SceneChangeDetect from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText Mpeg2SlowPal where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2SlowPal from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText Mpeg2SpatialAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2SpatialAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText Mpeg2Syntax where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2Syntax from value: '" <>
        e <> "'. Accepted values: d_10, default"
...
instance FromText Mpeg2Telecine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2Telecine from value: '" <>
        e <> "'. Accepted values: hard, none, soft"
...
instance FromText Mpeg2TemporalAdaptiveQuantization where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Mpeg2TemporalAdaptiveQuantization from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText MsSmoothAudioDeduplication where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MsSmoothAudioDeduplication from value: '" <>
        e <> "'. Accepted values: combine_duplicate_streams, none"
...
instance FromText MsSmoothManifestEncoding where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing MsSmoothManifestEncoding from value: '" <>
        e <> "'. Accepted values: utf16, utf8"
...
instance FromText NoiseReducerFilter where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing NoiseReducerFilter from value: '" <>
        e <>
...
instance FromText Order where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Order from value: '" <>
...
instance FromText OutputGroupType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OutputGroupType from value: '" <>
        e <>
...
instance FromText OutputSdt where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing OutputSdt from value: '" <>
        e <>
...
instance FromText PresetListBy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing PresetListBy from value: '" <>
        e <> "'. Accepted values: creation_date, name, system"
...
instance FromText ProresCodecProfile where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresCodecProfile from value: '" <>
        e <>
...
instance FromText ProresFramerateControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresFramerateControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText ProresFramerateConversionAlgorithm where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresFramerateConversionAlgorithm from value: '" <>
        e <> "'. Accepted values: duplicate_drop, interpolate"
...
instance FromText ProresInterlaceMode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresInterlaceMode from value: '" <>
        e <>
        "'. Accepted values: bottom_field, follow_bottom_field, follow_top_field, progressive, top_field"
...
instance FromText ProresParControl where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresParControl from value: '" <>
        e <> "'. Accepted values: initialize_from_source, specified"
...
instance FromText ProresSlowPal where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresSlowPal from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
...
instance FromText ProresTelecine where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ProresTelecine from value: '" <>
        e <> "'. Accepted values: hard, none"
...
instance FromText QueueListBy where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing QueueListBy from value: '" <>
        e <> "'. Accepted values: creation_date, name"
...
instance FromText QueueStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing QueueStatus from value: '" <>
        e <> "'. Accepted values: active, paused"
...
instance FromText RespondToAfd where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RespondToAfd from value: '" <>
        e <> "'. Accepted values: none, passthrough, respond"
...
instance FromText ScalingBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScalingBehavior from value: '" <>
        e <> "'. Accepted values: default, stretch_to_output"
...
instance FromText SccDestinationFramerate where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SccDestinationFramerate from value: '" <>
        e <>
...
instance FromText TimecodeBurninPosition where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TimecodeBurninPosition from value: '" <>
        e <>
...
instance FromText TimecodeSource where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TimecodeSource from value: '" <>
        e <> "'. Accepted values: embedded, specifiedstart, zerobased"
...
instance FromText TimedMetadata where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TimedMetadata from value: '" <>
        e <> "'. Accepted values: none, passthrough"
...
instance FromText TtmlStylePassthrough where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing TtmlStylePassthrough from value: '" <>
        e <> "'. Accepted values: disabled, enabled"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: custom, system"
...
instance FromText VideoCodec where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoCodec from value: '" <>
        e <> "'. Accepted values: frame_capture, h_264, h_265, mpeg2, prores"
...
instance FromText VideoTimecodeInsertion where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing VideoTimecodeInsertion from value: '" <>
        e <> "'. Accepted values: disabled, pic_timing_sei"
