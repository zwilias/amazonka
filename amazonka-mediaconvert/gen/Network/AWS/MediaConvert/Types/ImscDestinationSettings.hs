...
newtype ImscDestinationSettings = ImscDestinationSettings'{_idsStylePassthrough
                                                           ::
                                                           Maybe
...
imscDestinationSettings
    :: ImscDestinationSettings
imscDestinationSettings
  = ImscDestinationSettings'{_idsStylePassthrough =
                               Nothing}
...
instance FromJSON ImscDestinationSettings where
        parseJSON
          = withObject "ImscDestinationSettings"
              (\ x ->
                 ImscDestinationSettings' <$>
                   (x .:? "stylePassthrough"))

instance Hashable ImscDestinationSettings where

instance NFData ImscDestinationSettings where
