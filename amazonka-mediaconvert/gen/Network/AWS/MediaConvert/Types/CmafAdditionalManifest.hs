...
data CmafAdditionalManifest = CmafAdditionalManifest'{_camManifestNameModifier
                                                      :: !(Maybe Text),
                                                      _camSelectedOutputs ::
                                                      !(Maybe [Text])}
...
cmafAdditionalManifest
    :: CmafAdditionalManifest
cmafAdditionalManifest
  = CmafAdditionalManifest'{_camManifestNameModifier =
                              Nothing,
...
instance FromJSON CmafAdditionalManifest where
        parseJSON
          = withObject "CmafAdditionalManifest"
              (\ x ->
                 CmafAdditionalManifest' <$>
                   (x .:? "manifestNameModifier") <*>
                     (x .:? "selectedOutputs" .!= mempty))

instance Hashable CmafAdditionalManifest where

instance NFData CmafAdditionalManifest where
