...
data EmbeddedDestinationSettings = EmbeddedDestinationSettings'{_edsDestination608ChannelNumber
                                                                :: !(Maybe Nat),
...
embeddedDestinationSettings
    :: EmbeddedDestinationSettings
embeddedDestinationSettings
  = EmbeddedDestinationSettings'{_edsDestination608ChannelNumber
                                   = Nothing,
