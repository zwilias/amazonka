...
data SpekeKeyProviderCmaf = SpekeKeyProviderCmaf'{_skpcResourceId
                                                  :: !(Maybe Text),
...
spekeKeyProviderCmaf
    :: SpekeKeyProviderCmaf
spekeKeyProviderCmaf
  = SpekeKeyProviderCmaf'{_skpcResourceId = Nothing,
                          _skpcDashSignaledSystemIds = Nothing,
                          _skpcCertificateARN = Nothing, _skpcURL = Nothing,
...
instance FromJSON SpekeKeyProviderCmaf where
        parseJSON
          = withObject "SpekeKeyProviderCmaf"
              (\ x ->
                 SpekeKeyProviderCmaf' <$>
                   (x .:? "resourceId") <*>
...
instance Hashable SpekeKeyProviderCmaf where

instance NFData SpekeKeyProviderCmaf where
