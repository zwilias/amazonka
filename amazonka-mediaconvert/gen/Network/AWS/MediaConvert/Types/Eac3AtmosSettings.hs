...
data Eac3AtmosSettings = Eac3AtmosSettings'{_easStereoDownmix
...
eac3AtmosSettings
    :: Eac3AtmosSettings
eac3AtmosSettings
  = Eac3AtmosSettings'{_easStereoDownmix = Nothing,
                       ...
                       _easCodingMode = Nothing, _easSampleRate = Nothing,
                       _easSpeechThreshold = Nothing, _easBitrate = Nothing,
...
instance Hashable Eac3AtmosSettings where

instance NFData Eac3AtmosSettings where
