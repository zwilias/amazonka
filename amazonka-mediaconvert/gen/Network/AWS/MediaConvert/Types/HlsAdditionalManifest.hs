...
data HlsAdditionalManifest = HlsAdditionalManifest'{_hamManifestNameModifier
                                                    :: !(Maybe Text),
                                                    _hamSelectedOutputs ::
                                                    !(Maybe [Text])}
...
hlsAdditionalManifest
    :: HlsAdditionalManifest
hlsAdditionalManifest
  = HlsAdditionalManifest'{_hamManifestNameModifier =
                             Nothing,
...
instance FromJSON HlsAdditionalManifest where
        parseJSON
          = withObject "HlsAdditionalManifest"
              (\ x ->
                 HlsAdditionalManifest' <$>
                   (x .:? "manifestNameModifier") <*>
                     (x .:? "selectedOutputs" .!= mempty))

instance Hashable HlsAdditionalManifest where

instance NFData HlsAdditionalManifest where
