...
newtype EsamManifestConfirmConditionNotification = EsamManifestConfirmConditionNotification'{_emccnMccXML
                                                                                             ::
                                                                                             Maybe
                                                                                               Text}
...
esamManifestConfirmConditionNotification
    :: EsamManifestConfirmConditionNotification
esamManifestConfirmConditionNotification
  = EsamManifestConfirmConditionNotification'{_emccnMccXML
                                                = Nothing}
