...
data DolbyVisionLevel6Metadata = DolbyVisionLevel6Metadata'{_dvlmMaxFall
                                                            :: !(Maybe Nat),
                                                            _dvlmMaxCll ::
                                                            !(Maybe Nat)}
...
dolbyVisionLevel6Metadata
    :: DolbyVisionLevel6Metadata
dolbyVisionLevel6Metadata
  = DolbyVisionLevel6Metadata'{_dvlmMaxFall = Nothing,
                               _dvlmMaxCll = Nothing}
...
instance FromJSON DolbyVisionLevel6Metadata where
        parseJSON
          = withObject "DolbyVisionLevel6Metadata"
              (\ x ->
                 DolbyVisionLevel6Metadata' <$>
                   (x .:? "maxFall") <*> (x .:? "maxCll"))

instance Hashable DolbyVisionLevel6Metadata where

instance NFData DolbyVisionLevel6Metadata where
