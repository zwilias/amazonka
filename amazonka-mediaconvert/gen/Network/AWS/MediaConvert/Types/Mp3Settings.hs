...
data Mp3Settings = Mp3Settings'{_mp3Channels ::
                                !(Maybe Nat),
                                _mp3RateControlMode ::
...
mp3Settings
    :: Mp3Settings
mp3Settings
  = Mp3Settings'{_mp3Channels = Nothing,
                 _mp3RateControlMode = Nothing,
                 _mp3SampleRate = Nothing, _mp3Bitrate = Nothing,
...
instance FromJSON Mp3Settings where
        parseJSON
          = withObject "Mp3Settings"
              (\ x ->
                 Mp3Settings' <$>
                   (x .:? "channels") <*> (x .:? "rateControlMode") <*>
                     (x .:? "sampleRate")
                     <*> (x .:? "bitrate")
                     <*> (x .:? "vbrQuality"))

instance Hashable Mp3Settings where

instance NFData Mp3Settings where
