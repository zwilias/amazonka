...
assAudioDescriptionBroadcasterMix ::
     Lens' AacSettings (Maybe AacAudioDescriptionBroadcasterMix)
assAudioDescriptionBroadcasterMix =
  lens
    _assAudioDescriptionBroadcasterMix
    (\s a -> s {_assAudioDescriptionBroadcasterMix = a})
...
assRateControlMode =
  lens _assRateControlMode (\s a -> s {_assRateControlMode = a})
...
instance FromJSON AacSettings where
  parseJSON =
    withObject
      "AacSettings"
      (\x ->
         AacSettings' <$> (x .:? "audioDescriptionBroadcasterMix") <*>
         (x .:? "rawFormat") <*>
         (x .:? "codingMode") <*>
         (x .:? "rateControlMode") <*>
         (x .:? "sampleRate") <*>
...
aDynamicRangeCompressionProfile ::
     Lens' Ac3Settings (Maybe Ac3DynamicRangeCompressionProfile)
aDynamicRangeCompressionProfile =
  lens
    _aDynamicRangeCompressionProfile
    (\s a -> s {_aDynamicRangeCompressionProfile = a})
...
instance FromJSON AiffSettings where
  parseJSON =
    withObject
      "AiffSettings"
      (\x ->
         AiffSettings' <$> (x .:? "bitDepth") <*> (x .:? "channels") <*>
         (x .:? "sampleRate"))
...
assSourceAncillaryChannelNumber =
  lens
    ...
    (\s a -> s {_assSourceAncillaryChannelNumber = a})

instance FromJSON AncillarySourceSettings where
  parseJSON =
    withObject
      "AncillarySourceSettings"
      (\x -> AncillarySourceSettings' <$> (x .:? "sourceAncillaryChannelNumber"))
...
instance FromJSON AudioCodecSettings where
  parseJSON =
    withObject
      "AudioCodecSettings"
      (\x ->
         AudioCodecSettings' <$> (x .:? "aiffSettings") <*> (x .:? "codec") <*>
         (x .:? "ac3Settings") <*>
         (x .:? "mp2Settings") <*>
         (x .:? "wavSettings") <*>
         (x .:? "aacSettings") <*>
...
instance FromJSON AudioDescription where
  parseJSON =
    withObject
      "AudioDescription"
      (\x ->
         AudioDescription' <$> (x .:? "audioSourceName") <*>
         (x .:? "languageCode") <*>
         (x .:? "audioType") <*>
...
-- | Undocumented member.
ansPeakCalculation ::
     Lens' AudioNormalizationSettings (Maybe AudioNormalizationPeakCalculation)
ansPeakCalculation =
  lens _ansPeakCalculation (\s a -> s {_ansPeakCalculation = a})
...
ansCorrectionGateLevel =
  lens _ansCorrectionGateLevel (\s a -> s {_ansCorrectionGateLevel = a})
...
-- | Undocumented member.
ansLoudnessLogging ::
     Lens' AudioNormalizationSettings (Maybe AudioNormalizationLoudnessLogging)
ansLoudnessLogging =
  lens _ansLoudnessLogging (\s a -> s {_ansLoudnessLogging = a})
...
asProgramSelection =
  lens _asProgramSelection (\s a -> s {_asProgramSelection = a})
...
asDefaultSelection =
  lens _asDefaultSelection (\s a -> s {_asDefaultSelection = a})
...
asExternalAudioFileInput =
  lens _asExternalAudioFileInput (\s a -> s {_asExternalAudioFileInput = a})
...
asgAudioSelectorNames =
  lens _asgAudioSelectorNames (\s a -> s {_asgAudioSelectorNames = a}) .
  _Default . _Coerce
...
instance FromJSON AudioSelectorGroup where
  parseJSON =
    withObject
      "AudioSelectorGroup"
      (\x -> AudioSelectorGroup' <$> (x .:? "audioSelectorNames" .!= mempty))
...
instance ToJSON AudioSelectorGroup where
  toJSON AudioSelectorGroup' {..} =
    object (catMaybes [("audioSelectorNames" .=) <$> _asgAudioSelectorNames])
...
instance ToJSON AvailBlanking where
  toJSON AvailBlanking' {..} =
    object (catMaybes [("availBlankingImage" .=) <$> _abAvailBlankingImage])
...
bdsBackgroundOpacity =
  lens _bdsBackgroundOpacity (\s a -> s {_bdsBackgroundOpacity = a})
...
-- | Undocumented member.
bdsBackgroundColor ::
     Lens' BurninDestinationSettings (Maybe BurninSubtitleBackgroundColor)
bdsBackgroundColor =
  lens _bdsBackgroundColor (\s a -> s {_bdsBackgroundColor = a})
...
-- | Undocumented member.
bdsTeletextSpacing ::
     Lens' BurninDestinationSettings (Maybe BurninSubtitleTeletextSpacing)
bdsTeletextSpacing =
  lens _bdsTeletextSpacing (\s a -> s {_bdsTeletextSpacing = a})
...
-- | Undocumented member.
bdsOutlineColor ::
     Lens' BurninDestinationSettings (Maybe BurninSubtitleOutlineColor)
...
-- | Undocumented member.
bdsShadowColor ::
     Lens' BurninDestinationSettings (Maybe BurninSubtitleShadowColor)
...
instance FromJSON CaptionDescription where
  parseJSON =
    withObject
      "CaptionDescription"
      (\x ->
         CaptionDescription' <$> (x .:? "captionSelectorName") <*>
         (x .:? "languageCode") <*>
...
cdpDestinationSettings ::
     Lens' CaptionDescriptionPreset (Maybe CaptionDestinationSettings)
cdpDestinationSettings =
  lens _cdpDestinationSettings (\s a -> s {_cdpDestinationSettings = a})

-- | Human readable information to indicate captions available for players (eg. English, or Spanish). Alphanumeric characters, spaces, and underscore are legal.
cdpLanguageDescription :: Lens' CaptionDescriptionPreset (Maybe Text)
cdpLanguageDescription =
  lens _cdpLanguageDescription (\s a -> s {_cdpLanguageDescription = a})
...
instance FromJSON CaptionDescriptionPreset where
  parseJSON =
    withObject
      "CaptionDescriptionPreset"
      (\x ->
         CaptionDescriptionPreset' <$> (x .:? "languageCode") <*>
         (x .:? "destinationSettings") <*>
         (x .:? "languageDescription"))
...
-- | Undocumented member.
cdsDestinationType ::
     Lens' CaptionDestinationSettings (Maybe CaptionDestinationType)
cdsDestinationType =
  lens _cdsDestinationType (\s a -> s {_cdsDestinationType = a})

-- | Undocumented member.
cdsSccDestinationSettings ::
     Lens' CaptionDestinationSettings (Maybe SccDestinationSettings)
cdsSccDestinationSettings =
  lens _cdsSccDestinationSettings (\s a -> s {_cdsSccDestinationSettings = a})
...
cssTeletextSourceSettings ::
     Lens' CaptionSourceSettings (Maybe TeletextSourceSettings)
cssTeletextSourceSettings =
...
cssFileSourceSettings =
  lens _cssFileSourceSettings (\s a -> s {_cssFileSourceSettings = a})

-- | Undocumented member.
cssDvbSubSourceSettings ::
     Lens' CaptionSourceSettings (Maybe DvbSubSourceSettings)
cssDvbSubSourceSettings =
  lens _cssDvbSubSourceSettings (\s a -> s {_cssDvbSubSourceSettings = a})

-- | Undocumented member.
cssAncillarySourceSettings ::
     Lens' CaptionSourceSettings (Maybe AncillarySourceSettings)
cssAncillarySourceSettings =
  lens _cssAncillarySourceSettings (\s a -> s {_cssAncillarySourceSettings = a})

-- | Undocumented member.
cssEmbeddedSourceSettings ::
     Lens' CaptionSourceSettings (Maybe EmbeddedSourceSettings)
cssEmbeddedSourceSettings =
...
instance FromJSON CaptionSourceSettings where
  parseJSON =
    withObject
      "CaptionSourceSettings"
      (\x ->
         CaptionSourceSettings' <$> (x .:? "teletextSourceSettings") <*>
         (x .:? "sourceType") <*>
...
cmOutputChannels =
  lens _cmOutputChannels (\s a -> s {_cmOutputChannels = a}) .
  _Default . _Coerce
...
ccColorSpaceConversion =
  lens _ccColorSpaceConversion (\s a -> s {_ccColorSpaceConversion = a})
...
instance FromJSON ColorCorrector where
  parseJSON =
    withObject
      "ColorCorrector"
      (\x ->
         ColorCorrector' <$> (x .:? "saturation") <*> (x .:? "hue") <*>
...
instance FromJSON ContainerSettings where
  parseJSON =
    withObject
      "ContainerSettings"
      (\x ->
         ContainerSettings' <$> (x .:? "m2tsSettings") <*>
         (x .:? "m3u8Settings") <*>
         (x .:? "movSettings") <*>
         (x .:? "mp4Settings") <*>
         (x .:? "container") <*>
...
diesSpekeKeyProvider =
  lens _diesSpekeKeyProvider (\s a -> s {_diesSpekeKeyProvider = a})

instance FromJSON DashIsoEncryptionSettings where
  parseJSON =
    withObject
      "DashIsoEncryptionSettings"
      (\x -> DashIsoEncryptionSettings' <$> (x .:? "spekeKeyProvider"))
...
instance ToJSON DashIsoEncryptionSettings where
  toJSON DashIsoEncryptionSettings' {..} =
    object (catMaybes [("spekeKeyProvider" .=) <$> _diesSpekeKeyProvider])
...
digsFragmentLength =
  lens _digsFragmentLength (\s a -> s {_digsFragmentLength = a})

-- | Undocumented member.
digsSegmentControl :: Lens' DashIsoGroupSettings (Maybe DashIsoSegmentControl)
digsSegmentControl =
  lens _digsSegmentControl (\s a -> s {_digsSegmentControl = a})
...
digsHbbtvCompliance =
  lens _digsHbbtvCompliance (\s a -> s {_digsHbbtvCompliance = a})
...
instance FromJSON DashIsoGroupSettings where
  parseJSON =
    withObject
      "DashIsoGroupSettings"
      (\x ->
         DashIsoGroupSettings' <$> (x .:? "fragmentLength") <*>
         (x .:? "segmentControl") <*>
         (x .:? "destination") <*>
         (x .:? "hbbtvCompliance") <*>
         (x .:? "minBufferTime") <*>
...
instance FromJSON DvbNitSettings where
  parseJSON =
    withObject
      "DvbNitSettings"
      (\x ->
         DvbNitSettings' <$> (x .:? "networkId") <*> (x .:? "networkName") <*>
         (x .:? "nitInterval"))
...
dsdsFontResolution =
  lens _dsdsFontResolution (\s a -> s {_dsdsFontResolution = a})
...
-- | Undocumented member.
dsdsBackgroundColor ::
     Lens' DvbSubDestinationSettings (Maybe DvbSubtitleBackgroundColor)
dsdsBackgroundColor =
...
-- | Undocumented member.
dsdsTeletextSpacing ::
     Lens' DvbSubDestinationSettings (Maybe DvbSubtitleTeletextSpacing)
dsdsTeletextSpacing =
  lens _dsdsTeletextSpacing (\s a -> s {_dsdsTeletextSpacing = a})
...
-- | Undocumented member.
dsdsOutlineColor ::
     Lens' DvbSubDestinationSettings (Maybe DvbSubtitleOutlineColor)
...
-- | Undocumented member.
dsdsShadowColor ::
     Lens' DvbSubDestinationSettings (Maybe DvbSubtitleShadowColor)
...
esDynamicRangeCompressionLine ::
     Lens' Eac3Settings (Maybe Eac3DynamicRangeCompressionLine)
esDynamicRangeCompressionLine =
  lens
    _esDynamicRangeCompressionLine
    (\s a -> s {_esDynamicRangeCompressionLine = a})
...
esDynamicRangeCompressionRf ::
     Lens' Eac3Settings (Maybe Eac3DynamicRangeCompressionRf)
esDynamicRangeCompressionRf =
  lens
    _esDynamicRangeCompressionRf
    (\s a -> s {_esDynamicRangeCompressionRf = a})
  ...
  toJSON Eac3Settings' {..} =
    object
      (catMaybes
         ...
         , ("dynamicRangeCompressionLine" .=) <$> _esDynamicRangeCompressionLine
...
instance FromJSON Endpoint where
  parseJSON = withObject "Endpoint" (\x -> Endpoint' <$> (x .:? "url"))
...
instance FromJSON F4vSettings where
  parseJSON =
    withObject "F4vSettings" (\x -> F4vSettings' <$> (x .:? "moovPlacement"))
...
instance ToJSON FileGroupSettings where
  toJSON FileGroupSettings' {..} =
    object (catMaybes [("destination" .=) <$> _fgsDestination])
...
fssConvert608To708 =
  lens _fssConvert608To708 (\s a -> s {_fssConvert608To708 = a})
...
instance FromJSON FileSourceSettings where
  parseJSON =
    withObject
      "FileSourceSettings"
      (\x ->
         FileSourceSettings' <$> (x .:? "convert608To708") <*>
         (x .:? "timeDelta") <*>
         (x .:? "sourceFile"))
...
fcsFramerateDenominator =
  lens _fcsFramerateDenominator (\s a -> s {_fcsFramerateDenominator = a})
...
fcsFramerateNumerator =
  lens _fcsFramerateNumerator (\s a -> s {_fcsFramerateNumerator = a})
...
instance FromJSON FrameCaptureSettings where
  parseJSON =
    withObject
      "FrameCaptureSettings"
      (\x ->
         FrameCaptureSettings' <$> (x .:? "quality") <*>
...
hUnregisteredSeiTimecode ::
     Lens' H264Settings (Maybe H264UnregisteredSeiTimecode)
hUnregisteredSeiTimecode =
  lens _hUnregisteredSeiTimecode (\s a -> s {_hUnregisteredSeiTimecode = a})

-- | Undocumented member.
hQualityTuningLevel :: Lens' H264Settings (Maybe H264QualityTuningLevel)
hQualityTuningLevel =
  lens _hQualityTuningLevel (\s a -> s {_hQualityTuningLevel = a})

-- | Undocumented member.
hTemporalAdaptiveQuantization ::
     Lens' H264Settings (Maybe H264TemporalAdaptiveQuantization)
hTemporalAdaptiveQuantization =
  lens
    _hTemporalAdaptiveQuantization
    (\s a -> s {_hTemporalAdaptiveQuantization = a})

-- | Undocumented member.
hSceneChangeDetect :: Lens' H264Settings (Maybe H264SceneChangeDetect)
hSceneChangeDetect =
  lens _hSceneChangeDetect (\s a -> s {_hSceneChangeDetect = a})
...
hHrdBufferInitialFillPercentage =
  lens
    ...
    (\s a -> s {_hHrdBufferInitialFillPercentage = a})
...
hNumberBFramesBetweenReferenceFrames =
  lens
    ...
    (\s a -> s {_hNumberBFramesBetweenReferenceFrames = a})
...
hNumberReferenceFrames =
  lens _hNumberReferenceFrames (\s a -> s {_hNumberReferenceFrames = a})
...
hFlickerAdaptiveQuantization ::
     Lens' H264Settings (Maybe H264FlickerAdaptiveQuantization)
hFlickerAdaptiveQuantization =
  lens
    _hFlickerAdaptiveQuantization
    (\s a -> s {_hFlickerAdaptiveQuantization = a})
...
hFramerateDenominator =
  lens _hFramerateDenominator (\s a -> s {_hFramerateDenominator = a})

-- | Undocumented member.
hFramerateConversionAlgorithm ::
     Lens' H264Settings (Maybe H264FramerateConversionAlgorithm)
hFramerateConversionAlgorithm =
  lens
    _hFramerateConversionAlgorithm
    (\s a -> s {_hFramerateConversionAlgorithm = a})
...
hAdaptiveQuantization =
  lens _hAdaptiveQuantization (\s a -> s {_hAdaptiveQuantization = a})

-- | Framerate numerator - framerate is a fraction, e.g. 24000 / 1001 = 23.976 fps.
hFramerateNumerator :: Lens' H264Settings (Maybe Int)
hFramerateNumerator =
  lens _hFramerateNumerator (\s a -> s {_hFramerateNumerator = a})
...
hSpatialAdaptiveQuantization ::
     Lens' H264Settings (Maybe H264SpatialAdaptiveQuantization)
hSpatialAdaptiveQuantization =
  lens
    _hSpatialAdaptiveQuantization
    (\s a -> s {_hSpatialAdaptiveQuantization = a})
...
instance FromJSON H264Settings where
  parseJSON =
    withObject
      "H264Settings"
      (\x ->
         H264Settings' <$> (x .:? "unregisteredSeiTimecode") <*>
...
instance ToJSON H264Settings where
  toJSON H264Settings' {..} =
    object
      (catMaybes
         [ ("unregisteredSeiTimecode" .=) <$> _hUnregisteredSeiTimecode
         ...
         , ("spatialAdaptiveQuantization" .=) <$> _hSpatialAdaptiveQuantization
         ])
...
hsUnregisteredSeiTimecode ::
     Lens' H265Settings (Maybe H265UnregisteredSeiTimecode)
hsUnregisteredSeiTimecode =
  lens _hsUnregisteredSeiTimecode (\s a -> s {_hsUnregisteredSeiTimecode = a})

-- | Undocumented member.
hsQualityTuningLevel :: Lens' H265Settings (Maybe H265QualityTuningLevel)
hsQualityTuningLevel =
  lens _hsQualityTuningLevel (\s a -> s {_hsQualityTuningLevel = a})

-- | Undocumented member.
hsTemporalAdaptiveQuantization ::
     Lens' H265Settings (Maybe H265TemporalAdaptiveQuantization)
hsTemporalAdaptiveQuantization =
  lens
    _hsTemporalAdaptiveQuantization
    (\s a -> s {_hsTemporalAdaptiveQuantization = a})
...
hsHrdBufferInitialFillPercentage =
  lens
    ...
    (\s a -> s {_hsHrdBufferInitialFillPercentage = a})
...
hsNumberBFramesBetweenReferenceFrames =
  lens
    ...
    (\s a -> s {_hsNumberBFramesBetweenReferenceFrames = a})
...
hsAlternateTransferFunctionSei ::
     Lens' H265Settings (Maybe H265AlternateTransferFunctionSei)
hsAlternateTransferFunctionSei =
  lens
    _hsAlternateTransferFunctionSei
    (\s a -> s {_hsAlternateTransferFunctionSei = a})
...
hsNumberReferenceFrames =
  lens _hsNumberReferenceFrames (\s a -> s {_hsNumberReferenceFrames = a})
...
hsFlickerAdaptiveQuantization ::
     Lens' H265Settings (Maybe H265FlickerAdaptiveQuantization)
hsFlickerAdaptiveQuantization =
  lens
    _hsFlickerAdaptiveQuantization
    (\s a -> s {_hsFlickerAdaptiveQuantization = a})

-- | Undocumented member.
hsSampleAdaptiveOffsetFilterMode ::
     Lens' H265Settings (Maybe H265SampleAdaptiveOffsetFilterMode)
hsSampleAdaptiveOffsetFilterMode =
  lens
    _hsSampleAdaptiveOffsetFilterMode
    (\s a -> s {_hsSampleAdaptiveOffsetFilterMode = a})
...
hsFramerateConversionAlgorithm ::
     Lens' H265Settings (Maybe H265FramerateConversionAlgorithm)
hsFramerateConversionAlgorithm =
  lens
    _hsFramerateConversionAlgorithm
    (\s a -> s {_hsFramerateConversionAlgorithm = a})
...
hsGopClosedCadence =
  lens _hsGopClosedCadence (\s a -> s {_hsGopClosedCadence = a})
...
hsSpatialAdaptiveQuantization ::
     Lens' H265Settings (Maybe H265SpatialAdaptiveQuantization)
hsSpatialAdaptiveQuantization =
  lens
    _hsSpatialAdaptiveQuantization
    (\s a -> s {_hsSpatialAdaptiveQuantization = a})
...
instance FromJSON H265Settings where
  parseJSON =
    withObject
      "H265Settings"
      (\x ->
         H265Settings' <$> (x .:? "unregisteredSeiTimecode") <*>
         (x .:? "qualityTuningLevel") <*>
         (x .:? "temporalAdaptiveQuantization") <*>
         (x .:? "sceneChangeDetect") <*>
         (x .:? "hrdBufferInitialFillPercentage") <*>
  ...
  toJSON H265Settings' {..} =
    object
      (catMaybes
         ...
         , ("flickerAdaptiveQuantization" .=) <$> _hsFlickerAdaptiveQuantization
         ...
         , ("spatialAdaptiveQuantization" .=) <$> _hsSpatialAdaptiveQuantization
         ])
...
hmMaxFrameAverageLightLevel =
  lens
    ...
    (\s a -> s {_hmMaxFrameAverageLightLevel = a})
...
hmMaxContentLightLevel =
  lens _hmMaxContentLightLevel (\s a -> s {_hmMaxContentLightLevel = a})
...
instance FromJSON Hdr10Metadata where
  parseJSON =
    withObject
      "Hdr10Metadata"
      (\x ->
         Hdr10Metadata' <$> (x .:? "redPrimaryX") <*> (x .:? "bluePrimaryX") <*>
...
hclmLanguageDescription =
  lens _hclmLanguageDescription (\s a -> s {_hclmLanguageDescription = a})

-- | Caption channel.
hclmCaptionChannel :: Lens' HlsCaptionLanguageMapping (Maybe Int)
hclmCaptionChannel =
  lens _hclmCaptionChannel (\s a -> s {_hclmCaptionChannel = a})
...
instance FromJSON HlsCaptionLanguageMapping where
  parseJSON =
    withObject
      "HlsCaptionLanguageMapping"
      (\x ->
         HlsCaptionLanguageMapping' <$> (x .:? "languageCode") <*>
         (x .:? "languageDescription") <*>
         (x .:? "captionChannel"))
...
hesEncryptionMethod =
  lens _hesEncryptionMethod (\s a -> s {_hesEncryptionMethod = a})
...
hesConstantInitializationVector =
  lens
    ...
    (\s a -> s {_hesConstantInitializationVector = a})
...
hesStaticKeyProvider =
  lens _hesStaticKeyProvider (\s a -> s {_hesStaticKeyProvider = a})

-- | Undocumented member.
hesSpekeKeyProvider :: Lens' HlsEncryptionSettings (Maybe SpekeKeyProvider)
hesSpekeKeyProvider =
  lens _hesSpekeKeyProvider (\s a -> s {_hesSpekeKeyProvider = a})

-- | Undocumented member.
hesInitializationVectorInManifest ::
     Lens' HlsEncryptionSettings (Maybe HlsInitializationVectorInManifest)
hesInitializationVectorInManifest =
  lens
    _hesInitializationVectorInManifest
    (\s a -> s {_hesInitializationVectorInManifest = a})
...
instance FromJSON HlsEncryptionSettings where
  parseJSON =
    withObject
      "HlsEncryptionSettings"
      (\x ->
         HlsEncryptionSettings' <$> (x .:? "encryptionMethod") <*>
...
hsAudioRenditionSets =
  lens _hsAudioRenditionSets (\s a -> s {_hsAudioRenditionSets = a})

-- | Undocumented member.
hsIFrameOnlyManifest :: Lens' HlsSettings (Maybe HlsIFrameOnlyManifest)
hsIFrameOnlyManifest =
  lens _hsIFrameOnlyManifest (\s a -> s {_hsIFrameOnlyManifest = a})
...
instance FromJSON HlsSettings where
  parseJSON =
    withObject
      "HlsSettings"
      (\x ->
         HlsSettings' <$> (x .:? "audioRenditionSets") <*>
...
instance ToJSON Id3Insertion where
  toJSON Id3Insertion' {..} =
    object (catMaybes [("id3" .=) <$> _iiId3, ("timecode" .=) <$> _iiTimecode])
...
iiInsertableImages =
  lens _iiInsertableImages (\s a -> s {_iiInsertableImages = a}) .
  _Default . _Coerce
...
instance ToJSON ImageInserter where
  toJSON ImageInserter' {..} =
    object (catMaybes [("insertableImages" .=) <$> _iiInsertableImages])
...
iAudioSelectorGroups =
  lens _iAudioSelectorGroups (\s a -> s {_iAudioSelectorGroups = a}) .
  _Default . _Map
...
iAudioSelectors =
  lens _iAudioSelectors (\s a -> s {_iAudioSelectors = a}) . _Default . _Map
...
iInputClippings =
  lens _iInputClippings (\s a -> s {_iInputClippings = a}) . _Default . _Coerce
...
iCaptionSelectors =
  lens _iCaptionSelectors (\s a -> s {_iCaptionSelectors = a}) . _Default . _Map
...
instance FromJSON Input where
  parseJSON =
    withObject
      "Input"
      (\x ->
         Input' <$> (x .:? "videoSelector") <*> (x .:? "programNumber") <*>
...
instance FromJSON InputClipping where
  parseJSON =
    withObject
      "InputClipping"
      (\x ->
         InputClipping' <$> (x .:? "endTimecode") <*> (x .:? "startTimecode"))
...
itAudioSelectorGroups =
  lens _itAudioSelectorGroups (\s a -> s {_itAudioSelectorGroups = a}) .
  _Default . _Map
...
itAudioSelectors =
  lens _itAudioSelectors (\s a -> s {_itAudioSelectors = a}) . _Default . _Map
...
itInputClippings =
  lens _itInputClippings (\s a -> s {_itInputClippings = a}) .
  _Default . _Coerce
...
itCaptionSelectors =
  lens _itCaptionSelectors (\s a -> s {_itCaptionSelectors = a}) .
  _Default . _Map
...
instance FromJSON InputTemplate where
  parseJSON =
    withObject
      "InputTemplate"
      (\x ->
         InputTemplate' <$> (x .:? "videoSelector") <*> (x .:? "programNumber") <*>
         (x .:? "audioSelectorGroups" .!= mempty) <*>
         (x .:? "timecodeSource") <*>
         (x .:? "audioSelectors" .!= mempty) <*>
         (x .:? "deblockFilter") <*>
...
iiImageInserterInput =
  lens _iiImageInserterInput (\s a -> s {_iiImageInserterInput = a})
...
instance FromJSON InsertableImage where
  parseJSON =
    withObject
      "InsertableImage"
      (\x ->
         InsertableImage' <$> (x .:? "imageX") <*> (x .:? "height") <*>
         (x .:? "startTime") <*>
         (x .:? "fadeOut") <*>
         (x .:? "width") <*>
         (x .:? "opacity") <*>
...
jUserMetadata =
  lens _jUserMetadata (\s a -> s {_jUserMetadata = a}) . _Default . _Map
...
jOutputGroupDetails =
  lens _jOutputGroupDetails (\s a -> s {_jOutputGroupDetails = a}) .
  _Default . _Coerce
...
jsTimedMetadataInsertion =
  lens _jsTimedMetadataInsertion (\s a -> s {_jsTimedMetadataInsertion = a})

-- | Undocumented member.
jsNielsenConfiguration :: Lens' JobSettings (Maybe NielsenConfiguration)
jsNielsenConfiguration =
  lens _jsNielsenConfiguration (\s a -> s {_jsNielsenConfiguration = a})
...
jsOutputGroups =
  lens _jsOutputGroups (\s a -> s {_jsOutputGroups = a}) . _Default . _Coerce
...
jtLastUpdated =
  lens _jtLastUpdated (\s a -> s {_jtLastUpdated = a}) . mapping _Time
...
instance FromJSON JobTemplate where
  parseJSON =
    withObject
      "JobTemplate"
      (\x ->
         JobTemplate' <$> (x .:? "lastUpdated") <*> (x .:? "settings") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "category") <*>
         (x .:? "queue") <*>
...
jtsTimedMetadataInsertion ::
     Lens' JobTemplateSettings (Maybe TimedMetadataInsertion)
jtsTimedMetadataInsertion =
  lens _jtsTimedMetadataInsertion (\s a -> s {_jtsTimedMetadataInsertion = a})

-- | Undocumented member.
jtsNielsenConfiguration ::
     Lens' JobTemplateSettings (Maybe NielsenConfiguration)
jtsNielsenConfiguration =
  lens _jtsNielsenConfiguration (\s a -> s {_jtsNielsenConfiguration = a})
...
jtsOutputGroups =
  lens _jtsOutputGroups (\s a -> s {_jtsOutputGroups = a}) . _Default . _Coerce
...
instance FromJSON JobTemplateSettings where
  parseJSON =
    withObject
      "JobTemplateSettings"
      (\x ->
         JobTemplateSettings' <$> (x .:? "inputs" .!= mempty) <*>
         (x .:? "timedMetadataInsertion") <*>
         (x .:? "nielsenConfiguration") <*>
         (x .:? "availBlanking") <*>
         (x .:? "timecodeConfig") <*>
...
mTransportStreamId =
  lens _mTransportStreamId (\s a -> s {_mTransportStreamId = a})
...
mPrivateMetadataPid =
  lens _mPrivateMetadataPid (\s a -> s {_mPrivateMetadataPid = a})
...
mNullPacketBitrate =
  lens _mNullPacketBitrate (\s a -> s {_mNullPacketBitrate = a})
...
mAudioFramesPerPes =
  lens _mAudioFramesPerPes (\s a -> s {_mAudioFramesPerPes = a})
...
mSegmentationMarkers =
  lens _mSegmentationMarkers (\s a -> s {_mSegmentationMarkers = a})
...
mDvbSubPids =
  lens _mDvbSubPids (\s a -> s {_mDvbSubPids = a}) . _Default . _Coerce
...
mSegmentationStyle =
  lens _mSegmentationStyle (\s a -> s {_mSegmentationStyle = a})
...
instance FromJSON M2tsSettings where
  parseJSON =
    withObject
      "M2tsSettings"
      (\x ->
         M2tsSettings' <$> (x .:? "pmtPid") <*> (x .:? "videoPid") <*>
         (x .:? "bufferModel") <*>
         (x .:? "programNumber") <*>
         (x .:? "scte35Pid") <*>
         (x .:? "minEbpInterval") <*>
...
msPrivateMetadataPid =
  lens _msPrivateMetadataPid (\s a -> s {_msPrivateMetadataPid = a})
...
msAudioPids =
  lens _msAudioPids (\s a -> s {_msAudioPids = a}) . _Default . _Coerce
...
msMpeg2FourCCControl =
  lens _msMpeg2FourCCControl (\s a -> s {_msMpeg2FourCCControl = a})
...
instance FromJSON MovSettings where
  parseJSON =
    withObject
      "MovSettings"
      (\x ->
         MovSettings' <$> (x .:? "reference") <*> (x .:? "cslgAtom") <*>
...
instance FromJSON Mp2Settings where
  parseJSON =
    withObject
      "Mp2Settings"
      (\x ->
         Mp2Settings' <$> (x .:? "channels") <*> (x .:? "sampleRate") <*>
         (x .:? "bitrate"))
...
instance FromJSON Mp4Settings where
  parseJSON =
    withObject
      "Mp4Settings"
      (\x ->
         Mp4Settings' <$> (x .:? "moovPlacement") <*> (x .:? "freeSpaceBox") <*>
         (x .:? "mp4MajorBrand") <*>
         (x .:? "cslgAtom"))
...
msQualityTuningLevel =
  lens _msQualityTuningLevel (\s a -> s {_msQualityTuningLevel = a})

-- | Undocumented member.
msTemporalAdaptiveQuantization ::
     Lens' Mpeg2Settings (Maybe Mpeg2TemporalAdaptiveQuantization)
msTemporalAdaptiveQuantization =
  lens
    _msTemporalAdaptiveQuantization
    (\s a -> s {_msTemporalAdaptiveQuantization = a})

-- | Undocumented member.
msSceneChangeDetect :: Lens' Mpeg2Settings (Maybe Mpeg2SceneChangeDetect)
msSceneChangeDetect =
  lens _msSceneChangeDetect (\s a -> s {_msSceneChangeDetect = a})
...
msHrdBufferInitialFillPercentage =
  lens
    ...
    (\s a -> s {_msHrdBufferInitialFillPercentage = a})
...
msNumberBFramesBetweenReferenceFrames =
  lens
    ...
    (\s a -> s {_msNumberBFramesBetweenReferenceFrames = a})
...
msIntraDcPrecision =
  lens _msIntraDcPrecision (\s a -> s {_msIntraDcPrecision = a})
...
msFramerateDenominator =
  lens _msFramerateDenominator (\s a -> s {_msFramerateDenominator = a})

-- | Undocumented member.
msFramerateConversionAlgorithm ::
     Lens' Mpeg2Settings (Maybe Mpeg2FramerateConversionAlgorithm)
msFramerateConversionAlgorithm =
  lens
    _msFramerateConversionAlgorithm
    (\s a -> s {_msFramerateConversionAlgorithm = a})
...
msFramerateControl =
  lens _msFramerateControl (\s a -> s {_msFramerateControl = a})

-- | Undocumented member.
msAdaptiveQuantization :: Lens' Mpeg2Settings (Maybe Mpeg2AdaptiveQuantization)
msAdaptiveQuantization =
  lens _msAdaptiveQuantization (\s a -> s {_msAdaptiveQuantization = a})

-- | Framerate numerator - framerate is a fraction, e.g. 24000 / 1001 = 23.976 fps.
msFramerateNumerator :: Lens' Mpeg2Settings (Maybe Int)
msFramerateNumerator =
  lens _msFramerateNumerator (\s a -> s {_msFramerateNumerator = a})
...
msGopClosedCadence =
  lens _msGopClosedCadence (\s a -> s {_msGopClosedCadence = a})
...
msSpatialAdaptiveQuantization ::
     Lens' Mpeg2Settings (Maybe Mpeg2SpatialAdaptiveQuantization)
msSpatialAdaptiveQuantization =
  lens
    _msSpatialAdaptiveQuantization
    (\s a -> s {_msSpatialAdaptiveQuantization = a})
...
instance FromJSON Mpeg2Settings where
  parseJSON =
    withObject
      "Mpeg2Settings"
      (\x ->
         Mpeg2Settings' <$> (x .:? "qualityTuningLevel") <*>
         (x .:? "temporalAdaptiveQuantization") <*>
         (x .:? "sceneChangeDetect") <*>
         (x .:? "hrdBufferInitialFillPercentage") <*>
         (x .:? "slowPal") <*>
  ...
  toJSON Mpeg2Settings' {..} =
    object
      (catMaybes
         ...
         , ("spatialAdaptiveQuantization" .=) <$> _msSpatialAdaptiveQuantization
         ])
...
msesSpekeKeyProvider ::
     Lens' MsSmoothEncryptionSettings (Maybe SpekeKeyProvider)
msesSpekeKeyProvider =
  lens _msesSpekeKeyProvider (\s a -> s {_msesSpekeKeyProvider = a})
...
instance ToJSON MsSmoothEncryptionSettings where
  toJSON MsSmoothEncryptionSettings' {..} =
    object (catMaybes [("spekeKeyProvider" .=) <$> _msesSpekeKeyProvider])
...
msgsFragmentLength =
  lens _msgsFragmentLength (\s a -> s {_msgsFragmentLength = a})

-- | Undocumented member.
msgsManifestEncoding ::
     Lens' MsSmoothGroupSettings (Maybe MsSmoothManifestEncoding)
msgsManifestEncoding =
  lens _msgsManifestEncoding (\s a -> s {_msgsManifestEncoding = a})
...
msgsAudioDeduplication ::
     Lens' MsSmoothGroupSettings (Maybe MsSmoothAudioDeduplication)
msgsAudioDeduplication =
  lens _msgsAudioDeduplication (\s a -> s {_msgsAudioDeduplication = a})
...
instance FromJSON NielsenConfiguration where
  parseJSON =
    withObject
      "NielsenConfiguration"
      (\x ->
         NielsenConfiguration' <$> (x .:? "breakoutCode") <*>
         (x .:? "distributorId"))
...
nrSpatialFilterSettings ::
     Lens' NoiseReducer (Maybe NoiseReducerSpatialFilterSettings)
nrSpatialFilterSettings =
  lens _nrSpatialFilterSettings (\s a -> s {_nrSpatialFilterSettings = a})
...
instance FromJSON NoiseReducer where
  parseJSON =
    withObject
      "NoiseReducer"
      (\x ->
         NoiseReducer' <$> (x .:? "spatialFilterSettings") <*>
         (x .:? "filterSettings") <*>
         (x .:? "filter"))
...
nrsfsPostFilterSharpenStrength ::
     Lens' NoiseReducerSpatialFilterSettings (Maybe Int)
nrsfsPostFilterSharpenStrength =
  lens
    _nrsfsPostFilterSharpenStrength
    (\s a -> s {_nrsfsPostFilterSharpenStrength = a})
...
instance FromJSON NoiseReducerSpatialFilterSettings where
  parseJSON =
    withObject
      "NoiseReducerSpatialFilterSettings"
      (\x ->
         NoiseReducerSpatialFilterSettings' <$> (x .:? "strength") <*>
  ...
  toJSON NoiseReducerSpatialFilterSettings' {..} =
    object
      (catMaybes
         ...
         , ("postFilterSharpenStrength" .=) <$> _nrsfsPostFilterSharpenStrength
         , ("speed" .=) <$> _nrsfsSpeed
         ])
...
oCaptionDescriptions =
  lens _oCaptionDescriptions (\s a -> s {_oCaptionDescriptions = a}) .
  _Default . _Coerce
...
oContainerSettings =
  lens _oContainerSettings (\s a -> s {_oContainerSettings = a})
...
oAudioDescriptions =
  lens _oAudioDescriptions (\s a -> s {_oAudioDescriptions = a}) .
  _Default . _Coerce
...
instance FromJSON Output where
  parseJSON =
    withObject
      "Output"
      (\x ->
         Output' <$> (x .:? "captionDescriptions" .!= mempty) <*>
         (x .:? "extension") <*>
         (x .:? "videoDescription") <*>
         (x .:? "containerSettings") <*>
         (x .:? "outputSettings") <*>
...
ocmInputChannels =
  lens _ocmInputChannels (\s a -> s {_ocmInputChannels = a}) .
  _Default . _Coerce
...
instance FromJSON OutputChannelMapping where
  parseJSON =
    withObject
      "OutputChannelMapping"
      (\x -> OutputChannelMapping' <$> (x .:? "inputChannels" .!= mempty))
...
instance FromJSON OutputDetail where
  parseJSON =
    withObject
      "OutputDetail"
      (\x -> OutputDetail' <$> (x .:? "videoDetails") <*> (x .:? "durationInMs"))
...
instance FromJSON OutputGroup where
  parseJSON =
    withObject
      "OutputGroup"
      (\x ->
         OutputGroup' <$> (x .:? "outputGroupSettings") <*>
         (x .:? "outputs" .!= mempty) <*>
         (x .:? "customName") <*>
         (x .:? "name"))
...
ogdOutputDetails =
  lens _ogdOutputDetails (\s a -> s {_ogdOutputDetails = a}) .
  _Default . _Coerce
...
ogsFileGroupSettings =
  lens _ogsFileGroupSettings (\s a -> s {_ogsFileGroupSettings = a})
...
ogsDashIsoGroupSettings ::
     Lens' OutputGroupSettings (Maybe DashIsoGroupSettings)
ogsDashIsoGroupSettings =
  lens _ogsDashIsoGroupSettings (\s a -> s {_ogsDashIsoGroupSettings = a})
...
instance FromJSON OutputGroupSettings where
  parseJSON =
    withObject
      "OutputGroupSettings"
      (\x ->
         OutputGroupSettings' <$> (x .:? "fileGroupSettings") <*>
...
pLastUpdated =
  lens _pLastUpdated (\s a -> s {_pLastUpdated = a}) . mapping _Time
...
instance FromJSON Preset where
  parseJSON =
    withObject
      "Preset"
      (\x ->
         Preset' <$> (x .:? "lastUpdated") <*> (x .:? "settings") <*>
         (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "category") <*>
         (x .:? "name") <*>
...
psCaptionDescriptions =
  lens _psCaptionDescriptions (\s a -> s {_psCaptionDescriptions = a}) .
  _Default . _Coerce

-- | (VideoDescription) contains a group of video encoding settings. The specific video settings depend on the video codec you choose when you specify a value for Video codec (codec). Include one instance of (VideoDescription) per output.
psVideoDescription :: Lens' PresetSettings (Maybe VideoDescription)
psVideoDescription =
  lens _psVideoDescription (\s a -> s {_psVideoDescription = a})

-- | Undocumented member.
psContainerSettings :: Lens' PresetSettings (Maybe ContainerSettings)
psContainerSettings =
  lens _psContainerSettings (\s a -> s {_psContainerSettings = a})

-- | (AudioDescriptions) contains groups of audio encoding settings organized by audio codec. Include one instance of (AudioDescriptions) per output. (AudioDescriptions) can contain multiple groups of encoding settings.
psAudioDescriptions :: Lens' PresetSettings [AudioDescription]
psAudioDescriptions =
  lens _psAudioDescriptions (\s a -> s {_psAudioDescriptions = a}) .
  _Default . _Coerce
...
instance FromJSON PresetSettings where
  parseJSON =
    withObject
      "PresetSettings"
      (\x ->
         PresetSettings' <$> (x .:? "captionDescriptions" .!= mempty) <*>
         (x .:? "videoDescription") <*>
         (x .:? "containerSettings") <*>
         (x .:? "audioDescriptions" .!= mempty))
...
psFramerateDenominator =
  lens _psFramerateDenominator (\s a -> s {_psFramerateDenominator = a})

-- | Undocumented member.
psFramerateConversionAlgorithm ::
     Lens' ProresSettings (Maybe ProresFramerateConversionAlgorithm)
psFramerateConversionAlgorithm =
  lens
    _psFramerateConversionAlgorithm
    (\s a -> s {_psFramerateConversionAlgorithm = a})

-- | Undocumented member.
psFramerateControl :: Lens' ProresSettings (Maybe ProresFramerateControl)
psFramerateControl =
  lens _psFramerateControl (\s a -> s {_psFramerateControl = a})
...
psFramerateNumerator =
  lens _psFramerateNumerator (\s a -> s {_psFramerateNumerator = a})
...
instance FromJSON ProresSettings where
  parseJSON =
    withObject
      "ProresSettings"
      (\x ->
         ProresSettings' <$> (x .:? "slowPal") <*> (x .:? "parNumerator") <*>
         (x .:? "telecine") <*>
         (x .:? "interlaceMode") <*>
         (x .:? "parControl") <*>
         (x .:? "codecProfile") <*>
...
qLastUpdated =
  lens _qLastUpdated (\s a -> s {_qLastUpdated = a}) . mapping _Time
...
instance FromJSON Queue where
  parseJSON =
    withObject
      "Queue"
      (\x ->
         Queue' <$> (x .:? "status") <*> (x .:? "lastUpdated") <*> (x .:? "arn") <*>
         (x .:? "createdAt") <*>
         (x .:? "name") <*>
         (x .:? "type") <*>
         (x .:? "description"))
...
instance FromJSON Rectangle where
  parseJSON =
    withObject
      "Rectangle"
      (\x ->
         Rectangle' <$> (x .:? "height") <*> (x .:? "width") <*> (x .:? "x") <*>
         (x .:? "y"))
...
instance FromJSON RemixSettings where
  parseJSON =
    withObject
      "RemixSettings"
      (\x ->
         RemixSettings' <$> (x .:? "channelMapping") <*> (x .:? "channelsIn") <*>
         (x .:? "channelsOut"))
...
skpSystemIds =
  lens _skpSystemIds (\s a -> s {_skpSystemIds = a}) . _Default . _Coerce
...
instance FromJSON SpekeKeyProvider where
  parseJSON =
    withObject
      "SpekeKeyProvider"
      (\x ->
         SpekeKeyProvider' <$> (x .:? "resourceId") <*> (x .:? "url") <*>
         (x .:? "systemIds" .!= mempty))
...
sKeyFormatVersions =
  lens _sKeyFormatVersions (\s a -> s {_sKeyFormatVersions = a})
...
instance FromJSON StaticKeyProvider where
  parseJSON =
    withObject
      "StaticKeyProvider"
      (\x ->
         StaticKeyProvider' <$> (x .:? "staticKeyValue") <*> (x .:? "url") <*>
         (x .:? "keyFormat") <*>
         (x .:? "keyFormatVersions"))
...
instance FromJSON TeletextDestinationSettings where
  parseJSON =
    withObject
      "TeletextDestinationSettings"
      (\x -> TeletextDestinationSettings' <$> (x .:? "pageNumber"))
...
instance ToJSON TeletextDestinationSettings where
  toJSON TeletextDestinationSettings' {..} =
    object (catMaybes [("pageNumber" .=) <$> _tdsPageNumber])
...
instance FromJSON TimecodeBurnin where
  parseJSON =
    withObject
      "TimecodeBurnin"
      (\x ->
         TimecodeBurnin' <$> (x .:? "prefix") <*> (x .:? "fontSize") <*>
         (x .:? "position"))
...
instance FromJSON TimecodeConfig where
  parseJSON =
    withObject
      "TimecodeConfig"
      (\x ->
         TimecodeConfig' <$> (x .:? "start") <*> (x .:? "timestampOffset") <*>
         (x .:? "anchor") <*>
         (x .:? "source"))
...
tmiId3Insertions =
  lens _tmiId3Insertions (\s a -> s {_tmiId3Insertions = a}) .
  _Default . _Coerce
...
instance FromJSON TimedMetadataInsertion where
  parseJSON =
    withObject
      "TimedMetadataInsertion"
      (\x -> TimedMetadataInsertion' <$> (x .:? "id3Insertions" .!= mempty))
...
instance FromJSON Timing where
  parseJSON =
    withObject
      "Timing"
      (\x ->
         Timing' <$> (x .:? "startTime") <*> (x .:? "finishTime") <*>
         (x .:? "submitTime"))
...
-- | Undocumented member.
tdsStylePassthrough ::
     Lens' TtmlDestinationSettings (Maybe TtmlStylePassthrough)
tdsStylePassthrough =
  lens _tdsStylePassthrough (\s a -> s {_tdsStylePassthrough = a})
...
instance ToJSON TtmlDestinationSettings where
  toJSON TtmlDestinationSettings' {..} =
    object (catMaybes [("stylePassthrough" .=) <$> _tdsStylePassthrough])
...
vcsFrameCaptureSettings =
  lens _vcsFrameCaptureSettings (\s a -> s {_vcsFrameCaptureSettings = a})
...
instance FromJSON VideoCodecSettings where
  parseJSON =
    withObject
      "VideoCodecSettings"
      (\x ->
         VideoCodecSettings' <$> (x .:? "frameCaptureSettings") <*>
         (x .:? "codec") <*>
         (x .:? "h265Settings") <*>
         (x .:? "proresSettings") <*>
         (x .:? "h264Settings") <*>
...
vdTimecodeInsertion =
  lens _vdTimecodeInsertion (\s a -> s {_vdTimecodeInsertion = a})
...
vdDropFrameTimecode =
  lens _vdDropFrameTimecode (\s a -> s {_vdDropFrameTimecode = a})
...
vdVideoPreprocessors =
  lens _vdVideoPreprocessors (\s a -> s {_vdVideoPreprocessors = a})
...
instance FromJSON VideoDescription where
  parseJSON =
    withObject
      "VideoDescription"
      (\x ->
         VideoDescription' <$> (x .:? "timecodeInsertion") <*> (x .:? "height") <*>
         (x .:? "afdSignaling") <*>
         (x .:? "sharpness") <*>
         (x .:? "crop") <*>
         (x .:? "width") <*>
...
instance FromJSON VideoDetail where
  parseJSON =
    withObject
      "VideoDetail"
      (\x -> VideoDetail' <$> (x .:? "heightInPx") <*> (x .:? "widthInPx"))
...
instance FromJSON VideoPreprocessor where
  parseJSON =
    withObject
      "VideoPreprocessor"
      (\x ->
         VideoPreprocessor' <$> (x .:? "timecodeBurnin") <*>
         (x .:? "colorCorrector") <*>
         (x .:? "deinterlacer") <*>
         (x .:? "noiseReducer") <*>
         (x .:? "imageInserter"))
...
instance FromJSON WavSettings where
  parseJSON =
    withObject
      "WavSettings"
      (\x ->
         WavSettings' <$> (x .:? "bitDepth") <*> (x .:? "channels") <*>
         (x .:? "sampleRate"))
