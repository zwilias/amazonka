...
data MsSmoothAdditionalManifest = MsSmoothAdditionalManifest'{_msamManifestNameModifier
                                                              :: !(Maybe Text),
...
msSmoothAdditionalManifest
    :: MsSmoothAdditionalManifest
msSmoothAdditionalManifest
  = MsSmoothAdditionalManifest'{_msamManifestNameModifier
                                  = Nothing,
...
instance FromJSON MsSmoothAdditionalManifest where
        parseJSON
          = withObject "MsSmoothAdditionalManifest"
              (\ x ->
                 MsSmoothAdditionalManifest' <$>
                   (x .:? "manifestNameModifier") <*>
                     (x .:? "selectedOutputs" .!= mempty))

instance Hashable MsSmoothAdditionalManifest where

instance NFData MsSmoothAdditionalManifest where
