...
uatAssessmentTargetARN =
  lens _uatAssessmentTargetARN (\s a -> s {_uatAssessmentTargetARN = a})

-- | The name of the assessment target that you want to update.
uatAssessmentTargetName :: Lens' UpdateAssessmentTarget Text
uatAssessmentTargetName =
  lens _uatAssessmentTargetName (\s a -> s {_uatAssessmentTargetName = a})

-- | The ARN of the resource group that is used to specify the new resource group to associate with the assessment target.
uatResourceGroupARN :: Lens' UpdateAssessmentTarget Text
uatResourceGroupARN =
  lens _uatResourceGroupARN (\s a -> s {_uatResourceGroupARN = a})
