...
catAssessmentTargetName =
  lens _catAssessmentTargetName (\s a -> s {_catAssessmentTargetName = a})

-- | The ARN that specifies the resource group that is used to create the assessment target.
catResourceGroupARN :: Lens' CreateAssessmentTarget Text
catResourceGroupARN =
  lens _catResourceGroupARN (\s a -> s {_catResourceGroupARN = a})
...
instance AWSRequest CreateAssessmentTarget where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateAssessmentTargetResponse' <$> (pure (fromEnum s)) <*>
...
catrsResponseStatus =
  lens _catrsResponseStatus (\s a -> s {_catrsResponseStatus = a})

-- | The ARN that specifies the assessment target that is created.
catrsAssessmentTargetARN :: Lens' CreateAssessmentTargetResponse Text
catrsAssessmentTargetARN =
  lens _catrsAssessmentTargetARN (\s a -> s {_catrsAssessmentTargetARN = a})
