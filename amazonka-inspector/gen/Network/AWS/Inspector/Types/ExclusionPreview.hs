...
data ExclusionPreview = ExclusionPreview'{_epAttributes
                                          :: !(Maybe [Attribute]),
                                          _epTitle :: !Text,
                                          _epDescription :: !Text,
...
exclusionPreview
    ...
    -> ExclusionPreview
exclusionPreview pTitle_ pDescription_
  pRecommendation_ pScopes_
  = ExclusionPreview'{_epAttributes = Nothing,
                      _epTitle = pTitle_, _epDescription = pDescription_,
