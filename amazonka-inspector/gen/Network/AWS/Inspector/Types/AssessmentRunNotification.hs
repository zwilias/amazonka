...
data AssessmentRunNotification = AssessmentRunNotification'{_arnSnsTopicARN
                                                            :: !(Maybe Text),
...
assessmentRunNotification pDate_ pEvent_ pError_
  = AssessmentRunNotification'{_arnSnsTopicARN =
                                 Nothing,
                               _arnSnsPublishStatusCode = Nothing,
                               _arnMessage = Nothing, _arnDate = _Time # pDate_,
                               _arnEvent = pEvent_, _arnError = pError_}
