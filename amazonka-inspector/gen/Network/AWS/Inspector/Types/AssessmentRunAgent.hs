...
data AssessmentRunAgent = AssessmentRunAgent'{_araAutoScalingGroup
                                              :: !(Maybe Text),
...
assessmentRunAgent
    ...
    -> AssessmentRunAgent
assessmentRunAgent pAgentId_ pAssessmentRunARN_
  pAgentHealth_ pAgentHealthCode_
  = AssessmentRunAgent'{_araAutoScalingGroup = Nothing,
