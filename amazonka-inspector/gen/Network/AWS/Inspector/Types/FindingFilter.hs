...
data FindingFilter = FindingFilter'{_ffAgentIds ::
                                    !(Maybe [Text]),
...
findingFilter
    :: FindingFilter
findingFilter
  = FindingFilter'{_ffAgentIds = Nothing,
                   _ffRuleNames = Nothing, _ffUserAttributes = Nothing,
                   _ffRulesPackageARNs = Nothing,
                   _ffAttributes = Nothing, _ffSeverities = Nothing,
