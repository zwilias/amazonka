...
data AssessmentTemplate = AssessmentTemplate'{_atLastAssessmentRunARN
                                              :: !(Maybe Text),
                                              _atArn :: !Text, _atName :: !Text,
...
assessmentTemplate
    ...
    -> UTCTime -- ^ 'atCreatedAt'
    -> AssessmentTemplate
assessmentTemplate pArn_ pName_ pAssessmentTargetARN_
  pDurationInSeconds_ pAssessmentRunCount_ pCreatedAt_
  = AssessmentTemplate'{_atLastAssessmentRunARN =
                          Nothing,
                        _atArn = pArn_, _atName = pName_,
