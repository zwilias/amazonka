...
data AgentPreview = AgentPreview'{_apHostname ::
                                  !(Maybe Text),
...
agentPreview pAgentId_
  = AgentPreview'{_apHostname = Nothing,
                  _apAutoScalingGroup = Nothing,
                  _apOperatingSystem = Nothing,
                  _apAgentVersion = Nothing,
                  _apKernelVersion = Nothing, _apAgentHealth = Nothing,
                  _apIpv4Address = Nothing, _apAgentId = pAgentId_}
