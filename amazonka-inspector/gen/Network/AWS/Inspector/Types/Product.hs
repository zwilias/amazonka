...
afAgentHealths =
  lens _afAgentHealths (\s a -> s {_afAgentHealths = a}) . _Coerce
...
afAgentHealthCodes =
  lens _afAgentHealthCodes (\s a -> s {_afAgentHealthCodes = a}) . _Coerce
...
apAutoScalingGroup =
  lens _apAutoScalingGroup (\s a -> s {_apAutoScalingGroup = a})
...
instance FromJSON AgentPreview where
  parseJSON =
    withObject
      "AgentPreview"
      (\x ->
         AgentPreview' <$> (x .:? "hostname") <*> (x .:? "autoScalingGroup") <*>
         (x .:? "operatingSystem") <*>
         (x .:? "agentVersion") <*>
         (x .:? "kernelVersion") <*>
         (x .:? "agentHealth") <*>
...
arCompletedAt =
  lens _arCompletedAt (\s a -> s {_arCompletedAt = a}) . mapping _Time
...
arAssessmentTemplateARN =
  lens _arAssessmentTemplateARN (\s a -> s {_arAssessmentTemplateARN = a})
...
arDurationInSeconds =
  lens _arDurationInSeconds (\s a -> s {_arDurationInSeconds = a}) . _Nat

-- | The rules packages selected for the assessment run.
arRulesPackageARNs :: Lens' AssessmentRun (NonEmpty Text)
arRulesPackageARNs =
  lens _arRulesPackageARNs (\s a -> s {_arRulesPackageARNs = a}) . _List1
...
arUserAttributesForFindings =
  lens
    ...
    (\s a -> s {_arUserAttributesForFindings = a}) .
  _Coerce
...
arStateChangedAt =
  lens _arStateChangedAt (\s a -> s {_arStateChangedAt = a}) . _Time
...
arStateChanges =
  lens _arStateChanges (\s a -> s {_arStateChanges = a}) . _Coerce

-- | A list of notifications for the event subscriptions. A notification about a particular generated finding is added to this list only once.
arNotifications :: Lens' AssessmentRun [AssessmentRunNotification]
arNotifications =
  lens _arNotifications (\s a -> s {_arNotifications = a}) . _Coerce

-- | Provides a total count of generated findings per severity.
arFindingCounts :: Lens' AssessmentRun (HashMap Severity Int)
arFindingCounts =
  lens _arFindingCounts (\s a -> s {_arFindingCounts = a}) . _Map
...
instance FromJSON AssessmentRun where
  parseJSON =
    withObject
      "AssessmentRun"
      (\x ->
         AssessmentRun' <$> (x .:? "startedAt") <*> (x .:? "completedAt") <*>
         (x .: "arn") <*>
         (x .: "name") <*>
...
araAutoScalingGroup =
  lens _araAutoScalingGroup (\s a -> s {_araAutoScalingGroup = a})

-- | The description for the agent health code.
araAgentHealthDetails :: Lens' AssessmentRunAgent (Maybe Text)
araAgentHealthDetails =
  lens _araAgentHealthDetails (\s a -> s {_araAgentHealthDetails = a})
...
araAssessmentRunARN =
  lens _araAssessmentRunARN (\s a -> s {_araAssessmentRunARN = a})
...
araAgentHealthCode =
  lens _araAgentHealthCode (\s a -> s {_araAgentHealthCode = a})

-- | The Amazon Inspector application data metrics that are collected by the agent.
araTelemetryMetadata :: Lens' AssessmentRunAgent [TelemetryMetadata]
araTelemetryMetadata =
  lens _araTelemetryMetadata (\s a -> s {_araTelemetryMetadata = a}) . _Coerce
...
instance FromJSON AssessmentRunAgent where
  parseJSON =
    withObject
      "AssessmentRunAgent"
      (\x ->
         AssessmentRunAgent' <$> (x .:? "autoScalingGroup") <*>
...
arfStateChangeTimeRange =
  lens _arfStateChangeTimeRange (\s a -> s {_arfStateChangeTimeRange = a})
...
arfRulesPackageARNs =
  lens _arfRulesPackageARNs (\s a -> s {_arfRulesPackageARNs = a}) .
  _Default . _Coerce
...
arfCompletionTimeRange =
  lens _arfCompletionTimeRange (\s a -> s {_arfCompletionTimeRange = a})
...
arnSnsPublishStatusCode =
  lens _arnSnsPublishStatusCode (\s a -> s {_arnSnsPublishStatusCode = a})
...
instance FromJSON AssessmentRunNotification where
  parseJSON =
    withObject
      "AssessmentRunNotification"
      (\x ->
         AssessmentRunNotification' <$> (x .:? "snsTopicArn") <*>
...
arscStateChangedAt =
  lens _arscStateChangedAt (\s a -> s {_arscStateChangedAt = a}) . _Time
...
instance FromJSON AssessmentRunStateChange where
  parseJSON =
    withObject
      "AssessmentRunStateChange"
      (\x ->
         AssessmentRunStateChange' <$> (x .: "stateChangedAt") <*>
         (x .: "state"))
...
atfAssessmentTargetNamePattern =
  lens
    ...
    (\s a -> s {_atfAssessmentTargetNamePattern = a})
...
atLastAssessmentRunARN =
  lens _atLastAssessmentRunARN (\s a -> s {_atLastAssessmentRunARN = a})
...
atAssessmentTargetARN =
  lens _atAssessmentTargetARN (\s a -> s {_atAssessmentTargetARN = a})
...
instance FromJSON AssessmentTemplate where
  parseJSON =
    withObject
      "AssessmentTemplate"
      (\x ->
         AssessmentTemplate' <$> (x .:? "lastAssessmentRunArn") <*> (x .: "arn") <*>
         (x .: "name") <*>
...
atfRulesPackageARNs =
  lens _atfRulesPackageARNs (\s a -> s {_atfRulesPackageARNs = a}) .
  _Default . _Coerce
...
aaAutoScalingGroup =
  lens _aaAutoScalingGroup (\s a -> s {_aaAutoScalingGroup = a})

-- | The list of IP v4 addresses of the EC2 instance where the finding is generated.
aaIpv4Addresses :: Lens' AssetAttributes [Text]
aaIpv4Addresses =
  lens _aaIpv4Addresses (\s a -> s {_aaIpv4Addresses = a}) . _Default . _Coerce
...
aaSchemaVersion =
  lens _aaSchemaVersion (\s a -> s {_aaSchemaVersion = a}) . _Nat
...
instance FromJSON AssetAttributes where
  parseJSON =
    withObject
      "AssetAttributes"
      (\x ->
         AssetAttributes' <$> (x .:? "hostname") <*> (x .:? "autoScalingGroup") <*>
...
instance ToJSON Attribute where
  toJSON Attribute' {..} =
    object (catMaybes [("value" .=) <$> _aValue, Just ("key" .= _aKey)])
...
instance FromJSON EventSubscription where
  parseJSON =
    withObject
      "EventSubscription"
      (\x -> EventSubscription' <$> (x .: "event") <*> (x .: "subscribedAt"))
...
instance FromJSON FailedItemDetails where
  parseJSON =
    withObject
      "FailedItemDetails"
      (\x -> FailedItemDetails' <$> (x .: "failureCode") <*> (x .: "retryable"))
...
fSchemaVersion =
  lens _fSchemaVersion (\s a -> s {_fSchemaVersion = a}) . mapping _Nat
...
fServiceAttributes =
  lens _fServiceAttributes (\s a -> s {_fServiceAttributes = a})
...
fIndicatorOfCompromise =
  lens _fIndicatorOfCompromise (\s a -> s {_fIndicatorOfCompromise = a})
...
fUserAttributes =
  lens _fUserAttributes (\s a -> s {_fUserAttributes = a}) . _Coerce
...
ffRuleNames =
  lens _ffRuleNames (\s a -> s {_ffRuleNames = a}) . _Default . _Coerce
...
ffUserAttributes =
  lens _ffUserAttributes (\s a -> s {_ffUserAttributes = a}) .
  _Default . _Coerce
...
ffRulesPackageARNs =
  lens _ffRulesPackageARNs (\s a -> s {_ffRulesPackageARNs = a}) .
  _Default . _Coerce
...
ffAttributes =
  lens _ffAttributes (\s a -> s {_ffAttributes = a}) . _Default . _Coerce
...
ffSeverities =
  lens _ffSeverities (\s a -> s {_ffSeverities = a}) . _Default . _Coerce

-- | The time range during which the finding is generated.
ffCreationTimeRange :: Lens' FindingFilter (Maybe TimestampRange)
ffCreationTimeRange =
  lens _ffCreationTimeRange (\s a -> s {_ffCreationTimeRange = a})
...
ffAutoScalingGroups =
  lens _ffAutoScalingGroups (\s a -> s {_ffAutoScalingGroups = a}) .
  _Default . _Coerce
...
isaRulesPackageARN =
  lens _isaRulesPackageARN (\s a -> s {_isaRulesPackageARN = a})

-- | The ARN of the assessment run during which the finding is generated.
isaAssessmentRunARN :: Lens' InspectorServiceAttributes (Maybe Text)
isaAssessmentRunARN =
  lens _isaAssessmentRunARN (\s a -> s {_isaAssessmentRunARN = a})

-- | The schema version of this data type.
isaSchemaVersion :: Lens' InspectorServiceAttributes Natural
isaSchemaVersion =
  lens _isaSchemaVersion (\s a -> s {_isaSchemaVersion = a}) . _Nat
...
instance FromJSON InspectorServiceAttributes where
  parseJSON =
    withObject
      "InspectorServiceAttributes"
      (\x ->
         InspectorServiceAttributes' <$> (x .:? "rulesPackageArn") <*>
         (x .:? "assessmentRunArn") <*>
         (x .: "schemaVersion"))
...
instance ToJSON ResourceGroupTag where
  toJSON ResourceGroupTag' {..} =
    object (catMaybes [("value" .=) <$> _rgtValue, Just ("key" .= _rgtKey)])
...
instance FromJSON RulesPackage where
  parseJSON =
    withObject
      "RulesPackage"
      (\x ->
         RulesPackage' <$> (x .:? "description") <*> (x .: "arn") <*>
         (x .: "name") <*>
         (x .: "version") <*>
         (x .: "provider"))
...
sEventSubscriptions =
  lens _sEventSubscriptions (\s a -> s {_sEventSubscriptions = a}) . _List1
...
instance FromJSON Subscription where
  parseJSON =
    withObject
      "Subscription"
      (\x ->
         Subscription' <$> (x .: "resourceArn") <*> (x .: "topicArn") <*>
...
instance FromJSON TelemetryMetadata where
  parseJSON =
    withObject
      "TelemetryMetadata"
      (\x ->
         TelemetryMetadata' <$> (x .:? "dataSize") <*> (x .: "messageType") <*>
         (x .: "count"))
