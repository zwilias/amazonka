...
data Exclusion = Exclusion'{_eAttributes ::
                            !(Maybe [Attribute]),
                            _eArn :: !Text, _eTitle :: !Text,
                            _eDescription :: !Text, _eRecommendation :: !Text,
...
exclusion
    ...
    -> Exclusion
exclusion pArn_ pTitle_ pDescription_
  pRecommendation_ pScopes_
  = Exclusion'{_eAttributes = Nothing, _eArn = pArn_,
               _eTitle = pTitle_, _eDescription = pDescription_,
