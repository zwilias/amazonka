...
newtype DeleteAssessmentTemplate =
  DeleteAssessmentTemplate'
...
datAssessmentTemplateARN =
  lens _datAssessmentTemplateARN (\s a -> s {_datAssessmentTemplateARN = a})
...
instance ToJSON DeleteAssessmentTemplate where
  toJSON DeleteAssessmentTemplate' {..} =
    object
      (catMaybes [Just ("assessmentTemplateArn" .= _datAssessmentTemplateARN)])
