...
data CreateDataSourceFromRDS = CreateDataSourceFromRDS'{_cdsfrdsDataSourceName
                                                        :: !(Maybe Text),
...
createDataSourceFromRDS
    ...
    -> Text -- ^ 'cdsfrdsRoleARN'
    -> CreateDataSourceFromRDS
createDataSourceFromRDS pDataSourceId_ pRDSData_
  pRoleARN_
  = CreateDataSourceFromRDS'{_cdsfrdsDataSourceName =
                               Nothing,
...
data CreateDataSourceFromRDSResponse = CreateDataSourceFromRDSResponse'{_cdsfrdsrsDataSourceId
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
createDataSourceFromRDSResponse pResponseStatus_
  = CreateDataSourceFromRDSResponse'{_cdsfrdsrsDataSourceId
                                       = Nothing,
                                     _cdsfrdsrsResponseStatus =
                                       pResponseStatus_}
