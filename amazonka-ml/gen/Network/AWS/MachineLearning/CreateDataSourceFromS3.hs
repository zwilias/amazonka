...
data CreateDataSourceFromS3 = CreateDataSourceFromS3'{_cdsfsDataSourceName
                                                      :: !(Maybe Text),
...
createDataSourceFromS3 pDataSourceId_ pDataSpec_
  = CreateDataSourceFromS3'{_cdsfsDataSourceName =
                              Nothing,
...
data CreateDataSourceFromS3Response = CreateDataSourceFromS3Response'{_cdsfsrsDataSourceId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
createDataSourceFromS3Response pResponseStatus_
  = CreateDataSourceFromS3Response'{_cdsfsrsDataSourceId
                                      = Nothing,
