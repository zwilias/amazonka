...
bpLastUpdatedAt =
  lens _bpLastUpdatedAt (\s a -> s {_bpLastUpdatedAt = a}) . mapping _Time
...
bpTotalRecordCount =
  lens _bpTotalRecordCount (\s a -> s {_bpTotalRecordCount = a})
...
bpFinishedAt =
  lens _bpFinishedAt (\s a -> s {_bpFinishedAt = a}) . mapping _Time

-- | Undocumented member.
bpInvalidRecordCount :: Lens' BatchPrediction (Maybe Integer)
bpInvalidRecordCount =
  lens _bpInvalidRecordCount (\s a -> s {_bpInvalidRecordCount = a})
...
instance FromJSON BatchPrediction where
  parseJSON =
    withObject
      "BatchPrediction"
      (\x ->
         BatchPrediction' <$> (x .:? "Status") <*> (x .:? "LastUpdatedAt") <*>
         (x .:? "CreatedAt") <*>
         (x .:? "ComputeTime") <*>
...
dsLastUpdatedAt =
  lens _dsLastUpdatedAt (\s a -> s {_dsLastUpdatedAt = a}) . mapping _Time
...
dsFinishedAt =
  lens _dsFinishedAt (\s a -> s {_dsFinishedAt = a}) . mapping _Time
...
instance FromJSON DataSource where
  parseJSON =
    withObject
      "DataSource"
      (\x ->
         DataSource' <$> (x .:? "Status") <*> (x .:? "NumberOfFiles") <*>
         (x .:? "LastUpdatedAt") <*>
         (x .:? "CreatedAt") <*>
         (x .:? "ComputeTime") <*>
         (x .:? "DataSourceId") <*>
...
eLastUpdatedAt =
  lens _eLastUpdatedAt (\s a -> s {_eLastUpdatedAt = a}) . mapping _Time
...
instance FromJSON Evaluation where
  parseJSON =
    withObject
      "Evaluation"
      (\x ->
         Evaluation' <$> (x .:? "Status") <*> (x .:? "PerformanceMetrics") <*>
         (x .:? "LastUpdatedAt") <*>
         (x .:? "CreatedAt") <*>
         (x .:? "ComputeTime") <*>
         (x .:? "InputDataLocationS3") <*>
...
mlmLastUpdatedAt =
  lens _mlmLastUpdatedAt (\s a -> s {_mlmLastUpdatedAt = a}) . mapping _Time
...
mlmScoreThresholdLastUpdatedAt =
  lens
    _mlmScoreThresholdLastUpdatedAt
...
mlmCreatedAt =
  lens _mlmCreatedAt (\s a -> s {_mlmCreatedAt = a}) . mapping _Time
...
mlmStartedAt =
  lens _mlmStartedAt (\s a -> s {_mlmStartedAt = a}) . mapping _Time
...
mlmFinishedAt =
  lens _mlmFinishedAt (\s a -> s {_mlmFinishedAt = a}) . mapping _Time
...
instance FromJSON MLModel where
  parseJSON =
    withObject
      "MLModel"
      (\x ->
         MLModel' <$> (x .:? "Status") <*> (x .:? "LastUpdatedAt") <*>
...
pmProperties =
  lens _pmProperties (\s a -> s {_pmProperties = a}) . _Default . _Map
...
pPredictedScores =
  lens _pPredictedScores (\s a -> s {_pPredictedScores = a}) . _Default . _Map
...
instance FromJSON Prediction where
  parseJSON =
    withObject
      "Prediction"
      (\x ->
         Prediction' <$> (x .:? "predictedValue") <*> (x .:? "predictedLabel") <*>
...
rdsdsDatabaseInformation =
  lens _rdsdsDatabaseInformation (\s a -> s {_rdsdsDatabaseInformation = a})
...
rdsdsDatabaseCredentials =
  lens _rdsdsDatabaseCredentials (\s a -> s {_rdsdsDatabaseCredentials = a})
...
rdsdsSecurityGroupIds =
  lens _rdsdsSecurityGroupIds (\s a -> s {_rdsdsSecurityGroupIds = a}) . _Coerce
...
instance FromJSON RDSDatabase where
  parseJSON =
    withObject
      "RDSDatabase"
      (\x ->
         RDSDatabase' <$> (x .: "InstanceIdentifier") <*> (x .: "DatabaseName"))
...
instance FromJSON RDSMetadata where
  parseJSON =
    withObject
      "RDSMetadata"
      (\x ->
         RDSMetadata' <$> (x .:? "SelectSqlQuery") <*> (x .:? "DataPipelineId") <*>
         (x .:? "Database") <*>
         (x .:? "DatabaseUserName") <*>
         (x .:? "ResourceRole") <*>
         (x .:? "ServiceRole"))
...
reiCreatedAt =
  lens _reiCreatedAt (\s a -> s {_reiCreatedAt = a}) . mapping _Time
...
reiPeakRequestsPerSecond =
  lens _reiPeakRequestsPerSecond (\s a -> s {_reiPeakRequestsPerSecond = a})
...
instance FromJSON RealtimeEndpointInfo where
  parseJSON =
    withObject
      "RealtimeEndpointInfo"
      (\x ->
         RealtimeEndpointInfo' <$> (x .:? "CreatedAt") <*> (x .:? "EndpointUrl") <*>
         (x .:? "EndpointStatus") <*>
...
rDataRearrangement =
  lens _rDataRearrangement (\s a -> s {_rDataRearrangement = a})

-- | Describes the @DatabaseName@ and @ClusterIdentifier@ for an Amazon Redshift @DataSource@ .
rDatabaseInformation :: Lens' RedshiftDataSpec RedshiftDatabase
rDatabaseInformation =
  lens _rDatabaseInformation (\s a -> s {_rDatabaseInformation = a})
...
rDatabaseCredentials =
  lens _rDatabaseCredentials (\s a -> s {_rDatabaseCredentials = a})

-- | Describes an Amazon S3 location to store the result set of the @SelectSqlQuery@ query.
rS3StagingLocation :: Lens' RedshiftDataSpec Text
rS3StagingLocation =
  lens _rS3StagingLocation (\s a -> s {_rS3StagingLocation = a})
...
instance FromJSON RedshiftDatabase where
  parseJSON =
    withObject
      "RedshiftDatabase"
      (\x ->
         RedshiftDatabase' <$> (x .: "DatabaseName") <*>
         (x .: "ClusterIdentifier"))
...
instance ToJSON RedshiftDatabaseCredentials where
  toJSON RedshiftDatabaseCredentials' {..} =
    object
      (catMaybes
         [Just ("Username" .= _rdcUsername), Just ("Password" .= _rdcPassword)])
...
redRedshiftDatabase =
  lens _redRedshiftDatabase (\s a -> s {_redRedshiftDatabase = a})

-- | Undocumented member.
redDatabaseUserName :: Lens' RedshiftMetadata (Maybe Text)
redDatabaseUserName =
  lens _redDatabaseUserName (\s a -> s {_redDatabaseUserName = a})
...
instance FromJSON RedshiftMetadata where
  parseJSON =
    withObject
      "RedshiftMetadata"
      (\x ->
         RedshiftMetadata' <$> (x .:? "SelectSqlQuery") <*>
         (x .:? "RedshiftDatabase") <*>
         (x .:? "DatabaseUserName"))
