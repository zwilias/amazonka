...
data RedshiftDataSpec = RedshiftDataSpec'{_rDataSchemaURI
                                          :: !(Maybe Text),
...
redshiftDataSpec
    ...
    -> RedshiftDataSpec
redshiftDataSpec pDatabaseInformation_
  pSelectSqlQuery_ pDatabaseCredentials_
  pS3StagingLocation_
  = RedshiftDataSpec'{_rDataSchemaURI = Nothing,
