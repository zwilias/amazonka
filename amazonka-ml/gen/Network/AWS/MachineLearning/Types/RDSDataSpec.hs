...
data RDSDataSpec = RDSDataSpec'{_rdsdsDataSchemaURI
                                :: !(Maybe Text),
...
rdsDataSpec
    ...
    -> Text -- ^ 'rdsdsSubnetId'
    -> RDSDataSpec
rdsDataSpec pDatabaseInformation_ pSelectSqlQuery_
  pDatabaseCredentials_ pS3StagingLocation_
  pResourceRole_ pServiceRole_ pSubnetId_
  = RDSDataSpec'{_rdsdsDataSchemaURI = Nothing,
