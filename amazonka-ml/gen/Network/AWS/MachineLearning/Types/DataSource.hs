...
data DataSource = DataSource'{_dsStatus ::
                              !(Maybe EntityStatus),
...
dataSource
    :: DataSource
dataSource
  = DataSource'{_dsStatus = Nothing,
                _dsNumberOfFiles = Nothing,
                _dsLastUpdatedAt = Nothing, _dsCreatedAt = Nothing,
                _dsComputeTime = Nothing, _dsDataSourceId = Nothing,
                _dsRDSMetadata = Nothing,
                _dsDataSizeInBytes = Nothing, _dsStartedAt = Nothing,
                _dsFinishedAt = Nothing,
                _dsCreatedByIAMUser = Nothing, _dsName = Nothing,
                _dsDataLocationS3 = Nothing,
                _dsComputeStatistics = Nothing, _dsMessage = Nothing,
                _dsRedshiftMetadata = Nothing,
                _dsDataRearrangement = Nothing, _dsRoleARN = Nothing}
