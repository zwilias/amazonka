         ...
         _waitAcceptors =
           [matchAll "COMPLETED" AcceptSuccess
            ...
            matchAll "FAILED" AcceptFailure
              (dsrsStep . _Just . sStatus . _Just . ssState . _Just
                 . to toTextCI),
            matchAll "CANCELLED" AcceptFailure
              (dsrsStep . _Just . sStatus . _Just . ssState . _Just
                 . to toTextCI)]}
  ...
  = Wait{_waitName = "ClusterTerminated",
         ...
         _waitAcceptors =
           [matchAll "TERMINATED" AcceptSuccess
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI),
            matchAll "TERMINATED_WITH_ERRORS" AcceptFailure
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI)]}
  ...
  = Wait{_waitName = "ClusterRunning",
         ...
         _waitAcceptors =
           [matchAll "RUNNING" AcceptSuccess
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI),
            matchAll "WAITING" AcceptSuccess
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI),
            matchAll "TERMINATING" AcceptFailure
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI),
            matchAll "TERMINATED" AcceptFailure
              (dcrsCluster . cluStatus . csState . _Just .
                 to toTextCI),
            matchAll "TERMINATED_WITH_ERRORS" AcceptFailure
              (dcrsCluster . cluStatus . csState . _Just .
