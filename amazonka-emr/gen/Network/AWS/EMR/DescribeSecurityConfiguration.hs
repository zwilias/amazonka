...
newtype DescribeSecurityConfiguration =
  DescribeSecurityConfiguration'
    { _dName :: Text
    }
...
instance AWSRequest DescribeSecurityConfiguration where
  type Rs DescribeSecurityConfiguration = DescribeSecurityConfigurationResponse
...
drsSecurityConfiguration ::
     Lens' DescribeSecurityConfigurationResponse (Maybe Text)
drsSecurityConfiguration =
  lens _drsSecurityConfiguration (\s a -> s {_drsSecurityConfiguration = a})
...
drsCreationDateTime ::
     Lens' DescribeSecurityConfigurationResponse (Maybe UTCTime)
drsCreationDateTime =
  lens _drsCreationDateTime (\s a -> s {_drsCreationDateTime = a}) .
  mapping _Time
