...
instance AWSRequest ListSecurityConfigurations where
  type Rs ListSecurityConfigurations = ListSecurityConfigurationsResponse
...
lscrsSecurityConfigurations ::
     Lens' ListSecurityConfigurationsResponse [SecurityConfigurationSummary]
lscrsSecurityConfigurations =
  lens
    _lscrsSecurityConfigurations
    (\s a -> s {_lscrsSecurityConfigurations = a}) .
  _Default . _Coerce
...
lscrsResponseStatus =
  lens _lscrsResponseStatus (\s a -> s {_lscrsResponseStatus = a})
