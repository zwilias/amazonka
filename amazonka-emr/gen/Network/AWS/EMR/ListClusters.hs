...
lcCreatedAfter =
  lens _lcCreatedAfter (\s a -> s {_lcCreatedAfter = a}) . mapping _Time
...
lcClusterStates =
  lens _lcClusterStates (\s a -> s {_lcClusterStates = a}) . _Default . _Coerce

-- | The creation date and time end value filter for listing clusters.
lcCreatedBefore :: Lens' ListClusters (Maybe UTCTime)
lcCreatedBefore =
  lens _lcCreatedBefore (\s a -> s {_lcCreatedBefore = a}) . mapping _Time
...
lcrsClusters =
  lens _lcrsClusters (\s a -> s {_lcrsClusters = a}) . _Default . _Coerce
