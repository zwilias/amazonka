...
instance FromText ActionOnFailure where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ActionOnFailure from value: '" <>
        e <>
...
instance FromText AdjustmentType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AdjustmentType from value: '" <>
        e <>
...
instance FromText AutoScalingPolicyState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutoScalingPolicyState from value: '" <>
        e <>
...
instance FromText AutoScalingPolicyStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing AutoScalingPolicyStateChangeReasonCode from value: '" <>
        e <>
...
instance FromText CancelStepsRequestStatus where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing CancelStepsRequestStatus from value: '" <>
        e <> "'. Accepted values: failed, submitted"
...
instance FromText ClusterState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ClusterState from value: '" <>
        e <>
...
instance FromText ClusterStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ClusterStateChangeReasonCode from value: '" <>
        e <>
...
instance FromText InstanceCollectionType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceCollectionType from value: '" <>
        e <> "'. Accepted values: instance_fleet, instance_group"
...
instance FromText InstanceFleetState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceFleetState from value: '" <>
        e <>
...
instance FromText InstanceFleetStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceFleetStateChangeReasonCode from value: '" <>
        e <>
...
instance FromText InstanceFleetType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceFleetType from value: '" <>
        e <> "'. Accepted values: core, master, task"
...
instance FromText InstanceGroupState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceGroupState from value: '" <>
        e <>
...
instance FromText InstanceGroupStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceGroupStateChangeReasonCode from value: '" <>
        e <>
        "'. Accepted values: cluster_terminated, instance_failure, internal_error, validation_error"
...
instance FromText InstanceGroupType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceGroupType from value: '" <>
        e <> "'. Accepted values: core, master, task"
...
instance FromText InstanceRoleType where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceRoleType from value: '" <>
        e <> "'. Accepted values: core, master, task"
...
instance FromText InstanceState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceState from value: '" <>
        e <>
...
instance FromText InstanceStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing InstanceStateChangeReasonCode from value: '" <>
        e <>
...
instance FromText RepoUpgradeOnBoot where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing RepoUpgradeOnBoot from value: '" <>
        e <> "'. Accepted values: none, security"
...
instance FromText ScaleDownBehavior where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing ScaleDownBehavior from value: '" <>
        e <>
...
instance FromText SpotProvisioningTimeoutAction where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing SpotProvisioningTimeoutAction from value: '" <>
        e <> "'. Accepted values: switch_to_on_demand, terminate_cluster"
  ...
  parser =
    takeLowerText >>= \case
      ...
      e ->
        ...
        e <> "'. Accepted values: average, maximum, minimum, sample_count, sum"
...
instance FromText StepState where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StepState from value: '" <>
        e <>
...
instance FromText StepStateChangeReasonCode where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing StepStateChangeReasonCode from value: '" <>
        e <> "'. Accepted values: none"
...
instance FromText Unit where
  parser =
    takeLowerText >>= \case
      ...
      e ->
        fromTextError $
        "Failure parsing Unit from value: '" <>
        e <>
