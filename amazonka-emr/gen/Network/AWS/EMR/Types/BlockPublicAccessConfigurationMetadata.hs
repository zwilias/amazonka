...
data BlockPublicAccessConfigurationMetadata = BlockPublicAccessConfigurationMetadata'{_bpacmCreationDateTime
                                                                                      ::
                                                                                      !POSIX,
                                                                                      _bpacmCreatedByARN
                                                                                      ::
...
blockPublicAccessConfigurationMetadata
    :: UTCTime -- ^ 'bpacmCreationDateTime'
    -> Text -- ^ 'bpacmCreatedByARN'
    -> BlockPublicAccessConfigurationMetadata
blockPublicAccessConfigurationMetadata
  pCreationDateTime_ pCreatedByARN_
  = BlockPublicAccessConfigurationMetadata'{_bpacmCreationDateTime
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "BlockPublicAccessConfigurationMetadata"
              (\ x ->
                 BlockPublicAccessConfigurationMetadata' <$>
