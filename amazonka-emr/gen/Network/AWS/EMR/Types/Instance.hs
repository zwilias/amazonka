...
data Instance = Instance'{_iStatus ::
...
instance'
    :: Instance
instance'
  = Instance'{_iStatus = Nothing,
              _iPublicDNSName = Nothing, _iEBSVolumes = Nothing,
              _iEC2InstanceId = Nothing, _iInstanceType = Nothing,
              _iMarket = Nothing, _iPrivateIPAddress = Nothing,
              _iInstanceFleetId = Nothing, _iId = Nothing,
