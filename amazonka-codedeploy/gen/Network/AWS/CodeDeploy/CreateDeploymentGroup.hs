...
cdgOnPremisesTagSet =
  lens _cdgOnPremisesTagSet (\s a -> s {_cdgOnPremisesTagSet = a})
...
cdgEc2TagFilters =
  lens _cdgEc2TagFilters (\s a -> s {_cdgEc2TagFilters = a}) .
  _Default . _Coerce

-- | Information about blue/green deployment options for a deployment group.
cdgBlueGreenDeploymentConfiguration ::
     Lens' CreateDeploymentGroup (Maybe BlueGreenDeploymentConfiguration)
cdgBlueGreenDeploymentConfiguration =
  lens
    _cdgBlueGreenDeploymentConfiguration
    (\s a -> s {_cdgBlueGreenDeploymentConfiguration = a})

-- | Information about the load balancer used in a deployment.
cdgLoadBalancerInfo :: Lens' CreateDeploymentGroup (Maybe LoadBalancerInfo)
cdgLoadBalancerInfo =
  lens _cdgLoadBalancerInfo (\s a -> s {_cdgLoadBalancerInfo = a})
...
cdgAlarmConfiguration =
  lens _cdgAlarmConfiguration (\s a -> s {_cdgAlarmConfiguration = a})
...
cdgTriggerConfigurations =
  lens _cdgTriggerConfigurations (\s a -> s {_cdgTriggerConfigurations = a}) .
  _Default . _Coerce
...
cdgDeploymentStyle =
  lens _cdgDeploymentStyle (\s a -> s {_cdgDeploymentStyle = a})

-- | Configuration information for an automatic rollback that is added when a deployment group is created.
cdgAutoRollbackConfiguration ::
     Lens' CreateDeploymentGroup (Maybe AutoRollbackConfiguration)
cdgAutoRollbackConfiguration =
  lens
    _cdgAutoRollbackConfiguration
    (\s a -> s {_cdgAutoRollbackConfiguration = a})
...
instance AWSRequest CreateDeploymentGroup where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateDeploymentGroupResponse' <$> (x .?> "deploymentGroupId") <*>
         (pure (fromEnum s)))
...
cdgrsDeploymentGroupId =
  lens _cdgrsDeploymentGroupId (\s a -> s {_cdgrsDeploymentGroupId = a})

-- | -- | The response status code.
cdgrsResponseStatus :: Lens' CreateDeploymentGroupResponse Int
cdgrsResponseStatus =
  lens _cdgrsResponseStatus (\s a -> s {_cdgrsResponseStatus = a})
