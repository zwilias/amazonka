...
udgOnPremisesTagSet =
  lens _udgOnPremisesTagSet (\s a -> s {_udgOnPremisesTagSet = a})

-- | The new name of the deployment group, if you want to change it.
udgNewDeploymentGroupName :: Lens' UpdateDeploymentGroup (Maybe Text)
udgNewDeploymentGroupName =
  lens _udgNewDeploymentGroupName (\s a -> s {_udgNewDeploymentGroupName = a})

-- | The replacement set of Amazon EC2 tags on which to filter, if you want to change them. To keep the existing tags, enter their names. To remove tags, do not enter any tag names.
udgEc2TagFilters :: Lens' UpdateDeploymentGroup [EC2TagFilter]
udgEc2TagFilters =
  lens _udgEc2TagFilters (\s a -> s {_udgEc2TagFilters = a}) .
  _Default . _Coerce

-- | Information about blue/green deployment options for a deployment group.
udgBlueGreenDeploymentConfiguration ::
     Lens' UpdateDeploymentGroup (Maybe BlueGreenDeploymentConfiguration)
udgBlueGreenDeploymentConfiguration =
  lens
    _udgBlueGreenDeploymentConfiguration
    (\s a -> s {_udgBlueGreenDeploymentConfiguration = a})

-- | Information about the load balancer used in a deployment.
udgLoadBalancerInfo :: Lens' UpdateDeploymentGroup (Maybe LoadBalancerInfo)
udgLoadBalancerInfo =
  lens _udgLoadBalancerInfo (\s a -> s {_udgLoadBalancerInfo = a})
...
udgAlarmConfiguration =
  lens _udgAlarmConfiguration (\s a -> s {_udgAlarmConfiguration = a})
...
udgTriggerConfigurations =
  lens _udgTriggerConfigurations (\s a -> s {_udgTriggerConfigurations = a}) .
  _Default . _Coerce
...
udgDeploymentStyle =
  lens _udgDeploymentStyle (\s a -> s {_udgDeploymentStyle = a})

-- | Information for an automatic rollback configuration that is added or changed when a deployment group is updated.
udgAutoRollbackConfiguration ::
     Lens' UpdateDeploymentGroup (Maybe AutoRollbackConfiguration)
udgAutoRollbackConfiguration =
  lens
    _udgAutoRollbackConfiguration
    (\s a -> s {_udgAutoRollbackConfiguration = a})
  ...
  toJSON UpdateDeploymentGroup' {..} =
    object
      (catMaybes
         ...
         , Just ("currentDeploymentGroupName" .= _udgCurrentDeploymentGroupName)
         ])
...
udgrsHooksNotCleanedUp =
  lens _udgrsHooksNotCleanedUp (\s a -> s {_udgrsHooksNotCleanedUp = a}) .
  _Default . _Coerce

-- | -- | The response status code.
udgrsResponseStatus :: Lens' UpdateDeploymentGroupResponse Int
udgrsResponseStatus =
  lens _udgrsResponseStatus (\s a -> s {_udgrsResponseStatus = a})
