...
lopiTagFilters =
  lens _lopiTagFilters (\s a -> s {_lopiTagFilters = a}) . _Default . _Coerce
...
lopiRegistrationStatus ::
     Lens' ListOnPremisesInstances (Maybe RegistrationStatus)
lopiRegistrationStatus =
...
instance AWSRequest ListOnPremisesInstances where
  ...
  response =
    receiveJSON
      (\s h x ->
         ListOnPremisesInstancesResponse' <$> (x .?> "nextToken") <*>
...
lopirsInstanceNames =
  lens _lopirsInstanceNames (\s a -> s {_lopirsInstanceNames = a}) .
  _Default . _Coerce

-- | -- | The response status code.
lopirsResponseStatus :: Lens' ListOnPremisesInstancesResponse Int
lopirsResponseStatus =
  lens _lopirsResponseStatus (\s a -> s {_lopirsResponseStatus = a})
