...
acIgnorePollAlarmFailure =
  lens _acIgnorePollAlarmFailure (\s a -> s {_acIgnorePollAlarmFailure = a})
...
instance FromJSON AlarmConfiguration where
  parseJSON =
    withObject
      "AlarmConfiguration"
      (\x ->
         AlarmConfiguration' <$> (x .:? "ignorePollAlarmFailure") <*>
         (x .:? "enabled") <*>
         (x .:? "alarms" .!= mempty))
...
aiGitHubAccountName =
  lens _aiGitHubAccountName (\s a -> s {_aiGitHubAccountName = a})

-- | The time at which the application was created.
aiCreateTime :: Lens' ApplicationInfo (Maybe UTCTime)
aiCreateTime =
  lens _aiCreateTime (\s a -> s {_aiCreateTime = a}) . mapping _Time
...
instance FromJSON ApplicationInfo where
  parseJSON =
    withObject
      "ApplicationInfo"
      (\x ->
         ApplicationInfo' <$> (x .:? "linkedToGitHub") <*>
         (x .:? "computePlatform") <*>
         (x .:? "applicationId") <*>
         (x .:? "applicationName") <*>
         (x .:? "gitHubAccountName") <*>
...
instance FromJSON AutoRollbackConfiguration where
  parseJSON =
    withObject
      "AutoRollbackConfiguration"
      (\x ->
         AutoRollbackConfiguration' <$> (x .:? "enabled") <*>
         (x .:? "events" .!= mempty))
...
instance ToJSON AutoRollbackConfiguration where
  toJSON AutoRollbackConfiguration' {..} =
    object
      (catMaybes [("enabled" .=) <$> _arcEnabled, ("events" .=) <$> _arcEvents])
...
bgdcDeploymentReadyOption ::
     Lens' BlueGreenDeploymentConfiguration (Maybe DeploymentReadyOption)
bgdcDeploymentReadyOption =
  lens _bgdcDeploymentReadyOption (\s a -> s {_bgdcDeploymentReadyOption = a})

-- | Information about how instances are provisioned for a replacement environment in a blue/green deployment.
bgdcGreenFleetProvisioningOption ::
     Lens' BlueGreenDeploymentConfiguration (Maybe GreenFleetProvisioningOption)
bgdcGreenFleetProvisioningOption =
  lens
    _bgdcGreenFleetProvisioningOption
    (\s a -> s {_bgdcGreenFleetProvisioningOption = a})

-- | Information about whether to terminate instances in the original fleet during a blue/green deployment.
bgdcTerminateBlueInstancesOnDeploymentSuccess ::
     Lens' BlueGreenDeploymentConfiguration (Maybe BlueInstanceTerminationOption)
bgdcTerminateBlueInstancesOnDeploymentSuccess =
  lens
    _bgdcTerminateBlueInstancesOnDeploymentSuccess
    (\s a -> s {_bgdcTerminateBlueInstancesOnDeploymentSuccess = a})
...
instance FromJSON BlueGreenDeploymentConfiguration where
  parseJSON =
    withObject
      "BlueGreenDeploymentConfiguration"
      (\x ->
         BlueGreenDeploymentConfiguration' <$> (x .:? "deploymentReadyOption") <*>
...
bitoTerminationWaitTimeInMinutes ::
     Lens' BlueInstanceTerminationOption (Maybe Int)
bitoTerminationWaitTimeInMinutes =
  lens
    _bitoTerminationWaitTimeInMinutes
    (\s a -> s {_bitoTerminationWaitTimeInMinutes = a})
...
instance FromJSON BlueInstanceTerminationOption where
  parseJSON =
    withObject
      "BlueInstanceTerminationOption"
      (\x ->
         BlueInstanceTerminationOption' <$> (x .:? "action") <*>
...
dciComputePlatform =
  lens _dciComputePlatform (\s a -> s {_dciComputePlatform = a})
...
dciTrafficRoutingConfig ::
     Lens' DeploymentConfigInfo (Maybe TrafficRoutingConfig)
dciTrafficRoutingConfig =
  lens _dciTrafficRoutingConfig (\s a -> s {_dciTrafficRoutingConfig = a})
...
dciCreateTime =
  lens _dciCreateTime (\s a -> s {_dciCreateTime = a}) . mapping _Time
...
instance FromJSON DeploymentConfigInfo where
  parseJSON =
    withObject
      "DeploymentConfigInfo"
      (\x ->
         DeploymentConfigInfo' <$> (x .:? "deploymentConfigName") <*>
         (x .:? "computePlatform") <*>
...
dgiLastAttemptedDeployment ::
     Lens' DeploymentGroupInfo (Maybe LastDeploymentInfo)
dgiLastAttemptedDeployment =
  lens _dgiLastAttemptedDeployment (\s a -> s {_dgiLastAttemptedDeployment = a})

-- | Information about groups of tags applied to an on-premises instance. The deployment group includes only on-premises instances identified by all the tag groups. Cannot be used in the same call as onPremisesInstanceTagFilters.
dgiOnPremisesTagSet :: Lens' DeploymentGroupInfo (Maybe OnPremisesTagSet)
dgiOnPremisesTagSet =
  lens _dgiOnPremisesTagSet (\s a -> s {_dgiOnPremisesTagSet = a})
...
dgiComputePlatform =
  lens _dgiComputePlatform (\s a -> s {_dgiComputePlatform = a})
...
dgiEc2TagFilters =
  lens _dgiEc2TagFilters (\s a -> s {_dgiEc2TagFilters = a}) .
  _Default . _Coerce

-- | Information about blue/green deployment options for a deployment group.
dgiBlueGreenDeploymentConfiguration ::
     Lens' DeploymentGroupInfo (Maybe BlueGreenDeploymentConfiguration)
dgiBlueGreenDeploymentConfiguration =
  lens
    _dgiBlueGreenDeploymentConfiguration
    (\s a -> s {_dgiBlueGreenDeploymentConfiguration = a})

-- | Information about the load balancer to use in a deployment.
dgiLoadBalancerInfo :: Lens' DeploymentGroupInfo (Maybe LoadBalancerInfo)
dgiLoadBalancerInfo =
  lens _dgiLoadBalancerInfo (\s a -> s {_dgiLoadBalancerInfo = a})
...
dgiLastSuccessfulDeployment =
  lens
    ...
    (\s a -> s {_dgiLastSuccessfulDeployment = a})
...
dgiAlarmConfiguration =
  lens _dgiAlarmConfiguration (\s a -> s {_dgiAlarmConfiguration = a})

-- | Information about triggers associated with the deployment group.
dgiTriggerConfigurations :: Lens' DeploymentGroupInfo [TriggerConfig]
dgiTriggerConfigurations =
  lens _dgiTriggerConfigurations (\s a -> s {_dgiTriggerConfigurations = a}) .
  _Default . _Coerce
...
dgiDeploymentStyle =
  lens _dgiDeploymentStyle (\s a -> s {_dgiDeploymentStyle = a})

-- | Information about the automatic rollback configuration associated with the deployment group.
dgiAutoRollbackConfiguration ::
     Lens' DeploymentGroupInfo (Maybe AutoRollbackConfiguration)
dgiAutoRollbackConfiguration =
  lens
    _dgiAutoRollbackConfiguration
    (\s a -> s {_dgiAutoRollbackConfiguration = a})
...
instance FromJSON DeploymentGroupInfo where
  parseJSON =
    withObject
      "DeploymentGroupInfo"
      (\x ->
         DeploymentGroupInfo' <$> (x .:? "serviceRoleArn") <*>
         (x .:? "ec2TagSet") <*>
...
diPreviousRevision =
  lens _diPreviousRevision (\s a -> s {_diPreviousRevision = a})
...
diInstanceTerminationWaitTimeStarted =
  lens
    ...
    (\s a -> s {_diInstanceTerminationWaitTimeStarted = a})

-- | Messages that contain information about the status of a deployment.
diDeploymentStatusMessages :: Lens' DeploymentInfo [Text]
diDeploymentStatusMessages =
  lens _diDeploymentStatusMessages (\s a -> s {_diDeploymentStatusMessages = a}) .
  _Default . _Coerce
...
diCompleteTime =
  lens _diCompleteTime (\s a -> s {_diCompleteTime = a}) . mapping _Time

-- | Information about blue/green deployment options for this deployment.
diBlueGreenDeploymentConfiguration ::
     Lens' DeploymentInfo (Maybe BlueGreenDeploymentConfiguration)
diBlueGreenDeploymentConfiguration =
  lens
    _diBlueGreenDeploymentConfiguration
    (\s a -> s {_diBlueGreenDeploymentConfiguration = a})
...
diLoadBalancerInfo =
  lens _diLoadBalancerInfo (\s a -> s {_diLoadBalancerInfo = a})
...
diAdditionalDeploymentStatusInfo =
  lens
    ...
    (\s a -> s {_diAdditionalDeploymentStatusInfo = a})
...
diFileExistsBehavior =
  lens _diFileExistsBehavior (\s a -> s {_diFileExistsBehavior = a})
...
diCreateTime =
  lens _diCreateTime (\s a -> s {_diCreateTime = a}) . mapping _Time

-- | Information about the automatic rollback configuration associated with the deployment.
diAutoRollbackConfiguration ::
     Lens' DeploymentInfo (Maybe AutoRollbackConfiguration)
diAutoRollbackConfiguration =
  lens
    _diAutoRollbackConfiguration
    (\s a -> s {_diAutoRollbackConfiguration = a})
...
diUpdateOutdatedInstancesOnly =
  lens
    ...
    (\s a -> s {_diUpdateOutdatedInstancesOnly = a})
...
instance FromJSON DeploymentInfo where
  parseJSON =
    withObject
      "DeploymentInfo"
      (\x ->
         DeploymentInfo' <$> (x .:? "creator") <*> (x .:? "status") <*>
         (x .:? "deploymentId") <*>
         (x .:? "deploymentConfigName") <*>
         (x .:? "computePlatform") <*>
         (x .:? "previousRevision") <*>
...
instance FromJSON DeploymentOverview where
  parseJSON =
    withObject
      "DeploymentOverview"
      (\x ->
         DeploymentOverview' <$> (x .:? "Pending") <*> (x .:? "Skipped") <*>
         (x .:? "InProgress") <*>
         (x .:? "Succeeded") <*>
         (x .:? "Ready") <*>
         (x .:? "Failed"))
...
instance FromJSON DeploymentReadyOption where
  parseJSON =
    withObject
      "DeploymentReadyOption"
      (\x ->
         DeploymentReadyOption' <$> (x .:? "actionOnTimeout") <*>
         (x .:? "waitTimeInMinutes"))
...
dsDeploymentOption =
  lens _dsDeploymentOption (\s a -> s {_dsDeploymentOption = a})
...
instance FromJSON DeploymentStyle where
  parseJSON =
    withObject
      "DeploymentStyle"
      (\x ->
         DeploymentStyle' <$> (x .:? "deploymentOption") <*>
         (x .:? "deploymentType"))
...
instance FromJSON Diagnostics where
  parseJSON =
    withObject
      "Diagnostics"
      (\x ->
         Diagnostics' <$> (x .:? "logTail") <*> (x .:? "errorCode") <*>
         (x .:? "scriptName") <*>
         (x .:? "message"))
...
instance FromJSON EC2TagFilter where
  parseJSON =
    withObject
      "EC2TagFilter"
      (\x ->
         EC2TagFilter' <$> (x .:? "Value") <*> (x .:? "Key") <*> (x .:? "Type"))
...
etsEc2TagSetList =
  lens _etsEc2TagSetList (\s a -> s {_etsEc2TagSetList = a}) .
  _Default . _Coerce
...
instance FromJSON ELBInfo where
  parseJSON = withObject "ELBInfo" (\x -> ELBInfo' <$> (x .:? "name"))
...
instance ToJSON ELBInfo where
  toJSON ELBInfo' {..} = object (catMaybes [("name" .=) <$> _elbiName])
...
griRegisterTime =
  lens _griRegisterTime (\s a -> s {_griRegisterTime = a}) . mapping _Time

-- | When the revision was first used by AWS CodeDeploy.
griFirstUsedTime :: Lens' GenericRevisionInfo (Maybe UTCTime)
griFirstUsedTime =
  lens _griFirstUsedTime (\s a -> s {_griFirstUsedTime = a}) . mapping _Time
...
griLastUsedTime =
  lens _griLastUsedTime (\s a -> s {_griLastUsedTime = a}) . mapping _Time
...
instance FromJSON GenericRevisionInfo where
  parseJSON =
    withObject
      "GenericRevisionInfo"
      (\x ->
         GenericRevisionInfo' <$> (x .:? "registerTime") <*>
         (x .:? "firstUsedTime") <*>
...
instance FromJSON GitHubLocation where
  parseJSON =
    withObject
      "GitHubLocation"
      (\x -> GitHubLocation' <$> (x .:? "commitId") <*> (x .:? "repository"))
...
gfpoAction ::
     Lens' GreenFleetProvisioningOption (Maybe GreenFleetProvisioningAction)
...
iiRegisterTime =
  lens _iiRegisterTime (\s a -> s {_iiRegisterTime = a}) . mapping _Time
...
iiDeregisterTime =
  lens _iiDeregisterTime (\s a -> s {_iiDeregisterTime = a}) . mapping _Time
...
instance FromJSON InstanceInfo where
  parseJSON =
    withObject
      "InstanceInfo"
      (\x ->
         InstanceInfo' <$> (x .:? "registerTime") <*> (x .:? "instanceArn") <*>
         (x .:? "deregisterTime") <*>
         (x .:? "iamUserArn") <*>
         (x .:? "instanceName") <*>
         (x .:? "iamSessionArn") <*>
...
isLastUpdatedAt =
  lens _isLastUpdatedAt (\s a -> s {_isLastUpdatedAt = a}) . mapping _Time
...
instance FromJSON InstanceSummary where
  parseJSON =
    withObject
      "InstanceSummary"
      (\x ->
         InstanceSummary' <$> (x .:? "instanceId") <*> (x .:? "status") <*>
         (x .:? "deploymentId") <*>
         (x .:? "lastUpdatedAt") <*>
...
ldiCreateTime =
  lens _ldiCreateTime (\s a -> s {_ldiCreateTime = a}) . mapping _Time
...
instance FromJSON LastDeploymentInfo where
  parseJSON =
    withObject
      "LastDeploymentInfo"
      (\x ->
         LastDeploymentInfo' <$> (x .:? "status") <*> (x .:? "deploymentId") <*>
         (x .:? "endTime") <*>
         (x .:? "createTime"))
...
instance FromJSON LifecycleEvent where
  parseJSON =
    withObject
      "LifecycleEvent"
      (\x ->
         LifecycleEvent' <$> (x .:? "status") <*> (x .:? "lifecycleEventName") <*>
         (x .:? "startTime") <*>
         (x .:? "diagnostics") <*>
         (x .:? "endTime"))
...
lbiElbInfoList =
  lens _lbiElbInfoList (\s a -> s {_lbiElbInfoList = a}) . _Default . _Coerce
...
lbiTargetGroupInfoList =
  lens _lbiTargetGroupInfoList (\s a -> s {_lbiTargetGroupInfoList = a}) .
  _Default . _Coerce
...
instance FromJSON LoadBalancerInfo where
  parseJSON =
    withObject
      "LoadBalancerInfo"
      (\x ->
         LoadBalancerInfo' <$> (x .:? "elbInfoList" .!= mempty) <*>
...
instance FromJSON MinimumHealthyHosts where
  parseJSON =
    withObject
      "MinimumHealthyHosts"
      (\x -> MinimumHealthyHosts' <$> (x .:? "value") <*> (x .:? "type"))
...
instance ToJSON MinimumHealthyHosts where
  toJSON MinimumHealthyHosts' {..} =
    object (catMaybes [("value" .=) <$> _mhhValue, ("type" .=) <$> _mhhType])
...
optsOnPremisesTagSetList =
  lens _optsOnPremisesTagSetList (\s a -> s {_optsOnPremisesTagSetList = a}) .
  _Default . _Coerce
...
instance FromJSON OnPremisesTagSet where
  parseJSON =
    withObject
      "OnPremisesTagSet"
      (\x -> OnPremisesTagSet' <$> (x .:? "onPremisesTagSetList" .!= mempty))
...
instance ToJSON OnPremisesTagSet where
  toJSON OnPremisesTagSet' {..} =
    object
      (catMaybes [("onPremisesTagSetList" .=) <$> _optsOnPremisesTagSetList])
...
instance ToJSON RawString where
  toJSON RawString' {..} =
    object
      (catMaybes [("content" .=) <$> _rsContent, ("sha256" .=) <$> _rsSha256])
...
riGenericRevisionInfo =
  lens _riGenericRevisionInfo (\s a -> s {_riGenericRevisionInfo = a})

-- | Information about the location and type of an application revision.
riRevisionLocation :: Lens' RevisionInfo (Maybe RevisionLocation)
riRevisionLocation =
  lens _riRevisionLocation (\s a -> s {_riRevisionLocation = a})
...
instance FromJSON RevisionInfo where
  parseJSON =
    withObject
      "RevisionInfo"
      (\x ->
         RevisionInfo' <$> (x .:? "genericRevisionInfo") <*>
         (x .:? "revisionLocation"))
...
instance FromJSON RevisionLocation where
  parseJSON =
    withObject
      "RevisionLocation"
      (\x ->
         RevisionLocation' <$> (x .:? "string") <*> (x .:? "revisionType") <*>
         (x .:? "s3Location") <*>
         (x .:? "gitHubLocation"))
...
riRollbackTriggeringDeploymentId =
  lens
    ...
    (\s a -> s {_riRollbackTriggeringDeploymentId = a})
...
riRollbackDeploymentId =
  lens _riRollbackDeploymentId (\s a -> s {_riRollbackDeploymentId = a})
...
instance FromJSON RollbackInfo where
  parseJSON =
    withObject
      "RollbackInfo"
      (\x ->
         RollbackInfo' <$> (x .:? "rollbackTriggeringDeploymentId") <*>
         (x .:? "rollbackMessage") <*>
...
instance FromJSON S3Location where
  parseJSON =
    withObject
      "S3Location"
      (\x ->
         S3Location' <$> (x .:? "bundleType") <*> (x .:? "eTag") <*>
         (x .:? "bucket") <*>
         (x .:? "key") <*>
         (x .:? "version"))
...
instance FromJSON TagFilter where
  parseJSON =
    withObject
      "TagFilter"
      (\x -> TagFilter' <$> (x .:? "Value") <*> (x .:? "Key") <*> (x .:? "Type"))
...
instance FromJSON TargetGroupInfo where
  parseJSON =
    withObject "TargetGroupInfo" (\x -> TargetGroupInfo' <$> (x .:? "name"))
...
instance ToJSON TargetGroupInfo where
  toJSON TargetGroupInfo' {..} = object (catMaybes [("name" .=) <$> _tgiName])
...
tiTagFilters =
  lens _tiTagFilters (\s a -> s {_tiTagFilters = a}) . _Default . _Coerce

-- | The names of one or more Auto Scaling groups to identify a replacement environment for a blue/green deployment.
tiAutoScalingGroups :: Lens' TargetInstances [Text]
tiAutoScalingGroups =
  lens _tiAutoScalingGroups (\s a -> s {_tiAutoScalingGroups = a}) .
  _Default . _Coerce
...
tbcCanaryPercentage =
  lens _tbcCanaryPercentage (\s a -> s {_tbcCanaryPercentage = a})
...
instance FromJSON TimeBasedCanary where
  parseJSON =
    withObject
      "TimeBasedCanary"
      (\x ->
         TimeBasedCanary' <$> (x .:? "canaryInterval") <*>
         (x .:? "canaryPercentage"))
...
tblLinearPercentage =
  lens _tblLinearPercentage (\s a -> s {_tblLinearPercentage = a})
...
instance FromJSON TimeBasedLinear where
  parseJSON =
    withObject
      "TimeBasedLinear"
      (\x ->
         TimeBasedLinear' <$> (x .:? "linearInterval") <*>
         (x .:? "linearPercentage"))
...
instance ToJSON TimeRange where
  toJSON TimeRange' {..} =
    object (catMaybes [("start" .=) <$> _trStart, ("end" .=) <$> _trEnd])
...
trcTimeBasedCanary =
  lens _trcTimeBasedCanary (\s a -> s {_trcTimeBasedCanary = a})

-- | A configuration that shifts traffic from one version of a Lambda function to another in equal increments, with an equal number of minutes between each increment. The original and target Lambda function versions are specified in the deployment's AppSpec file.
trcTimeBasedLinear :: Lens' TrafficRoutingConfig (Maybe TimeBasedLinear)
trcTimeBasedLinear =
  lens _trcTimeBasedLinear (\s a -> s {_trcTimeBasedLinear = a})
...
instance FromJSON TrafficRoutingConfig where
  parseJSON =
    withObject
      "TrafficRoutingConfig"
      (\x ->
         TrafficRoutingConfig' <$> (x .:? "timeBasedCanary") <*>
         (x .:? "timeBasedLinear") <*>
         (x .:? "type"))
...
tcTriggerEvents =
  lens _tcTriggerEvents (\s a -> s {_tcTriggerEvents = a}) . _Default . _Coerce

-- | The ARN of the Amazon Simple Notification Service topic through which notifications about deployment or instance events are sent.
tcTriggerTargetARN :: Lens' TriggerConfig (Maybe Text)
tcTriggerTargetARN =
  lens _tcTriggerTargetARN (\s a -> s {_tcTriggerTargetARN = a})
