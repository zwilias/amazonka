...
cdFileExistsBehavior =
  lens _cdFileExistsBehavior (\s a -> s {_cdFileExistsBehavior = a})
...
cdAutoRollbackConfiguration ::
     Lens' CreateDeployment (Maybe AutoRollbackConfiguration)
cdAutoRollbackConfiguration =
  lens
    _cdAutoRollbackConfiguration
    (\s a -> s {_cdAutoRollbackConfiguration = a})
...
cdUpdateOutdatedInstancesOnly =
  lens
    ...
    (\s a -> s {_cdUpdateOutdatedInstancesOnly = a})
  ...
  toJSON CreateDeployment' {..} =
    object
      (catMaybes
         ...
         , ("updateOutdatedInstancesOnly" .=) <$> _cdUpdateOutdatedInstancesOnly
