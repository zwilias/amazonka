...
data CreateUserPoolDomain = CreateUserPoolDomain'{_cupdCustomDomainConfig
                                                  ::
                                                  !(Maybe
...
createUserPoolDomain pDomain_ pUserPoolId_
  = CreateUserPoolDomain'{_cupdCustomDomainConfig =
                            Nothing,
...
data CreateUserPoolDomainResponse = CreateUserPoolDomainResponse'{_cupdrsCloudFrontDomain
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _cupdrsResponseStatus
                                                                  :: !Int}
...
createUserPoolDomainResponse pResponseStatus_
  = CreateUserPoolDomainResponse'{_cupdrsCloudFrontDomain
                                    = Nothing,
