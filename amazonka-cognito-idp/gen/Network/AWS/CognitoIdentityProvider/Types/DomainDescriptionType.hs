...
data DomainDescriptionType = DomainDescriptionType'{_ddtStatus
                                                    ::
...
domainDescriptionType
    :: DomainDescriptionType
domainDescriptionType
  = DomainDescriptionType'{_ddtStatus = Nothing,
                           _ddtCloudFrontDistribution = Nothing,
                           _ddtUserPoolId = Nothing, _ddtDomain = Nothing,
                           _ddtAWSAccountId = Nothing,
                           _ddtCustomDomainConfig = Nothing,
                           _ddtVersion = Nothing, _ddtS3Bucket = Nothing}
