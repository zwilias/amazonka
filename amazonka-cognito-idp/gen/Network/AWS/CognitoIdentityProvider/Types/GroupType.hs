...
data GroupType = GroupType'{_gtLastModifiedDate ::
                            !(Maybe POSIX),
...
groupType
    :: GroupType
groupType
  = GroupType'{_gtLastModifiedDate = Nothing,
               _gtUserPoolId = Nothing, _gtCreationDate = Nothing,
               _gtPrecedence = Nothing, _gtGroupName = Nothing,
               _gtDescription = Nothing, _gtRoleARN = Nothing}
