...
data AccountTakeoverRiskConfigurationType = AccountTakeoverRiskConfigurationType'{_atrctNotifyConfiguration
                                                                                  ::
                                                                                  !(Maybe
...
accountTakeoverRiskConfigurationType pActions_
  = AccountTakeoverRiskConfigurationType'{_atrctNotifyConfiguration
                                            = Nothing,
