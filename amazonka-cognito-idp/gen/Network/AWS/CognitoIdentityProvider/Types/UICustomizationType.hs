...
data UICustomizationType = UICustomizationType'{_uictClientId
...
uICustomizationType
    :: UICustomizationType
uICustomizationType
  = UICustomizationType'{_uictClientId = Nothing,
                         _uictLastModifiedDate = Nothing,
                         _uictUserPoolId = Nothing, _uictCSS = Nothing,
                         _uictCSSVersion = Nothing, _uictImageURL = Nothing,
