...
data EventRiskType = EventRiskType'{_ertCompromisedCredentialsDetected
                                    :: !(Maybe Bool),
...
eventRiskType
    :: EventRiskType
eventRiskType
  = EventRiskType'{_ertCompromisedCredentialsDetected =
                     Nothing,
                   _ertRiskLevel = Nothing, _ertRiskDecision = Nothing}
