...
data AuthEventType = AuthEventType'{_aetEventRisk ::
                                    !(Maybe EventRiskType),
                                    _aetEventResponse ::
...
authEventType
    :: AuthEventType
authEventType
  = AuthEventType'{_aetEventRisk = Nothing,
                   _aetEventResponse = Nothing,
                   _aetEventContextData = Nothing,
                   _aetChallengeResponses = Nothing,
                   _aetEventType = Nothing, _aetCreationDate = Nothing,
                   _aetEventFeedback = Nothing, _aetEventId = Nothing}
