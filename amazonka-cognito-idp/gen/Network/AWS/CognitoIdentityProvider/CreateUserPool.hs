...
cupUserPoolTags =
  lens _cupUserPoolTags (\s a -> s {_cupUserPoolTags = a}) . _Default . _Map

-- | The template for the verification message that the user sees when the app requests permission to access the user's information.
cupVerificationMessageTemplate ::
     Lens' CreateUserPool (Maybe VerificationMessageTemplateType)
cupVerificationMessageTemplate =
  lens
    _cupVerificationMessageTemplate
    (\s a -> s {_cupVerificationMessageTemplate = a})
...
cupEmailVerificationMessage =
  lens
    ...
    (\s a -> s {_cupEmailVerificationMessage = a})
...
cupSmsAuthenticationMessage =
  lens
    ...
    (\s a -> s {_cupSmsAuthenticationMessage = a})
...
cupEmailVerificationSubject =
  lens
    ...
    (\s a -> s {_cupEmailVerificationSubject = a})

-- | Specifies whether email addresses or phone numbers can be specified as usernames when a user signs up.
cupUsernameAttributes :: Lens' CreateUserPool [UsernameAttributeType]
cupUsernameAttributes =
  lens _cupUsernameAttributes (\s a -> s {_cupUsernameAttributes = a}) .
  _Default . _Coerce
...
cupAliasAttributes =
  lens _cupAliasAttributes (\s a -> s {_cupAliasAttributes = a}) .
  _Default . _Coerce
...
cupEmailConfiguration =
  lens _cupEmailConfiguration (\s a -> s {_cupEmailConfiguration = a})

-- | A string representing the SMS verification message.
cupSmsVerificationMessage :: Lens' CreateUserPool (Maybe Text)
cupSmsVerificationMessage =
  lens _cupSmsVerificationMessage (\s a -> s {_cupSmsVerificationMessage = a})

-- | Specifies MFA configuration details.
cupMFAConfiguration :: Lens' CreateUserPool (Maybe UserPoolMFAType)
cupMFAConfiguration =
  lens _cupMFAConfiguration (\s a -> s {_cupMFAConfiguration = a})
...
cupSmsConfiguration =
  lens _cupSmsConfiguration (\s a -> s {_cupSmsConfiguration = a})

-- | The configuration for @AdminCreateUser@ requests.
cupAdminCreateUserConfig ::
     Lens' CreateUserPool (Maybe AdminCreateUserConfigType)
cupAdminCreateUserConfig =
  lens _cupAdminCreateUserConfig (\s a -> s {_cupAdminCreateUserConfig = a})

-- | The device configuration.
cupDeviceConfiguration :: Lens' CreateUserPool (Maybe DeviceConfigurationType)
cupDeviceConfiguration =
  lens _cupDeviceConfiguration (\s a -> s {_cupDeviceConfiguration = a})
...
cupAutoVerifiedAttributes =
  lens _cupAutoVerifiedAttributes (\s a -> s {_cupAutoVerifiedAttributes = a}) .
  _Default . _Coerce
...
instance AWSRequest CreateUserPool where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateUserPoolResponse' <$> (x .?> "UserPool") <*> (pure (fromEnum s)))
...
cuprsResponseStatus =
  lens _cuprsResponseStatus (\s a -> s {_cuprsResponseStatus = a})
