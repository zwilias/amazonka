...
instance AWSRequest GetTrailStatus where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetTrailStatusResponse' <$> (x .?> "TimeLoggingStopped") <*>
...
instance ToHeaders GetTrailStatus where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrailStatus" :: ByteString)
         , "Content-Type" =# ("application/x-amz-json-1.1" :: ByteString)
         ])

instance ToJSON GetTrailStatus where
  toJSON GetTrailStatus' {..} = object (catMaybes [Just ("Name" .= _gtsName)])
...
gtsrsTimeLoggingStopped =
  lens _gtsrsTimeLoggingStopped (\s a -> s {_gtsrsTimeLoggingStopped = a})
...
gtsrsLatestDeliveryError =
  lens _gtsrsLatestDeliveryError (\s a -> s {_gtsrsLatestDeliveryError = a})
...
gtsrsLatestDigestDeliveryTime =
  lens
    ...
    (\s a -> s {_gtsrsLatestDigestDeliveryTime = a}) .
  mapping _Time

-- | This field is deprecated.
gtsrsLatestNotificationAttemptSucceeded ::
     Lens' GetTrailStatusResponse (Maybe Text)
gtsrsLatestNotificationAttemptSucceeded =
  lens
    _gtsrsLatestNotificationAttemptSucceeded
    (\s a -> s {_gtsrsLatestNotificationAttemptSucceeded = a})
...
gtsrsLatestDeliveryAttemptSucceeded =
  lens
    ...
    (\s a -> s {_gtsrsLatestDeliveryAttemptSucceeded = a})
...
gtsrsTimeLoggingStarted =
  lens _gtsrsTimeLoggingStarted (\s a -> s {_gtsrsTimeLoggingStarted = a})
...
gtsrsLatestDigestDeliveryError =
  lens
    ...
    (\s a -> s {_gtsrsLatestDigestDeliveryError = a})
...
gtsrsLatestDeliveryAttemptTime =
  lens
    ...
    (\s a -> s {_gtsrsLatestDeliveryAttemptTime = a})

-- | Specifies the date and time that CloudTrail last delivered log files to an account's Amazon S3 bucket.
gtsrsLatestDeliveryTime :: Lens' GetTrailStatusResponse (Maybe UTCTime)
gtsrsLatestDeliveryTime =
  lens _gtsrsLatestDeliveryTime (\s a -> s {_gtsrsLatestDeliveryTime = a}) .
  mapping _Time

-- | Displays the most recent date and time when CloudTrail delivered logs to CloudWatch Logs.
gtsrsLatestCloudWatchLogsDeliveryTime ::
     Lens' GetTrailStatusResponse (Maybe UTCTime)
gtsrsLatestCloudWatchLogsDeliveryTime =
  lens
    _gtsrsLatestCloudWatchLogsDeliveryTime
    (\s a -> s {_gtsrsLatestCloudWatchLogsDeliveryTime = a}) .
  mapping _Time
...
gtsrsLatestCloudWatchLogsDeliveryError =
  lens
    ...
    (\s a -> s {_gtsrsLatestCloudWatchLogsDeliveryError = a})
...
gtsrsLatestNotificationAttemptTime =
  lens
    ...
    (\s a -> s {_gtsrsLatestNotificationAttemptTime = a})
