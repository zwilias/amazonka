...
instance AWSRequest DescribeDomainEndpointOptions
         where
...
instance Hashable DescribeDomainEndpointOptions where

instance NFData DescribeDomainEndpointOptions where

instance ToHeaders DescribeDomainEndpointOptions
         where
