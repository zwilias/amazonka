...
data DoubleOptions = DoubleOptions'{_dSourceField ::
                                    !(Maybe Text),
...
doubleOptions
    :: DoubleOptions
doubleOptions
  = DoubleOptions'{_dSourceField = Nothing,
                   _dReturnEnabled = Nothing, _dFacetEnabled = Nothing,
                   _dSearchEnabled = Nothing, _dSortEnabled = Nothing,
