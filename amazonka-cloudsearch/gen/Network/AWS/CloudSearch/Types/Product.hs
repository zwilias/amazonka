...
instance FromXML AccessPoliciesStatus where
  parseXML x = AccessPoliciesStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML AnalysisOptions where
  parseXML x =
    AnalysisOptions' <$> (x .@? "AlgorithmicStemming") <*> (x .@? "Stopwords") <*>
...
asAnalysisSchemeLanguage =
  lens _asAnalysisSchemeLanguage (\s a -> s {_asAnalysisSchemeLanguage = a})

instance FromXML AnalysisScheme where
  parseXML x =
    AnalysisScheme' <$> (x .@? "AnalysisOptions") <*>
...
instance FromXML AnalysisSchemeStatus where
  parseXML x = AnalysisSchemeStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML AvailabilityOptionsStatus where
  parseXML x =
    AvailabilityOptionsStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML DateArrayOptions where
  parseXML x =
    DateArrayOptions' <$> (x .@? "SourceFields") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML DateOptions where
  parseXML x =
    DateOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
...
dsoFuzzyMatching ::
     Lens' DocumentSuggesterOptions (Maybe SuggesterFuzzyMatching)
...
instance FromXML DocumentSuggesterOptions where
  parseXML x =
    DocumentSuggesterOptions' <$> (x .@? "SortExpression") <*>
    (x .@? "FuzzyMatching") <*>
    (x .@ "SourceField")
...
dsRequiresIndexDocuments =
  lens _dsRequiresIndexDocuments (\s a -> s {_dsRequiresIndexDocuments = a})

instance FromXML DomainStatus where
  parseXML x =
    DomainStatus' <$> (x .@? "SearchInstanceCount") <*>
...
instance FromXML DoubleArrayOptions where
  parseXML x =
    DoubleArrayOptions' <$> (x .@? "SourceFields") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML DoubleOptions where
  parseXML x =
    DoubleOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML Expression where
  parseXML x =
    Expression' <$> (x .@ "ExpressionName") <*> (x .@ "ExpressionValue")
...
instance FromXML ExpressionStatus where
  parseXML x = ExpressionStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML IndexField where
  parseXML x =
    IndexField' <$> (x .@? "DoubleArrayOptions") <*> (x .@? "DateOptions") <*>
    (x .@? "TextArrayOptions") <*>
    (x .@? "DoubleOptions") <*>
    (x .@? "TextOptions") <*>
    (x .@? "LatLonOptions") <*>
...
instance FromXML IndexFieldStatus where
  parseXML x = IndexFieldStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML IntArrayOptions where
  parseXML x =
    IntArrayOptions' <$> (x .@? "SourceFields") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML IntOptions where
  parseXML x =
    IntOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML LatLonOptions where
  parseXML x =
    LatLonOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
...
lMaximumReplicationCount =
  lens _lMaximumReplicationCount (\s a -> s {_lMaximumReplicationCount = a}) .
  _Nat

-- | Undocumented member.
lMaximumPartitionCount :: Lens' Limits Natural
lMaximumPartitionCount =
  lens _lMaximumPartitionCount (\s a -> s {_lMaximumPartitionCount = a}) . _Nat

instance FromXML Limits where
  parseXML x =
    Limits' <$> (x .@ "MaximumReplicationCount") <*>
...
instance FromXML LiteralArrayOptions where
  parseXML x =
    LiteralArrayOptions' <$> (x .@? "SourceFields") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML LiteralOptions where
  parseXML x =
    LiteralOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "FacetEnabled") <*>
    (x .@? "SearchEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML OptionStatus where
  parseXML x =
    OptionStatus' <$> (x .@? "PendingDeletion") <*> (x .@? "UpdateVersion") <*>
    (x .@ "CreationDate") <*>
    (x .@ "UpdateDate") <*>
    (x .@ "State")
...
spDesiredReplicationCount =
  lens _spDesiredReplicationCount (\s a -> s {_spDesiredReplicationCount = a}) .
  mapping _Nat
...
instance FromXML ScalingParameters where
  parseXML x =
    ScalingParameters' <$> (x .@? "DesiredInstanceType") <*>
...
instance FromXML ScalingParametersStatus where
  parseXML x = ScalingParametersStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
sDocumentSuggesterOptions =
  lens _sDocumentSuggesterOptions (\s a -> s {_sDocumentSuggesterOptions = a})

instance FromXML Suggester where
  parseXML x =
    Suggester' <$> (x .@ "SuggesterName") <*> (x .@ "DocumentSuggesterOptions")
...
instance FromXML SuggesterStatus where
  parseXML x = SuggesterStatus' <$> (x .@ "Options") <*> (x .@ "Status")
...
instance FromXML TextArrayOptions where
  parseXML x =
    TextArrayOptions' <$> (x .@? "SourceFields") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "AnalysisScheme") <*>
    (x .@? "HighlightEnabled") <*>
    (x .@? "DefaultValue")
...
instance FromXML TextOptions where
  parseXML x =
    TextOptions' <$> (x .@? "SourceField") <*> (x .@? "ReturnEnabled") <*>
    (x .@? "AnalysisScheme") <*>
    (x .@? "HighlightEnabled") <*>
    (x .@? "SortEnabled") <*>
    (x .@? "DefaultValue")
