...
instance AWSRequest UpdateServiceAccessPolicies where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         UpdateServiceAccessPoliciesResponse' <$> (pure (fromEnum s)) <*>
         (x .@ "AccessPolicies"))
...
usaprsResponseStatus =
  lens _usaprsResponseStatus (\s a -> s {_usaprsResponseStatus = a})

-- | The access rules configured for the domain.
usaprsAccessPolicies ::
     Lens' UpdateServiceAccessPoliciesResponse AccessPoliciesStatus
usaprsAccessPolicies =
