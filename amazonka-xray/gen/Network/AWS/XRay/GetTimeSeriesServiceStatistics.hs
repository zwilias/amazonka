...
--
-- * 'gtsssGroupARN' - The ARN of the group for which to pull statistics from.
--
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gtsssrsContainsOldGroupVersions' - A flag indicating whether or not a group's filter expression has been consistent, or if a returned aggregation may show statistics from an older version of the group's filter expression.
--
