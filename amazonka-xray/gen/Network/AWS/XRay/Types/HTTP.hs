...
data HTTP = HTTP'{_httpHTTPMethod :: !(Maybe Text),
...
hTTP
    :: HTTP
hTTP
  = HTTP'{_httpHTTPMethod = Nothing,
          _httpHTTPStatus = Nothing, _httpClientIP = Nothing,
          _httpUserAgent = Nothing, _httpHTTPURL = Nothing}
