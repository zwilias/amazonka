...
data ErrorRootCauseService = ErrorRootCauseService'{_ercsEntityPath
                                                    ::
                                                    !(Maybe
...
errorRootCauseService
    :: ErrorRootCauseService
errorRootCauseService
  = ErrorRootCauseService'{_ercsEntityPath = Nothing,
                           _ercsAccountId = Nothing, _ercsNames = Nothing,
                           _ercsName = Nothing, _ercsInferred = Nothing,
                           _ercsType = Nothing}
