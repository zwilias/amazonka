...
data FaultRootCauseService = FaultRootCauseService'{_frcsEntityPath
                                                    ::
                                                    !(Maybe
...
faultRootCauseService
    :: FaultRootCauseService
faultRootCauseService
  = FaultRootCauseService'{_frcsEntityPath = Nothing,
                           _frcsAccountId = Nothing, _frcsNames = Nothing,
                           _frcsName = Nothing, _frcsInferred = Nothing,
                           _frcsType = Nothing}
