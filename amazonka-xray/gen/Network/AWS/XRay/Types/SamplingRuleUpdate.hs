...
data SamplingRuleUpdate = SamplingRuleUpdate'{_sruHTTPMethod
                                              :: !(Maybe Text),
...
samplingRuleUpdate
    :: SamplingRuleUpdate
samplingRuleUpdate
  = SamplingRuleUpdate'{_sruHTTPMethod = Nothing,
                        _sruPriority = Nothing, _sruRuleName = Nothing,
                        _sruReservoirSize = Nothing, _sruFixedRate = Nothing,
                        _sruResourceARN = Nothing, _sruAttributes = Nothing,
                        _sruServiceName = Nothing, _sruServiceType = Nothing,
                        _sruHost = Nothing, _sruRuleARN = Nothing,
                        _sruURLPath = Nothing}
