...
data ResponseTimeRootCauseService = ResponseTimeRootCauseService'{_rtrcsEntityPath
                                                                  ::
                                                                  !(Maybe
...
responseTimeRootCauseService
    :: ResponseTimeRootCauseService
responseTimeRootCauseService
  = ResponseTimeRootCauseService'{_rtrcsEntityPath =
                                    Nothing,
                                  _rtrcsAccountId = Nothing,
                                  _rtrcsNames = Nothing, _rtrcsName = Nothing,
