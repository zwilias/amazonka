...
data SamplingRule = SamplingRule'{_srRuleName ::
                                  !(Maybe Text),
                                  _srAttributes :: !(Maybe (Map Text Text)),
                                  _srRuleARN :: !(Maybe Text),
                                  _srResourceARN :: !Text, _srPriority :: !Nat,
                                  _srFixedRate :: !Double,
                                  _srReservoirSize :: !Nat,
                                  _srServiceName :: !Text,
                                  _srServiceType :: !Text, _srHost :: !Text,
                                  _srHTTPMethod :: !Text, _srURLPath :: !Text,
                                  _srVersion :: !Nat}
...
samplingRule
    ...
    -> Natural -- ^ 'srVersion'
    -> SamplingRule
samplingRule pResourceARN_ pPriority_ pFixedRate_
  pReservoirSize_ pServiceName_ pServiceType_ pHost_
  pHTTPMethod_ pURLPath_ pVersion_
  = SamplingRule'{_srRuleName = Nothing,
                  _srAttributes = Nothing, _srRuleARN = Nothing,
                  ...
                  _srServiceType = pServiceType_, _srHost = pHost_,
                  _srHTTPMethod = pHTTPMethod_, _srURLPath = pURLPath_,
