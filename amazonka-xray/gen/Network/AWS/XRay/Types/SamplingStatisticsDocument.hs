...
data SamplingStatisticsDocument = SamplingStatisticsDocument'{_ssdBorrowCount
                                                              :: !(Maybe Nat),
                                                              _ssdRuleName ::
                                                              !Text,
                                                              _ssdClientId ::
...
samplingStatisticsDocument
    ...
    -> SamplingStatisticsDocument
samplingStatisticsDocument pRuleName_ pClientId_
  pTimestamp_ pRequestCount_ pSampledCount_
  = SamplingStatisticsDocument'{_ssdBorrowCount =
                                  Nothing,
