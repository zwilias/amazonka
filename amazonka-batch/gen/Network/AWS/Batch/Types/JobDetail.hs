...
jobDetail pJobName_ pJobId_ pJobQueue_ pStatus_
  ...
  = JobDetail'{_jdStoppedAt = Nothing,
               ...
               _jdAttempts = Nothing, _jdStartedAt = Nothing,
               _jdDependsOn = Nothing, _jdContainer = Nothing,
               _jdNodeDetails = Nothing, _jdParameters = Nothing,
               _jdStatusReason = Nothing,
               _jdArrayProperties = Nothing, _jdTimeout = Nothing,
               _jdNodeProperties = Nothing, _jdJobName = pJobName_,
               _jdJobId = pJobId_, _jdJobQueue = pJobQueue_,
               _jdStatus = pStatus_,
