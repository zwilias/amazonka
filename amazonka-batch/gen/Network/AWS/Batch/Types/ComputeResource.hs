...
data ComputeResource = ComputeResource'{_crSecurityGroupIds
                                        ...
                                        _crType :: !CRType, _crMinvCPUs :: !Int,
                                        _crMaxvCPUs :: !Int,
...
--
-- * 'crTags' - Key-value pair tags to be applied to resources that are launched in the compute environment. For AWS Batch, these take the form of "String1": "String2", where String1 is the tag key and String2 is the tag value—for example, { "Name": "AWS Batch Instance - C4OnDemand" }.
--
...
computeResource
    ...
    -> Text -- ^ 'crInstanceRole'
    -> ComputeResource
computeResource pType_ pMinvCPUs_ pMaxvCPUs_
  pInstanceRole_
  = ComputeResource'{_crSecurityGroupIds = Nothing,
                     _crEc2KeyPair = Nothing, _crBidPercentage = Nothing,
                     ...
                     _crType = pType_, _crMinvCPUs = pMinvCPUs_,
                     _crMaxvCPUs = pMaxvCPUs_, _crInstanceTypes = mempty,
                     _crSubnets = mempty,
