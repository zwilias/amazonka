...
instance FromJSON AttemptContainerDetail where
  parseJSON =
    withObject
      "AttemptContainerDetail"
      (\x ->
         AttemptContainerDetail' <$> (x .:? "taskArn") <*>
...
instance FromJSON AttemptDetail where
  parseJSON =
    withObject
      "AttemptDetail"
      (\x ->
         AttemptDetail' <$> (x .:? "stoppedAt") <*> (x .:? "startedAt") <*>
         (x .:? "container") <*>
         (x .:? "statusReason"))
...
instance FromJSON ComputeEnvironmentDetail where
  parseJSON =
    withObject
      "ComputeEnvironmentDetail"
      (\x ->
         ComputeEnvironmentDetail' <$> (x .:? "status") <*> (x .:? "state") <*>
         (x .:? "computeResources") <*>
         (x .:? "statusReason") <*>
         (x .:? "type") <*>
         (x .:? "serviceRole") <*>
...
instance FromJSON ComputeEnvironmentOrder where
  parseJSON =
    withObject
      "ComputeEnvironmentOrder"
      (\x ->
         ComputeEnvironmentOrder' <$> (x .: "order") <*>
...
instance FromJSON ComputeResource where
  parseJSON =
    withObject
      "ComputeResource"
      (\x ->
         ComputeResource' <$> (x .:? "ec2KeyPair") <*> (x .:? "bidPercentage") <*>
         (x .:? "spotIamFleetRole") <*>
         (x .:? "imageId") <*>
         (x .:? "desiredvCpus") <*>
         (x .:? "tags" .!= mempty) <*>
...
instance FromJSON ContainerDetail where
  parseJSON =
    withObject
      "ContainerDetail"
      (\x ->
         ContainerDetail' <$> (x .:? "image") <*> (x .:? "command" .!= mempty) <*>
...
instance FromJSON ContainerProperties where
  parseJSON =
    withObject
      "ContainerProperties"
      (\x ->
         ContainerProperties' <$> (x .:? "command" .!= mempty) <*>
         (x .:? "environment" .!= mempty) <*>
         (x .:? "ulimits" .!= mempty) <*>
         (x .:? "privileged") <*>
         (x .:? "jobRoleArn") <*>
...
instance FromJSON JobDefinition where
  parseJSON =
    withObject
      "JobDefinition"
      (\x ->
         JobDefinition' <$> (x .:? "status") <*> (x .:? "retryStrategy") <*>
         (x .:? "parameters" .!= mempty) <*>
         (x .:? "timeout") <*>
...
instance FromJSON JobDetail where
  parseJSON =
    withObject
      "JobDetail"
      (\x ->
         JobDetail' <$> (x .:? "stoppedAt") <*> (x .:? "createdAt") <*>
         (x .:? "retryStrategy") <*>
         (x .:? "attempts" .!= mempty) <*>
         (x .:? "dependsOn" .!= mempty) <*>
         (x .:? "container") <*>
...
jqdComputeEnvironmentOrder =
  lens _jqdComputeEnvironmentOrder (\s a -> s {_jqdComputeEnvironmentOrder = a}) .
  _Coerce
...
instance FromJSON JobQueueDetail where
  parseJSON =
    withObject
      "JobQueueDetail"
      (\x ->
         JobQueueDetail' <$> (x .:? "status") <*> (x .:? "statusReason") <*>
         (x .: "jobQueueName") <*>
         (x .: "jobQueueArn") <*>
         (x .: "state") <*>
         (x .: "priority") <*>
...
instance FromJSON JobSummary where
  parseJSON =
    withObject
      "JobSummary"
      (\x ->
         JobSummary' <$> (x .:? "stoppedAt") <*> (x .:? "status") <*>
         (x .:? "createdAt") <*>
         (x .:? "startedAt") <*>
         (x .:? "container") <*>
         (x .:? "statusReason") <*>
