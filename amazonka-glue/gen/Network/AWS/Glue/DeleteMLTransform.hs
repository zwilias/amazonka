...
newtype DeleteMLTransform = DeleteMLTransform'{_dmltTransformId
                                               :: Text}
...
deleteMLTransform
    :: Text -- ^ 'dmltTransformId'
    -> DeleteMLTransform
deleteMLTransform pTransformId_
  = DeleteMLTransform'{_dmltTransformId =
                         pTransformId_}
...
instance Hashable DeleteMLTransform where

instance NFData DeleteMLTransform where
...
data DeleteMLTransformResponse = DeleteMLTransformResponse'{_dmltrsTransformId
                                                            :: !(Maybe Text),
                                                            _dmltrsResponseStatus
                                                            :: !Int}
...
deleteMLTransformResponse
    :: Int -- ^ 'dmltrsResponseStatus'
    -> DeleteMLTransformResponse
deleteMLTransformResponse pResponseStatus_
  = DeleteMLTransformResponse'{_dmltrsTransformId =
                                 Nothing,
...
instance NFData DeleteMLTransformResponse where
