...
newtype BatchGetDevEndpoints = BatchGetDevEndpoints'{_bgdeDevEndpointNames
                                                     :: List1 Text}
...
batchGetDevEndpoints
    :: NonEmpty Text -- ^ 'bgdeDevEndpointNames'
    -> BatchGetDevEndpoints
batchGetDevEndpoints pDevEndpointNames_
  = BatchGetDevEndpoints'{_bgdeDevEndpointNames =
...
instance Hashable BatchGetDevEndpoints where

instance NFData BatchGetDevEndpoints where
...
data BatchGetDevEndpointsResponse = BatchGetDevEndpointsResponse'{_bgdersDevEndpointsNotFound
                                                                  ::
                                                                  !(Maybe
                                                                      (List1
                                                                         Text)),
...
batchGetDevEndpointsResponse
    :: Int -- ^ 'bgdersResponseStatus'
    -> BatchGetDevEndpointsResponse
batchGetDevEndpointsResponse pResponseStatus_
  = BatchGetDevEndpointsResponse'{_bgdersDevEndpointsNotFound
                                    = Nothing,
...
instance NFData BatchGetDevEndpointsResponse where
