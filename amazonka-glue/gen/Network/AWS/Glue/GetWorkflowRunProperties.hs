...
data GetWorkflowRunProperties = GetWorkflowRunProperties'{_gwrpName
                                                          :: !Text,
                                                          _gwrpRunId :: !Text}
...
getWorkflowRunProperties pName_ pRunId_
  = GetWorkflowRunProperties'{_gwrpName = pName_,
                              _gwrpRunId = pRunId_}
...
instance AWSRequest GetWorkflowRunProperties where
        type Rs GetWorkflowRunProperties =
             GetWorkflowRunPropertiesResponse
...
instance Hashable GetWorkflowRunProperties where

instance NFData GetWorkflowRunProperties where
...
data GetWorkflowRunPropertiesResponse = GetWorkflowRunPropertiesResponse'{_gwrprsRunProperties
                                                                          ::
                                                                          !(Maybe
                                                                              (Map
                                                                                 Text
...
getWorkflowRunPropertiesResponse
    :: Int -- ^ 'gwrprsResponseStatus'
    -> GetWorkflowRunPropertiesResponse
getWorkflowRunPropertiesResponse pResponseStatus_
  = GetWorkflowRunPropertiesResponse'{_gwrprsRunProperties
                                        = Nothing,
