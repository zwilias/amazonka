...
newtype GetSecurityConfiguration = GetSecurityConfiguration'{_gscName
                                                             :: Text}
...
data GetSecurityConfigurationResponse = GetSecurityConfigurationResponse'{_gscrsSecurityConfiguration
                                                                          ::
                                                                          !(Maybe
...
getSecurityConfigurationResponse pResponseStatus_
  = GetSecurityConfigurationResponse'{_gscrsSecurityConfiguration
                                        = Nothing,
