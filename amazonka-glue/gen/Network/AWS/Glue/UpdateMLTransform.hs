...
data UpdateMLTransform = UpdateMLTransform'{_umltNumberOfWorkers
                                            :: !(Maybe Int),
                                            _umltWorkerType ::
                                            !(Maybe WorkerType),
...
updateMLTransform
    :: Text -- ^ 'umltTransformId'
    -> UpdateMLTransform
updateMLTransform pTransformId_
  = UpdateMLTransform'{_umltNumberOfWorkers = Nothing,
                       _umltWorkerType = Nothing,
                       _umltGlueVersion = Nothing, _umltRole = Nothing,
                       _umltName = Nothing, _umltParameters = Nothing,
                       _umltMaxRetries = Nothing,
                       _umltMaxCapacity = Nothing, _umltTimeout = Nothing,
...
instance Hashable UpdateMLTransform where

instance NFData UpdateMLTransform where
...
data UpdateMLTransformResponse = UpdateMLTransformResponse'{_umltrsTransformId
                                                            :: !(Maybe Text),
                                                            _umltrsResponseStatus
                                                            :: !Int}
...
updateMLTransformResponse
    :: Int -- ^ 'umltrsResponseStatus'
    -> UpdateMLTransformResponse
updateMLTransformResponse pResponseStatus_
  = UpdateMLTransformResponse'{_umltrsTransformId =
                                 Nothing,
...
instance NFData UpdateMLTransformResponse where
