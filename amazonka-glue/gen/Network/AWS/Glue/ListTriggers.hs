...
data ListTriggers = ListTriggers'{_ltNextToken ::
                                  !(Maybe Text),
...
listTriggers
    :: ListTriggers
listTriggers
  = ListTriggers'{_ltNextToken = Nothing,
                  _ltMaxResults = Nothing, _ltTags = Nothing,
...
instance Hashable ListTriggers where

instance NFData ListTriggers where
...
data ListTriggersResponse = ListTriggersResponse'{_ltrsTriggerNames
                                                  :: !(Maybe [Text]),
                                                  _ltrsNextToken ::
                                                  !(Maybe Text),
...
listTriggersResponse pResponseStatus_
  = ListTriggersResponse'{_ltrsTriggerNames = Nothing,
...
instance NFData ListTriggersResponse where
