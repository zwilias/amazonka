...
data GetWorkflowRuns = GetWorkflowRuns'{_gwrIncludeGraph
                                        :: !(Maybe Bool),
...
getWorkflowRuns pName_
  = GetWorkflowRuns'{_gwrIncludeGraph = Nothing,
                     _gwrNextToken = Nothing, _gwrMaxResults = Nothing,
                     _gwrName = pName_}
...
instance Hashable GetWorkflowRuns where

instance NFData GetWorkflowRuns where
...
data GetWorkflowRunsResponse = GetWorkflowRunsResponse'{_gwrrsRuns
                                                        ::
                                                        !(Maybe
                                                            (List1
                                                               WorkflowRun)),
...
getWorkflowRunsResponse
    :: Int -- ^ 'gwrrsResponseStatus'
    -> GetWorkflowRunsResponse
getWorkflowRunsResponse pResponseStatus_
  = GetWorkflowRunsResponse'{_gwrrsRuns = Nothing,
...
instance NFData GetWorkflowRunsResponse where
