...
data StartExportLabelsTaskRun = StartExportLabelsTaskRun'{_seltrTransformId
                                                          :: !Text,
                                                          _seltrOutputS3Path ::
                                                          !Text}
...
startExportLabelsTaskRun
    :: Text -- ^ 'seltrTransformId'
    -> Text -- ^ 'seltrOutputS3Path'
    -> StartExportLabelsTaskRun
startExportLabelsTaskRun pTransformId_ pOutputS3Path_
  = StartExportLabelsTaskRun'{_seltrTransformId =
                                pTransformId_,
...
instance AWSRequest StartExportLabelsTaskRun where
        type Rs StartExportLabelsTaskRun =
             StartExportLabelsTaskRunResponse
...
instance Hashable StartExportLabelsTaskRun where

instance NFData StartExportLabelsTaskRun where
...
data StartExportLabelsTaskRunResponse = StartExportLabelsTaskRunResponse'{_seltrrsTaskRunId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
startExportLabelsTaskRunResponse
    :: Int -- ^ 'seltrrsResponseStatus'
    -> StartExportLabelsTaskRunResponse
startExportLabelsTaskRunResponse pResponseStatus_
  = StartExportLabelsTaskRunResponse'{_seltrrsTaskRunId
                                        = Nothing,
