...
data GetMLTransforms = GetMLTransforms'{_gmltNextToken
                                        :: !(Maybe Text),
                                        _gmltSort ::
...
getMLTransforms
    :: GetMLTransforms
getMLTransforms
  = GetMLTransforms'{_gmltNextToken = Nothing,
                     _gmltSort = Nothing, _gmltFilter = Nothing,
...
instance Hashable GetMLTransforms where

instance NFData GetMLTransforms where
...
data GetMLTransformsResponse = GetMLTransformsResponse'{_gmltsrsNextToken
                                                        :: !(Maybe Text),
                                                        _gmltsrsResponseStatus
                                                        :: !Int,
                                                        _gmltsrsTransforms ::
                                                        ![MLTransform]}
...
getMLTransformsResponse
    :: Int -- ^ 'gmltsrsResponseStatus'
    -> GetMLTransformsResponse
getMLTransformsResponse pResponseStatus_
  = GetMLTransformsResponse'{_gmltsrsNextToken =
                               Nothing,
...
instance NFData GetMLTransformsResponse where
