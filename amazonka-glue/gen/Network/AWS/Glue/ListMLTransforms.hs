...
data ListMLTransforms = ListMLTransforms'{_lmltNextToken
                                          :: !(Maybe Text),
                                          _lmltSort ::
...
listMLTransforms
    :: ListMLTransforms
listMLTransforms
  = ListMLTransforms'{_lmltNextToken = Nothing,
                      _lmltSort = Nothing, _lmltFilter = Nothing,
                      _lmltMaxResults = Nothing, _lmltTags = Nothing}
...
instance Hashable ListMLTransforms where

instance NFData ListMLTransforms where
...
data ListMLTransformsResponse = ListMLTransformsResponse'{_lmltrsNextToken
                                                          :: !(Maybe Text),
                                                          _lmltrsResponseStatus
                                                          :: !Int,
                                                          _lmltrsTransformIds ::
                                                          ![Text]}
...
listMLTransformsResponse
    :: Int -- ^ 'lmltrsResponseStatus'
    -> ListMLTransformsResponse
listMLTransformsResponse pResponseStatus_
  = ListMLTransformsResponse'{_lmltrsNextToken =
                                Nothing,
...
instance NFData ListMLTransformsResponse where
