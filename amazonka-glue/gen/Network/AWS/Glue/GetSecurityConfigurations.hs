...
data GetSecurityConfigurations = GetSecurityConfigurations'{_gscNextToken
                                                            :: !(Maybe Text),
                                                            _gscMaxResults ::
                                                            !(Maybe Nat)}
...
getSecurityConfigurations
    :: GetSecurityConfigurations
getSecurityConfigurations
  = GetSecurityConfigurations'{_gscNextToken = Nothing,
...
data GetSecurityConfigurationsResponse = GetSecurityConfigurationsResponse'{_gscsrsSecurityConfigurations
                                                                            ::
                                                                            !(Maybe
...
getSecurityConfigurationsResponse pResponseStatus_
  = GetSecurityConfigurationsResponse'{_gscsrsSecurityConfigurations
                                         = Nothing,
