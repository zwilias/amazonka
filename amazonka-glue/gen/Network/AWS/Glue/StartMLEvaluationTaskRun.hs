...
newtype StartMLEvaluationTaskRun = StartMLEvaluationTaskRun'{_smletrTransformId
                                                             :: Text}
...
startMLEvaluationTaskRun
    :: Text -- ^ 'smletrTransformId'
    -> StartMLEvaluationTaskRun
startMLEvaluationTaskRun pTransformId_
  = StartMLEvaluationTaskRun'{_smletrTransformId =
                                pTransformId_}
...
instance AWSRequest StartMLEvaluationTaskRun where
        type Rs StartMLEvaluationTaskRun =
             StartMLEvaluationTaskRunResponse
...
instance Hashable StartMLEvaluationTaskRun where

instance NFData StartMLEvaluationTaskRun where
...
data StartMLEvaluationTaskRunResponse = StartMLEvaluationTaskRunResponse'{_smletrrsTaskRunId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
startMLEvaluationTaskRunResponse
    :: Int -- ^ 'smletrrsResponseStatus'
    -> StartMLEvaluationTaskRunResponse
startMLEvaluationTaskRunResponse pResponseStatus_
  = StartMLEvaluationTaskRunResponse'{_smletrrsTaskRunId
                                        = Nothing,
                                      _smletrrsResponseStatus =
                                        pResponseStatus_}
