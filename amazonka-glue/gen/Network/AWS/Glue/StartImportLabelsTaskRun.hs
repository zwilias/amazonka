...
data StartImportLabelsTaskRun = StartImportLabelsTaskRun'{_siltrReplaceAllLabels
                                                          :: !(Maybe Bool),
                                                          _siltrTransformId ::
                                                          !Text,
                                                          _siltrInputS3Path ::
...
startImportLabelsTaskRun
    :: Text -- ^ 'siltrTransformId'
    -> Text -- ^ 'siltrInputS3Path'
    -> StartImportLabelsTaskRun
startImportLabelsTaskRun pTransformId_ pInputS3Path_
  = StartImportLabelsTaskRun'{_siltrReplaceAllLabels =
                                Nothing,
...
instance AWSRequest StartImportLabelsTaskRun where
        type Rs StartImportLabelsTaskRun =
             StartImportLabelsTaskRunResponse
...
instance Hashable StartImportLabelsTaskRun where

instance NFData StartImportLabelsTaskRun where
...
data StartImportLabelsTaskRunResponse = StartImportLabelsTaskRunResponse'{_siltrrsTaskRunId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
startImportLabelsTaskRunResponse
    :: Int -- ^ 'siltrrsResponseStatus'
    -> StartImportLabelsTaskRunResponse
startImportLabelsTaskRunResponse pResponseStatus_
  = StartImportLabelsTaskRunResponse'{_siltrrsTaskRunId
                                        = Nothing,
