...
data CreateWorkflow = CreateWorkflow'{_cwDefaultRunProperties
                                      :: !(Maybe (Map Text Text)),
...
createWorkflow pName_
  = CreateWorkflow'{_cwDefaultRunProperties = Nothing,
                    _cwDescription = Nothing, _cwTags = Nothing,
                    _cwName = pName_}
...
instance Hashable CreateWorkflow where

instance NFData CreateWorkflow where
          ...
          = object
              (catMaybes
                 [("DefaultRunProperties" .=) <$>
                  ...
                  ("Tags" .=) <$> _cwTags, Just ("Name" .= _cwName)])
...
data CreateWorkflowResponse = CreateWorkflowResponse'{_cwrsName
                                                      :: !(Maybe Text),
                                                      _cwrsResponseStatus ::
                                                      !Int}
...
createWorkflowResponse pResponseStatus_
  = CreateWorkflowResponse'{_cwrsName = Nothing,
...
instance NFData CreateWorkflowResponse where
