...
data ListDevEndpoints = ListDevEndpoints'{_ldeNextToken
                                          :: !(Maybe Text),
...
listDevEndpoints
    :: ListDevEndpoints
listDevEndpoints
  = ListDevEndpoints'{_ldeNextToken = Nothing,
                      _ldeMaxResults = Nothing, _ldeTags = Nothing}
...
instance Hashable ListDevEndpoints where

instance NFData ListDevEndpoints where
...
data ListDevEndpointsResponse = ListDevEndpointsResponse'{_ldersNextToken
                                                          :: !(Maybe Text),
                                                          _ldersDevEndpointNames
                                                          :: !(Maybe [Text]),
...
listDevEndpointsResponse pResponseStatus_
  = ListDevEndpointsResponse'{_ldersNextToken =
                                Nothing,
...
instance NFData ListDevEndpointsResponse where
