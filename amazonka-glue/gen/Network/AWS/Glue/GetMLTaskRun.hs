...
data GetMLTaskRun = GetMLTaskRun'{_gTransformId ::
                                  !Text,
                                  _gTaskRunId :: !Text}
...
getMLTaskRun pTransformId_ pTaskRunId_
  = GetMLTaskRun'{_gTransformId = pTransformId_,
...
instance Hashable GetMLTaskRun where

instance NFData GetMLTaskRun where
...
data GetMLTaskRunResponse = GetMLTaskRunResponse'{_gmltrrsCompletedOn
                                                  :: !(Maybe POSIX),
                                                  _gmltrrsStatus ::
                                                  !(Maybe TaskStatusType),
                                                  _gmltrrsLastModifiedOn ::
                                                  !(Maybe POSIX),
                                                  _gmltrrsErrorString ::
                                                  !(Maybe Text),
                                                  _gmltrrsStartedOn ::
                                                  !(Maybe POSIX),
                                                  _gmltrrsLogGroupName ::
                                                  !(Maybe Text),
                                                  _gmltrrsExecutionTime ::
                                                  !(Maybe Int),
                                                  _gmltrrsProperties ::
...
getMLTaskRunResponse
    :: Int -- ^ 'gmltrrsResponseStatus'
    -> GetMLTaskRunResponse
getMLTaskRunResponse pResponseStatus_
  = GetMLTaskRunResponse'{_gmltrrsCompletedOn =
                            Nothing,
...
instance NFData GetMLTaskRunResponse where
