...
data CancelMLTaskRun = CancelMLTaskRun'{_cmltrTransformId
                                        :: !Text,
...
cancelMLTaskRun
    :: Text -- ^ 'cmltrTransformId'
    -> Text -- ^ 'cmltrTaskRunId'
    -> CancelMLTaskRun
cancelMLTaskRun pTransformId_ pTaskRunId_
  = CancelMLTaskRun'{_cmltrTransformId = pTransformId_,
...
instance AWSRequest CancelMLTaskRun where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CancelMLTaskRunResponse' <$>
                   (x .?> "Status") <*> (x .?> "TransformId") <*>
                     (x .?> "TaskRunId")
                     <*> (pure (fromEnum s)))

instance Hashable CancelMLTaskRun where

instance NFData CancelMLTaskRun where
...
data CancelMLTaskRunResponse = CancelMLTaskRunResponse'{_cmltrrsStatus
                                                        ::
...
cancelMLTaskRunResponse
    :: Int -- ^ 'cmltrrsResponseStatus'
    -> CancelMLTaskRunResponse
cancelMLTaskRunResponse pResponseStatus_
  = CancelMLTaskRunResponse'{_cmltrrsStatus = Nothing,
...
instance NFData CancelMLTaskRunResponse where
