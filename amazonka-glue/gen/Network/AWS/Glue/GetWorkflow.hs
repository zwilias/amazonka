...
data GetWorkflow = GetWorkflow'{_gwIncludeGraph ::
                                !(Maybe Bool),
                                _gwName :: !Text}
...
getWorkflow
    ...
    -> GetWorkflow
getWorkflow pName_
  = GetWorkflow'{_gwIncludeGraph = Nothing,
                 _gwName = pName_}
...
instance Hashable GetWorkflow where

instance NFData GetWorkflow where
...
data GetWorkflowResponse = GetWorkflowResponse'{_gwrsWorkflow
                                                :: !(Maybe Workflow),
...
getWorkflowResponse
    :: Int -- ^ 'gwrsResponseStatus'
    -> GetWorkflowResponse
getWorkflowResponse pResponseStatus_
  = GetWorkflowResponse'{_gwrsWorkflow = Nothing,
...
instance NFData GetWorkflowResponse where
