...
data PutDataCatalogEncryptionSettings = PutDataCatalogEncryptionSettings'{_pdcesCatalogId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
putDataCatalogEncryptionSettings
  ...
  = PutDataCatalogEncryptionSettings'{_pdcesCatalogId =
                                        Nothing,
                                      _pdcesDataCatalogEncryptionSettings =
                                        pDataCatalogEncryptionSettings_}
...
newtype PutDataCatalogEncryptionSettingsResponse = PutDataCatalogEncryptionSettingsResponse'{_pdcesrsResponseStatus
                                                                                             ::
                                                                                             Int}
...
putDataCatalogEncryptionSettingsResponse
  pResponseStatus_
  = PutDataCatalogEncryptionSettingsResponse'{_pdcesrsResponseStatus
                                                = pResponseStatus_}
