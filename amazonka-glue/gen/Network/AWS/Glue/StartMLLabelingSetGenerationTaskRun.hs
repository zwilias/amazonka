...
data StartMLLabelingSetGenerationTaskRun = StartMLLabelingSetGenerationTaskRun'{_smllsgtrTransformId
                                                                                ::
                                                                                !Text,
...
startMLLabelingSetGenerationTaskRun
    :: Text -- ^ 'smllsgtrTransformId'
    -> Text -- ^ 'smllsgtrOutputS3Path'
    -> StartMLLabelingSetGenerationTaskRun
startMLLabelingSetGenerationTaskRun pTransformId_
  pOutputS3Path_
  = StartMLLabelingSetGenerationTaskRun'{_smllsgtrTransformId
                                           = pTransformId_,
...
instance ToJSON StartMLLabelingSetGenerationTaskRun
         where
...
instance ToPath StartMLLabelingSetGenerationTaskRun
         where
        toPath = const "/"

instance ToQuery StartMLLabelingSetGenerationTaskRun
         where
        toQuery = const mempty

-- | /See:/ 'startMLLabelingSetGenerationTaskRunResponse' smart constructor.
data StartMLLabelingSetGenerationTaskRunResponse = StartMLLabelingSetGenerationTaskRunResponse'{_smllsgtrrsTaskRunId
                                                                                                ::
                                                                                                !(Maybe
                                                                                                    Text),
...
startMLLabelingSetGenerationTaskRunResponse
    :: Int -- ^ 'smllsgtrrsResponseStatus'
    -> StartMLLabelingSetGenerationTaskRunResponse
startMLLabelingSetGenerationTaskRunResponse
  pResponseStatus_
  = StartMLLabelingSetGenerationTaskRunResponse'{_smllsgtrrsTaskRunId
                                                   = Nothing,
                                                 _smllsgtrrsResponseStatus =
                                                   pResponseStatus_}
