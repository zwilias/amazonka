...
data ListCrawlers = ListCrawlers'{_lcNextToken ::
                                  !(Maybe Text),
...
listCrawlers
    :: ListCrawlers
listCrawlers
  = ListCrawlers'{_lcNextToken = Nothing,
                  _lcMaxResults = Nothing, _lcTags = Nothing}
...
instance Hashable ListCrawlers where

instance NFData ListCrawlers where
...
data ListCrawlersResponse = ListCrawlersResponse'{_lcrsNextToken
                                                  :: !(Maybe Text),
                                                  _lcrsCrawlerNames ::
                                                  !(Maybe [Text]),
...
listCrawlersResponse pResponseStatus_
  = ListCrawlersResponse'{_lcrsNextToken = Nothing,
...
instance NFData ListCrawlersResponse where
