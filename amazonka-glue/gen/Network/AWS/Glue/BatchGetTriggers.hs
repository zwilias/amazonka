...
newtype BatchGetTriggers = BatchGetTriggers'{_bgtTriggerNames
                                             :: [Text]}
...
instance Hashable BatchGetTriggers where

instance NFData BatchGetTriggers where
...
data BatchGetTriggersResponse = BatchGetTriggersResponse'{_bgtrsTriggersNotFound
                                                          :: !(Maybe [Text]),
                                                          _bgtrsTriggers ::
                                                          !(Maybe [Trigger]),
...
batchGetTriggersResponse pResponseStatus_
  = BatchGetTriggersResponse'{_bgtrsTriggersNotFound =
                                Nothing,
...
instance NFData BatchGetTriggersResponse where
