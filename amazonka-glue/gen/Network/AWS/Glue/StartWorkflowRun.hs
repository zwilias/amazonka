...
newtype StartWorkflowRun = StartWorkflowRun'{_swrName
                                             :: Text}
...
startWorkflowRun pName_
  = StartWorkflowRun'{_swrName = pName_}
...
instance Hashable StartWorkflowRun where

instance NFData StartWorkflowRun where
...
data StartWorkflowRunResponse = StartWorkflowRunResponse'{_swrrsRunId
                                                          :: !(Maybe Text),
...
startWorkflowRunResponse
    :: Int -- ^ 'swrrsResponseStatus'
    -> StartWorkflowRunResponse
startWorkflowRunResponse pResponseStatus_
  = StartWorkflowRunResponse'{_swrrsRunId = Nothing,
...
instance NFData StartWorkflowRunResponse where
