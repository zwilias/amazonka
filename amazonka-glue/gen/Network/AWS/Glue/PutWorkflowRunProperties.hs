...
data PutWorkflowRunProperties = PutWorkflowRunProperties'{_pwrpName
                                                          :: !Text,
                                                          _pwrpRunId :: !Text,
                                                          _pwrpRunProperties ::
                                                          !(Map Text Text)}
...
putWorkflowRunProperties pName_ pRunId_
  = PutWorkflowRunProperties'{_pwrpName = pName_,
                              _pwrpRunId = pRunId_, _pwrpRunProperties = mempty}
...
instance AWSRequest PutWorkflowRunProperties where
        type Rs PutWorkflowRunProperties =
             PutWorkflowRunPropertiesResponse
...
instance Hashable PutWorkflowRunProperties where

instance NFData PutWorkflowRunProperties where
...
newtype PutWorkflowRunPropertiesResponse = PutWorkflowRunPropertiesResponse'{_pwrprsResponseStatus
                                                                             ::
                                                                             Int}
...
putWorkflowRunPropertiesResponse
    :: Int -- ^ 'pwrprsResponseStatus'
    -> PutWorkflowRunPropertiesResponse
putWorkflowRunPropertiesResponse pResponseStatus_
  = PutWorkflowRunPropertiesResponse'{_pwrprsResponseStatus
                                        = pResponseStatus_}
