...
newtype GetDataCatalogEncryptionSettings = GetDataCatalogEncryptionSettings'{_gdcesCatalogId
                                                                             ::
                                                                             Maybe
                                                                               Text}
...
getDataCatalogEncryptionSettings
    :: GetDataCatalogEncryptionSettings
getDataCatalogEncryptionSettings
  = GetDataCatalogEncryptionSettings'{_gdcesCatalogId =
                                        Nothing}
...
data GetDataCatalogEncryptionSettingsResponse = GetDataCatalogEncryptionSettingsResponse'{_gdcesrsDataCatalogEncryptionSettings
                                                                                          ::
                                                                                          !(Maybe
...
getDataCatalogEncryptionSettingsResponse
  pResponseStatus_
  = GetDataCatalogEncryptionSettingsResponse'{_gdcesrsDataCatalogEncryptionSettings
                                                = Nothing,
                                              _gdcesrsResponseStatus =
                                                pResponseStatus_}
