...
data TaskRunFilterCriteria = TaskRunFilterCriteria'{_trfcStatus
...
taskRunFilterCriteria
    :: TaskRunFilterCriteria
taskRunFilterCriteria
  = TaskRunFilterCriteria'{_trfcStatus = Nothing,
...
instance Hashable TaskRunFilterCriteria where

instance NFData TaskRunFilterCriteria where
