...
data CodeGenEdge = CodeGenEdge'{_cgeTargetParameter
                                :: !(Maybe Text),
                                _cgeSource :: !Text, _cgeTarget :: !Text}
...
codeGenEdge pSource_ pTarget_
  = CodeGenEdge'{_cgeTargetParameter = Nothing,
                 _cgeSource = pSource_, _cgeTarget = pTarget_}
