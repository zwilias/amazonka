...
data TransformSortCriteria = TransformSortCriteria'{_tscColumn
...
transformSortCriteria
    :: TransformSortColumnType -- ^ 'tscColumn'
    -> SortDirectionType -- ^ 'tscSortDirection'
    -> TransformSortCriteria
transformSortCriteria pColumn_ pSortDirection_
  = TransformSortCriteria'{_tscColumn = pColumn_,
...
instance Hashable TransformSortCriteria where

instance NFData TransformSortCriteria where
