...
data GrokClassifier = GrokClassifier'{_gcCreationTime
                                      :: !(Maybe POSIX),
...
grokClassifier pName_ pClassification_ pGrokPattern_
  = GrokClassifier'{_gcCreationTime = Nothing,
                    _gcLastUpdated = Nothing, _gcVersion = Nothing,
                    _gcCustomPatterns = Nothing, _gcName = pName_,
