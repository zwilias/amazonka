...
data Action = Action'{_aNotificationProperty ::
...
action
    :: Action
action
  = Action'{_aNotificationProperty = Nothing,
            _aArguments = Nothing, _aJobName = Nothing,
            _aSecurityConfiguration = Nothing,
            _aTimeout = Nothing, _aCrawlerName = Nothing}
