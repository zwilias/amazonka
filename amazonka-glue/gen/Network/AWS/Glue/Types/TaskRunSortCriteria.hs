...
data TaskRunSortCriteria = TaskRunSortCriteria'{_trscColumn
...
taskRunSortCriteria
    :: TaskRunSortColumnType -- ^ 'trscColumn'
    -> SortDirectionType -- ^ 'trscSortDirection'
    -> TaskRunSortCriteria
taskRunSortCriteria pColumn_ pSortDirection_
  = TaskRunSortCriteria'{_trscColumn = pColumn_,
...
instance Hashable TaskRunSortCriteria where

instance NFData TaskRunSortCriteria where
