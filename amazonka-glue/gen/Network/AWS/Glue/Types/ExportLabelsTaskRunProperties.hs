...
newtype ExportLabelsTaskRunProperties = ExportLabelsTaskRunProperties'{_eltrpOutputS3Path
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
exportLabelsTaskRunProperties
    :: ExportLabelsTaskRunProperties
exportLabelsTaskRunProperties
  = ExportLabelsTaskRunProperties'{_eltrpOutputS3Path =
                                     Nothing}
...
instance FromJSON ExportLabelsTaskRunProperties where
        parseJSON
          = withObject "ExportLabelsTaskRunProperties"
              (\ x ->
                 ExportLabelsTaskRunProperties' <$>
                   (x .:? "OutputS3Path"))

instance Hashable ExportLabelsTaskRunProperties where

instance NFData ExportLabelsTaskRunProperties where
