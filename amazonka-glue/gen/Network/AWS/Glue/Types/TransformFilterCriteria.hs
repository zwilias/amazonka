...
data TransformFilterCriteria = TransformFilterCriteria'{_tfcCreatedAfter
                                                        :: !(Maybe POSIX),
                                                        _tfcStatus ::
                                                        !(Maybe
                                                            TransformStatusType),
...
transformFilterCriteria
    :: TransformFilterCriteria
transformFilterCriteria
  = TransformFilterCriteria'{_tfcCreatedAfter =
                               Nothing,
                             _tfcStatus = Nothing,
                             _tfcLastModifiedAfter = Nothing,
                             _tfcLastModifiedBefore = Nothing,
                             _tfcGlueVersion = Nothing, _tfcSchema = Nothing,
                             _tfcTransformType = Nothing, _tfcName = Nothing,
...
instance Hashable TransformFilterCriteria where

instance NFData TransformFilterCriteria where
