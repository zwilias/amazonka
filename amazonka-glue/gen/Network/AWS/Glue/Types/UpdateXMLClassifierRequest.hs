...
data UpdateXMLClassifierRequest = UpdateXMLClassifierRequest'{_uxcrClassification
                                                              :: !(Maybe Text),
                                                              _uxcrRowTag ::
                                                              !(Maybe Text),
                                                              _uxcrName ::
...
updateXMLClassifierRequest pName_
  = UpdateXMLClassifierRequest'{_uxcrClassification =
                                  Nothing,
                                _uxcrRowTag = Nothing, _uxcrName = pName_}
