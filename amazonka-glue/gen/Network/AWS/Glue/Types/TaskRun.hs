...
data TaskRun = TaskRun'{_trCompletedOn ::
                        !(Maybe POSIX),
...
taskRun
    :: TaskRun
taskRun
  = TaskRun'{_trCompletedOn = Nothing,
             _trStatus = Nothing, _trLastModifiedOn = Nothing,
             _trErrorString = Nothing, _trStartedOn = Nothing,
             _trLogGroupName = Nothing,
             _trExecutionTime = Nothing, _trProperties = Nothing,
             _trTransformId = Nothing, _trTaskRunId = Nothing}
...
instance Hashable TaskRun where

instance NFData TaskRun where
