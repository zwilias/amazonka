...
data Node = Node'{_nTriggerDetails ::
...
node
    :: Node
node
  = Node'{_nTriggerDetails = Nothing,
          _nUniqueId = Nothing, _nCrawlerDetails = Nothing,
          _nName = Nothing, _nJobDetails = Nothing,
          _nType = Nothing}
