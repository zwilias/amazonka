...
newtype LabelingSetGenerationTaskRunProperties = LabelingSetGenerationTaskRunProperties'{_lsgtrpOutputS3Path
                                                                                         ::
                                                                                         Maybe
                                                                                           Text}
...
labelingSetGenerationTaskRunProperties
    :: LabelingSetGenerationTaskRunProperties
labelingSetGenerationTaskRunProperties
  = LabelingSetGenerationTaskRunProperties'{_lsgtrpOutputS3Path
                                              = Nothing}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "LabelingSetGenerationTaskRunProperties"
              (\ x ->
                 LabelingSetGenerationTaskRunProperties' <$>
                   (x .:? "OutputS3Path"))
