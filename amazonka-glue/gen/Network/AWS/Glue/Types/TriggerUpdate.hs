...
data TriggerUpdate = TriggerUpdate'{_tuActions ::
                                    !(Maybe [Action]),
...
triggerUpdate
    :: TriggerUpdate
triggerUpdate
  = TriggerUpdate'{_tuActions = Nothing,
                   _tuSchedule = Nothing, _tuPredicate = Nothing,
                   _tuName = Nothing, _tuDescription = Nothing}
