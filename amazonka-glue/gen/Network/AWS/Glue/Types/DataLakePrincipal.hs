...
newtype DataLakePrincipal = DataLakePrincipal'{_dlpDataLakePrincipalIdentifier
                                               :: Maybe Text}
...
dataLakePrincipal
    :: DataLakePrincipal
dataLakePrincipal
  = DataLakePrincipal'{_dlpDataLakePrincipalIdentifier
                         = Nothing}
...
instance FromJSON DataLakePrincipal where
        parseJSON
          = withObject "DataLakePrincipal"
              (\ x ->
                 DataLakePrincipal' <$>
                   (x .:? "DataLakePrincipalIdentifier"))

instance Hashable DataLakePrincipal where

instance NFData DataLakePrincipal where
