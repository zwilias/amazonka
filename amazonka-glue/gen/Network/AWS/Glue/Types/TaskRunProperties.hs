...
data TaskRunProperties = TaskRunProperties'{_trpTaskType
                                            :: !(Maybe TaskType),
...
taskRunProperties
    :: TaskRunProperties
taskRunProperties
  = TaskRunProperties'{_trpTaskType = Nothing,
...
instance Hashable TaskRunProperties where

instance NFData TaskRunProperties where
