...
data ImportLabelsTaskRunProperties = ImportLabelsTaskRunProperties'{_iltrpReplace
                                                                    ::
                                                                    !(Maybe
                                                                        Bool),
                                                                    _iltrpInputS3Path
...
importLabelsTaskRunProperties
    :: ImportLabelsTaskRunProperties
importLabelsTaskRunProperties
  = ImportLabelsTaskRunProperties'{_iltrpReplace =
                                     Nothing,
...
instance FromJSON ImportLabelsTaskRunProperties where
        parseJSON
          = withObject "ImportLabelsTaskRunProperties"
              (\ x ->
                 ImportLabelsTaskRunProperties' <$>
                   (x .:? "Replace") <*> (x .:? "InputS3Path"))

instance Hashable ImportLabelsTaskRunProperties where

instance NFData ImportLabelsTaskRunProperties where
