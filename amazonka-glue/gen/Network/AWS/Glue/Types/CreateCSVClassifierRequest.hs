...
data CreateCSVClassifierRequest = CreateCSVClassifierRequest'{_cccrQuoteSymbol
                                                              :: !(Maybe Text),
                                                              _cccrContainsHeader
                                                              ::
                                                              !(Maybe
...
instance Hashable CreateCSVClassifierRequest where

instance NFData CreateCSVClassifierRequest where
