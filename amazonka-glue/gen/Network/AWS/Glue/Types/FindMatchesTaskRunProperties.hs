...
data FindMatchesTaskRunProperties = FindMatchesTaskRunProperties'{_fmtrpJobId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _fmtrpJobName
                                                                  ::
...
findMatchesTaskRunProperties
    :: FindMatchesTaskRunProperties
findMatchesTaskRunProperties
  = FindMatchesTaskRunProperties'{_fmtrpJobId =
                                    Nothing,
...
instance FromJSON FindMatchesTaskRunProperties where
        parseJSON
          = withObject "FindMatchesTaskRunProperties"
              (\ x ->
                 FindMatchesTaskRunProperties' <$>
                   (x .:? "JobId") <*> (x .:? "JobName") <*>
                     (x .:? "JobRunId"))

instance Hashable FindMatchesTaskRunProperties where

instance NFData FindMatchesTaskRunProperties where
