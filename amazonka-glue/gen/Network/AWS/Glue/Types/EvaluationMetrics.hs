...
data EvaluationMetrics = EvaluationMetrics'{_emFindMatchesMetrics
...
evaluationMetrics
    :: TransformType -- ^ 'emTransformType'
    -> EvaluationMetrics
evaluationMetrics pTransformType_
  = EvaluationMetrics'{_emFindMatchesMetrics = Nothing,
...
instance Hashable EvaluationMetrics where

instance NFData EvaluationMetrics where
