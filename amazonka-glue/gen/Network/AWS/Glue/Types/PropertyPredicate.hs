...
data PropertyPredicate = PropertyPredicate'{_ppValue
                                            :: !(Maybe Text),
                                            _ppKey :: !(Maybe Text),
                                            _ppComparator ::
                                            !(Maybe Comparator)}
...
propertyPredicate
    :: PropertyPredicate
propertyPredicate
  = PropertyPredicate'{_ppValue = Nothing,
                       _ppKey = Nothing, _ppComparator = Nothing}
...
instance Hashable PropertyPredicate where

instance NFData PropertyPredicate where
