...
data Partition = Partition'{_pCreationTime ::
                            !(Maybe POSIX),
                            _pValues :: !(Maybe [Text]),
...
partition
    :: Partition
partition
  = Partition'{_pCreationTime = Nothing,
               _pValues = Nothing, _pLastAnalyzedTime = Nothing,
               _pStorageDescriptor = Nothing,
               _pDatabaseName = Nothing, _pParameters = Nothing,
               _pLastAccessTime = Nothing, _pTableName = Nothing}
