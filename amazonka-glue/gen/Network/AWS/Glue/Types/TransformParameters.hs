...
data TransformParameters = TransformParameters'{_tpFindMatchesParameters
                                                ::
...
--
-- * 'tpTransformType' - The type of machine learning transform. For information about the types of machine learning transforms, see <http://docs.aws.amazon.com/glue/latest/dg/add-job-machine-learning-transform.html Creating Machine Learning Transforms> .
transformParameters
    :: TransformType -- ^ 'tpTransformType'
    -> TransformParameters
transformParameters pTransformType_
  = TransformParameters'{_tpFindMatchesParameters =
                           Nothing,
...
-- | The type of machine learning transform. For information about the types of machine learning transforms, see <http://docs.aws.amazon.com/glue/latest/dg/add-job-machine-learning-transform.html Creating Machine Learning Transforms> .
...
instance FromJSON TransformParameters where
        parseJSON
          = withObject "TransformParameters"
              (\ x ->
                 TransformParameters' <$>
                   (x .:? "FindMatchesParameters") <*>
                     (x .: "TransformType"))

instance Hashable TransformParameters where

instance NFData TransformParameters where
