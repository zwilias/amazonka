...
data PrincipalPermissions = PrincipalPermissions'{_ppPrincipal
...
principalPermissions
    :: PrincipalPermissions
principalPermissions
  = PrincipalPermissions'{_ppPrincipal = Nothing,
...
instance FromJSON PrincipalPermissions where
        parseJSON
          = withObject "PrincipalPermissions"
              (\ x ->
                 PrincipalPermissions' <$>
                   (x .:? "Principal") <*>
                     (x .:? "Permissions" .!= mempty))

instance Hashable PrincipalPermissions where

instance NFData PrincipalPermissions where
