...
data LastCrawlInfo = LastCrawlInfo'{_lciStatus ::
...
lastCrawlInfo
    :: LastCrawlInfo
lastCrawlInfo
  = LastCrawlInfo'{_lciStatus = Nothing,
                   _lciStartTime = Nothing, _lciLogStream = Nothing,
                   _lciLogGroup = Nothing, _lciMessagePrefix = Nothing,
