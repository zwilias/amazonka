...
data UpdateCSVClassifierRequest = UpdateCSVClassifierRequest'{_uccrQuoteSymbol
                                                              :: !(Maybe Text),
                                                              _uccrContainsHeader
                                                              ::
                                                              !(Maybe
...
instance Hashable UpdateCSVClassifierRequest where

instance NFData UpdateCSVClassifierRequest where
