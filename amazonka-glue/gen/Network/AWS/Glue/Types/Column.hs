...
data Column = Column'{_cParameters ::
                      !(Maybe (Map Text Text)),
                      _cType :: !(Maybe Text), _cComment :: !(Maybe Text),
                      _cName :: !Text}
...
column
    ...
    -> Column
column pName_
  = Column'{_cParameters = Nothing, _cType = Nothing,
            _cComment = Nothing, _cName = pName_}
