...
data GetMLTaskRuns = GetMLTaskRuns'{_gmltrNextToken
                                    :: !(Maybe Text),
...
getMLTaskRuns
    :: Text -- ^ 'gmltrTransformId'
    -> GetMLTaskRuns
getMLTaskRuns pTransformId_
  = GetMLTaskRuns'{_gmltrNextToken = Nothing,
                   _gmltrSort = Nothing, _gmltrFilter = Nothing,
...
instance AWSRequest GetMLTaskRuns where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 GetMLTaskRunsResponse' <$>
                   (x .?> "NextToken") <*> (x .?> "TaskRuns" .!@ mempty)
                     <*> (pure (fromEnum s)))

instance Hashable GetMLTaskRuns where

instance NFData GetMLTaskRuns where
...
data GetMLTaskRunsResponse = GetMLTaskRunsResponse'{_gmltrsrsNextToken
                                                    :: !(Maybe Text),
                                                    _gmltrsrsTaskRuns ::
                                                    !(Maybe [TaskRun]),
                                                    _gmltrsrsResponseStatus ::
                                                    !Int}
...
getMLTaskRunsResponse
    :: Int -- ^ 'gmltrsrsResponseStatus'
    -> GetMLTaskRunsResponse
getMLTaskRunsResponse pResponseStatus_
  = GetMLTaskRunsResponse'{_gmltrsrsNextToken =
                             Nothing,
...
instance NFData GetMLTaskRunsResponse where
