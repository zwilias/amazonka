...
newtype BatchGetCrawlers = BatchGetCrawlers'{_bgcCrawlerNames
                                             :: [Text]}
...
instance Hashable BatchGetCrawlers where

instance NFData BatchGetCrawlers where
...
data BatchGetCrawlersResponse = BatchGetCrawlersResponse'{_bgcrsCrawlersNotFound
                                                          :: !(Maybe [Text]),
                                                          _bgcrsCrawlers ::
                                                          !(Maybe [Crawler]),
...
batchGetCrawlersResponse pResponseStatus_
  = BatchGetCrawlersResponse'{_bgcrsCrawlersNotFound =
                                Nothing,
...
instance NFData BatchGetCrawlersResponse where
