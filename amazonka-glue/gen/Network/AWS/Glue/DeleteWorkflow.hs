...
newtype DeleteWorkflow = DeleteWorkflow'{_dwName ::
                                         Text}
...
instance Hashable DeleteWorkflow where

instance NFData DeleteWorkflow where
...
data DeleteWorkflowResponse = DeleteWorkflowResponse'{_dwrsName
                                                      :: !(Maybe Text),
                                                      _dwrsResponseStatus ::
                                                      !Int}
...
deleteWorkflowResponse pResponseStatus_
  = DeleteWorkflowResponse'{_dwrsName = Nothing,
...
instance NFData DeleteWorkflowResponse where
