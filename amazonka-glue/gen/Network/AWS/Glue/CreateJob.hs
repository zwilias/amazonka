...
data CreateJob = CreateJob'{_cjNumberOfWorkers ::
                            !(Maybe Int),
...
createJob pName_ pRole_ pCommand_
  = CreateJob'{_cjNumberOfWorkers = Nothing,
               _cjNotificationProperty = Nothing,
               _cjConnections = Nothing, _cjWorkerType = Nothing,
               ...
               _cjMaxCapacity = Nothing, _cjTimeout = Nothing,
               _cjDefaultArguments = Nothing,
               _cjDescription = Nothing, _cjTags = Nothing,
               _cjName = pName_, _cjRole = pRole_,
          ...
          = object
              (catMaybes
                 [("NumberOfWorkers" .=) <$> _cjNumberOfWorkers,
                  ...
                  ("Tags" .=) <$> _cjTags, Just ("Name" .= _cjName),
                  Just ("Role" .= _cjRole),
