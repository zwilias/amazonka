...
data BatchGetWorkflows = BatchGetWorkflows'{_bgwIncludeGraph
                                            :: !(Maybe Bool),
...
batchGetWorkflows
    :: NonEmpty Text -- ^ 'bgwNames'
    -> BatchGetWorkflows
batchGetWorkflows pNames_
  = BatchGetWorkflows'{_bgwIncludeGraph = Nothing,
...
instance AWSRequest BatchGetWorkflows where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 BatchGetWorkflowsResponse' <$>
                   (x .?> "MissingWorkflows") <*> (x .?> "Workflows")
                     <*> (pure (fromEnum s)))

instance Hashable BatchGetWorkflows where

instance NFData BatchGetWorkflows where
...
data BatchGetWorkflowsResponse = BatchGetWorkflowsResponse'{_bgwrsMissingWorkflows
                                                            ::
                                                            !(Maybe
                                                                (List1 Text)),
                                                            _bgwrsWorkflows ::
...
batchGetWorkflowsResponse
    :: Int -- ^ 'bgwrsResponseStatus'
    -> BatchGetWorkflowsResponse
batchGetWorkflowsResponse pResponseStatus_
  = BatchGetWorkflowsResponse'{_bgwrsMissingWorkflows =
                                 Nothing,
...
instance NFData BatchGetWorkflowsResponse where
