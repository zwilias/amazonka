...
newtype BatchGetJobs = BatchGetJobs'{_bgjJobNames ::
                                     [Text]}
...
instance Hashable BatchGetJobs where

instance NFData BatchGetJobs where
...
data BatchGetJobsResponse = BatchGetJobsResponse'{_bgjrsJobs
                                                  :: !(Maybe [Job]),
                                                  _bgjrsJobsNotFound ::
                                                  !(Maybe [Text]),
...
batchGetJobsResponse
    :: Int -- ^ 'bgjrsResponseStatus'
    -> BatchGetJobsResponse
batchGetJobsResponse pResponseStatus_
  = BatchGetJobsResponse'{_bgjrsJobs = Nothing,
...
instance NFData BatchGetJobsResponse where
