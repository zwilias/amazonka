...
data GetJobBookmark = GetJobBookmark'{_gjbRunId ::
                                      !(Maybe Text),
                                      _gjbJobName :: !Text}
...
getJobBookmark pJobName_
  = GetJobBookmark'{_gjbRunId = Nothing,
...
data GetJobBookmarkResponse = GetJobBookmarkResponse'{_gjbrsJobBookmarkEntry
                                                      ::
                                                      !(Maybe JobBookmarkEntry),
                                                      _gjbrsResponseStatus ::
                                                      !Int}
...
getJobBookmarkResponse pResponseStatus_
  = GetJobBookmarkResponse'{_gjbrsJobBookmarkEntry =
                              Nothing,
