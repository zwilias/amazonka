...
data CopyDBSnapshot = CopyDBSnapshot'{_cdsPreSignedURL
                                      :: !(Maybe Text),
...
copyDBSnapshot
    ...
    -> CopyDBSnapshot
copyDBSnapshot pSourceDBSnapshotIdentifier_
  pTargetDBSnapshotIdentifier_
  = CopyDBSnapshot'{_cdsPreSignedURL = Nothing,
                    _cdsCopyTags = Nothing, _cdsKMSKeyId = Nothing,
                    _cdsOptionGroupName = Nothing, _cdsTags = Nothing,
...
data CopyDBSnapshotResponse = CopyDBSnapshotResponse'{_cdsrsDBSnapshot
                                                      :: !(Maybe DBSnapshot),
...
copyDBSnapshotResponse pResponseStatus_
  = CopyDBSnapshotResponse'{_cdsrsDBSnapshot = Nothing,
