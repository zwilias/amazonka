...
cdirrPubliclyAccessible =
  lens _cdirrPubliclyAccessible (\s a -> s {_cdirrPubliclyAccessible = a})
...
cdirrAutoMinorVersionUpgrade =
  lens
    ...
    (\s a -> s {_cdirrAutoMinorVersionUpgrade = a})
...
cdirrDBSubnetGroupName =
  lens _cdirrDBSubnetGroupName (\s a -> s {_cdirrDBSubnetGroupName = a})

-- | The ARN for the IAM role that permits RDS to send enhanced monitoring metrics to Amazon CloudWatch Logs. For example, @arn:aws:iam:123456789012:role/emaccess@ . For information on creating a monitoring role, go to <http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.html#USER_Monitoring.OS.IAMRole To create an IAM role for Amazon RDS Enhanced Monitoring> . If @MonitoringInterval@ is set to a value other than 0, then you must supply a @MonitoringRoleArn@ value.
cdirrMonitoringRoleARN :: Lens' CreateDBInstanceReadReplica (Maybe Text)
cdirrMonitoringRoleARN =
  lens _cdirrMonitoringRoleARN (\s a -> s {_cdirrMonitoringRoleARN = a})
...
cdirrMonitoringInterval =
  lens _cdirrMonitoringInterval (\s a -> s {_cdirrMonitoringInterval = a})
...
cdirrDBInstanceClass =
  lens _cdirrDBInstanceClass (\s a -> s {_cdirrDBInstanceClass = a})
...
cdirrEnablePerformanceInsights =
  lens
    ...
    (\s a -> s {_cdirrEnablePerformanceInsights = a})
...
cdirrAvailabilityZone =
  lens _cdirrAvailabilityZone (\s a -> s {_cdirrAvailabilityZone = a})

-- | The AWS KMS key identifier for encryption of Performance Insights data. The KMS key ID is the Amazon Resource Name (ARN), KMS key identifier, or the KMS key alias for the KMS encryption key.
cdirrPerformanceInsightsKMSKeyId ::
     Lens' CreateDBInstanceReadReplica (Maybe Text)
cdirrPerformanceInsightsKMSKeyId =
  lens
    _cdirrPerformanceInsightsKMSKeyId
    (\s a -> s {_cdirrPerformanceInsightsKMSKeyId = a})
...
cdirrOptionGroupName =
  lens _cdirrOptionGroupName (\s a -> s {_cdirrOptionGroupName = a})
...
cdirrCopyTagsToSnapshot =
  lens _cdirrCopyTagsToSnapshot (\s a -> s {_cdirrCopyTagsToSnapshot = a})
...
cdirrEnableIAMDatabaseAuthentication ::
     Lens' CreateDBInstanceReadReplica (Maybe Bool)
cdirrEnableIAMDatabaseAuthentication =
  lens
    _cdirrEnableIAMDatabaseAuthentication
    (\s a -> s {_cdirrEnableIAMDatabaseAuthentication = a})
...
cdirrEnableCloudwatchLogsExports =
  lens
    ...
    (\s a -> s {_cdirrEnableCloudwatchLogsExports = a}) .
  _Default . _Coerce

-- | The DB instance identifier of the Read Replica. This identifier is the unique key that identifies a DB instance. This parameter is stored as a lowercase string.
cdirrDBInstanceIdentifier :: Lens' CreateDBInstanceReadReplica Text
cdirrDBInstanceIdentifier =
  lens _cdirrDBInstanceIdentifier (\s a -> s {_cdirrDBInstanceIdentifier = a})
...
cdirrSourceDBInstanceIdentifier =
  lens
    ...
    (\s a -> s {_cdirrSourceDBInstanceIdentifier = a})
...
instance AWSRequest CreateDBInstanceReadReplica where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CreateDBInstanceReadReplicaResponse' <$> (x .@? "DBInstance") <*>
         (pure (fromEnum s)))
  ...
  toQuery CreateDBInstanceReadReplica' {..} =
    mconcat
      ...
      , "EnableCloudwatchLogsExports" =:
        toQuery (toQueryList "member" <$> _cdirrEnableCloudwatchLogsExports)
...
-- | Undocumented member.
cdirrrsDBInstance ::
     Lens' CreateDBInstanceReadReplicaResponse (Maybe DBInstance)
...
cdirrrsResponseStatus =
  lens _cdirrrsResponseStatus (\s a -> s {_cdirrrsResponseStatus = a})
