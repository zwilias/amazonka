...
data DescribeExportTasks = DescribeExportTasks'{_detSourceARN
                                                :: !(Maybe Text),
                                                _detFilters ::
                                                !(Maybe [Filter]),
...
describeExportTasks
    :: DescribeExportTasks
describeExportTasks
  = DescribeExportTasks'{_detSourceARN = Nothing,
                         _detFilters = Nothing, _detMarker = Nothing,
...
instance AWSRequest DescribeExportTasks where
        ...
        response
          = receiveXMLWrapper "DescribeExportTasksResult"
              (\ s h x ->
                 DescribeExportTasksResponse' <$>
                   (x .@? "Marker") <*>
...
data DescribeExportTasksResponse = DescribeExportTasksResponse'{_detrsMarker
                                                                ::
                                                                !(Maybe Text),
                                                                _detrsExportTasks
                                                                ::
...
describeExportTasksResponse pResponseStatus_
  = DescribeExportTasksResponse'{_detrsMarker =
                                   Nothing,
