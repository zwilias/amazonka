...
ddsgDBSubnetGroupName =
  lens _ddsgDBSubnetGroupName (\s a -> s {_ddsgDBSubnetGroupName = a})

-- | This parameter is not currently supported.
ddsgFilters :: Lens' DescribeDBSubnetGroups [Filter]
ddsgFilters =
  lens _ddsgFilters (\s a -> s {_ddsgFilters = a}) . _Default . _Coerce
...
ddsgrsDBSubnetGroups =
  lens _ddsgrsDBSubnetGroups (\s a -> s {_ddsgrsDBSubnetGroups = a}) .
  _Default . _Coerce
...
ddsgrsResponseStatus =
  lens _ddsgrsResponseStatus (\s a -> s {_ddsgrsResponseStatus = a})
