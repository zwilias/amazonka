...
data CreateCustomAvailabilityZone = CreateCustomAvailabilityZone'{_ccazVPNTunnelOriginatorIP
                                                                  ::
                                                                  !(Maybe Text),
...
createCustomAvailabilityZone
    :: Text -- ^ 'ccazCustomAvailabilityZoneName'
    -> CreateCustomAvailabilityZone
createCustomAvailabilityZone
  pCustomAvailabilityZoneName_
  = CreateCustomAvailabilityZone'{_ccazVPNTunnelOriginatorIP
                                    = Nothing,
...
instance AWSRequest CreateCustomAvailabilityZone
         where
...
instance Hashable CreateCustomAvailabilityZone where

instance NFData CreateCustomAvailabilityZone where
...
data CreateCustomAvailabilityZoneResponse = CreateCustomAvailabilityZoneResponse'{_ccazrsCustomAvailabilityZone
                                                                                  ::
                                                                                  !(Maybe
...
createCustomAvailabilityZoneResponse
    :: Int -- ^ 'ccazrsResponseStatus'
    -> CreateCustomAvailabilityZoneResponse
createCustomAvailabilityZoneResponse pResponseStatus_
  = CreateCustomAvailabilityZoneResponse'{_ccazrsCustomAvailabilityZone
                                            = Nothing,
                                          _ccazrsResponseStatus =
                                            pResponseStatus_}
