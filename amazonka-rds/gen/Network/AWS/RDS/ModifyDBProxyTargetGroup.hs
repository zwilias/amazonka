...
data ModifyDBProxyTargetGroup = ModifyDBProxyTargetGroup'{_mdptgConnectionPoolConfig
                                                          ::
                                                          !(Maybe
...
modifyDBProxyTargetGroup
    :: Text -- ^ 'mdptgTargetGroupName'
    -> Text -- ^ 'mdptgDBProxyName'
    -> ModifyDBProxyTargetGroup
modifyDBProxyTargetGroup pTargetGroupName_
  pDBProxyName_
  = ModifyDBProxyTargetGroup'{_mdptgConnectionPoolConfig
                                = Nothing,
...
instance AWSRequest ModifyDBProxyTargetGroup where
        type Rs ModifyDBProxyTargetGroup =
             ModifyDBProxyTargetGroupResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "ModifyDBProxyTargetGroupResult"
              (\ s h x ->
                 ModifyDBProxyTargetGroupResponse' <$>
                   (x .@? "DBProxyTargetGroup") <*> (pure (fromEnum s)))

instance Hashable ModifyDBProxyTargetGroup where

instance NFData ModifyDBProxyTargetGroup where
...
data ModifyDBProxyTargetGroupResponse = ModifyDBProxyTargetGroupResponse'{_mdptgrsDBProxyTargetGroup
                                                                          ::
                                                                          !(Maybe
                                                                              DBProxyTargetGroup),
...
modifyDBProxyTargetGroupResponse
    :: Int -- ^ 'mdptgrsResponseStatus'
    -> ModifyDBProxyTargetGroupResponse
modifyDBProxyTargetGroupResponse pResponseStatus_
  = ModifyDBProxyTargetGroupResponse'{_mdptgrsDBProxyTargetGroup
                                        = Nothing,
