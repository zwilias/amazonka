...
data ModifyCurrentDBClusterCapacity = ModifyCurrentDBClusterCapacity'{_mcdccTimeoutAction
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _mcdccCapacity
...
modifyCurrentDBClusterCapacity pDBClusterIdentifier_
  = ModifyCurrentDBClusterCapacity'{_mcdccTimeoutAction
                                      = Nothing,
...
data ModifyCurrentDBClusterCapacityResponse = ModifyCurrentDBClusterCapacityResponse'{_mcdccrsDBClusterIdentifier
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
modifyCurrentDBClusterCapacityResponse
  pResponseStatus_
  = ModifyCurrentDBClusterCapacityResponse'{_mcdccrsDBClusterIdentifier
                                              = Nothing,
