...
data CopyDBClusterSnapshot = CopyDBClusterSnapshot'{_cdbcsPreSignedURL
                                                    :: !(Maybe Text),
                                                    _cdbcsCopyTags ::
                                                    !(Maybe Bool),
                                                    _cdbcsKMSKeyId ::
...
copyDBClusterSnapshot
  ...
  = CopyDBClusterSnapshot'{_cdbcsPreSignedURL =
                             Nothing,
                           _cdbcsCopyTags = Nothing, _cdbcsKMSKeyId = Nothing,
                           _cdbcsTags = Nothing,
                           _cdbcsSourceDBClusterSnapshotIdentifier =
                             pSourceDBClusterSnapshotIdentifier_,
                           _cdbcsTargetDBClusterSnapshotIdentifier =
...
data CopyDBClusterSnapshotResponse = CopyDBClusterSnapshotResponse'{_cdcsrsDBClusterSnapshot
                                                                    ::
                                                                    !(Maybe
                                                                        DBClusterSnapshot),
                                                                    _cdcsrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
copyDBClusterSnapshotResponse pResponseStatus_
  = CopyDBClusterSnapshotResponse'{_cdcsrsDBClusterSnapshot
                                     = Nothing,
