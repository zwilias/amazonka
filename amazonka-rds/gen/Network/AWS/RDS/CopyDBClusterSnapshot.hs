...
cdbcsSourceDBClusterSnapshotIdentifier =
  lens
    _cdbcsSourceDBClusterSnapshotIdentifier
    (\s a -> s {_cdbcsSourceDBClusterSnapshotIdentifier = a})
...
cdbcsTargetDBClusterSnapshotIdentifier =
  lens
    _cdbcsTargetDBClusterSnapshotIdentifier
    (\s a -> s {_cdbcsTargetDBClusterSnapshotIdentifier = a})
...
instance AWSRequest CopyDBClusterSnapshot where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CopyDBClusterSnapshotResponse' <$> (x .@? "DBClusterSnapshot") <*>
         (pure (fromEnum s)))
...
-- | Undocumented member.
cdcsrsDBClusterSnapshot ::
     Lens' CopyDBClusterSnapshotResponse (Maybe DBClusterSnapshot)
cdcsrsDBClusterSnapshot =
  lens _cdcsrsDBClusterSnapshot (\s a -> s {_cdcsrsDBClusterSnapshot = a})

-- | -- | The response status code.
cdcsrsResponseStatus :: Lens' CopyDBClusterSnapshotResponse Int
cdcsrsResponseStatus =
  lens _cdcsrsResponseStatus (\s a -> s {_cdcsrsResponseStatus = a})
