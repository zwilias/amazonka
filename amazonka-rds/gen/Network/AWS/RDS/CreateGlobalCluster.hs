...
data CreateGlobalCluster = CreateGlobalCluster'{_cgcEngineVersion
                                                :: !(Maybe Text),
...
createGlobalCluster
    :: CreateGlobalCluster
createGlobalCluster
  = CreateGlobalCluster'{_cgcEngineVersion = Nothing,
                         ...
                         _cgcEngine = Nothing, _cgcDatabaseName = Nothing}
...
data CreateGlobalClusterResponse = CreateGlobalClusterResponse'{_cgcrsGlobalCluster
                                                                ::
                                                                !(Maybe
                                                                    GlobalCluster),
                                                                _cgcrsResponseStatus
                                                                :: !Int}
...
createGlobalClusterResponse pResponseStatus_
  = CreateGlobalClusterResponse'{_cgcrsGlobalCluster =
                                   Nothing,
