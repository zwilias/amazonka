...
data StartExportTask = StartExportTask'{_setExportOnly
                                        :: !(Maybe [Text]),
...
startExportTask
    :: Text -- ^ 'setExportTaskIdentifier'
    -> Text -- ^ 'setSourceARN'
    -> Text -- ^ 'setS3BucketName'
    -> Text -- ^ 'setIAMRoleARN'
    -> Text -- ^ 'setKMSKeyId'
    -> StartExportTask
startExportTask pExportTaskIdentifier_ pSourceARN_
  pS3BucketName_ pIAMRoleARN_ pKMSKeyId_
  = StartExportTask'{_setExportOnly = Nothing,
...
instance AWSRequest StartExportTask where
        ...
        response
          = receiveXMLWrapper "StartExportTaskResult"
              (\ s h x -> parseXML x)
