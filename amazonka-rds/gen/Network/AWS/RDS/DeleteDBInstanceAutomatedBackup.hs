...
newtype DeleteDBInstanceAutomatedBackup = DeleteDBInstanceAutomatedBackup'{_ddiabDBiResourceId
                                                                           ::
                                                                           Text}
...
deleteDBInstanceAutomatedBackup pDBiResourceId_
  = DeleteDBInstanceAutomatedBackup'{_ddiabDBiResourceId
                                       = pDBiResourceId_}
...
data DeleteDBInstanceAutomatedBackupResponse = DeleteDBInstanceAutomatedBackupResponse'{_ddbiabrsDBInstanceAutomatedBackup
                                                                                        ::
                                                                                        !(Maybe
...
deleteDBInstanceAutomatedBackupResponse
  pResponseStatus_
  = DeleteDBInstanceAutomatedBackupResponse'{_ddbiabrsDBInstanceAutomatedBackup
                                               = Nothing,
                                             _ddbiabrsResponseStatus =
                                               pResponseStatus_}
