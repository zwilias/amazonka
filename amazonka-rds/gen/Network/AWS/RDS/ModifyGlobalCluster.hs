...
data ModifyGlobalCluster = ModifyGlobalCluster'{_mgcDeletionProtection
                                                :: !(Maybe Bool),
...
modifyGlobalCluster
    :: ModifyGlobalCluster
modifyGlobalCluster
  = ModifyGlobalCluster'{_mgcDeletionProtection =
                           Nothing,
...
data ModifyGlobalClusterResponse = ModifyGlobalClusterResponse'{_mgcrsGlobalCluster
                                                                ::
                                                                !(Maybe
                                                                    GlobalCluster),
                                                                _mgcrsResponseStatus
                                                                :: !Int}
...
modifyGlobalClusterResponse pResponseStatus_
  = ModifyGlobalClusterResponse'{_mgcrsGlobalCluster =
                                   Nothing,
