...
data StopActivityStream = StopActivityStream'{_sasApplyImmediately
                                              :: !(Maybe Bool),
...
stopActivityStream pResourceARN_
  = StopActivityStream'{_sasApplyImmediately = Nothing,
...
instance AWSRequest StopActivityStream where
        type Rs StopActivityStream =
             StopActivityStreamResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "StopActivityStreamResult"
              (\ s h x ->
                 StopActivityStreamResponse' <$>
...
instance Hashable StopActivityStream where

instance NFData StopActivityStream where
...
data StopActivityStreamResponse = StopActivityStreamResponse'{_sasrsStatus
                                                              ::
                                                              !(Maybe
...
stopActivityStreamResponse pResponseStatus_
  = StopActivityStreamResponse'{_sasrsStatus = Nothing,
...
instance NFData StopActivityStreamResponse where
