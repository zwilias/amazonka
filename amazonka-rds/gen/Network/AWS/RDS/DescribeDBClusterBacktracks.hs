...
ddcbBacktrackIdentifier =
  lens _ddcbBacktrackIdentifier (\s a -> s {_ddcbBacktrackIdentifier = a})
...
ddcbFilters =
  lens _ddcbFilters (\s a -> s {_ddcbFilters = a}) . _Default . _Coerce
...
ddcbDBClusterIdentifier =
  lens _ddcbDBClusterIdentifier (\s a -> s {_ddcbDBClusterIdentifier = a})

instance AWSRequest DescribeDBClusterBacktracks where
  type Rs DescribeDBClusterBacktracks = DescribeDBClusterBacktracksResponse
  request = postQuery rds
  response =
    receiveXMLWrapper
      "DescribeDBClusterBacktracksResult"
      (\s h x ->
         DescribeDBClusterBacktracksResponse' <$> (x .@? "Marker") <*>
...
ddcbrsDBClusterBacktracks ::
     Lens' DescribeDBClusterBacktracksResponse [DBClusterBacktrack]
ddcbrsDBClusterBacktracks =
  lens _ddcbrsDBClusterBacktracks (\s a -> s {_ddcbrsDBClusterBacktracks = a}) .
  _Default . _Coerce

-- | -- | The response status code.
ddcbrsResponseStatus :: Lens' DescribeDBClusterBacktracksResponse Int
ddcbrsResponseStatus =
  lens _ddcbrsResponseStatus (\s a -> s {_ddcbrsResponseStatus = a})
