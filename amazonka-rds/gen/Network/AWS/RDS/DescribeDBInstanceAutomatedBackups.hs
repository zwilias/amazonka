...
data DescribeDBInstanceAutomatedBackups = DescribeDBInstanceAutomatedBackups'{_ddbiabFilters
                                                                              ::
                                                                              !(Maybe
                                                                                  [Filter]),
...
describeDBInstanceAutomatedBackups
    :: DescribeDBInstanceAutomatedBackups
describeDBInstanceAutomatedBackups
  = DescribeDBInstanceAutomatedBackups'{_ddbiabFilters
                                          = Nothing,
...
data DescribeDBInstanceAutomatedBackupsResponse = DescribeDBInstanceAutomatedBackupsResponse'{_ddiabrsDBInstanceAutomatedBackups
                                                                                              ::
                                                                                              !(Maybe
...
describeDBInstanceAutomatedBackupsResponse
  pResponseStatus_
  = DescribeDBInstanceAutomatedBackupsResponse'{_ddiabrsDBInstanceAutomatedBackups
                                                  = Nothing,
