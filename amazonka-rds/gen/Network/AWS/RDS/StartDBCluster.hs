...
newtype StartDBCluster = StartDBCluster'{_sdcDBClusterIdentifier
                                         :: Text}
...
startDBCluster pDBClusterIdentifier_
  = StartDBCluster'{_sdcDBClusterIdentifier =
...
data StartDBClusterResponse = StartDBClusterResponse'{_sdcrsDBCluster
                                                      :: !(Maybe DBCluster),
                                                      _sdcrsResponseStatus ::
                                                      !Int}
...
startDBClusterResponse pResponseStatus_
  = StartDBClusterResponse'{_sdcrsDBCluster = Nothing,
