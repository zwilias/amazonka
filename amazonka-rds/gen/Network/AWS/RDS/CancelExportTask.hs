...
newtype CancelExportTask = CancelExportTask'{_cetExportTaskIdentifier
                                             :: Text}
...
cancelExportTask
    :: Text -- ^ 'cetExportTaskIdentifier'
    -> CancelExportTask
cancelExportTask pExportTaskIdentifier_
  = CancelExportTask'{_cetExportTaskIdentifier =
...
instance AWSRequest CancelExportTask where
        ...
        response
          = receiveXMLWrapper "CancelExportTaskResult"
              (\ s h x -> parseXML x)
