...
cdpgSourceDBParameterGroupIdentifier =
  lens
    ...
    (\s a -> s {_cdpgSourceDBParameterGroupIdentifier = a})
...
cdpgTargetDBParameterGroupIdentifier =
  lens
    ...
    (\s a -> s {_cdpgTargetDBParameterGroupIdentifier = a})
...
cdpgTargetDBParameterGroupDescription =
  lens
    _cdpgTargetDBParameterGroupDescription
    (\s a -> s {_cdpgTargetDBParameterGroupDescription = a})
...
instance AWSRequest CopyDBParameterGroup where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CopyDBParameterGroupResponse' <$> (x .@? "DBParameterGroup") <*>
         (pure (fromEnum s)))
...
-- | Undocumented member.
cdbpgrsDBParameterGroup ::
     Lens' CopyDBParameterGroupResponse (Maybe DBParameterGroup)
cdbpgrsDBParameterGroup =
  lens _cdbpgrsDBParameterGroup (\s a -> s {_cdbpgrsDBParameterGroup = a})
