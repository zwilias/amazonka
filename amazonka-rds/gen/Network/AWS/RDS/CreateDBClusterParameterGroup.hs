...
data CreateDBClusterParameterGroup = CreateDBClusterParameterGroup'{_cdcpgTags
                                                                    ::
                                                                    !(Maybe
                                                                        [Tag]),
...
createDBClusterParameterGroup
  ...
  = CreateDBClusterParameterGroup'{_cdcpgTags =
                                     Nothing,
                                   _cdcpgDBClusterParameterGroupName =
                                     pDBClusterParameterGroupName_,
                                   _cdcpgDBParameterGroupFamily =
...
data CreateDBClusterParameterGroupResponse = CreateDBClusterParameterGroupResponse'{_cdbcpgrsDBClusterParameterGroup
                                                                                    ::
                                                                                    !(Maybe
...
createDBClusterParameterGroupResponse
  pResponseStatus_
  = CreateDBClusterParameterGroupResponse'{_cdbcpgrsDBClusterParameterGroup
                                             = Nothing,
                                           _cdbcpgrsResponseStatus =
                                             pResponseStatus_}
