...
rditpitUseLatestRestorableTime ::
     Lens' RestoreDBInstanceToPointInTime (Maybe Bool)
rditpitUseLatestRestorableTime =
  lens
    _rditpitUseLatestRestorableTime
    (\s a -> s {_rditpitUseLatestRestorableTime = a})
...
rditpitPubliclyAccessible =
  lens _rditpitPubliclyAccessible (\s a -> s {_rditpitPubliclyAccessible = a})
...
rditpitAutoMinorVersionUpgrade =
  lens
    ...
    (\s a -> s {_rditpitAutoMinorVersionUpgrade = a})
...
rditpitDBSubnetGroupName =
  lens _rditpitDBSubnetGroupName (\s a -> s {_rditpitDBSubnetGroupName = a})
...
rditpitRestoreTime =
  lens _rditpitRestoreTime (\s a -> s {_rditpitRestoreTime = a}) . mapping _Time
...
rditpitTDECredentialPassword ::
     Lens' RestoreDBInstanceToPointInTime (Maybe Text)
rditpitTDECredentialPassword =
  lens
    _rditpitTDECredentialPassword
    (\s a -> s {_rditpitTDECredentialPassword = a})

-- | The compute and memory capacity of the Amazon RDS DB instance, for example, @db.m4.large@ . Not all DB instance classes are available in all AWS Regions, or for all database engines. For the full list of DB instance classes, and availability for your engine, see <http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html DB Instance Class> in the Amazon RDS User Guide.  Default: The same DBInstanceClass as the original DB instance.
rditpitDBInstanceClass :: Lens' RestoreDBInstanceToPointInTime (Maybe Text)
rditpitDBInstanceClass =
  lens _rditpitDBInstanceClass (\s a -> s {_rditpitDBInstanceClass = a})
...
rditpitLicenseModel =
  lens _rditpitLicenseModel (\s a -> s {_rditpitLicenseModel = a})
...
rditpitAvailabilityZone =
  lens _rditpitAvailabilityZone (\s a -> s {_rditpitAvailabilityZone = a})
...
rditpitOptionGroupName =
  lens _rditpitOptionGroupName (\s a -> s {_rditpitOptionGroupName = a})
...
rditpitCopyTagsToSnapshot =
  lens _rditpitCopyTagsToSnapshot (\s a -> s {_rditpitCopyTagsToSnapshot = a})

-- | The ARN from the key store with which to associate the instance for TDE encryption.
rditpitTDECredentialARN :: Lens' RestoreDBInstanceToPointInTime (Maybe Text)
rditpitTDECredentialARN =
  lens _rditpitTDECredentialARN (\s a -> s {_rditpitTDECredentialARN = a})

-- | Specify the name of the IAM role to be used when making API calls to the Directory Service.
rditpitDomainIAMRoleName :: Lens' RestoreDBInstanceToPointInTime (Maybe Text)
rditpitDomainIAMRoleName =
  lens _rditpitDomainIAMRoleName (\s a -> s {_rditpitDomainIAMRoleName = a})

-- | Undocumented member.
rditpitTags :: Lens' RestoreDBInstanceToPointInTime [Tag]
rditpitTags =
  lens _rditpitTags (\s a -> s {_rditpitTags = a}) . _Default . _Coerce
...
rditpitEnableIAMDatabaseAuthentication =
  lens
    ...
    (\s a -> s {_rditpitEnableIAMDatabaseAuthentication = a})
...
rditpitStorageType =
  lens _rditpitStorageType (\s a -> s {_rditpitStorageType = a})

-- | The list of logs that the restored DB instance is to export to CloudWatch Logs.
rditpitEnableCloudwatchLogsExports ::
     Lens' RestoreDBInstanceToPointInTime [Text]
rditpitEnableCloudwatchLogsExports =
  lens
    _rditpitEnableCloudwatchLogsExports
    (\s a -> s {_rditpitEnableCloudwatchLogsExports = a}) .
  _Default . _Coerce
...
rditpitSourceDBInstanceIdentifier =
  lens
    ...
    (\s a -> s {_rditpitSourceDBInstanceIdentifier = a})
...
rditpitTargetDBInstanceIdentifier =
  lens
    ...
    (\s a -> s {_rditpitTargetDBInstanceIdentifier = a})
...
instance AWSRequest RestoreDBInstanceToPointInTime where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         RestoreDBInstanceToPointInTimeResponse' <$> (x .@? "DBInstance") <*>
         (pure (fromEnum s)))
  ...
  toQuery RestoreDBInstanceToPointInTime' {..} =
    mconcat
      ...
      , "EnableCloudwatchLogsExports" =:
        toQuery (toQueryList "member" <$> _rditpitEnableCloudwatchLogsExports)
...
-- | Undocumented member.
rditpitrsDBInstance ::
     Lens' RestoreDBInstanceToPointInTimeResponse (Maybe DBInstance)
rditpitrsDBInstance =
  lens _rditpitrsDBInstance (\s a -> s {_rditpitrsDBInstance = a})

-- | -- | The response status code.
rditpitrsResponseStatus :: Lens' RestoreDBInstanceToPointInTimeResponse Int
rditpitrsResponseStatus =
  lens _rditpitrsResponseStatus (\s a -> s {_rditpitrsResponseStatus = a})
