...
data RestoreDBInstanceToPointInTime = RestoreDBInstanceToPointInTime'{_rditpitDeletionProtection
                                                                      ::
                                                                      !(Maybe
                                                                          Bool),
...
--
-- * 'rditpitPubliclyAccessible' - A value that indicates whether the DB instance is publicly accessible. When the DB instance is publicly accessible, it is an Internet-facing instance with a publicly resolvable DNS name, which resolves to a public IP address. When the DB instance isn't publicly accessible, it is an internal instance with a DNS name that resolves to a private IP address. For more information, see 'CreateDBInstance' .
--
...
restoreDBInstanceToPointInTime
  ...
  = RestoreDBInstanceToPointInTime'{_rditpitDeletionProtection
                                      = Nothing,
