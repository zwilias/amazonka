...
data DescribeReservedDBInstances = DescribeReservedDBInstances'{_drdiProductDescription
                                                                ::
                                                                !(Maybe Text),
                                                                _drdiFilters ::
                                                                !(Maybe
...
data DescribeReservedDBInstancesResponse = DescribeReservedDBInstancesResponse'{_drdirsReservedDBInstances
                                                                                ::
                                                                                !(Maybe
                                                                                    [ReservedDBInstance]),
                                                                                _drdirsMarker
...
describeReservedDBInstancesResponse pResponseStatus_
  = DescribeReservedDBInstancesResponse'{_drdirsReservedDBInstances
                                           = Nothing,
