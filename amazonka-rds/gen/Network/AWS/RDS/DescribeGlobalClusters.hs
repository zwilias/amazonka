...
data DescribeGlobalClusters = DescribeGlobalClusters'{_dgcsGlobalClusterIdentifier
                                                      :: !(Maybe Text),
                                                      _dgcsFilters ::
                                                      !(Maybe [Filter]),
                                                      _dgcsMarker ::
...
describeGlobalClusters
    :: DescribeGlobalClusters
describeGlobalClusters
  = DescribeGlobalClusters'{_dgcsGlobalClusterIdentifier
                              = Nothing,
                            _dgcsFilters = Nothing, _dgcsMarker = Nothing,
...
data DescribeGlobalClustersResponse = DescribeGlobalClustersResponse'{_drsGlobalClusters
                                                                      ::
                                                                      !(Maybe
                                                                          [GlobalCluster]),
                                                                      _drsMarker
...
describeGlobalClustersResponse pResponseStatus_
  = DescribeGlobalClustersResponse'{_drsGlobalClusters
                                      = Nothing,
                                    _drsMarker = Nothing,
