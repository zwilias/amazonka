...
ddlfFilenameContains =
  lens _ddlfFilenameContains (\s a -> s {_ddlfFilenameContains = a})

-- | This parameter is not currently supported.
ddlfFilters :: Lens' DescribeDBLogFiles [Filter]
ddlfFilters =
  lens _ddlfFilters (\s a -> s {_ddlfFilters = a}) . _Default . _Coerce
...
ddlfFileLastWritten =
  lens _ddlfFileLastWritten (\s a -> s {_ddlfFileLastWritten = a})
...
ddlfDBInstanceIdentifier =
  lens _ddlfDBInstanceIdentifier (\s a -> s {_ddlfDBInstanceIdentifier = a})
...
ddlfrsDescribeDBLogFiles ::
     Lens' DescribeDBLogFilesResponse [DescribeDBLogFilesDetails]
ddlfrsDescribeDBLogFiles =
  lens _ddlfrsDescribeDBLogFiles (\s a -> s {_ddlfrsDescribeDBLogFiles = a}) .
  _Default . _Coerce
...
ddlfrsResponseStatus =
  lens _ddlfrsResponseStatus (\s a -> s {_ddlfrsResponseStatus = a})
