...
data RestoreDBInstanceFromS3 = RestoreDBInstanceFromS3'{_rdifsEngineVersion
                                                        :: !(Maybe Text),
...
restoreDBInstanceFromS3
    ...
    -> RestoreDBInstanceFromS3
restoreDBInstanceFromS3 pDBInstanceIdentifier_
  pDBInstanceClass_ pEngine_ pSourceEngine_
  pSourceEngineVersion_ pS3BucketName_
  pS3IngestionRoleARN_
  = RestoreDBInstanceFromS3'{_rdifsEngineVersion =
                               Nothing,
...
data RestoreDBInstanceFromS3Response = RestoreDBInstanceFromS3Response'{_rdifsrsDBInstance
                                                                        ::
                                                                        !(Maybe
                                                                            DBInstance),
...
restoreDBInstanceFromS3Response pResponseStatus_
  = RestoreDBInstanceFromS3Response'{_rdifsrsDBInstance
                                       = Nothing,
