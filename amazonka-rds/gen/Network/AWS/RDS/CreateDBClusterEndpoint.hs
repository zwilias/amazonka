...
data CreateDBClusterEndpoint = CreateDBClusterEndpoint'{_cdceStaticMembers
                                                        :: !(Maybe [Text]),
...
createDBClusterEndpoint
    ...
    -> CreateDBClusterEndpoint
createDBClusterEndpoint pDBClusterIdentifier_
  pDBClusterEndpointIdentifier_ pEndpointType_
  = CreateDBClusterEndpoint'{_cdceStaticMembers =
                               Nothing,
