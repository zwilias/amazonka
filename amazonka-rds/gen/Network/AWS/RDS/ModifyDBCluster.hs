...
--
-- * 'mdcDomain' - The Active Directory directory ID to move the DB cluster to. Specify @none@ to remove the cluster from its current domain. The domain must be created prior to this operation. 
--
...
modifyDBCluster pDBClusterIdentifier_
  = ModifyDBCluster'{_mdcEngineVersion = Nothing,
                     ...
                     _mdcDomain = Nothing, _mdcBacktrackWindow = Nothing,
                     ...
                     _mdcDomainIAMRoleName = Nothing, _mdcPort = Nothing,
