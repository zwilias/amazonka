...
dedcpFilters =
  lens _dedcpFilters (\s a -> s {_dedcpFilters = a}) . _Default . _Coerce
...
dedcpDBParameterGroupFamily =
  lens
    ...
    (\s a -> s {_dedcpDBParameterGroupFamily = a})

instance AWSRequest DescribeEngineDefaultClusterParameters where
  type Rs DescribeEngineDefaultClusterParameters = DescribeEngineDefaultClusterParametersResponse
...
instance ToQuery DescribeEngineDefaultClusterParameters where
  toQuery DescribeEngineDefaultClusterParameters' {..} =
    mconcat
      [ "Action" =: ("DescribeEngineDefaultClusterParameters" :: ByteString)
...
-- | Undocumented member.
dedcprsEngineDefaults ::
     Lens' DescribeEngineDefaultClusterParametersResponse (Maybe EngineDefaults)
dedcprsEngineDefaults =
  lens _dedcprsEngineDefaults (\s a -> s {_dedcprsEngineDefaults = a})

-- | -- | The response status code.
dedcprsResponseStatus ::
     Lens' DescribeEngineDefaultClusterParametersResponse Int
dedcprsResponseStatus =
  lens _dedcprsResponseStatus (\s a -> s {_dedcprsResponseStatus = a})
