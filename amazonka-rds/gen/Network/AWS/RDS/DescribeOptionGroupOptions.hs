...
dogoFilters =
  lens _dogoFilters (\s a -> s {_dogoFilters = a}) . _Default . _Coerce
...
-- | Undocumented member.
dogorsOptionGroupOptions ::
     Lens' DescribeOptionGroupOptionsResponse [OptionGroupOption]
dogorsOptionGroupOptions =
  lens _dogorsOptionGroupOptions (\s a -> s {_dogorsOptionGroupOptions = a}) .
  _Default . _Coerce
...
dogorsResponseStatus =
  lens _dogorsResponseStatus (\s a -> s {_dogorsResponseStatus = a})
