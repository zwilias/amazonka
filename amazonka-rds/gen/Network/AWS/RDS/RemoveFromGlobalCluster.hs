...
data RemoveFromGlobalCluster = RemoveFromGlobalCluster'{_rfgcDBClusterIdentifier
                                                        :: !(Maybe Text),
...
removeFromGlobalCluster
    :: RemoveFromGlobalCluster
removeFromGlobalCluster
  = RemoveFromGlobalCluster'{_rfgcDBClusterIdentifier =
                               Nothing,
...
data RemoveFromGlobalClusterResponse = RemoveFromGlobalClusterResponse'{_rfgcrsGlobalCluster
                                                                        ::
                                                                        !(Maybe
                                                                            GlobalCluster),
...
removeFromGlobalClusterResponse pResponseStatus_
  = RemoveFromGlobalClusterResponse'{_rfgcrsGlobalCluster
                                       = Nothing,
