...
rdcfsEngineVersion =
  lens _rdcfsEngineVersion (\s a -> s {_rdcfsEngineVersion = a})

-- | Specifies whether the restored DB cluster is encrypted.
rdcfsStorageEncrypted :: Lens' RestoreDBClusterFromS3 (Maybe Bool)
rdcfsStorageEncrypted =
  lens _rdcfsStorageEncrypted (\s a -> s {_rdcfsStorageEncrypted = a})
...
rdcfsDBSubnetGroupName =
  lens _rdcfsDBSubnetGroupName (\s a -> s {_rdcfsDBSubnetGroupName = a})
...
rdcfsBacktrackWindow =
  lens _rdcfsBacktrackWindow (\s a -> s {_rdcfsBacktrackWindow = a})
...
rdcfsPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_rdcfsPreferredMaintenanceWindow = a})
...
rdcfsAvailabilityZones =
  lens _rdcfsAvailabilityZones (\s a -> s {_rdcfsAvailabilityZones = a}) .
  _Default . _Coerce

-- | A value that indicates that the restored DB cluster should be associated with the specified CharacterSet.
rdcfsCharacterSetName :: Lens' RestoreDBClusterFromS3 (Maybe Text)
rdcfsCharacterSetName =
  lens _rdcfsCharacterSetName (\s a -> s {_rdcfsCharacterSetName = a})
...
rdcfsPreferredBackupWindow =
  lens _rdcfsPreferredBackupWindow (\s a -> s {_rdcfsPreferredBackupWindow = a})
...
rdcfsBackupRetentionPeriod =
  lens _rdcfsBackupRetentionPeriod (\s a -> s {_rdcfsBackupRetentionPeriod = a})

-- | A list of EC2 VPC security groups to associate with the restored DB cluster.
rdcfsVPCSecurityGroupIds :: Lens' RestoreDBClusterFromS3 [Text]
rdcfsVPCSecurityGroupIds =
  lens _rdcfsVPCSecurityGroupIds (\s a -> s {_rdcfsVPCSecurityGroupIds = a}) .
  _Default . _Coerce
...
rdcfsDBClusterParameterGroupName =
  lens
    ...
    (\s a -> s {_rdcfsDBClusterParameterGroupName = a})
...
rdcfsOptionGroupName =
  lens _rdcfsOptionGroupName (\s a -> s {_rdcfsOptionGroupName = a})
...
rdcfsEnableIAMDatabaseAuthentication ::
     Lens' RestoreDBClusterFromS3 (Maybe Bool)
rdcfsEnableIAMDatabaseAuthentication =
  lens
    _rdcfsEnableIAMDatabaseAuthentication
    (\s a -> s {_rdcfsEnableIAMDatabaseAuthentication = a})
...
rdcfsDBClusterIdentifier =
  lens _rdcfsDBClusterIdentifier (\s a -> s {_rdcfsDBClusterIdentifier = a})
...
rdcfsMasterUsername =
  lens _rdcfsMasterUsername (\s a -> s {_rdcfsMasterUsername = a})

-- | The password for the master database user. This password can contain any printable ASCII character except "/", """, or "@". Constraints: Must contain from 8 to 41 characters.
rdcfsMasterUserPassword :: Lens' RestoreDBClusterFromS3 Text
rdcfsMasterUserPassword =
  lens _rdcfsMasterUserPassword (\s a -> s {_rdcfsMasterUserPassword = a})
...
rdcfsSourceEngineVersion =
  lens _rdcfsSourceEngineVersion (\s a -> s {_rdcfsSourceEngineVersion = a})
...
rdcfsS3IngestionRoleARN =
  lens _rdcfsS3IngestionRoleARN (\s a -> s {_rdcfsS3IngestionRoleARN = a})
...
instance AWSRequest RestoreDBClusterFromS3 where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         RestoreDBClusterFromS3Response' <$> (x .@? "DBCluster") <*>
         (pure (fromEnum s)))
...
instance ToQuery RestoreDBClusterFromS3 where
  toQuery RestoreDBClusterFromS3' {..} =
    mconcat
      ...
      , "AvailabilityZones" =:
        toQuery (toQueryList "AvailabilityZone" <$> _rdcfsAvailabilityZones)
      ...
      , "VpcSecurityGroupIds" =:
        toQuery (toQueryList "VpcSecurityGroupId" <$> _rdcfsVPCSecurityGroupIds)
...
rdcfsrsResponseStatus =
  lens _rdcfsrsResponseStatus (\s a -> s {_rdcfsrsResponseStatus = a})
