...
data ScalingConfiguration = ScalingConfiguration'{_scSecondsUntilAutoPause
                                                  :: !(Maybe Int),
                                                  _scTimeoutAction ::
                                                  !(Maybe Text),
...
scalingConfiguration
    :: ScalingConfiguration
scalingConfiguration
  = ScalingConfiguration'{_scSecondsUntilAutoPause =
                            Nothing,
                          _scTimeoutAction = Nothing, _scAutoPause = Nothing,
                          _scMaxCapacity = Nothing, _scMinCapacity = Nothing}
