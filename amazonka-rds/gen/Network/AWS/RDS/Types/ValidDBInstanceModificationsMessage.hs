...
data ValidDBInstanceModificationsMessage = ValidDBInstanceModificationsMessage'{_vdimmValidProcessorFeatures
                                                                                ::
                                                                                !(Maybe
...
validDBInstanceModificationsMessage
    :: ValidDBInstanceModificationsMessage
validDBInstanceModificationsMessage
  = ValidDBInstanceModificationsMessage'{_vdimmValidProcessorFeatures
                                           = Nothing,
