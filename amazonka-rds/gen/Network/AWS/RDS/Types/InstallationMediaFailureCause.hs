...
newtype InstallationMediaFailureCause = InstallationMediaFailureCause'{_imfcMessage
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
installationMediaFailureCause
    :: InstallationMediaFailureCause
installationMediaFailureCause
  = InstallationMediaFailureCause'{_imfcMessage =
                                     Nothing}
...
instance Hashable InstallationMediaFailureCause where

instance NFData InstallationMediaFailureCause where
