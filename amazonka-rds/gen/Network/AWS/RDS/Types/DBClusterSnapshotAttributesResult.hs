...
data DBClusterSnapshotAttributesResult = DBClusterSnapshotAttributesResult'{_dcsarDBClusterSnapshotIdentifier
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
dbClusterSnapshotAttributesResult
    :: DBClusterSnapshotAttributesResult
dbClusterSnapshotAttributesResult
  = DBClusterSnapshotAttributesResult'{_dcsarDBClusterSnapshotIdentifier
                                         = Nothing,
                                       _dcsarDBClusterSnapshotAttributes =
                                         Nothing}
