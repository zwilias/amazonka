...
data MinimumEngineVersionPerAllowedValue = MinimumEngineVersionPerAllowedValue'{_mevpavMinimumEngineVersion
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
                                                                                _mevpavAllowedValue
...
minimumEngineVersionPerAllowedValue
    :: MinimumEngineVersionPerAllowedValue
minimumEngineVersionPerAllowedValue
  = MinimumEngineVersionPerAllowedValue'{_mevpavMinimumEngineVersion
                                           = Nothing,
