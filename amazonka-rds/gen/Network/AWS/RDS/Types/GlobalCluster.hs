...
data GlobalCluster = GlobalCluster'{_gcEngineVersion
                                    :: !(Maybe Text),
...
globalCluster
    :: GlobalCluster
globalCluster
  = GlobalCluster'{_gcEngineVersion = Nothing,
                   _gcStatus = Nothing, _gcDeletionProtection = Nothing,
                   _gcStorageEncrypted = Nothing,
                   _gcGlobalClusterIdentifier = Nothing,
                   _gcEngine = Nothing, _gcGlobalClusterARN = Nothing,
