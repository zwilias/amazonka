...
data DBInstanceAutomatedBackup = DBInstanceAutomatedBackup'{_diabRestoreWindow
                                                            ::
                                                            !(Maybe
                                                                RestoreWindow),
                                                            _diabEngineVersion
...
dbInstanceAutomatedBackup
    :: DBInstanceAutomatedBackup
dbInstanceAutomatedBackup
  = DBInstanceAutomatedBackup'{_diabRestoreWindow =
                                 Nothing,
                               ...
                               _diabIOPS = Nothing, _diabVPCId = Nothing,
                               _diabInstanceCreateTime = Nothing,
                               _diabEngine = Nothing, _diabEncrypted = Nothing,
                               ...
                               _diabPort = Nothing, _diabStorageType = Nothing}
