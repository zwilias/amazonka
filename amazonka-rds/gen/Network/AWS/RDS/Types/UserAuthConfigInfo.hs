...
data UserAuthConfigInfo = UserAuthConfigInfo'{_uaciIAMAuth
                                              :: !(Maybe IAMAuthMode),
...
userAuthConfigInfo
    :: UserAuthConfigInfo
userAuthConfigInfo
  = UserAuthConfigInfo'{_uaciIAMAuth = Nothing,
                        _uaciUserName = Nothing, _uaciAuthScheme = Nothing,
                        _uaciSecretARN = Nothing, _uaciDescription = Nothing}
...
instance FromXML UserAuthConfigInfo where
        parseXML x
          = UserAuthConfigInfo' <$>
              (x .@? "IAMAuth") <*> (x .@? "UserName") <*>
                (x .@? "AuthScheme")
                <*> (x .@? "SecretArn")
                <*> (x .@? "Description")

instance Hashable UserAuthConfigInfo where

instance NFData UserAuthConfigInfo where
