...
data CustomAvailabilityZone = CustomAvailabilityZone'{_cazVPNDetails
                                                      :: !(Maybe VPNDetails),
...
customAvailabilityZone
    :: CustomAvailabilityZone
customAvailabilityZone
  = CustomAvailabilityZone'{_cazVPNDetails = Nothing,
...
instance Hashable CustomAvailabilityZone where

instance NFData CustomAvailabilityZone where
