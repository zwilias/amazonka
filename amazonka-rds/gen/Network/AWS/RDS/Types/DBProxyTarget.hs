...
data DBProxyTarget = DBProxyTarget'{_dptTargetARN ::
                                    !(Maybe Text),
...
dbProxyTarget
    :: DBProxyTarget
dbProxyTarget
  = DBProxyTarget'{_dptTargetARN = Nothing,
                   _dptTargetHealth = Nothing,
                   _dptTrackedClusterId = Nothing,
                   _dptRDSResourceId = Nothing, _dptType = Nothing,
                   _dptEndpoint = Nothing, _dptPort = Nothing}
...
instance Hashable DBProxyTarget where

instance NFData DBProxyTarget where
