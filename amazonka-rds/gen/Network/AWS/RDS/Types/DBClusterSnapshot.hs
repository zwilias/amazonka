...
data DBClusterSnapshot = DBClusterSnapshot'{_dcsEngineVersion
                                            :: !(Maybe Text),
...
dbClusterSnapshot
    :: DBClusterSnapshot
dbClusterSnapshot
  = DBClusterSnapshot'{_dcsEngineVersion = Nothing,
                       _dcsStatus = Nothing, _dcsStorageEncrypted = Nothing,
                       ...
                       _dcsEngine = Nothing, _dcsLicenseModel = Nothing,
                       _dcsAvailabilityZones = Nothing,
                       _dcsSnapshotType = Nothing, _dcsKMSKeyId = Nothing,
                       ...
                       _dcsPercentProgress = Nothing, _dcsPort = Nothing}
