...
data InstallationMedia = InstallationMedia'{_imEngineVersion
                                            :: !(Maybe Text),
...
installationMedia
    :: InstallationMedia
installationMedia
  = InstallationMedia'{_imEngineVersion = Nothing,
                       _imStatus = Nothing,
...
instance Hashable InstallationMedia where

instance NFData InstallationMedia where
