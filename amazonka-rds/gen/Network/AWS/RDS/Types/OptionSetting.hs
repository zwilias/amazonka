...
data OptionSetting = OptionSetting'{_osIsCollection
                                    :: !(Maybe Bool),
...
optionSetting
    :: OptionSetting
optionSetting
  = OptionSetting'{_osIsCollection = Nothing,
                   _osApplyType = Nothing, _osValue = Nothing,
                   _osName = Nothing, _osDefaultValue = Nothing,
                   _osIsModifiable = Nothing, _osDataType = Nothing,
                   _osAllowedValues = Nothing, _osDescription = Nothing}
