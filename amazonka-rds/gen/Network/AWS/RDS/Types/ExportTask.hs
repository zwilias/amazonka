...
data ExportTask = ExportTask'{_etTotalExtractedDataInGB
                              :: !(Maybe Int),
...
exportTask
    :: ExportTask
exportTask
  = ExportTask'{_etTotalExtractedDataInGB = Nothing,
                _etStatus = Nothing, _etIAMRoleARN = Nothing,
                _etSourceARN = Nothing, _etExportOnly = Nothing,
                _etTaskStartTime = Nothing,
                _etWarningMessage = Nothing,
                _etSnapshotTime = Nothing, _etKMSKeyId = Nothing,
                _etTaskEndTime = Nothing,
                _etExportTaskIdentifier = Nothing,
                _etS3Prefix = Nothing, _etPercentProgress = Nothing,
                _etS3Bucket = Nothing, _etFailureCause = Nothing}
...
instance FromXML ExportTask where
        parseXML x
          = ExportTask' <$>
              (x .@? "TotalExtractedDataInGB") <*> (x .@? "Status")
                <*> (x .@? "IamRoleArn")
                <*> (x .@? "SourceArn")
                <*>
                (x .@? "ExportOnly" .!@ mempty >>=
