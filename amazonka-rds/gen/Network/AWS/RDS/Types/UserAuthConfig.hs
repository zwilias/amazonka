...
data UserAuthConfig = UserAuthConfig'{_uacIAMAuth ::
                                      !(Maybe IAMAuthMode),
...
userAuthConfig
    :: UserAuthConfig
userAuthConfig
  = UserAuthConfig'{_uacIAMAuth = Nothing,
                    _uacUserName = Nothing, _uacAuthScheme = Nothing,
                    _uacSecretARN = Nothing, _uacDescription = Nothing}
...
instance Hashable UserAuthConfig where

instance NFData UserAuthConfig where
