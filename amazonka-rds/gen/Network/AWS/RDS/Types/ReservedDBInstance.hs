...
data ReservedDBInstance = ReservedDBInstance'{_rdiDBInstanceCount
                                              :: !(Maybe Int),
...
reservedDBInstance
    :: ReservedDBInstance
reservedDBInstance
  = ReservedDBInstance'{_rdiDBInstanceCount = Nothing,
                        ...
                        _rdiOfferingType = Nothing, _rdiUsagePrice = Nothing,
                        _rdiFixedPrice = Nothing, _rdiDuration = Nothing}
