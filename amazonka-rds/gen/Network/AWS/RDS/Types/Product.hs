...
instance FromXML Certificate where
  parseXML x =
    Certificate' <$> (x .@? "CertificateType") <*> (x .@? "CertificateArn") <*>
    (x .@? "ValidTill") <*>
...
csCharacterSetDescription =
  lens _csCharacterSetDescription (\s a -> s {_csCharacterSetDescription = a})

instance FromXML CharacterSet where
  parseXML x =
    CharacterSet' <$> (x .@? "CharacterSetName") <*>
...
clecDisableLogTypes =
  lens _clecDisableLogTypes (\s a -> s {_clecDisableLogTypes = a}) .
  _Default . _Coerce

-- | The list of log types to enable.
clecEnableLogTypes :: Lens' CloudwatchLogsExportConfiguration [Text]
clecEnableLogTypes =
  lens _clecEnableLogTypes (\s a -> s {_clecEnableLogTypes = a}) .
  _Default . _Coerce
...
dcBacktrackConsumedChangeRecords =
  lens
    ...
    (\s a -> s {_dcBacktrackConsumedChangeRecords = a})
...
dcReplicationSourceIdentifier =
  lens
    _dcReplicationSourceIdentifier
    (\s a -> s {_dcReplicationSourceIdentifier = a})
...
dcDBClusterParameterGroup =
  lens _dcDBClusterParameterGroup (\s a -> s {_dcDBClusterParameterGroup = a})
...
dcIAMDatabaseAuthenticationEnabled =
  lens
    ...
    (\s a -> s {_dcIAMDatabaseAuthenticationEnabled = a})

-- | The earliest time to which a DB cluster can be backtracked.
dcEarliestBacktrackTime :: Lens' DBCluster (Maybe UTCTime)
dcEarliestBacktrackTime =
  lens _dcEarliestBacktrackTime (\s a -> s {_dcEarliestBacktrackTime = a}) .
  mapping _Time
...
dcDBClusterResourceId =
  lens _dcDBClusterResourceId (\s a -> s {_dcDBClusterResourceId = a})

-- | The earliest time to which a database can be restored with point-in-time restore.
dcEarliestRestorableTime :: Lens' DBCluster (Maybe UTCTime)
dcEarliestRestorableTime =
  lens _dcEarliestRestorableTime (\s a -> s {_dcEarliestRestorableTime = a}) .
  mapping _Time
...
dcLatestRestorableTime =
  lens _dcLatestRestorableTime (\s a -> s {_dcLatestRestorableTime = a}) .
  mapping _Time
...
dcPreferredMaintenanceWindow =
  lens
    _dcPreferredMaintenanceWindow
    (\s a -> s {_dcPreferredMaintenanceWindow = a})

-- | Provides the list of EC2 Availability Zones that instances in the DB cluster can be created in.
dcAvailabilityZones :: Lens' DBCluster [Text]
dcAvailabilityZones =
  lens _dcAvailabilityZones (\s a -> s {_dcAvailabilityZones = a}) .
  _Default . _Coerce

-- | If present, specifies the name of the character set that this cluster is associated with.
dcCharacterSetName :: Lens' DBCluster (Maybe Text)
dcCharacterSetName =
  lens _dcCharacterSetName (\s a -> s {_dcCharacterSetName = a})
...
dcAllocatedStorage =
  lens _dcAllocatedStorage (\s a -> s {_dcAllocatedStorage = a})

-- | Specifies the time when the DB cluster was created, in Universal Coordinated Time (UTC).
dcClusterCreateTime :: Lens' DBCluster (Maybe UTCTime)
dcClusterCreateTime =
  lens _dcClusterCreateTime (\s a -> s {_dcClusterCreateTime = a}) .
  mapping _Time
...
dcDBClusterOptionGroupMemberships ::
     Lens' DBCluster [DBClusterOptionGroupStatus]
dcDBClusterOptionGroupMemberships =
  lens
    _dcDBClusterOptionGroupMemberships
    (\s a -> s {_dcDBClusterOptionGroupMemberships = a}) .
  _Default . _Coerce

instance FromXML DBCluster where
  parseXML x =
    DBCluster' <$> (x .@? "BacktrackConsumedChangeRecords") <*>
    (x .@? "EngineVersion") <*>
    (x .@? "Status") <*>
    (x .@? "StorageEncrypted") <*>
    ...
    (x .@? "AssociatedRoles" .!@ mempty >>= may (parseXMLList "DBClusterRole")) <*>
...
dcbBacktrackIdentifier =
  lens _dcbBacktrackIdentifier (\s a -> s {_dcbBacktrackIdentifier = a})

-- | The timestamp of the time to which the DB cluster was backtracked.
dcbBacktrackTo :: Lens' DBClusterBacktrack (Maybe UTCTime)
dcbBacktrackTo =
  lens _dcbBacktrackTo (\s a -> s {_dcbBacktrackTo = a}) . mapping _Time

-- | Contains a user-supplied DB cluster identifier. This identifier is the unique key that identifies a DB cluster.
dcbDBClusterIdentifier :: Lens' DBClusterBacktrack (Maybe Text)
dcbDBClusterIdentifier =
  lens _dcbDBClusterIdentifier (\s a -> s {_dcbDBClusterIdentifier = a})

-- | The timestamp of the time from which the DB cluster was backtracked.
dcbBacktrackedFrom :: Lens' DBClusterBacktrack (Maybe UTCTime)
dcbBacktrackedFrom =
  lens _dcbBacktrackedFrom (\s a -> s {_dcbBacktrackedFrom = a}) . mapping _Time
...
dcbBacktrackRequestCreationTime =
  lens
    ...
    (\s a -> s {_dcbBacktrackRequestCreationTime = a}) .
  mapping _Time

instance FromXML DBClusterBacktrack where
  parseXML x =
    DBClusterBacktrack' <$> (x .@? "Status") <*> (x .@? "BacktrackIdentifier") <*>
    (x .@? "BacktrackTo") <*>
    (x .@? "DBClusterIdentifier") <*>
    (x .@? "BacktrackedFrom") <*>
...
dcmDBInstanceIdentifier =
  lens _dcmDBInstanceIdentifier (\s a -> s {_dcmDBInstanceIdentifier = a})

-- | Value that is @true@ if the cluster member is the primary instance for the DB cluster and @false@ otherwise.
dcmIsClusterWriter :: Lens' DBClusterMember (Maybe Bool)
dcmIsClusterWriter =
  lens _dcmIsClusterWriter (\s a -> s {_dcmIsClusterWriter = a})
...
dcmDBClusterParameterGroupStatus =
  lens
    ...
    (\s a -> s {_dcmDBClusterParameterGroupStatus = a})

instance FromXML DBClusterMember where
  parseXML x =
    DBClusterMember' <$> (x .@? "PromotionTier") <*>
...
dcogsDBClusterOptionGroupName =
  lens
    ...
    (\s a -> s {_dcogsDBClusterOptionGroupName = a})

instance FromXML DBClusterOptionGroupStatus where
  parseXML x =
    DBClusterOptionGroupStatus' <$> (x .@? "Status") <*>
...
dcpgDBClusterParameterGroupName =
  lens
    ...
    (\s a -> s {_dcpgDBClusterParameterGroupName = a})
...
instance FromXML DBClusterParameterGroup where
  parseXML x =
    DBClusterParameterGroup' <$> (x .@? "DBClusterParameterGroupArn") <*>
...
dcpgnmDBClusterParameterGroupName ::
     Lens' DBClusterParameterGroupNameMessage (Maybe Text)
dcpgnmDBClusterParameterGroupName =
  lens
    _dcpgnmDBClusterParameterGroupName
    (\s a -> s {_dcpgnmDBClusterParameterGroupName = a})
...
instance FromXML DBClusterRole where
  parseXML x = DBClusterRole' <$> (x .@? "Status") <*> (x .@? "RoleArn")
...
dcsStorageEncrypted =
  lens _dcsStorageEncrypted (\s a -> s {_dcsStorageEncrypted = a})

-- | Specifies the DB cluster identifier of the DB cluster that this DB cluster snapshot was created from.
dcsDBClusterIdentifier :: Lens' DBClusterSnapshot (Maybe Text)
dcsDBClusterIdentifier =
  lens _dcsDBClusterIdentifier (\s a -> s {_dcsDBClusterIdentifier = a})
...
dcsIAMDatabaseAuthenticationEnabled =
  lens
    ...
    (\s a -> s {_dcsIAMDatabaseAuthenticationEnabled = a})

-- | The Amazon Resource Name (ARN) for the DB cluster snapshot.
dcsDBClusterSnapshotARN :: Lens' DBClusterSnapshot (Maybe Text)
dcsDBClusterSnapshotARN =
  lens _dcsDBClusterSnapshotARN (\s a -> s {_dcsDBClusterSnapshotARN = a})
...
dcsDBClusterSnapshotIdentifier =
  lens
    ...
    (\s a -> s {_dcsDBClusterSnapshotIdentifier = a})
...
dcsAvailabilityZones =
  lens _dcsAvailabilityZones (\s a -> s {_dcsAvailabilityZones = a}) .
  _Default . _Coerce
...
dcsSnapshotCreateTime =
  lens _dcsSnapshotCreateTime (\s a -> s {_dcsSnapshotCreateTime = a}) .
  mapping _Time

-- | Specifies the allocated storage size in gibibytes (GiB).
dcsAllocatedStorage :: Lens' DBClusterSnapshot (Maybe Int)
dcsAllocatedStorage =
  lens _dcsAllocatedStorage (\s a -> s {_dcsAllocatedStorage = a})
...
dcsSourceDBClusterSnapshotARN =
  lens
    ...
    (\s a -> s {_dcsSourceDBClusterSnapshotARN = a})

-- | Specifies the time when the DB cluster was created, in Universal Coordinated Time (UTC).
dcsClusterCreateTime :: Lens' DBClusterSnapshot (Maybe UTCTime)
dcsClusterCreateTime =
  lens _dcsClusterCreateTime (\s a -> s {_dcsClusterCreateTime = a}) .
  mapping _Time

-- | Specifies the percentage of the estimated data that has been transferred.
dcsPercentProgress :: Lens' DBClusterSnapshot (Maybe Int)
dcsPercentProgress =
  lens _dcsPercentProgress (\s a -> s {_dcsPercentProgress = a})
...
instance FromXML DBClusterSnapshot where
  parseXML x =
    DBClusterSnapshot' <$> (x .@? "EngineVersion") <*> (x .@? "Status") <*>
    (x .@? "StorageEncrypted") <*>
    (x .@? "DBClusterIdentifier") <*>
    (x .@? "MasterUsername") <*>
    (x .@? "IAMDatabaseAuthenticationEnabled") <*>
...
dcsaAttributeValues =
  lens _dcsaAttributeValues (\s a -> s {_dcsaAttributeValues = a}) .
  _Default . _Coerce
...
instance FromXML DBClusterSnapshotAttribute where
  parseXML x =
    DBClusterSnapshotAttribute' <$>
    (x .@? "AttributeValues" .!@ mempty >>= may (parseXMLList "AttributeValue")) <*>
    (x .@? "AttributeName")
...
dcsarDBClusterSnapshotIdentifier ::
     Lens' DBClusterSnapshotAttributesResult (Maybe Text)
dcsarDBClusterSnapshotIdentifier =
  lens
    _dcsarDBClusterSnapshotIdentifier
    (\s a -> s {_dcsarDBClusterSnapshotIdentifier = a})

-- | The list of attributes and values for the manual DB cluster snapshot.
dcsarDBClusterSnapshotAttributes ::
     Lens' DBClusterSnapshotAttributesResult [DBClusterSnapshotAttribute]
dcsarDBClusterSnapshotAttributes =
  lens
    _dcsarDBClusterSnapshotAttributes
    (\s a -> s {_dcsarDBClusterSnapshotAttributes = a}) .
  _Default . _Coerce

instance FromXML DBClusterSnapshotAttributesResult where
  parseXML x =
    DBClusterSnapshotAttributesResult' <$> (x .@? "DBClusterSnapshotIdentifier") <*>
...
instance FromXML DBEngineVersion where
  parseXML x =
    ...
    (x .@? "SupportedTimezones" .!@ mempty >>= may (parseXMLList "Timezone")) <*>
    (x .@? "ExportableLogTypes" .!@ mempty >>= may (parseXMLList "member"))
...
diDBSecurityGroups =
  lens _diDBSecurityGroups (\s a -> s {_diDBSecurityGroups = a}) .
  _Default . _Coerce

-- | Specifies whether the DB instance is encrypted.
diStorageEncrypted :: Lens' DBInstance (Maybe Bool)
diStorageEncrypted =
  lens _diStorageEncrypted (\s a -> s {_diStorageEncrypted = a})

-- | If the DB instance is a member of a DB cluster, contains the name of the DB cluster that the DB instance is a member of.
diDBClusterIdentifier :: Lens' DBInstance (Maybe Text)
diDBClusterIdentifier =
  lens _diDBClusterIdentifier (\s a -> s {_diDBClusterIdentifier = a})

-- | Specifies the accessibility options for the DB instance. A value of true specifies an Internet-facing instance with a publicly resolvable DNS name, which resolves to a public IP address. A value of false specifies an internal instance with a DNS name that resolves to a private IP address. Default: The default behavior varies depending on whether a VPC has been requested or not. The following list shows the default behavior in each case.     * __Default VPC:__ true     * __VPC:__ false If no DB subnet group has been specified as part of the request and the PubliclyAccessible value has not been set, the DB instance is publicly accessible. If a specific DB subnet group has been specified as part of the request and the PubliclyAccessible value has not been set, the DB instance is private.
diPubliclyAccessible :: Lens' DBInstance (Maybe Bool)
diPubliclyAccessible =
  lens _diPubliclyAccessible (\s a -> s {_diPubliclyAccessible = a})

-- | Indicates that minor version patches are applied automatically.
diAutoMinorVersionUpgrade :: Lens' DBInstance (Maybe Bool)
diAutoMinorVersionUpgrade =
  lens _diAutoMinorVersionUpgrade (\s a -> s {_diAutoMinorVersionUpgrade = a})
...
diReadReplicaDBInstanceIdentifiers =
  lens
    ...
    (\s a -> s {_diReadReplicaDBInstanceIdentifiers = a}) .
  _Default . _Coerce
...
diIAMDatabaseAuthenticationEnabled =
  lens
    ...
    (\s a -> s {_diIAMDatabaseAuthenticationEnabled = a})

-- | The ARN for the IAM role that permits RDS to send Enhanced Monitoring metrics to Amazon CloudWatch Logs.
diMonitoringRoleARN :: Lens' DBInstance (Maybe Text)
diMonitoringRoleARN =
  lens _diMonitoringRoleARN (\s a -> s {_diMonitoringRoleARN = a})
...
diInstanceCreateTime =
  lens _diInstanceCreateTime (\s a -> s {_diInstanceCreateTime = a}) .
  mapping _Time
...
diReadReplicaSourceDBInstanceIdentifier =
  lens
    ...
    (\s a -> s {_diReadReplicaSourceDBInstanceIdentifier = a})

-- | The interval, in seconds, between points when Enhanced Monitoring metrics are collected for the DB instance.
diMonitoringInterval :: Lens' DBInstance (Maybe Int)
diMonitoringInterval =
  lens _diMonitoringInterval (\s a -> s {_diMonitoringInterval = a})
...
diLatestRestorableTime =
  lens _diLatestRestorableTime (\s a -> s {_diLatestRestorableTime = a}) .
  mapping _Time
...
diPreferredMaintenanceWindow =
  lens
    _diPreferredMaintenanceWindow
    (\s a -> s {_diPreferredMaintenanceWindow = a})

-- | The identifier of the CA certificate for this DB instance.
diCACertificateIdentifier :: Lens' DBInstance (Maybe Text)
diCACertificateIdentifier =
  lens _diCACertificateIdentifier (\s a -> s {_diCACertificateIdentifier = a})

-- | Contains a user-supplied database identifier. This identifier is the unique key that identifies a DB instance.
diDBInstanceIdentifier :: Lens' DBInstance (Maybe Text)
diDBInstanceIdentifier =
  lens _diDBInstanceIdentifier (\s a -> s {_diDBInstanceIdentifier = a})

-- | If present, specifies the name of the character set that this instance is associated with.
diCharacterSetName :: Lens' DBInstance (Maybe Text)
diCharacterSetName =
  lens _diCharacterSetName (\s a -> s {_diCharacterSetName = a})
...
diPreferredBackupWindow =
  lens _diPreferredBackupWindow (\s a -> s {_diPreferredBackupWindow = a})

-- | Specifies the name of the Availability Zone the DB instance is located in.
diAvailabilityZone :: Lens' DBInstance (Maybe Text)
diAvailabilityZone =
  lens _diAvailabilityZone (\s a -> s {_diAvailabilityZone = a})

-- | Provides a list of VPC security group elements that the DB instance belongs to.
diVPCSecurityGroups :: Lens' DBInstance [VPCSecurityGroupMembership]
diVPCSecurityGroups =
  lens _diVPCSecurityGroups (\s a -> s {_diVPCSecurityGroups = a}) .
  _Default . _Coerce

-- | Specifies the number of days for which automatic DB snapshots are retained.
diBackupRetentionPeriod :: Lens' DBInstance (Maybe Int)
diBackupRetentionPeriod =
  lens _diBackupRetentionPeriod (\s a -> s {_diBackupRetentionPeriod = a})
...
diPerformanceInsightsKMSKeyId =
  lens
    _diPerformanceInsightsKMSKeyId
    (\s a -> s {_diPerformanceInsightsKMSKeyId = a})
...
diOptionGroupMemberships =
  lens _diOptionGroupMemberships (\s a -> s {_diOptionGroupMemberships = a}) .
  _Default . _Coerce
...
diEnabledCloudwatchLogsExports =
  lens
    ...
    (\s a -> s {_diEnabledCloudwatchLogsExports = a}) .
  _Default . _Coerce
...
diEnhancedMonitoringResourceARN =
  lens
    _diEnhancedMonitoringResourceARN
    (\s a -> s {_diEnhancedMonitoringResourceARN = a})

-- | If present, specifies the name of the secondary Availability Zone for a DB instance with multi-AZ support.
diSecondaryAvailabilityZone :: Lens' DBInstance (Maybe Text)
diSecondaryAvailabilityZone =
  lens
    _diSecondaryAvailabilityZone
    (\s a -> s {_diSecondaryAvailabilityZone = a})

-- | True if Performance Insights is enabled for the DB instance, and otherwise false.
diPerformanceInsightsEnabled :: Lens' DBInstance (Maybe Bool)
diPerformanceInsightsEnabled =
  lens
    _diPerformanceInsightsEnabled
    (\s a -> s {_diPerformanceInsightsEnabled = a})

-- | Specifies the allocated storage size specified in gibibytes.
diAllocatedStorage :: Lens' DBInstance (Maybe Int)
diAllocatedStorage =
  lens _diAllocatedStorage (\s a -> s {_diAllocatedStorage = a})
...
diDBParameterGroups =
  lens _diDBParameterGroups (\s a -> s {_diDBParameterGroups = a}) .
  _Default . _Coerce

-- | Specifies whether tags are copied from the DB instance to snapshots of the DB instance.
diCopyTagsToSnapshot :: Lens' DBInstance (Maybe Bool)
diCopyTagsToSnapshot =
  lens _diCopyTagsToSnapshot (\s a -> s {_diCopyTagsToSnapshot = a})
...
diTDECredentialARN =
  lens _diTDECredentialARN (\s a -> s {_diTDECredentialARN = a})
...
diDBInstanceStatus =
  lens _diDBInstanceStatus (\s a -> s {_diDBInstanceStatus = a})
...
diPendingModifiedValues =
  lens _diPendingModifiedValues (\s a -> s {_diPendingModifiedValues = a})
...
diReadReplicaDBClusterIdentifiers =
  lens
    ...
    (\s a -> s {_diReadReplicaDBClusterIdentifiers = a}) .
  _Default . _Coerce
...
diStatusInfos =
  lens _diStatusInfos (\s a -> s {_diStatusInfos = a}) . _Default . _Coerce

-- | The Active Directory Domain membership records associated with the DB instance.
diDomainMemberships :: Lens' DBInstance [DomainMembership]
diDomainMemberships =
  lens _diDomainMemberships (\s a -> s {_diDomainMemberships = a}) .
  _Default . _Coerce
...
instance FromXML DBInstanceStatusInfo where
  parseXML x =
    DBInstanceStatusInfo' <$> (x .@? "Status") <*> (x .@? "Normal") <*>
    (x .@? "StatusType") <*>
    (x .@? "Message")
...
instance FromXML DBParameterGroup where
  parseXML x =
    DBParameterGroup' <$> (x .@? "DBParameterGroupArn") <*>
    (x .@? "DBParameterGroupFamily") <*>
...
dpgnmDBParameterGroupName =
  lens _dpgnmDBParameterGroupName (\s a -> s {_dpgnmDBParameterGroupName = a})

instance FromXML DBParameterGroupNameMessage where
  parseXML x = DBParameterGroupNameMessage' <$> (x .@? "DBParameterGroupName")
...
dpgsDBParameterGroupName =
  lens _dpgsDBParameterGroupName (\s a -> s {_dpgsDBParameterGroupName = a})

-- | The status of parameter updates.
dpgsParameterApplyStatus :: Lens' DBParameterGroupStatus (Maybe Text)
dpgsParameterApplyStatus =
  lens _dpgsParameterApplyStatus (\s a -> s {_dpgsParameterApplyStatus = a})

instance FromXML DBParameterGroupStatus where
  parseXML x =
    DBParameterGroupStatus' <$> (x .@? "DBParameterGroupName") <*>
...
dbsgDBSecurityGroupARN =
  lens _dbsgDBSecurityGroupARN (\s a -> s {_dbsgDBSecurityGroupARN = a})

-- | Contains a list of 'IPRange' elements.
dbsgIPRanges :: Lens' DBSecurityGroup [IPRange]
dbsgIPRanges =
  lens _dbsgIPRanges (\s a -> s {_dbsgIPRanges = a}) . _Default . _Coerce
...
instance FromXML DBSecurityGroup where
  parseXML x =
    DBSecurityGroup' <$> (x .@? "VpcId") <*> (x .@? "OwnerId") <*>
...
dsgmDBSecurityGroupName =
  lens _dsgmDBSecurityGroupName (\s a -> s {_dsgmDBSecurityGroupName = a})

instance FromXML DBSecurityGroupMembership where
  parseXML x =
    DBSecurityGroupMembership' <$> (x .@? "Status") <*>
    (x .@? "DBSecurityGroupName")
...
dsIAMDatabaseAuthenticationEnabled =
  lens
    ...
    (\s a -> s {_dsIAMDatabaseAuthenticationEnabled = a})
...
dsInstanceCreateTime =
  lens _dsInstanceCreateTime (\s a -> s {_dsInstanceCreateTime = a}) .
  mapping _Time
...
dsDBSnapshotIdentifier =
  lens _dsDBSnapshotIdentifier (\s a -> s {_dsDBSnapshotIdentifier = a})
...
dsSourceDBSnapshotIdentifier =
  lens
    _dsSourceDBSnapshotIdentifier
    (\s a -> s {_dsSourceDBSnapshotIdentifier = a})
...
dsDBInstanceIdentifier =
  lens _dsDBInstanceIdentifier (\s a -> s {_dsDBInstanceIdentifier = a})
...
dsAvailabilityZone =
  lens _dsAvailabilityZone (\s a -> s {_dsAvailabilityZone = a})

-- | Provides the time when the snapshot was taken, in Universal Coordinated Time (UTC).
dsSnapshotCreateTime :: Lens' DBSnapshot (Maybe UTCTime)
dsSnapshotCreateTime =
  lens _dsSnapshotCreateTime (\s a -> s {_dsSnapshotCreateTime = a}) .
  mapping _Time

-- | Specifies the allocated storage size in gibibytes (GiB).
dsAllocatedStorage :: Lens' DBSnapshot (Maybe Int)
dsAllocatedStorage =
  lens _dsAllocatedStorage (\s a -> s {_dsAllocatedStorage = a})
...
dsTDECredentialARN =
  lens _dsTDECredentialARN (\s a -> s {_dsTDECredentialARN = a})
...
instance FromXML DBSnapshot where
  parseXML x =
    DBSnapshot' <$> (x .@? "EngineVersion") <*> (x .@? "Status") <*>
    (x .@? "DBSnapshotArn") <*>
    (x .@? "MasterUsername") <*>
    (x .@? "SourceRegion") <*>
    (x .@? "IAMDatabaseAuthenticationEnabled") <*>
...
dsaAttributeValues =
  lens _dsaAttributeValues (\s a -> s {_dsaAttributeValues = a}) .
  _Default . _Coerce
...
dsarDBSnapshotIdentifier =
  lens _dsarDBSnapshotIdentifier (\s a -> s {_dsarDBSnapshotIdentifier = a})

-- | The list of attributes and values for the manual DB snapshot.
dsarDBSnapshotAttributes ::
     Lens' DBSnapshotAttributesResult [DBSnapshotAttribute]
dsarDBSnapshotAttributes =
  lens _dsarDBSnapshotAttributes (\s a -> s {_dsarDBSnapshotAttributes = a}) .
  _Default . _Coerce

instance FromXML DBSnapshotAttributesResult where
  parseXML x =
    DBSnapshotAttributesResult' <$> (x .@? "DBSnapshotIdentifier") <*>
...
dsgDBSubnetGroupName =
  lens _dsgDBSubnetGroupName (\s a -> s {_dsgDBSubnetGroupName = a})
...
dsgDBSubnetGroupARN =
  lens _dsgDBSubnetGroupARN (\s a -> s {_dsgDBSubnetGroupARN = a})

-- | Provides the status of the DB subnet group.
dsgSubnetGroupStatus :: Lens' DBSubnetGroup (Maybe Text)
dsgSubnetGroupStatus =
  lens _dsgSubnetGroupStatus (\s a -> s {_dsgSubnetGroupStatus = a})

instance FromXML DBSubnetGroup where
  parseXML x =
    DBSubnetGroup' <$> (x .@? "DBSubnetGroupName") <*> (x .@? "VpcId") <*>
...
instance FromXML DescribeDBLogFilesDetails where
  parseXML x =
    DescribeDBLogFilesDetails' <$> (x .@? "LastWritten") <*> (x .@? "Size") <*>
    (x .@? "LogFileName")
...
instance FromXML DomainMembership where
  parseXML x =
    DomainMembership' <$> (x .@? "Status") <*> (x .@? "FQDN") <*>
    (x .@? "Domain") <*>
    (x .@? "IAMRoleName")
...
esgEC2SecurityGroupId =
  lens _esgEC2SecurityGroupId (\s a -> s {_esgEC2SecurityGroupId = a})
...
instance FromXML Endpoint where
  parseXML x =
    Endpoint' <$> (x .@? "HostedZoneId") <*> (x .@? "Address") <*>
    (x .@? "Port")
...
edDBParameterGroupFamily =
  lens _edDBParameterGroupFamily (\s a -> s {_edDBParameterGroupFamily = a})
...
instance FromXML EngineDefaults where
  parseXML x =
    EngineDefaults' <$> (x .@? "DBParameterGroupFamily") <*> (x .@? "Marker") <*>
...
eEventCategories =
  lens _eEventCategories (\s a -> s {_eEventCategories = a}) .
  _Default . _Coerce
...
instance FromXML Event where
  parseXML x =
    Event' <$> (x .@? "SourceType") <*> (x .@? "SourceArn") <*>
    (x .@? "SourceIdentifier") <*>
    (x .@? "Date") <*>
    (x .@? "EventCategories" .!@ mempty >>= may (parseXMLList "EventCategory")) <*>
    (x .@? "Message")
...
instance FromXML EventCategoriesMap where
  parseXML x =
    EventCategoriesMap' <$> (x .@? "SourceType") <*>
    (x .@? "EventCategories" .!@ mempty >>= may (parseXMLList "EventCategory"))
...
esEventSubscriptionARN =
  lens _esEventSubscriptionARN (\s a -> s {_esEventSubscriptionARN = a})
...
esSubscriptionCreationTime =
  lens _esSubscriptionCreationTime (\s a -> s {_esSubscriptionCreationTime = a})
...
esSourceIdsList =
  lens _esSourceIdsList (\s a -> s {_esSourceIdsList = a}) . _Default . _Coerce

instance FromXML EventSubscription where
  parseXML x =
    EventSubscription' <$> (x .@? "Status") <*> (x .@? "CustomerAwsId") <*>
    ...
    (x .@? "SourceIdsList" .!@ mempty >>= may (parseXMLList "SourceId"))
...
instance ToQuery Filter where
  toQuery Filter' {..} =
    mconcat ["Name" =: _fName, "Values" =: toQueryList "Value" _fValues]
...
oOptionSettings =
  lens _oOptionSettings (\s a -> s {_oOptionSettings = a}) . _Default . _Coerce
...
instance FromXML Option where
  parseXML x =
    Option' <$> (x .@? "OptionName") <*> (x .@? "Permanent") <*>
    (x .@? "Persistent") <*>
    (x .@? "OptionDescription") <*>
    (x .@? "OptionSettings" .!@ mempty >>= may (parseXMLList "OptionSetting")) <*>
  ...
  toQuery OptionConfiguration' {..} =
    mconcat
      ...
      , "VpcSecurityGroupMemberships" =:
        toQuery
          (toQueryList "VpcSecurityGroupId" <$> _ocVPCSecurityGroupMemberships)
      , "DBSecurityGroupMemberships" =:
        toQuery
          (toQueryList "DBSecurityGroupName" <$> _ocDBSecurityGroupMemberships)
...
ogOptionGroupDescription =
  lens _ogOptionGroupDescription (\s a -> s {_ogOptionGroupDescription = a})
...
instance FromXML OptionGroup where
  parseXML x =
    OptionGroup' <$> (x .@? "OptionGroupDescription") <*> (x .@? "VpcId") <*>
...
instance FromXML OptionGroupMembership where
  parseXML x =
    OptionGroupMembership' <$> (x .@? "Status") <*> (x .@? "OptionGroupName")
...
ogoOptionsConflictsWith =
  lens _ogoOptionsConflictsWith (\s a -> s {_ogoOptionsConflictsWith = a}) .
  _Default . _Coerce
...
ogoOptionGroupOptionVersions =
  lens
    ...
    (\s a -> s {_ogoOptionGroupOptionVersions = a}) .
  _Default . _Coerce
...
ogoSupportsOptionVersionDowngrade =
  lens
    ...
    (\s a -> s {_ogoSupportsOptionVersionDowngrade = a})
...
ogoOptionGroupOptionSettings ::
     Lens' OptionGroupOption [OptionGroupOptionSetting]
ogoOptionGroupOptionSettings =
  lens
...
ogoRequiresAutoMinorEngineVersionUpgrade =
  lens
    ...
    (\s a -> s {_ogoRequiresAutoMinorEngineVersionUpgrade = a})
...
instance FromXML OptionGroupOption where
  parseXML x =
    OptionGroupOption' <$> (x .@? "MinimumRequiredMinorEngineVersion") <*>
    ...
    (x .@? "PortRequired") <*>
    (x .@? "Description") <*>
    (x .@? "OptionsDependedOn" .!@ mempty >>= may (parseXMLList "OptionName")) <*>
    (x .@? "VpcOnly")
...
instance FromXML OptionGroupOptionSetting where
  parseXML x =
    OptionGroupOptionSetting' <$> (x .@? "ApplyType") <*> (x .@? "SettingName") <*>
    (x .@? "DefaultValue") <*>
    (x .@? "IsModifiable") <*>
...
instance FromXML OptionSetting where
  parseXML x =
    OptionSetting' <$> (x .@? "IsCollection") <*> (x .@? "ApplyType") <*>
    (x .@? "Value") <*>
    (x .@? "Name") <*>
    (x .@? "DefaultValue") <*>
    (x .@? "IsModifiable") <*>
...
instance FromXML OptionVersion where
  parseXML x = OptionVersion' <$> (x .@? "Version") <*> (x .@? "IsDefault")
...
odioMinStorageSize =
  lens _odioMinStorageSize (\s a -> s {_odioMinStorageSize = a})
...
odioSupportsPerformanceInsights =
  lens
    ...
    (\s a -> s {_odioSupportsPerformanceInsights = a})

-- | The DB instance class for a DB instance.
odioDBInstanceClass :: Lens' OrderableDBInstanceOption (Maybe Text)
odioDBInstanceClass =
  lens _odioDBInstanceClass (\s a -> s {_odioDBInstanceClass = a})
...
odioAvailabilityZones =
  lens _odioAvailabilityZones (\s a -> s {_odioAvailabilityZones = a}) .
  _Default . _Coerce
...
odioSupportsStorageEncryption =
  lens
    ...
    (\s a -> s {_odioSupportsStorageEncryption = a})

-- | Indicates whether a DB instance can have a Read Replica.
odioReadReplicaCapable :: Lens' OrderableDBInstanceOption (Maybe Bool)
odioReadReplicaCapable =
  lens _odioReadReplicaCapable (\s a -> s {_odioReadReplicaCapable = a})
...
odioSupportsEnhancedMonitoring =
  lens
    ...
    (\s a -> s {_odioSupportsEnhancedMonitoring = a})

-- | Maximum total provisioned IOPS for a DB instance.
odioMaxIOPSPerDBInstance :: Lens' OrderableDBInstanceOption (Maybe Int)
odioMaxIOPSPerDBInstance =
  lens _odioMaxIOPSPerDBInstance (\s a -> s {_odioMaxIOPSPerDBInstance = a})
...
instance FromXML OrderableDBInstanceOption where
  parseXML x =
    OrderableDBInstanceOption' <$> (x .@? "EngineVersion") <*>
    (x .@? "MinIopsPerGib") <*>
...
instance FromXML Parameter where
  parseXML x =
    Parameter' <$> (x .@? "ApplyType") <*> (x .@? "ParameterValue") <*>
    (x .@? "ApplyMethod") <*>
...
pcleLogTypesToEnable =
  lens _pcleLogTypesToEnable (\s a -> s {_pcleLogTypesToEnable = a}) .
  _Default . _Coerce

-- | Log types that are in the process of being enabled. After they are enabled, these log types are exported to CloudWatch Logs.
pcleLogTypesToDisable :: Lens' PendingCloudwatchLogsExports [Text]
pcleLogTypesToDisable =
  lens _pcleLogTypesToDisable (\s a -> s {_pcleLogTypesToDisable = a}) .
  _Default . _Coerce

instance FromXML PendingCloudwatchLogsExports where
  parseXML x =
    PendingCloudwatchLogsExports' <$>
    (x .@? "LogTypesToEnable" .!@ mempty >>= may (parseXMLList "member")) <*>
    (x .@? "LogTypesToDisable" .!@ mempty >>= may (parseXMLList "member"))
...
pmaForcedApplyDate =
  lens _pmaForcedApplyDate (\s a -> s {_pmaForcedApplyDate = a}) . mapping _Time
...
instance FromXML PendingMaintenanceAction where
  parseXML x =
    PendingMaintenanceAction' <$> (x .@? "AutoAppliedAfterDate") <*>
    (x .@? "Action") <*>
    (x .@? "OptInStatus") <*>
    (x .@? "Description") <*>
    (x .@? "ForcedApplyDate") <*>
...
pmvDBSubnetGroupName =
  lens _pmvDBSubnetGroupName (\s a -> s {_pmvDBSubnetGroupName = a})
...
pmvCACertificateIdentifier =
  lens _pmvCACertificateIdentifier (\s a -> s {_pmvCACertificateIdentifier = a})
...
pmvPendingCloudwatchLogsExports ::
     Lens' PendingModifiedValues (Maybe PendingCloudwatchLogsExports)
pmvPendingCloudwatchLogsExports =
  lens
    _pmvPendingCloudwatchLogsExports
    (\s a -> s {_pmvPendingCloudwatchLogsExports = a})

-- | Specifies the pending number of days for which automated backups are retained.
pmvBackupRetentionPeriod :: Lens' PendingModifiedValues (Maybe Int)
pmvBackupRetentionPeriod =
  lens _pmvBackupRetentionPeriod (\s a -> s {_pmvBackupRetentionPeriod = a})
...
instance FromXML Range where
  parseXML x = Range' <$> (x .@? "To") <*> (x .@? "From") <*> (x .@? "Step")
...
rdiDBInstanceCount =
  lens _rdiDBInstanceCount (\s a -> s {_rdiDBInstanceCount = a})
...
rdiReservedDBInstancesOfferingId =
  lens
    ...
    (\s a -> s {_rdiReservedDBInstancesOfferingId = a})

-- | The recurring price charged to run this reserved DB instance.
rdiRecurringCharges :: Lens' ReservedDBInstance [RecurringCharge]
rdiRecurringCharges =
  lens _rdiRecurringCharges (\s a -> s {_rdiRecurringCharges = a}) .
  _Default . _Coerce
...
instance FromXML ReservedDBInstance where
  parseXML x =
    ReservedDBInstance' <$> (x .@? "DBInstanceCount") <*> (x .@? "State") <*>
    (x .@? "CurrencyCode") <*>
    (x .@? "StartTime") <*>
...
rdioProductDescription =
  lens _rdioProductDescription (\s a -> s {_rdioProductDescription = a})

-- | The DB instance class for the reserved DB instance.
rdioDBInstanceClass :: Lens' ReservedDBInstancesOffering (Maybe Text)
rdioDBInstanceClass =
  lens _rdioDBInstanceClass (\s a -> s {_rdioDBInstanceClass = a})
...
rdioReservedDBInstancesOfferingId ::
     Lens' ReservedDBInstancesOffering (Maybe Text)
rdioReservedDBInstancesOfferingId =
  lens
    _rdioReservedDBInstancesOfferingId
    (\s a -> s {_rdioReservedDBInstancesOfferingId = a})

-- | The recurring price charged to run this reserved DB instance.
rdioRecurringCharges :: Lens' ReservedDBInstancesOffering [RecurringCharge]
rdioRecurringCharges =
  lens _rdioRecurringCharges (\s a -> s {_rdioRecurringCharges = a}) .
  _Default . _Coerce
...
instance FromXML ReservedDBInstancesOffering where
  parseXML x =
    ReservedDBInstancesOffering' <$> (x .@? "CurrencyCode") <*>
    (x .@? "ProductDescription") <*>
    (x .@? "DBInstanceClass") <*>
    (x .@? "MultiAZ") <*>
    (x .@? "ReservedDBInstancesOfferingId") <*>
...
rpmaPendingMaintenanceActionDetails ::
     Lens' ResourcePendingMaintenanceActions [PendingMaintenanceAction]
rpmaPendingMaintenanceActionDetails =
  lens
...
instance FromXML SourceRegion where
  parseXML x =
    SourceRegion' <$> (x .@? "Status") <*> (x .@? "RegionName") <*>
    (x .@? "Endpoint")
...
instance FromXML Subnet where
  parseXML x =
    Subnet' <$> (x .@? "SubnetStatus") <*> (x .@? "SubnetIdentifier") <*>
...
utIsMajorVersionUpgrade =
  lens _utIsMajorVersionUpgrade (\s a -> s {_utIsMajorVersionUpgrade = a})
...
instance FromXML VPCSecurityGroupMembership where
  parseXML x =
    VPCSecurityGroupMembership' <$> (x .@? "Status") <*>
...
vdimmStorage =
  lens _vdimmStorage (\s a -> s {_vdimmStorage = a}) . _Default . _Coerce

instance FromXML ValidDBInstanceModificationsMessage where
  parseXML x =
    ValidDBInstanceModificationsMessage' <$>
    (x .@? "Storage" .!@ mempty >>= may (parseXMLList "ValidStorageOptions"))
...
vsoStorageSize =
  lens _vsoStorageSize (\s a -> s {_vsoStorageSize = a}) . _Default . _Coerce

-- | The valid range of provisioned IOPS. For example, 1000-20000.
vsoProvisionedIOPS :: Lens' ValidStorageOptions [Range]
vsoProvisionedIOPS =
  lens _vsoProvisionedIOPS (\s a -> s {_vsoProvisionedIOPS = a}) .
  _Default . _Coerce

-- | The valid range of Provisioned IOPS to gibibytes of storage multiplier. For example, 3-10, which means that provisioned IOPS can be between 3 and 10 times storage.
vsoIOPSToStorageRatio :: Lens' ValidStorageOptions [DoubleRange]
vsoIOPSToStorageRatio =
  lens _vsoIOPSToStorageRatio (\s a -> s {_vsoIOPSToStorageRatio = a}) .
  _Default . _Coerce
...
instance FromXML ValidStorageOptions where
  parseXML x =
    ...
    (x .@? "IopsToStorageRatio" .!@ mempty >>= may (parseXMLList "DoubleRange")) <*>
    (x .@? "StorageType")
