...
data AddRoleToDBInstance = AddRoleToDBInstance'{_artdiDBInstanceIdentifier
                                                :: !Text,
                                                _artdiRoleARN :: !Text,
...
addRoleToDBInstance
    ...
    -> AddRoleToDBInstance
addRoleToDBInstance pDBInstanceIdentifier_ pRoleARN_
  pFeatureName_
  = AddRoleToDBInstance'{_artdiDBInstanceIdentifier =
