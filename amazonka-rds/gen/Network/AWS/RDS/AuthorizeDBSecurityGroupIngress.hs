...
data AuthorizeDBSecurityGroupIngress = AuthorizeDBSecurityGroupIngress'{_adsgiEC2SecurityGroupOwnerId
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
authorizeDBSecurityGroupIngress pDBSecurityGroupName_
  = AuthorizeDBSecurityGroupIngress'{_adsgiEC2SecurityGroupOwnerId
                                       = Nothing,
...
data AuthorizeDBSecurityGroupIngressResponse = AuthorizeDBSecurityGroupIngressResponse'{_adsgirsDBSecurityGroup
                                                                                        ::
                                                                                        !(Maybe
                                                                                            DBSecurityGroup),
...
authorizeDBSecurityGroupIngressResponse
  pResponseStatus_
  = AuthorizeDBSecurityGroupIngressResponse'{_adsgirsDBSecurityGroup
                                               = Nothing,
                                             _adsgirsResponseStatus =
                                               pResponseStatus_}
