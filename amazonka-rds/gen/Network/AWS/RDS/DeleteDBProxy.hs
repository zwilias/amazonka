...
newtype DeleteDBProxy = DeleteDBProxy'{_ddpDBProxyName
                                       :: Text}
...
instance AWSRequest DeleteDBProxy where
        ...
        response
          = receiveXMLWrapper "DeleteDBProxyResult"
              (\ s h x ->
                 DeleteDBProxyResponse' <$>
                   (x .@? "DBProxy") <*> (pure (fromEnum s)))

instance Hashable DeleteDBProxy where

instance NFData DeleteDBProxy where
...
data DeleteDBProxyResponse = DeleteDBProxyResponse'{_ddbprsDBProxy
                                                    :: !(Maybe DBProxy),
                                                    _ddbprsResponseStatus ::
                                                    !Int}
...
deleteDBProxyResponse
    :: Int -- ^ 'ddbprsResponseStatus'
    -> DeleteDBProxyResponse
deleteDBProxyResponse pResponseStatus_
  = DeleteDBProxyResponse'{_ddbprsDBProxy = Nothing,
...
instance NFData DeleteDBProxyResponse where
