...
data DescribeCustomAvailabilityZones = DescribeCustomAvailabilityZones'{_dcazFilters
                                                                        ::
                                                                        !(Maybe
                                                                            [Filter]),
...
describeCustomAvailabilityZones
    :: DescribeCustomAvailabilityZones
describeCustomAvailabilityZones
  = DescribeCustomAvailabilityZones'{_dcazFilters =
                                       Nothing,
...
instance AWSPager DescribeCustomAvailabilityZones
         where
        page rq rs
          | stop (rs ^. dcazrsMarker) = Nothing
          | stop (rs ^. dcazrsCustomAvailabilityZones) =
            Nothing
          | otherwise =
            Just $ rq & dcazMarker .~ rs ^. dcazrsMarker

instance AWSRequest DescribeCustomAvailabilityZones
         where
...
instance NFData DescribeCustomAvailabilityZones where

instance ToHeaders DescribeCustomAvailabilityZones
         where
...
instance ToQuery DescribeCustomAvailabilityZones
         where
        toQuery DescribeCustomAvailabilityZones'{..}
          = mconcat
              ["Action" =:
               ...
               "Filters" =:
                 toQuery (toQueryList "Filter" <$> _dcazFilters),
...
data DescribeCustomAvailabilityZonesResponse = DescribeCustomAvailabilityZonesResponse'{_dcazrsCustomAvailabilityZones
                                                                                        ::
                                                                                        !(Maybe
...
describeCustomAvailabilityZonesResponse
    :: Int -- ^ 'dcazrsResponseStatus'
    -> DescribeCustomAvailabilityZonesResponse
describeCustomAvailabilityZonesResponse
  pResponseStatus_
  = DescribeCustomAvailabilityZonesResponse'{_dcazrsCustomAvailabilityZones
                                               = Nothing,
