...
newtype DeleteInstallationMedia = DeleteInstallationMedia'{_dInstallationMediaId
                                                           :: Text}
...
deleteInstallationMedia
    :: Text -- ^ 'dInstallationMediaId'
    -> DeleteInstallationMedia
deleteInstallationMedia pInstallationMediaId_
  = DeleteInstallationMedia'{_dInstallationMediaId =
...
instance AWSRequest DeleteInstallationMedia where
        ...
        response
          = receiveXMLWrapper "DeleteInstallationMediaResult"
              (\ s h x -> parseXML x)

instance Hashable DeleteInstallationMedia where

instance NFData DeleteInstallationMedia where
