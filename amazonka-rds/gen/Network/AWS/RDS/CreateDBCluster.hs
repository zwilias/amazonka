...
cdcStorageEncrypted =
  lens _cdcStorageEncrypted (\s a -> s {_cdcStorageEncrypted = a})

-- | The password for the master database user. This password can contain any printable ASCII character except "/", """, or "@". Constraints: Must contain from 8 to 41 characters.
cdcMasterUserPassword :: Lens' CreateDBCluster (Maybe Text)
cdcMasterUserPassword =
  lens _cdcMasterUserPassword (\s a -> s {_cdcMasterUserPassword = a})
...
cdcReplicationSourceIdentifier =
  lens
    ...
    (\s a -> s {_cdcReplicationSourceIdentifier = a})
...
cdcDBSubnetGroupName =
  lens _cdcDBSubnetGroupName (\s a -> s {_cdcDBSubnetGroupName = a})
...
cdcBacktrackWindow =
  lens _cdcBacktrackWindow (\s a -> s {_cdcBacktrackWindow = a})
...
cdcPreferredMaintenanceWindow =
  lens
    ...
    (\s a -> s {_cdcPreferredMaintenanceWindow = a})
...
cdcAvailabilityZones =
  lens _cdcAvailabilityZones (\s a -> s {_cdcAvailabilityZones = a}) .
  _Default . _Coerce

-- | A value that indicates that the DB cluster should be associated with the specified CharacterSet.
cdcCharacterSetName :: Lens' CreateDBCluster (Maybe Text)
cdcCharacterSetName =
  lens _cdcCharacterSetName (\s a -> s {_cdcCharacterSetName = a})
...
cdcPreferredBackupWindow =
  lens _cdcPreferredBackupWindow (\s a -> s {_cdcPreferredBackupWindow = a})

-- | The number of days for which automated backups are retained. You must specify a minimum value of 1. Default: 1 Constraints:     * Must be a value from 1 to 35
cdcBackupRetentionPeriod :: Lens' CreateDBCluster (Maybe Int)
cdcBackupRetentionPeriod =
  lens _cdcBackupRetentionPeriod (\s a -> s {_cdcBackupRetentionPeriod = a})

-- | A list of EC2 VPC security groups to associate with this DB cluster.
cdcVPCSecurityGroupIds :: Lens' CreateDBCluster [Text]
cdcVPCSecurityGroupIds =
  lens _cdcVPCSecurityGroupIds (\s a -> s {_cdcVPCSecurityGroupIds = a}) .
  _Default . _Coerce
...
cdcDBClusterParameterGroupName =
  lens
    ...
    (\s a -> s {_cdcDBClusterParameterGroupName = a})
...
cdcOptionGroupName =
  lens _cdcOptionGroupName (\s a -> s {_cdcOptionGroupName = a})
...
cdcEnableIAMDatabaseAuthentication =
  lens
    ...
    (\s a -> s {_cdcEnableIAMDatabaseAuthentication = a})
...
cdcDBClusterIdentifier =
  lens _cdcDBClusterIdentifier (\s a -> s {_cdcDBClusterIdentifier = a})
...
instance AWSRequest CreateDBCluster where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         CreateDBClusterResponse' <$> (x .@? "DBCluster") <*>
         (pure (fromEnum s)))
...
instance ToQuery CreateDBCluster where
  toQuery CreateDBCluster' {..} =
    mconcat
      ...
      , "VpcSecurityGroupIds" =:
        toQuery (toQueryList "VpcSecurityGroupId" <$> _cdcVPCSecurityGroupIds)
      ...
      , "Port" =: _cdcPort
      , "EnableIAMDatabaseAuthentication" =: _cdcEnableIAMDatabaseAuthentication
