...
data DescribeDBProxyTargetGroups = DescribeDBProxyTargetGroups'{_ddptgFilters
                                                                ::
                                                                !(Maybe
                                                                    [Filter]),
                                                                _ddptgMarker ::
...
describeDBProxyTargetGroups
    :: Text -- ^ 'ddptgDBProxyName'
    -> DescribeDBProxyTargetGroups
describeDBProxyTargetGroups pDBProxyName_
  = DescribeDBProxyTargetGroups'{_ddptgFilters =
                                   Nothing,
...
instance AWSPager DescribeDBProxyTargetGroups where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ddptgMarker .~ rs ^. ddptgrsMarker
...
instance Hashable DescribeDBProxyTargetGroups where

instance NFData DescribeDBProxyTargetGroups where
...
data DescribeDBProxyTargetGroupsResponse = DescribeDBProxyTargetGroupsResponse'{_ddptgrsMarker
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
describeDBProxyTargetGroupsResponse
    :: Int -- ^ 'ddptgrsResponseStatus'
    -> DescribeDBProxyTargetGroupsResponse
describeDBProxyTargetGroupsResponse pResponseStatus_
  = DescribeDBProxyTargetGroupsResponse'{_ddptgrsMarker
                                           = Nothing,
