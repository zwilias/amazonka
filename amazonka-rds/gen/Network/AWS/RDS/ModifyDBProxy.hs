...
data ModifyDBProxy = ModifyDBProxy'{_mdpDebugLogging
                                    :: !(Maybe Bool),
...
modifyDBProxy pDBProxyName_
  = ModifyDBProxy'{_mdpDebugLogging = Nothing,
                   _mdpSecurityGroups = Nothing, _mdpAuth = Nothing,
                   _mdpRequireTLS = Nothing,
                   _mdpIdleClientTimeout = Nothing,
                   _mdpNewDBProxyName = Nothing, _mdpRoleARN = Nothing,
...
instance AWSRequest ModifyDBProxy where
        ...
        response
          = receiveXMLWrapper "ModifyDBProxyResult"
              (\ s h x ->
                 ModifyDBProxyResponse' <$>
                   (x .@? "DBProxy") <*> (pure (fromEnum s)))

instance Hashable ModifyDBProxy where

instance NFData ModifyDBProxy where
...
data ModifyDBProxyResponse = ModifyDBProxyResponse'{_mdprsDBProxy
                                                    :: !(Maybe DBProxy),
...
modifyDBProxyResponse pResponseStatus_
  = ModifyDBProxyResponse'{_mdprsDBProxy = Nothing,
...
instance NFData ModifyDBProxyResponse where
