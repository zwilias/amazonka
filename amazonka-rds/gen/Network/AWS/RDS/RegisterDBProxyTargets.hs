...
data RegisterDBProxyTargets = RegisterDBProxyTargets'{_rdptDBClusterIdentifiers
                                                      :: !(Maybe [Text]),
...
registerDBProxyTargets
    :: Text -- ^ 'rdptDBProxyName'
    -> RegisterDBProxyTargets
registerDBProxyTargets pDBProxyName_
  = RegisterDBProxyTargets'{_rdptDBClusterIdentifiers =
                              Nothing,
...
instance AWSRequest RegisterDBProxyTargets where
        type Rs RegisterDBProxyTargets =
             RegisterDBProxyTargetsResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "RegisterDBProxyTargetsResult"
              (\ s h x ->
                 RegisterDBProxyTargetsResponse' <$>
...
instance Hashable RegisterDBProxyTargets where

instance NFData RegisterDBProxyTargets where
...
data RegisterDBProxyTargetsResponse = RegisterDBProxyTargetsResponse'{_rdptrsDBProxyTargets
                                                                      ::
                                                                      !(Maybe
                                                                          [DBProxyTarget]),
                                                                      _rdptrsResponseStatus
                                                                      :: !Int}
...
registerDBProxyTargetsResponse
    :: Int -- ^ 'rdptrsResponseStatus'
    -> RegisterDBProxyTargetsResponse
registerDBProxyTargetsResponse pResponseStatus_
  = RegisterDBProxyTargetsResponse'{_rdptrsDBProxyTargets
                                      = Nothing,
...
instance NFData RegisterDBProxyTargetsResponse where
