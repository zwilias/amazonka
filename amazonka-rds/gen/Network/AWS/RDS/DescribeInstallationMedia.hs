...
data DescribeInstallationMedia = DescribeInstallationMedia'{_dimInstallationMediaId
                                                            :: !(Maybe Text),
                                                            _dimFilters ::
                                                            !(Maybe [Filter]),
                                                            _dimMarker ::
...
describeInstallationMedia
    :: DescribeInstallationMedia
describeInstallationMedia
  = DescribeInstallationMedia'{_dimInstallationMediaId
                                 = Nothing,
                               _dimFilters = Nothing, _dimMarker = Nothing,
...
instance AWSPager DescribeInstallationMedia where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dimMarker .~ rs ^. dimrsMarker
...
instance AWSRequest DescribeInstallationMedia where
        ...
        response
          = receiveXMLWrapper "DescribeInstallationMediaResult"
              (\ s h x ->
                 DescribeInstallationMediaResponse' <$>
                   (x .@? "Marker") <*>
...
instance Hashable DescribeInstallationMedia where

instance NFData DescribeInstallationMedia where
        ...
        toQuery DescribeInstallationMedia'{..}
          = mconcat
              ["Action" =:
               ...
               "Filters" =:
                 toQuery (toQueryList "Filter" <$> _dimFilters),
               "Marker" =: _dimMarker,
               "MaxRecords" =: _dimMaxRecords]

-- | /See:/ 'describeInstallationMediaResponse' smart constructor.
data DescribeInstallationMediaResponse = DescribeInstallationMediaResponse'{_dimrsMarker
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
describeInstallationMediaResponse
    :: Int -- ^ 'dimrsResponseStatus'
    -> DescribeInstallationMediaResponse
describeInstallationMediaResponse pResponseStatus_
  = DescribeInstallationMediaResponse'{_dimrsMarker =
                                         Nothing,
