...
cSourceOptionGroupIdentifier =
  lens
    ...
    (\s a -> s {_cSourceOptionGroupIdentifier = a})
...
cTargetOptionGroupIdentifier =
  lens
    ...
    (\s a -> s {_cTargetOptionGroupIdentifier = a})
...
cTargetOptionGroupDescription =
  lens
    ...
    (\s a -> s {_cTargetOptionGroupDescription = a})
...
cogrsResponseStatus =
  lens _cogrsResponseStatus (\s a -> s {_cogrsResponseStatus = a})
