...
data CreateDBProxy = CreateDBProxy'{_cdpDebugLogging
                                    :: !(Maybe Bool),
...
createDBProxy
    :: Text -- ^ 'cdpDBProxyName'
    -> EngineFamily -- ^ 'cdpEngineFamily'
    -> Text -- ^ 'cdpRoleARN'
    -> CreateDBProxy
createDBProxy pDBProxyName_ pEngineFamily_ pRoleARN_
  = CreateDBProxy'{_cdpDebugLogging = Nothing,
                   _cdpRequireTLS = Nothing,
                   _cdpIdleClientTimeout = Nothing,
                   _cdpVPCSecurityGroupIds = Nothing,
                   _cdpTags = Nothing, _cdpDBProxyName = pDBProxyName_,
                   _cdpEngineFamily = pEngineFamily_, _cdpAuth = mempty,
                   _cdpRoleARN = pRoleARN_, _cdpVPCSubnetIds = mempty}
...
instance AWSRequest CreateDBProxy where
        ...
        response
          = receiveXMLWrapper "CreateDBProxyResult"
              (\ s h x ->
                 CreateDBProxyResponse' <$>
                   (x .@? "DBProxy") <*> (pure (fromEnum s)))

instance Hashable CreateDBProxy where

instance NFData CreateDBProxy where
...
data CreateDBProxyResponse = CreateDBProxyResponse'{_cdprsDBProxy
                                                    :: !(Maybe DBProxy),
                                                    _cdprsResponseStatus ::
                                                    !Int}
...
createDBProxyResponse pResponseStatus_
  = CreateDBProxyResponse'{_cdprsDBProxy = Nothing,
...
instance NFData CreateDBProxyResponse where
