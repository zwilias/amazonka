...
drdioProductDescription ::
     Lens' DescribeReservedDBInstancesOfferings (Maybe Text)
drdioProductDescription =
  lens _drdioProductDescription (\s a -> s {_drdioProductDescription = a})

-- | This parameter is not currently supported.
drdioFilters :: Lens' DescribeReservedDBInstancesOfferings [Filter]
drdioFilters =
  lens _drdioFilters (\s a -> s {_drdioFilters = a}) . _Default . _Coerce

-- | The DB instance class filter value. Specify this parameter to show only the available offerings matching the specified DB instance class.
drdioDBInstanceClass :: Lens' DescribeReservedDBInstancesOfferings (Maybe Text)
drdioDBInstanceClass =
  lens _drdioDBInstanceClass (\s a -> s {_drdioDBInstanceClass = a})
...
drdioReservedDBInstancesOfferingId =
  lens
    ...
    (\s a -> s {_drdioReservedDBInstancesOfferingId = a})
...
instance AWSRequest DescribeReservedDBInstancesOfferings where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DescribeReservedDBInstancesOfferingsResponse' <$> (x .@? "Marker") <*>
...
instance ToQuery DescribeReservedDBInstancesOfferings where
  toQuery DescribeReservedDBInstancesOfferings' {..} =
    mconcat
      [ "Action" =: ("DescribeReservedDBInstancesOfferings" :: ByteString)
      ...
      , "ReservedDBInstancesOfferingId" =: _drdioReservedDBInstancesOfferingId
...
drdiorsReservedDBInstancesOfferings ::
     Lens' DescribeReservedDBInstancesOfferingsResponse [ReservedDBInstancesOffering]
drdiorsReservedDBInstancesOfferings =
  lens
    _drdiorsReservedDBInstancesOfferings
    (\s a -> s {_drdiorsReservedDBInstancesOfferings = a}) .
  _Default . _Coerce

-- | -- | The response status code.
drdiorsResponseStatus :: Lens' DescribeReservedDBInstancesOfferingsResponse Int
drdiorsResponseStatus =
  lens _drdiorsResponseStatus (\s a -> s {_drdiorsResponseStatus = a})
