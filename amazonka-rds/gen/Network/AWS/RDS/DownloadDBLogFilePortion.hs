...
ddlfpNumberOfLines =
  lens _ddlfpNumberOfLines (\s a -> s {_ddlfpNumberOfLines = a})
...
ddlfpDBInstanceIdentifier =
  lens _ddlfpDBInstanceIdentifier (\s a -> s {_ddlfpDBInstanceIdentifier = a})
...
instance AWSRequest DownloadDBLogFilePortion where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         DownloadDBLogFilePortionResponse' <$> (x .@? "LogFileData") <*>
...
ddlfprsLogFileData =
  lens _ddlfprsLogFileData (\s a -> s {_ddlfprsLogFileData = a})
...
ddlfprsAdditionalDataPending =
  lens
    ...
    (\s a -> s {_ddlfprsAdditionalDataPending = a})
...
ddlfprsResponseStatus =
  lens _ddlfprsResponseStatus (\s a -> s {_ddlfprsResponseStatus = a})
