...
data DescribeDBParameters = DescribeDBParameters'{_ddpFilters
                                                  :: !(Maybe [Filter]),
                                                  _ddpMarker :: !(Maybe Text),
                                                  _ddpMaxRecords ::
                                                  !(Maybe Int),
                                                  _ddpSource :: !(Maybe Text),
                                                  _ddpDBParameterGroupName ::
                                                  !Text}
...
describeDBParameters pDBParameterGroupName_
  = DescribeDBParameters'{_ddpFilters = Nothing,
                          _ddpMarker = Nothing, _ddpMaxRecords = Nothing,
                          _ddpSource = Nothing,
...
data DescribeDBParametersResponse = DescribeDBParametersResponse'{_ddprsMarker
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _ddprsParameters
                                                                  ::
...
describeDBParametersResponse pResponseStatus_
  = DescribeDBParametersResponse'{_ddprsMarker =
                                    Nothing,
