...
data DescribeDBProxies = DescribeDBProxies'{_ddbpFilters
                                            :: !(Maybe [Filter]),
...
describeDBProxies
    :: DescribeDBProxies
describeDBProxies
  = DescribeDBProxies'{_ddbpFilters = Nothing,
                       _ddbpMarker = Nothing, _ddbpMaxRecords = Nothing,
...
instance Hashable DescribeDBProxies where

instance NFData DescribeDBProxies where
...
data DescribeDBProxiesResponse = DescribeDBProxiesResponse'{_ddpsrsDBProxies
                                                            ::
                                                            !(Maybe [DBProxy]),
                                                            _ddpsrsMarker ::
                                                            !(Maybe Text),
                                                            _ddpsrsResponseStatus
                                                            :: !Int}
...
describeDBProxiesResponse
    :: Int -- ^ 'ddpsrsResponseStatus'
    -> DescribeDBProxiesResponse
describeDBProxiesResponse pResponseStatus_
  = DescribeDBProxiesResponse'{_ddpsrsDBProxies =
                                 Nothing,
...
instance NFData DescribeDBProxiesResponse where
