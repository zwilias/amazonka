...
rdbcfsEngineVersion =
  lens _rdbcfsEngineVersion (\s a -> s {_rdbcfsEngineVersion = a})
...
rdbcfsDBSubnetGroupName =
  lens _rdbcfsDBSubnetGroupName (\s a -> s {_rdbcfsDBSubnetGroupName = a})
...
rdbcfsBacktrackWindow =
  lens _rdbcfsBacktrackWindow (\s a -> s {_rdbcfsBacktrackWindow = a})

-- | Provides the list of EC2 Availability Zones that instances in the restored DB cluster can be created in.
rdbcfsAvailabilityZones :: Lens' RestoreDBClusterFromSnapshot [Text]
rdbcfsAvailabilityZones =
  lens _rdbcfsAvailabilityZones (\s a -> s {_rdbcfsAvailabilityZones = a}) .
  _Default . _Coerce
...
rdbcfsVPCSecurityGroupIds =
  lens _rdbcfsVPCSecurityGroupIds (\s a -> s {_rdbcfsVPCSecurityGroupIds = a}) .
  _Default . _Coerce

-- | The database name for the restored DB cluster.
rdbcfsDatabaseName :: Lens' RestoreDBClusterFromSnapshot (Maybe Text)
rdbcfsDatabaseName =
  lens _rdbcfsDatabaseName (\s a -> s {_rdbcfsDatabaseName = a})

-- | The name of the option group to use for the restored DB cluster.
rdbcfsOptionGroupName :: Lens' RestoreDBClusterFromSnapshot (Maybe Text)
rdbcfsOptionGroupName =
  lens _rdbcfsOptionGroupName (\s a -> s {_rdbcfsOptionGroupName = a})
...
rdbcfsEnableIAMDatabaseAuthentication ::
     Lens' RestoreDBClusterFromSnapshot (Maybe Bool)
rdbcfsEnableIAMDatabaseAuthentication =
  lens
    _rdbcfsEnableIAMDatabaseAuthentication
    (\s a -> s {_rdbcfsEnableIAMDatabaseAuthentication = a})
...
rdbcfsDBClusterIdentifier =
  lens _rdbcfsDBClusterIdentifier (\s a -> s {_rdbcfsDBClusterIdentifier = a})
...
rdbcfsSnapshotIdentifier =
  lens _rdbcfsSnapshotIdentifier (\s a -> s {_rdbcfsSnapshotIdentifier = a})
...
instance AWSRequest RestoreDBClusterFromSnapshot where
  type Rs RestoreDBClusterFromSnapshot = RestoreDBClusterFromSnapshotResponse
  request = postQuery rds
  response =
    receiveXMLWrapper
      "RestoreDBClusterFromSnapshotResult"
      (\s h x ->
         RestoreDBClusterFromSnapshotResponse' <$> (x .@? "DBCluster") <*>
         (pure (fromEnum s)))
...
instance ToQuery RestoreDBClusterFromSnapshot where
  toQuery RestoreDBClusterFromSnapshot' {..} =
    mconcat
      ...
      , "AvailabilityZones" =:
        toQuery (toQueryList "AvailabilityZone" <$> _rdbcfsAvailabilityZones)
...
-- | Undocumented member.
rdbcfsrsDBCluster ::
     Lens' RestoreDBClusterFromSnapshotResponse (Maybe DBCluster)
...
rdbcfsrsResponseStatus =
  lens _rdbcfsrsResponseStatus (\s a -> s {_rdbcfsrsResponseStatus = a})
