...
data ModifyCertificates = ModifyCertificates'{_mcCertificateIdentifier
                                              :: !(Maybe Text),
...
modifyCertificates
    :: ModifyCertificates
modifyCertificates
  = ModifyCertificates'{_mcCertificateIdentifier =
                          Nothing,
...
instance AWSRequest ModifyCertificates where
        type Rs ModifyCertificates =
             ModifyCertificatesResponse
        request = postQuery rds
        response
          = receiveXMLWrapper "ModifyCertificatesResult"
              (\ s h x ->
                 ModifyCertificatesResponse' <$>
                   (x .@? "Certificate") <*> (pure (fromEnum s)))

instance Hashable ModifyCertificates where

instance NFData ModifyCertificates where
...
data ModifyCertificatesResponse = ModifyCertificatesResponse'{_mcrsCertificate
                                                              ::
                                                              !(Maybe
                                                                  Certificate),
                                                              _mcrsResponseStatus
...
modifyCertificatesResponse pResponseStatus_
  = ModifyCertificatesResponse'{_mcrsCertificate =
                                  Nothing,
...
instance NFData ModifyCertificatesResponse where
