...
data RemoveRoleFromDBInstance = RemoveRoleFromDBInstance'{_rrfdiDBInstanceIdentifier
                                                          :: !Text,
                                                          _rrfdiRoleARN ::
                                                          !Text,
                                                          _rrfdiFeatureName ::
...
removeRoleFromDBInstance
    ...
    -> RemoveRoleFromDBInstance
removeRoleFromDBInstance pDBInstanceIdentifier_
  pRoleARN_ pFeatureName_
  = RemoveRoleFromDBInstance'{_rrfdiDBInstanceIdentifier
