...
prrPreferredBackupWindow =
  lens _prrPreferredBackupWindow (\s a -> s {_prrPreferredBackupWindow = a})
...
prrBackupRetentionPeriod =
  lens _prrBackupRetentionPeriod (\s a -> s {_prrBackupRetentionPeriod = a})
...
prrrsResponseStatus =
  lens _prrrsResponseStatus (\s a -> s {_prrrsResponseStatus = a})
