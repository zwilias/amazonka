...
data ImportInstallationMedia = ImportInstallationMedia'{_iimCustomAvailabilityZoneId
                                                        :: !Text,
                                                        _iimEngine :: !Text,
                                                        _iimEngineVersion ::
                                                        !Text,
...
importInstallationMedia
    :: Text -- ^ 'iimCustomAvailabilityZoneId'
    -> Text -- ^ 'iimEngine'
    -> Text -- ^ 'iimEngineVersion'
    -> Text -- ^ 'iimEngineInstallationMediaPath'
    -> Text -- ^ 'iimOSInstallationMediaPath'
    -> ImportInstallationMedia
importInstallationMedia pCustomAvailabilityZoneId_
  pEngine_ pEngineVersion_
  pEngineInstallationMediaPath_
  pOSInstallationMediaPath_
  = ImportInstallationMedia'{_iimCustomAvailabilityZoneId
...
instance AWSRequest ImportInstallationMedia where
        ...
        response
          = receiveXMLWrapper "ImportInstallationMediaResult"
              (\ s h x -> parseXML x)

instance Hashable ImportInstallationMedia where

instance NFData ImportInstallationMedia where
