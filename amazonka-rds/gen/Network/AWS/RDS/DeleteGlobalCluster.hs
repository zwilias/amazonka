...
newtype DeleteGlobalCluster = DeleteGlobalCluster'{_dgcGlobalClusterIdentifier
                                                   :: Text}
...
deleteGlobalCluster pGlobalClusterIdentifier_
  = DeleteGlobalCluster'{_dgcGlobalClusterIdentifier =
...
data DeleteGlobalClusterResponse = DeleteGlobalClusterResponse'{_dgcrsGlobalCluster
                                                                ::
                                                                !(Maybe
                                                                    GlobalCluster),
...
deleteGlobalClusterResponse pResponseStatus_
  = DeleteGlobalClusterResponse'{_dgcrsGlobalCluster =
                                   Nothing,
