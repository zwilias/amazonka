...
rdifdsPubliclyAccessible =
  lens _rdifdsPubliclyAccessible (\s a -> s {_rdifdsPubliclyAccessible = a})

-- | Indicates that minor version upgrades are applied automatically to the DB instance during the maintenance window.
rdifdsAutoMinorVersionUpgrade ::
     Lens' RestoreDBInstanceFromDBSnapshot (Maybe Bool)
rdifdsAutoMinorVersionUpgrade =
  lens
    _rdifdsAutoMinorVersionUpgrade
    (\s a -> s {_rdifdsAutoMinorVersionUpgrade = a})
...
rdifdsDBSubnetGroupName =
  lens _rdifdsDBSubnetGroupName (\s a -> s {_rdifdsDBSubnetGroupName = a})
...
rdifdsTDECredentialPassword ::
     Lens' RestoreDBInstanceFromDBSnapshot (Maybe Text)
rdifdsTDECredentialPassword =
  lens
    _rdifdsTDECredentialPassword
    (\s a -> s {_rdifdsTDECredentialPassword = a})

-- | The compute and memory capacity of the Amazon RDS DB instance, for example, @db.m4.large@ . Not all DB instance classes are available in all AWS Regions, or for all database engines. For the full list of DB instance classes, and availability for your engine, see <http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html DB Instance Class> in the Amazon RDS User Guide.  Default: The same DBInstanceClass as the original DB instance.
rdifdsDBInstanceClass :: Lens' RestoreDBInstanceFromDBSnapshot (Maybe Text)
rdifdsDBInstanceClass =
  lens _rdifdsDBInstanceClass (\s a -> s {_rdifdsDBInstanceClass = a})
...
rdifdsLicenseModel =
  lens _rdifdsLicenseModel (\s a -> s {_rdifdsLicenseModel = a})
...
rdifdsAvailabilityZone =
  lens _rdifdsAvailabilityZone (\s a -> s {_rdifdsAvailabilityZone = a})
...
rdifdsOptionGroupName =
  lens _rdifdsOptionGroupName (\s a -> s {_rdifdsOptionGroupName = a})
...
rdifdsCopyTagsToSnapshot =
  lens _rdifdsCopyTagsToSnapshot (\s a -> s {_rdifdsCopyTagsToSnapshot = a})

-- | The ARN from the key store with which to associate the instance for TDE encryption.
rdifdsTDECredentialARN :: Lens' RestoreDBInstanceFromDBSnapshot (Maybe Text)
rdifdsTDECredentialARN =
  lens _rdifdsTDECredentialARN (\s a -> s {_rdifdsTDECredentialARN = a})

-- | Specify the name of the IAM role to be used when making API calls to the Directory Service.
rdifdsDomainIAMRoleName :: Lens' RestoreDBInstanceFromDBSnapshot (Maybe Text)
rdifdsDomainIAMRoleName =
  lens _rdifdsDomainIAMRoleName (\s a -> s {_rdifdsDomainIAMRoleName = a})
...
rdifdsEnableIAMDatabaseAuthentication =
  lens
    ...
    (\s a -> s {_rdifdsEnableIAMDatabaseAuthentication = a})
...
rdifdsEnableCloudwatchLogsExports ::
     Lens' RestoreDBInstanceFromDBSnapshot [Text]
rdifdsEnableCloudwatchLogsExports =
  lens
    _rdifdsEnableCloudwatchLogsExports
    (\s a -> s {_rdifdsEnableCloudwatchLogsExports = a}) .
  _Default . _Coerce
...
rdifdsDBInstanceIdentifier =
  lens _rdifdsDBInstanceIdentifier (\s a -> s {_rdifdsDBInstanceIdentifier = a})
...
rdifdsDBSnapshotIdentifier =
  lens _rdifdsDBSnapshotIdentifier (\s a -> s {_rdifdsDBSnapshotIdentifier = a})
...
instance AWSRequest RestoreDBInstanceFromDBSnapshot where
  ...
  response =
    receiveXMLWrapper
      ...
      (\s h x ->
         RestoreDBInstanceFromDBSnapshotResponse' <$> (x .@? "DBInstance") <*>
         (pure (fromEnum s)))
  ...
  toQuery RestoreDBInstanceFromDBSnapshot' {..} =
    mconcat
      ...
      , "EnableCloudwatchLogsExports" =:
        toQuery (toQueryList "member" <$> _rdifdsEnableCloudwatchLogsExports)
...
-- | Undocumented member.
rdifdsrsDBInstance ::
     Lens' RestoreDBInstanceFromDBSnapshotResponse (Maybe DBInstance)
rdifdsrsDBInstance =
  lens _rdifdsrsDBInstance (\s a -> s {_rdifdsrsDBInstance = a})

-- | -- | The response status code.
rdifdsrsResponseStatus :: Lens' RestoreDBInstanceFromDBSnapshotResponse Int
rdifdsrsResponseStatus =
  lens _rdifdsrsResponseStatus (\s a -> s {_rdifdsrsResponseStatus = a})
