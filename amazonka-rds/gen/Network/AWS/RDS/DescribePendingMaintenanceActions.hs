...
dpmaFilters =
  lens _dpmaFilters (\s a -> s {_dpmaFilters = a}) . _Default . _Coerce
...
dpmarsPendingMaintenanceActions ::
     Lens' DescribePendingMaintenanceActionsResponse [ResourcePendingMaintenanceActions]
dpmarsPendingMaintenanceActions =
  lens
    _dpmarsPendingMaintenanceActions
    (\s a -> s {_dpmarsPendingMaintenanceActions = a}) .
  _Default . _Coerce
...
dpmarsResponseStatus =
  lens _dpmarsResponseStatus (\s a -> s {_dpmarsResponseStatus = a})
