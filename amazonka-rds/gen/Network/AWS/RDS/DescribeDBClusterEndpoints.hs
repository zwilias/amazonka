...
data DescribeDBClusterEndpoints = DescribeDBClusterEndpoints'{_ddbceDBClusterIdentifier
                                                              :: !(Maybe Text),
                                                              _ddbceFilters ::
                                                              !(Maybe [Filter]),
...
describeDBClusterEndpoints
    :: DescribeDBClusterEndpoints
describeDBClusterEndpoints
  = DescribeDBClusterEndpoints'{_ddbceDBClusterIdentifier
                                  = Nothing,
...
data DescribeDBClusterEndpointsResponse = DescribeDBClusterEndpointsResponse'{_ddcersDBClusterEndpoints
                                                                              ::
                                                                              !(Maybe
                                                                                  [DBClusterEndpoint]),
                                                                              _ddcersMarker
...
describeDBClusterEndpointsResponse pResponseStatus_
  = DescribeDBClusterEndpointsResponse'{_ddcersDBClusterEndpoints
                                          = Nothing,
