...
newtype StopDBCluster = StopDBCluster'{_sdbcDBClusterIdentifier
                                       :: Text}
...
stopDBCluster pDBClusterIdentifier_
  = StopDBCluster'{_sdbcDBClusterIdentifier =
...
data StopDBClusterResponse = StopDBClusterResponse'{_sdbcrsDBCluster
                                                    :: !(Maybe DBCluster),
                                                    _sdbcrsResponseStatus ::
                                                    !Int}
...
stopDBClusterResponse pResponseStatus_
  = StopDBClusterResponse'{_sdbcrsDBCluster = Nothing,
