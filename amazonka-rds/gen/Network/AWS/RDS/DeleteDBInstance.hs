...
ddiFinalDBSnapshotIdentifier =
  lens
    ...
    (\s a -> s {_ddiFinalDBSnapshotIdentifier = a})
...
ddiSkipFinalSnapshot =
  lens _ddiSkipFinalSnapshot (\s a -> s {_ddiSkipFinalSnapshot = a})

-- | The DB instance identifier for the DB instance to be deleted. This parameter isn't case-sensitive. Constraints:     * Must match the name of an existing DB instance.
ddiDBInstanceIdentifier :: Lens' DeleteDBInstance Text
ddiDBInstanceIdentifier =
  lens _ddiDBInstanceIdentifier (\s a -> s {_ddiDBInstanceIdentifier = a})
...
ddirsResponseStatus =
  lens _ddirsResponseStatus (\s a -> s {_ddirsResponseStatus = a})
