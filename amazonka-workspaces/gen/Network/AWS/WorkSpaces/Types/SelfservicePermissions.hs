...
data SelfservicePermissions = SelfservicePermissions'{_spRestartWorkspace
                                                      :: !(Maybe ReconnectEnum),
...
selfservicePermissions
    :: SelfservicePermissions
selfservicePermissions
  = SelfservicePermissions'{_spRestartWorkspace =
                              Nothing,
...
instance FromJSON SelfservicePermissions where
        parseJSON
          = withObject "SelfservicePermissions"
              (\ x ->
                 SelfservicePermissions' <$>
                   (x .:? "RestartWorkspace") <*>
                     (x .:? "ChangeComputeType")
...
instance Hashable SelfservicePermissions where

instance NFData SelfservicePermissions where
