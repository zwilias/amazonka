...
data WorkspaceAccessProperties = WorkspaceAccessProperties'{_wapDeviceTypeWindows
                                                            ::
                                                            !(Maybe
                                                                AccessPropertyValue),
                                                            _wapDeviceTypeWeb ::
...
workspaceAccessProperties
    :: WorkspaceAccessProperties
workspaceAccessProperties
  = WorkspaceAccessProperties'{_wapDeviceTypeWindows =
                                 Nothing,
...
instance FromJSON WorkspaceAccessProperties where
        parseJSON
          = withObject "WorkspaceAccessProperties"
              (\ x ->
                 WorkspaceAccessProperties' <$>
                   (x .:? "DeviceTypeWindows") <*>
                     (x .:? "DeviceTypeWeb")
...
instance Hashable WorkspaceAccessProperties where

instance NFData WorkspaceAccessProperties where
