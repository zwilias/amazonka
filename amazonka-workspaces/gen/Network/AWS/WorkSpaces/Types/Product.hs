...
instance FromJSON ComputeType where
  parseJSON = withObject "ComputeType" (\x -> ComputeType' <$> (x .:? "Name"))
...
dwcpCustomSecurityGroupId ::
     Lens' DefaultWorkspaceCreationProperties (Maybe Text)
dwcpCustomSecurityGroupId =
  lens _dwcpCustomSecurityGroupId (\s a -> s {_dwcpCustomSecurityGroupId = a})

-- | Indicates whether the WorkSpace user is an administrator on the WorkSpace.
dwcpUserEnabledAsLocalAdministrator ::
     Lens' DefaultWorkspaceCreationProperties (Maybe Bool)
dwcpUserEnabledAsLocalAdministrator =
  lens
...
dwcpEnableInternetAccess ::
     Lens' DefaultWorkspaceCreationProperties (Maybe Bool)
dwcpEnableInternetAccess =
  lens _dwcpEnableInternetAccess (\s a -> s {_dwcpEnableInternetAccess = a})
...
instance FromJSON DefaultWorkspaceCreationProperties where
  parseJSON =
    withObject
      "DefaultWorkspaceCreationProperties"
      (\x ->
         DefaultWorkspaceCreationProperties' <$> (x .:? "CustomSecurityGroupId") <*>
...
fcwrWorkspaceRequest ::
     Lens' FailedCreateWorkspaceRequest (Maybe WorkspaceRequest)
fcwrWorkspaceRequest =
  lens _fcwrWorkspaceRequest (\s a -> s {_fcwrWorkspaceRequest = a})
...
instance FromJSON FailedCreateWorkspaceRequest where
  parseJSON =
    withObject
      "FailedCreateWorkspaceRequest"
      (\x ->
         FailedCreateWorkspaceRequest' <$> (x .:? "WorkspaceRequest") <*>
         (x .:? "ErrorCode") <*>
         (x .:? "ErrorMessage"))
...
instance FromJSON FailedWorkspaceChangeRequest where
  parseJSON =
    withObject
      "FailedWorkspaceChangeRequest"
      (\x ->
         FailedWorkspaceChangeRequest' <$> (x .:? "ErrorCode") <*>
         (x .:? "WorkspaceId") <*>
         (x .:? "ErrorMessage"))
...
instance FromJSON ModificationState where
  parseJSON =
    withObject
      "ModificationState"
      (\x -> ModificationState' <$> (x .:? "State") <*> (x .:? "Resource"))
...
instance FromJSON RootStorage where
  parseJSON =
    withObject "RootStorage" (\x -> RootStorage' <$> (x .:? "Capacity"))
...
instance FromJSON UserStorage where
  parseJSON =
    withObject "UserStorage" (\x -> UserStorage' <$> (x .:? "Capacity"))
...
wModificationStates =
  lens _wModificationStates (\s a -> s {_wModificationStates = a}) .
  _Default . _Coerce
...
wWorkspaceProperties =
  lens _wWorkspaceProperties (\s a -> s {_wWorkspaceProperties = a})

-- | Indicates whether the data stored on the root volume is encrypted.
wRootVolumeEncryptionEnabled :: Lens' Workspace (Maybe Bool)
wRootVolumeEncryptionEnabled =
  lens
    _wRootVolumeEncryptionEnabled
    (\s a -> s {_wRootVolumeEncryptionEnabled = a})
...
wVolumeEncryptionKey =
  lens _wVolumeEncryptionKey (\s a -> s {_wVolumeEncryptionKey = a})
...
wUserVolumeEncryptionEnabled =
  lens
    _wUserVolumeEncryptionEnabled
    (\s a -> s {_wUserVolumeEncryptionEnabled = a})
...
instance FromJSON Workspace where
  parseJSON =
    withObject
      "Workspace"
      (\x ->
         Workspace' <$> (x .:? "DirectoryId") <*> (x .:? "State") <*>
         (x .:? "IpAddress") <*>
...
instance FromJSON WorkspaceBundle where
  parseJSON =
    withObject
      "WorkspaceBundle"
      (\x ->
         WorkspaceBundle' <$> (x .:? "BundleId") <*> (x .:? "Owner") <*>
         (x .:? "RootStorage") <*>
         (x .:? "Name") <*>
         (x .:? "ComputeType") <*>
         (x .:? "UserStorage") <*>
...
wcsLastKnownUserConnectionTimestamp ::
     Lens' WorkspaceConnectionStatus (Maybe UTCTime)
wcsLastKnownUserConnectionTimestamp =
  lens
    _wcsLastKnownUserConnectionTimestamp
    (\s a -> s {_wcsLastKnownUserConnectionTimestamp = a}) .
  mapping _Time
...
wcsConnectionStateCheckTimestamp =
  lens
    ...
    (\s a -> s {_wcsConnectionStateCheckTimestamp = a}) .
  mapping _Time
...
wcsConnectionState =
  lens _wcsConnectionState (\s a -> s {_wcsConnectionState = a})
...
wdSubnetIds =
  lens _wdSubnetIds (\s a -> s {_wdSubnetIds = a}) . _Default . _Coerce

-- | The identifiers of the IP access control groups associated with the directory.
wdIpGroupIds :: Lens' WorkspaceDirectory [Text]
wdIpGroupIds =
  lens _wdIpGroupIds (\s a -> s {_wdIpGroupIds = a}) . _Default . _Coerce
...
wdWorkspaceSecurityGroupId =
  lens _wdWorkspaceSecurityGroupId (\s a -> s {_wdWorkspaceSecurityGroupId = a})
...
wdWorkspaceCreationProperties ::
     Lens' WorkspaceDirectory (Maybe DefaultWorkspaceCreationProperties)
wdWorkspaceCreationProperties =
  lens
...
wdDNSIPAddresses =
  lens _wdDNSIPAddresses (\s a -> s {_wdDNSIPAddresses = a}) .
  _Default . _Coerce
...
instance FromJSON WorkspaceDirectory where
  parseJSON =
    withObject
      "WorkspaceDirectory"
      (\x ->
         WorkspaceDirectory' <$> (x .:? "RegistrationCode") <*>
         (x .:? "IamRoleId") <*>
         (x .:? "DirectoryId") <*>
         (x .:? "State") <*>
         (x .:? "CustomerUserName") <*>
...
wpRootVolumeSizeGib =
  lens _wpRootVolumeSizeGib (\s a -> s {_wpRootVolumeSizeGib = a})
...
wpRunningModeAutoStopTimeoutInMinutes =
  lens
    ...
    (\s a -> s {_wpRunningModeAutoStopTimeoutInMinutes = a})

-- | The size of the user storage.
wpUserVolumeSizeGib :: Lens' WorkspaceProperties (Maybe Int)
wpUserVolumeSizeGib =
  lens _wpUserVolumeSizeGib (\s a -> s {_wpUserVolumeSizeGib = a})
...
instance FromJSON WorkspaceProperties where
  parseJSON =
    withObject
      "WorkspaceProperties"
      (\x ->
         WorkspaceProperties' <$> (x .:? "ComputeTypeName") <*>
         (x .:? "RunningMode") <*>
         (x .:? "RootVolumeSizeGib") <*>
...
wrWorkspaceProperties =
  lens _wrWorkspaceProperties (\s a -> s {_wrWorkspaceProperties = a})
...
wrRootVolumeEncryptionEnabled =
  lens
    ...
    (\s a -> s {_wrRootVolumeEncryptionEnabled = a})

-- | The KMS key used to encrypt data stored on your WorkSpace.
wrVolumeEncryptionKey :: Lens' WorkspaceRequest (Maybe Text)
wrVolumeEncryptionKey =
  lens _wrVolumeEncryptionKey (\s a -> s {_wrVolumeEncryptionKey = a})
...
wrUserVolumeEncryptionEnabled =
  lens
    ...
    (\s a -> s {_wrUserVolumeEncryptionEnabled = a})
...
instance FromJSON WorkspaceRequest where
  parseJSON =
    withObject
      "WorkspaceRequest"
      (\x ->
         WorkspaceRequest' <$> (x .:? "WorkspaceProperties") <*>
         (x .:? "RootVolumeEncryptionEnabled") <*>
         (x .:? "VolumeEncryptionKey") <*>
         (x .:? "UserVolumeEncryptionEnabled") <*>
         (x .:? "Tags" .!= mempty) <*>
  ...
  toJSON WorkspaceRequest' {..} =
    object
      (catMaybes
         ...
         , ("RootVolumeEncryptionEnabled" .=) <$> _wrRootVolumeEncryptionEnabled
         , ("VolumeEncryptionKey" .=) <$> _wrVolumeEncryptionKey
         , ("UserVolumeEncryptionEnabled" .=) <$> _wrUserVolumeEncryptionEnabled
         , ("Tags" .=) <$> _wrTags
...
wigUserRules =
  lens _wigUserRules (\s a -> s {_wigUserRules = a}) . _Default . _Coerce
