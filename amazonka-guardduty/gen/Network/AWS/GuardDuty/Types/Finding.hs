...
data Finding = Finding'{_fService ::
                        ...
                        _fARN :: !Text, _fCreatedAt :: !Text, _fId :: !Text,
                        _fRegion :: !Text, _fResource :: !Resource,
                        _fSchemaVersion :: !Text, _fSeverity :: !Double,
                        _fType :: !Text, _fUpdatedAt :: !Text}
...
finding
    ...
    -> Text -- ^ 'fUpdatedAt'
    -> Finding
finding pAccountId_ pARN_ pCreatedAt_ pId_ pRegion_
  pResource_ pSchemaVersion_ pSeverity_ pType_
  pUpdatedAt_
  = Finding'{_fService = Nothing,
             _fConfidence = Nothing, _fPartition = Nothing,
             _fTitle = Nothing, _fDescription = Nothing,
             _fAccountId = pAccountId_, _fARN = pARN_,
             _fCreatedAt = pCreatedAt_, _fId = pId_,
             _fRegion = pRegion_, _fResource = pResource_,
             _fSchemaVersion = pSchemaVersion_,
             _fSeverity = pSeverity_, _fType = pType_,
