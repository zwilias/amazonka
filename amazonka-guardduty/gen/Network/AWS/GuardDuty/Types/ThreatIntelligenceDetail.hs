...
data ThreatIntelligenceDetail = ThreatIntelligenceDetail'{_tidThreatNames
                                                          :: !(Maybe [Text]),
                                                          _tidThreatListName ::
                                                          !(Maybe Text)}
...
threatIntelligenceDetail
    :: ThreatIntelligenceDetail
threatIntelligenceDetail
  = ThreatIntelligenceDetail'{_tidThreatNames =
                                Nothing,
...
instance FromJSON ThreatIntelligenceDetail where
        parseJSON
          = withObject "ThreatIntelligenceDetail"
              (\ x ->
                 ThreatIntelligenceDetail' <$>
                   (x .:? "threatNames" .!= mempty) <*>
                     (x .:? "threatListName"))

instance Hashable ThreatIntelligenceDetail where

instance NFData ThreatIntelligenceDetail where
