...
data Condition = Condition'{_cEQ :: !(Maybe [Text]),
                            ...
                            _cGT :: !(Maybe Int), _cEquals :: !(Maybe [Text]),
                            _cNeq :: !(Maybe [Text]),
                            _cNotEquals :: !(Maybe [Text]),
                            _cLT :: !(Maybe Int), _cGte :: !(Maybe Int),
...
condition
    :: Condition
condition
  = Condition'{_cEQ = Nothing, _cLessThan = Nothing,
               _cLte = Nothing, _cGreaterThanOrEqual = Nothing,
               _cLessThanOrEqual = Nothing, _cGT = Nothing,
               _cEquals = Nothing, _cNeq = Nothing,
               _cNotEquals = Nothing, _cLT = Nothing,
               _cGte = Nothing, _cGreaterThan = Nothing}
...
instance ToJSON Condition where
        toJSON Condition'{..}
          = object
              (catMaybes
                 [("eq" .=) <$> _cEQ, ("lessThan" .=) <$> _cLessThan,
                  ("lte" .=) <$> _cLte,
                  ("greaterThanOrEqual" .=) <$> _cGreaterThanOrEqual,
                  ("lessThanOrEqual" .=) <$> _cLessThanOrEqual,
                  ("gt" .=) <$> _cGT, ("equals" .=) <$> _cEquals,
                  ("neq" .=) <$> _cNeq,
                  ("notEquals" .=) <$> _cNotEquals, ("lt" .=) <$> _cLT,
                  ("gte" .=) <$> _cGte,
