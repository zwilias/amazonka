...
data DestinationProperties = DestinationProperties'{_dpKMSKeyARN
                                                    :: !(Maybe Text),
                                                    _dpDestinationARN ::
                                                    !(Maybe Text)}
...
destinationProperties
    :: DestinationProperties
destinationProperties
  = DestinationProperties'{_dpKMSKeyARN = Nothing,
...
instance FromJSON DestinationProperties where
        parseJSON
          = withObject "DestinationProperties"
              (\ x ->
                 DestinationProperties' <$>
                   (x .:? "kmsKeyArn") <*> (x .:? "destinationArn"))

instance Hashable DestinationProperties where

instance NFData DestinationProperties where
