...
data DescribeOrganizationConfigurationResponse = DescribeOrganizationConfigurationResponse'{_docrsResponseStatus
                                                                                            ::
                                                                                            !Int,
                                                                                            _docrsAutoEnable
                                                                                            ::
...
describeOrganizationConfigurationResponse
  ...
  = DescribeOrganizationConfigurationResponse'{_docrsResponseStatus
                                                 = pResponseStatus_,
