...
createFilter pDetectorId_
  = CreateFilter'{_cfClientToken = Nothing,
                  _cfFindingCriteria = Nothing, _cfAction = Nothing,
                  _cfName = Nothing, _cfDescription = Nothing,
                  _cfRank = Nothing, _cfDetectorId = pDetectorId_}
...
data CreateFilterResponse = CreateFilterResponse'{_cfrsName
                                                  :: !(Maybe Text),
...
createFilterResponse pResponseStatus_
  = CreateFilterResponse'{_cfrsName = Nothing,
