...
grdvResourceDefinitionVersionId =
  lens
    ...
    (\s a -> s {_grdvResourceDefinitionVersionId = a})

-- | The ID of the resource definition.
grdvResourceDefinitionId :: Lens' GetResourceDefinitionVersion Text
grdvResourceDefinitionId =
  lens _grdvResourceDefinitionId (\s a -> s {_grdvResourceDefinitionId = a})

instance AWSRequest GetResourceDefinitionVersion where
  type Rs GetResourceDefinitionVersion = GetResourceDefinitionVersionResponse
  request = get greengrass
  response =
    receiveJSON
      (\s h x ->
         GetResourceDefinitionVersionResponse' <$> (x .?> "Definition") <*>
         (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
...
grdvrsDefinition ::
     Lens' GetResourceDefinitionVersionResponse (Maybe ResourceDefinitionVersion)
...
grdvrsCreationTimestamp ::
     Lens' GetResourceDefinitionVersionResponse (Maybe Text)
grdvrsCreationTimestamp =
  lens _grdvrsCreationTimestamp (\s a -> s {_grdvrsCreationTimestamp = a})
...
grdvrsResponseStatus =
  lens _grdvrsResponseStatus (\s a -> s {_grdvrsResponseStatus = a})
