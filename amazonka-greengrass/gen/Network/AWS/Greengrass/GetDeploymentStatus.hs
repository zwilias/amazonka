...
instance AWSRequest GetDeploymentStatus where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetDeploymentStatusResponse' <$> (x .?> "DeploymentType") <*>
...
gdsrsDeploymentType =
  lens _gdsrsDeploymentType (\s a -> s {_gdsrsDeploymentType = a})

-- | Error details
gdsrsErrorDetails :: Lens' GetDeploymentStatusResponse [ErrorDetail]
gdsrsErrorDetails =
  lens _gdsrsErrorDetails (\s a -> s {_gdsrsErrorDetails = a}) .
  _Default . _Coerce

-- | The status of the deployment.
gdsrsDeploymentStatus :: Lens' GetDeploymentStatusResponse (Maybe Text)
gdsrsDeploymentStatus =
  lens _gdsrsDeploymentStatus (\s a -> s {_gdsrsDeploymentStatus = a})
