...
lfdvFunctionDefinitionId =
  lens _lfdvFunctionDefinitionId (\s a -> s {_lfdvFunctionDefinitionId = a})

instance AWSRequest ListFunctionDefinitionVersions where
  type Rs ListFunctionDefinitionVersions = ListFunctionDefinitionVersionsResponse
...
instance ToQuery ListFunctionDefinitionVersions where
  toQuery ListFunctionDefinitionVersions' {..} =
    mconcat ["NextToken" =: _lfdvNextToken, "MaxResults" =: _lfdvMaxResults]
...
lfdvrsVersions ::
     Lens' ListFunctionDefinitionVersionsResponse [VersionInformation]
lfdvrsVersions =
  lens _lfdvrsVersions (\s a -> s {_lfdvrsVersions = a}) . _Default . _Coerce
...
lfdvrsResponseStatus =
  lens _lfdvrsResponseStatus (\s a -> s {_lfdvrsResponseStatus = a})
