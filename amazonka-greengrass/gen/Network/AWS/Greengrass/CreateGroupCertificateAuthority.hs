...
cgcaAmznClientToken =
  lens _cgcaAmznClientToken (\s a -> s {_cgcaAmznClientToken = a})
...
instance AWSRequest CreateGroupCertificateAuthority where
  type Rs CreateGroupCertificateAuthority = CreateGroupCertificateAuthorityResponse
...
instance ToPath CreateGroupCertificateAuthority where
  toPath CreateGroupCertificateAuthority' {..} =
    mconcat
      ["/greengrass/groups/", toBS _cgcaGroupId, "/certificateauthorities"]
...
cgcarsGroupCertificateAuthorityARN ::
     Lens' CreateGroupCertificateAuthorityResponse (Maybe Text)
cgcarsGroupCertificateAuthorityARN =
  lens
    _cgcarsGroupCertificateAuthorityARN
    (\s a -> s {_cgcarsGroupCertificateAuthorityARN = a})

-- | -- | The response status code.
cgcarsResponseStatus :: Lens' CreateGroupCertificateAuthorityResponse Int
cgcarsResponseStatus =
  lens _cgcarsResponseStatus (\s a -> s {_cgcarsResponseStatus = a})
