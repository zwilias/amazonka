...
gcdvCoreDefinitionId =
  lens _gcdvCoreDefinitionId (\s a -> s {_gcdvCoreDefinitionId = a})
...
gcdvCoreDefinitionVersionId =
  lens
    ...
    (\s a -> s {_gcdvCoreDefinitionVersionId = a})
...
instance AWSRequest GetCoreDefinitionVersion where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetCoreDefinitionVersionResponse' <$> (x .?> "Definition") <*>
         (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
...
gcdvrsDefinition ::
     Lens' GetCoreDefinitionVersionResponse (Maybe CoreDefinitionVersion)
...
gcdvrsCreationTimestamp =
  lens _gcdvrsCreationTimestamp (\s a -> s {_gcdvrsCreationTimestamp = a})
...
gcdvrsResponseStatus =
  lens _gcdvrsResponseStatus (\s a -> s {_gcdvrsResponseStatus = a})
