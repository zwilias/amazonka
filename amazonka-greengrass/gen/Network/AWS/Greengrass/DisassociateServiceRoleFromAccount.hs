...
instance AWSRequest DisassociateServiceRoleFromAccount where
  type Rs DisassociateServiceRoleFromAccount = DisassociateServiceRoleFromAccountResponse
...
dsrfarsDisassociatedAt ::
     Lens' DisassociateServiceRoleFromAccountResponse (Maybe Text)
dsrfarsDisassociatedAt =
  lens _dsrfarsDisassociatedAt (\s a -> s {_dsrfarsDisassociatedAt = a})

-- | -- | The response status code.
dsrfarsResponseStatus :: Lens' DisassociateServiceRoleFromAccountResponse Int
dsrfarsResponseStatus =
  lens _dsrfarsResponseStatus (\s a -> s {_dsrfarsResponseStatus = a})
