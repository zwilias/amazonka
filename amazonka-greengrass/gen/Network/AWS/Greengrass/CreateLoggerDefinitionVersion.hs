...
cldvLoggers =
  lens _cldvLoggers (\s a -> s {_cldvLoggers = a}) . _Default . _Coerce

-- | A client token used to correlate requests and responses.
cldvAmznClientToken :: Lens' CreateLoggerDefinitionVersion (Maybe Text)
cldvAmznClientToken =
  lens _cldvAmznClientToken (\s a -> s {_cldvAmznClientToken = a})

-- | The ID of the logger definition.
cldvLoggerDefinitionId :: Lens' CreateLoggerDefinitionVersion Text
cldvLoggerDefinitionId =
  lens _cldvLoggerDefinitionId (\s a -> s {_cldvLoggerDefinitionId = a})

instance AWSRequest CreateLoggerDefinitionVersion where
  type Rs CreateLoggerDefinitionVersion = CreateLoggerDefinitionVersionResponse
  request = postJSON greengrass
  response =
    receiveJSON
      (\s h x ->
         CreateLoggerDefinitionVersionResponse' <$> (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
         (pure (fromEnum s)))
...
cldvrsCreationTimestamp ::
     Lens' CreateLoggerDefinitionVersionResponse (Maybe Text)
cldvrsCreationTimestamp =
  lens _cldvrsCreationTimestamp (\s a -> s {_cldvrsCreationTimestamp = a})
...
cldvrsResponseStatus =
  lens _cldvrsResponseStatus (\s a -> s {_cldvrsResponseStatus = a})
