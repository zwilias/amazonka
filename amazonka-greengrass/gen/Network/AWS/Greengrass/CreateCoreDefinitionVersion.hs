...
ccdvAmznClientToken =
  lens _ccdvAmznClientToken (\s a -> s {_ccdvAmznClientToken = a})
...
ccdvCoreDefinitionId =
  lens _ccdvCoreDefinitionId (\s a -> s {_ccdvCoreDefinitionId = a})

instance AWSRequest CreateCoreDefinitionVersion where
  type Rs CreateCoreDefinitionVersion = CreateCoreDefinitionVersionResponse
  request = postJSON greengrass
  response =
    receiveJSON
      (\s h x ->
         CreateCoreDefinitionVersionResponse' <$> (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
         (pure (fromEnum s)))
...
instance ToPath CreateCoreDefinitionVersion where
  toPath CreateCoreDefinitionVersion' {..} =
    mconcat
      ["/greengrass/definition/cores/", toBS _ccdvCoreDefinitionId, "/versions"]
...
ccdvrsCreationTimestamp ::
     Lens' CreateCoreDefinitionVersionResponse (Maybe Text)
ccdvrsCreationTimestamp =
  lens _ccdvrsCreationTimestamp (\s a -> s {_ccdvrsCreationTimestamp = a})
...
ccdvrsResponseStatus =
  lens _ccdvrsResponseStatus (\s a -> s {_ccdvrsResponseStatus = a})
