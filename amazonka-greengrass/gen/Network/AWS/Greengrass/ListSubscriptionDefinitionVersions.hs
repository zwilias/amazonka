...
lsdvSubscriptionDefinitionId =
  lens
    ...
    (\s a -> s {_lsdvSubscriptionDefinitionId = a})

instance AWSRequest ListSubscriptionDefinitionVersions where
  type Rs ListSubscriptionDefinitionVersions = ListSubscriptionDefinitionVersionsResponse
...
instance ToQuery ListSubscriptionDefinitionVersions where
  toQuery ListSubscriptionDefinitionVersions' {..} =
    mconcat ["NextToken" =: _lsdvNextToken, "MaxResults" =: _lsdvMaxResults]
...
lsdvrsVersions ::
     Lens' ListSubscriptionDefinitionVersionsResponse [VersionInformation]
lsdvrsVersions =
  lens _lsdvrsVersions (\s a -> s {_lsdvrsVersions = a}) . _Default . _Coerce
...
lsdvrsResponseStatus =
  lens _lsdvrsResponseStatus (\s a -> s {_lsdvrsResponseStatus = a})
