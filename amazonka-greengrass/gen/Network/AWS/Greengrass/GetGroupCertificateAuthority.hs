...
ggcaCertificateAuthorityId =
  lens _ggcaCertificateAuthorityId (\s a -> s {_ggcaCertificateAuthorityId = a})
...
instance AWSRequest GetGroupCertificateAuthority where
  type Rs GetGroupCertificateAuthority = GetGroupCertificateAuthorityResponse
...
ggcarsPemEncodedCertificate ::
     Lens' GetGroupCertificateAuthorityResponse (Maybe Text)
ggcarsPemEncodedCertificate =
  lens
    _ggcarsPemEncodedCertificate
    (\s a -> s {_ggcarsPemEncodedCertificate = a})
...
ggcarsGroupCertificateAuthorityARN =
  lens
    ...
    (\s a -> s {_ggcarsGroupCertificateAuthorityARN = a})
...
ggcarsGroupCertificateAuthorityId =
  lens
    ...
    (\s a -> s {_ggcarsGroupCertificateAuthorityId = a})

-- | -- | The response status code.
ggcarsResponseStatus :: Lens' GetGroupCertificateAuthorityResponse Int
ggcarsResponseStatus =
  lens _ggcarsResponseStatus (\s a -> s {_ggcarsResponseStatus = a})
