...
crdvAmznClientToken =
  lens _crdvAmznClientToken (\s a -> s {_crdvAmznClientToken = a})

-- | A list of resources.
crdvResources :: Lens' CreateResourceDefinitionVersion [Resource]
crdvResources =
  lens _crdvResources (\s a -> s {_crdvResources = a}) . _Default . _Coerce

-- | The ID of the resource definition.
crdvResourceDefinitionId :: Lens' CreateResourceDefinitionVersion Text
crdvResourceDefinitionId =
  lens _crdvResourceDefinitionId (\s a -> s {_crdvResourceDefinitionId = a})

instance AWSRequest CreateResourceDefinitionVersion where
  type Rs CreateResourceDefinitionVersion = CreateResourceDefinitionVersionResponse
  request = postJSON greengrass
  response =
    receiveJSON
      (\s h x ->
         CreateResourceDefinitionVersionResponse' <$> (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
         (pure (fromEnum s)))
...
crdvrsCreationTimestamp ::
     Lens' CreateResourceDefinitionVersionResponse (Maybe Text)
crdvrsCreationTimestamp =
  lens _crdvrsCreationTimestamp (\s a -> s {_crdvrsCreationTimestamp = a})
...
crdvrsResponseStatus =
  lens _crdvrsResponseStatus (\s a -> s {_crdvrsResponseStatus = a})
