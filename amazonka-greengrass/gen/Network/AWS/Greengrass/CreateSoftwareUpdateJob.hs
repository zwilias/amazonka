...
-- | Undocumented member.
csujUpdateAgentLogLevel ::
     Lens' CreateSoftwareUpdateJob (Maybe UpdateAgentLogLevel)
csujUpdateAgentLogLevel =
  lens _csujUpdateAgentLogLevel (\s a -> s {_csujUpdateAgentLogLevel = a})

-- | A client token used to correlate requests and responses.
csujAmznClientToken :: Lens' CreateSoftwareUpdateJob (Maybe Text)
csujAmznClientToken =
  lens _csujAmznClientToken (\s a -> s {_csujAmznClientToken = a})

-- | Undocumented member.
csujSoftwareToUpdate :: Lens' CreateSoftwareUpdateJob (Maybe SoftwareToUpdate)
csujSoftwareToUpdate =
  lens _csujSoftwareToUpdate (\s a -> s {_csujSoftwareToUpdate = a})
...
csujUpdateTargetsOperatingSystem =
  lens
    ...
    (\s a -> s {_csujUpdateTargetsOperatingSystem = a})

-- | Undocumented member.
csujS3URLSignerRole :: Lens' CreateSoftwareUpdateJob (Maybe Text)
csujS3URLSignerRole =
  lens _csujS3URLSignerRole (\s a -> s {_csujS3URLSignerRole = a})

-- | Undocumented member.
csujUpdateTargets :: Lens' CreateSoftwareUpdateJob [Text]
csujUpdateTargets =
  lens _csujUpdateTargets (\s a -> s {_csujUpdateTargets = a}) .
  _Default . _Coerce

-- | Undocumented member.
csujUpdateTargetsArchitecture ::
     Lens' CreateSoftwareUpdateJob (Maybe UpdateTargetsArchitecture)
csujUpdateTargetsArchitecture =
  lens
    _csujUpdateTargetsArchitecture
    (\s a -> s {_csujUpdateTargetsArchitecture = a})
...
instance AWSRequest CreateSoftwareUpdateJob where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateSoftwareUpdateJobResponse' <$> (x .?> "IotJobArn") <*>
         (x .?> "IotJobId") <*>
         (pure (fromEnum s)))
...
csujrsResponseStatus =
  lens _csujrsResponseStatus (\s a -> s {_csujrsResponseStatus = a})
