...
ugccCertificateExpiryInMilliseconds ::
     Lens' UpdateGroupCertificateConfiguration (Maybe Text)
ugccCertificateExpiryInMilliseconds =
  lens
    _ugccCertificateExpiryInMilliseconds
    (\s a -> s {_ugccCertificateExpiryInMilliseconds = a})
...
instance AWSRequest UpdateGroupCertificateConfiguration where
  type Rs UpdateGroupCertificateConfiguration = UpdateGroupCertificateConfigurationResponse
...
ugccrsCertificateAuthorityExpiryInMilliseconds ::
     Lens' UpdateGroupCertificateConfigurationResponse (Maybe Text)
ugccrsCertificateAuthorityExpiryInMilliseconds =
  lens
    _ugccrsCertificateAuthorityExpiryInMilliseconds
    (\s a -> s {_ugccrsCertificateAuthorityExpiryInMilliseconds = a})
...
ugccrsCertificateExpiryInMilliseconds =
  lens
    ...
    (\s a -> s {_ugccrsCertificateExpiryInMilliseconds = a})

-- | -- | The response status code.
ugccrsResponseStatus :: Lens' UpdateGroupCertificateConfigurationResponse Int
ugccrsResponseStatus =
  lens _ugccrsResponseStatus (\s a -> s {_ugccrsResponseStatus = a})
