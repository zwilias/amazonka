...
cfdAmznClientToken =
  lens _cfdAmznClientToken (\s a -> s {_cfdAmznClientToken = a})

-- | Information about the initial version of the function definition.
cfdInitialVersion ::
     Lens' CreateFunctionDefinition (Maybe FunctionDefinitionVersion)
...
instance AWSRequest CreateFunctionDefinition where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateFunctionDefinitionResponse' <$> (x .?> "LatestVersionArn") <*>
         (x .?> "Arn") <*>
         (x .?> "Name") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Id") <*>
...
cfdrsLatestVersionARN =
  lens _cfdrsLatestVersionARN (\s a -> s {_cfdrsLatestVersionARN = a})
...
cfdrsCreationTimestamp =
  lens _cfdrsCreationTimestamp (\s a -> s {_cfdrsCreationTimestamp = a})
...
cfdrsLatestVersion =
  lens _cfdrsLatestVersion (\s a -> s {_cfdrsLatestVersion = a})

-- | The time, in milliseconds since the epoch, when the definition was last updated.
cfdrsLastUpdatedTimestamp :: Lens' CreateFunctionDefinitionResponse (Maybe Text)
cfdrsLastUpdatedTimestamp =
  lens _cfdrsLastUpdatedTimestamp (\s a -> s {_cfdrsLastUpdatedTimestamp = a})

-- | -- | The response status code.
cfdrsResponseStatus :: Lens' CreateFunctionDefinitionResponse Int
cfdrsResponseStatus =
  lens _cfdrsResponseStatus (\s a -> s {_cfdrsResponseStatus = a})
