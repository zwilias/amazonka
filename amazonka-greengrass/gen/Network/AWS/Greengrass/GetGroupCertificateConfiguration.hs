...
instance AWSRequest GetGroupCertificateConfiguration where
  type Rs GetGroupCertificateConfiguration = GetGroupCertificateConfigurationResponse
...
ggccrsCertificateAuthorityExpiryInMilliseconds ::
     Lens' GetGroupCertificateConfigurationResponse (Maybe Text)
ggccrsCertificateAuthorityExpiryInMilliseconds =
  lens
    _ggccrsCertificateAuthorityExpiryInMilliseconds
    (\s a -> s {_ggccrsCertificateAuthorityExpiryInMilliseconds = a})
...
ggccrsCertificateExpiryInMilliseconds =
  lens
    ...
    (\s a -> s {_ggccrsCertificateExpiryInMilliseconds = a})

-- | -- | The response status code.
ggccrsResponseStatus :: Lens' GetGroupCertificateConfigurationResponse Int
ggccrsResponseStatus =
  lens _ggccrsResponseStatus (\s a -> s {_ggccrsResponseStatus = a})
