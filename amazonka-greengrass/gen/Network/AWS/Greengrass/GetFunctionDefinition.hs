...
gfdFunctionDefinitionId =
  lens _gfdFunctionDefinitionId (\s a -> s {_gfdFunctionDefinitionId = a})
...
instance AWSRequest GetFunctionDefinition where
  ...
  response =
    receiveJSON
      (\s h x ->
         GetFunctionDefinitionResponse' <$> (x .?> "LatestVersionArn") <*>
         (x .?> "Arn") <*>
         (x .?> "Name") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Id") <*>
...
instance ToPath GetFunctionDefinition where
  toPath GetFunctionDefinition' {..} =
    mconcat ["/greengrass/definition/functions/", toBS _gfdFunctionDefinitionId]
...
gfdrsLatestVersionARN =
  lens _gfdrsLatestVersionARN (\s a -> s {_gfdrsLatestVersionARN = a})
...
gfdrsCreationTimestamp =
  lens _gfdrsCreationTimestamp (\s a -> s {_gfdrsCreationTimestamp = a})
...
gfdrsLatestVersion =
  lens _gfdrsLatestVersion (\s a -> s {_gfdrsLatestVersion = a})

-- | The time, in milliseconds since the epoch, when the definition was last updated.
gfdrsLastUpdatedTimestamp :: Lens' GetFunctionDefinitionResponse (Maybe Text)
gfdrsLastUpdatedTimestamp =
  lens _gfdrsLastUpdatedTimestamp (\s a -> s {_gfdrsLastUpdatedTimestamp = a})

-- | -- | The response status code.
gfdrsResponseStatus :: Lens' GetFunctionDefinitionResponse Int
gfdrsResponseStatus =
  lens _gfdrsResponseStatus (\s a -> s {_gfdrsResponseStatus = a})
