...
data Connector = Connector'{_conParameters ::
                            !(Maybe (Map Text Text)),
                            _conConnectorARN :: !Text, _conId :: !Text}
...
connector
    :: Text -- ^ 'conConnectorARN'
    -> Text -- ^ 'conId'
    -> Connector
connector pConnectorARN_ pId_
  = Connector'{_conParameters = Nothing,
               _conConnectorARN = pConnectorARN_, _conId = pId_}
