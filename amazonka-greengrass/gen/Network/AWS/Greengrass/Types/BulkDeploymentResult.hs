...
data BulkDeploymentResult = BulkDeploymentResult'{_bdrDeploymentId
                                                  :: !(Maybe Text),
                                                  _bdrDeploymentARN ::
                                                  !(Maybe Text),
                                                  _bdrCreatedAt ::
...
bulkDeploymentResult
    :: BulkDeploymentResult
bulkDeploymentResult
  = BulkDeploymentResult'{_bdrDeploymentId = Nothing,
                          _bdrDeploymentARN = Nothing, _bdrCreatedAt = Nothing,
                          _bdrDeploymentType = Nothing,
                          _bdrErrorDetails = Nothing, _bdrGroupARN = Nothing,
