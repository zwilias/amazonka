...
data ResourceDownloadOwnerSetting = ResourceDownloadOwnerSetting'{_rdosGroupOwner
                                                                  :: !Text,
...
resourceDownloadOwnerSetting
    :: Text -- ^ 'rdosGroupOwner'
    -> Permission -- ^ 'rdosGroupPermission'
    -> ResourceDownloadOwnerSetting
resourceDownloadOwnerSetting pGroupOwner_
  pGroupPermission_
  = ResourceDownloadOwnerSetting'{_rdosGroupOwner =
                                    pGroupOwner_,
...
instance FromJSON ResourceDownloadOwnerSetting where
        parseJSON
          = withObject "ResourceDownloadOwnerSetting"
              (\ x ->
                 ResourceDownloadOwnerSetting' <$>
                   (x .: "GroupOwner") <*> (x .: "GroupPermission"))

instance Hashable ResourceDownloadOwnerSetting where

instance NFData ResourceDownloadOwnerSetting where
