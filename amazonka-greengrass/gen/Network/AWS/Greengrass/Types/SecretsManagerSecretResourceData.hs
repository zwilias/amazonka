...
data SecretsManagerSecretResourceData = SecretsManagerSecretResourceData'{_smsrdAdditionalStagingLabelsToDownload
                                                                          ::
                                                                          !(Maybe
                                                                              [Text]),
                                                                          _smsrdARN
...
secretsManagerSecretResourceData
    :: SecretsManagerSecretResourceData
secretsManagerSecretResourceData
  = SecretsManagerSecretResourceData'{_smsrdAdditionalStagingLabelsToDownload
                                        = Nothing,
                                      _smsrdARN = Nothing}
