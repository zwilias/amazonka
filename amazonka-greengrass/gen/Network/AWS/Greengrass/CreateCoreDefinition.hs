...
ccdAmznClientToken =
  lens _ccdAmznClientToken (\s a -> s {_ccdAmznClientToken = a})
...
instance AWSRequest CreateCoreDefinition where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateCoreDefinitionResponse' <$> (x .?> "LatestVersionArn") <*>
         (x .?> "Arn") <*>
         (x .?> "Name") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Id") <*>
...
ccdrsLatestVersionARN =
  lens _ccdrsLatestVersionARN (\s a -> s {_ccdrsLatestVersionARN = a})
...
ccdrsCreationTimestamp =
  lens _ccdrsCreationTimestamp (\s a -> s {_ccdrsCreationTimestamp = a})
...
ccdrsLatestVersion =
  lens _ccdrsLatestVersion (\s a -> s {_ccdrsLatestVersion = a})

-- | The time, in milliseconds since the epoch, when the definition was last updated.
ccdrsLastUpdatedTimestamp :: Lens' CreateCoreDefinitionResponse (Maybe Text)
ccdrsLastUpdatedTimestamp =
  lens _ccdrsLastUpdatedTimestamp (\s a -> s {_ccdrsLastUpdatedTimestamp = a})

-- | -- | The response status code.
ccdrsResponseStatus :: Lens' CreateCoreDefinitionResponse Int
ccdrsResponseStatus =
  lens _ccdrsResponseStatus (\s a -> s {_ccdrsResponseStatus = a})
