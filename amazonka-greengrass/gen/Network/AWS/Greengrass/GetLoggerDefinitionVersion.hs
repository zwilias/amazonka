...
gldvLoggerDefinitionVersionId =
  lens
    ...
    (\s a -> s {_gldvLoggerDefinitionVersionId = a})

-- | The ID of the logger definition.
gldvLoggerDefinitionId :: Lens' GetLoggerDefinitionVersion Text
gldvLoggerDefinitionId =
  lens _gldvLoggerDefinitionId (\s a -> s {_gldvLoggerDefinitionId = a})

instance AWSRequest GetLoggerDefinitionVersion where
  type Rs GetLoggerDefinitionVersion = GetLoggerDefinitionVersionResponse
  request = get greengrass
  response =
    receiveJSON
      (\s h x ->
         GetLoggerDefinitionVersionResponse' <$> (x .?> "Definition") <*>
         (x .?> "Arn") <*>
         (x .?> "CreationTimestamp") <*>
         (x .?> "Version") <*>
         (x .?> "Id") <*>
...
gldvrsDefinition ::
     Lens' GetLoggerDefinitionVersionResponse (Maybe LoggerDefinitionVersion)
...
gldvrsCreationTimestamp =
  lens _gldvrsCreationTimestamp (\s a -> s {_gldvrsCreationTimestamp = a})
...
gldvrsResponseStatus =
  lens _gldvrsResponseStatus (\s a -> s {_gldvrsResponseStatus = a})
