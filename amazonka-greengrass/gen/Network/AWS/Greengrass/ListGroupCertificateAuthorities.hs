...
instance AWSRequest ListGroupCertificateAuthorities where
  type Rs ListGroupCertificateAuthorities = ListGroupCertificateAuthoritiesResponse
...
instance ToPath ListGroupCertificateAuthorities where
  toPath ListGroupCertificateAuthorities' {..} =
    mconcat
      ["/greengrass/groups/", toBS _lgcaGroupId, "/certificateauthorities"]
...
lgcarsGroupCertificateAuthorities ::
     Lens' ListGroupCertificateAuthoritiesResponse [GroupCertificateAuthorityProperties]
lgcarsGroupCertificateAuthorities =
  lens
    _lgcarsGroupCertificateAuthorities
    (\s a -> s {_lgcarsGroupCertificateAuthorities = a}) .
  _Default . _Coerce

-- | -- | The response status code.
lgcarsResponseStatus :: Lens' ListGroupCertificateAuthoritiesResponse Int
lgcarsResponseStatus =
  lens _lgcarsResponseStatus (\s a -> s {_lgcarsResponseStatus = a})
