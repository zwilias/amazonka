...
data AssociateQualificationWithWorker = AssociateQualificationWithWorker'{_aqwwIntegerValue
                                                                          ::
                                                                          !(Maybe
                                                                              Int),
...
associateQualificationWithWorker
    ...
    -> AssociateQualificationWithWorker
associateQualificationWithWorker
  pQualificationTypeId_ pWorkerId_
...
newtype AssociateQualificationWithWorkerResponse = AssociateQualificationWithWorkerResponse'{_aqwwrsResponseStatus
                                                                                             ::
                                                                                             Int}
...
associateQualificationWithWorkerResponse
  pResponseStatus_
  = AssociateQualificationWithWorkerResponse'{_aqwwrsResponseStatus
                                                = pResponseStatus_}
