...
data ListQualificationTypes = ListQualificationTypes'{_lqtMustBeOwnedByCaller
                                                      :: !(Maybe Bool),
                                                      _lqtNextToken ::
                                                      !(Maybe Text),
                                                      _lqtQuery ::
...
listQualificationTypes pMustBeRequestable_
  = ListQualificationTypes'{_lqtMustBeOwnedByCaller =
                              Nothing,
                            _lqtNextToken = Nothing, _lqtQuery = Nothing,
...
data ListQualificationTypesResponse = ListQualificationTypesResponse'{_lqtrsQualificationTypes
                                                                      ::
                                                                      !(Maybe
                                                                          [QualificationType]),
                                                                      _lqtrsNextToken
...
listQualificationTypesResponse pResponseStatus_
  = ListQualificationTypesResponse'{_lqtrsQualificationTypes
                                      = Nothing,
