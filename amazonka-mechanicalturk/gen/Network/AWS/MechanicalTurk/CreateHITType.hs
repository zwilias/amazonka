...
data CreateHITType = CreateHITType'{_chittAutoApprovalDelayInSeconds
                                    :: !(Maybe Integer),
                                    ...
                                    !Integer,
                                    _chittReward :: !Text, _chittTitle :: !Text,
...
createHITType
    ...
    -> CreateHITType
createHITType pAssignmentDurationInSeconds_ pReward_
  pTitle_ pDescription_
  = CreateHITType'{_chittAutoApprovalDelayInSeconds =
                     Nothing,
                   _chittKeywords = Nothing,
                   _chittQualificationRequirements = Nothing,
                   _chittAssignmentDurationInSeconds =
                     pAssignmentDurationInSeconds_,
                   _chittReward = pReward_, _chittTitle = pTitle_,
...
data CreateHITTypeResponse = CreateHITTypeResponse'{_chittrsHITTypeId
                                                    :: !(Maybe Text),
                                                    _chittrsResponseStatus ::
                                                    !Int}
...
createHITTypeResponse pResponseStatus_
  = CreateHITTypeResponse'{_chittrsHITTypeId = Nothing,
