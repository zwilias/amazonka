...
chittAutoApprovalDelayInSeconds =
  lens
    ...
    (\s a -> s {_chittAutoApprovalDelayInSeconds = a})
...
chittQualificationRequirements =
  lens
    ...
    (\s a -> s {_chittQualificationRequirements = a}) .
  _Default . _Coerce
...
chittAssignmentDurationInSeconds =
  lens
    ...
    (\s a -> s {_chittAssignmentDurationInSeconds = a})
...
instance AWSRequest CreateHITType where
  ...
  response =
    receiveJSON
      (\s h x ->
         CreateHITTypeResponse' <$> (x .?> "HITTypeId") <*> (pure (fromEnum s)))
  ...
  toJSON CreateHITType' {..} =
    object
      (catMaybes
         ...
         , ("QualificationRequirements" .=) <$> _chittQualificationRequirements
         , Just
             ("AssignmentDurationInSeconds" .= _chittAssignmentDurationInSeconds)
...
chittrsResponseStatus =
  lens _chittrsResponseStatus (\s a -> s {_chittrsResponseStatus = a})
