...
data BonusPayment = BonusPayment'{_bpReason ::
                                  !(Maybe Text),
...
bonusPayment
    :: BonusPayment
bonusPayment
  = BonusPayment'{_bpReason = Nothing,
                  _bpGrantTime = Nothing, _bpWorkerId = Nothing,
                  _bpAssignmentId = Nothing, _bpBonusAmount = Nothing}
