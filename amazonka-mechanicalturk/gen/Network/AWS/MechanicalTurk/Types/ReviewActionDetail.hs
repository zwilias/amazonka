...
data ReviewActionDetail = ReviewActionDetail'{_radStatus
...
reviewActionDetail
    :: ReviewActionDetail
reviewActionDetail
  = ReviewActionDetail'{_radStatus = Nothing,
                        _radTargetId = Nothing, _radActionId = Nothing,
                        _radTargetType = Nothing, _radResult = Nothing,
                        _radActionName = Nothing, _radCompleteTime = Nothing,
