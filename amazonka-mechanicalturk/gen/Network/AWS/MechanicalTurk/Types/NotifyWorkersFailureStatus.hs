...
data NotifyWorkersFailureStatus = NotifyWorkersFailureStatus'{_nwfsNotifyWorkersFailureMessage
                                                              :: !(Maybe Text),
...
notifyWorkersFailureStatus
    :: NotifyWorkersFailureStatus
notifyWorkersFailureStatus
  = NotifyWorkersFailureStatus'{_nwfsNotifyWorkersFailureMessage
                                  = Nothing,
