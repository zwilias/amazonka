...
data NotificationSpecification = NotificationSpecification'{_nsDestination
                                                            :: !Text,
                                                            _nsTransport ::
...
notificationSpecification pDestination_ pTransport_
  pVersion_
  = NotificationSpecification'{_nsDestination =
                                 pDestination_,
                               _nsTransport = pTransport_,
                               _nsVersion = pVersion_, _nsEventTypes = mempty}
