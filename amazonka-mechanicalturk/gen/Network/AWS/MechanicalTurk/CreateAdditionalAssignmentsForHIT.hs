...
caafhitUniqueRequestToken ::
     Lens' CreateAdditionalAssignmentsForHIT (Maybe Text)
caafhitUniqueRequestToken =
  lens _caafhitUniqueRequestToken (\s a -> s {_caafhitUniqueRequestToken = a})
...
caafhitNumberOfAdditionalAssignments ::
     Lens' CreateAdditionalAssignmentsForHIT Int
caafhitNumberOfAdditionalAssignments =
  lens
    _caafhitNumberOfAdditionalAssignments
    (\s a -> s {_caafhitNumberOfAdditionalAssignments = a})

instance AWSRequest CreateAdditionalAssignmentsForHIT where
  type Rs CreateAdditionalAssignmentsForHIT = CreateAdditionalAssignmentsForHITResponse
...
instance ToHeaders CreateAdditionalAssignmentsForHIT where
  toHeaders =
    const
      (mconcat
         [ "X-Amz-Target" =#
           ("MTurkRequesterServiceV20170117.CreateAdditionalAssignmentsForHIT" :: ByteString)
...
caafhitrsResponseStatus =
  lens _caafhitrsResponseStatus (\s a -> s {_caafhitrsResponseStatus = a})
