...
data ApproveAssignment = ApproveAssignment'{_aaOverrideRejection
                                            :: !(Maybe Bool),
...
approveAssignment pAssignmentId_
  = ApproveAssignment'{_aaOverrideRejection = Nothing,
...
newtype ApproveAssignmentResponse = ApproveAssignmentResponse'{_aarsResponseStatus
                                                               :: Int}
...
approveAssignmentResponse pResponseStatus_
  = ApproveAssignmentResponse'{_aarsResponseStatus =
                                 pResponseStatus_}
