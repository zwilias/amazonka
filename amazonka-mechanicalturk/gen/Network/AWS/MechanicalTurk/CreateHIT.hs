...
data CreateHIT = CreateHIT'{_chitHITReviewPolicy ::
                            !(Maybe ReviewPolicy),
                            ...
                            _chitReward :: !Text, _chitTitle :: !Text,
...
createHIT
    ...
    -> CreateHIT
createHIT pLifetimeInSeconds_
  pAssignmentDurationInSeconds_ pReward_ pTitle_
  pDescription_
  = CreateHIT'{_chitHITReviewPolicy = Nothing,
               ...
               _chitKeywords = Nothing, _chitHITLayoutId = Nothing,
               ...
               _chitReward = pReward_, _chitTitle = pTitle_,
...
data CreateHITResponse = CreateHITResponse'{_chitrsHIT
                                            :: !(Maybe HIT),
...
createHITResponse pResponseStatus_
  = CreateHITResponse'{_chitrsHIT = Nothing,
